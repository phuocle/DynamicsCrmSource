CREATE TABLE [dbo].[MailboxBase] (
    ...
    CONSTRAINT [business_unit_mailbox] FOREIGN KEY ([OwningBusinessUnit]) REFERENCES [dbo].[BusinessUnitBase] ([BusinessUnitId]) NOT FOR REPLICATION,
    CONSTRAINT [emailserverprofile_mailbox] FOREIGN KEY ([EmailServerProfile]) REFERENCES [dbo].[EmailServerProfileBase] ([EmailServerProfileId]) NOT FOR REPLICATION,
    CONSTRAINT [owner_mailbox] FOREIGN KEY ([OwnerId]) REFERENCES [dbo].[OwnerBase] ([OwnerId]) NOT FOR REPLICATION
);
