CREATE TABLE [dbo].[TeamBase] (
    ...
    CONSTRAINT [business_unit_teams] FOREIGN KEY ([BusinessUnitId]) REFERENCES [dbo].[BusinessUnitBase] ([BusinessUnitId]) NOT FOR REPLICATION,
    CONSTRAINT [queue_team] FOREIGN KEY ([QueueId]) REFERENCES [dbo].[QueueBase] ([QueueId]) NOT FOR REPLICATION,
    CONSTRAINT [teamtemplate_Teams] FOREIGN KEY ([TeamTemplateId]) REFERENCES [dbo].[TeamTemplateBase] ([TeamTemplateId]) NOT FOR REPLICATION,
    CONSTRAINT [TransactionCurrency_Team] FOREIGN KEY ([TransactionCurrencyId]) REFERENCES [dbo].[TransactionCurrencyBase] ([TransactionCurrencyId]) NOT FOR REPLICATION
);
