...
begin
	...
	select top 1
		@PricingDecimalPrecision = o.pricingdecimalprecision,
...
GO
GRANT SELECT
    ON OBJECT::[dbo].[fn_GetFormatStrings] TO [CRM\ReportingGroup {8a0aa7db-84c3-4ddf-bdca-6fbc8b5e12c6}]
    AS [dbo];


GO
GRANT SELECT
    ON OBJECT::[dbo].[fn_GetFormatStrings] TO [CRMReaderRole]
    AS [dbo];
