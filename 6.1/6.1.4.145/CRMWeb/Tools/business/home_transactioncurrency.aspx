<%@ Page language="c#" Inherits="Microsoft.Crm.Application.Pages.Tools.Business.TransactionCurrency" %>
...
<tr>
<td><label class="ms-crm-Setting-ContextHeader-Title"><loc:Text ResourceId="TransactionCurrencyAreaTitle" runat="server"/></label></td>
