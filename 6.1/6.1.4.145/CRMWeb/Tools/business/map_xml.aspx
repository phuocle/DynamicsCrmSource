...
<%
if (Organization.CurrentSettings.FiscalCalendarStart != DateTime.MinValue)
{
%>
<page id="06">
<title><loc:Text ResourceId="Web.Tools.map_xml.aspx_53" runat="server"/></title>
<icon>/_imgs/tools/ico_salesperson.gif</icon>
<link inline="1">/_static/loading.htm</link>
<url>home_salesperson.aspx</url>
<help><loc:Text ResourceId="Web.Tools.map_xml.aspx_56" runat="server"/></help>
</page>
<%
}
%>
