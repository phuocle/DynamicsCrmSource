...
<tr>
<td><label class="ms-crm-Setting-ContextHeader-Title"><loc:Text ResourceId="SM_Title_Resources" runat="server"/></label></td>
...
<tr>
<td nowrap class="home_resource_td_AppViewSelector"><label for="crmGrid_SavedQuerySelector"><span class="ms-crm-Bold-Header"><loc:Text ResourceId="Web.Tools.business.home_team.aspx_86" runat="server"/></span></label></td>
<td><cnt:AppViewSelector id="crmViewSelector" runat="server"/></td>
<td align="center"><span class="home_resource_span_QuickFindSpacer">&nbsp;</span></td>
</tr>
</table>
</div>
