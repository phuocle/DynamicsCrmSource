...
options.width = 800;
options.height = 650;
var url = Mscrm.CrmUri.create('/WebWizard/WizardContainer.aspx?WizardId=59345E49-6BF3-464c-BCF3-8FA44151EDE9');
...
options.width = 800;
options.height = 650;
var url = Mscrm.CrmUri.create('/WebWizard/WizardContainer.aspx?WizardId=F2F5B4A7-000B-4483-88AD-267DA3322DC9');
Xrm.Internal.openDialog(url.toString(), options, null, null, locationReload);
}
...
wizardContainer.append($('<iframe id="wzframe" src="' + htmlEncode(wizardSource.val()) + '"height="538" width="822"></iframe>'));
}
