<%@ Page Language="c#" Inherits="Microsoft.Crm.Web.Tools.Admin.AddOn.RemoveStorageCompletePage" EnableViewState="true" %>
...
function removeStorageLicenseCompletePage_onload()
{
Initialize();
}


Sys.Application.add_load(removeStorageLicenseCompletePage_onload);

function Initialize()
{

XUI.Html.SetText($get('TransactionInfoDescription'), PAGE_DESCRIPTION);
XUI.Html.SetText($get('StorageLicensesRemoved'), LICENSE_CHANGE);
XUI.Html.SetText($get('NewStorageLicenseCount'), UPDATED_STORAGE_LICENSE_COUNT_USAGE_INFO);
...
FormatToCurrencyAsync('ChangeInMonthlyCharge', 0);
...
$get('BillingSummaryTable').setAttribute('summary', <%=Microsoft.Crm.CrmEncodeDecode.CrmJavaScriptEncode(CurrentResourceManager.GetString("AddOnWizard.LicenseCompletePage.UpdatedBillingSummaryHeader"))%>);
...
<b>
<loc:Text ResourceId="AddOnWizard.LicenseCompletePage.TransactionInfoHeader" runat="server" /></b>
...
<loc:Text ResourceId="AddOnWizard.StorageLicenseCompletePage.StorageLicensesRemovedDescription" runat="server" />
</div>
<div class="ms-crm-LeftSideBox">
<label id="StorageLicensesRemoved">
</label>
...
<div class="ms-crm-LeftSideBox">
<loc:Text ResourceId="AddOnWizard.StorageLicenseCompletePage.NewStorageLicenseCountDescription" runat="server" />
</div>
<div class="ms-crm-LeftSideBox">
<label id="NewStorageLicenseCount">
</label>
</div>
<br />
