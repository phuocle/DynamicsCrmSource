...
var success = Mscrm.FormUtils.saveForm(0, 0, dashName.get_dataValue(), dashDesc.get_dataValue());
if(success)
{
...
originalOpener.Mscrm.DashboardRibbonActions.refreshDashboardSelector(Mscrm.FormEditorVariables.formId, true, true);
...
{
return dashName.get_isDirty() || dashDesc.get_isDirty();
}
