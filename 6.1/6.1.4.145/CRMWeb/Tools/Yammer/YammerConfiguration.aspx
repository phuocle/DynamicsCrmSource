...
<%= Microsoft.Crm.CrmEncodeDecode.CrmHtmlEncode(Config.YammerNetworkName) %></span>
</p>
</div>
</div>
</li>
...
<select class="groupSelect" id="yammerGroupSelect">
<option value="0">
<loc:text resourceid="Web.Tools.Yammer.Config.SelectFromDropDown" runat="server" />
</option>
<% if (this.Groups != null) {
foreach (var group in this.Groups) { %>
<option value="<%= Microsoft.Crm.CrmEncodeDecode.CrmHtmlAttributeEncode(group.Id.ToString())%>" <%= this.SelectedGroup == group.Id ? "selected" : "" %>>
<%= Microsoft.Crm.CrmEncodeDecode.CrmHtmlEncode(group.Name) %></option>
<% }
} %>
</select>
</p>
