...
<tr>
<td width="100%"><label style="font-weight:bold"><loc:Text ResourceId="Web.Tools.DocumentManagement.SettingsPage.EntityTable.Title" runat="server"/></label></td>
</tr>
<tr>
<td width="100%"><label><loc:Text ResourceId="Web.Tools.DocumentManagement.SettingsPage.EntityTable.Description" runat="server"/></label></td>
</tr>
<tr><td>
<br />
...
<tr>
<td width="100%"><br /><label style="font-weight:bold" for="txtSiteCollectionUrl"><loc:Text ResourceId="Web.Tools.DocumentManagement.SettingsPage.SiteCollectionUrl.Title" runat="server"/></label></td>
</tr>
<tr>
<td width="100%" id="siteUrlDescription" runat="server"><label for="txtSiteCollectionUrl"><loc:Text ResourceId="Web.Tools.DocumentManagement.SettingsPage.SiteCollectionUrl.Description" runat="server"/></label></td>
</tr>
<tr><td>
<br />
<table width="100%" id=siteUrlTextTable><tr>
