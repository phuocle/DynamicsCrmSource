...
<html xmlns:Crm>
<head>
<title><loc:Text ResourceId="Title_OfflineFilter" runat="server"/></title>
...
advFind.set_onGetViewInfo(GetDataGroupInfo);
...
oArgs.sCustomFields = "<result value='primarykey' datatype='custom'>" + CrmEncodeDecode.CrmHtmlEncode(LOCID_OFFLINEFILTER_CHILD) + "</result>";
}
}
...
function GetDataGroupInfo(oArgs)
{

var crmDialog = new Mscrm.CrmDialog(Mscrm.CrmUri.create("/AdvancedFind/QueryProperties.aspx?feature=datagroup"), oArgs, 500, 310, null);
