...
<script language="JavaScript">
	...
	var _bShowRelatedEntities = _oArgs.ShowRelatedEntities;
	var _oFetchXml;
	var _oGridXml;
	...
	var oEntityList;
	var _Fields = null;
	var _entitiesForDisplayingHiddenFields = ['sharepointdocument'];
	...
	function off(e)
	{
		if (_oLastGlow)	_oLastGlow.style.backgroundColor = "";
	}
...
<frm:DialogForm id="crmForm" runat="server">
		...
		<div height="22px" style = "position: relative; top: 20px;">
				<table id="tblGridBar" cellpadding="0" cellspacing="0" class="ms-crm-ViewForm-Header">
					<tr onclick="onGridColumnClick(new Sys.UI.DomEvent(event));" onmouseover="onGridColumnMouseOver(new Sys.UI.DomEvent(event));" onmouseout="onGridColumnMouseOut(new Sys.UI.DomEvent(event));">
