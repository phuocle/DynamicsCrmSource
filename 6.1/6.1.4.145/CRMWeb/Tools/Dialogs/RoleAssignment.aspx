...
<td><input name="visibleToEveryone" id="visibleToEveryone" type="radio" onclick="Mscrm.RoleAssignment.onClickVisibleToEveryone();" class="radio"></td>
<td colspan="2"><label for="visibleToEveryone"><loc:Text ResourceId="Dlg_ProcessForm_Role_Assignment_DisplayToEveryOne" runat="server"/></label></td>
</tr>
<tr style="height:25px">
<td><input name="visibleToSelectedRoles" id="visibleToSelectedRoles" type="radio" onclick="Mscrm.RoleAssignment.onClickVisibleToSelectedRoles();" class="radio"></td>
<td><label for="visibleToSelectedRoles"><loc:Text ResourceId="Dlg_ProcessForm_Role_Assignment_DisplayToSelectedRoles" runat="server"/></label></td>
<td>
