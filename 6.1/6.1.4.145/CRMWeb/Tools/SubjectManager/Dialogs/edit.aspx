...
{
titleCtrl.setFocus();
$find("crmForm").displayMissingValue(XUI.Html.GetText(XUI.Html.DomUtils.GetPrevSibling(titleCtrl.get_element().parentNode.parentNode)));
}
}
return false;
}
...
<tr>
<td class="ms-crm-Field-Required" id="Td1"><label for="title"><loc:Text ResourceId="Web.Tools.SubjectEditor.Dialogs.Edit.aspx_77" runat="server"/><img src="/_imgs/frm_required.gif" alt="<loc:Text Encoding='HtmlAttribute' ResourceId='Forms.Required.AltTag' runat='server'/>"/></label></td>
<td><sdk:TextBoxControl id="title" required maxlength="60" TabIndex="1" runat="server"/></td>
</tr>
<tr>
<td><label for="parentsubject"><loc:Text ResourceId="Web.Tools.SubjectEditor.Dialogs.Edit.aspx_81" runat="server"/></label></td>
<td id="Td2"><sdk:LookupControl id="parentsubject" AccessibilityLabelResourceId="Web.Tools.SubjectEditor.Dialogs.Edit.aspx_81" Required="false" TabIndex="2" runat="server"/></td>
</tr>
<tr style="height:100%">
...
<td style="height:76px"><sdk:TextAreaControl id="description" runat="server" TabIndex="3" height="100%" maxlength="2000"/></td>
</tr>
</table>
</frm:HardcodedForm>
