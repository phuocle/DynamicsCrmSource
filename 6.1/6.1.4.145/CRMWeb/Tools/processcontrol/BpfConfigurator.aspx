...
<h2 class="bpfh2"><div id="WorkflowCategory" class="wfCat" runat="server"></div></h2>
...
<label for="expandImg" class="ms-crm-InlineEditLabel bpfexpandCollapse"><loc:Text ResourceId="ProcessControl.Configurator.Expand" class="msc-crm-InlineEditLabel" runat="server"/></label>
...
<label for="collapseImg" class="ms-crm-InlineEditLabel bpfexpandCollapse"><loc:Text ResourceId="ProcessControl.Configurator.Collapse" class="msc-crm-InlineEditLabel" runat="server"/></label>
...
<label id = "includedEntities" class="ms-crm-InlineEditLabel confDescriptionLabel"><loc:Text ResourceId="ProcessControl.Configurator.IncludedEntities" class="msc-crm-InlineEditLabel" runat="server"/></label>
<div id="process_configurator_container" class="ui-dialog-content">
<div id="ConfiguratorArea" runat="server">
</div>
<div class='ui-dialog-buttonpane ui-widget-content ui-helper-clearfix ui-dialog-Process-Configurator-Button-Pane' style=''>
