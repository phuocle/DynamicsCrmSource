...
XUI.Html.SetText(document.getElementById("statusTD"), (result.Success) ? SAMPLE_DATA_INSTALLING : SAMPLE_DATA_FAILED);
}
...
XUI.Html.SetText(document.getElementById("statusTD"), (result.Success) ? SAMPLE_DATA_UNINSTALLING : SAMPLE_DATA_FAILED);
}
...
{
XUI.Html.SetText(document.getElementById("statusTD"), (result.Success) ? BUSINESS_PROCESS_INSTALLED : BUSINESS_PROCESS_NOT_INSTALLED);
}
</script>
