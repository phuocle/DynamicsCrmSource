...
document.getElementById("uploadFileFrame").contentWindow.document.getElementById("uploadFileNameId").onchange = uploadFileNameChanged;
}
...
var frameContentDoc = document.getElementById("uploadFileFrame").contentWindow.document;
frameContentDoc.getElementById("uploadFileNameId").disabled = false;
WizardSetProperty("ImportFileName", null);
WizardSetProperty("RemoveUploadedFile",true);

if(updateViaImportFile != true)
{
frameContentDoc.getElementById("enclosedDiv").style.display = "none";
...
function moveNext()
{
var shortName=document.getElementById("uploadFileFrame").contentWindow.document.getElementById("uploadFileNameId").value;
...
frameContentDoc.getElementById("uploadFileNameId").disabled = true;
...
frameContentDoc.getElementById("uploadFileNameId").onkeyup = uploadFileNameChanged;
frameContentDoc.getElementById("uploadFileNameId").onchange = uploadFileNameChanged;
...
var frameContentDoc = document.getElementById("uploadFileFrame").contentWindow.document;
if(frameContentDoc.getElementById("uploadFileNameId").value=="")
{
