...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	...
	<xsl:template match="section/rows/row/cell">
		...
		<xsl:variable name="isSubGrid" select="control[starts-with(@classid,'{E7A81278-8635-4d9e-8D4D-59480B391C5B}')]"/>
			...
			<div>
				...
				<table cellspacing="0" cellpadding="0" class="cell">
					...
					<xsl:choose>
						...
						<!--Headers for Iframes, WebResources, and Social Insights. -->
						<xsl:when test="$isIframe or $isWebResource or $isSocialInsight">
							<xsl:variable name="headerFormat">
								<xsl:choose>
									<xsl:when test="$isIframe">
					...
					<tr>
						...
						<td nowrap="" class="dashboardfield">
							...
							<xsl:if test="$isSocialInsight">
								<xsl:variable name="previewFrameId">socialInsightsPreviewFrame_<xsl:value-of select="$fieldName" /></xsl:variable>
								<xsl:variable name="previewOverlayId">socialInsightsPreviewOverlay_<xsl:value-of select="$fieldName" /></xsl:variable>
								<xsl:variable name="errorMessageContainerId">socialInsightsPreviewErrorMessage_<xsl:value-of select="$fieldName" /></xsl:variable>
								<xsl:element name="iframe">
								...
								<xsl:element name="div">
									<xsl:attribute name="id"><xsl:value-of select="$previewOverlayId" /></xsl:attribute>
								...
								<xsl:element name="div">
									<xsl:attribute name="id"><xsl:value-of select="$errorMessageContainerId" /></xsl:attribute>
							...
							<xsl:if test="$isPreviewCell">
								...
								<a id="gridLink" class="PlaceholderAnchor" onmouseover="Mscrm.PreviewCellUtils.onHover(this)" onmousedown="Mscrm.PreviewCellUtils.cancelEvent(Mscrm.Utilities.eventToDomEvent(event))" onmouseout="Mscrm.PreviewCellUtils.offHover(this)" onmousemove="Mscrm.PreviewCellUtils.cancelEvent(Mscrm.Utilities.eventToDomEvent(event))" tabIndex="10" onclick="Mscrm.PreviewCellUtils.addSubgridFromPlaceHolder(Mscrm.Utilities.eventToDomEvent(event), false, true);" href="javascript:;" type="placeholder">
									<xsl:element name="img">
										<xsl:attribute name="src">
								...
								<br/>
								<a id="IframeLink" class="PlaceholderAnchor" onmouseover="Mscrm.PreviewCellUtils.onHover(this)" onmousedown="Mscrm.PreviewCellUtils.cancelEvent(Mscrm.Utilities.eventToDomEvent(event))" onmouseout="Mscrm.PreviewCellUtils.offHover(this)" onmousemove="Mscrm.PreviewCellUtils.cancelEvent(Mscrm.Utilities.eventToDomEvent(event))" tabIndex="10" onclick="Mscrm.PreviewCellUtils.addIframeFromPlaceHolder(Mscrm.Utilities.eventToDomEvent(event), false, true);" href="javascript:;" type="placeholder">
									<xsl:element name="img">
										<xsl:attribute name="src">
								...
								<a id="WebResourceLink" class="PlaceholderAnchor" onmouseover="Mscrm.PreviewCellUtils.onHover(this)" onmousedown="Mscrm.PreviewCellUtils.cancelEvent(Mscrm.Utilities.eventToDomEvent(event))" onmouseout="Mscrm.PreviewCellUtils.offHover(this)" onmousemove="Mscrm.PreviewCellUtils.cancelEvent()" tabIndex="10" onclick="Mscrm.PreviewCellUtils.addIframeFromPlaceHolder(Mscrm.Utilities.eventToDomEvent(event), true, true);" href="javascript:;" type="placeholder">
									<xsl:element name="img">
										<xsl:attribute name="src">
