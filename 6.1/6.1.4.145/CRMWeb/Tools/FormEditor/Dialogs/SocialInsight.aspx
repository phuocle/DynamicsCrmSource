...
_url.value = oIframe.SolutionUrl;
...
var oNodes = XUI.Xml.SelectNodes(_oFormXml, "/entity/form/tabs/tab/columns/column/sections/section/rows/row/cell/control[@classid = '" + _ControlClassIds.socialInsight + "']", null);
...
<td ><input id="Label" name="Label" type="text" value="<%= Microsoft.Crm.CrmEncodeDecode.CrmHtmlEncode(defaultLabel) %>" class="ms-crm-Text" maxlength="100"/></td>
</tr>
<tr>
