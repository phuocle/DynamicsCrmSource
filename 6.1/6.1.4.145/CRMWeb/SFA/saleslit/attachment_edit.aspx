...
<col><col width="85%">
<tr>
<td id="title_c" class="ms-crm-Field-Required"><label for="title"><loc:Text ResourceId="Web.SFA.saleslit.attachment_edit.aspx_70" runat="server"/><img src="/_imgs/frm_required.gif" alt="<loc:Text Encoding='HtmlAttribute' ResourceId='Forms.Required.AltTag' runat='server'/>"/></label></td>
<td><sdk:TextBoxControl Required="true" id="title" MaxLength="200" runat="server"/></td>
</tr>
<tr>
<td><label for="authorname"><loc:Text ResourceId="Web.SFA.saleslit.attachment_edit.aspx_74" runat="server"/></label></td>
<td><sdk:TextBoxControl id="authorname" MaxLength="255" runat="server"/></td>
</tr>
<tr>
<td><label for="keywords"><loc:Text ResourceId="Web.SFA.saleslit.attachment_edit.aspx_78" runat="server"/></label></td>
<td><sdk:TextBoxControl id="keywords" MaxLength="255" runat="server"/></td>
</tr>
<tr>
<td class="ms-crm-Form-Section ms-crm-Form-SectionBar" colspan="2" style="padding-top:10px;"><label for="abstract"><loc:Text ResourceId="Web.SFA.saleslit.attachment_edit.aspx_82" runat="server"/></label></td>
</tr>
<tr height="100%">
