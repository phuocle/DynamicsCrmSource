...
<tr>
<td width="100" class="ms-crm-Field-Normal" id="lbSelectParentAccount"><label for="parentAccountLookup">
...
<tr>
<td width="100" class="ms-crm-Field-Normal" id="lbSelectParentContact"><label for="parentContactLookup">
...
<br/>
<br/>
<label><loc:Text ResourceId="Flyout.DupWarn.ActionText" runat="server"/></label>
