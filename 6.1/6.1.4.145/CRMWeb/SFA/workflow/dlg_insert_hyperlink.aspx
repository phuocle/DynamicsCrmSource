...
<head>
    ...
    <script language="javascript" type = "text/javascript">
		...
		function PageLoad() {
			...
			//Used for initializing various conditions For Condition Form Assistant in this dialog.
			_isConditionMode = true;
			//Associate the dataType string with both the controls on dialog
			GenerateHyperLinkTypeMapping();
			//Attaches OnAttributeFocus on text Box elements for data Slugging
			AttachHyperlinkPageAttributes();
			var textControl = window.document.getElementById("DisplayText");
			//Bring focus on Display Text Box on Page Load
		...
		//Generates the combined XML for name and value 
		...
		//Creates an xml for URL text  box values to be passed to Prompt Page
		...
		//Creates an xml for DisplayText box values to be passed to Prompt Page
