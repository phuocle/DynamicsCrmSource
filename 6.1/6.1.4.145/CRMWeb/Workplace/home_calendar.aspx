...
<a href="#" onclick="new Sys.UI.DomEvent(event).preventDefault();"><img class="ms-crm-AlignToSpan" alt="<loc:Text Encoding='HtmlAttribute' ResourceId='Web.Workplace.home_calendar.aspx_MonthAction' runat='server'/>" title="<loc:Text Encoding='HtmlAttribute' ResourceId='Web.Workplace.home_calendar.aspx_MonthAction' runat='server'/>" id="calrMonth" /></a>
<span class="ms-crm-AlignTo16Image"><loc:Text ResourceId="Web.Workplace.home_calendar.aspx_193" runat="server"/></span>
</li>
...
<span class="ms-crm-AlignTo16Image"><loc:Text ResourceId="Web.Workplace.home_calendar.aspx_196" runat="server"/></span>
</li>
...
<span class="ms-crm-AlignTo16Image"><loc:Text ResourceId="Web.Workplace.home_calendar.aspx_199" runat="server"/></span>
</li>
</ul>
<%
if( Microsoft.Crm.Security.User.GetPrivilege(Microsoft.Crm.Privileges.CreateActivity, Microsoft.Crm.Application.Security.UserInformation.Current) )
