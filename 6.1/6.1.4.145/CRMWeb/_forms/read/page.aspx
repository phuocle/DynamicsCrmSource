...
<div id="containerLoadingProgress" style="text-align: center; position: absolute;
top: 0px; left: 0px; bottom: 0px; right: 0px; z-index: 100; background-color: White;">
<img id="loading" alt="<loc:Text ResourceId='PageLoadingMessage' runat='server'/>"
src="/_imgs/AdvFind/progress.gif" style="text-align: center; position: absolute;
