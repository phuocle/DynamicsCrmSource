...
if( typeof( oFrame.ConfirmWizardClose ) == "undefined" ||
oFrame.ConfirmWizardClose == null )
{
wizardClose();
return;
}
...
var buttonNext = oFrame.$get("buttonNext")
if (!IsNull(buttonNext) && buttonNext.disabled == false && buttonNext.Visable == true)
{
buttonNext.focus();
}
else if(!IsNull(wizardpageframe))
{
wizardpageframe.focus();
}
return;
}
