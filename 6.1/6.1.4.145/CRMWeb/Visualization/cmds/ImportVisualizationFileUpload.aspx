...
window.parent.Mscrm.ImportVisualizationDialog.visualizationImportFailureCallBack(<%=Microsoft.Crm.CrmEncodeDecode.CrmJavaScriptEncode(validationErrors)%>);

<%} else if(!String.IsNullOrEmpty(visualizationXml)) {%>
window.parent.Mscrm.ImportVisualizationDialog.proceedWithImport(CrmEncodeDecode.CrmXmlEncode(<%=Microsoft.Crm.CrmEncodeDecode.CrmJavaScriptEncode(visualizationXml) %>),
...
Mscrm.Utilities.parseBoolean(<%=Microsoft.Crm.CrmEncodeDecode.CrmJavaScriptEncode(duplicateFound.ToString(CultureInfo.InvariantCulture))%>),
...
Mscrm.Utilities.parseBoolean(<%=Microsoft.Crm.CrmEncodeDecode.CrmJavaScriptEncode(isUserUpdateAllowed.ToString(CultureInfo.InvariantCulture))%>),
Mscrm.Utilities.parseBoolean(<%=Microsoft.Crm.CrmEncodeDecode.CrmJavaScriptEncode(isUserCreateAllowed.ToString(CultureInfo.InvariantCulture))%>),
<%=duplicateCount%>);
...
}catch(e){window.parent.Mscrm.ImportVisualizationDialog.showImportWaitingSpan(false)};
}
...
<label for="fileUpload"><loc:Text ID="Text1" ResourceId="UploadMapFile_Label" runat="server"/></label>
</td>
</tr>
<tr>
<td style="padding-left:15px;padding-right:15px;vertical-align: top">
