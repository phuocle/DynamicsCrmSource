...
<loc:Text ResourceId="RecurrenceRule.AppointmentTimeSection.Title" runat="server" /></legend>
...
<loc:Text ResourceId="RecurrenceRule.AppointmentTimeSection.EndLabel" runat="server" /></label>
</td>
<td class="ms-crm-recurrence-dialog-datecontrol">
...
<loc:Text ResourceId="RecurrenceRule.AppointmentTimeSection.DurationLabel" runat="server" /></label>
</td>
<td class="ms-crm-recurrence-dialog-datecontrol">
...
<loc:Text ResourceId="RecurrenceRule.RecurrencePatternSection.Title" runat="server" /></div></legend>
<table cellspacing="0" cellpadding="0" width="100%" border="0" class="stdtable">
<colgroup>
<col width ="20px" />
<col />
...
<loc:Text ResourceId="RecurrenceRule.RangeOfRecurrence.Title" runat="server" /></legend>
<table cellspacing="0" cellpadding="0" width="100%" border="0" class="stdtable">
<colgroup>
<col width ="20px" />
<col width ="140px" />
...
<loc:Text ResourceId="RecurrenceRule.RangeOfRecurrence.StartRange.Label1" runat="server" /></label>
</td>
<td class="ms-crm-recurrence-dialog-datecontrol">
...
<loc:Text ResourceId="RecurrenceRule.RangeOfRecurrence.EndRange.Label1" runat="server" /></label>
</td>
<td colspan="2" >
<div>
