...
function reportWizardHasXmlProperty(propertyName)
{
return Mscrm.Utilities.isEdge() ? !IsNull(getResultNode(WizardGetProperty(propertyName))) : WizardHasProperty(propertyName);
}
