...
<head>
	...
	<script language="javascript" type="text/javascript">
		...
		{
			// Append WRPC token so that we can make platform call
			
			var oUrl = Mscrm.CrmUri.create("/CRMReports/AdHocWizard/SuccessFailurePage.aspx?" + <%= Microsoft.Crm.CrmEncodeDecode.CrmJavaScriptEncode(CurrentWrpcContext.GetWrpcTokenAsQueryString(Microsoft.Crm.Application.Utility.CrmUri.Create("/CRMReports/AdHocWizard/SuccessFailurePage.aspx", Microsoft.Crm.Application.Security.UserInformation.Current))) %>);
