							...
							<table width="100%" height="auto" cellspacing="3" cellpadding="0" style="table-layout: fixed;">
								...
								<tr valign="top">
									<frm:FormCell id="picklistCategoryCell" ShowLabel="true" LabelResourceId="Web.Reports.Category" runat="server">
										<span id="picklistCategory"><ui:MultiPicklist runat="server" id="picklistCategorySpan" TabIndex="8"></ui:MultiPicklist></span>
									</frm:FormCell>
								</tr>
								<tr valign="top">
									<frm:FormCell id="picklistRelatedEntityCell" ShowLabel="true" LabelResourceId="Web.Reports.RelatedEntity" runat="server">
										<span id="picklistRelatedEntity"><ui:MultiPicklist runat="server" id="picklistRelatedEntitySpan" TabIndex="9"></ui:MultiPicklist></span>
									</frm:FormCell>
								</tr>
								<tr valign="top">
									<frm:FormCell id="picklistVisibilityCell" ShowLabel="true" LabelResourceId="Web.Reports.Showin" runat="server">
										<span id="picklistVisibility"><ui:MultiPicklist runat="server" id="picklistVisibilitySpan" TabIndex="10"></ui:MultiPicklist></span>
									</frm:FormCell>
								</tr>
