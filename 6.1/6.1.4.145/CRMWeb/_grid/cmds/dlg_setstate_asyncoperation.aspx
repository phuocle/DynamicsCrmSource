...
{
_custParams = "&sNewState=" + newState + "&postponeUntil=" + CrmEncodeDecode.CrmUrlEncode(FormatUtcDate(Mscrm.FormControlInputBehavior.GetBehavior('postponeDate').get_dataValue()));
}
else
{
