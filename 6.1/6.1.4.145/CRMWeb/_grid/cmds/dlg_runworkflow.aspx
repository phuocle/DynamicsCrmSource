...
{
_custParams = "&wfId=" + CrmEncodeDecode.CrmUrlEncode("<%=Request.QueryString["wfId"]%>") + "&sIds=" + CrmEncodeDecode.CrmUrlEncode("<%=Request.QueryString["sIds"]%>");
}
...
<b><loc:Text ResourceId="Dialog_RunWorkflow_Body_Confirm" runat="server"/></b>
</td>
</tr>
