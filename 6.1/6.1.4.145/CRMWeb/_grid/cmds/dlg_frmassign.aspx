...
<html>
<head>
<title><loc:Text ResourceId="Web._grid.cmds.dlg_assign.aspx_37" runat="server"/></title>
...
<td valign="top">
<label class="ms-crm-Bold-Header" for="rdoMe"><loc:Text ResourceId="Web._grid.cmds.dlg_assign.aspx_104" runat="server"/></label>
<br>
...
<% if (!Util.UseTouchSkin()) { %> <tr><td colspan="2">&nbsp;</td></tr> <% } %>
<tr>
<td valign="top">
...
<td valign="top">
<label class="ms-crm-Bold-Header" for="rdoOther"><loc:Text id="assignLabel" runat="server"/></label>
<br>
