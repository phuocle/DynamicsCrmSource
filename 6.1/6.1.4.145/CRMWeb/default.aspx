...
<title><loc:Text ResourceId="Web.default.aspx_99" runat="server"/></title>
</head>
<noscript>
...
{
Response.Write(@"window.location.replace(" + Microsoft.Crm.CrmEncodeDecode.CrmJavaScriptEncode(Microsoft.Crm.Application.Utility.CrmUri.Create("/main.aspx", Microsoft.Crm.Application.Security.UserInformation.Current).ToString() + this.Request.Url.Query) + @");");
}
%>
}
else
