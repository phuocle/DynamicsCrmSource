...
.notesWall .watermark
{
	font-size: 12px !important ; /* _locID_css@font-size="notesWall_watermark_FontSize" _locComment="Font Size" */
	line-height: 19px;
	color: #666666;
	font-style: italic; /* _locID_css@font-style="notesWall_watermark_FontStyle" _locComment="Font Style {ValidStrings=normal,bold,italic}" */
}
...
.notesWall .text
{
	padding: 10px 10px 0 0;
	color: #444444;
	font-size: 12px; /* _locID_css@font-size="notesWall_text_FontSize" _locComment="Font Size" */
	font-family: Segoe UI, Tahoma, Arial; /* _locID_css@font-family="notesWall_text_FontFamily" _locComment="Font Family" */
}
...
.notesWall .post .attachAction:hover,
.notesWall .post .attachAction:hover .imageAction
{
...
.notesWall .post .attachAction:hover .deleteActionGradientMask
{
	background: rgba(215, 235, 249, 0.15);
	<%-- The IE <= 8 and IE9 behave very different in the rendering of the gradient mask in RTL mode. 
	The IE9 seems to automatically handle the color direction change. However, IE8 doesn't handle it --%>
	<%if( CrmStyles.IsRightToLeft && Request.Browser.MajorVersion <= 8 ){ %>
	filter: progid:DXImageTransform.Microsoft.gradient(startColorstr='#ffd7ebf9', endColorstr='#26d7ebf9', GradientType=1);
	<% } else { %>
	filter: progid:DXImageTransform.Microsoft.gradient(startColorstr='#26d7ebf9', endColorstr='#ffd7ebf9', GradientType=1);
	<%} %>

<% if (CrmStyles.IsRightToLeft) { %>
	background: -moz-linear-gradient(left, rgba(215, 235, 249, 0.15), #d7ebf9);
	background: -webkit-gradient(linear, left, right, color-stop(rgba(215, 235, 249, 0.15)), color-stop(#d7ebf9));
	background: -webkit-linear-gradient(left, rgba(215, 235, 249, 0.15), #d7ebf9);
	background: -o-linear-gradient(left, rgba(215, 235, 249, 0.15), #d7ebf9);
	background: -ms-linear-gradient(left, rgba(215, 235, 249, 0.15), #d7ebf9);
	background: linear-gradient(left, rgba(215, 235, 249, 0.15), #d7ebf9);
<% } else { %>
	background: -moz-linear-gradient(right, rgba(215, 235, 249, 0.15), #d7ebf9);
	background: -webkit-gradient(linear, right, left, color-stop(rgba(215, 235, 249, 0.15)), color-stop(#d7ebf9));
	background: -webkit-linear-gradient(right, rgba(215, 235, 249, 0.15), #d7ebf9);
	background: -o-linear-gradient(right, rgba(215, 235, 249, 0.15), #d7ebf9);
	background: -ms-linear-gradient(right, rgba(215, 235, 249, 0.15), #d7ebf9);
	background: linear-gradient(right, rgba(215, 235, 249, 0.15), #d7ebf9);
<% } %>
}
...
.notesWall .post .attachAction:hover .ms-crm-Inline-GradientMask
{
	background: rgba(215, 235, 249, 0.25); /* for non-css3 browsers */

	<%-- The IE <= 8 and IE9 behave very different in the rendering of the gradient mask in RTL mode. 
	The IE9 seems to automatically handle the color direction change. However, IE8 doesn't handle it --%>
	<%if( CrmStyles.IsRightToLeft && Request.Browser.MajorVersion <= 8 ){ %>
	filter: progid:DXImageTransform.Microsoft.gradient(startColorstr='#ffd7ebf9', endColorstr='#3fd7ebf9', GradientType=1);
	<% } else { %>
	filter: progid:DXImageTransform.Microsoft.gradient(startColorstr='#3fd7ebf9', endColorstr='#ffd7ebf9', GradientType=1);
	<%} %>

<% if (CrmStyles.IsRightToLeft) { %>
	background: -moz-linear-gradient(left,rgb(215, 235, 249) 25%,rgb(215, 235, 249) 100%);
	background: -webkit-gradient(linear,left,right,color-stop(25%, rgb(215, 235, 249)),color-stop(100%, rgb(215, 235, 249)));
	background: -webkit-linear-gradient(left,rgb(215, 235, 249) 25%,rgb(215, 235, 249) 100%);
	background: -o-linear-gradient(left,rgb(215, 235, 249) 25%,rgb(215, 235, 249) 100%);
	background: -ms-linear-gradient(left,rgb(215, 235, 249) 25%,rgb(215, 235, 249) 100%);
	background: linear-gradient(left,rgb(215, 235, 249) 25%,rgb(215, 235, 249) 100%);
<% } else { %>
	background: -moz-linear-gradient(right,rgb(215, 235, 249) 25%,rgb(215, 235, 249) 100%);
	background: -webkit-gradient(linear,right,left,color-stop(25%, rgb(215, 235, 249)),color-stop(100%, rgb(215, 235, 249)));
	background: -webkit-linear-gradient(right,rgb(215, 235, 249) 25%,rgb(215, 235, 249) 100%);
	background: -o-linear-gradient(right,rgb(215, 235, 249) 25%,rgb(215, 235, 249) 100%);
	background: -ms-linear-gradient(right,rgb(215, 235, 249) 25%,rgb(215, 235, 249) 100%);
	background: linear-gradient(right,rgb(215, 235, 249) 25%,rgb(215, 235, 249) 100%);
<% } %>
}
