    ...
    <script language="javascript" type="text/javascript">
        ...
        function GetPreviousPageDefinition() {
            if (wizardPageHandler.get_currentDataItemType() === 1) {
                return new NextPageDefinition(Mscrm.CrmUri
                    .create("/SocialInsight/ConfigurationWizard/SelectSearchTopicPage.aspx"));
            }
            return new NextPageDefinition(Mscrm.CrmUri
                .create("/SocialInsight/ConfigurationWizard/SelectSearchTopicCategoryPage.aspx"));
        }
        ...
        function GetNextPageDefinition() {
            ...
            if (Mscrm.SocialInsights.Configuration.Views.WizardPageHandler.get_signInAutoNavigate() === true) {
                return new NextPageDefinition(Mscrm.CrmUri
                    .create("/SocialInsight/ConfigurationWizard/MslSignInPage.aspx"));
            }
            return null;
        }
    </script>
