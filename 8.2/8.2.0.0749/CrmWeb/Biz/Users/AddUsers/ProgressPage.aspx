...
<head>
    ...
    <script language="javascript" type="text/javascript">
        ...
        function getSecurityRoles() {
            ...
            var saRawSecurityRoles = WizardHasProperty("SecurityRoles")
                ? WizardGetProperty("SecurityRoles")
                : new Array();
            ...
            for (var i = 0; i < oUserNodes.length; i++) {
                ...
                if (!IS_LIVE && provider != null && provider == "2") {
                    ...
                    if (firstNameNode != null && lastNameNode != null) {
                        ...
                        XUI.Xml.SetText(fullNameNode,
                            XUI.Xml.GetText(firstNameNode) + " " + XUI.Xml.GetText(lastNameNode));
