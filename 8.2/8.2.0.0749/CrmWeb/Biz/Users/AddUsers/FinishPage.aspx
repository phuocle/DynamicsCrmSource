    ...
    <script language="javascript" type="text/javascript">
        ...
        function writeMessages(saMessages, sSeverityLabel, iNotificationSeverity) {
            ...
            for (var i = 0; i < saMessages.length; i++) {
                ...
                $find("notifications").AddNotification(sNotificationId,
                    iNotificationSeverity,
                    "",
                    formatString(sSeverityLabel, CrmEncodeDecode.CrmHtmlDecode(saMessages[i])));
            }
        }
        ...
        function AdjustNotificationArea() {
            ...
            var notificationAreaHeight = (finishPage.offsetHeight -
            (usersAdded.offsetHeight +
                usersNotAdded.offsetHeight +
                buttonCopyToClipboard.offsetHeight +
                addUsersRestart.offsetHeight +
                10));
