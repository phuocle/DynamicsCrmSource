    ...
    <script language="javascript" type="text/javascript">
        ...
        function businessUnitPage_onload() {
            if (WizardHasProperty("BusinessUnit")) {
                Mscrm.FormControlInputBehavior.GetBehavior('businessUnit')
                    .set_dataValue(WizardGetProperty("BusinessUnit"));
            }
        }


        function GetNextPageDefinition() {
            var oUrl = "/Biz/Users/AddUsers/SecurityRolesPage.aspx?unit=" +
                CrmEncodeDecode.CrmUrlEncode(WizardGetProperty("BusinessUnit"));
        ...
        function savePage() {
            WizardSetProperty("BusinessUnit",
                Mscrm.FormControlInputBehavior.GetBehavior('businessUnit').get_dataValue());
        }
...
<frm:WizardForm id="crmForm" runat="server">
    <table class="ms-crm-AddUsers-SingleSelect">
        <col width="150"/><col/>
        <tr>
            <frm:FormCell runat="server" LabelResourceId="AddUsersWizard.BusinessUnitPage.BusinessUnit" ShowLabel="True" RequiredLevel="Required">
                <ui:Select id="businessUnit" runat="server"/>
            </frm:FormCell>
        </tr>
    </table>
</frm:WizardForm>
