...
<head>
    ...
    <script language="JavaScript" type="text/javascript">
        ...
        function ChangeHomePage() {
            ...
            Xrm.Internal.openDialog(CrmUri.create("/tools/personalsettings/dialogs/personalsettings.aspx").toString(),
                dialogOptions,
                null,
                null,
                callbackFunction);
        ...
        function showPrintPage() {
            openStdWin(Mscrm.CrmUri.create("/Biz/GettingStarted/PrintGettingStarted.aspx"),
                "PrintGettingStarted",
                900,
                600,
                "scrollbars=1");
...
<div class="ms-crm-GettingStarted-TaskTreeFrame">
    <table width="100%" border="0" class="ms-crm-GettingStarted-topSection">
        ...
        <tr>
            ...
            <td align="right">
                <div id="printSection" runat="server"></div>
            </td>
        </tr>
    </table>
</div>
