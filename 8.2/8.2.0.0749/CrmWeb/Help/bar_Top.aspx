...
<head>
    ...
    <script type="text/javascript">
        ...
        function showTOCLocal() {
            ...
            XUI.Html.SetText(XUI.Html.DomUtils.GetLastChild(XUI.Html.DomUtils
                    .GetFirstChild(XUI.Html.DomUtils.GetFirstChild(butTOC))),
                LOCID_HIDE_TOC);
        }
        ...
        function Initialize() {
            ...
            if (LOCID_UI_DIR == "RTL") {
                if (contentArea.cols == "*,0") {
                    XUI.Html.DomUtils.GetLastChild(contentArea).style.display = "none";
                    XUI.Html.SetText(XUI.Html.DomUtils
                        .GetLastChild(XUI.Html.DomUtils.GetFirstChild(XUI.Html.DomUtils.GetFirstChild(butTOC))),
                        LOCID_SHOW_TOC);
                } else {
                    XUI.Html.SetText(XUI.Html.DomUtils
                        .GetLastChild(XUI.Html.DomUtils.GetFirstChild(XUI.Html.DomUtils.GetFirstChild(butTOC))),
