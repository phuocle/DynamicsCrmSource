...
<head>
    ...
    <script type="text/javascript">
        ...
        function applychanges() {
            ...
            if (IsNull(returnObject.type) || parseInt(returnObject.type) == Number.NaN) {
                alert(LOCID_SELECT_EXISTING_RECORD);
                return;
            }
        ...
        function OpenCreate() {
            ...
            if (!IsNull(emailAttributeNode) && emailAttributeNode.value != "") {
                openObj(iObjectType,
                    null,
                    CrmEncodeDecode.CrmUrlEncode(emailAttributeNode.value) +
                    "=" +
                    CrmEncodeDecode.CrmUrlEncode(sEmailAddress));
            } else {
        ...
        function optionClick() {
            ...
            Mscrm.FormControlInputBehavior.GetElementBehavior($get('crmExistingLookup'))
                .set_disabled($get('rdoNew').checked);
            ...
            divResolveDisplay.className = (rdoExistingBut.checked
                ? "ms-crm-Lookup ms-crm-ReadOnly ms-crm-Lookup-ReadOnly"
                : "ms-crm-Lookup");
        }
    </script>
</head>
...
<frm:DialogForm id="crmForm" runat="server">
    ...
    <table cellspacing="0" cellpadding="2" width="100%" style="table-layout: fixed">
        ...
        <tr>
            <td>
                <label for="txtName">
                    <loc:Text ResourceId="Web.Activities.email.resolve.aspx_124" runat="server"/>
                </label>
            </td>
            <td>
                <input readonly runat="server" type="text" id="txtName">
            </td>
        </tr>
    </table>
    <table cellspacing="0" cellpadding="2" width="100%">
        <tr>
            <td colspan="2" style="border-bottom: 1px solid #A4ABB2;">&nbsp;</td>
        </tr>
        <tr>
            <td>&nbsp;</td>
        </tr>
        ...
        <tr>
            ...
            <td valign="top">
                <label class="ms-crm-Emphasis-Strong" for="rdoExisting">
                    <loc:Text ResourceId="Web.Activities.email.resolve.aspx_136" runat="server"/>
                </label>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td valign="top">
                <label class="ms-crm-Emphasis-Strong" for="rdoNew">
                    <loc:Text ResourceId="Web.Activities.email.resolve.aspx_154" runat="server"/>
                </label>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td valign="top" height="35px">
                <table id="tblResolvedTo" width="100%" cellspacing="0" cellpadding="0" disabled>
                    <tr>
                        <td width="80">
                            <loc:Text ResourceId="Web.Activities.email.resolve.aspx_190" runat="server"/>
                        </td>
                        <td>
                            <div class="ms-crm-Lookup ms-crm-ReadOnly ms-crm-Lookup-ReadOnly" id="divResolveDisplay"></div>
                        </td>
                    </tr>
                </table>
            </td>
