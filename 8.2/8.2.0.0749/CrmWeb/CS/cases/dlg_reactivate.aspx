<!DOCTYPE html >
<%@ Page language="c#" Inherits="Microsoft.Crm.Service.Dialogs.ReactivateCasePage" %>
...
<head>
    ...
    <title>
        <loc:Text ResourceId="Web.CS.cases.dlg_reactivate.aspx_20" runat="server"/>
    </title>
...
<frm:DialogForm id="crmForm" runat="server">
    <loc:Text id="statusMsg" ResourceId="Web.CS.cases.dlg_reactivate.aspx_50" runat="server"/>
            ...
            <tr>
                <td class="dlg_deactivate_td_status">
                    <label for="statusCode">
                        <loc:Text ResourceId="Web._grid.cmds.dlg_cancel.aspx_87" runat="server"/>
                    </label>
                </td>
                <td>
