...
<head>
    ...
    <script type="text/javascript">
        ...
        function LoadItem() {
            ...
            var iCreateFromId =
                <%= Microsoft.Crm.CrmEncodeDecode.CrmJavaScriptEncode(Request.QueryString["_CreateFromId"]) %>;
            var iCreateFromType =
                <%= Microsoft.Crm.CrmEncodeDecode.CrmJavaScriptEncode(Request.QueryString["_CreateFromType"]) %>;
...
<style>
    ...
    .ms-crm-Dialog-List { position: relative; }
    ...
    .ms-crm-InnerTable #TemplateTable { overflow: hidden; }
...
<div class="ms-crm-absolutePosition">
    <div class="ms-crm-Dialog-Header">
        <div class="ms-crm-Dialog-Header-Title">
            <b>
                <loc:Text ResourceId="Web.CS.articles.lookup_template.aspx_113" runat="server"/>
            </b>
        </div>
        <div class="ms-crm-Dialog-Header-Desc">
            <loc:Text ResourceId="Web.CS.articles.lookup_template.aspx_114" runat="server"/>
        </div>
    </div>
    <div class="ms-crm-LookupTemplateContentBlock">
        <div class="ms-crm-LookupTemplateLanguageBlock">
            <table cellpadding="0" cellspacing="0" width="50%">
                <col width="100"/><col/>
                <tr>
                    <td valign="top" id="languagecode_c">
        ...
        <div class="ms-crm-LookupTemplateDetails">
            <div class="ms-crm-LookupTemplateLeft">
                <div id="ItemList" class="ms-crm-Dialog-ScrollableList  ms-crm-absolutePosition ms-crm-InnerTable" style="width: auto; height: auto;">
                ...
                <table cellspacing="2" cellpadding="1" class="stdTable" style="padding: 10px;">
                    ...
                    <tr>
                        <td class="ms-crm-Bold-Header">
                            <loc:Text ResourceId="Web.CS.articles.lookup_template.aspx_149" runat="server"/>
                        </td>
                    </tr>
                    <tr>
                        <td id="TmplTitle">&nbsp;</td>
                    ...
                    <tr>
                        <td class="ms-crm-Bold-Header">
                            <loc:Text ResourceId="Web.CS.articles.lookup_template.aspx_151" runat="server"/>
                        </td>
                    </tr>
                    <tr>
                        <td id="TmplCreatedBy">&nbsp;</td>
                    </tr>
                    <tr style="height: 8px;">
                        <td>&nbsp;</td>
                    </tr>
                    <tr>
                        <td class="ms-crm-Bold-Header" valign="top">
                            <loc:Text ResourceId="Web.CS.articles.lookup_template.aspx_152" runat="server"/>
                        </td>
                    </tr>
                    <tr>
                        <td id="TmplDesc"></td>
