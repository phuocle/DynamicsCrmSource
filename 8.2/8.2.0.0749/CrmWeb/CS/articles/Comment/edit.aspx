...
<style>
    ...
    #DlgHdBodyContainer { bottom: 56px; }
</style>
    ...
    <frm:HardcodedForm id="crmForm" SupportsDefaultData="false" runat="server">
        ...
        <div style="height: 32px; position: relative">
            <div style="display: inline-block; width: 120px" class="ms-crm-Field-Required">
                <label for="title">
                    <loc:Text ResourceId="Web.CS.articles.Comment.edit.aspx_69" runat="server"/><img src="/_imgs/frm_required.gif" alt="<loc:Text Encoding='HtmlAttribute' ResourceId='Forms.Required.AltTag' runat='server'/>"/>
                </label>
            </div>
