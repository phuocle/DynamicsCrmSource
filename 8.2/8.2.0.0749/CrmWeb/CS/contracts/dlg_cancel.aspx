...
<frm:DialogForm id="crmForm" runat="server">
    <table cellspacing="0" cellpadding="0" width="100%" height="100%" style="table-layout: fixed;">
        <tr>
            <td class="dlg_cancel_td_Cancel">
                <label for="txtCancelDate">
                    <loc:Text ResourceId="Web.CS.contracts.dlg_cancel.aspx_54" runat="server"/>
                </label>
            </td>
            <td>
                <ui:DateTimeUI id="txtCancelDate" runat="server"/>
            </td>
        </tr>
    </table>
</frm:DialogForm>
