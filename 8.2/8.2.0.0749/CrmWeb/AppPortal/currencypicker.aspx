    ...
    <form id="CurrencyPickerForm" runat="server">
        <div id="AppPortalContentDiv" class="AppPortalContentDiv">
            ...
            <div class="CurrencyTitleContainer">
                <h2>
                    <loc:Text ResourceId="CurrencyPicker.Title" runat="server"/>
                </h2>
            </div>
            <div class="CurrencyTileHelpIcon">
                <a href="/appportal/currencyhelp.aspx" target="_blank">
            ...
            <div>
                <div id="BuiltInCurrencyDiv">
                    <div class="BaseCurrencyColumns">
                        <div class="FloatLeft">
                            <span>
                                <loc:Text ResourceId="CurrencyPicker.CountryLabel" runat="server"/>
                            </span>
                        </div>
                    ...
                    <div class="BaseCurrencyColumns">
                        <div class="FloatLeft">
                            <span>
                                <loc:Text ResourceId="CurrencyPicker.CurrencyLabel" runat="server"/>
                            </span>
                        </div>
                        <div class="FloatRight">
                    ...
                    <div class="BaseCurrencyColumns">
                        <div class="FloatRight CustomCurrencyLink">
                            <a id="SpecifyCustomCurrencyLink" href="#">
                                <loc:Text ResourceId="CurrencyPicker.SpecifyCurrency" runat="server"/>
                            </a>
                        </div>
                    </div>
                </div>
                ...
                <div id="CustomCurrencyDiv" class="CustomCurrencyHidden">
                    ...
                    <div class="BaseCurrencyColumns">
                        <div class="FloatLeft">
                            ...
                            <span>
                                <loc:Text ResourceId="CurrencyPicker.CustomCurrencyCode" runat="server"/>
                            </span>
                        </div>
                        <div class="FloatRight">
                    ...
                    <div class="BaseCurrencyColumns">
                        <div class="FloatLeft">
                            <span class="RedText">*</span>
                            <span>
                                <loc:Text ResourceId="CurrencyPicker.CustomCurrencySymbol" runat="server"/>
                            </span>
                        </div>
                        <div class="FloatRight">
                    ...
                    <div class="BaseCurrencyColumns">
                        <div class="FloatLeft">
                            <span class="RedText">*</span>
                            <span>
                                <loc:Text ResourceId="CurrencyPicker.CustomCurrencyName" runat="server"/>
                            </span>
                        </div>
                        <div class="FloatRight">
                    ...
                    <div class="BaseCurrencyColumns">
                        <div class="FloatLeft">
                            <span class="RedText">*</span>
                            <span>
                                <loc:Text ResourceId="CurrencyPicker.CustomCurrencyPrecision" runat="server"/>
                            </span>
                        </div>
                        <div class="FloatRight">
