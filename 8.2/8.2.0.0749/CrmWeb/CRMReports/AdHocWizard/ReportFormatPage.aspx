...
<head>
    ...
    <script language="javascript" type="text/javascript">
        ...
        function GetNextPageDefinition() {
            var oUrl = ($get("layoutTableOnly").checked)
                ? getSummaryPageUrl()
                : Mscrm.CrmUri.create("/CRMReports/AdHocWizard/ChartTypePage.aspx");
        ...
        function reportFormatPage_onload() {
            ...
            if (!valueAxesAvailable()) {
                ...
                var sNotificationText = (_iColumnAxisType == PROPERTY_PAGE_TYPE_GROUP)
                    ? LOCID_CHART_UNAVAILABLE_GROUPING
                    : LOCID_CHART_UNAVAILABLE_COLUMN;
                $find("notifications").AddNotification("chartUnavailable",
                    Mscrm.Severity.SEVERITYINFORMATION,
                    "",
                    sNotificationText);
    ...
    <ul>
        <li>
            <div class="ms-crm-Bold-Header">
                ...
                <label for="layoutTableOnly">
                    <loc:Text ResourceId="CustomReporting.AdHocWizard.ReportFormatPage.TableOnly" runat="server"/>
                </label>
            </div>
        ...
        <li>
            <div class="ms-crm-Bold-Header">
                ...
                <label for="layoutChartAndTable">
                    <loc:Text ResourceId="CustomReporting.AdHocWizard.ReportFormatPage.ChartAndTable" runat="server"/>
                </label>
            </div>
            <ul class="ms-crm-AdHocWizard-MinorReportFormat">
                <li>
                    <div>
                        ...
                        <label for="tableLayoutNormal">
                            <loc:Text ResourceId="CustomReporting.AdHocWizard.ReportFormatPage.TableNormal" runat="server"/>
                        </label>
                    </div>
                ...
                <li>
                    <div>
                        ...
                        <label for="tableLayoutDrillthrough">
                            <loc:Text ResourceId="CustomReporting.AdHocWizard.ReportFormatPage.TableDrillthrough" runat="server"/>
                        </label>
                    </div>
