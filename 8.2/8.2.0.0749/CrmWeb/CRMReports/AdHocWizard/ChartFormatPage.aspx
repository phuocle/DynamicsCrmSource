...
<head>
    ...
    <script language="javascript" type="text/javascript">
        ...
        function moveNext() {
            ...
            var sColumnAxisName = (bIsPieChart)
                ? _columnAxisFieldCtrl.get_selectedText()
                : _columnAxisLabelCtrl.get_dataValue();
            ...
            var sValueAxis1Name = (bIsPieChart)
                ? _valueAxis1FieldCtrl.get_selectedText()
                : _valueAxis1LabelCtrl.get_dataValue();
            _oChartLayoutXmlBuilder.AddValueAxis(_valueAxis1FieldCtrl.get_dataValue(),
                sValueAxis1Name,
                _valueAxis1FieldCtrl.get_selectedOption().getAttribute("SummaryValue"));
            ...
            if (!IsNull(_valueAxis2FieldCtrl.get_dataValue()) &&
                ...
                _oChartLayoutXmlBuilder.AddValueAxis(_valueAxis2FieldCtrl.get_dataValue(),
                    _valueAxis2LabelCtrl.get_dataValue(),
                    _valueAxis2FieldCtrl.get_selectedOption().getAttribute("SummaryValue"));
            }
        ...
        <tr>
            <td valign="top" class="ms-crm-AdHocWizard-ChartFormat">
                <table class="MaxWidth ChartFormat" cellpadding="3" cellspacing="0">
                    ...
                    <tr>
                        <frm:FormCell runat="server" ID="columnAxisFieldCell" ShowLabel="True" LabelResourceId="CustomReporting.AdHocWizard.ChartFormatPage.Field" RequiredLevel="Required">
                            <ui:Select id="columnAxisField" runat="server"/>
                        </frm:FormCell>
                    </tr>
                    <tr>
                        <frm:FormCell runat="server" ID="columnAxisLabelCell" ShowLabel="True" LabelResourceId="CustomReporting.AdHocWizard.ChartFormatPage.Label" RequiredLevel="Required">
                            <ui:TextBox id="columnAxisLabel" MaxLength="250" OnChange="updatePreviewAxes();updateNextButton();" runat="server"/>
                        </frm:FormCell>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <frm:FormCell runat="server" ID="valueAxis1FieldCell" ShowLabel="True" LabelResourceId="CustomReporting.AdHocWizard.ChartFormatPage.Value1Data" RequiredLevel="Required">
                            <ui:Select id="valueAxis1Field" runat="server"/>
                        </frm:FormCell>
                    </tr>
                    <tr>
                        <frm:FormCell runat="server" ID="valueAxis1LabelCell" ShowLabel="True" LabelResourceId="CustomReporting.AdHocWizard.ChartFormatPage.Value1Label" RequiredLevel="Required">
                            <ui:TextBox id="valueAxis1Label" MaxLength="250" OnChange="updatePreviewAxes();updateNextButton();" runat="server"/>
                        </frm:FormCell>
                    </tr>
                    <tr>
                        <frm:FormCell runat="server" ID="valueAxis2FieldCell" ShowLabel="True" LabelResourceId="CustomReporting.AdHocWizard.ChartFormatPage.Value2Data">
                            <ui:Select id="valueAxis2Field" runat="server"/>
                        </frm:FormCell>
                    </tr>
                    <tr>
                        <frm:FormCell runat="server" ID="valueAxis2LabelCell" ShowLabel="True" LabelResourceId="CustomReporting.AdHocWizard.ChartFormatPage.Value2Label">
                            <ui:TextBox id="valueAxis2Label" MaxLength="250" OnChange="updatePreviewAxes();updateNextButton();" runat="server"/>
                        </frm:FormCell>
                    </tr>
                    <tr>
            ...
            <td valign="top">
                <table class="MaxWidth" cellpadding="3" cellspacing="0">
                    ...
                    <tr>
                        <td class="ms-crm-Form-Section" colspan="2">
                            <loc:Text ResourceId="CustomReporting.AdHocWizard.ChartFormatPage.ChartPreview" runat="server"/>
                        </td>
                    </tr>
                    <tr>
                        <td class="YAxis" id="yAxisCell"/>
                        <td class="ms-crm-AdHocWizard-PreviewImage">
                            <img src="" alt="" id="previewImage" class="ms-crm-AdHocWizard-PreviewImage"/>
                        </td>
                    </tr>
                    <tr>
                        <td></td>
