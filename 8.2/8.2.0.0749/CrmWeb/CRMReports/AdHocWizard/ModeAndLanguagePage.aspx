...
<script language="javascript" type="text/javascript">
    ...
    function initializePage() {
        ...
        if (iWizardMode == EDIT_MODE_UPDATE || (iWizardMode == EDIT_MODE_CREATE && WizardHasProperty("ReportId"))) {
            ...
            if (WizardHasProperty("ExistingReportLookup")) {
                ...
                _reportId
                    .set_dataValue(new Array(new
                        LookupControlItem(existingReportLookup
                            .id,
                            existingReportLookup.type,
                            existingReportLookup.name)));
            }
        ...
        if (WizardHasProperty("Language")) {
            Mscrm.FormControlInputBehavior.GetBehavior('selectReportLanguage')
                .set_dataValue(WizardGetProperty("Language"));
        }
    ...
    function moveNext() {
        ...
        WizardSetProperty("WizardMode",
            ($get("wizardModeCreate").checked ||
                _overwriteExisting.get_disabled() ||
                !_overwriteExisting.get_dataValue())
            ? EDIT_MODE_CREATE
            : EDIT_MODE_UPDATE);
        ...
        WizardSetProperty("Language",
            Mscrm.FormControlInputBehavior.GetBehavior('selectReportLanguage').get_dataValue())
...
<frm:WizardForm id="crmForm" runat="server">
    ...
    <table cellpadding="5" cellspacing="0" width="100%" style="padding: 5px; table-layout: fixed;" id="languageTable">
        ...
        <tr>
            <frm:FormCell runat="server" id="reportLanguageCell" ShowLabel="True">
                <sdk:LanguagePicker runat="server" ID="selectReportLanguage"/>
            </frm:FormCell>
            <td/>
        </tr>
    </table>
