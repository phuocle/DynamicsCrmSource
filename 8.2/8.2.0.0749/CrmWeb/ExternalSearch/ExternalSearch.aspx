...
<script id="contentTemplate" type="text/x-jquery-tmpl">
    ...
    <span style="display: none;" id="highlightDisplayStyle">
...
<script id="headerTemplate" type="text/x-jquery-tmpl">
    <span style="display: none;" id="pageCount">
        ${_pageCount}
    </span>
    <span style="display: none;" id="pageNumber">
        ${_pageNumber}
    </span>
</script>
...
<script language="javascript">
    ...
    function PlaceChildElementsAsAnAttachments(iterationRecords) {
        ...
        if (iterationRecords[recordCounter]._haschild) {
            ...
            for (var i = 0; i < iterationRecords[recordCounter]._attachments.length; i++) {
                ...
                attachHtml += CreateAttachmentTemplate(iterationRecords[recordCounter],
                    totalAttachmentCountShow,
                    sourceObjectId,
                    styleToDisplay,
                    currentAttachmentId,
                    i,
    ...
    function ProcessAllExistingTraversedData(currRecord) {
        ...
        if (currRecord._shouldReplaceDummy == true || currRecord._isalreadytraversed == true) {
            ...
            attachHtmlToOldEntity +=
                "<div class='section listItem_section image_enabled_meqf listItemMargin listItemMarginDisplay RE'>";
            ...
            if (currRecord._entityImage != '') {
                attachHtmlToOldEntity += "<img style='width: 46px; height: 46px;' src='" +
                    currRecord._entityImage +
                    "' alt='Profile Picture' />";
            } else {
                attachHtmlToOldEntity += "<div class='meqfTile' style='background-color: " +
                    currRecord._entityTheme +
                    ";'>";
            ...
            attachHtmlToOldEntity += "<span id='entityDisplayName' class='entityDisplayName'>" +
                currRecord._entityDisplayName +
                " </span>";
            attachHtmlToOldEntity += "</div>";
            attachHtmlToOldEntity += "</div>";
            attachHtmlToOldEntity += "<div class='section_control_meqf noLabel'>";
            attachHtmlToOldEntity +=
                "<div class='control_value attributePrimary' style='max-height: 48px; height: 22px;'>";
            ...
            attachHtmlToOldEntity += "<div class='control_value'>";
            attachHtmlToOldEntity += "<span id='attribtwo' style='max-width: 732px; height: 21px;'>" +
                currRecord._attribute2 +
                "</span>";
            attachHtmlToOldEntity += "</div>";
            attachHtmlToOldEntity += "</div>";
            attachHtmlToOldEntity += "<div class='section_control_meqf noLabel attributeOther' style='width: 732px;'>";
            attachHtmlToOldEntity += "<div class='control_value'>";
            attachHtmlToOldEntity += "<span id='attribthree' style='max-width: 732px; height: 21px;'>" +
                currRecord._attribute3 +
                "</span>";
            attachHtmlToOldEntity += "</div>";
            attachHtmlToOldEntity += "</div>";
            attachHtmlToOldEntity += "<div class='section_control_meqf noLabel attributeOther' style='width: 732px;'>";
            attachHtmlToOldEntity += "<div class='control_value'>";
            attachHtmlToOldEntity += "<span id='attribfour' style='max-width: 732px; height: 21px;'>" +
                currRecord._attribute4 +
                "</span>";
            attachHtmlToOldEntity += "</div>";
            attachHtmlToOldEntity += "</div>";
            attachHtmlToOldEntity += "<div class='section_control_meqf noLabel attributeOther' style='width: 732px;'>";
            attachHtmlToOldEntity += "<div class='control_value'>";
            attachHtmlToOldEntity += "<span id='attribfive' style='max-width: 732px; height: 21px;'>" +
                currRecord._attribute5 +
                "</span>";
            attachHtmlToOldEntity += "</div>";
            attachHtmlToOldEntity += "</div>";
    ...
    function RestructureAllAttachmentOFEntityEmail(currRecord) {
        ...
        if (currRecord._haschild) {
            ...
            for (var i = 0; i < currRecord._attachments.length; i++) {
                ...
                reformAttachments +=
                    CreateAttachmentTemplate(currRecord,
                        totalAttachmentCountShow,
                        sourceObjectId,
                        styleToDisplay,
                        currentAttachmentId,
    ...
    function mouseOver(id, curId) {
        ...
        if (currentId != null) {
            ...
            if (id.parentNode.parentNode.parentNode.parentNode.parentNode.parentNode
                .getAttribute("tmp_title") ==
                null ||
                "") {
                id.parentNode.parentNode.parentNode.parentNode.parentNode.parentNode
                    .setAttribute("tmp_title",
                        id.parentNode.parentNode.parentNode.parentNode.parentNode.parentNode.title);
            }
    ...
    function closePopupOnDocumentclick(id, curId) {
        ...
        id.parentNode.parentNode.parentNode.parentNode.parentNode.parentNode
            .setAttribute("title",
                id.parentNode.parentNode.parentNode.parentNode.parentNode.parentNode.setAttribut("tmp_title"));
    }

    function closePopup(id) {
        document.getElementById('contentRecords').style.height = clientHeight + "px";
        document.getElementById(id.parentNode.id).style.display = "none";
        id.parentNode.parentNode.parentNode.parentNode.parentNode.parentNode.parentNode.parentNode.style
            .overflow = "hidden";
        id.parentNode.parentNode.parentNode.parentNode.parentNode.parentNode.parentNode.style.overflow = "hidden";
        id.parentNode.parentNode.parentNode.parentNode.parentNode.parentNode.parentNode.parentNode
            .setAttribute("title",
                id.parentNode.parentNode.parentNode.parentNode.parentNode.parentNode.parentNode.parentNode
                .getAttribute("tmp_title"));
    ...
    function CreateAttachmentTemplate(recordObj,
        totalAttachmentCountShow,
        sourceObjectId,
        styleToDisplay,
        currentAttachmentId,
        ...
        highlightedBody) {
        var template = "";
        template += "<div class='section_control_meqf noLabel attributeOther RA " +
            sourceObjectId +
            "' style='width: 525px;display:" +
            styleToDisplay +
            "' id='attachments_" +
            currentAttachmentId +
            "'>";
        ...
        if (highlightedFilename != null) {
            var name = highlightedFilename.toString().replace(/{crmhit}/g, '<em>').toString()
                .replace(/{\/crmhit}/g, '</em>');
            name = name.toString().replace(/{\/crmhit}/g, '</em>');
            template += "<span onmouseover='mouseOver(this,\"" +
                curId +
                "\")'><b><img src='/_imgs/ico_16_attach.gif' title='" +
                Mscrm.ExternalSearch.getAttachmentsLabelTextToDisplay() +
                "' alt='" +
                Mscrm.ExternalSearch.getAttachmentsLabelTextToDisplay() +
                "'/> &nbsp; " +
                Mscrm.ExternalSearch.getAttachmentsLabelTextToDisplay() +
                " : </b>" +
                highlightedFilename.toString().replace(/{crmhit}/g, '<em>').toString().replace(/{\/crmhit}/g, '</em>');
        } else {
            template += "<span onmouseover='mouseOver(this,\"" +
                curId +
                "\")'><b><img src='/_imgs/ico_16_attach.gif' title='" +
        ...
        if (highlightedBody != null) {
            ...
            template += "<div id='arrowbox_attachments_" +
                currentAttachmentId +
                "' style='max-width:800px;' class='arrow_box'>";
            template += "<a href='javascript:void(0)' id='cross_" +
                currentAttachmentId +
                "' class='cross' onclick='event.stopPropagation(); closePopup(this)'>";
            template += "</a>";
        ...
        if (i == 0 && totalAttachmentCountShow > 0) {
            template += "<a id='showmore_" +
                sourceObjectId +
                "' tabindex='0' href='javascript:void(0)' style='color:#0072C6;z-index:9999;padding-top: 2px;' onclick='event.stopPropagation();ToggleAttachmentsSection(\"" +
                sourceObjectId +
                "\");'> " +
                totalAttachmentCountShow +
                " " +
                Mscrm.ExternalSearch.getAttachmentShowMoreTextToDisplay() +
                "</a> ";
        } else if (totalAttachmentCountShow > 0 && i == totalAttachmentCountShow) {
            template += "<a id='showless_" +
                sourceObjectId +
                "' tabindex='0'  href='javascript:void(0)' style='color:#0072C6;z-index:9999;display:none;padding-top: 2px;' onclick='event.stopPropagation();ToggleAttachmentsSection(\"" +
                sourceObjectId +
                "\");'> " +
                Mscrm.ExternalSearch.getAttachmentShowLessTextToDisplay() +
                "</a> ";
        }
        ...
        for (var i = 0; i < childrens.length; i += 1) {
            ...
            for (var j = 0; j < nodes.length; j += 1) {
                ...
                if (j == nodes.length - 1 && isEligibleForMasterJson) {
                    ...
                    if ((k == masterJSONResponse.length || typeof masterJSONResponse.length === "undefined") &&
                        isEligibleForDummyCreation) {
                        nodes[j + 1] = {
                            "@search.objectid": childrens[i]["objectid"],
                            "@search.entityname": childrens[i]["objecttypecode"],
                            "@search.objecttypecode": childrens[i]["objecttypecode"],
                            "subject": childrens[i]["activitysubject"]
                        };
    ...
    $(window).scroll(function() {
        if ($(window).scrollTop() + $(window).height() > $(document).height() - 100 &&
            Mscrm.ExternalSearch.unProcessedJsonValueLength == queryPageSize) {
    ...
    function show_more(type) {
        ...
        if (document.getElementById("autompleteRecordType" + type) != null) {
            ...
            if (type == "entity") {
                ...
                for (var i = 0; i < recordTyperesults["facets"]["@search.entityname"].length && i < 20; i++) {
                    var obj;
                    obj = {
                        id: recordTyperesults["facets"]["@search.entityname"][i].Value,
                        value: Mscrm.ExternalSearch
                            .getEntityDisplayName(recordTyperesults["facets"]["@search.entityname"][i].Value),
                        type: "Entity",
                    };
                ...
                $("#autompleteRecordType_" + parameter2).autocomplete({
                    ...
                    select: function(event, ui) {
                        ...
                        Mscrm.ExternalSearch
                            .executeRecordSearchSdkCall(queryPageSize, 0, ui.item.entityTypeCode, filter, false, "");
                        return false;
                    }
                });
            } else if (type == "Picklist") {
    ...
    function createDateTimeControl(container,
        chartdata,
        guid,
        columnName,
        otc,
    ...
    function createFutureDateTimeControl(container,
        chartdata,
        guid,
        columnName,
        otc,
    ...
    function createSliderControl(container,
        chartdata,
        guid,
        columnName,
        otc,
    ...
    function onSelectionBoxChange(value) {
        ...
        if (value == "2") {
            ...
            window.open(Mscrm.CrmUri.create("/MultiEntityQuickFind/MultiEntityQuickFind.aspx?text=" + searchtxt),
                '_self');
        } else {
            OpenDialogue();
        }
    ...
    function NewGuid() {
        var guid = (GenerateRandomNumber() +
            GenerateRandomNumber() +
            "-" +
            GenerateRandomNumber() +
            "-4" +
            GenerateRandomNumber().substr(0, 3) +
            "-" +
            GenerateRandomNumber() +
            "-" +
            GenerateRandomNumber() +
            GenerateRandomNumber() +
            GenerateRandomNumber()).toLowerCase();
        return guid;
    }
    ...
    function SearchResultTabbingSequenceChange() {
        ...
        if (logoText === "" || typeof logoText === "undefined" || logoText === null) {
            ...
            ) focusElement.setAttribute("id", "adynamics365");
        }
            ...
            <div class="row dropdownbox_searchboxcontainer">
                ...
                <div class="col-md-2 removingdefaultpadding" id="searchSelectionView">
                    <a
                        ...
                        tabindex="0"
                        id="crmGrid_Selector" class="ms-crm-View-Name ms-crm-View-Name-View-Lite" style="position: relative; text-decoration: none; height: 37px;" href="#" onclick="OpenDialogue();" title="<%= CurrentResourceManager.GetString("ExternalSearch_Label_Tooltip") %>" id="crmGrid_SavedNewQuerySelector" gridid="crmGrid">
                        <span style="line-height: 35px;" class="ms-crm-View-Name ms-crm-ViewSelector-title-associated-lite ms-crm-TextAutoEllipsis"><%= CurrentResourceManager.GetString("ExternalSearch_Relevance_Search") %></span><span style="top: 8px;" class="ms-crm-View-icon ms-crm-ViewSelector-dropdown-icon-associated-lite">
                            <img class="ms-crm-View-icon-associated-lite ms-crm-ImageStrip-Dropdown_Arrow" alt="Select a view" src="/_imgs/grid/dropdown_arrow.png"/>
                        </span>
                    </a>
                    <div id="searchDiagolue" class="ms-crm-VS-Menu" style="width: 220px; display: none; margin-top: 0px; position: absolute; z-index: 1000;">
                        <ul class="ms-crm-VS-Menu" id="searchDiagolueUL" role="listbox">
                            ...
                            <li id="categorizedSearchLi" role="option" aria-selected="false" aria-label="<%= CurrentResourceManager.GetString("CategorizedSearch_Label_Tooltip") %>" class="ms-crm-MenuItem-NoOutline ms-crm-VS-header-MenuItem ms-crm-VS-header-MenuItem-Rest" style="float: none;">
                                <a href="#" class="ms-crm-VS-header-MenuItem-Aux ms-crm-VS-header-MenuItem-Aux-Rest" style="float: right; display: none;">
                                    <span class="ms-crm-VS-header-MenuItem-Aux ms-crm-VS-header-MenuItem-Aux-Rest">
                                        <img title="" alt="" class="ms-crm-VS-header-MenuItem-Aux ms-crm-VS-header-MenuItem-Aux-Rest">
                                    </span>
                                </a><a class="crmntfcoverride ms-crm-VS-header-MenuItem-Anchor-Rest" style="cursor: default;" onclick="onSelectionBoxChange('2')" style="background-color: none;">
                                    <span>
                                        <span class="ms-crm-VS-header-MenuItem-Icon ms-crm-VS-header-MenuItem-Icon-Rest">
                                            <img src="/_imgs/DashboardSelector/crm_dashboard.png" class="ms-crm-VS-header-MenuItem-Icon ms-crm-VS-header-MenuItem-Icon-Rest">
                                        </span><span class="ms-crm-VS-header-MenuItem-Sep ms-crm-VS-header-MenuItem-Sep-Rest"></span><nobr class="ms-crm-VS-header-MenuItem-Title ms-crm-VS-header-MenuItem-Title-Rest" style="width: 120px !important;">
                                            <span style="font-weight: normal;" title="<%= CurrentResourceManager.GetString("CategorizedSearch_Label_Tooltip") %>" class="ms-crm-VS-header-MenuItem-Title ms-crm-VS-header-MenuItem-Title-Rest"><%= Microsoft.Crm.CrmEncodeDecode.CrmHtmlEncode(CurrentResourceManager.GetString("CategorizedSearch_Relevance_Search")) %></span>
                                        </nobr>
                                    </span>
                                </a>
                            </li>
                    ...
                    <div id="allrecordType" role="Facets">
                        <div name="facet">
                            <div class="facetsname_RecordOwnerCreatedModified">
                                <span title="<%= CurrentResourceManager.GetString("ExternalSearch_Relevance_Search_RecordType") %>" id="RecordTypeEntityTitleDisplay">
                                    <loc:text resourceid="ExternalSearch_Relevance_Search_RecordType" runat="server"/>
                                </span>
                            </div>
                        ...
                        <div id="ownerfacet">
                            <div class="facetsname_RecordOwnerCreatedModified">
                                <span title="<%= CurrentResourceManager.GetString("ExternalSearch_Relevance_Search_OwnerName") %>" id="ownerNameTitleDisplay">
                                    <loc:text resourceid="ExternalSearch_Relevance_Search_OwnerName" runat="server"/>
                                </span>
                            </div>
