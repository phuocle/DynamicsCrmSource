...
function
    FormObj(oFormXml, oDepends, bFaExpanded, bLeftNavShown, sName, sDescription, bEnableFa, sMaxWidth, showImage) {
...
function TimerControlObj(sId,
    sSuccessConditionName,
    sSuccessConditionValues,
    sFailureConditionName,
    sFailureConditionValue,
    sWarningConditionName,
    sWarningConditionValue,
    sCancelConditionName,
    sCancelConditionValue,
    sPauseConditionName,
    sPauseConditionValue,
    sFailureTimeField,
    iRowSpan,
    iColSpan,
    sTabName,
...
function QuickFormObj(sId,
    ...
    isReferencePanelQuickFormCollection = typeof isReferencePanelQuickFormCollection !== "undefined"
        ? isReferencePanelQuickFormCollection
        : false;
...
function SearchWidgetObj(sId,
    sFilterResults,
    bAllowChangingFiltersOnUI,
    bShowLanguageFilter,
    bShowDepartmentFilter,
    bEnableAutoSuggestions,
    sSearchForAutoSuggestionsUsing,
    sAutoSuggestionSource,
    iNumberOfResults,
    bShowContextualActions,
    sActionList,
    sSelectPrimaryCustomer,
    iRowSpan,
    iColSpan,
    sTabName,
    sSectionName,
    ...
    this.FormXml = oFormXml;
    this.Visible = bVisible;
    isReferencePanelSearchWidget = typeof isReferencePanelSearchWidget !== "undefined"
        ? isReferencePanelSearchWidget
        : false;
