...
Mscrm.DataSetControlDefinitions = function(definitions) {
    ...
    this.DataSetDefinitions = new (Microsoft.Crm.Client.Core.Framework.TypedDictionary$1
        .$$(Microsoft.Crm.Client.Core.Framework.CustomControl
            .DataSetSpecificationRecord))(definitions['DataSetDefinitions']);
    this.PropertyDefinitions = new (Microsoft.Crm.Client.Core.Framework.TypedDictionary$1
        .$$(Microsoft.Crm.Client.Core.Framework.CustomControl
            .PropertySpecificationRecord))(definitions['PropertyDefinitions']);
}
...
Mscrm.DataSetCancellationTokenSource = function() {
    this.$18_0 = new Mscrm.DataSetCancellationToken(this);
}
...
Mscrm.DataSetCancellationToken.prototype = {
    ...
    get_isCanceled: function() {
        return this.$1n_0.$1I_0;
    }
}


Mscrm.DataSetColumn = function(name,
    displayName,
    alias,
    dataType,
    visualSizeFactor,
    ...
    attributes,
    validator) {
    this.$W_0 = new Mscrm.DataSetCancellationTokenSource();
    this.name = name;
...
Mscrm.DataSetColumn.prototype = {
    ...
    addOnChange: function(handler, system) {
        this.get_$R_0().addHandler('Change', handler, system);
    },

    fireOnChange: function(wrapper) {
        var $v_0 = this.get_$R_0().getHandler('Change');
        if ($v_0) {
            $v_0(wrapper, null);
        }
    },
    ...
    removeOnChange: function(handler) {
        this.get_$R_0().removeHandler('Change', handler);
    },
    ...
    updateAttributes: function(metadata) {
        ...
        this.dataType = Microsoft.Crm.Client.Core.Framework.CustomControlUtils
            .retrieveCorrespondingManifestType($v_2, $v_3);
        this.$v_0 = metadata.get_type();
        this.$1B_0 = metadata;
        ...
        this.$1Q_0 = Microsoft.Crm.Client.Core.Framework.CustomControlUtils
            .extractUnformattedAttributeData($v_4, this.attributes);
        Mscrm.DataSetControlAttributeHelper
            .addGlobalAssociatedAttributes(this.attributes,
                Microsoft.Crm.Client.Core.Storage.DataApi.DataSource.get_defaultInstance().get_userContext());
        $v_0.stop();
    },
    ...
    getDataSetLookup: function(recordFactory, selectedRecord, lookupDefinition) {
        var $v_0 = Microsoft.Crm.Client.Core.Imported.MscrmComponents
            .deferredPromiseFactory(Mscrm.DataSetLookup, Microsoft.Crm.Client.Core.Framework.ErrorStatus);
        if (this.$v_0 !== 6 || _Script.isNullOrUndefined(this.attributes) || !(('targets') in this.attributes)) {
            ...
            if (!_Script.isNullOrUndefined(this.$t_0)) {
                ...
                $v_3.set_$29_1((!_Script.isNullOrUndefined(selectedRecord)) ? selectedRecord.getRecordId() : null);
                ...
                this.$2v_0(Mscrm.DataSetControlDataProvider.get_instance(), lookupDefinition, $v_6)
                    .done(function($p1_0) {
                        var $v_7 = new Mscrm.DataSetLookup(Mscrm.DataSetControlDataProvider.get_instance(),
                            recordFactory,
                            $p1_0);
                        ...
                        $v_8.set_$29_1((!_Script.isNullOrUndefined(selectedRecord))
                        ...
                        var $v_9 = new Mscrm.DataSetLookup(Mscrm.DataSetControlDataProvider.get_instance(),
                            recordFactory,
                            null);
                        $v_9.hasError = true;
    ...
    $2v_0: function($p0, $p1, $p2) {
        var $v_0 = Microsoft.Crm.Client.Core.Imported.MscrmComponents
            .deferredPromiseFactory(Mscrm.IDataSetObjectInputs,
        ...
        if (!IsNull($p1) &&
            !Microsoft.Crm.Client.Core.Framework._String.isNullOrEmpty($p1.fetchXml) &&
            !Microsoft.Crm.Client.Core.Framework._String.isNullOrEmpty($p1.layoutXml)) {
            ...
            $p0.retrieveMultiple($v_2, this.$W_0.$18_0).done(function($p1_0) {
                var $v_3 = $p1_0;
                if (!IsNull($v_3) && !IsNull($v_3.entityCollection) && !IsNull($v_3.entityCollection.get_entities())) {
                    ...
                    $v_0.reject(Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.Responses.CrmErrorResponse
                        .fromErrorCode(0));
                }
            }).fail(function($p1_0) {
                $v_0.reject($p1_0);
...
Mscrm.DataSetColumnValidator.prototype = {
    ...
    validate: function(value, isValueChanging, isDisabled) {
        return new Mscrm.DataSetColumnValidatorResult(this.$1S_0.validate(value, isValueChanging, isDisabled));
    },
...
Mscrm.DataSetControl = function(element) {
    ...
    this.$$d_$2p_3 = Function.createDelegate(this, this.$2p_3);
    ...
    this.$V_3 = this.get_id().replace(Mscrm.DataSetControl.datasetctrL_PREFIX, '');
    this.$3_3 = Mscrm.GridControl.findComponent(this.$V_3);
    this.$11_3 = $get(this.$V_3);
    ...
    this.$3_3.add_onResetComplete(this.$$d_$26_3);
    this.$3_3.add_onRefresh(this.$$d_$2m_3);
    ...
    if (!Mscrm.InternalUtilities._Script.isNullOrUndefined(this.get_$u_3())) {
        this.get_$u_3().addTabStateChange(this.$$d_$2p_3);
    }
}
...
Mscrm.DataSetControl.$22 = function($p0) {
    var $v_0 = $P_CRM($p0.frameElement);
    return !$v_0.length ||
        (Mscrm.DataSetControl.$22($p0.parent) && $v_0.is(':visible') && $v_0.css('visibility') === 'visible');
}
Mscrm.DataSetControl.prototype = {
    ...
    get_$2h_3: function() {
        return (!Mscrm.InternalUtilities._Script.isNullOrUndefined(this.get_$u_3()))
            ? this.get_$u_3().getDisplayState() === 'expanded'
            : true;
    },
    ...
    get_addContextualButton: function() {
        var $v_0 = this.$V_3 + '_addImageButton';
        return $get($v_0);
    },
    ...
    changeVisualizationTo: function(id, parameters, constructor, stylesToLoad, scriptsToLoad, configurationIdString) {
        ...
        if (!this.$Z_3.equals($v_0)) {
            if (new Microsoft.Crm.Client.Core.Framework.Guid(id)
                ...
                if (this.$O_3 !== constructor) {
                    this.$2s_3(parameters, constructor, stylesToLoad, scriptsToLoad);
                } else {
    ...
    $19_3: function($p0) {
        ...
        $v_0 = $v_0 && !this.$a_3;
        $v_0 = $v_0 && !this.$1E_3;
        $v_0 = $v_0 && (this.$3_3.get_gridType() === Mscrm.GridControl.hompageGrid || this.$2Z_3());
        if ($v_0) {
            this.$2b_3($p0);
        }
    },
    ...
    $2b_3: function($p0) {
        if (!isNullOrEmptyString(this.$O_3)) {
            if (!$p0) {
                var $$t_1, $$t_2;
                (($$t_2 = Mscrm.JsonUtilities
                    .tryGetParsedJson(eval(String.format('window.DataSetDefinitions{0}', this.get_id())),
                        ($$t_1 = { 'val': $p0 }))), $p0 = $$t_1.val, $$t_2);
    ...
    $1O_3: function() {
        ...
        this.$2t_3().done(function() {
            ...
            $$t_3.$1m_3(true);
            Xrm.Internal.trace.logT(Mscrm.DataSetControl,
                'Failed initializing DataSetControl. Error: {0}',
                $p1_0.message);
        });
    },
    ...
    $2t_3: function() {
        ...
        var $v_1 = Microsoft.Crm.Client.Core.Imported.MscrmComponents
            .deferredPromiseFactory(Boolean, Mscrm.DataSetControlErrorStatus);
        this.$1u_3();
        var $v_2 = new Mscrm.DataSetControlFactory();
        try {
            $v_0 = $v_2.buildDataSetControl(this.get_element(),
                this.$V_3,
                this.$O_3,
                this.$l_3,
                this.$D_3,
        ...
        $v_0.done(function($p1_0) {
            try {
                $$t_7.$2_3 = $p1_0;
                $$t_7.$2_3.add_onSelectionChanged($$t_7.$$d_$27_3);
                $$t_7.$2_3.init();
                $v_1.resolve(true);
            } catch ($v_4) {
    ...
    $1m_3: function($p0) {
        ...
        if (this.$3_3.get_gridType() === Mscrm.GridControl.hompageGrid) {
            ...
            Sys.UI.DomElement.setVisible(this.$11_3, $p0);
        }
        if ($p0) {
            this.$3_3.Refresh();
        }
    ...
    $1P_3: function() {
        if (!Mscrm.InternalUtilities._Script.isNullOrUndefined(this.$2_3) &&
            this.getVisible() &&
            this.get_gridType() !== Mscrm.GridControl.inlineSubGrid) {
            setSelectedControl(this);
        }
    },

    $2s_3: function($p0, $p1, $p2, $p3) {
        this.$O_3 = $p1;
        this.$2j_3($p2);
        this.$2i_3($p3);
    ...
    $1f_3: function() {
        return this.get_$2h_3() && this.getVisible();
    },
    ...
    initialize: function() {
        ...
        this.$19_3(null);
        if (!this.$a_3) {
            $addHandler(window, 'load', this.$$d_$2n_3);
        }
    },
    ...
    dispose: function() {
        ...
        if (!this.$3_3.get_isDisposed()) {
            if (this.$3_3.get_gridType() !== Mscrm.GridControl.hompageGrid) {
                $removeHandler(window, 'load', this.$$d_$2n_3);
            }
            this.$3_3.remove_onResetComplete(this.$$d_$26_3);
            this.$3_3.remove_onRefresh(this.$$d_$2m_3);
        }
        if (!Mscrm.InternalUtilities._Script.isNullOrUndefined(this.get_$u_3())) {
            this.get_$u_3().removeTabStateChange(this.$$d_$2p_3);
        }
    ...
    $1u_3: function() {
        if (!IsNull(this.$2_3)) {
            this.$2_3.remove_onSelectionChanged(this.$$d_$27_3);
            this.$2_3.dispose();
        }
    },
    ...
    handleEvent: function(eventCode, parameters, sourceComponent) {
        ...
        case 87:
        case 9:
            if (!IsNull(this.$2_3) && this.getVisible() && (!this.$1J_3 || eventCode === 87)) {
                this.$1J_3 = true;
                this.$1P_3();
            }
            this.$1g_3();
    ...
    get_hasMorePages: function() {
        try {
            return this.$2_3.get_primaryDataSet().get_paging().get_hasNextPage() ||
                this.$2_3.get_primaryDataSet().get_paging().get_hasPreviousPage();
        } catch ($$e_0) {
            return false;
        }
    },
    ...
    getVisible: function() {
        var $v_0 = Mscrm.DataSetControl.$22(window.self) && $P_CRM(this.get_element()).is(':visible');
        return $v_0;
    },
...
Mscrm.DataSetControlAttributeHelper.extractAttributesFromMetadata = function(metadata, serverType) {
    var $v_0 = {};
    var $v_1 = Microsoft.Crm.Client.Core.Framework.CustomControlAttributeProperty.getAttributeListByType(serverType);
    for (var $$arr_4 = $v_1, $$len_5 = $$arr_4.length, $$idx_6 = 0; $$idx_6 < $$len_5; ++$$idx_6) {
        ...
        case 'lastUpdatedField':
            $v_0['lastUpdatedField'] = Microsoft.Crm.Client.Core.Framework.CustomControlUtils
                .getRollupDateFieldName(metadata.get_logicalName());
            break;
...
Mscrm.DataSetControlAttributeHelper.addGlobalAssociatedAttributes = function(attributes, userContext) {
    ...
    if ($v_0 === 'integer') {
        if ($v_1 === 'timezone') {
            attributes['timezonebycode'] = Mscrm.DataSetControlAttributeHelper.$2S(userContext);
        } else if ($v_1 === 'language') {
            attributes['languagebycode'] = window.EnabledLanguages;
        }
    }
}
Mscrm.DataSetControlAttributeHelper.$2S = function($p0) {
...
Mscrm.DataSetControlClientInfo = function(maxAvailableWidth, viewportHeight) {
    ...
    this.languageCode = Microsoft.Crm.Client.Core.Storage.DataApi.DataSource.get_defaultInstance().get_userContext()
        .get_UserSettings().get_userCultureLcid();
    this.locale = Microsoft.Crm.Client.Core.Storage.DataApi.DataSource.get_defaultInstance().get_userContext()
        .get_UserSettings().get_formatInfoCultureName();
    this.orgSettings = Microsoft.Crm.Client.Core.Storage.DataApi.DataSource.get_defaultInstance().get_userContext()
        .get_organizationSettings().getExternalExposedData();
    this.orgSettings['showWeekNumber'] = Microsoft.Crm.Client.Core.Storage.DataApi.DataSource.get_defaultInstance()
        .get_userContext().get_UserSettings().get_showCalendarWeeks();
    this.dateFormattingInfo = Microsoft.Crm.Client.Core.Storage.DataApi.DataSource.get_defaultInstance()
        .get_userContext().get_UserSettings().getExternalDateFormatData();
    this.numberFormattingInfo = Microsoft.Crm.Client.Core.Storage.DataApi.DataSource.get_defaultInstance()
        .get_userContext().get_UserSettings().getExternalNumberFormatData();
...
Mscrm.DataSetControlClientInfo.getCurrentUserTimeZoneUtcOffset = function(date) {
    return Microsoft.Crm.Client.Core.Storage.DataApi.DataSource.get_defaultInstance().get_userContext()
        .get_UserSettings().get_timeZoneUtcOffsetMinutes() +
        Microsoft.Crm.Client.Core.Framework.UserDateTimeUtils
        .getDSTAdjustmentMinutes(date,
            Microsoft.Crm.Client.Core.Storage.DataApi.DataSource.get_defaultInstance().get_userContext()
    ...
    adjustDataAreaHeight: function(controlName, currentHeight, rowHeight, nonDataHeight) {
        ...
        try {
            ...
            if ($v_2.get_gridType() === Mscrm.GridControl.inlineSubGrid && $v_2.$3_3.isLiteSubGrid()) {
                ...
                var $v_5 = $v_2.get_element().offsetHeight;
                var $v_6 = ($v_4 + 1) * rowHeight + $v_0 + $v_1;
                $v_2.get_element().style.height = String.format('{0}px', $v_6);
                $v_3.parentNode.style.height = String
                    .format('{0}px', $v_6 + nonDataHeight + ($v_3.parentNode.offsetHeight - $v_5));
                this.viewportHeight = $v_6 + nonDataHeight;
                return $v_6;
            }
        } catch ($$e_B) {
        }
...
Mscrm.DataSetControlDataProvider = function($p0) {
    this.$13_0 = {};
    this.$1L_0 = $p0.get_metadataCache();
    this.$1R_0 = new Microsoft.Crm.Client.Core.Storage.DataApi.UserPrivileges($p0.get_userContext());
}
Mscrm.DataSetControlDataProvider.get_instance = function() {
    if (_Script.isNullOrUndefined(Mscrm.DataSetControlDataProvider.$1H)) {
        Mscrm.DataSetControlDataProvider.$1H = new Mscrm
            .DataSetControlDataProvider(Microsoft.Crm.Client.Core.Storage.DataApi.DataSource.get_defaultInstance());
    }
    return Mscrm.DataSetControlDataProvider.$1H;
}
Mscrm.DataSetControlDataProvider.prototype = {
    ...
    retrieveMultiple: function(fetchXml, cancellationToken) {
        return this.$33_0(Xrm.Sdk.Response,
            Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.Responses.CrmErrorResponse,
            Xrm.Internal.messages.retrieveMultiple(fetchXml),
            cancellationToken);
    },
    ...
    retrieveRecordRelatedEntities: function(entityMetadata, source, identifier, columnSet, record) {
        return Microsoft.Crm.Client.Core.Storage.DataApi.DataSource.get_defaultInstance()
            .retrieveRecordRelatedEntities(entityMetadata, source, identifier, columnSet, record);
    },

    retrieveEntityMetadata: function(entityLogicalName) {
        var $v_0 = Microsoft.Crm.Client.Core.Imported.MscrmComponents
            .deferredPromiseFactory(Microsoft.Crm.Client.Core.Storage.Common.EntityAttributeMetadataPair,
                Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.Responses.CrmErrorResponse);
        if (!_Script.isNullOrUndefined(this.$13_0[entityLogicalName])) {
            return this.$13_0[entityLogicalName];
        }
        this.$13_0[entityLogicalName] = $v_0.promise();
        var $v_1 = new Mscrm.Performance
            .PerformanceStopwatch('DataSetControl.RetrieveMetaDataChanges ' + entityLogicalName);
        $v_1.start();
        var $$t_7 = this, $$t_8 = this;
        Xrm.Internal.messages.retrieveEntityMetadata(entityLogicalName, Xrm.Page.context.getUserLcid())
            .done(function($p1_0) {
                $v_1.stop();
                if (!_Script.isNullOrUndefined($p1_0.get_entityMetadataCollection()) &&
                    $p1_0.get_entityMetadataCollection().get_count() > 0) {
                    ...
                    $$t_7.$1L_0.cacheEntityMetadata($v_3);
                    $$t_7.$1L_0.cacheAttributeMetadata(entityLogicalName,
                        $v_2.get_allAttributes(),
                        new (Microsoft.Crm.Client.Core.Framework.CallbackSafeArray$1
                            .$$(Microsoft.Crm.Client.Core.Storage.Common.IAttributeMetadata))($v_2.get_attributes()));
                    $v_0.resolve($p1_0.get_entityMetadataCollection().get_item(0));
                } else {
                    $v_0.reject(Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.Responses.CrmErrorResponse
                        .fromErrorCode(-2147093952));
                }
            }).fail(function($p1_0) {
                $v_0.reject($p1_0);
            });
...
Mscrm.DataSetControlErrorStatus.buildFromGenericError = function(error) {
    if (Mscrm.DataSetControlErrorStatus.isInstanceOfType(error)) {
        return error;
    } else if (Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.Responses.CrmErrorResponse
        .isInstanceOfType(error)) {
...
Mscrm.DataSetControlFactory.prototype = {
    buildDataSetControl: function(container,
        controlName,
        constructorName,
        dataSetDefinitions,
        primaryDataSetInputs,
        isActive) {
        var $v_0 = Microsoft.Crm.Client.Core.Imported.MscrmComponents
            .deferredPromiseFactory(Mscrm.IDataSetControlHost, Mscrm.DataSetControlErrorStatus);
        ...
        this.$2M_0().done(function() {
            ...
            $v_2.set_propertyBag($$t_A.$2O_0(container,
                controlName,
                constructorName,
                dataSetDefinitions,
                primaryDataSetInputs,
    ...
    $2O_0: function($p0, $p1, $p2, $p3, $p4, $p5) {
        ...
        this.$2N_0($v_0, $p3, $p1, $p4);
        return $v_0;
    },

    $2N_0: function($p0, $p1, $p2, $p3) {
        for (var $$arr_4 = $p1.DataSetDefinitions.get_keys(), $$len_5 = $$arr_4.length, $$idx_6 = 0;
            $$idx_6 < $$len_5;
            ++$$idx_6) {
            var $v_0 = $$arr_4[$$idx_6];
            if ($v_0 !== 'Grid') {
            ...
            $p3.set_entityLogicalName((Microsoft.Crm.Client.Core.Framework._String.isNullOrEmpty($v_1.TargetEntityType))
                ? $v_1.EntityName
                : $v_1.TargetEntityType);
            var $v_2 = new Array(0);
            for (var $v_4 = 0; $v_4 < $v_1.Columns.length; $v_4++) {
                var $v_5 = $v_1.Columns[$v_4];
                $v_2[$v_4] = new Microsoft.Crm.Client.Core.Framework.CustomControl
                    .ColumnDefinition($v_5.Name, $v_5.DisplayName, $v_5.Alias, $v_5.DataType, $v_5.VisualSizeFactor);
            }
            var $v_3 = new Mscrm.DataSetDefinition($v_1.Name,
                new Microsoft.Crm.Client.Core.Framework.Guid($v_1.ViewId),
                $v_2,
                $v_1.ContextFilter,
                $v_1.ExtraCondition,
                $v_1.RelationshipType,
                $v_1.EnableViewPicker,
                $v_1.FilteredViewIds,
                $v_1.RelationshipName,
                $v_1.ReferencingName);
            $v_3.$15_0 = $v_1.Lookups;
            $v_3.$7_0 = this.$2L_0($p2, $v_3, $p3);
            $p0.addDataSetParameter($v_0, $v_3.$7_0);
        }
        for (var $$arr_D = $p1.PropertyDefinitions.get_keys(), $$len_E = $$arr_D.length, $$idx_F = 0;
            $$idx_F < $$len_E;
            ++$$idx_F) {
            var $v_6 = $$arr_D[$$idx_F];
    ...
    $2L_0: function($p0, $p1, $p2) {
        var $v_0 = new Array(0);
        if (!IsNull($p1.$L_0)) {
            for (var $v_2 = 0; $v_2 < $p1.$L_0.length; $v_2++) {
                var $v_3 = $p1.$L_0[$v_2];
                $v_0[$v_2] = new Mscrm.DataSetColumn($v_3.get_name(),
                    $v_3.get_displayName(),
                    $v_3.get_alias(),
                    $v_3.get_dataType(),
                    $v_3.get_visualSizeFactor(),
                    false,
                    -1,
                    false,
                    null,
        ...
        $v_1.set_columns($v_0);
        $v_1.set_lookups(this.$2K_0($p2.get_entityLogicalName(), $p1.$15_0));
    ...
    $2K_0: function($p0, $p1) {
        ...
        for (var $$key_7 in $$dict_6) {
            ...
            var $v_2 = $v_1.value;
            var $v_3 = new Mscrm.DataSetLookupDefinition($p0,
                $v_2['DependentAttributeName'],
                $v_2['DependentAttributeType'],
                Microsoft.Crm.Client.Core.Framework.Guid.tryCreate($v_2['DefaultViewId']).toString(),
                $v_2['FilterRelationshipName'],
                (('AllowFilterOff') in $v_2) ? Boolean.parse($v_2['AllowFilterOff']) : false,
                (('ContextFilter') in $v_2) ? $v_2['ContextFilter'] : '',
                (('ExtraCondition') in $v_2) ? $v_2['ExtraCondition'] : '',
                (('FetchXml') in $v_2) ? $v_2['FetchXml'] : '',
                (('LayoutXml') in $v_2) ? $v_2['LayoutXml'] : '');
            $v_0[$v_1.key] = $v_3;
        }
        return $v_0;
    },
...
Mscrm.DataSetControlFormatting.prototype = {
    formatDateShort: function(value, includeTime) {
        if (includeTime) {
            return Microsoft.Crm.Client.Core.Storage.Common.CrmFormatter.get_instance()
                .formatShortDateTimeValue(value, 0);
        }
    ...
    formatDecimal: function(value, precision) {
        return Microsoft.Crm.Client.Core.Storage.Common.CrmFormatter.get_instance()
            .formatDecimalValue(value, precision);
    },

    formatCurrency: function(value, precision, symbol) {
        return Microsoft.Crm.Client.Core.Storage.Common.CrmFormatter.get_instance()
            .formatCurrencyValue(value, symbol, precision);
    },
    ...
    formatTime: function(value, behavior) {
        return Microsoft.Crm.Client.Core.Storage.Common.CrmFormatter.get_instance()
            .formatShortDateTimeValue(value, behavior);
    },
...
Mscrm.DataSetControlHost = function(container) {
    this.$$d_$2k_1 = Function.createDelegate(this, this.$2k_1);
...
Mscrm.DataSetControlHost.prototype = {
    ...
    get_primaryDataSet: function() {
        return (!_Script.isNullOrUndefined(this.$9_1)) ? this.$9_1.get_primaryDataSet() : null;
    },
    ...
    set_propertyBag: function(value) {
        this.$9_1 = value;
        this.$9_1.add_onPropertyBagChanged(this.$$d_update);
        this.$9_1.add_onSelectionChanged(this.$$d_$24_1);
        return value;
    },
    ...
    init: function() {
        ...
        $v_0.start();
        this.$9_1.get_updatedProperties().push('activation');
        try {
            this.$X_1.init(this.$b_1, this.$$d_$2k_1, this.$9_1, this.$10_1, null);
        } catch ($v_1) {
            this.$1K_1('Init', $v_1);
        }
        this.$9_1.refresh();
    ...
    update: function() {
        var $v_0 = new Mscrm.Performance
            .PerformanceStopwatch('DataSetControl.DataSetControlHost.Update ' + this.$b_1.id);
        $v_0.start();
        try {
            this.$X_1.update(this.$9_1);
        } catch ($v_1) {
            this.$1K_1('Update', $v_1);
        }
        this.$9_1.clearUpdatedProperties();
        $v_0.stop();
    },

    activate: function(width, height) {
        this.$9_1.activate(width, height);
    },
    ...
    isActive: function() {
        return this.$9_1.get_mode().get_isActive();
    },

    resize: function(width, height) {
        this.$9_1.resize(width, height);
    },
    ...
    dispose: function() {
        try {
            ...
            this.$1K_1('Destroy', $v_0);
        }
        this.$9_1.remove_onPropertyBagChanged(this.$$d_update);
        this.$9_1.remove_onSelectionChanged(this.$$d_$24_1);
        this.$9_1.dispose();
    ...
    $2k_1: function() {
        ...
        try {
            ...
            this.$1K_1('GetOutputs', $v_1);
        }
        if (!_Script.isNullOrUndefined($v_0)) {
            this.$9_1.updateLinkedOutputs($v_0);
        }
    },
    ...
    $1K_1: function($p0, $p1) {
        ...
        var $v_1 = String.format('Control id={0} type={1} threw an exception on {2}(): {3}',
            this.$b_1.id,
            this.$b_1.getAttribute('type'),
            $p0,
            $v_0);
...
Mscrm.DataSetControlPropertyBag.prototype = {
    ...
    addDataSetParameter: function(parameterKey, dataSetObject) {
        ...
        dataSetObject.addOnDataSetUpdated(this.$$d_$25_1);
        dataSetObject.addOnSelectionChange(this.$$d_$24_1);
    },
    ...
    resize: function(width, height) {
        var $v_0 = this.$2I_1(width, height);
        if ($v_0) {
    ...
    dispose: function() {
        ...
        for (var $$key_3 in $$dict_2) {
            ...
            if (Mscrm.IDataSetObject.isInstanceOfType($v_0.value)) {
                var $v_1 = $v_0.value;
                $v_1.removeOnDataSetUpdated(this.$$d_$25_1);
                $v_1.removeOnSelectionChange(this.$$d_$24_1);
                $v_1.dispose();
            }
        }
    },
...
Mscrm.DataSetControlUserAgent = function() {
    this.isWin = (window.navigator.appVersion.indexOf('Win') !== -1) ||
        (window.navigator.appVersion.indexOf('NT') !== -1);
...
Mscrm.DataSetControlUtilities.getState = function(constructorName, viewId) {
    var $v_0 = Xrm.Internal.getLocalStorageItem(Mscrm.DataSetControlUtilities.$20(constructorName, viewId));
    return (_Script.isNullOrUndefined($v_0)) ? {} : Sys.Serialization.JavaScriptSerializer.deserialize($v_0);
}
Mscrm.DataSetControlUtilities.$20 = function($p0, $p1) {
...
Mscrm.DataSetControlUtilities.prototype = {
    ...
    setState: function(state) {
        Xrm.Internal.setLocalStorageItem(Mscrm.DataSetControlUtilities.$20(this.$O_0, this.$1W_0),
...
Mscrm.DataSetFetchXmlHelper.refreshFetchXmlSorting = function(fetchXmlDocument, sortingInfo, entityLogicalName) {
    if (!_Script.isNullOrUndefined(sortingInfo)) {
        Mscrm.DataSetFetchXmlHelper.$2P(fetchXmlDocument);
        Mscrm.DataSetFetchXmlHelper.$1t(fetchXmlDocument,
            entityLogicalName,
            sortingInfo.get_SortByField(),
            sortingInfo.get_SortDescending());
        Mscrm.DataSetFetchXmlHelper.$1t(fetchXmlDocument,
            entityLogicalName,
            sortingInfo.get_SecondarySortByField(),
            sortingInfo.get_SecondarySortDescending());
    }
}
Mscrm.DataSetFetchXmlHelper
    .refreshFetchXmlRollupFields = function(fetchXmlDocument, rollupColumnNames, entityLogicalName) {
        if (!_Script.isNullOrUndefined(rollupColumnNames) && rollupColumnNames.get_Count() > 0) {
            ...
            if (!_Script.isNullOrUndefined($v_1)) {
                for (var $v_2 = 0; $v_2 < rollupColumnNames.get_Count(); $v_2++) {
                    var $v_3 = rollupColumnNames.get_item($v_2);
                    var $v_4 = XUI.Xml.SelectSingleNode(fetchXmlDocument,
                        String.format('{0}/attribute[@name=\'{1}\']', $v_0, $v_3),
                        null);
                    if (_Script.isNullOrUndefined($v_4)) {
                        Mscrm.DataSetFetchXmlHelper.$2Q(fetchXmlDocument, $v_1, $v_3);
                    }
                }
            }
        }
    }
Mscrm.DataSetFetchXmlHelper.$2P = function($p0) {
...
Mscrm.DataSetFetchXmlHelper.$1t = function($p0, $p1, $p2, $p3) {
    var $v_0 = null;
...
Mscrm.DataSetFetchXmlHelper.$2Q = function($p0, $p1, $p2) {
    if (!Microsoft.Crm.Client.Core.Framework._String.isNullOrEmpty($p2)) {
...
Mscrm.DataSetFetchXmlHelper.refreshXmlFiltering = function(fetchXmlDocument,
    baseFilterXml,
    additionalFilterXml,
    entityLogicalName) {
    var $v_0 = String.format('/fetch/entity[@name=\'{0}\']', entityLogicalName);
    ...
    if (!_Script.isNullOrUndefined($v_1)) {
        ...
        if (!Mscrm.InternalUtilities.JSTypes.isNullOrEmptyString(baseFilterXml)) {
            if (!Mscrm.InternalUtilities.JSTypes.isNullOrEmptyString(additionalFilterXml)) {
                $v_3 += '<filter type=\"' +
                    Microsoft.Crm.Client.Core.Storage.Common.FetchExpression.LogicalOperator.toString(0).toLowerCase() +
                    '\">';
                $v_3 += baseFilterXml;
...
Mscrm.DataSetFetchXmlHelper.addInternalColumns = function(fetchXml, entityLogicalName) {
    ...
    var $v_2 = eval($v_1);
    if ($v_2) {
        Mscrm.DataSetFetchXmlHelper.$1r($v_0, entityLogicalName, 'statecode');
    }
    if (entityLogicalName === 'systemuser') {
        Mscrm.DataSetFetchXmlHelper.$1r($v_0, entityLogicalName, 'isdisabled');
    }
    return XUI.Xml.XMLSerializer.serializeToString($v_0);
}
Mscrm.DataSetFetchXmlHelper.$1r = function($p0, $p1, $p2) {
...
Mscrm.DataSetFetchXmlHelper.setContextFilterValue = function(fetchXmlDocument, queryContextId) {
    var $v_0 = XUI.Xml.SelectSingleNode(fetchXmlDocument,
        '/fetch/entity//condition[boolean(@value)=false and @operator=\'eq\']',
        null);
    if (!_Script.isNullOrUndefined($v_0)) {
        if (!Microsoft.Crm.Client.Core.Framework._String.isNullOrEmpty(queryContextId)) {
            $v_0.attributes.setNamedItem(Microsoft.Crm.Client.Core.Storage.Common.Xml.XmlNode
                .createAttribute(fetchXmlDocument, 'value', queryContextId));
        } else {
            if (!_Script.isNullOrUndefined($v_0.parentNode) && !_Script.isNullOrUndefined($v_0.parentNode.parentNode)) {
                if ($v_0.parentNode.parentNode.nodeName === 'link-entity' &&
                    !_Script.isNullOrUndefined($v_0.parentNode.parentNode.parentNode)) {
...
Mscrm.DataSetFieldAccessHelper.prototype = {
    ...
    getValidator: function(columnName) {
        var $v_0 = Microsoft.Crm.Client.Core.Imported.MscrmComponents
            .deferredPromiseFactory(Mscrm.IDataSetColumnValidator, Mscrm.DataSetControlErrorStatus);
        var $$t_6 = this, $$t_7 = this;
        this.$1j_1().done(function() {
            $$t_6.getFieldRequiredLevel(columnName).done(function($p2_0) {
                var $v_1 = $$t_6.$m_1.get_attributesByName().get_item(columnName);
                if (_Script.isNullOrUndefined($v_1)) {
                    $v_0.reject(Mscrm.DataSetControlErrorStatus
                        .buildFromMessage($$t_6.$G_1.getResourceString('Error_Title_0x8004f990')));
                    return;
                }
                $v_0.resolve($$t_6.$2d_1($v_1, $p2_0));
            }).fail(function($p2_0) {
    ...
    getValidationParameters: function(columns) {
        var $v_0 = {};
        var $v_1 = Microsoft.Crm.Client.Core.Imported.MscrmComponents
            .deferredPromiseFactory(Object, Mscrm.DataSetControlErrorStatus);
        var $v_2 = new Array(0);
        for (var $$arr_4 = columns, $$len_5 = $$arr_4.length, $$idx_6 = 0; $$idx_6 < $$len_5; ++$$idx_6) {
            var $v_3 = $$arr_4[$$idx_6];
            $v_2.push(this.$32_1($v_3, $v_0));
        }
    ...
    getColumnAttributes: function(column) {
        ...
        var $v_1 = column;
        var $v_2 = new Mscrm.Performance
            .PerformanceStopwatch('DataSetControl.RetrieveEntityAttributeMetadataPair ' + column.get_name());
        $v_2.start();
        var $$t_5 = this, $$t_6 = this;
        this.$1k_1().done(function() {
            $v_2.stop();
    ...
    isRecordDisabled: function() {
        ...
        if (!Microsoft.Crm.Client.Core.Models.StateCodeHelper.canRetrieveActivationState(this.$M_1)) {
            ...
            $v_0.resolve(Microsoft.Crm.Client.Core.Models.StateCodeHelper
                .isRecordDisabled(this.$M_1, $v_1, this.$G_1.get_userPrivileges().get_rolePrivileges()));
        }
        return $v_0.promise();
    },
    ...
    getFieldAccessLevelsForOperation: function(fieldName, operationType) {
        ...
        this.$1j_1().done(function() {
            $v_1.stop();
            $$t_6.$G_1.get_userPrivileges()
                .getFieldAccessLevelsForOperation($$t_6.$M_1, fieldName, operationType, $$t_6.$m_1)
                .done(function($p2_0) {
                    $v_0.resolve($p2_0);
                }).fail(function($p2_0) {
                    $v_0.reject($p2_0);
    ...
    isOperationEnabledOnModel: function(operationType) {
        ...
        this.$1j_1().done(function() {
            var $v_1 = $$t_4.$G_1.get_userPrivileges()
                .isOperationEnabledOnModel($$t_4.$M_1.get_actionableIdentifier().LogicalName,
                    $$t_4.$M_1,
                    2,
                    $$t_4.$o_1,
                    $$t_4.$1i_1);
    ...
    $2x_1: function() {
        ...
        this.$g_1 = Microsoft.Crm.Client.Core.Imported.MscrmComponents
            .deferredPromiseFactory(Boolean, Microsoft.Crm.Client.Core.Framework.ErrorStatus);
        var $$t_2 = this, $$t_3 = this;
        this.$G_1.retrieveRecordRelatedEntities(this.$o_1,
            'RetrieveRecordRelatedEntities',
            this.$M_1.get_actionableIdentifier(),
            this.$M_1.get_directColumnSet(),
            this.$M_1).done(function($p1_0) {
    ...
    $1k_1: function() {
        if (!_Script.isNullOrUndefined(this.$T_1)) {
            return this.$T_1;
        }
        this.$T_1 = Microsoft.Crm.Client.Core.Imported.MscrmComponents
            .deferredPromiseFactory(Microsoft.Crm.Client.Core.Storage.Common.EntityAttributeMetadataPair,
                Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.Responses.CrmErrorResponse);
        var $$t_4 = this, $$t_5 = this;
        this.$G_1.retrieveEntityMetadata(this.$M_1.get_actionableIdentifier().LogicalName).done(function($p1_0) {
            ...
            if ($$t_4.$o_1.get_isChildEntity()) {
                $$t_4.$G_1.retrieveEntityMetadata($$t_4.$o_1.get_parentEntityLogicalName()).done(function($p2_0) {
                    $$t_4.$1i_1 = $p2_0.get_entityMetadata();
                    $$t_4.$T_1.resolve($p1_0);
                }).fail(function($p2_0) {
                    $$t_4.$T_1.reject($p2_0);
                });
            } else {
    ...
    $2d_1: function($p0, $p1) {
        ...
        var $v_1 = Microsoft.Crm.Client.Core.Models.Validation.CustomControlValidationHelper
            .getValidatorType($v_0, $p0.get_format());
        var $v_2 = null;
        var $v_3 = $p1 === 2 || $p1 === 1;
        var $v_4 = true;
        ...
        case 1:
            ...
            break;
        case 2:
            $v_2 = new Microsoft.Crm.Client.Core.Models.Validation
                .IntegerValidator($v_3, $v_4, $p0.get_minValue(), $p0.get_maxValue());
            break;
        case 3:
            $v_2 = new Microsoft.Crm.Client.Core.Models.Validation
                .DecimalValidator($v_3, $v_4, $p0.get_minValue(), $p0.get_maxValue(), $p0.get_precision());
            break;
        case 4:
        case 7:
            $v_2 = new Microsoft.Crm.Client.Core.Models.Validation
                .MoneyValidator($v_3, $v_4, $p0.get_minValue(), $p0.get_maxValue(), $p0.get_precision(), false);
            break;
        case 5:
        ...
        case 8:
            $v_2 = new Microsoft.Crm.Client.Core.Models.Validation
                .DateTimeValidator($v_3,
                    $v_4,
                    (!_Script.isNullOrUndefined($p0.get_behavior())) ? $p0.get_behavior() : 1,
                    new Date(1753, 0, 1));
            break;
        case 0:
        default:
...
Mscrm.DataSetFiltering.prototype = {
    ...
    filterExpressionToFetchXml: function(filterExpression) {
        var $v_0 = '';
        if (_Script.isNullOrUndefined(filterExpression) ||
        ((_Script.isNullOrUndefined(filterExpression.conditions) || !filterExpression.conditions.length) &&
            (_Script.isNullOrUndefined(filterExpression.filters) || !filterExpression.filters.length))) {
            return $v_0;
        }
        ...
        if (!_Script.isNullOrUndefined(filterExpression.conditions)) {
            if (filterExpression.conditions.length > 0) {
                Microsoft.Crm.Client.Core.Storage.Common.CustomControls.CustomControlDataSetFilteringUtils
                    .checkFilterOperatorIsValid(Microsoft.Crm.Client.Core.Storage.Common.FetchExpression.LogicalOperator
                        .toString(filterExpression.filterOperator));
                $v_0 += '<filter type=\"' +
                    Microsoft.Crm.Client.Core.Storage.Common.FetchExpression.LogicalOperator
                    .toString(filterExpression.filterOperator).toLowerCase() +
                    '\">';
            }
            for (var $v_1 = 0; $v_1 < filterExpression.conditions.length; $v_1++) {
                var $v_2 = filterExpression.conditions[$v_1];
                Microsoft.Crm.Client.Core.Storage.Common.CustomControls.CustomControlDataSetFilteringUtils
                    .checkIfConditionExpressionHasInvalidArguments($v_2);
                var $v_3 = Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.EncodeDecode
                    .xmlEncode(Microsoft.Crm.Client.Core.Storage.Common.CustomControls
                        .CustomControlDataSetFilteringUtils.conditionOperatorToString($v_2.conditionOperator));
                Microsoft.Crm.Client.Core.Storage.Common.CustomControls.CustomControlDataSetFilteringUtils
                    .checkConditionOperatorIsValid($v_3);
                ...
                if (_Script.isNullOrUndefined($v_2.value) && _Script.isNullOrUndefined($v_2.values)) {
                    $v_0 += '<condition attribute=\"' +
                        Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.EncodeDecode.xmlEncode($v_4) +
                        '\" operator=\"' +
                        $v_3 +
                        '\"/>';
            ...
            for (var $v_7 = 0; $v_7 < filterExpression.filters.length; $v_7++) {
                $v_0 += this.filterExpressionToFetchXml(filterExpression.filters[$v_7]);
            }
            if (filterExpression.filters.length > 1) {
                $v_0 += '</filter>';
            }
    ...
    refreshFetchXml: function(fetchXmlDocument, entityLogicalName) {
        Mscrm.DataSetFetchXmlHelper.refreshXmlFiltering(fetchXmlDocument,
            this.$1X_0,
            this.filterExpressionToFetchXml(this.filterExpression),
            entityLogicalName);
    },
...
Mscrm.DataSetLookup.prototype = {
    ...
    reset: function() {
        this.set_fetchXml(this.$1T_2);
    }
}


Mscrm.DataSetLookupDefinition = function(dependentEntityName,
    dependentAttributeName,
    targetEntityName,
    targetViewId,
    targetFilterRelationshipName,
    allowFilterOff,
    contextFilter,
    extraCondition,
    fetchXml,
...
Mscrm.DataSetLookupFiltering.prototype = {
    ...
    canDisableRelationshipFilter: function() {
        return (Mscrm.InternalUtilities._Script.isNullOrUndefined(this.lookupConfiguration))
            ? false
            : this.lookupConfiguration.allowFilterOff;
    },
    ...
    disableRelationshipFilter: function() {
        if (this.canDisableRelationshipFilter()) {
            ...
            this.$i_0 = '';
            this.$z_0 = '';
            this.get_$1Y_1().reset();
        }
    },

    clearFilter: function() {
        if (!Mscrm.InternalUtilities._Script.isNullOrUndefined(this.$17_1)) {
            this.setFilter(null);
        } else {
    ...
    setFilter: function(filterExpression) {
        if (!Mscrm.InternalUtilities._Script.isNullOrUndefined(this.$17_1)) {
            var $v_0 = new Microsoft.Crm.Client.Core.Storage.Common.CustomControls
                .CustomControlDataSetConditionExpression();
            $v_0.attributeName = this.get_$1Y_1().get_primaryIdAttribute();
            $v_0.value = this.$17_1;
            $v_0.conditionOperator = 1;
            var $v_1 = new Microsoft.Crm.Client.Core.Storage.Common.CustomControls
                .CustomControlDataSetFilterExpression();
            $v_1.conditions = [$v_0];
    ...
    enableRelationshipFilter: function(parentRecord) {
        ...
        this.get_$1Y_1().reset();
        var $v_0 = '';
        if (!Mscrm.InternalUtilities._Script.isNullOrUndefined(parentRecord) &&
            !Mscrm.InternalUtilities._Script.isNullOrUndefined(this.lookupConfiguration.dependentAttributeName) &&
            !Mscrm.InternalUtilities._String.isNullOrEmpty(this.lookupConfiguration.dependentAttributeName)) {
            ...
            this.$y_0 = this.lookupConfiguration.contextFilter;
            this.$i_0 = $v_0;
        }
        this.$z_0 = this.lookupConfiguration.extraCondition;
    },
...
Mscrm.DataSetObject = function(dataProvider, recordFactory, inputs) {
    this.$$d_$27_1 = Function.createDelegate(this, this.$27_1);
    this.$$d_$2l_1 = Function.createDelegate(this, this.$2l_1);
    Mscrm.DataSetObject.initializeBase(this);
    this.includeInternalColumns = true;
    this.$G_1 = dataProvider;
    this.$W_1 = new Mscrm.DataSetCancellationTokenSource();
    this.$1M_1 = recordFactory;
    this.$8_1 = inputs;
...
Mscrm.DataSetObject.prototype = {
    ...
    set_selectionHelper: function(value) {
        this.$H_1 = this.$2J_1(value);
        return value;
    },

    initialize: function() {
        var $v_0 = new Mscrm.Performance
            .PerformanceStopwatch('DataSetControl.DataSetObject.Initialize ' + this.$8_1.get_entityLogicalName());
        $v_0.start();
        var $v_1 = this.$2W_1(this.$8_1.get_layoutXml());
        this.$2X_1($v_1);
        this.set_fetchXml(this.$2a_1(this.$8_1.get_fetchXml()));
        $v_0.stop();
    },
    ...
    $1w_1: function() {
        var $v_0 = new Mscrm.Performance
            .PerformanceStopwatch('DataSetControl.DataSetObject.RetrieveMultiple ' + this.$8_1.get_entityLogicalName());
        $v_0.start();
        var $$t_B = this, $$t_C = this, $$t_D = this, $$t_E = this;
        this.$2w_1().always(function() {
            $v_0.stop();
            $$t_B.$1v_1();
            ...
            var $v_1 = $p1_0;
            var $v_2 = 0;
            for (var $$arr_4 = $v_1.entityCollection.get_entities(), $$len_5 = $$arr_4.length, $$idx_6 = 0;
                $$idx_6 < $$len_5;
                ++$$idx_6) {
                var $v_3 = $$arr_4[$$idx_6];
                var $v_4 = $$t_C.$1M_1.buildDataSetRecord($v_3, $$t_C.columns, $$t_C.$F_1);
                var $v_5 = $v_3.get_identifier().get_identifier();
                $$t_C.sortedRecordIds[$v_2] = $v_5;
                $$t_C.records[$v_5] = $v_4;
                $v_4.add_onChange($$t_C.$$d_$2l_1);
                $v_2++;
            }
    ...
    addOnRecordSelect: function(handler, system) {
        this.get_$R_1().addHandler('RecordSelect', handler, system);
    },

    addOnRecordSave: function(handler, system) {
        this.get_$R_1().addHandler('RecordSave', handler, system);
    },

    fireOnRecordSelect: function(wrapper) {
        var $v_0 = this.get_$R_1().getHandler('RecordSelect');
        if ($v_0) {
            $v_0(wrapper, null);
        }
    },
    ...
    fireOnRecordSave: function(wrapper) {
        var $v_0 = this.get_$R_1().getHandler('RecordSave');
        if ($v_0) {
            $v_0(wrapper, null);
        }
    },
    ...
    removeOnRecordSelect: function(handler) {
        this.get_$R_1().removeHandler('RecordSelect', handler);
    },

    removeOnRecordSave: function(handler) {
        this.get_$R_1().removeHandler('RecordSave', handler);
    },
    ...
    generateAdditionalAttributes: function() {
        var $v_0 = Microsoft.Crm.Client.Core.Imported.MscrmComponents.deferredPromiseFactory(Boolean, Object);
        var $$t_A = this, $$t_B = this;
        this.$G_1.retrieveEntityMetadata(this.$8_1.get_entityLogicalName()).done(function($p1_0) {
            var $v_1 = $p1_0.get_attributeMetadataCollection().get_attributes();
            var $v_2 = {};
            for (var $v_3 = 0; $v_3 < $v_1.length; $v_3++) {
                $v_2[$v_1[$v_3].get_logicalName()] = $v_1[$v_3];
            }
            for (var $$arr_5 = $$t_A.columns, $$len_6 = $$arr_5.length, $$idx_7 = 0; $$idx_7 < $$len_6; ++$$idx_7) {
                var $v_4 = $$arr_5[$$idx_7];
                if (!$v_4.get_isJoinedColumn()) {
                    $v_4.updateAttributes($v_2[$v_4.get_name()]);
                }
            }
            $v_0.resolve(true);
        }).fail(function($p1_0) {
    ...
    generateValidators: function() {
        return Microsoft.Crm.Client.Core.Imported.MscrmComponents.deferredPromiseFactory(Boolean, Object)
            .resolve(false);
    },
    ...
    getLookupDataSet: function(columnName) {
        ...
        if (IsNull($v_0)) {
            return Microsoft.Crm.Client.Core.Imported.MscrmComponents
                .deferredPromiseFactory(Mscrm.DataSetLookup, Microsoft.Crm.Client.Core.Framework.ErrorStatus)
                .resolve(null);
        }
        var $v_1 = Mscrm.DataSetLookupDefinition
            .retrieveFormattedKey(this.getViewId(), this.$8_1.get_entityLogicalName(), $v_0.get_name());
        var $v_2 = this.lookups[$v_1];
        return $v_0.getDataSetLookup(this.$1M_1, this.getSelectedRecord(), $v_2);
    },
    ...
    updateLinkedOutput: function(dataSetRecord) {
        ...
        dataSetRecord.validateAllColumns().done(function($p1_0) {
            if ($p1_0) {
                ...
                $$t_3.$2f_1(dataSetRecord);
            } else {
                $$t_3.fireEvent('OnDataSetRecordChange',
                    Mscrm.DataSetUpdateResult.onRecordUpdate(dataSetRecord.getRecordId(), false));
            }
        }).fail(function($p1_0) {
            dataSetRecord.set_externalErrorMessage($p1_0.message);
            $$t_4.fireEvent('OnDataSetRecordChange',
                Mscrm.DataSetUpdateResult.onRecordUpdate(dataSetRecord.getRecordId(), false));
        });
    },
    ...
    $2f_1: function($p0) {
        ...
        this.$G_1.update($p0.get_entityRecord()).done(function() {
            var $v_0 = Mscrm.DataSetColumn.mapToColumnNames(Mscrm.DataSetColumn
                .filterByMainEntityVisibleColumns($$t_6.columns));
            $$t_6.$G_1.retrieve($p0.get_identifier(), $v_0).done(function($p2_0) {
                var $v_1 = $p2_0;
                $p0.merge($v_1.entity);
                $$t_6.fireEvent('OnDataSetRecordChange',
                    Mscrm.DataSetUpdateResult.onRecordUpdate($p0.getRecordId(), true));
            }).fail(function($p2_0) {
                $p0.set_externalErrorMessage($p2_0.get_localizedMessage() || $p2_0.get_message());
                $$t_6.fireEvent('OnDataSetRecordChange',
                    Mscrm.DataSetUpdateResult.onRecordUpdate($p0.getRecordId(), false));
            });
        }).fail(function($p1_0) {
            $p0.set_externalErrorMessage($p1_0.get_localizedMessage() || $p1_0.get_message());
            $$t_7
                .fireEvent('OnDataSetRecordChange', Mscrm.DataSetUpdateResult.onRecordUpdate($p0.getRecordId(), false));
        });
    },
    ...
    dispose: function() {
        this.$W_1.cancel();
        this.$1v_1();
        this.$H_1.remove_onSelectionChanged(this.$$d_$27_1);
        this.$H_1.dispose();
        Mscrm.NotifyPropertyChanged.prototype.dispose.call(this);
        this.records = null;
    ...
    $1v_1: function() {
        ...
        for (var $$key_3 in $$dict_2) {
            var $v_0 = { key: $$key_3, value: $$dict_2[$$key_3] };
            var $v_1 = $v_0.value;
            $v_1.remove_onChange(this.$$d_$2l_1);
            $v_1.dispose();
        }
    },
    ...
    $2w_1: function() {
        var $v_0 = Microsoft.Crm.Client.Core.Imported.MscrmComponents
            .deferredPromiseFactory(Xrm.Sdk.Response, Mscrm.DataSetControlErrorStatus);
        if (this.$8_1.get_isFetchXmlNotFinal()) {
            $v_0.reject(Mscrm.DataSetControlErrorStatus
                .buildFromMessage(this.$G_1.getResourceString('Error_Message_0x80060565')));
            return $v_0.promise();
        }
        var $$t_3 = this, $$t_4 = this;
        this.$G_1.retrieveMultiple(this.$8_1.get_fetchXml(), this.$W_1.$18_0).done(function($p1_0) {
            $v_0.resolve($p1_0);
        }).fail(function($p1_0) {
    ...
    $2W_1: function($p0) {
        var $v_0 = {};
        this.$1N_1 = new (Microsoft.Crm.Client.Core.Framework.List$1.$$(String))();
        ...
        for (var $v_4 = 0; $v_4 < $v_2.length; $v_4++) {
            var $v_5 = $v_2[$v_4];
            var $v_6 = ($v_3) ? $v_5.attributes.getNamedItem('name').nodeValue : XUI.Xml.GetText($v_5);
            var $v_7 = ($v_5.attributes.getNamedItem('width'))
                ? parseFloat($v_5.attributes.getNamedItem('width').nodeValue)
                : 1;
            var $v_8 = ($v_5.attributes.getNamedItem('isHidden') &&
                    $v_5.attributes.getNamedItem('isHidden').nodeValue === 'true')
                ? true
                : false;
            var $v_9 = ($v_5.attributes.getNamedItem('label')) ? $v_5.attributes.getNamedItem('label').nodeValue : '';
            var $v_A = ($v_5.attributes.getNamedItem('isSortable') &&
                    $v_5.attributes.getNamedItem('isSortable').nodeValue === 'true')
                ? false
                : true;
            var $v_B = ($v_5.attributes.getNamedItem('type')) ? $v_5.attributes.getNamedItem('type').nodeValue : '';
            var $v_C = ($v_5.attributes.getNamedItem('sourcetype'))
                ? Microsoft.Crm.Client.Core.Framework._Enum
                .parse(Microsoft.Crm.Client.Core.Storage.Common.ObjectModel.AttributeSourceType,
                    $v_5.attributes.getNamedItem('sourcetype').nodeValue)
                : -1;
            var $v_D = $v_B.split('.');
            var $v_E = $v_D[0].toLowerCase();
            var $v_F = '';
            if ($v_D.length > 1) {
                $v_F = $v_D[1].toLowerCase();
            }
            var $v_G = {};
            $v_G['width'] = $v_7;
            $v_G['isHidden'] = $v_8;
            $v_G['label'] = $v_9;
            $v_G['disableSorting'] = $v_A;
            $v_G['order'] = $v_4;
            $v_G['type'] = $v_E;
            $v_G['sourcetype'] = $v_C;
            $v_G['format'] = $v_F;
            $v_G['manifesttype'] = Microsoft.Crm.Client.Core.Framework.CustomControlUtils
                .retrieveCorrespondingManifestType($v_E, $v_F);
            $v_0[$v_6] = $v_G;
            if ($v_C === 2) {
                var $v_H = Microsoft.Crm.Client.Core.Framework.CustomControlUtils.getRollupDateFieldName($v_6);
                if (!(($v_H) in $v_0)) {
                    $v_0[$v_H] = this.$2Y_1();
                    this.$1N_1.add($v_H);
                }
            ...
            if ((($v_3.key) in $v_0)) {
                ...
                if ($v_C !== -1) {
                    ...
                    if (_Script.isNullOrUndefined($v_D.get_attributes())) {
                        $v_D = new Mscrm.DataSetColumn($v_D.get_name(),
                            (Microsoft.Crm.Client.Core.Framework._String.isNullOrEmpty($v_D.get_displayName()))
                            ? $v_8
                            : $v_D.get_displayName(),
                            $v_D.get_alias(),
                            $v_D.get_dataType(),
                ...
                this.columns.push(new Mscrm.DataSetColumn($v_3.key,
                    $v_8,
                    $v_3.key,
                    $v_9,
                    $v_5,
    ...
    $2q_1: function() {
        ...
        if (!_Script.isNullOrUndefined($v_0) && !_Script.isNullOrUndefined($v_0.documentElement)) {
            ...
            Mscrm.DataSetFetchXmlHelper
                .refreshFetchXmlRollupFields($v_0, this.$1N_1, this.$8_1.get_entityLogicalName());
        }
        this.set_fetchXml(XUI.Xml.XMLSerializer.serializeToString($v_0));
    },
    ...
    $2z_1: function() {
        ...
        var $v_0 = new Mscrm.Performance
            .PerformanceStopwatch('DataSetControl.DataSetObject.RunOnDataSetRecordLoadHandlers ' +
                this.$8_1.get_entityLogicalName());
        $v_0.start();
        if (!this.$1h_1) {
            this.$1h_1 = true;
            ...
            if ($v_2) {
                if ((Mscrm.FeatureControl.get_Current().isFeatureEnabled('FCB.EditableGridControlPbl') ||
                        Mscrm.FeatureControl.get_Current().isFeatureEnabled('FCB.EditableGridControlJsEvents')) &&
                    ($v_2.$3_3.get_gridType() === Mscrm.GridControl.hompageGrid ||
                        $v_2.$3_3.get_gridType() === Mscrm.GridControl.associatedGrid)) {
            ...
            if (Mscrm.FeatureControl.get_Current().isFeatureEnabled('FCB.EditableGridControlPbl')) {
                if (Mscrm.Utilities.isTurboForm()) {
                    Mscrm.TurboForm.Control.CustomScriptsManager.get_instance()
                        .executeHandler('Mscrm.BusinessRulesScript.GetDataSetRecordLoadHandlers', '', null);
                    Mscrm.TurboForm.Control.CustomScriptsManager.get_instance()
                        .executeHandler('Mscrm.BusinessRulesScript.GetDataSetInitializers', '', null);
                } else {
                ...
                if (Mscrm.Utilities.isTurboForm()) {
                    $v_3 = '\'' + $v_3 + '\'';
                    Mscrm.TurboForm.Control.CustomScriptsManager.get_instance()
                        .executeHandler('Mscrm.BusinessRulesScript.RunDataSetInitializer', $v_3, null);
                } else if (!_Script.isNullOrUndefined(Mscrm.BusinessRulesScript) &&
                    !_Script.isNullOrUndefined(Mscrm.BusinessRulesScript.RunDataSetInitializer)) {
            ...
            if (Mscrm.FeatureControl.get_Current().isFeatureEnabled('FCB.EditableGridControlJsEvents')) {
                ...
                if (Mscrm.Utilities.isTurboForm()) {
                    Mscrm.TurboForm.Control.CustomScriptsManager.get_instance()
                        .executeHandler('Mscrm.GridScript.InitializeGridControlScripts', '\'' + $v_4 + '\'', null);
                } else if (!_Script.isNullOrUndefined(Mscrm.GridScript) &&
                    !_Script.isNullOrUndefined(Mscrm.GridScript.InitializeGridControlScripts)) {
        ...
        if ((Mscrm.FeatureControl.get_Current().isFeatureEnabled('FCB.EditableGridControlPbl') ||
                Mscrm.FeatureControl.get_Current().isFeatureEnabled('FCB.EditableGridControlJsEvents')) &&
            !_Script.isNullOrUndefined(Xrm.Page) &&
            !_Script.isNullOrUndefined(Xrm.Page.getControl(this.$F_1)) &&
            !_Script.isNullOrUndefined(Xrm.Page.getControl(this.$F_1).getGrid())) {
    ...
    $30_1: function() {
        var $v_0 = new Mscrm.Performance
            .PerformanceStopwatch('DataSetControl.DataSetObject.RunOnDataSetRecordSaveHandlers ' +
                this.$8_1.get_entityLogicalName());
        $v_0.start();
        if ((Mscrm.FeatureControl.get_Current().isFeatureEnabled('FCB.EditableGridControlPbl') ||
                Mscrm.FeatureControl.get_Current().isFeatureEnabled('FCB.EditableGridControlJsEvents')) &&
            ...
            !_Script.isNullOrUndefined(Xrm.Page.getControl(this.$F_1).getGrid().getSelectedRows().get(0)) &&
            !_Script.isNullOrUndefined(Xrm.Page.getControl(this.$F_1).getGrid().getSelectedRows().get(0).getData()) &&
            !_Script.isNullOrUndefined(Xrm.Page.getControl(this.$F_1).getGrid().getSelectedRows().get(0).getData()
                .entity)) {
    ...
    $2J_1: function($p0) {
        ...
        $p0.add_onSelectionChanged(this.$$d_$27_1);
        return $p0;
    },
    ...
    $2c_1: function() {
        this.$I_1 = Microsoft.Crm.Client.Core.Framework.SortingInfo
            .createFromFetchXml(XUI.Xml.LoadXml(this.get_fetchXml()));
        if (!_Script.isNull(this.$I_1)) {
            ...
            if (!_Script.isNull(this.$I_1.get_SecondarySortByField()) &&
                !_Script.isNull(this.$I_1.get_SecondarySortDescending())) {
...
Mscrm.DataSetObjectInputs.prototype = {
    ...
    getProperty: function(key) {
        return this.$2H_0(this.get_$2A_0(), key);
    },

    setProperty: function(key, value) {
        this.$1l_0(this.get_$2A_0(), key, value);
    },

    getParameter: function(key) {
        return this.$2H_0(this.get_$28_0(), key);
    },

    setParameter: function(key, value) {
        this.$1l_0(this.get_$28_0(), key, value);
    },
...
Mscrm.DataSetRecord = function(entityRecord, columns, fieldAccessHelper, controlName, validationErrorMessage) {
    ...
    this.$C_1 = Microsoft.Crm.Client.Core.Models.RecordModel.createWithoutEventHandlers(entityRecord);
    this.$C_1.add_propertyChanged(this.$$d_$2o_1);
    this.$L_1 = columns;
    this.$12_1 = this.$2R_1(columns);
    this.$1o_1 = this.$2T_1(columns);
    this.$B_1 = fieldAccessHelper;
    this.$J_1 = controlName;
    this.$1p_1 = validationErrorMessage;
    this.$2C_1(this.$C_1);
}
Mscrm.DataSetRecord.prototype = {
    ...
    get_identifier: function() {
        return this.$C_1.get_identifier();
    },

    get_actionableIdentifier: function() {
        return this.$C_1.get_actionableIdentifier();
    },
    ...
    get_entityRecord: function() {
        return this.$C_1.get_entityRecord();
    },

    $J_1: null,

    get_$2g_1: function() {
        return _Script.isNullOrUndefined(Microsoft.Crm.Client.Core.Storage.DataApi.DataSource.get_defaultInstance()
            .get_metadataCache().getEntityMetadata(this.getPrimaryEntityLogicalName()));
    },
    ...
    setValue: function(columnAlias, newValue) {
        ...
        this.$Y_1 = '';
        if (!this.$C_1.hasField($v_1.get_name())) {
            this.$C_1.get_entityRecord().initializeValue($v_1.get_name(), null, $v_1.get_attributeType());
        }
        var $v_4 = Microsoft.Crm.Client.Core.Framework.CustomControlUtils.getInternalDataValue(newValue, $v_1);
        this.$C_1.SetValue($v_1.get_name(), $v_4);
        this.$1A_1($v_1.get_name(), $v_2, $v_3);
        $v_0.resolve(true);
        return $v_0.promise();
    },
    ...
    reformatValue: function(columnAlias) {
        var $v_0 = this.$h_1(columnAlias);
        this.$C_1.reformatValue(this.get_entityRecord(), $v_0);
    ...
    setFieldErrorMessage: function(columnName, message) {
        ...
        this.$B_1.setFieldErrorMessage(columnName, message);
        this.$1A_1(columnName, $v_0, $v_1);
    },

    clearFieldErrorMessage: function(columnName) {
        var $v_0 = this.isValid(columnName);
        var $v_1 = this.getNotification(columnName);
        this.$B_1.clearFieldErrorMessage(columnName);
        this.$1A_1(columnName, $v_0, $v_1);
    },
    ...
    setFieldEditableProperty: function(columnName, isEditable) {
        ...
        var $v_1 = this.getNotification(columnName);
        var $$t_6 = this, $$t_7 = this;
        this.$B_1.isEditable(this.$14_1(columnName)).done(function($p1_0) {
            $$t_6.$B_1.setFieldEditableProperty(columnName, isEditable);
            $$t_6.$1A_1(columnName, $v_0, $v_1);
            $$t_6.fireEvent('OnDataSetRecordChange',
                Mscrm.DataSetUpdateResult.onSetDisabled($$t_6.getRecordId(), columnName));
        }).fail(function($p1_0) {
        });
    },

    getFieldEditableProperty: function(columnName) {
        return this.$B_1.getFieldEditableProperty(columnName);
    },

    isEditable: function(columnName) {
        return this.$B_1.isEditable(this.$14_1(columnName));
    },

    isSecured: function(columnName) {
        return this.$B_1.isSecured(columnName);
    },

    isReadable: function(columnName) {
        return this.$B_1.isReadable(columnName);
    },

    isValid: function(columnName) {
        return this.$B_1.isValid(columnName);
    },

    getNotification: function(columnName) {
        return this.$B_1.getNotification(columnName);
    },

    setFieldRequiredLevel: function(columnName, requiredLevel) {
        var $v_0 = this.isValid(columnName);
        var $v_1 = this.getNotification(columnName);
        this.$B_1.setFieldRequiredLevel(columnName, requiredLevel);
        this.$1A_1(columnName, $v_0, $v_1);
        this.fireEvent('OnDataSetRecordChange',
            Mscrm.DataSetUpdateResult.onSetRequiredLevel(this.getRecordId(), columnName));
    },

    retrieveFieldRequiredLevel: function(columnName) {
        return this.$B_1.retrieveFieldRequiredLevel(columnName);
    },

    getFieldRequiredLevel: function(columnName) {
        return this.$B_1.getFieldRequiredLevel(columnName);
    },
    ...
    getValidator: function(columnName) {
        return this.$B_1.getValidator(columnName);
    },

    getNamedReference: function() {
        return this.$C_1.get_namedReference();
    },
    ...
    validateAllColumns: function() {
        ...
        this.$B_1.getValidationParameters($v_1).done(function($p1_0) {
            for (var $$arr_3 = $v_1, $$len_4 = $$arr_3.length, $$idx_5 = 0; $$idx_5 < $$len_4; ++$$idx_5) {
                ...
                $$t_B.$21_1($v_2.get_name(), $v_3, $v_4, $v_5);
            }
    ...
    dispose: function() {
        this.$C_1.remove_propertyChanged(this.$$d_$2o_1);
        this.$C_1.dispose();
        this.$C_1 = null;
        this.$p_1 = null;
        this.$Q_1 = null;
    ...
    $1A_1: function($p0, $p1, $p2) {
        var $$t_6 = this, $$t_7 = this;
        this.$B_1.getValidationParameters([this.$14_1($p0)]).done(function($p1_0) {
            var $v_0 = $p1_0[$p0];
            $$t_6.$21_1($p0, $v_0, $p1, $p2);
        }).fail(function($p1_0) {
            $$t_7.$Y_1 = $p1_0.message;
        });
    },

    $21_1: function($p0, $p1, $p2, $p3) {
        var $v_0 = $p2;
        ...
        if (!_Script.isNullOrUndefined($p1) && !_Script.isNullOrUndefined($p1.$j_0)) {
            ...
            this.$B_1.setValidatorResult($p0, $v_4.isValid, $v_1, $v_4.errorMessage);
            $v_0 = this.$B_1.isValid($p0);
            var $v_5 = this.$B_1.getNotification($p0);
            if ($p2 !== $v_0 || $p3 !== $v_5) {
                this.fireEvent('OnDataSetRecordChange',
                    Mscrm.DataSetUpdateResult.onIsValidChange(this.getRecordId(), $p0));
            }
        }
        return $v_0;
    },
    ...
    $h_1: function($p0) {
        if (!_Script.isNullOrUndefined(this.$12_1[$p0])) {
            return this.$12_1[$p0];
        }
        return $p0;
    },
    ...
    $2C_1: function($p0) {
        ...
        for (var $$arr_1 = this.$L_1, $$len_2 = $$arr_1.length, $$idx_3 = 0; $$idx_3 < $$len_2; ++$$idx_3) {
            var $v_0 = $$arr_1[$$idx_3];
            var $v_1 = this.$2e_1($v_0.get_name());
            var $v_2 = $p0.get_entityRecord().getFormattedValue($v_0.get_name());
            this.$Q_1[$v_0.get_name()] = Microsoft.Crm.Client.Core.Framework.CustomControlUtils
                .getPublicDataValue($v_1, $v_0);
            this.$p_1[$v_0.get_name()] = $v_2;
            if (!Mscrm.InternalUtilities.JSTypes.isNullOrEmptyString($v_0.get_alias())) {
                this[$v_0.get_alias()] = this.$Q_1[$v_0.get_name()];
            }
        }
    },

    $2o_1: function($p0, $p1) {
        if (Microsoft.Crm.Client.Core.Models.FormModel.getFormat($p1) ===
            Microsoft.Crm.Client.Core.Framework.FieldFormat.raw) {
    ...
    $2e_1: function($p0) {
        if (this.get_$2g_1()) {
            return this.$C_1.get_entityRecord().getValue($p0);
        }
        return this.$C_1.GetValue($p0 + Microsoft.Crm.Client.Core.Framework.FieldFormat.raw);
    },

    $2y_1: function($p0) {
        var $v_0 = new Mscrm.Performance
            .PerformanceStopwatch('DataSetControl.DataSetRecord.RunOnDataSetColumnChangeHandlers ' + this.$J_1);
        $v_0.start();
        if ((Mscrm.FeatureControl.get_Current().isFeatureEnabled('FCB.EditableGridControlPbl') ||
                Mscrm.FeatureControl.get_Current().isFeatureEnabled('FCB.EditableGridControlJsEvents')) &&
            !_Script.isNullOrUndefined(Xrm.Page) &&
            !_Script.isNullOrUndefined(Xrm.Page.getControl(this.$J_1)) &&
            !_Script.isNullOrUndefined(Xrm.Page.getControl(this.$J_1).getGrid()) &&
            !_Script.isNullOrUndefined(Xrm.Page.getControl(this.$J_1).getGrid().getSelectedRows()) &&
            !_Script.isNullOrUndefined(Xrm.Page.getControl(this.$J_1).getGrid().getSelectedRows().get(0)) &&
            !_Script.isNullOrUndefined(Xrm.Page.getControl(this.$J_1).getGrid().getSelectedRows().get(0).getData()) &&
            !_Script.isNullOrUndefined(Xrm.Page.getControl(this.$J_1).getGrid().getSelectedRows().get(0).getData()
                .entity) &&
            !_Script.isNullOrUndefined(Xrm.Page.getControl(this.$J_1).getGrid().getSelectedRows().get(0).getData()
                .entity
                .attributes)) {
            if (!_Script.isNullOrUndefined(Xrm.Page.getControl(this.$J_1).getGrid().getSelectedRows().get(0).getData()
                .entity.attributes.get($p0))) {
                Xrm.Page.getControl(this.$J_1).getGrid().getSelectedRows().get(0).getData().entity.attributes.get($p0)
                    .fireOnChange();
            }
        }
        $v_0.stop();
...
Mscrm.DataSetRecordSelectionHelper = function(dataSetObject) {
    ...
    this.$E_1 = {};
    this.$N_1 = {};
    this.$7_1.addOnDataSetUpdated(this.$$d_$25_1);
}
Mscrm.DataSetRecordSelectionHelper.prototype = {
    ...
    dispose: function() {
        this.$7_1.removeOnDataSetUpdated(this.$$d_$25_1);
        this.$7_1 = null;
        this.$N_1 = null;
        this.$E_1 = null;
        Mscrm.NotifyPropertyChanged.prototype.dispose.call(this);
...
Mscrm.NotifyPropertyChanged.prototype = {
    ...
    get_$1b_0: function() {
        return this.$1D_0 || (this.$1D_0 = new Sys.EventHandlerList());
    },

    addEventHandler: function(eventName, eventHandler) {
        this.get_$1b_0().addHandler(eventName, eventHandler);
    },

    removeEventHandler: function(eventName, eventHandler) {
        this.get_$1b_0().removeHandler(eventName, eventHandler);
    },

    getHandler: function(eventName) {
        return this.get_$1b_0().getHandler(eventName);
    },
    ...
    dispose: function() {
        this.$1D_0 = new Sys.EventHandlerList();
    }
}
...
Mscrm.XrmControlDataSetWrapper.prototype = {
    ...
    getRows: function() {
        return this.$1z_1(false);
    },

    getSelectedRows: function() {
        return this.$1z_1(true);
    },
    ...
    $1z_1: function($p0) {
        ...
        var $v_2 = $p0 &&
            $v_1.length === 1 &&
            (Mscrm.FeatureControl.get_Current().isFeatureEnabled('FCB.EditableGridControlPbl') ||
                Mscrm.FeatureControl.get_Current().isFeatureEnabled('FCB.EditableGridControlJsEvents'));
        for (var $$arr_4 = $v_1, $$len_5 = $$arr_4.length, $$idx_6 = 0; $$idx_6 < $$len_5; ++$$idx_6) {
            var $v_3 = $$arr_4[$$idx_6];
...
Mscrm.XrmDataSetColumnControlWrapper.prototype = {
    ...
    getDisabled: function() {
        var $v_0 = true;
        if (!IsNull(this.$6_3)) {
            var $v_1 = this.$6_3.getFieldEditableProperty(this.$U_3.getName());
            if ($v_1) {
                $v_0 = false;
            }
        }
    ...
    setDisabled: function(isDisabled) {
        if (!IsNull(this.$6_3)) {
            this.$6_3.setFieldEditableProperty(this.$U_3.getName(), !isDisabled);
        }
    },

    clearNotification: function(uniqueId) {
        if (!IsNull(this.$6_3)) {
            this.$6_3.clearFieldErrorMessage(this.$U_3.getName());
            return true;
        }
        return false;
    },
    ...
    setNotification: function(message, uniqueId) {
        if (!IsNull(this.$6_3)) {
            this.$6_3.setFieldErrorMessage(this.$U_3.getName(), message);
            return true;
        }
        return false;
    },
...
Mscrm.XrmDataSetEntityAttributeWrapper.prototype = {
    ...
    getValue: function() {
        if (!IsNull(this.$6_1) && !IsNull(this.$1_1)) {
            ...
            } else if (this.$1_1.get_dataType().toLowerCase() === 'lookup.simple' ||
                this.$1_1.get_dataType().toLowerCase() === 'lookup.customer' ||
                this.$1_1.get_dataType().toLowerCase() === 'lookup.owner' ||
                this.$1_1.get_dataType().toLowerCase() === 'lookup.regarding') {
...
Mscrm.XrmDataSetEntityBooleanAttributeWrapper.prototype = {
    ...
    getOption: function(value) {
        ...
        if (!IsNull(this.$1_3) &&
            !IsNull(this.$1_3.get_attributeMetadata()) &&
            !IsNull(this.$1_3.get_attributeMetadata().get_optionSet()) &&
            !IsNull(this.$1_3.get_attributeMetadata().get_optionSet().get_options())) {
...
Mscrm.XrmDataSetEntityWrapper = function($p0, $p1, $p2) {
    ...
    if (!IsNull(this.$5_1) && !IsNull(this.$5_1.get_columns())) {
        for (var $$arr_3 = this.$5_1
            ...
            case 2:
                this.attributes.add(new Mscrm
                    .XrmDataSetEntityDateTimeAttributeWrapper(this.$5_1,
                        this.get_$1F_1(),
                        $v_0,
                        this.$4_1,
                        this,
            ...
            case 0:
                this.attributes.add(new Mscrm
                    .XrmDataSetEntityBooleanAttributeWrapper(this.$5_1,
                        this.get_$1F_1(),
                        $v_0,
                        this.$4_1,
                        this,
            ...
            case 13:
                this.attributes.add(new Mscrm
                    .XrmDataSetEntityOptionSetAttributeWrapper(this.$5_1,
                        this.get_$1F_1(),
                        $v_0,
                        this.$4_1,
                        this,
            ...
            default:
                this.attributes.add(new Mscrm
                    .XrmDataSetEntityAttributeWrapper(this.$5_1,
                        this.get_$1F_1(),
                        $v_0,
                        this.$4_1,
                        this,
...
Mscrm.XrmDataSetEntityWrapper.prototype = {
    ...
    get_$1F_1: function() {
        if (IsNull(this.$6_1) &&
            !IsNull(this.$5_1) &&
            !IsNull(this.$5_1.get_records()) &&
            !IsNull(((this.$K_1.Id) in this.$5_1.get_records()))) {
...
Mscrm.DataSetColumn.registerClass('Mscrm.DataSetColumn',
    null,
    Mscrm.IDataSetColumn,
    Sys.IDisposable,
    Microsoft.Crm.Client.Core.Framework.ICustomControlAttribute,
    Mscrm.IDataSetColumnEvent);
Mscrm.DataSetColumnValidator.registerClass('Mscrm.DataSetColumnValidator',
    null,
    Mscrm.IDataSetColumnValidator,
    Sys.IDisposable);
Mscrm.DataSetColumnValidatorResult.registerClass('Mscrm.DataSetColumnValidatorResult');
Mscrm.DataSetControl.registerClass('Mscrm.DataSetControl',
    Mscrm.CrmUIControl,
...
Mscrm.DataSetControlDataProvider.registerClass('Mscrm.DataSetControlDataProvider',
    null,
    Mscrm.IDataSetControlDataProvider);
Mscrm.DataSetControlErrorStatus.registerClass('Mscrm.DataSetControlErrorStatus');
Mscrm.DataSetControlFactory.registerClass('Mscrm.DataSetControlFactory',
    null,
    Mscrm.IDataSetControlFactory,
    Mscrm.IDataSetRecordFactory);
...
Mscrm.DataSetControlHost.registerClass('Mscrm.DataSetControlHost',
    Mscrm.NotifyPropertyChanged,
    Mscrm.IDataSetControlHost,
    Sys.IDisposable);
Mscrm.DataSetControlMode.registerClass('Mscrm.DataSetControlMode', null, Mscrm.IDataSetControlMode);
Mscrm.DataSetControlNavigationUtilities.registerClass('Mscrm.DataSetControlNavigationUtilities',
    null,
    Mscrm.IDataSetControlNavigationUtilities);
Mscrm.DataSetControlPropertyBag.registerClass('Mscrm.DataSetControlPropertyBag',
    Mscrm.NotifyPropertyChanged,
    Mscrm.IDataSetControlPropertyBag,
    Sys.IDisposable);
...
Mscrm.DataSetFieldAccessHelper.registerClass('Mscrm.DataSetFieldAccessHelper',
    Microsoft.Crm.Client.Core.Models.CustomControls.CustomControlAbstractFieldAccessHelper,
    Mscrm.IDataSetFieldAccessHelper,
...
Mscrm.DataSetObject.registerClass('Mscrm.DataSetObject',
    Mscrm.NotifyPropertyChanged,
    Mscrm.IDataSetObject,
    Mscrm.IDataSetObjectEvent,
    Sys.IDisposable);
Mscrm.DataSetLookup.registerClass('Mscrm.DataSetLookup',
    Mscrm.DataSetObject,
    Mscrm.IDataSetLookup,
    Mscrm.IDataSetObject,
    Mscrm.IDataSetObjectEvent,
    Sys.IDisposable);
...
Mscrm.DataSetRecord.registerClass('Mscrm.DataSetRecord',
    Mscrm.NotifyPropertyChanged,
    Mscrm.IDataSetRecord,
    Sys.IDisposable);
Mscrm.DataSetRecordSelectionHelper.registerClass('Mscrm.DataSetRecordSelectionHelper',
    Mscrm.NotifyPropertyChanged,
    Mscrm.IDataSetRecordSelectionHelper,
    Sys.IDisposable);
...
Mscrm.XrmDataSetEntityAttributeWrapper.registerClass('Mscrm.XrmDataSetEntityAttributeWrapper',
    Xrm.XrmEntityAttribute,
    Xrm.Interfaces.IXrmDataSetColumn);
Mscrm.XrmDataSetEntityBooleanAttributeWrapper.registerClass('Mscrm.XrmDataSetEntityBooleanAttributeWrapper',
    Xrm.XrmEntityAttributeBoolean,
    Xrm.Interfaces.IXrmDataSetColumn);
Mscrm.XrmDataSetEntityDateTimeAttributeWrapper
    .registerClass('Mscrm.XrmDataSetEntityDateTimeAttributeWrapper',
        Xrm.XrmEntityAttributeDateTime,
        Xrm.Interfaces.IXrmDataSetColumn);
Mscrm.XrmDataSetEntityOptionSetAttributeWrapper
    .registerClass('Mscrm.XrmDataSetEntityOptionSetAttributeWrapper',
        Xrm.XrmEntityAttributeOptionSet,
        Xrm.Interfaces.IXrmDataSetColumn);
Mscrm.XrmDataSetEntityWrapper.registerClass('Mscrm.XrmDataSetEntityWrapper',
    Xrm.XrmEntity,
    Xrm.Interfaces.IXrmDataSetRecord);
...
Mscrm.DataSetControlDataProvider.$1H = null;
