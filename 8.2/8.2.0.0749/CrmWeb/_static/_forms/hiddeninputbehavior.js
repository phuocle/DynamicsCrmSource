...
Mscrm.FormInputControl.HiddenInputBehavior = function(element) {
    Mscrm.FormInputControl.HiddenInputBehavior.initializeBase(this, [element])
};
Mscrm.FormInputControl.HiddenInputBehavior.prototype = {
    $0_4: null,
    initialize: function() {
        Mscrm.FormControlInputBehavior.prototype.initialize.call(this);
        this.$0_4 = IsNull(this.get_element().getAttribute("value")) ? "" : this.get_element().getAttribute("value")
    },
    get_isDirty: function() { return this.$0_4 !== this.get_elementValue() },
    get_defaultValue: function() { return this.$0_4 },
    set_defaultValue: function(value) {
        this.$0_4 = value;
        return value
    },
    get_attributeType: function() { return this.get_element().getAttribute("attrType") },
...
Mscrm.FormInputControl.HiddenInputBehavior.registerClass("Mscrm.FormInputControl.HiddenInputBehavior",
