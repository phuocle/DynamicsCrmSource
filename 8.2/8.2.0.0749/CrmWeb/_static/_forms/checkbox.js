...
Mscrm.FormInputControl.CheckBoxInputBehavior = function(element) {
    ...
    Mscrm.FormInputControl.CheckBoxInputBehavior.initializeBase(this, [element])
};
Mscrm.FormInputControl.CheckBoxInputBehavior.prototype = {
    ...
    get_isDirty: function() { return this.$0_4 !== this.get_dataValue() },
    get_dataXml: function() {
        var $v_0 = this.get_dataValue(), $v_1 = this.get_element().id;
        return String.format("<{0}>{1}</{0}>", $v_1, $v_0 ? "1" : "0")
    },
    get_dataValue: function() { return this.get_element().checked },
    ...
    dispose: function() {
        ...
        !IsNull(this.get_element()) && $removeHandler(this.get_element(), "change", this.$$d_$1_4);
    ...
    $1_4: function($p0) { this.handleDataValueChangedEvent() }
};
Mscrm.FormInputControl.CheckBoxInputBehavior.registerClass("Mscrm.FormInputControl.CheckBoxInputBehavior",
