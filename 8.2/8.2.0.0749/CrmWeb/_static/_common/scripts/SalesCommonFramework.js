...
Sales.Common.Framework.List$1.prototype = {
    ...
    filter: function(callback) {
        return new (Sales.Common.Framework.List$1.$$(this
            .$$gta['Sales.Common.Framework.List$1']['T']))(_Array
            .filter(this.$$gta['Sales.Common.Framework.List$1']['T'], this.$0_0, callback));
    },
...
function parseQueryString(windowLocation) {
    if (Sales.Common.Framework.JsTypes.isNull(windowLocation) ||
        Sales.Common.Framework.JsTypes.isNull(windowLocation.search) ||
        !windowLocation.search.length) {
        return {};
    }
...
function _Nullable$1(value) {
    this.$2_0 = ((this.$$gta['_Nullable$1']['T'] === Number || Type.isEnum(this.$$gta['_Nullable$1']['T']))
        ? 0
        : (this.$$gta['_Nullable$1']['T'] === Boolean) ? false : null);
    this.$2_0 = value;
}
...
_String.format = function(format, arg0, arg1, arg2, arg3, arg4, arg5) {
    if (_String.isUndefined(arg0) &&
        _String.isUndefined(arg1) &&
        _String.isUndefined(arg2) &&
        _String.isUndefined(arg3) &&
        _String.isUndefined(arg4) &&
        _String.isUndefined(arg5)) {
        return format;
    }
...
Sales.Common.Framework.Loaders.ConcurrentContentLoader.prototype = {
    ...
    $8_1: function($p0, $p1, $p2) {
        ...
        Sales.Common.Framework.Loaders.ContentLoader.prototype.loadContent
            .call(this, $p1, $p2, $p0.$$d_setResult, $p0.$$d_setError);
    },
...
Sales.Common.Framework.Loaders.ConcurrentContentLoaderData
    .registerClass('Sales.Common.Framework.Loaders.ConcurrentContentLoaderData');
Sales.Common.Framework.Loaders.ContentLoader.registerClass('Sales.Common.Framework.Loaders.ContentLoader');
Sales.Common.Framework.Loaders.ConcurrentContentLoader
    .registerClass('Sales.Common.Framework.Loaders.ConcurrentContentLoader',
        Sales.Common.Framework.Loaders.ContentLoader,
        Sys.IDisposable);
