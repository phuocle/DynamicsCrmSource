                        ...
                        if (innermostIntersecting) {
                            ...
                            if (!this.instance.isOver) {
                                ...
                                this.instance.currentItem = $(that).clone().removeAttr("id")
                                    .appendTo(this.instance.element).data("ui-sortable-item", true);
                                ...
                                this.instance.offset.parent
                                    .left -= inst.offset.parent.left - this.instance.offset.parent.left;
                                this.instance.offset.parent
                                    .top -= inst.offset.parent.top - this.instance.offset.parent.top;
...
(function($, undefined) {
    ...
    $.ui.intersect = function(draggable, droppable, toleranceMode) {
        ...
        case "pointer":
            draggableLeft = ((draggable.positionAbs || draggable.position.absolute).left +
            ...
            _create: function() {
                ...
                if (this.element[0].nodeName.match(/canvas|textarea|input|select|button|img/i)) {
                    ...
                    this._proportionallyResizeElements.push(this.originalElement
                        .css({ position: "static", zoom: 1, display: "block" }));
            ...
            _proportionallyResize: function() {
                ...
                for (i = 0; i < this._proportionallyResizeElements.length; i++) {
                    ...
                    if (!this.borderDif) {
                        this.borderDif = [];
                        borders = [
                            prel.css("borderTopWidth"), prel.css("borderRightWidth"), prel.css("borderBottomWidth"),
                            prel.css("borderLeftWidth")
                        ];
                        paddings = [
                            prel.css("paddingTop"), prel.css("paddingRight"), prel.css("paddingBottom"), prel
                            .css("paddingLeft")
                        ];
    ...
    $.ui.plugin.add("resizable",
        "containment",
        {
            ...
            resize: function(event) {
                ...
                woset = Math.abs((that._helper ? that.offset.left - cop.left : (that.offset.left - cop.left)) +
                    that.sizeDiff.width);
...
//Execute the drag once - this causes the helper not to be visible before getting its correct position
            ...
            _intersectsWithSides: function(item) {
                ...
                var isOverBottomHalf = isOverAxis(this.positionAbs.top + this.offset.click.top,
...
//Trigger update callback if the DOM position has changed
                ...
                for (i = this.containers.length - 1; i >= 0; i--) {
                    if (!noPropagation) {
                        delayedTriggers.push((function(c) {
                            return function(event) { c._trigger("deactivate", event, this._uiHash(this)); };
                        }).call(this, this.containers[i]));
                    }
                    if (this.containers[i].containerCache.over) {
                        delayedTriggers.push((function(c) {
                            return function(event) { c._trigger("out", event, this._uiHash(this)); };
                        }).call(this, this.containers[i]));
                        this.containers[i].containerCache.over = 0;
                    }
                }
    ...
    function bindHover(dpDiv) {
        ...
        return dpDiv.delegate(selector,
            ...
            .delegate(selector,
                ...
                function() {
                    if (!$.datepicker
                        ._isDisabledDatepicker(instActive.inline ? dpDiv.parent()[0] : instActive.input[0])) {
