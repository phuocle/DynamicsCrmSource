...
(function(MscrmCommon) {
    ...
    var CommonControl = (function() {
        ...
        Object.defineProperty(CommonControl.prototype,
        ...
        CommonControl.prototype.init = function(container, notifyOutputChanged, context, state, valueContainer) {
            ...
            if (MscrmCommon.ControlUtils.Object.isNullOrUndefined(notifyOutputChanged)) {
                MscrmCommon.ErrorHandling.ExceptionHandler
                    .throwException(CommonControl.NullOrUndefinedInitNotifyOutputChangedDelegate);
            }
        ...
        CommonControl.prototype.createWrapperContainer = function(className) {
            ...
            if (MscrmCommon.ControlUtils.Object.isNullOrUndefined(this.container)) {
                MscrmCommon.ErrorHandling.ExceptionHandler
                    .throwException(MscrmCommon.CommonControl.NullOrUndefinedInitContainer);
            }
        ...
        CommonControl.prototype.initCore = function(context, state) {
            MscrmCommon.ErrorHandling.ExceptionHandler
                .throwException(MscrmCommon.ControlUtils.String
                    .Format(CommonControl.MethodNotOverridenFormat, "initCore"));
        };
        /**
        ...
        CommonControl.prototype.updateCore = function(context) {
            MscrmCommon.ErrorHandling.ExceptionHandler
                .throwException(MscrmCommon.ControlUtils.String
                    .Format(CommonControl.MethodNotOverridenFormat, "updateCore"));
        };
        /**
        ...
        CommonControl.prototype.destroyCore = function() {
            MscrmCommon.ErrorHandling.ExceptionHandler
                .throwException(MscrmCommon.ControlUtils.String
                    .Format(CommonControl.MethodNotOverridenFormat, "destroyCore"));
        };
        /**
        ...
        CommonControl.prototype.getOutputsCore = function() {
            MscrmCommon.ErrorHandling.ExceptionHandler
                .throwException(MscrmCommon.ControlUtils.String
                    .Format(CommonControl.MethodNotOverridenFormat, "getOutputsCore"));
            return null;
        };
        /**
            ...
            "valueContainer",
            {
                ...
                get: function() {
                    if (MscrmCommon.ControlUtils.Object.isNullOrUndefined(this.valueContainerElement)) {
                        MscrmCommon.ErrorHandling.ExceptionHandler
                            .throwException(CommonControl.NullOrUndefinedInitValueContainer);
                    }
        ...
        */
        CommonControl.prototype.initializeControl = function(context, state) {
            try {
                this.throwIfPropertyBagNotValid(context);
                this.notificationHandler = new MscrmCommon.ErrorHandling
                    .NotificationHandler(context.utils.setNotification, context.utils.clearNotification);
        ...
        */
        ...
        CommonControl.prototype.throwIfPropertyBagNotValid = function(context) {
            ...
            if (MscrmCommon.ControlUtils.Object.isNullOrUndefined(context.parameters)) {
                MscrmCommon.ErrorHandling.ExceptionHandler
                    .throwException(MscrmCommon.ControlUtils.String
                        .Format(MscrmCommon.CommonControl.InvalidDataBagKeyFormat, "dataBag.parameters"));
            }
            if (MscrmCommon.ControlUtils.Object.isNullOrUndefined(context.utils)) {
                MscrmCommon.ErrorHandling.ExceptionHandler
                    .throwException(MscrmCommon.ControlUtils.String
                        .Format(MscrmCommon.CommonControl.InvalidDataBagKeyFormat, "dataBag.utils"));
            }
            if (MscrmCommon.ControlUtils.Object.isNullOrUndefined(context.utils.setNotification)) {
                MscrmCommon.ErrorHandling.ExceptionHandler
                    .throwException(MscrmCommon.ControlUtils.String
                        .Format(MscrmCommon.CommonControl.InvalidDataBagKeyFormat, "dataBag.utils.setNotification"));
            }
            if (MscrmCommon.ControlUtils.Object.isNullOrUndefined(context.utils.clearNotification)) {
                MscrmCommon.ErrorHandling.ExceptionHandler
                    .throwException(MscrmCommon.ControlUtils.String
                        .Format(MscrmCommon.CommonControl.InvalidDataBagKeyFormat, "dataBag.utils.clearNotification"));
            }
            if (MscrmCommon.ControlUtils.Object.isNullOrUndefined(context.utils.openInBrowser)) {
                MscrmCommon.ErrorHandling.ExceptionHandler
                    .throwException(MscrmCommon.ControlUtils.String
                        .Format(MscrmCommon.CommonControl.InvalidDataBagKeyFormat, "dataBag.utils.openInBrowser"));
            }
            if (MscrmCommon.ControlUtils.Object.isNullOrUndefined(context.utils.getServiceUri)) {
                MscrmCommon.ErrorHandling.ExceptionHandler
                    .throwException(MscrmCommon.ControlUtils.String
                        .Format(MscrmCommon.CommonControl.InvalidDataBagKeyFormat, "dataBag.utils.getServiceUri"));
            }
            if (MscrmCommon.ControlUtils.Object.isNullOrUndefined(context.mode)) {
                MscrmCommon.ErrorHandling.ExceptionHandler
                    .throwException(MscrmCommon.ControlUtils.String
                        .Format(MscrmCommon.CommonControl.InvalidDataBagKeyFormat, "dataBag.mode"));
            }
            if (MscrmCommon.ControlUtils.Object.isNullOrUndefined(context.mode.isControlDisabled)) {
                MscrmCommon.ErrorHandling.ExceptionHandler
                    .throwException(MscrmCommon.ControlUtils.String
                        .Format(MscrmCommon.CommonControl.InvalidDataBagKeyFormat, "dataBag.mode.isControlDisabled"));
            }
            if (MscrmCommon.ControlUtils.Object.isNullOrUndefined(context.mode.isRead)) {
                MscrmCommon.ErrorHandling.ExceptionHandler
                    .throwException(MscrmCommon.ControlUtils.String
                        .Format(MscrmCommon.CommonControl.InvalidDataBagKeyFormat, "dataBag.mode.isRead"));
            }
            if (MscrmCommon.ControlUtils.Object.isNullOrUndefined(context.mode.isPreview)) {
                MscrmCommon.ErrorHandling.ExceptionHandler
                    .throwException(MscrmCommon.ControlUtils.String
                        .Format(MscrmCommon.CommonControl.InvalidDataBagKeyFormat, "dataBag.mode.isPreview"));
            }
            if (MscrmCommon.ControlUtils.Object.isNullOrUndefined(context.utils)) {
                throw MscrmCommon.ControlUtils.String
                    .Format(MscrmCommon.CommonControl.InvalidDataBagKeyFormat, "dataBag.utils");
            }
            if (MscrmCommon.ControlUtils.Object.isNullOrUndefined(context.utils.crmHtmlEncode)) {
                throw MscrmCommon.ControlUtils.String
                    .Format(MscrmCommon.CommonControl.InvalidDataBagKeyFormat, "dataBag.utils.crmHtmlEncode");
            }
        };
        /**
        ...
        CommonControl.prototype.addPanoramaEventsHandlers = function() {
            var _this = this;
            $(this.container).on(CommonControl.PointerDownEventName,
                function(event) {
                    if (_this.isEnabled) {
            ...
            $(this.container).on(CommonControl.PointerMoveEventName,
                function(event) {
                    if (_this.isEnabled) {
                        event.stopPropagation();
                    }
                });
            $(this.container).on(CommonControl.PointerUpEventName,
                function(event) {
                    if (_this.isEnabled) {
                        _this.disablePanoramaScroll(false);
                    }
                });
            $(this.container).on(CommonControl.TouchEndEventName,
                function(event) {
        ...
        CommonControl
            .NullOrUndefinedInitNotifyOutputChangedDelegate = "Null or undefined NotifyOutputChanged delegate.";
        ...
        CommonControl
            .InvalidInputParamStep =
            "Step parameter should be greater than 0 and less than the interval bound by min and max.";
...
(function(MscrmCommon) {
    ...
    var EventGuard = (function() {
        ...
        EventGuard.prototype.preventClicksUntilUserInteracted = function() {
            ...
            $(this.container).on(EventGuard.hasUserInteractedEventName,
                function(e) {
        ...
        EventGuard.prototype.preventEditModeTransitionFocus = function() {
            ...
            inputElements.each(function(index, element) {
                ...
                if (_this.userAgent.isAndroid) {
                    $(element).on(EventGuard.focusRemoveEvent,
                        function(e) {
                            $(element).blur();
                ...
                $(element).on(EventGuard.hasUserInteractedWithElementEventName,
                    function(e) {
        ...
        EventGuard.prototype.preventMultipleEventTypes = function() {
            ...
            var removalCallback = function() {
                ...
                _this.container.removeEventListener(MscrmCommon.EventConstants
                    .Click,
                    resetMultipleEventTypeFlags,
                    true);
            };
    ...
    (function(ControlUtils) {
        ...
        */
        var HitTarget = (function() {
             ...
             */
            HitTarget.create = function(container,
                controlDomElement,
                hitTargetClass,
                trackElementClassSelector,
                paddingLeftPx,
                min,
                max,
                setControlValue) {
                ...
                var setValue = function(event) {
                    ...
                    var isClickInsideContainer = $(event.target).hasClass(controlDomElement[0].className) ||
                        $(event.target).hasClass(hitTargetClass);
                    ...
                    if (xAxisDisplacementPercent <= 1) {
                        ...
                        var newValue = ControlUtils.NumericInterval
                            .trunc(min + (controlNumericRange * xAxisDisplacementPercent));
                    ...
                    if (event.type === MscrmCommon.EventConstants.PointerDown) {
                        ...
                        $(document).on(HitTarget.mouseUpHitTargetEventName,
                            function(e) {
                ...
                hitTargetElement.on(MscrmCommon.EventConstants.TouchEnd,
                    function(event) {
        ...
        var NumericInterval = (function() {
            ...
            NumericInterval.throwIfNullDataBagParameters = function(context, hasStep) {
                ...
                if (ControlUtils.Object.isNullOrUndefined(context.parameters.value)) {
                    MscrmCommon.ErrorHandling.ExceptionHandler
                        .throwException(ControlUtils.String
                            .Format(MscrmCommon.CommonControl.InvalidDataBagKeyFormat, "value"));
                }
                if (ControlUtils.Object.isNullOrUndefined(context.parameters.value.attributes.minValue)) {
                    MscrmCommon.ErrorHandling.ExceptionHandler
                        .throwException(ControlUtils.String
                            .Format(MscrmCommon.CommonControl.InvalidDataBagKeyFormat, "value.attributes.minValue"));
                }
                if (ControlUtils.Object.isNullOrUndefined(context.parameters.value.attributes.maxValue)) {
                    MscrmCommon.ErrorHandling.ExceptionHandler
                        .throwException(ControlUtils.String
                            .Format(MscrmCommon.CommonControl.InvalidDataBagKeyFormat, "value.attributes.maxValue"));
                }
                if (hasStep && ControlUtils.Object.isNullOrUndefined(context.parameters.step)) {
                    MscrmCommon.ErrorHandling.ExceptionHandler
                        .throwException(ControlUtils.String
                            .Format(MscrmCommon.CommonControl.InvalidDataBagKeyFormat, "step"));
                }
                if (ControlUtils.Object.isNullOrUndefined(context.parameters.min)) {
                    MscrmCommon.ErrorHandling.ExceptionHandler
                        .throwException(ControlUtils.String
                            .Format(MscrmCommon.CommonControl.InvalidDataBagKeyFormat, "min"));
                }
                if (ControlUtils.Object.isNullOrUndefined(context.parameters.max)) {
                    MscrmCommon.ErrorHandling.ExceptionHandler
                        .throwException(ControlUtils.String
                            .Format(MscrmCommon.CommonControl.InvalidDataBagKeyFormat, "max"));
                }
            };
            /**
            ...
            NumericInterval.processPropertyBagValues = function(context, notificationHandler, roundValues) {
                ...
                if (value.raw < min.raw || value.raw > max.raw) {
                    var messageFormat = context.resources
                        .getString(MscrmCommon.ErrorHandling.ErrorCode.ValueOutOfRangeId);
            ...
            NumericInterval.moveValueToMultipleOfStep = function(value, context) {
                if (Math.abs(value - context.parameters.min.raw) % context.parameters.step.raw !== 0 &&
                    value !== context.parameters.max.raw) {
                    var stepsAfterMinimum = Math.floor(Math.abs(value - context.parameters.min.raw) /
                        context.parameters.step.raw);
            ...
            NumericInterval.getFormattedValue = function(value) {
                ...
                if (MscrmCommon.ControlUtils.Object.isNullOrUndefined(formattedValue) ||
                    ...
                    formattedValue = !MscrmCommon.ControlUtils.Object.isNullOrUndefined(rawValue)
                        ? rawValue.toString()
                        : MscrmCommon.ControlUtils.String.Empty;
                }
            ...
            */
            NumericInterval.isPercent = function(formattedValue) {
                return !MscrmCommon.ControlUtils.Object.isNullOrUndefined(formattedValue) &&
        ...
        var WijmoGlobalization = (function() {
            ...
            */
            WijmoGlobalization.getFormat = function(context) {
                ...
                var formattedValue = MscrmCommon.ControlUtils.NumericInterval
                    .getFormattedValue(context.parameters.value);
                ...
                var overriddenPrecision = MscrmCommon.ControlUtils.NumericInterval
                    .getPrecision(context.parameters.value);
                WijmoGlobalization
                    .setWijmoNumberFormatStructure(numberFormattingInfo, crmNumberType, isPercent, overriddenPrecision);
                var valueFormat = MscrmCommon.Globalization.WijmoNumberFormatFactory
                    .getNumberFormatString(numberFormattingInfo, crmNumberType, isPercent, overriddenPrecision);
                return valueFormat;
            };
            /**
            ...
            */
            WijmoGlobalization
                .setWijmoNumberFormatStructure = function(crmNumberFormat, numberType, isPercent, overriddenPrecision) {
                    var wijmoNumberFormat = MscrmCommon.Globalization.WijmoNumberFormatFactory
                        .getWijmoNumberFormatStructure(crmNumberFormat, numberType, isPercent, overriddenPrecision);
...
(function(MscrmCommon) {
    ...
    var FullscreenHelper = (function() {
        ...
        Object.defineProperty(FullscreenHelper,
        ...
        */
        var NumberPatternFactory = (function() {
            function NumberPatternFactory() {
                ...
                this.currencyNegativePatternArray = [
                    "($n)", "-$n", "$-n", "$n-", "(n$)", "-n$", "n-$", "n$-", "-n $", "-$ n", "n $-", "$ n-", "$ -n",
                    "n- $", "($ n)", "(n $)"
                ];
                this.percentPositivePatternArray = ["n %", "n%", "%n", "% n"];
                this.percentNegativePatternArray = [
            ...
            NumberPatternFactory.prototype.getPattern = function(patternArray, patternValue) {
                if (patternValue < 0 || patternValue >= patternArray.length) {
                    ExceptionHandler.throwException(MscrmCommon.ControlUtils.String
                        .Format(NumberPatternFactory.NoSuchPatternError, patternValue));
                }
                return patternArray[patternValue];
            };
            NumberPatternFactory
                .NoSuchPatternError = "The number formatting pattern value that you specified does not exist: {0}.";
    ...
    (function(Globalization) {
        ...
        */
        var WijmoNumberFormatFactory = (function() {
             ...
             */
            WijmoNumberFormatFactory
                .getWijmoNumberFormatStructure = function(numberFormatInfo,
                    crmNumberType,
                    isPercent,
                    overriddenPrecision) {
                    ...
                    var percentNegativePattern = patternFactory
                        .getPercentNegativePattern(numberFormatInfo.PercentNegativePattern);
                    var percentPositivePattern = patternFactory
                        .getPercentPositivePattern(numberFormatInfo.PercentPositivePattern);
                    var currencyNegativePattern = patternFactory
                        .getCurrencyNegativePattern(numberFormatInfo.CurrencyNegativePattern);
                    var currencyPositivePattern = patternFactory
                    ...
                    return {
                        ...
                        currency: {
                            decimals: !MscrmCommon.ControlUtils.Object.isNullOrUndefined(overriddenPrecision)
                                ? overriddenPrecision
             ...
             */
            WijmoNumberFormatFactory
                .getNumberFormatString = function(numberFormatInfo, crmNumberType, isPercent, overriddenPrecision) {
                    crmNumberType = crmNumberType.toLowerCase();
                    if (isPercent) {
                        return "p" +
                        (!MscrmCommon.ControlUtils.Object.isNullOrUndefined(overriddenPrecision)
                            ? overriddenPrecision.toString()
                            : numberFormatInfo.PercentDecimalDigits.toString());
                    }
                    ...
                    default:
                        ...
                        (!MscrmCommon.ControlUtils.Object.isNullOrUndefined(overriddenPrecision)
                            ? overriddenPrecision.toString()
                            : numberFormatInfo.NumberDecimalDigits.toString());
                    }
                };
            WijmoNumberFormatFactory.validateSymbolLength = function(value, maxLength) {
                if (!MscrmCommon.ControlUtils.Object.isNullOrUndefined(value) && value.length > maxLength) {
                    MscrmCommon.ErrorHandling.ExceptionHandler
                        .throwException(WijmoNumberFormatFactory.InvalidSymbolErrorMessage);
                }
                return value;
            };
            WijmoNumberFormatFactory
                .InvalidSymbolErrorMessage =
                "An invalid symbol has been provided by the number formatting information infrastructure.";
