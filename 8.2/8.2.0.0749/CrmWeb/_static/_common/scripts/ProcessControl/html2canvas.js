 ...
 */
    ...
    (function() {
        ...
        function K(a, b, c) {
            r(function(a) {
                    var e = !1,
                        f = J(c,
                            b,
                            function(c) { e || (e = !0, b !== c ? q(a, c) : m(a, c)) },
                            function(b) { e || (e = !0, g(a, b)) });
                    !e && f && (e = !0, g(a, f))
                },
                a)
        }
        ...
        function L(a, b) {
            1 === b.a
                ? m(a, b.b)
                : 2 === a.a ? g(a, b.b) : u(b, void 0, function(b) { q(a, b) }, function(b) { g(a, b) })
        }
        ...
        function N(a, b) {
            try {
                b(function(b) { q(a, b) }, function(b) { g(a, b) })
            } catch (c) {
                g(a, c)
            }
        }
        ...
        function k(a, b, c, d) {
            ...
            this.i = c;
            this.o(b)
                ? (this.m = b, this.d = this.length = b.length, this.l(), 0 === this.length
                    ? m(this.c,
                        this.b)
        ...
        k.prototype.j = function(a, b) {
            ...
            "object" === typeof a && null !== a
                ? a.constructor === c && void 0 !== a.a ? (a.f = null, this.g(a.a, b, a.b)) : this.q(c.resolve(a), b)
        ...
        var z = {
            ...
            polyfill: function() {
                var a;
                a = "undefined" !== typeof global
                    ? global
                    : "undefined" !== typeof window && window.document ? window : self;
                "Promise" in a &&
                    "resolve" in
                    a.Promise &&
                    "reject" in a.Promise &&
...
/*! https://mths.be/punycode v1.3.1 by @mathias */
    ...
    window.html2canvas = function(nodeList, options) {
        ...
        if (typeof(nodeList) === "string") {
            ...
            return loadUrlDocument(absoluteUrl(nodeList), options.proxy, document, width, height, options)
        ...
        return renderDocument(node.ownerDocument,
            options,
            options.width !== undefined ? options.width : node.ownerDocument.defaultView.innerWidth,
            options.height !== undefined ? options.height : node.ownerDocument.defaultView.innerHeight,
    ...
    function renderDocument(document, options, windowWidth, windowHeight, html2canvasIndex) {
        return createWindowClone(document,
            document,
            windowWidth,
            windowHeight,
            options,
    ...
    function renderWindow(node, container, options, windowWidth, windowHeight) {
        ...
        $(node.firstChild).css('float', 'left');
...
// https://github.com/niklasvh/html2canvas/issues/503
    ...
    function cloneCanvasContents(ownerDocument, documentClone) {
        [].slice.call(ownerDocument.querySelectorAll("[" + html2canvasCanvasCloneAttribute + "]"), 0)
            .forEach(function(canvas) {
                try {
                    var clonedCanvas = documentClone
                        .querySelector('[' +
                    ...
                    if (clonedCanvas) {
                        ...
                        clonedCanvas.getContext("2d")
                            .putImageData(canvas.getContext("2d")
...
// JSON.stringify([].slice.call($$('.named-color-table tr'), 1).map(function(row) { return [row.childNodes[3].textContent, row.childNodes[5].textContent.trim().split(",").map(Number)] }).reduce(function(data, row) {data[row[0]] = row[1]; return data}, {}))
    ...
    ImageLoader.prototype.timeout = function(container, timeout) {
        ...
        var promise = Promise.race([
            container.promise, new Promise(function(res, reject) {
        ...
        this.colorStops.forEach(function(colorStop, index) {
                if (colorStop.stop === null) {
                    this.colorStops.slice(index).some(function(find, count) {
                            if (find.stop !== null) {
                                colorStop.stop = ((find.stop - this.colorStops[index - 1].stop) / (count + 1)) +
    ...
    LinearGradientContainer.prototype
        .stepRegExp = /((?:rgb|rgba)\(\d{1,3},\s\d{1,3},\s\d{1,3}(?:,\s[0-9\.]+)?\))\s*(\d{1,3})?(%|px)?/;

    function log() {
        if (window.html2canvas.logging && window.console && window.console.log) {
            Function.prototype.bind.call(window.console.log, (window.console))
                .apply(window.console,
                    [(Date.now() - window.html2canvas.start) + "ms", "html2canvas:"]
    ...
    NodeParser.prototype.getChildren = function(parentContainer) {
        return flatten([].filter.call(parentContainer.node.childNodes, renderableNode).map(function(node) {
                ...
                return node.nodeType === Node.ELEMENT_NODE && container.length && node.tagName !== "TEXTAREA"
                    ? (container[0].isElementVisible() ? container.concat(this.getChildren(container[0])) : [])
                    : container;
            },
            this));
    };
    ...
    NodeParser.prototype.parse = function(stack) {
        ...
        var negativeZindex = stack.contexts
            .filter(negativeZIndex); // 2. the child stacking contexts with negative stack levels (most negative first).
        ...
        var nonPositionedFloats = descendantElements.filter(not(isPositioned))
            .filter(isFloating); // 4. the non-positioned floats.
        var inFlow = descendantNonFloats.filter(not(isPositioned))
            .filter(inlineLevel);
...
// 6. the child stacking contexts with stack level 0 and the positioned descendants with stack level 0.
        ...
        var positiveZindex = stack.contexts
            .filter(positiveZIndex);
// 7. the child stacking contexts with positive stack levels (least positive first).
    ...
    NodeParser.prototype.paintCheckbox = function(container) {
        ...
        this.renderer.clip(container.backgroundClip,
            function() {
                this.renderer.rectangle(bounds.left + 1,
                    bounds.top + 1,
                    bounds.width - 2,
                    bounds.height - 2,
                    new Color("#DEDEDE"));
    ...
    NodeParser.prototype.paintRadio = function(container) {
        ...
        this.renderer.clip(container.backgroundClip,
            function() {
                this.renderer.circleStroke(bounds.left + 1,
                    bounds.top + 1,
                    size,
                    new Color('#DEDEDE'),
                    1,
    ...
    NodeParser.prototype.paintText = function(container) {
        ...
        this.renderer.clip(container.parent.clip,
            function() {
                textList.map(this.parseTextBounds(container), this).forEach(function(bounds, index) {
                        if (bounds) {
                            this.renderer.text(textList[index], bounds.left, bounds.bottom);
                            this.renderTextDecoration(container.parent,
                                bounds,
    ...
    function calculateCurvePoints(bounds, borderRadius, borders) {
        ...
        return {
            ...
            topLeftInner: getCurvePoints(x + borders[3].width,
                y + borders[0].width,
            ...
            bottomLeftInner: getCurvePoints(x + borders[3].width,
                y + leftHeight,
    ...
    function zIndexSort(contexts) {
        return function(a, b) {
            return (a.cssInt("zIndex") + (contexts.indexOf(a) / contexts.length)) -
 ...
 */
    ...
    CanvasRenderer.prototype
        .backgroundRepeatShape = function(imageContainer,
            backgroundPosition,
            size,
            bounds,
            left,
    ...
    CanvasRenderer.prototype
        .renderBackgroundRepeat = function(imageContainer, backgroundPosition, size, bounds, borderLeft, borderTop) {
