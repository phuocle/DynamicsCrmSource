            ...
            var DateTimeEditView = (function(_super) {
                ...
                DateTimeEditView.prototype.updateDateTime = function(event) {
                    ...
                    if (this.inlineControlView.get_validateResult().isValid) {
                        ...
                        if (dateTimeStr != null) {
                            var dateTimeGMT = ProcessControl.Configuration.BPFClientProxy
                ...
                DateTimeEditView.prototype.initializeInlineControl = function() {
                    ...
                    var element = ProcessControl.Configuration.BPFClientProxy
                    ...
                    if (this.get() != null && this.get() != "" && this.get() != " ") {
                        if (this.isTimeRendered) {
                            ...
                            initialDateTime = ProcessControl.Configuration.BPFClientProxy
                                .parseDateInvariant(this.get());
                        }
                    }
                    this.inlineControlView = ProcessControl.Configuration.BPFClientProxy
                        ...
                        _.each(pickListValues,
                            function(item) {
                                var checked = (self.selectedValues.indexOf(item.pickListValueOrderId.toString()) >= 0)
                                    ...
                                    : '';
                                self.$el
                                    .append("<div><input id='prop-picklistValue' class='prop-picklist-checkbox' tabindex='" + Util.tabIndexValue + "' type='checkbox' value='" + item.pickListValueOrderId + "' " + checked + "><span class='headline2'>" + GenericWorkflowDesigner.CrmEncodeDecode.CrmHtmlEncode(item.pickListValue) + '</span></div>');
                            });
                            ...
                            if (isNumber) {
                                ...
                                case AttributeType.Money:
                                    if (!Util.isNull(value) &&
                                        ...
                                        if (!Util.isNull(MetadataProxy.SourceAttributesMap[model
                                            .entityLogicalName][model.getAttribute()])) {
                                            var precision = MetadataProxy.SourceAttributesMap[model
                                            ...
                                            value = Mscrm.NumberUtility
                                                .addFormatting(parseFloat(value.trim()), precision);
                                            self.$el.val(value);
                                        }
                                    }
                                    break;
    ...
    (function(ConditionPropertyPage) {
        ...
        var ConditionExpressionModel = (function(_super) {
            ...
            ConditionExpressionModel.prototype.setAttribute = function(value) {
                ...
                if (ConditionExpressionModel.isLookupType(MetadataProxy
                    .getAttributeType(value, this.entityLogicalName))) {
            ...
            ConditionExpressionModel.prototype.setOperator = function(value) {
                ...
                } else if (ConditionExpressionModel
                    .isStatusType(MetadataProxy.getAttributeType(exp._attribute, this.entityLogicalName)) &&
            ...
            ConditionExpressionModel.prototype.setType = function(value) {
                ...
                if (value == ConditionPropertyPage.ValueType.Attribute) {
                    ...
                    if (ConditionExpressionModel
                        .isLookupType(MetadataProxy.getAttributeType(exp._attribute, this.entityLogicalName))) {
                        exp._value._lookupEntityType = null;
                        exp._value._lookupLabel = null;
                    }
            ...
            ConditionExpressionModel.prototype.getExpressionText = function() {
                ...
                try {
                    ...
                    var entityName = (ConditionPropertyPage.isTaskFlow && typeof exp._entity != "undefined")
                        ? exp._entity.get_entityName()
                        : this.entityLogicalName;
                    text = MetadataProxy.SourceAttributesMap[entityName][exp._attribute].displayName +
                        ' ' +
                        operatorText +
                        ' ';
                    if (exp._value) {
                        if (exp._value._isFormula) {
                            var rightEntityName = (ConditionPropertyPage.isTaskFlow &&
                                    exp._value._formula._rightEntity != undefined &&
                                    !Util.isNull(exp._value._formula._rightEntity))
                                ? exp._value._formula._rightEntity.get_entityName()
                                : this.entityLogicalName;
                            var leftEntityName = (ConditionPropertyPage.isTaskFlow &&
                                    exp._value._formula._leftEntity != undefined &&
                                    !Util.isNull(exp._value._formula._rightEntity))
                                ? exp._value._formula._leftEntity.get_entityName()
                                : this.entityLogicalName;
                            var strValue = exp._value._formula._isAttribute
                                ? MetadataProxy.SourceAttributesMap[rightEntityName][exp._value._formula._value]
                                .displayName
                                : exp._value._formula._value;
                            text += '[' +
                                MetadataProxy.SourceAttributesMap[leftEntityName][exp._value._formula._attribute]
                                .displayName +
                                ' ' +
                            ...
                            // The exception to enumerated fields here is when the field is of type State or Status and is used with a string operator
                            if (!exp._value._isAttribute &&
                                ...
                                !(ConditionExpressionModel.isStatusType(exp._attributeType) &&
                                    ConditionExpressionModel.isUniversalStringOperator(exp._operator))) {
                                text += '[' +
                                    MetadataProxy.getPicklistValueNames(this.getAttribute(), exp._value._value).join() +
                                    ']';
                            } else if (!exp._value._isAttribute &&
                                ConditionExpressionModel
                                .isLookupType(MetadataProxy
                                    .getAttributeType(this.getAttribute(), this.entityLogicalName)) &&
                                !(ConditionExpressionModel.isUniversalStringOperator(exp._operator))) {
                                text += '[' + this.getDisplayName() + ']';
                            } else {
                                entityName = (ConditionPropertyPage.isTaskFlow &&
                                        typeof exp._value._entity != "undefined")
                                    ? exp._value._entity.get_entityName()
                                    : this.entityLogicalName;
                                var strValue;
                                if (exp._value._isAttribute) {
                                    strValue = typeof MetadataProxy.SourceAttributesMap[entityName][exp._value._value
                                            .toString()] !=
                                        "undefined"
                                        ? MetadataProxy.SourceAttributesMap[entityName][exp._value._value.toString()]
                                        .displayName
                                        : "";
                                } else {
                                    ...
                                    if (exp._attributeType == 2 && !isNaN(Date.parse(strValue))) {
                                        ...
                                        if (isDateOnly) {
                                            var userTime = ProcessControl.Configuration.BPFClientProxy
                                                .convertToUserSettingTime(exp._value._value, isDateOnly);
                                            dateToBeLocalized = ProcessControl.Configuration.BPFClientProxy
            ...
            ConditionExpressionModel.lookupFieldTypes = [
                        ...
                        _.each(picklistValues,
                            function(item) {
                                ...
                                self.$el.append("<div><input id='bpfprop-picklistValue' type='checkbox' value='" +
                                    ...
                                    checked +
                                    "><span>" +
                                    GenericWorkflowDesigner.CrmEncodeDecode.CrmHtmlEncode(item.pickListValue) +
                                    '</span></div>');
                            });
                        deferred.resolve(self);
                    });
        ...
        var PropertiesView = (function(_super) {
            ...
            PropertiesView.prototype.initialize = function() {
                ...
                this.model.conditionExpression.forEach(function(exp, idx) {
                    ...
                    // For normal BPFs, each attribute in the condition expression will belong to the parent stage's entity, while they can be selected from any source for TBXes, determined by the entity associated with the Condition Expression
            ...
            PropertiesView.prototype.render = function() {
                ...
                var descriptionMessage = MetadataProvider
                    .getLocalizedString("ProcessDesignerControl_BPF_BranchPropertyView_Description");
        ...
        var ConditionExpressionView = (function(_super) {
            ...
            ConditionExpressionView.prototype.render = function() {
                ...
                this.model.getViewDescriptor().then(function(d) {
                    ...
                    if (typeVal == null) {
                        ...
                        typeVal.val() &&
                        typeVal.val().trim() == ConditionPropertyPage.ValueType.Formula) {
                        ...
                        var attributeType = MetadataProxy.SourceAttributesMap[self.model.entityLogicalName][self.model
                        ...
                        var valueView = new
                            TextBoxEditView({
                                ...
                                attributes: { id: 'value', class: 'prop-input', value: self.model.getFormulaValue() }
                            });
                        ...
                        typeVal.val() &&
                        typeVal.val().trim() == ConditionPropertyPage.ValueType.Attribute &&
                        ...
                        $('[id=valueFields]:has(.taskflow-source)').find('#branchpropertydetails_value')
                            .attr("style", "display: none !important");
                    }
                    self.setToolTips();
                    self.setTabIndex();
            ...
            ConditionExpressionView.prototype.renderValue = function() {
                ...
                var isText = MetadataProxy.isTextField(this.model.getAttribute(),
                    ...
                    ConditionOperator[this.$('#operator').val()]);
                if (isText) {
                ...
                case AttributeType.Customer:
                    ...
                    // TODO: Render a normal text field if the operator is Contains/Does not Contain, etc.
                ...
                case AttributeType.Money:
                    this.valueView = new TextBoxEditView({
                        ...
                        attributes: {
                            id: 'value',
                            class: 'prop-input headline4',
                            tabindex: Util.tabIndexValue,
                            value: this.model.getSingleValue()
                        }
                    });
                    this.$("#valueContainer").html(this.valueView.render().$el);
        ...
        var ConditionPropertiesView = (function(_super) {
            ...
            ConditionPropertiesView.prototype.isPropertyViewModified = function() {
                try {
                    ...
                    if (len > 0) {
                        ...
                        for (var i = 0; i < len; i++) {
                            viewConditionExpressions[i]._prevStepOperator = modelConditionExperssions[i]
                                ._prevStepOperator = modelRuleLogic;
                        }
            ...
            ConditionPropertiesView.prototype.validateOnChange = function() {
                ...
                if (this._initDone) {
                    ...
                    this.propertyViewCurrentModelClone
                        .setActivityID(GenericWorkflowDesigner.PropertyView.getPropertyViewCurrentModel()
                            .getActivityID());
            ...
            ConditionPropertiesView.prototype.errorCount = function() {
                this.copyTo(this.propertyViewCurrentModelClone);
                return this.propertyViewCurrentModelClone
                    ._getErrorCount(); //Calling getErrorCount will go into infinite loop
            };
            ...
            ConditionPropertiesView.prototype.updateModel = function() {
                ...
                var newModelData;
                if (GenericWorkflowDesigner.PropertyView.getPropertyViewCurrentModel()._conditionExpression[0]
                    ._attribute ==
                    "NEW_EXP" &&
                    conditionExpressions.length == 1 &&
                    !conditionExpressions[0]._hasConditionExpChanged) {
                    newModelData = {
            ...
            ConditionPropertiesView.prototype.saveConditionBranch = function(event) {
                try {
                    ...
                    var ruleLogic = this.model.get('ruleLogic');
                    // var propertyViewCurrentModelClone = propertyViewCurrentModel.clone();
                    this.copyTo(this.propertyViewCurrentModelClone);
                ...
                try {
                    ...
                    expList.forEach(function(exp, idx) {
                        ...
                        if (ConditionPropertyPage.ConditionExpressionModel
                            .isLookupType(expression.get("_expression").attributeType)) {
                ...
                if (ConditionPropertyPage.isTaskFlow) {
                    MetadataProxy.getAttributeList(self._entityLogicalName, expression._entity.relationshipName)
                        .then(function(attributeList) {
                            ...
                            ruleLabels["branchpropertydetails_operator"] = MscrmControls.ProcessDesigner
                                .MetadataProvider
                                .getLocalizedString("ProcessDesignerControl_BPF_BranchPropertyDetails_Operator");
                            ruleLabels["branchpropertydetails_operatorTooltip"] = MscrmControls.ProcessDesigner
                                .MetadataProvider.getLocalizedString("ProcessDesignerControl_BPF_OperatorTooltip");
                            ruleLabels["branchpropertydetails_field"] = MscrmControls.ProcessDesigner.MetadataProvider
                                .getLocalizedString("ProcessDesignerControl_BPF_BranchPropertyDetails_Field");
                            ruleLabels["branchpropertydetails_fieldTooltip"] = MscrmControls.ProcessDesigner
                                .MetadataProvider.getLocalizedString("ProcessDesignerControl_BPF_FieldTooltip");
                            ruleLabels["branchpropertydetails_source"] = MscrmControls.ProcessDesigner.MetadataProvider
                                .getLocalizedString("ProcessDesignerControl_PBL_BranchPropertyDetails_Source");
                            ruleLabels["branchpropertydetails_sourceTooltip"] = MscrmControls.ProcessDesigner
                                .MetadataProvider.getLocalizedString("ProcessDesignerControl_TBX_SourceTooltip");
                            ruleLabels["branchpropertydetails_type"] = MscrmControls.ProcessDesigner.MetadataProvider
                                .getLocalizedString("ProcessDesignerControl_BPF_BranchPropertyDetails_Type");
                            ruleLabels["branchpropertydetails_typeTooltip"] = MscrmControls.ProcessDesigner
                                .MetadataProvider.getLocalizedString("ProcessDesignerControl_BPF_TypeTooltip");
                            ruleLabels["branchpropertydetails_value"] = MscrmControls.ProcessDesigner.MetadataProvider
                                .getLocalizedString("ProcessDesignerControl_BPF_BranchPropertyDetails_Value");
                            ruleLabels["branchpropertydetails_valueTooltip"] = MscrmControls.ProcessDesigner
                                .MetadataProvider.getLocalizedString("ProcessDesignerControl_BPF_ValueTooltip");
                            ruleLabels["branchpropertydetails_days"] = MscrmControls.ProcessDesigner.MetadataProvider
                                .getLocalizedString("ProcessDesignerControl_BPF_BranchPropertyDetails_Days");
                            ruleLabels["branchpropertydetails_daysTooltip"] = MscrmControls.ProcessDesigner
                                .MetadataProvider.getLocalizedString("ProcessDesignerControl_BPF_Tooltip_Label_Days");
                            ruleLabels["empty_dropDownlist"] = MscrmControls.ProcessDesigner.MetadataProvider
                            ...
                            var attributeTypeName = MetadataProxy.SourceAttributesMap[self
                            ...
                            if (expression._value._isAttribute) {
                                expressionDescriptor.types
                                    .push(MscrmControls.ProcessDesigner.MetadataProvider
                                ...
                                if (expression._value._formula._isAttribute) {
                                    expressionDescriptor.value
                                        .types = [
                                            ConditionPropertyPage.ValueType.Attribute, ConditionPropertyPage.ValueType
                                            .Value
                                        ];
                                } else {
                                    var attributeTypeName = MetadataProxy.SourceAttributesMap[self
                                    ...
                                    if (attributeTypeName == AttributeType.DateTime) {
                                        ...
                                        expressionDescriptor.value
                                            .types = [
                                                ConditionPropertyPage.ValueType.Value, ConditionPropertyPage.ValueType
                                                .Attribute
                                            ];
                                    }
                                }
                    ...
                    MetadataProxy.getAttributeList(self._entityLogicalName).then(function(attributeList) {
                        ...
                        var isNew = (expression._attribute == "NEW_EXP");
                        var ruleLabels = new ConditionPropertyPage.Dictionary();
                        ruleLabels["branchpropertydetails_operator"] = MscrmControls.ProcessDesigner.MetadataProvider
                            .getLocalizedString("ProcessDesignerControl_BPF_BranchPropertyDetails_Operator");
                        ruleLabels["branchpropertydetails_operatorTooltip"] = MscrmControls.ProcessDesigner
                            .MetadataProvider.getLocalizedString("ProcessDesignerControl_BPF_OperatorTooltip");
                        ruleLabels["branchpropertydetails_field"] = MscrmControls.ProcessDesigner.MetadataProvider
                        ...
                        ruleLabels["branchpropertydetails_type"] = MscrmControls.ProcessDesigner.MetadataProvider
                            .getLocalizedString("ProcessDesignerControl_BPF_BranchPropertyDetails_Type");
                        ruleLabels["branchpropertydetails_typeTooltip"] = MscrmControls.ProcessDesigner.MetadataProvider
                        ...
                        ruleLabels["branchpropertydetails_days"] = MscrmControls.ProcessDesigner.MetadataProvider
                            .getLocalizedString("ProcessDesignerControl_BPF_BranchPropertyDetails_Days");
                        ruleLabels["branchpropertydetails_daysTooltip"] = MscrmControls.ProcessDesigner.MetadataProvider
                        ...
                        expressionDescriptor.types = [];
                        if (expression._value._isAttribute) {
                            expressionDescriptor.types.push(MscrmControls.ProcessDesigner.MetadataProvider
                                .getLocalizedString('ProcessDesignerControl_PBL_PlainTextGenerator_Field'));
                            expressionDescriptor.types.push(MscrmControls.ProcessDesigner.MetadataProvider
                                .getLocalizedString('ProcessDesignerControl_PBL_PlainTextGenerator_Value'));
                            if (isFormulaValid) {
                            ...
                            if (expression._value._formula._isAttribute) {
                                expressionDescriptor.value
                                    .types = [
                                        ConditionPropertyPage.ValueType.Attribute, ConditionPropertyPage.ValueType.Value
                                    ];
                            } else {
                                var attributeTypeName = MetadataProxy.SourceAttributesMap[self
                                    ._entityLogicalName][expressionDescriptor.selectedAttribute].attributeType;
                            ...
                            if (!ConditionPropertyPage.isTaskFlow) {
                                MetadataProxy
                                    .getComparableAttributes(self._entityLogicalName,
                                        ...
                                        if (expressionDescriptor.value.selectedAttribute == "NEW_EXP") {
                                            ...
                                            expressionDescriptor.value.selectedAttribute = expressionDescriptor.value
                                                .attributeList[firstInnerKey];
                                            expressionDescriptor.value.selectedOperator = '+';
                                        }
                                        deferred.resolve(expressionDescriptor);
                                        return deferred.promise();
                                ...
                                var leftSelectedSource = (expression._value._formula._leftEntity instanceof
                                        Microsoft.Crm.Workflow.Expressions.PrimaryEntity)
                                    ? expression._value._formula._leftEntity.get_entityName()
                                    : expression._value._formula._leftEntity.get_relationshipName();
                                // The left and right sides, if both attributes, may be from two different sources, and thus a second retrieval might be necessary
                                        ...
                                        if (expression._value._formula._isAttribute &&
                                            ...
                                            var rightSelectedSource =
                                                (expression._value._formula._rightEntity instanceof
                                                        Microsoft.Crm.Workflow.Expressions.PrimaryEntity)
                                                    ? expression._value._formula._rightEntity.get_entityName()
                                                    : expression._value._formula._rightEntity.get_relationshipName();
                                            MetadataProxy
                                                .getComparableAttributes(self._entityLogicalName,
                                                    expression._attribute,
                                                    expression._value._formula._rightEntity.get_entityName())
