...
Microsoft.Crm.Client.Core.SharedScript.load = function(target, scriptUrl, importer) {
    ...
    var $v_1 = function($p1_0, $p1_1) {
        return $p1_0.document.writeln('<script src=' +
            CrmEncodeDecode.CrmHtmlAttributeEncode(scriptUrl) +
            ' id=' +
...
Microsoft.Crm.Client.Core.SharedScript.loadAsync = function(target, scriptUrl, importer, loader, onSuccess) {
    ...
    var $v_0 = scriptUrl.toLowerCase();
    var $v_1 = [target.top, target.parent];
...
Microsoft.Crm.Client.Core.Framework.IOptionMetadata
    .registerInterface('Microsoft.Crm.Client.Core.Framework.IOptionMetadata');


Microsoft.Crm.Client.Core.Framework.IOptionSetMetadata = function() {}
Microsoft.Crm.Client.Core.Framework.IOptionSetMetadata
    .registerInterface('Microsoft.Crm.Client.Core.Framework.IOptionSetMetadata');
...
Microsoft.Crm.Client.Core.Framework.INotifyPropertyChanged
    .registerInterface('Microsoft.Crm.Client.Core.Framework.INotifyPropertyChanged');
...
Microsoft.Crm.Client.Core.Framework.PerformanceMarkerType
    .registerEnum('Microsoft.Crm.Client.Core.Framework.PerformanceMarkerType', false);


Microsoft.Crm.Client.Core.Framework.IAuthenticationManager = function() {}
Microsoft.Crm.Client.Core.Framework.IAuthenticationManager
    .registerInterface('Microsoft.Crm.Client.Core.Framework.IAuthenticationManager');
...
Microsoft.Crm.Client.Core.Framework.AuthenticationState
    .registerEnum('Microsoft.Crm.Client.Core.Framework.AuthenticationState', false);
...
Microsoft.Crm.Client.Core.Framework.MailAppDisplayMode
    .registerEnum('Microsoft.Crm.Client.Core.Framework.MailAppDisplayMode', false);
...
Microsoft.Crm.Client.Core.Framework.DateTimeFieldBehavior
    .registerEnum('Microsoft.Crm.Client.Core.Framework.DateTimeFieldBehavior', false);
...
Microsoft.Crm.Client.Core.Framework.MetadataType
    .registerEnum('Microsoft.Crm.Client.Core.Framework.MetadataType', false);
...
Microsoft.Crm.Client.Core.Framework.ApplicationMetadataType
    .registerEnum('Microsoft.Crm.Client.Core.Framework.ApplicationMetadataType', false);
...
Microsoft.Crm.Client.Core.Framework.MetadataSubtype
    .registerEnum('Microsoft.Crm.Client.Core.Framework.MetadataSubtype', false);
...
Microsoft.Crm.Client.Core.Framework.IPicklistItem
    .registerInterface('Microsoft.Crm.Client.Core.Framework.IPicklistItem');
...
Microsoft.Crm.Client.Core.Framework.OperationType
    .registerEnum('Microsoft.Crm.Client.Core.Framework.OperationType', false);
...
Microsoft.Crm.Client.Core.Framework.ValueRequiredLevel
    .registerEnum('Microsoft.Crm.Client.Core.Framework.ValueRequiredLevel', false);
...
Microsoft.Crm.Client.Core.Framework.TraceComponent
    .registerEnum('Microsoft.Crm.Client.Core.Framework.TraceComponent', false);
...
Microsoft.Crm.Client.Core.Framework.CustomControlAttributeProperty.prototype = {
    ...
    $1Z_0: function() {
        var $$t_0;
        return ($$t_0 = this.$O_0()).concat.call($$t_0,
            'minValue',
            'maxValue',
            'imeMode',
            'lastUpdatedField',
    ...
    $27_0: function() {
        var $$t_0;
        return ($$t_0 = this.$O_0()).concat.call($$t_0, 'options', 'defaultValue');
    }
}
...
Microsoft.Crm.Client.Core.Framework.CustomControlUtils
    .retrieveCorrespondingManifestType = function(sDataType, sDataTypeFormat) {
...
Microsoft.Crm.Client.Core.Framework.CustomControlUtils.getInternalDataValue = function(publicValue, column) {
    if (!_Script.isNullOrUndefined(publicValue) &&
        !(Microsoft.Crm.Client.Core.Framework.IPicklistItem.isInstanceOfType(publicValue)) &&
        Microsoft.Crm.Client.Core.Framework.CustomControlUtils.isLinkedValueOptionMetadata(column)) {
        var $v_0;
...
Microsoft.Crm.Client.Core.Framework.Activity = function(name, properties) {
    this.n = name;
    this.t = Microsoft.Crm.Client.Core.Framework.UserDateTimeUtils.getUtcEquivalentFromLocal(new Date())
        .getMilliseconds();
...
Microsoft.Crm.Client.Core.Framework.MruCache$1.prototype = {
    ...
    cache: function(key, value) {
        var $v_0 = new (Microsoft.Crm.Client.Core.Framework.MruCacheNode$1
            .$$(Microsoft.Crm.Client.Core.Framework.CallbackSafeArray$1
                .$$(this.$$gta['Microsoft.Crm.Client.Core.Framework.MruCache$1']['T'])))(key, value);
        ...
        if ($v_1 < this.$u_0) {
            if (((key) in this.$9_0)) {
                ...
                this.$f_0(1026,
                    ...
                    $v_2.get_key(),
                    $v_2.get_value().get_length().toString());
                this.$q_0($v_2);
            }
            while (this.$b_0 + $v_1 > this.$u_0 && !_Script.isNullOrUndefined(this.$6_0)) {
                this.$f_0(1026,
                    ...
                    this.$6_0.get_key(),
                    this.$6_0.get_value().get_length().toString());
                this.$q_0(this.$6_0);
            }
            this.$f_0(1026,
                'MRUCache_Cache : Adding node - Key : {0}; callbackSafeArrayLength : {1}',
                $v_0.get_key(),
                $v_0.get_value().get_length().toString());
            this.$1o_0($v_0, $v_1);
        } else {
            this.$f_0(1026,
...
Microsoft.Crm.Client.Core.Framework.MruCacheNode$1 = function(key, value) {
    this.$1I_1 = ((this.$$gta['Microsoft.Crm.Client.Core.Framework.MruCacheNode$1']['T'] === Number ||
            Type.isEnum(this.$$gta['Microsoft.Crm.Client.Core.Framework.MruCacheNode$1']['T']))
        ? 0
        : (this.$$gta['Microsoft.Crm.Client.Core.Framework.MruCacheNode$1']['T'] === Boolean) ? false : null);
    Microsoft.Crm.Client.Core.Framework.MruCacheNode$1.$$(this
        .$$gta['Microsoft.Crm.Client.Core.Framework.MruCacheNode$1']['T']).initializeBase(this);
    this.$X_1 = key;
    this.$1I_1 = value;
}
Microsoft.Crm.Client.Core.Framework.MruCacheNode$1.$$ = function(T) {
    ...
    if (!Microsoft.Crm.Client.Core.Framework[$$cn]) {
        ...
        $$ccr.registerClass('Microsoft.Crm.Client.Core.Framework.' + $$cn,
            Microsoft.Crm.Client.Core.Framework.DoublyLinkedListNode);
...
Microsoft.Crm.Client.Core.Framework.ObjectComparer.areValuesEqual = function(value1, value2) {
    if (Microsoft.Crm.Client.Core.Framework.Guid.isInstanceOfType(value1) &&
        Microsoft.Crm.Client.Core.Framework.Guid.isInstanceOfType(value2)) {
        return (value1).equals(value2);
    }
    if (Microsoft.Crm.Client.Core.Framework.IReference.isInstanceOfType(value1) &&
        Microsoft.Crm.Client.Core.Framework.IReference.isInstanceOfType(value2)) {
        return (value1).equals(value2);
    }
    if (Microsoft.Crm.Client.Core.Framework.IPicklistItem.isInstanceOfType(value1) &&
        Microsoft.Crm.Client.Core.Framework.IPicklistItem.isInstanceOfType(value2)) {
        return (value1).get_ValueString() === (value2).get_ValueString() &&
            (value1).get_Label() === (value2).get_Label();
    }
    if (Microsoft.Crm.Client.Core.Framework.IAlias.isInstanceOfType(value1) &&
        Microsoft.Crm.Client.Core.Framework.IAlias.isInstanceOfType(value2)) {
        return Microsoft.Crm.Client.Core.Framework.ObjectComparer
            .areValuesEqual((value1).get_value(), (value2).get_value());
    }
...
Microsoft.Crm.Client.Core.Framework.SortingInfo = function(sortByField,
    sortDescending,
...
Microsoft.Crm.Client.Core.Framework.SortingInfo.prototype = {
    ...
    equalTo: function(other) {
        return !_Script.isNullOrUndefined(other) &&
            this.$T_0 === other.$T_0 &&
            this.$U_0 === other.$U_0 &&
            this.$R_0 === other.$R_0 &&
            this.$S_0 === other.$S_0;
...
Microsoft.Crm.Client.Core.Framework.FieldFormat.FieldFormatValue
    .registerEnum('Microsoft.Crm.Client.Core.Framework.FieldFormat.FieldFormatValue', false);
...
Microsoft.Crm.Client.Core.Framework.FieldLevelAccess.get_openAccess = function() {
    if (_Script.isNullOrUndefined(Microsoft.Crm.Client.Core.Framework.FieldLevelAccess.$w)) {
        Microsoft.Crm.Client.Core.Framework.FieldLevelAccess.$w = new Microsoft.Crm.Client.Core.Framework
            .FieldLevelAccess(false, true, true);
    }
...
Microsoft.Crm.Client.Core.Framework.FieldLevelAccess.get_readOnlyAccess = function() {
    if (_Script.isNullOrUndefined(Microsoft.Crm.Client.Core.Framework.FieldLevelAccess.$x)) {
        Microsoft.Crm.Client.Core.Framework.FieldLevelAccess.$x = new Microsoft.Crm.Client.Core.Framework
            .FieldLevelAccess(false, true, false);
    }
...
Microsoft.Crm.Client.Core.Framework.ErrorStatus.fromMessage = function(message) {
    ...
    var $v_0 = (Microsoft.Crm.Client.Core.Framework._String.isNullOrEmpty(message))
        ? ''
        : String.format.apply(null, [message].concat(args));
...
Microsoft.Crm.Client.Core.Framework.ErrorStatus.fromErrorCode = function(errorCode) {
    ...
    var $v_0 = new Microsoft.Crm.Client.Core.Framework
        .ErrorStatus(Microsoft.Crm.Client.Core.Framework.Common.ResourceManager.getErrorMessage(errorCode, parameters));
    $v_0.$2_0 = errorCode;
    return $v_0;
}
...
Microsoft.Crm.Client.Core.Framework.ErrorStatus.fromError = function(previousError, message, errorCode) {
    ...
    if (!Microsoft.Crm.Client.Core.Framework._String.isNullOrEmpty(message)) {
        ...
        $v_0 = new Microsoft.Crm.Client.Core.Framework
            .ErrorStatus(Microsoft.Crm.Client.Core.Framework.Common.ResourceManager.getErrorMessage(errorCode));
    } else {
...
Microsoft.Crm.Client.Core.Framework.Guid.$1e = function($p0) {
    ...
    $p0 = $p0.toLowerCase();
    if (Microsoft.Crm.Client.Core.Framework.Guid.get_$2B().test($p0) ||
        Microsoft.Crm.Client.Core.Framework.Guid.get_$1Q().test($p0)) {
...
Microsoft.Crm.Client.Core.Framework.Guid.get_empty = function() {
    return Microsoft.Crm.Client.Core.Framework.Guid.$m ||
    (Microsoft.Crm.Client.Core.Framework.Guid.$m = new Microsoft.Crm.Client.Core.Framework
        .Guid('00000000-0000-0000-0000-000000000000'));
}
Microsoft.Crm.Client.Core.Framework.Guid.get_$2A = function() {
    return Microsoft.Crm.Client.Core.Framework.Guid.$1B ||
        (Microsoft.Crm.Client.Core.Framework.Guid.$1B = new RegExp('{|}|-', 'g'));
}
Microsoft.Crm.Client.Core.Framework.Guid.get_$2B = function() {
    return Microsoft.Crm.Client.Core.Framework.Guid.$1C ||
    (Microsoft.Crm.Client.Core.Framework.Guid
        .$1C = new RegExp('^(\\d|[a-f]){8}-(\\d|[a-f]){4}-(\\d|[a-f]){4}-(\\d|[a-f]){4}-(\\d|[a-f]){12}$'));
}
Microsoft.Crm.Client.Core.Framework.Guid.get_$1Q = function() {
    return Microsoft.Crm.Client.Core.Framework.Guid.$14 ||
    (Microsoft.Crm.Client.Core.Framework.Guid
        .$14 = new RegExp('^{(\\d|[a-f]){8}-(\\d|[a-f]){4}-(\\d|[a-f]){4}-(\\d|[a-f]){4}-(\\d|[a-f]){12}}$'));
}
Microsoft.Crm.Client.Core.Framework.Guid.get_$1t = function() {
    return Microsoft.Crm.Client.Core.Framework.Guid.$17 ||
        (Microsoft.Crm.Client.Core.Framework.Guid.$17 = new RegExp('^(\\d|[a-f]){32}$'));
}
...
Microsoft.Crm.Client.Core.Framework.Guid.prototype = {
    ...
    getHashCode: function() {
        return (!Microsoft.Crm.Client.Core.Framework._String.isNullOrEmpty(this.$4_0))
            ? Microsoft.Crm.Client.Core.Framework._String.hashCode(this.$4_0)
            : 0;
    },

    toString: function() {
        if (!this.$r_0) {
            this.$r_0 = this.$4_0.substring(0, 8) +
                '-' +
                this.$4_0.substring(8, 12) +
                '-' +
                this.$4_0.substring(12, 16) +
                '-' +
                this.$4_0.substring(16, 20) +
                '-' +
                this.$4_0.substring(20, 32);
        }
        return this.$r_0;
    }
}
...
Microsoft.Crm.Client.Core.Framework.KeyValuePair$2 = function(key, value) {
    this.$X_0 = ((this.$$gta['Microsoft.Crm.Client.Core.Framework.KeyValuePair$2']['TKey'] === Number ||
            Type.isEnum(this.$$gta['Microsoft.Crm.Client.Core.Framework.KeyValuePair$2']['TKey']))
        ? 0
        : (this.$$gta['Microsoft.Crm.Client.Core.Framework.KeyValuePair$2']['TKey'] === Boolean) ? false : null);
    this.$1L_0 = ((this.$$gta['Microsoft.Crm.Client.Core.Framework.KeyValuePair$2']['TValue'] === Number ||
            Type.isEnum(this.$$gta['Microsoft.Crm.Client.Core.Framework.KeyValuePair$2']['TValue']))
        ? 0
        : (this.$$gta['Microsoft.Crm.Client.Core.Framework.KeyValuePair$2']['TValue'] === Boolean) ? false : null);
    this.$X_0 = key;
    this.$1L_0 = value;
}
Microsoft.Crm.Client.Core.Framework.KeyValuePair$2.$$ = function(TKey, TValue) {
    ...
    if (!Microsoft.Crm.Client.Core.Framework[$$cn]) {
        var $$ccr = Microsoft.Crm.Client.Core.Framework[$$cn] = function() {
            (this.$$gta = this
                .$$gta ||
                {})['Microsoft.Crm.Client.Core.Framework.KeyValuePair$2'] = { 'TKey': TKey, 'TValue': TValue };
            var $v_0 = [];
            for (var $v_1 = 0; $v_1 < arguments.length; ++$v_1) {
                $v_0[$v_1] = arguments[$v_1];
            }
...
Microsoft.Crm.Client.Core.Framework.UserDateTimeUtils
    .convertDateTimeFromUtcToUserDisplay = function(time, userUtcOffsetMinutes, adjusters) {
...
Microsoft.Crm.Client.Core.Framework.UserDateTimeUtils
    .convertTimeToBehaviorDisplay = function(time, userUtcOffsetMinutes, behavior, adjusters) {
        switch (behavior) {
        case 2:
        case 3:
            return Microsoft.Crm.Client.Core.Framework.UserDateTimeUtils.getUtcEquivalentFromLocal(time);
        case 1:
            return Microsoft.Crm.Client.Core.Framework.UserDateTimeUtils
                .convertDateTimeFromUtcToUserDisplay(time, userUtcOffsetMinutes, adjusters);
        default:
            return new Date(time.getTime());
        }
    }
Microsoft.Crm.Client.Core.Framework.UserDateTimeUtils
    .convertTimeFromBehaviorDisplay = function(time, userUtcOffsetMinutes, behavior, adjusters) {
        switch (behavior) {
        case 2:
        case 3:
...
Microsoft.Crm.Client.Core.Framework.UserDateTimeUtils.getDaysInMonth = function(month, year) {
    var $v_0 = (Microsoft.Crm.Client.Core.Framework.UserDateTimeUtils.isLeapYear(year))
        ? Microsoft.Crm.Client.Core.Framework.UserDateTimeUtils.$1S
        : Microsoft.Crm.Client.Core.Framework.UserDateTimeUtils.$1R;
    if (!month) {
        return $v_0[month];
    }
...
Microsoft.Crm.Client.Core.Framework.UserDateTimeUtils
    .getWeekOfYearFullDays = function(date, firstDayOfWeek, numberOfFullDays) {
...
Microsoft.Crm.Client.Core.Framework._String.format = function(format, arg0, arg1, arg2, arg3, arg4, arg5) {
    if (_Script.isUndefined(arg0) &&
        _Script.isUndefined(arg1) &&
        _Script.isUndefined(arg2) &&
        _Script.isUndefined(arg3) &&
        _Script.isUndefined(arg4) &&
        _Script.isUndefined(arg5)) {
        return format;
    }
...
Microsoft.Crm.Client.Core.Framework.Common.ImeMode
    .registerEnum('Microsoft.Crm.Client.Core.Framework.Common.ImeMode', false);
...
Microsoft.Crm.Client.Core.Framework.Common.ResourceManager.hasErrorTitle = function(errorCode) {
    return (('Error_Title_0x' + Microsoft.Crm.Client.Core.Framework.Common.ResourceManager.getHexErrorCode(errorCode)
        ) in
...
Microsoft.Crm.Client.Core.Framework.Common.ResourceManager.hasErrorMessage = function(errorCode) {
    return (('Error_Message_0x' + Microsoft.Crm.Client.Core.Framework.Common.ResourceManager.getHexErrorCode(errorCode)
        ) in
        Microsoft.Crm.Client.Core.Framework.Common.ResourceManager.$Q);
}
Microsoft.Crm.Client.Core.Framework.Common.ResourceManager.getErrorTitle = function(errorCode, parameters) {
    ...
    return String.format.apply(null,
        [Microsoft.Crm.Client.Core.Framework.Common.ResourceManager.getLocalizedString($v_0)].concat(parameters));
}
Microsoft.Crm.Client.Core.Framework.Common.ResourceManager.getErrorMessage = function(errorCode, parameters) {
    ...
    if (!(($v_1) in Microsoft.Crm.Client.Core.Framework.Common.ResourceManager.$Q)) {
        $v_0 = String.format.apply(null,
        [
            Microsoft.Crm.Client.Core.Framework.Common.ResourceManager
            .getLocalizedString('Error_Message_Generic_Mobile_Client'), '0x' + errorCode.toString(16)
        ].concat(parameters));
    } else if (!_Script.isNullOrUndefined(parameters)) {
        $v_0 = String.format.apply(null,
            [Microsoft.Crm.Client.Core.Framework.Common.ResourceManager.getLocalizedString($v_1)].concat(parameters));
    } else {
...
Microsoft.Crm.Client.Core.Framework.CustomControl
    .ColumnSpecificationRecord = function(name, displayName, alias, dataType, visualSizeFactor) {
        this.Name = name;
...
Microsoft.Crm.Client.Core.Framework.CustomControl
    .DataSetSpecificationRecord = function(name,
        viewId,
        columns,
        entityName,
        targetEntityType,
...
Microsoft.Crm.Client.Core.Framework.CustomControl.PropertyUsage
    .registerEnum('Microsoft.Crm.Client.Core.Framework.CustomControl.PropertyUsage', false);


Microsoft.Crm.Client.Core.Framework.CustomControl
    .ColumnDefinition = function(name, displayName, alias, dataType, visualSizeFactor) {
        this.$1H_0 = name;
...
Microsoft.Crm.Client.Core.Storage.Common.Xml.IXmlNodeList
    .registerInterface('Microsoft.Crm.Client.Core.Storage.Common.Xml.IXmlNodeList');
...
Microsoft.Crm.Client.Core.Storage.Common.Xml.XmlEvaluatorType
    .registerEnum('Microsoft.Crm.Client.Core.Storage.Common.Xml.XmlEvaluatorType', false);


Microsoft.Crm.Client.Core.Storage.Common.Xml.DOMParserNodeListWrapper = function($p0) {
    this.$D_0 = new (Microsoft.Crm.Client.Core.Framework.List$1
        .$$(Microsoft.Crm.Client.Core.Storage.Common.Xml.DOMParserNodeWrapper))();
...
Microsoft.Crm.Client.Core.Storage.Common.Xml.DOMParserNodeWrapper.prototype = {
    ...
    getElementsByTagName: function($p0) {
        ...
        for (var $v_5 = 0; $v_5 < $v_1.length; $v_5++) {
            Array.add($v_3,
                new Microsoft.Crm.Client.Core.Storage.Common.Xml.DOMParserNodeWrapper($v_1[$v_5], this.$3_1));
        }
    ...
    childNodes: function() {
        ...
        for (var $v_1 = 0, $v_2 = this.$0_1.childNodes.length; $v_1 < $v_2; $v_1++) {
            Array.add($v_0,
                new Microsoft.Crm.Client.Core.Storage.Common.Xml
                .DOMParserNodeWrapper(this.$0_1.childNodes[$v_1], this.$3_1));
        }
    ...
    $1n_1: function($p0, $p1) {
        ...
        for (var $v_E = 0; $v_E < $v_0.length; $v_E++) {
            Array.add($v_1,
                new Microsoft.Crm.Client.Core.Storage.Common.Xml.DOMParserNodeWrapper($v_0[$v_E], this.$3_1));
        }
...
Microsoft.Crm.Client.Core.Storage.Common.Xml.NodeSnapshotWrapper = function($p0, $p1, $p2) {
    ...
    if (!_Script.isNullOrUndefined($v_0.length)) {
        for (var $v_1 = 0; $v_1 < $v_0.length; $v_1++) {
            Array.add(this.$D_0,
                new Microsoft.Crm.Client.Core.Storage.Common.Xml.XPathEvaluatorWrapper($p0, $v_0[$v_1], $p2));
        }
    } else {
        var $v_2 = $p1;
        for (var $v_3 = 0; $v_3 < $v_2.snapshotLength; $v_3++) {
            Array.add(this.$D_0,
                new Microsoft.Crm.Client.Core.Storage.Common.Xml
                .XPathEvaluatorWrapper($p0, $v_2.snapshotItem($v_3), $p2));
        }
    }
}
...
Microsoft.Crm.Client.Core.Storage.Common.Xml.XmlNodeFactory.$1v = function($p0) {
    ...
    if (Microsoft.Crm.Client.Core.Storage.Common.Xml.XmlNodeFactory.$L === -1) {
        Microsoft.Crm.Client.Core.Framework.Utils.ExceptionHelpers
            .throwOnNullOrUndefinedArgument(Microsoft.Crm.Client.Core.Storage.Common.Xml.XmlNodeFactory.$L,
...
Microsoft.Crm.Client.Core.Storage.Common.Xml.XPathEvaluatorWrapper = function($p0, $p1, $p2) {
    this.$$d_$2E_1 = Function.createDelegate(this, this.$2E_1);
...
Microsoft.Crm.Client.Core.Storage.Common.Xml.XPathEvaluatorWrapper.prototype = {
    ...
    selectSingleNode: function($p0) {
        var $v_0 = this.$K_1.evaluate($p0, this.$0_1, this.$$d_$2E_1, 9, null);
        return (_Script.isNullOrUndefined($v_0.singleNodeValue))
            ? null
            : new Microsoft.Crm.Client.Core.Storage.Common.Xml
            .XPathEvaluatorWrapper(this.$K_1, $v_0.singleNodeValue, this.$3_1);
    },

    selectNodes: function($p0) {
        return new Microsoft.Crm.Client.Core.Storage.Common.Xml
            .NodeSnapshotWrapper(this.$K_1, this.$K_1.evaluate($p0, this.$0_1, this.$$d_$2E_1, 7, null), this.$3_1);
    },
    ...
    getElementsByTagName: function($p0) {
        return new Microsoft.Crm.Client.Core.Storage.Common.Xml
            .NodeSnapshotWrapper(this.$K_1, this.$0_1.getElementsByTagName($p0), this.$3_1);
    },

    childNodes: function() {
        return new Microsoft.Crm.Client.Core.Storage.Common.Xml
            .NodeSnapshotWrapper(this.$K_1, this.$0_1.childNodes, this.$3_1);
    },
...
Microsoft.Crm.Client.Core.Models.Validation.ValidatorType
    .registerEnum('Microsoft.Crm.Client.Core.Models.Validation.ValidatorType', false);


Microsoft.Crm.Client.Core.Models.Validation.IValidator = function() {}
Microsoft.Crm.Client.Core.Models.Validation.IValidator
    .registerInterface('Microsoft.Crm.Client.Core.Models.Validation.IValidator');
...
Microsoft.Crm.Client.Core.Models.Validation
    .ValidatorResult = function(isValueValid, validatedValue, errorMessage, errorId, errorMessageLevel) {
...
Microsoft.Crm.Client.Core.Storage.Common.CustomControls.CustomControlDataSetConditionExpression
    .ConditionOperator = function() {}
Microsoft.Crm.Client.Core.Storage.Common.CustomControls.CustomControlDataSetConditionExpression.ConditionOperator
    .prototype = {
        none: -1,
        equal: 0,
        notEqual: 1,
...
Microsoft.Crm.Client.Core.Storage.Common.CustomControls.CustomControlDataSetConditionExpression.ConditionOperator
    .registerEnum('Microsoft.Crm.Client.Core.Storage.Common.CustomControls.CustomControlDataSetConditionExpression.ConditionOperator', false);
...
Microsoft.Crm.Client.Core.Storage.Common.CustomControls.CustomControlDataSetFilteringUtils
    .conditionOperatorToString = function(conditionOperator) {
...
Microsoft.Crm.Client.Core.Storage.Common.CustomControls.CustomControlDataSetFilteringUtils
    .checkFilterOperatorIsValid = function(filterOperator) {
...
Microsoft.Crm.Client.Core.Storage.Common.CustomControls.CustomControlDataSetFilteringUtils
    .checkConditionOperatorIsValid = function(conditionOperator) {
        switch (conditionOperator) {
        case 'eq':
        case 'ne':
        case 'ge':
...
Microsoft.Crm.Client.Core.Storage.Common.CustomControls.CustomControlDataSetFilteringUtils
    .checkIfConditionExpressionHasInvalidArguments = function(condition) {
        if (!_Script.isNullOrUndefined(condition.attributeName) &&
            (!_Script.isNullOrUndefined(condition.value) || !_Script.isNullOrUndefined(condition.values)) &&
            _Script.isNullOrUndefined(condition.conditionOperator)) {
            throw Error.argumentNull('Condition Operator in ConditionExpression is missing');
        }
        if (!_Script.isNullOrUndefined(condition.conditionOperator) &&
            (!_Script.isNullOrUndefined(condition.value) || !_Script.isNullOrUndefined(condition.values)) &&
            _Script.isNullOrUndefined(condition.attributeName)) {
            throw Error.argumentNull('AttributeName in ConditionExpression is missing');
        }
    }
Microsoft.Crm.Client.Core.Storage.Common.CustomControls.CustomControlDataSetFilteringUtils
    .fetchXmlToFilterExpression = function(filterXml) {
        ...
        if (!Microsoft.Crm.Client.Core.Framework._String.isNullOrEmpty(filterXml)) {
            ...
            if ($v_2.length > 0) {
                ...
                $v_0.filterOperator = ($v_3.nodeValue ===
                        Microsoft.Crm.Client.Core.Storage.Common.FetchExpression.LogicalOperator.toString(0)
                        .toLowerCase())
                    ? 0
                    : 1;
                ...
                for (var $v_5 = 0; $v_5 < $v_4.length; $v_5++) {
                    ...
                    if ($v_6.nodeName.toLowerCase() === 'condition') {
                        var $v_7 = new Microsoft.Crm.Client.Core.Storage.Common.CustomControls
                            .CustomControlDataSetConditionExpression();
                        $v_7.conditionOperator = Microsoft.Crm.Client.Core.Storage.Common.CustomControls
                            .CustomControlDataSetFilteringUtils.$1s($v_6.attributes.getNamedItem('operator').nodeValue);
                        ...
                        var $v_A = Microsoft.Crm.Client.Core.Storage.Common.Xml.XmlNodeFactory.create($v_6)
                            .get_outerXml();
                        $v_0.filters.push(Microsoft.Crm.Client.Core.Storage.Common.CustomControls
                            .CustomControlDataSetFilteringUtils.fetchXmlToFilterExpression($v_A));
                    }
                }
            }
        }
...
Microsoft.Crm.Client.Core.Storage.Common.FetchExpression.LogicalOperator
    .registerEnum('Microsoft.Crm.Client.Core.Storage.Common.FetchExpression.LogicalOperator', false);
...
Microsoft.Crm.Client.Core.Framework.Utils.ExceptionHelpers
    .throwOnNullOrUndefinedArgument = function(argument, argumentName) {
        if (_Script.isNullOrUndefined(argument)) {
...
Microsoft.Crm.Client.Core.Framework.Utils.ExceptionHelpers
    .throwOnNullOrEmptyArrayArgument = function(array, argumentName) {
        if (!array || !array.length) {
            throw Error.argumentNull(argumentName, 'Argument can\'t be null or empty');
        }
    }
Microsoft.Crm.Client.Core.Framework.Utils.ExceptionHelpers
    .throwOnEquals = function(argument, unexpectedValue, argumentName) {
...
Microsoft.Crm.Client.Core.Framework.Utils.ExceptionHelpers
    .throwOnNotEquals = function(argument, expectedValue, argumentName) {
        if (argument !== expectedValue) {
            throw Error.argument(argumentName, 'Argument is ' + argument + 'but should be equal to ' + expectedValue);
        }
    }
Microsoft.Crm.Client.Core.Framework.Utils.ExceptionHelpers
    .throwOnOutOfRange = function(value, minValue, maxValue, argumentName) {
...
Microsoft.Crm.Client.Core.Framework.DefaultContext
    .registerClass('Microsoft.Crm.Client.Core.Framework.DefaultContext',
        Microsoft.Crm.Client.Core.Framework.CallingContext);
Microsoft.Crm.Client.Core.Framework.CustomControlAttributeProperty
    .registerClass('Microsoft.Crm.Client.Core.Framework.CustomControlAttributeProperty');
Microsoft.Crm.Client.Core.Framework.CustomControlConstants
    .registerClass('Microsoft.Crm.Client.Core.Framework.CustomControlConstants');
Microsoft.Crm.Client.Core.Framework.CustomControlUtils
    .registerClass('Microsoft.Crm.Client.Core.Framework.CustomControlUtils');
Microsoft.Crm.Client.Core.Framework.Activity.registerClass('Microsoft.Crm.Client.Core.Framework.Activity');
Microsoft.Crm.Client.Core.Framework.DoublyLinkedListNode
    .registerClass('Microsoft.Crm.Client.Core.Framework.DoublyLinkedListNode');
...
Microsoft.Crm.Client.Core.Framework.SortingInfo
    .registerClass('Microsoft.Crm.Client.Core.Framework.SortingInfo',
        null,
        Microsoft.Crm.Client.Core.Framework.ISerializable);
Microsoft.Crm.Client.Core.Framework.UrlParameterConstants
    .registerClass('Microsoft.Crm.Client.Core.Framework.UrlParameterConstants');
...
Microsoft.Crm.Client.Core.Framework.AppBootPerformanceMarkerNames
    .registerClass('Microsoft.Crm.Client.Core.Framework.AppBootPerformanceMarkerNames');
Microsoft.Crm.Client.Core.Framework.DataLayerPerformanceMarkerNames
    .registerClass('Microsoft.Crm.Client.Core.Framework.DataLayerPerformanceMarkerNames');
Microsoft.Crm.Client.Core.Framework.OfflineDataStoreCRUDPerformanceMarkerNames
    .registerClass('Microsoft.Crm.Client.Core.Framework.OfflineDataStoreCRUDPerformanceMarkerNames');
Microsoft.Crm.Client.Core.Framework.DeviceConfiguration
    .registerClass('Microsoft.Crm.Client.Core.Framework.DeviceConfiguration');
Microsoft.Crm.Client.Core.Framework.FieldFormat.registerClass('Microsoft.Crm.Client.Core.Framework.FieldFormat');
Microsoft.Crm.Client.Core.Framework.MetadataTypeName
    .registerClass('Microsoft.Crm.Client.Core.Framework.MetadataTypeName');
Microsoft.Crm.Client.Core.Framework.FieldLevelAccess
    .registerClass('Microsoft.Crm.Client.Core.Framework.FieldLevelAccess');
Microsoft.Crm.Client.Core.Framework.RolePrivilegeId
    .registerClass('Microsoft.Crm.Client.Core.Framework.RolePrivilegeId');
...
Microsoft.Crm.Client.Core.Framework.ErrorStatus
    .registerClass('Microsoft.Crm.Client.Core.Framework.ErrorStatus',
        null,
        Microsoft.Crm.Client.Core.Framework.ISerializable);
...
Microsoft.Crm.Client.Core.Framework.TimeZoneAdjuster
    .registerClass('Microsoft.Crm.Client.Core.Framework.TimeZoneAdjuster',
        null,
        Microsoft.Crm.Client.Core.Framework.ISerializable);
Microsoft.Crm.Client.Core.Framework.UserDateTimeUtils
    .registerClass('Microsoft.Crm.Client.Core.Framework.UserDateTimeUtils');
Microsoft.Crm.Client.Core.Framework.TransitionConstraint
    .registerClass('Microsoft.Crm.Client.Core.Framework.TransitionConstraint',
        null,
        Microsoft.Crm.Client.Core.Framework.ISerializable);
...
Microsoft.Crm.Client.Core.Framework.Common.ResourceManager
    .registerClass('Microsoft.Crm.Client.Core.Framework.Common.ResourceManager');
Microsoft.Crm.Client.Core.Framework.CustomControl.ColumnSpecificationRecord
    .registerClass('Microsoft.Crm.Client.Core.Framework.CustomControl.ColumnSpecificationRecord');
Microsoft.Crm.Client.Core.Framework.CustomControl.DataSetSpecificationRecord
    .registerClass('Microsoft.Crm.Client.Core.Framework.CustomControl.DataSetSpecificationRecord');
Microsoft.Crm.Client.Core.Framework.CustomControl.ColumnDefinition
    .registerClass('Microsoft.Crm.Client.Core.Framework.CustomControl.ColumnDefinition');
...
Microsoft.Crm.Client.Core.Storage.Common.Xml.DOMParserNodeListWrapper
    .registerClass('Microsoft.Crm.Client.Core.Storage.Common.Xml.DOMParserNodeListWrapper',
        null,
        Microsoft.Crm.Client.Core.Storage.Common.Xml.IXmlNodeList);
Microsoft.Crm.Client.Core.Storage.Common.Xml.XmlNode
    .registerClass('Microsoft.Crm.Client.Core.Storage.Common.Xml.XmlNode');
Microsoft.Crm.Client.Core.Storage.Common.Xml.DOMParserNodeWrapper
    .registerClass('Microsoft.Crm.Client.Core.Storage.Common.Xml.DOMParserNodeWrapper',
        Microsoft.Crm.Client.Core.Storage.Common.Xml.XmlNode);
Microsoft.Crm.Client.Core.Storage.Common.Xml.NodeSnapshotWrapper
    .registerClass('Microsoft.Crm.Client.Core.Storage.Common.Xml.NodeSnapshotWrapper',
        null,
        Microsoft.Crm.Client.Core.Storage.Common.Xml.IXmlNodeList);
Microsoft.Crm.Client.Core.Storage.Common.Xml.XmlNodeFactory
    .registerClass('Microsoft.Crm.Client.Core.Storage.Common.Xml.XmlNodeFactory');
Microsoft.Crm.Client.Core.Storage.Common.Xml.XPathEvaluatorWrapper
    .registerClass('Microsoft.Crm.Client.Core.Storage.Common.Xml.XPathEvaluatorWrapper',
        Microsoft.Crm.Client.Core.Storage.Common.Xml.XmlNode);
Microsoft.Crm.Client.Core.Models.Validation.CustomControlValidationHelper
    .registerClass('Microsoft.Crm.Client.Core.Models.Validation.CustomControlValidationHelper');
...
Microsoft.Crm.Client.Core.Storage.Common.CustomControls.CustomControlDataSetConditionExpression
    .registerClass('Microsoft.Crm.Client.Core.Storage.Common.CustomControls.CustomControlDataSetConditionExpression');
Microsoft.Crm.Client.Core.Storage.Common.CustomControls.CustomControlDataSetFilterExpression
    .registerClass('Microsoft.Crm.Client.Core.Storage.Common.CustomControls.CustomControlDataSetFilterExpression');
Microsoft.Crm.Client.Core.Storage.Common.CustomControls.CustomControlDataSetFilteringUtils
    .registerClass('Microsoft.Crm.Client.Core.Storage.Common.CustomControls.CustomControlDataSetFilteringUtils');
...
Microsoft.Crm.Client.Core.Imported.DeferredPromiseDecorator
    .registerClass('Microsoft.Crm.Client.Core.Imported.DeferredPromiseDecorator');
...
Microsoft.Crm.Client.Core.Attributes.ExportToTypescriptAttribute
    .registerClass('Microsoft.Crm.Client.Core.Attributes.ExportToTypescriptAttribute', Sys.Attribute);
Microsoft.Crm.Client.Core.Framework.Utils.ExceptionHelpers
    .registerClass('Microsoft.Crm.Client.Core.Framework.Utils.ExceptionHelpers');
...
Microsoft.Crm.Client.Core.Framework.UrlParameterConstants
    .delayedPanoramaRenderingParameterName = 'panoramadelayedrender';
...
Microsoft.Crm.Client.Core.Framework.PageLoadPerformanceMarkerNames
    .renderedViewportInitialUI = 'RenderedViewportInitialUI';
Microsoft.Crm.Client.Core.Framework.PageLoadPerformanceMarkerNames
    .loadedViewportInitialData = 'LoadedViewportInitialData';
Microsoft.Crm.Client.Core.Framework.PageLoadPerformanceMarkerNames
...
Microsoft.Crm.Client.Core.Framework.PageLoadPerformanceMarkerNames
    .landingPageQuickCommands = 'LandingPageQuickCommands';
...
Microsoft.Crm.Client.Core.Framework.PageLoadPerformanceMarkerNames
    .initializingLookupSearch = 'StartMarkerForLookupSearch';
...
Microsoft.Crm.Client.Core.Framework.DataLayerPerformanceMarkerNames
    .checkRemoteDataSourceUpdates = 'DataSource_CheckRemoteDataSourceUpdates';
Microsoft.Crm.Client.Core.Framework.DataLayerPerformanceMarkerNames
    .initializeAfterUpdatesCheck = 'DataSource_InitializeAfterUpdatesCheck';
Microsoft.Crm.Client.Core.Framework.DataLayerPerformanceMarkerNames
    .syncAllEntityAndAttributeMetadata = 'DataSource_SyncAllEntityAndAttributeMetadata';
Microsoft.Crm.Client.Core.Framework.DataLayerPerformanceMarkerNames
    .syncAllApplicationMetadata = 'DataSource_SyncAllApplicationMetadata';
Microsoft.Crm.Client.Core.Framework.DataLayerPerformanceMarkerNames
    .syncEntityAttributeBatch = 'DataSource_SyncEntityAttributeBatch';
Microsoft.Crm.Client.Core.Framework.DataLayerPerformanceMarkerNames
    .syncApplicationMetdataBatch = 'DataSource_SyncApplicationMetadataBatch';
Microsoft.Crm.Client.Core.Framework.DataLayerPerformanceMarkerNames.offlineSync = 'DataSource_OfflineSync';
Microsoft.Crm.Client.Core.Framework.OfflineDataStoreCRUDPerformanceMarkerNames
    .offlineCreateRecord = 'OfflineDataStore_CreateRecord';
Microsoft.Crm.Client.Core.Framework.OfflineDataStoreCRUDPerformanceMarkerNames
    .offlineRetrieveRecord = 'OfflineDataStore_RetrieveRecord';
Microsoft.Crm.Client.Core.Framework.OfflineDataStoreCRUDPerformanceMarkerNames
    .offlineUpdateRecord = 'OfflineDataStore_UpdateRecord';
Microsoft.Crm.Client.Core.Framework.OfflineDataStoreCRUDPerformanceMarkerNames
    .offlineDeleteRecord = 'OfflineDataStore_DeleteRecord';
Microsoft.Crm.Client.Core.Framework.OfflineDataStoreCRUDPerformanceMarkerNames
    .offlineRetrieveMultipleRecords = 'OfflineDataStore_RetrieveMultipleRecords';
...
Microsoft.Crm.Client.Core.Framework.FieldFormat.allowedStatusTransitions = Microsoft.Crm.Client.Core.Framework
    .FieldFormat.$C(8);
...
Microsoft.Crm.Client.Core.Framework.RolePrivilegeId
    .overridePriceEngineOpportunity = '0fe2f754-3531-4670-8a8d-b3d7eb49321e';
...
Microsoft.Crm.Client.Core.Framework.RolePrivilegeId
    .readUserQueryVisualizations = 'd68cb29d-2243-41d1-b5a8-ee24dc885140';
Microsoft.Crm.Client.Core.Framework.RolePrivilegeId
    .readSavedQueryVisualizations = '575b9a8f-46da-4fb5-b014-51a689b003f0';
...
Microsoft.Crm.Client.Core.Framework.Common.ResourceManager
    .defaultErrorMessageId = 'Error_Message_Generic_Mobile_Client';
