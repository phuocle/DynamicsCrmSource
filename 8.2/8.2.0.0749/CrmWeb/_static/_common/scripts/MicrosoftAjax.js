...
Sys.Observer.remove = function(a, b) {
    ...
    if (c !== -1) {
        Array.remove(a, b);
        Sys.Observer._collectionChange(a,
...
Sys.Observer.removeAt = function(b, a) {
    if (a > -1 && a < b.length) {
        var c = b[a];
        Array.removeAt(b, a);
        Sys.Observer._collectionChange(b,
    ...
    _getDateTimeFormats: function() {
        if (!this._dateTimeFormats) {
            ...
            this._dateTimeFormats = [
                a.MonthDayPattern, a.YearMonthPattern, a.ShortDatePattern, a.ShortTimePattern, a.LongDatePattern, a
                .LongTimePattern, a.FullDateTimePattern, a.RFC1123Pattern, a.SortableDateTimePattern, a
...
Sys.Serialization.JavaScriptSerializer._serializeStringWithBuilder = function(a, c) {
    ...
    if (Sys.Serialization.JavaScriptSerializer._escapeRegEx.test(a)) {
        ...
        if (a.length < 128)
            a = a.replace(Sys.Serialization.JavaScriptSerializer._escapeRegExGlobal,
                function(a) {
            ...
            for (var d = 0; d < 34; d++) {
                ...
                if (a.indexOf(b) !== -1)
                    if (Sys.Browser.agent === Sys.Browser.Opera || Sys.Browser.agent === Sys.Browser.FireFox)
                        ...
                        a = a.replace(Sys.Serialization.JavaScriptSerializer._charsToEscapeRegExs[b],
...
Sys.UI.DomEvent = function(e) {
    ...
    if (typeof a.button !== "undefined")
        this.button = typeof a.which !== "undefined"
            ? a.button
            : a.button === 4
            ? Sys.UI.MouseButton.middleButton
            : a.button === 2 ? Sys.UI.MouseButton.rightButton : Sys.UI.MouseButton.leftButton;
    if (b === "keypress")
...
Sys._Application.prototype = {
    ...
    findComponent: function(b, a) {
        return a
            ? Sys.IContainer.isInstanceOfType(a) ? a.findComponent(b) : a[b] || null
    ...
    get_xml: function() {
        ...
        if (!a || !a.documentElement) {
            ...
            navigator.userAgent.indexOf("MSIE") !== -1 &&
                a.setProperty("SelectionLanguage", "XPath");
        if (a.documentElement.namespaceURI === "http://www.mozilla.org/newlayout/xml/parsererror.xml" &&
...
Sys.Net.WebServiceProxy.prototype = {
    ...
    _invoke: function(d, e, g, f, c, b, a) {
        ...
        return Sys.Net.WebServiceProxy.invoke(d,
            e,
            g,
            f,
            c,
    ...
    if (n) {
        ...
        function t(d, e) {
            ...
            if (typeof e !== "undefined" && e !== 200) {
                if (b) {
                    h = new Sys.Net.WebServiceError(false,
