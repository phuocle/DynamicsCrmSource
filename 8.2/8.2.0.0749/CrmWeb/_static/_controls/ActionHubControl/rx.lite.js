...
(function(undefined) {
    ...
    (function() {
        ...
        var setImmediate = typeof (setImmediate = freeGlobal && moduleExports && freeGlobal.setImmediate
            ) ==
            'function' &&
    ...
    var Observable = Rx.Observable = (function() {
        ...
        */
        ...
        observableProto.subscribeOnNext = function(onNext, thisArg) {
            return this._subscribe(observerCreate(typeof thisArg !== 'undefined'
                ? function(x) { onNext.call(thisArg, x); }
                : onNext));
        };
        ...
        observableProto.subscribeOnError = function(onError, thisArg) {
            return this._subscribe(observerCreate(null,
                typeof thisArg !== 'undefined' ? function(e) { onError.call(thisArg, e); } : onError));
        };
        ...
        observableProto.subscribeOnCompleted = function(onCompleted, thisArg) {
            return this._subscribe(observerCreate(null,
                null,
                typeof thisArg !== 'undefined' ? function() { onCompleted.call(thisArg); } : onCompleted));
        };
 ...
 */
    ...
    */
    observableProto['do'] = observableProto.tap = observableProto
    ...
    */
    ...
    var RetryWhenObservable = (function(__super__) {
        ...
        RetryWhenObservable.prototype.subscribeCore = function(o) {
            ...
            var cancelable = currentThreadScheduler.scheduleRecursive(null,
                function(_, recurse) {
                    if (state.isDisposed) {
                        return;
                    }
                    ...
                    outer.setDisposable(currentValue.subscribe(
                        ...
                        function(exn) {
                            inner.setDisposable(notifier.subscribe(recurse,
                                function(ex) {
                                    o.onError(ex);
                                },
                                function() {
    ...
    */
    ...
    observableProto.flatMap = observableProto.selectMany = observableProto
    ...
    */
    ...
    function observableTimerDateAndPeriod(dueTime, period, scheduler) {
        return new AnonymousObservable(function(observer) {
            ...
            return scheduler.scheduleRecursiveFuture(0,
                d,
                function(count, self) {
                    if (p > 0) {
    ...
    function observableTimerTimeSpanAndPeriod(dueTime, period, scheduler) {
        return dueTime === period
            ? new AnonymousObservable(function(observer) {
                return scheduler.schedulePeriodic(0,
                    period,
                    function(count) {
                        observer.onNext(count);
                        return count + 1;
                ...
                subscription = source.materialize().timestamp(scheduler).subscribe(function(notification) {
                    ...
                    if (shouldRun) {
                        if (exception !== null) {
                            ...
                            d.setDisposable(scheduler.scheduleRecursiveFuture(null,
                                dueTime,
                                function(_, self) {
    ...
    var DebounceObserver = (function(__super__) {
        ...
        DebounceObserver.prototype.next = function(x) {
            ...
            d.setDisposable(this._scheduler.scheduleFuture(this,
                this._d,
                function(_, self) {
    ...
    function timeout(source, dueTime, other, scheduler) {
        ...
        return new AnonymousObservable(function(o) {
                ...
                function createTimer() {
                    var myId = id;
                    timer.setDisposable(scheduler.scheduleFuture(null,
                        dueTime,
                        function() {
                            switched = id === myId;
                            if (switched) {
    ...
    var ControlledSubject = (function(__super__) {
        ...
        addProperties(ControlledSubject.prototype,
            Observer,
            {
    ...
    var Subject = Rx.Subject = (function(__super__) {
        ...
        addProperties(Subject.prototype,
            Observer.prototype,
            {
                _subscribe: function(o) {
                    checkDisposed(this);
    ...
    var AsyncSubject = Rx.AsyncSubject = (function(__super__) {
        ...
        addProperties(AsyncSubject.prototype,
            Observer.prototype,
            {
                _subscribe: function(o) {
                    checkDisposed(this);
    ...
    var AnonymousSubject = Rx.AnonymousSubject = (function(__super__) {
        ...
        addProperties(AnonymousSubject.prototype,
            Observer.prototype,
            {
                _subscribe: function(o) {
    ...
    var BehaviorSubject = Rx.BehaviorSubject = (function(__super__) {
        ...
        addProperties(BehaviorSubject.prototype,
            Observer.prototype,
            {
                _subscribe: function(o) {
                    checkDisposed(this);
    ...
    var ReplaySubject = Rx.ReplaySubject = (function(__super__) {
        ...
        addProperties(ReplaySubject.prototype,
            Observer.prototype,
            {
                _subscribe: function(o) {
                    checkDisposed(this);
