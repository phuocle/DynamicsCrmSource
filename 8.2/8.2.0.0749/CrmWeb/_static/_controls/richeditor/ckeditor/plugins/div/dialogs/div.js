            ...
            for (i = 0; i < blockGroups.length; i++) {
                ...
                for (j = 0; j < blockGroups[i].length; j++) {
                    ...
                    if (!(currentNode.getCustomData && currentNode.getCustomData('block_processed'))) {
                        currentNode
                            .is &&
                            CKEDITOR.dom.element.setMarker(database, currentNode, 'block_processed', true);
                            ...
                            children: [
                                {
                                    ...
                                    onChange: function() {
                                        commitInternally.call(this,
                                            ['info:elementStyle', 'info:class', 'advanced:dir', 'advanced:style']);
                                    },
                                    setup: function(element) {
                                        for (var name in styles)
                                            styles[name].checkElementRemovable(element, true, editor) &&
