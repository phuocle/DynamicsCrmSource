...
(function() {
    ...
    function validatorNum(msg, tooLargeMsg) {
        return function() {
            ...
            // If/when we get real localized text for too-large values, we could include the check while setting pass above and remove the following five lines.
            if (value > 1000) {
                alert(tooLargeMsg); // jshint ignore:line
                this.select();
                return false;
            }
                                    ...
                                    children: [
                                        {
                                            ...
                                            required: true,
                                            validate:
                                                validatorNum(editor.lang.table.invalidRows,
                                                    editor.lang.common.invalidValue),
                                        ...
                                        },
                                        {
                                            ...
                                            required: true,
                                            validate:
                                                validatorNum(editor.lang.table.invalidCols,
                                                    editor.lang.common.invalidValue),
                                        ...
                                        },
                                        {
                                            ...
                                            items: [
                                                [editor.lang.table.headersNone, 'none'],
                                            ...
                                            setup: function(selectedTable) {
                                                ...
                                                if ((selectedTable.$.tHead !== null))
                                                    ...
                                                    this.setValue(dialog.hasColumnHeaders ? 'col' : 'none');
                                            },
                                            commit: commitValue
                                        },
                                        {
                                ...
                                },
                                {
                                    ...
                                    children: [
                                            ...
                                            children: [
                                                {
                                                    ...
                                                    'default': editor.filter.check('table{width}')
                                                        ? (editable.getSize('width') < 500 ? '100%' : 500)
                                                        : 0,
                                                    getValue: defaultToPixel,
                                                    validate: CKEDITOR.dialog.validate
                                                        .cssLength(editor.lang.common.invalidCssLength
                                                            .replace('%1', editor.lang.common.width)),
                                                    onChange: function() {
                                                        var styles = this.getDialog()
                                        ...
                                        },
                                        {
                                            ...
                                            validate: CKEDITOR.dialog.validate
                                                .number(editor.lang.table.invalidCellSpacing),
                                            setup: function(selectedTable) {
                                        ...
                                        },
                                        {
                                            ...
                                            validate: CKEDITOR.dialog.validate
                                                .number(editor.lang.table.invalidCellPadding),
                                            setup: function(selectedTable) {
                            ...
                            children: [
                                {
                                    ...
                                    setup: function(selectedTable) {
                                        ...
                                        if (nodeList.count() > 0) {
                                            ...
                                            var firstElementChild = caption
                                                .getFirst(CKEDITOR.dom.walker.nodeType(CKEDITOR.NODE_ELEMENT));
