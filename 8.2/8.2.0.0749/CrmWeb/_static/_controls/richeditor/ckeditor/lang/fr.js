...
CKEDITOR.lang['fr'] = {
    ...
    table:
    {
        ...
        cell:
        {
            ...
            invalidRowSpan: 'La plage de lignes doit être un nombre entier.',
            invalidColSpan: 'La plage de colonnes doit être un nombre entier.',
            chooseColor: 'Choisir'
        },
    ...
    stylescombo:
    {
        ...
        panelTitle2: 'Styles intralignes',
        panelTitle3: 'Styles d\'objet'
    },
    specialchar:
    {
        options: 'Options des caractères spéciaux',
        title: 'Sélectionnez un caractère spécial',
    ...
    pastetext:
    {
        button: 'Coller sous forme de texte brut',
        title: 'Coller sous forme de texte brut'
    },
    pastefromword:
    {
        confirmCleanup:
            'Le texte à coller semble avoir été copié depuis Word. Voulez-vous le nettoyer avant de le coller ?',
        error: 'Impossible de nettoyer les données collées en raison d\'une erreur interne',
    ...
    link:
    {
        acccessKey: 'Touche d\'accès rapide',
        advanced: 'Avancé',
        advisoryContentType: 'Type de contenu de conseil',
        advisoryTitle: 'Titre du conseil',
        anchor:
        {
            toolbar: 'Ancre',
            ...
            name: 'Nom de l\'ancre',
            errorName: 'Tapez le nom de l\'ancre.',
        ...
        noEmail: 'Tapez l\'adresse de messagerie',
        noUrl: 'Tapez l\'URL du lien',
        other: '<autre>',
        popupDependent: 'Dépendant (Netscape)',
        popupFeatures: 'Fonctions de la fenêtre contextuelle',
        ...
        targetPopup: '<fenêtre contextuelle>',
        targetPopupName: 'Nom de la fenêtre contextuelle',
        title: 'Lien',
        toAnchor: 'Lier à l\'ancre du texte',
        toEmail: 'Courrier électronique',
        toUrl: 'URL',
        toolbar: 'Lien',
        type: 'Type de lien',
    ...
    image:
    {
        ...
        button2Img: 'Voulez-vous transformer le bouton Image sélectionné en image simple ?',
        hSpace: 'Espacement horizontal',
        img2Button: 'Voulez-vous transformer l\'image sélectionnée sur un bouton Image ?',
    ...
    {
        label: 'Format',
        panelTitle: 'Format du paragraphe',
        tag_address: 'Adresse',
        tag_div: 'Normal (DIV)',
        tag_h1: 'Titre 1',
        tag_h2: 'Titre 2',
    ...
    expand:
    {
        ...
        collapse: 'Réduire le contenu'
    },
    embedmedia:
    {
        pathName: 'objet multimédia',
        title: 'Média incorporé',
        button: 'Média incorporé',
        mediaHtml: 'HTML du média',
        unacceptedContent: '(Tous les indicateurs &lt;script&gt; et &lt;style&gt; seront supprimés)'
    },
    div:
    {
        IdInputLabel: 'ID',
        advisoryTitleInputLabel: 'Titre du conseil',
        cssClassInputLabel: 'Classes de feuille de style',
        edit: 'Modifier Div',
        inlineStyleInputLabel: 'Style intraligne',
    ...
    clipboard:
    {
        copy: 'Copier',
        copyError:
            'Les paramètres de sécurité de votre navigateur n\'autorisent pas à l\'éditeur à exécuter automatiquement des opérations de copie. Utilisez plutôt le clavier à cet effet (Ctrl/Cmd+C).',
        cut: 'Couper',
        cutError:
            'Les paramètres de sécurité de votre navigateur n\'autorisent pas à l\'éditeur à exécuter automatiquement des opérations de coupage. Utilisez plutôt le clavier à cet effet (Ctrl/Cmd+X).',
        paste: 'Coller',
        pasteArea: 'Zone Coller',
        pasteMsg:
            'Collez dans la zone suivante en utilisant le clavier (<strong>Ctrl/Cmd+V</strong>) et cliquez sur OK.',
        securityMsg:
            'L\'éditeur ne peut pas accéder directement à vos données du Presse-papiers à cause des paramètres de sécurité de votre navigateur. Vous devez le recoller dans cette fenêtre.',
        title: 'Coller'
    },
    button:
    {
    ...
    editorPanel: 'Volet Éditeur de texte enrichi',
    common:
    {
        editorHelp: 'Appuyer sur Alt 0 pour obtenir de l\'aide',
        ...
        confirmNewPage:
            'Les modifications non enregistrées vont être perdues. Êtes-vous sûr de vouloir charger une nouvelle page ?',
        confirmCancel: 'Vous avez modifié certaines options. Êtes-vous sûr de vouloir fermer la fenêtre de dialogue ?',
        options: 'Options',
        target: 'Cible',
        ...
        invalidInlineStyle:
            'La valeur spécifiée pour le style intraligne doit être composée d\'au moins un tuple de valeurs au format « nom : valeur », separées par des points-virgules.',
        cssLengthTooltip:
            'Entrez un nombre pour une valeur en pixels ou un nombre avec une unité CSS valide (px, %, in, cm, mm, em, ex, pt ou pc).',
        unavailable: '%1<span class="cke_accessibility">, non disponible</span>',
        invalidURL: 'L\'URL doit être une adresse Web valide.'
    },
    langSizing:
    {
