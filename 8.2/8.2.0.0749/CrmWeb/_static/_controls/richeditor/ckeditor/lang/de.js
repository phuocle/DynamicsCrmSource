...
CKEDITOR.lang['de'] = {
    ...
    toolbar:
    {
        toolbarCollapse: 'Symbolleiste reduzieren',
        toolbarExpand: 'Symbolleiste erweitern',
        toolbarGroups:
        {
            document: 'Dokument',
    ...
    table:
    {
        ...
        cell:
        {
            ...
            cellType: 'Zellart',
            rowSpan: 'Anzahl der Zeilen verbinden',
            colSpan: 'Anzahl der Spalten verbinden',
            ...
            yes: 'Ja',
            no: 'Nein',
            invalidWidth: 'Die Zellenbreite muss als Zahl eingegeben werden.',
            invalidHeight: 'Die Zellenhöhe muss als Zahl eingegeben werden.',
            invalidRowSpan: '"Anzahl der Zeilen verbinden" muss als Ganzzahl eingegeben werden.',
            invalidColSpan: '"Anzahl der Spalten verbinden" muss als Ganzzahl eingegeben werden.',
        ...
        invalidBorder: 'Die Rahmenbreite muss als Zahl eingegeben werden.',
        invalidCellPadding: 'Der Zellenabstand innen muss als positive Zahl eingegeben werden.',
        invalidCellSpacing: 'Der Zellenabstand außen muss als positive Zahl eingegeben werden.',
        invalidCols: 'Die Anzahl der Spalten muss größer als 0 sein.',
        invalidHeight: 'Die Tabellenhöhe muss als Zahl eingegeben werden.',
        invalidRows: 'Die Anzahl der Zeilen muss größer als 0 sein.',
        invalidWidth: 'Die Tabellenbreite muss als Zahl eingegeben werden.',
    ...
    list:
    {
        bulletedlist: 'Aufzählungsliste einfügen/entfernen',
        numberedlist: 'Nummerierte Liste einfügen/entfernen'
    },
    link:
    {
        acccessKey: 'Tastenkombination',
        advanced: 'Erweitert',
        advisoryContentType: 'Inhaltstyp',
        advisoryTitle: 'Titelbeschreibung',
        anchor:
        {
            toolbar: 'Anker',
        ...
        noEmail: 'Bitte geben Sie die E-Mail-Adresse ein.',
        ...
        targetPopupName: 'Popup-Fenster-Name',
        title: 'Link',
        toAnchor: 'Link zum Anker in diesem Text',
        toEmail: 'E-Mail',
        toUrl: 'URL',
        toolbar: 'Link',
        type: 'Link-Typ',
    ...
    image:
    {
        ...
        validateBorder: 'Der Rahmen muss als ganze Zahl angegeben werden.',
        validateHSpace: 'Der horizontale Abstand muss als ganze Zahl angegeben werden.',
        validateVSpace: 'Der vertikale Abstand muss als ganze Zahl angegeben werden.'
    },
    format:
    {
        label: 'Format',
    ...
    expand:
    {
        ...
        collapse: 'Inhalt reduzieren'
    },
    embedmedia:
    {
        pathName: 'Medienobjekt',
        title: 'Medien einbetten',
        button: 'Medien einbetten',
        mediaHtml: 'Medien-HTML',
        unacceptedContent: '(Alle &lt;script&gt;- und &lt;style&gt;-Tags werden entfernt)'
    },
    div:
    {
    ...
    clipboard:
    {
        ...
        cut: 'Ausschneiden',
        cutError:
            'Die Sicherheitseinstellungen Ihres Browsers lassen es nicht zu, den Text automatisch auszuschneiden. Bitte benutzen Sie die System-Zwischenablage über STRG-X (ausschneiden).',
        paste: 'Einfügen',
        pasteArea: 'Einfügebereich',
        pasteMsg:
            'Bitte fügen Sie den Text in dem folgenden Feld über die Tastatur (mit <strong>STRG+V</strong>) ein und bestätigen Sie mit OK.',
        securityMsg:
    ...
    editorPanel: 'Rich Text Editor-Bereich',
    common:
    {
        editorHelp: 'Drücken Sie ALT+0 für die Hilfe.',
        ...
        langDirRtl: 'Rechts nach Links (RTL)',
        langCode: 'Sprachcode',
        longDescr: 'URL für ausführliche Beschreibung',
        ...
        confirmNewPage:
            'Alle nicht gespeicherten Änderungen gehen verloren. Möchten Sie wirklich die neue Seite laden?',
        confirmCancel: 'Einige Optionen wurden geändert. Möchten Sie den Dialog dennoch schließen?',
        options: 'Optionen',
        target: 'Zielseite',
        ...
        invalidHeight: 'Als Höhe muss eine Zahl eingegeben werden.',
        invalidWidth: 'Als Breite muss eine Zahl eingegeben werden.',
        invalidCssLength:
            'Der für das Feld "%1" festgelegte Wert muss ein positiver numerischer Wert mit oder ohne korrekter CSS-Maßeinheit (px, %, in, cm, mm, em, ex, pt oder pc) sein.',
        invalidHtmlLength:
            'Der für das Feld "%1" festgelegte Wert muss ein positiver numerischer Wert mit oder ohne korrekter HTML-Maßeinheit (px oder %) sein.',
        invalidInlineStyle:
            'Der für die Inline-Stilart festgelegte Wert muss aus einem oder mehreren Tupels mit dem Format "Name : Wert" bestehen, getrennt durch Semikolons.',
        cssLengthTooltip:
            'Geben Sie eine Zahl für einen Wert in Pixel oder eine Zahl mit einer korrekten CSS-Einheit (px, %, in, cm, mm, em, ex, pt oder pc) ein.',
        unavailable: '%1<span class="cke_accessibility">, nicht verfügbar</span>',
        invalidURL: 'Die URL muss eine gültige Internetadresse sein.'
    },
    langSizing:
    {
