...
CKEDITOR.lang['pt-br'] = {
    ...
    table:
    {
        ...
        invalidCellPadding: 'O enchimento da célula deve ser um número positivo.',
        invalidCellSpacing: 'O espaçamento de célula deve ser um número positivo.',
    ...
    {
        confirmCleanup:
            'O texto que você deseja colar parece ter sido copiado do Word. Deseja remover a formatação antes de colar?',
    ...
    link:
    {
        ...
        anchor:
        {
            ...
            name: 'Nome da Âncora',
            errorName: 'Digite o nome da âncora',
        ...
        menu: 'Editar Link',
        name: 'Nome',
        noAnchors: '(Não há âncoras disponíveis no documento)',
        ...
        title: 'Link',
        toAnchor: 'Link para ancorar o texto',
        toEmail: 'Email',
        toUrl: 'URL',
        toolbar: 'Link',
        type: 'Tipo de Link',
    ...
    {
        label: 'Formatar',
        panelTitle: 'Formatação de Parágrafo',
    ...
    expand:
    {
        ...
        collapse: 'Recolher Conteúdo'
    },
    embedmedia:
    {
        pathName: 'objeto de mídia',
        title: 'Inserir Mídia',
        button: 'Inserir Mídia',
        mediaHtml: 'HTML de Mídia',
        unacceptedContent: '(Todas as marcas &lt;script&gt; e &lt;style&gt; serão removidas)'
    },
    div:
    {
        IdInputLabel: 'ID',
    ...
    {
        auto: 'Automático',
        bgColorTitle: 'Cor da Tela de Fundo',
        colors:
        {
            '000': 'Preto',
            '800000': 'Bordô',
    ...
    clipboard:
    {
        copy: 'Copiar',
        copyError:
            'As configurações de segurança do seu navegador não permitem que o editor execute operações de cópia automaticamente. Para isso, use o teclado (Ctrl/Cmd+C).',
        cut: 'Recortar',
        cutError:
            'As configurações de segurança do seu navegador não permitem que o editor execute operações de corte automaticamente. Para isso, use o teclado (Ctrl/Cmd+X).',
        paste: 'Colar',
        pasteArea: 'Área de Colar',
        pasteMsg: 'Cole dentro da seguinte caixa usando o teclado (<strong>Ctrl/Cmd+V</strong>) e pressione OK',
        securityMsg:
            'Devido às configurações de segurança do seu navegador, o editor não pode acessar os dados da área de transferência diretamente. Cole o conteúdo novamente nesta janela.',
        title: 'Colar'
    },
    button:
    {
    ...
    common:
    {
        ...
        confirmNewPage:
            'Todas as mudanças não salvas feitas neste conteúdo serão perdidas. Tem certeza de que deseja carregar uma nova página?',
        ...
        invalidInlineStyle:
            'O valor especificado para o estilo embutido deve conter uma ou mais tuplas no formato "nome : valor", separadas por ponto-e-vírgula.',
        cssLengthTooltip:
            'Insira um número para um valor em pixels ou um número com uma unidade CSS válida (px, %, in, cm, mm, em, ex, pt ou pc).',
        unavailable: '%1<span class="cke_accessibility">, indisponível</span>',
        invalidURL: 'A URL deve ser um endereço web válido.'
    },
    langSizing:
    {
