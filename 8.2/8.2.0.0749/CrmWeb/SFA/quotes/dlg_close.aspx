...
<script language="javascript">
    ...
    function updateUIState() {
        ...
        $get('lbCloseOpp').disabled = !($get('rdNoRevisedQuote').checked &&
            <%= _canCloseOpportunity.ToString().ToLower() %>);
    ...
    function applychanges() {
        ...
        if (bCloseOpp) {
            ...
            var oUrl = Mscrm.CrmUri
                .create("/sfa/opps/dlg_closeopp.aspx?pId=<%= Microsoft.Crm.CrmEncodeDecode.CrmJavaScriptEncodeNoQuotes(Microsoft.Crm.CrmEncodeDecode.CrmUrlEncode(_quoteId)) %>&pType=<%= Util.Quote.ToString(System.Globalization.CultureInfo.InvariantCulture) %>&won=false");
...
<table width="100%" style="table-layout: fixed">
    ...
    <tr>
        ...
        <td>
            <label for="closeDate">
                <loc:Text ResourceId="Web.SFA.quotes.dlg_close.aspx_155" runat="server"/>
            </label>
        </td>
        <td colspan="2">
            ...
            <table width='100%' style='table-layout: fixed'>
                ...
                <tr>
                    <td>
                        ...
                        <label id="lblCreateRevisedQuote" for="rdCreateRevisedQuote" style="vertical-align: middle">
                            <loc:Text ResourceId="Web.SFA.quotes.dlg_close.aspx_167" runat="server"/>
                        </label>
                    </td>
                </tr>
                <tr>
                    <td>
                        ...
                        <label for="rdNoRevisedQuote" style="vertical-align: middle">
                            <loc:Text ResourceId="Web.SFA.quotes.dlg_close.aspx_170" runat="server"/>
                        </label>
                    </td>
                </tr>
            </table>
    ...
    <tr>
        ...
        <td class="dlg_close_td_CloseOpp" id="tdCloseOpp" colspan="2">
            <input type="checkbox" class="ms-crm-CheckBox" id="chkCloseOpp">&nbsp;<label id="lbCloseOpp" for="chkCloseOpp">
                <loc:Text ResourceId="Web.SFA.quotes.dlg_close.aspx_178" runat="server"/>
            </label>
        </td>
    </tr>
</table>