...
<head>
    ...
    <title>
        <loc:Text ResourceId="Title_MultiPage_Print" runat="server"/>
    </title>
...
<frm:DialogForm id="crmForm" runat="server">
    <table cellpadding="0" cellspacing="5" width="100%" style="table-layout: fixed">
        ...
        <tr>
            <td colspan="2">
                <b>
                    <loc:Text ResourceId="Instructions_MultiPage_Print" runat="server"/>
                </b>
            </td>
        </tr>
        <tr>
        ...
        <tr style="vertical-align: top">
            <td>
                <input type="radio" name="printOptions" id="printCurrent" style="border: 0px; width: 20px; cursor: pointer;" checked="checked"/>
            </td>
            <td>
                <label for="printCurrent" style="cursor: pointer; line-height: 20px;">
                    <loc:Text ID="txtPrintPage" ResourceId="Label_PrintDlg_PrintPage" runat="server"/>
                </label>
            </td>
        </tr>
        <tr style="vertical-align: top">
            <td>
                <input type="radio" name="printOptions" id="printAll" style="border: 0px; width: 20px; cursor: pointer;"/>
            </td>
            <td>
                <label for="printAll" style="cursor: pointer; line-height: 20px;">
                    <loc:Text ResourceId="Label_PrintDlg_PrintAllPages" runat="server"/>
                </label>
            </td>
        </tr>
    </table>
