    ...
    <script language="JavaScript">
        ...
        function confirmMode(b) {
            ...
            if (b) {
                ...
                if (o.iStateCode == -1 &&
                    !IsNull(_statusCode) &&
                    !IsNull(_statusCode.get_selectedIndex()) &&
                    !IsNull(_statusCode.get_element()[_statusCode.get_selectedIndex()]) &&
                    !IsNull(_statusCode.get_element()[_statusCode.get_selectedIndex()].parentNode
                        .getAttribute('state'))) {
                    o.iStateCode = _statusCode.get_element()[_statusCode.get_selectedIndex()].parentNode
                        .getAttribute('state');
                }
