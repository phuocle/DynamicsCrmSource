...
<div>
    ...
    <div id="UserInputDiv">
        ...
        <div class="ms-crm-ImageSelectionDiv">
            ...
            <label class="ms-crm-Bold-Header ms-crm-ImageSelectOption" for="UploadPictureOption">
                <loc:Text ResourceId="Web._grid.cmds.dlg_imageupload.aspx_UploadOptionLabel" runat="server"/>
            </label>
        ...
        <div id="FileTypeErrorDiv" class="ms-crm-ImageErrorDiv" style="display: none">
            <span class="ms-crm-ImageErrorText">
                <loc:Text ResourceId="Web._grid.cmds.dlg_imageupload.aspx_FileExtensionError" runat="server"/>
            </span>
        </div>
