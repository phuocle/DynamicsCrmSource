...
<script language="JavaScript">
    ...
    function doMerge() {
        ...
        if (result.get_success()) {
            ...
            if (iWarningStart != -1) {
                ...
                var sWarning = CrmEncodeDecode.CrmXmlDecode(result.get_returnValue()
                    .substring(iWarningStart, result.get_returnValue().indexOf("</warning>")));
    ...
    function displayFields() {
        ...
        for (var i = 2; i <= iRows; i++) {
            if (i == iRows || crmMergeForm.rows[i].className == "mergesection") {
                ...
                XUI.Html.DomUtils.GetFirstChild(crmMergeForm.rows[i].cells[iSectionOne]).section = XUI.Html.DomUtils
                    .GetFirstChild(oSectionRow.cells[iSectionOne]);
                XUI.Html.DomUtils.GetFirstChild(crmMergeForm.rows[i].cells[iSectionTwo]).section = XUI.Html.DomUtils
                    .GetFirstChild(oSectionRow.cells[iSectionTwo]);
    ...
    function updateCell(o) {
        if (o.className != "mergecell selected") {
            ...
            var oRadioTwo = (o.cellIndex == iFieldOne)
                ? XUI.Html.DomUtils.GetFirstChild(oRow.cells[iFieldTwo])
                : XUI.Html.DomUtils.GetFirstChild(oRow.cells[iFieldOne]);
    ...
    function selectRecord(o) {
        ...
        if (!IsNull(crmMergeForm) && !IsNull(crmMergeForm.rows[1])) {
            ...
            var iNextSection = selectSection(XUI.Html.DomUtils
                .GetFirstChild(crmMergeForm.rows[1].cells[iRecordColumn]));

            while (iNextSection != -1) {
                iNextSection = selectSection(XUI.Html.DomUtils
                    .GetFirstChild(crmMergeForm.rows[iNextSection].cells[iRecordColumn]));
            }
        }
    }
    ...
    function saveFieldData() {
        ...
        while (oRow != null) {
            ...
            if (oRow.getAttribute('name') == "data") {
                ...
                if ((leftMasterEntity && XUI.Html.DomUtils.GetFirstChild(oRow.cells[fieldTwo]).checked) ||
                    (!leftMasterEntity && XUI.Html.DomUtils.GetFirstChild(oRow.cells[fieldOne]).checked)) {
    ...
    function addXmlNode(oData) {
        ...
        return "<" +
            CrmEncodeDecode.CrmXmlEncode(oData.getAttribute("name")) +
            typeAttribute +
            ">" +
            CrmEncodeDecode.CrmXmlEncode(Trim(oData.getAttribute("returnValue"))) +
            "</" +
            CrmEncodeDecode.CrmXmlEncode(oData.getAttribute("name")) +
            ">";
    }
...
<style type="text/css">
    DIV.ms-crm-POPUP-Menu { display: none; }
</style>
</head>
    ...
    <table width="100%" cellspacing="0" cellpadding="0" class="dlg_merge_MainTable">
            ...
            <td colspan="3">
                <table cellspacing="0" cellpadding="0" class="stdTable dlg_merge_HeaderTable">
                    ...
                    <tr class="ms-crm-Bold-Header">
                        ...
                        <td class="dlg_merge_td_Title">
                            <loc:Text ResourceId="Merge_Fields_Title" runat="server"/>
                        </td>
                    </tr>
                </table>
            </td>
            ...
            <td colspan="3">
                <table width="100%" cellspacing="0" cellpadding="0" style="table-layout: fixed;">
                    <tr height="30px">
                        <td colspan="5" class="dlg_merge_Main_td">
                            <table cellspacing="0" cellpadding="0" class="stdTable">
                                ...
                                <tr height="30px">
                                    <td class="ms-crm-Bold-Header" style="text-indent: 5px;">
                                        <loc:Text ResourceId="Merge_Master_Record_Field" runat="server"/>
                                    </td>
                    ...
                    <tr>
                        ...
                        <td colspan="5">
                            <div id="mergeFields" class="merge"></div>
                        </td>
                    </tr>
                </table>
            </td>
        ...
        <tr>
            ...
            <td class="dlg_merge_td_SelectData">
                <label for="dataCheckBox">
                    <loc:Text ResourceId="Merge_Select_All_Form_Data_Label" runat="server"/>
                </label>
            </td>
        </tr>
        <tr height="10px">
