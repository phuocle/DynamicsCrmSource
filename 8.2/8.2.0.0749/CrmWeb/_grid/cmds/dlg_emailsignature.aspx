...
<head>
    <script type="text/javascript">
        ...
        function ChangeLanguage() {
            ...
            oCommand.SetParameter("entityName", "<%= Request.QueryString["entityName"] %>");
            ...
            if (_oSignature != null) {
                ...
                if (null != richClient && richClient == "1") {
                    ...
                    if (null != targetType && (targetType == "4406" || targetType == "4402")) {
                        ...
                        objSignature
                            .innerHTML =
                            '<img style="MARGIN-RIGHT: 4px" alt="" align=absMiddle src="/_imgs/ico_16_2010.gif">';
                        window.returnValue = objSignature;
                    } else {
                        ...
                        if (result.Success) {
                            ...
                            if (typeof (result.ReturnValue) == "string") {
                                ...
                                if (oXml.getElementsByTagName("SignatureValue")[0] &&
                                    oXml.getElementsByTagName("SignatureValue")[0].firstChild) {
                                    objSignature.EmailBody = CrmEncodeDecode
                                        .CrmXmlDecode(oXml.getElementsByTagName("SignatureValue")[0].firstChild
                                            .nodeValue);
                                }
                            }
                            window.returnValue = objSignature;
    ...
    <style>
        ...
        .ms-crm-SelectOn { border: 1px solid transparent; }
    </style>
</head>
<body>
