...
<head>
    ...
    <title>
        <% if (Request.QueryString["stateTransitionType"] == "revise")
           {
        %>
            <loc:Text ResourceId="Web._grid.cmds.dlg_productStateTransition.aspx_28_revise" runat="server">
                <loc:Argument runat="server"><%= Microsoft.Crm.CrmEncodeDecode.CrmHtmlEncode(toObjName) %></loc:Argument>
            </loc:Text>
        <% }
           else if (Request.QueryString["stateTransitionType"] == "publish")
           {
        %>
            <loc:Text ResourceId="Web._grid.cmds.dlg_productStateTransition.aspx_28_publish" runat="server">
                <loc:Argument runat="server"><%= Microsoft.Crm.CrmEncodeDecode.CrmHtmlEncode(toObjName) %></loc:Argument>
            </loc:Text>
        <% }
           ...
           {
        %>
            <loc:Text ResourceId="Web._grid.cmds.dlg_productStateTransition.aspx_28_revert" runat="server">
                <loc:Argument runat="server"><%= Microsoft.Crm.CrmEncodeDecode.CrmHtmlEncode(toObjName) %></loc:Argument>
            </loc:Text>
        <% }
           ...
           {
        %>
            <loc:Text ResourceId="Web._grid.cmds.dlg_productStateTransition.aspx_28_retire" runat="server">
                <loc:Argument runat="server"><%= Microsoft.Crm.CrmEncodeDecode.CrmHtmlEncode(toObjName) %></loc:Argument>
            </loc:Text>
        <% }
           ...
           {
        %>
            <loc:Text ResourceId="Web._grid.cmds.dlg_productStateTransition.aspx_28_retirehierarchy" runat="server">
                <loc:Argument runat="server"><%= Microsoft.Crm.CrmEncodeDecode.CrmHtmlEncode(toObjName) %></loc:Argument>
            </loc:Text>
        <% }
           ...
           {
        %>
            <loc:Text ResourceId="Web._grid.cmds.dlg_productStateTransition.aspx_28_publishhierarchy" runat="server">
                <loc:Argument runat="server"><%= Microsoft.Crm.CrmEncodeDecode.CrmHtmlEncode(toObjName) %></loc:Argument>
            </loc:Text>
        <% } %>
