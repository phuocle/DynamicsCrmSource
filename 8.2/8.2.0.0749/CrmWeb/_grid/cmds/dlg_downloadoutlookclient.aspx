...
<head>
    ...
    <style type="text/css">
        ...
        .ms-crm-RefreshDialog-SecondTopButton { top: 15px; }
        ...
        .ms-crm-RefreshDialog-Main { top: 65px; }
        ...
        .ms-crm-ReadOnly { font-size: 12px; }

        a.default-link:link, a.default-link:visited, a.default-link:active { color: #115FB7; }
    </style>
...
<frm:DialogForm id="crmForm" runat="server">
    <table width="100%" height="90%" cellspacing="0" cellpadding="0">
        <tr>
            <td valign="top">
                <div class="Step">
                    <loc:Text ResourceId="Dialog.DownloadClient.Step1" runat="server"/>
                </div>
                <div class="Desc">
                    <loc:Text ResourceId="Dialog.DownloadClient.Step1Desc" runat="server"/>
                    <a id='downloadLink' class="default-link" href='#' target="_blank">
                        <span>
                            <loc:Text ResourceId="Dialog.DownloadClient.DownloadLink" runat="server"/>
                        </span>
                    </a>
                    <br/>
        ...
        <tr>
            <td valign="top">
                ...
                <div class="Desc">
                    <loc:Text ResourceId="Dialog.DownloadClient.Step2Desc" runat="server"/>
        ...
        <tr>
            <td valign="top">
                <div class="Step">
                    <loc:Text ResourceId="Dialog.DownloadClient.Step3" runat="server"/>
                </div>
            </td>
        </tr>
    </table>
