...
<frm:DialogForm id="crmForm" runat="server">
    <div style="height: 45px;">
        <b>
            <loc:Text ResourceId="SolutionComponent.AddExisting.Dialog.Description" runat="server"/>
        </b>
    </div>
            ...
            <tr>
                ...
                <td style="vertical-align: middle">
                    <label for="rdoYes" hidefocus="true">
                        <b>
                            <loc:Text ResourceId="SolutionComponent.AddExisting.Option.Yes.Text" runat="server"/>
                        </b>
                    </label>
                </td>
            </tr>
            <tr>
                ...
                <td style="vertical-align: middle">
                    <label for="rdoNo" hidefocus="true">
                        <b>
                            <loc:Text ResourceId="SolutionComponent.AddExisting.Option.No.Text" runat="server"/>
                        </b>
                    </label>
                </td>
            </tr>
    ...
    <div style="display: <%= showGrid %>; height: 30px;">
        <b>
            <loc:Text ResourceId="SolutionComponent.AddExisting.Dialog.Title" runat="server"/>
        </b>
    </div>
