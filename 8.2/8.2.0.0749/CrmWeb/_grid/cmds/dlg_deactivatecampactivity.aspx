...
<head>
    ...
    <script language="JavaScript">
        ...
        function confirmMode(b) {
            ...
            if (b) {
                var o = new Object();
                o.iStateCode = ("undefined" == typeof(Mscrm.FormControlInputBehavior.GetBehavior('stateCode')))
                    ? -1
                    : Mscrm.FormControlInputBehavior.GetBehavior('stateCode').get_dataValue();
                o.iStatusCode = (IsNull(Mscrm.FormControlInputBehavior.GetBehavior('statusCode')))
                    ? -1
                    : Mscrm.FormControlInputBehavior.GetBehavior('statusCode').get_dataValue();
                if (_txtStartDate.get_dataValue() != null) {
                    o.iStartDate = ("undefined" == typeof(_txtStartDate))
                        ? -1
                        : FormatUtcDateTime(_txtStartDate.get_dataValue());
                } else {
                    o.iStartDate = "";
                }
                if (_txtEndDate.get_dataValue() != null) {
                    o.iEndDate = ("undefined" == typeof(_txtEndDate))
                        ? -1
                        : FormatUtcDateTime(_txtEndDate.get_dataValue());
                } else {
                    o.iEndDate = "";
                }
...
<frm:DialogForm id="crmForm" runat="server">
    ...
    <table cellpadding="0" border=0 bordercolor=red cellspacing="0" width="100%" style="table-layout: fixed">
        <col width="80"></col>
        <tr>
            <td width=25% class="dlg_deactivatecampactivity_td_status">
        ...
        <tr>
            <td class="dlg_deactivatecampactivity_td_StartDate">
                <label for="txtStartDate">
                    <loc:Text ResourceId="Web._grid.cmds.dlg_deactivate.aspx_88" runat="server"/>
                </label>
            </td>
            <td>
        ...
        <tr>
            <td class="dlg_deactivatecampactivity_td_EndDate">
                <label for="txtEndDate">
                    <loc:Text ResourceId="Web._grid.cmds.dlg_deactivate.aspx_89" runat="server"/>
                </label>
            </td>
            <td>
