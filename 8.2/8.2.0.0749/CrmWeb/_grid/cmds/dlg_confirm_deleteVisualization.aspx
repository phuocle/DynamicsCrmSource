...
<head>
    ...
    <title>
        <loc:Text ResourceId="Visualization_Deletion_Confirmation_Title" runat="server"/>
    </title>
...
<frm:DialogForm id="crmForm" runat="server">
    <table width="100%" style="table-layout: fixed">
        ...
        <tr>
            <td>
                <loc:Text ResourceId="Visualization_Deletion_Confirmation_Message" runat="server"/>
            </td>
        </tr>
    </table>
</frm:DialogForm>
