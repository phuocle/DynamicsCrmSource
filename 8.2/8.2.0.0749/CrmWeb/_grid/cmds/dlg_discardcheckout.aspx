...
<head>
    ...
    <title>
        <loc:Text ResourceId="Web._grid.cmds.dlg_discardcheckout.aspx_discardTitle" runat="server"/>
    </title>
...
<frm:DialogForm id="crmForm" runat="server">
    <table width="100%" style="table-layout: fixed">
        ...
        <tr>
            <td>
                <loc:Text ResourceId="Web._grid.cmds.dlg_discardcheckout.aspx_discardconfirm" runat="server"/>
            </td>
        </tr>
    </table>
</frm:DialogForm>
