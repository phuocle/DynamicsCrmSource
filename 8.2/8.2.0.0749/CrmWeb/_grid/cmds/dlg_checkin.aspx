        ...
        <tr>
            <td colspan="4">
                ...
                <label for="rdRetain1" class="ms-crm-radioTextDialog">
                    <loc:Text ResourceId="Web._grid.cmds.dlg_checkin.aspx_retainYes" runat="server"/>
                </label>
                ...
                <label for="rdRetain2" class="ms-crm-radioTextDialog">
                    <loc:Text ResourceId="Web._grid.cmds.dlg_checkin.aspx_retainNo" runat="server"/>
                </label>
            </td>
        </tr>
