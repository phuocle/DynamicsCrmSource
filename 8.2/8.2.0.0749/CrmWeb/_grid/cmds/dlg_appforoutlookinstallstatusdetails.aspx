...
<head>
    ...
    <style type="text/css">
        ...
        .ms-crm-RefreshDialog-Warning { position: static !important; }
        ...
        .exceptionText { font-weight: bold !important; }
        ...
        .anchorText { color: #444444 !important; }
        ...
        <div>
            ...
            <div class="navTourClose" runat="server" tabindex="0">
                <a class="navTourCloseButton" href="javascript:closeWindow(true);" id="buttonClose" tabindex="-1">
                    <div class="navTourCloseDiv">
                        <img class="closeButtonImage" alt="<loc:Text ResourceId='Button_Label_Close' runat='server'/>" src="/_imgs/NavTourNew/icon_x-close_13x13.png" unselectable="on"/>
                    </div>
                </a>
            </div>
        </div>
