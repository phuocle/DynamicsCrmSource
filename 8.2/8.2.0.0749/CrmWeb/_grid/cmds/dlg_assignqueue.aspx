...
<head>
    <title>
        <loc:Text ResourceId="Web._grid.cmds.dlg_assignqueue.aspx_13" runat="server"/>
    </title>
    ...
    <script type="text/javascript">
        ...
        function applychanges() {
           ...
           if (sourceQueueId != null)
           {
                        %>
                        _custParams +=
                            "&srcQueueId=<%= Microsoft.Crm.CrmEncodeDecode.CrmJavaScriptEncodeNoQuotes(Microsoft.Crm.CrmEncodeDecode.CrmUrlEncode(sourceQueueId)) %>";
                        <%
           }
                        %>
        ...
        function updateUIState() {
            ...
            $get("butBegin").disabled = (!IsNull(crmOwnerLookupControl) && !crmOwnerLookupControl.get_disabled()) &&
                IsNull(crmOwnerLookupControl.get_dataValue());
        }
    </script>
</head>
