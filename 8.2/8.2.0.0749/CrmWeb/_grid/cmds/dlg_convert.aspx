...
<head>
    ...
    <title>
        <loc:Text ResourceId="Web._grid.cmds.dlg_convert.aspx_28" runat="server">
...
<frm:DialogForm id="crmForm" runat="server">
    ...
    <%
       ...
       {
    %>
        <loc:Text ResourceId="Web._grid.cmds.dlg_convert.aspx_63" runat="server">
            <loc:Argument ID="Argument2" runat="server"><%= Microsoft.Crm.CrmEncodeDecode.CrmHtmlEncode(fromObjName) %></loc:Argument>
        </loc:Text>
    <%
       }
    %>
