...
<head>
    <title>
        <loc:Text ResourceId="Web._grid.cmds.dlg_removeitems.aspx_7" runat="server"/>
    </title>
    ...
    <script type="text/javascript" language="JavaScript">
        ...
        function applychanges() {
            _custParams +=
                "&groupid=<%= Microsoft.Crm.CrmEncodeDecode.CrmJavaScriptEncodeNoQuotes(Microsoft.Crm.CrmEncodeDecode.CrmUrlEncode(Request.QueryString["groupid"])) %>";
            go();
        }
    </script>
</head>
