...
<script language="javascript">
    ...
    function enable() {
        Mscrm.FormControlInputBehavior.GetBehavior("ActivityLookup")
            .set_disabled(($get("rad_user_queue").checked) ? false : true);
        Mscrm.FormControlInputBehavior.GetBehavior("QueueLookup")
            .set_disabled(($get("chk_queue").checked) ? false : true);
    }
    ...
    <tr>
        ...
        <table width="100%" style="table-layout: fixed">
            ...
            <tr>
                ...
                <td>
                    <label for="rad_3">
                        <loc:Text ResourceId="MA.CampaignActivity.Dialogs.confirm_propagation.aspx_Owner_Myself" runat="server"/>
                    </label>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <label for="rad_user_queue">
                        <loc:Text ResourceId="Confirm_Propagation_Dlg_Assign_Label" runat="server"/>
                    </label>
