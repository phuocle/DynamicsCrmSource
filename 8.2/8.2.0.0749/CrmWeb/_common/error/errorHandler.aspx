            ...
            <td style="text-align: center; padding-top: 3px;">
                <table id="ErrorDetailsBody" width="442px" cellspacing="0" cellpadding="5" class="tblErrorDetails">
                    ...
                    <tr>
                        ...
                        <td>
                            <h1>
                                <div tabIndex="0" runat="server" id="ErrorTitle" class="ms-crm-Error-Header"></div>
                            </h1>
                            <p>
                    ...
                    <tr>
                        <td colspan="2" style="padding-top: 20px;">
                            <table width="100%" height="100%" cellspacing="0" cellpadding="0">
                                ...
                                <tr height="20px">
                                    <td>
                                        <img alt="" src="/_imgs/box_on_left.gif" class="errorHandler_img_boxOnLeft">
                                    </td>
                                    <td nowrap class="ms-crm-Error-AdditionalInformation">
                                        <loc:Text ResourceId="Web._common.error.unsupported.aspx_74" runat="server"/>
                                    </td>
                                    <td>
                                        <img alt="" src="/_imgs/box_right.gif" class="errorHandler_img_BoxRight"/>
                                    </td>
                                </tr>
                                <tr>
