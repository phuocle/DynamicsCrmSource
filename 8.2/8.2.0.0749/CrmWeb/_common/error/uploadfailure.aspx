    ...
    <script type="text/javascript">
        ...
        function PageOnLoad() {
            ...
            if (typeof(traceMessage) != "undefined") {
                ...
                $get('TraceMessage').innerHTML = CrmEncodeDecode.CrmHtmlEncode(traceMessage.replace("\r", ""))
                    .replace("&#10;", "<br/>");
            }
            $addHandler(window, 'unload', PageOnUnLoad);

            try {
                window.opener.auto(_objectType);
            } catch (e) {
            }
        }
...
<table cellpadding="0" cellspacing="0" width="100%" style="table-layout: fixed;" class="ms-crm-Dialog-Error">
    ...
    <tr>
        <td>&nbsp;</td>
        <td class="ms-crm-Dialog-Error-Icon" style="vertical-align: top;">
    ...
    <tr style="vertical-align: top;">
        ...
        <td style="padding-top: 8px">
            <div id="TraceMessage" runat="server"></div>
        </td>
    </tr>
    <tr>
        <td colspan="2">&nbsp;</td>
        <td style="padding-top: 8px">
            <a href="javascript:resizeToOriginalAndReturn()" class="ms-crm-Dialog-Error-Link" id="returnLink">
                <loc:Text ResourceId="Web._common.error.uploadfailure.aspx_45" runat="server"/>
            </a>
        </td>
        <td>&nbsp;</td>
    </tr>
