                ...
                <div id="divInformationSection">
                    <fieldset>
                        ...
                        <table cellpadding="0" cellspacing="5" width="100%" style="table-layout: fixed;">
                            ...
                            <tr>
                                <td id="tdStatusEncryption" colspan="2">
                            ...
                            <tr>
                                <td colspan="2">
                                    <loc:Text ResourceId="Web.Tools.SqlEncryption.aspx.CurrentEncryptionKey" runat="server"/>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="2">
                                    <div id="divDisplayEncryptionKeyHidden">
                                        <ui:TextBox id="txtDisplayEncryptionKeyHidden" runat="server"/>
                                    </div>
                                    <div id="divDisplayEncryptionKeyShown" style="display: none">
                                        <ui:TextBox id="txtDisplayEncryptionKeyShown" runat="server"/>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <ui:CheckBox id="chkShowEncryptionKey" onclick="chkShowEncryptionKey_OnClick();" runat="server"/>
                                </td>
                                <td>
                                    <label for="chkShowEncryptionKey">
                                        <loc:Text ResourceId="Web.Tools.SqlEncryption.aspx.Show" runat="server"/>
                                    </label>
                                </td>
                            </tr>
                        </table>
                ...
                <div id="divChangeSection" style="display: <%= this.isSqlEncryptionActive ? "block" : "none" %>">
                    ...
                    <fieldset>
                        ...
                        <table cellpadding="0" cellspacing="5" width="100%" style="table-layout: fixed;">
                            ...
                            <tr>
                                <td colspan="2">
                                    <ui:TextBox id="txtChangeNewEncryptionKey" runat="server"/>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <loc:Text ResourceId="Web.Tools.SqlEncryption.aspx.ChangeKeyRequirements" runat="server"/>
                                </td>
                                <td align="right">
                                    <ui:Button id="butChangeEncryptionKey" onclick="butChangeEncryptionKey_OnClick();" ResourceId="Web.Tools.SqlEncryption.aspx.Change" runat="server"/>
                                </td>
                            </tr>
                        </table>
                    </fieldset>
                            ...
                            <td>
                                <loc:Text ResourceId="Web.Tools.SqlEncryption.aspx.ChangeAndRestoreWarning" runat="server">
                                    <loc:Argument runat="server">
                                        <a href="http://go.microsoft.com/fwlink/?LinkId=316366" target="_blank" style="text-decoration: underline">
                                            <loc:Text ResourceId="DataManagement.SqlEncryption.ChangeAndRestoreWarning.HelpLinkTitle" runat="server"/>
                                        </a>
                                    </loc:Argument>
                                </loc:Text>
                            </td>
                ...
                <div id="divRestoreSection" style="display: <%= this.isSqlEncryptionActive ? "none" : "block" %>">
                    ...
                    <fieldset>
                        ...
                        <table cellpadding="0" cellspacing="5" width="100%" style="table-layout: fixed;">
                            ...
                            <tr>
                                <td colspan="2">
                                    <ui:TextBox id="txtRestoreEnterEncryptionKey" runat="server"/>
                                </td>
                            </tr>
                            <tr>
                                <td/>
                                <td align="right">
                                    <ui:Button id="butRestoreEncryptionKey" onclick="butRestoreEncryptionKey_OnClick();" ResourceId="Web.Tools.SqlEncryption.aspx.Restore" runat="server"/>
                                </td>
                            </tr>
                        </table>
                    </fieldset>
