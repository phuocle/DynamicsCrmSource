...
<head>
    ...
    <script language="javascript" type="text/javascript">
        ...
        function GetNextPageDefinition() {
            ...
            var uri = Mscrm.CrmUri.create('/Tools/Solution/ExportWizard/PackageSelectionPage.aspx?appSolutionId=' +
                solutionId);
        ...
        function LoadPageProperties() {
            ...
            if (WizardHasProperty("exportOutlookSynchronization")) {
                document.getElementById("exportOutlookSynchronization")
                    .checked = WizardGetProperty("exportOutlookSynchronization");
            }
            ...
            if (WizardHasProperty("exportExternalApplications")) {
                document.getElementById("exportExternalApplications")
                    .checked = WizardGetProperty("exportExternalApplications");
            }
        }
        ...
        function SavePageProperties() {
            ...
            WizardSetProperty("exportOutlookSynchronization",
                document.getElementById("exportOutlookSynchronization").checked);
            ...
            WizardSetProperty("exportExternalApplications",
                document.getElementById("exportExternalApplications").checked);
        ...
        function GetOptionsXml() {
            ...
            addTextXmlNode(oDataXml,
                "exportOutlookSynchronization",
                document.getElementById("exportOutlookSynchronization").checked);
            addTextXmlNode(oDataXml,
                "exportRelationshipRole",
                document.getElementById("exportRelationshipRole").checked);
