    ...
    <script type="text/javascript" language="javascript">
        ...
        function SendMessageToMarketplace() {
            ...
            iframewindow.postMessage({
                    ...
                    "hostData": {
                        firstName: Marketplace_UserFirstName,
                        lastName: Marketplace_UserLastName,
                        workEmail: Marketplace_UserWorkEmail,
                        sessionId: Marketplace_TelemetrySessionId
                    }
                },
                Marketplace_Host);
        }
        ...
        function ReceiveMessageFromMarketplace(msg) {
            ...
            if (msg.data.msgType == 'acquireApp') {
                var gladosUrl = GladosMarketplace_Url +
                    "&telemetrySessionId=" +
                    Marketplace_TelemetrySessionId +
                    "&data=" +
