...
<head>
    ...
    <script type="text/javascript">
        ...
        function processSkipProductUpdateDependenciesChange(skipProductUpdateDependenciesCheckBox) {
            $get(Mscrm.SolutionWizardController.skipProductUpdateDependencies)
                .value = skipProductUpdateDependenciesCheckBox.checked;
...
<input type="hidden" id="hasError" value="<%= Microsoft.Crm.CrmEncodeDecode.CrmHtmlAttributeEncode(hasError) %>"/>
