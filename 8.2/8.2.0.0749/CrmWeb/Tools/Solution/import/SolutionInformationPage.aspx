...
<head>
    ...
    <script type="text/javascript">
        ...
        function resizeLayout() {
            var computedStyle = $get("div_content").offsetHeight -
                ($get("tb_solution").offsetHeight + $get("tb_publisher").offsetHeight + 7);
                ...
                <tr>
                    <td style="width: 50%">
                        <table class="stdTable" cellspacing="0" style="table-layout: fixed; width: 100%; vertical-align: top;">
                            ...
                            <% if (!string.IsNullOrEmpty(solutionParentUniqueName))
                               {
                            %>
                                <tr style="vertical-align: top">
                                    <td class="ms-crm-FieldLabel-LeftAlign">
                                        <label for="solutionTargetVersion">
                                            <loc:text resourceid="SystemCustomization.ImportCustomizationsPage.Tab.Solution.solutionTargetVersion" runat="server"/>
                                        </label>
                                    </td>
                                    <td id="version_t">
                                        <ui:textbox id="solutionTargetVersion" tabindex="-1" runat="server"/>
                                    </td>
                                </tr>
                            <%
                               }
                    ...
                    <td style="width: 50%">
                        <table class="stdTable" cellspacing="0" style="table-layout: fixed; width: 100%; vertical-align: top;">
                            ...
                            %>
                                <tr>
                                    <td class="ms-crm-FieldLabel-LeftAlign">
                                        <label for="solutionTargetName">
                                            <loc:text resourceid="SystemCustomization.ImportCustomizationsPage.Tab.Solution.solutionTargetName" runat="server"/>
                                        </label>
                                    </td>
                                    <td>
                                        <ui:textbox id="solutionTargetName" tabindex="-1" runat="server"/>
                                    </td>
                                </tr>
                            <%
                               }
