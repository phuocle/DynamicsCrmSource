    ...
    <div id="borderdiv" class='border'>
        <div id="solutionTabsContainer" class='tabContainer'>
            <div id="popularSolutionsContainer" class='solutionsTab selectedTab'>
                <span id="popularSolutions" class='listingType'>
                    <a href="#" class='listingText'>
                        <loc:Text ResourceId="Tools.Customization.SolutionsMarketplace.Popular" runat="server"/>
                    </a>
                </span>
            </div>
            <div id="newestSolutionsContainer" class='solutionsTab'>
                <span id="newestSolutions" class='listingType'>
                    <a href="#" class='listingText'>
                        <loc:Text ResourceId="Tools.Customization.SolutionsMarketplace.Newest" runat="server"/>
                    </a>
                </span>
            </div>
            <div id="staffPicksSolutionsContainer" class='solutionsTab'>
                <span id="staffPicksSolutions" class='listingType'>
                    <a href="#" class='listingText'>
                        <loc:Text ResourceId="Tools.Customization.SolutionsMarketplace.StaffPicks" runat="server"/>
                    </a>
                </span>
            </div>
            <div id="popularSolutionsMoreContainer" class='solutionsTab'>
                <span class='listingType'>
                    <a id="popularSolutionsMoreLink" target="_blank" runat="server">
                        <loc:Text ResourceId="Solutions.Marketplace.More.Link" runat="server"/>
                    </a>
                </span>
            </div>
            <div id="newestSolutionsMoreContainer" class='solutionsTab'>
                <span class='listingType'>
                    <a id="newestSolutionsMoreLink" target="_blank" runat="server">
                        <loc:Text ResourceId="Solutions.Marketplace.More.Link" runat="server"/>
                    </a>
                </span>
            </div>
            <div id="staffPicksSolutionsMoreContainer" class='solutionsTab'>
                <span class='listingType'>
                    <a id="staffPicksSolutionsMoreLink" target="_blank" runat="server">
                        <loc:Text ResourceId="Solutions.Marketplace.More.Link" runat="server"/>
                    </a>
                </span>
            </div>
            <span class="tabbottomborder">
                <img width="100%" height="1px" align="middle" alt="" src="/_imgs/tools/hr.gif"/>
            </span>
        </div>
