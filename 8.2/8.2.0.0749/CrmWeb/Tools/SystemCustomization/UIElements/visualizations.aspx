...
<head>
    ...
    <script type="text/javascript" language="javascript">
        var _bCanUpdateViews =
            <% = Microsoft.Crm.Security.User.GetPrivilege(Privileges.WriteQuery, Microsoft.Crm.Application.Security.UserInformation.Current) ? "true" : "false" %>;
    ...
    <div class="ms-crm-home-querycontainer">
        <table style="width: 100%" cellpadding="0" cellspacing="0">
            <tr>
                ...
                <td style="width: 100%">
                    <ui:Select id="selectFilter" OnChange="onFilterChange();" runat="server"/>
                </td>
            </tr>
        </table>
    </div>
