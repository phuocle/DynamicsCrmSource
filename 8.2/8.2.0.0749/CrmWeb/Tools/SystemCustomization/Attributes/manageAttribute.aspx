                ...
                <td>
                    <table width="100%" style="table-layout: fixed;" cellspacing="0" cellpadding="3">
                        ...
                        <tr class="param">
                            ...
                            <td id="txtDisplayNameLabel" class="ms-crm-Field-Required">
                        ...
                        <tr class="param">
                                        ...
                                        %>
                                            <td>
                                                <div id="txtSchemaNamePrefix" class="manageAttribute_div_SchemaName">
                                                    <%= Microsoft.Crm.CrmEncodeDecode.CrmHtmlEncode(CurrentSolutionContext.Prefix.ToLowerInvariant()) %>
                                                </div>
                                            </td>
                                        <%
                                            }
                            ...
                            <td id="selectSearchableLabel" class="ms-crm-Field-Normal">
                                <label for="selectSearchable">
                        ...
                        <tr class="param">
                        <tr class="param">
                            <td id="rdFieldSecurityLabel" class="ms-crm-Field-Normal">
                                <label for="rdFieldSecurityLabel">
                                    <loc:text resourceid="SystemCustomization.ManageAttributePage.SchemaSection.Labels.FieldSecurity" runat="server"/>
                                </label>
                            </td>
                            <td>
                        ...
                        <tr class="param" id="txtFieldSecurityAlertMessage" runat="server">
                            ...
                            <td colspan="3">
                                ...
                                <span style="vertical-align: middle;">
                                    <loc:text resourceid="SystemCustomization.ManageAttributePage.SchemaSection.Alert.FieldSecurity" runat="server"/>
                                </span>
                                <a style="vertical-align: middle;" target="_blank" href="<%= CurrentResourceManager.GetString("ManageAttribute.aspx_Link_LearnMore") %>" class="help_link">
                                    <loc:Text ResourceId="ManageAttribute.aspx_Text_LearnMore" runat="server"/>
                                </a>
                            </td>
                        </tr>
                        <tr class="param">
                            <td id="rdAuditingLabel" class="ms-crm-Field-Required">
                                <label for="rdIsAuditingEnabled">
                                    <loc:text resourceid="SystemCustomization.ManageAttributePage.SchemaSection.Labels.Auditing" runat="server"/><img src="/_imgs/frm_required.gif" alt="<loc:Text Encoding='HtmlAttribute' ResourceId='Forms.Required.AltTag' runat='server'/>"/>
                                </label>
                            </td>
                            <td>
                        ...
                        <tr class="param" style="height: 80px">
                            <td id="txtDescriptionLabel" class="ms-crm-Field-Normal" valign="top">
                        ...
                        <% if (Microsoft.Crm.Caching.FeatureEnabledHelper.IsFeatureEnabled(FeatureControl.Current.Features.InteractionCentricDashboard, Microsoft.Crm.Application.Security.UserInformation.Current) == true)
                           { %>
                            <tr class="param">
                                <td id="selectIsGlobalFilterEnabledLabel" class="ms-crm-Field-Normal">
                                    <label for="selectIsGlobalFilterEnabled">
                                        <loc:text resourceid="SystemCustomization.ManageAttributePage.SchemaSection.Labels.GlobalFilterEnabled" runat="server"/>
                                    </label>
                                </td>
                                <td>
                                    <ui:CheckBox id="selectIsGlobalFilterEnabled" runat="server"/>
                                </td>
                                <td id="selectIsSortableEnabledLabel" class="ms-crm-Field-Normal">
                                    <label for="selectIsSortableEnabled">
                                        <loc:text resourceid="SystemCustomization.ManageAttributePage.SchemaSection.Labels.SortableEnabled" runat="server"/>
                                    </label>
                                </td>
                                <td>
...
<tr>
    <td>
        <table width="100%" style="table-layout: fixed;" cellspacing="0" cellpadding="0">
            ...
            <tr class="param">
                <td id="selTypeLabel" class="ms-crm-Field-Required typelabel">
                    <label for="selType">
            ...
            <tr id="dataSourceParam" class="param" style="display: none;">
                <td id="selDataSourceLabel" class="ms-crm-Field-Required typelabel">
                    <label for="selDataSource">
                        <loc:text resourceid="SystemCustomization.ManageAttributePage.TypeSection.Labels.DataSource" runat="server"/><img src="/_imgs/frm_required.gif" alt="<loc:Text Encoding='HtmlAttribute' ResourceId='Forms.Required.AltTag' runat='server'/>"/>
                    </label>
                </td>
                <td class="typecontrol">
...
<tr id="intParams" style="display: none;">
    <td>
        <table width="100%" style="table-layout: fixed;" cellspacing="0" cellpadding="0">
            ...
            <tr class="param">
                <td id="selIntFormatLabel" class="ms-crm-Field-Required">
                    <label for="selIntFormat">
            ...
            <tr class="IntegerParams param">
                <td id="numMinIntValueLabel" class="ms-crm-Field-Required">
                    <label for="numMinIntValue">
                        <loc:text resourceid="SystemCustomization.ManageAttributePage.TypeSection.Labels.MinValue" runat="server"/><img src="/_imgs/frm_required.gif" alt="<loc:Text Encoding='HtmlAttribute' ResourceId='Forms.Required.AltTag' runat='server'/>"/>
                    </label>
                </td>
                <td>
            ...
            <tr class="IntegerParams param">
                <td id="numMaxIntValueLabel" class="ms-crm-Field-Required">
                    <label for="numMaxIntValue">
                        <loc:text resourceid="SystemCustomization.ManageAttributePage.TypeSection.Labels.MaxValue" runat="server"/><img src="/_imgs/frm_required.gif" alt="<loc:Text Encoding='HtmlAttribute' ResourceId='Forms.Required.AltTag' runat='server'/>"/>
                    </label>
                </td>
                <td>
...
<tr id="floatParams" style="display: none;">
    <td>
        <table width="100%" style="table-layout: fixed;" cellspacing="0" cellpadding="0">
            ...
            <tr class="param">
                <td id="selFloatPrecisionLabel" class="ms-crm-Field-Required">
                    <label for="selFloatPrecision">
                        <loc:text resourceid="SystemCustomization.ManageAttributePage.TypeSection.Labels.Precision" runat="server"/><img src="/_imgs/frm_required.gif" alt="<loc:Text Encoding='HtmlAttribute' ResourceId='Forms.Required.AltTag' runat='server'/>"/>
                    </label>
                </td>
                <td width="100%">
            ...
            <tr class="param">
                <td id="numMinFloatValueLabel" class="ms-crm-Field-Required">
                    <label for="numMinFloatValue">
                        <loc:text resourceid="SystemCustomization.ManageAttributePage.TypeSection.Labels.MinValue" runat="server"/><img src="/_imgs/frm_required.gif" alt="<loc:Text Encoding='HtmlAttribute' ResourceId='Forms.Required.AltTag' runat='server'/>"/>
                    </label>
                </td>
                <td>
            ...
            <tr class="param">
                <td id="numMaxFloatValueLabel" class="ms-crm-Field-Required">
                    <label for="numMaxFloatValue">
                        <loc:text resourceid="SystemCustomization.ManageAttributePage.TypeSection.Labels.MaxValue" runat="server"/><img src="/_imgs/frm_required.gif" alt="<loc:Text Encoding='HtmlAttribute' ResourceId='Forms.Required.AltTag' runat='server'/>"/>
                    </label>
                </td>
                <td>
...
<tr id="decimalParams" style="display: none;">
    <td>
        <table width="100%" style="table-layout: fixed;" cellspacing="0" cellpadding="0">
            ...
            <tr class="param">
                <td id="selDecimalPrecisionLabel" class="ms-crm-Field-Required">
                    <label for="selDecimalPrecision">
                        <loc:text resourceid="SystemCustomization.ManageAttributePage.TypeSection.Labels.Precision" runat="server"/><img src="/_imgs/frm_required.gif" alt="<loc:Text Encoding='HtmlAttribute' ResourceId='Forms.Required.AltTag' runat='server'/>"/>
                    </label>
                </td>
                <td width="100%">
            ...
            <tr class="param">
                <td id="numMinDecimalValueLabel" class="ms-crm-Field-Required">
                    <label for="numMinDecimalValue">
                        <loc:text resourceid="SystemCustomization.ManageAttributePage.TypeSection.Labels.MinValue" runat="server"/><img src="/_imgs/frm_required.gif" alt="<loc:Text Encoding='HtmlAttribute' ResourceId='Forms.Required.AltTag' runat='server'/>"/>
                    </label>
                </td>
                <td>
            ...
            <tr class="param">
                <td id="numMaxDecimalValueLabel" class="ms-crm-Field-Required">
                    <label for="numMaxDecimalValue">
                        <loc:text resourceid="SystemCustomization.ManageAttributePage.TypeSection.Labels.MaxValue" runat="server"/><img src="/_imgs/frm_required.gif" alt="<loc:Text Encoding='HtmlAttribute' ResourceId='Forms.Required.AltTag' runat='server'/>"/>
                    </label>
                </td>
                <td>
...
<tr id="datetimeParams" style="display: none;">
    <td>
        <table width="100%" style="table-layout: fixed;" cellspacing="0" cellpadding="0">
            ...
            <tr class="param">
                <td id="selDatetimeBehaviorLabel" class="ms-crm-Field-Required">
                    <label for="selDatetimeBehavior">
                        <loc:text resourceid="SystemCustomization.ManageAttributePage.TypeSection.Labels.Behavior" runat="server"/><img src="/_imgs/frm_required.gif" alt="<loc:Text Encoding='HtmlAttribute' ResourceId='Forms.Required.AltTag' runat='server'/>"/>
                    </label>
                </td>
                <td width="100%">
        ...
        <table width="100%" style="table-layout: fixed;" cellspacing="0" cellpadding="0">
            ...
            <tr class="param">
                <td id="selDatetimeFormatLabel" class="ms-crm-Field-Required">
                    <label for="selDatetimeFormat">
                        <loc:text resourceid="SystemCustomization.ManageAttributePage.TypeSection.Labels.Format" runat="server"/><img src="/_imgs/frm_required.gif" alt="<loc:Text Encoding='HtmlAttribute' ResourceId='Forms.Required.AltTag' runat='server'/>"/>
                    </label>
                </td>
                <td width="100%">
...
<tr id="picklistParams" style="display: none;">
    <td>
        <table width="100%" style="table-layout: fixed;" cellspacing="0" cellpadding="0">
            ...
            <tr class="param">
                <td id="rdUseExistingLabel" style="table-layout: fixed;">
                    <label for="rdUseExisting">
                        <loc:text resourceid="SystemCustomization.ManageAttributePage.TypeSection.UseExistingSet.Label" runat="server"/>
                    </label>
                </td>
                <td class="typecontrol">
            ...
            <tr class="param" id="tr_selectOptionSet" style="display: <%= Microsoft.Crm.CrmEncodeDecode.CrmHtmlAttributeEncode(optionReferenceVisibility) %>;">
                <td id="selectOptionSetLabel" style="table-layout: fixed;" class="ms-crm-Field-Required">
                    <label for="selectOptionSet">
                        <loc:text resourceid="SystemCustomization.ManageAttributePage.TypeSection.ReferencedSetLabel" runat="server"/><img src="/_imgs/frm_required.gif" alt="<loc:Text Encoding='HtmlAttribute' ResourceId='Forms.Required.AltTag' runat='server'/>"/>
                    </label>
                </td>
                <td class="typecontrol">
            ...
            <tr class="param" id="picklistDefault_control">
                <td id="tdledtPicklistDefault">
                    <label for="ledtPicklistDefault">
                        <loc:text resourceid="Web._controls.listedit.labels.DefaultValue" runat="server"/>
                    </label>
                </td>
                <td class="typecontrol">
...
<tr id="lookupParams" style="display: none;">
    <td>
        <table width="100%" style="table-layout: fixed;" cellspacing="0" cellpadding="0">
            ...
            <col/>
            <tr class="param">
                <td id="selectTargetLabel" style="table-layout: fixed;" class="ms-crm-Field-Required typelabel">
                    <label for="selectTarget">
                        <loc:Text ResourceId="SystemCustomization.ManageAttributePage.TypeSection.Labels.ReferencedEntity" runat="server"/><img src="/_imgs/frm_required.gif" alt="<loc:Text Encoding='HtmlAttribute' ResourceId='Forms.Required.AltTag' runat='server'/>"/>
                    </label>
                </td>
                <td class="typecontrol">
                    <ui:Select id="selectTarget" OnChange="onTargetChange();" runat="server"/>
                </td>
                <td></td>
            </tr>
            <tr class="param">
                <td id="txtRelationshipNameLabel" style="table-layout: fixed;" class="ms-crm-Field-Required">
                    <label for="txtRelationshipName">
                        <loc:Text ResourceId="SystemCustomization.ManageAttributePage.TypeSection.Labels.RelationshipName" runat="server"/><img src="/_imgs/frm_required.gif" alt="<loc:Text Encoding='HtmlAttribute' ResourceId='Forms.Required.AltTag' runat='server'/>"/>
                    </label>
                </td>
                <td width="100%">
                    <table width="100%" cellspacing="0" cellpadding="0" dir="ltr">
...
<tr id="customerParams" style="display: none;">
    <td>
        <table width="100%" style="table-layout: fixed;" cellspacing="0" cellpadding="0">
            ...
            <col/>
            <tr class="param">
                <td id="relationshipNames" style="table-layout: fixed;" class="ms-crm-Field-Required">
                    <label for="txtRelationshipName">
                        <loc:Text ResourceId="SystemCustomization.ManageAttributePage.TypeSection.Labels.CustomerRelationshipNames" runat="server"/>
                    </label>
                </td>
                <td></td>
                <td></td>
            ...
            <tr class="param">
                <td id="txtAccountRelationshipNameLabel" style="table-layout: fixed;" class="ms-crm-Field-Required">
                    <label for="txtAccountRelationshipName">
                        <loc:Text ResourceId="SystemCustomization.ManageAttributePage.TypeSection.Labels.CustomerAccountRelationshipName" runat="server"/><img src="/_imgs/frm_required.gif" alt="<loc:Text Encoding='HtmlAttribute' ResourceId='Forms.Required.AltTag' runat='server'/>"/>
                    </label>
                </td>
                <td width="100%">
                    <table width="100%" cellspacing="0" cellpadding="0" dir="ltr">
            ...
            <tr class="param">
                <td id="txtContactRelationshipNameLabel" style="table-layout: fixed;" class="ms-crm-Field-Required">
                    <label for="txtContactRelationshipName">
                        <loc:Text ResourceId="SystemCustomization.ManageAttributePage.TypeSection.Labels.CustomerContactRelationshipName" runat="server"/><img src="/_imgs/frm_required.gif" alt="<loc:Text Encoding='HtmlAttribute' ResourceId='Forms.Required.AltTag' runat='server'/>"/>
                    </label>
                </td>
                <td width="100%">
                    <table width="100%" cellspacing="0" cellpadding="0" dir="ltr">
                ...
                <td>
                    <table width="100%" style="table-layout: fixed;" cellspacing="0" cellpadding="0">
                        ...
                        <tr class="param">
                            <td id="selStateLabel">
                                <label for="selState">
                                    <loc:text resourceid="SystemCustomization.ManageAttributePage.TypeSection.Labels.State" runat="server"/>
                                </label>
                            </td>
                            <td width="100%">
    ...
    <td>
        <table width="100%" style="table-layout: fixed;" cellspacing="0" cellpadding="0">
            ...
            <tr class="param" style="display: none">
                <td id="selMemoFormatLabel" class="ms-crm-Field-Required">
                    <label for="selMemoFormat">
                        <loc:text resourceid="SystemCustomization.ManageAttributePage.TypeSection.Labels.Format" runat="server"/><img src="/_imgs/frm_required.gif" alt="<loc:Text Encoding='HtmlAttribute' ResourceId='Forms.Required.AltTag' runat='server'/>"/>
                    </label>
                </td>
                <td width="100%">
            ...
            <tr class="MemoParams param" style="display: none;">
                <td id="numMaxMemoLenLabel" class="ms-crm-Field-Required">
                    <label for="numMaxMemoLen">
...
<tr id="nvarcharParams" style="display: none;">
    <td>
        <table width="100%" style="table-layout: fixed;" cellspacing="0" cellpadding="0">
            ...
            <tr class="param">
                <td id="selStringFormatLabel" class="ms-crm-Field-Required">
                    <label for="selStringFormat">
                        <loc:text resourceid="SystemCustomization.ManageAttributePage.TypeSection.Labels.Format" runat="server"/><img src="/_imgs/frm_required.gif" alt="<loc:Text Encoding='HtmlAttribute' ResourceId='Forms.Required.AltTag' runat='server'/>"/>
                    </label>
                </td>
                <td width="100%">
            ...
            <tr class="param">
                <td id="numMaxStringLenLabel" class="ms-crm-Field-Required">
                    <label for="numMaxStringLen">
                        <loc:text resourceid="SystemCustomization.ManageAttributePage.TypeSection.Labels.MaxLen" runat="server"/><img src="/_imgs/frm_required.gif" alt="<loc:Text Encoding='HtmlAttribute' ResourceId='Forms.Required.AltTag' runat='server'/>"/>
                    </label>
                </td>
                <td>
...
<tr id="moneyParams" style="display: none;">
    <td>
        <table width="100%" style="table-layout: fixed;" cellspacing="0" cellpadding="0">
            ...
            <tr class="param">
                <td id="selMoneyPrecisionLabel" class="ms-crm-Field-Required">
                    <label for="selMoneyPrecision">
                        <loc:text resourceid="SystemCustomization.ManageAttributePage.TypeSection.Labels.Precision" runat="server"/><img src="/_imgs/frm_required.gif" alt="<loc:Text Encoding='HtmlAttribute' ResourceId='Forms.Required.AltTag' runat='server'/>"/>
                    </label>
                </td>
                <td width="100%">
            ...
            <tr class="param">
                <td id="numMinMoneyValueLabel" class="ms-crm-Field-Required">
                    <label for="numMinMoneyValue">
                        <loc:text resourceid="SystemCustomization.ManageAttributePage.TypeSection.Labels.MinValue" runat="server"/><img src="/_imgs/frm_required.gif" alt="<loc:Text Encoding='HtmlAttribute' ResourceId='Forms.Required.AltTag' runat='server'/>"/>
                    </label>
                </td>
                <td>
            ...
            <tr class="param">
                <td id="numMaxMoneyValueLabel" class="ms-crm-Field-Required">
                    <label for="numMaxMoneyValue">
                        <loc:text resourceid="SystemCustomization.ManageAttributePage.TypeSection.Labels.MaxValue" runat="server"/><img src="/_imgs/frm_required.gif" alt="<loc:Text Encoding='HtmlAttribute' ResourceId='Forms.Required.AltTag' runat='server'/>"/>
                    </label>
                </td>
                <td>
...
<tr id="imeParams" style="display: none;">
    <td>
        <table width="100%" style="table-layout: fixed;" cellspacing="0" cellpadding="0">
            ...
            <tr class="param">
                <td id="selIMEModeLabel" class="ms-crm-Field-Required">
                    <label for="selIMEMode">
                        <loc:text resourceid="SystemCustomization.ManageAttributePage.TypeSection.Labels.IMEMode" runat="server"/><img src="/_imgs/frm_required.gif" alt="<loc:Text Encoding='HtmlAttribute' ResourceId='Forms.Required.AltTag' runat='server'/>"/>
                    </label>
                </td>
                <td width="100%">
    ...
    <td>
        <table width="100%" style="table-layout: fixed;" cellspacing="0" cellpadding="0">
            ...
            <% if (Microsoft.Crm.Caching.FeatureEnabledHelper.IsFeatureEnabled("PhoneticBasedSearch", Microsoft.Crm.Application.Security.UserInformation.Current) == true)
               { %>
                <tr class="param">
                    <td id="selStringPhoneticLabel" class="ms-crm-Field-Required">
                        <label for="selStringPhonetic">
                            <loc:text resourceid="SystemCustomization.ManageAttributePage.TypeSection.Labels.Phonetic" runat="server"/><img src="/_imgs/frm_required.gif" alt="<loc:Text Encoding='HtmlAttribute' ResourceId='Forms.Required.AltTag' runat='server'/>"/>
                        </label>
                    </td>
                    <td width="100%">
                        ...
                        <script type="text/javascript">
                            Sys.Application.add_init(function() {
                                crmCreate(Mscrm.FormInputControl.SelectInputBehavior,
                                    {},
                                    null,
                                    null,
                                    $get('selStringPhonetic'));
                            });
                        </script>
                    </td>
                </tr>
...
<tr class="param" id="dynamicToolTip" runat="server" style="display: none;">
    <td colspan="3">
        <img style="vertical-align: middle;" src="/_imgs/ico/16_alert.gif" alt="<loc:Text Encoding='HtmlAttribute' ResourceId='DocumentManagement.SharePoint.Properties.AlertIcon.AltTag' runat='server'/>"/>
        <span style="vertical-align: middle;">
            <loc:text resourceid="SystemCustomization.DateTimeField.Dynamic_Behavior_Tooltip" runat="server"/>
        </span>
    </td>
</tr>
<tr class="param" id="dateOnlyToolTip" runat="server" style="display: none;">
    <td colspan="3">
        <img style="vertical-align: middle;" src="/_imgs/ico/16_alert.gif" alt="<loc:Text Encoding='HtmlAttribute' ResourceId='DocumentManagement.SharePoint.Properties.AlertIcon.AltTag' runat='server'/>"/>
        <span style="vertical-align: middle;">
            <loc:text resourceid="SystemCustomization.DateTimeField.DateOnly_Behavior_ToolTip" runat="server"/>
        </span>
    </td>
</tr>
<tr class="param" id="staticTimeZoneInvariantToolTip" runat="server" style="display: none;">
    <td colspan="3">
        <img style="vertical-align: middle;" src="/_imgs/ico/16_alert.gif" alt="<loc:Text Encoding='HtmlAttribute' ResourceId='DocumentManagement.SharePoint.Properties.AlertIcon.AltTag' runat='server'/>"/>
        <span style="vertical-align: middle;">
            <loc:text resourceid="SystemCustomization.DateTimeField.StaticTimeZoneInvariant_Behavior_ToolTip" runat="server"/>
        </span>
    </td>
</tr>
<tr class="param" id="dateOnlyToolTipForUpdate" runat="server" style="display: none;">
    <td colspan="3">
        <img style="vertical-align: middle;" src="/_imgs/ico/16_alert.gif" alt="<loc:Text Encoding='HtmlAttribute' ResourceId='DocumentManagement.SharePoint.Properties.AlertIcon.AltTag' runat='server'/>"/>
        <span style="vertical-align: middle;">
            <loc:text resourceid="SystemCustomization.DateTimeField.DateOnly_Behavior_ToolTip_ForUpdate" runat="server"/>
        </span>
        <a style="vertical-align: middle;" target="_blank" href="<%= CurrentResourceManager.GetString("ManageAttribute.aspx_Link_DateTime") %>" class="help_link">
...
<tr class="param" id="staticTimeZoneInvariantToolTipForUpdate" runat="server" style="display: none;">
    <td colspan="3">
        <img style="vertical-align: middle;" src="/_imgs/ico/16_alert.gif" alt="<loc:Text Encoding='HtmlAttribute' ResourceId='DocumentManagement.SharePoint.Properties.AlertIcon.AltTag' runat='server'/>"/>
        <span style="vertical-align: middle;">
            <loc:text resourceid="SystemCustomization.DateTimeField.StaticTimeZoneInvariant_Behavior_ToolTip_ForUpdate" runat="server"/>
        </span>
        <a style="vertical-align: middle;" target="_blank" href="<%= CurrentResourceManager.GetString("ManageAttribute.aspx_Link_DateTime") %>" class="help_link">
        <loc:Text ResourceId="ManageAttribute.aspx_Text_DateTime" runat="server"/>
    </td>
    ...
    <td>
        ...
        <table width="100%" style="table-layout: fixed;" cellspacing="0" cellpadding="0">
            ...
            <tr class="param" id="linkedAttributeRow2" runat="server">
                <td id="tdDataPropagationSectionLinkedFieldLabel">
                    <label for="txtLinkedAttributeName">
                        <asp:Label ID="labelLinkedAttributeName" runat="server"/>
                    </label>
                </td>
            ...
            <tr class="param" id="linkedAttributeRow3" runat="server">
                <td class="" valign="top">
                    <label for="selectLinkedAttribute">
                        <loc:text resourceid="SystemCustomization.ManageAttributePage.DataPropagationSection.Labels.SelectField" runat="server"/><img src="/_imgs/frm_required.gif" alt="<loc:Text Encoding='HtmlAttribute' ResourceId='Forms.Required.AltTag' runat='server'/>"/>
                    </label>
                </td>
                <td>
            ...
            <tr class="param" id="linkedAttributeRow4" style="display: none" runat="server">
                <td id="txtNewAttributeNameLabel" style="vertical-align: top">
                    <label for="txtNewAttributeName">
                        <loc:text resourceid="SystemCustomization.ManageAttributePage.DataPropagationSection.Labels.DisplayName" runat="server"/>
                    </label>
                </td>
                <td>
