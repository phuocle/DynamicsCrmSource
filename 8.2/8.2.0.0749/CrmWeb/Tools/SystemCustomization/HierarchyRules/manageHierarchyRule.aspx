...
<head>
    ...
    <script type="text/javascript">
        ...
        var newHierarchySettingSolutionPrefix =
                                                ...
                                                <tr>
                                                    <td>
                                                        <table width="100%" style="table-layout: fixed;" cellspacing="0" cellpadding="3">
                                                            ...
                                                            <tr class="param">
                                                                <td id="txtHierarchySettingNameLabel" class="ms-crm-Field-Required">
                                                                    <label for="txtHierarchySettingName">
                                                                        <loc:text resourceid="SystemCustomization.ManageHierarchySettingPage.SchemaSection.Labels.SchemaName" runat="server"/><img src="/_imgs/frm_required.gif" alt="<loc:Text Encoding='HtmlAttribute' ResourceId='Forms.Required.AltTag' runat='server'/>"/>
                                                                    </label>
                                                                </td>
                                                                <td>
                                                            ...
                                                            <tr class="param">
                                                                <td id="txtRelationshipLabel">
                                                                    <label for="txtRelationship">
                                                                        <loc:text resourceid="SystemCustomization.ManageHierarchySettingPage.Title.Line" runat="server"/>
                                                                    </label>
                                                                </td>
                                                                <td>
                                                            ...
                                                            <tr class="param" style="height: 80px">
                                                                <td id="txtHierarchySettingdescriptionLabel" class="ms-crm-Field-Normal" valign="top">
                                                                    <label for="txtHierarchySettingDescription">
                                                                        <loc:text resourceid="SystemCustomization.ManageHierarchySettingPage.DescriptionSection.Title" runat="server"/>
                                                                    </label>
                                                                </td>
