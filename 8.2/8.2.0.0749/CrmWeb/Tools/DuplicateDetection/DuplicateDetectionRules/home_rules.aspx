...
<script type="text/javascript">
    ...
    function AdjustForWindowSize() {
        ...
        var padding = parseInt(body.style.paddingTop) +
            parseInt(XUI.Html.GetComputedStyle(body, "marginRight")) +
            parseInt(XUI.Html.GetComputedStyle(body, "marginLeft"));
    ...
    <div id="quickFindContainer" class="ms-crm-home-querycontainer" style="height: 68px">
        <table style="width: 100%; height: 50%" cellpadding="0" cellspacing="0">
            ...
            <tr id="Row1">
                ...
                <td id="tdFindCriteria" colspan="2" class="home_rules_td_FindCriteria">
        ...
        <table style="width: 100%; height: 50%" cellpadding="0" cellspacing="0">
            ...
            <tr id="Tr1">
                <td id="td2" class="home_rules_td_EntityTypeLabel">
                    <label for="entityTypeSelector">
                        <span class="ms-crm-Bold-Header">
                            <loc:Text ResourceId="Web.View_Label_ViewByEntityType" runat="server"/>
                        </span>
                    </label>
                </td>
                <td id="td3" class="home_rules_td_EntityTypeSelector">
                    <ui:Select id="entityTypeSelector" runat="server" onchange="OnEntityTypeChange(this);"/>
                </td>
                <td id="td4" class="home_rules_td_ViewSelectorLabel">
                    <label for="crmGrid_SavedQuerySelector">
                        <span class="ms-crm-Bold-Header">
                            <loc:Text ResourceId="DataManagement.ManageRulesPage.View.Label" runat="server"/>
                        </span>
                    </label>
                </td>
                <td id="td5">
