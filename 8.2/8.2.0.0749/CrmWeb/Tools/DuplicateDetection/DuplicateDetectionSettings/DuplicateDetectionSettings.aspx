...
<head>
    ...
    <title>
        <loc:Text ResourceId="Web.Tools.DuplicateDetection.duplicatedetectionsettings.aspx_title" runat="server"/>
    </title>
    ...
    <script type="text/javascript" language="javascript">
        ...
        function applychanges() {
            ...
            retval += "<isduplicatedetectionenabled>" +
                $get("chkEnableDeDup").checked +
                "</isduplicatedetectionenabled>";
            retval += "<isduplicatedetectionenabledforimport>" +
                $get("chkImport").checked +
                "</isduplicatedetectionenabledforimport>";
            retval += "<isduplicatedetectionenabledforofflinesync>" +
                $get("chkOfflineSync").checked +
                "</isduplicatedetectionenabledforofflinesync>";
            retval += "<isduplicatedetectionenabledforonlinecreateupdate>" +
                $get("chkOnlineCreate").checked +
    ...
    <style type="text/css">
        ...
        DIV.ms-crm-DialogStrict-Main { overflow: hidden; }
                ...
                <table width="100%">
                    ...
                    <tr>
                        <td class="ms-crm-Form-Section ms-crm-Form-SectionBar" colspan="2" valign="bottom">
                            <loc:Text ResourceId="Duplicatedetectionsettings.aspx_Enable_Duplicate_Detection" runat="server"/>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <ui:CheckBox id="chkEnableDeDup" onclick="onClickEnableDeDup();" runat="Server"/>
                        </td>
                        <td class="ms-crm-Bold-Header">
                            <label for="chkEnableDeDup">
                                <loc:Text ResourceId="Duplicatedetectionsettings.aspx_chkEnableDeDupe_label" runat="server"/>
                            </label>
                        </td>
                    </tr>
                    <tr>
                        <td></td>
                        <td>
                            <loc:Text ResourceId="Duplicatedetectionsettings.aspx_DetectDuplicates_label" runat="server"/>
                        </td>
                    </tr>
                    <tr>
                        <td></td>
                        <td>
                            <table width="100%">
                                ...
                                <tr>
                                    <td>
                                        <ui:CheckBox id="chkOnlineCreate" runat="Server"/>
                                    </td>
                                    <td>
                                        <label for="chkOnlineCreate">
                                            <loc:Text ResourceId="Duplicatedetectionsettings.aspx_chkOnlineCreate_label" runat="server"/>
                                        </label>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <ui:CheckBox id="chkOfflineSync" runat="Server"/>
                                    </td>
                                    <td>
                                        <label for="chkOfflineSync">
                                            <loc:Text ResourceId="Duplicatedetectionsettings.aspx_chkOfflineSync_label" runat="server"/>
                                        </label>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <ui:CheckBox id="chkImport" runat="Server"/>
                                    </td>
                                    <td>
                                        <label for="chkImport">
                                            <loc:Text ResourceId="Duplicatedetectionsettings.aspx_chkImport_label" runat="server"/>
                                        </label>
                                    </td>
                                </tr>
                            </table>
