...
<head>
    ...
    <script language=javascript>
        ...
        var isDuplicatesFound =
            <%= _isDuplicatesFound.ToString("D", System.Globalization.CultureInfo.InvariantCulture) %>;
...
<table>
    ...
    <tr>
        <% if (source == Util.DuplicatesSource.OutlookGoOnline || source == Util.DuplicatesSource.OutlookGoOnlineXrm)
           { %>
            <td>
                <label for="DuplicatesCountPicklist">
                    <loc:Text ResourceId='Outlook_Total_Duplicates_Found_DuplicatesList_aspx' runat='server'/>
                </label>
            </td>
        <% }
           ...
           { %>
            <td>
                <label for="DuplicatesCountPicklist">
                    <loc:Text ResourceId='Outlook_Total_Duplicates_FoundInMIcrosoftCRM_DuplicatesList_aspx' runat='server'/>
                </label>
            </td>
        <% }
           else if (source == Microsoft.Crm.Application.Utility.Util.DuplicatesSource.OnlineCreateUpdate)
           { %>
            <td>
                <label for="DuplicatesCountPicklist" class="UpperCaseDialogLabel">
                    <loc:Text ResourceId='Total_Duplicates_Found_DuplicatesList_aspx' runat='server'/>
                </label>
            </td>
        <% }
           else
        ...
        <% }
           ...
           { %>
            <td>
                <loc:Text ResourceId='NoDuplicates_Found_ViewDuplicates_aspx' runat='server'/>
            </td>
        <% } %>
    </tr>
</table>
