    ...
    <script type="text/javascript">
        ...
        function SysInit() {
            ...
            context["resources"]["getAttributeListMetadata"] = function(entityName, callbcak) {
                var deferred = Mscrm.BusinessRules.BusinessRuleEntityManager.get_instance()
                    .requestAttributes(entityName);
            ...
            context["resources"]["getRelationshipMetadata"] = function(entityName, callback) {
                return ProcessControl.Configuration.BPFClientProxy
                    .getEntityAndRelationshipMetadata(entityName, callback);
            };
...
<div id="processConfig" class="bpfConfForm">
    <div id="bpfConfContent" class="bpfConfContent">
        ...
        <div id="header">
            <h2 class="bpfh2">
                <div id="BusinessProcessType" class="wfBusinessProcessType" runat="server"></div>
            </h2>
            <h1 class="bpfh1">
                <div id="ProcessTitle" runat="server"></div>
            </h1>
            <div id="expandContainer" tabindex="0" class="expandCollapseContainer" title="<%= CrmEncodeDecode.CrmHtmlAttributeEncode(AppResourceManager.Default.GetString("ProcessControl.Configurator.Expand")) %>">
                <label for="expandImg" class="ms-crm-InlineEditLabel bpfexpandCollapse">
                    <loc:Text ResourceId="ProcessControl.Configurator.Details" class="msc-crm-InlineEditLabel" runat="server"/>
                </label>
            ...
            <div id="collapseContainer" tabindex="0" class="expandCollapseContainer" title="<%= CrmEncodeDecode.CrmHtmlAttributeEncode(AppResourceManager.Default.GetString("ProcessControl.Configurator.Collapse")) %>">
                <label for="collapseImg" class="ms-crm-InlineEditLabel bpfexpandCollapse">
                    <loc:Text ResourceId="ProcessControl.Configurator.Details" class="msc-crm-InlineEditLabel" runat="server"/>
                </label>
            ...
            <h3 class="bpfh3">
                <div id="SolutionTitle" runat="server"></div>
            </h3>
        </div>
        <div id="processDetailArea" class="confDetailArea confProcessDetailsArea">
            <div id="leftArea" class="configuratorDetailsDiv">
                <div class="configuratorControlsDiv">
                    <div class="bpfConfLabelDiv">
                        <label title="<%= CrmEncodeDecode.CrmHtmlAttributeEncode(AppResourceManager.Default.GetString("ProcessName_Label")) %>" for="ProcessName" class="ms-crm-InlineEditLabel confLabel">
                ...
                <div class="configuratorControlsDiv">
                    <div class="bpfConfLabelDiv">
                        <label title="<%= CrmEncodeDecode.CrmHtmlAttributeEncode(AppResourceManager.Default.GetString("ProcessControl.Configurator.ProcessOwnerLabel")) %>" for="ProcessOwner" class="ms-crm-InlineEditLabel confLabel">
                            <loc:Text ResourceId="ProcessControl.Configurator.ProcessOwnerLabel" class="msc-crm-InlineEditLabel" runat="server"/>
                        </label>
                        <img title="<%= CrmEncodeDecode.CrmHtmlAttributeEncode(AppResourceManager.Default.GetString("Forms.Required.AltTag")) %>" alt="<%= CrmEncodeDecode.CrmHtmlAttributeEncode(AppResourceManager.Default.GetString("Forms.Required.AltTag")) %>" src="/_imgs/frm_required.gif" class="bpfConfReq"/>
                    </div>
                    <div class="ms-crm-Inline-Edit confInput">
                ...
                <div class="configuratorControlsDiv" id="ProcessUniqueNameDiv" runat="server">
                    <div class="bpfConfLabelDiv">
                        <label title="<%= CrmEncodeDecode.CrmHtmlAttributeEncode(AppResourceManager.Default.GetString("ProcessControl.Configurator.ProcessUniqueNameLabel")) %>" for="ProcessUniqueName" class="ms-crm-InlineEditLabel confLabel">
                            <loc:Text ResourceId="ProcessControl.Configurator.ProcessUniqueNameLabel" class="msc-crm-InlineEditLabel" runat="server"/>
                        </label>
                        <img title="<%= CrmEncodeDecode.CrmHtmlAttributeEncode(AppResourceManager.Default.GetString("Forms.Required.AltTag")) %>" alt="<%= CrmEncodeDecode.CrmHtmlAttributeEncode(AppResourceManager.Default.GetString("Forms.Required.AltTag")) %>" src="/_imgs/frm_required.gif" class="bpfConfReq"/>
                    </div>
                    <div class="ms-crm-Inline-Edit confInput">
            ...
            <div id="rightArea" class="configuratorDetailsDiv">
                <div class="configuratorControlsDiv">
                    <div class="bpfConfLabelDiv">
                        <label title="<%= CrmEncodeDecode.CrmHtmlAttributeEncode(AppResourceManager.Default.GetString("Web.SFA.Workflow.PrimaryEntityLabel")) %>" for="PrimaryEntity" class="ms-crm-InlineEditLabel confLabel">
                            <loc:Text ResourceId="Web.SFA.Workflow.PrimaryEntityLabel" class="msc-crm-InlineEditLabel" runat="server"/>
                        </label>
                    </div>
                    <div class="ms-crm-Inline-Edit confInput">
                ...
                <div class="configuratorControlsDiv">
                    <div class="bpfConfLabelDiv">
                        <label title="<%= CrmEncodeDecode.CrmHtmlAttributeEncode(AppResourceManager.Default.GetString("Category_Label")) %>" for="Category" class="ms-crm-InlineEditLabel confLabel">
                ...
                <div class="configuratorControlsDiv processImageDiv" id="ProcessImageDiv" runat="server">
                    <div class="bpfConfLabelDiv">
                        <label title="<%= CrmEncodeDecode.CrmHtmlAttributeEncode(AppResourceManager.Default.GetString("ProcessControl.Configurator.ProcessImageLabel")) %>" for="Image" class="ms-crm-InlineEditLabel confLabel">
                            <loc:Text ResourceId="ProcessControl.Configurator.ProcessImageLabel" class="msc-crm-InlineEditLabel" runat="server"/>
                        </label>
                    </div>
                    <div class="bpfConfLabelDiv">
                        <a href="#" class="setImageLink bpfConfTitle" title="<%= CrmEncodeDecode.CrmHtmlAttributeEncode(AppResourceManager.Default.GetString("ProcessControl.Configurator.ProcessSetImageLinkLabel")) %>">
                            <loc:Text ResourceId="ProcessControl.Configurator.ProcessSetImageLinkLabel" class="msc-crm-InlineEditLabel" runat="server"/>
                        </a>
                    </div>
                </div>
            </div>
            <div class="configuratorDescriptionDiv">
                <div class="bpfConfLabelDiv">
                    <label title="<%= CrmEncodeDecode.CrmHtmlAttributeEncode(AppResourceManager.Default.GetString("Description_Label")) %>" for="Description" class="ms-crm-InlineEditLabel confDescriptionLabel">
