...
<page id="0">
    <title>
        <loc:Text ResourceId="SocialMedia.RootPage.Title" runat="server"/>
    </title>
    <showstagetitle>1</showstagetitle>
    <subtitle>
        <loc:Text ResourceId="SocialMedia.RootPage.SubTitle" runat="server"/>
    </subtitle>
    ...
    %>
        <page id="01">
            <title>
                <loc:Text ResourceId="SystemCustomization.SettingsPage.EmailServerProfile.Title" runat="server"/>
            </title>
            ...
            <url>
                <app:FlatHomepageUrlControl EntityLogicalName="emailserverprofile" XmlEncode="true" runat="server"/>
            </url>
            <help>
                <loc:Text ResourceId="SystemCustomization.SettingsPage.EmailServerProfile.Detail" runat="server"/>
            </help>
        </page>
    <%
        }
    ...
    %>
        <page id="02">
            <title>
                <loc:Text ResourceId="SystemCustomization.SettingsPage.Mailbox.Title" runat="server"/>
            </title>
            ...
            <url>
                <app:FlatHomepageUrlControl EntityLogicalName="mailbox" XmlEncode="true" runat="server"/>
            </url>
            <help>
                <loc:Text ResourceId="SystemCustomization.SettingsPage.Mailbox.Detail" runat="server"/>
            </help>
        </page>
    <%
        }
    ...
    %>
        <page id="03">
            <title>
                <loc:Text ResourceId="SystemCustomization.SettingsPage.EmailMigration.Title" runat="server"/>
            </title>
            ...
            %>
            <help>
                <loc:Text ResourceId="SystemCustomization.SettingsPage.EmailMigration.Detail" runat="server"/>
            </help>
        </page>
    <%
        }
    ...
    %>
        <page id="04">
            <title>
                <loc:Text ResourceId="SystemCustomization.SettingsPage.EmailSettings.Title" runat="server"/>
            </title>
            <icon>/_imgs/tools/ico_emailSettings.gif</icon>
            <help>
                <loc:Text ResourceId="SystemCustomization.SettingsPage.EmailSettings.Detail" runat="server"/>
            </help>
    ...
    %>
        <page id="05">
            <title>
                <loc:Text ResourceId="SystemCustomization.SettingsPage.ServerSideSyncPerformance.Title" runat="server"/>
            </title>
            <icon>/_imgs/tools/ServerSideSyncPerformance_48.png</icon>
            <help>
                <loc:Text ResourceId="SystemCustomization.SettingsPage.ServerSideSyncPerformance.Detail" runat="server"/>
            </help>
