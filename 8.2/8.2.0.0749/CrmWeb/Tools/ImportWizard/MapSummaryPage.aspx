...
<script language="javascript" type="text/javascript">
    ...
    function EditMap() {
        ...
        if (importType != ImportType_XlsxCreateUpdate)
    ...
    function WantToSkip() {
        ...
        if (WizardGetProperty("JumpBackToEntityMappingPage") == true ||
            WizardGetProperty("JumpBackToAttributeMappingPage") == true ||
            WizardGetProperty("JumpBackToDataSourcePage") == true) {
            return true;
        } else {
            return false;
        }
