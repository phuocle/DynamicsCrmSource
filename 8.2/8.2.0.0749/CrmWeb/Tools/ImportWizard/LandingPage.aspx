    ...
    <script language="javascript">
        ...
        function PageOnLoad() {
            if (entityNameIsValid == true) {
                ...
                crmRecordType
                    .DataValue = '<%= Microsoft.Crm.CrmEncodeDecode.CrmJavaScriptEncodeNoQuotes(entityName) %>';
        ...
        function btnDownload() {
            var url = Mscrm.CrmUri.create("/tools/importwizard/createtemplate.aspx?entityName=" +
                CrmEncodeDecode.CrmUrlEncode(Mscrm.FormControlInputBehavior.GetBehavior("crmRecordType")
                    .get_dataValue()));
