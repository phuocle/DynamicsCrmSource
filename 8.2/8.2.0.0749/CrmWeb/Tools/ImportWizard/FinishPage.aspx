        ...
        <table>
            <tr>
                <td rowspan="3" style="vertical-align: top">
                    <img alt="" class="mscrm-iw-InfoBarBalloon" src="/_imgs/importwizardinfo.gif">
                </td>
                <td width="1px"/>
                <td>
                    <span id="infoBalloonText1" class="mscrm-iw-InfoBarText" runat="server"></span>
                </td>
            </tr>
            <tr>
                <td width="1px"/>
                <td>
                    <span id="infoBalloonText2" class="mscrm-iw-InfoBarText" runat="server"></span>
                </td>
            </tr>
            <tr id="customAttributeText" style="display: none">
                <td width="1px"/>
                <td>
                    <span id="infoBalloonText3" class="mscrm-iw-InfoBarText" runat="server"></span>
                </td>
            </tr>
        </table>
    </div>
