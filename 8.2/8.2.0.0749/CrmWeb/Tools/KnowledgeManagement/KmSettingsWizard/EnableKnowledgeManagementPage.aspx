...
<script language="javascript" type="text/javascript">
    ...
    function moveNext() {
        if (Mscrm.EnableKnowledgeManagementPageHelper.savePageProperties(ENTITY_COUNT)) {
            if (isCurrentSolutionParature()) {
                ...
                Mscrm.EnableKnowledgeManagementPageHelper.validate(siteUrl,
                    accountID,
                    department,
                    function() {
                        validations = 0;
        ...
        if (confirm(window.LOCID_RESET_CONFORMATIONTEXT) == true) {
            ...
            if (true == WizardGetProperty("IsParature")) {
                Mscrm.EnableKnowledgeManagementPageHelper
                    .saveKnowledgeManagementSettings(saveKnowledgeManagementSettingsCallbackFunction, true);
            }
        }
    }
    ...
    function EnableDisableButtons() {
        if (isCurrentSolutionParature()) {
            if ($get("selParatureInstance").selectedIndex != -1 &&
                $get("txtDepartment").value.length != 0 &&
                $get("txtSupportURL").value.length != 0 &&
                !bDepGrayTextOn &&
                !bSupGrayTextOn) {
...
<tr>
    <td width="100%">
        <label style="font-weight: bold">
            <loc:Text ResourceId="Web.Tools.KnowledgeManagement.SettingsPage.EntityTable.Title" runat="server"/>
        </label>
    </td>
</tr>
<tr>
    <td width="100%">
        <label class="KM-Wizard-TextFont">
            <loc:Text ResourceId="Web.Tools.KnowledgeManagement.SettingsPage.EntityTable.Description" runat="server"/>
        </label>
    </td>
</tr>
<tr>
    <td>
        ...
        <table class="km-wizard-TableEntities" border="1" cellpadding="0" cellspacing="0">
            ...
            <tr>
                <td colspan="2" height="100%" class="km-wizard-entity">
        ...
        <table id="knowledgeSolutionTable" width="100%" cellpadding="1" cellspacing="1" runat="server">
            <tr>
                <td width="100%">
                    <label>
                        <br/><b>
                            <loc:Text ResourceId="Web.Tools.KnowledgeManagement.SettingsPage.KnowledgeSolution.Title" runat="server"/>
                        </b>
                    </label>
                </td>
            </tr>
            <tr>
                <td width="100%">
                    <label class="KM-Wizard-TextFont">
                        <loc:Text ResourceId="Web.Tools.KnowledgeManagement.SettingsPage.KnowledgeSolution.Description" runat="server"/>
                    </label>
                </td>
            </tr>
            <tr>
                <td>
                    <table id="knowledgeSolutionTextTable" width="100%">
                        <tr>
                            <td width="25%" style="wordwrap: break-word;" id="colknowledgeSolution">
                                <label for="selKnowledgeSolution">
                                    <b>
                                        <loc:Text ResourceId="Web.Tools.KnowledgeManagement.SettingsPage.KnowledgeSolution.Label" runat="server"/>
                                    </b>
                                </label>
                            </td>
                            <td width="75%" maxlength="1000" title="<loc:Text Encoding='HtmlAttribute' ResourceId='Web.Tools.KnowledgeManagement.SettingsPage.KnowledgeSolution.InstanceDropdown' runat='server'/>">
                                <select id="selKnowledgeSolution" onchange="onSolutionChange();" runat="server">
                                    <option id="optPatatureSolution" value="parature" runat="server">Parature</option><option id="optCrmSolution" value="nativecrm" runat="server">Dynamics 365</option>
                                </select>
                            </td>
                        </tr>
                    </table>
...
<table id="nativeCRMDetailsTable" width="100%" cellpadding="1" cellspacing="1" runat="server">
    <tr>
        <td>
            <label>
                <br/><b>
                    <loc:Text ResourceId="Web.Tools.KnowledgeManagement.SettingsPage.NativeCRMConnection.Title" runat="server"/>
                </b>
            </label>
        </td>
    </tr>
    <tr>
        <td>
            <label class="KM-Wizard-TextFont">
                <loc:Text ResourceId="Web.Tools.KnowledgeManagement.SettingsPage.NativeCRMConnection.Description" runat="server"/>
            </label>
        </td>
    </tr>
    <tr>
                ...
                <tr>
                    <td>
                        <table width="100%" cellpadding="1" cellspacing="1" runat="server">
                            <tr>
                                <td width="25%" style="wordwrap: break-word;" id="chkUseExtPortalLabel">
                                    <label for="chkUseExtPortal">
                                        <b>
                                            <loc:Text ResourceId="Web.Tools.KnowledgeManagement.SettingsPage.UseExtPortal.Title" runat="server"/>
                                        </b>
                                    </label>
                                </td>
                                <td width="3%">
                                    <ui:CheckBox id="chkUseExtPortal" margin-left="0" defaultChecked="true" onclick="EnableDisableButtons();" runat="server"/>
                                </td>
                                <td>
                                    <label class="KM-Wizard-TextFont">
                                        <loc:Text Encoding='HtmlAttribute' ResourceId="Web.Tools.KnowledgeManagement.SettingsPage.UseExtPortal.Description" runat="server"/>
                                    </label>
                                </td>
                            </tr>
                        </table>
                    ...
                    <td>
                        <table width="100%" cellpadding="1" cellspacing="1" runat="server">
                            <tr>
                                ...
                                <td width="75%">
                                    <label class="KM-Wizard-TextFont">
                                        <loc:Text Encoding='HtmlAttribute' ResourceId="Web.Tools.KnowledgeManagement.SettingsPage.UseExtPortal.DetailDescription" runat="server"/>
                                    </label>
                                </td>
                            </tr>
                        </table>
                ...
                <tr>
                    <td>
                        <table width="100%" ellpadding="1" cellspacing="1" runat="server">
                            <tr>
                                <td width="25%" style="wordwrap: break-word;">
                                    <label for="txtNativeCRMUrl" class="required">
                                        <b>
                                ...
                                <td width="75%">
                                    <ui:TextBox id="txtNativeCRMUrl" MaxLength="1000" runat="Server" class="siteURL" onchange="EnableDisableButtons();"/>
                                </td>
                            </tr>
                        </table>
                    </td>
        ...
        <table id="paratureDetailsTable" width="100%" cellpadding="1" cellspacing="1" runat="server">
            <tr>
                <td>
                    <label>
                        <b>
                            <loc:Text ResourceId="Web.Tools.KnowledgeManagement.SettingsPage.ParatureConnection.Title" runat="server"/>
                        </b>
                    </label>
                </td>
            </tr>
            <tr>
                <td>
                    <label class="KM-Wizard-TextFont">
                        <loc:Text ResourceId="Web.Tools.KnowledgeManagement.SettingsPage.ParatureConnection.Description" runat="server"/>
                    </label>
                </td>
            </tr>
            <tr>
                <td>
                    ...
                    <table width="100%" id="siteUrlTextTable">
                        <tr>
                            <td width="25%" style="wordwrap: break-word;" id="colParatureInstance">
                                <label for="selParatureInstance">
                                    <b>
                                        <loc:Text ResourceId="Web.Tools.KnowledgeManagement.SettingsPage.Instance.Label" runat="server"/>
                                    </b>
                                </label><img id="paratureImage" align="right" alt="" style="display: none"/>
                            </td>
                            <td width="75%" maxlength="1000" title="<loc:Text Encoding='HtmlAttribute' ResourceId='Web.Tools.KnowledgeManagement.SettingsPage.ParatureConnection.InstanceDropdown' runat='server'/>">
                                <ui:Select id="selParatureInstance" runat="server" onchange="OnInstanceChange();"/>
                            </td>
                        </tr>
                        <tr>
                            <td width="25%" style="wordwrap: break-word;">
                                <label for="txtSiteCollectionUrl" class="required">
                                    <b>
                            ...
                            <td width="75%">
                                <ui:TextBox id="txtSiteCollectionUrl" MaxLength="255" runat="Server" class="siteURL"/>
                            </td>
                        </tr>
                        <tr>
                            <td width="25%" style="wordwrap: break-word;">
                                <label for="txtAccountId" class="required">
                                    <b>
                            ...
                            <td width="75%">
                                <ui:TextBox id="txtAccountId" MaxLength="1000" runat="Server"/>
                            </td>
                        </tr>
                        <tr>
                            <td width="25%" style="wordwrap: break-word;">
                                <label for="txtDepartment" class="required">
                                    <b>
                            ...
                            <td width="75%">
                                <ui:TextBox id="txtDepartment" MaxLength="1000" runat="Server" onchange="EnableDisableButtons()"/>
                            </td>
                        </tr>
                        <tr>
                            <td width="25%" style="wordwrap: break-word;">
                                <label for="txtSupportURL" class="required">
                                    <b>
                            ...
                            <td width="75%">
                                <ui:TextBox id="txtSupportURL" MaxLength="1000" runat="Server" onchange="EnableDisableButtons()"/>
                            </td>
                        </tr>
                    </table>
                </td>
                ...
                <td>
                    <table id="SupportURLText" class="KM-Wizard-TextFont">
                        <tr>
                            <td width="100%">
                                <label>
                                    <loc:Text ResourceId="Web.Tools.KnowledgeManagement.SettingsPage.SupprortURL.Message1" runat="server"/>
                                </label>
                                <label class="km-wizard-url-format">
                                    <loc:Text ResourceId="Web.Tools.KnowledgeManagement.SettingsPage.SupprortURL.Message2" runat="server"/>
                                </label>
                                <label>
                                    <loc:Text ResourceId="Web.Tools.KnowledgeManagement.SettingsPage.SupprortURL.Message3" runat="server"/>
                                </label>
                            </td>
                        </tr>
                    </table>
            ...
            <tr>
                <td>
                    <table id="ResetTable">
                        <tr>
                            <td>
                                <ui:Button id="btnReset" OnClick="Reset();" runat="server" ResourceId="Web.Tools.KnowledgeManagement.SettingsPage.Reset.Text" accesskey="R"></ui:Button><label class="KM-Wizard-TextFont">
                                    <loc:Text ResourceId="Web.Tools.KnowledgeManagement.SettingsPage.Reset.HelpText" runat="server"/>
                                </label><br/>
                            </td>
                        </tr>
                    </table>
