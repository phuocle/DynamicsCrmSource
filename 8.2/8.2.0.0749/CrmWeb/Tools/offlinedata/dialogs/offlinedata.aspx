...
<script type="text/javascript">
    ...
    function handleDblClick(sender, args) {
        ...
        openStdDlg(Mscrm.CrmUri.create("/Tools/OfflineData/OfflineFilter.aspx?QueryId=" +
                CrmEncodeDecode.CrmUrlEncode(args.objectID) +
                "&QuerySource=userquery&QueryType=<%= CrmEncodeDecode.CrmUrlEncode(Request.QueryString["QueryType"]) %>"),
            top.window,
            oWindowInfo.Width,
            oWindowInfo.Height);
    ...
    function handleDblClickInactive(sender, args) {
        ...
        openStdDlg(Mscrm.CrmUri.create("/Tools/OfflineData/OfflineFilter.aspx?QueryId=" +
                CrmEncodeDecode.CrmUrlEncode(args.objectID) +
                "&QuerySource=savedquery&QueryType=<%= CrmEncodeDecode.CrmUrlEncode(Request.QueryString["QueryType"]) %>"),
            top.window,
            oWindowInfo.Width,
            oWindowInfo.Height);
...
<style type="text/css">
    ...
    .configurable:hover { opacity: 0.6; }
</style>
</head>
<body>
