...
<head>
    ...
    <script type="text/javascript">
        ...
        function setAndEditDependencies() {
            _crmFormSubmit.webResourceDependencyXML.value = XUI.Xml.XMLSerializer
                .serializeToString(XUI.Xml.SelectSingleNode(_dependencyXml, '/Dependencies'));
            editWR();
        }
    ...
    <td colspan="7" class="ms-crm-Form-Section ms-crm-Form-SectionBar">
        <A class="ms-crm-InlineTabHeaderText">
            <H3 class="ms-crm-Form">
                <label>
                    <loc:Text ResourceId="WebResource_Edit_aspx_General" runat="server"/>
                </label>
            </H3>
        </A>
    </td>
...
<tr>
    ...
    <td class="ms-crm-Field-Required" id="name_c">
        <label id="pathAndFileNameLabel" for="pathandfilename">
            <loc:Text ResourceId="WebResource_Edit_aspx_PathandFileName" runat="server"/><img src="/_imgs/frm_required.gif" alt="<loc:Text Encoding='HtmlAttribute' ResourceId='Forms.Required.AltTag' runat='server'/>"/>
        </label>
    </td>
    <td colspan="4">
...
<tr>
    ...
    <td>
        <label>
            <loc:Text ResourceId="WebResource_Edit_aspx_DisplayName" runat="server"/>
        </label>
    </td>
    <td colspan="4">
        <table style="width: 100%">
...
<tr>
    ...
    <td style="vertical-align: top;">
        <label>
            <loc:Text ResourceId="WebResource_Edit_aspx_Description" runat="server"/>
        </label>
    </td>
    <td colspan="4">
...
<tr>
    ...
    <td class="ms-crm-Field-Required" id="type_c">
        <label for="webResourceType" id="labelType">
            <loc:Text ResourceId="WebResource_Edit_aspx_Type" runat="server"/><img src="/_imgs/frm_required.gif" alt="<loc:Text Encoding='HtmlAttribute' ResourceId='Forms.Required.AltTag' runat='server'/>"/>
        </label>
    </td>
    <td colspan="3">
        <table style="width: 100%">
...
<tr>
    <td colspan="2"/>
    <td >
        <label for="languagecode" id="labelLanguageCode">
            <loc:Text ResourceId="WebResource_Edit_aspx_LanguageCode" runat="server"/>
        </label>
    </td>
    <td colspan="3">
        <table style="width: 100%">
...
<tr>
    <td colspan="2"/>
    <td>
        <loc:Text ResourceId="WebResource_Edit_aspx_UpdateFile" runat="server"/>
    </td>
    <td colspan="3">
        <table style="width: 100%">
...
<tr>
    <td colspan="2"/>
    <td>
        <label id="silverLightVersionLabel">
            <loc:Text ResourceId="WebResource_Edit_aspx_SilverLifhtVersion_Text" runat="server"/>
        </label>
    </td>
    <td colspan="3">
        <table style="width: 100%">
        ...
        <table cellpadding="0" cellspacing="0" width="100%" style="border-collapse: collapse; table-layout: fixed; border-spacing: 0;">
            ...
            <tr>
                <td style="display: none">
                    <sdk:LookupControl id="libraryLookup" DefaultViewId="125A31CE-0F5E-4957-8AA3-7A10C0713886" LookupBrowse="false" LookupStyle="single" runat="server"/>
                </td>
            </tr>
            <tr/>
        </table>
