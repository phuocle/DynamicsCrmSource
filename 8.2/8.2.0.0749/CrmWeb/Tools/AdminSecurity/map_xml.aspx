...
<page id="0">
    <title>
        <loc:Text ResourceId="Security.RootPage.Title" runat="server"/>
    </title>
    ...
    %>
        <page id="06">
            <title>
                <loc:Text ResourceId="NamePlural_User" runat="server"/>
            </title>
            ...
            <url>
                <app:FlatHomepageUrlControl EntityLogicalName="systemuser" XmlEncode="true" runat="server"/>
            </url>
            <help>
                <loc:Text ResourceId="Web.Tools.map_xml.aspx_46" runat="server"/>
            </help>
        </page>
    <%
        }
    ...
    %>
        <page id="07">
            <title>
                <loc:Text ResourceId="NamePlural_Team" runat="server"/>
            </title>
            ...
            <url>
                <app:FlatHomepageUrlControl EntityLogicalName="team" XmlEncode="true" runat="server"/>
            </url>
            <help>
                <loc:Text ResourceId="Web.Tools.map_xml.aspx_69" runat="server"/>
            </help>
        </page>
    <%
        }
    ...
    %>
        <page id="01">
            <title>
                <loc:Text ResourceId="Web.Tools.map_xml.aspx_79" runat="server"/>
            </title>
            <showstagetitle>1</showstagetitle>
            ...
            <help>
                <loc:Text ResourceId="Web.Tools.map_xml.aspx_82" runat="server"/>
            </help>
        </page>
    <%
        }
    ...
    %>
        <page id="02">
            <title>
                <loc:Text ResourceId="Web.Tools.map_xml.aspx_29" runat="server"/>
            </title>
            <showstagetitle>1</showstagetitle>
            ...
            <help>
                <loc:Text ResourceId="Web.Tools.map_xml.aspx_32" runat="server"/>
            </help>
        </page>
    <%
        }
    ...
    %>
        <page id="05">
            ...
            <help>
                <loc:Text ResourceId="Web.Tools.map_xml.aspx_84" runat="server"/>
            </help>
        </page>
    <%
        }
    ...
    %>
        <page id="08">
            <title>
                <loc:Text ResourceId="Web.Tools.HSMConfiguration.Config.Title" runat="server"/>
            </title>
            <showstagetitle>1</showstagetitle>
            ...
            <help>
                <loc:Text ResourceId="Web.Tools.HSMConfiguration.Config.Title.Help" runat="server"/>
            </help>
        </page>
    <%
        }
    ...
    %>
        ...
        <page id="04">
            <title>
                <loc:Text ResourceId="NamePlural_Position" runat="server"/>
            </title>
            <showstagetitle>1</showstagetitle>
            ...
            <url>
                <app:FlatHomepageUrlControl EntityLogicalName="position" XmlEncode="true" runat="server"/>
            </url>
            <help>
                <loc:Text ResourceId="Web.Tools.map_xml.aspx_50" runat="server"/>
            </help>
        </page>
    <%
        }
    ...
    %>
        <page id="03">
            <title>
                <loc:Text ResourceId="NamePlural_TeamTemplate" runat="server"/>
            </title>
            <showstagetitle>1</showstagetitle>
            <icon>/_imgs/tools/ico_team.gif</icon>
            ...
            <help>
                <loc:Text ResourceId="Web.Tools.map_xml.aspx_85" runat="server"/>
            </help>
        </page>
    <%
        }
