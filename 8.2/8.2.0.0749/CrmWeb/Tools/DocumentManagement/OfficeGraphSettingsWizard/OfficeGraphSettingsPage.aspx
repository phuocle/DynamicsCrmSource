    ...
    <script language="javascript" type="text/javascript">
        ...
        function GetNextPageDefinition() {
            var oUrl = Mscrm.CrmUri
                .create("/Tools/DocumentManagement/OfficeGraphSettingsWizard/OfficeGraphSettingsFinalize.aspx");
            return new NextPageDefinition(oUrl, Mscrm.OfficeGraphSettingsPageHelper.getWizardDataToPost());
        }

        function moveNext() {
            if (Mscrm.OfficeGraphSettingsPageHelper
                .savePageProperties(ENTITY_COUNT, IS_OFFICEGRAPHINTEGRATION_ENABLED)) {
        ...
        <tr>
            <td>
                ...
                <table border="0" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                        <td>
                            <ui:CheckBox id="enableOfficeGraph" onclick="EnableDisableOfficeGraphSettings();" runat="server"/>
