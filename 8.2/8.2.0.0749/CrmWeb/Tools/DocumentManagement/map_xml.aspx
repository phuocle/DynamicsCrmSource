...
<page id="0">
<title>
    <loc:Text ID="Text1" ResourceId="DocumentManagement.RootPage.Title" runat="server"/>
</title>
...
<section>
<title>
    <loc:Text ResourceId="DocumentManagement.RootPage.section.map_xml.aspx_title1" runat="server"/>
</title>
...
%>
    <page id="01">
        <title>
            <loc:Text ID="DocumentMgmtSetting" ResourceId="DocumentManagement.RootPage.SettingsOption.Title" runat="server"/>
        </title>
        <subtitle>
            <loc:Text ResourceId="DocumentManagement.RootPage.SettingsOption.Subtitle" runat="server"/>
        </subtitle>
        <icon>/_imgs/tools/DocumentManagementSettings_48.png</icon>
        <help>
            <loc:Text ResourceId="DocumentManagement.RootPage.SettingsOption.Help" runat="server"/>
        </help>
    ...
    %>
        <page id="02">
            <title>
                <loc:Text ID="InstallGridComponent" ResourceId="Ribbon.sharepointsite.MainTab.Actions.InstallGrid" runat="server"/>
            </title>
            <icon>/_imgs/tools/InstallCRMGrid_48.png</icon>
            <help>
                <loc:Text ResourceId="Ribbon.sharepointsite.MainTab.Actions.InstallGrid" runat="server"/>
            </help>
...
%>
    <page id="03">
        <title>
            <loc:Text ID="SharePointSites" ResourceId="DocumentManagement.SettingsArea.Sites.Title" runat="server"/>
        </title>
        <icon>/_imgs/tools/SharepointSites_48.png</icon>
        <help>
            <loc:Text ResourceId="DocumentManagement.SettingsArea.Sites.Help" runat="server"/>
        </help>
        <link inline="1" entitytype="<%= Microsoft.Crm.Application.Utility.EntityNames.SharePointSite %>">/_static/loading.htm</link>
        <url>
            <app:FlatHomepageUrlControl EntityLogicalName="sharepointsite" XmlEncode="true" runat="server"/>
        </url>
    </page>
<%
    }
...
%>
    <page id="04">
        <title>
            <loc:Text ID="SharePointDocumentLibraries" ResourceId="DocumentManagement.SettingsArea.DocumentLocations.Title" runat="server"/>
        </title>
        <icon>/_imgs/tools/SharepointLocations_48.png</icon>
        <help>
            <loc:Text ResourceId="DocumentManagement.SettingsArea.DocumentLocations.Help" runat="server"/>
        </help>
        ...
        <url>
            <app:FlatHomepageUrlControl EntityLogicalName="sharepointdocumentlocation" XmlEncode="true" runat="server"/>
        </url>
    </page>
<%
    }
...
%>
    <page id="05">
        <title>
            <loc:Text ID="S2SUpgrade" ResourceId="Web.Tools.S2SUpgrade.SettingsPage.Wizard.Title" runat="server"/>
        </title>
        <subtitle>
            <loc:Text ResourceId="S2SUpgrade.RootPage.SettingsOption.Subtitle" runat="server"/>
        </subtitle>
        <icon>/_imgs/tools/InstallCRMGrid_48.png</icon>
        <help>
            <loc:Text ResourceId="S2SUpgrade.RootPage.SettingsOption.Help" runat="server"/>
        </help>
...
%>
    <page id="05">
        <title>
            <loc:Text ID="S2SConfiguration" ResourceId="Web.Tools.S2SConfigure.SettingsPage.Wizard.Title" runat="server"/>
        </title>
        <subtitle>
            <loc:Text ResourceId="S2SUpgrade.RootPage.SettingsOption.Subtitle" runat="server"/>
        </subtitle>
        <icon>/_imgs/tools/InstallCRMGrid_48.png</icon>
        <help>
            <loc:Text ResourceId="S2SConfigure.RootPage.SettingsOption.Help" runat="server"/>
        </help>
...
%>
    <page id="06">
        <title>
            <loc:Text ID="OneNoteIntegration" ResourceId="Web.Tools.OneNoteIntegration.SettingsPage.Wizard.Title" runat="server"/>
        </title>
        <icon>/_imgs/tools/OneNoteIntegration_48.png</icon>
        <help>
            <loc:Text ResourceId="OneNoteIntegration.RootPage.SettingsOption.Help" runat="server"/>
        </help>
...
%>
    <page id="07">
        <title>
            <loc:Text ID="Text6" ResourceId="DocumentManagement.SettingsOption.EnableOneDriveforBusiness.Title" runat="server"/>
        </title>
        <subtitle>
            <loc:Text ResourceId="DocumentManagement.SettingsOption.EnableOneDriveforBusiness.SubTitle" runat="server"/>
        </subtitle>
        <icon>/_imgs/tools/OneDrive_Enable_48.png</icon>
        <help>
            <loc:Text ResourceId="DocumentManagement.SettingsOption.EnableOneDriveforBusiness.Help" runat="server"/>
        </help>
...
%>
    <page id="08">
        <title>
            <loc:Text ID="Text4" ResourceId="DocumentManagement.SettingsArea.OfficeGraphIntegrationSettings.Title" runat="server"/>
        </title>
        <%
        ...
        %>
        <help>
            <loc:Text ResourceId="DocumentManagement.SettingsArea.OfficeGraphIntegrationSettings.Help" runat="server"/>
        </help>
...
%>
    <page id="09">
        <title>
            <loc:Text ID="Text3" ResourceId="DocumentManagement.SettingsOption.EnableDocumentRecommendations.Title" runat="server"/>
        </title>
        <subtitle>
            <loc:Text ResourceId="DocumentManagement.SettingsOption.EnableDocumentRecommendations.SubTitle" runat="server"/>
        </subtitle>
        <%
            if (!Microsoft.Crm.Security.User.Current.UseImageStrips)
            {
        ...
        %>
        <help>
            <loc:Text ResourceId="DocumentManagement.SettingsOption.EnableDocumentRecommendations.Help" runat="server"/>
        </help>
...
%>
    <section>
        <title>
            <loc:Text ResourceId="DocumentManagement.RootPage.section.map_xml.aspx_title2" runat="server"/>
        </title>
        <page id="10">
            <title>
                <loc:Text ID="Text2" ResourceId="DocumentManagement.SettingsOption.OneDriveforBusiness.Title" runat="server"/>
            </title>
            <subtitle>
                <loc:Text ResourceId="DocumentManagement.SettingsOption.OneDriveforBusiness.SubTitle" runat="server"/>
            </subtitle>
            <icon>/_imgs/tools/OneDriveforBusiness_48.png</icon>
            <help>
                <loc:Text ResourceId="DocumentManagement.SettingsOption.OneDriveforBusiness.Help" runat="server"/>
            </help>
