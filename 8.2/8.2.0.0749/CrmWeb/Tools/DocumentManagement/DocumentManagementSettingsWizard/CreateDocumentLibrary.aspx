...
<frm:WizardForm id="crmForm" runat="server">
    <table id="DocumentLibraryCreationStatus" width="50%" cellpadding="2" cellspacing="2" runat="server">
        ...
        <tr>
            <td colspan="2">
                <b>
                    <loc:Text ResourceId="Web.Tools.DocumentManagement.SettingsPage.CreateDL.Summary.Header" runat="server"/>
                </b>
            </td>
        </tr>
        <tr>
            <td>
                <loc:Text ResourceId="Web.Tools.DocumentManagement.SettingsPage.CreateDL.Summary.ToCreate" runat="server"/>
            </td>
            <td>
                <label id="ToCreate"></label>
            </td>
        </tr>
        <tr>
            <td >
                <loc:Text ResourceId="Web.Tools.DocumentManagement.SettingsPage.CreateDL.Summary.NewCreate" runat="server"/>
            </td>
            <td>
                <label id="NewCreate"></label>
            </td>
        </tr>
        <tr>
            <td >
                <loc:Text ResourceId="Web.Tools.DocumentManagement.SettingsPage.CreateDL.Summary.Failed" runat="server"/>
            </td>
            <td>
                <label id="Failed"></label>
            </td>
        </tr>
        <tr>
            <td >
                <loc:Text ResourceId="Web.Tools.DocumentManagement.SettingsPage.CreateDL.Summary.AlreadyExist" runat="server"/>
            </td>
            <td>
                <label id="AlreadyExist"></label>
            </td>
        </tr>
    </table>
    <br/>
    <table style="height: 5%" id="StatusReportSectionHeader" width="100%" cellpadding="1" cellspacing="1">
        <tr>
            <td width="10%">
                <b>
                    <loc:Text ResourceId="Web.Tools.DocumentManagement.SettingsPage.CreateDL.Report.Header" runat="server"/>
                </b>
            </td>
        </tr>
    </table>
