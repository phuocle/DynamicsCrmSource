...
<frm:WizardForm id="crmForm" runat="server">
    <div id="formcontent">
        ...
        <div id="EnableS2SWizardDescription" runat="server">
            <div id="descriptionHeader" style="width: 100%;" class="mscrm-text-SelectedStage mscrm-text-dark">
                <loc:Text ResourceId="Web.Tools.S2SUpgrade.Wizard.Description" runat="server"/>
            </div>
            <div id="S2SChangesMessage">
                <div>
                    <div style="display: inline">
                        <loc:Text ResourceId="Web.Tools.S2SUpgrade.Wizard.DescriptionStart" runat="server"/>
                    </div>&nbsp;
                    <div style="display: inline" class="mscrm-text-S2Swizard">
                        <loc:Text ResourceId="Web.Tools.S2SUpgrade.Wizard.Description1" runat="server"/>
                    </div>
                </div>
                <div>
                    <div style="display: inline">
                    ...
                    <div style="display: inline" class="mscrm-text-S2Swizard">
                        <loc:Text ResourceId="Web.Tools.S2SUpgrade.Wizard.Description2" runat="server"/>
                    </div>
                </div>
                <div>
                    <div style="display: inline">
                    ...
                    <div style="display: inline" class="mscrm-text-S2Swizard">
                        <loc:Text ResourceId="Web.Tools.S2SUpgrade.Wizard.Description3" runat="server"/>
                    </div>
                </div>
            </div>
            <div id="S2SSitesMessage" style="width: 100%; margin-bottom: 8px">
                <div class="mscrm-text-S2Swizard" style="margin-top: 11px">
                    <loc:Text ResourceId="Web.Tools.S2SUpgrade.Wizard.Description4" runat="server"/>
                </div>
            </div>
