    ...
    <script language="javascript" type="text/javascript">
        ...
        function GetNextPageDefinition() {
            var oUrl = Mscrm.CrmUri
                .create("/Tools/DocumentManagement/S2SUpgardeSettingsWizard/S2SUpgradeFinalize.aspx");
        ...
        function showHideErrorLog() {
            document.getElementById('errorlogid').value = CrmEncodeDecode
                .CrmHtmlDecode(XUI.Html.GetText(document.getElementById('errorlogid')));
    ...
    <div id="formcontent">
        ...
        <table id="SiteValidationStatus" width="100%" runat="server" cellpadding="0" cellspacing="0">
            <tr id="NoSitesFound" style="display: none">
                <td class="mscrm-text-validatesites">
                    <loc:Text ResourceId="Web.Tools.DocumentManagement.S2SUpgrade.ValidateSites.NoSitesFound" runat="server"/>
                </td>
            </tr>
        </table>
            ...
            <tr>
                <td>
                    <div class="mscrm-text-SelectedStage mscrm-text-dark">
                        <loc:Text ResourceId="Web.Tools.DocumentManagement.S2SUpgrade.ValidateSites.InvalidSites.Message1" runat="server"/>
                        <span id="cannotEnableMsg" style="display: none;" class="mscrm-text-S2Swizard">
                            <loc:Text ResourceId="Web.Tools.DocumentManagement.S2SUpgrade.ValidateSites.InvalidSites.Message2" runat="server"/>
                        </span>
                    </div>
        ...
        <table style="display: none; margin-bottom: 10px; margin-top: 50px;" id="ValidSitesMessage" width="100%" cellpadding="0" cellspacing="0">
            <tr>
                <td >
                    <div class="mscrm-text-SelectedStage mscrm-text-dark" style="display: inline">
                        <b>
                            <loc:Text ResourceId="Web.Tools.DocumentManagement.S2SUpgrade.ValidateSites.ValidSites.Message3" runat="server"/>
                        </b>
                    </div>
                    <div id="ValidSitesMessageNote" class="mscrm-text-S2Swizard" style="display: inline" runat="server">
                        <loc:Text ResourceId="Web.Tools.DocumentManagement.S2SUpgrade.ValidateSites.ValidSites.Message1" runat="server"/>
                    </div>
                </td>
            </tr>
        </table>
