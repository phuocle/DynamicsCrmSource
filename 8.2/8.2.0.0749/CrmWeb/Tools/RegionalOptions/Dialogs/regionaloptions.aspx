...
<style type="text/css">
    ...
    td.settingsCol { padding: 0 10px 0 10px; }
...
<script type="text/javascript" language="javascript">
    ...
    function RegionalOptionsOnLoad() {
        ...
        selectNegativeCurrencyFormatControl = Mscrm.FormControlInputBehavior
            .GetBehavior('selectNegativeCurrencyFormat');
    ...
    function UpdateLongDateFormats() {
        ...
        var oCommand = new RemoteCommand(_oAttrUtlConst.sCustomizationCommandObject,
            _oAttrUtlConst.sGetDateFormatsCommand);
    ...
    function getNumberFormatOptions(bGetInnerText) {
        ...
        retval += buildNode("numberseparator",
            selectDigitGroupingSymbolControl.get_selectedText().replace(/\x20/g, String.fromCharCode(160)),
            "xml:space=\"preserve\"");
    ...
    function getTimeFormatOptions(bGetInnerText) {
        ...
        retval += buildNode("timeformatcode",
            bGetInnerText ? selectTimeFormatControl.get_selectedText() : selectTimeFormatControl.get_dataValue());
    ...
    function getDateFormatOptions(bGetInnerText) {
        ...
        retval += buildNode("dateformatcode",
            bGetInnerText
            ? selectShortDateFormatControl.get_selectedText()
            : selectShortDateFormatControl.get_dataValue());
        retval += buildNode("dateseparator",
            selectShortDateSeparatorControl.get_selectedText(),
            "xml:space=\"preserve\"");
        retval += buildNode("longdateformatcode",
            bGetInnerText
            ? selectLongDateFormatControl.get_selectedText()
            : selectLongDateFormatControl
            .get_dataValue());
    ...
    function updateReadingOrderFormatCodeBox() {
        ...
        for (var i = 0; i < selectNegativeNumberFormatElement.options.length; i++) {
            setOptionText($get('selectNegativeNumberFormat'),
                i,
                XUI.Html.GetText($get('selectNegativeNumberFormat').options[i]),
                bRTL);
        }
    }
    ...
    <table width="100%" style="table-layout: fixed;">
        ...
        <tr>
            <td nowrap valign="center">
                <label for="selectDecimalSymbol">
                    <loc:Text ResourceId="Regional_Option_Dlg_Number_Tab_DecimalSymbol" runat="server"/>
                </label>
            </td>
            <td valign="center">
        ...
        <tr>
            <td nowrap valign="center">
                <label for="selectDigitGroupingSymbol">
                    <loc:Text ResourceId="Regional_Option_Dlg_Number_Tab_DigitGroupingSymbol" runat="server"/>
                </label>
            </td>
            <td valign="center">
        ...
        <tr>
            <td nowrap valign="center">
                <label for="selectDigitGroup">
                    <loc:Text ResourceId="Regional_Option_Dlg_Number_Tab_DigitGroup" runat="server"/>
                </label>
            </td>
            <td valign="center">
                <crm:Select id="selectDigitGroup" OnChange="regionalOptionDataChangeHandler(this);" runat="server"/>
            </td>
            <td></td>
        </tr>
        <tr>
            <td nowrap valign="center">
                <label for="selectNegativeNumberFormat">
                    <loc:Text ResourceId="Regional_Option_Dlg_Number_Tab_NegativeNumberFormat" runat="server"/>
                </label>
            </td>
            <td valign="center">
                <crm:Select id="selectNegativeNumberFormat" OnChange="regionalOptionDataChangeHandler(this);" runat="server"/>
            </td>
            <td></td>
        </tr>
        <tr>
            <td colspan="3">
                <fieldset style="margin-top: 40px; padding-bottom: 10px;">
                    <legend>
                        <loc:Text ResourceId="Regional_Option_Dlg_Number_Tab_NumberFormatPreview" runat="server"/>
                    </legend>
                    <table id="x" style="width: 100%;">
                        <tr>
                            <td style="padding: 0 10px 0 10px">
                                <label for="textPositiveNumberPreview">
                                    <loc:Text ResourceId="Regional_Option_Dlg_Number_Tab_NumberFormatPreview_Positive" runat="server"/>
                                </label>
                            </td>
                            <td style="padding: 0 10px 0 10px">
                                <crm:TextBox id="textPositiveNumberPreview" runat="server"/>
                            </td>
                            <td style="padding: 0 10px 0 10px">
                                <label for="textNegativeNumberPreview">
                                    <loc:Text ResourceId="Regional_Option_Dlg_Number_Tab_NumberFormatPreview_Negative" runat="server"/>
                                </label>
                            </td>
                            <td style="padding: 0 10px 0 10px">
                                <crm:TextBox id="textNegativeNumberPreview" runat="server"/>
                            </td>
                        </tr>
                    </table>
                </fieldset>
...
<div id="tab1" class="ms-crm-Tab TabContent">
    <table width="100%" style="table-layout: fixed;">
        ...
        <tr>
            <td nowrap valign="center">
                <label for="selectCurrencyFormat">
                    <loc:Text ResourceId="Regional_Option_Dlg_Currency_Tab_CurrencyFormat" runat="server"/>
                </label>
            </td>
            <td valign="center">
        ...
        <tr>
            <td nowrap valign="center">
                <label for="selectNegativeCurrencyFormat">
                    <loc:Text ResourceId="Regional_Option_Dlg_Currency_Tab_NegativeCurrencyFormat" runat="server"/>
                </label>
            </td>
            <td valign="center">
        ...
        <tr>
            <td colspan="3">
                <fieldset style="margin-top: 63px; margin-bottom: 10px;">
                    <legend>
                        <loc:Text ResourceId="Regional_Option_Dlg_Currency_Tab_CurrencyFormatPreview" runat="server"/>
                    </legend>
                    <table id="Table1" width="100%">
                        <tr>
                            <td style="padding: 0 10px 0 10px">
                                <label for="textPositiveCurrencyPreview">
                                    <loc:Text ResourceId="Regional_Option_Dlg_Currency_Tab_CurrencyFormatPreview_Positive" runat="server"/>
                                </label>
                            </td>
                            <td style="padding: 0 10px 0 10px">
                                <crm:TextBox id="textPositiveCurrencyPreview" runat="server"/>
                            </td>
                            <td style="padding: 0 10px 0 10px">
                                <label for="textNegativeCurrencyPreview">
                                    <loc:Text ResourceId="Regional_Option_Dlg_Currency_Tab_CurrencyFormatPreview_Negative" runat="server"/>
                                </label>
                            </td>
                            <td style="padding: 0 10px 0 10px">
                                <crm:TextBox id="textNegativeCurrencyPreview" runat="server"/>
                            </td>
                        </tr>
                    </table>
                </fieldset>
...
<div id="tab2" class="ms-crm-Tab TabContent">
    <table width="100%" style="table-layout: fixed;">
        ...
        <tr>
            <td nowrap valign="center">
                <label for="selectTimeFormat">
                    <loc:Text ResourceId="Regional_Option_Dlg_Time_Tab_TimeFormat" runat="server"/>
                </label>
            </td>
            <td valign="center">
        ...
        <tr>
            <td nowrap valign="center">
                <label for="selectTimeSeparator">
                    <loc:Text ResourceId="Regional_Option_Dlg_Time_Tab_TimeSeparator" runat="server"/>
                </label>
            </td>
            <td valign="center">
        ...
        <tr>
            <td nowrap valign="center">
                <label for="selectAMSymbol">
                    <loc:Text ResourceId="Regional_Option_Dlg_Time_Tab_AMSymbol" runat="server"/>
                </label>
            </td>
            <td valign="center">
                <crm:Select id="selectAMSymbol" OnChange="regionalOptionDataChangeHandler(this);" runat="server"/>
            </td>
            <td></td>
        </tr>
        <tr>
            <td nowrap valign="center">
                <label for="selectPMSymbol">
                    <loc:Text ResourceId="Regional_Option_Dlg_Time_Tab_PMSymbol" runat="server"/>
                </label>
            </td>
            <td valign="center">
                <crm:Select id="selectPMSymbol" OnChange="regionalOptionDataChangeHandler(this);" runat="server"/>
            </td>
            <td></td>
        </tr>
        ...
        <tr>
            <td colspan="3">
                <fieldset style="padding-top: 5px; padding-bottom: 10px;">
                    <legend>
                        <loc:Text ResourceId="Regional_Option_Dlg_Time_Tab_TimeFormatPreview" runat="server"/>
                    </legend>
                    <table id="Table3" width="100%">
                        <tr>
                            <td class="settingsCol">
                                <label for="textTimeFormatPreview">
                                    <loc:Text ResourceId="Regional_Option_Dlg_Time_Tab_TimeFormat" runat="server"/>
                                </label>
                            </td>
                            <td class="settingsCol">
                                <crm:TextBox id="textTimeFormatPreview" runat="server"/>
                            </td>
                        </tr>
                    </table>
                </fieldset>
...
<div id="tab3" class="ms-crm-Tab TabContent">
    <table width="100%" style="table-layout: fixed;">
        ...
        <tr id="calendarTypeRow">
            <td nowrap valign="center">
                <label for="selectCalendarType">
                    <loc:Text ResourceId="Regional_Option_Dlg_Date_Tab_CalendarType" runat="server"/>
                </label>
            </td>
            <td valign="center">
        ...
        <% if (!UserSettings)
           { %>
            <tr>
                <td nowrap valign="center">
                    <label for="selectFirstDayOfWeek">
                        <loc:Text ResourceId="Regional_Option_Dlg_Date_Tab_FirstDayOfWeek" runat="server"/>
                    </label>
                </td>
                <td valign="center">
            ...
            <tr>
                <td nowrap valign="center">
                    <label for="selectFirstWeekOfYear">
                        <loc:Text ResourceId="Regional_Option_Dlg_Date_Tab_FirstWeekOfYear" runat="server"/>
                    </label>
                </td>
                <td valign="center">
                    <crm:Select id="selectFirstWeekOfYear" OnChange="regionalOptionDataChangeHandler(this);" runat="server"/>
                </td>
            </tr>
        <% } %>
        <tr>
            <td valign="center">
                <crm:CheckBox id="checkShowWeekNumber" OnClick="regionalOptionDataChangeHandler(this);" runat="server"/><label for="checkShowWeekNumber">
                    <loc:Text ResourceId="Regional_Option_Dlg_Date_Tab_ShowWeekNumber" runat="server"/>
                </label>
            </td>
        </tr>
        <tr style="padding-top: 10px; padding-bottom: 5px;">
            <td colspan="3">
                <fieldset style="padding-top: 5px; padding-bottom: 10px;">
                    <legend>
                        <loc:Text ResourceId="Regional_Option_Dlg_Date_Tab_ShortDate" runat="server"/>
                    </legend>
                    <table id="short_date_table" width="100%">
                        <col width="250"/><col width="200"/><col/>
                        <tr>
                            <td style="padding: 0 10px 0 10px">
                                <label for="selectShortDateFormat">
                                    <loc:Text ResourceId="Regional_Option_Dlg_Date_Tab_ShortDateFormat" runat="server"/>
                                </label>
                            </td>
                            <td style="padding: 0 10px 0 10px">
                                <crm:Select id="selectShortDateFormat" OnChange="regionalOptionDataChangeHandler(this);" runat="server"/>
                            </td>
                        </tr>
                        <tr>
                            <td style="padding: 0 10px 0 10px">
                                <label for="selectShortDateSeparator">
                                    <loc:Text ResourceId="Regional_Option_Dlg_Date_Tab_ShortDateSeparator" runat="server"/>
                                </label>
                            </td>
                            <td style="padding: 0 10px 0 10px">
                                <crm:Select id="selectShortDateSeparator" OnChange="regionalOptionDataChangeHandler(this);" runat="server"/>
                            </td>
                        </tr>
                        <tr>
                            <td style="padding: 0 10px 0 10px">
                                <label for="textShortDatePreview">
                                    <loc:Text ResourceId="Regional_Option_Dlg_Date_Tab_ShortDatePreview" runat="server"/>
                                </label>
                            </td>
                            <td style="padding: 0 10px 0 10px">
                                <crm:TextBox id="textShortDatePreview" runat="server"/>
                            </td>
                        </tr>
                    </table>
                </fieldset>
        ...
        <tr style="padding-top: 10px; padding-bottom: 5px;">
            <td colspan="3">
                <fieldset style="padding-top: 5px; padding-bottom: 10px;">
                    <legend>
                        <loc:Text ResourceId="Regional_Option_Dlg_Date_Tab_LongDate" runat="server"/>
                    </legend>
                    <table id="long_date_table" width="100%">
                        <col width="250"/><col width="200"/><col/>
                        <tr>
                            <td class="settingsCol">
                                <label for="selectLongDateFormat">
                                    <loc:Text ResourceId="Regional_Option_Dlg_Date_Tab_LongDateFormat" runat="server"/>
                                </label>
                            </td>
                            <td class="settingsCol">
                                <crm:Select id="selectLongDateFormat" OnChange="regionalOptionDataChangeHandler(this);" runat="server"/>
                            </td>
                        </tr>
                        <tr>
                            <td class="settingsCol">
                                <label for="textLongDatePreview">
                                    <loc:Text ResourceId="Regional_Option_Dlg_Date_Tab_LongDatePreview" runat="server"/>
                                </label>
                            </td>
                            <td class="settingsCol">
                                <crm:TextBox id="textLongDatePreview" runat="server"/>
                            </td>
                        </tr>
                    </table>
                </fieldset>
