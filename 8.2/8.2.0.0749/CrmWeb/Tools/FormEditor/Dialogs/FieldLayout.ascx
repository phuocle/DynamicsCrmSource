...
<div id="divColumnLayoutSection" style="display: none;">
    <fieldset>
        ...
        <table cellpadding="0" cellspacing="5" width="100%" style="table-layout: fixed;">
            ...
            <tr>
                <td>
                    <input id="SpanTrue" name="Span" type="radio" class="radio">
                </td>
                <td>
                    <label for="SpanTrue">
            ...
            <tr>
                <td>
                    <input id="SpanFalse" name="Span" type="radio" class="radio">
                </td>
                <td>
                    <label for="SpanFalse">
        ...
        <fieldset>
            ...
            <table cellpadding="0" cellspacing="5" width="100%" style="table-layout: fixed;">
                ...
                <tr>
                    ...
                    <td>
                        <ui:Number id="NumRows" Precision="0" MinValue="1" MaxValue="50" runat="server"/>
                    </td>
                </tr>
                <tr style="display: <%= previewMode ? "none" : "block" %>;">
                    <td>
                        <ui:CheckBox id="Auto" name="Auto" runat="server"/>
                    </td>
                    <td colspan="2">
                        <label for="Auto">
