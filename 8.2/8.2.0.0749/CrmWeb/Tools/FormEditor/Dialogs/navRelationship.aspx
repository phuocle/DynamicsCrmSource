                        ...
                        <fieldset>
                            ...
                            <table cellpadding="0" cellspacing="5" width="100%" style="table-layout: fixed;">
                                ...
                                <tr>
                                    <td colspan="2">
                                        <label for="txtLabel">
                                            <loc:Text ResourceId="Web.Tools.FormEditor.Dialogs.field-text.aspx_180" runat="server"/>
                                        </label>
                                    </td>
                                    <td>
                ...
                <div id="tabSchema" class="ms-crm-Tab">
                    ...
                    <div id="divSchemaSection">
                        <fieldset>
                            ...
                            <table cellpadding="0" cellspacing="5" width="100%" style="table-layout: fixed;">
                                ...
                                <tr>
                                    <td>
                                        <label for="txtRelationshipDisplayName">
                                            <loc:Text ResourceId="Dlg_Update_Nav_Relationship_Display_Name" runat="server"/>
                                        </label>
                                    </td>
                                    <td>
                                        <ui:TextBox id="txtRelationshipDisplayName" Disabled="true" runat="server"/>
                                    </td>
                                </tr>

                                <tr>
                                    <td>
                                        <label for="txtRelationshipSchemaName">
                                            <loc:Text ResourceId="Dlg_Update_Nav_Relationship_Name" runat="server"/>
                                        </label>
                                    </td>
                                    <td>
                                        <ui:TextBox id="txtRelationshipSchemaName" Disabled="true" runat="server"/>
                                    </td>
                                </tr>

                                <tr>
                                    <td id="oneToManyTD" valign="top">
                                        <label for="txtRelationshipEntityName">
                                            <loc:Text ResourceId="Dlg_Update_Nav_Relationship_Related_Entity_Name" runat="server"/>
                                        </label>
                                    </td>
                                    <td id="manyToManyTD" valign="top">
                                        <label for="txtRelationshipEntityName">
                                            <loc:Text ResourceId="Dlg_Update_Nav_Relationship_Other_Entity_Name" runat="server"/>
                                        </label>
                                    </td>
                                    <td>
                                        <ui:TextBox id="txtRelationshipEntityName" Disabled="true" runat="server"/></textarea>
                                    </td>
                                </tr>

                                <tr>
                                    <td>
                                        <label for="txtRelationshipDisplayOption">
                                            <loc:Text ResourceId="Dlg_Update_Nav_Relationship_Display_Option" runat="server"/>
                                        </label>
                                    </td>
                                    <td>
                                        <ui:TextBox id="txtRelationshipDisplayOption" Disabled="true" runat="server"/>
                                    </td>
                                </tr>
                            </table>
                        </fieldset>
                    ...
                    <table style="width: 100%">
                        <tr id='editSchemaPropButtonRow'>
                            <td>
                                <ui:Button id="editSchProps" onclick="Mscrm.EditNavRelationship.editRelationshipSchema();" width="20" ResourceId="Edit_View_From_SubGrid" runat="server"/></ui:Button>
                            </td>
                        </tr>
                        <tr id="nometadataMessageRow" style="display: none">
                            ...
                            <td>
                                <loc:Text ResourceId="Dlg_Form_Nav_Relationship_No_Metadata_Message" runat="server"/>
                            </td>
                        </tr>
