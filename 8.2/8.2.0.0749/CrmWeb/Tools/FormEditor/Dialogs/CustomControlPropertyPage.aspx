...
<script>
    ...
    function populateRelFiltersSection(entityTypeCode,
        attributeId,
    ...
    function populateDisplaySectionForLookupProperty(entityTypeCode,
        attributeId,
        viewId,
        disableQuickFind,
        disableViewPicker,
        ...
        try {
            ...
            CreateViewFiltersForLookupProperty(entityTypeCode,
                attributeId,
                viewDivId,
                viewLabelDivId,
                viewComboDivId,
    ...
    function CreateViewFiltersForLookupProperty(entityTypeCode,
        attributeId,
        viewDivId,
        viewLabelDivId,
        viewComboDivId,
    ...
    <div class="customcontrolproperty-standardspace">
        ...
        <span class="customcontrolproperty-label">
            <label id="lblViewPicker" for="rdbtnViewPicker" style="font-size: 14px;">
                <b>
                    <loc:Text ResourceId="CustomControls_Configuration_ViewPicker" runat="server"/>
                </b>
            </label>
        </span>
    </div>
        ...
        <table id="tblViewPicker" cellpadding="0" cellspacing="5" width="100%" style="table-layout: fixed; padding-left: 25px;">
            ...
            <tr>
                ...
                <td id="viewPickerEntity">
                    <select id="ccDataSourceCombo" style="width: 94%;" class="ms-crm-SelectBox"></select>
                </td>
            </tr>
            <tr>
                <td>
...
<div id="divViewLookup" style="display: none;">
    <div id="divViewLookupSelect" style="display: none;" class="customcontrolproperty-standardspace">
        <table cellpadding="0" cellspacing="5" width="100%" style="table-layout: fixed;">
            <col width="100%"><col>
            <tr>
                <td colspan="1" id="selectLookupInstruction">
                    <loc:Text ResourceId="CustomControls_SelectLookupFieldInstructions" runat="server"/>
                </td>
            </tr>
        </table>
        <table cellpadding="0" cellspacing="5" width="100%" style="table-layout: fixed;">
            ...
            <col width="65px"><col>
            <tr>
                <td colspan="2" id="entityViewLabelId">
                    <loc:Text ResourceId="Web.Tools.FormEditor.Dialogs.subgrid.aspx.Views" runat="server"/>
                </td>
                <td id="entityViews"></td>
            </tr>
            <tr>
                <td colspan="2" id="entityViewFieldLabelId">
                    <loc:Text ResourceId="CustomControls_AvailableColumns" runat="server"/>
                </td>
                <td id="entityViewFields">
                    <div>
    ...
    <div class="customcontrolproperty-standardspace">
        <table cellpadding="0" cellspacing="5" width="100%" style="table-layout: fixed;">
            <col width="100%"><col>
            <tr>
                <td colspan="1" id="configureInstruction">
                    <loc:Text ResourceId="CustomControls_ConfigureLookupInstructions" runat="server"/>
                </td>
            </tr>
        </table>
        <table cellpadding="0" cellspacing="5" width="100%" style="table-layout: fixed;">
        ...
        <table id="tblCardFormPicker" cellpadding="0" cellspacing="5" width="100%" style="table-layout: fixed; padding-left: 25px;">
            ...
            <tr>
                ...
                <td id="cardFormPickerEntity">
                    <select id="ccDataSourceComboForCardForm" style="width: 94%;" class="ms-crm-SelectBox"></select>
                </td>
            </tr>
            <tr>
                <td>
        ...
        <table id="tblMainFormPicker" cellpadding="0" cellspacing="5" width="100%" style="table-layout: fixed; padding-left: 25px;">
            ...
            <tr>
                ...
                <td id="mainFormPickerEntity">
                    <select id="ccDataSourceComboForMainForm" style="width: 94%;" class="ms-crm-SelectBox"></select>
                </td>
            </tr>
            <tr>
                <td>
    ...
    <div class="customcontrolproperty-standardspace">
        ...
        <span class="customcontrolproperty-label">
            <label id="lblStaticOptions" for="rdbtnStaticOptions" style="font-size: 14px;">
                <b>
                    <loc:Text ResourceId="CustomControl_StaticOptions_Label" runat="server"/>
                </b>
            </label>
        </span>
    </div>
