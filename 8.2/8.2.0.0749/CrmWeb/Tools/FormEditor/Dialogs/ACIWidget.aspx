    ...
    <fieldset>
        ...
        <table cellpadding="0" cellspacing="5" width="100%" style="table-layout: fixed;">
            ...
            <tr>
                <td colspan="2" class="ms-crm-Field-Required">
                    <label for="Url">
                        <loc:Text ResourceId="Web.Tools.FormEditor.Dialogs.aciwidget.aspx_viewname" runat="server"/><img src="/_imgs/frm_required.gif" alt="<loc:Text Encoding='HtmlAttribute' ResourceId='Forms.Required.AltTag' runat='server'/>"/>
                    </label>
                </td>
                <td>
                    <sdk:TextBoxControl id="ViewName" name="ViewName" class="ms-crm-Text" maxlength="2048" runat="server"/>
                </td>
            </tr>
        </table>
    </fieldset>
