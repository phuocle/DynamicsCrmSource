...
<style type="text/css">
    ...
    .ms-crm-DialogStrict-Main { overflow-x: hidden !important; }
</style>
<script type="text/javascript" language="javascript">
    ...
    function OnLoad() {
        ...
        Mscrm.FormControlInputBehavior.GetBehavior('ImageWidth')
            .set_dataValue(oWebResource.Width ? parseInt(oWebResource.Width, 10) : null);
        Mscrm.FormControlInputBehavior.GetBehavior('ImageHeight')
            .set_dataValue(oWebResource.Height ? parseInt(oWebResource.Height, 10) : null);
    ...
    function populateLayoutCombo() {
        if (_typeCode != null) {
            ...
            if (IsImageWebResourceType(_typeCode) || _typeCode == WebResourceTypes.xap) {
                if (_typeCode == WebResourceTypes.xap &&
                    (_oWebResource.SizeType == 'StretchMaintainAspectRatio' || _oWebResource.SizeType == 'Original')) {
    ...
    function applychanges() {
        ...
        if (_mode == "add") {
            ...
            if (Mscrm.FormControlInputBehavior.GetElementBehavior(_fieldName).get_isDirty()) {
                ...
                var oNodesHtmlWR = XUI.Xml.SelectNodes(_oFormXml,
                    "/entity/form/tabs/tab/columns/column/sections/section/rows/row/cell/control[@classid = '" +
                    _ControlClassIds.webResourceHtml +
                    "']",
                    null);
                var oNodesImageWR = XUI.Xml.SelectNodes(_oFormXml,
                    "/entity/form/tabs/tab/columns/column//sections/section/rows/row/cell/control[@classid = '" +
                    _ControlClassIds.webResourceImage +
                    "']",
                    null);
                var oNodesSilverlightWR = XUI.Xml
                    .SelectNodes(_oFormXml,
                        "/entity/form/tabs/tab/columns/column//sections/section/rows/row/cell/control[@classid = '" +
                        _ControlClassIds.webResourceSilverlight +
                        "']",
                        null);
                if (DoesWRNameExists(oNodesHtmlWR, tempId) ||
                    DoesWRNameExists(oNodesImageWR, tempId) ||
                    DoesWRNameExists(oNodesSilverlightWR, tempId)) {
        ...
        if (_typeCode == WebResourceTypes.html || IsImageWebResourceType(_typeCode) || _typeCode == WebResourceTypes.xap
            ...
            if (!$get('ImageHeight').disabled &&
                $get('ImageHeight').value.length > 0 &&
                (IsImageWebResourceType(_typeCode) || _typeCode == WebResourceTypes.xap))
                height = Mscrm.FormControlInputBehavior.GetBehavior('ImageHeight').get_dataValue().toString();
            if (!$get('ImageWidth').disabled &&
                $get('ImageWidth').value.length > 0 &&
                (IsImageWebResourceType(_typeCode) || _typeCode == WebResourceTypes.xap))
            ...
            if ((IsImageWebResourceType(_typeCode) || _typeCode == WebResourceTypes.xap) &&
                layoutComboElement.value.length > 0)
    ...
    function LookupValueChanged() {
        ...
        if (_webResourcesControl.get_dataValue() != null) {
            _typeCode = GetTypeCode(_webResourcesControl.get_dataValue()[0].id);
            _isEnabledForMobileClient = _webResourcesControl.get_dataValue()[0].keyValues.isenabledformobileclient
                .value;
        }
        EnableDisableDialogParts();
        populateLayoutCombo();
...
<div id="tab0" class="ms-crm-Tab" style="display: block; width: auto">
    <fieldset>
        ...
        <table cellpadding="0" cellspacing="5" width="100%" style="table-layout: fixed;">
            ...
            <tr>
                <td class="ms-crm-Field-Required" id="resource_c">
                    <label>
                        <loc:Text ResourceId="Formeditor_Dialogs_WebResource_Name_Label" runat="server"/><img src="/_imgs/frm_required.gif" alt="<loc:Text Encoding='HtmlAttribute' ResourceId='Forms.Required.AltTag' runat='server'/>"/>
                    </label>
                </td>
                <td>
                    <sdk:LookupControl id="webResources" DefaultViewId="5A8587CE-D536-46f9-BB89-0F96CAC9B1A0" LookupBrowse="false" LookupStyle="single" runat="server"/>
                </td>
            </tr>
        </table>
    </fieldset>
    ...
    <fieldset>
        ...
        <table cellpadding="0" cellspacing="5" width="100%" style="table-layout: fixed;">
            ...
            <tr>
                <td colspan="2" class="ms-crm-Field-Required" id="name_c">
                    <label for="FieldName">
                        <loc:Text ResourceId="Web.Tools.FormEditor.Dialogs.iframe.aspx_153" runat="server"/><img src="/_imgs/frm_required.gif" alt="<loc:Text Encoding='HtmlAttribute' ResourceId='Forms.Required.AltTag' runat='server'/>"/>
                    </label>
                </td>
                <% if (mode.Equals("add"))
                   {
                    ...
                    <td>
                        <table cellpadding="0" cellspacing="1" width="100%" style="table-layout: fixed;" dir="ltr">
                            ...
                            <tr>
                                ...
                                <td>
                                    <input id="FieldName" onchange="if (!_labelDirty) { $get('Label').value = $get('FieldName').value; }" name="FieldName" type="text" class="ms-crm-Text" maxlength="100" style="background-color: <%= Microsoft.Crm.CrmEncodeDecode.CrmHtmlAttributeEncode(AppResourceManager.Default.GetString("Required_Fields_Background_Color")) %>"/>
                                </td>
                            </tr>
                        </table>
                    </td>
                ...
                %>
                    <td>
                        <ui:TextBox ID="FieldName" name="FieldName" MaxLength="100" runat="server"/>
                    </td>
                <%
                   }
                %>
            ...
            <tr>
                <td class="ms-crm-Field-Required" colspan="2" id="label_c">
                    <label for="Label">
                        <loc:Text ResourceId="Web.Tools.FormEditor.Dialogs.field-text.aspx_180" runat="server"/><img src="/_imgs/frm_required.gif" alt="<loc:Text Encoding='HtmlAttribute' ResourceId='Forms.Required.AltTag' runat='server'/>"/>
                    </label>
                </td>
                <td>
                    <input id="Label" onkeypress="_labelDirty = true;" name="Label" type="text" class="ms-crm-Text" maxlength="100"/>
                </td>
            </tr>
            <tr>
                <td>
                    <ui:CheckBox id="ShowLabel" name="ShowLabel" runat="server"/>
                </td>
                <td colspan="2">
                    <label id="ShowFieldLabel" for="ShowLabel" runat="server"></label>
                </td>
            </tr>
        </table>
    </fieldset>
    ...
    <fieldset id="webResourceProperties">
        ...
        <table cellpadding="0" cellspacing="5" width="100%" style="table-layout: fixed;">
            ...
            <tr>
                <td colspan="2">
                    <label for="customParameter" id="customParameterLabel">
                        <loc:Text ResourceId="Formeditor_Dialogs_WebResource_CustomParameter_Text" runat="server"/>
                    </label>
                </td>
                <td>
                    <ui:TextArea id="customParameter" height="50px" maxlength="1500" runat="server"/>
                </td>
            </tr>
            <tr>
                <td>
                    <ui:CheckBox id="Restricted" name="Restricted" class="checkbox" runat="server"/>
                </td>
                <td colspan="2">
                    <label for="Restricted" id="RestrictedLabel">
                        <loc:Text ResourceId="Web.Tools.FormEditor.Dialogs.iframe.aspx_175" runat="server"/>
                    </label>
                </td>
            </tr>
            <tr>
                <td>
                    <ui:CheckBox id="PassParams" name="PassParams" class="checkbox" runat="server"/>
                </td>
                <td colspan="2">
                    <label id="PassParamsLabel" for="PassParams">
                        <loc:Text ResourceId="Web.Tools.FormEditor.Dialogs.iframe.pass_params" runat="server"/>
                    </label>
                </td>
            </tr>
            ...
            <tr>
                <td>
                    <ui:CheckBox id="ShowOnMobileClient" name="ShowOnMobileClient" class="checkbox" runat="server"/>
                </td>
                <td colspan="2">
                    <label id="ShowOnMobileClientLabel" for="ShowOnMobileClient">
                        <loc:Text ResourceId="SystemCustomization.ManageEntityPage.OptionsSection.EnableDisable.Labels.TabletClient" runat="server"/>
                    </label>
                </td>
            </tr>
            <tr>
                <td colspan="2">
                    <label for="alternativeText" id="alternativeTextLabel">
                        <loc:Text ResourceId="Formeditor_Dialogs_WebResource_AlterNative_Text" runat="server"/>
                    </label>
                </td>
                <td>
                    <input id="alternativeText" name="AlternativeText" type="text" class="ms-crm-Text" maxlength="100"/>
                </td>
            </tr>
        </table>
    </fieldset>
...
<fieldset id="Scrolling">
    ...
    <table cellpadding="0" cellspacing="5" width="100%" style="table-layout: fixed;">
        ...
        <tr>
            <td>
                <label for="selScrolling">
                    <loc:Text ResourceId="Web.Tools.FormEditor.Dialogs.iframe.ScrollingSection.Labels.Scrolling" runat="server"/>
                </label>
            </td>
            <td>
                <ui:Select id="selScrolling" runat="server"/>
            </td>
        </tr>
    </table>
</fieldset>
...
<fieldset id="BorderWR">
    ...
    <table cellpadding="0" cellspacing="5" width="100%" style="table-layout: fixed;">
        ...
        <tr>
            <td>
                <ui:CheckBox id="Border" name="Border" runat="server"/>
            </td>
            <td colspan="2">
                <label for="Border">
                    <loc:Text ResourceId="Web.Tools.FormEditor.Dialogs.iframe.BorderSection.Labels.Border" runat="server"/>
                </label>
            </td>
        </tr>
    </table>
...
<fieldset id="ImageAppearance">
    ...
    <table cellpadding="0" cellspacing="5" width="100%" style="table-layout: fixed;">
        ...
        <tr>
            <td colspan="2">
                <label for="verticalAlignment" id="verticalAlignmentLabel">
                    <loc:Text ResourceId="Formeditor_Dialogs_WebResource_Image_VerticalAlignment_Text" runat="server"/>
                </label>
            </td>
        ...
        <tr>
            <td colspan="2">
                <label for="horizontalAlignment" id="horizontalAlignmentLabel">
                    <loc:Text ResourceId="Formeditor_Dialogs_WebResource_Image_HorizontalAlignment_Text" runat="server"/>
                </label>
            </td>
        ...
        <tr>
            <td colspan="2">
                <label for="imageLayout" id="imageLayoutLabel">
                    <loc:Text ResourceId="Formeditor_Dialogs_WebResource_Size_Label" runat="server"/>
                </label>
            </td>
        ...
        <tr>
            ...
            <td/>
            <td >
                <label for="ImageWidth" id="ImageWidthLabel">
                    <loc:Text ResourceId="Formeditor_Dialogs_WebResource_Image_Width" runat="server"/>
                </label>
            </td>
            <td>
                <ui:Number id="ImageWidth" runat="server"/>
            </td>
            <td >
                <label id='ImageWidthPixelLabel'>
                    <loc:Text ResourceId="Formeditor_Dialogs_WebResource_Size_Pixels" runat="server"/>
                </label>
            </td>
        </tr>
        <tr>
            ...
            <td/>
            <td >
                <label for="ImageHeight" id="ImageHeightLabel">
                    <loc:Text ResourceId="Formeditor_Dialogs_WebResource_Image_Height" runat="server"/>
                </label>
            </td>
            <td>
                <ui:Number id="ImageHeight" runat="server"/>
            </td>
            <td >
                <label id='ImageHeightPixelLabel'>
                    <loc:Text ResourceId="Formeditor_Dialogs_WebResource_Size_Pixels" runat="server"/>
                </label>
            </td>
        </tr>
