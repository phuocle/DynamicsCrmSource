...
<script type="text/javascript" language="JavaScript">
    ...
    function OnLoadQuick() {
        ...
        Mscrm.FormLibraryAndEventHandlerUtils.formXml = XUI.Xml
            .LoadXml(XUI.Xml.XMLSerializer.serializeToString(oFormObj.FormXml));
        ...
        if (FORM_TYPE == "quickCreate") {
            ...
            Mscrm.FormLibraryAndEventHandlerUtils
                .onLoadControl(false, Mscrm.FormControlTypes.form, 'form', _objectTypeCode);
    ...
    function OkForMobile() {
        ...
        Mscrm.Utilities.setReturnValue(new FormObj(null,
            null,
            null,
            null,
            txtFormName.value,
    ...
    function OkForQuick() {
        ...
        if (FORM_TYPE == "quickCreate") {
            ...
            Mscrm.FormPropertiesUtils
                .setUpdatedParameterXml(parameterEditValues_listEditComponent.get_xmlData(),
        ...
        Mscrm.Utilities.setReturnValue(new FormObj(Mscrm.FormLibraryAndEventHandlerUtils.formXml,
            sDependsAry,
            null,
            null,
            txtFormName.value,
    ...
    function OkForDesktop() {
        ...
        Mscrm.FormPropertiesUtils.setUpdatedParameterXml(parameterEditValues_listEditComponent.get_xmlData(),
            Mscrm.FormLibraryAndEventHandlerUtils.formXml);
        Mscrm.FormLibraryAndEventHandlerUtils.processLibraryXmlBeforeSave();
                        ...
                        <div id="tab1" class="ms-crm-Tab ms-crm-TabContainer" style="overflow-y: auto">
                            <fieldset>
                                ...
                                <table cellpadding="0" cellspacing="5" width="100%" style="table-layout: fixed;">
                                    ...
                                    <tr>
                                        <td>
                                            <label for="txtFormName">
                                                <loc:Text ResourceId="Dlg_Form_Properties_Form_Name_Label" runat="server"/><img src="/_imgs/frm_required.gif" alt="<loc:Text Encoding='HtmlAttribute' ResourceId='Forms.Required.AltTag' runat='server'/>"/>
                                            </label>
                                        </td>
                                        <td>
                                            <sdk:TextBoxControl id="txtFormName" runat="server"/>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="height: 105px; vertical-align: top">
                                            <label for="txtDescription">
                                                <loc:Text ResourceId="Dlg_Form_Properties_Form_Description" runat="server"/>
                                            </label>
                                        </td>
                                        <td style="height: 105px;">
                                            <sdk:TextAreaControl id="txtDescription" Height="100px" runat="server"/>
                                        </td>
                                    </tr>
                                </table>
                            </fieldset>
                            <div id="formAssistantAreaDiv" runat="server">
                                <fieldset id="formAssistantArea" style="display: none">
                                    ...
                                    <table cellpadding="0" cellspacing="5" width="100%" style="table-layout: fixed;">
                                        ...
                                        <tr>
                                            <td>
                                                <ui:CheckBox id="chkEnableFormAssistant" OnClick="EnableFormAssistantChecked()" runat="server"/>
                                            </td>
                                            <td colspan="2">
                                                <label id="chkEnableFormAssistantLabel" for="chkEnableFormAssistant">
                                                    <loc:Text ResourceId="LabelFormEditorFormPropertiesEnableFormAssistant" runat="server"/>
                                                </label>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            <td>
                                                <ui:CheckBox id="chkExpandedByDefault" runat="server"/>
                                            </td>
                                            <td colspan="2">
                                                <label id="chkExpandedByDefaultLabel" for="chkExpandedByDefault">
                                                    <loc:Text ResourceId="LabelFormEditorFormPropertiesExpandFormAssistantByDefault" runat="server"/>
                                                </label>
                                            </td>
                                        </tr>
                                    </table>
                                ...
                                <fieldset>
                                    ...
                                    <table cellpadding="0" cellspacing="5" width="100%" style="table-layout: fixed;">
                                        ...
                                        <tr>
                                            <td>
                                                <ui:CheckBox id="chkEnableLeftNavItems" runat="server"/>
                                            </td>
                                            <td colspan="2">
                                                <label id="chkEnableLeftNavLabel" for="chkEnableLeftNavItems">
                                                    <loc:Text ResourceId="Web.Tools.FormEditor.FormProperties.NavItems" runat="server"/>
                                                </label>
                                            </td>
                                        </tr>
                                    </table>
                                ...
                                <fieldset>
                                    ...
                                    <table cellpadding="0" cellspacing="5" width="100%" style="table-layout: fixed;">
                                        ...
                                        <tr>
                                            <td>
                                                <ui:CheckBox id="chkEnableImage" runat="server"/>
                                            </td>
                                            <td colspan="2">
                                                <label id="chkEnableImageLabel" for="chkEnableImage">
                                                    <loc:Text ResourceId="Web.Tools.FormEditor.FormProperties.ImageTitle" runat="server"/>
                                                </label>
                                            </td>
                                        </tr>
                                    </table>
                                ...
                                <fieldset>
                                    ...
                                    <table cellpadding="0" cellspacing="5" width="100%" style="table-layout: fixed;">
                                        ...
                                        <tr>
                                            <td>
                                                <label for="maxWidthInPixel">
                                                    <loc:Text ResourceId="maxWidthInPixel" runat="server"/><img src="/_imgs/frm_required.gif" alt="<loc:Text Encoding='HtmlAttribute' ResourceId='Forms.Required.AltTag' runat='server'/>"/>
                                                </label>
                                            </td>
                                            <td>
                                                <sdk:IntegerControl MinValue="400" Precision="0" id="maxWidthInPixel" runat="server"/>
                                            </td>
                                        </tr>
                                    </table>
                                </fieldset>
