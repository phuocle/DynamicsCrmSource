        ...
        <div>
            <fieldset>
                ...
                <table cellpadding="0" cellspacing="5" height="100%" width="100%" style="table-layout: fixed;">
                    ...
                    <tr >
                        <td>
                            <label id="linkNameLabel for="linkName">
                        ...
                        <td colspan="2">
                            <ui:TextBox id="linkName" MaxLength="255" runat="server"/>
                        </td>
                        </td>
                    </tr>
                    ...
                    <tr >
                        <td>
                            <label for="rdIcon" id="rdIconLabel">
                                <loc:Text ResourceId="Dlg_Update_Nav_Icon_Label" runat="server"/>
                            </label>
                        </td>
                        <td colspan="2">
                            <sdk:LookupControl id="iconWebResource" DisableViewPicker="true" DefaultViewId="DCAC5DFC-2EFF-42b3-9A0D-AFF1577533EB" LookupBrowse="false" LookupStyle="single" runat="server"/>
                        </td>
                        </td>
                    </tr>
                </table>
