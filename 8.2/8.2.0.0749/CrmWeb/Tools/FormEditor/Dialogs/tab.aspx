...
<script type="text/javascript" language="javascript">
    ...
    var _chkExpandByDefaultRow = null;
    ...
    function OnLoad() {
        ...
        _chkExpandByDefaultRow = $get('chkExpandByDefaultRow');
        ...
        Mscrm.FormLibraryAndEventHandlerUtils.formXml = XUI.Xml
            .LoadXml(XUI.Xml.XMLSerializer.serializeToString(_oTab.FormXml));
        ...
        _chkAvailable.checked = _oTab.AvailableForPhone;
        ...
        if (FORM_TYPE == "mainInteractionCentric") {
            ...
            _chkExpandByDefaultRow.style.display = "none";
        }
        ...
        if (FORM_TYPE != "mainInteractionCentric" && _txtName.value.length > 0)
    ...
    function loadLibraryControl() {
        Mscrm.FormLibraryAndEventHandlerUtils.onLoadControl(true,
            Mscrm.FormControlTypes.tab,
            _oTab.TabId,
            oArgs.ObjectTypeCode);
    }
    ...
    <fieldset>
        ...
        <table cellpadding="0" cellspacing="5" width="100%" style="table-layout: fixed;">
            ...
            <tr id="tabNameRow">
                ...
                <td>
                    <ui:TextBox id="txtName" MaxLength="255" runat="server"/>
                </td>
            </tr>
            <tr>
                <td class="ms-crm-Field-Required" id="description_c">
        ...
        <table cellpadding="0" cellspacing="5" width="100%" style="table-layout: fixed;">
            ...
            <tr>
                <td>
                    <ui:CheckBox id="chkDispOption" onclick="OnDispOptionClick();" runat="server"/>
                </td>
                <td >
                    <label id="showLabelID" for="chkDispOption" runat="server"></label>
                </td>
            </tr>
            <tr id="chkExpandByDefaultRow">
                <td>
                    <ui:CheckBox id="chkExpandByDefault" runat="server"/>
                </td>
                <td >
                    <label for="chkExpandByDefault">
                        <loc:Text ResourceId="Web.Tools.FormEditor.Dialogs.iframe.tab.aspx.Expand" runat="server"/>
                    </label>
                </td>
            </tr>
        </table>
    ...
    <div id="divVisibilitySection">
        ...
        <fieldset>
            ...
            <table cellpadding="0" cellspacing="5" width="100%" style="table-layout: fixed;">
                ...
                <tr>
                    <td colspan="2">
                        <loc:Text ResourceId="FormEditor_Dialogs_Tab_Visible_Section_Heading" runat="server"/>
                    </td>
                </tr>
    ...
    <div id="divAvailabilitySection">
        ...
        <fieldset>
            ...
            <table cellpadding="0" cellspacing="5" width="100%" style="table-layout: fixed;">
                ...
                <tr>
                    <td colspan="2">
                        <loc:Text ResourceId="FormEditor_Dialogs_Tab_Available_Section_Heading" runat="server"/>
                    </td>
                </tr>
    ...
    <% if (isDebug)
       { %>
        ...
        <table cellpadding="0" cellspacing="5" width="100%" style="table-layout: fixed;">
            ...
            <tr>
                <td>
                    <ui:CheckBox id="LockTab" onclick="SetLockTabState();" runat="server"/>
                </td>
                <td >
                    <label id="lockTabLabel" for="LockTab" runat="server"></label>
                </td>
            </tr>
        </table>
        ...
        <table id="tblLockTabMessage" style="display: none" cellpadding="0" width="100%" style="table-layout: fixed;">
            ...
            <tr>
                ...
                <td>
                    <loc:Text ResourceId="Web.Tools.FormEditor.Dialogs.tab.aspx_236" runat="server"/>
                </td>
            </tr>
        </table>
    <% }
    ...
    <fieldset>
        ...
        <table cellpadding="0" cellspacing="5" width="100%" style="table-layout: fixed;">
            ...
            <tr>
                ...
                <td>
                    <input name="rdColumnSpan" id="rdColumnSpan1" type="radio" onclick="onColChange();" class="radio">
                </td>
                <td>
            ...
            <tr>
                ...
                <td></td>
                <td>
                    <table id="tabTemplate0" cellpadding="0" cellspacing="4" style="width: 75px" onclick="applyTemplate(0);" class="example">
                        <tr>
            ...
            <tr>
                ...
                <td>
                    <input name="rdColumnSpan" id="rdColumnSpan2" type="radio" onclick="onColChange();" class="radio">
                </td>
                <td>
            ...
            <tr>
                ...
                <td></td>
                <td>
                    <table id="tabTemplate1" cellpadding="0" cellspacing="4" style="width: 75px" onclick="applyTemplate(1);" class="example">
                        <tr>
                            <td style="height: 25px" class="example active">&nbsp;</td>
                            <td style="height: 25px" class="example active">&nbsp;</td>
                        </tr>
                ...
                <td>
                    <table id="tabTemplate2" cellpadding="0" cellspacing="4" style="width: 75px" onclick="applyTemplate(2);" class="example">
                        <tr>
                ...
                <td>
                    <table id="tabTemplate3" cellpadding="0" cellspacing="4" style="width: 75px" onclick="applyTemplate(3);" class="example">
                        <tr>
            ...
            <tr>
                ...
                <td>
                    <input name="rdColumnSpan" id="rdColumnSpan3" type="radio" onclick="onColChange();" class="radio">
                </td>
                <td>
            ...
            <tr>
                ...
                <td></td>
                <td>
                    <table id="tabTemplate4" cellpadding="0" cellspacing="4" style="width: 75px" onclick="applyTemplate(4);" class="example">
                        <tr>
                            <td style="height: 25px" class="example active">&nbsp;</td>
                            <td style="height: 25px" class="example active">&nbsp;</td>
                            <td style="height: 25px" class="example active">&nbsp;</td>
                ...
                <td>
                    <table id="tabTemplate5" cellpadding="0" cellspacing="4" style="width: 75px" onclick="applyTemplate(5);" class="example">
                        <tr>
        ...
        <table cellpadding="0" cellspacing="5" width="100%" style="table-layout: fixed;">
            ...
            <td>
                <ui:Number id="col1Width" onchange="onChangeCol1Width();" runat="server"/>
            </td>
            <td id="perCol1">%</td>
            <tr>
            </tr>
        ...
        <table cellpadding="0" cellspacing="5" width="100%" style="table-layout: fixed;">
            ...
            <tr>
                <td>
                    <ui:Number id="col2Width" onchange="onChangeCol2Width();" runat="server"/>
                </td>
                <td id="perCol2">%</td>
            </tr>
        </table>
        ...
        <table cellpadding="0" cellspacing="5" width="100%" style="table-layout: fixed;">
            ...
            <td>
                <ui:Number id="col3Width" onchange="onChangeCol3Width();" runat="server"/>
            </td>
            <td id="perCol3">%</td>
            <tr>
            </tr>
