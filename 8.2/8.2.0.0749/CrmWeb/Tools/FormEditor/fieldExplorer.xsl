...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="2.0">
  ...
  <xsl:template name="renderRelationShipRow">
    <li tabindex="10" class="ms-crm-Dialog-ListItem-ImportMap" type="relationship"
        ondblclick="Mscrm.FormNavigationUtils.addNavItemFromRelationshipExplorer(Mscrm.Utilities.eventToDomEvent(event));"
        onmouseover="OnField(Mscrm.Utilities.eventToDomEvent(event), this)"
        onmouseout="OffField(Mscrm.Utilities.eventToDomEvent(event), this)">
      <xsl:attribute name="id">
  ...
  <xsl:template name="renderBusinessRulesRow">
    <li tabindex="10" class="ms-crm-Dialog-ListItem-ImportMap" type="businessrule"
        onkeypress="Mscrm.BusinessRulesExplorer.HandleKeyPress(Mscrm.Utilities.eventToDomEvent(event));"
        ondblclick="Mscrm.BusinessRulesExplorer.openBusinessRuleEditorForEdit(Mscrm.Utilities.eventToDomEvent(event));"
        onmouseover="OnField(Mscrm.Utilities.eventToDomEvent(event), this)"
        onmouseout="OffField(Mscrm.Utilities.eventToDomEvent(event), this)">
      <xsl:attribute name="id">
        <xsl:value-of select="@id" />
