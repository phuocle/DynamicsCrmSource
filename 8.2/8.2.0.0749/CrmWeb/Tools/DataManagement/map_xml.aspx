...
<page id="0">
<title>
    <loc:Text ResourceId="DataManagement.RootPage.Title" runat="server"/>
</title>
<showstagetitle>1</showstagetitle>
<subtitle>
    <loc:Text ResourceId="DataManagement.RootPage.Subtitle" runat="server"/>
</subtitle>
...
%>
    <page id="01">
        <title>
            <loc:Text ResourceId="DataManagement.DeDupePreferencesPage.Title" runat="server"/>
        </title>
        <subtitle>
            <loc:Text ResourceId="DataManagement.DeDupePreferencesPage.Subtitle" runat="server"/>
        </subtitle>
        <icon>/_imgs/dedupe_settings.gif</icon>
        <help>
            <loc:Text ResourceId="DataManagement.DeDupePreferencesPage.Help" runat="server"/>
        </help>
...
%>
    <page id="02">
        <title>
            <loc:Text ResourceId="DataManagement.ManageRulesPage.Title" runat="server"/>
        </title>
        <showstagetitle>1</showstagetitle>
        <subtitle>
            <loc:Text ResourceId="DataManagement.ManageRulesPage.Subtitle" runat="server"/>
        </subtitle>
        <icon>/_imgs/dedupe_rules.gif</icon>
        <help>
            <loc:Text ResourceId="DataManagement.ManageRulesPage.Help" runat="server"/>
        </help>
...
%>
    <page id="03">
        <title>
            <loc:Text ResourceId="DataManagement.DuplicateDetectionJobs.Title" runat="server"/>
        </title>
        <showstagetitle>1</showstagetitle>
        <subtitle>
            <loc:Text ResourceId="DataManagement.DuplicateDetectionJobs.Subtitle" runat="server"/>
        </subtitle>
        <icon>/_imgs/dup_detect.gif</icon>
        <help>
            <loc:Text ResourceId="DataManagement.DuplicateDetectionJobs.Help" runat="server"/>
        </help>
...
%>
    <page id="05">
        <title>
            <loc:Text ResourceId="DataManagement.BulkDeletion.Title" runat="server"/>
        </title>
        <showstagetitle>1</showstagetitle>
        <subtitle>
            <loc:Text ResourceId="DataManagement.BulkDeletion.Subtitle" runat="server"/>
        </subtitle>
        ...
        %>
            <help>
                <loc:Text ResourceId="DataManagement.BulkDeletion.Help" runat="server"/>
            </help>
        <%
            }
            else
        ...
        %>
            <help>
                <loc:Text ResourceId="Live.DataManagement.BulkDeletion.Help" runat="server"/>
            </help>
        <%
            }
        %>
...
%>
    <page id="04">
        <title>
            <loc:Text ResourceId="DataManagement.ImportMaps.Title" runat="server"/>
        </title>
        <showstagetitle>1</showstagetitle>
        <subtitle>
            <loc:Text ResourceId="DataManagement.ImportMaps.Subtitle" runat="server"/>
        </subtitle>
        <icon>/_imgs/tools/ico_48_dmimportmaps.gif</icon>
        <help>
            <loc:Text ResourceId="DataManagement.ImportMaps.Help" runat="server"/>
        </help>
...
%>
    <page id="06">
        <title>
            <loc:Text ResourceId="DataManagement.Imports.Title" runat="server"/>
        </title>
        <subtitle>
            <loc:Text ResourceId="DataManagement.Imports.Subtitle" runat="server"/>
        </subtitle>
        <icon>/_imgs/import_dm.gif</icon>
        <help>
            <loc:Text ResourceId="DataManagement.Imports.Help" runat="server"/>
        </help>
        <link inline="1" entitytype="<%= Microsoft.Crm.Application.Utility.EntityNames.ImportFile %>">/_static/loading.htm</link>
        <url>
            <app:FlatHomepageUrlControl EntityLogicalName="importfile" XmlEncode="true" runat="server"/>
        </url>
    </page>
    ...
    %>
        <page id="07">
            ...
            <subtitle>
                <loc:Text ResourceId="DataManagement.DownloadTemplate.Subtitle" runat="server"/>
            </subtitle>
            <icon>/_imgs/template_data_import48.gif</icon>
            <help>
                <loc:Text ResourceId="DataManagement.DownloadTemplate.Help" runat="server"/>
            </help>
...
%>
    <page id="08">
        <title>
            <loc:Text ResourceId="DataManagement.SampleData.Title" runat="server"/>
        </title>
        <subtitle>
            <loc:Text ResourceId="DataManagement.SampleData.Subtitle" runat="server"/>
        </subtitle>
        <icon>/_imgs/SampleData48.gif</icon>
        <help>
            <loc:Text ResourceId="DataManagement.SampleData.Help" runat="server"/>
        </help>
...
%>
    <page id="10">
        <title>
            <loc:Text ResourceId="DataManagement.InstallBusinessProcess.Title" runat="server"/>
        </title>
        <subtitle>
            <loc:Text ResourceId="DataManagement.InstallBusinessProcess.Subtitle" runat="server"/>
        </subtitle>
        <icon>/_imgs/Config_Workflow_48.png</icon>
        <help>
            <loc:Text ResourceId="DataManagement.InstallBusinessProcess.Help" runat="server"/>
        </help>
...
%>
    <page id="09">
        <title>
            <loc:Text ResourceId="DataManagement.SqlEncryption.Title" runat="server"/>
        </title>
        <showstagetitle>1</showstagetitle>
        <subtitle>
            <loc:Text ResourceId="DataManagement.SqlEncryption.Subtitle" runat="server"/>
        </subtitle>
        <icon>/_imgs/Encryption_48x48.png</icon>
        <help>
            <loc:Text ResourceId="DataManagement.SqlEncryption.Help" runat="server"/>
        </help>
...
<page id="11">
    <title>
        <loc:Text ResourceId="DataManagement.ExportLocLabels.Title" runat="server"/>
    </title>
    <subtitle>
        <loc:Text ResourceId="DataManagement.ExportLocLabels.Subtitle" runat="server"/>
    </subtitle>
    <icon>/_imgs/translation_export_48.png</icon>
    <help>
        <loc:Text ResourceId="DataManagement.ExportLocLabels.Help" runat="server"/>
    </help>
    <link inline="0">openStdWin(Mscrm.CrmUri.create('/_grid/cmds/dlg_exportfieldtranslation.aspx'),null,500,210,true);</link>
</page>
...
%>
    <page id="12">
        <title>
            <loc:Text ResourceId="DataManagement.ImportLocLabels.Title" runat="server"/>
        </title>
        <subtitle>
            <loc:Text ResourceId="DataManagement.ImportLocLabels.Subtitle" runat="server"/>
        </subtitle>
        <icon>/_imgs/translation_import_48.png</icon>
        <help>
            <loc:Text ResourceId="DataManagement.ImportLocLabels.Help" runat="server"/>
        </help>
        <link inline="1">/_static/loading.htm</link>
        <url>../ImportLabels/ImportFieldTranslations.aspx</url>
    </page>
<%
    }
%>
...
<%
    if (ShouldAdvancedSimilarityRuleBeVisible())
    {
%>
    <page id="13">
        <title>
            <loc:Text ResourceId="Web.Tools.AdvancedSimilarityRuleTitle" runat="server"/>
        </title>
        <icon>/_imgs/Tools/SimilarCaseSuggestions_48.png</icon>
        <link inline="1" entitytype="<%= Microsoft.Crm.Application.Utility.EntityNames.AdvancedSimilarityRule %>">/_static/loading.htm</link>
        <url>
            <app:FlatHomepageUrlControl EntityLogicalName="advancedsimilarityrule" XmlEncode="true" runat="server"/>
        </url>
        <help>
            <loc:Text ResourceId="Web.Tools.AdvancedSimilarityRuleHelp" runat="server"/>
        </help>
    </page>
<%
    }
