...
<page id="0">
<title>
    <loc:Text ResourceId="Web.Tools.ServiceManagement.map_xml.aspx_1" runat="server"/>
</title>
<showstagetitle>1</showstagetitle>
<subtitle>
    <loc:Text ResourceId="Web.Tools.ServiceManagement.map_xml.aspx_2" runat="server"/>
</subtitle>
...
<section>
    <title>
        <loc:Text ResourceId="Web.Tools.ServiceManagement.section.map_xml.aspx_title1" runat="server"/>
    </title>
    ...
    %>
        <page id="01">
            <title>
                <loc:Text ResourceId="Web.Tools.ServiceManagement.ServiceQueus.map_xml.aspx" runat="server"/>
            </title>
            <showstagetitle>1</showstagetitle>
    ...
    %> <page id="10">
        <title>
            <loc:Text ResourceId="Web._grid.cmds.dlg_casehierarchy.ServiceManagement_Title" runat="server"/>
        </title>
        <showstagetitle>1</showstagetitle>
        <icon>/_imgs/tools/Parent_Child_Case_Settings_44.png</icon>
        <help>
            <loc:Text ResourceId="Web._grid.cmds.dlg_casehierarchy.ServiceManagement_Help_Title" runat="server"/>
        </help>
        <link inline="0">
        ...
        <help>
            <loc:Text ResourceId="Web._grid.cmds.dlg_casehierarchy.aspx_1" runat="server"/>
        </help>
    </page>
    <%
       }
    ...
    %>
        ...
        <page id="02">
            <title>
                <loc:Text ResourceId="NamePlural_RoutingRule" runat="server"/>
            </title>
            <showstagetitle>1</showstagetitle>
            ...
            <url>
                <app:FlatHomepageUrlControl EntityLogicalName="routingrule" XmlEncode="true" runat="server"/>
            </url>
            <help>
                <loc:Text ResourceId="Web.Tools.ServiceManagement.map_xml.aspx_5" runat="server"/>
            </help>
        </page>
    <%
       }
    ...
    %>
        <page id="08">
            ...
            <help>
                <loc:Text ResourceId="Web.Tools.ServiceManagement.Subjects.Description.map_xml.aspx" runat="server"/>
            </help>
    ...
    %>
        <page id="20">
            <title>
                <loc:Text ResourceId="Web.Tools.TopicModelTitle" runat="server"/>
            </title>
            ...
            <url>
                <app:FlatHomepageUrlControl EntityLogicalName="topicmodel" XmlEncode="true" runat="server"/>
            </url>
            <help>
                <loc:Text ResourceId="Web.Tools.TopicModelHelp" runat="server"/>
            </help>
        </page>
    <%
       }
...
<section>
    <title>
        <loc:Text ResourceId="Web.Tools.ServiceManagement.section.map_xml.aspx_title2" runat="server"/>
    </title>
    ...
    %>
        ...
        <page id="05">
            <title>
                <loc:Text ResourceId="NamePlural_SLA" runat="server"/>
            </title>
            <showstagetitle>1</showstagetitle>
            ...
            <url>
                <app:FlatHomepageUrlControl EntityLogicalName="sla" XmlEncode="true" runat="server"/>
            </url>
            <help>
                <loc:Text ResourceId="Web.Tools.ServiceManagement.map_xml.aspx_6" runat="server"/>
            </help>
        </page>
    <%
        }
    ...
    %>
        ...
        <page id="03">
            <title>
                <loc:Text ResourceId="NamePlural_Entitlement" runat="server"/>
            </title>
            <showstagetitle>1</showstagetitle>
            ...
            <url>
                <app:FlatHomepageUrlControl EntityLogicalName="entitlement" XmlEncode="true" runat="server"/>
            </url>
            <help>
                <loc:Text ResourceId="Web.Tools.ServiceManagement.map_xml.aspx_3" runat="server"/>
            </help>
        </page>
    <%
        }
    ...
    %>
        <page id="07">
            <title>
                <loc:Text ResourceId="SM_Holiday_Schedule_Title" runat="server"/>
            </title>
            <showstagetitle>1</showstagetitle>
            ...
            <help>
                <loc:Text ResourceId="SM_Holiday_Schedule" runat="server"/>
            </help>
        </page>
    <%
        }
    ...
    %>
        <page id="19">
            <title>
                <loc:Text ResourceId="SM_Service_Configuration_Settings_Link_Title" runat="server"/>
            </title>
            <showstagetitle>1</showstagetitle>
            <icon>/_imgs/tools/Service_Settings_Configuaration_48.png</icon>
            <help>
                <loc:Text ResourceId="SM_Service_Configuration_Settings_Link_Description" runat="server"/>
            </help>--%>
    ...
    %>
        <page id="06">
            <title>
                <loc:Text ResourceId="SM_Customer_Service_Schedule_Link_Title" runat="server"/>
            </title>
            <showstagetitle>1</showstagetitle>
            ...
            <help>
                <loc:Text ResourceId="SM_Customer_Service_Schedule_Link_Description" runat="server"/>
            </help>
        </page>
    <%
        }
...
<section>
    <title>
        <loc:Text ResourceId="Web.Tools.ServiceManagement.section.map_xml.aspx_title5" runat="server"/>
    </title>
    ...
    %>
        <page id="18">
            <title>
                <loc:Text ID="KnowledgeMgmtSetting" ResourceId="KnowledgeManagement.RootPage.SettingsOption.Title" runat="server"/>
            </title>
            <showstagetitle>1</showstagetitle>
            ...
            <url></url>
            <help>
                <loc:Text ResourceId="KnowledgeManagement.RootPage.SettingsOption.Help" runat="server"/>
            </help>
        </page>
        ...
        %>
            <page id="22">
                <title>
                    <loc:Text ResourceId="Web.Tools.KnowledgeSearchModelTitle" runat="server"/>
                </title>
                ...
                <url>
                    <app:FlatHomepageUrlControl EntityLogicalName="knowledgesearchmodel" XmlEncode="true" runat="server"/>
                </url>
                <help>
                    <loc:Text ResourceId="Web.Tools.KnowledgeSearchModelHelp" runat="server"/>
                </help>
            </page>
    <%
            }
    ...
    %>
        <page id="23">
            <title>
                <loc:Text ID="CategoriesConfiguration" ResourceId="Web.Tools.CategoriesConfigurationTitle" runat="server"/>
            </title>
            <showstagetitle>1</showstagetitle>
            ...
            <url>
                <app:FlatHomepageUrlControl EntityLogicalName="category" XmlEncode="true" runat="server"/>
            </url>
            <help>
                <loc:Text ResourceId="Web.Tools.ServiceManagement.CategoriesConfiguration.aspx_23" runat="server"/>
            </help>
        </page>
    <%
       }
...
<section>
    <title>
        <loc:Text ResourceId="Web.Tools.ServiceManagement.section.map_xml.aspx_title3" runat="server"/>
    </title>
    <%
    ...
    %>
        ...
        <page id="04">
            <title>
                <loc:Text ResourceId="NamePlural_EntitlementTemplate" runat="server"/>
            </title>
            <showstagetitle>1</showstagetitle>
            ...
            <url>
                <app:FlatHomepageUrlControl EntityLogicalName="entitlementtemplate" XmlEncode="true" runat="server"/>
            </url>
            <help>
                <loc:Text ResourceId="Web.Tools.ServiceManagement.map_xml.aspx_4" runat="server"/>
            </help>
        </page>
    <%
        }
    ...
    %>
        <page id="11">
            ...
            <help>
                <loc:Text ResourceId="Web.Tools.map_xml.aspx_173" runat="server"/>
            </help>
        </page>
    <%
        }
    ...
    %>
        <page id="12">
            ...
            <help>
                <loc:Text ResourceId="Web.Tools.map_xml.aspx_147" runat="server"/>
            </help>
        </page>
    <%
        }
    ...
    %>
        <page id="13">
            ...
            <help>
                <loc:Text ResourceId="Web.Tools.map_xml.aspx_135" runat="server"/>
            </help>
        </page>
    <%
        }
...
<section>
    <title>
        <loc:Text ResourceId="Web.Tools.ServiceManagement.section.map_xml.aspx_title4" runat="server"/>
    </title>
    ...
    %>
        <page id="14">
            <title>
                <loc:Text ResourceId="SM_Business_Closure_Title" runat="server"/>
            </title>
            <showstagetitle>1</showstagetitle>
