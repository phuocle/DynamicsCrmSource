...
<head>
    <title>
        <loc:Text ResourceId="KMControl.USD.SearchPage" runat="server"/>
    </title>
    ...
    <style type="text/css">
        ...
        .kmwall .wallContainer { height: 98%; }
    ...
    <script type="text/javascript">
        ...
        function SetFilters() {
            ...
            if (!IsNull(filterResults) &&
                filterResults != "" &&
                Mscrm.SearchWidgetConstants.articleFilterButtons()[filterResults] != null) {
                KMControl.changeSelectedMenuItem(Mscrm.SearchWidgetCommand.articlesFilter,
                    Mscrm.SearchWidgetConstants.articleFilterButtons()[filterResults - 1]);
            }


            if (!IsNull(sortMethod) &&
                sortMethod != "" &&
                Mscrm.SearchWidgetConstants.articleFilterButtons()[sortMethod] != null) {
                KMControl.changeSelectedMenuItem(Mscrm.SearchWidgetCommand.sortFilter,
                    Mscrm.SearchWidgetConstants.sortFilterButtons()[sortMethod - 1]);
            }
        }
