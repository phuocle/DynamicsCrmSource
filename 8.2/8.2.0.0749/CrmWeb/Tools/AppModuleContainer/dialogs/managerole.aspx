...
<head>
    ...
    <style type="text/css">
        ...
        .ms-crm-RefreshDialog-Header { padding-top: 20px; }
        ...
        .ms-crm-RefreshDialog-Main { top: 128px; }
...
<frm:DialogForm id="crmForm" runat="server">
    <div style="height: 120px; top: 0px; position: absolute; width: 100%;">
        <table cellpadding="1" cellspacing="0" height="100%" width="100%" style="table-layout: fixed;">
            ...
            <tr>
                <td>
                    <input name="visibleToEveryone" id="visibleToEveryone" type="radio" onclick="Mscrm.AppModuleRoleAssignment.onClickVisibleToEveryone();" class="radio" tabindex="0">
                </td>
                <td>
            ...
            <tr>
                <td>
                    <input name="visibleToSelectedRoles" id="visibleToSelectedRoles" type="radio" onclick="Mscrm.AppModuleRoleAssignment.onClickVisibleToSelectedRoles();" class="radio" tabindex="0">
                </td>
                <td>
