...
<script language="JavaScript">
    ...
    function addColumnsPage_onload() {
        ...
        if ((Mscrm.Utilities.isIE8OrLower() &&
                isArrayContainsValue(_entitiesForDisplayingHiddenFields, _sPrimaryEntityName)) ||
    ...
    function populateEntityList() {
        ...
        for (var i = 0; i < oEntities.length; i++) {
            ...
            oOption = entityListComponent.AddOption(oEntities[i].getAttribute("displayname"),
                oEntities[i].getAttribute("relid"));
    ...
    function applychanges() {
        ...
        if (_bShowRelatedEntities) {
            ...
            if (!IsNull(_oAllFieldPropertiesXml)) {
                oReturnValue.FieldPropertiesXml = Trim(XUI.Xml.XMLSerializer
                    .serializeToString(_oAllFieldPropertiesXml));
            }
    ...
    function entityChanged(e) {
        ...
        if (oFieldListInfo == null) {
            ...
            _aoFieldLists[sKey] = new FieldListInfo(_FieldList.innerHTML,
                _sSortColumnName,
                _bSortOrderAscend,
                _chkAll.checked);
    ...
    function saveEntityFieldsState(sEntityKey) {
        ...
        if (oFieldListInfo == null) {
            ...
            _aoFieldLists[sEntityKey] = new FieldListInfo(_FieldList.innerHTML,
                _sSortColumnName,
                _bSortOrderAscend,
                _chkAll.checked);
        } else {
    ...
    function SetColumnsLabel() {
        ...
        if (columnLabel) {
            ...
            XUI.Html.SetText(columnLabel,
                formatString(LOCID_COLUMNS_SELECTED,
                    IsNull(_iSelectedColumns) ? 0 : _iSelectedColumns,
                    maxSelectedColumns));
        }
    }
...
<style type="text/css">
    div.ms-crm-DialogStrict-Main { -webkit-overflow-scrolling: touch; }
...
<frm:DialogForm id="crmForm" runat="server">
    <div height="25px" id="trEntityList" style="display: none">
        <div style="display: inline-block; width: 150px">
            <nobr>
                <label for="entityList"><loc:Text ResourceId="Label_AddColumns_RecordType" runat="server"/>&nbsp;</label>
            </nobr>
        </div>
    ...
    <div height="22px" style="position: relative; top: 20px;">
        <table id="tblGridBar" cellpadding="0" cellspacing="0" class="ms-crm-ViewForm-Header">
            <tr onclick="onGridColumnClick(new Sys.UI.DomEvent(event));" onmouseover="onGridColumnMouseOver(new Sys.UI.DomEvent(event));">
                <td width="5%" class="AddColumns_td_SelectAll">
                    <input id="chkAll" type="checkbox" class="checkbox" onclick="SelectAll(new Sys.UI.DomEvent(event));" title="<loc:Text ResourceId='Grid.CheckAll.ViewColumns.Title' runat='server'/>"/>
                </td>
                <td class="ms-crm-ViewForm-Spacer">
                    <img alt="" src="/_imgs/grid/bar_line.gif">
                </td>
                <th width="35%" class="ViewForm_AddFields_th_gridheader" field="displayname">
                    <nobr>
                        <loc:Text ResourceId="Web.Tools.ViewEditor.dialogs.AddColumns.aspx_208" runat="server"/><img alt="" src="/_imgs/grid/bar_up.gif" class="addFields_img_barUp">
                    </nobr>
                </th>
                <td class="ms-crm-ViewForm-Spacer">
                    <img alt="" src="/_imgs/grid/bar_line.gif">
                </td>
                <th class="ViewForm_AddFields_th_gridheader" field="name" width="29%">
                    <nobr>
                        <loc:Text ResourceId="Web.Tools.ViewEditor.dialogs.AddColumns.aspx_210" runat="server"/><img alt="" src="/_imgs/grid/bar_up.gif" class="addFields_img_barUp">
                    </nobr>
                </th>
                <td class="ms-crm-ViewForm-Spacer">
                    <img alt="" src="/_imgs/grid/bar_line.gif">
                </td>
                <th class="ViewForm_AddFields_th_gridheader" field="datatype" width="29%">
                    <nobr>
                        <loc:Text ResourceId="Web.Tools.ViewEditor.dialogs.AddColumns.aspx_212" runat="server"/><img alt="" src="/_imgs/grid/bar_up.gif" class="addFields_img_barUp">
                    </nobr>
                </th>
                <td class="ms-crm-ViewForm-Spacer">
                    <img alt="" src="/_imgs/grid/bar_line.gif">
