    ...
    <div class="ms-crm-absolutePosition">
        <div class="ms-crm-sales-Title">
            <div class="subtitle" style="padding: 5px;">
                <loc:Text ResourceId="Web.Tools.business.home_salesperson.aspx_83" runat="server"/>
            </div>
        ...
        %>
            <div class="ms-crm-sales-error ms-crm-Salesperson-Error">
                <loc:Text ResourceId="Web.Tools.business.home_salesperson.aspx_103" runat="server">
                    <loc:Argument runat="server"><%= Microsoft.Crm.CrmEncodeDecode.CrmHtmlEncode(Microsoft.Crm.Formatting.CrmFormatter.FormatDate(dt, CurrentUser.SystemUserId, new Microsoft.Crm.OrganizationContext(CurrentUser.OrganizationId))) %></loc:Argument>
                </loc:Text>
            </div>
        <%
            }
