...
<head>
    ...
    <script language="javascript">
            ...
            if (_selectedSubject) {
                if (window.confirm(LOCID_SUBJED_CONFIRMDELETE)) {
                    ...
                    command.SetParameter("id",
                        (IsNull(_selectedSubject) || _selectedSubject == "")
        ...
        function AddSubject(bEdit) {
            ...
            if (bEdit) {
                ...
                url += "?_CreateFromType=" +
                    CrmEncodeDecode.CrmUrlEncode(Subject) +
                    "&_CreateFromId=" +
                    CrmEncodeDecode.CrmUrlEncode(_selectedSubject);
            }
    ...
    <style type="text/css">
        ...
        .ms-crm-TreeBox tbody { height: inherit; }
    </style>
</head>
<body>
