        ...
        if (WizardGetProperty("entityName") != null && WizardGetProperty("entityName") == "asyncoperation")
            if (LOCID_ISPRIVILEGED == "true")
                if ($(WizardGetProperty("fetchXml")).find("[attribute=operationtype]").length == 1 &&
                    $(WizardGetProperty("fetchXml")).find("[attribute=operationtype]")[0].outerHTML
                    .match(/\svalue\s*=\s*"10"/g) !=
                    null)
                    return true;
        return false;
    }
                    ...
                    <tr>
                        <td>
                            <label class="ms-crm-Bold-Header" for="startTime">
                                <loc:Text ResourceId="BulkDeleteWizard.AdditionalOptionsPage.JobStartTime" runat="server"/>
                            </label>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            ...
                            <table width="100%">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <label for="chkRecurrence">
                                            <loc:Text ResourceId="BulkDeleteWizard.AdditionalOptionsPage.RecurringOption" runat="server"/>
                                        </label>
                                    </td>
                                </tr>
                            </table>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <label for="numberOfDays">
                                            <loc:Text ResourceId="BulkDeleteWizard.AdditionalOptionsPage.DaysText" runat="server"/>
                                        </label>
                                    </td>
                                    <td>&nbsp;</td>
                                </tr>
