...
<script>
    ...
    function initializeEvents() {
        document.getElementById("imgTemplateTour").onkeypress = function() {
    ...
    <div id="templateTourPage" class="templateTourPage">
        ...
        <div id="templateTourPageTryGetIt" class="templateTourPageTryGetIt">
            <a href="javascript:close();">
                <span class="templateTourTryItOutSpan">
                    <loc:Text ResourceId="Web.TemplateTourPage.TryItOut" runat="server"/>
                </span>
                <span class="templateTourArrowSpan">
                    <img id="imgTemplateTour" class="imgTemplateTour" alt="<loc:Text ResourceId='Web.TemplateTourPage.TryItOut' runat='server'/>" src="<%= NextButtonArrowImage %>" unselectable="on" tabindex="0">
                </span>
            </a>
        </div>
    </div>
