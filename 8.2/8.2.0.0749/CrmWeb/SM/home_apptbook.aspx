...
<head>
    ...
    <script language="javascript" type="text/javascript">
        ...
        function apptBookPage_onload() {
            var imageNames = new Array("/_imgs/ico_16_calmonth.gif",
                "/_imgs/ico_16_calweek.gif",
                "/_imgs/ico_16_calday.gif",
                "/_imgs/ico_24_caltoday_menu.gif",
                "/_imgs/ico_16_caltoday.gif",
                "/_imgs/ico_24_cal_expand.gif",
                "/_imgs/ico_24_cal_collapse.gif",
                "/_imgs/ApptBook/up.gif");
            var controlNames = new Array("calMonth",
                "calWeek",
                "calDay",
                "cal24Today",
                "cal16Today",
...
<div id="ganttPageBodyTable" style="width: 100%; height: 100%">
    ...
    <div style="height: 58px; padding-top: 7px;">
            ...
            <tr>
                <td>
                    <label class="ms-crm-Setting-ContextHeader-Title">
                        <loc:Text ResourceId="Homepage_AppointmentBook" runat="server"/>
                    </label>
                </td>
                <td>
        ...
        <table width="100%" cellpadding="1" cellspacing="0">
            ...
            <tr>
                <td nowrap class="ms-crm-Emphasis-Strong">
                    <label for="crmTypeSelector">
                        <loc:Text ResourceId="Web.View_Label_ViewByType" runat="server"/>
                    </label>
                </td>

                <td>
                    <ui:Select id="crmTypeSelector" runat="server" onchange="OnViewTypeChange(this);"/>
                </td>
                <td nowrap class="ms-crm-Emphasis-Strong">
                    <asp:Label runat="server" ID="ViewLabel" CssClass="home_apptbook_label_View"/>
                </td>
                <td id="tdViewSelector">
                    <crm:ViewSelector runat="server" id="crmGrid_SavedQuerySelector"/>
                </td>
                <td align="center">
                    <span class="home_apptbook_span_QuickFindSpacer">&nbsp;</span>
                </td>
            </tr>
        </table>
    </div>
    ...
    <div id="primary" class="primaryPane">
        ...
        <div id="CalendarPane" class="calendarPane">
            ...
            <span id="calendarTitle" class="calendarTitle">
                <loc:Text ResourceId="Appointment_Book_Calendar_Title" runat="server"/>
            </span>
            ...
            <table id="CalendarViews" cellspacing="0" cellpadding="0">
                ...
                <tr id="popupCalendar" onmouseover="On(this);" onmouseout="Off(this);" onclick="PopupCalendar(this);" style="cursor: pointer; display: none;">
                    <td>
                        <img alt="<loc:Text Encoding='HtmlAttribute' ResourceId='SM.CalendarPane.ShowCalendar' runat='server'/>" id="cal24Today" class="home_appbook_img_ico24caltodaymenu"/>
                    </td>
                </tr>
                <tr id="today" onmouseover="On(this);" onmouseout="Off(this);" onclick="Today();" style="cursor: pointer; display: none;">
                    <td>
                        <img alt="<loc:Text Encoding='HtmlAttribute' ResourceId='SM.CalendarPane.ShowToday' runat='server'/>" id="cal16Today"/>
                    </td>
                </tr>
            </table>
            ...
            <table id="CalendarViews" cellspacing="0" cellpadding="3">
                ...
                <tr id="MonthView" onmouseover="On(this);" onmouseout="Off(this);" onclick="SelectCalendarRange(HILITE_NONE);" style="cursor: pointer;">
                    <td>
                        <a onclick="return false;" href="javascript:onclick();" target="_self">
                            <img alt="<loc:Text Encoding='HtmlAttribute' ResourceId='Web.Workplace.home_calendar.aspx_MonthAction' runat='server'/>" title="<loc:Text Encoding='HtmlAttribute' ResourceId='Web.Workplace.home_calendar.aspx_MonthAction' runat='server'/>" id="calMonth"/>
                        </a>
                    </td><td id="MonthViewLabel">
                        <loc:Text ResourceId="Web.Workplace.home_calendar.aspx_193" runat="server"/><br>
                    </td>
                </tr>
                <tr id="WeekView" onmouseover="On(this);" onmouseout="Off(this);" onclick="SelectCalendarRange(HILITE_WEEK);" style="cursor: pointer;">
                    <td>
                        <a onclick="return false;" href="javascript:onclick();" target="_self">
                            <img alt="<loc:Text Encoding='HtmlAttribute' ResourceId='Web.Workplace.home_calendar.aspx_WeekAction' runat='server'/>" title="<loc:Text Encoding='HtmlAttribute' ResourceId='Web.Workplace.home_calendar.aspx_WeekAction' runat='server'/>" id="calWeek"/>
                        </a>
                    </td><td id="WeekViewLabel">
                        <loc:Text ResourceId="Web.Workplace.home_calendar.aspx_196" runat="server"/><br>
                    </td>
                </tr>
                <tr id="DayView" onmouseover="On(this);" onmouseout="Off(this);" onclick="SelectCalendarRange(HILITE_DAY);" style="cursor: pointer;">
                    <td>
                        <a onclick="return false;" href="javascript:onclick();" target="_self">
                            <img alt="<loc:Text Encoding='HtmlAttribute' ResourceId='Web.Workplace.home_calendar.aspx_DayAction' runat='server'/>" title="<loc:Text Encoding='HtmlAttribute' ResourceId='Web.Workplace.home_calendar.aspx_DayAction' runat='server'/>" id="calDay"/>
                        </a>
                    </td><td id="DayViewLabel">
                        <loc:Text ResourceId="Web.Workplace.home_calendar.aspx_199" runat="server"/><br>
                    </td>
                </tr>
            </table>
        </div>
