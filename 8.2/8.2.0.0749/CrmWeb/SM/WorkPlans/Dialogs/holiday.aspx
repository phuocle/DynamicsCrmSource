...
<script language="javascript">
    ...
    function applychanges() {
        ...
        command.SetParameter("scheduledStart",
            FormatUtcDate(Mscrm.FormControlInputBehavior.GetBehavior("scheduledstart").get_dataValue()));
        command.SetParameter("scheduledEnd",
            FormatUtcDate(Mscrm.FormControlInputBehavior.GetBehavior("scheduledend").get_dataValue()));
...
<frm:DialogForm id="crmForm" runat="server">
    <div class="main ms-crm-absolutePosition">
        ...
        <div class="ms-crm-TabBar-Cell" style="position: relative; top: 0px; left: 0px; right: 0px; height: 20px;">
            <crm:apptabbar id="crmTabBar" runat="server"/>
        </div>
        <div id="tab0" class="ms-crm-Tab" style="position: relative; top: 0px; bottom: 0px; left: 0px; right: 0px; height: auto;">
            <table width="100%">
                <tr height="24">
                            ...
                            <tr>
                                <td width="40%">
                                    <label for="scheduledstart">
                                        <% if (CalendarType == Util.HolidaySchedule)
                                           { %><loc:text resourceid="Web.SM.WorkPlans.Dialogs.timeoff.aspx__220"
                                                                                               runat="server"/>
                                        <% }
                                           else
                                           { %>
                            ...
                            <tr>
                                <td width="40%">
                                    <label for="scheduledend">
                                        <% if (CalendarType == Util.HolidaySchedule)
                                           { %><loc:text resourceid="Web.SM.WorkPlans.Dialogs.timeoff.aspx__221"
                                                                                               runat="server"/>
                                        <% }
                                           else
                                           { %>
