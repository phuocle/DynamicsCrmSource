    ...
    <table id="customerServiceTable" width="70%" cellspacing="0" cellpadding="0">
        <tr height="25">
            <td id="nameLabel" class="ms-crm-Field-Required" width="30%">
                <label for="name">
                    <loc:text resourceid="SM_Customer_Service_Schedule_Dialog_Title_01" runat="server"/>
                    <img src="/_imgs/frm_required.gif" alt="<loc:Text Encoding='HtmlAttribute' ResourceId='Forms.Required.AltTag' runat='server'/>"/>
                </label>
            </td>
            <td width="70%">
                <ui:textbox id="txtName" tabindex="1" runat="server"/>
            </td>
        </tr>
        <tr height="35">
            <td id="description" width="30%">
                <label for="description">
                    <loc:text resourceid="SM_Customer_Service_Schedule_Dialog_Title_02" runat="server"/>
                </label>
            </td>
            <td width="70%">
                <ui:textarea id="txtdescription" tabindex="2" runat="server" rows="3"/>
            </td>
        </tr>
    </table>
</frm:dialogform>
