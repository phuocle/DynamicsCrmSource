...
<frm:DialogForm id="crmForm" runat="server">
    <table width="100%" cellspacing="5" cellpadding="0">
        <tr height="30">
            <td colspan="3">
                <loc:Text ResourceId="Create_Resource_Group_Dialog_Question" runat="server"/>
            </td>
        </tr>
        <tr height="30">
            <td style="width: 20px">
            ...
            <td>
                <label for="Yes">
                    <loc:Text ResourceId="Create_Resource_Group_Dialog_Option_Yes" runat="server"/>
                </label>
            </td>
        ...
        <tr height="30">
            ...
            <td colspan="2">
                <label for="No">
                    <loc:Text ResourceId="Create_Resource_Group_Dialog_Option_No" runat="server"/>
                </label>
            </td>
        </tr>
    </table>
