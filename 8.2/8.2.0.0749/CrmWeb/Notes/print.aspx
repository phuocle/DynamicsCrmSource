            ...
            <tr >
                <td valign="top" style="padding: 10px">
                    <table cellpadding="2" cellspacing="0" width="100%" style="table-layout: fixed;">
                        ...
                        <tr>
                            <td class="ms-crm-Field-Label-Print" id="subject_c">
                                <loc:Text ResourceId="Web.Notes.edit.aspx_97" runat="server"/>
                            </td>
                ...
                <td valign="bottom" style="padding: 10px">
                    <table cellpadding="2" cellspacing="0" width="100%" style="table-layout: fixed;">
                        ...
                        <tr style="padding-top: 10px;">
                            <td class="ms-crm-Field-Label-Print" id="regarding_c" nowrap>
                                <loc:Text ResourceId="Notes_Parent_Entity" runat="server"/>
                            </td>
                            <td>
                                <span id="crmOwnerLookup" runat="server"/>
                            </td>
                        </tr>
                        <tr style="padding-top: 20px;">
                            <td class="ms-crm-Form-Section ms-crm-Form-SectionBar" id="attachment_c" colspan="" valign="top">
                                <loc:Text ResourceId="Web.Notes.print.aspx_30" runat="server"/>
                            </td>
                        </tr>
                        <tr>
                            <td class="ms-crm-Field-Label-Print" id="filename_c">
