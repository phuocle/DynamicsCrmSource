...
<head>
    ...
    <style type="text/css">
        ...
        tr.ms-crm-AboutDialog-Header td { height: 80px !important; }
                ...
                <div id="info" class="info ms-crm-AboutDialog-Info">
                    <span class="norm">
                        <span id="USCanadaText" runat="server">
                            ...
                            <loc:Text ResourceId="AboutBox_US_Support_Message" runat="server">
                                <loc:Argument runat="server">
                                    <a runat="server" class="ms-crm-Link" id="DynamicsCustomerSourceSupportLink" target="_blank" href="http://go.microsoft.com/fwlink/?LinkId=52446">
                                        <loc:Text ResourceId="AboutBox_US_Support_Message_MBS_CustomerSource" runat="server"/>
                                    </a>
                                </loc:Argument>
                                <loc:Argument runat="server">
                                    <a runat="server" class="ms-crm-Link" id="DynamicsSupportLink" target="_blank" href="http://go.microsoft.com/fwlink/?LinkId=50896&amp;clcid=0x409">
                                        <loc:Text ResourceId="AboutBox_US_Support_Message_MS_HelpSupport" runat="server"/>
                                    </a>
                                </loc:Argument>
                            </loc:Text>
                            <br>
                        ...
                        <loc:Text ResourceId="AboutBox_International_Support_Message" runat="server">
                            <loc:Argument runat="server">
                                <a runat="server" class="ms-crm-Link" id="InternationalSupportLink" target="_blank" href="http://go.microsoft.com/fwlink/?LinkID=390992">
                                    <loc:Text ResourceId="AboutBox_International_Support_Message_MS_HelpSupport" runat="server"/>
                                </a>
                            </loc:Argument>
                        </loc:Text>
                        <br>
                        <br>
                        <loc:Text ResourceId="Web.About.default.aspx_88" runat="server">
                            <loc:Argument runat="server">
                                <a runat="server" class="ms-crm-Link" id="CrmLink" target="_blank" href="http://go.microsoft.com/fwlink/?LinkId=52444">
                                    <loc:Text ResourceId="AboutBox_AdditionInformation_Microsoft_CRM" runat="server"/>
                                </a>
                            </loc:Argument>
                        </loc:Text>
                        <br>
                        <span id="crmLiveText" runat="server">
                            <a class="ms-crm-Link" runat="server" id="PrivacyLinkLive" target="_blank">
                                <loc:Text ResourceId="AboutBox_Privacy_CrmLive" runat="server"/>
                            </a>
                        </span>
                        <br><br>
