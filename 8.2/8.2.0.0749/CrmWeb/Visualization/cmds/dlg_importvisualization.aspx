...
<head>
    <style type="text/css">
        ...
        .ms-crm-IE7-Texarea { position: static !important; }
...
<div class="main ms-crm-VizDialog-Header-Mssg">
    <div id="uploadFileHeaderSpan" class="ms-crm-RefreshDialog-Header">
        <a href="#" class="ms-crm-RefreshDialog-FirstTopButton" onclick="Mscrm.ImportVisualizationDialog.closeDialog();">
            <img src="/_imgs/CloseDialog.png" style="height: 16px; width: 16px;"/>
        </a>
        <div class="ms-crm-RefreshDialog-Header-Title">
            <loc:Text ResourceId="Web.Visualization.Designer.Import.DialogTitle" runat="server"/>
        </div>
        <div class="ms-crm-RefreshDialog-Header-Desc">
            <loc:Text ResourceId="Web.Visualization.Designer.Import.DialogTitleDescription" runat="server"/>
        </div>
    </div>
        ...
        <div id="uploadFileBodySpan">
            <div>
                <div class="ms-crm-RefreshDialog-Main" style="margin-left: 15px; overflow: hidden">
                    <iframe id="uploadFileFrame" class="ms-crm-ContentFrame" name="uploadFileFrame" src="<%= Microsoft.Crm.CrmEncodeDecode.CrmHtmlAttributeEncode(Microsoft.Crm.Application.Utility.CrmUri.Create("/Visualization/cmds/ImportVisualizationFileUpload.aspx", Microsoft.Crm.Application.Security.UserInformation.Current).ToString()) %>" width="100%" scrolling="no" frameborder="0">
                    </iframe>
                </div>
                <div class="ms-crm-RefreshDialog-Footer" style="bottom: 5px">
                    <div class="ms-crm-Dialog-Buttons ms-crm-Bottom-Border" style="padding-left: 30px; padding-right: 30px">
                        ...
                        &nbsp;
                        <ui:Button ID="btn_id_Cancel" CssClass="ms-crm-RefreshDialog-Button" accesskey="C" OnClick="Mscrm.ImportVisualizationDialog.closeDialog();" ResourceId="UploadFile_Dialog_Button_Cancel" runat="server"></ui:Button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div>
            ...
            <div class="ms-crm-VizDialog-Footer">
                ...
                <div class="divFooterButton" style="padding-right: 20px;">
                    ...
                    <ui:Button ID="btn_Cancel" CssClass="ms-crm-RefreshDialog-Button" width="100" accesskey="C" OnClick="Mscrm.ImportVisualizationDialog.closeDialog();" ResourceId="UploadFile_Dialog_Button_Cancel" runat="server"></ui:Button>
                </div>
            </div>
        </div>
    </div>
    <div id="errorBodySpan" style="display: none">
        <div>
            <div style="padding-left: 15px; padding-right: 15px; height: 20px; vAlign: bottom;">
                <label for="visualizationErrorArea">
                    <loc:Text ResourceId="Web.Visualization.Designer.Import.ErrorText" runat="server"/>
                </label>
            </div>
            <div style="height: 10px;">&nbsp;</div>
            ...
            <div class="ms-crm-VizDialog-Footer">
                ...
                <table cellpadding="2" cellspacing="3" width="100%">
                    ...
                    <tr align="right" valign="middle">
                        <td>
                            <ui:Button ID="btn_error_close" width="100" accesskey="O" OnClick="Mscrm.ImportVisualizationDialog.closeDialog();" ResourceId="Button_Label_Close" runat="server"></ui:Button>
                        </td>
                    </tr>
                </table>
            </div>
        ...
        <div>
            <table cellpadding="0" cellspacing="5" width="100%" style="table-layout: fixed">
                <tr style="height: 20px">
                    <td class="ms-crm-Field-Required" valign="bottom" style="padding-left: 15px; padding-right: 15px">
                        <label for="visualizationNameControl">
                            <loc:Text ResourceId="Web.Visualization.Designer.SaveAs.Name" runat="server"/><img src="/_imgs/frm_required.gif" alt="<loc:Text Encoding='HtmlAttribute' ResourceId='Forms.Required.AltTag' runat='server'/>"/>
                        </label>
                    </td>
                </tr>
                <tr>
                    <td valign="top" style="padding-left: 15px; padding-right: 15px">
                        <sdk:TextBoxControl id="visualizationNameControl" MaxLength="100" runat="server"/>
                    </td>
                </tr>
                <tr>
                    <td valign="bottom" style="padding-left: 15px; padding-right: 15px">
                        <label for="visualizationDescriptionControl">
                            <loc:Text ResourceId="Web.Visualization.Designer.Import.DescriptionLabel" runat="server"/>
                        </label>
                    </td>
                </tr>
                <tr>
            ...
            <div class="ms-crm-VizDialog-Footer">
                <table cellpadding=2 cellspacing=3 width="100%" style="padding-right: 30px">
                    ...
                    <tr align="right" valign="middle">
                        <td></td>
                        <td>
                            <ui:Button ID="btn_id_Import" CssClass="ms-crm-RefreshDialog-Button" width="100" accesskey="I" OnClick="applychanges();" ResourceId="Web.Visualization.Designer.Import.ImportText" runat="server"></ui:Button>
                        </td>
                        <td>
                            <ui:Button ID="btn_id_Cancel_import" CssClass="ms-crm-RefreshDialog-Button" width="100" accesskey="C" OnClick="Mscrm.ImportVisualizationDialog.closeDialog();" ResourceId="UploadFile_Dialog_Button_Cancel" runat="server"></ui:Button>
                        </td>
                    </tr>
                </table>
            </div>
                ...
                <table cellpadding="2" cellspacing="3" width="100%">
                    ...
                    <tr align="right" valign="middle">
                        <td style="padding-right: 30px">
                            <ui:Button ID="btn_success_close" CssClass="ms-crm-RefreshDialog-Button" width="100" accesskey="C" ResourceId="Button_Label_Close" runat="server"></ui:Button>
                        </td>
                    </tr>
                </table>
            </div>
