...
<style type="text/css">
    ...
    SPAN.ms-crm-AdvFind-Detailed { width: 150%; }
...
<script language="Javascript">
    ...
    function overrideOpAdvFind(clientCache) {
        ...
        oaOperator["date"] = createOpCtrl(oaOpNames,
            "on;on-or-after;on-or-before;yesterday;today;tomorrow;next-seven-days;last-seven-days;next-week;last-week;this-week;next-month;last-month;this-month;next-year;last-year;this-year;last-x-days;next-x-days;last-x-weeks;next-x-weeks;last-x-months;next-x-months;last-x-years;next-x-years;anytime");
        oaOperator["dateonly"] = createOpCtrl(oaOpNames,
            "on;on-or-after;on-or-before;yesterday;today;tomorrow;next-seven-days;last-seven-days;next-week;last-week;this-week;next-month;last-month;this-month;next-year;last-year;this-year;last-x-days;next-x-days;last-x-weeks;next-x-weeks;last-x-months;next-x-months;last-x-years;next-x-years;anytime");
        ...
        oaOperator["ownerwithname"] = createOpCtrl(oaOpNames,
            "eq-userid;ne-userid;eq-userteams;eq-useroruserteams;eq;ne");
