                ...
                <div class="articleThumbnailArea">
                    <div class="articleThumbnail">
                        <div class="iconThumbnail" articleid="${articleId}" title="${Mscrm.SearchWidget.localizedStrings.KMWALL_PRIVATE_ARTICLE_ICON_TOOLTIP_STRING}">
                            <a href="#" tabindex="-1">
                                <img id="kmArticleImage" alt="${Mscrm.SearchWidget.localizedStrings.KMWALL_PRIVATE_ARTICLE_ICON_TOOLTIP_STRING}"/>
                            </a>
                        </div>
                    </div>
                </div>
...
<script id="showMoreLinkTemplate" type="text/html">
    ...
    <div id="DialogLoadingMoreDiv" class="kmwall-loading">
        <table class="ms-crm-LoadingContainer">
            <tr class='ms-crm-LoadingContainer'>
                <td align='center'><img id='DialogLoadingDivImg' alt='${Mscrm.SearchWidget.localizedStrings.KMWALL_SEARCHING}' src='/_imgs/AdvFind/progress.gif'/><br/>${Mscrm.SearchWidget.localizedStrings.KMWALL_SEARCHING}</td>
            </tr>
        </table>
    </div>
</script>
