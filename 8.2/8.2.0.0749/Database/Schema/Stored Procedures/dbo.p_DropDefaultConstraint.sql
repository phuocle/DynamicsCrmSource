...
EXEC dbo.sp_executesql @sqlstr, N'@default_constraint_name_out sysname OUTPUT, @column_name_value sysname, @table_name_value sysname', @default_constraint_name_out = @default_constraint_name OUTPUT, @column_name_value = @column_name, @table_name_value = @table_name
