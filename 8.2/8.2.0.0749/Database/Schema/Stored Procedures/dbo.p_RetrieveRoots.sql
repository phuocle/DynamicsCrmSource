...
create procedure [dbo].[p_RetrieveRoots]
(
	@ObjectId uniqueidentifier,
	@ComponentType int,
	@RetrievalType int,
	@IncludeSubcomponents bit = true,
	@IncludeManagedComponents bit = true,
	@ReturnRootsOnly bit = true
)
as
begin	
	...
	exec p_RetrieveMultipleRoots @InsertionSql, @RetrievalType, @IncludeSubcomponents, @IncludeManagedComponents, @ReturnRootsOnly
