...
-- Update Statement
		 ...
		 SET @previousResult=[KnowledgeArticleViews], [KnowledgeArticleViews]=@result, [KnowledgeArticleViews_Date]=@startDate, [KnowledgeArticleViews_State]=@state, @id=[RootArticleId], [ModifiedOn] = GETUTCDATE()
