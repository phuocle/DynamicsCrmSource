...
from [NewProcessBase] 
    ...
    left join [SystemUserBase] [lk_newprocess_createdby] with(nolock) on ([NewProcessBase].[CreatedBy] = [lk_newprocess_createdby].[SystemUserId])
    left join [SystemUserBase] [lk_newprocess_createdonbehalfby] with(nolock) on ([NewProcessBase].[CreatedOnBehalfBy] = [lk_newprocess_createdonbehalfby].[SystemUserId])
    ...
    left join [SystemUserBase] [lk_newprocess_modifiedby] with(nolock) on ([NewProcessBase].[ModifiedBy] = [lk_newprocess_modifiedby].[SystemUserId])
    left join [SystemUserBase] [lk_newprocess_modifiedonbehalfby] with(nolock) on ([NewProcessBase].[ModifiedOnBehalfBy] = [lk_newprocess_modifiedonbehalfby].[SystemUserId])
    ...
    left join [OrganizationBase] [organization_newprocess] with(nolock) on ([NewProcessBase].[OrganizationId] = [organization_newprocess].[OrganizationId])
