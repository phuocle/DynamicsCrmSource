...
GO
GRANT SELECT ON  [dbo].[FilteredPluginAssembly] TO [CRMReaderRole]
GO
GRANT SELECT ON  [dbo].[FilteredPluginAssembly] TO [PHUOCLE\ReportingGroup {8ff092ff-6d16-41c8-aeb9-43e799050400}]
GO
