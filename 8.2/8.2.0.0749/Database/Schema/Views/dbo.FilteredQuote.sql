...
(
	...
	(
		...
		[Quote].[OwningBusinessUnit] in (select BusinessUnitId from SystemUserBusinessUnitEntityMap WITH (NOLOCK) where SystemUserId = u.SystemUserId and ObjectTypeCode = 1084)
	) 
	or
	(
		-- global security
...
GO
GRANT SELECT ON  [dbo].[FilteredQuote] TO [CRMReaderRole]
GO
GRANT SELECT ON  [dbo].[FilteredQuote] TO [PHUOCLE\ReportingGroup {8ff092ff-6d16-41c8-aeb9-43e799050400}]
GO
