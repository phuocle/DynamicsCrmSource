...
select
    ...
    [EmailServerProfileBase].[TimeoutMailboxConnection],
    [EmailServerProfileBase].[SendEmailAlert],
    [EmailServerProfileBase].[TimeoutMailboxConnectionAfterAmount],
    [EmailServerProfileBase].[EmailServerTypeName],
    [EmailServerProfileBase].[ExchangeOnlineTenantId],
    [EmailServerProfileBase].[LastTestExecutionStatus],
    [EmailServerProfileBase].[LastTestValidationStatus],
    [EmailServerProfileBase].[LastTestRequest],
    [EmailServerProfileBase].[LastTestResponse],
    [EmailServerProfileBase].[LastTestStartTime],
    [EmailServerProfileBase].[LastTestTotalExecutionTime],
    [EmailServerProfileBase].[OwnerEmailAddress],
    [EmailServerProfileBase].[UseDefaultTenantId],
    [EmailServerProfileBase].[LastAuthorizationStatus],
    [EmailServerProfileBase].[LastCrmMessage],
    [EmailServerProfileBase].[DefaultServerLocation]
