...
GO
GRANT SELECT ON  [dbo].[FilteredServiceAppointment] TO [CRMReaderRole]
GO
GRANT SELECT ON  [dbo].[FilteredServiceAppointment] TO [PHUOCLE\ReportingGroup {8ff092ff-6d16-41c8-aeb9-43e799050400}]
GO
