...
(
	...
	[Incident].OwnerId in 
		(select OwnerId from [dbo].[fn_GetOwnerIdsForFilteredView](u.SystemUserId, 112))
...
(
	...
	[Incident].[IncidentId] in 
		(select ObjectId from [dbo].[fn_GetSharedRecordIdsForFilteredView](u.SystemUserId, 112))
	)
)
GO
GRANT SELECT ON  [dbo].[FilteredIncident] TO [CRMReaderRole]
GO
GRANT SELECT ON  [dbo].[FilteredIncident] TO [PHUOCLE\ReportingGroup {8ff092ff-6d16-41c8-aeb9-43e799050400}]
GO
