...
(
	...
	[InteractionForEmail].OwnerId in 
		(select OwnerId from [dbo].[fn_GetOwnerIdsForFilteredView](u.SystemUserId, 9986))
...
(
	...
	[InteractionForEmail].[InteractionForEmailId] in 
		(select ObjectId from [dbo].[fn_GetSharedRecordIdsForFilteredView](u.SystemUserId, 9986))
	)
)
GO
GRANT SELECT ON  [dbo].[FilteredInteractionForEmail] TO [CRMReaderRole]
GO
GRANT SELECT ON  [dbo].[FilteredInteractionForEmail] TO [PHUOCLE\ReportingGroup {8ff092ff-6d16-41c8-aeb9-43e799050400}]
GO
