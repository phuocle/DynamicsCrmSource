...
(
	...
	(
		...
		[UserSettings].[BusinessUnitId] in (select BusinessUnitId from SystemUserBusinessUnitEntityMap WITH (NOLOCK) where SystemUserId = u.SystemUserId and ObjectTypeCode = 150)
	) 
	or
	(
		-- global security
...
GO
GRANT SELECT ON  [dbo].[FilteredUserSettings] TO [CRMReaderRole]
GO
GRANT SELECT ON  [dbo].[FilteredUserSettings] TO [PHUOCLE\ReportingGroup {8ff092ff-6d16-41c8-aeb9-43e799050400}]
GO
