...
create procedure dbo.p_CollectPrincipalsForBusinessUnitMove(@movedBusinessId uniqueidentifier, @oldParentId uniqueidentifier, @newParentId uniqueidentifier) as
begin
SET NOCOUNT ON
