...
create procedure dbo.p_GetNewValueFromAuditTrail(
...
begin
	if EXISTS
	(select  top 1 1 from AuditBase
	 where
	 ((ObjectId = '00000000-0000-0000-0000-000000000000' and ObjectTypeCode = @objectTypeCode and
		([Action] = 103 and 	 AttributeMask like '%,' + @attributeColumnNumber + ',%' 	 and ChangeData = 'false')) -- checking attribute level audit flag changes
	 or (ObjectId = '00000000-0000-0000-0000-000000000000' and ObjectTypeCode = @objectTypeCode and [Action] = 102) -- To check entity level audit flag changes
	 or (ObjectId = '00000000-0000-0000-0000-000000000000' and ObjectTypeCode = 1019 and [Action] = 104 and  AttributeMask like '%,156,%')) -- To check organization audit flags
	and
...
begin
	...
	(select top 1 1 from AuditBase
	 where
		 ((ObjectId = '00000000-0000-0000-0000-000000000000' and ObjectTypeCode = @objectTypeCode 
		 and ([Action] = 103 and AttributeMask like '%,' + @attributeColumnNumber + ',%' 	 and ChangeData = 'false')) -- checking attribute level audit flag changes
		or (ObjectId = '00000000-0000-0000-0000-000000000000' and ObjectTypeCode = @objectTypeCode and [Action] = 102) -- To check entity level audit flag changes
		or (ObjectId = '00000000-0000-0000-0000-000000000000' and ObjectTypeCode = 1019 and [Action] = 104 and  AttributeMask like '%,156,%') -- To check organization audit flags
		)
