...
set @l=@l+1 if(exists(select * from @t where t in(1090,4700,10004,1010,3,1146,10000,1088,2,4400,9700,1,1145,1084,112,4,4406,4402)))begin insert into @t(o,t,u,q,s,y,l) select o.MailboxTrackingFolderId,9608,o.OwnerId,c.o,c.t,1,@l from MailboxTrackingFolder o,@t c where o.RegardingObjectId=c.o and c.t in(1090,4700,10004,1010,3,1146,10000,1088,2,4400,9700,1,1145,1084,112,4,4406,4402) end
set @l=@l+1 if(exists(select * from @t where t in(1090,1010,3,1146,9953,10000,1088,2,4400,9700,1,1145,1084,112,4,4406,4402)))begin insert into @t(o,t,u,q,s,y,l) select o.ActivityId,4207,o.OwnerId,c.o,c.t,1,@l from Letter o,@t c where o.RegardingObjectId=c.o and c.t in(1090,1010,3,1146,9953,10000,1088,2,4400,9700,1,1145,1084,112,4,4406,4402) end
set @l=@l+1 if(exists(select * from @t where t in(1090,1010,3,1146,9953,10000,1088,2,4400,9700,1,1145,1084,112,4,4406,4402)))begin insert into @t(o,t,u,q,s,y,l) select o.ActivityId,4210,o.OwnerId,c.o,c.t,1,@l from PhoneCall o,@t c where o.RegardingObjectId=c.o and c.t in(1090,1010,3,1146,9953,10000,1088,2,4400,9700,1,1145,1084,112,4,4406,4402) end
set @l=@l+1 if(exists(select * from @t where t in(1090,4700,1010,3,1146,9953,10000,1088,2,4400,9700,1,1145,1084,112,4,4406,4402)))begin insert into @t(o,t,u,q,s,y,l) select o.ActivityId,4202,o.OwnerId,c.o,c.t,1,@l from Email o,@t c where o.RegardingObjectId=c.o and c.t in(1090,4700,1010,3,1146,9953,10000,1088,2,4400,9700,1,1145,1084,112,4,4406,4402) end
set @l=@l+1 if(exists(select * from @t where t in(1090,1010,3,1146,9953,10000,1088,2,4400,9700,1,1145,1084,112,4)))begin insert into @t(o,t,u,q,s,y,l) select o.ActivityId,4214,o.OwnerId,c.o,c.t,1,@l from ServiceAppointment o,@t c where o.RegardingObjectId=c.o and c.t in(1090,1010,3,1146,9953,10000,1088,2,4400,9700,1,1145,1084,112,4) end
set @l=@l+1 if(exists(select * from @t where t in(1090,1010,3,1146,9953,10000,1088,2,4400,9700,1,1145,1084,112,4,4402)))begin insert into @t(o,t,u,q,s,y,l) select o.ActivityId,4212,o.OwnerId,c.o,c.t,1,@l from Task o,@t c where o.RegardingObjectId=c.o and c.t in(1090,1010,3,1146,9953,10000,1088,2,4400,9700,1,1145,1084,112,4,4402) end
set @l=@l+1 if(exists(select * from @t where t in(1090,1010,3,1146,9953,10000,1088,2,4400,9700,1,1145,1084,112,4,4406,4402)))begin insert into @t(o,t,u,q,s,y,l) select o.ActivityId,4204,o.OwnerId,c.o,c.t,1,@l from Fax o,@t c where o.RegardingObjectId=c.o and c.t in(1090,1010,3,1146,9953,10000,1088,2,4400,9700,1,1145,1084,112,4,4406,4402) end
set @l=@l+1 if(exists(select * from @t where t in(1090,1010,3,1146,9953,10000,1088,2,4400,9700,1,1145,1084,112,4,4406,4402)))begin insert into @t(o,t,u,q,s,y,l) select o.ActivityId,4251,o.OwnerId,c.o,c.t,1,@l from RecurringAppointmentMaster o,@t c where o.RegardingObjectId=c.o and c.t in(1090,1010,3,1146,9953,10000,1088,2,4400,9700,1,1145,1084,112,4,4406,4402) end
set @l=@l+1 if(exists(select * from @t where t in(1090,1010,3,1146,9953,10000,1088,2,4400,9700,1,1145,1084,112,4,4406,4402)))begin insert into @t(o,t,u,q,s,y,l) select o.ActivityId,4201,o.OwnerId,c.o,c.t,1,@l from Appointment o,@t c where o.RegardingObjectId=c.o and c.t in(1090,1010,3,1146,9953,10000,1088,2,4400,9700,1,1145,1084,112,4,4406,4402) end
...
set @l=@l+1 if(exists(select * from @t where t in(1090,1150,9605,1010,4300,1149,3,9400,1146,9606,4703,9953,10000,9300,9750,1088,2,4400,4414,8181,9700,9507,9600,1,1145,1084,112,1151,1148,3005,4,4251,4204,4202,4206,4401,4207,4209,4201,4216,4208,4211,4212,4402,4214,4210)))begin insert into @t(o,t,u,q,s,y,l) select o.AnnotationId,5,o.OwnerId,c.o,c.t,1,@l from Annotation o,@t c where o.ObjectId=c.o and c.t in(1090,1150,9605,1010,4300,1149,3,9400,1146,9606,4703,9953,10000,9300,9750,1088,2,4400,4414,8181,9700,9507,9600,1,1145,1084,112,1151,1148,3005,4,4251,4204,4202,4206,4401,4207,4209,4201,4216,4208,4211,4212,4402,4214,4210) end
