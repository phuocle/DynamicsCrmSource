...
create view dbo.[AttributePicklistValueAsIfPublishedLogicalView] as (SELECT A1.* FROM [AttributePicklistValueLogicalView] A1 LEFT OUTER JOIN [AttributePicklistValueLogicalView] A2 ON
