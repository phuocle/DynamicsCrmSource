CREATE TABLE [dbo].[LookUpMappingBase] (
    ...
    CONSTRAINT [LookUpMapping_ColumnMapping] FOREIGN KEY ([ColumnMappingId]) REFERENCES [dbo].[ColumnMappingBase] ([ColumnMappingId]),
    CONSTRAINT [LookUpMapping_TransformationParameterMapping] FOREIGN KEY ([TransformationParameterMappingId]) REFERENCES [dbo].[TransformationParameterMappingBase] ([TransformationParameterMappingId])
);
