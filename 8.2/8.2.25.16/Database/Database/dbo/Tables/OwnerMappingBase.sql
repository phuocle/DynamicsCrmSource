CREATE TABLE [dbo].[OwnerMappingBase] (
    ...
    CONSTRAINT [OwnerMapping_ImportMap] FOREIGN KEY ([ImportMapId]) REFERENCES [dbo].[ImportMapBase] ([ImportMapId]),
    CONSTRAINT [OwnerMapping_SystemUser] FOREIGN KEY ([TargetSystemUserId]) REFERENCES [dbo].[SystemUserBase] ([SystemUserId])
);
