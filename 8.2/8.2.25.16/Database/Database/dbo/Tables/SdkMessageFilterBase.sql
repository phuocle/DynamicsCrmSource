CREATE TABLE [dbo].[SdkMessageFilterBase] (
    ...
    CONSTRAINT [createdby_sdkmessagefilter] FOREIGN KEY ([CreatedBy]) REFERENCES [dbo].[SystemUserBase] ([SystemUserId]),
    CONSTRAINT [createdonbehalfby_sdkmessagefilter] FOREIGN KEY ([CreatedOnBehalfBy]) REFERENCES [dbo].[SystemUserBase] ([SystemUserId]),
    CONSTRAINT [modifiedby_sdkmessagefilter] FOREIGN KEY ([ModifiedBy]) REFERENCES [dbo].[SystemUserBase] ([SystemUserId]),
    CONSTRAINT [modifiedonbehalfby_sdkmessagefilter] FOREIGN KEY ([ModifiedOnBehalfBy]) REFERENCES [dbo].[SystemUserBase] ([SystemUserId]),
    CONSTRAINT [sdkmessageid_sdkmessagefilter] FOREIGN KEY ([SdkMessageId]) REFERENCES [dbo].[SdkMessageBaseIds] ([SdkMessageId]),
