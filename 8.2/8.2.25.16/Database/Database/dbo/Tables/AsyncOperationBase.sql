...
CREATE NONCLUSTERED INDEX [ndx_OwnerId]
    ON [dbo].[AsyncOperationBase]([OwnerId] ASC) WITH (FILLFACTOR = 80);


GO
CREATE NONCLUSTERED INDEX [ndx_CorrelationId_RecurrencePattern]
    ON [dbo].[AsyncOperationBase]([CorrelationId] ASC, [RecurrencePattern] ASC) WITH (FILLFACTOR = 80);
