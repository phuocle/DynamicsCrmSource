CREATE TABLE [dbo].[SdkMessageRequestFieldBase] (
    ...
    CONSTRAINT [createdby_sdkmessagerequestfield] FOREIGN KEY ([CreatedBy]) REFERENCES [dbo].[SystemUserBase] ([SystemUserId]),
    CONSTRAINT [createdonbehalfby_sdkmessagerequestfield] FOREIGN KEY ([CreatedOnBehalfBy]) REFERENCES [dbo].[SystemUserBase] ([SystemUserId]),
    CONSTRAINT [messagerequest_sdkmessagerequestfield] FOREIGN KEY ([SdkMessageRequestId]) REFERENCES [dbo].[SdkMessageRequestBaseIds] ([SdkMessageRequestId]),
    CONSTRAINT [modifiedby_sdkmessagerequestfield] FOREIGN KEY ([ModifiedBy]) REFERENCES [dbo].[SystemUserBase] ([SystemUserId]),
    CONSTRAINT [modifiedonbehalfby_sdkmessagerequestfield] FOREIGN KEY ([ModifiedOnBehalfBy]) REFERENCES [dbo].[SystemUserBase] ([SystemUserId]),
...
CREATE NONCLUSTERED INDEX [ndx_SdkMessageRequestId]
    ON [dbo].[SdkMessageRequestFieldBase]([SdkMessageRequestId] ASC) WITH (FILLFACTOR = 80);
