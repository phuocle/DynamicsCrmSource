CREATE TABLE [dbo].[ImportMapBase] (
    ...
    CONSTRAINT [BusinessUnit_ImportMaps] FOREIGN KEY ([OwningBusinessUnit]) REFERENCES [dbo].[BusinessUnitBase] ([BusinessUnitId]),
    CONSTRAINT [owner_importmaps] FOREIGN KEY ([OwnerId]) REFERENCES [dbo].[OwnerBase] ([OwnerId])
);
