CREATE TABLE [dbo].[SdkMessageResponseFieldBase] (
    ...
    CONSTRAINT [createdby_sdkmessageresponsefield] FOREIGN KEY ([CreatedBy]) REFERENCES [dbo].[SystemUserBase] ([SystemUserId]),
    CONSTRAINT [createdonbehalfby_sdkmessageresponsefield] FOREIGN KEY ([CreatedOnBehalfBy]) REFERENCES [dbo].[SystemUserBase] ([SystemUserId]),
    CONSTRAINT [messageresponse_sdkmessageresponsefield] FOREIGN KEY ([SdkMessageResponseId]) REFERENCES [dbo].[SdkMessageResponseBaseIds] ([SdkMessageResponseId]),
    CONSTRAINT [modifiedby_sdkmessageresponsefield] FOREIGN KEY ([ModifiedBy]) REFERENCES [dbo].[SystemUserBase] ([SystemUserId]),
    CONSTRAINT [modifiedonbehalfby_sdkmessageresponsefield] FOREIGN KEY ([ModifiedOnBehalfBy]) REFERENCES [dbo].[SystemUserBase] ([SystemUserId]),
