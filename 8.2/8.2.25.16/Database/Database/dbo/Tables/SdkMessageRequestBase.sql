CREATE TABLE [dbo].[SdkMessageRequestBase] (
    ...
    CONSTRAINT [createdby_sdkmessagerequest] FOREIGN KEY ([CreatedBy]) REFERENCES [dbo].[SystemUserBase] ([SystemUserId]),
    CONSTRAINT [createdonbehalfby_sdkmessagerequest] FOREIGN KEY ([CreatedOnBehalfBy]) REFERENCES [dbo].[SystemUserBase] ([SystemUserId]),
    CONSTRAINT [messagepair_sdkmessagerequest] FOREIGN KEY ([SdkMessagePairId]) REFERENCES [dbo].[SdkMessagePairBaseIds] ([SdkMessagePairId]),
    CONSTRAINT [modifiedby_sdkmessagerequest] FOREIGN KEY ([ModifiedBy]) REFERENCES [dbo].[SystemUserBase] ([SystemUserId]),
    CONSTRAINT [modifiedonbehalfby_sdkmessagerequest] FOREIGN KEY ([ModifiedOnBehalfBy]) REFERENCES [dbo].[SystemUserBase] ([SystemUserId]),
