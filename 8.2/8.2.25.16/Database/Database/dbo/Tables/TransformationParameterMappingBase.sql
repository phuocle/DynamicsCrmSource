CREATE TABLE [dbo].[TransformationParameterMappingBase] (
    ...
    CONSTRAINT [TransformationParameterMapping_TransformationMapping] FOREIGN KEY ([TransformationMappingId]) REFERENCES [dbo].[TransformationMappingBase] ([TransformationMappingId])
);
