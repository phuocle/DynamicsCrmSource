CREATE TABLE [dbo].[SdkMessagePairBase] (
    ...
    [SdkMessageBindingInformation] NVARCHAR (128)   NULL,
    ...
    CONSTRAINT [createdby_sdkmessagepair] FOREIGN KEY ([CreatedBy]) REFERENCES [dbo].[SystemUserBase] ([SystemUserId]),
    CONSTRAINT [createdonbehalfby_sdkmessagepair] FOREIGN KEY ([CreatedOnBehalfBy]) REFERENCES [dbo].[SystemUserBase] ([SystemUserId]),
    CONSTRAINT [message_sdkmessagepair] FOREIGN KEY ([SdkMessageId]) REFERENCES [dbo].[SdkMessageBaseIds] ([SdkMessageId]),
    CONSTRAINT [modifiedby_sdkmessagepair] FOREIGN KEY ([ModifiedBy]) REFERENCES [dbo].[SystemUserBase] ([SystemUserId]),
    CONSTRAINT [modifiedonbehalfby_sdkmessagepair] FOREIGN KEY ([ModifiedOnBehalfBy]) REFERENCES [dbo].[SystemUserBase] ([SystemUserId]),
