...
GO
CREATE NONCLUSTERED INDEX [ndx_e10cdd445c7f4ac8a5d1b2118926f2bd]
    ON [dbo].[AccountBase]([OpenDeals] ASC) WITH (FILLFACTOR = 80);


GO
CREATE NONCLUSTERED INDEX [ndx_306845ef446a42e58df811c31bafaded]
    ON [dbo].[AccountBase]([OpenRevenue] ASC) WITH (FILLFACTOR = 80);


GO
CREATE NONCLUSTERED INDEX [ndx_fb4e42c39a134a9688f8d6820d1d0062]
    ON [dbo].[AccountBase]([OpenRevenue_Base] ASC) WITH (FILLFACTOR = 80);
