...
CREATE NONCLUSTERED INDEX [ndx_FiscalYear]
    ...
    INCLUDE([ActualValue_Base], [EstimatedValue_Base], [StateCode], [OwnerId]) WITH (FILLFACTOR = 80);
...
CREATE NONCLUSTERED INDEX [ndx_QF_ParentAccountId]
    ON [dbo].[OpportunityBase]([ParentAccountId] ASC) WITH (FILLFACTOR = 80);


GO
CREATE NONCLUSTERED INDEX [ndx_QF_ParentContactId]
    ON [dbo].[OpportunityBase]([ParentContactId] ASC) WITH (FILLFACTOR = 80);
