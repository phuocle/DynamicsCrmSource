CREATE TABLE [dbo].[SystemUserBase] (
    ...
    [DefaultOdbFolderName]              NVARCHAR (200)   CONSTRAINT [DF_SystemUserBase_DefaultOdbFolderName] DEFAULT ('CRM') NOT NULL,
...
CREATE NONCLUSTERED INDEX [ndx_IsLicensed]
    ON [dbo].[SystemUserBase]([IsLicensed] ASC) WITH (FILLFACTOR = 80);
