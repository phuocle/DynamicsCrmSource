...
{{/if}}
{{if $data.postId != 'createNote' && $data.postId.substring(0,4) != 'temp' }}
href=${window.self._notesV2DownloadUrl + "&AttachmentId=" + postId +  window.self._notesV2DownloadToken} target="" onclick="var domEvent=new Sys.UI.DomEvent(event); domEvent.stopPropagation();"
