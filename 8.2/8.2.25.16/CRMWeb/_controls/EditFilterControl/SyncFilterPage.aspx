...
var nameValue = <%= "\"" + CrmEncodeDecode.CrmJavaScriptEncodeNoQuotes(Request.QueryString["requiredFields"].ToString()) + "\""%>;
...
if (conditionNode.attributes.getNamedItem("attribute").value.toLowerCase() === requiredField.toLowerCase())
{
...
if (isNullOrEmptyString (sFetchXml)) {return;}
...
if (!window.confirm(LOCID_AF_CRITERIANOTDEFINED)) {return;}
}
else {
