...
<a onclick="event.preventDefault(); Mscrm.OneNoteControl.GridDataToOneNoteSectionConvertor.OpenOneNoteSection('{{>editUrl}}','{{>absoluteUrl}}','{{>encodedname}}');" title="{{>tooltip}}" href="#"><span class="onenoteSectionTitle">{{>displayname}}</span></a>
</div>
</div>
