...
<div id="createLabel" style="display: none;"><loc:text resourceid="NetBreeze.Config.TopicPage.CreateATopic" runat="server" /></div>
<div id="editLabel" style="display: none;"><loc:text resourceid="NetBreeze.Config.TopicPage.EditATopic" runat="server" /></div>
</label>
</div>
