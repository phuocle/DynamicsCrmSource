...
command.SetParameter("currentDate", '<%=Microsoft.Crm.CrmEncodeDecode.CrmJavaScriptEncodeNoQuotes(CurrentDate)%>');
...
<tr><td colspan="2"><div class="ms-crm-Dialog-Header-Title"><loc:Text ResourceId="SM_How_To_Edit_Weekly_Schedule" runat="server"/></div></td></tr>
<tr>
<td>
...
<td width="95%" id="exceptionstring" nowrap><label for="rad0"><%=Microsoft.Crm.CrmEncodeDecode.CrmHtmlEncode(RenderExceptionString())%></label></td>
</tr>
<tr>
...
<tr>
<td><img alt="" src="/_imgs/exception.gif" style="width:451px; height:25px" class="changeschedule_img_exception"></td>
</tr>
<tr>
<td id="specificdate"><img alt="" src="/_imgs/clear.gif" style="width:223px; height:1px" class="changeschedule_img_clear"><img alt="" src="/_imgs/line.gif">
...
<td width="95%" id="onwardstring" <%=RenderEditOnwardStyle()%> nowrap><label for="rad1"><%=Microsoft.Crm.CrmEncodeDecode.CrmHtmlEncode(RenderEditOnwardString())%></label></td>
</tr>
<tr>
<td width="5%" nowrap></td>
<td width="95%" nowrap>
<table cellspacing="0" cellpadding="0">
<tr>
<td><img alt="" src="/_imgs/newpattern.gif" style="width:451px; height:25px" class="changeschedule_img_newpattern"></td>
</tr>
<tr>
...
<td width="95%" id="wholepatternstring" nowrap><label for="rad2"><%=Microsoft.Crm.CrmEncodeDecode.CrmHtmlEncode(RenderWholePatternString())%></label></td>
</tr>
<tr>
<td width="5%" nowrap></td>
<td width="95%" nowrap>
<table cellspacing="0" cellpadding="0">
<tr>
<td><img alt="" src="/_imgs/wholepattern.gif" style="width:451px; height:25px" class="changeschedule_img_wholepattern"></td>
</tr>
<tr>
