...
var oReturnArguments = new ruleArgs(quantity.value, (effort.value.toLowerCase() == sAllValue.toLowerCase()) ? fInfinity : effort.value, samesite.value, objective.value, description.value);
if (oReturnArguments)
{
...
{
if (effort != null && effort.value.length > 0 &&
...
var windowWidth = Sys.Browser.agent === Sys.Browser.InternetExplorer ? window.document.body.clientWidth : window.outerWidth;
var windowHeight = Sys.Browser.agent === Sys.Browser.InternetExplorer ? document.documentElement.offsetHeight : window.outerHeight;
...
XUI.Html.DomUtils.GetNextSibling(element.parentNode.parentNode.parentNode.parentNode).style.display = "none";
...
<tr height="27">
<td width="40%" class="ms-crm-Field-Required" style="vertical-align:top" id="quantity_c"><label for="quantityPicker">
...
<tr height="84">
<td width="40%" style="vertical-align:top"><label for="description">
...
<td width="40%" style="vertical-align:top"><label for="sitePicker">
...
<tr height="27">
<td width="40%" style="vertical-align:top"><label for="criteriaPicker">
...
<tr height="27">
<td width="40%" class="ms-crm-Field-Required" style="vertical-align:top"><label for="effort">
