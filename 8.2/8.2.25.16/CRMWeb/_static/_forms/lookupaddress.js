...
function LookupAddress()
{
    ...
    var oUrl = Mscrm.CrmUri.create("/sfa/quotes/dlg_lookupaddress.aspx?headerForm=1&parentType=" + CrmEncodeDecode.CrmUrlEncode(aoItems[0].type) + "&parentId=" + CrmEncodeDecode.CrmUrlEncode(aoItems[0].id) + "&willCall=" + (Xrm.Page.data.entity.attributes.get("willcall").getValue() ? "1" : "0"));
...
function LookupDetailAddress()
{
    ...
    if(!Xrm.Page.data.entity.attributes.get("willcall").getValue())
    {
        ...
        dialogOptions.width = 500;
        var oUrl = Mscrm.CrmUri.create("/sfa/quotes/dlg_lookupaddress.aspx?headerForm=0&headerType=" + CrmEncodeDecode.CrmUrlEncode(iHeaderType) + "&headerId=" + CrmEncodeDecode.CrmUrlEncode(sHeaderId));
        Xrm.Internal.openDialog(oUrl.toString(),dialogOptions,"LookupAddress",null,performActionAfterLookupDetailAddress)
    }
}
...
function SetBillTo(o)
{
    ...
    if(o.BillTo)
    {
        if(!IsNull(Xrm.Page.ui.controls.get("billto_composite")))
        {
            ...
            Xrm.Internal.setComposeAddress("billto_",o.Address.Line1,o.Address.Line2,o.Address.Line3,o.Address.City,o.Address.StateOrProvince,o.Address.PostalCode,o.Address.Country)
        }
...
function SetShipTo(o,isDetail,iObjectType)
{
    ...
    if(o.ShipTo)
    {
        if(!IsNull(Xrm.Page.ui.controls.get("shipto_composite")))
        {
            ...
            Xrm.Internal.setComposeAddress("shipto_",o.Address.Line1,o.Address.Line2,o.Address.Line3,o.Address.City,o.Address.StateOrProvince,o.Address.PostalCode,o.Address.Country)
        }
        ...
        {
            iObjectType != "invoice" && !IsNull(Xrm.Page.data.entity.attributes.get("freighttermscode")) && 
