...
var OBJECTIVE_RANDOM_ID = "0",
    ...
    OBJECTIVE_RANDOM_EXPRESSION = '<Expression><Body>udf "Random"(factory,resource,appointment,request,leftoffset,rightoffset)</Body><Parameters><Parameter name="factory"/><Parameter name="resource"/><Parameter name="appointment"/><Parameter name="request"/><Parameter name="leftoffset"/><Parameter name="rightoffset"/></Parameters><Properties EvaluationInterval="P0D" evaluationcost="0"/></Expression>',
    OBJECTIVE_LEAST_BUSY_EXPRESSION = '<Expression><Body>udf "LeastBusy"(factory,resource,appointment,request,leftoffset,rightoffset)</Body><Parameters><Parameter name="factory"/><Parameter name="resource"/><Parameter name="appointment"/><Parameter name="request"/><Parameter name="leftoffset"/><Parameter name="rightoffset"/></Parameters><Properties EvaluationInterval="P1D" evaluationcost="1"/></Expression>',
    OBJECTIVE_MOST_BUSY_EXPRESSION = '<Expression><Body>udf "MostBusy"(factory,resource,appointment,request,leftoffset,rightoffset)</Body><Parameters><Parameter name="factory"/><Parameter name="resource"/><Parameter name="appointment"/><Parameter name="request"/><Parameter name="leftoffset"/><Parameter name="rightoffset"/></Parameters><Properties EvaluationInterval="P1D" evaluationcost="1"/></Expression>',
...
{
    return '<span><a onclick="' + CrmEncodeDecode.CrmHtmlAttributeEncode(action) + '" class="rsHelperlink">' + CrmEncodeDecode.CrmHtmlEncode(innerText) + "</a></span>"
}
function makeTag(sTagname,sInnerText,sAttributes)
{
    return sInnerText == null ? formatString("<{0}/>",sTagname) : formatString("<{0}{1}>{2}</{0}>",sTagname,sAttributes != null && sAttributes.length > 0 ? " " + sAttributes : "",sInnerText)
}
