    ...
    (function (ConditionPropertyPage) {
        ...
        var ConditionExpressionModel = (function (_super) {
            ...
            function ConditionExpressionModel(attrs, options) {
                ...
                _.bindAll(this, 'getValue', 'getValues', 'getSingleValue', 'setValue', 'setSingleValue', 'getDisplayName', 'setDisplayName', 'getFormulaValue', 'setFormulaValue', 'isLookupType', 'setLookupEntity');
    ...
    (function (ConditionPropertyPage) {
        ...
        var PropertiesView = (function (_super) {
            ...
            PropertiesView.prototype.render = function () {
                ...
                MscrmControls.ProcessDesigner.DOMUtil.renderPropertyPageLevelErrorMessages(this.model, $(this.$el.selector + " #properties-panel"), this.model._errorMessages);
                ...
                switch (attributeType) {
                    ...
                    case AttributeType.Customer:
                        if (MetadataProxy.SourceAttributesMap != null) {
                            ...
                            this.valueView = new LookupEditView({ model: this.model, get: this.model.getSingleValue, set: this.model.setSingleValue, targetEntity: targetEntity, isMulti: isMulti, getNameCB: this.model.getDisplayName, setNameCB: this.model.setDisplayName, setLookupEntityCB: this.model.setLookupEntity });
