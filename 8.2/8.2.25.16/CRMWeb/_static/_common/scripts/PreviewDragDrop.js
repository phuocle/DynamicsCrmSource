...
Sys.Preview.UI._DragDropManager.prototype = {_instance:null,_events:null,_ieBrowserVersion:0,_isIEBrowserVersionComputed:false,add_dragStart:function(a)
{
...
Sys.Preview.UI.DragDropEventArgs.prototype = {get_dragMode:function()
{
...
Sys.Preview.UI.IDragSource.prototype = {get_dragDataType:function()
{
...
Sys.Preview.UI.IDropTarget.prototype = {get_dropTargetElement:function()
{
    throw Error.notImplemented()
},canDrop:function()
{
...
Sys.Preview.UI.IEDragDropManager.prototype = {_dropTargets:null,_radius:10,_activeDragVisual:null,_activeContext:null,_activeDragSource:null,_underlyingTarget:null,_oldOffset:null,_potentialTarget:null,_isDragging:false,_mouseUpHandler:null,_documentMouseMoveHandler:null,_documentDragOverHandler:null,_dragStartHandler:null,_mouseMoveHandler:null,_dragEnterHandler:null,_dragLeaveHandler:null,_dragOverHandler:null,_dropHandler:null,add_dragStart:function(a)
{
    this.get_events().addHandler("dragStart",a)
},remove_dragStart:function(a)
{
...
},_drag:function(e)
{
    ...
    if(!e && parseInt(this._activeDragVisual.style.left) == a.x && parseInt(this._activeDragVisual.style.top) == a.y)
        return;
...
},_findPotentialTarget:function(a)
{
    ...
    for(var m = a.get_dragDataType(),
        ...
        c = 0; c < this._dropTargets.length; c++)
    {
...
Sys.Preview.UI.GenericDragDropManager.prototype = {_scrollEdgeConst:40,_scrollByConst:10,_scroller:null,_scrollDeltaX:null,_scrollDeltaY:null,_activeDragVisual:null,_activeContext:null,_activeDragSource:null,_mouseUpHandler:null,_mouseMoveHandler:null,_keyPressHandler:null,initialize:function()
{
...
},_autoScroll:function()
{
    ...
    if(a.width > 0)
    {
        ...
        if(b.clientX < a.x + this._scrollEdgeConst)
            ...
            if(b.clientX > a.width - this._scrollEdgeConst)
                this._scrollDeltaX = this._scrollByConst;
        if(b.clientY < a.y + this._scrollEdgeConst)
            this._scrollDeltaY = -this._scrollByConst;
        else
            if(b.clientY > a.height - this._scrollEdgeConst)
                this._scrollDeltaY = this._scrollByConst;
...
Sys.Preview.UI.DragDropList.prototype = {_isDragging:null,_dataType:null,_dragMode:null,_dragVisual:null,_direction:Sys.Preview.UI.RepeatDirection.Vertical,_emptyTemplate:null,_emptyTemplateInstance:null,_dropCueTemplate:null,_dropCueTemplateInstance:null,_floatContainerInstance:null,_originalParent:null,_originalNextSibling:null,_originalZIndex:null,_currentContext:null,_data:null,get_data:function()
{
    return this._data
},set_data:function(a)
{
...
},drop:function(e,d,a)
{
    ...
    {
        var b = a;
        if(Sys.Preview.Data.DataRow.isInstanceOfType(a) && Sys.Preview.Data.DataTable.isInstanceOfType(this._data))
        {
            var f = a.get_table();
            if(f)
    ...
    if(this._dropCueTemplate)
        if(d)
        {
            ...
            if(!Sys.Preview.UI.DragDropManager._getInstance().hasParent(this._dropCueTemplateInstance))
            {
                ...
                if(Sys.Preview.UI.DragDropManager._getInstance().getNextSibling(this._dropCueTemplateInstance) !== a)
                {
            ...
            this._dropCueTemplateInstance && Sys.Preview.UI.DragDropManager._getInstance().hasParent(this._dropCueTemplateInstance) && 
                this.get_element().removeChild(this._dropCueTemplateInstance)
},_findPotentialNextSibling:function(e)
{
    for(var c = Sys.UI.DomElement.getBounds(e),
        ...
        b,
        a = this.get_element().firstChild; a !== null; a = a.nextSibling)
...
{
    for(var b = this._dropCueTemplateInstance == null || !Sys.Preview.UI.DragDropManager._getInstance().hasParent(this._dropCueTemplateInstance),
        c = 0,
        a = this.get_element().firstChild; a !== null; a = a.nextSibling)
...
},_setEmptyTemplateVisible:function(a)
{
    if(this._emptyTemplate)
        if(a)
            ...
            this._emptyTemplateInstance && Sys.Preview.UI.DragDropManager._getInstance().hasParent(this._emptyTemplateInstance) && 
...
Sys.Preview.UI.DragDropList.descriptor = {properties:[{name:"acceptedDataTypes",type:Array},{name:"data",type:Object},{name:"dragDataType",type:String},{name:"emptyTemplate",type:Sys.Preview.UI.ITemplate},{name:"dropCueTemplate",type:Sys.Preview.UI.ITemplate},{name:"dropTargetElement",type:Object,readOnly:true},{name:"direction",type:Sys.Preview.UI.RepeatDirection},{name:"dragMode",type:Sys.Preview.UI.DragMode}]};
...
Sys.Preview.UI.DataSourceDropTarget.prototype = {_control:null,_acceptedDataTypes:null,_append:true,_target:null,_property:"data",get_append:function()
{
    return this._append
...
Sys.Preview.UI.DataSourceDropTarget.descriptor = {properties:[{name:"acceptedDataTypes",type:Array},{name:"append",type:Boolean},{name:"dropTargetElement",type:Object,readOnly:true},{name:"target",type:Object},{name:"property",type:String}]};
...
Sys.Preview.UI.DraggableListItem = function(e)
{
    ...
    this._createDragVisual = function()
    {
        ...
        if(c != null)
        {
            ...
            a = Sys.Preview.UI.DragDropManager._getInstance().addPoints(a,Sys.Preview.UI.DragDropManager._getInstance().getScrollOffset(document.body,true));
...
Sys.Preview.UI.DraggableListItem.descriptor = {properties:[{name:"data",type:Object},{name:"handle",isDomElement:true},{name:"dragVisualTemplate",type:Sys.Preview.UI.ITemplate}]};
...
Sys.Preview.UI.FloatingBehavior.prototype = {_handle:null,_location:null,_dragStartLocation:null,_profileProperty:null,_profileComponent:null,add_move:function(a)
{
...
},dispose:function()
{
    ...
    this._handle && this._mouseDownHandler && 
        Sys.UI.DomEvent.removeHandler(this._handle,"mousedown",this._mouseDownHandler);
...
Sys.Preview.UI.FloatingBehavior.descriptor = {properties:[{name:"profileProperty",type:String},{name:"profileComponent",type:Object},{name:"dragData",type:Object,readOnly:true},{name:"dragDataType",type:String,readOnly:true},{name:"dragMode",type:Sys.Preview.UI.DragMode,readOnly:true},{name:"dropTargetElement",type:Object,readOnly:true},{name:"handle",isDomElement:true},{name:"location",type:String}],events:[{name:"move"}]};
