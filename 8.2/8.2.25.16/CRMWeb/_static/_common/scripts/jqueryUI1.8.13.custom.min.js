...
(function(d)
{
    ...
    },drag:function(a,b)
    {
        for(var c = d(this).data("draggable"),
            ...
            i = c.snapElements.length - 1; i >= 0; i--)
        {
...
(function(d)
{
    ...
    {
        for(var a = d.ui.ddmanager.droppables[this.options.scope],
            b = 0; b < a.length; b++)
...
(function(e)
{
    ...
    },_mouseStart:function(b)
    {
        ...
        (d.is(".ui-draggable") || /absolute/.test(d.css("position"))) && 
    ...
    },_proportionallyResize:function()
    {
        if(this._proportionallyResizeElements.length)
            for(var b = this.helper || this.element,
    ...
    e.ui.plugin.add("resizable","ghost",{start:function()
    {
        ...
        b.ghost.css({opacity:.25,display:"block",position:"relative",height:c.height,width:c.width,margin:0,left:0,top:0}).addClass("ui-resizable-ghost").addClass(typeof a.ghost == "string" ? a.ghost : "");
...
(function(d)
{
    ...
    },_contactContainers:function(a)
    {
        for(var b = null,
            c = null,
            e = this.containers.length - 1; e >= 0; e--)
        ...
        if(b)
            if(this.containers.length === 1)
            {
                ...
                if(this.currentContainer != this.containers[c])
                {
                    b = 1e4;
                    e = null;
                    for(var f = this.positionAbs[this.containers[c].floating ? "left" : "top"],
                        g = this.items.length - 1; g >= 0; g--)
    ...
    },_createHelper:function(a)
    {
        ...
        (a[0].style.width == "" || b.forceHelperSize) && 
    ...
    },_clear:function(a,b)
    {
        ...
        (this.fromOutside || this.domPosition.prev != this.currentItem.prev().not(".ui-sortable-helper")[0] || this.domPosition.parent != this.currentItem.parent()[0]) && !b && 
            c.push(function(f)
            {
        ...
        if(this.type === "checkbox")
            ...
            else
            {
                ...
                }).bind("keydown.button",function(e)
                {
                    if(c.disabled)
                        return false;
                    (e.keyCode == a.ui.keyCode.SPACE || e.keyCode == a.ui.keyCode.ENTER) && 
                        a(this).addClass("ui-state-active")
...
(function(c,l)
{
    ...
    }},resizable:true,show:null,stack:true,title:"",width:300,zIndex:1e3},_create:function()
    {
        ...
        var a = this,
            ...
            g = (a.uiDialog = c("<div></div>")).appendTo(document.body).hide().addClass("ui-dialog ui-widget ui-widget-content ui-corner-all " + b.dialogClass).css({zIndex:b.zIndex}).attr("tabIndex",-1).css("outline",0).keydown(function(i)
            {
...
(function(d,p)
{
    ...
    },remove:function(b)
    {
        ...
        a.hasClass("ui-tabs-selected") && this.anchors.length > 1 && 
...
jQuery.effects || function(f,j)
{
    ...
    },easeInOutElastic:function(c,a,b,d,e)
    {
        ...
        if(h < Math.abs(d))
        {
            ...
            c = g / (2 * Math.PI) * Math.asin(d / h);
        if(a < 1)
            return -.5 * h * Math.pow(2,10 * (a -= 1)) * Math.sin((a * e - c) * 2 * Math.PI / g) + b;
    ...
    {
        if(a < e / 2)
            return f.easing.easeInBounce(c,a * 2,0,d,e) * .5 + b;
...
(function(j)
{
    j.effects.explode = function(a)
    {
        return this.queue(function()
        {
            ...
            for(var h = b.outerWidth(true),
                i = b.outerHeight(true),
                e = 0; e < c; e++)
                for(var f = 0; f < d; f++)
