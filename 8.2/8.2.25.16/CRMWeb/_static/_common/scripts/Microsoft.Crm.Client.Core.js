...
Microsoft.Crm.Client.Core.Framework.CustomControlAttributeProperty.prototype = {
    ...
    $2A_0: function() {
        var $$t_0;
        return ($$t_0 = this.$1a_0()).concat.call($$t_0, 'format');
    },
    
    $27_0: function() {
        var $$t_0;
        return ($$t_0 = this.$1a_0()).concat.call($$t_0, 'precision');
    },
...
Microsoft.Crm.Client.Core.Framework.Activity = function(name, properties) {
    ...
    this.rid = (!_Script.isNullOrUndefined(Microsoft.Crm.Client.Core.Framework.Activity.$a)) ? Microsoft.Crm.Client.Core.Framework.Activity.$a : Microsoft.Crm.Client.Core.Framework.Guid.newGuid().toString();
    this.p = properties;
    this.f = false;
}
Microsoft.Crm.Client.Core.Framework.Activity.get_sessionActivityId = function() {
    return Microsoft.Crm.Client.Core.Framework.Activity.$a;
}
Microsoft.Crm.Client.Core.Framework.Activity.set_sessionActivityId = function(value) {
    Microsoft.Crm.Client.Core.Framework.Activity.$a = value;
    return value;
}
...
Microsoft.Crm.Client.Core.Framework.MruCache$1.prototype = {
    ...
    cache: function(key, value) {
        ...
        var $v_1 = this.$1e_0(value);
        if ($v_1 < this.$v_0) {
            if (((key) in this.$9_0)) {
                var $v_2 = this.$9_0[key];
                this.$g_0(1026, 'MRUCache_Cache : Removing existing item before adding new value - Key : {0}; callbackSafeArrayLength : {1}', $v_2.get_key(), $v_2.get_value().get_length().toString());
                this.$r_0($v_2);
            }
            while (this.$c_0 + $v_1 > this.$v_0 && !_Script.isNullOrUndefined(this.$6_0)) {
                this.$g_0(1026, 'MRUCache_Cache : Removing least recently used object - Key : {0}; callbackSafeArrayLength : {1}', this.$6_0.get_key(), this.$6_0.get_value().get_length().toString());
                this.$r_0(this.$6_0);
            }
            this.$g_0(1026, 'MRUCache_Cache : Adding node - Key : {0}; callbackSafeArrayLength : {1}', $v_0.get_key(), $v_0.get_value().get_length().toString());
            this.$1p_0($v_0, $v_1);
        }
        else {
            this.$g_0(1026, 'MRUCache_Cache : Skipping from cache as the size of the object is bigger than the max limit of cache - Key : {0}; callbackSafeArrayLength : {1}', $v_0.get_key(), $v_0.get_value().get_length().toString());
        }
    },
    ...
    getCachedObject: function(key) {
        if (!_Script.isNullOrUndefined(this.$9_0) && ((key) in this.$9_0)) {
            var $v_0 = this.$9_0[key];
            this.$g_0(1026, 'MRUCache_GetCachedObject - Key: {0}; callbackSafeArrayLength : {1}', key, $v_0.get_value().get_length().toString());
            this.$2D_0($v_0);
            return $v_0.get_value();
        }
        this.$g_0(1026, 'MRUCache_GetCachedObject - Not found in Cache - Key: {0}', key);
        return null;
    },
    ...
    $2E_0: function($p0) {
        ...
        this.$c_0 -= this.$1e_0($p0.get_value());
    },
...
Microsoft.Crm.Client.Core.Framework.MruCacheNode$1 = function(key, value) {
    this.$1J_1 = ((this.$$gta['Microsoft.Crm.Client.Core.Framework.MruCacheNode$1']['T'] === Number || Type.isEnum(this.$$gta['Microsoft.Crm.Client.Core.Framework.MruCacheNode$1']['T'])) ? 0 : (this.$$gta['Microsoft.Crm.Client.Core.Framework.MruCacheNode$1']['T'] === Boolean) ? false : null);
...
Microsoft.Crm.Client.Core.Framework.DeviceConfiguration.get_IsPreview = function() {
    return Microsoft.Crm.Client.Core.Framework.DeviceConfiguration.$13;
}
Microsoft.Crm.Client.Core.Framework.DeviceConfiguration.set_IsPreview = function(value) {
    Microsoft.Crm.Client.Core.Framework.DeviceConfiguration.$13 = value;
    return value;
}
Microsoft.Crm.Client.Core.Framework.DeviceConfiguration.get_GetClientType = function() {
    if (Microsoft.Crm.Client.Core.Framework.DeviceConfiguration.get_formFactor() === 3) {
        return 'ISH';
    }
    else if (Microsoft.Crm.Client.Core.Framework.DeviceConfiguration.get_formFactor() === 4) {
        return 'Latte';
    }
    else if (Microsoft.Crm.Client.Core.Framework.DeviceConfiguration.get_formFactor() === 2) {
        return 'Phone';
    }
    else if (Microsoft.Crm.Client.Core.Framework.DeviceConfiguration.get_formFactor() === 1) {
        return 'Slate';
    }
    else {
        return 'Unknown';
...
Microsoft.Crm.Client.Core.Framework.FieldLevelAccess = function(isSecured, isReadable, isEditable) {
    this.$1H_0 = isSecured;
    this.$1G_0 = isReadable;
    this.$1E_0 = isEditable;
}
Microsoft.Crm.Client.Core.Framework.FieldLevelAccess.get_openAccess = function() {
    if (_Script.isNullOrUndefined(Microsoft.Crm.Client.Core.Framework.FieldLevelAccess.$x)) {
        Microsoft.Crm.Client.Core.Framework.FieldLevelAccess.$x = new Microsoft.Crm.Client.Core.Framework.FieldLevelAccess(false, true, true);
    }
...
Microsoft.Crm.Client.Core.Framework.FieldLevelAccess.get_readOnlyAccess = function() {
    if (_Script.isNullOrUndefined(Microsoft.Crm.Client.Core.Framework.FieldLevelAccess.$y)) {
        Microsoft.Crm.Client.Core.Framework.FieldLevelAccess.$y = new Microsoft.Crm.Client.Core.Framework.FieldLevelAccess(false, true, false);
    }
    return Microsoft.Crm.Client.Core.Framework.FieldLevelAccess.$y;
}
...
Microsoft.Crm.Client.Core.Framework.CallingContext = function(callerId, callerName, callerPriority, telemetryActivity) {
    this.$16_0 = (!Microsoft.Crm.Client.Core.Framework._String.isNullOrEmpty(callerId)) ? callerId : 'unknown';
    this.$j_0 = (!Microsoft.Crm.Client.Core.Framework._String.isNullOrEmpty(callerName)) ? callerName : 'unknown';
    this.$17_0 = callerPriority;
    this.$1L_0 = telemetryActivity;
}
...
Microsoft.Crm.Client.Core.Framework.ErrorStatus.fromErrorCodeWithMessage = function(errorCode, message) {
    var $v_0 = null;
    if (errorCode === -2147220891 && !_Script.isNullOrUndefined(message)) {
        $v_0 = Microsoft.Crm.Client.Core.Framework.ErrorStatus.fromMessage(message);
        $v_0.$3_0 = errorCode;
    }
    else {
        $v_0 = Microsoft.Crm.Client.Core.Framework.ErrorStatus.fromErrorCode(errorCode);
    }
    return $v_0;
}
...
Microsoft.Crm.Client.Core.Framework.ErrorStatus.fromError = function(previousError, message, errorCode) {
    ...
    $v_0.$3_0 = (!_Script.isNullOrUndefined(errorCode)) ? errorCode : previousError.$3_0;
...
Microsoft.Crm.Client.Core.Framework.ErrorStatus.fromErrorData = function(errors) {
    ...
    var $v_1 = new Microsoft.Crm.Client.Core.Framework.ErrorStatus($v_0.$w_0);
    $v_1.$i_0 = $v_0.$z_0;
    $v_1.$J_0 = $v_0.$J_0;
    $v_1.$I_0 = $v_0.$I_0;
    $v_1.$3_0 = $v_0.$3_0;
...
Microsoft.Crm.Client.Core.Framework.ErrorStatus.prototype = {
    ...
    getDiagnostics: function() {
        ...
        if (!_Script.isNullOrUndefined(this.$M_0)) {
            for (var $$arr_1 = this.$M_0, $$len_2 = $$arr_1.length, $$idx_3 = 0; $$idx_3 < $$len_2; ++$$idx_3) {
                ...
                if (!Microsoft.Crm.Client.Core.Framework._String.isNullOrEmpty($v_1.$V_0)) {
                    $v_0 += $v_1.$V_0;
                    if (!Microsoft.Crm.Client.Core.Framework._String.isNullOrEmpty($v_1.$b_0)) {
                        $v_0 += '\nStackTrace:\n' + $v_1.$b_0;
                    }
                    $v_0 += '\n\n';
                }
        ...
        if (Microsoft.Crm.Client.Core.Framework._String.isNullOrWhiteSpace($v_0)) {
            $v_0 = 'Diagnostic message not found for error ' + this.$3_0 + ' with message: ' + this.$B_0;
        }
        return $v_0;
    },
...
Microsoft.Crm.Client.Core.Framework.Guid = function(guidValue) {
    this.$4_0 = Microsoft.Crm.Client.Core.Framework.Guid.$1f(guidValue);
...
Microsoft.Crm.Client.Core.Framework.Guid.$1f = function($p0) {
    if (Microsoft.Crm.Client.Core.Framework._String.isNullOrEmpty($p0)) {
        return null;
    }
    $p0 = $p0.toLowerCase();
    if (Microsoft.Crm.Client.Core.Framework.Guid.get_$2C().test($p0) || Microsoft.Crm.Client.Core.Framework.Guid.get_$1R().test($p0)) {
        return $p0.replace(Microsoft.Crm.Client.Core.Framework.Guid.get_$2B(), '');
    }
    else if (Microsoft.Crm.Client.Core.Framework.Guid.get_$1u().test($p0)) {
        return $p0;
    }
    return null;
}
Microsoft.Crm.Client.Core.Framework.Guid.get_empty = function() {
    return Microsoft.Crm.Client.Core.Framework.Guid.$n || (Microsoft.Crm.Client.Core.Framework.Guid.$n = new Microsoft.Crm.Client.Core.Framework.Guid('00000000-0000-0000-0000-000000000000'));
}
Microsoft.Crm.Client.Core.Framework.Guid.get_$2B = function() {
    return Microsoft.Crm.Client.Core.Framework.Guid.$1C || (Microsoft.Crm.Client.Core.Framework.Guid.$1C = new RegExp('{|}|-', 'g'));
}
Microsoft.Crm.Client.Core.Framework.Guid.get_$2C = function() {
    return Microsoft.Crm.Client.Core.Framework.Guid.$1D || (Microsoft.Crm.Client.Core.Framework.Guid.$1D = new RegExp('^(\\d|[a-f]){8}-(\\d|[a-f]){4}-(\\d|[a-f]){4}-(\\d|[a-f]){4}-(\\d|[a-f]){12}$'));
}
Microsoft.Crm.Client.Core.Framework.Guid.get_$1R = function() {
    return Microsoft.Crm.Client.Core.Framework.Guid.$15 || (Microsoft.Crm.Client.Core.Framework.Guid.$15 = new RegExp('^{(\\d|[a-f]){8}-(\\d|[a-f]){4}-(\\d|[a-f]){4}-(\\d|[a-f]){4}-(\\d|[a-f]){12}}$'));
}
Microsoft.Crm.Client.Core.Framework.Guid.get_$1u = function() {
    return Microsoft.Crm.Client.Core.Framework.Guid.$18 || (Microsoft.Crm.Client.Core.Framework.Guid.$18 = new RegExp('^(\\d|[a-f]){32}$'));
}
...
Microsoft.Crm.Client.Core.Framework.Guid.tryCreate = function(guidValue) {
    var $v_0 = Microsoft.Crm.Client.Core.Framework.Guid.$1f(guidValue);
...
Microsoft.Crm.Client.Core.Framework.Guid.formatToUpper = function(sourceGuid) {
    ...
    if (Microsoft.Crm.Client.Core.Framework.Guid.get_$1R().test(sourceGuid)) {
...
Microsoft.Crm.Client.Core.Framework.Guid.isNullOrEmpty = function(guid) {
    ...
    if (new Microsoft.Crm.Client.Core.Framework.Guid(guid).equals(Microsoft.Crm.Client.Core.Framework.Guid.$n)) {
        return true;
    }
    return false;
}
...
Microsoft.Crm.Client.Core.Framework.Guid.prototype = {
    ...
    toString: function() {
        if (!this.$s_0) {
            this.$s_0 = this.$4_0.substring(0, 8) + '-' + this.$4_0.substring(8, 12) + '-' + this.$4_0.substring(12, 16) + '-' + this.$4_0.substring(16, 20) + '-' + this.$4_0.substring(20, 32);
        }
        return this.$s_0;
    }
}
...
Microsoft.Crm.Client.Core.Framework.KeyValuePair$2 = function(key, value) {
    ...
    this.$1M_0 = ((this.$$gta['Microsoft.Crm.Client.Core.Framework.KeyValuePair$2']['TValue'] === Number || Type.isEnum(this.$$gta['Microsoft.Crm.Client.Core.Framework.KeyValuePair$2']['TValue'])) ? 0 : (this.$$gta['Microsoft.Crm.Client.Core.Framework.KeyValuePair$2']['TValue'] === Boolean) ? false : null);
    this.$X_0 = key;
    this.$1M_0 = value;
}
...
Microsoft.Crm.Client.Core.Framework.TimeZoneAdjuster = function(end, start, delta, daylightStart, daylightEnd) {
    ...
    this.$e_0 = start;
    this.$f_0 = delta;
    this.$m_0 = daylightStart;
    this.$l_0 = daylightEnd;
}
...
Microsoft.Crm.Client.Core.Framework.TimeZoneAdjuster.prototype = {
    ...
    getObjectData: function() {
        var $v_0 = {};
        $v_0['dateend'] = this.$d_0;
        $v_0['datestart'] = this.$e_0;
        $v_0['delta'] = this.$f_0;
        $v_0['daylightstart'] = this.$m_0.getObjectData();
        $v_0['daylightend'] = this.$l_0.getObjectData();
        return $v_0;
    },
    
    getLocalAdjustmentFromDate: function(time) {
        var $v_0 = time.getFullYear();
        var $v_1 = this.$m_0.getConstraintByYear($v_0);
        var $v_2 = this.$l_0.getConstraintByYear($v_0);
        if ($v_2 < $v_1) {
...
Microsoft.Crm.Client.Core.Framework.UserDateTimeUtils.$1v = function($p0, $p1, $p2) {
...
Microsoft.Crm.Client.Core.Framework.UserDateTimeUtils.getDSTAdjustment = function(time, adjusters) {
    ...
    for (var $v_2 = 0; $v_2 < adjusters.length; $v_2++) {
        var $v_3 = adjusters[$v_2].$e_0;
        var $v_4 = adjusters[$v_2].$d_0;
        if ($v_1 >= $v_3 && $v_1 <= $v_4) {
            $v_0 = adjusters[$v_2];
            break;
        }
...
Microsoft.Crm.Client.Core.Framework.UserDateTimeUtils.convertTimeFromBehaviorDisplay = function(time, userUtcOffsetMinutes, behavior, adjusters) {
    switch (behavior) {
        ...
        case 1:
            return Microsoft.Crm.Client.Core.Framework.UserDateTimeUtils.$1v(time, userUtcOffsetMinutes, adjusters);
        default:
            return new Date(time.getTime());
    }
}
...
Microsoft.Crm.Client.Core.Framework.UserDateTimeUtils.getDaysInMonth = function(month, year) {
    var $v_0 = (Microsoft.Crm.Client.Core.Framework.UserDateTimeUtils.isLeapYear(year)) ? Microsoft.Crm.Client.Core.Framework.UserDateTimeUtils.$1T : Microsoft.Crm.Client.Core.Framework.UserDateTimeUtils.$1S;
    if (!month) {
        return $v_0[month];
    }
...
Microsoft.Crm.Client.Core.Framework.TransitionConstraint.prototype = {
    ...
    getConstraintByYear: function(year) {
        if (this.$t_0) {
            return new Date(year, this.$P_0, this.$k_0, this.$H_0.getHours(), this.$H_0.getMinutes(), this.$H_0.getSeconds());
        }
        var $v_0 = (this.$11_0 * 7) - 6;
...
Microsoft.Crm.Client.Core.Framework._String.replaceNewlineWithEnding = function(text, ending) {
    if (Microsoft.Crm.Client.Core.Framework._String.isNullOrEmpty(text)) {
        ...
        var $v_1 = text.split(Microsoft.Crm.Client.Core.Framework._String.$1j);
        for (var $v_2 = 0; $v_2 < $v_1.length; $v_2++) {
...
HtmlEncoder.encode = function(rawHtml) {
    ...
    var $v_0 = rawHtml.replace(HtmlEncoder.$1P, '&amp;');
    $v_0 = $v_0.replace(HtmlEncoder.$1i, '&lt;');
    $v_0 = $v_0.replace(HtmlEncoder.$1g, '&gt;');
    $v_0 = $v_0.replace(HtmlEncoder.$1Q, '&apos;');
    $v_0 = $v_0.replace(HtmlEncoder.$1k, '&quot;');
    return $v_0;
}
HtmlEncoder.decode = function(encodedHtml) {
    ...
    var $v_0 = encodedHtml.replace(HtmlEncoder.$1Y, '\"');
    $v_0 = $v_0.replace(HtmlEncoder.$1V, '\'');
    $v_0 = $v_0.replace(HtmlEncoder.$1W, '>');
    $v_0 = $v_0.replace(HtmlEncoder.$1X, '<');
...
Microsoft.Crm.Client.Core.Framework.Common.ResourceManager.updateDisplayMode = function(isHorizontal) {
    Microsoft.Crm.Client.Core.Framework.Common.ResourceManager.$1h = isHorizontal;
}
...
Microsoft.Crm.Client.Core.Framework.Common.ResourceManager.getErrorTitle = function(errorCode, parameters) {
    var $v_0 = Microsoft.Crm.Client.Core.Framework.Common.ResourceManager.$24(errorCode);
...
Microsoft.Crm.Client.Core.Framework.Common.ResourceManager.getErrorMessage = function(errorCode, parameters) {
    var $v_0;
    var $v_1 = Microsoft.Crm.Client.Core.Framework.Common.ResourceManager.$23(errorCode);
...
Microsoft.Crm.Client.Core.Framework.Common.ResourceManager.getErrorMessageFromErrorStatus = function(errorStatus) {
    if (errorStatus.$3_0 === -2147220891 && !_Script.isNullOrUndefined(errorStatus.$B_0)) {
        return errorStatus.$B_0;
    }
    else {
        return Microsoft.Crm.Client.Core.Framework.Common.ResourceManager.getErrorMessage(errorStatus.$3_0);
    }
}
Microsoft.Crm.Client.Core.Framework.Common.ResourceManager.$24 = function($p0) {
    if (_Script.isNullOrUndefined($p0)) {
...
Microsoft.Crm.Client.Core.Framework.CustomControl.ColumnDefinition = function(name, displayName, alias, dataType, visualSizeFactor) {
    this.$1I_0 = name;
    this.$1A_0 = displayName;
    this.$14_0 = alias;
    this.$19_0 = dataType;
    this.$1N_0 = visualSizeFactor;
}
...
Microsoft.Crm.Client.Core.Storage.Common.Xml.DOMParserNodeWrapper = function($p0, $p1) {
    ...
    this.$0_1 = $p0;
    this.$2_1 = (_Script.isNullOrUndefined($p1)) ? {} : $p1;
}
Microsoft.Crm.Client.Core.Storage.Common.Xml.DOMParserNodeWrapper.prototype = {
    ...
    getElementsByTagName: function($p0) {
        ...
        for (var $v_5 = 0; $v_5 < $v_1.length; $v_5++) {
            Array.add($v_3, new Microsoft.Crm.Client.Core.Storage.Common.Xml.DOMParserNodeWrapper($v_1[$v_5], this.$2_1));
        }
    ...
    childNodes: function() {
        ...
        for (var $v_1 = 0, $v_2 = this.$0_1.childNodes.length; $v_1 < $v_2; $v_1++) {
            Array.add($v_0, new Microsoft.Crm.Client.Core.Storage.Common.Xml.DOMParserNodeWrapper(this.$0_1.childNodes[$v_1], this.$2_1));
        }
    ...
    getNamespaceOfPrefix: function($p0) {
        if (!_Script.isNullOrUndefined(this.$2_1) && !_Script.isNullOrUndefined(this.$2_1[$p0])) {
            return this.$2_1[$p0];
        }
        return '';
    },
    ...
    $1o_1: function($p0, $p1) {
        ...
        if ($p0.startsWith('//') || $p0.startsWith('.//')) {
            ...
            $v_0 = this.$1K_1($v_0, $p0.substr(1), $p1);
        }
        else {
            Array.add($v_0, this.$0_1);
            $v_0 = this.$1K_1($v_0, $p0, $p1);
        }
        var $v_1 = [];
        for (var $v_E = 0; $v_E < $v_0.length; $v_E++) {
            Array.add($v_1, new Microsoft.Crm.Client.Core.Storage.Common.Xml.DOMParserNodeWrapper($v_0[$v_E], this.$2_1));
        }
        return new Microsoft.Crm.Client.Core.Storage.Common.Xml.DOMParserNodeListWrapper($v_1);
    },
    
    $1K_1: function($p0, $p1, $p2) {
        if ($p2) {
            return this.$2H_1($p0, $p1);
        }
        return this.$1m_1($p0, $p1);
    },
    ...
    $1n_1: function($p0, $p1) {
        ...
        for (var $v_6 = 0, $v_7 = $p0.childNodes.length; $v_6 < $v_7; $v_6++) {
            if (this.$1F_1($p0.childNodes[$v_6], $v_3)) {
                var $v_8 = [];
                Array.add($v_8, $p0.childNodes[$v_6]);
                var $v_9 = $v_8;
                if (null !== $v_4) {
                    $v_9 = this.$1B_1($v_8, $v_4);
                }
                if ($v_9.length > 0) {
                    if (null === $v_2) {
                        $v_5 = $v_9[0];
    ...
    $2G_1: function($p0, $p1) {
        ...
        for (var $v_5 = 0, $v_6 = $p0.childNodes.length; $v_5 < $v_6; $v_5++) {
            if (this.$1F_1($p0.childNodes[$v_5], $v_1)) {
                Array.add($v_3, $p0.childNodes[$v_5]);
            }
        }
        var $v_4 = $v_3;
        if ($v_3.length > 0 && null !== $v_2) {
            $v_4 = this.$1B_1($v_3, $v_2);
        }
        return $v_4;
    },
    ...
    $1B_1: function($p0, $p1) {
        ...
        for (var $v_5 = 0; $v_5 < $p0.length; $v_5++) {
            var $v_6 = $p0[$v_5];
            if ($v_0 && this.$1x_1($v_6, $v_2, $v_3)) {
                Array.add($v_4, $v_6);
            }
            else if (this.$1y_1($v_6, $v_2, $v_3)) {
                Array.add($v_4, $v_6);
            }
        }
        return $v_4;
    ...
    $1y_1: function($p0, $p1, $p2) {
        for (var $v_0 = 0, $v_1 = $p0.childNodes.length; $v_0 < $v_1; $v_0++) {
            if (this.$1F_1($p0.childNodes[$v_0], $p1)) {
                if (null === $p2) {
                    return true;
                }
...
Microsoft.Crm.Client.Core.Storage.Common.Xml.XmlNodeFactory.create = function(node) {
    ...
    if (Microsoft.Crm.Client.Core.Storage.Common.Xml.XmlNodeFactory.$L === -1) {
        Microsoft.Crm.Client.Core.Storage.Common.Xml.XmlNodeFactory.$1w(node);
    }
...
Microsoft.Crm.Client.Core.Storage.Common.Xml.XmlNodeFactory.$1w = function($p0) {
    if (Microsoft.Crm.Client.Core.Storage.Common.Xml.XmlNodeFactory.$1s()) {
...
Microsoft.Crm.Client.Core.Storage.Common.Xml.XmlNodeFactory.$1s = function() {
...
Microsoft.Crm.Client.Core.Storage.Common.Xml.XPathEvaluatorWrapper = function($p0, $p1, $p2) {
    this.$$d_$2F_1 = Function.createDelegate(this, this.$2F_1);
    ...
    this.$2_1 = (_Script.isNullOrUndefined($p2)) ? {} : $p2;
}
Microsoft.Crm.Client.Core.Storage.Common.Xml.XPathEvaluatorWrapper.prototype = {
    ...
    selectSingleNode: function($p0) {
        var $v_0 = this.$K_1.evaluate($p0, this.$0_1, this.$$d_$2F_1, 9, null);
        return (_Script.isNullOrUndefined($v_0.singleNodeValue)) ? null : new Microsoft.Crm.Client.Core.Storage.Common.Xml.XPathEvaluatorWrapper(this.$K_1, $v_0.singleNodeValue, this.$2_1);
    },
    
    selectNodes: function($p0) {
        return new Microsoft.Crm.Client.Core.Storage.Common.Xml.NodeSnapshotWrapper(this.$K_1, this.$K_1.evaluate($p0, this.$0_1, this.$$d_$2F_1, 7, null), this.$2_1);
    },
    ...
    getElementsByTagName: function($p0) {
        return new Microsoft.Crm.Client.Core.Storage.Common.Xml.NodeSnapshotWrapper(this.$K_1, this.$0_1.getElementsByTagName($p0), this.$2_1);
    },
    
    childNodes: function() {
        return new Microsoft.Crm.Client.Core.Storage.Common.Xml.NodeSnapshotWrapper(this.$K_1, this.$0_1.childNodes, this.$2_1);
    },
...
Microsoft.Crm.Client.Core.Models.Validation.ValidatorResult = function(isValueValid, validatedValue, errorMessage, errorId, errorMessageLevel) {
    this.$u_0 = isValueValid;
    this.$10_0 = validatedValue;
    this.$p_0 = errorMessage;
    this.$o_0 = errorId;
    this.$q_0 = errorMessageLevel;
}
...
Microsoft.Crm.Client.Core.Storage.Common.CustomControls.CustomControlDataSetFilteringUtils.$1t = function($p0) {
    switch ($p0) {
        case 'eq':
            return 0;
        case 'ne':
        ...
        if ($v_2.length > 0) {
            ...
            for (var $v_5 = 0; $v_5 < $v_4.length; $v_5++) {
                ...
                if ($v_6.nodeName.toLowerCase() === 'condition') {
                    ...
                    $v_7.conditionOperator = Microsoft.Crm.Client.Core.Storage.Common.CustomControls.CustomControlDataSetFilteringUtils.$1t($v_6.attributes.getNamedItem('operator').nodeValue);
...
Microsoft.Crm.Client.Core.Framework.DataLayerPerformanceMarkerNames.endToEndSyncMetadata = 'DataSource_EndToEndSyncMetadata';
...
Microsoft.Crm.Client.Core.Framework.FieldLevelAccess.$y = null;
...
Microsoft.Crm.Client.Core.Framework.CrmErrorCodes.oneNoteLocationNotCreated = -2147088122;
...
Microsoft.Crm.Client.Core.Framework.Guid.$n = null;
Microsoft.Crm.Client.Core.Framework.Guid.$1C = null;
Microsoft.Crm.Client.Core.Framework.Guid.$1D = null;
Microsoft.Crm.Client.Core.Framework.Guid.$15 = null;
Microsoft.Crm.Client.Core.Framework.Guid.$18 = null;
...
Microsoft.Crm.Client.Core.Framework.UserDateTimeUtils.$1S = [ 31, 59, 90, 120, 151, 181, 212, 243, 273, 304, 334, 365 ];
Microsoft.Crm.Client.Core.Framework.UserDateTimeUtils.$1T = [ 31, 60, 91, 121, 152, 182, 213, 244, 274, 305, 335, 366 ];
...
Microsoft.Crm.Client.Core.Framework._String.$1j = new RegExp('[\n\r]+');
HtmlEncoder.$1P = new RegExp('&', 'g');
HtmlEncoder.$1i = new RegExp('<', 'g');
HtmlEncoder.$1g = new RegExp('>', 'g');
HtmlEncoder.$1Q = new RegExp('\'', 'g');
HtmlEncoder.$1k = new RegExp('\"', 'g');
HtmlEncoder.$1U = new RegExp('&amp;', 'g');
HtmlEncoder.$1X = new RegExp('&lt;', 'g');
HtmlEncoder.$1W = new RegExp('&gt;', 'g');
HtmlEncoder.$1V = new RegExp('&apos;', 'g');
HtmlEncoder.$1Y = new RegExp('&quot;', 'g');
...
Microsoft.Crm.Client.Core.Framework.Common.ResourceManager.$1h = true;
