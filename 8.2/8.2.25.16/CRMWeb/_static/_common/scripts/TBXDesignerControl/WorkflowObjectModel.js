...
Microsoft.Crm.Workflow.FormulaDisplayVisitor = function Microsoft_Crm_Workflow_FormulaDisplayVisitor(useForReadMode, calculatedFieldLabelDescription, getAttributeLocalizedNameFunc) {
...
Microsoft.Crm.Workflow.FormulaDisplayVisitor.expressionToString = function Microsoft_Crm_Workflow_FormulaDisplayVisitor$expressionToString(expression) {
...
Microsoft.Crm.Workflow.FormulaDisplayVisitor.prototype = {
    ...
    visitConditionBranchStep: function Microsoft_Crm_Workflow_FormulaDisplayVisitor$visitConditionBranchStep(conditionBranchStep) {
    ...
    visitSetAttributeValueStep: function Microsoft_Crm_Workflow_FormulaDisplayVisitor$visitSetAttributeValueStep(setAttributeValueStep) {
        if (!setAttributeValueStep.get_propertySpec()) {
            return;
        }
        var formula = this._generateExpressionString$p$2(setAttributeValueStep.get_propertySpec().propertyValueExpr);
        if (formula.startsWith('(') && formula.endsWith(')')) {
            formula = formula.substring(1, formula.length - 1);
        }
        if (this._useForReadMode$2) {
            formula = String.format(window.LOCID_BUSINESSRULE_SETATTRVALUE, String.format('<b>{0}</b>', CrmEncodeDecode.CrmHtmlEncode(this._calculatedFieldLabelDescription$2)), String.format('<b>{0}</b>', CrmEncodeDecode.CrmHtmlEncode(formula)));
        }
        this._appendWithIndent$p$2(formula);
    },
    
    visitMethodCallExpression: function Microsoft_Crm_Workflow_FormulaDisplayVisitor$visitMethodCallExpression(expression) {
                ...
                switch (expressionOperator) {
                    ...
                    default:
                        ...
                        if (parameters.length > 1) {
                            this._builder$2.append(this._generateExpressionString$p$2(parameters[parameters.length - 1]));
                        }
                        this._builder$2.append(')');
                        break;
                }
    ...
    visitEntityAttributeExpression: function Microsoft_Crm_Workflow_FormulaDisplayVisitor$visitEntityAttributeExpression(expression) {
    ...
    visitPrimitiveExpression: function Microsoft_Crm_Workflow_FormulaDisplayVisitor$visitPrimitiveExpression(expression) {
        ...
        if (expression.type === 14) {
            if (!this._useForReadMode$2) {
                ...
                primitiveExpressionString = primitiveExpressionString.replace(regexBackslash, '\\\\').replace(regexQuotation, '\\\"');
            }
    ...
    _generatePrimaryEntityDisplayString$p$2: function Microsoft_Crm_Workflow_FormulaDisplayVisitor$_generatePrimaryEntityDisplayString$p$2(expression) {
        return (this._localizeEnabled$2) ? this._getAttributeLocalizedNameFunc$2(expression.entity.entityName, expression.attributeName) : expression.attributeName;
    },
    
    _generateRelatedEntityDisplayString$p$2: function Microsoft_Crm_Workflow_FormulaDisplayVisitor$_generateRelatedEntityDisplayString$p$2(expression) {
        ...
        var primaryString = (this._localizeEnabled$2) ? this._getAttributeLocalizedNameFunc$2(expression._workflow$p$0.primaryEntityName, relatedEntity.get_relatedAttributeName()) : relatedEntity.get_relatedAttributeName();
    ...
    _generateExpressionString$p$2: function Microsoft_Crm_Workflow_FormulaDisplayVisitor$_generateExpressionString$p$2(expression) {
    ...
    get__entityAttributeExpressionTemplate$p$2: function Microsoft_Crm_Workflow_FormulaDisplayVisitor$get__entityAttributeExpressionTemplate$p$2() {
        return (this._localizeEnabled$2) ? '({0}) {1}' : '{0}.{1}';
    },
    
    _getExpressionOperatorString$p$2: function Microsoft_Crm_Workflow_FormulaDisplayVisitor$_getExpressionOperatorString$p$2(expressionOperator) {
        switch (expressionOperator) {
            case 0:
                return '+';
            case 1:
    ...
    _getConditionExpressionOperatorString$p$2: function Microsoft_Crm_Workflow_FormulaDisplayVisitor$_getConditionExpressionOperatorString$p$2(conditionOperator) {
...
Microsoft.Crm.Workflow.SharedExpressionVisitor.prototype = {
    ...
    visitConditionBranchStep: function Microsoft_Crm_Workflow_SharedExpressionVisitor$visitConditionBranchStep(conditionBranchStep) {
        conditionBranchStep.conditionExpression.accept(this);
        this.visitChildren(conditionBranchStep);
    },
    
    visitSetAttributeValueStep: function Microsoft_Crm_Workflow_SharedExpressionVisitor$visitSetAttributeValueStep(setAttributeValueStep) {
    ...
    visitChildWorkflowStep: function Microsoft_Crm_Workflow_SharedExpressionVisitor$visitChildWorkflowStep(childWorkflowStep) {
        Microsoft.Crm.Workflow.Utils.SharedUtility.throwException(0);
    },
    ...
    visitCustomActivityStep: function Microsoft_Crm_Workflow_SharedExpressionVisitor$visitCustomActivityStep(customActivityStep) {
        Microsoft.Crm.Workflow.Utils.SharedUtility.throwException(0);
    },
    
    visitChildInteractiveWorkflowStep: function Microsoft_Crm_Workflow_SharedExpressionVisitor$visitChildInteractiveWorkflowStep(childWorkflowStep) {
        Microsoft.Crm.Workflow.Utils.SharedUtility.throwException(0);
    },
    ...
    visitAssignVariableStep: function Microsoft_Crm_Workflow_SharedExpressionVisitor$visitAssignVariableStep(assignVariableStep) {
        Microsoft.Crm.Workflow.Utils.SharedUtility.throwException(0);
    },
    ...
    visitWaitTimeoutStep: function Microsoft_Crm_Workflow_SharedExpressionVisitor$visitWaitTimeoutStep(waitTimeoutStep) {
        Microsoft.Crm.Workflow.Utils.SharedUtility.throwException(0);
    },
    
    visitStopWorkflowStep: function Microsoft_Crm_Workflow_SharedExpressionVisitor$visitStopWorkflowStep(stopWorkflowStep) {
        Microsoft.Crm.Workflow.Utils.SharedUtility.throwException(0);
    },
    ...
    visitSetVisibilityStep: function Microsoft_Crm_Workflow_SharedExpressionVisitor$visitSetVisibilityStep(setVisibilityStep) {
        Microsoft.Crm.Workflow.Utils.SharedUtility.throwException(0);
    },
    
    visitSetDefaultValueStep: function Microsoft_Crm_Workflow_SharedExpressionVisitor$visitSetDefaultValueStep(setDefaultValueStep) {
        Microsoft.Crm.Workflow.Utils.SharedUtility.throwException(0);
    },
    
    visitSetDisplayModeStep: function Microsoft_Crm_Workflow_SharedExpressionVisitor$visitSetDisplayModeStep(setDisplayModeStep) {
        Microsoft.Crm.Workflow.Utils.SharedUtility.throwException(0);
    },
    
    visitCustomJavascriptStep: function Microsoft_Crm_Workflow_SharedExpressionVisitor$visitCustomJavascriptStep(customJSStep) {
        Microsoft.Crm.Workflow.Utils.SharedUtility.throwException(0);
    },
    ...
    visitRelationshipCollectionStep: function Microsoft_Crm_Workflow_SharedExpressionVisitor$visitRelationshipCollectionStep(relationshipCollectionStep) {
        Microsoft.Crm.Workflow.Utils.SharedUtility.throwException(0);
    },
    
    visitRelationshipStep: function Microsoft_Crm_Workflow_SharedExpressionVisitor$visitRelationshipStep(relationshipStep) {
        Microsoft.Crm.Workflow.Utils.SharedUtility.throwException(0);
    },
    ...
    visitSetFieldRequiredLevelStep: function Microsoft_Crm_Workflow_SharedExpressionVisitor$visitSetFieldRequiredLevelStep(setFieldRequiredLevelStep) {
        Microsoft.Crm.Workflow.Utils.SharedUtility.throwException(0);
    },
    ...
    visitSetNextStageStep: function Microsoft_Crm_Workflow_SharedExpressionVisitor$visitSetNextStageStep(setNextStageStep) {
        Microsoft.Crm.Workflow.Utils.SharedUtility.throwException(0);
    },
    
    visitInteractionStep: function Microsoft_Crm_Workflow_SharedExpressionVisitor$visitInteractionStep(interactionStep) {
        Microsoft.Crm.Workflow.Utils.SharedUtility.throwException(0);
    },
    
    visitInteractionPageStep: function Microsoft_Crm_Workflow_SharedExpressionVisitor$visitInteractionPageStep(interactionPageStep) {
        Microsoft.Crm.Workflow.Utils.SharedUtility.throwException(0);
    },
    ...
    visitMethodCallExpression: function Microsoft_Crm_Workflow_SharedExpressionVisitor$visitMethodCallExpression(expression) {
        var parameters = expression.getParameters();
    ...
    visitPropertySpecification: function Microsoft_Crm_Workflow_SharedExpressionVisitor$visitPropertySpecification(propertySpecification) {
        if (null !== propertySpecification.propertyValueExpr) {
            propertySpecification.propertyValueExpr.accept(this);
        }
    },
    
    visitPrimitiveExpression: function Microsoft_Crm_Workflow_SharedExpressionVisitor$visitPrimitiveExpression(expression) {
        Microsoft.Crm.Workflow.Utils.SharedUtility.throwException(0);
    },
    
    visitEntityAttributeExpression: function Microsoft_Crm_Workflow_SharedExpressionVisitor$visitEntityAttributeExpression(expression) {
        Microsoft.Crm.Workflow.Utils.SharedUtility.throwException(0);
    },
    
    visitTimeSpanExpression: function Microsoft_Crm_Workflow_SharedExpressionVisitor$visitTimeSpanExpression(expression) {
        Microsoft.Crm.Workflow.Utils.SharedUtility.throwException(0);
    },
    ...
    visitEntitySpecification: function Microsoft_Crm_Workflow_SharedExpressionVisitor$visitEntitySpecification(entitySpecification) {
...
Microsoft.Crm.Workflow.ObjectModel.ArgumentDirection.registerEnum('Microsoft.Crm.Workflow.ObjectModel.ArgumentDirection', false);
...
Microsoft.Crm.Workflow.ObjectModel.NullObjectsFactory.buildStep = function Microsoft_Crm_Workflow_ObjectModel_NullObjectsFactory$buildStep(className) {
    ...
    switch (className) {
        ...
        case 'WaitBranchStep:#Microsoft.Crm.Workflow.ObjectModel':
            ...
            return new Microsoft.Crm.Workflow.ObjectModel.WaitBranchStep(waitBranchWaitStep, new Microsoft.Crm.Workflow.Expressions.NullExpression(dummy));
        ...
        case 'WaitTimeoutStep:#Microsoft.Crm.Workflow.ObjectModel':
            ...
            return new Microsoft.Crm.Workflow.ObjectModel.WaitTimeoutStep(waitBranchTimeoutStep, new Microsoft.Crm.Workflow.Expressions.NullExpression(dummy));
...
Microsoft.Crm.Workflow.ObjectModel.NullObjectsFactory.buildExpression = function Microsoft_Crm_Workflow_ObjectModel_NullObjectsFactory$buildExpression(className) {
    ...
    switch (className) {
        ...
        case 'BinaryExpression:#Microsoft.Crm.Workflow.Expressions':
            return new Microsoft.Crm.Workflow.Expressions.BinaryExpression(dummy, 6, new Microsoft.Crm.Workflow.Expressions.PrimitiveExpression(dummy, null, 14), []);
        case 'EntityAttributeExpression:#Microsoft.Crm.Workflow.Expressions':
            return new Microsoft.Crm.Workflow.Expressions.EntityAttributeExpression(new Microsoft.Crm.Workflow.Expressions.InvalidEntity(dummy, 'dummyParam'), 'name');
        ...
        case 'TimeSpanExpression:#Microsoft.Crm.Workflow.Expressions':
            return new Microsoft.Crm.Workflow.Expressions.TimeSpanExpression(dummy, new Microsoft.Crm.Workflow.CrmTimeSpan(0, 0, 0, 0, 0));
...
Microsoft.Crm.Workflow.ObjectModel.NullObjectsFactory.buildEntity = function Microsoft_Crm_Workflow_ObjectModel_NullObjectsFactory$buildEntity(className) {
    ...
    switch (className) {
        ...
        case 'RelatedEntityLinked:#Microsoft.Crm.Workflow.Expressions':
            return new Microsoft.Crm.Workflow.Expressions.RelatedEntityLinked(dummy, 'dummyProperty', 'dummyEntity', 'dummyRelationshipName');
        case 'EntityCreatedByStep:#Microsoft.Crm.Workflow.Expressions':
            return new Microsoft.Crm.Workflow.Expressions.EntityCreatedByStep(dummy, null, 'dummy', 'dummy', 'dummy', true);
        default:
            return null;
    }
}
...
Microsoft.Crm.Workflow.ObjectModel.AssignStep.prototype = {
    ...
    toJson: function Microsoft_Crm_Workflow_ObjectModel_AssignStep$toJson() {
        ...
        if (this.assignTo) {
            sb.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getObjectJson('assignTo', this.assignTo.toJson(), true));
        }
        if (this.entity) {
    ...
    initializeFromDynamic: function Microsoft_Crm_Workflow_ObjectModel_AssignStep$initializeFromDynamic(deserialized) {
        if (deserialized) {
            ...
            if (sourceObject.assignTo) {
                this.assignTo = Microsoft.Crm.Workflow.ObjectModel.NullObjectsFactory.buildExpression(sourceObject.assignTo.__class);
                this.assignTo.initializeFromDynamic(sourceObject.assignTo);
            }
            if (sourceObject.entity) {
                this.entity = Microsoft.Crm.Workflow.ObjectModel.NullObjectsFactory.buildEntity(sourceObject.entity.__class);
...
Microsoft.Crm.Workflow.ObjectModel.AssignVariableStep = function Microsoft_Crm_Workflow_ObjectModel_AssignVariableStep(workflowStep) {
...
Microsoft.Crm.Workflow.ObjectModel.AssignVariableStep.prototype = {
    ...
    get_direction: function Microsoft_Crm_Workflow_ObjectModel_AssignVariableStep$get_direction() {
        return this.direction;
    },
    
    set_direction: function Microsoft_Crm_Workflow_ObjectModel_AssignVariableStep$set_direction(value) {
        this.direction = value;
        return value;
    },
    
    get_readOnly: function Microsoft_Crm_Workflow_ObjectModel_AssignVariableStep$get_readOnly() {
        return this.readOnly;
    },
    
    set_readOnly: function Microsoft_Crm_Workflow_ObjectModel_AssignVariableStep$set_readOnly(value) {
        this.readOnly = value;
        return value;
    },
    ...
    get_dataType: function Microsoft_Crm_Workflow_ObjectModel_AssignVariableStep$get_dataType() {
        return this.dataType;
    },
    
    set_dataType: function Microsoft_Crm_Workflow_ObjectModel_AssignVariableStep$set_dataType(value) {
        this.dataType = value;
        return value;
    },
    ...
    toJson: function Microsoft_Crm_Workflow_ObjectModel_AssignVariableStep$toJson() {
        ...
        sb.append('{');
        sb.append(Microsoft.Crm.Workflow.ObjectModel.StepBase.prototype.toJson.call(this));
        sb.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getPropertyJson('variableName', this.variableName, true));
        sb.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getObjectJson('readOnly', Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getJson(this.readOnly), true));
        sb.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getObjectJson('direction', Microsoft.Crm.Workflow.Utils.StringUtility.toStringInvariant(this.direction), true));
        sb.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getObjectJson('dataType', this._getDataTypeJson$p$1(this.dataType), true));
        if (this.valueExpression) {
            sb.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getObjectJson('valueExpression', this.valueExpression.toJson(), true));
        }
        sb.append('}');
        return sb.toString();
    },
    
    initializeFromDynamic: function Microsoft_Crm_Workflow_ObjectModel_AssignVariableStep$initializeFromDynamic(deserialized) {
        if (deserialized) {
            Microsoft.Crm.Workflow.ObjectModel.StepBase.prototype.initializeFromDynamic.call(this, deserialized);
            var sourceObject = deserialized;
            ...
            if (sourceObject.readOnly) {
                this.readOnly = sourceObject.readOnly;
            }
            if (sourceObject.direction) {
                this.direction = (sourceObject.direction);
            }
            if (sourceObject.dataType) {
                this.dataType = (sourceObject.dataType);
            }
            if (sourceObject.valueExpression) {
                this.valueExpression = Microsoft.Crm.Workflow.ObjectModel.NullObjectsFactory.buildExpression(sourceObject.valueExpression.__class);
                this.valueExpression.initializeFromDynamic(sourceObject.valueExpression);
            }
        }
    },
    
    _getDataTypeJson$p$1: function Microsoft_Crm_Workflow_ObjectModel_AssignVariableStep$_getDataTypeJson$p$1(attributeType) {
        return Microsoft.Crm.Workflow.Utils.StringUtility.toStringInvariant(attributeType);
    }
}
...
Microsoft.Crm.Workflow.ObjectModel.ActionStep.prototype = {
    ...
    appendStep: function Microsoft_Crm_Workflow_ObjectModel_ActionStep$appendStep(newStep) {
        Microsoft.Crm.Workflow.Utils.ExceptionUtility.assert((Microsoft.Crm.Workflow.ObjectModel.AssignVariableStep.isInstanceOfType(newStep)) || (Microsoft.Crm.Workflow.ObjectModel.CustomJavascriptStep.isInstanceOfType(newStep)), 'Can only insert AssignVariableStep or CustomJavascriptStep');
    ...
    remove: function Microsoft_Crm_Workflow_ObjectModel_ActionStep$remove(stepBase) {
        Microsoft.Crm.Workflow.Utils.ExceptionUtility.assert((Microsoft.Crm.Workflow.ObjectModel.AssignVariableStep.isInstanceOfType(stepBase)) || (Microsoft.Crm.Workflow.ObjectModel.CustomJavascriptStep.isInstanceOfType(stepBase)), 'Can only insert AssignVariableStep or CustomJavascriptStep');
    ...
    toJson: function Microsoft_Crm_Workflow_ObjectModel_ActionStep$toJson() {
        ...
        sb.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getPropertyJson('actionType', Microsoft.Crm.Workflow.Utils.StringUtility.toStringInvariant(this.actionType), true));
        sb.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getPropertyJson('processId', this.processId.toString(), true));
        ...
        if (this.triggerEvents && this.triggerEvents.length > 0) {
            ...
            sbTriggerEvents.append('[' + Microsoft.Crm.Workflow.Utils.StringUtility.join(String, ',', jsonTriggers) + ']');
            sb.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getObjectJson('triggerEvents', sbTriggerEvents.toString(), true));
        }
        if (!Microsoft.Crm.Workflow.Utils.StringUtility.isNull(this.actionControl)) {
            sb.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getObjectJson('actionControl', this.actionControl.toJson(), true));
        }
        sb.append('}');
        return sb.toString();
    },
    ...
    initializeFromDynamic: function Microsoft_Crm_Workflow_ObjectModel_ActionStep$initializeFromDynamic(deserialized) {
        if (deserialized) {
            ...
            if (sourceObject.actionControl) {
                this.actionControl = Microsoft.Crm.Workflow.ObjectModel.NullObjectsFactory.buildStep(sourceObject.actionControl.__class);
...
Microsoft.Crm.Workflow.ObjectModel.ProcessTriggerData = function Microsoft_Crm_Workflow_ObjectModel_ProcessTriggerData() {
}
Microsoft.Crm.Workflow.ObjectModel.ProcessTriggerData.prototype = {
    
    get_Event: function Microsoft_Crm_Workflow_ObjectModel_ProcessTriggerData$get_Event() {
        return this.eventName;
    },
    
    set_Event: function Microsoft_Crm_Workflow_ObjectModel_ProcessTriggerData$set_Event(value) {
        this.eventName = value;
        return value;
    },
    
    get_FilterId: function Microsoft_Crm_Workflow_ObjectModel_ProcessTriggerData$get_FilterId() {
        return this.filterId;
    },
    
    set_FilterId: function Microsoft_Crm_Workflow_ObjectModel_ProcessTriggerData$set_FilterId(value) {
        this.filterId = value;
        return value;
    },
    
    get_PipelineStageId: function Microsoft_Crm_Workflow_ObjectModel_ProcessTriggerData$get_PipelineStageId() {
        return this.pipelineStageId;
    },
    
    set_PipelineStageId: function Microsoft_Crm_Workflow_ObjectModel_ProcessTriggerData$set_PipelineStageId(value) {
    ...
    toJson: function Microsoft_Crm_Workflow_ObjectModel_ProcessTriggerData$toJson() {
        var sb = new Sys.StringBuilder();
        sb.append('{');
        sb.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getPropertyJson('eventName', this.eventName, false));
        sb.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getPropertyJson('filterId', this.filterId, true));
        sb.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getPropertyJson('pipelineStageId', this.pipelineStageId, true));
        sb.append('}');
        return sb.toString();
    },
    
    initializeFromDynamic: function Microsoft_Crm_Workflow_ObjectModel_ProcessTriggerData$initializeFromDynamic(deserialized) {
        var sourceObject = deserialized;
        if (sourceObject) {
            this.eventName = sourceObject.eventName;
            this.pipelineStageId = sourceObject.pipelineStageId;
            this.filterId = sourceObject.filterId;
        }
    }
}
...
Microsoft.Crm.Workflow.ObjectModel.ControlStep.getControlStep = function Microsoft_Crm_Workflow_ObjectModel_ControlStep$getControlStep(stepBase) {
...
Microsoft.Crm.Workflow.ObjectModel.ControlStep.prototype = {
    ...
    _createDataSources$i$0: function Microsoft_Crm_Workflow_ObjectModel_ControlStep$_createDataSources$i$0(dataSources) {
    },
    ...
    toJson: function Microsoft_Crm_Workflow_ObjectModel_ControlStep$toJson() {
        ...
        sb.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getPropertyJson('dataFieldName', this.dataFieldName, true));
        sb.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getPropertyJson('systemStepType', this.systemStepType.toString(), true));
        sb.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getObjectJson('isSystemControl', Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getJson(this.isSystemControl), true));
        sb.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getPropertyJson('parameters', this.parameters, true));
        sb.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getPropertyJson('controlDisplayName', this.controlDisplayName, true));
        sb.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getObjectJson('isUnbound', Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getJson(this.isUnbound), true));
        sb.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getPropertyJson('controlType', Microsoft.Crm.Workflow.Utils.StringUtility.toStringInvariant(this.controlType), true));
...
Microsoft.Crm.Workflow.ObjectModel.EntityStep.prototype = {
    ...
    toJson: function Microsoft_Crm_Workflow_ObjectModel_EntityStep$toJson() {
        ...
        sb.append('{');
        sb.append(Microsoft.Crm.Workflow.ObjectModel.CompositeStepBase.prototype.toJson.call(this));
        sb.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getPropertyJson('relationshipName', this.relationshipName, true));
        sb.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getPropertyJson('attributeName', this.attributeName, true));
        sb.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getObjectJson('isClosedLoop', Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getJson(this.isClosedLoop), true));
        sb.append('}');
        return sb.toString();
    },
...
Microsoft.Crm.Workflow.ObjectModel.RelationshipCollectionStep = function Microsoft_Crm_Workflow_ObjectModel_RelationshipCollectionStep(workflowStep) {
...
Microsoft.Crm.Workflow.ObjectModel.RelationshipCollectionStep.prototype = {
    ...
    appendStep: function Microsoft_Crm_Workflow_ObjectModel_RelationshipCollectionStep$appendStep(newStep) {
        Microsoft.Crm.Workflow.Utils.ExceptionUtility.assert(Microsoft.Crm.Workflow.ObjectModel.RelationshipStep.isInstanceOfType(newStep), 'Cannot insert a non Relationship step');
        Microsoft.Crm.Workflow.ObjectModel.CompositeStepBase.prototype.appendStep.call(this, newStep);
    },
    
    remove: function Microsoft_Crm_Workflow_ObjectModel_RelationshipCollectionStep$remove(stepBase) {
        Microsoft.Crm.Workflow.Utils.ExceptionUtility.assert(Microsoft.Crm.Workflow.ObjectModel.RelationshipStep.isInstanceOfType(stepBase), 'Cannot remove a non Relationship step');
        Microsoft.Crm.Workflow.ObjectModel.CompositeStepBase.prototype.remove.call(this, stepBase);
    },
    ...
    _createDataSources$i$0: function Microsoft_Crm_Workflow_ObjectModel_RelationshipCollectionStep$_createDataSources$i$0(dataSources) {
    },
...
Microsoft.Crm.Workflow.ObjectModel.RelationshipStep = function Microsoft_Crm_Workflow_ObjectModel_RelationshipStep(workflowStep) {
...
Microsoft.Crm.Workflow.ObjectModel.RelationshipStep.prototype = {
    ...
    _createDataSources$i$0: function Microsoft_Crm_Workflow_ObjectModel_RelationshipStep$_createDataSources$i$0(dataSources) {
    },
    ...
    toJson: function Microsoft_Crm_Workflow_ObjectModel_RelationshipStep$toJson() {
        ...
        sb.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getPropertyJson('relationshipName', this.relationshipName, true));
        sb.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getPropertyJson('attributeName', this.attributeName, true));
        sb.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getPropertyJson('sourceStageId', this.sourceStageId, true));
        sb.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getPropertyJson('targetStageId', this.targetStageId, true));
        sb.append('}');
        return sb.toString();
    },
    
    initializeFromDynamic: function Microsoft_Crm_Workflow_ObjectModel_RelationshipStep$initializeFromDynamic(deserialized) {
        if (deserialized) {
            Microsoft.Crm.Workflow.ObjectModel.StepBase.prototype.initializeFromDynamic.call(this, deserialized);
            var sourceObject = deserialized;
            this.relationshipName = sourceObject.relationshipName;
...
Microsoft.Crm.Workflow.ObjectModel.StepStep.prototype = {
    ...
    appendStep: function Microsoft_Crm_Workflow_ObjectModel_StepStep$appendStep(newStep) {
        Microsoft.Crm.Workflow.Utils.ExceptionUtility.assert(Microsoft.Crm.Workflow.ObjectModel.ControlStep.isInstanceOfType(newStep) || Microsoft.Crm.Workflow.ObjectModel.ActionStep.isInstanceOfType(newStep), 'Cannot insert a non Control/action Step');
        Microsoft.Crm.Workflow.ObjectModel.CompositeStepBase.prototype.appendStep.call(this, newStep);
    },
    
    remove: function Microsoft_Crm_Workflow_ObjectModel_StepStep$remove(stepBase) {
        Microsoft.Crm.Workflow.Utils.ExceptionUtility.assert(Microsoft.Crm.Workflow.ObjectModel.ControlStep.isInstanceOfType(stepBase) || Microsoft.Crm.Workflow.ObjectModel.ActionStep.isInstanceOfType(stepBase), 'Cannot remove a non Control/Action Step');
        Microsoft.Crm.Workflow.ObjectModel.CompositeStepBase.prototype.remove.call(this, stepBase);
    },
    ...
    toJson: function Microsoft_Crm_Workflow_ObjectModel_StepStep$toJson() {
        ...
        sb.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getObjectJson('isProcessRequired', Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getJson(this.isProcessRequired), true));
        sb.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getObjectJson('isHidden', Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getJson(this.isHidden), true));
        sb.append('}');
        return sb.toString();
    },
...
Microsoft.Crm.Workflow.ObjectModel.ChildWorkflowStep = function Microsoft_Crm_Workflow_ObjectModel_ChildWorkflowStep(workflowStep) {
...
Microsoft.Crm.Workflow.ObjectModel.ChildWorkflowStep.prototype = {
    ...
    toJson: function Microsoft_Crm_Workflow_ObjectModel_ChildWorkflowStep$toJson() {
        ...
        if (this.childWorkflow) {
            sb.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getObjectJson('childWorkflow', this.childWorkflow.toJson(), true));
        }
        if (this.entity) {
            sb.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getObjectJson('entity', this.entity.toJson(), true));
        }
    ...
    initializeFromDynamic: function Microsoft_Crm_Workflow_ObjectModel_ChildWorkflowStep$initializeFromDynamic(deserialized) {
        if (deserialized) {
            Microsoft.Crm.Workflow.ObjectModel.StepBase.prototype.initializeFromDynamic.call(this, deserialized);
            var sourceObject = deserialized;
            if (sourceObject.childWorkflow) {
                this.childWorkflow = Microsoft.Crm.Workflow.ObjectModel.NullObjectsFactory.buildExpression(sourceObject.childWorkflow.__class);
...
Microsoft.Crm.Workflow.ObjectModel.ConditionBranchStep.prototype = {
    ...
    toJson: function Microsoft_Crm_Workflow_ObjectModel_ConditionBranchStep$toJson() {
        ...
        sb.append(Microsoft.Crm.Workflow.ObjectModel.CompositeStepBase.prototype.toJson.call(this));
        if (this.conditionExpression) {
            sb.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getObjectJson('conditionExpression', this.conditionExpression.toJson(), true));
        }
        sb.append('}');
        return sb.toString();
    },
    ...
    initializeFromDynamic: function Microsoft_Crm_Workflow_ObjectModel_ConditionBranchStep$initializeFromDynamic(deserialized) {
        if (deserialized) {
            ...
            if (sourceObject.conditionExpression) {
                this.conditionExpression = Microsoft.Crm.Workflow.ObjectModel.NullObjectsFactory.buildExpression(sourceObject.conditionExpression.__class);
...
Microsoft.Crm.Workflow.ObjectModel.ConditionStep.prototype = {
    ...
    findElseBranch: function Microsoft_Crm_Workflow_ObjectModel_ConditionStep$findElseBranch() {
        var elseBranch = null;
        Sys.Debug.assert(this.steps.get_Count() > 0, 'Expected ConditionStep.Steps to contain at least 1 ConditionBranchStep.');
        var stepBase = this.steps.get_item(this.steps.get_Count() - 1);
        Sys.Debug.assert(Microsoft.Crm.Workflow.ObjectModel.ConditionBranchStep.isInstanceOfType(stepBase), 'Expected last child to be of type ConditionBranchStep.');
    ...
    toJson: function Microsoft_Crm_Workflow_ObjectModel_ConditionStep$toJson() {
        ...
        sb.append('{');
        sb.append(Microsoft.Crm.Workflow.ObjectModel.CompositeStepBase.prototype.toJson.call(this));
        sb.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getObjectJson('containsElsebranch', Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getJson(this.containsElsebranch), true));
        sb.append('}');
        return sb.toString();
    },
...
Microsoft.Crm.Workflow.ObjectModel.CreateStep.prototype = {
    ...
    set_entity: function Microsoft_Crm_Workflow_ObjectModel_CreateStep$set_entity(value) {
        Microsoft.Crm.Workflow.Utils.ExceptionUtility.assert(!!value, 'Entity specification value cannot be set to null');
        this.entity = value;
        return value;
    },
    ...
    toJson: function Microsoft_Crm_Workflow_ObjectModel_CreateStep$toJson() {
        ...
        if (this.output) {
            sb.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getObjectJson('output', this.output.toJson(), true));
        }
        sb.append('}');
        return sb.toString();
    },
...
Microsoft.Crm.Workflow.ObjectModel.CustomActivityInfo = function Microsoft_Crm_Workflow_ObjectModel_CustomActivityInfo() {
    Microsoft.Crm.Workflow.ObjectModel.CustomActivityInfo.initializeBase(this);
}


Microsoft.Crm.Workflow.ObjectModel.CustomActivityInfoBase = function Microsoft_Crm_Workflow_ObjectModel_CustomActivityInfoBase() {
}
Microsoft.Crm.Workflow.ObjectModel.CustomActivityInfoBase.prototype = {
    ...
    toJson: function Microsoft_Crm_Workflow_ObjectModel_CustomActivityInfoBase$toJson() {
        ...
        sb.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getPropertyJson('pluginTypeId', this.pluginTypeId, true));
        sb.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getPropertyJson('assemblyName', this.assemblyName, true));
        sb.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getPropertyJson('publicKeyToken', this.publicKeyToken, true));
        sb.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getPropertyJson('culture', this.culture, true));
        sb.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getPropertyJson('assemblyVersion', this.assemblyVersion, true));
        sb.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getObjectJson('isNet4', Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getJson(this.get_isNet4()), true));
        sb.append('}');
        return sb.toString();
    },
    
    initializeFromDynamic: function Microsoft_Crm_Workflow_ObjectModel_CustomActivityInfoBase$initializeFromDynamic(deserialized) {
        if (deserialized) {
            var sourceObject = deserialized;
...
Microsoft.Crm.Workflow.ObjectModel.CustomActivityParameterInfo = function Microsoft_Crm_Workflow_ObjectModel_CustomActivityParameterInfo() {
    Microsoft.Crm.Workflow.ObjectModel.CustomActivityParameterInfo.initializeBase(this);
}


Microsoft.Crm.Workflow.ObjectModel.CustomParameterInfoBase = function Microsoft_Crm_Workflow_ObjectModel_CustomParameterInfoBase() {
}
Microsoft.Crm.Workflow.ObjectModel.CustomParameterInfoBase.prototype = {
    ...
    set_isInOutArgument: function Microsoft_Crm_Workflow_ObjectModel_CustomParameterInfoBase$set_isInOutArgument(value) {
        this.isInOutArgument = value;
        return value;
    },
    
    get_workflowAttributeType: function Microsoft_Crm_Workflow_ObjectModel_CustomParameterInfoBase$get_workflowAttributeType() {
        return this.workflowAttributeType;
    },
    
    set_workflowAttributeType: function Microsoft_Crm_Workflow_ObjectModel_CustomParameterInfoBase$set_workflowAttributeType(value) {
    ...
    get_dependencyPropertyName: function Microsoft_Crm_Workflow_ObjectModel_CustomParameterInfoBase$get_dependencyPropertyName() {
        return this.dependencyProperty;
    },
    
    set_dependencyPropertyName: function Microsoft_Crm_Workflow_ObjectModel_CustomParameterInfoBase$set_dependencyPropertyName(value) {
    ...
    toJson: function Microsoft_Crm_Workflow_ObjectModel_CustomParameterInfoBase$toJson() {
        var sb = new Sys.StringBuilder();
        sb.append('{');
        sb.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getObjectJson('required', Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getJson(this.required), false));
        sb.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getPropertyJson('name', this.name, true));
        sb.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getPropertyJson('typeName', this.typeName, true));
        sb.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getPropertyJson('attributeName', this.attributeName, true));
        sb.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getPropertyJson('dependencyProperty', this.dependencyProperty, true));
        sb.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getPropertyJson('workflowAttributeType', Microsoft.Crm.Workflow.Utils.StringUtility.toStringInvariant(this.workflowAttributeType), true));
        sb.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getObjectJson('isInOutArgument', Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getJson(this.isInOutArgument), true));
        sb.append('}');
        return sb.toString();
    },
    
    initializeFromDynamic: function Microsoft_Crm_Workflow_ObjectModel_CustomParameterInfoBase$initializeFromDynamic(deserialized) {
        if (deserialized) {
            var sourceObject = deserialized;
...
Microsoft.Crm.Workflow.ObjectModel.CustomActivityStep = function Microsoft_Crm_Workflow_ObjectModel_CustomActivityStep(workflowStep) {
...
Microsoft.Crm.Workflow.ObjectModel.CustomStepBase = function Microsoft_Crm_Workflow_ObjectModel_CustomStepBase(workflowStep) {
...
Microsoft.Crm.Workflow.ObjectModel.CustomStepBase.prototype = {
    ...
    toJson: function Microsoft_Crm_Workflow_ObjectModel_CustomStepBase$toJson() {
        ...
        if (this.activityInfo) {
            sb.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getObjectJson('activityInfo', (this.activityInfo).toJson(), true));
        }
        sb.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getObjectJson('hasOutputs', Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getJson(this.hasOutputs), true));
        sb.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getObjectJson('isInvalid', Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getJson(this.isInvalid), true));
        sb.append(',');
        sb.append('\"outputs\":');
        var $$t_3 = this, $$t_4 = this;
        sb.append(Microsoft.Crm.Workflow.Utils.DictionaryUtility.toJson(String, Microsoft.Crm.Workflow.ObjectModel.CustomParameterInfoBase, this.outputs, function(property) {
    ...
    initializeFromDynamic: function Microsoft_Crm_Workflow_ObjectModel_CustomStepBase$initializeFromDynamic(deserialized) {
        if (deserialized) {
            Microsoft.Crm.Workflow.ObjectModel.StepBase.prototype.initializeFromDynamic.call(this, deserialized);
            var sourceObject = deserialized;
            ...
            if (sourceObject.outputs) {
                ...
                this.outputs = Microsoft.Crm.Workflow.Utils.DictionaryUtility.fromJson(String, Microsoft.Crm.Workflow.ObjectModel.CustomActivityParameterInfo, sourceObject.outputs, function(property) {
                    return property;
...
Microsoft.Crm.Workflow.ObjectModel.DataValue = function Microsoft_Crm_Workflow_ObjectModel_DataValue(source, key, referenceData) {
...
Microsoft.Crm.Workflow.ObjectModel.DataValue.prototype = {
    ...
    getDisplayName: function Microsoft_Crm_Workflow_ObjectModel_DataValue$getDisplayName(cultureInfo) {
        Microsoft.Crm.Workflow.Utils.ExceptionUtility.assert(!!this._source$p$0, 'Source should be non null in GetDisplayName');
...
Microsoft.Crm.Workflow.ObjectModel.DynamicAttributesInProcess.$$cctor = function Microsoft_Crm_Workflow_ObjectModel_DynamicAttributesInProcess$$$cctor() {
    Microsoft.Crm.Workflow.ObjectModel.DynamicAttributesInProcess._dynamicAttributes$p['!Process_Custom_Attribute_URL_'] = 'Dialog.CustomAttribute.URL.DisplayName';
    Microsoft.Crm.Workflow.ObjectModel.DynamicAttributesInProcess._dynamicAttributes$p['!Process_Custom_Attribute_PostURL_'] = 'ActivityFeeds.CustomAttribute.PostURL.DisplayName';
}
...
Microsoft.Crm.Workflow.ObjectModel.DynamicAttributesInProcess.get_keys = function Microsoft_Crm_Workflow_ObjectModel_DynamicAttributesInProcess$get_keys() {
    return _Dictionary.keys(Microsoft.Crm.Workflow.ObjectModel.DynamicAttributesInProcess._dynamicAttributes$p);
}


Microsoft.Crm.Workflow.ObjectModel.EntityDataSource = function Microsoft_Crm_Workflow_ObjectModel_EntityDataSource(entitySource, isRestrictiveAttributeListDefined, restrictiveAttributeList) {
...
Microsoft.Crm.Workflow.ObjectModel.EntityDataSource.prototype = {
    ...
    getLocalizedNameForDataValue: function Microsoft_Crm_Workflow_ObjectModel_EntityDataSource$getLocalizedNameForDataValue(value, cultureInfo) {
        Microsoft.Crm.Workflow.Utils.ExceptionUtility.assert(value._source$p$0 === this, 'Data value does not belong to this data source');
        ...
        if (Microsoft.Crm.Workflow.ObjectModel.DynamicAttributesInProcess.containsKey(attributeName)) {
            return this._entitySource$0._workflow$p$0._metadataProvider$p$2.getResourceString(Microsoft.Crm.Workflow.ObjectModel.DynamicAttributesInProcess.getAttribute(attributeName));
        }
        return this._entitySource$0._workflow$p$0._metadataProvider$p$2.getAttributeLocalizedName(cultureInfo, this._entitySource$0.entityName, attributeName);
    },
    ...
    getDataValues: function Microsoft_Crm_Workflow_ObjectModel_EntityDataSource$getDataValues(valueType) {
        try {
            if (!Microsoft.Crm.Workflow.Utils.StringUtility.isNullOrEmpty(this._entitySource$0.entityName)) {
                var attributes = this._entitySource$0._workflow$p$0._metadataProvider$p$2.getAttributesByType(this._entitySource$0.entityName, valueType);
    ...
    getLookupDataValues: function Microsoft_Crm_Workflow_ObjectModel_EntityDataSource$getLookupDataValues(objectTypeCode) {
        try {
            if (!Microsoft.Crm.Workflow.Utils.StringUtility.isNullOrEmpty(this._entitySource$0.entityName)) {
                var attributes = this._entitySource$0._workflow$p$0._metadataProvider$p$2.getLookupAttributes(this._entitySource$0.entityName, objectTypeCode);
    ...
    _prunedAttributeList$p$0: function Microsoft_Crm_Workflow_ObjectModel_EntityDataSource$_prunedAttributeList$p$0(attributes) {
    ...
    _createDataValuesFromAttributes$p$0: function Microsoft_Crm_Workflow_ObjectModel_EntityDataSource$_createDataValuesFromAttributes$p$0(attributes) {
        ...
        for (var $$arr_2 = attributes, $$len_3 = $$arr_2.length, $$idx_4 = 0; $$idx_4 < $$len_3; ++$$idx_4) {
            ...
            values.add(new Microsoft.Crm.Workflow.ObjectModel.DataValue(this, this._entitySource$0.get_uiXmlName() + '.' + attribute, referenceData));
        }
        return values;
    },
    
    _addDynamicAttributesInDataValueCollection$p$0: function Microsoft_Crm_Workflow_ObjectModel_EntityDataSource$_addDynamicAttributesInDataValueCollection$p$0(valueType, valueCollection) {
        if (14 === valueType) {
            for (var $$arr_2 = Microsoft.Crm.Workflow.ObjectModel.DynamicAttributesInProcess.get_keys(), $$len_3 = $$arr_2.length, $$idx_4 = 0; $$idx_4 < $$len_3; ++$$idx_4) {
                var attribute = $$arr_2[$$idx_4];
                valueCollection.add(new Microsoft.Crm.Workflow.ObjectModel.DataValue(this, this._entitySource$0.get_uiXmlName() + '.' + attribute, ''));
            }
        }
...
Microsoft.Crm.Workflow.ObjectModel.ChildInteractiveWorkflowStep = function Microsoft_Crm_Workflow_ObjectModel_ChildInteractiveWorkflowStep(workflowStep) {
...
Microsoft.Crm.Workflow.ObjectModel.ChildInteractiveWorkflowStep._jsonForKeyValuePair$p = function Microsoft_Crm_Workflow_ObjectModel_ChildInteractiveWorkflowStep$_jsonForKeyValuePair$p(key, value) {
    var sb = new Sys.StringBuilder();
    sb.append('{');
...
Microsoft.Crm.Workflow.ObjectModel.ChildInteractiveWorkflowStep._joinString$p = function Microsoft_Crm_Workflow_ObjectModel_ChildInteractiveWorkflowStep$_joinString$p(connector, items) {
    var sb = new Sys.StringBuilder();
    if (!items.length) {
        return sb.toString();
    }
...
Microsoft.Crm.Workflow.ObjectModel.ChildInteractiveWorkflowStep.prototype = {
    ...
    set_childWorkflow: function Microsoft_Crm_Workflow_ObjectModel_ChildInteractiveWorkflowStep$set_childWorkflow(value) {
        this.childWorkflow = value;
        return value;
    },
    ...
    toJson: function Microsoft_Crm_Workflow_ObjectModel_ChildInteractiveWorkflowStep$toJson() {
        ...
        if (this.inputs) {
            var inputsJsonList = new (Microsoft.Crm.Client.Core.Framework.List$1.$$(String))();
            for (var $$arr_2 = this.inputs.get_keys(), $$len_3 = $$arr_2.length, $$idx_4 = 0; $$idx_4 < $$len_3; ++$$idx_4) {
                var key = $$arr_2[$$idx_4];
                inputsJsonList.add(Microsoft.Crm.Workflow.ObjectModel.ChildInteractiveWorkflowStep._jsonForKeyValuePair$p(key.toJson(), this.inputs.get_item(key).toJson()));
            }
            var inputsJsonString = '[' + Microsoft.Crm.Workflow.ObjectModel.ChildInteractiveWorkflowStep._joinString$p(',', inputsJsonList.toArray()) + ']';
            sb.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getObjectJson('inputsSerialized', inputsJsonString, true));
        }
        sb.append('}');
        return sb.toString();
    },
    
    initializeFromDynamic: function Microsoft_Crm_Workflow_ObjectModel_ChildInteractiveWorkflowStep$initializeFromDynamic(deserialized) {
        if (!deserialized) {
            return;
        }
        Microsoft.Crm.Workflow.ObjectModel.StepBase.prototype.initializeFromDynamic.call(this, deserialized);
        ...
        if (stepDeserialized.entity) {
            this.entity = Microsoft.Crm.Workflow.ObjectModel.NullObjectsFactory.buildEntity(stepDeserialized.entity.__class);
            this.entity.initializeFromDynamic(stepDeserialized.entity);
        }
        if (stepDeserialized.childWorkflow) {
            this.childWorkflow = Microsoft.Crm.Workflow.ObjectModel.NullObjectsFactory.buildExpression(stepDeserialized.childWorkflow.__class);
        ...
        if (stepDeserialized._inputsSerialized$p$1) {
            for (var i = 0; i < stepDeserialized._inputsSerialized$p$1.length; i++) {
                ...
                var value = Microsoft.Crm.Workflow.ObjectModel.NullObjectsFactory.buildExpression(valueDynamic['__class']);
...
Microsoft.Crm.Workflow.ObjectModel.InteractionPageStep = function Microsoft_Crm_Workflow_ObjectModel_InteractionPageStep(workflowStep) {
...
Microsoft.Crm.Workflow.ObjectModel.InteractionPageStep.prototype = {
    ...
    toJson: function Microsoft_Crm_Workflow_ObjectModel_InteractionPageStep$toJson() {
        ...
        sb.append('{');
        sb.append(Microsoft.Crm.Workflow.ObjectModel.CompositeStepBase.prototype.toJson.call(this));
        sb.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getObjectJson('allowBack', Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getJson(this._allowBack$p$2), true));
        sb.append('}');
        return sb.toString();
    },
    
    initializeFromDynamic: function Microsoft_Crm_Workflow_ObjectModel_InteractionPageStep$initializeFromDynamic(deserialized) {
        if (deserialized) {
            var sourceObject = deserialized;
            Microsoft.Crm.Workflow.ObjectModel.CompositeStepBase.prototype.initializeFromDynamic.call(this, sourceObject);
...
Microsoft.Crm.Workflow.ObjectModel.InteractionStep = function Microsoft_Crm_Workflow_ObjectModel_InteractionStep(workflowStep) {
...
Microsoft.Crm.Workflow.ObjectModel.InteractionStep.prototype = {
    ...
    get_isResponseMetadataBound: function Microsoft_Crm_Workflow_ObjectModel_InteractionStep$get_isResponseMetadataBound() {
        return this.isResponseMetadataBound;
    },
    
    set_isResponseMetadataBound: function Microsoft_Crm_Workflow_ObjectModel_InteractionStep$set_isResponseMetadataBound(value) {
    ...
    set_staticResponseValues: function Microsoft_Crm_Workflow_ObjectModel_InteractionStep$set_staticResponseValues(value) {
    ...
    set_defaultResponseValue: function Microsoft_Crm_Workflow_ObjectModel_InteractionStep$set_defaultResponseValue(value) {
    ...
    toJson: function Microsoft_Crm_Workflow_ObjectModel_InteractionStep$toJson() {
        ...
        sb.append(Microsoft.Crm.Workflow.ObjectModel.StepBase.prototype.toJson.call(this));
        if (this.promptText) {
            sb.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getObjectJson('promptText', this.promptText.toJson(), true));
        }
        if (this.hintText) {
            sb.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getObjectJson('hintText', this.hintText.toJson(), true));
        }
        sb.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getObjectJson('logResponse', Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getJson(this.logResponse), true));
        sb.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getPropertyJson('responseContainerType', Microsoft.Crm.Workflow.Utils.StringUtility.toStringInvariant(this.responseContainerType), true));
        sb.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getPropertyJson('responseMetadataType', Microsoft.Crm.Workflow.Utils.StringUtility.toStringInvariant(this.responseMetadataType), true));
        sb.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getPropertyJson('staticResponseValues', this.staticResponseValues, true));
        if (this.defaultResponseValue) {
            sb.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getObjectJson('defaultResponseValue', this.defaultResponseValue.toJson(), true));
        }
        sb.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getPropertyJson('attributeList', this.attributeList, true));
        sb.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getPropertyJson('queryVariableName', this.queryVariableName, true));
        sb.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getPropertyJson('queryEntityName', this.queryEntityName, true));
        sb.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getPropertyJson('attributeDelimiter', this.attributeDelimiter, true));
        sb.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getObjectJson('isResponseMetadataBound', Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getJson(this.isResponseMetadataBound), true));
        sb.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getPropertyJson('InteractionResponsePostfix', '_interactionResponseValue', true));
        sb.append('}');
        return sb.toString();
    },
    
    initializeFromDynamic: function Microsoft_Crm_Workflow_ObjectModel_InteractionStep$initializeFromDynamic(deserialized) {
        if (deserialized) {
            Microsoft.Crm.Workflow.ObjectModel.StepBase.prototype.initializeFromDynamic.call(this, deserialized);
            var sourceObject = deserialized;
            if (sourceObject.promptText) {
                this.promptText = Microsoft.Crm.Workflow.ObjectModel.NullObjectsFactory.buildExpression(sourceObject.promptText.__class);
                this.promptText.initializeFromDynamic(sourceObject.promptText);
            }
            if (sourceObject.hintText) {
                this.hintText = Microsoft.Crm.Workflow.ObjectModel.NullObjectsFactory.buildExpression(sourceObject.hintText.__class);
            ...
            this.staticResponseValues = Microsoft.Crm.Workflow.Utils.StringUtility.reduceToCanonicalForm(sourceObject.staticResponseValues);
            if (sourceObject.defaultResponseValue) {
                this.defaultResponseValue = Microsoft.Crm.Workflow.ObjectModel.NullObjectsFactory.buildExpression(sourceObject.defaultResponseValue.__class);
                this.defaultResponseValue.initializeFromDynamic(sourceObject.defaultResponseValue);
            }
            this.attributeList = Microsoft.Crm.Workflow.Utils.StringUtility.reduceToCanonicalForm(sourceObject.attributeList);
            this.queryVariableName = Microsoft.Crm.Workflow.Utils.StringUtility.reduceToCanonicalForm(sourceObject.queryVariableName);
            this.queryEntityName = Microsoft.Crm.Workflow.Utils.StringUtility.reduceToCanonicalForm(sourceObject.queryEntityName);
            this.attributeDelimiter = Microsoft.Crm.Workflow.Utils.StringUtility.reduceToCanonicalForm(sourceObject.attributeDelimiter);
...
Microsoft.Crm.Workflow.ObjectModel.InteractiveWorkflowInputDictionary = function Microsoft_Crm_Workflow_ObjectModel_InteractiveWorkflowInputDictionary() {
...
Microsoft.Crm.Workflow.ObjectModel.InteractiveWorkflowInputDictionary.prototype = {
    ...
    get_keys: function Microsoft_Crm_Workflow_ObjectModel_InteractiveWorkflowInputDictionary$get_keys() {
        var keys = new (Microsoft.Crm.Client.Core.Framework.List$1.$$(Microsoft.Crm.Workflow.ObjectModel.CustomActivityParameterInfo))();
...
Microsoft.Crm.Workflow.ObjectModel.InteractiveWorkflowInputDictionary._wrapper = function Microsoft_Crm_Workflow_ObjectModel_InteractiveWorkflowInputDictionary__wrapper() {
}
Microsoft.Crm.Workflow.ObjectModel.InteractiveWorkflowInputDictionary._wrapper.prototype = {
    ...
    set_value: function Microsoft_Crm_Workflow_ObjectModel_InteractiveWorkflowInputDictionary__wrapper$set_value(value) {
...
Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getPropertyJson = function Microsoft_Crm_Workflow_ObjectModel_JsonBuilder$getPropertyJson(propertyName, propertyValue, prependComma) {
    ...
    return ((prependComma) ? ',' : '') + Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getQuotedString(propertyName) + ':' + value;
}
Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getQuotedString = function Microsoft_Crm_Workflow_ObjectModel_JsonBuilder$getQuotedString(propertyName) {
    return '\"' + propertyName + '\"';
}
Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getObjectJson = function Microsoft_Crm_Workflow_ObjectModel_JsonBuilder$getObjectJson(propertyName, propertyValueJson, prependComma) {
    return ((prependComma) ? ',' : '') + Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getQuotedString(propertyName) + ':' + propertyValueJson;
}
Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getListJson = function Microsoft_Crm_Workflow_ObjectModel_JsonBuilder$getListJson(json) {
    return '{\"list\":[' + json + ']}';
}
...
Microsoft.Crm.Workflow.ObjectModel._publicationParametersFactory = function Microsoft_Crm_Workflow_ObjectModel__publicationParametersFactory() {
}
Microsoft.Crm.Workflow.ObjectModel._publicationParametersFactory._create$i = function Microsoft_Crm_Workflow_ObjectModel__publicationParametersFactory$_create$i(workflowCategory, workflowMode) {
...
Microsoft.Crm.Workflow.ObjectModel.WorkflowPublicationParameters.prototype = {
    ...
    containsUpdateTriggerCondition: function Microsoft_Crm_Workflow_ObjectModel_WorkflowPublicationParameters$containsUpdateTriggerCondition() {
        ...
        else if (Microsoft.Crm.Workflow.Utils.StringUtility.areEqual(this._updateAttributeList$p$0, 'statecode') || Microsoft.Crm.Workflow.Utils.StringUtility.areEqual(this._updateAttributeList$p$0, 'ownerid') || Microsoft.Crm.Workflow.Utils.StringUtility.areEqual(this._updateAttributeList$p$0, 'statecode;ownerid') || Microsoft.Crm.Workflow.Utils.StringUtility.areEqual(this._updateAttributeList$p$0, 'ownerid;statecode')) {
            returnValue = false;
        }
        else {
            returnValue = true;
...
Microsoft.Crm.Workflow.ObjectModel.CustomJavascriptStep.prototype = {
    ...
    initializeFromDynamic: function Microsoft_Crm_Workflow_ObjectModel_CustomJavascriptStep$initializeFromDynamic(deserialized) {
        if (deserialized) {
            Microsoft.Crm.Workflow.ObjectModel.StepBase.prototype.initializeFromDynamic.call(this, deserialized);
            var sourceObject = deserialized;
...
Microsoft.Crm.Workflow.ObjectModel.SetAttributeValueStep.prototype = {
    ...
    toJson: function Microsoft_Crm_Workflow_ObjectModel_SetAttributeValueStep$toJson() {
        ...
        if (this.specification) {
            sb.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getObjectJson('specification', this.specification.toJson(), true));
        }
        sb.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getObjectJson('entity', this.entity.toJson(), true));
        sb.append('}');
        return sb.toString();
...
Microsoft.Crm.Workflow.ObjectModel.SetDefaultValueStep = function Microsoft_Crm_Workflow_ObjectModel_SetDefaultValueStep(workflowStep, propSpec) {
...
Microsoft.Crm.Workflow.ObjectModel.SetDefaultValueStep.prototype = {
    ...
    initializeFromDynamic: function Microsoft_Crm_Workflow_ObjectModel_SetDefaultValueStep$initializeFromDynamic(deserialized) {
        if (deserialized) {
            Microsoft.Crm.Workflow.ObjectModel.StepBase.prototype.initializeFromDynamic.call(this, deserialized);
            var sourceObject = deserialized;
            this.entity = Microsoft.Crm.Workflow.ObjectModel.NullObjectsFactory.buildEntity(sourceObject.entity.__class);
...
Microsoft.Crm.Workflow.ObjectModel.SetDisplayModeStep.prototype = {
    ...
    toJson: function Microsoft_Crm_Workflow_ObjectModel_SetDisplayModeStep$toJson() {
        ...
        sb.append(Microsoft.Crm.Workflow.ObjectModel.StepBase.prototype.toJson.call(this));
        sb.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getPropertyJson('controlId', this.controlId, true));
        sb.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getPropertyJson('controlType', this.controlType, true));
        sb.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getObjectJson('isReadOnly', Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getJson(this.isReadOnly), true));
        if (this.entity) {
            sb.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getObjectJson('entity', this.entity.toJson(), true));
        }
        sb.append('}');
...
Microsoft.Crm.Workflow.ObjectModel.SetVisibilityStep.prototype = {
    ...
    toJson: function Microsoft_Crm_Workflow_ObjectModel_SetVisibilityStep$toJson() {
        ...
        sb.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getPropertyJson('controlId', this.controlId, true));
        sb.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getPropertyJson('controlType', this.controlType, true));
        sb.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getObjectJson('isVisible', Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getJson(this.isVisible), true));
        if (this.entity) {
            sb.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getObjectJson('entity', this.entity.toJson(), true));
        }
        sb.append('}');
...
Microsoft.Crm.Workflow.ObjectModel.SetMessageStep.prototype = {
    ...
    toJson: function Microsoft_Crm_Workflow_ObjectModel_SetMessageStep$toJson() {
        ...
        sb.append('{');
        sb.append(Microsoft.Crm.Workflow.ObjectModel.StepBase.prototype.toJson.call(this));
        sb.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getObjectJson('actionSteps', this.actionSteps.toJson(), true));
        sb.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getPropertyJson('controlId', this.controlId, true));
        if (this.entity) {
            sb.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getObjectJson('entity', this.entity.toJson(), true));
        }
...
Microsoft.Crm.Workflow.ObjectModel.SetNextStageStep = function Microsoft_Crm_Workflow_ObjectModel_SetNextStageStep(workflowStep) {
...
Microsoft.Crm.Workflow.ObjectModel.SetNextStageStep.prototype = {
    ...
    toJson: function Microsoft_Crm_Workflow_ObjectModel_SetNextStageStep$toJson() {
        ...
        sb.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getPropertyJson('parentStageId', this.parentStageId, true));
        sb.append('}');
        return sb.toString();
    },
    
    initializeFromDynamic: function Microsoft_Crm_Workflow_ObjectModel_SetNextStageStep$initializeFromDynamic(deserialized) {
        if (deserialized) {
            Microsoft.Crm.Workflow.ObjectModel.StepBase.prototype.initializeFromDynamic.call(this, deserialized);
            var sourceObject = deserialized;
...
Microsoft.Crm.Workflow.ObjectModel.SetFieldRequiredLevelStep.prototype = {
    ...
    toJson: function Microsoft_Crm_Workflow_ObjectModel_SetFieldRequiredLevelStep$toJson() {
        ...
        sb.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getPropertyJson('controlId', this.controlId, true));
        sb.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getPropertyJson('controlType', this.controlType, true));
        sb.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getPropertyJson('requiredLevel', Microsoft.Crm.Workflow.Utils.StringUtility.toStringInvariant(this.requiredLevel), true));
        sb.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getObjectJson('entity', this.entity.toJson(), true));
        sb.append('}');
        return sb.toString();
    },
...
Microsoft.Crm.Workflow.ObjectModel.QueryStep.prototype = {
    ...
    toJson: function Microsoft_Crm_Workflow_ObjectModel_QueryStep$toJson() {
        ...
        if (this.fetchExpression) {
            sb.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getObjectJson('fetchExpression', this.fetchExpression.toJson(), true));
        }
        sb.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getPropertyJson('fetchCount', this.fetchCount + '', true));
        sb.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getPropertyJson('attributeList', this.attributeList, true));
        sb.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getPropertyJson('entityName', this.entityName, true));
        sb.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getPropertyJson('originalFetchXml', this.originalFetchXml, true));
        sb.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getPropertyJson('originalLayoutXml', this.originalLayoutXml, true));
        sb.append('}');
        return sb.toString();
    },
    ...
    initializeFromDynamic: function Microsoft_Crm_Workflow_ObjectModel_QueryStep$initializeFromDynamic(deserialized) {
        if (deserialized) {
            ...
            if (sourceObject.fetchExpression) {
                this.fetchExpression = Microsoft.Crm.Workflow.ObjectModel.NullObjectsFactory.buildExpression(sourceObject.fetchExpression.__class);
...
Microsoft.Crm.Workflow.ObjectModel.RollupRuleStep = function Microsoft_Crm_Workflow_ObjectModel_RollupRuleStep(workflowStep) {
...
Microsoft.Crm.Workflow.ObjectModel.RollupRuleStep.prototype = {
    ...
    get_hierarchicalRelationshipName: function Microsoft_Crm_Workflow_ObjectModel_RollupRuleStep$get_hierarchicalRelationshipName() {
        return this.hierarchicalRelationshipName;
    },
    
    set_hierarchicalRelationshipName: function Microsoft_Crm_Workflow_ObjectModel_RollupRuleStep$set_hierarchicalRelationshipName(value) {
    ...
    get_targetRelationshipLinked: function Microsoft_Crm_Workflow_ObjectModel_RollupRuleStep$get_targetRelationshipLinked() {
        return this.targetRelationshipLinked;
    },
    
    set_targetRelationshipLinked: function Microsoft_Crm_Workflow_ObjectModel_RollupRuleStep$set_targetRelationshipLinked(value) {
    ...
    toJson: function Microsoft_Crm_Workflow_ObjectModel_RollupRuleStep$toJson() {
        ...
        if (this.sourceFilter) {
            sb.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getObjectJson('sourceFilter', this.sourceFilter.toJson(), true));
        }
        sb.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getPropertyJson('hierarchicalRelationshipName', this.hierarchicalRelationshipName, true));
        if (this.targetFilter) {
            sb.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getObjectJson('targetFilter', this.targetFilter.toJson(), true));
        }
        if (this.targetRelationship) {
            sb.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getObjectJson('targetRelationship', this.targetRelationship.toJson(), true));
        }
        if (this.targetLinkedFilter) {
            sb.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getObjectJson('targetLinkedFilter', this.targetLinkedFilter.toJson(), true));
        }
        if (this.targetRelationshipLinked) {
            sb.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getObjectJson('targetRelationshipLinked', this.targetRelationshipLinked.toJson(), true));
        }
        if (this.aggregate) {
            sb.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getObjectJson('aggregate', this.aggregate.toJson(), true));
        }
        sb.append('}');
        return sb.toString();
    },
    ...
    initializeFromDynamic: function Microsoft_Crm_Workflow_ObjectModel_RollupRuleStep$initializeFromDynamic(deserialized) {
        if (deserialized) {
            Microsoft.Crm.Workflow.ObjectModel.StepBase.prototype.initializeFromDynamic.call(this, deserialized);
            var sourceObject = deserialized;
            this.hierarchicalRelationshipName = sourceObject.hierarchicalRelationshipName;
            if (sourceObject.sourceFilter) {
                this.sourceFilter = Microsoft.Crm.Workflow.ObjectModel.NullObjectsFactory.buildExpression(sourceObject.sourceFilter.__class);
                this.sourceFilter.initializeFromDynamic(sourceObject.sourceFilter);
            }
            if (sourceObject.targetRelationship) {
                this.targetRelationship = Microsoft.Crm.Workflow.ObjectModel.NullObjectsFactory.buildEntity(sourceObject.targetRelationship.__class);
                this.targetRelationship.initializeFromDynamic(sourceObject.targetRelationship);
            }
            if (sourceObject.targetFilter) {
                this.targetFilter = Microsoft.Crm.Workflow.ObjectModel.NullObjectsFactory.buildExpression(sourceObject.targetFilter.__class);
                this.targetFilter.initializeFromDynamic(sourceObject.targetFilter);
            }
            if (sourceObject.targetRelationshipLinked) {
                this.targetRelationshipLinked = Microsoft.Crm.Workflow.ObjectModel.NullObjectsFactory.buildEntity(sourceObject.targetRelationshipLinked.__class);
            ...
            if (sourceObject.targetLinkedFilter) {
                this.targetLinkedFilter = Microsoft.Crm.Workflow.ObjectModel.NullObjectsFactory.buildExpression(sourceObject.targetLinkedFilter.__class);
                this.targetLinkedFilter.initializeFromDynamic(sourceObject.targetLinkedFilter);
            }
            if (sourceObject.aggregate) {
                this.aggregate = Microsoft.Crm.Workflow.ObjectModel.NullObjectsFactory.buildExpression(sourceObject.aggregate.__class);
...
Microsoft.Crm.Workflow.ObjectModel.SendEmailStep = function Microsoft_Crm_Workflow_ObjectModel_SendEmailStep(workflowStep) {
...
Microsoft.Crm.Workflow.ObjectModel.SendEmailStep.prototype = {
    ...
    toJson: function Microsoft_Crm_Workflow_ObjectModel_SendEmailStep$toJson() {
        ...
        sb.append('{');
        sb.append(Microsoft.Crm.Workflow.ObjectModel.StepBase.prototype.toJson.call(this));
        sb.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getPropertyJson('sendEmailType', Microsoft.Crm.Workflow.Utils.StringUtility.toStringInvariant(this.sendEmailType), true));
        sb.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getPropertyJson('emailTemplateId', this.emailTemplateId.toString(), true));
        if (this.entity) {
            sb.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getObjectJson('entity', this.entity.toJson(), true));
        }
        if (this.regardingEntity) {
            sb.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getObjectJson('regardingEntity', this.regardingEntity.toJson(), true));
        }
        sb.append('}');
        return sb.toString();
    },
    ...
    initializeFromDynamic: function Microsoft_Crm_Workflow_ObjectModel_SendEmailStep$initializeFromDynamic(deserialized) {
        if (deserialized) {
            Microsoft.Crm.Workflow.ObjectModel.StepBase.prototype.initializeFromDynamic.call(this, deserialized);
            var sourceObject = deserialized;
            ...
            if (sourceObject.regardingEntity) {
                this.regardingEntity = Microsoft.Crm.Workflow.ObjectModel.NullObjectsFactory.buildEntity(sourceObject.regardingEntity.__class);
...
Microsoft.Crm.Workflow.ObjectModel.SetStateStep = function Microsoft_Crm_Workflow_ObjectModel_SetStateStep(workflowStep) {
...
Microsoft.Crm.Workflow.ObjectModel.SetStateStep.prototype = {
    ...
    toJson: function Microsoft_Crm_Workflow_ObjectModel_SetStateStep$toJson() {
        ...
        if (this.status) {
            sb.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getObjectJson('status', this.status.toJson(), true));
        }
        if (this.entity) {
            sb.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getObjectJson('entity', this.entity.toJson(), true));
        }
    ...
    initializeFromDynamic: function Microsoft_Crm_Workflow_ObjectModel_SetStateStep$initializeFromDynamic(deserialized) {
        if (deserialized) {
            Microsoft.Crm.Workflow.ObjectModel.StepBase.prototype.initializeFromDynamic.call(this, deserialized);
            var sourceObject = deserialized;
            if (sourceObject.status) {
                this.status = Microsoft.Crm.Workflow.ObjectModel.NullObjectsFactory.buildExpression(sourceObject.status.__class);
                this.status.initializeFromDynamic(sourceObject.status);
            }
            if (sourceObject.state) {
                this.state = Microsoft.Crm.Workflow.ObjectModel.NullObjectsFactory.buildExpression(sourceObject.state.__class);
...
Microsoft.Crm.Workflow.ObjectModel.StageStep.prototype = {
    ...
    appendToJson: function Microsoft_Crm_Workflow_ObjectModel_StageStep$appendToJson(sb) {
        sb.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getPropertyJson('stageId', this.stageId, true));
        sb.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getPropertyJson('nextStageId', this.nextStageId, true));
        sb.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getPropertyJson('stageCategory', this.stageCategory, true));
    },
    ...
    initializeFromDynamic: function Microsoft_Crm_Workflow_ObjectModel_StageStep$initializeFromDynamic(deserialized) {
        if (deserialized) {
            ...
            this.nextStageId = Microsoft.Crm.Workflow.Utils.StringUtility.reduceToCanonicalForm(sourceObject.nextStageId);
...
Microsoft.Crm.Workflow.ObjectModel.StepBase.prototype = {
        ...
        if (step.id !== referenceStep.id && !isSiblingInteractions) {
            ...
            if (Microsoft.Crm.Workflow.ObjectModel.CompositeStepBase.isInstanceOfType(step)) {
                ...
                for (var i = 0; i < compositeStep.steps.get_Count(); i++) {
                    ...
                    if (!this.collectDataSourcesRecursive(childStep, referenceStep, includeReferenceStep, dataSources)) {
                        return false;
                    }
                }
            }
    ...
    toJson: function Microsoft_Crm_Workflow_ObjectModel_StepBase$toJson() {
        ...
        sb.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getPropertyJson('description', this.description, true));
        sb.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getPropertyJson('name', this.name, true));
        sb.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getObjectJson('stepLabels', this.stepLabels.toJson(), true));
        return sb.toString();
    },
...
Microsoft.Crm.Workflow.ObjectModel.StepCollection.prototype = {
    ...
    _getAddRemoveCollectionChangedArgs$p$0: function Microsoft_Crm_Workflow_ObjectModel_StepCollection$_getAddRemoveCollectionChangedArgs$p$0(action, step) {
        var args = new (Microsoft.Crm.Workflow.ObjectModel.StepCollectionChangedEventArgs$1.$$(Microsoft.Crm.Workflow.ObjectModel.StepBase))();
    ...
    _removeWithoutRaisingEvent$p$0: function Microsoft_Crm_Workflow_ObjectModel_StepCollection$_removeWithoutRaisingEvent$p$0(stepBase) {
...
Microsoft.Crm.Workflow.ObjectModel.StepCollectionChangedEventArgs$1 = function Microsoft_Crm_Workflow_ObjectModel_StepCollectionChangedEventArgs$1() {
    Microsoft.Crm.Workflow.ObjectModel.StepCollectionChangedEventArgs$1.$$(this.$$gta['Microsoft.Crm.Workflow.ObjectModel.StepCollectionChangedEventArgs$1']['TViewModel']).initializeBase(this);
}
Microsoft.Crm.Workflow.ObjectModel.StepCollectionChangedEventArgs$1.$$ = function Microsoft_Crm_Workflow_ObjectModel_StepCollectionChangedEventArgs$1$$$(TViewModel) {
    ...
    if (!Microsoft.Crm.Workflow.ObjectModel[$$cn]) {
        var $$ccr = Microsoft.Crm.Workflow.ObjectModel[$$cn] = function() {
            (this.$$gta = this.$$gta || {})['Microsoft.Crm.Workflow.ObjectModel.StepCollectionChangedEventArgs$1'] = {'TViewModel': TViewModel};
            var newArgs = [];
...
Microsoft.Crm.Workflow.ObjectModel.StepCollectionChangedEventArgs$1.prototype = {
    ...
    get_oldStartingIndex: function Microsoft_Crm_Workflow_ObjectModel_StepCollectionChangedEventArgs$1$get_oldStartingIndex() {
        return this._oldStartingIndex$p$1;
    },
    
    set_oldStartingIndex: function Microsoft_Crm_Workflow_ObjectModel_StepCollectionChangedEventArgs$1$set_oldStartingIndex(value) {
        this._oldStartingIndex$p$1 = value;
        return value;
    },
    
    get_newStartingIndex: function Microsoft_Crm_Workflow_ObjectModel_StepCollectionChangedEventArgs$1$get_newStartingIndex() {
        return this._newStartingIndex$p$1;
    },
    
    set_newStartingIndex: function Microsoft_Crm_Workflow_ObjectModel_StepCollectionChangedEventArgs$1$set_newStartingIndex(value) {
...
Microsoft.Crm.Workflow.ObjectModel.StepLabel.prototype = {
    ...
    toJson: function Microsoft_Crm_Workflow_ObjectModel_StepLabel$toJson() {
        ...
        sb.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getObjectJson('languageCode', Microsoft.Crm.Workflow.Utils.StringUtility.toStringInvariant(this.languageCode), true));
        sb.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getPropertyJson('description', this.description, true));
        sb.append('}');
        return sb.toString();
    },
...
Microsoft.Crm.Workflow.ObjectModel.StopWorkflowStep.prototype = {
    ...
    toJson: function Microsoft_Crm_Workflow_ObjectModel_StopWorkflowStep$toJson() {
        ...
        sb.append('{');
        sb.append(Microsoft.Crm.Workflow.ObjectModel.StepBase.prototype.toJson.call(this));
        sb.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getPropertyJson('status', Microsoft.Crm.Workflow.Utils.StringUtility.toStringInvariant(this.status), true));
        if (this.message) {
            sb.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getObjectJson('message', this.message.toJson(), true));
        }
        sb.append('}');
        return sb.toString();
    },
    ...
    initializeFromDynamic: function Microsoft_Crm_Workflow_ObjectModel_StopWorkflowStep$initializeFromDynamic(deserialized) {
        if (deserialized) {
            Microsoft.Crm.Workflow.ObjectModel.StepBase.prototype.initializeFromDynamic.call(this, deserialized);
            var sourceObject = deserialized;
            this.status = parseInt(sourceObject.status);
            if (sourceObject.message) {
                this.message = Microsoft.Crm.Workflow.ObjectModel.NullObjectsFactory.buildExpression(sourceObject.message.__class);
...
Microsoft.Crm.Workflow.ObjectModel.PageStep = function Microsoft_Crm_Workflow_ObjectModel_PageStep(workflowStep, stageName) {
...
Microsoft.Crm.Workflow.ObjectModel.PageStep.prototype = {
    ...
    set_defaultNextPageLayoutId: function Microsoft_Crm_Workflow_ObjectModel_PageStep$set_defaultNextPageLayoutId(value) {
    ...
    appendToJson: function Microsoft_Crm_Workflow_ObjectModel_PageStep$appendToJson(sb) {
        ...
        sb.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getPropertyJson('pageLayoutId', this.pageLayoutId, true));
        sb.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getPropertyJson('pageUniqueName', this.pageUniqueName, true));
    },
    
    _setDefaultNextPageLayoutId$p$3: function Microsoft_Crm_Workflow_ObjectModel_PageStep$_setDefaultNextPageLayoutId$p$3() {
    ...
    initializeFromDynamic: function Microsoft_Crm_Workflow_ObjectModel_PageStep$initializeFromDynamic(deserialized) {
        if (deserialized) {
            ...
            var sourceObject = deserialized;
            this.pageLayoutId = Microsoft.Crm.Workflow.Utils.StringUtility.reduceToCanonicalForm(sourceObject.pageLayoutId);
            if (sourceObject.pageUniqueName) {
                this.pageUniqueName = Microsoft.Crm.Workflow.Utils.StringUtility.reduceToCanonicalForm(sourceObject.pageUniqueName);
            }
        }
    }
}
...
Microsoft.Crm.Workflow.ObjectModel.UpdateStep.prototype = {
    ...
    toJson: function Microsoft_Crm_Workflow_ObjectModel_UpdateStep$toJson() {
        ...
        sb.append(Microsoft.Crm.Workflow.ObjectModel.StepBase.prototype.toJson.call(this));
        if (this.entitySpec) {
            sb.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getObjectJson('entitySpec', this.entitySpec.toJson(), true));
        }
        if (this.entity) {
            sb.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getObjectJson('entity', this.entity.toJson(), true));
        }
...
Microsoft.Crm.Workflow.ObjectModel.WaitBranchStep = function Microsoft_Crm_Workflow_ObjectModel_WaitBranchStep(waitStep, conditionExpression) {
...
Microsoft.Crm.Workflow.ObjectModel.WaitBranchStep.prototype = {
    ...
    set_parent: function Microsoft_Crm_Workflow_ObjectModel_WaitBranchStep$set_parent(value) {
        ...
        if (!(Microsoft.Crm.Workflow.ObjectModel.WaitStep.isInstanceOfType(value))) {
            Microsoft.Crm.Workflow.Utils.ExceptionUtility.throwArgumentException('Parent must be of type WaitStep.', 'Parent');
        }
        Microsoft.Crm.Workflow.ObjectModel.StepBase.prototype.set_parent.call(this, value);
        return value;
    },
    ...
    addPeer: function Microsoft_Crm_Workflow_ObjectModel_WaitBranchStep$addPeer(direction, newStep) {
        ...
        Microsoft.Crm.Workflow.Utils.ExceptionUtility.assert((!!branch) || (!!timeout), 'A child of WaitStep must be of type WaitBranchStep or WaitTimeoutStep.');
        if (branch) {
    ...
    initializeFromDynamic: function Microsoft_Crm_Workflow_ObjectModel_WaitBranchStep$initializeFromDynamic(deserialized) {
        if (deserialized) {
            Microsoft.Crm.Workflow.ObjectModel.CompositeStepBase.prototype.initializeFromDynamic.call(this, deserialized);
            var sourceObject = deserialized;
            if (sourceObject.conditionExpression) {
...
Microsoft.Crm.Workflow.ObjectModel.WaitStep.prototype = {
    ...
    _headOfWaitBranchStep$i$2: function Microsoft_Crm_Workflow_ObjectModel_WaitStep$_headOfWaitBranchStep$i$2() {
        Microsoft.Crm.Workflow.Utils.ExceptionUtility.assert(this.steps.get_Count() > 0, 'There must be a least one step in steps collection.');
        return (Microsoft.Crm.Workflow.ObjectModel.WaitBranchStep.isInstanceOfType(this.steps.get_item(0))) ? this.steps.get_item(0) : null;
    },
    ...
    _tailOfWaitBranchStep$i$2: function Microsoft_Crm_Workflow_ObjectModel_WaitStep$_tailOfWaitBranchStep$i$2() {
        ...
        return (Microsoft.Crm.Workflow.ObjectModel.WaitBranchStep.isInstanceOfType(this.steps.get_item(i - 1))) ? this.steps.get_item(i - 1) : null;
    },
    ...
    append: function Microsoft_Crm_Workflow_ObjectModel_WaitStep$append(newStep) {
        ...
        if (branch) {
            if (!this._tailOfWaitBranchStep$i$2()) {
                ...
                Microsoft.Crm.Workflow.ObjectModel.CompositeStepBase.prototype.insert.call(this, this._tailOfWaitBranchStep$i$2(), 1, branch);
            }
        }
        else {
...
Microsoft.Crm.Workflow.ObjectModel.WaitTimeoutStep = function Microsoft_Crm_Workflow_ObjectModel_WaitTimeoutStep(waitStep, timeoutExpression) {
...
Microsoft.Crm.Workflow.ObjectModel.WaitTimeoutStep.prototype = {
    ...
    _validateTimeoutExpression$p$2: function Microsoft_Crm_Workflow_ObjectModel_WaitTimeoutStep$_validateTimeoutExpression$p$2(expression) {
        Microsoft.Crm.Workflow.Utils.ExceptionUtility.throwIfNull(expression, 'TimeoutExpression');
        Microsoft.Crm.Workflow.Utils.ExceptionUtility.assert(Microsoft.Crm.Workflow.Expressions.NullExpression.isInstanceOfType(expression) || Microsoft.Crm.Workflow.Expressions.TimeSpanExpression.isInstanceOfType(expression) || expression.type === 2 || expression.type === 14 || Microsoft.Crm.Workflow.Expressions.MethodCallExpression.isInstanceOfType(expression), 'Type of TimeoutExpression must be DateTime, TimeSpan or MethodCallExpression');
    },
    ...
    toJson: function Microsoft_Crm_Workflow_ObjectModel_WaitTimeoutStep$toJson() {
        ...
        if (this.timeoutExpression) {
            sb.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getObjectJson('timeoutExpression', this.timeoutExpression.toJson(), true));
        }
        sb.append('}');
        return sb.toString();
    },
    
    initializeFromDynamic: function Microsoft_Crm_Workflow_ObjectModel_WaitTimeoutStep$initializeFromDynamic(deserialized) {
        if (deserialized) {
            Microsoft.Crm.Workflow.ObjectModel.CompositeStepBase.prototype.initializeFromDynamic.call(this, deserialized);
            var sourceObject = deserialized;
            if (sourceObject.timeoutExpression) {
                this.timeoutExpression = Microsoft.Crm.Workflow.ObjectModel.NullObjectsFactory.buildExpression(sourceObject.timeoutExpression.__class);
...
Microsoft.Crm.Workflow.ObjectModel.WorkflowArgument.prototype = {
    ...
    set_argumentTypeDisplay: function Microsoft_Crm_Workflow_ObjectModel_WorkflowArgument$set_argumentTypeDisplay(value) {
    ...
    toJson: function Microsoft_Crm_Workflow_ObjectModel_WorkflowArgument$toJson() {
        var sb = new Sys.StringBuilder();
        sb.append('{');
        sb.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getPropertyJson('_description', this._description, false));
        sb.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getPropertyJson('_entityName', this._entityName, true));
        sb.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getPropertyJson('_name', this._name, true));
        sb.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getPropertyJson('_required', Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getJson(this._required), true));
        sb.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getPropertyJson('_target', Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getJson(this._target), true));
        sb.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getPropertyJson('_argumentTypeCode', this._argumentTypeCode.toString(), true));
        sb.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getPropertyJson('_argumentTypeDisplay', this._argumentTypeDisplay, true));
        sb.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getObjectJson('_argumentDirection', Microsoft.Crm.Workflow.Utils.StringUtility.toStringInvariant(this._argumentDirection), true));
        sb.append('}');
        return sb.toString();
    },
    
    initializeFromDynamic: function Microsoft_Crm_Workflow_ObjectModel_WorkflowArgument$initializeFromDynamic(deserialized) {
        ...
        this._argumentDirection = (sourceArgument._argumentDirection);
    }
}
...
Microsoft.Crm.Workflow.ObjectModel.WorkflowStep = function Microsoft_Crm_Workflow_ObjectModel_WorkflowStep(primaryEntityName, category) {
    this._arguments = new (Microsoft.Crm.Client.Core.Framework.List$1.$$(Microsoft.Crm.Workflow.ObjectModel.WorkflowArgument))();
    this.stepDictionary = new Microsoft.Crm.Workflow.ObjectModel.StepDictionary();
    this._workflowStepVariables$p$2 = new (Microsoft.Crm.Client.Core.Framework.List$1.$$(Microsoft.Crm.Workflow.ObjectModel.WorkflowArgument))();
    this._workflowStepInputs$p$2 = new (Microsoft.Crm.Client.Core.Framework.List$1.$$(Microsoft.Crm.Workflow.ObjectModel.WorkflowArgument))();
	// TODO: add guid
...
Microsoft.Crm.Workflow.ObjectModel.WorkflowStep.initializeFrom = function Microsoft_Crm_Workflow_ObjectModel_WorkflowStep$initializeFrom(deserialized) {
    var result = new Microsoft.Crm.Workflow.ObjectModel.WorkflowStep(deserialized.primaryEntityName, deserialized.category);
    result.initializeFromDynamic(deserialized);
    return result;
}
Microsoft.Crm.Workflow.ObjectModel.WorkflowStep.prototype = {
    
    initializeBusinessProcess: function Microsoft_Crm_Workflow_ObjectModel_WorkflowStep$initializeBusinessProcess(businessProcessType, formId) {
    ...
    _initializeWorkflowStep$p$2: function Microsoft_Crm_Workflow_ObjectModel_WorkflowStep$_initializeWorkflowStep$p$2(sourcePrimaryEntityName, sourceCategory, sourceMode, sourceBpType) {
        ...
        this.publicationParameters = Microsoft.Crm.Workflow.ObjectModel._publicationParametersFactory._create$i(sourceCategory, sourceMode);
    ...
    deleteStep: function Microsoft_Crm_Workflow_ObjectModel_WorkflowStep$deleteStep(step) {
        ...
        if ((step._workflow$p$0 !== this) || !(Microsoft.Crm.Workflow.ObjectModel.CompositeStepBase.isInstanceOfType(step.get_parent()))) {
    ...
    appendStep: function Microsoft_Crm_Workflow_ObjectModel_WorkflowStep$appendStep(newStep) {
        ...
        for (var i = 0; i < this.steps.get_Count(); i++) {
            var childStep = this.steps.get_item(i);
            Microsoft.Crm.Workflow.Utils.ExceptionUtility.assert(!(Microsoft.Crm.Workflow.ObjectModel.StageStep.isInstanceOfType(childStep)), 'Cannot add a step to workflow with workflowStep as a parent step since there exist at least one Stage step.');
        }
        Microsoft.Crm.Workflow.ObjectModel.CompositeStepBase.prototype.appendStep.call(this, newStep);
    },
    ...
    get_workflowBusinessProcessType: function Microsoft_Crm_Workflow_ObjectModel_WorkflowStep$get_workflowBusinessProcessType() {
    ...
    getIdentifierDisplayName: function Microsoft_Crm_Workflow_ObjectModel_WorkflowStep$getIdentifierDisplayName(variableName) {
        if (Microsoft.Crm.Workflow.Utils.StringUtility.isNullOrWhiteSpace(variableName)) {
            Microsoft.Crm.Workflow.Utils.ExceptionUtility.throwArgumentException('Variable name cannot be null or empty', 'variableName');
        }
    ...
    toJson: function Microsoft_Crm_Workflow_ObjectModel_WorkflowStep$toJson() {
        ...
        sb.append('{');
        sb.append(Microsoft.Crm.Workflow.ObjectModel.CompositeStepBase.prototype.toJson.call(this));
        sb.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getPropertyJson('primaryEntityName', this.primaryEntityName, true));
        sb.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getPropertyJson('nextStepIndex', Microsoft.Crm.Workflow.Utils.StringUtility.toStringInvariant(this.nextStepIndex), true));
        sb.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getObjectJson('isCrmUIWorkflow', Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getJson(this.isCrmUIWorkflow), true));
        sb.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getPropertyJson('category', Microsoft.Crm.Workflow.Utils.StringUtility.toStringInvariant(this.category), true));
        sb.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getPropertyJson('businessProcessType', Microsoft.Crm.Workflow.Utils.StringUtility.toStringInvariant(this.businessProcessType), true));
        sb.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getPropertyJson('mode', Microsoft.Crm.Workflow.Utils.StringUtility.toStringInvariant(this.mode), true));
        sb.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getPropertyJson('title', this.title, true));
        sb.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getPropertyJson('description', this.description, true));
        sb.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getPropertyJson('workflowEntityId', this.workflowEntityId.toString(), true));
        ...
        var argumentJsonList = new (Microsoft.Crm.Client.Core.Framework.List$1.$$(String))();
        for (var i = 0; i < this.argumentsArray.length; i++) {
            argumentJsonList.add(this.argumentsArray[i].toJson());
        }
        var argumentJsonString = '[' + Microsoft.Crm.Workflow.Utils.StringUtility.join(String, ',', argumentJsonList.toArray()) + ']';
        sb.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getObjectJson('argumentsArray', argumentJsonString, true));
        sb.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getObjectJson('variables', this._serializeWorkflowVariables$p$2(false), true));
        sb.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getObjectJson('inputs', this._serializeWorkflowVariables$p$2(true), true));
        sb.append('}');
        return sb.toString();
    },
    
    _serializeWorkflowVariables$p$2: function Microsoft_Crm_Workflow_ObjectModel_WorkflowStep$_serializeWorkflowVariables$p$2(isInputParameter) {
        var argumentsList = (isInputParameter) ? this._workflowStepInputs$p$2 : this._workflowStepVariables$p$2;
        if (!argumentsList) {
            return null;
        }
        var serializedList = new (Microsoft.Crm.Client.Core.Framework.List$1.$$(String))();
        for (var i = 0; i < argumentsList.get_Count(); ++i) {
            var argument = argumentsList.get_item(i);
            var sb = new Sys.StringBuilder();
            sb.append('{');
            sb.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getPropertyJson('name', argument._name, false));
            sb.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getPropertyJson('type', argument._argumentTypeDisplay, true));
            sb.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getPropertyJson('type_code', argument._argumentTypeCode.toString(), true));
            sb.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getObjectJson('value', (argument._value).toJson(), true));
            sb.append('}');
            serializedList.add(sb.toString());
        }
        return '[' + Microsoft.Crm.Workflow.Utils.StringUtility.join(String, ',', serializedList.toArray()) + ']';
    },
    ...
    initializeFromDynamic: function Microsoft_Crm_Workflow_ObjectModel_WorkflowStep$initializeFromDynamic(deserialized) {
        if (deserialized) {
            ...
            this.businessProcessType = (sourceObject.businessProcessType) ? JSON.parse(sourceObject.businessProcessType) : 0;
            ...
            if (sourceObject.workflowEntityId) {
            	// TODO: add guid
            	//this.workflowEntityId = Microsoft.Crm.Client.Core.Framework.Guid.tryCreate(sourceObject.workflowEntityId.toString());
            	this.workflowEntityId = "00000000-0000-0000-0000-000000000000";
            }
            this._arguments = new (Microsoft.Crm.Client.Core.Framework.List$1.$$(Microsoft.Crm.Workflow.ObjectModel.WorkflowArgument))();
            var sourceArgumentArray = new (Microsoft.Crm.Client.Core.Framework.List$1.$$(Microsoft.Crm.Workflow.ObjectModel.WorkflowArgument))(sourceObject.argumentsArray);
            ...
            if (variables) {
                for (var i = 0; i < variables.length; ++i) {
                    ...
                    var value = Microsoft.Crm.Workflow.ObjectModel.NullObjectsFactory.buildExpression(valueDeserialized['__class']);
...
Microsoft.Crm.Workflow.ObjectModel.DataCollection$1.$$ = function Microsoft_Crm_Workflow_ObjectModel_DataCollection$1$$$(T) {
    ...
    if (!Microsoft.Crm.Workflow.ObjectModel[$$cn]) {
        ...
        $$ccr.registerClass('Microsoft.Crm.Workflow.ObjectModel.' + $$cn, null, Microsoft.Crm.Client.Core.Framework.IList$1.$$(T));
...
Microsoft.Crm.Workflow.ObjectModel.DataCollection$1.prototype = {
    ...
    set_item: function Microsoft_Crm_Workflow_ObjectModel_DataCollection$1$set_item(index, value) {
        Microsoft.Crm.Workflow.Utils.ExceptionUtility.assert(!this._readOnly$p$0, 'Cannot modify value in a readonly data value collection');
    ...
    append: function Microsoft_Crm_Workflow_ObjectModel_DataCollection$1$append(collection) {
        ...
        for (var $$arr_1 = collection.get_items(), $$len_2 = $$arr_1.length, $$idx_3 = 0; $$idx_3 < $$len_2; ++$$idx_3) {
            var ds = $$arr_1[$$idx_3];
            this.add(ds);
        }
    },
...
Microsoft.Crm.Workflow.ObjectModel.DataValueCollection = function Microsoft_Crm_Workflow_ObjectModel_DataValueCollection() {
    Microsoft.Crm.Workflow.ObjectModel.DataValueCollection.initializeBase(this);
}


Microsoft.Crm.Workflow.ObjectModel.ProcessDefinitionVisitorBase = function Microsoft_Crm_Workflow_ObjectModel_ProcessDefinitionVisitorBase() {
...
Microsoft.Crm.Workflow.ObjectModel.ProcessDefinitionVisitorBase.prototype = {
    ...
    visitAssignStep: function Microsoft_Crm_Workflow_ObjectModel_ProcessDefinitionVisitorBase$visitAssignStep(assignStep) {
        if (!this._isNull$p$1(assignStep.assignTo)) {
            assignStep.assignTo.accept(this);
        }
    },
    
    visitChildWorkflowStep: function Microsoft_Crm_Workflow_ObjectModel_ProcessDefinitionVisitorBase$visitChildWorkflowStep(childWorkflowStep) {
        if (!this._isNull$p$1(childWorkflowStep.childWorkflow)) {
            childWorkflowStep.childWorkflow.accept(this);
        }
    },
    
    visitConditionBranchStep: function Microsoft_Crm_Workflow_ObjectModel_ProcessDefinitionVisitorBase$visitConditionBranchStep(conditionBranchStep) {
    ...
    visitConditionStep: function Microsoft_Crm_Workflow_ObjectModel_ProcessDefinitionVisitorBase$visitConditionStep(conditionStep) {
        this._visitChildren$p$1(conditionStep);
    },
    
    visitCreateStep: function Microsoft_Crm_Workflow_ObjectModel_ProcessDefinitionVisitorBase$visitCreateStep(createStep) {
        if (!this._isNull$p$1(createStep.entity)) {
            createStep.entity.accept(this);
        }
    },
    
    visitEntityStep: function Microsoft_Crm_Workflow_ObjectModel_ProcessDefinitionVisitorBase$visitEntityStep(entityStep) {
        this._visitChildren$p$1(entityStep);
    },
    
    visitSendEmailStep: function Microsoft_Crm_Workflow_ObjectModel_ProcessDefinitionVisitorBase$visitSendEmailStep(sendEmailStep) {
        if (!this._isNull$p$1(sendEmailStep.entity)) {
            sendEmailStep.entity.accept(this);
        }
    },
    
    visitSetAttributeValueStep: function Microsoft_Crm_Workflow_ObjectModel_ProcessDefinitionVisitorBase$visitSetAttributeValueStep(setAttributeValueStep) {
        if (!this._isNull$p$1(setAttributeValueStep.get_propertySpec())) {
            setAttributeValueStep.get_propertySpec().accept(this);
        }
    },
    
    visitSetStateStep: function Microsoft_Crm_Workflow_ObjectModel_ProcessDefinitionVisitorBase$visitSetStateStep(setStateStep) {
    ...
    visitUpdateStep: function Microsoft_Crm_Workflow_ObjectModel_ProcessDefinitionVisitorBase$visitUpdateStep(updateStep) {
        if (!this._isNull$p$1(updateStep.entitySpec)) {
            updateStep.entitySpec.accept(this);
        }
    },
    
    visitWaitBranchStep: function Microsoft_Crm_Workflow_ObjectModel_ProcessDefinitionVisitorBase$visitWaitBranchStep(waitBranchStep) {
    ...
    visitWaitTimeoutStep: function Microsoft_Crm_Workflow_ObjectModel_ProcessDefinitionVisitorBase$visitWaitTimeoutStep(waitTimeoutStep) {
    ...
    visitCustomActivityStep: function Microsoft_Crm_Workflow_ObjectModel_ProcessDefinitionVisitorBase$visitCustomActivityStep(customActivityStep) {
    },
    
    visitCustomJavascriptStep: function Microsoft_Crm_Workflow_ObjectModel_ProcessDefinitionVisitorBase$visitCustomJavascriptStep(customJSStep) {
    },
    
    visitWorkflowStep: function Microsoft_Crm_Workflow_ObjectModel_ProcessDefinitionVisitorBase$visitWorkflowStep(workflowStep) {
        this._visitChildren$p$1(workflowStep);
    },
    
    visitStopWorkflowStep: function Microsoft_Crm_Workflow_ObjectModel_ProcessDefinitionVisitorBase$visitStopWorkflowStep(stopWorkflowStep) {
    },
    
    visitSetVisibilityStep: function Microsoft_Crm_Workflow_ObjectModel_ProcessDefinitionVisitorBase$visitSetVisibilityStep(setVisibilityStep) {
    },
    
    visitSetDisplayModeStep: function Microsoft_Crm_Workflow_ObjectModel_ProcessDefinitionVisitorBase$visitSetDisplayModeStep(setDisplayModeStep) {
    },
    
    visitSetFieldRequiredLevelStep: function Microsoft_Crm_Workflow_ObjectModel_ProcessDefinitionVisitorBase$visitSetFieldRequiredLevelStep(setFieldRequiredLevelStep) {
    },
    
    visitSetMessageStep: function Microsoft_Crm_Workflow_ObjectModel_ProcessDefinitionVisitorBase$visitSetMessageStep(setMessageStep) {
    },
    
    visitControlStep: function Microsoft_Crm_Workflow_ObjectModel_ProcessDefinitionVisitorBase$visitControlStep(controlStep) {
    },
    
    visitActionStep: function Microsoft_Crm_Workflow_ObjectModel_ProcessDefinitionVisitorBase$visitActionStep(actionStep) {
    },
    
    visitRollupRuleStep: function Microsoft_Crm_Workflow_ObjectModel_ProcessDefinitionVisitorBase$visitRollupRuleStep(rollupRuleStep) {
    },
    
    visitSetDefaultValueStep: function Microsoft_Crm_Workflow_ObjectModel_ProcessDefinitionVisitorBase$visitSetDefaultValueStep(setDefaultValueStep) {
    },
    
    visitSetNextStageStep: function Microsoft_Crm_Workflow_ObjectModel_ProcessDefinitionVisitorBase$visitSetNextStageStep(setNextStageStep) {
    },
    
    visitAssignVariableStep: function Microsoft_Crm_Workflow_ObjectModel_ProcessDefinitionVisitorBase$visitAssignVariableStep(assignVariableStep) {
    },
    
    visitChildInteractiveWorkflowStep: function Microsoft_Crm_Workflow_ObjectModel_ProcessDefinitionVisitorBase$visitChildInteractiveWorkflowStep(childWorkflowStep) {
    },
    
    visitInteractionPageStep: function Microsoft_Crm_Workflow_ObjectModel_ProcessDefinitionVisitorBase$visitInteractionPageStep(interactionPageStep) {
    },
    
    visitInteractionStep: function Microsoft_Crm_Workflow_ObjectModel_ProcessDefinitionVisitorBase$visitInteractionStep(interactionStep) {
    },
    
    visitQueryStep: function Microsoft_Crm_Workflow_ObjectModel_ProcessDefinitionVisitorBase$visitQueryStep(queryStep) {
    },
    
    visitBinaryExpression: function Microsoft_Crm_Workflow_ObjectModel_ProcessDefinitionVisitorBase$visitBinaryExpression(expression) {
        expression.left.accept(this);
    ...
    visitUnaryExpression: function Microsoft_Crm_Workflow_ObjectModel_ProcessDefinitionVisitorBase$visitUnaryExpression(expression) {
        expression.operand.accept(this);
    },
    
    visitPropertySpecification: function Microsoft_Crm_Workflow_ObjectModel_ProcessDefinitionVisitorBase$visitPropertySpecification(propertySpecification) {
    ...
    visitEntitySpecification: function Microsoft_Crm_Workflow_ObjectModel_ProcessDefinitionVisitorBase$visitEntitySpecification(entitySpecification) {
    ...
    visitMethodCallExpression: function Microsoft_Crm_Workflow_ObjectModel_ProcessDefinitionVisitorBase$visitMethodCallExpression(expression) {
    ...
    visitLookupExpression: function Microsoft_Crm_Workflow_ObjectModel_ProcessDefinitionVisitorBase$visitLookupExpression(expression) {
    ...
    visitPrimitiveExpression: function Microsoft_Crm_Workflow_ObjectModel_ProcessDefinitionVisitorBase$visitPrimitiveExpression(expression) {
        if (!this._isNull$p$1(expression.primitiveValue) && expression.type === 9) {
            var entitySpecifications = expression.primitiveValue;
            for (var $$arr_2 = entitySpecifications, $$len_3 = $$arr_2.length, $$idx_4 = 0; $$idx_4 < $$len_3; ++$$idx_4) {
    ...
    visitEntityAttributeExpression: function Microsoft_Crm_Workflow_ObjectModel_ProcessDefinitionVisitorBase$visitEntityAttributeExpression(expression) {
    },
    
    visitTimeSpanExpression: function Microsoft_Crm_Workflow_ObjectModel_ProcessDefinitionVisitorBase$visitTimeSpanExpression(expression) {
    },
    
    visitNullExpression: function Microsoft_Crm_Workflow_ObjectModel_ProcessDefinitionVisitorBase$visitNullExpression(expression) {
    },
    
    _visitChildren$p$1: function Microsoft_Crm_Workflow_ObjectModel_ProcessDefinitionVisitorBase$_visitChildren$p$1(step) {
        for (var i = 0; i < step.steps.get_Count(); i++) {
            var childStep = step.steps.get_item(i);
            childStep.apply(this);
        }
...
Microsoft.Crm.Workflow.Utils.ArrayUtility.toJson = function Microsoft_Crm_Workflow_Utils_ArrayUtility$toJson(T, items, jsonConverter) {
    var arrayItems = items.toArray();
    return Microsoft.Crm.Workflow.Utils.ArrayUtility.arrayToJson(T, arrayItems, jsonConverter);
}
Microsoft.Crm.Workflow.Utils.ArrayUtility.arrayToJson = function Microsoft_Crm_Workflow_Utils_ArrayUtility$arrayToJson(T, arrayItems, jsonConverter) {
    var sb = new Sys.StringBuilder();
    sb.append('[');
...
Microsoft.Crm.Workflow.Utils.DictionaryUtility.toJson = function Microsoft_Crm_Workflow_Utils_DictionaryUtility$toJson(TKey, TValue, items, keyJsonConverter, valueJsonConverter) {
    var sb = new Sys.StringBuilder();
    sb.append('{');
    sb.append('\"keys\":');
    sb.append(Microsoft.Crm.Workflow.Utils.ArrayUtility.arrayToJson(TKey, _Dictionary.keys(items), keyJsonConverter).toString());
    sb.append(',');
    sb.append('\"values\":');
    sb.append(Microsoft.Crm.Workflow.Utils.ArrayUtility.arrayToJson(TValue, _Dictionary.toArray(TValue, items), valueJsonConverter).toString());
    sb.append('}');
    return sb.toString();
}
Microsoft.Crm.Workflow.Utils.DictionaryUtility.fromJson = function Microsoft_Crm_Workflow_Utils_DictionaryUtility$fromJson(TKey, TValue, deserializedObject, keyJsonConverter, valueJsonConverter) {
...
Microsoft.Crm.Workflow.Utils.SharedUtility.dictionaryAdd = function Microsoft_Crm_Workflow_Utils_SharedUtility$dictionaryAdd(TKey, TValue, dictionary, key, value) {
    dictionary[key.toString()] = value;
}
Microsoft.Crm.Workflow.Utils.SharedUtility.dictionaryContainKey = function Microsoft_Crm_Workflow_Utils_SharedUtility$dictionaryContainKey(TKey, TValue, dictionary, key) {
    return ((key.toString()) in dictionary);
}
Microsoft.Crm.Workflow.Utils.SharedUtility.dictionaryGetValue = function Microsoft_Crm_Workflow_Utils_SharedUtility$dictionaryGetValue(TKey, TValue, dictionary, key) {
    return dictionary[key.toString()];
}
Microsoft.Crm.Workflow.Utils.SharedUtility.dictionaryGetKeys = function Microsoft_Crm_Workflow_Utils_SharedUtility$dictionaryGetKeys(TKey, TValue, dictionary) {
...
Microsoft.Crm.Workflow.Utils.SharedUtility.throwException = function Microsoft_Crm_Workflow_Utils_SharedUtility$throwException(code) {
    var args = [];
    ...
    Microsoft.Crm.Workflow.Utils.ExceptionUtility.throwException(Microsoft.Crm.Workflow.Utils.StringUtility.formatInvariant.apply(null, [ errorStringTemplate ].concat(args)));
}
...
Microsoft.Crm.Workflow.Utils.StringUtility.format = function Microsoft_Crm_Workflow_Utils_StringUtility$format(cultureInfo, message) {
    var parameters = [];
...
Microsoft.Crm.Workflow.Utils.StringUtility.reduceToCanonicalForm = function Microsoft_Crm_Workflow_Utils_StringUtility$reduceToCanonicalForm(value) {
...
Microsoft.Crm.Workflow.Utils.StringUtility.isNullOrWhiteSpace = function Microsoft_Crm_Workflow_Utils_StringUtility$isNullOrWhiteSpace(value) {
    return Microsoft.Crm.Workflow.Utils.StringUtility.isNullOrEmpty(value) || Microsoft.Crm.Workflow.Utils.StringUtility.isNullOrEmpty(value.trim());
}
Microsoft.Crm.Workflow.Utils.StringUtility.split = function Microsoft_Crm_Workflow_Utils_StringUtility$split(value, character, limit) {
    return value.split(character, limit);
}
Microsoft.Crm.Workflow.Utils.StringUtility.join = function Microsoft_Crm_Workflow_Utils_StringUtility$join(T, connector, items) {
    var sb = new Sys.StringBuilder();
    if (!items.length) {
        return sb.toString();
    }
...
Microsoft.Crm.Workflow.Expressions.BpfAttributeType.registerEnum('Microsoft.Crm.Workflow.Expressions.BpfAttributeType', false);
...
Microsoft.Crm.Workflow.Expressions.AttributeDateTimeBehavior.registerEnum('Microsoft.Crm.Workflow.Expressions.AttributeDateTimeBehavior', false);
...
Microsoft.Crm.Workflow.Expressions.IEntityBaseDecorator.registerInterface('Microsoft.Crm.Workflow.Expressions.IEntityBaseDecorator');
...
Microsoft.Crm.Workflow.Expressions.BinaryExpression.prototype = {
    ...
    toJson: function Microsoft_Crm_Workflow_Expressions_BinaryExpression$toJson() {
        ...
        sb.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getPropertyJson('conditionOperatoroperator', Microsoft.Crm.Workflow.Utils.StringUtility.toStringInvariant(this.conditionOperatoroperator), true));
    ...
    initializeFromDynamic: function Microsoft_Crm_Workflow_Expressions_BinaryExpression$initializeFromDynamic(deserialized) {
        if (deserialized) {
            ...
            if (sourceObject.left) {
                this.left = Microsoft.Crm.Workflow.ObjectModel.NullObjectsFactory.buildExpression(sourceObject.left.__class);
                this.left.initializeFromDynamic(sourceObject.left);
            }
            if (sourceObject.right) {
                this.right = new Microsoft.Crm.Workflow.Expressions.ExpressionCollection([], sourceObject.right._readOnly$i$0);
                var rightExpressions = sourceObject.right;
                for (var i = 0; i < rightExpressions.length; i++) {
                    var sourceExpression = rightExpressions[i];
                    var targetExpression = Microsoft.Crm.Workflow.ObjectModel.NullObjectsFactory.buildExpression(sourceExpression.__class);
...
Microsoft.Crm.Workflow.Expressions.EntityAttributeExpression.prototype = {
    ...
    getDisplayText: function Microsoft_Crm_Workflow_Expressions_EntityAttributeExpression$getDisplayText(cultureInfo) {
        ...
        if (Microsoft.Crm.Workflow.ObjectModel.DynamicAttributesInProcess.containsKey(this.attributeName)) {
            attrName = this._workflow$p$0._metadataProvider$p$2.getResourceString(Microsoft.Crm.Workflow.ObjectModel.DynamicAttributesInProcess.getAttribute(this.attributeName));
        }
        else {
            attrName = this._workflow$p$0._metadataProvider$p$2.getAttributeLocalizedName(cultureInfo, this.entity.entityName, this.attributeName);
        }
...
Microsoft.Crm.Workflow.Expressions.RelatedEntity = function Microsoft_Crm_Workflow_Expressions_RelatedEntity(workflow, relatedAttributeName, relatedEntity) {
    Microsoft.Crm.Workflow.Expressions.RelatedEntity.initializeBase(this, [ workflow, 'related' + '_' + relatedAttributeName + '_' + relatedEntity ]);
...
Microsoft.Crm.Workflow.Expressions.RelatedEntity.prototype = {
    ...
    set_relatedAttributeName: function Microsoft_Crm_Workflow_Expressions_RelatedEntity$set_relatedAttributeName(value) {
    ...
    getLocalizedName: function Microsoft_Crm_Workflow_Expressions_RelatedEntity$getLocalizedName(cultureInfo) {
        return Microsoft.Crm.Workflow.Utils.StringUtility.formatInvariant('{0} ({1})', this._workflow$p$0._metadataProvider$p$2.getAttributeLocalizedName(cultureInfo, this._workflow$p$0.primaryEntityName, this.get_relatedAttributeName()), this._workflow$p$0._metadataProvider$p$2.getEntityLocalizedName(cultureInfo, this.entityName));
    },
    ...
    appendToJson: function Microsoft_Crm_Workflow_Expressions_RelatedEntity$appendToJson(sb) {
        sb.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getPropertyJson('relatedAttributeName', this.get_relatedAttributeName(), true));
    },
    ...
    initializeFromDynamic: function Microsoft_Crm_Workflow_Expressions_RelatedEntity$initializeFromDynamic(deserialized) {
        if (deserialized) {
...
Microsoft.Crm.Workflow.Expressions.RelatedEntityLinked = function Microsoft_Crm_Workflow_Expressions_RelatedEntityLinked(workflow, relatedAttributeName, relatedEntity, relationshipName) {
    Microsoft.Crm.Workflow.Expressions.RelatedEntityLinked.initializeBase(this, [ workflow, relatedAttributeName, relatedEntity ]);
    this.parameterName = 'relatedlinked' + '_' + relationshipName + '_' + relatedAttributeName + '_' + relatedEntity;
    this.relatedAttributeName = relatedAttributeName;
...
Microsoft.Crm.Workflow.Expressions.RelatedEntityLinked.prototype = {
    ...
    get_relatedAttributeName: function Microsoft_Crm_Workflow_Expressions_RelatedEntityLinked$get_relatedAttributeName() {
        return this.relatedAttributeName;
    },
    
    set_relatedAttributeName: function Microsoft_Crm_Workflow_Expressions_RelatedEntityLinked$set_relatedAttributeName(value) {
        this.relatedAttributeName = value;
        return value;
    },
    ...
    get_xamlKey: function Microsoft_Crm_Workflow_Expressions_RelatedEntityLinked$get_xamlKey() {
        return 'relatedlinked' + '_' + this.relationshipName + '#' + this.get_relatedAttributeName() + '#' + this.entityName;
    },
    
    initializeFromDynamic: function Microsoft_Crm_Workflow_Expressions_RelatedEntityLinked$initializeFromDynamic(deserialized) {
        if (deserialized) {
...
Microsoft.Crm.Workflow.Expressions.EntityCreatedByStep = function Microsoft_Crm_Workflow_Expressions_EntityCreatedByStep(workflow, step, entityName, entityIdentifier, parameterName, isCustomOperationArgument) {
...
Microsoft.Crm.Workflow.Expressions.EntityCreatedByStep.prototype = {
    ...
    get_isCustomOperationArgument: function Microsoft_Crm_Workflow_Expressions_EntityCreatedByStep$get_isCustomOperationArgument() {
        return this.isCustomOperationArgument;
    },
    
    set_isCustomOperationArgument: function Microsoft_Crm_Workflow_Expressions_EntityCreatedByStep$set_isCustomOperationArgument(value) {
    ...
    getLocalizedName: function Microsoft_Crm_Workflow_Expressions_EntityCreatedByStep$getLocalizedName(cultureInfo) {
        ...
        if (Microsoft.Crm.Workflow.Utils.StringUtility.isNullOrEmpty(this.entityIdentifier)) {
            if (Microsoft.Crm.Workflow.ObjectModel.WorkflowStep.isInstanceOfType(this.step)) {
                ...
                stepDisplayString = this.step._workflow$p$0._metadataProvider$p$2.getResourceString('Web.SFA.Workflow.StepName.' + this.step.get_typeName());
                if (Microsoft.Crm.Workflow.Utils.StringUtility.isNullOrEmpty(stepDisplayString)) {
                    stepDisplayString = this.step.get_typeName();
                }
            }
            localizedName = Microsoft.Crm.Workflow.Utils.StringUtility.format(cultureInfo, '{0} ({1})', stepDisplayString, entityName);
        }
        else {
            ...
            localizedName = Microsoft.Crm.Workflow.Utils.StringUtility.format(cultureInfo, '{0}:{2} ({1})', stepDisplayString, entityName, entityIdentifierText);
        }
    ...
    toJson: function Microsoft_Crm_Workflow_Expressions_EntityCreatedByStep$toJson() {
        ...
        sb.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getPropertyJson('entityIdentifier', this.entityIdentifier, true));
        sb.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getPropertyJson('identifierName', this.identifierName, true));
        sb.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getObjectJson('isCustomOperationArgument', Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getJson(this.isCustomOperationArgument), true));
        sb.append('}');
        return sb.toString();
    },
    ...
    initializeFromDynamic: function Microsoft_Crm_Workflow_Expressions_EntityCreatedByStep$initializeFromDynamic(deserialized) {
        if (deserialized) {
            Microsoft.Crm.Workflow.Expressions.EntityBase.prototype.initializeFromDynamic.call(this, deserialized);
            var sourceObject = deserialized;
...
Microsoft.Crm.Workflow.Expressions.EntitySpecification = function Microsoft_Crm_Workflow_Expressions_EntitySpecification(entityName) {
    this.entityName = entityName;
    this.properties = Microsoft.Crm.Workflow.Utils.ArrayUtility.getList(Microsoft.Crm.Workflow.Expressions.PropertySpecification);
}
Microsoft.Crm.Workflow.Expressions.EntitySpecification.prototype = {
    ...
    addProperty: function Microsoft_Crm_Workflow_Expressions_EntitySpecification$addProperty(propertyName, propertyExpression) {
        var property = new Microsoft.Crm.Workflow.Expressions.PropertySpecification(propertyName, propertyExpression);
    ...
    toJson: function Microsoft_Crm_Workflow_Expressions_EntitySpecification$toJson() {
        ...
        var $$t_2 = this;
        sb.append(Microsoft.Crm.Workflow.Utils.ArrayUtility.toJson(Microsoft.Crm.Workflow.Expressions.PropertySpecification, this.properties, function(property) {
    ...
    initializeFromDynamic: function Microsoft_Crm_Workflow_Expressions_EntitySpecification$initializeFromDynamic(deserialized) {
        if (deserialized) {
            var sourceObject = deserialized;
            this.entityName = sourceObject.entityName;
...
Microsoft.Crm.Workflow.Expressions.TimeSpanExpression.prototype = {
    ...
    toJson: function Microsoft_Crm_Workflow_Expressions_TimeSpanExpression$toJson() {
        ...
        sb.append('{');
        sb.append(Microsoft.Crm.Workflow.Expressions.ExpressionBase.prototype.toJson.call(this));
        sb.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getPropertyJson('days', Microsoft.Crm.Workflow.Utils.StringUtility.toStringInvariant(this.value.days), true));
        sb.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getPropertyJson('hours', Microsoft.Crm.Workflow.Utils.StringUtility.toStringInvariant(this.value.hours), true));
        sb.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getPropertyJson('minutes', Microsoft.Crm.Workflow.Utils.StringUtility.toStringInvariant(this.value.minutes), true));
        sb.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getPropertyJson('months', Microsoft.Crm.Workflow.Utils.StringUtility.toStringInvariant(this.value.months), true));
        sb.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getPropertyJson('years', Microsoft.Crm.Workflow.Utils.StringUtility.toStringInvariant(this.value.years), true));
        sb.append('}');
        return sb.toString();
    },
...
Microsoft.Crm.Workflow.Expressions.EntityBase.prototype = {
    ...
    toJson: function Microsoft_Crm_Workflow_Expressions_EntityBase$toJson() {
        var sb = new Sys.StringBuilder();
        sb.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getPropertyJson('__class', this.__class, false));
        sb.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getPropertyJson('parameterName', this.parameterName, true));
        sb.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getPropertyJson('entityName', this.entityName, true));
        return sb.toString();
    },
...
Microsoft.Crm.Workflow.Expressions.MethodCallExpression.prototype = {
    ...
    _methodCallExpressionIntialization$p$1: function Microsoft_Crm_Workflow_Expressions_MethodCallExpression$_methodCallExpressionIntialization$p$1(sourceMethod, sourceParameters) {
    ...
    toJson: function Microsoft_Crm_Workflow_Expressions_MethodCallExpression$toJson() {
        ...
        sb.append('{');
        sb.append(Microsoft.Crm.Workflow.Expressions.ExpressionBase.prototype.toJson.call(this));
        sb.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getPropertyJson('method', Microsoft.Crm.Workflow.Utils.StringUtility.toStringInvariant(this.method), true));
        sb.append(',');
    ...
    initializeFromDynamic: function Microsoft_Crm_Workflow_Expressions_MethodCallExpression$initializeFromDynamic(deserialized) {
        if (deserialized) {
            ...
            for (var i = 0; i < sourceObject.parameters.length; i++) {
                ...
                if (isObject) {
                    var targetExpression = Microsoft.Crm.Workflow.ObjectModel.NullObjectsFactory.buildExpression((parameter1).__class);
...
Microsoft.Crm.Workflow.Expressions.ExpressionBase.prototype = {
    ...
    toJson: function Microsoft_Crm_Workflow_Expressions_ExpressionBase$toJson() {
        var sb = new Sys.StringBuilder();
        sb.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getPropertyJson('__class', this.__class, false));
        sb.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getPropertyJson('type', Microsoft.Crm.Workflow.Utils.StringUtility.toStringInvariant(this.type), true));
        sb.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getObjectJson('typeSet', Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getJson(this.typeSet), true));
        sb.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getObjectJson('behavior', Microsoft.Crm.Workflow.Utils.StringUtility.toStringInvariant(this.behavior), true));
        return sb.toString();
    },
...
Microsoft.Crm.Workflow.Expressions.ExpressionCollection.prototype = {
    ...
    set_item: function Microsoft_Crm_Workflow_Expressions_ExpressionCollection$set_item(index, value) {
        Microsoft.Crm.Workflow.Utils.ExceptionUtility.assert(!this._readOnly$i$0, 'Cannot modify value in a readonly expression collection');
...
Microsoft.Crm.Workflow.Expressions.LookupExpression.prototype = {
    ...
    toJson: function Microsoft_Crm_Workflow_Expressions_LookupExpression$toJson() {
        ...
        sb.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getObjectJson('staticValue', (this.staticValue).toJson(), true));
        sb.append('}');
        return sb.toString();
    },
    ...
    initializeFromDynamic: function Microsoft_Crm_Workflow_Expressions_LookupExpression$initializeFromDynamic(deserialized) {
        if (deserialized) {
            ...
            if (expression.staticValue) {
                this.staticValue = Microsoft.Crm.Workflow.ObjectModel.NullObjectsFactory.buildExpression((expression.staticValue).__class);
...
Microsoft.Crm.Workflow.Expressions.PropertySpecification.prototype = {
    ...
    toJson: function Microsoft_Crm_Workflow_Expressions_PropertySpecification$toJson() {
        var sb = new Sys.StringBuilder();
        sb.append('{');
        sb.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getPropertyJson('propertyName', this.propertyName, false));
        sb.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getObjectJson('propertyValueExpr', this.propertyValueExpr.toJson(), true));
        sb.append('}');
        return sb.toString();
    },
    
    _fixInternalLinks$i$0: function Microsoft_Crm_Workflow_Expressions_PropertySpecification$_fixInternalLinks$i$0(workflowStep) {
    ...
    initializeFromDynamic: function Microsoft_Crm_Workflow_Expressions_PropertySpecification$initializeFromDynamic(deserialized) {
        if (deserialized) {
            ...
            this.propertyValueExpr = Microsoft.Crm.Workflow.ObjectModel.NullObjectsFactory.buildExpression(sourceObject.propertyValueExpr.__class);
...
Microsoft.Crm.Workflow.Expressions.PrimitiveExpression.prototype = {
    ...
    toJson: function Microsoft_Crm_Workflow_Expressions_PrimitiveExpression$toJson() {
        ...
        if (this.type === 9) {
            ...
            sb.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getPropertyJson('primitiveValue', this._getValueForSerialization$p$1(), true));
        }
        sb.append('}');
        return sb.toString();
    },
    
    _getSerializedActivityParty$p$1: function Microsoft_Crm_Workflow_Expressions_PrimitiveExpression$_getSerializedActivityParty$p$1() {
    ...
    _getValueForSerialization$p$1: function Microsoft_Crm_Workflow_Expressions_PrimitiveExpression$_getValueForSerialization$p$1() {
        return (Microsoft.Crm.Workflow.Utils.StringUtility.isNull(this.primitiveValue)) ? null : this.primitiveValue.toString();
    },
            ...
            if (this.type === 9) {
                if (sourceObject.primitiveValue) {
                    ...
                    for (var i = 0; i < primitiveEntities.length; i++) {
                        ...
                        var targetEntity = new Microsoft.Crm.Workflow.Expressions.EntitySpecification(sourceEntity.entityName);
    ...
    initializeFromDynamic: function Microsoft_Crm_Workflow_Expressions_UnaryExpression$initializeFromDynamic(deserialized) {
        if (deserialized) {
            ...
            if (sourceObject.operand) {
                ...
                this.operand = Microsoft.Crm.Workflow.ObjectModel.NullObjectsFactory.buildExpression(sourceOperand.__class);
...
Microsoft.Crm.Workflow.Expressions.EntityCreatedByStepDecorator = function Microsoft_Crm_Workflow_Expressions_EntityCreatedByStepDecorator(entity, metadataProvider) {
    Microsoft.Crm.Workflow.Expressions.EntityCreatedByStepDecorator.initializeBase(this, [ entity, metadataProvider ]);
}


Microsoft.Crm.Workflow.Expressions.EntityBaseDecorator$1 = function Microsoft_Crm_Workflow_Expressions_EntityBaseDecorator$1(entity, metadataProvider) {
    Microsoft.Crm.Workflow.Expressions.EntityBaseDecorator$1.$$(this.$$gta['Microsoft.Crm.Workflow.Expressions.EntityBaseDecorator$1']['TEntity']).initializeBase(this, [ entity._workflow$p$0, entity.parameterName ]);
    this._entitySource$1 = entity;
    entity._workflow$p$0._metadataProvider$p$2 = metadataProvider;
}
Microsoft.Crm.Workflow.Expressions.EntityBaseDecorator$1.$$ = function Microsoft_Crm_Workflow_Expressions_EntityBaseDecorator$1$$$(TEntity) {
    ...
    if (!Microsoft.Crm.Workflow.Expressions[$$cn]) {
        var $$ccr = Microsoft.Crm.Workflow.Expressions[$$cn] = function() {
            (this.$$gta = this.$$gta || {})['Microsoft.Crm.Workflow.Expressions.EntityBaseDecorator$1'] = {'TEntity': TEntity};
            var newArgs = [];
            for (var i = 0; i < arguments.length; ++i) {
                newArgs[i] = arguments[i];
            }
        ...
        $$ccr.registerClass('Microsoft.Crm.Workflow.Expressions.' + $$cn, Microsoft.Crm.Workflow.Expressions.EntityBase, Microsoft.Crm.Workflow.Expressions.IEntityBaseDecorator);
...
Microsoft.Crm.Workflow.Expressions.EntityDecoratorFactory = function Microsoft_Crm_Workflow_Expressions_EntityDecoratorFactory() {
}
Microsoft.Crm.Workflow.Expressions.EntityDecoratorFactory.getDecorator = function Microsoft_Crm_Workflow_Expressions_EntityDecoratorFactory$getDecorator(entity, metadataProvider) {
...
Microsoft.Crm.Workflow.Expressions.InvalidEntityDecorator = function Microsoft_Crm_Workflow_Expressions_InvalidEntityDecorator(entity, metadataProvider) {
    Microsoft.Crm.Workflow.Expressions.InvalidEntityDecorator.initializeBase(this, [ entity, metadataProvider ]);
}


Microsoft.Crm.Workflow.Expressions.PrimaryEntityDecorator = function Microsoft_Crm_Workflow_Expressions_PrimaryEntityDecorator(entity, metadataProvider) {
    Microsoft.Crm.Workflow.Expressions.PrimaryEntityDecorator.initializeBase(this, [ entity, metadataProvider ]);
}


Microsoft.Crm.Workflow.Expressions.RelatedEntityDecorator = function Microsoft_Crm_Workflow_Expressions_RelatedEntityDecorator(entity, metadataProvider) {
...
Microsoft.Crm.Workflow.Validators.IExpressionValidator.registerInterface('Microsoft.Crm.Workflow.Validators.IExpressionValidator');


Microsoft.Crm.Workflow.Validators.ICalculatedFieldValidatorContext = function() {}
Microsoft.Crm.Workflow.Validators.ICalculatedFieldValidatorContext.registerInterface('Microsoft.Crm.Workflow.Validators.ICalculatedFieldValidatorContext');


Microsoft.Crm.Workflow.Validators.IValidatorContext = function() {}
Microsoft.Crm.Workflow.Validators.IValidatorContext.registerInterface('Microsoft.Crm.Workflow.Validators.IValidatorContext');


Microsoft.Crm.Workflow.Validators.BaseValidatorContext = function Microsoft_Crm_Workflow_Validators_BaseValidatorContext() {
}
Microsoft.Crm.Workflow.Validators.BaseValidatorContext.prototype = {
    ...
    get_attributeLogicalName: function Microsoft_Crm_Workflow_Validators_BaseValidatorContext$get_attributeLogicalName() {
        return this._attributeLogicalName$0;
    },
    
    set_attributeLogicalName: function Microsoft_Crm_Workflow_Validators_BaseValidatorContext$set_attributeLogicalName(value) {
...
Microsoft.Crm.Workflow.Validators.CalculatedFieldValidatorContext = function Microsoft_Crm_Workflow_Validators_CalculatedFieldValidatorContext() {
    Microsoft.Crm.Workflow.Validators.CalculatedFieldValidatorContext.initializeBase(this);
}


Microsoft.Crm.Workflow.Validators.ExpressionValidator = function Microsoft_Crm_Workflow_Validators_ExpressionValidator() {
}
...
Microsoft.Crm.Workflow.Validators.UnaryExpressionValidator = function Microsoft_Crm_Workflow_Validators_UnaryExpressionValidator(expression) {
    ...
    var listItem = Microsoft.Crm.Workflow.Utils.SharedUtility.getList(Microsoft.Crm.Workflow.Expressions.WorkflowConditionOperator);
    listItem.add(0);
    listItem.add(1);
    Microsoft.Crm.Workflow.Utils.SharedUtility.dictionaryAdd(Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType, Sales.Common.Framework.IList$1.$$(Microsoft.Crm.Workflow.Expressions.WorkflowConditionOperator), this.applicableOperatorsDictionary, 0, listItem);
    Microsoft.Crm.Workflow.Utils.SharedUtility.dictionaryAdd(Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType, Sales.Common.Framework.IList$1.$$(Microsoft.Crm.Workflow.Expressions.WorkflowConditionOperator), this.applicableOperatorsDictionary, 6, listItem);
    Microsoft.Crm.Workflow.Utils.SharedUtility.dictionaryAdd(Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType, Sales.Common.Framework.IList$1.$$(Microsoft.Crm.Workflow.Expressions.WorkflowConditionOperator), this.applicableOperatorsDictionary, 11, listItem);
    Microsoft.Crm.Workflow.Utils.SharedUtility.dictionaryAdd(Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType, Sales.Common.Framework.IList$1.$$(Microsoft.Crm.Workflow.Expressions.WorkflowConditionOperator), this.applicableOperatorsDictionary, 1, listItem);
    Microsoft.Crm.Workflow.Utils.SharedUtility.dictionaryAdd(Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType, Sales.Common.Framework.IList$1.$$(Microsoft.Crm.Workflow.Expressions.WorkflowConditionOperator), this.applicableOperatorsDictionary, 8, listItem);
    Microsoft.Crm.Workflow.Utils.SharedUtility.dictionaryAdd(Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType, Sales.Common.Framework.IList$1.$$(Microsoft.Crm.Workflow.Expressions.WorkflowConditionOperator), this.applicableOperatorsDictionary, 2, listItem);
    Microsoft.Crm.Workflow.Utils.SharedUtility.dictionaryAdd(Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType, Sales.Common.Framework.IList$1.$$(Microsoft.Crm.Workflow.Expressions.WorkflowConditionOperator), this.applicableOperatorsDictionary, 5, listItem);
    Microsoft.Crm.Workflow.Utils.SharedUtility.dictionaryAdd(Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType, Sales.Common.Framework.IList$1.$$(Microsoft.Crm.Workflow.Expressions.WorkflowConditionOperator), this.applicableOperatorsDictionary, 3, listItem);
    Microsoft.Crm.Workflow.Utils.SharedUtility.dictionaryAdd(Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType, Sales.Common.Framework.IList$1.$$(Microsoft.Crm.Workflow.Expressions.WorkflowConditionOperator), this.applicableOperatorsDictionary, 14, listItem);
    Microsoft.Crm.Workflow.Utils.SharedUtility.dictionaryAdd(Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType, Sales.Common.Framework.IList$1.$$(Microsoft.Crm.Workflow.Expressions.WorkflowConditionOperator), this.applicableOperatorsDictionary, 7, listItem);
    Microsoft.Crm.Workflow.Utils.SharedUtility.dictionaryAdd(Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType, Sales.Common.Framework.IList$1.$$(Microsoft.Crm.Workflow.Expressions.WorkflowConditionOperator), this.applicableOperatorsDictionary, 4, listItem);
    Microsoft.Crm.Workflow.Utils.SharedUtility.dictionaryAdd(Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType, Sales.Common.Framework.IList$1.$$(Microsoft.Crm.Workflow.Expressions.WorkflowConditionOperator), this.applicableOperatorsDictionary, 10, listItem);
    Microsoft.Crm.Workflow.Utils.SharedUtility.dictionaryAdd(Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType, Sales.Common.Framework.IList$1.$$(Microsoft.Crm.Workflow.Expressions.WorkflowConditionOperator), this.applicableOperatorsDictionary, 12, listItem);
    Microsoft.Crm.Workflow.Utils.SharedUtility.dictionaryAdd(Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType, Sales.Common.Framework.IList$1.$$(Microsoft.Crm.Workflow.Expressions.WorkflowConditionOperator), this.applicableOperatorsDictionary, 13, listItem);
}
...
Microsoft.Crm.Workflow.Validators.BinaryExpressionValidator = function Microsoft_Crm_Workflow_Validators_BinaryExpressionValidator(expression) {
    ...
    Microsoft.Crm.Workflow.Validators.BinaryExpressionValidator._twoOptionOperator$p = Microsoft.Crm.Workflow.Utils.SharedUtility.getList(Microsoft.Crm.Workflow.Expressions.WorkflowConditionOperator);
    ...
    var listItem = null;
    listItem = Microsoft.Crm.Workflow.Utils.SharedUtility.getList(Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType);
    listItem.add(5);
    listItem.add(3);
    listItem.add(7);
    listItem.add(4);
    Microsoft.Crm.Workflow.Utils.SharedUtility.dictionaryAdd(Microsoft.Crm.Workflow.Expressions.WorkflowConditionOperator, Sales.Common.Framework.IList$1.$$(Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType), this._numericDictionary$p$1, 6, listItem);
    Microsoft.Crm.Workflow.Utils.SharedUtility.dictionaryAdd(Microsoft.Crm.Workflow.Expressions.WorkflowConditionOperator, Sales.Common.Framework.IList$1.$$(Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType), this._numericDictionary$p$1, 7, listItem);
    Microsoft.Crm.Workflow.Utils.SharedUtility.dictionaryAdd(Microsoft.Crm.Workflow.Expressions.WorkflowConditionOperator, Sales.Common.Framework.IList$1.$$(Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType), this._numericDictionary$p$1, 14, listItem);
    Microsoft.Crm.Workflow.Utils.SharedUtility.dictionaryAdd(Microsoft.Crm.Workflow.Expressions.WorkflowConditionOperator, Sales.Common.Framework.IList$1.$$(Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType), this._numericDictionary$p$1, 16, listItem);
    Microsoft.Crm.Workflow.Utils.SharedUtility.dictionaryAdd(Microsoft.Crm.Workflow.Expressions.WorkflowConditionOperator, Sales.Common.Framework.IList$1.$$(Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType), this._numericDictionary$p$1, 15, listItem);
    Microsoft.Crm.Workflow.Utils.SharedUtility.dictionaryAdd(Microsoft.Crm.Workflow.Expressions.WorkflowConditionOperator, Sales.Common.Framework.IList$1.$$(Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType), this._numericDictionary$p$1, 17, listItem);
    listItem = Microsoft.Crm.Workflow.Utils.SharedUtility.getList(Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType);
    listItem.add(2);
    Microsoft.Crm.Workflow.Utils.SharedUtility.dictionaryAdd(Microsoft.Crm.Workflow.Expressions.WorkflowConditionOperator, Sales.Common.Framework.IList$1.$$(Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType), this._dateTimeDictionary$p$1, 16, listItem);
    Microsoft.Crm.Workflow.Utils.SharedUtility.dictionaryAdd(Microsoft.Crm.Workflow.Expressions.WorkflowConditionOperator, Sales.Common.Framework.IList$1.$$(Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType), this._dateTimeDictionary$p$1, 17, listItem);
    Microsoft.Crm.Workflow.Utils.SharedUtility.dictionaryAdd(Microsoft.Crm.Workflow.Expressions.WorkflowConditionOperator, Sales.Common.Framework.IList$1.$$(Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType), this._dateTimeDictionary$p$1, 14, listItem);
    Microsoft.Crm.Workflow.Utils.SharedUtility.dictionaryAdd(Microsoft.Crm.Workflow.Expressions.WorkflowConditionOperator, Sales.Common.Framework.IList$1.$$(Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType), this._dateTimeDictionary$p$1, 15, listItem);
    Microsoft.Crm.Workflow.Utils.SharedUtility.dictionaryAdd(Microsoft.Crm.Workflow.Expressions.WorkflowConditionOperator, Sales.Common.Framework.IList$1.$$(Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType), this._dateTimeDictionary$p$1, 6, listItem);
    Microsoft.Crm.Workflow.Utils.SharedUtility.dictionaryAdd(Microsoft.Crm.Workflow.Expressions.WorkflowConditionOperator, Sales.Common.Framework.IList$1.$$(Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType), this._dateTimeDictionary$p$1, 7, listItem);
    listItem = Microsoft.Crm.Workflow.Utils.SharedUtility.getList(Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType);
    listItem.add(0);
    Microsoft.Crm.Workflow.Utils.SharedUtility.dictionaryAdd(Microsoft.Crm.Workflow.Expressions.WorkflowConditionOperator, Sales.Common.Framework.IList$1.$$(Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType), this._booleanDictionary$p$1, 6, listItem);
    Microsoft.Crm.Workflow.Utils.SharedUtility.dictionaryAdd(Microsoft.Crm.Workflow.Expressions.WorkflowConditionOperator, Sales.Common.Framework.IList$1.$$(Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType), this._booleanDictionary$p$1, 7, listItem);
    Microsoft.Crm.Workflow.Utils.SharedUtility.dictionaryAdd(Microsoft.Crm.Workflow.Expressions.WorkflowConditionOperator, Sales.Common.Framework.IList$1.$$(Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType), this._booleanDictionary$p$1, 2, listItem);
    Microsoft.Crm.Workflow.Utils.SharedUtility.dictionaryAdd(Microsoft.Crm.Workflow.Expressions.WorkflowConditionOperator, Sales.Common.Framework.IList$1.$$(Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType), this._booleanDictionary$p$1, 3, listItem);
    listItem = Microsoft.Crm.Workflow.Utils.SharedUtility.getList(Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType);
    listItem.add(10);
    Microsoft.Crm.Workflow.Utils.SharedUtility.dictionaryAdd(Microsoft.Crm.Workflow.Expressions.WorkflowConditionOperator, Sales.Common.Framework.IList$1.$$(Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType), this._picklistDictionary$p$1, 6, listItem);
    Microsoft.Crm.Workflow.Utils.SharedUtility.dictionaryAdd(Microsoft.Crm.Workflow.Expressions.WorkflowConditionOperator, Sales.Common.Framework.IList$1.$$(Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType), this._picklistDictionary$p$1, 7, listItem);
    listItem = Microsoft.Crm.Workflow.Utils.SharedUtility.getList(Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType);
    listItem.add(12);
    Microsoft.Crm.Workflow.Utils.SharedUtility.dictionaryAdd(Microsoft.Crm.Workflow.Expressions.WorkflowConditionOperator, Sales.Common.Framework.IList$1.$$(Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType), this._statusDictionary$p$1, 6, listItem);
    Microsoft.Crm.Workflow.Utils.SharedUtility.dictionaryAdd(Microsoft.Crm.Workflow.Expressions.WorkflowConditionOperator, Sales.Common.Framework.IList$1.$$(Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType), this._statusDictionary$p$1, 7, listItem);
    listItem = Microsoft.Crm.Workflow.Utils.SharedUtility.getList(Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType);
    listItem.add(13);
    Microsoft.Crm.Workflow.Utils.SharedUtility.dictionaryAdd(Microsoft.Crm.Workflow.Expressions.WorkflowConditionOperator, Sales.Common.Framework.IList$1.$$(Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType), this._statusReasonDictionary$p$1, 6, listItem);
    Microsoft.Crm.Workflow.Utils.SharedUtility.dictionaryAdd(Microsoft.Crm.Workflow.Expressions.WorkflowConditionOperator, Sales.Common.Framework.IList$1.$$(Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType), this._statusReasonDictionary$p$1, 7, listItem);
    listItem = Microsoft.Crm.Workflow.Utils.SharedUtility.getList(Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType);
    listItem.add(14);
    Microsoft.Crm.Workflow.Utils.SharedUtility.dictionaryAdd(Microsoft.Crm.Workflow.Expressions.WorkflowConditionOperator, Sales.Common.Framework.IList$1.$$(Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType), this._stringDictionary$p$1, 6, listItem);
    Microsoft.Crm.Workflow.Utils.SharedUtility.dictionaryAdd(Microsoft.Crm.Workflow.Expressions.WorkflowConditionOperator, Sales.Common.Framework.IList$1.$$(Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType), this._stringDictionary$p$1, 7, listItem);
    Microsoft.Crm.Workflow.Utils.SharedUtility.dictionaryAdd(Microsoft.Crm.Workflow.Expressions.WorkflowConditionOperator, Sales.Common.Framework.IList$1.$$(Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType), this._stringDictionary$p$1, 8, listItem);
    Microsoft.Crm.Workflow.Utils.SharedUtility.dictionaryAdd(Microsoft.Crm.Workflow.Expressions.WorkflowConditionOperator, Sales.Common.Framework.IList$1.$$(Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType), this._stringDictionary$p$1, 9, listItem);
    Microsoft.Crm.Workflow.Utils.SharedUtility.dictionaryAdd(Microsoft.Crm.Workflow.Expressions.WorkflowConditionOperator, Sales.Common.Framework.IList$1.$$(Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType), this._stringDictionary$p$1, 10, listItem);
    Microsoft.Crm.Workflow.Utils.SharedUtility.dictionaryAdd(Microsoft.Crm.Workflow.Expressions.WorkflowConditionOperator, Sales.Common.Framework.IList$1.$$(Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType), this._stringDictionary$p$1, 11, listItem);
    Microsoft.Crm.Workflow.Utils.SharedUtility.dictionaryAdd(Microsoft.Crm.Workflow.Expressions.WorkflowConditionOperator, Sales.Common.Framework.IList$1.$$(Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType), this._stringDictionary$p$1, 12, listItem);
    Microsoft.Crm.Workflow.Utils.SharedUtility.dictionaryAdd(Microsoft.Crm.Workflow.Expressions.WorkflowConditionOperator, Sales.Common.Framework.IList$1.$$(Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType), this._stringDictionary$p$1, 13, listItem);
}
Microsoft.Crm.Workflow.Validators.BinaryExpressionValidator.prototype = {
    ...
    getTypeDictionary: function Microsoft_Crm_Workflow_Validators_BinaryExpressionValidator$getTypeDictionary(expressionType) {
...
Microsoft.Crm.Workflow.Validators._methodCallArithmeticEvaluateExpressionValidator = function Microsoft_Crm_Workflow_Validators__methodCallArithmeticEvaluateExpressionValidator(operands, expressionOperator, context) {
    Microsoft.Crm.Workflow.Validators._methodCallArithmeticEvaluateExpressionValidator.initializeBase(this, [ operands, expressionOperator, context ]);
    if (!this._operands$0) {
        this._context$0.trace('Operand array passed into {0} is null', Object.getType(this).getName());
        Microsoft.Crm.Workflow.Utils.SharedUtility.throwException(-2147089372, this._context$0.get_attributeLogicalName());
    }
    if (this._operands$0.length !== 2) {
        this._context$0.trace('Invalid number of operands in {0}: expected {1} actual {2}', Object.getType(this).getName(), this._operands$0.length, 2);
        Microsoft.Crm.Workflow.Utils.SharedUtility.throwException(-2147089372, this._context$0.get_attributeLogicalName());
    }
    this._validWorkflowAttributeTypeWithRankings$p$1 = {};
    Microsoft.Crm.Workflow.Utils.SharedUtility.dictionaryAdd(Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType, Number, this._validWorkflowAttributeTypeWithRankings$p$1, 5, 1);
    Microsoft.Crm.Workflow.Utils.SharedUtility.dictionaryAdd(Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType, Number, this._validWorkflowAttributeTypeWithRankings$p$1, 3, 2);
    Microsoft.Crm.Workflow.Utils.SharedUtility.dictionaryAdd(Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType, Number, this._validWorkflowAttributeTypeWithRankings$p$1, 7, 3);
}
Microsoft.Crm.Workflow.Validators._methodCallArithmeticEvaluateExpressionValidator.prototype = {
    ...
    validate: function Microsoft_Crm_Workflow_Validators__methodCallArithmeticEvaluateExpressionValidator$validate() {
        ...
        this._type$0 = Microsoft.Crm.Workflow.Validators.TypeUtility.methodCallExpressionSetTypeFromRank(this._validWorkflowAttributeTypeWithRankings$p$1, this._operands$0);
        if (this._operator$0 === 3) {
            this._validateDivisor$p$1();
        }
    },
    
    _validateDivisor$p$1: function Microsoft_Crm_Workflow_Validators__methodCallArithmeticEvaluateExpressionValidator$_validateDivisor$p$1() {
        for (var i = 1; i < this._operands$0.length; i++) {
            var divisor = Microsoft.Crm.Workflow.Expressions.MethodCallExpression.extractSelectFirstNull(this._operands$0[i]);
            ...
            this._context$0.trace('Attempted to divide by zero in sub-formula {0} in {1}', i, primitiveDivisor.primitiveValue.toString(), Object.getType(this).getName());
            Microsoft.Crm.Workflow.Utils.SharedUtility.throwException(-2147089363, primitiveDivisor.primitiveValue.toString());
        }
    },
    
    _validateArithmeticOperandCompatibility$p$1: function Microsoft_Crm_Workflow_Validators__methodCallArithmeticEvaluateExpressionValidator$_validateArithmeticOperandCompatibility$p$1() {
        var leftexpression = this._operands$0[0];
        var left = leftexpression.type;
        if (!Microsoft.Crm.Workflow.Utils.SharedUtility.dictionaryContainKey(Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType, Number, this._validWorkflowAttributeTypeWithRankings$p$1, left)) {
            this._context$0.trace('Invalid operand #{0} of WorkflowAttributeType {1} in {2}', 0, Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType.toString(left), Object.getType(this).getName());
            Microsoft.Crm.Workflow.Utils.SharedUtility.throwException(-2147089370, Microsoft.Crm.Workflow.FormulaDisplayVisitor.expressionToString(leftexpression), Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType.toString(left));
        }
        for (var i = 1; i < this._operands$0.length; i++) {
            var expression = this._operands$0[i];
            var right = expression.type;
            if (!Microsoft.Crm.Workflow.Utils.SharedUtility.dictionaryContainKey(Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType, Number, this._validWorkflowAttributeTypeWithRankings$p$1, right)) {
                this._context$0.trace('Invalid operand #{0} of WorkflowAttributeType {1} in {2}', i, Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType.toString(right), Object.getType(this).getName());
                Microsoft.Crm.Workflow.Utils.SharedUtility.throwException(-2147089370, Microsoft.Crm.Workflow.FormulaDisplayVisitor.expressionToString(expression), Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType.toString(right));
            }
        }
    }
}
...
Microsoft.Crm.Workflow.Validators._methodCallDateMathEvaluateExpressionValidator = function Microsoft_Crm_Workflow_Validators__methodCallDateMathEvaluateExpressionValidator(expressions, expressionOperator, context) {
    Microsoft.Crm.Workflow.Validators._methodCallDateMathEvaluateExpressionValidator.initializeBase(this, [ expressions, expressionOperator, context ]);
    switch (expressionOperator) {
        case 42:
        case 47:
        case 43:
...
Microsoft.Crm.Workflow.Validators._methodCallDateMathEvaluateExpressionValidator.prototype = {
    ...
    validate: function Microsoft_Crm_Workflow_Validators__methodCallDateMathEvaluateExpressionValidator$validate() {
        ...
        if (this._operands$0.length !== 2) {
            this._context$0.trace('Invalid number of operands in {0}: expected {1} actual {2}', Object.getType(this).getName(), 2, this._operands$0.length);
            Microsoft.Crm.Workflow.Utils.SharedUtility.throwException(-2147089372, this._context$0.get_attributeLogicalName());
        }
        var operand0 = this._operands$0[0];
        var operand1 = this._operands$0[1];
        if (!operand0 || !operand1) {
            this._context$0.trace('One or more null operands have been passed into {0}', Object.getType(this).getName());
            Microsoft.Crm.Workflow.Utils.SharedUtility.throwException(-2147089372, this._context$0.get_attributeLogicalName());
        }
        ...
        switch (this._operator$0) {
            ...
            case 46:
                if (operand0.type !== 2) {
                    this._context$0.trace('Unexpected operand #{0} in {1}: expected {2} actual {3}', 0, Object.getType(this).getName(), Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType.toString(5), Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType.toString(operand0.type));
                    Microsoft.Crm.Workflow.Utils.SharedUtility.throwException(-2147089364, Microsoft.Crm.Workflow.FormulaDisplayVisitor.expressionToString(operand0), Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType.toString(operand0.type));
                }
                if (operand1.type !== 2) {
                    this._context$0.trace('Unexpected operand #{0} in {1}: expected {2} actual {3}', 1, Object.getType(this).getName(), Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType.toString(2), Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType.toString(operand1.type));
                    Microsoft.Crm.Workflow.Utils.SharedUtility.throwException(-2147089364, Microsoft.Crm.Workflow.FormulaDisplayVisitor.expressionToString(operand1), Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType.toString(operand1.type));
                }
                if (operand0.behavior !== operand1.behavior) {
                    this._context$0.trace('Invalid operand #{0} of WorkflowAttributeType {1} in {2}', 1, Object.getType(this).getName(), Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType.toString(2), Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType.toString(operand1.type));
                    Microsoft.Crm.Workflow.Utils.SharedUtility.throwException(-2147089364, Microsoft.Crm.Workflow.FormulaDisplayVisitor.expressionToString(operand1), Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType.toString(operand1.type));
                }
                if ((this._operator$0 === 42 || this._operator$0 === 43) && operand0.behavior === 2) {
                    this._context$0.trace('Invalid operand #{0} of WorkflowAttributeType {1} in {2}', 1, Object.getType(this).getName(), Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType.toString(2), Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType.toString(operand1.type));
                    Microsoft.Crm.Workflow.Utils.SharedUtility.throwException(-2147089370, Microsoft.Crm.Workflow.FormulaDisplayVisitor.expressionToString(operand1), Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType.toString(operand1.type));
                }
                break;
            default:
                if (operand0.type !== 5) {
...
Microsoft.Crm.Workflow.Validators.MethodCallEvaluateExpressionValidatorBase = function Microsoft_Crm_Workflow_Validators_MethodCallEvaluateExpressionValidatorBase(operands, expressionOperator, context) {
...
Microsoft.Crm.Workflow.Validators.MethodCallEvaluateExpressionValidatorBase.prototype = {
    ...
    get_operands: function Microsoft_Crm_Workflow_Validators_MethodCallEvaluateExpressionValidatorBase$get_operands() {
        return this._operands$0;
    },
    
    set_operands: function Microsoft_Crm_Workflow_Validators_MethodCallEvaluateExpressionValidatorBase$set_operands(value) {
    ...
    get_type: function Microsoft_Crm_Workflow_Validators_MethodCallEvaluateExpressionValidatorBase$get_type() {
        return this._type$0;
    },
    
    set_type: function Microsoft_Crm_Workflow_Validators_MethodCallEvaluateExpressionValidatorBase$set_type(value) {
        this._type$0 = value;
        return value;
    },
    ...
    get_behaviorType: function Microsoft_Crm_Workflow_Validators_MethodCallEvaluateExpressionValidatorBase$get_behaviorType() {
        return this._behaviorType$0;
    },
    
    set_behaviorType: function Microsoft_Crm_Workflow_Validators_MethodCallEvaluateExpressionValidatorBase$set_behaviorType(value) {
    ...
    get_context: function Microsoft_Crm_Workflow_Validators_MethodCallEvaluateExpressionValidatorBase$get_context() {
        return this._context$0;
    },
    
    set_context: function Microsoft_Crm_Workflow_Validators_MethodCallEvaluateExpressionValidatorBase$set_context(value) {
        this._context$0 = value;
        return value;
    },
    ...
    get_operator: function Microsoft_Crm_Workflow_Validators_MethodCallEvaluateExpressionValidatorBase$get_operator() {
        return this._operator$0;
    },
    
    set_operator: function Microsoft_Crm_Workflow_Validators_MethodCallEvaluateExpressionValidatorBase$set_operator(value) {
...
Microsoft.Crm.Workflow.Validators.MethodCallEvaluateExpressionValidatorFactory = function Microsoft_Crm_Workflow_Validators_MethodCallEvaluateExpressionValidatorFactory() {
}
Microsoft.Crm.Workflow.Validators.MethodCallEvaluateExpressionValidatorFactory.getValidator = function Microsoft_Crm_Workflow_Validators_MethodCallEvaluateExpressionValidatorFactory$getValidator(expressionOperator, expressions, context) {
    ...
    switch (expressionOperator) {
        ...
        case 2:
        case 3:
            evaluateExpressionSqlGenerator = new Microsoft.Crm.Workflow.Validators._methodCallArithmeticEvaluateExpressionValidator(expressions, expressionOperator, context);
            break;
        case 25:
        case 27:
        case 29:
        ...
        case 46:
        case 47:
            evaluateExpressionSqlGenerator = new Microsoft.Crm.Workflow.Validators._methodCallDateMathEvaluateExpressionValidator(expressions, expressionOperator, context);
            break;
        case 22:
        case 24:
        case 23:
            evaluateExpressionSqlGenerator = new Microsoft.Crm.Workflow.Validators._methodCallStringEvaluateExpressionValidator(expressions, expressionOperator, context);
            break;
        case 35:
        case 37:
        case 39:
        ...
        case 36:
            break;
        default:
            context.trace('Unexpected expression operator {0} in {1}', Microsoft.Crm.Workflow.Activities.ExpressionOperator.toString(expressionOperator), Microsoft.Crm.Workflow.Validators.MethodCallEvaluateExpressionValidatorFactory.getName());
            Microsoft.Crm.Workflow.Utils.SharedUtility.throwException(-2147089369, Microsoft.Crm.Workflow.Activities.ExpressionOperator.toString(expressionOperator));
            break;
    }
...
Microsoft.Crm.Workflow.Validators._methodCallStringEvaluateExpressionValidator = function Microsoft_Crm_Workflow_Validators__methodCallStringEvaluateExpressionValidator(operands, expressionOperator, context) {
    Microsoft.Crm.Workflow.Validators._methodCallStringEvaluateExpressionValidator.initializeBase(this, [ operands, expressionOperator, context ]);
    this._type$0 = 14;
}
    ...
    validate: function Microsoft_Crm_Workflow_Validators__methodCallStringEvaluateExpressionValidator$validate() {
        switch (this._operator$0) {
            ...
            case 23:
                ...
                break;
            default:
                this._context$0.trace('Unexpected expression operator {0} in {1}', Microsoft.Crm.Workflow.Activities.ExpressionOperator.toString(this._operator$0), Object.getType(this).getName());
                Microsoft.Crm.Workflow.Utils.SharedUtility.throwException(-2147089369, Microsoft.Crm.Workflow.Activities.ExpressionOperator.toString(this._operator$0));
                break;
        }
    },
    
    validateConcat: function Microsoft_Crm_Workflow_Validators__methodCallStringEvaluateExpressionValidator$validateConcat() {
        if (!this._operands$0) {
            this._context$0.trace('Operand array passed into {0} is null', Object.getType(this).getName());
            Microsoft.Crm.Workflow.Utils.SharedUtility.throwException(-2147089372, this._context$0.get_attributeLogicalName());
        }
        if (this._operands$0.length < 2) {
            this._context$0.trace('Invalid number of operands in {0}: expected {1} actual {2}', Object.getType(this).getName(), '>1', this._operands$0.length);
            Microsoft.Crm.Workflow.Utils.SharedUtility.throwException(-2147089372, this._context$0.get_attributeLogicalName());
        }
        var expression = null;
        for (var i = 0; i < this._operands$0.length; i++) {
            ...
            if (expression.type !== 14 && expression.type !== 5 && expression.type !== 7 && expression.type !== 3) {
                this._context$0.trace('Invalid operand #{0} of WorkflowAttributeType {1} in {2}', i, Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType.toString(expression.type), Object.getType(this).getName());
                Microsoft.Crm.Workflow.Utils.SharedUtility.throwException(-2147089364, Microsoft.Crm.Workflow.FormulaDisplayVisitor.expressionToString(expression), Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType.toString(expression.type));
            }
        }
    },
    
    validateTrim: function Microsoft_Crm_Workflow_Validators__methodCallStringEvaluateExpressionValidator$validateTrim() {
        if (!this._operands$0) {
            this._context$0.trace('Operand array passed into {0} is null', Object.getType(this).getName());
            Microsoft.Crm.Workflow.Utils.SharedUtility.throwException(-2147089372, this._context$0.get_attributeLogicalName());
        }
        ...
        if (expression1.type !== 14) {
            this._context$0.trace('Unexpected operand #{0} in {1}: expected {2} actual {3}', 0, Object.getType(this).getName(), Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType.toString(14), Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType.toString(expression1.type));
            Microsoft.Crm.Workflow.Utils.SharedUtility.throwException(-2147089364, Microsoft.Crm.Workflow.FormulaDisplayVisitor.expressionToString(expression1), Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType.toString(expression1.type));
        }
        if (expression2.type !== 5 && expression2.type !== 3) {
            this._context$0.trace('Unexpected operand #{0} in {1}: expected {2} actual {3}', 1, Object.getType(this).getName(), Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType.toString(5), Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType.toString(expression2.type));
            Microsoft.Crm.Workflow.Utils.SharedUtility.throwException(-2147089364, Microsoft.Crm.Workflow.FormulaDisplayVisitor.expressionToString(expression2), Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType.toString(expression2.type));
        }
    }
}


Microsoft.Crm.Workflow.Validators.MethodCallExpressionValidator = function Microsoft_Crm_Workflow_Validators_MethodCallExpressionValidator(expression) {
...
Microsoft.Crm.Workflow.Validators.MethodCallExpressionValidator.prototype = {
    ...
    validate: function Microsoft_Crm_Workflow_Validators_MethodCallExpressionValidator$validate() {
        switch (this._expression$1.method) {
            ...
            case 0:
                ...
                break;
            default:
                this._context$0.trace('Unexpected method call {0} in {1}', Microsoft.Crm.Workflow.Expressions.MethodCall.toString(this._expression$1.method), Object.getType(this).getName());
                Microsoft.Crm.Workflow.Utils.SharedUtility.throwException(-2147089372, this._context$0.get_attributeLogicalName());
                break;
        }
    },
    
    _validateEvaluateExpression$p$1: function Microsoft_Crm_Workflow_Validators_MethodCallExpressionValidator$_validateEvaluateExpression$p$1() {
        ...
        if (parameters.length < 1) {
            this._context$0.trace('Invalid number of parameters in {0}: expected {1} actual {2}', Object.getType(this).getName(), '>=1', parameters.length);
            Microsoft.Crm.Workflow.Utils.SharedUtility.throwException(-2147089372, this._context$0.get_attributeLogicalName());
        }
        ...
        if (parameters.length !== methodCallExpressions.length + 1) {
            this._context$0.trace('Invalid number of operands in {0}: expected {1} actual {2}', Object.getType(this).getName(), parameters.length - 1, methodCallExpressions.length);
            Microsoft.Crm.Workflow.Utils.SharedUtility.throwException(-2147089372, this._context$0.get_attributeLogicalName());
        }
        var validator = Microsoft.Crm.Workflow.Validators.MethodCallEvaluateExpressionValidatorFactory.getValidator(expressionOperator, methodCallExpressions, this._context$0);
        validator.validate();
    ...
    _validateSelectFirstNonNull$p$1: function Microsoft_Crm_Workflow_Validators_MethodCallExpressionValidator$_validateSelectFirstNonNull$p$1() {
        var parameters = this._expression$1.getParameters();
        if (!parameters) {
            this._context$0.trace('Parameter array passed into {0} is null', Object.getType(this).getName());
            Microsoft.Crm.Workflow.Utils.SharedUtility.throwException(-2147089372, this._context$0.get_attributeLogicalName());
        ...
        if ((Microsoft.Crm.Workflow.Expressions.EntityAttributeExpression.isInstanceOfType(parameters[0]) || Microsoft.Crm.Workflow.Expressions.MethodCallExpression.isInstanceOfType(parameters[0])) && this._expression$1.type === 2 && !this._expression$1.behavior) {
...
Microsoft.Crm.Workflow.Validators.SetAttributeValueStepValidator = function Microsoft_Crm_Workflow_Validators_SetAttributeValueStepValidator() {
    this._validAssignmentMapping$p$0 = {};
    this._context$0 = new Microsoft.Crm.Workflow.Validators.CalculatedFieldValidatorContext();
    var listItem = null;
    listItem = Microsoft.Crm.Workflow.Utils.SharedUtility.getList(Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType);
    listItem.add(0);
    Microsoft.Crm.Workflow.Utils.SharedUtility.dictionaryAdd(Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType, Sales.Common.Framework.IList$1.$$(Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType), this._validAssignmentMapping$p$0, 0, listItem);
    listItem = Microsoft.Crm.Workflow.Utils.SharedUtility.getList(Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType);
    listItem.add(2);
    Microsoft.Crm.Workflow.Utils.SharedUtility.dictionaryAdd(Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType, Sales.Common.Framework.IList$1.$$(Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType), this._validAssignmentMapping$p$0, 2, listItem);
    listItem = Microsoft.Crm.Workflow.Utils.SharedUtility.getList(Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType);
    listItem.add(3);
    listItem.add(5);
    listItem.add(7);
    Microsoft.Crm.Workflow.Utils.SharedUtility.dictionaryAdd(Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType, Sales.Common.Framework.IList$1.$$(Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType), this._validAssignmentMapping$p$0, 3, listItem);
    listItem = Microsoft.Crm.Workflow.Utils.SharedUtility.getList(Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType);
    listItem.add(3);
    listItem.add(5);
    listItem.add(7);
    Microsoft.Crm.Workflow.Utils.SharedUtility.dictionaryAdd(Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType, Sales.Common.Framework.IList$1.$$(Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType), this._validAssignmentMapping$p$0, 5, listItem);
    listItem = Microsoft.Crm.Workflow.Utils.SharedUtility.getList(Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType);
    listItem.add(3);
    listItem.add(5);
    listItem.add(7);
    Microsoft.Crm.Workflow.Utils.SharedUtility.dictionaryAdd(Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType, Sales.Common.Framework.IList$1.$$(Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType), this._validAssignmentMapping$p$0, 7, listItem);
    listItem = Microsoft.Crm.Workflow.Utils.SharedUtility.getList(Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType);
    listItem.add(10);
    Microsoft.Crm.Workflow.Utils.SharedUtility.dictionaryAdd(Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType, Sales.Common.Framework.IList$1.$$(Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType), this._validAssignmentMapping$p$0, 10, listItem);
    listItem = Microsoft.Crm.Workflow.Utils.SharedUtility.getList(Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType);
    listItem.add(14);
    listItem.add(3);
    listItem.add(5);
    listItem.add(7);
    Microsoft.Crm.Workflow.Utils.SharedUtility.dictionaryAdd(Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType, Sales.Common.Framework.IList$1.$$(Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType), this._validAssignmentMapping$p$0, 14, listItem);
}
Microsoft.Crm.Workflow.Validators.SetAttributeValueStepValidator.prototype = {
    _validAssignmentMapping$p$0: null,
    _context$0: null,
    
    validateAssignmentApplicability: function Microsoft_Crm_Workflow_Validators_SetAttributeValueStepValidator$validateAssignmentApplicability(attributeType, attributeBehaviorDateTimeType, expression) {
        ...
        if (!Microsoft.Crm.Workflow.Utils.SharedUtility.dictionaryContainKey(Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType, Sales.Common.Framework.IList$1.$$(Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType), this._validAssignmentMapping$p$0, calculatedFieldAttribute)) {
            this._context$0.trace('Attribute {0} is not a valid calculated field', Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType.toString(assignmentType));
            Microsoft.Crm.Workflow.Utils.SharedUtility.throwException(-2147089372, this._context$0.get_attributeLogicalName());
        }
        if (!Microsoft.Crm.Workflow.Utils.SharedUtility.dictionaryGetValue(Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType, Sales.Common.Framework.IList$1.$$(Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType), this._validAssignmentMapping$p$0, calculatedFieldAttribute).contains(assignmentType)) {
            this._context$0.trace('Attribute type {0} is not a valid for set on {1} type calculated field', Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType.toString(assignmentType), Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType.toString(calculatedFieldAttribute));
            Microsoft.Crm.Workflow.Utils.SharedUtility.throwException(-2147089365, Microsoft.Crm.Workflow.FormulaDisplayVisitor.expressionToString(expression), Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType.toString(assignmentType), Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType.toString(calculatedFieldAttribute));
        }
        if (calculatedFieldAttribute === 2 && exprressionDateTimeBehaviorType !== calculatedFieldAttributeBehaviorType) {
...
Microsoft.Crm.Workflow.Validators.TypeUtility.methodCallExpressionSetTypeFromRank = function Microsoft_Crm_Workflow_Validators_TypeUtility$methodCallExpressionSetTypeFromRank(rankDictionary, operands) {
    var maxRankType = 0;
    var isfirstExpression = true;
    for (var $$arr_4 = operands, $$len_5 = $$arr_4.length, $$idx_6 = 0; $$idx_6 < $$len_5; ++$$idx_6) {
        var operand = $$arr_4[$$idx_6];
        Microsoft.Crm.Workflow.Utils.ExceptionUtility.assert(Microsoft.Crm.Workflow.Utils.SharedUtility.dictionaryContainKey(Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType, Number, rankDictionary, operand.type), 'dictionary does not contain key');
        if (isfirstExpression) {
            maxRankType = operand.type;
            isfirstExpression = false;
            continue;
        }
        if (Microsoft.Crm.Workflow.Utils.SharedUtility.dictionaryGetValue(Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType, Number, rankDictionary, operand.type) > Microsoft.Crm.Workflow.Utils.SharedUtility.dictionaryGetValue(Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType, Number, rankDictionary, maxRankType)) {
            maxRankType = operand.type;
        }
    }
    return maxRankType;
...
ProcessObjectModel.Visitors.IBusinessProcessFlowVisitor.registerInterface('ProcessObjectModel.Visitors.IBusinessProcessFlowVisitor');


ProcessObjectModel.Visitors.IBusinessProcessFlowStepVisitor = function() {}
ProcessObjectModel.Visitors.IBusinessProcessFlowStepVisitor.registerInterface('ProcessObjectModel.Visitors.IBusinessProcessFlowStepVisitor');


ProcessObjectModel.Visitors.IBusinessProcessFlowStepVisitorFactory = function() {}
ProcessObjectModel.Visitors.IBusinessProcessFlowStepVisitorFactory.registerInterface('ProcessObjectModel.Visitors.IBusinessProcessFlowStepVisitorFactory');
...
ProcessObjectModel.Visitors._conditionStepVisitor.prototype = {
    ...
    visit: function ProcessObjectModel_Visitors__conditionStepVisitor$visit(step) {
        ...
        Sys.Debug.assert(Microsoft.Crm.Workflow.ObjectModel.ConditionStep.isInstanceOfType(step), 'Condition step should not be invalid');
...
ProcessObjectModel.Visitors._relationshipCollectionStepVisitor = function ProcessObjectModel_Visitors__relationshipCollectionStepVisitor() {
...
ProcessObjectModel.Visitors._relationshipCollectionStepVisitor.prototype = {
    ...
    visit: function ProcessObjectModel_Visitors__relationshipCollectionStepVisitor$visit(step) {
        ProcessObjectModel.Visitors._businessProcessFlowStepVisitorBase.prototype.visit.call(this, step);
        Sys.Debug.assert(Microsoft.Crm.Workflow.ObjectModel.RelationshipCollectionStep.isInstanceOfType(step), 'RelationshipCollection step should not be invalid');
...
ProcessObjectModel.Visitors._entityStepVisitor.prototype = {
    ...
    visit: function ProcessObjectModel_Visitors__entityStepVisitor$visit(step) {
        ProcessObjectModel.Visitors._businessProcessFlowStepVisitorBase.prototype.visit.call(this, step);
        Sys.Debug.assert(Microsoft.Crm.Workflow.ObjectModel.EntityStep.isInstanceOfType(step), 'Workflow step should not be invalid');
        var entityStep = step;
        this._businessProcessFlowVisitor$p$0.addEntity(entityStep);
        this.visitChildren(entityStep);
    },
    
    createStepVisitor: function ProcessObjectModel_Visitors__entityStepVisitor$createStepVisitor(parentStep, step, businessProcessVisitor) {
        var stepVisitor = this._stepVisitorFactory$p$0.createStepVisitor(step, this._businessProcessFlowVisitor$p$0);
...
ProcessObjectModel.Visitors._businessProcessFlowStepVisitorBase = function ProcessObjectModel_Visitors__businessProcessFlowStepVisitorBase() {
}
ProcessObjectModel.Visitors._businessProcessFlowStepVisitorBase.prototype = {
    ...
    get_stepVisitorFactory: function ProcessObjectModel_Visitors__businessProcessFlowStepVisitorBase$get_stepVisitorFactory() {
        return this._stepVisitorFactory$p$0;
    },
    
    set_stepVisitorFactory: function ProcessObjectModel_Visitors__businessProcessFlowStepVisitorBase$set_stepVisitorFactory(value) {
        this._stepVisitorFactory$p$0 = value;
        return value;
    },
    
    get_businessProcessFlowVisitor: function ProcessObjectModel_Visitors__businessProcessFlowStepVisitorBase$get_businessProcessFlowVisitor() {
        return this._businessProcessFlowVisitor$p$0;
    },
    
    set_businessProcessFlowVisitor: function ProcessObjectModel_Visitors__businessProcessFlowStepVisitorBase$set_businessProcessFlowVisitor(value) {
    ...
    visit: function ProcessObjectModel_Visitors__businessProcessFlowStepVisitorBase$visit(step) {
        Sys.Debug.assert(!Mscrm.InternalUtilities.JSTypes.isNull(this._businessProcessFlowVisitor$p$0), 'Business Process Flow visitor should not be null');
    ...
    visitChildren: function ProcessObjectModel_Visitors__businessProcessFlowStepVisitorBase$visitChildren(step) {
        Sys.Debug.assert(!Mscrm.InternalUtilities.JSTypes.isNull(step), 'Composite step should not be null while visiting its children');
        Sys.Debug.assert(!Mscrm.InternalUtilities.JSTypes.isNull(this._stepVisitorFactory$p$0), 'Step Visitor Factory should not be null');
        Sys.Debug.assert(!Mscrm.InternalUtilities.JSTypes.isNull(this._businessProcessFlowVisitor$p$0), 'Business Process Flow visitor should not be null');
        for (var i = 0; i < step.steps.get_Count(); i++) {
    ...
    createStepVisitor: function ProcessObjectModel_Visitors__businessProcessFlowStepVisitorBase$createStepVisitor(parentStep, step, businessProcessVisitor) {
...
ProcessObjectModel.Visitors._stageStepVisitor.prototype = {
    ...
    visit: function ProcessObjectModel_Visitors__stageStepVisitor$visit(step) {
        ProcessObjectModel.Visitors._businessProcessFlowStepVisitorBase.prototype.visit.call(this, step);
        Sys.Debug.assert(Microsoft.Crm.Workflow.ObjectModel.StageStep.isInstanceOfType(step), 'Workflow step should not be invalid');
        var stageStep = step;
...
ProcessObjectModel.Visitors._stepVisitorFactory.prototype = {
    ...
    createStepVisitor: function ProcessObjectModel_Visitors__stepVisitorFactory$createStepVisitor(step, businessProcessFlowVisitor) {
...
ProcessObjectModel.Visitors.BusinessProcessFlowVisitor = function ProcessObjectModel_Visitors_BusinessProcessFlowVisitor() {
}
ProcessObjectModel.Visitors.BusinessProcessFlowVisitor.prototype = {
    ...
    get__relationshipsMapping$p$0: function ProcessObjectModel_Visitors_BusinessProcessFlowVisitor$get__relationshipsMapping$p$0() {
    ...
    _calculateFirstLevelStages$p$0: function ProcessObjectModel_Visitors_BusinessProcessFlowVisitor$_calculateFirstLevelStages$p$0() {
        ...
        while (!Mscrm.InternalUtilities._String.isNullOrWhiteSpace(nextStageStep.nextStageId)) {
            Sys.Debug.assert(((nextStageStep.nextStageId) in this.get_stagesById()), 'Next stage id should not be invalid');
            nextStageStep = this.get_stagesById()[nextStageStep.nextStageId];
            this._firstLevelStages$p$0[nextStageStep.stageId] = nextStageStep;
        }
    },
    
    get_areConditionsPresent: function ProcessObjectModel_Visitors_BusinessProcessFlowVisitor$get_areConditionsPresent() {
    ...
    get_entitiesByEntityName: function ProcessObjectModel_Visitors_BusinessProcessFlowVisitor$get_entitiesByEntityName() {
    ...
    get_conditionsByParentStageId: function ProcessObjectModel_Visitors_BusinessProcessFlowVisitor$get_conditionsByParentStageId() {
    ...
    get_parentEntityStepByStageId: function ProcessObjectModel_Visitors_BusinessProcessFlowVisitor$get_parentEntityStepByStageId() {
    ...
    getRelationshipStep: function ProcessObjectModel_Visitors_BusinessProcessFlowVisitor$getRelationshipStep(sourceStageId, targetStageId) {
    ...
    getRelationshipStepsByTargetStage: function ProcessObjectModel_Visitors_BusinessProcessFlowVisitor$getRelationshipStepsByTargetStage(targetStageId) {
        Sys.Debug.assert(!Mscrm.InternalUtilities.JSTypes.isNullOrEmptyString(targetStageId), 'Expected targetStageId to be not empty and a valid guid.');
        if (!this._backCompatRelationsHandled$p$0) {
            this._updateRelationshipsMappingForBackCompatible$p$0();
        }
        var targetStageIdKey = Microsoft.Crm.Workflow.Utils.StringUtility.reduceToCanonicalForm(targetStageId);
    ...
    _updateRelationshipsMappingForBackCompatible$p$0: function ProcessObjectModel_Visitors_BusinessProcessFlowVisitor$_updateRelationshipsMappingForBackCompatible$p$0() {
        for (var i = 0; i < this.get_entities().length - 1; i++) {
            ...
            if (Mscrm.InternalUtilities.JSTypes.isNullOrEmptyString(relationshipName) || Mscrm.InternalUtilities.JSTypes.isNullOrEmptyString(attributeName)) {
                continue;
            }
            var lastStageInCurrentEntity = currentEntityStep.steps.get_item(currentEntityStep.steps.get_Count() - 1);
            var firstStageInNextEntity = nextEntityStep.steps.get_item(0);
            var newRelationshipStep = new Microsoft.Crm.Workflow.ObjectModel.RelationshipStep(currentEntityStep._workflow$p$0);
            newRelationshipStep.relationshipName = relationshipName;
            newRelationshipStep.attributeName = attributeName;
            newRelationshipStep.sourceStageId = Microsoft.Crm.Workflow.Utils.StringUtility.reduceToCanonicalForm(lastStageInCurrentEntity.stageId);
            newRelationshipStep.targetStageId = Microsoft.Crm.Workflow.Utils.StringUtility.reduceToCanonicalForm(firstStageInNextEntity.stageId);
    ...
    visit: function ProcessObjectModel_Visitors_BusinessProcessFlowVisitor$visit(workflowStep) {
        Sys.Debug.assert(!Mscrm.InternalUtilities.JSTypes.isNull(workflowStep), 'Workflow step should not be null while visiting it');
    ...
    get_businessProcessFlowStepVisitorFactory: function ProcessObjectModel_Visitors_BusinessProcessFlowVisitor$get_businessProcessFlowStepVisitorFactory() {
    ...
    set_businessProcessFlowStepVisitorFactory: function ProcessObjectModel_Visitors_BusinessProcessFlowVisitor$set_businessProcessFlowStepVisitorFactory(value) {
    ...
    addEntity: function ProcessObjectModel_Visitors_BusinessProcessFlowVisitor$addEntity(entityStep) {
        Sys.Debug.assert(!Mscrm.InternalUtilities.JSTypes.isNull(entityStep), 'Entity step should not be null while adding it');
    ...
    addStage: function ProcessObjectModel_Visitors_BusinessProcessFlowVisitor$addStage(entityStep, stageStep) {
        ...
        Sys.Debug.assert(!Mscrm.InternalUtilities.JSTypes.isNull(stageStep), 'Stage step should not be null while adding it to the collection');
    ...
    addCondition: function ProcessObjectModel_Visitors_BusinessProcessFlowVisitor$addCondition(condition) {
        Sys.Debug.assert(!Mscrm.InternalUtilities.JSTypes.isNull(condition), 'Condition step should not be null while adding it to collection');
        Sys.Debug.assert(Microsoft.Crm.Workflow.ObjectModel.StageStep.isInstanceOfType(condition.get_parent()), 'Condition step parent should not be null');
        ...
        Sys.Debug.assert(!((stageId) in this.get_conditionsByParentStageId()), 'Condition step\'s parent stage id should not be invalid');
    ...
    addRelationship: function ProcessObjectModel_Visitors_BusinessProcessFlowVisitor$addRelationship(relationship) {
        if (Mscrm.InternalUtilities.JSTypes.isNullOrEmptyString(relationship.sourceStageId) || Mscrm.InternalUtilities.JSTypes.isNullOrEmptyString(relationship.targetStageId)) {
            return;
        }
        var sourceStageIdKey = Microsoft.Crm.Workflow.Utils.StringUtility.reduceToCanonicalForm(relationship.sourceStageId);
        var targetStageIdKey = Microsoft.Crm.Workflow.Utils.StringUtility.reduceToCanonicalForm(relationship.targetStageId);
        if (((targetStageIdKey) in this.get__relationshipsMapping$p$0())) {
...
ProcessObjectModel.Visitors._workflowStepVisitor.prototype = {
    ...
    visit: function ProcessObjectModel_Visitors__workflowStepVisitor$visit(step) {
        ProcessObjectModel.Visitors._businessProcessFlowStepVisitorBase.prototype.visit.call(this, step);
        Sys.Debug.assert(Microsoft.Crm.Workflow.ObjectModel.WorkflowStep.isInstanceOfType(step), 'Workflow step should not be valid');
...
Microsoft.Crm.Workflow.SharedExpressionVisitor.registerClass('Microsoft.Crm.Workflow.SharedExpressionVisitor', Microsoft.Crm.Workflow.ObjectModel.StepVisitorBase, Microsoft.Crm.Workflow.Expressions.IExpressionVisitor);
Microsoft.Crm.Workflow.FormulaDisplayVisitor.registerClass('Microsoft.Crm.Workflow.FormulaDisplayVisitor', Microsoft.Crm.Workflow.SharedExpressionVisitor);
Microsoft.Crm.Workflow.CrmTimeSpan.registerClass('Microsoft.Crm.Workflow.CrmTimeSpan');
Microsoft.Crm.Workflow.DataSourceCollection.registerClass('Microsoft.Crm.Workflow.DataSourceCollection', Microsoft.Crm.Workflow.ObjectModel.DataCollection$1.$$(Microsoft.Crm.Workflow.ObjectModel.IDataSource));
...
Microsoft.Crm.Workflow.ObjectModel.AssignStep.registerClass('Microsoft.Crm.Workflow.ObjectModel.AssignStep', Microsoft.Crm.Workflow.ObjectModel.StepBase);
Microsoft.Crm.Workflow.ObjectModel.AssignVariableStep.registerClass('Microsoft.Crm.Workflow.ObjectModel.AssignVariableStep', Microsoft.Crm.Workflow.ObjectModel.StepBase);
...
Microsoft.Crm.Workflow.ObjectModel.ActionStep.registerClass('Microsoft.Crm.Workflow.ObjectModel.ActionStep', Microsoft.Crm.Workflow.ObjectModel.CompositeStepBase);
Microsoft.Crm.Workflow.ObjectModel.ProcessTriggerData.registerClass('Microsoft.Crm.Workflow.ObjectModel.ProcessTriggerData');
...
Microsoft.Crm.Workflow.ObjectModel.RelationshipCollectionStep.registerClass('Microsoft.Crm.Workflow.ObjectModel.RelationshipCollectionStep', Microsoft.Crm.Workflow.ObjectModel.CompositeStepBase);
Microsoft.Crm.Workflow.ObjectModel.RelationshipStep.registerClass('Microsoft.Crm.Workflow.ObjectModel.RelationshipStep', Microsoft.Crm.Workflow.ObjectModel.StepBase);
...
Microsoft.Crm.Workflow.ObjectModel.ChildWorkflowStep.registerClass('Microsoft.Crm.Workflow.ObjectModel.ChildWorkflowStep', Microsoft.Crm.Workflow.ObjectModel.StepBase);
...
Microsoft.Crm.Workflow.ObjectModel.CreateStep.registerClass('Microsoft.Crm.Workflow.ObjectModel.CreateStep', Microsoft.Crm.Workflow.ObjectModel.StepBase);
Microsoft.Crm.Workflow.ObjectModel.CustomActivityInfoBase.registerClass('Microsoft.Crm.Workflow.ObjectModel.CustomActivityInfoBase');
Microsoft.Crm.Workflow.ObjectModel.CustomActivityInfo.registerClass('Microsoft.Crm.Workflow.ObjectModel.CustomActivityInfo', Microsoft.Crm.Workflow.ObjectModel.CustomActivityInfoBase);
Microsoft.Crm.Workflow.ObjectModel.CustomParameterInfoBase.registerClass('Microsoft.Crm.Workflow.ObjectModel.CustomParameterInfoBase');
Microsoft.Crm.Workflow.ObjectModel.CustomActivityParameterInfo.registerClass('Microsoft.Crm.Workflow.ObjectModel.CustomActivityParameterInfo', Microsoft.Crm.Workflow.ObjectModel.CustomParameterInfoBase);
Microsoft.Crm.Workflow.ObjectModel.CustomStepBase.registerClass('Microsoft.Crm.Workflow.ObjectModel.CustomStepBase', Microsoft.Crm.Workflow.ObjectModel.StepBase);
Microsoft.Crm.Workflow.ObjectModel.CustomActivityStep.registerClass('Microsoft.Crm.Workflow.ObjectModel.CustomActivityStep', Microsoft.Crm.Workflow.ObjectModel.CustomStepBase);
...
Microsoft.Crm.Workflow.ObjectModel.EntityDataSource.registerClass('Microsoft.Crm.Workflow.ObjectModel.EntityDataSource', null, Microsoft.Crm.Workflow.ObjectModel.IDataSource);
Microsoft.Crm.Workflow.ObjectModel.ChildInteractiveWorkflowStep.registerClass('Microsoft.Crm.Workflow.ObjectModel.ChildInteractiveWorkflowStep', Microsoft.Crm.Workflow.ObjectModel.StepBase);
Microsoft.Crm.Workflow.ObjectModel.InteractionPageStep.registerClass('Microsoft.Crm.Workflow.ObjectModel.InteractionPageStep', Microsoft.Crm.Workflow.ObjectModel.CompositeStepBase);
Microsoft.Crm.Workflow.ObjectModel.InteractionStep.registerClass('Microsoft.Crm.Workflow.ObjectModel.InteractionStep', Microsoft.Crm.Workflow.ObjectModel.StepBase);
Microsoft.Crm.Workflow.ObjectModel.InteractiveWorkflowInputDictionary.registerClass('Microsoft.Crm.Workflow.ObjectModel.InteractiveWorkflowInputDictionary');
Microsoft.Crm.Workflow.ObjectModel.InteractiveWorkflowInputDictionary._wrapper.registerClass('Microsoft.Crm.Workflow.ObjectModel.InteractiveWorkflowInputDictionary._wrapper');
...
Microsoft.Crm.Workflow.ObjectModel._publicationParametersFactory.registerClass('Microsoft.Crm.Workflow.ObjectModel._publicationParametersFactory');
...
Microsoft.Crm.Workflow.ObjectModel.SetDefaultValueStep.registerClass('Microsoft.Crm.Workflow.ObjectModel.SetDefaultValueStep', Microsoft.Crm.Workflow.ObjectModel.SetValueStepBase);
...
Microsoft.Crm.Workflow.ObjectModel.SetNextStageStep.registerClass('Microsoft.Crm.Workflow.ObjectModel.SetNextStageStep', Microsoft.Crm.Workflow.ObjectModel.StepBase);
...
Microsoft.Crm.Workflow.ObjectModel.QueryStep.registerClass('Microsoft.Crm.Workflow.ObjectModel.QueryStep', Microsoft.Crm.Workflow.ObjectModel.StepBase);
Microsoft.Crm.Workflow.ObjectModel.RollupRuleStep.registerClass('Microsoft.Crm.Workflow.ObjectModel.RollupRuleStep', Microsoft.Crm.Workflow.ObjectModel.StepBase);
Microsoft.Crm.Workflow.ObjectModel.SendEmailStep.registerClass('Microsoft.Crm.Workflow.ObjectModel.SendEmailStep', Microsoft.Crm.Workflow.ObjectModel.StepBase);
Microsoft.Crm.Workflow.ObjectModel.SetStateStep.registerClass('Microsoft.Crm.Workflow.ObjectModel.SetStateStep', Microsoft.Crm.Workflow.ObjectModel.StepBase);
...
Microsoft.Crm.Workflow.ObjectModel.PageStep.registerClass('Microsoft.Crm.Workflow.ObjectModel.PageStep', Microsoft.Crm.Workflow.ObjectModel.StageStep);
Microsoft.Crm.Workflow.ObjectModel.UpdateStep.registerClass('Microsoft.Crm.Workflow.ObjectModel.UpdateStep', Microsoft.Crm.Workflow.ObjectModel.StepBase);
Microsoft.Crm.Workflow.ObjectModel.WaitBranchStep.registerClass('Microsoft.Crm.Workflow.ObjectModel.WaitBranchStep', Microsoft.Crm.Workflow.ObjectModel.CompositeStepBase);
Microsoft.Crm.Workflow.ObjectModel.WaitStep.registerClass('Microsoft.Crm.Workflow.ObjectModel.WaitStep', Microsoft.Crm.Workflow.ObjectModel.CompositeStepBase);
Microsoft.Crm.Workflow.ObjectModel.WaitTimeoutStep.registerClass('Microsoft.Crm.Workflow.ObjectModel.WaitTimeoutStep', Microsoft.Crm.Workflow.ObjectModel.CompositeStepBase);
Microsoft.Crm.Workflow.ObjectModel.WorkflowArgument.registerClass('Microsoft.Crm.Workflow.ObjectModel.WorkflowArgument');
...
Microsoft.Crm.Workflow.ObjectModel.DataValueCollection.registerClass('Microsoft.Crm.Workflow.ObjectModel.DataValueCollection', Microsoft.Crm.Workflow.ObjectModel.DataCollection$1.$$(Microsoft.Crm.Workflow.ObjectModel.DataValue));
Microsoft.Crm.Workflow.ObjectModel.ProcessDefinitionVisitorBase.registerClass('Microsoft.Crm.Workflow.ObjectModel.ProcessDefinitionVisitorBase', Microsoft.Crm.Workflow.ObjectModel.StepVisitorBase, Microsoft.Crm.Workflow.Expressions.IExpressionVisitor);
...
Microsoft.Crm.Workflow.Expressions.RelatedEntity.registerClass('Microsoft.Crm.Workflow.Expressions.RelatedEntity', Microsoft.Crm.Workflow.Expressions.EntityBase);
Microsoft.Crm.Workflow.Expressions.RelatedEntityLinked.registerClass('Microsoft.Crm.Workflow.Expressions.RelatedEntityLinked', Microsoft.Crm.Workflow.Expressions.RelatedEntity);
Microsoft.Crm.Workflow.Expressions.EntityCreatedByStep.registerClass('Microsoft.Crm.Workflow.Expressions.EntityCreatedByStep', Microsoft.Crm.Workflow.Expressions.EntityBase);
Microsoft.Crm.Workflow.Expressions.EntitySpecification.registerClass('Microsoft.Crm.Workflow.Expressions.EntitySpecification');
...
Microsoft.Crm.Workflow.Expressions.EntityCreatedByStepDecorator.registerClass('Microsoft.Crm.Workflow.Expressions.EntityCreatedByStepDecorator', Microsoft.Crm.Workflow.Expressions.EntityBaseDecorator$1.$$(Microsoft.Crm.Workflow.Expressions.EntityCreatedByStep));
Microsoft.Crm.Workflow.Expressions.EntityDecoratorFactory.registerClass('Microsoft.Crm.Workflow.Expressions.EntityDecoratorFactory');
Microsoft.Crm.Workflow.Expressions.InvalidEntityDecorator.registerClass('Microsoft.Crm.Workflow.Expressions.InvalidEntityDecorator', Microsoft.Crm.Workflow.Expressions.EntityBaseDecorator$1.$$(Microsoft.Crm.Workflow.Expressions.InvalidEntity));
Microsoft.Crm.Workflow.Expressions.PrimaryEntityDecorator.registerClass('Microsoft.Crm.Workflow.Expressions.PrimaryEntityDecorator', Microsoft.Crm.Workflow.Expressions.EntityBaseDecorator$1.$$(Microsoft.Crm.Workflow.Expressions.PrimaryEntity));
Microsoft.Crm.Workflow.Expressions.RelatedEntityDecorator.registerClass('Microsoft.Crm.Workflow.Expressions.RelatedEntityDecorator', Microsoft.Crm.Workflow.Expressions.EntityBaseDecorator$1.$$(Microsoft.Crm.Workflow.Expressions.RelatedEntity));
Microsoft.Crm.Workflow.Validators.BaseValidatorContext.registerClass('Microsoft.Crm.Workflow.Validators.BaseValidatorContext', null, Microsoft.Crm.Workflow.Validators.IValidatorContext);
Microsoft.Crm.Workflow.Validators.CalculatedFieldValidatorContext.registerClass('Microsoft.Crm.Workflow.Validators.CalculatedFieldValidatorContext', Microsoft.Crm.Workflow.Validators.BaseValidatorContext, Microsoft.Crm.Workflow.Validators.ICalculatedFieldValidatorContext, Microsoft.Crm.Workflow.Validators.IValidatorContext);
Microsoft.Crm.Workflow.Validators.ExpressionValidator.registerClass('Microsoft.Crm.Workflow.Validators.ExpressionValidator', null, Microsoft.Crm.Workflow.Validators.IExpressionValidator);
Microsoft.Crm.Workflow.Validators.UnaryExpressionValidator.registerClass('Microsoft.Crm.Workflow.Validators.UnaryExpressionValidator', Microsoft.Crm.Workflow.Validators.ExpressionValidator);
Microsoft.Crm.Workflow.Validators.BinaryExpressionValidator.registerClass('Microsoft.Crm.Workflow.Validators.BinaryExpressionValidator', Microsoft.Crm.Workflow.Validators.ExpressionValidator);
Microsoft.Crm.Workflow.Validators.MethodCallEvaluateExpressionValidatorBase.registerClass('Microsoft.Crm.Workflow.Validators.MethodCallEvaluateExpressionValidatorBase');
Microsoft.Crm.Workflow.Validators._methodCallArithmeticEvaluateExpressionValidator.registerClass('Microsoft.Crm.Workflow.Validators._methodCallArithmeticEvaluateExpressionValidator', Microsoft.Crm.Workflow.Validators.MethodCallEvaluateExpressionValidatorBase);
Microsoft.Crm.Workflow.Validators._methodCallDateMathEvaluateExpressionValidator.registerClass('Microsoft.Crm.Workflow.Validators._methodCallDateMathEvaluateExpressionValidator', Microsoft.Crm.Workflow.Validators.MethodCallEvaluateExpressionValidatorBase);
Microsoft.Crm.Workflow.Validators.MethodCallEvaluateExpressionValidatorFactory.registerClass('Microsoft.Crm.Workflow.Validators.MethodCallEvaluateExpressionValidatorFactory');
Microsoft.Crm.Workflow.Validators._methodCallStringEvaluateExpressionValidator.registerClass('Microsoft.Crm.Workflow.Validators._methodCallStringEvaluateExpressionValidator', Microsoft.Crm.Workflow.Validators.MethodCallEvaluateExpressionValidatorBase);
Microsoft.Crm.Workflow.Validators.MethodCallExpressionValidator.registerClass('Microsoft.Crm.Workflow.Validators.MethodCallExpressionValidator', Microsoft.Crm.Workflow.Validators.ExpressionValidator);
Microsoft.Crm.Workflow.Validators.SetAttributeValueStepValidator.registerClass('Microsoft.Crm.Workflow.Validators.SetAttributeValueStepValidator');
Microsoft.Crm.Workflow.Validators.TypeUtility.registerClass('Microsoft.Crm.Workflow.Validators.TypeUtility');
ProcessObjectModel.Visitors._businessProcessFlowStepVisitorBase.registerClass('ProcessObjectModel.Visitors._businessProcessFlowStepVisitorBase');
ProcessObjectModel.Visitors._conditionStepVisitor.registerClass('ProcessObjectModel.Visitors._conditionStepVisitor', ProcessObjectModel.Visitors._businessProcessFlowStepVisitorBase, ProcessObjectModel.Visitors.IBusinessProcessFlowStepVisitor);
ProcessObjectModel.Visitors._relationshipCollectionStepVisitor.registerClass('ProcessObjectModel.Visitors._relationshipCollectionStepVisitor', ProcessObjectModel.Visitors._businessProcessFlowStepVisitorBase, ProcessObjectModel.Visitors.IBusinessProcessFlowStepVisitor);
ProcessObjectModel.Visitors._entityStepVisitor.registerClass('ProcessObjectModel.Visitors._entityStepVisitor', ProcessObjectModel.Visitors._businessProcessFlowStepVisitorBase, ProcessObjectModel.Visitors.IBusinessProcessFlowStepVisitor);
ProcessObjectModel.Visitors._stageStepVisitor.registerClass('ProcessObjectModel.Visitors._stageStepVisitor', ProcessObjectModel.Visitors._businessProcessFlowStepVisitorBase, ProcessObjectModel.Visitors._iStageStepVisitor, ProcessObjectModel.Visitors.IBusinessProcessFlowStepVisitor);
ProcessObjectModel.Visitors._stepVisitorFactory.registerClass('ProcessObjectModel.Visitors._stepVisitorFactory', null, ProcessObjectModel.Visitors.IBusinessProcessFlowStepVisitorFactory);
ProcessObjectModel.Visitors.BusinessProcessFlowVisitor.registerClass('ProcessObjectModel.Visitors.BusinessProcessFlowVisitor', null, ProcessObjectModel.Visitors.IBusinessProcessFlowVisitor);
ProcessObjectModel.Visitors._workflowStepVisitor.registerClass('ProcessObjectModel.Visitors._workflowStepVisitor', ProcessObjectModel.Visitors._businessProcessFlowStepVisitorBase, ProcessObjectModel.Visitors.IBusinessProcessFlowStepVisitor);
...
Microsoft.Crm.Workflow.Utils.TraceConstants.invalidParameterCount = 'Invalid number of parameters in {0}: expected {1} actual {2}';
Microsoft.Crm.Workflow.Utils.TraceConstants.nullOperands = 'One or more null operands have been passed into {0}';
Microsoft.Crm.Workflow.Utils.TraceConstants.invalidOperandCount = 'Invalid number of operands in {0}: expected {1} actual {2}';
Microsoft.Crm.Workflow.Utils.TraceConstants.invalidOperandType = 'Invalid operand #{0} of WorkflowAttributeType {1} in {2}';
Microsoft.Crm.Workflow.Utils.TraceConstants.incompatibleOperator = 'Operator {0} is not compatible with operand type {1} in {2}';
Microsoft.Crm.Workflow.Utils.TraceConstants.incompatibleOperand = 'Operand {0} is not compatible with operand type {1} and operator {2} in {3}';
Microsoft.Crm.Workflow.Utils.TraceConstants.invalidExpressionType = 'Invalid expression #{0} of type {1} in {2}';
Microsoft.Crm.Workflow.Utils.TraceConstants.unexpectedOperandType = 'Unexpected operand #{0} in {1}: expected {2} actual {3}';
...
Microsoft.Crm.Workflow.Utils.TraceConstants.nullAttributeMetadata = 'Metadata is null attempting to get {0} attribute in {1}';
Microsoft.Crm.Workflow.Utils.TraceConstants.invalidAttribute = 'Attribute {0} from entity {1} in {2} is not valid for calculated field';
Microsoft.Crm.Workflow.Utils.TraceConstants.invalidSetAttribute = 'Attribute {0} is not a valid calculated field';
Microsoft.Crm.Workflow.Utils.TraceConstants.invalidTypeAssignment = 'Attribute type {0} is not a valid for set on {1} type calculated field';
Microsoft.Crm.Workflow.Utils.TraceConstants.rollupInvalidTypeAssignment = 'Attribute type {0} is not a valid for set on {1} type rollup field';
...
Microsoft.Crm.Workflow.Utils.TraceConstants.invalidDateOnlyBehaviorAssignment = 'You can only use a Date Only type of field.';
Microsoft.Crm.Workflow.Utils.TraceConstants.invalidTimeInvBehaviorAssignment = 'You can only use a Time-Zone Independent Date Time type of field.';
Microsoft.Crm.Workflow.Utils.TraceConstants.invalidUserLocBehaviorAssignment = 'You can only use a User Local Date Time type of field.';
...
Microsoft.Crm.Workflow.Utils.TraceConstants.invalidChildStepCount = 'Invalid child step count for {0} type in {1}: expected {2} actual {3}';
Microsoft.Crm.Workflow.Utils.TraceConstants.typeNotSupported = '{0} type is not supported in {1}';
Microsoft.Crm.Workflow.Utils.TraceConstants.childStepTypeNotSupported = 'Child {0} type is not supported for {1} in {1}';
Microsoft.Crm.Workflow.Utils.TraceConstants.invalidFieldToSet = 'Can\'t set field in {0}: attempted to set {1}, expected to set {2}';
...
Microsoft.Crm.Workflow.Utils.TraceConstants.invalidNumberOfRollupSteps = 'There can be only one rollup step within the workflow';
Microsoft.Crm.Workflow.Utils.TraceConstants.rollupTargetRelationshipNotGiven = 'When hierarchy is not specified, then target relationship should be specified';
Microsoft.Crm.Workflow.Utils.TraceConstants.rollupSourceFilterGiven = 'When source filter is given, then hierarchy should be specified on the rollup';
Microsoft.Crm.Workflow.Utils.TraceConstants.targetEntityNotPartOfOneToNRelationship = 'Target entity {0} is not part of the 1:N relationship with entity {1}';
Microsoft.Crm.Workflow.Utils.TraceConstants.targetEntitySameAsSourceEntity = 'Self referential 1:N relationships are not allowed for the rollup field';
...
Microsoft.Crm.Workflow.Utils.TraceConstants.filterCanOnlyContainPersistentFields = 'Rollup filter conditions can only filter based on persistent fields. Field {0} is not a persistent field';
Microsoft.Crm.Workflow.Utils.TraceConstants.sourceEntityShouldBeHierarchical = 'When hierarchy is specified, source entity {0} should be hierarchical';
Microsoft.Crm.Workflow.Utils.TraceConstants.attributeNotSupportedForAggregate = 'Attribute data type {0} is not supported for aggregate operator {1}';
Microsoft.Crm.Workflow.Utils.TraceConstants.aggregateOnRollupFieldOrComplexCalcFieldNotAllowed = 'Aggregated field must be either a Simple field or a basic Calculated field';
Microsoft.Crm.Workflow.Utils.TraceConstants.rollupFieldAggregateFunctionNotAllowed = 'The aggregate function {0} isn\u2019t allowed.';
Microsoft.Crm.Workflow.Utils.TraceConstants.rollupFieldAggregateFunctionNotAllowedForRollupFieldDataType = 'The aggregate function {0} isn\u2019t allowed when the rollup field is a {1} data type.';
Microsoft.Crm.Workflow.Utils.TraceConstants.attributeCannotBeUsedInAggregate = 'The {0} attribute cannot be used with an aggregation function in a rollup formula.';
Microsoft.Crm.Workflow.Utils.TraceConstants.sourceFilterAttributeNotExistInSourceEntity = 'Source filter attribute {0} does not exist in source entity {1}.';
Microsoft.Crm.Workflow.Utils.TraceConstants.targetFilterAttributeNotExistInTargetEntity = 'Target filter attribute {0} does not exist in target entity {1}.';
Microsoft.Crm.Workflow.Utils.TraceConstants.aggregateFieldNotExistInSourceOrTargetEntity = 'Aggregate field {0} does not exist in {1} entity {2}';
Microsoft.Crm.Workflow.Utils.TraceConstants.aggregateFieldTypeNotSupportedForRollupFieldType = 'Aggregare field {0} not supported for rollup field of type {1}';
Microsoft.Crm.Workflow.Utils.TraceConstants.rollupFieldDataTypeInvalid = 'The {0} data type isn\u2019t valid for the rollup field.';
Microsoft.Crm.Workflow.Utils.TraceConstants.sourceTypeMaskInvalid = 'The attribute {0} in entity {1} has an invalid sourceTypeMask in {2}.';
Microsoft.Crm.Workflow.Utils.TraceConstants.rollupTargetLinkedEntityOnlySupportedForActivityEntities = 'Target related entity is only supported for rollup over {0} type entities.';
Microsoft.Crm.Workflow.Utils.TraceConstants.rollupTargetLinkedEntityCanOnlyUsedForActivityPartyEntities = 'Target related entity can only be used for {0} entity for rollup over {1} type entities.';
Microsoft.Crm.Workflow.Utils.TraceConstants.rollupInvalidAttributeForFilterCondition = 'The {0} attribute is not allowed for filter condition.';
Microsoft.Crm.Workflow.Utils.TraceConstants.rollupTargetLinkedRelationshipNotValid = 'Target Linked Relationship {0} is not valid.';
