...
(function(jQuery)
{
    ...
    {
        $.vakata = {};
        $.vakata.css = {get_css:function(rule_name,delete_flag,sheet)
        {
        ...
        $.jstree = {defaults:{plugins:[]},_focused:function()
        {
        ...
        },_fn:{},plugin:function(pname,pdata)
        {
                ...
                $.jstree._fn[i] = function()
                {
                    ...
                    else
                    {
                        ...
                        if(typeof rslt !== "undefined")
                            args = rslt;
                        rslt = func.apply($.extend({},this,{__callback:function(data)
                        {
        ...
        $.jstree.plugin("core",{__init:function()
        {
            this.data.core.locked = false;
            this.data.core.to_open = this.get_settings().core.initially_open;
            this.data.core.to_load = this.get_settings().core.initially_load
        },defaults:{html_titles:false,animation:500,initially_open:[],initially_load:[],open_parents:true,notify_plugins:true,rtl:false,load_open:false,strings:{loading:"Loading ...",new_node:"New node",multiple_selection:"Multiple selection"}},_fn:{init:function()
        {
            this.set_focus();
            ...
            this._get_settings().core.notify_plugins && this.get_container().bind("load_node.jstree",$.proxy(function(e,data)
            {
                ...
                {
                    var th = $(this);
                    th.data("jstree") && $.each(th.data("jstree"),function(plugin,values)
                    {
                        t.data[plugin] && $.isFunction(t["_" + plugin + "_notify"]) && t["_" + plugin + "_notify"].call(t,th,values)
                    })
                })
            },this));
            this._get_settings().core.load_open && this.get_container().bind("load_node.jstree",$.proxy(function(e,data)
            {
                var o = this._get_node(data.rslt.obj),
                    t = this;
                if(o === -1)
        ...
        },reload_nodes:function(is_callback)
        {
            ...
            this.data.core.to_open.length && $.each(this.data.core.to_open,function(i,val)
            {
        ...
        },open_node:function(obj,callback,skip_animation)
        {
            ...
            {
                this._get_settings().core.open_parents && obj.parentsUntil(".jstree",".jstree-closed").each(function()
                {
        ...
        },delete_node:function(obj)
        {
            ...
            obj = obj.detach();
            p !== -1 && p.find("> ul > li").length === 0 && p.removeClass("jstree-open jstree-closed").addClass("jstree-leaf");
            this.clean_node(p);
        ...
        },move_node:function(obj,ref,position,is_copy,is_prepared,skip_check)
        {
            ...
            try
            {
                ...
                !obj.op.find("> ul > li").length && obj.op.removeClass("jstree-open jstree-closed").addClass("jstree-leaf").children("ul").remove()
            }
            catch(e)
            {
            }
    ...
    (function($)
    {
        ...
        $(function()
        {
            ...
            {
                e1 = $('<textarea cols="10" rows="2"></textarea>').css({position:"absolute",top:-1e3,left:0}).appendTo("body");
                e2 = $('<textarea cols="10" rows="2" style="overflow: hidden;"></textarea>').css({position:"absolute",top:-1e3,left:0}).appendTo("body");
                scrollbar_width = e1.width() - e2.width();
                e1.add(e2).remove()
            }
            else
            {
                e1 = $("<div />").css({width:100,height:100,overflow:"auto",position:"absolute",top:-1e3,left:0}).prependTo("body").append("<div />").find("div").css({width:"100%",height:200});
        ...
        $.jstree.plugin("ui",{__init:function()
        {
            ...
            this.get_container().delegate("a","click.jstree",$.proxy(function(event)
            {
                ...
                !$(event.currentTarget).hasClass("jstree-loading") && this.select_node(event.currentTarget,true,event)
            ...
            },this)).bind("delete_node.jstree",$.proxy(function(event,data)
            {
                ...
                s && clk.length && data.rslt.prev.each(function()
                {
                    if(this.parentNode)
                    {
        ...
        },save_selected:function()
        {
            ...
            {
                this.id && _this.data.ui.to_select.push("#" + this.id.toString().replace(/^#/,"").replace(/\\\//g,"/").replace(/\//g,"\\/").replace(/\\\./g,".").replace(/\./g,"\\.").replace(/\:/g,"\\:"))
            });
        ...
        },select_node:function(obj,check,e)
        {
            ...
            if(proceed && !is_selected)
            {
                ...
                s.selected_parent_open && obj.parents(".jstree-closed").each(function()
                {
                    t.open_node(this,false,true)
                });
    ...
    (function($)
    {
        $.jstree.plugin("crrm",{__init:function()
        {
        ...
        },defaults:{input_width_limit:200,move:{always_copy:false,open_onmove:true,default_position:"last",check_move:function(m)
        {
            return true
        }}},_fn:{_show_input:function(obj,callback)
        {
            obj = this._get_node(obj);
            var rtl = this._get_settings().core.rtl,
                ...
                h2 = obj.css("position","relative").append($("<input />",{value:t,"class":"jstree-rename-input",css:{padding:"0",border:"1px solid silver",position:"absolute",left:rtl ? "auto" : w1 + w2 + 4 + "px",right:rtl ? w1 + w2 + 4 + "px" : "auto",top:"0px",height:this.data.core.li_height - 2 + "px",lineHeight:this.data.core.li_height - 2 + "px",width:"150px"},blur:$.proxy(function()
                {
    ...
    (function($)
    {
        ...
        $.jstree.plugin("themes",{__init:function()
        {
        ...
        $(function()
        {
            $.jstree._themes === false && $("script").each(function()
            {
    ...
    (function($)
    {
        $.jstree.plugin("json_data",{__init:function()
        {
            var s = this._get_settings().json_data;
            s.progressive_unload && this.get_container().bind("after_close.jstree",function(e,data)
            {
                data.rslt.obj.children("ul").remove()
            })
        },defaults:{data:false,ajax:false,correct_state:true,progressive_render:false,progressive_unload:false},_fn:{load_node:function(obj,s_call,e_call)
        {
            var _this = this;
        ...
        },refresh:function(obj)
        {
            obj = this._get_node(obj);
            var s = this._get_settings().json_data;
            obj && obj !== -1 && s.progressive_unload && ($.isFunction(s.data) || !!s.ajax) && obj.removeData("jstree_children");
            return this.__call_old()
        ...
        },get_json:function(obj,li_attr,a_attr,is_callback)
        {
            ...
            obj.each(function()
            {
                ...
                a.each(function()
                {
                    ...
                    {
                        lang = false;
                        $.inArray("languages",s.plugins) !== -1 && $.isArray(s.languages) && s.languages.length && $.each(s.languages,function(l,lv)
                        {
                            if(t.hasClass(lv))
                            {
                                lang = lv;
                        ...
                        $.inArray("languages",s.plugins) !== -1 && $.isArray(s.languages) && s.languages.length && $.each(s.languages,function(k,z)
                        {
                            if(t.hasClass(z))
                            {
                                tmp2.language = z;
    ...
    (function($)
    {
        $.jstree.plugin("languages",{__init:function()
        {
            this._load_css()
        },defaults:[],_fn:{set_lang:function(i)
        {
            ...
            var t = this.__call_old(true,obj,position,js,function(t)
                {
                    ...
                    {
                        for(ln = 0; ln < langs.length; ln++)
                            !a.is("." + langs[ln]) && t.append(a.eq(0).clone().removeClass(langs.join(" ")).addClass(langs[ln]));
    ...
    (function($)
    {
        $.jstree.plugin("sort",{__init:function()
        {
    ...
    (function($)
    {
        ...
        $.jstree.plugin("search",{__init:function()
        {
            this.data.search.str = "";
            this.data.search.result = $();
            this._get_settings().search.show_only_matches && this.get_container().bind("search.jstree",function(e,data)
            {
        ...
        },defaults:{ajax:false,search_method:"jstree_contains",show_only_matches:false},_fn:{search:function(str,skip_async)
        {
            if($.trim(str) === "")
            {
                this.clear_search();
    ...
    (function($)
    {
        $.vakata.context = {hide_on_mouseleave:false,cnt:$("<div id='vakata-contextmenu' />"),vis:false,tgt:false,par:false,func:false,data:false,rtl:false,show:function(s,t,x,y,d,p,rtl)
        {
            ...
            $.vakata.context.hide_on_mouseleave && $.vakata.context.cnt.one("mouseleave",function(e)
            {
                $.vakata.context.hide()
            });
        ...
        $(function()
        {
            ...
            typeof $.hotkeys !== "undefined" && $(document).bind("keydown","up",function(e)
            {
        ...
        $.jstree.plugin("contextmenu",{__init:function()
        {
            this.get_container().delegate("a","contextmenu.jstree",$.proxy(function(e)
            {
                e.preventDefault();
                !$(e.currentTarget).hasClass("jstree-loading") && this.show_contextmenu(e.currentTarget,e.pageX,e.pageY)
        ...
        },defaults:{select_node:false,show_at_node:true,items:{create:{separator_before:false,separator_after:true,label:"Create",action:function(obj)
        {
            this.create(obj)
        }},rename:{separator_before:false,separator_after:false,label:"Rename",action:function(obj)
        {
            this.rename(obj)
        }},remove:{separator_before:false,icon:false,separator_after:false,label:"Delete",action:function(obj)
        {
            if(this.is_selected(obj))
                this.remove();
            else
                this.remove(obj)
        }},ccp:{separator_before:true,icon:false,separator_after:false,label:"Edit",action:false,submenu:{cut:{separator_before:false,separator_after:false,label:"Cut",action:function(obj)
        {
            this.cut(obj)
        }},copy:{separator_before:false,icon:false,separator_after:false,label:"Copy",action:function(obj)
        {
            this.copy(obj)
        }},paste:{separator_before:false,icon:false,separator_after:false,label:"Paste",action:function(obj)
        {
            this.paste(obj)
        }}}}}},_fn:{show_contextmenu:function(obj,x,y)
        {
            obj = this._get_node(obj);
    ...
    (function($)
    {
        $.jstree.plugin("types",{__init:function()
        {
            ...
            is_ie6 && this.get_container().bind("load_node.jstree set_type.jstree",$.proxy(function(e,data)
            {
        ...
        },defaults:{max_children:-1,max_depth:-1,valid_children:"all",use_data:false,type_attr:"rel",types:{"default":{max_children:-1,max_depth:-1,valid_children:"all"}}},_fn:{_types_notify:function(n,data)
        {
        ...
        },_check:function(rule,obj,opts)
        {
            ...
            else
            {
                ...
                if(data && data.types && typeof data.types[rule] !== "undefined")
                    ...
                    if(!!s.types[t] && typeof s.types[t][rule] !== "undefined")
                        v = s.types[t][rule];
                    else
                        if(!!s.types["default"] && typeof s.types["default"][rule] !== "undefined")
                            v = s.types["default"][rule]
            }
            if($.isFunction(v))
                v = v.call(this,obj);
            rule === "max_depth" && obj !== -1 && opts !== false && s.max_depth !== -2 && v !== 0 && obj.children("a:eq(0)").parentsUntil(".jstree","li").each(function(i)
            {
    ...
    (function($)
    {
        $.jstree.plugin("html_data",{__init:function()
        {
        ...
        },defaults:{data:false,ajax:false,correct_state:true},_fn:{load_node:function(obj,s_call,e_call)
        {
            var _this = this;
    ...
    (function($)
    {
        $.jstree.plugin("themeroller",{__init:function()
        {
                ...
                if(data.func == "create_node")
                    if(data.args[4] || this._is_loaded(data.args[0]))
                    {
                        ...
                        if(typeof data.args[2] === "string")
                            ...
                            if(!data.args[2] || !data.args[2].data)
    ...
    (function($)
    {
        $.jstree.plugin("wholerow",{__init:function()
        {
            ...
            (is_ie7 || is_ie6) && $.vakata.css.add_sheet({str:".jstree-" + this.get_index() + " { position:relative; } ",title:"jstree"})
        },defaults:{},__destroy:function()
        {
            this.get_container().children(".jstree-wholerow").remove();
            this.get_container().find(".jstree-wholerow-span").remove()
        },_fn:{_prepare_wholerow_span:function(obj)
        {
    ...
    (function($)
    {
        ...
        $.jstree.plugin("model",{__init:function()
        {
