...
function homepageWindowOnload()
{
    ...
    !isOutlookClient && window.location.pathname.toUpperCase().endsWith("/HOMEPAGE.ASPX") >= 0 && 
        registerReminder()
}
window.onload = homepageWindowOnload;
function registerReminder()
{
    typeof _bShowPendingApprovalReminder != "undefined" && _bShowPendingApprovalReminder != "undefined" && _bShowPendingApprovalReminder != null && 
