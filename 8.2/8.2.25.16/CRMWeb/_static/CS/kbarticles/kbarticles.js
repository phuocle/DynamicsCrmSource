...
function IsQueueSelected(name,crmGrid)
{
    ...
    if(_selectedView == "{9778E83D-E110-4332-84EA-FA2DC89689B5}")
        ...
        if(_selectedView == "{9778E83D-E110-4332-84EA-FA2DC89689B7}")
            return name == "Unapproved";
        else
            if(_selectedView == "{9778E83D-E110-4332-85EA-FA2DC89689B5}")
...
function gridOnBeforeFormLoadHandler()
{
    ...
    !IsNull(oGridItem) && !IsNull(oGridItem[0]) && 
...
function newComment()
{
    var crmDialog = new Mscrm.CrmDialog(Mscrm.CrmUri.create("/cs/articles/comment/edit.aspx?parentId=" + CrmEncodeDecode.CrmUrlEncode($get("crmFormSubmit").crmFormSubmitId.value)),window,500,350,null);
    crmDialog.show()
}
function Reject()
{
    var crmDialog = new Mscrm.CrmDialog(Mscrm.CrmUri.create("/cs/articles/comment/edit.aspx?mode=reject&parentId=" + CrmEncodeDecode.CrmUrlEncode($get("crmFormSubmit").crmFormSubmitId.value)),null,500,350,null);
