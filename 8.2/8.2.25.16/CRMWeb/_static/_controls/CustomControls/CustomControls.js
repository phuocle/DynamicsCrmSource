...
Mscrm.CustomControls.CandidateControlsDialogManager.get_instance = function() {
    if (!Mscrm.CustomControls.CandidateControlsDialogManager.$l) {
        Mscrm.CustomControls.CandidateControlsDialogManager.$l = new Mscrm.CustomControls.CandidateControlsDialogManager();
    }
...
Mscrm.CustomControls.CandidateControlsDialogManager.prototype = {
    ...
    $3Y_0: function($p0) {
        if (!IsNull($p0.rawEvent.currentTarget) && $p0.rawEvent.currentTarget.tagName.toUpperCase() === 'TR' && $p0.rawEvent.currentTarget !== this.$Z_0) {
    ...
    initiate: function() {
        ...
        Mscrm.CustomControls.CustomControlUtility.addHandlerToDomElement($get('tblCustomControlDialog'), 'keyup', this.$1c_0);
    ...
    $3v_0: function($p0) {
        ...
        $v_7.appendChild(Mscrm.CustomControls.CustomControlUtility.wrapTextInGivenTagname(this.$4G_0($v_0.$m_0), 'span'));
        $v_5.appendChild($v_6);
        $v_5.appendChild($v_7);
        $v_2.appendChild($v_5);
...
Mscrm.CustomControls.CustomControlManager.getAssociatePropertyByName = function(fieldCustomControl, propertyName) {
    ...
    for (var $$arr_3 = fieldCustomControl.$3_0.$5_0, $$len_4 = $$arr_3.length, $$idx_5 = 0; $$idx_5 < $$len_4; ++$$idx_5) {
        var $v_1 = $$arr_3[$$idx_5];
...
Mscrm.CustomControls.CustomControlManager.$4x = function($p0, $p1) {
    if (IsNull($p1) || isNullOrEmptyString($p0) || (!$p1.$6_0.length && Microsoft.Crm.Client.Core.Framework._String.isNullOrEmpty($p1.$j_0))) {
        return null;
    }
    var $v_0 = -1;
    if ($p1.$H_0 || $p1.$W_0) {
        ...
        var $v_2 = Mscrm.CustomControls.CustomControlManager.getAssociatePropertyByName(Mscrm.CustomControls.CustomControlManager.get_instance().$M_0[$p0], $p1.$n_0);
        $v_0 = $v_2.$E_1;
    }
    else {
...
Mscrm.CustomControls.CustomControlManager.updatePropertyValue = function(propertyInfo) {
    ...
    if ($v_1.$H_0) {
        ...
        if (Mscrm.FeatureControl.get_Current().isFeatureEnabled(Mscrm.FeatureNames.EditableGridControlJsEvents) && $v_A.$2_0 === 'SubGrid' && $v_3) {
...
Mscrm.CustomControls.CustomControlManager.openPropertyPage = function(customControlId, controlProperty, isEntityGrid, isDashboardEditor) {
    ...
    if (isNullOrEmptyString(customControlId) || IsNull(Mscrm.CustomControls.CustomControlManager.get_instance().$M_0[customControlId])) {
        return;
    }
    var $v_4 = '';
    if (!isNullOrEmptyString(controlProperty.$j_0)) {
        $v_4 = Mscrm.CustomControls.CustomControlManager.getAssociatePropertyByName(Mscrm.CustomControls.CustomControlManager.get_instance().$M_0[customControlId], controlProperty.$j_0).$I_0;
    }
    ...
    if (controlProperty.$V_0) {
        if (!Mscrm.CustomControls.CustomControlManager.$4S(customControlId, controlProperty) && !$v_2) {
            Mscrm.CustomControls.CustomControlManager.$3Z('0x80061215', controlProperty, Mscrm.CustomControls.CustomControlManager.getAssociatePropertyByName(Mscrm.CustomControls.CustomControlManager.get_instance().$M_0[customControlId], controlProperty.$n_0).$I_0);
            return;
        }
    }
    if ($v_3) {
        $v_5.width = 500;
        $v_5.height = (controlProperty.$W_0) ? 500 : (Mscrm.CustomControls.CustomControlUtility.isPotentialLookupProperty(controlProperty.$6_0)) ? 600 : 430;
...
Mscrm.CustomControls.CustomControlManager.updateControlPropertyList = function(customControlId, dataSetProperty, needUxUpdate, controlDescriptor) {
    if ((IsNull(Mscrm.CustomControls.CustomControlManager.get_instance().$M_0[customControlId]) && IsNull(controlDescriptor)) || IsNull(dataSetProperty) || IsNull(dataSetProperty.$9_1)) {
        return;
    }
    ...
    if (needUxUpdate) {
        ...
        $v_0.$Y_0.focus();
        $v_0.$Y_0.click();
        var $v_A = $get(Mscrm.CustomControls.CustomControlManager.get_instance().$1f_0(customControlId, dataSetProperty.$2_0));
        $v_A.focus();
        $v_A.click();
    }
}
...
Mscrm.CustomControls.CustomControlManager.prototype = {
    ...
    $3Y_0: function($p0) {
        var $v_0 = $p0.rawEvent.currentTarget;
        if (!IsNull($p0.rawEvent.currentTarget) && $p0.rawEvent.currentTarget.tagName.toUpperCase() === 'TR' && $p0.rawEvent.currentTarget !== Mscrm.CustomControls.CustomControlUtility.$1Z) {
            Mscrm.CustomControls.CustomControlUtility.applyRowBackgroundColor($v_0, '#D7EBF9');
        }
        this.$Z_0 = $v_0;
    ...
    $4i_0: function($p0) {
        if (!IsNull($p0.rawEvent.currentTarget) && $p0.rawEvent.currentTarget.tagName.toUpperCase() === 'TR' && $p0.rawEvent.currentTarget !== this.$1B_0) {
            var $v_0 = $p0.rawEvent.currentTarget;
            Mscrm.CustomControls.CustomControlUtility.applyRowBackgroundColor($v_0, '#D7EBF9');
        }
    },
    ...
    $4f_0: function($p0) {
        ...
        if (!isNullOrEmptyString($v_1) && !isNullOrEmptyString($v_2)) {
            var $v_3 = Mscrm.CustomControls.CustomControlManager.getAssociatePropertyByName(Mscrm.CustomControls.CustomControlManager.get_instance().$M_0[$v_1], $v_2);
            $v_3.$1_0 = $v_0.value;
    ...
    $3H_0: function($p0) {
        ...
        if (!isNullOrEmptyString($p0)) {
            ...
            Mscrm.CustomControls.CustomControlUtility.removeHandlerFromDomElement(this.$Z_0, 'click', this._onGridRowClickHandler);
                        ...
                        if ($v_2[$v_4].isRequired && !$v_5 && isNullOrEmptyString($v_2[$v_4].$1_0)) {
                            ...
                            if (!$v_3) {
                                ...
                                if (!$v_1.$T_0.hasChildNodes()) {
                                    $v_1.$T_0.appendChild(Mscrm.CustomControls.CustomControlUtility.wrapTextAndImgageInGivenTagname(Mscrm.CustomControls.CustomControlManager.$2J, '/_imgs/error/notif_icn_crit16.png'));
    ...
    $3K_0: function($p0, $p1) {
        ...
        if (!IsNull($p0.$u_0)) {
            ...
            if (this.$3q_0($p0, $v_0)) {
                $p0.$u_0.appendChild(Mscrm.CustomControls.CustomControlUtility.wrapTextInGivenTagname($v_3 + ' ' + window.LOCID_CCCONFIG_REQUIRED, 'label', 'style', 'cursor:default'));
            }
            else {
                $p0.$u_0.appendChild(Mscrm.CustomControls.CustomControlUtility.wrapTextInGivenTagname($v_3, 'label', 'style', 'cursor:default'));
            }
        }
        if (!IsNull($p0.$1H_0)) {
    ...
    $3W_0: function($p0) {
        ...
        for (var $v_5 = 0; $v_5 < $v_3.length; $v_5++) {
            var $v_6 = $v_3[$v_5];
            if ($v_6.$2_0 === $v_4) {
                Mscrm.CustomControls.CustomControlManager.openPropertyPage($v_2.$4_0.toString(), $v_6, this.$K_0, this.$2E_0);
                break;
            }
        }
    },
    ...
    initializeControlDescriptors: function(responseText) {
        ...
        if (!this.$F_0) {
            ...
            var $v_4 = XUI.Xml.SelectSingleNode($v_3, 'entity/form/controlDescriptions/controlDescription[@forControl=\'' + this.$O_0 + '\']', null);
            if (IsNull($v_4)) {
                this.$1E_0 = false;
            }
            else {
    ...
    $3F_0: function($p0) {
        ...
        if (!IsNull($v_7)) {
            ...
            for (var $$arr_L = $v_A, $$len_M = $$arr_L.length, $$idx_N = 0; $$idx_N < $$len_M; ++$$idx_N) {
                ...
                if (!IsNull($v_J) && ($v_J.nodeValue === 'Form.Card' || $v_J.nodeValue === 'Form.Main')) {
                    ...
                    if (!IsNull($v_a)) {
                        if ($v_H.hasChildNodes()) {
                            ...
                            for (var $$arr_i = $v_b, $$len_j = $$arr_i.length, $$idx_k = 0; $$idx_k < $$len_j; ++$$idx_k) {
                                var $v_c = $$arr_i[$$idx_k];
                ...
                if (!IsNull($v_K)) {
                    if ($v_H.childNodes.length > 1 && Mscrm.CustomControls.CustomControlUtility.isPotentialLookupProperty($v_K.$6_0)) {
                        var $v_e = $v_K;
                        if ($v_e) {
                    ...
                    if ($v_K.$U_0) {
                        ($v_K).$C_1 = (!$v_H.attributes.getNamedItem('static')) ? false : Boolean.parse($v_H.attributes.getNamedItem('static').nodeValue);
                    }
                    if (isNullOrEmptyString($v_K.$L_0)) {
                        var $v_f = XUI.Xml.GetText($v_H);
                        var $v_g = this.$4J_0($v_K, $v_5, $v_f);
                        $v_K.set_selectedCandidatePropertyType((!$v_H.attributes.getNamedItem('type')) ? $v_g : $v_H.attributes.getNamedItem('type').nodeValue);
                    }
                }
            }
        }
        ...
        for (var $v_h = 0; $v_h < 3; $v_h++) {
            var $v_i = XUI.Xml.SelectSingleNode($v_3, String.format('//customControl[@formFactor=\'{0}\']', $v_h), null);
            if ($v_i) {
                switch ($v_h) {
                    case 0:
                        $p0.$G_0.push(0);
    ...
    $3x_0: function($p0) {
        for (var $$arr_1 = this.$1X_0, $$len_2 = $$arr_1.length, $$idx_3 = 0; $$idx_3 < $$len_2; ++$$idx_3) {
            var $v_0 = $$arr_1[$$idx_3];
            if (!IsNull($v_0) && !Microsoft.Crm.Client.Core.Framework._String.isNullOrEmpty($v_0.$1b_0) && $v_0.$1b_0 === $p0) {
    ...
    getCustomControlDOMForformXML: function(formXMLDoc, currentControlClassId, parameters) {
        ...
        var $v_3 = XUI.Xml.SelectSingleNode(formXMLDoc, 'entity/form/controlDescriptions/controlDescription[@forControl=\'' + this.$O_0 + '\']', null);
        ...
        if (IsNull($v_3)) {
            ...
            var $v_8 = XUI.Xml.SelectNodes(formXMLDoc, 'entity/form/controlDescriptions/controlDescription[@forControl=\'' + this.$O_0 + '\']/customControl', null);
            for (var $$arr_C = $v_8, $$len_D = $$arr_C.length, $$idx_E = 0; $$idx_E < $$len_D; ++$$idx_E) {
                var $v_9 = $$arr_C[$$idx_E];
                $v_3.removeChild($v_9);
            }
            $v_1 = XUI.Xml.SelectSingleNode(formXMLDoc, 'entity/form/controlDescriptions/controlDescription[@forControl=\'' + this.$O_0 + '\']', null);
        }
    ...
    $3D_0: function($p0, $p1, $p2, $p3) {
        ...
        if (Mscrm.CustomControls.CustomControlUtility.isLookupProperty($p0.$L_0) && !$p0.$V_0) {
            ...
            XUI.Xml.SetText($v_7, (isNullOrEmptyString(($p0).$B_1)) ? Microsoft.Crm.Client.Core.Framework.Guid.get_empty().toString() : ($p0).$B_1);
            $v_0.appendChild($v_7);
    ...
    $4F_0: function($p0, $p1) {
        $p1.$B_1 = (!IsNull($p0['DefaultViewId'])) ? $p0['DefaultViewId'].toString() : Microsoft.Crm.Client.Core.Framework.Guid.get_empty().toString();
    ...
    createExistingCustomControlsFromFormXml: function() {
        ...
        if (!IsNull($v_1)) {
            var $v_2 = XUI.Xml.SelectNodes($v_1, 'entity/form/controlDescriptions/controlDescription[@forControl=\'' + this.$O_0 + '\']/customControl', null);
            if (!$v_2.length) {
                ...
                for (var $v_6 = 0; $v_6 < $v_2.length; $v_6++) {
                    ...
                    if ($v_9 !== $v_4 || Mscrm.CustomControls.CustomControlUtility.getNodeOuterHtml(Mscrm.CustomControls.CustomControlUtility.getXmlNodeFirstChild($v_7)) !== $v_5 || !$v_A) {
                        ...
                        if (Mscrm.CustomControls.CustomControlUtility.getXmlNodeFirstChild(Mscrm.CustomControls.CustomControlUtility.getXmlNodeFirstChild($v_7)).nodeName === 'datafieldname' || (this.$F_0 && $v_8 === new Microsoft.Crm.Client.Core.Framework.Guid('{E7A81278-8635-4d9e-8D4D-59480B391C5B}').toString())) {
                            $v_B.$J_0 = true;
            ...
            if (!IsNull(oldCustomControl)) {
                for (var $v_4 = 0; $v_4 < oldCustomControl.$3_0.$S_0.length; $v_4++) {
                    ...
                    if (!isNullOrEmptyString($v_5.$B_1) && $v_5.$d_1) {
                        ...
                        this.$3t_0($v_5, $v_6);
                        Mscrm.CustomControls.CustomControlManager.updateControlPropertyList($v_1.$4_0.toString(), $v_6, false);
                    }
                }
        ...
        if (!IsNull($p0.$3_0) && !IsNull($p0.$3_0.$5_0)) {
            ...
            for (var $v_R = 0; $v_R < $v_M.length; $v_R++) {
                ...
                if ($v_U.$1O_0) {
                    ...
                    var $v_m = $v_U;
                    if ($v_m.$1U_1) {
                        $v_X.appendChild(Mscrm.CustomControls.CustomControlUtility.wrapTextInGivenTagname($v_m.$16_1, 'span'));
                        $v_J = false;
                    }
                    else {
                        $v_X.appendChild(Mscrm.CustomControls.CustomControlUtility.wrapTextInGivenTagname(this.$33_0(), 'span'));
                        $v_m.$1_0 = this.$2B_0();
                        $v_m.$B_1 = $v_m.$1_0;
                        if (this.$K_0) {
                    ...
                    $v_X.appendChild(Mscrm.CustomControls.CustomControlUtility.wrapTextInGivenTagname(this.$2A_0(), 'span'));
                    $v_T = this.$2A_0();
                    $v_U.$1_0 = this.$2A_0();
                    ...
                    var $v_n = $v_U;
                    $v_X.appendChild(Mscrm.CustomControls.CustomControlUtility.wrapTextInGivenTagname($v_n.get_formData().$r_0, 'span'));
                ...
                if (!$v_J && !$p0.$g_0 && !$v_K) {
                    ...
                    $v_o.setAttribute('class', ($v_0) ? 'customcontrolproperty-value-RTL' : 'customcontrolproperty-value');
    ...
    $3O_0: function($p0) {
        return $p0.$J_0 || (!!$p0.$3_0 && !!$p0.$3_0.$S_0 && $p0.$3_0.$S_0.length > 0 && ($p0.$3_0.$S_0[0]).$d_1 && (!IsNull(this.$N_0) && !IsNull(this.$N_0['IsControlWebEnabled']) && Boolean.parse(this.$N_0['IsControlWebEnabled'].toString())) && !this.$2E_0);
    },
    ...
    $3M_0: function($p0) {
        ...
        var $v_0 = this.$3A_0($p0, this.isRadiobuttonChecked($p0.$G_0, 2), this.isRadiobuttonChecked($p0.$G_0, 0), this.isRadiobuttonChecked($p0.$G_0, 1), $p0.$4_0.toString());
    ...
    $2r_0: function($p0) {
        ...
        $v_0.$i_0 = (isNullOrEmptyString($p0['CustomControlPreviewImagePath'])) ? '' : CrmEncodeDecode.CrmHtmlDecode($p0['CustomControlPreviewImagePath']);
        ...
        for (var $$arr_5 = $v_1, $$len_6 = $$arr_5.length, $$idx_7 = 0; $$idx_7 < $$len_6; ++$$idx_7) {
            ...
            if ($v_6) {
                ...
                ($v_5).$1W_1 = (isNullOrEmptyString($v_4['PropertySetLength'])) ? 0 : Number.parseInvariant(CrmEncodeDecode.CrmHtmlDecode($v_4['PropertySetLength']));
                $v_5.$6_0 = [ 'Grid' ];
                ($v_5).$1U_1 = (isNullOrEmptyString($v_4['IsConfigurationNeeded'])) ? false : Boolean.parse(CrmEncodeDecode.CrmHtmlDecode($v_4['IsConfigurationNeeded']));
                ($v_5).$d_1 = (isNullOrEmptyString($v_4['IsDatasetEditable'])) ? false : Boolean.parse(CrmEncodeDecode.CrmHtmlDecode($v_4['IsDatasetEditable']));
                ($v_5).$Q_1 = (!$v_3.get_Count());
                $v_3.add($v_5);
            }
            $v_5.$2_0 = (isNullOrEmptyString($v_4['PropertyName'])) ? '' : CrmEncodeDecode.CrmHtmlDecode($v_4['PropertyName']);
            $v_5.$I_0 = (isNullOrEmptyString($v_4['PropertyDisplayName'])) ? '' : CrmEncodeDecode.CrmHtmlDecode($v_4['PropertyDisplayName']);
            $v_5.$A_0 = (isNullOrEmptyString($v_4['PropertyDescription'])) ? '' : CrmEncodeDecode.CrmHtmlDecode($v_4['PropertyDescription']);
            $v_5.$j_0 = (isNullOrEmptyString($v_4['PropertyOfSameType'])) ? '' : CrmEncodeDecode.CrmHtmlDecode($v_4['PropertyOfSameType']);
            ...
            $v_5.$1_0 = ((Mscrm.CustomControls.InputControlProperty.isInstanceOfType($v_5)) && isNullOrEmptyString($v_4['PropertyDefaultValue'])) ? '' : CrmEncodeDecode.CrmHtmlDecode($v_4['PropertyDefaultValue']);
            $v_5.$13_0 = (isNullOrEmptyString($v_4['PropertyDefaultValue'])) ? '' : CrmEncodeDecode.CrmHtmlDecode($v_4['PropertyDefaultValue']);
            $v_5.$6_0 = (IsNull($v_4['PropertyCompatibleTypes'])) ? new Array(0) : CrmEncodeDecode.CrmHtmlDecode(($v_4['PropertyCompatibleTypes'])).split(',');
            $v_5.$n_0 = (isNullOrEmptyString($v_4['PropertySetParentDatasetName'])) ? '' : CrmEncodeDecode.CrmHtmlDecode($v_4['PropertySetParentDatasetName']);
            $v_5.$V_0 = !isNullOrEmptyString($v_5.$n_0);
            $v_5.$1F_0 = (isNullOrEmptyString($v_4['ParentGroupName'])) ? '' : CrmEncodeDecode.CrmHtmlDecode($v_4['ParentGroupName']);
            $v_5.$15_0 = (isNullOrEmptyString($v_4['GrandParentGroupsName'])) ? '' : CrmEncodeDecode.CrmHtmlDecode($v_4['GrandParentGroupsName']);
            ...
            if (!IsNull($v_8)) {
                for (var $$arr_I = $v_8, $$len_J = $$arr_I.length, $$idx_K = 0; $$idx_K < $$len_J; ++$$idx_K) {
                    ...
                    $v_F.$28_0 = (isNullOrEmptyString($v_E['OptionName'])) ? '' : CrmEncodeDecode.CrmHtmlDecode($v_E['OptionName']);
                    $v_F.$1e_0 = (isNullOrEmptyString($v_E['OptionValue'])) ? '' : CrmEncodeDecode.CrmHtmlDecode($v_E['OptionValue']);
                    $v_F.$1u_0 = (isNullOrEmptyString($v_E['OptionDisplayName'])) ? '' : CrmEncodeDecode.CrmHtmlDecode($v_E['OptionDisplayName']);
                    $v_F.$1t_0 = (isNullOrEmptyString($v_E['OptionDescription'])) ? '' : CrmEncodeDecode.CrmHtmlDecode($v_E['OptionDescription']);
                    $v_F.$27_0 = (isNullOrEmptyString($v_E['OptionDefaultSelect'])) ? '' : CrmEncodeDecode.CrmHtmlDecode($v_E['OptionDefaultSelect']);
    ...
    $2x_0: function($p0, $p1) {
        ...
        if (this.$1Q_0.toUpperCase() === 'HEADER') {
            $v_0 = XUI.Xml.SelectSingleNode($p0, 'entity/form/header/rows/row/cell/control[@uniqueid =\'' + this.$O_0 + '\']', null);
        }
        else if (this.$1Q_0.toUpperCase() === 'FOOTER') {
            $v_0 = XUI.Xml.SelectSingleNode($p0, 'entity/form/footer/rows/row/cell/control[@uniqueid =\'' + this.$O_0 + '\']', null);
        }
        else {
            $v_0 = XUI.Xml.SelectSingleNode($p0, 'entity/form/tabs/tab/columns/column/sections/section/rows/row/cell/control[@uniqueid =\'' + this.$O_0 + '\']', null);
        }
        return $v_0;
    },
            ...
            for (var $$arr_3 = $p1.$9_1, $$len_4 = $$arr_3.length, $$idx_5 = 0; $$idx_5 < $$len_4; ++$$idx_5) {
                ...
                if ((($v_1) in $p2)) {
                    ...
                    if ($p1.$Q_1 && $v_0.$R_1 && !isNullOrEmptyString($v_0.$X_1)) {
                        $v_3 = String.format('{0} ({1})', $v_2, Mscrm.CustomControls.CustomControlUtility.getViewNameByEntityTypeCode($v_0.$R_1, $v_0.$X_1));
                    }
                    $v_0.$1K_1 = $v_2;
...
Mscrm.CustomControls.CustomControlValidation.validateStaticType = function(value, staticValueType, errorMessage) {
    switch (staticValueType) {
        ...
        case 'Currency':
            return Mscrm.CustomControls.CustomControlValidation.$35(value, errorMessage, -922337203685477, 922337203685477, 4);
        default:
            errorMessage.val = '';
            return true;
    }
...
Mscrm.CustomControls.CustomControlUtility.onExistingTableRowClick = function(evt) {
    Mscrm.CustomControls.CustomControlUtility.$1Z = Mscrm.CustomControls.CustomControlUtility.handleRowClick(evt, Mscrm.CustomControls.CustomControlUtility.$1Z);
    var $v_0 = evt.target;
...
Mscrm.CustomControls.CustomControlUtility.onExistingPropertyTableRowClick = function(evt) {
    Mscrm.CustomControls.CustomControlUtility.$2N = Mscrm.CustomControls.CustomControlUtility.handleRowClick(evt, Mscrm.CustomControls.CustomControlUtility.$2N);
}
    ...
    if (controlProperty.$U_0 && controlProperty.get_staticOptions().length > 0) {
        for (var $v_2 = 0; $v_2 < controlProperty.get_staticOptions().length; $v_2++) {
            ...
            if ($v_3.$1e_0 === controlProperty.$1_0.toString()) {
                Mscrm.CustomControls.CustomControlUtility.processPropertyValueString($v_0, controlProperty, $v_3.$1u_0, $v_1);
                return;
            }
        }
    }
    Mscrm.CustomControls.CustomControlUtility.processPropertyValueString($v_0, controlProperty, controlProperty.$1_0, $v_1);
}
...
Mscrm.CustomControls.CustomControlUtility.processPropertyValueString = function(spanElement, controlProperty, propertyDisplayValue, isRTL) {
    if (!isRTL) {
        ...
        spanElement.innerHTML = CrmEncodeDecode.CrmHtmlEncode(String.format('{0} ', propertyDisplayValue)) + '<span>&lrm;' + CrmEncodeDecode.CrmHtmlEncode(String.format('({0})', controlProperty.$L_0)) + '&lrm;</span>';
    }
}
...
Mscrm.CustomControls.PropertyDialogManager.prototype = {
    ...
    initiate: function() {
        ...
        if (this.$0_0.$H_0) {
            ...
            var $v_P = this.$0_0;
            this.$1v_0 = Mscrm.CustomControls.CustomControlUtility.retrieveFormattedViewLookupPropertyValue($v_P.$X_1, $v_P.$k_1, $v_P.$n_0);
        }
        else {
            this.$1v_0 = (!isNullOrEmptyString(this.$0_0.$1_0)) ? String.format('{0} ({1})', this.$0_0.$1_0, this.$0_0.$L_0) : '';
        }
        var $v_1 = $get('lblHeader');
        var $v_2 = $get('rdStaticProperty');
        var $v_3 = $get('rdEntityProperty');
        var $v_4 = $get('lblStaticOptions');
        Mscrm.CustomControls.CustomControlUtility.setInnerText($v_1, window.LOCID_CCCONFIG_CONFIGPROPERTY + ' \"' + this.$0_0.$I_0 + '\"');
        var $v_5 = (Microsoft.Crm.Client.Core.Framework._String.isNullOrEmpty(this.$0_0.$I_0)) ? this.$0_0.$2_0 : this.$0_0.$I_0;
        ...
        if (this.$0_0.$W_0) {
            ...
            var $v_Q = (Microsoft.Crm.Client.Core.Framework._String.isNullOrEmpty(this.$0_0.$I_0)) ? this.$0_0.$2_0 : this.$0_0.$I_0;
            Mscrm.CustomControls.CustomControlUtility.setInnerText($v_1, window.LOCID_CCCONFIG_CONFIGPROPERTY + ' \"' + $v_Q + '\"');
            this.$3m_0($v_0);
        }
        else if (this.$0_0.$q_0) {
            var $v_R = (Microsoft.Crm.Client.Core.Framework._String.isNullOrEmpty(this.$0_0.$I_0)) ? this.$0_0.$2_0 : this.$0_0.$I_0;
            Mscrm.CustomControls.CustomControlUtility.setInnerText($v_1, window.LOCID_CCCONFIG_CONFIGPROPERTY + ' \"' + $v_R + '\"');
            this.$3l_0($v_0);
        }
        else {
        ...
        if (Mscrm.CustomControls.CustomControlUtility.isPotentialLookupProperty(this.$0_0.$6_0) && !this.$0_0.$V_0 && !this.$0_0.$H_0) {
                ...
                if (this.$12_0) {
                    ...
                    for (var $v_V = 0; $v_V < this.$0_0.get_staticOptions().length; $v_V++) {
                        ...
                        if (this.$0_0.get_staticOptions()[$v_V].$1e_0 === this.$0_0.$1_0) {
                            $v_W.selected = true;
                            Mscrm.CustomControls.CustomControlUtility.setInnerText($v_Q, this.$0_0.get_staticOptions()[$v_V].$1t_0);
                            $v_T = true;
                        }
                        $v_O.appendChild($v_W);
                    }
                    if (!$v_T) {
                        ...
                        Mscrm.CustomControls.CustomControlUtility.setInnerText($v_Q, $v_Z.getAttribute('OptionDescription'));
                        $v_Z.selected = true;
                        this.$2z_0 = true;
                    }
    ...
    $3r_0: function() {
        ...
        if ($v_3.$y_1) {
            ...
            $v_6.style.display = 'block';
            window.populateDisplaySection($v_3.$R_1, null, $v_3.$X_1, 'entityViews', 'entityViewLabelId', 'entityViewCombo');
    ...
    bindViewColumnOptions: function(selectElement, viewLookupDataDict, viewId) {
        ...
        if ($v_3.length > 0) {
            for (var $$arr_C = $v_3, $$len_D = $$arr_C.length, $$idx_E = 0; $$idx_E < $$len_D; ++$$idx_E) {
                ...
                var $v_B = Mscrm.CustomControls.CustomControlUtility.retrieveFormattedViewLookupPropertyName($v_0.$10_1, viewId, $v_8, $v_0.$n_0);
    ...
    $2I_0: function($p0, $p1) {
        if ($p1 && $p0.$R_1 !== Microsoft.Crm.Client.Core.Framework.Undefined.int32Value) {
            ...
            window.populateDisplaySectionForLookupProperty($p0.$R_1, $p0.$1_0, $p0.$B_1, $p0.$w_1, $p0.$p_1, 'DefaultView', 'defaultViewLabelId', 'DefaultViewCombo', 'viewSelection', 'ViewListSelector', $p0.$14_1);
            window.populateRelFiltersSection($p0.$R_1, $p0.$1_0, $p0.$c_1, $p0.$a_1, $p0.$b_1, $p0.$P_1);
        }
        else {
            window.populateDisplaySection($p0.$R_1, $p0.$k_1, $p0.$B_1, 'DefaultView', 'defaultViewLabelId', 'DefaultViewCombo');
    ...
    $4U_0: function($p0) {
        ...
        var $v_3 = $v_1.text;
        var $v_4 = $v_3.split('(')[1];
        if (Mscrm.CustomControls.CustomControlUtility.isLookupProperty($v_4) && !Microsoft.Crm.Client.Core.Framework._String.isNullOrEmpty($v_2) && !this.$0_0.$V_0) {
            var $v_5 = this.$0_0;
            $v_5.$1_0 = $v_2;
            $v_5.$c_1 = null;
            $v_5.$p_1 = true;
    ...
    $43_0: function($p0) {
        ...
        if ($p0) {
            var $v_1 = Mscrm.CustomControls.CustomControlUtility.wrapTextAndImgageInGivenTagname(Mscrm.CustomControls.PropertyDialogManager.$3I, '');
            $v_0.appendChild($v_1);
        }
        if (!(isNullOrEmptyString(this.$0_0.$j_0))) {
            var $v_2 = Mscrm.CustomControls.CustomControlUtility.wrapTextAndImgageInGivenTagname(String.format(Mscrm.CustomControls.PropertyDialogManager.$3J, this.$2P_0), '');
            $v_0.appendChild($v_2);
        }
    },
...
Mscrm.CustomControls.ViewLookupProperty = function(parentEntityDisplayName, parentEntityLogicalName, parentEntityTypeCode, parentEntityViewId, attributeDisplayName, attributeLogicalName, propertyDescription, parentDataSetProperty, isTemplate) {
    ...
    this.$V_0 = true;
    this.$W_0 = true;
    this.$2_0 = Mscrm.CustomControls.CustomControlUtility.retrieveFormattedViewLookupPropertyName(parentEntityLogicalName, parentEntityViewId, attributeLogicalName, parentDataSetProperty.$2_0);
    ...
    this.$I_0 = (isTemplate) ? window.LOCID_CCCONFIG_ADDLOOKUP : String.format('{0} {1}', window.LOCID_CCCONFIG_VIEWLOOKUPPREFIX, $v_0);
...
Mscrm.CustomControls.ViewLookupProperty.createTemplate = function(parentDataSetProperty) {
    return new Mscrm.CustomControls.ViewLookupProperty(parentDataSetProperty.$A_0, parentDataSetProperty.$h_1, parentDataSetProperty.$E_1, parentDataSetProperty.$B_1, null, null, null, parentDataSetProperty, true);
}
Mscrm.CustomControls.ViewLookupProperty.createFromModifiedTemplate = function(template) {
    var $v_0 = new Mscrm.CustomControls.ViewLookupProperty(template.$1V_1, template.$10_1, template.$R_1, template.$X_1, template.$1K_1, template.$k_1, template.$A_0, template.parentDataSetProperty, false);
...
Mscrm.CustomControls.ViewLookupProperty.prototype = {
    ...
    clone: function() {
        return new Mscrm.CustomControls.ViewLookupProperty(this.$1V_1, this.$10_1, this.$R_1, this.$X_1, this.$1K_1, this.$k_1, this.$A_0, this.parentDataSetProperty, this.$y_1);
    },
