...
Mscrm.ActivityContainer.get_filterWall = function() {
    if (!Mscrm.ActivityContainer.$H) {
        Mscrm.ActivityContainer.$H = Mscrm.CrmUIComponent.crmCreate(Mscrm.ActivityCommandBarButton, null, null, null, $get('activityFilterButton'));
    }
    return Mscrm.ActivityContainer.$H;
}
Mscrm.ActivityContainer.get_moreActivitiesButton = function() {
    if (!Mscrm.ActivityContainer.$I) {
        Mscrm.ActivityContainer.$I = Mscrm.CrmUIComponent.crmCreate(Mscrm.ActivityCommandBarButton, null, null, null, $get('moreActivitiesButton'));
    }
    return Mscrm.ActivityContainer.$I;
}
Mscrm.ActivityContainer.get_activityWallSortButton = function() {
    if (!Mscrm.ActivityContainer.$V) {
        Mscrm.ActivityContainer.$V = Mscrm.CrmUIComponent.crmCreate(Mscrm.ActivityCommandBarButton, null, null, null, $get('activityWallSortButton'));
    }
...
Mscrm.ActivityContainer.changeNotchPosition = function(select) {
    ...
    Mscrm.ActivityContainer.$f = (select.offsetWidth / 2) - Mscrm.ActivityContainer.$v;
...
Mscrm.ActivityContainer.$p = function($p0, $p1) {
    ...
    if (Mscrm.ActivityContainer.$8 !== $p0) {
        ...
        var $v_4 = $get($v_0);
        if ($p0 === 4210) {
            if (Mscrm.ActivityContainer.isLeftVoiceMailAttrSet()) {
...
Mscrm.ActivityContainer.$18 = function($p0) {
    ...
    switch ($p0) {
        ...
        case 4212:
            ...
            var $v_2 = Mscrm.ActivityContainer.$t(Mscrm.ActivityContainer.$M);
            $v_2.resetLayoutOnBoundControls('subject');
            $v_2.resetLayoutOnBoundControls('ownerid');
            $v_2.setDefaultEmptyValuePlaceholderText('description', Mscrm.ActivityContainer.$E);
            break;
        default:
            break;
    }
    var $v_3 = Mscrm.ActivityContainer.$t($v_0);
    if (!IsNull($v_3)) {
        $v_3.setEditMode($v_1);
    }
}
Mscrm.ActivityContainer.focusOnPhoneActivity = function() {
    ...
    var $v_0 = Mscrm.ActivityContainer.$t('df202c21-8393-488d-b464-aa6c70c21f88');
...
Mscrm.ActivityContainer.$e = function() {
    var $v_0 = Mscrm.ActivityContainer.$t(Mscrm.ActivityContainer.$1);
    if (IsNull($v_0)) {
        return;
    }
    Mscrm.ActivityContainer.$G($v_0, 'subject');
    Mscrm.ActivityContainer.$G($v_0, 'leftvoicemail');
    ...
    $v_0.setDefaultEmptyValuePlaceholderText('description', Mscrm.ActivityContainer.$D);
...
Mscrm.ActivityContainer.isLeftVoiceMailAttrSet = function() {
    var $v_0 = Mscrm.ActivityContainer.$t(Mscrm.ActivityContainer.$1);
    var $v_1 = $v_0.getEntityAttribute('leftvoicemail');
    if (!Mscrm.InternalUtilities._Script.isNullOrUndefined($v_1) && !Mscrm.InternalUtilities._Script.isNullOrUndefined($v_1.getValue()) && ($v_1.getValue()) === 1) {
        return true;
    }
    else {
        return false;
...
Mscrm.ActivityContainer.$G = function($p0, $p1) {
...
Mscrm.ActivityContainer.$X = function($p0, $p1) {
    ...
    switch ($v_0.getEntityName()) {
        ...
        case 'account':
            ...
            if (!IsNull($v_2) && !IsNull($v_2.getValue())) {
                ...
                if (!Mscrm.Utilities.isNullOrEmptyGuid($v_0.getId()) && !Mscrm.Utilities.isNullOrEmptyGuid($v_0.getPrimaryAttributeValue())) {
                    Mscrm.ActivityContainer.$0 = Mscrm.ActivityContainer.$b($v_0.getPrimaryAttributeValue(), $v_0.getId(), 1, 'account');
                }
            }
        ...
        case 'contact':
            if (!Mscrm.Utilities.isNullOrEmptyGuid($v_0.getId()) && !Mscrm.Utilities.isNullOrEmptyGuid($v_0.getPrimaryAttributeValue())) {
                Mscrm.ActivityContainer.$0 = Mscrm.ActivityContainer.$b($v_0.getPrimaryAttributeValue(), $v_0.getId(), 2, 'contact');
            }
            Mscrm.ActivityContainer.$n($p0);
            Mscrm.ActivityContainer.$m($p0);
            break;
        ...
        case 'lead':
            ...
            if (!IsNull($v_3) && !IsNull($v_3.getValue())) {
                ...
                if (!Mscrm.Utilities.isNullOrEmptyGuid($v_0.getId()) && !IsNull($v_0.getPrimaryAttributeValue())) {
                    Mscrm.ActivityContainer.$0 = Mscrm.ActivityContainer.$b($v_0.getPrimaryAttributeValue(), $v_0.getId(), 4, 'lead');
                }
            }
            Mscrm.ActivityContainer.$N($v_3);
            Mscrm.ActivityContainer.$n($p0);
...
Mscrm.ActivityContainer.$m = function($p0) {
    if (!((Mscrm.ActivityContainer.$h) in Mscrm.ActivityContainer.$7)) {
        ...
        Mscrm.ActivityContainer.$F.schedule(function() {
...
Mscrm.ActivityContainer.$13 = function() {
    ...
    if (!IsNull($v_0)) {
        Mscrm.ActivityContainer.$Q = Mscrm.ActivityContainer.$s($v_0);
        if (IsNull(Mscrm.ActivityContainer.$R)) {
            Mscrm.ActivityContainer.$R = function($p1_0) {
                var $v_1 = Mscrm.ActivityContainer.$s($v_0);
...
Mscrm.ActivityContainer.$15 = function() {
    ...
    var $v_1 = Mscrm.ActivityContainer.$t(Mscrm.ActivityContainer.$1);
    var $v_2 = Mscrm.ActivityContainer.$r();
...
Mscrm.ActivityContainer.$o = function($p0) {
    var $v_0 = Mscrm.ActivityContainer.$r();
    if (!IsNull($v_0)) {
...
Mscrm.ActivityContainer.$d = function($p0, $p1) {
    if ($p1 === 0) {
        Mscrm.ActivityContainer.$G($p0, 'to');
        Mscrm.ActivityContainer.$x($p0, 'from');
    }
    else {
        Mscrm.ActivityContainer.$x($p0, 'to');
        Mscrm.ActivityContainer.$G($p0, 'from');
    }
}
...
Mscrm.ActivityContainer.initializeTaskQuickForm = function() {
    var $v_0 = Mscrm.ActivityContainer.$t(Mscrm.ActivityContainer.$M);
    if (!IsNull($v_0)) {
        $v_0.disableWarningsOnAllControls();
    }
    $v_0.resetAttributeValue('subject', null);
...
Mscrm.ActivityContainer.$17 = function($p0) {
    ...
    var $v_1 = null;
    if (!Mscrm.ActivityContainer.$L() && !$v_0.get_entityName().localeCompare('phonecall') && window.MakeSocialPanePhoneCallCompleted) {
...
Mscrm.ActivityContainer.$w = function($p0) {
    Mscrm.ActivityContainer.$t($p0.get_uniqueId()).remove_failureEvent(Mscrm.ActivityContainer.$c);
    Mscrm.ActivityContainer.$t($p0.get_uniqueId()).remove_successEvent(Mscrm.ActivityContainer.$k);
}
Mscrm.ActivityContainer.$c = function($p0, $p1) {
    Mscrm.ActivityContainer.$w($p1);
}
...
Mscrm.ActivityContainer.voicemailChecked = function(checkBoxId) {
    ...
    var $v_1 = Mscrm.ActivityContainer.$t('df202c21-8393-488d-b464-aa6c70c21f88');
...
Mscrm.ActivityContainer.prototype = {
    ...
    initialize: function() {
        ...
        Mscrm.ActivityContainer.$D = window.self.ACTIVITY_PHONECALL_DESCRIPTION_EMPTYVALUE_PLACEHOLDER_TEXT;
        Mscrm.ActivityContainer.$D = (!Mscrm.ActivityContainer.$D) ? '--' : Mscrm.ActivityContainer.$D;
        Mscrm.ActivityContainer.$E = window.self.ACTIVITY_TASK_DESCRIPTION_EMPTYVALUE_PLACEHOLDER_TEXT;
        Mscrm.ActivityContainer.$E = (!Mscrm.ActivityContainer.$E) ? '--' : Mscrm.ActivityContainer.$E;
        ...
        if (!Mscrm.InternalUtilities._Script.isNullOrUndefined(window.self._activityTypeCode)) {
            ...
            if ($v_0 !== -1) {
                ...
                if (Mscrm.Utilities.isTurboForm()) {
                    var $v_2$2 = Mscrm.ActivityContainer.$t(Mscrm.ActivityContainer.$1, false);
                    var $$t_D = this;
                    var $v_3 = function($p1_0) {
        ...
        if (Mscrm.Utilities.isTurboForm()) {
            var $v_5 = Mscrm.ActivityContainer.$t(Mscrm.ActivityContainer.$1, false);
            Mscrm.ActivityContainer.$G($v_5, 'subject');
            Mscrm.ActivityContainer.$d($v_5, 0);
            Mscrm.ActivityContainer.$G($v_5, 'leftvoicemail');
        }
        else {
            Mscrm.ActivityContainer.$u();
    ...
    dispose: function() {
        ...
        Mscrm.ActivityContainer.$F.dispose();
        Mscrm.ActivityContainer.$F = new Mscrm.CrmDisposeHelper();
