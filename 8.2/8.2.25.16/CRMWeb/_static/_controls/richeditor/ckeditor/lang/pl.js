...
CKEDITOR.lang['pl'] = {
    ...
    table : 
    {
    	...
    	cell : 
    	{
    		...
    		invalidRowSpan : 'Zakres wierszy musi być liczbą całkowitą.',
    		invalidColSpan : 'Zakres kolumn musi być liczbą całkowitą.',
    		chooseColor : 'Wybierz'
    	},
    	cellPad : 'Dopełnienie komórek',
    	cellSpace : 'Odstęp między komórkami',
    	column : 
    	{
    		menu : 'Kolumna',
    	...
    	invalidBorder : 'Grubość obramowania musi być liczbą.',
    ...
    {
    	label : 'Style',
    	panelTitle : 'Style formatowania',
    	panelTitle1 : 'Style bloków',
    	panelTitle2 : 'Style linii',
    ...
    pastetext : 
    {
    	...
    	title : 'Wklej jako zwykły tekst'
    },
    pastefromword : 
    {
    	confirmCleanup : 'Tekst, który chcesz wkleić, prawdopodobnie został skopiowany z programu Word. Czy chcesz go wyczyścić przed wklejeniem?',
    	error : 'Wyczyszczenie wklejonych danych nie było możliwe z powodu wewnętrznego błędu.',
    	title : 'Wklej z programu Word',
    	toolbar : 'Wklej z programu Word'
    },
    list : 
    {
    	bulletedlist : 'Wstaw/usuń listę punktowaną',
    	numberedlist : 'Wstaw/usuń listę numerowaną'
    },
    link : 
    {
    	acccessKey : 'Klawisz dostępu',
    	advanced : 'Zaawansowane',
    	advisoryContentType : 'Typ zawartości obiektu docelowego',
    	...
    	anchorName : 'Wg nazwy kotwicy',
    	charset : 'Kodowanie znaków połączonego zasobu',
    	cssClasses : 'Klasy arkuszy stylów',
    	...
    	title : 'Łącze',
    	toAnchor : 'Łącze do kotwicy w tekście',
    ...
    image : 
    {
    	...
    	button2Img : 'Czy chcesz przekonwertować zaznaczony przycisk graficzny na zwykły obraz?',
    	hSpace : 'Odstęp poziomy',
    	img2Button : 'Czy chcesz przekonwertować zaznaczony obraz na przycisk graficzny?',
    	...
    	upload : 'Przekaż',
    	urlMissing : 'Brak adresu URL obrazu.',
    ...
    expand : 
    {
    	expand : 'Rozwiń zawartość',
    	collapse : 'Zwiń zawartość'
    },
    embedmedia : 
    {
    	pathName : 'obiekt multimediów',
    	title : 'Osadź multimedia',
    	button : 'Osadź multimedia',
    	mediaHtml : 'Kod HTML multimediów',
    	unacceptedContent : '(Wszystkie tagi &lt;script&gt; i &lt;style&gt; zostaną usunięte)'
    },
    div : 
    {
    	IdInputLabel : 'Identyfikator',
    	advisoryTitleInputLabel : 'Opis obiektu docelowego',
    	cssClassInputLabel : 'Klasy arkuszy stylów',
    	edit : 'Edytuj pojemnik Div',
    	inlineStyleInputLabel : 'Styl wbudowany',
    ...
    {
    	copy : 'Kopiuj',
    	copyError : 'Ustawienia bezpieczeństwa Twojej przeglądarki nie pozwalają edytorowi na automatyczne operacje kopiowania. Użyj skrótu klawiaturowego (Ctrl/Cmd+C).',
    	cut : 'Wytnij',
    	cutError : 'Ustawienia bezpieczeństwa Twojej przeglądarki nie pozwalają edytorowi na automatyczne operacje wycinania. Użyj skrótu klawiaturowego (Ctrl/Cmd+X).',
    	paste : 'Wklej',
    	pasteArea : 'Obszar wklejania',
    	pasteMsg : 'Wklej zawartość w poniższym polu, używając skrótu klawiaturowego (<strong>Ctrl/Cmd+V</strong>), i kliknij przycisk OK.',
    	securityMsg : 'Ustawienia zabezpieczeń w przeglądarce uniemożliwiają edytorowi bezpośredni dostęp do danych w schowku. Wklej dane ponownie w tym oknie.',
    	title : 'Wklej'
    },
    button : 
    {
    ...
    common : 
    {
    	...
    	browseServer : 'Przeglądaj serwer',
    	url : 'Adres URL',
    	protocol : 'Protokół',
    	upload : 'Przekaż',
    	...
    	confirmNewPage : 'Wszystkie niezapisane modyfikacje tej treści zostaną utracone. Czy na pewno załadować nową stronę?',
    	...
    	invalidCssLength : 'Wartość podana dla pola „%1” musi być liczbą dodatnią bez jednostki lub z poprawną jednostką długości zgodną ze standardem CSS (px, %, in, cm, mm, em, ex, pt lub pc).',
    	invalidHtmlLength : 'Wartość podana dla pola „%1” musi być liczbą dodatnią bez jednostki lub z poprawną jednostką długości zgodną ze standardem HTML (px lub %).',
    	invalidInlineStyle : 'Wartość podana dla stylu musi składać się z jednej lub więcej krotek w formacie „nazwa : wartość”, rozdzielonych średnikami.',
    	cssLengthTooltip : 'Wpisz liczbę dla wartości w pikselach lub liczbę wraz z jednostką długości zgodną ze standardem CSS (px, %, in, cm, mm, em, ex, pt lub pc).',
    	unavailable : '%1<span class="cke_accessibility">, niedostępne</span>',
    	invalidURL: 'Adres URL musi być prawidłowym adresem internetowym.'
    },
    langSizing : 
    {
