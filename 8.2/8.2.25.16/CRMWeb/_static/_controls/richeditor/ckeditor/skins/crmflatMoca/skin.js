...
CKEDITOR.on( 'instanceLoaded', function( e ) {
	...
	fontSize( '.cke_dialog .cke_dialog_tab_label,\
		...
		.cke_dialog.cke_dialog .cke_dialog_ui_vbox_child_html_preview div.cke_dialog_ui_vbox_child_html_preview_label', editor.lang.langSizing.mocaDialogSectionLabel );
	fontSize( '.cke_dialog .cke_dialog_body label,\
		...
		.cke_dialog td.cke_dialog_ui_vbox_child_html>div.cke_dialog_ui_html[role=note]', editor.lang.langSizing.mocaDialogField );
	fontSize( '.cke_dialog div.cke_accessibility_legend dd,\
		.cke_dialog .cke_dialog_ui_html', editor.lang.langSizing.mocaDialogDescription );
	fontSize( '.cke_dialog .cke_dialog_footer_buttons a.cke_dialog_ui_button span', editor.lang.langSizing.mocaDialogButton );
	...
	fontSize( 'html.cke_panel_container div.cke_panel_block.cke_colorblock a.cke_colorauto td', editor.lang.langSizing.mocaColorPickerAutomaticText );
