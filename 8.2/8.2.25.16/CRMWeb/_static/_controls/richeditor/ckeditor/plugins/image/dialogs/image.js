							...
							children: [ {
								...
								setup: function( type, element ) {
									if ( type == IMAGE ) {
										...
										field.setValue( CrmEncodeDecode.CrmNameValueDecode( url ) ); // And call this.onChange()
				...
				},
				{
					...
					},
					{
						...
						children: [ {
							...
							html: '<div class="cke_dialog_ui_vbox_child_html_preview_container"><div class="cke_dialog_ui_vbox_child_html_preview_label">' + CKEDITOR.tools.htmlEncode( editor.lang.common.preview ) + '</div>' +
