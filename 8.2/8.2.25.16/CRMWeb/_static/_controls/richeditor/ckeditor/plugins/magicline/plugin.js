...
( function() {
	CKEDITOR.plugins.add( 'magicline', {
		lang: 'ar,bg,ca,cs,da,de,el,en,es,et,eu,fi,fr,gl,he,hi,hr,hu,id,it,ja,kk,ko,lt,lv,ms,nb,nl,pl,pt-br,pt,ro,ru,sk,sl,sr-latn,sr,sv,th,tr,uk,vi,zh-cn,zh-HK,zh', // %REMOVE_LINE_CORE%
		init: initPlugin
	} );
