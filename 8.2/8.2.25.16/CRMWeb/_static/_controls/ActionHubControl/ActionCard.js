        ...
        (function (CardUtils) {
            ...
            function getEntityImage(entityName, entityId) {
                if (Xrm.Internal.messages) {
                    var fetchXML = "<fetch mapping='logical'> <entity name='" + entityName + "'> <attribute name='entityimage_url' /> <filter> <condition attribute='" + entityName + 'id' + "' operator='eq' value='" + entityId + "' /> </filter> </entity> </fetch>";
            ...
            function getCardTypeEntities() {
                if (Xrm.Internal.messages) {
                    var fetchXML = "<fetch mapping='logical'> <entity name='cardtype'> <attribute name='cardtypeid' /><attribute name='cardname' />	<attribute name='softtitle' /><attribute name='hassnoozedismiss' /><attribute name='grouptype' /><attribute name='summarytext' /><attribute name='actions' /> </entity> </fetch>";
                    return Xrm.Internal.messages.retrieveMultiple(fetchXML);
                }
                else {
                    return null;
            ...
            function getEntityReference(entityLogicalName, entityId) {
                return new Xrm.Objects.EntityReference(entityLogicalName, new Microsoft.Crm.Client.Core.Framework.Guid(entityId));
            }
                    ...
                    if (keys.length > 0) {
                        ...
                        if (curRecord) {
                            ...
                            window.setTimeout(function () {
                                if (_this.fetchIsInprogress) {
                                    _this.fetchActionCommandsCompleted(callback);
                                }
                            }, 5000);
                            this._context.parameters.SubGrid.commanding.getRecordCommands(curRecord["actioncardid"].toString()).then(function (data) {
    ...
    (function (CRMNow) {
        var GenericCardView = (function (_super) {
            ...
            GenericCardView.prototype.handleDismiss = function (self) {
                if (!CRMNow.CardUtils.isMOCAOffline()) {
                    if (this.props.callbackContainer)
                        this.props.callbackContainer("dismiss", { "cardId": self.props.cardData.cardId, "isGroupSwipe": false });
                }
                else {
                    this.resetCard();
            ...
            GenericCardView.prototype.handleSnooze = function (self) {
                if (!CRMNow.CardUtils.isMOCAOffline()) {
                    if (this.props.callbackContainer)
                        this.props.callbackContainer("snooze", { "cardId": self.props.cardData.cardId, "isGroupSwipe": false });
                }
                else {
                    this.resetCard();
                    var offlineText = CRMNow.CardUtils.getResources('Error_Message_Generic_Mobile_Client_Offline');
            ...
            GenericCardView.prototype.onCardClick = function (event) {
                ...
                if (!this.mouseMoved) {
                    if (this.props.canShowDetailsView) {
                        action = "CardView";
                        data = { "cardId": this.props.cardData.cardId ? this.props.cardData.cardId : "", "data": this.props.cardData };
                    }
                    else if (!this.props.canShowDetailsView) {
                        if (this.props.cardData.data && this.props.cardData.data.mailweblink) {
                            action = "Navigation";
                            data = { "mailweblink": this.props.cardData.data.mailweblink, "cardData": this.props.cardData };
                        }
                        else {
                            if (this.props.regardingObject) {
                                if (this.props.regardingObject.LogicalName && this.props.regardingObject.Id) {
                                    action = "Navigation";
                                    data = { "entityName": this.props.regardingObject.LogicalName, "guid": this.props.regardingObject.Id.toString(), "cardData": this.props.cardData };
                                }
                            }
                            else if (this.props.cardData.data && this.props.cardData.data != null && this.props.cardData.data.cardContextDetails && this.props.cardData.data.cardContextDetails.length > 0) {
                                var contextItem = this.props.cardData.data.cardContextDetails[0];
                                var contextObject = contextItem ? contextItem.contextObject : "";
                                if (contextObject && contextObject.guid && contextObject.guid != null && contextObject.entityName && contextObject.entityName != null) {
                                    action = "Navigation";
                                    data = { "entityName": contextObject.entityName, "guid": contextObject.guid, "cardData": this.props.cardData };
                                }
                            }
                        }
                    }
            ...
            GenericCardView.prototype.handleActionClick = function (event, srcElememt, data) {
                if (this.props.callbackContainer) {
                    ...
                    this.props.callbackContainer("ActionClick", { "actionData": actionData, "cardId": this.props.cardData.cardId });
                }
            };
            ...
            GenericCardView.prototype.getActionData = function (card) {
                ...
                if (card.actions && commands && commands.length > 0) {
                    var filteredCommands = _.filter(commands, function (cmd) {
                        return ((cmd.command != "Mscrm.HomepageGrid.actioncard.DismissCommand" && cmd.command != "Mscrm.HomepageGrid.actioncard.SnoozeCommand") &&
                            ((cmd.command == "Mscrm.Modern.EmailAttendeesCommand" || cmd.command == "Mscrm.Modern.SendEmailCommand") ? canShowEmail : true));
                    });
                    ...
                    if (cardActions) {
                        ...
                        $.each(cardActions, function (label, command) {
                            if (actionCount < 2) {
                                var curcommand = _.find(filteredCommands, function (cmd) {
            ...
            GenericCardView.prototype.componentWillMount = function () {
                    ...
                    if (_this.mouseDown && cardBoundary && cardBoundary.width) {
                        if (_this.refs['genericCard']) {
                            ...
                            if (!_this.inSwipe && canPerformOp) {
                                ...
                                if (!(currentPosX > cardBoundary.left && currentPosX < cardBoundary.right) || !(currentPosY > cardBoundary.top && currentPosY < cardBoundary.bottom)) {
                                    _this.resetCard();
                                }
                            }
                        }
                ...
                this.swipeEndObserver.subscribe(function (muEvent) {
                    ...
                    if (cardBoundary && cardBoundary.width) {
                        if (Math.abs(startX - endPosX) / cardBoundary.width * 100 < 30 && Math.abs(startX - endPosX) != 0 || !(endPosY > cardBoundary.top && endPosY < cardBoundary.bottom)) {
                            _this.resetCard();
                        }
                            ...
                            if ((cardBoundary.right >= endPosX) && Boolean(_this.props.cardData.hasSnoozeDismiss)) {
                                ...
                                _this.timerId = setTimeout(function () {
                                    $(swipedElement).fadeOut("slow", function () {
            ...
            GenericCardView.prototype.resetCard = function () {
                ...
                if (this.props.callbackContainer)
                    this.props.callbackContainer("SwipeCards", { "currentElement": this.refs["genericCard"], "reset": true });
            };
            ...
            GenericCardView.prototype.elementMoveHandle = function (event) {
                ...
                if (this.props.callbackContainer)
                    this.props.callbackContainer("SwipeCards", { "currentElement": this.refs["genericCard"], "reset": reset });
            };
            GenericCardView.prototype.renderGenericSmallCard = function () {
                ...
                if (this.props.showPrimaryInfo) {
                    if (this.props.primaryTemplate == null) {
                        var contextObject = this.props.cardData.data && this.props.cardData.data != null ? this.props.cardData.data.cardContextDetails != null ? this.props.cardData.data.cardContextDetails[0].contextObject : undefined : undefined;
                        if (contextObject && contextObject.guid != null && contextObject.guid != undefined && contextObject.entityName != null && contextObject.entityName != undefined) {
                            var id = contextObject.guid;
                            id = id.replace(/-/g, "");
                            defaultIcon = Mscrm.Controls.VDOM.div(this.props.cardData.data, { key: "defaultIcon", className: CRMNow.CardUtils.defaultCardIcon(contextObject.entityName) + ' regarding ' + contextObject.entityName });
                            ...
                            if (CRMNow.CardUtils.isCCFMode()) {
                                if (contextObject.entityName != "" && contextObject.guid != "00000000-0000-0000-0000-000000000000") {
                                    var getEntityImg = CRMNow.CardUtils.getEntityImage(contextObject.entityName, contextObject.guid);
                                    getEntityImg.then(function (data) {
                                        if (data && data.entityCollection && data.entityCollection.get_entities().length > 0) {
                                            ...
                                            var id = data.entityCollection.get_entities()[0].getObjectData().identifier.id.rawguid;
                                            if (img && id && _this.imgBlockRef) {
                                                $(_this.imgBlockRef).find('*[data-entityimgid="' + "img_" + id + '"]').attr("src", img);
                                            }
                                        }
                                    }, function (failure) {
                            ...
                            defaultIcon = Mscrm.Controls.VDOM.div(this.props.cardData.data, { key: "defaultIcon", className: CRMNow.CardUtils.defaultCardIcon(this.props.cardData.cardName) });
                            imgBlock = Mscrm.Controls.VDOM.img(this.props.cardData, {
                                key: "iconCard",
                                src: ""
                            });
                        }
                        var imgBlockDiv = Mscrm.Controls.VDOM.div(this.props.cardData, { key: "imgBlockDiv", className: "imgdiv", ref: function (r) { return _this.imgBlockRef = r; } }, [imgBlock, defaultIcon]);
                        var title = this.props.cardData.title && this.props.cardData.title != null ? this.props.cardData.title : "";
                        if (this.props.cardData.softTitle != undefined && this.props.cardData.softTitle != "") {
                            if (this.props.cardData.softTitle.indexOf(":") != -1) {
                                ...
                                if (titleArray && titleArray.length > 0 && this.props.cardData.cardName.indexOf("AGENDA") != -1) {
                                    if (titleArray[1] != undefined && titleArray[1] != "" && titleArray[1].length > 0)
                                        title = titleArray[1];
                                    else
                                        title = this.props.cardData.softTitle;
                                    title += " : " + (this.props.cardData.originalTitle && this.props.cardData.originalTitle != null ? this.props.cardData.originalTitle : "");
                                    if (this.props.softTitleGenerator) {
                                        var starttime = this.props.cardData.data.cardRelatedInfo ? this.props.cardData.data.cardRelatedInfo.starttime : "";
                                        if (starttime && title)
                                            title = this.props.softTitleGenerator(title, starttime);
                                    }
                                    else {
                                        if (this.props.cardData.data && this.props.cardData.data.cardRelatedInfo && this.props.cardData.data.cardRelatedInfo.starttime) {
                                            title = this.softTitleGenerator(title, this.props.cardData.data.cardRelatedInfo.starttime);
                                        }
                                    }
                                }
                            }
                        ...
                        if (title) {
                            var titleElement = Mscrm.Controls.VDOM.div(this.props.cardData, {
                                key: "cardPrimTitle",
                                className: "card-primaryTitle" + (this.props.showIcon == true ? " no-left-margin" : "") + (this.props.showDescription && this.props.cardData.description ? " card-primaryTitle-withDescription" : "")
                            }, title);
                        }
                        var descriptionDiv;
                        if (this.props.showDescription && this.props.cardData.description) {
                            descriptionDiv = Mscrm.Controls.VDOM.div(this.props.cardData, {
                                ...
                                className: this.props.showIcon == true ? "generalCard-description no-left-margin" : "generalCard-description"
                            }, this.props.cardData.description);
                        }
                        var contentDiv = Mscrm.Controls.VDOM.div(this.props.cardData, { className: "group-attendeeicon" }, [imgBlockDiv, titleElement]);
                        content = Mscrm.Controls.VDOM.div(this.props.cardData, {
                            key: "content",
                            className: "generalCard-maincontent generalCard-maincontent-small" + (this.props.showIcon != true ? " align-center" : "")
                    ...
                    if (this.props.callerApp == "WebClient") {
                        var card = Mscrm.Controls.VDOM.div(this.props.cardData, {
                            key: "card",
                            className: this.props.isGroup ? "generalCard generalCard-small generalCard-small-group" : "generalCard generalCard-small",
                            onClick: this.onCardClick.bind(null, this)
                        }, [imgBlock, content]);
                        container = Mscrm.Controls.VDOM.div(this.props.cardData, { className: "swipe-content" }, [card]);
                    }
                    else {
                        var snoozeIcon = Mscrm.Controls.VDOM.div(this.props.cardData, { key: "snoozeIcon", className: "CRMMDL2 icon-snooze" });
                        var snoozeStr = CRMNow.CardUtils.getSnoozeTimeStr(this.props.cardData).split(/\s/);
                        var snoozeFirstWord = Mscrm.Controls.VDOM.div(this.props.cardData, { key: "snoozeWord", className: "first-word" }, snoozeStr[0]);
                        snoozeStr.shift();
                        var snoozeString = Mscrm.Controls.VDOM.div(this.props.cardData, { key: "snoozeText ", className: "snooze-text" }, [snoozeFirstWord, snoozeStr.join(" ")]);
                        var snooze = Mscrm.Controls.VDOM.div(this.props.cardData, { key: "snooze", className: "snooze" }, [snoozeIcon, snoozeString]);
                        var defaultSnooze = Mscrm.Controls.VDOM.div(this.props.cardData, { key: "snoozeContainer", ref: "snooze-container", className: "snooze-container" }, [snooze]);
                        var swipeUndoLabel = Mscrm.Controls.VDOM.span(this.props.cardData, { onClick: this.undoClick.bind(null, this), key: "snoozeUndo", className: "swipe-undo-label" }, CRMNow.CardUtils.getResources("ActionCard.CFC.Common.Undo"));
                        var swipeUndoContainer = Mscrm.Controls.VDOM.div(this.props.cardData, { key: "snoozeUndoContainer", className: "swipe-undo" }, swipeUndoLabel);
                        var snoozed = Mscrm.Controls.VDOM.div(this.props.cardData, { key: "snoozeAction", className: "swipedaction" }, CRMNow.CardUtils.getResources("ActionCard.CFC.Common.Snoozing"));
                        var snoozedState = Mscrm.Controls.VDOM.div(this.props.cardData, { key: "snoozeState", ref: "snooze-state", className: "snooze-state" }, [snoozed, swipeUndoContainer]);
                        var snoozeDiv = Mscrm.Controls.VDOM.div(this.props.cardData, { key: "snoozeleft", className: "snooze-left" }, [defaultSnooze, snoozedState]);
                        var dismissIcon = Mscrm.Controls.VDOM.div(this.props.cardData, { key: "dismissIcon", className: "CRMMDL2 icon-dismark" });
                        var dismissText = Mscrm.Controls.VDOM.div(this.props.cardData, { key: "dismissText", className: "dismiss-text" }, CRMNow.CardUtils.getResources("ActionCard.CFC.Common.Dismiss"));
                        var dismiss = Mscrm.Controls.VDOM.div(this.props.cardData, { key: "dismiss", className: "dismiss" }, [dismissIcon, dismissText]);
                        var dismissContainer = Mscrm.Controls.VDOM.div(this.props.cardData, { key: "dismissContainer", ref: "dismiss-container", className: "dismiss-container" }, [dismiss]);
                        var dismissed = Mscrm.Controls.VDOM.div(this.props.cardData, { key: "dismissAction", className: "swipedaction" }, CRMNow.CardUtils.getResources("ActionCard.CFC.Common.Dismissing"));
                        var dismissedState = Mscrm.Controls.VDOM.div(this.props.cardData, { key: "dismissState", ref: "dismiss-state", className: "dismiss-state" }, [dismissed, swipeUndoContainer]);
                        var dismissDiv = Mscrm.Controls.VDOM.div(this.props.cardData, { key: "dismissRight", className: "dismiss-right" }, [dismissContainer, dismissedState]);
                        var card = Mscrm.Controls.VDOM.div(this.props.cardData, {
                            key: "card",
                            ref: "swipe-content",
                            className: this.props.isGroup ? "generalCard generalCard-small generalCard-small-group" : "generalCard generalCard-small generalCard-small-group setborder",
                            onClick: this.onCardClick
                        }, this.props.showIcon == true ? [imgBlockDiv, content] : [content]);
                        container = Mscrm.Controls.VDOM.div(this.props.cardData, { key: "swipeContent", className: "swipe-content" }, [snoozeDiv, card, dismissDiv]);
                    }
                }
                else {
                    ...
                    if (!this.props.titleTemplate) {
                        ...
                        if (this.props.cardData.softTitle != undefined && this.props.cardData.softTitle != "") {
                            ...
                            if (this.props.softTitleGenerator) {
                                ...
                                if (this.props.cardData.data && this.props.cardData.data.cardRelatedInfo && this.props.cardData.data.cardRelatedInfo.starttime) {
                                    formatedTitle = this.softTitleGenerator(formatedTitle, this.props.cardData.data.cardRelatedInfo.starttime);
                                }
                            }
                        }
            ...
            GenericCardView.prototype.renderGenericMediumCard = function () {
                ...
                if (this.props.showPrimaryInfo) {
                    if (this.props.primaryTemplate == null) {
                        var description = Mscrm.Controls.VDOM.div(this.props.cardData, {
                            ...
                            dangerouslySetInnerHTML: { __html: this.props.cardData.description ? CRMNow.CardUtils.htmlDecoder(this.props.cardData.description) : "" }
                        });
                        ...
                        mainContent = Mscrm.Controls.VDOM.div(this.props.cardData, {
                            key: "cardTitle",
                            className: "generalCard-contentcontainer"
                        }, [this.renderCardTitle(), this.props.primaryTemplate ? this.props.primaryTemplate(this) : "", menu, optionBtn]);
                    }
                }
                ...
                if (this.props.callerApp == "WebClient") {
                    var cardData = Mscrm.Controls.VDOM.div(this.props.cardData, { key: "cardData", className: "swipe-medium-data" }, [mainContent, contextContent, relatedContent, this.renderGenericCardFooter()]);
                    var card = Mscrm.Controls.VDOM.div(this.props.cardData, {
                    ...
                    var dismissedState = Mscrm.Controls.VDOM.div(this.props.cardData, { key: "dismissState", ref: "dismiss-state", className: "dismiss-state" }, [dismissed, swipeUndoContainer]);
                    var dismissDiv = Mscrm.Controls.VDOM.div(this.props.cardData, { key: "dismissRight", className: "dismiss-right" }, [dismissContainer, dismissedState]);
                    var cardData = Mscrm.Controls.VDOM.div(this.props.cardData, { key: "cardData", ref: "swipe-content", className: "swipe-medium-data" }, [mainContent, contextContent, relatedContent, this.renderGenericCardFooter()]);
                    var card = Mscrm.Controls.VDOM.div(this.props.cardData, {
                        key: this.props.cardData.cardId,
                        className: this.props.showSuccessCardOverlay ? "overlay generalCard generalCard-medium" : "generalCard generalCard-medium",
                ...
                if (this.props.callerApp == "WebClient") {
                    ...
                    if (this.props.cardData.data.cardTypeData.cardtypeid == "{0734FEA3-46B9-4E9C-9001-53E957EC2DD4}") {
                        ...
                        webClientCardProps = {
                            ...
                            id: this.props.cardData.cardId,
                            onClick: this.props.defaultActionTemplate ? this.props.defaultActionTemplate.bind(this) : null
                        };
                    }
...
(function (MscrmControls) {
    ...
    (function (ActionCard) {
        var ActionCardUtil = (function () {
            ...
            ActionCardUtil.getSegmentValueFromReferenceTokens = function (referenceTokens, referenceTokenType, segment, returnFormat) {
                var segmentValue;
                    ...
                    if (referenceTokenObject) {
                        ...
                        if (referenceTokenObject_TokenType) {
                            ...
                            if (referenceTokenObject_TokenType_Segment) {
                                if (returnFormat == "ResourceString") {
                                    var _window = window;
                                    segmentValue = _window.Xrm.Internal.getResourceString(referenceTokenObject_TokenType_Segment, window.top);
                                }
            ...
            ActionCardUtil.calculateRemainingTime = function (startTime) {
                ...
                if (startTime) {
                    ...
                    var timeLeft = "";
                    if (duration.hours() > 0) {
                        var hoursText = _window.Xrm.Internal.getResourceString("ActionCard.CFC.Common.Hours", window.top);
                        remainingTime = duration.hours().toString() + " " + hoursText;
                    }
                    else if (duration.minutes() > 0) {
                        var minutesText = _window.Xrm.Internal.getResourceString("ActionCard.CFC.Common.Minutes", window.top);
                        remainingTime = duration.minutes().toString() + " " + minutesText;
                    }
                    else {
                        var timeExpiredText = _window.Xrm.Internal.getResourceString("ActionCard.CFC.Common.TimeExpired", window.top);
    ...
    (function (ActionCard) {
        ...
        var ActionCardView = (function (_super) {
            ...
            ActionCardView.prototype.generateDomElementsFromReferenceTokens = function (referenceTokenType) {
                ...
                var params = ActionCard.ActionCardUtil.getSegmentValueFromReferenceTokens(this.props.cardData.data.referencetokens, referenceTokenType, "Params", "Object");
                if (!params) {
                    return null;
                }
                var resourceString = ActionCard.ActionCardUtil.getSegmentValueFromReferenceTokens(this.props.cardData.data.referencetokens, referenceTokenType, "ResourceId", "ResourceString");
                ...
                for (var i = 0; i < params.length; i++) {
                    ...
                    if (paramsType == 1) {
                        try {
                            ...
                            if ((dateTime != null)) {
                                var specifier = "D";
                                if (name.indexOf("T") != -1) {
                                    var timeZoneDifference = _window.USER_TIMEZONE_OFFSET + dateTime.getTimezoneOffset();
                    ...
                    var placeholder = placeholders[i].substring(placeholders[i].indexOf("{"), placeholders[i].indexOf("}") + 1);
                    name = placeholders[i].replace(placeholder, name);
                    if (recordId) {
                        var entityName = _window.Xrm.Internal.getEntityName(params[i]["TypeCode"]);
                        formattedParams[i] = Mscrm.Controls.VDOM.anchor(this.props.cardData, { href: "javascript:Xrm.Utility.openEntityForm('" + entityName + "','{" + recordId + "}');", className: "cardText", tabIndex: "-1" }, " " + name);
                    }
                    else {
                ...
                for (var i = 0, j = 0; i < resourceStringSegments.length; i++) {
                    if (resourceStringSegments[i].match(regExpr)) {
                        ...
                        domElements[i] = Mscrm.Controls.VDOM.span(this.props.cardData, {}, " " + resourceStringSegments[i]);
                        if (toolTip == "") {
            ...
            ActionCardView.prototype.handleDismissOnClick = function (event) {
                ActionCard.handleCommand(this.props.cardData.cardId, "Mscrm.HomepageGrid.actioncard.DismissCommand", event);
            };
            ...
            ActionCardView.prototype.handleSnoozeOnClick = function (event) {
                ActionCard.handleCommand(this.props.cardData.cardId, "Mscrm.HomepageGrid.actioncard.SnoozeCommand", event);
            };
            ...
            ActionCardView.prototype.handleSnoozeHover = function (event) {
                ...
                element.src = _window.getAttributeInWindow("CDNURL") + '/_static/_controls/actionhubcontrol/iconsnoozeonfocus.png';
            };
            ActionCardView.prototype.handleDismissHover = function (event) {
                ...
                while (element.className != 'closeCard')
                    element = element.firstChild;
                element.src = _window.getAttributeInWindow("CDNURL") + '/_static/_controls/actionhubcontrol/icondismissonfocus.png';
            };
            ActionCardView.prototype.handleSnoozeNoHover = function (event) {
                ...
                while (element.className != 'snoozeCard')
                    element = element.firstChild;
                element.src = _window.getAttributeInWindow("CDNURL") + '/_static/_controls/actionhubcontrol/iconsnoozenofocus.png';
            };
            ActionCardView.prototype.handleDismissNoHover = function (event) {
                ...
                while (element.className != 'closeCard')
                    element = element.firstChild;
                element.src = _window.getAttributeInWindow("CDNURL") + '/_static/_controls/actionhubcontrol/icondismissnofocus.png';
            };
            ActionCardView.prototype.handleActionCommandOnKeyDown = function (requestedActionCommandKey, event) {
                if ((event.keyCode == 9) || (event.charCode == 9)) {
                    if (($(event.target).next().length == 0) && ($(event.target).closest('.actionhubcontrol').next().length == 0)) {
            ...
            ActionCardView.prototype.executeDefaultAction = function (event) {
                ...
                if (varDefaultActionJson) {
                    ...
                    if (defaultActionKeys.length > 0) {
                        ActionCard.handleCommand(this.props.cardData.cardId.toString(), defaultActions[defaultActionKeys[0]], event);
                    }
                }
            };
            ...
            ActionCardView.prototype.showTitleTemplate = function () {
                ...
                if (this.props.cardTypeIcon != "") {
                    ...
                    if (cardNameToolTip && (cardNameToolTip != null) && (cardNameToolTip != undefined) && (cardNameToolTip != "[object Object]")) {
                        imgCardTypeIcon = Mscrm.Controls.VDOM.img(this.props.cardData, {
                            src: this.props.cardData.cardTypeIcon, alt: cardNameToolTip
                        });
                        anchorCardTypeIcon = Mscrm.Controls.VDOM.anchor(this.props.cardData, {
                            className: "generalCard-leftblock", onClick: this.executeDefaultActionOnClick.bind(this), onKeyPress: this.executeDefaultActionOnKeyPress.bind(this),
                            href: "#c12", 'aria-label': cardNameToolTip, tabIndex: "0", title: cardNameToolTip }, imgCardTypeIcon);
                    }
                    else {
                        imgCardTypeIcon = Mscrm.Controls.VDOM.img(this.props.cardData, {
                        ...
                        anchorCardTypeIcon = Mscrm.Controls.VDOM.anchor(this.props.cardData, {
                            tabIndex: "0", className: "generalCard-leftblock", onClick: this.executeDefaultActionOnClick.bind(this), onKeyPress: this.executeDefaultActionOnKeyPress.bind(this) }, imgCardTypeIcon);
                    }
                }
                var divTitleDescription = Mscrm.Controls.VDOM.div(this.props.cardData, {
                    className: "generic-PrimTitle", title: varTitleToolTip, tabIndex: "0", onKeyPress: this.executeDefaultActionOnKeyPress.bind(this)
                }, this.props.cardData.title ? this.props.cardData.title : "");
                var cardtypeidArrays = ["{64A6C256-E479-41F5-8719-D1AFC4835FE8}", "{CF6BDDD4-E712-4F1D-97B6-68D3A7788A97}", "{DEA00147-C288-49D2-83C8-8B6437868C5A}", "{EEC00A9D-0D1E-445A-83AD-A3A6FB603CD4}",
                    "{7AC21A31-8C11-4239-8505-A9FD748439DC}", "{E9BF7F81-442C-4145-BD43-F68FFC56CD54}", "{8B087B1A-CF01-4203-921C-97DC156225EF}", "{6C54F024-E4DD-40DD-AC05-92667ED7FA3B}",
                ...
                if (this.props.cardData.data.priority >= 1000) {
                    snoozeToolTip = _window.Xrm.Internal.getResourceString("Ribbon.Tooltip.actioncard.Snooze.Minutes", window.top);
                    ...
                    snoozeToolTip = _window.Xrm.Internal.getResourceString("Ribbon.Tooltip.actioncard.Snooze.Hours", window.top);
                    snoozeReplacements = ["12"];
                }
                snoozeToolTip = ActionCard.ActionCardUtil.formatString(snoozeToolTip, snoozeRemovables, snoozeReplacements);
                var imgSnoozeIcon = Mscrm.Controls.VDOM.img(this.props.cardData, { className: "snoozeCard", alt: snoozeToolTip, src: _window.getAttributeInWindow("CDNURL") + "/_static/_controls/actionhubcontrol/iconsnoozenofocus.png" });
                var anchorSnoozeIcon = Mscrm.Controls.VDOM.anchor(this.props.cardData, {
                    className: "snoozeCardIcon", onMouseOver: this.handleSnoozeHover.bind(this), onMouseOut: this.handleSnoozeNoHover.bind(this), onFocus: this.handleSnoozeHover.bind(this), onBlur: this.handleSnoozeNoHover.bind(this), onClick: this.handleSnoozeOnClick.bind(this), onKeyPress: this.handleSnoozeOnKeyPress.bind(this),
                    href: "#c12", 'aria-label': snoozeToolTip, tabIndex: "0", title: snoozeToolTip }, imgSnoozeIcon);
                var dismissToolTip = _window.Xrm.Internal.getResourceString("Ribbon.Tooltip.actioncard.Dismiss", window.top);
                var imgDismissIcon = Mscrm.Controls.VDOM.img(this.props.cardData, { className: "closeCard", alt: dismissToolTip, src: _window.getAttributeInWindow("CDNURL") + "/_static/_controls/actionhubcontrol/icondismissnofocus.png" });
                var anchorDismissIcon = Mscrm.Controls.VDOM.anchor(this.props.cardData, {
                    onMouseOver: this.handleDismissHover.bind(this), onMouseOut: this.handleDismissNoHover.bind(this), onFocus: this.handleDismissHover.bind(this), onBlur: this.handleDismissNoHover.bind(this), onClick: this.handleDismissOnClick.bind(this), onKeyPress: this.handleDismissOnKeyPress.bind(this),
                    href: "#c12", 'aria-label': dismissToolTip, tabIndex: "0", title: dismissToolTip }, imgDismissIcon);
                var divIconGroup = Mscrm.Controls.VDOM.div(this.props.cardData, { className: "pullRightClass" }, [anchorSnoozeIcon, anchorDismissIcon]);
                ...
                if (formattedSoftTitle.indexOf("{0}") >= 0) {
                    ...
                    formattedSoftTitle = ActionCard.ActionCardUtil.formatString(formattedSoftTitle, removables, replacements);
                }
                var divSoftTitle = Mscrm.Controls.VDOM.div(this.props.cardData, {
                    className: "generalCard-softTitle", tabIndex: "0", title: formattedSoftTitle
            ...
            ActionCardView.prototype.showPrimaryTemplate = function () {
                ...
                if (!this.props.cardData.description) {
                    if (this.props.cardData.data.referencetokens != undefined) {
                        ...
                        divCardDescription = Mscrm.Controls.VDOM.div(this.props.cardData, { className: "Prim-Text-Info" }, [Mscrm.Controls.VDOM.span(this.props.cardData.data, {}, this.props.cardData.description)]);
                        if (this.props.cardData.description) {
                    ...
                    divCardDescription = Mscrm.Controls.VDOM.div(this.props.cardData, { className: "Prim-Text-Info", dangerouslySetInnerHTML: { __html: this.props.cardData.description ? this.props.cardData.description : "" } });
                    varDescriptionToolTip = ActionCard.ActionCardUtil.removeHtmlTags(this.props.cardData.description);
                }
                return Mscrm.Controls.VDOM.div(this.props.cardData, { className: "cardDescription", tabIndex: "0", title: varDescriptionToolTip, 'aria-label': varDescriptionToolTip, onKeyPress: this.executeDefaultActionOnKeyPress.bind(this) }, [divCardDescription]);
            };
            ActionCardView.prototype.showActionTemplate = function () {
                ...
                if (varActionsJson) {
                    ...
                    var action1Anchor = Mscrm.Controls.VDOM.anchor(this.props.cardData, { href: "javascript:MscrmControls.ActionCard.handleCommand('" + actionCardId + "','" + actions[actionKeys[0]] + "');", className: "actionItemsClass generalCardAction", tabIndex: "0", title: action1Name }, action1Name);
                    var action1Div = Mscrm.Controls.VDOM.div(this.props.cardData, { onKeyDown: this.handleActionCommandOnKeyDown.bind(this, actions[actionKeys[0]]) }, [action1Anchor]);
                    actionComponents.push(action1Div);
                    if (actionKeys[1]) {
                        var action2Name = _window.Xrm.Internal.getResourceString(actionKeys[1], window.top);
                        var action2Anchor = Mscrm.Controls.VDOM.anchor(this.props.cardData, { href: "javascript:MscrmControls.ActionCard.handleCommand('" + actionCardId + "','" + actions[actionKeys[1]] + "');", className: "actionItemsClass generalCardAction", tabIndex: "0", title: action2Name }, action2Name);
                        var action2Div = Mscrm.Controls.VDOM.div(this.props.cardData, { onKeyDown: this.handleActionCommandOnKeyDown.bind(this, actions[actionKeys[1]]) }, [action2Anchor]);
                        actionComponents.push(action2Div);
                    }
                    return Mscrm.Controls.VDOM.div(this.props.cardData, { className: "generalCard-footer-text" }, actionComponents);
                }
            };
            ActionCardView.prototype.executeDefaultActionOnCardClick = function (event) {
                var targetele = event.target;
                if (targetele.tagName.toLowerCase() != 'img' && targetele.tagName.toLowerCase() != 'a' && targetele.className != "generalCardAction") {
                    this.executeDefaultAction(event);
                }
            };
        ...
        var LetsGetStartedCardView = (function (_super) {
            ...
            LetsGetStartedCardView.prototype.renderActions = function () {
                ...
                if (varActionsJson) {
                    ...
                    var buttonAction1 = Mscrm.Controls.VDOM.button(this.props.cardData, { className: "startUpCardButton", tabIndex: "0", title: action1Name, onClick: this.handleCommandOnClick.bind(this, action1) }, action1Name);
                    var divAction1 = Mscrm.Controls.VDOM.div(this.props.cardData, { className: "startUpCardButtonContainer" }, [buttonAction1]);
            ...
            LetsGetStartedCardView.prototype.renderCardContentTemplate = function () {
                ...
                if (this.props.areActionCardsActive == true) {
                    letsGetStartedIconUrl = _window.getAttributeInWindow("CDNURL") + "/_static/_controls/ActionHubControl/CardsPreview.gif";
                    letsGetStartedCardIconAlt = _window.Xrm.Internal.getResourceString("ActionCard.LetsGetStarted.CardsPreview", window.top);
                    var letsGetStartedCardTitle = _window.Xrm.Internal.getResourceString("ActionCard.LetsGetStarted.ActivatedTitle", window.top);
                    var divLetsGetStartedCardTitle = Mscrm.Controls.VDOM.div(this.props.cardData, { className: "startUpCardTitleText" }, letsGetStartedCardTitle);
                    letsGetStartedDescription = _window.Xrm.Internal.getResourceString("ActionCard.LetsGetStarted.ActivatedBody", window.top);
                    var divLetsGetStartedDescription = Mscrm.Controls.VDOM.div(this.props.cardData, { className: "startUpCardDescriptionText", "aria-live": "polite" }, letsGetStartedDescription);
                    var divLetsGetStartedDescriptionContainer = Mscrm.Controls.VDOM.div(this.props.cardData, { className: "startupCardDescription" }, [divLetsGetStartedDescription]);
                    divLetsGetStartedCardContentBody = Mscrm.Controls.VDOM.div(this.props.cardData, { className: 'pullLeftClass startupCardDescriptionContainer' }, [divLetsGetStartedCardTitle, divLetsGetStartedDescriptionContainer]);
                }
                else {
                    letsGetStartedIconUrl = _window.getAttributeInWindow("CDNURL") + "/_static/_controls/ActionHubControl/IconLetsGetStarted.png";
                    letsGetStartedCardIconAlt = _window.Xrm.Internal.getResourceString("CardType_ToolTip_LetsGetStarted", window.top);
                    letsGetStartedDescription = ActionCard.ActionCardUtil.getSegmentValueFromReferenceTokens(this.props.cardData.data.referencetokens, "body", "ResourceId", "ResourceString");
                    var divLetsGetStartedDescription = Mscrm.Controls.VDOM.div(this.props.cardData, { className: "startUpCardDescriptionText" }, letsGetStartedDescription);
                    var divLetsGetStartedDescriptionContainer = Mscrm.Controls.VDOM.div(this.props.cardData, { className: "startupCardDescription" }, [divLetsGetStartedDescription]);
                    var divLetsGetStartedAction = this.renderActions();
                    var divLetsGetStartedActionContainer = Mscrm.Controls.VDOM.div(this.props.cardData, {}, [divLetsGetStartedAction]);
                    divLetsGetStartedCardContentBody = Mscrm.Controls.VDOM.div(this.props.cardData, { className: 'pullLeftClass startupCardDescriptionContainer' }, [divLetsGetStartedDescriptionContainer, divLetsGetStartedActionContainer]);
                }
                var imgLetsGetsStartedIcon = Mscrm.Controls.VDOM.img(this.props.cardData, { src: letsGetStartedIconUrl, width: '100px', height: '100px', alt: letsGetStartedCardIconAlt, "aria-label": letsGetStartedCardIconAlt });
                var divImgLetsGetsStartedIcon = Mscrm.Controls.VDOM.div(this.props.cardData, { className: "startUpCardIconTips pullLeftClass" }, [imgLetsGetsStartedIcon]);
                var divLetsGetStartedCardInnerContent = Mscrm.Controls.VDOM.div(this.props.cardData, { className: "startUpCardInnerLayout" }, [divImgLetsGetsStartedIcon, divLetsGetStartedCardContentBody]);
                var divLetsGetStartedCardContent = Mscrm.Controls.VDOM.div(this.props.cardData, { className: "startUpCardLayout swipe-medium-data" }, [divLetsGetStartedCardInnerContent]);
