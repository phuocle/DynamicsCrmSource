...
{
    var resourcesArray = ["ActionCard.LetsGetStarted.ActivatedTitle","ActionCard.LetsGetStarted.ActivatedBody","Ribbon.Tooltip.actioncard.Dismiss","Ribbon.Tooltip.actioncard.Snooze.Minutes","Ribbon.Tooltip.actioncard.Snooze.Hours","CardType_ToolTip_LetsGetStarted","ActionCard.LetsGetStarted.CardsPreview"];
...
function loadCards(isCarouselView)
{
    ...
    var arguments = {};
    arguments["isCarouselView"] = isCarouselView;
    if(Mscrm.ActionCardData.length > 0)
    {
        ...
        {
            arguments["whatsDisplayed"] = "letsGetStartedCard";
            loadLetsGetStartedCard(false)
        }
        else
        {
            arguments["whatsDisplayed"] = "allCards";
        ...
        if(isCarouselView)
        {
            arguments["whatsDisplayed"] = "noCards";
            $(parent.$("#containerID")).hide()
        }
        else
        {
            arguments["whatsDisplayed"] = "smileyCard";
    ...
    Mscrm.MetricsReporting.instance().addMetric("ActionCardOnLoad",arguments)
}
...
function loadLetsGetStartedCard(areActionCardsActive)
{
    ...
    var objCardData = {mode:"medium",cardId:letsGetStartedCardData.actioncardid,cardName:typeof varCardTypeData.cardname == "object" ? varCardTypeData.cardname.get_value() : varCardTypeData.cardname,cardTypeIcon:typeof varCardTypeData.cardtypeicon == "object" ? varCardTypeData.cardtypeicon.get_value() : varCardTypeData.cardtypeicon,description:letsGetStartedCardData.description,data:letsGetStartedCardData},
        letsGetStartedCard = MscrmControls.ActionCard.LetsGetStartedCardControl({cardData:objCardData,areActionCardsActive:varAreActionCardsActive});
...
function loadActionCards(isCarouselView)
{
    ...
    {
        var varCardTypeData = cardTypeDictionary[Mscrm.ActionCardData[actionCardIndex - 1].cardtypeid.Id.toString().toUpperCase()],
            varActionCardData = Mscrm.ActionCardData[actionCardIndex - 1];
        varActionCardData.cardTypeData = varCardTypeData;
        var objCardData = {mode:"medium",cardId:varActionCardData.actioncardid,cardName:typeof varCardTypeData.cardname == "object" ? varCardTypeData.cardname.get_value() : varCardTypeData.cardname,cardTypeIcon:typeof varCardTypeData.cardtypeicon == "object" ? varCardTypeData.cardtypeicon.get_value() : varCardTypeData.cardtypeicon,softTitle:typeof varCardTypeData.softtitle == "object" ? varCardTypeData.softtitle.get_value() : varCardTypeData.softtitle,title:varActionCardData.title,description:varActionCardData.description,data:varActionCardData},
            ActionCardControl = MscrmControls.ActionCard.varActionCardControl({cardData:objCardData,isCarouselView:isCarouselView});
...
{
    if(Mscrm.ActionCardData.length == 1 && Mscrm.ActionCardData[0].cardtypeid.Id.toString().toUpperCase() == "0734FEA3-46B9-4E9C-9001-53E957EC2DD4")
        return true;
    return false
}
function openRIConfiguUiPopUp()
{
    var src = Mscrm.CrmUri.create("/_static/tools/RelationshipIntelligenceConfig/UnifiedConfig.html?ispersonal=true").toString();
    window.open(src,"_blank","toolbar=0,location=0,menubar=0,resizable=1,width=966,height=628")
}
function openRIFeedback()
{
    window.open("https://go.microsoft.com/fwlink/p/?LinkId=825778","_blank","toolbar=0,location=0,menubar=0,resizable=1,width=966,height=628,scrollbars=1")
}
function addActionTelemetry(actionType,cardType,isWebClient)
{
    isWebClient = isWebClient == "true" || isWebClient == true;
    try
    {
        var arguments = {};
        arguments["actionType"] = actionType;
        arguments["cardType"] = cardType;
        arguments["isWebClient"] = isWebClient;
        Mscrm.MetricsReporting.instance().addMetric("relationshipcardactiontaken",arguments)
    }
    catch(e)
    {
    }
...
{
    var _window = window,
        feedbackImageUrl = _window.getAttributeInWindow("CDNURL") + "/_static/_controls/actionhubcontrol/feedback_16.png";
    $("#feedbackImage").attr("src",feedbackImageUrl);
    var customizationImageUrl = _window.getAttributeInWindow("CDNURL") + "/_static/_controls/actionhubcontrol/card_customization_16.png";
    $("#customizationImage").attr("src",customizationImageUrl);
    $("#feedbackImage").hover(function()
    {
        var feedbackImageUrlOnHover = _window.getAttributeInWindow("CDNURL") + "/_static/_controls/actionhubcontrol/feedback_hover_16.png";
    ...
    {
        var customizationImageUrlOnhover = _window.getAttributeInWindow("CDNURL") + "/_static/_controls/actionhubcontrol/card_customization_hover_16.png";
        $("#customizationImage").attr("src",customizationImageUrlOnhover)
    },function()
    {
        $("#customizationImage").attr("src",customizationImageUrl)
    });
    $("#feedbackAnchor").on("keydown click",function(e)
    {
    ...
    $("#customizeAnchor").on("keydown click",function(e)
    {
        if(e.which === 13 || e.which === 32 || e.type === "click")
        {
            e.preventDefault();
