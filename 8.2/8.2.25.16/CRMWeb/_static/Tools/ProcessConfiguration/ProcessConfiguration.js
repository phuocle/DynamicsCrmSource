...
ProcessControl.Configuration.RelationshipPickerDialogInitializer.initialize = function() {
    ...
    ProcessControl.Configuration.RelationshipPickerDialogInitializer.$4t = $v_1.createRelationshipPickerView(ProcessControl.Configuration.RelationshipPickerDialogInitializer.$12, $v_6, $v_7);
...
ProcessControl.Configuration.AddChildControlBehavior.prototype = {
    ...
    get_enabledIconInfo: function() {
        if (IsNull(this.$3s_3)) {
            this.$3s_3 = Mscrm.ImageStrip.getImageInfo(Mscrm.CrmUri.create(window.CDNURL + '/_imgs/processcontrol/21_orangeplus.png'));
        }
        return this.$3s_3;
    },
    ...
    get_$5R_3: function() {
        if (IsNull(this.$3o_3)) {
            this.$3o_3 = Mscrm.ImageStrip.getImageInfo(Mscrm.CrmUri.create(window.CDNURL + '/_imgs/processcontrol/21_inactiveplus.png'));
        }
        return this.$3o_3;
    },
...
ProcessControl.Configuration.AddStepBehavior.prototype = {
    ...
    $7O_4: function() {
        ...
        this.$u_4.find('li').focus(this.$$d_$8x_4).mouseover(this.$$d_$8x_4).mouseleave(this.$$d_$AS_4).click(this.$$d_$5q_4).keydown(this.$$d_$8o_4);
    ...
    $AH_4: function($p0, $p1) {
        ...
        if (IsNull(this.$1w_4) || IsNull(this.$1w_4.get_dataContext()) || IsNull(this.$1w_4.get_dataContext().get_Steps())) {
            return;
        }
        this.$3S_4();
    },
...
ProcessControl.Configuration.BpfMenuActions.openVisualizeProcess = function(eventData) {
    ...
    openStdWin($v_0, 'VisualizeProcess', ProcessControl.Configuration.BpfMenuActions.$5g, ProcessControl.Configuration.BpfMenuActions.$5f, null);
}
ProcessControl.Configuration.BpfMenuActions.bindMenuActions = function() {
    ...
    ProcessControl.Configuration.BpfMenuActions.$4V('#ProcessName', ProcessControl.Configuration.BpfMenuActions.$R.$$d_titleOrDescriptionChanged);
    ProcessControl.Configuration.BpfMenuActions.$4V('#Description', ProcessControl.Configuration.BpfMenuActions.$R.$$d_titleOrDescriptionChanged);
    var $v_0 = {};
    $v_0['Action'] = 'Shortcut';
...
ProcessControl.Configuration.BPFClientProxy.getEntityAndRelationshipMetadata = function(entityLogicalName, callback) {
    ...
    var $v_0 = ProcessControl.Configuration.BPFClientProxy.$1Q.retrieveEntityAndRelationshipMetadataAsync(entityLogicalName);
    $v_0.done(function() {
...
ProcessControl.Configuration.BPFClientProxy.getLoadedRelationshipEntityMetadata = function() {
    if (!ProcessControl.Configuration.BPFClientProxy.$4X) {
        ProcessControl.Configuration.BPFClientProxy.$4X = $P_CRM.parseJSON(window._BusinessRuleEditorJsonData.substr(8));
    }
...
ProcessControl.Configuration.BPFClientProxy.launchWorkflowLookupDialog = function(callback) {
    ...
    var $v_0 = '/_controls/lookup/lookupinfo.aspx?DefaultType=4703&DefaultViewId=45102185-B1B4-422b-A3BF-F1BA9C6E130A&IsInlineMultiLookup=0&LookupStyle=single&ShowNewButton=1&ShowPropButton=1&browse=true&dType=1&mrsh=false&objecttypes=4703';
...
ProcessControl.Configuration.ProcessDesignerMenuActions.saveProcess = function(eventData) {
    ...
    if (window._OverwriteOnSave) {
        ...
        $v_4.height = 250;
        $v_4.width = 550;
        Xrm.Dialog.openConfirmDialog($v_3, $v_4, function() {
            window._OverwriteOnSave = false;
            ProcessControl.Configuration.ProcessConfigurationUtility.resetFocusOnActiveControl();
...
ProcessControl.Configuration.ProcessDesignerMenuActions.$4q = function($p0) {
    ...
    ProcessControl.Configuration.ProcessDesignerMenuActions.$4o('UpdateProcess', function($p1_0, $p1_1) {
...
ProcessControl.Configuration.ProcessDesignerMenuActions.$A4 = function() {
    ProcessControl.Configuration.ProcessDesignerMenuActions.$4o('SaveAsBpf', ProcessControl.Configuration.ProcessDesignerMenuActions.$6l);
}
...
ProcessControl.Configuration.ProcessDesignerMenuActions.$31 = function($p0, $p1) {
    ...
    $v_0.content = {};
    $v_0.callback = $p1;
    var $v_1 = new Mscrm.CrmDialog(ProcessControl.Configuration.ProcessDesignerMenuActions.$4e($p0), [ window._Process_Id ], 500, 200, null);
...
ProcessControl.Configuration.ProcessDesignerMenuActions.$6X = function() {
    ProcessControl.Configuration.ProcessDesignerMenuActions.$9d('/_grid/cmds/dlg_delete.aspx', ProcessControl.Configuration.ProcessDesignerMenuActions.deleteProcessConfirmationCallback);
}
...
ProcessControl.Configuration.ProcessDesignerMenuActions.bindMenuActions = function() {
    ...
    ProcessControl.Configuration.ProcessDesignerMenuActions.$4V('#ProcessName', ProcessControl.Configuration.ProcessDesignerMenuActions.titleOrDescriptionChanged);
    ProcessControl.Configuration.ProcessDesignerMenuActions.$4V('#Description', ProcessControl.Configuration.ProcessDesignerMenuActions.titleOrDescriptionChanged);
    var $v_0 = {};
    $v_0['Action'] = 'Shortcut';
...
ProcessControl.Configuration.ProcessControlEntityView.prototype = {
    ...
    renderView: function() {
        ...
        this.$25_5 = $create(ProcessControl.Configuration.AddStepBehavior, $v_0, null, null, $get(String.format('{0}_add{1}', this.get_id(), 'step')));
    },
...
ProcessControl.Configuration.ProcessControlStageView.prototype = {
    ...
    $96_5: function() {
        ...
        var $v_2 = this.$8X_5();
        this.$2g_5 = Mscrm.InlineControlFactory.createInlinePicklistControlForDomByControlMode($v_1, $v_0, ProcessControl.Configuration.ProcessEnabledEntities.getEnumOptions(), '', 'normal', $v_2.toString());
        this.$2g_5.initializeAndRenderEditView();
        this.fixStageControl(ProcessControl.Configuration.ProcessEnabledEntities.getLabelByLogicalName(this.$d_5.get_entityLogicalName()), this.$2g_5);
    ...
    $9K_5: function() {
        ...
        if ($v_1.length > 0) {
            var $v_2 = this.$8W_5();
            this.$2E_5 = Mscrm.InlineControlFactory.createInlinePicklistControlForDomByControlMode($v_1, $v_0, ProcessControl.Configuration.StageCategory.getStageCategories(), '', 'normal', $v_2);
            this.$2E_5.initializeAndRenderEditView();
            this.fixStageControl(ProcessControl.Configuration.StageCategory.getLabelByValue(this.$2E_5.get_dataContext().get_editValue()), this.$2E_5);
    ...
    addStepKeyBoardShortcut: function(eventObject) {
        if (eventObject.altKey && eventObject.shiftKey && eventObject.keyCode === 78) {
            ...
            var $v_5 = this.$2_5.get_viewAdapterFactory().createStepViewAdapter(this.$2_5, $v_1, $v_4, this.$1M_5.get_viewFactory().getStageViewById(this.get_id()));
    ...
    get_$1z_5: function() {
        if (IsNull(this.$3d_5)) {
            this.$3d_5 = this.get_elementWrapper().children(':first-child').children(':first-child').children(':first-child');
        }
        return this.$3d_5;
    },
    ...
    get_$1A_5: function() {
        if (IsNull(this.$1p_5)) {
            this.$1p_5 = this.get_elementWrapper().children(':first-child').children(':nth-child(3)').children(':first-child').children(':first-child');
        }
        return this.$1p_5;
    },
...
ProcessControl.Configuration.ProcessControlStepView.prototype = {
    ...
    $5r_4: function() {
        ...
        var $$t_2 = this;
        this.get_$1R_4().bind('click', function($p1_0) {
            $$t_2.$6c_4($p1_0);
        });
        var $$t_3 = this;
        this.get_$1R_4().bind('keydown', function($p1_0) {
            switch ($p1_0.which) {
                case 13:
                case 32:
                    $$t_3.$6c_4($p1_0);
    ...
    get_$5t_4: function() {
        if (IsNull(this.$3g_4)) {
            this.$3g_4 = Mscrm.ImageStrip.getImageInfo(Mscrm.CrmUri.create(window.CDNURL + '/_imgs/processcontrol/12_checkbox_on.png'));
        }
        return this.$3g_4;
    },
    ...
    get_$73_4: function() {
        if (IsNull(this.$4R_4)) {
            this.$4R_4 = Mscrm.ImageStrip.getImageInfo(Mscrm.CrmUri.create(window.CDNURL + '/_imgs/processcontrol/12_checkbox_off.png'));
        }
        return this.$4R_4;
    },
...
ProcessControl.Configuration.ProcessControlView.$31 = function($p0, $p1) {
    ...
    $v_0.content = {};
    $v_0.callback = $p1;
    var $v_1 = new Mscrm.CrmDialog(ProcessControl.Configuration.ProcessControlView.$4e($p0), [ window._Process_Id ], 500, 200, null);
    $v_1.setCallbackReference($v_0);
    $v_1.show();
}
...
ProcessControl.Configuration.ProcessControlView.prototype = {
    ...
    saveProcess: function(callback) {
        var $$t_3 = this;
        this.$4o_5('UpdateProcess', function($p1_0, $p1_1) {
    ...
    $4o_5: function($p0, $p1) {
        ...
        if (!isNullOrEmptyString(ProcessControl.Configuration.ProcessControlView.$3I)) {
            ...
            ProcessControl.Configuration.BpfDataUtility.executeConfiguratorActionCommand(ProcessControl.Configuration.ProcessControlView.$3I, $p0, $p1, ProcessControl.Configuration.ProcessControlView.$84);
        }
    },
...
ProcessConfiguration.Behavior.StepFocusEventCapturingBehavior.prototype = {
    ...
    onFocused: function(eventHandler) {
        ProcessConfiguration.Behavior.StepFocusBehavior.prototype.onFocused.call(this, eventHandler);
        if (this.$1L_4.get_processControlStageViewAdapter() === ProcessConfiguration.Behavior.StageFocusBehavior.$6.$1M_5) {
            return;
        }
        ProcessConfiguration.Behavior.StageFocusBehavior.$6.$1M_5.get_stageFocusBehaviorAdapter().get_instance().$30_4();
    }
}
...
ProcessConfiguration.Behavior.AddEntityBehavior.prototype = {
    ...
    initialize: function() {
        ...
        this.$5r_4();
        this.$9x_4();
        ProcessConfiguration.Behavior.ConfiguratorFlyout.createFlyOutMenuDescriptor(this.get_$9_4().$3F_5, ProcessControl.Configuration.ProcessConfigurationUtility.getEntitiesInProcess(this.get_$9_4().get_dataContext()), this.get_$9_4().$t_5, this.$$d_clickHandler, this.get_$9_4().$1S_5);
    },
    ...
    $A1_4: function() {
        ...
        for (var $v_3 = 0; $v_3 < $v_0; $v_3++) {
            if ((this.get_$9_4().get_$Aa_3()[$v_3]).get_dataContext().get_Description() === 'DoNotPersist33F3B39A-9705-11E2-B7C4-67BF6188709B') {
    ...
    $5h_4: function($p0) {
        ProcessConfiguration.Behavior.ConfiguratorFlyout.createFlyOutMenuDescriptor($p0, ProcessControl.Configuration.ProcessConfigurationUtility.getEntitiesInProcess(this.get_$13_4()), this.get_$9_4().$t_5, this.$$d_clickHandler, this.get_$9_4().$1S_5);
    },
...
ProcessConfiguration.Behavior.ConfiguratorFlyout.createFlyOutMenuDescriptor = function(lastEntity, entitiesInProcess, relationshipDictionary, clickHandler, isProcessClosed) {
    ...
    var $v_7 = ProcessConfiguration.Behavior.ConfiguratorFlyout.$8O(relationshipDictionary, entitiesInProcess, clickHandler, lastEntity);
    $v_7.cssClass = $v_0;
...
ProcessConfiguration.Behavior.ConfiguratorFlyout.$8K = function($p0) {
    return ProcessConfiguration.Behavior.ConfiguratorFlyout.$4g(window.LOCID_PROCESS_ADDENTITY, 'AddEntity', $p0, window.LOCID_PROCESS_ADDENTITY_TOOLTIP, false);
}
...
ProcessConfiguration.Behavior.ConfiguratorFlyout.$8T = function($p0) {
    return ProcessConfiguration.Behavior.ConfiguratorFlyout.$4g($p0, 'NoOp', function($p1_0) {
    }, '', false);
}
ProcessConfiguration.Behavior.ConfiguratorFlyout.$8P = function($p0) {
    return ProcessConfiguration.Behavior.ConfiguratorFlyout.$4g(window.LOCID_PROCESS_CLOSELOOP, 'CloseLoop', $p0, window.LOCID_PROCESS_CLOSELOOP_TOOLTIP, false);
}
ProcessConfiguration.Behavior.ConfiguratorFlyout.$8c = function($p0) {
    return ProcessConfiguration.Behavior.ConfiguratorFlyout.$4g(window.LOCID_PROCESS_REMOVEENTITY, 'RemoveEntity', $p0, '', true);
}
...
ProcessConfiguration.Behavior.ConfiguratorUnloadBehavior.$9i = function($p0) {
    ProcessControl.Configuration.ProcessConfigurationUtility.resetFocusOnActiveControl();
    if (!(IsNull(ProcessConfiguration.Behavior.ConfiguratorUnloadBehavior.$1t)) && !ProcessConfiguration.Behavior.ConfiguratorUnloadBehavior.$1t.get_isDirty()) {
        return;
    }
...
ProcessConfiguration.Behavior.ExpandCollapseBehavior.setBehavior = function() {
    if (ProcessConfiguration.Behavior.ExpandCollapseBehavior.get_$2r().length > 0) {
        ProcessConfiguration.Behavior.ExpandCollapseBehavior.get_$2r().bind('click', ProcessConfiguration.Behavior.ExpandCollapseBehavior.expandHandler);
        ProcessConfiguration.Behavior.ExpandCollapseBehavior.get_$2r().bind('keyup', ProcessConfiguration.Behavior.ExpandCollapseBehavior.keyUpExpandHandler);
    }
...
ProcessConfiguration.Behavior.MoveBehavior.prototype = {
    ...
    get_$2q_3: function() {
        if (IsNull(this.$3t_3)) {
            this.$3t_3 = Mscrm.ImageStrip.getImageInfo(Mscrm.CrmUri.create(window.CDNURL + '/_imgs/processcontrol/30_enabled_move_up.png'));
        }
        return this.$3t_3;
    },
    ...
    get_$2p_3: function() {
        if (IsNull(this.$3r_3)) {
            this.$3r_3 = Mscrm.ImageStrip.getImageInfo(Mscrm.CrmUri.create(window.CDNURL + '/_imgs/processcontrol/30_enabled_move_down.png'));
        }
        return this.$3r_3;
    },
    ...
    get_$4j_3: function() {
        if (IsNull(this.$45_3)) {
            this.$45_3 = Mscrm.ImageStrip.getImageInfo(Mscrm.CrmUri.create(window.CDNURL + '/_imgs/processcontrol/30_moveuphover.png'));
        }
        return this.$45_3;
    },
    ...
    get_$4i_3: function() {
        if (IsNull(this.$42_3)) {
            this.$42_3 = Mscrm.ImageStrip.getImageInfo(Mscrm.CrmUri.create(window.CDNURL + '/_imgs/processcontrol/30_movedownhover.png'));
        }
        return this.$42_3;
    },
    ...
    get_$3R_3: function() {
        if (IsNull(this.$3p_3)) {
            this.$3p_3 = Mscrm.ImageStrip.getImageInfo(Mscrm.CrmUri.create(window.CDNURL + '/_imgs/processcontrol/30_disabled_move_up.png'));
        }
        return this.$3p_3;
    },
    ...
    get_$3Q_3: function() {
        if (IsNull(this.$3n_3)) {
            this.$3n_3 = Mscrm.ImageStrip.getImageInfo(Mscrm.CrmUri.create(window.CDNURL + '/_imgs/processcontrol/30_disabled_move_down.png'));
        }
        return this.$3n_3;
    },
...
ProcessConfiguration.Behavior.FocusBehaviorBase$1 = function(element) {
    ...
    this.$1N_3 = ((this.$$gta['ProcessConfiguration.Behavior.FocusBehaviorBase$1']['T'] === Number || Type.isEnum(this.$$gta['ProcessConfiguration.Behavior.FocusBehaviorBase$1']['T'])) ? 0 : (this.$$gta['ProcessConfiguration.Behavior.FocusBehaviorBase$1']['T'] === Boolean) ? false : null);
...
ProcessConfiguration.Behavior.HoverBehavior$1.prototype = {
    ...
    get_$6Q_3: function() {
        if (IsNull(this.$43_3)) {
            this.$43_3 = Mscrm.ImageStrip.getImageInfo(Mscrm.CrmUri.create(window.CDNURL + '/_imgs/processcontrol/12_active_config_delete.png'));
        }
        return this.$43_3;
    },
    ...
    get_$5z_3: function() {
        if (IsNull(this.$3m_3)) {
            this.$3m_3 = Mscrm.ImageStrip.getImageInfo(Mscrm.CrmUri.create(window.CDNURL + '/_imgs/processcontrol/12_inactive_config_delete.png'));
        }
        return this.$3m_3;
    },
...
ProcessConfiguration.Behavior.StageFocusBehavior.set_$3T = function($p0) {
    if (ProcessConfiguration.Behavior.StageFocusBehavior.$6 !== $p0) {
        if (!IsNull(ProcessConfiguration.Behavior.StageFocusBehavior.$6)) {
            ProcessConfiguration.Behavior.StepFocusBehavior.set_focusedStep(null);
            if (!IsNull(ProcessConfiguration.Behavior.StageFocusBehavior.$6) && ProcessConfiguration.Behavior.StageFocusBehavior.$6.$1M_5) {
                ProcessConfiguration.Behavior.StageFocusBehavior.$6.$1M_5.get_stageFocusBehaviorAdapter().get_instance().$30_4();
            }
        }
        ProcessConfiguration.Behavior.StageFocusBehavior.$6 = $p0;
        if (!IsNull(ProcessConfiguration.Behavior.StageFocusBehavior.$6) && ProcessConfiguration.Behavior.StageFocusBehavior.$6.$1M_5) {
            ProcessConfiguration.Behavior.StageFocusBehavior.$6.$1M_5.get_stageFocusBehaviorAdapter().get_instance().makeSelection();
        }
        if (!IsNull(ProcessConfiguration.Behavior.StageFocusBehavior.$6)) {
            try {
...
ProcessConfiguration.Models.SystemControlMetadataModel.prototype = {
    ...
    $7Q_0: function() {
        this.$2V_0 = new (Sales.Common.Framework.List$1.$$(ProcessConfiguration.Models.ISystemControlAttributeMetadataModel))();
    ...
    refreshAvailableSystemControls: function(oldAttributeLogicalName, newAttributeLogicalName) {
        ...
        var $v_0 = !_String.isNullOrWhiteSpace(oldAttributeLogicalName) && ((oldAttributeLogicalName) in this.get_$4s_0());
        if ($v_0) {
...
ProcessConfiguration.Services.RelationshipFilteringService.prototype = {
    ...
    getAllAvailableRelationships: function(targetStageId) {
        ...
        for (var $v_3 = 0; $v_3 < $v_2.get_count(); ++$v_3) {
            ...
            $v_1[$v_2.get_item($v_3)] = this.$85_0(this.$1_0.get_entityRelationshipMetadata()[$v_4.get_viewModel().get_entityLogicalName()], $v_2.get_item($v_3), $v_0.get_viewModel().get_stageId(), $v_0.get_viewModel().get_entityLogicalName());
        }
        return $v_1;
    },
...
ProcessConfiguration.Services.MetadataService.prototype = {
    ...
    $8s_0: function($p0) {
        return Microsoft.Crm.Workflow.Utils.SharedUtility.dictionaryContainKey(String, Object, this.$E_0, $p0) && Microsoft.Crm.Workflow.Utils.SharedUtility.dictionaryContainKey(String, Object, this.$2T_0, $p0);
    },
...
ProcessConfiguration.Utility.RelationshipFilteringModule.get_instance = function() {
    if (!ProcessConfiguration.Utility.RelationshipFilteringModule.$4l) {
        ProcessConfiguration.Utility.RelationshipFilteringModule.$4l = new ProcessConfiguration.Services.RelationshipFilteringService();
    }
...
ProcessConfiguration.Utility.ProcessViewVisitor.prototype = {
    ...
    validate: function() {
        this.$14_0 = new Microsoft.Crm.Workflow.ObjectModel.WorkflowStep(this.$1W_0.get_businessProcessFlowModel().get_primaryEntityName(), this.$1W_0.get_businessProcessFlowModel().get_workflowCategory());
        this.$14_0.initializeBusinessProcess(this.$1W_0.get_businessProcessFlowModel().get_workflowBusinessProcessType(), this.$1W_0.get_businessProcessFlowModel().get_formId());
        this.$7L_0();
        this.$4T_0 = {};
        ...
        if (!this.$c_0.$g_0) {
            if (isNullOrEmptyString(this.$c_0.$1F_0)) {
                ...
                if (!this.$A_0.get_entity() || Microsoft.Crm.Workflow.Expressions.PrimaryEntity.isInstanceOfType(this.$A_0.get_entity())) {
                    this.$A_0.set_entity(new Microsoft.Crm.Workflow.Expressions.RelatedEntityLinked(this.$A_0.get_workflow(), this.$c_0.$2C_0, this.$c_0.$x_0, this.$c_0.$1F_0));
                }
                else {
                    var $v_0 = this.$A_0.get_entity();
...
ProcessConfiguration.ViewModels.RelationshipControlViewModel.prototype = {
    ...
    get_relationshipsCollection: function() {
        return this.$4G_1 || (this.$4G_1 = new (Sales.Common.Framework.List$1.$$(ProcessConfiguration.Models.IRelationshipModel))());
    },
    ...
    validate: function() {
        ...
        var $v_1 = ProcessConfiguration.Utility.RelationshipFilteringModule.get_instance().getAllAvailableRelationships(this.$1Z_1);
...
ProcessConfiguration.ViewModels.StepListViewModel.prototype = {
    ...
    get_childStepViewModels: function() {
        return this.$4x_1 || (this.$4x_1 = new (Sales.Common.Framework.List$1.$$(ProcessConfiguration.ViewModels.IStepViewModel))());
    },
...
ProcessConfiguration.ViewModels.ProcessConfigurationValidationResult.prototype = {
    ...
    get_nestedResults: function() {
        return this.$58_0 || (this.$58_0 = new (Microsoft.Crm.Client.Core.Framework.List$1.$$(Mscrm.IValidationResult))());
    }
}
...
ProcessConfiguration.ViewModels.ConditionBranchViewModel.prototype = {
    ...
    initialize: function() {
        this.$1c_1 = new Mscrm.BusinessRules.ViewModels.BranchingConditionBranchSectionViewModel(this.$1J_1.get_conditionBranchStep(), this.$K_1);
    ...
    insertNextStageViewModel: function(nextStageViewModel) {
        var $v_0 = this.$1J_1.get_stepModelFactory().createNewSetNextStageModel(this.$1J_1, nextStageViewModel, this.get_parentStageViewModel());
        if (this.$N_1) {
            var $v_1 = this.$N_1;
...
ProcessConfiguration.ViewModels.ConditionViewModel.prototype = {
    ...
    get_childConditionBranchViewModels: function() {
        return this.$3h_1 || (this.$3h_1 = new (Sales.Common.Framework.List$1.$$(ProcessConfiguration.ViewModels.IConditionBranchViewModel))());
    },
...
ProcessConfiguration.ViewModels.RelationshipPickerViewModel.prototype = {
    ...
    checkForInvalidExistingRelationships: function() {
        var $v_0 = 0;
        for (var $$arr_1 = this.$1g_1.get_items(), $$len_2 = $$arr_1.length, $$idx_3 = 0; $$idx_3 < $$len_2; ++$$idx_3) {
            var $v_1 = $$arr_1[$$idx_3];
        ...
        for (var $$key_D in $$dict_C) {
            ...
            if ($v_2.get_count() > 0) {
                ...
                for (var $v_7 = 0; $v_7 < $v_2.get_count(); $v_7++) {
                    ...
                    Array.add($v_3, $v_5);
                    for (var $$arr_7 = this.$1g_1.get_items(), $$len_8 = $$arr_7.length, $$idx_9 = 0; $$idx_9 < $$len_8; ++$$idx_9) {
                        var $v_8 = $$arr_7[$$idx_9];
...
ProcessConfiguration.ViewModels.ProcessConfigurationViewModel.prototype = {
    ...
    get_firstLevelStageViewModels: function() {
        return this.$5W_1 || (this.$5W_1 = new (Sales.Common.Framework.List$1.$$(ProcessConfiguration.ViewModels.IStageViewModel))());
    },
...
ProcessConfiguration.View.StageView.prototype = {
    ...
    $9E_1: function() {
        ...
        if ($v_0.get_length() > 0) {
            this.$2e_1 = this.$2_1.createRelationshipControlView($v_0, this.get_viewModel().get_childRelationshipControlViewModel());
    ...
    initializeStepListView: function() {
        ...
        this.$2k_1 = this.$2_1.createStepListView(this, $v_0, this.get_viewModel().get_childStepListViewModel(), this.get_viewModel().get_stageModel().get_stepModelFactory());
        this.$2k_1.initialize();
    },
    
    initializeProcessControlStageViewAdapter: function() {
        this.$3c_1 = this.$1O_1.createAddBranchConditionBehaviorAdapter(this.get_$2J_1(), this.$J_1, this.get_viewModel(), this);
...
ProcessConfiguration.View.RelationshipControlView.prototype = {
    ...
    get_$83_1: function() {
        if (IsNull(this.$1E_1)) {
            this.$1E_1 = new Mscrm.ErrorFlyout(this.get_warningIcon().get_jQueryObject(), this.get_$AY_1().get_jQueryObject(), this.get_$60_1().get_jQueryObject());
        }
        return this.$1E_1;
    },
    ...
    get_$AY_1: function() {
        if (IsNull(this.$3N_1)) {
            this.$3N_1 = this.$0_0.fromHtml('<div></div>').addClass('ms-crm-Inline-Validation').hide().attribute('id', this.get_$5S_1() + '_err');
...
ProcessConfiguration.View.StepListView.prototype = {
    ...
    get_$5m_1: function() {
        return this.$5J_1 || (this.$5J_1 = new (Sales.Common.Framework.List$1.$$(ProcessConfiguration.View.IProcessControlStepViewAdapter))());
    },
    ...
    initialize: function() {
        ...
        for (var $v_2 = 0; $v_2 < this.get_$a_1().get_childStepViewModels().get_count(); $v_2++) {
            var $v_3 = this.$9S_1(this.$0_0.fromElement($v_0.get_item($v_2)), this.get_$a_1().get_childStepViewModels().get_item($v_2));
            if ($v_1) {
...
ProcessConfiguration.View.PageStepSourceView.prototype = {
    ...
    setStepControlValue: function(stepFieldControlView) {
        stepFieldControlView.get_valueElement().text(this.get_$3Z_6().get_source().$29_0 || window.LOCID_PROCESS_PAGE_SOURCENAME);
    },
...
ProcessConfiguration.View.ProcessConfigurationView.prototype = {
    ...
    get_firstLevelStageViews: function() {
        return this.$5X_1 || (this.$5X_1 = new (Sales.Common.Framework.List$1.$$(ProcessConfiguration.View.IStageView))());
    }
}
...
ProcessControl.Configuration.HtmlTemplate.$AI = ProcessControl.Configuration.HtmlTemplate.$62('<span class=\'{0}\'><div class=\'{1}\'><img src=\'{2}\' class=\'{3}\' tabindex=\'0\' title=\'{4}\' alt=\'{5}\' id=\'{6}\'/></div></span>', [ 'pc_step_dc', 'pc_step_del', '{0}', '{1}', '{2}', '{3}', '{4}' ]);
ProcessControl.Configuration.HtmlTemplate.$9z = ProcessControl.Configuration.HtmlTemplate.$62('<span class=\'{0}\'><div class=\'{1}\'><img src=\'{2}\' tabindex=\'0\' title=\'{3}\' alt=\'{4}\' id=\'{5}\'/></div></span>', [ 'pc_step_req', '{0}', '{1}', '{2}', '{3}', '{4}' ]);
ProcessControl.Configuration.HtmlTemplate.$5s = '<img src=\'/_imgs/processcontrol/6x8_breadcrumb_config.png\' id = \'{0}\' class=\'bpfConfBreadcrumbImg\'>';
ProcessControl.Configuration.HtmlTemplate.$6d = '<a id=\'pcc_options\' class=\'pcc_options\' title=\'{0}\'><img src=\'/_imgs/processcontrol/23_addminus_config.png\' id=\'pcc_options_img\' class=\'bpfConfOptionsImg\' alt=\'{0}\' title=\'{0}\' tabindex=\'0\'>{1}</a>';
