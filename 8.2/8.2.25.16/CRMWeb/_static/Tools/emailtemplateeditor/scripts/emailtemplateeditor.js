...
function AddSpacesArroundSlug(dataSlug)
{
    if(!IsNull(dataSlug))
    {
        ...
        (IsNull(prev) || !IsNull(prev) && prev.nodeType == 3 && !prev.nodeValue.match(new RegExp("[\\s" + escape(ThinSpace).replace(/%/,"\\") + "]{1}$"))) && 
