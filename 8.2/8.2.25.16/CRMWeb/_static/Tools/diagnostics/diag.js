...
var tests = {latency:{func:runLatencyTest,desc:"Latency Test"},bandwidth:{func:runBandwidthTest,desc:"Bandwidth Test"},browserInfo:{func:runBrowserInfoTest,desc:"Browser Info"},ipAddress:{func:runIpAddressTest,desc:"IP Address"},jsArrayBenchmark:{func:runJsArrayBenchmark,desc:"JavaScript Array Benchmark"},jsMorphBenchmark:{func:runJsMorphBenchmark,desc:"JavaScript Morph Benchmark"},jsBase64Benchmark:{func:runJsBase64Benchmark,desc:"JavaScript Base64 Benchmark"},jsDomBenchmark:{func:runJsDomBenchmark,desc:"JavaScript Dom Benchmark"},orgInfo:{func:runOrgInfoTest,desc:"Organization Info"},all:{func:runAllTests,desc:"All Tests"}},
    testQueue = [];
function getTime()
{
    var d = new Date;
