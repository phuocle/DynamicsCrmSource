...
function applyArticleTabChanges()
{
    ...
    var kmCtrl = new SearchWidgetObj("",_sSearchFilter,$get("chkAllowChangeFilters").checked,$get("chkShowLanguageFilter").checked,$get("chkShowDepartmentFilter").checked,$get("chkEnableAutomaticSuggestions").checked,_sAutomaticSuggestionSearchField,_sAutoSuggestionSource,$get("RowsPerPage").value,actionsSel,actionsSelected,_sPrimaryCustomer,0,0,_sTabName,_sSectionName,new Array(new LocalizedObj("",_oArgs.LangCode)),false,_oFormXml,bVisible,_sDefaultLanguage,void 0,void 0,$get("chkEnableRating").checked,_sRatingField);
    return kmCtrl
}
