...
function RemoveControlDescriptorsForNodes(nodes)
{
    if(Mscrm.FeatureControl.get_Current().isFeatureEnabled(Mscrm.FeatureNames.CustomControlMobile))
    {
        ...
        for(i = 0; i < nodes.length; i++)
        {
            ...
            {
                var controlDescriptor = XUI.Xml.SelectSingleNode(controlDescriptionsTagXmlNode,"controlDescription[@forControl='" + nodes[i].getAttribute("uniqueid") + "']",null);
...
function GetControlClassIdForFormFactor(formXml,customControlUniqueId,formFactor)
{
    ...
    if(Mscrm.FeatureControl.get_Current().isFeatureEnabled(Mscrm.FeatureNames.CustomControlMobile) && !IsNull(customControlUniqueId))
    {
        ...
        {
            var customControlNode = XUI.Xml.SelectSingleNode(controlDescriptor,"customControl[@formFactor='" + formFactor + "']",null);
