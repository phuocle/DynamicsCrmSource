...
function onMatchingRecordTypeChange()
{
    ...
    var conditionControlIframe = $get("ruleconditioncontrol"),
        url = Mscrm.CrmUri.create("/tools/systemcustomization/similarityrules/similarityrulecondition.aspx?baseentitycode=" + baseEntityCode + "&matchingentitycode=" + matchingEntityCode).toString();
