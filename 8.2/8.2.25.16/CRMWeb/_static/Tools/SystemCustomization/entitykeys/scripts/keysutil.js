...
var _oUtilMessages = {sConfirmEntityKeyDelete:LOCID_KEYSUTL_CONFIRMDELKEYS,sCreatingEntityKey:LOCID_KEYSUTL_CREATINGKEYS,sReactivateEntityKey:LOCID_KEYSUTL_REACTIVATEKEY,sDeletingEntityKey:LOCID_KEYSUTL_DELETINGKEYS},
    _oUtilTypes = {sString:"nvarchar"},
    _oUtilConst = {entityKeyId:"entityKeyId",sCustomizationCommandObject:"SystemCustomization",sCreateEntityKeyCommand:"CreateEntityKey",sReactivateEntityKeyCommand:"ReactivateEntityKey",sDeleteEntityKeyCommand:"DeleteEntityKey",sCommandParameterName:"data",sDeleteAction:"delete",sReactivateAction:"reactivate"};
function dispatchAction(sEntityKeyOid,sAction)
{
    switch(sAction)
    {
        case _oUtilConst.sDeleteAction:
            ...
            var retVal = Mscrm.GridRibbonActions.deleteRecords(gridControl,gridControl.get_selectedRecords(),Mscrm.EntityTypeCode.EntityKey);
            break;
