...
function getAttrVal(type,name,frmt)
{
    ...
    switch(type)
    {
        ...
        case "bit":
            ...
            break;
        case "money":
            o.val = "<val>" + CrmXmlEncode(getEl(name).value) + "</val><cs>" + CrmXmlEncode(getEl(name + "_cs").value) + "</cs>";
            o.enc = false;
            break;
        case "datetime":
            o.val = "<date>" + CrmXmlEncode(getEl(name).value) + "</date><time>" + CrmXmlEncode(getEl(name + "_t").value) + "</time>";
            o.enc = false;
            break;
        case "int":
            if(frmt == "duration")
            {
                ...
                o.val = "<val>" + CrmXmlEncode(getEl(name).value) + "</val><tu>" + CrmXmlEncode(getEl(durTimeUnits).value) + "</tu>";
                o.enc = false
            }
            else
                o.val = getEl(name).value;
        ...
        case "owner":
            ...
            o.val = "<type>" + CrmXmlEncode(tp) + "</type><txt>" + CrmXmlEncode(txt) + "</txt><usrTxt>" + CrmXmlEncode(usrTxt) + "</usrTxt><oid>" + CrmXmlEncode(oid) + "</oid>";
            o.enc = false;
            break;
        case "partylist":
            break
