...
function RemoveMembers(sGrid)
{
    ...
    if(a.length > 0)
    {
        var parameters = [getCrmGrid()],
            crmDialog = new Mscrm.CrmDialog(Mscrm.CrmUri.create("/_grid/cmds/dlg_removeusers.aspx?iObjType=" + APP_SALES_PERSON_OTC + "&iTotal=" + a.length + "&teamid=" + CURRENT_OBJ_ID),a,460,225,null);
