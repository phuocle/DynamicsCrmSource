...
function submitFeedback(e)
{
    ...
    var sSubject = sTitle + " (/1:" + sDeliverable + "/2:" + sProductVer + "/3:" + sDocVer + "/4:" + sURL + "/5:" + GetRating() + "/6:" + sLang + "/7:" + sSku + sExtension + ")",
...
function GetRating()
{
    if(document.getElementsByName("fbRating")[0].checked)
        ...
        if(document.getElementsByName("fbRating")[1].checked)
            return "No";
        else
            return "None"
}
function ScrollItemIntoView(sId)
{
    ...
    typeof oElement != "undefined" && oElement != null && 
