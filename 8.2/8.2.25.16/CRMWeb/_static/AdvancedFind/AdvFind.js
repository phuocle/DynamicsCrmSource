...
function ConfigureToolbars(oAdvFind)
{
    ...
    if(!IsNull(oToolbar))
    {
        ...
        PerformToolbarOperation(sOp,oToolbar,$get("btnSave",obuttonContainer),"$find('" + oAdvFind.get_id() + "').Save()");
        PerformToolbarOperation(sOp,oToolbar,$get("btnSaveAs",obuttonContainer),"$find('" + oAdvFind.get_id() + "').SaveAs()");
        PerformToolbarOperation(sOp,oToolbar,$get("btnNew",obuttonContainer),"$find('" + oAdvFind.get_id() + "').StartNew()");
        PerformToolbarOperation(sOp,oToolbar,$get("btnEditView",obuttonContainer),"$find('" + oAdvFind.get_id() + "').EditView()");
        PerformToolbarOperation(sOp,oToolbar,$get("btnEditProperties",obuttonContainer),"$find('" + oAdvFind.get_id() + "').EditProperties()")
    }
    oToolbar = $find(oAdvFind.get_id() + "mnuBar5");
    if(!IsNull(oToolbar) && oAdvFind.get_modes() & Mscrm.AdvancedFindModes.detailed)
    {
        var obuttonContainer = XUI.Html.DomUtils.GetFirstChild(oToolbar.get_element());
        PerformToolbarOperation(sOp,oToolbar,$get("btnSimple",obuttonContainer),"$find('" + oAdvFind.get_id() + "').set_mode(" + Mscrm.AdvancedFindModes.simple + ");$find('" + oAdvFind.get_id() + "').ConfigureMode()");
        PerformToolbarOperation(sOp,oToolbar,$get("btnAnd",obuttonContainer),"$find('" + oAdvFind.get_id() + "').Group('and')");
        PerformToolbarOperation(sOp,oToolbar,$get("btnOr",obuttonContainer),"$find('" + oAdvFind.get_id() + "').Group('or')");
        PerformToolbarOperation(sOp,oToolbar,$get("btnClear",obuttonContainer),"$find('" + oAdvFind.get_id() + "').Clear(true,false)")
    }
    oToolbar = $find(oAdvFind.get_id() + "mnuBar6");
    if(!IsNull(oToolbar) && oAdvFind.get_modes() & Mscrm.AdvancedFindModes.simple)
    {
        var obuttonContainer = XUI.Html.DomUtils.GetFirstChild(oToolbar.get_element());
        PerformToolbarOperation(sOp,oToolbar,$get("btnDetailed",obuttonContainer),"$find('" + oAdvFind.get_id() + "').set_mode(" + Mscrm.AdvancedFindModes.detailed + ");$find('" + oAdvFind.get_id() + "').ConfigureMode()")
    }
}
