        ...
        if(_currentDataType == "Boolean")
        {
            ...
            switch(className)
            {
                ...
                case "ms-crm-SelectBox":
                    ...
                    break;
                case "ms-crm-RadioButton":
                    var inputControls = XUI.Html.DomUtils.GetChildElementAt(defaultValueControl,2).getElementsByTagName("INPUT"),
                        inputLabels = XUI.Html.DomUtils.GetChildElementAt(defaultValueControl,2).getElementsByTagName("LABEL"),
                        valueToMatch = "0";
