        ...
        else
        {
            ...
            if(Xrm.Page.context.client.getClient() == Xrm.ClientName.mobile)
                ...
                if(typeof openFrmObj == "function")
                    if(typeof openFrmObj !== "undefined")
                        openFrmObj(sUrl,buildWinName(),iTypeToAdd);
                    else
                        typeof window.parent.openFrmObj !== "undefined" && typeof window.parent.buildWinName !== "undefined" && 
                            window.parent.openFrmObj(sUrl,window.parent.buildWinName(),iTypeToAdd);
                else
                    window.parent.openFrmObj(sUrl,window.parent.buildWinName(),iTypeToAdd)
        }
...
function RunFunctionFromParentOrSelf(sFunctionName,param1,param2,param3,param4)
{
    var func = window.parent[sFunctionName];
    if(IsNull(func) || typeof func != "function")
        func = window.self[sFunctionName];
    if(typeof Mscrm.CrmDebug !== "undefined")
        ...
        typeof window.parent.Mscrm.CrmDebug !== "undefined" && 
            window.parent.Mscrm.CrmDebug.assert(!IsNull(func) && typeof func === "function","Function '" + sFunctionName + "' is not found in window.parent nor in window.self");
