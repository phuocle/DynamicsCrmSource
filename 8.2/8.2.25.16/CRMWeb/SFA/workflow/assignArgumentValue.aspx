...
var slugValue = argumentSelector[("argumentSlug" + argumentSelector.selectedIndex)];

if (IsNull(slugValue)) {
slugValue = argumentSelector.getAttribute("argumentSlug" + argumentSelector.selectedIndex);
}
...
<td valign="top">
<table width="100%" height="320px" cellpadding="0" cellspacing="5">
<tr>
<td>
