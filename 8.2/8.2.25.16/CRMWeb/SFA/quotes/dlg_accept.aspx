...
<td>
<label for="selStatus"><loc:Text ResourceId="Web.SFA.quotes.aspx_40.dlg_accept" runat="server"/></label>
</td>
<td>
...
<td>
<label for="closeDate"><loc:Text ResourceId="Web.SFA.quotes.aspx_50.dlg_accept" runat="server"/></label>
</td>
<td>
...
<tr>
<td style="padding-top:20px" colspan="4"><label for="description"><loc:Text ResourceId="Web.SFA.salesorders.aspx_60.dlg_close" runat="server"/></label></td>
</tr>
<tr>
<td colspan="4" height="95px"><sdk:TextAreaControl id="description" MaxLength="2000" runat="server"/></td>
</tr>
</table>
</td>
</tr>
...
<td>
<label for="radCloseOpportunity"><loc:Text ResourceId="Web.SFA.quotes.aspx_243.dlg_accept" runat="server"/></label>
</td>
<td>
&nbsp;
</td>
