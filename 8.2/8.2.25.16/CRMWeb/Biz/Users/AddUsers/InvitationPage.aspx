...
<label for="sendInvitation" id="sendInvitationLabel" ><loc:Text ResourceId="AddUsersWizard.InvitationPage.SendInvitation" runat="server" /></label>
<div class="ms-crm-InvitationOption-SecondLine" id="invitationDisabled" ><loc:Text ResourceId="AddUsersWizard.InvitationPage.InvitationDisabled" runat="server" /></div>
</li>
<li class="ms-crm-InvitationOption">
<input type="radio" name="invite" id="doNotSendInvitation" class="ms-crm-RadioButton" />
<label for="doNotSendInvitation"><loc:Text ResourceId="AddUsersWizard.InvitationPage.DoNotSendInvitation" runat="server" /></label>
<div class="ms-crm-InvitationOption-SecondLine"><loc:Text ResourceId="AddUsersWizard.InvitationPage.DoNotSendInvitation.1" runat="server" /></div>
</li>
</ul>
</frm:WizardForm>
</body>
