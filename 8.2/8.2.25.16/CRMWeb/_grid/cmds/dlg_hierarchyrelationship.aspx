...
{
var ishierarchial = (hierarchyRelationshipsGrid.getCellValue("ishierarchial",hierarchyRelationshipsGrid.get_selectedIds()[0]) == "True")
...
var oCommand = new RemoteCommand(_oRelUtlConst.sCustomizationCommandObject, _oRelUtlConst.sUpdatingEntityRelation);
oCommand.SetParameter(_oRelUtlConst.relationshipIdParam, entityRelationshipId);
var result = oCommand.Execute();
if (result.Success)
{
relationshipName = XUI.DomUtilities.GetFirstChild(XUI.DomUtilities.GetFirstChild(hierarchyRelationshipsGrid.get_innerGrid().get_selectedRecords()[0][3].cells[2])).nodeValue;
var fieldName = XUI.DomUtilities.GetFirstChild(XUI.DomUtilities.GetFirstChild(hierarchyRelationshipsGrid.get_innerGrid().get_selectedRecords()[0][3].cells[6])).nodeValue;
