...
var submitUrl = Mscrm.CrmUri.create("/_grid/cmds/dlg_activate.aspx?iObjType=" + _iObjType + "&iTotal=" + iLen);
...
<loc:Argument runat="server"><%=Microsoft.Crm.CrmEncodeDecode.CrmHtmlEncode(statusString)%></loc:Argument></loc:Text>
</tr>
<%
...
%>
<br/>
<tr><loc:Argument runat="server"><%=Microsoft.Crm.CrmEncodeDecode.CrmHtmlEncode(extraInformationLine1)%></loc:Argument></tr>
<br/>
<tr><loc:Argument runat="server"><%=Microsoft.Crm.CrmEncodeDecode.CrmHtmlEncode(extraInformationLine2)%></loc:Argument></tr>
<%
}
%>
<tr><td>
