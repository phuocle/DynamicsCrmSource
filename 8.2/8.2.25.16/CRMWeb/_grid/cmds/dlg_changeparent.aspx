...
<title><loc:Text ResourceId="Web._grid.cmds.dlg_changeparent.aspx_46" runat="server"><loc:Argument runat="server"><%= Microsoft.Crm.CrmEncodeDecode.CrmHtmlEncode(parentObjName) %></loc:Argument></loc:Text></title>
...
<tr>
<td valign="top">
<div class="ms-crm-changeParentLookup"><label id="OwnerLookupLabel" for="crmOwnerLookup" runat="server"></label></div>
