...
oUrl = Mscrm.CrmUri.create("/_grid/cmds/dlg_confirm_delete.aspx?ObjectTypeId=" + CrmEncodeDecode.CrmUrlEncode(_iObjType) + "&iTotal=" + <%=Microsoft.Crm.CrmEncodeDecode.CrmUrlEncode(iTotal.ToString("D", CultureInfo.InvariantCulture))%>);
...
<loc:Text ResourceId="Web._grid.cmds.dlg_delete_account.aspx_54" runat="server"><loc:Argument runat="server"><%=Microsoft.Crm.CrmEncodeDecode.CrmHtmlEncode(ObjNamePlural)%></loc:Argument></loc:Text>
<span id="sharePointDocumentsWarning" runat="server"><loc:Text ResourceId="Delete_Account_Dialog_RelatedDocumentsWarning" runat="server" /></span>
<br>
<br>
