...
__dialogXml = "<profile><name>" + CrmEncodeDecode.CrmHtmlEncode($get("profileName").value) + "</name><profiletoclone>";
__dialogXml += CrmEncodeDecode.CrmHtmlEncode(<%= Microsoft.Crm.CrmEncodeDecode.CrmJavaScriptEncode(ProfileId) %>);
