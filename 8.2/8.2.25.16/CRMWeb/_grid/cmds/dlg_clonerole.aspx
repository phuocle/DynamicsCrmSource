...
{
__dialogXml = "<role><name>" + CrmEncodeDecode.CrmHtmlEncode($get("rolename").value) + "</name><roletoclone>";
__dialogXml += CrmEncodeDecode.CrmHtmlEncode(<%= Microsoft.Crm.CrmEncodeDecode.CrmJavaScriptEncode(RoleId) %>);
...
if (o.getAttribute("id") != "cmdDialogCancel" && ev.keyCode == KEY_ENTER && !$get("butBegin").getAttribute("disabled"))
{
ev.preventDefault();
applychanges();
}
...
<col width="140px"/><col/>
<tr valign="top">
<td><loc:Text ResourceId="Web._grid.cmds.dlg_clonerole.aspx_76" runat="server"/></td>
<td>
<div><%= Microsoft.Crm.CrmEncodeDecode.CrmHtmlEncode(RoleName) %></div>
</td>
</tr>
<tr valign="top">
<td><label for="rolename"><loc:Text ResourceId="Web._grid.cmds.dlg_clonerole.aspx_82" runat="server"/></label></td>
<td>
...
<label for="openrole"><loc:Text ResourceId="Web._grid.cmds.dlg_clonerole.aspx_90" runat="server"/></label>
</td>
</tr>
