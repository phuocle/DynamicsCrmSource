...
<title><loc:Text ResourceId="Web._grid.cmds.dlg_confirm_delete.aspx_10." runat="server"/></title>
...
<col>
<tr>
<td><loc:Text ResourceId="Web._grid.cmds.dlg_confirm_delete.aspx_39" runat="server"><loc:Argument runat="server"><%=Microsoft.Crm.CrmEncodeDecode.CrmHtmlEncode(ObjectName)%></loc:Argument><loc:Argument runat="server"><%=Microsoft.Crm.CrmEncodeDecode.CrmHtmlEncode(ObjectName)%></loc:Argument></loc:Text></td>
</tr>
</table>
</frm:DialogForm>
</body>
