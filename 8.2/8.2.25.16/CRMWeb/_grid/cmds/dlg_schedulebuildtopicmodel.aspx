...
.shedulebuilddailyhide {
display: none;
}

.shedulebuildweeklyhide {
display: none;
}

.shedulebuilddailyshow {
display: block;
}

.shedulebuildweeklyshow {
display: block;
}
...
_custParams = pattern + "&recPattern=" + "FREQ=WEEKLY;INTERVAL=" + interval + ";DAYWEEK=" + daysweek.toString().substring(1) + "";
}
else{
