...
{
if (type != "undefined" && _selectedItemPrevSibling.className == "ms-crm-Dialog-ListHeader ms-crm-Bold-Header")
{
...
if (parent.getAttribute("id")!=null && parent.getAttribute("id") == "TemplateTable")
{
if (type != "undefined" && _selectedItemNextSibling.className == "ms-crm-Dialog-ListHeader ms-crm-Bold-Header")
{
...
break;
case KEY_HOME:
if (typeof (XUI.Html.DomUtils.GetFirstChild(_selectedItem.parentNode).getAttribute("item")) != "undefined")
{
if(XUI.Html.DomUtils.GetFirstChild(_selectedItem.parentNode).className=="ms-crm-Dialog-ListHeader ms-crm-Bold-Header")
{
...
break;
case KEY_END:
if (typeof (XUI.Html.DomUtils.GetLastChild(_selectedItem.parentNode).getAttribute("item")) != "undefined")
{
...
oXmlHTTP.open("POST", Mscrm.CrmUri.create("/_grid/cmds/cmd_bulkemailfromids.aspx?fromId=" + CrmEncodeDecode.CrmUrlEncode(fromId) +
"&fromType=" + CrmEncodeDecode.CrmUrlEncode(fromType) +
"&template=" + CrmEncodeDecode.CrmUrlEncode(_oTemplate.getAttribute("tmplId")) +
"&objectTypeCode=" + <%= Util.GetInt(Request.QueryString["objectTypeCode"]) %>).toString(), false);
...
oXmlHTTP.open("POST", Mscrm.CrmUri.create("/_grid/cmds/cmd_bulkemailfromview.aspx?fromId=" + CrmEncodeDecode.CrmUrlEncode(fromId) + "&fromType=" + CrmEncodeDecode.CrmUrlEncode(fromType) + "&template=" + CrmEncodeDecode.CrmUrlEncode(_oTemplate.getAttribute("tmplId")) + "&" + ((bThisPageOnly) ? _sQueryString.toString() : _sQueryString.replace("multiPage=false", "multiPage=true")).toString()), false);
...
command.SetParameter("objectId", "<%= Microsoft.Crm.Util.GetGuid(Request.QueryString["objectid"]) %>");
command.SetParameter("objectTypeCode", <%= int.Parse(Request.QueryString["objectTypeCode"], NumberStyles.Integer, CultureInfo.InvariantCulture) %>);
...
o.EmailTemplateId = XUI.Xml.GetText(XUI.Xml.SelectSingleNode(oXml, "template/templateid", null));
}
...
XUI.Html.SetText($get("TmplCreatedOn"),Mscrm.DateTimeUtility.formatDate(ParseUtcDate(_oTemplate.getAttribute("tmplCreatedOn"))));
...
<col width="100" /><col />
<tr>
<td id="languagecode_c"><label for="LanguageCode"><loc:MetadataText ID="MetadataText1" EntityType="template" AttributeName="languagecode" runat="server"/></label></td>
...
<div id="ItemList" class="ms-crm-Dialog-List ms-crm-Dialog-List-Layered ms-crm-TextAlign-LeadingEdge  ms-crm-absolutePosition"  style="padding-top:0px;padding-bottom:0px;height:auto;"><ui:XmlRenderer id="xmlRenderer" runat="server"/></div>
...
<tr>
<td colspan="3"><b class="ms-crm-float-LeadingEdge"><loc:Text ID="Text5" ResourceId="Web._grid.cmds.dlg_bulkemail.aspx_346" runat="server"/>:</b></td>
</tr>
...
<td valign="top">
<div class="ms-crm-TextAlign-LeadingEdge"><label class="ms-crm-Bold-Header" for="radSelected" id="labelSelected"><loc:Text ID="Text6" ResourceId="Web._grid.cmds.dlg_bulkemail.aspx_214" runat="server"/></label></div>
<div class="ms-crm-TextAlign-LeadingEdge" style="padding-top:5px; color: #444444;"><loc:Text ID="Text7" ResourceId="Web._grid.cmds.dlg_bulkemail.aspx_216" runat="server"/></div>
</td>
</tr>
<tr><td colspan="3">&nbsp;</td></tr>
<tr>
...
<td valign="top">
<div class="ms-crm-TextAlign-LeadingEdge"><label class="ms-crm-Bold-Header" for="radCurrent" id="labelCurrent"><loc:Text ID="Text8" ResourceId="Web._grid.cmds.dlg_bulkemail.aspx_225" runat="server"/></label></div>
<div class="ms-crm-TextAlign-LeadingEdge" style="padding-top:5px; color: #444444;"><loc:Text ID="Text9" ResourceId="Web._grid.cmds.dlg_bulkemail.aspx_227" runat="server"/></div>
</td>
</tr>
<tr><td colspan="3">&nbsp;</td></tr>
<tr>
...
<td valign="top">
<div class="ms-crm-TextAlign-LeadingEdge"><label class="ms-crm-Bold-Header" for="radAll" id="labelAll"><loc:Text ID="Text10" ResourceId="Web._grid.cmds.dlg_bulkemail.aspx_236" runat="server"/></label></div>
<div class="ms-crm-TextAlign-LeadingEdge" style="padding-top:5px; color: #444444;"><loc:Text ID="Text11" ResourceId="Web._grid.cmds.dlg_bulkemail.aspx_238" runat="server"/></div>
</td>
</tr>
<tr><td colspan="3">&nbsp;</td></tr>
<tr>
<td colspan="3"><b class="ms-crm-float-LeadingEdge"><loc:Text ID="Text12" ResourceId="Web._grid.cmds.dlg_bulkemail.aspx_386" runat="server"/>:</b></td>
</tr>
<tr><td colspan="3">&nbsp;</td></tr>
<tr>
<td colspan="3">
...
<tr>
<td nowrap="nowrap" class="ms-crm-Field-Required dlg_bulkemail_td_ActivitySender" style="width:10%"><label for="crmLookup"><loc:Text ID="Text13" ResourceId="Web._grid.cmds.dlg_bulkemail.aspx_390" runat="server"/><img src="/_imgs/frm_required.gif" alt="<loc:Text Encoding='HtmlAttribute' ResourceId='Forms.Required.AltTag' runat='server'/>"/></label></td>
