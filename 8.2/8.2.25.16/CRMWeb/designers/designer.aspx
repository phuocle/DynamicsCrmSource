...
<% this.BuildVersion  = "8200250016"; %>

<title><%= this.GetPageTitle()  %></title>

<link rel="stylesheet" href="/designers/Common/Styles/Common.css?v=8200250016" />
<% if (this.IsRTL) { %>
<link rel="stylesheet" href="/designers/Common/Styles/Common.rtl.css?v=8200250016" />
<% } %>
...
<script type="text/javascript" src="/designers/Scripts/jquery-2.2.3.js?v=8200250016"></script>
<script type="text/javascript" src="/designers/Scripts/Angular/angular.js?v=8200250016"></script>
<script type="text/javascript" src="/designers/Scripts/Angular/angular-aria.js?v=8200250016"></script>
<script type="text/javascript" src="/designers/Scripts/Angular/angular-ui-router.js?v=8200250016"></script>
<script type="text/javascript" src="/designers/Scripts/Sdk.Soap.js?v=8200250016"></script>
<script type="text/javascript" src="/designers/Scripts/moment.js?v=8200250016"></script>
<script type="text/javascript" src="/designers/Common/Scripts/Common.js?v=8200250016"></script>
<script type="text/javascript" src="/designers/Scripts/stacktrace-with-promises-and-json-polyfills.js?v=8200250016"></script>
<script type="text/javascript" src="/designers/Framework/Scripts/Framework.js?v=8200250016"></script>

<% if((this.IsPerfTrackingEnabled) || (isOnlineOrIfd)) { %>
<script type="text/javascript" src="/designers/Perf/Scripts/Perf.js?v=8200250016"></script>
<script type="text/javascript" src="/designers/DesignerTelemetry/Scripts/DesignerTelemetry.js?v=8200250016"></script>
<% } %>
...
angular.module("Mscrm.Designers.DesignerApp").value("resourceStrings", <%= this.InjectResourceStrings(@"all")%>);
