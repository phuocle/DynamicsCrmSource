...
createDialogControl = Mscrm.DocumentTemplate.UploadDialogControl.create(document.getElementsByTagName("body")[0], <%=TemplateType %>, <%=LocatorService.Instance.GetSiteSetting("ImportMaxAllowedFileSizeInMB")%>);
checkDivWarnigCSS();
}
...
<p class="drop_zone_para dropText" id="drop_zone_para_shortText"><loc:Text ResourceId="Web.UploadDocumentTemplatePage.DropFileHere" runat="server" /></p>
<div id="errorDescription" class="errorDescription">
<p class="drop_zone_para specificError"></p>
<p class="drop_zone_para genericError"><loc:Text ID="locGenericError" ResourceId="Web.VerifyDocumentTemplatePage.FailureMessage" runat="server" /></p>
</div>
