...
document.getElementById("fetchXmlData").value = XUI.Xml.XMLSerializer.serializeToString(fetchXmlNodes[_SelectedIndex]);
}
else
{
...
var url = Mscrm.CrmUri.create("/tools/bulkdelete/bulkdeletequeryview.aspx?entityname=" + _EntityName).toString();
