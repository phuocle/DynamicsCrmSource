<%@ Page language="c#" Inherits="Microsoft.Crm.Web.Tools.BulkDelete.BulkDeletionJobs" %>
...
<tr>
<td><label class="ms-crm-Setting-ContextHeader-Title"><loc:Text ResourceId="DataManagement.BulkDeletion.Title" runat="server"/></label></td>
...
<tr>
<td id="td1" nowrap style="padding-right:5px;"><label for="crmGrid_SavedQuerySelector"><span class="ms-crm-Bold-Header"><loc:Text ResourceId="DataManagement.ManageRulesPage.View.Label" runat="server"/></span></label></td>
...
<cnt:AppNotifications id="Notifications" runat="server" AutoRegisterClientComponent="false"/>
...
<div class="ms-crm-absolutePosition" style="top:94px" is="bdgridconatiner">
<div class="ms-crm-IE7-Height-Fix-Dummy-Container">
<cnt:AppGrid runat="server" id="crmGrid" IsGridFilteringEnabled="false"/>
</div>
</div>
<script>
Sys.Application.add_init(function attachgridsizecalculator() {
crmCreate(Mscrm.GridSizeCalculator, {}, null, null, $get('bdgridconatiner'));
});
</script>
</div>
</body>
