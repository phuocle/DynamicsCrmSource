...
currentArticle.lastModifiedOn = IsNull(currentArticle.lastModifiedOn) ? null : new Date(currentArticle.lastModifiedOn);
currentArticle.createdOn = IsNull(currentArticle.createdOn) ? null : new Date(currentArticle.createdOn);
currentArticle.expiredDate = IsNull(currentArticle.expiredDate) ? null : new Date(currentArticle.expiredDate);
...
<style>
.kbArticleContent .contentwallbody
{
height:98%;
