...
<span class='listingType'><a id="popularSolutionsMoreLink" target="_blank" runat="server"><loc:Text ResourceId="Solutions.Marketplace.More.Link" runat="server" /></a></span>
</div>
<div id="newestSolutionsMoreContainer" class='solutionsTab'>
<span class='listingType'><a id="newestSolutionsMoreLink" target="_blank" runat="server"><loc:Text ResourceId="Solutions.Marketplace.More.Link" runat="server" /></a></span>
</div>
<div id="staffPicksSolutionsMoreContainer" class='solutionsTab'>
<span class='listingType'><a id="staffPicksSolutionsMoreLink" target="_blank" runat="server"><loc:Text ResourceId="Solutions.Marketplace.More.Link" runat="server" /></a></span>
</div>
