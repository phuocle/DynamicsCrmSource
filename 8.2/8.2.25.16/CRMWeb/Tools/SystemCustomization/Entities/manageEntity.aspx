...
{
if ($get('checkIsActivity').checked == true)
{
...
{
if(_bCreate && $get('checkIsActivity').checked == false)
{
_chkAEActivities.checked = false;
...
<td><ui:Select id="selPrimaryImage" TabIndex="5" runat="server"/></td>
</tr>
...
<label id="chkIsInteractionCentricEnabledLabel" for="chkIsInteractionCentricEnabled"><loc:Text ResourceId="SystemCustomization.ManageEntityPage.ICSection.EnableOnly.Labels.EnableEntity" runat="server"/></label>
</td>
...
<th style="width: 15%" class="customcontrol-text-ellipses" title="<loc:Text ResourceId='CustomControls_Configuration_Web' runat='server'/>"><b><loc:Text ResourceId="CustomControls_Configuration_Web" runat="server"/></b></th>
<%} %>
