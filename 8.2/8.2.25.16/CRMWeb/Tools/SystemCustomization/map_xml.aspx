...
<page id="0">
<title><loc:Text ResourceId="SystemCustomization.RootPage.Title" runat="server"/></title>
<showstagetitle>1</showstagetitle>
<subtitle><loc:Text ResourceId="SystemCustomization.RootPage.Subtitle" runat="server"/></subtitle>
...
%>
<page id="09">
<title><loc:Text ResourceId="Web.Tools.Solution.map_xml.DefaultSolution.Title" runat="server"/></title>
...
<help><loc:Text ResourceId="Web.Tools.Solution.map_xml.DefaultSolution.Description" runat="server"/></help>
</page>
<%
}
...
%>
<page id="10">
<title><loc:Text ResourceId="Web.Tools.Publisher.map_xml.aspx_1" runat="server"/></title>
...
<help><loc:Text ResourceId="Web.Tools.Publisher.map_xml.aspx_2" runat="server"/></help>
</page>
<%
}
%>
...
%>
<page id="11">
<title><loc:Text ResourceId="Web.Tools.Solution.map_xml.aspx_1" runat="server"/></title>
...
<help><loc:Text ResourceId="Web.Tools.Solution.map_xml.aspx_2" runat="server"/></help>
</page>
<%
}
...
<help><loc:Text ResourceId="Web.Tools.cust.map_xml.aspx_warning" runat="server"/></help>
</note>
<%
}
%>
...
%>
<page id="05">
<title><loc:Text ResourceId="SystemCustomization.WsdlProgramming.Title" runat="server"/></title>
<showstagetitle>1</showstagetitle>
<subtitle><loc:Text ResourceId="SystemCustomization.WsdlProgramming.Subtitle" runat="server"/></subtitle>
<icon>/_imgs/SystemCustomization/ico_downloadWebServiceDesc.gif</icon>
<help><loc:Text ResourceId="SystemCustomization.WsdlProgramming.Help" runat="server"/></help>
...
%>
<page id="12">
<title><loc:Text ResourceId="Web.Tools.Theme.map_xml.aspx_1" runat="server"/></title>
<showstagetitle>1</showstagetitle>
...
<url><app:FlatHomepageUrlControl EntityLogicalName="theme" XmlEncode="true" runat="server" /></url>
<help><loc:Text ResourceId="Web.Tools.Theme.map_xml.aspx_2" runat="server"/></help>
</page>
<%
}
%>
