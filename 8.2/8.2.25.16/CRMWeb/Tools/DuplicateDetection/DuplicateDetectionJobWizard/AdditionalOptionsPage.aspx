...
<tr>
<td><loc:Text ResourceId="DuplicateDetection_Wizard_Page3_SpecifyNameDescription" runat="server"/></td>
</tr>
<tr>
<td>&nbsp;</td>
</tr>
<% } %>
<tr>
<td><label class="ms-crm-Bold-Header" for="txtJobName"><loc:Text ResourceId="DuplicateDetection_Wizard_Page3_Name" runat="server"/></label></td>
</tr>
<tr>
...
<table width="100%" cellpadding=0 cellspacing=0>
<tr>
<td><label class="ms-crm-Bold-Header" for="startTime"><loc:Text ResourceId="DuplicateDetection_Wizard_Page3_StartTime" runat="server"/></label></td>
</tr>
<tr>
<td>
<table width="100%">
...
<td><label for="chkRecurrence"><loc:Text ResourceId="DuplicateDetection_Wizard_Page3_RecurrenceText" runat="server"/></label></td>
</tr>
</table>
<table width="100%">
...
<td><label for="numberOfDays"><loc:Text ResourceId="DuplicateDetection_Wizard_Page3_RecurrenceTextDays" runat="server"/></label></td>
<td>&nbsp;</td>
</tr>
</table>
</td>
...
<table width="100%">
<tr>
<td><label for="recipients"><loc:Text ResourceId="DuplicateDetection_Wizard_Page3_NotifyOthers" runat="server"/></label></td>
</tr>
</table>
<table width="100%">
<col width="70%"><col>
