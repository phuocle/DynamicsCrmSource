<%@ Page language="c#" Inherits="Microsoft.Crm.Web.Tools.ManageMaps.ManageMapsPage" %>
...
<tr>
<td><label class="ms-crm-Setting-ContextHeader-Title"><loc:Text ResourceId="DataManagement.ImportMaps.Title" runat="server"/></label></td>
...
<div height="0" style="display:none">
<form name="exportMap" action="" method="post" target="_top">
</form>
</div>
</div>
