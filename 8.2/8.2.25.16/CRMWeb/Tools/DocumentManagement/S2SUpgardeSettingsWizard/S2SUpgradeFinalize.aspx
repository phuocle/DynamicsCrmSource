...
Mscrm.S2SUpgradePageHelper.logTelemetryForOperation(Mscrm.S2SUpgradePageHelper.operationSuccess, Mscrm.S2SUpgradePageHelper.enableSharePointIntegration_CommandName);
}
...
Mscrm.S2SUpgradePageHelper.logMetricsforWizard(Mscrm.S2SUpgradePageHelper.telemetryLogEventWizardCancel, "S2SUpgradeFinalize");
...
openStdWin(Mscrm.CrmUri.create('/WebWizard/WizardContainer.aspx?WizardId=2164dd44-6f89-430c-9c7b-abfa44320cf0'), '_blank', 520, 530, null);
}
...
<b><loc:Text ResourceId="Web.Tools.S2SUpgrade.SettingsFinalizePage.Description"  runat="server"/></b>
</div>
<div style="text-align:center"><loc:Text ResourceId="Web.Tools.S2SUpgrade.SettingsFinalizePage.Description1"  runat="server"/></div>
