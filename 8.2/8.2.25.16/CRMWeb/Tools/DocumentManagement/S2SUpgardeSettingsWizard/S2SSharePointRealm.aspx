...
Mscrm.S2SUpgradePageHelper.updateGlobalSharePointSettings($get("txtsharepointrealmid").value, false, false);
}
...
Mscrm.S2SUpgradePageHelper.updateGlobalSharePointSettings($get("txtsharepointTenantid").value, true, true);
}
else {
Mscrm.S2SUpgradePageHelper.updateGlobalSharePointSettings("", WizardGetProperty("isSharePointOnline"), true);
}
}
}

function OnUserCancel() {
Mscrm.S2SUpgradePageHelper.logMetricsforWizard(Mscrm.S2SUpgradePageHelper.telemetryLogEventWizardCancel, "S2SSharePointRealm");
...
Mscrm.S2SUpgradeWizardRerunHelper.setDomElementsInWizard(Mscrm.S2SIntegrationStage.prepareSites,WizardGetProperty("isSharePointOnline"));
...
document.getElementById("setupDescription").innerHTML = '<%=descriptionCRMOnPremiseSPOnline.ToString()%>';
...
document.getElementById("setupDescription").innerHTML = '<%=descriptionCRMOnlineSPOnPremise.ToString()%>';
...
if (!WizardGetProperty("isSharePointOnline")) {
return (!window.bGrayTextOn["txtsharepointrealmid"] && !isNullOrEmptyString(document.getElementById("txtsharepointrealmid").value));
}
else {
return (!window.bGrayTextOn["txtsharepointTenantid"] && !isNullOrEmptyString(document.getElementById("txtsharepointTenantid").value));
}
}
}
...
if (!window.bGrayTextOn["txtSiteCollectionUrl"] && !isNullOrEmptyString(document.getElementById("txtSiteCollectionUrl").value)) {
return true;
}
return false;
}
...
<tr>
<td>
<span id="txtOneShowsites"><loc:Text ResourceId="Web.Tools.S2SUpgrade.Wizard.S2SSharePointRealm.Number1" runat="server" /></span>
...
<tr>
<td colspan="2">
<span id="txtOneShowURL"><loc:Text ResourceId="Web.Tools.S2SUpgrade.Wizard.S2SSharePointRealm.Number1" runat="server" /></span>
...
<loc:Text ResourceId="Web.Tools.S2SUpgrade.Wizard.S2SSharePointRealm.URL" runat="server" /></label>
</td>
...
<p class="mscrm-text-S2Swizard ms-crm-S2SPadding" style="margin-top: 0px; margin-bottom: 0px;"><loc:Text ResourceId="Web.Tools.S2SUpgrade.Wizard.S2SSharePointRealm.auth2" runat="server" /></p>
</div>
...
<loc:Text ResourceId="Web.Tools.S2SUpgrade.Wizard.S2SSharePointRealm.SPRealmID" runat="server" /></label>
</td>
<td style="padding-left: 22px">
