...
{
var oUrl = Mscrm.CrmUri.create("/Tools/DocumentManagement/DocumentManagementSettingsWizard/CreateDocumentLibrary.aspx");
return new NextPageDefinition(oUrl, WizardGetProperty("DefaultSiteUrl"));
}

function showHideErrorLog() {
document.getElementById('errorlogtextid').value = CrmEncodeDecode.CrmHtmlDecode(WizardGetProperty("ErrorLogText"));
...
Mscrm.EnableDocumentManagementPageHelper.saveDocumentManagementSettings(SaveDocumentManagementSettingsCallBackFunction);
}
}
...
var validateResult = WizardGetProperty("ValidateResult");
if ((validateResult == Mscrm.SPSiteValidateResult.sharePoint2010WithListSolution || validateResult == Mscrm.SPSiteValidateResult.sharePointS2SConfigured) && WizardGetProperty("SelectedEntityCount") > 0) {
...
if (!IsNull(siteUrl))
{
var siteUrlLink = "<a href=" + CrmEncodeDecode.CrmHtmlEncode(siteUrl) + " target=\"_blank\" style=\"text-decoration:underline;color:blue\">" + CrmEncodeDecode.CrmHtmlEncode(siteUrl) + "</a>";
...
<tr>
<td class="mscrm-docmgmt-LeftColumn"> <img src="/_imgs/Ribbon/ValidateURL_16.png" alt=""/> </td>
...
<tr>
<td class="mscrm-docmgmt-WarningMessage" valign="top" width="10%"><img src="/_imgs/error/notif_icn_warn16.png" alt=""/></td>
<td class="mscrm-docmgmt-WarningMessage" id="warningMessageLabel" runat="server"><ui:LabelUI  runat="server"/></td>
</tr>
</table>
<br />
...
<tr>
<td colspan="4"><label tabindex="0"><b><loc:Text ResourceId="Web.Tools.DocumentManagement.SettingsPage.FolderStructureTitle" runat="server"/></b></label></td>
</tr>
<tr>
<td colspan="4"><label tabindex="0"><loc:Text ResourceId="Web.Tools.DocumentManagement.SettingsPage.FolderStructureDescription" runat="server"/></label></td>
</tr>
<tr><td><br/></td></tr>
<tr>
<td class="mscrm-docmgmt-LeftColumn"><ui:CheckBox id="entityCentricSetting" onclick="OnEntityCentricCheckBoxClick(new Sys.UI.DomEvent(event));" runat="server"/></td>
<td width="30%"><b><loc:Text ResourceId="Web.Tools.DocumentManagement.SettingsPage.EntityCentricTitle" runat="server"/></b></td>
<td width="35%"><sdk:PicklistControl runat="server" id="folderStructureEntity" onchange="OnPickListChange();"/> </td>
<td>&nbsp;</td>
</tr>
<tr>
<td colspan="4"><label id="entityCentricDescription" runat="server"/></td>
</tr>
</table>
<table style="margin-top:20px;" width="100%" id="autoFolderOnSharePointTable" cellpadding="2" cellspacing="2" runat="server">
<tr>
<td colspan="4"><label tabindex="0"><b><loc:Text ResourceId="Web.Tools.DocumentManagement.SettingsPage.AutoFolderOnSharePointStructureTitle" runat="server"/></b></label></td>
</tr>
<tr>
<td colspan="4"><label tabindex="0"><loc:Text ResourceId="Web.Tools.DocumentManagement.SettingsPage.AutoFolderOnSharePointStructureDescription" runat="server"/></label></td>
</tr>
<tr><td><br/></td></tr>
<tr>
<td class="mscrm-docmgmt-LeftColumn"><ui:CheckBox id="autoFolderOnSharePointSetting" runat="server"/></td>
<td><b><loc:Text ResourceId="Web.Tools.DocumentManagement.SettingsPage.AutoFolderOnSharePointTitle" runat="server"/></b></td>
<td>&nbsp;</td>
</tr>
</table>
</frm:WizardForm>
