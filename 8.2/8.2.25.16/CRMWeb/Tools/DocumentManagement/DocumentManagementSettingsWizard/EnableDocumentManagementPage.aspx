...
{
var oUrl = Mscrm.CrmUri.create("/Tools/DocumentManagement/DocumentManagementSettingsWizard/SettingsFinalize.aspx");
...
Mscrm.S2SUpgradePageHelper.logTelemetryForOperation(Mscrm.S2SUpgradePageHelper.operationStart, Mscrm.S2SUpgradePageHelper.updateDocumentManagementSettings_CommandName);
}
...
<tr>
<td width="100%"><label style="font-weight:bold" tabindex="0"><loc:Text ResourceId="Web.Tools.DocumentManagement.SettingsPage.EntityTable.Title" runat="server"/></label></td>
</tr>
<tr>
<td width="100%"><label tabindex="0"><loc:Text ResourceId="Web.Tools.DocumentManagement.SettingsPage.EntityTable.Description" runat="server"/></label></td>
</tr>
<tr><td>
<br />
...
<tr>
<td width="100%"><br /><label style="font-weight:bold" id="siteUrlTitle" tabindex="0" runat="server"><loc:Text ResourceId="Web.Tools.DocumentManagement.SettingsPage.SiteCollectionUrl.Title" runat="server"/></label></td>
</tr>
<tr>
<td width="100%"><label id="siteUrlDescription" tabindex="0" runat="server"><loc:Text ResourceId="Web.Tools.DocumentManagement.SettingsPage.SiteCollectionUrl.Description" runat="server"/></label></td>
</tr>
<tr><td>
<br />
<table width="100%" style="table-layout:fixed;" id=siteUrlTextTable><tr>
<td width="10%" id="siteUrlLabelCell" runat="server"><label for="txtSiteCollectionUrl" id="siteUrlLabel" runat="server" ><b><loc:Text ResourceId="Web.Tools.DocumentManagement.SettingsPage.SiteCollectionUrl.Label" runat="server"/></b></label></td>
