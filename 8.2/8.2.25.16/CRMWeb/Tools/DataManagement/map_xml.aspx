...
<page id="11">
<title><loc:Text ResourceId="DataManagement.ExportLocLabels.Title" runat="server"/></title>
<subtitle><loc:Text ResourceId="DataManagement.ExportLocLabels.Subtitle" runat="server"/></subtitle>
<icon>/_imgs/translation_export_48.png</icon>
<help><loc:Text ResourceId="DataManagement.ExportLocLabels.Help" runat="server"/></help>
...
%>
<page id="12">
<title><loc:Text ResourceId="DataManagement.ImportLocLabels.Title" runat="server"/></title>
<subtitle><loc:Text ResourceId="DataManagement.ImportLocLabels.Subtitle" runat="server"/></subtitle>
<icon>/_imgs/translation_import_48.png</icon>
<help><loc:Text ResourceId="DataManagement.ImportLocLabels.Help" runat="server"/></help>
<link inline="1">/_static/loading.htm</link>
...
%>
<page id="13">
<title><loc:Text ResourceId="Web.Tools.AdvancedSimilarityRuleTitle" runat="server"/></title>
...
<url><app:FlatHomepageUrlControl EntityLogicalName="advancedsimilarityrule" XmlEncode="true" runat="server" /></url>
<help><loc:Text ResourceId="Web.Tools.AdvancedSimilarityRuleHelp" runat="server"/></help>
</page>
<%
}
%>
