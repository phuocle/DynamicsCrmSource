...
var propertiesToPost = new Array("ImportId", "FieldDelimiter", "DataDelimiter", "IsFirstRowHeader", "ImportFileName", "OriginalImportFileId");
...
if (IsNull(existingFieldDelimiter) || (existingFieldDelimiter != Mscrm.FormControlInputBehavior.GetBehavior("fieldDelimiter").get_dataValue()))
{
WizardSetProperty("FieldDelimiter", Mscrm.FormControlInputBehavior.GetBehavior("fieldDelimiter").get_dataValue());
...
<tr>
<td valign="bottom">
<a class="mscrm-iw-Anchor" href="javascript:ToggleDelimiterSection();"><img id="sectionToggleArrowImg" src="/_imgs/tab_section_right.png"/></a>
</td>
<td width="100%">
<a id="viewSettings" href="javascript:ToggleDelimiterSection();" class="ms-crm-InlineTabHeaderText">
<nobr><loc:Text ResourceId="ImportWizard.UploadPreviewPage.DelimiterSectionHeading" runat="server"/></nobr>
</a>
</td>
</tr>
</tbody>
...
<tr>
<td>
<label for="fieldDelimiter"><loc:Text ResourceId="ImportWizard.UploadPreviewPage.FirstDelimiterHeading" runat="server"/></label>
</td>
<td>
...
<label for="firstRowIsHeaders"><loc:Text ResourceId="ImportWizard.UploadPreviewPage.CheckboxDescription" runat="server"/></label>
</div>
</div>
</div>
</div>
