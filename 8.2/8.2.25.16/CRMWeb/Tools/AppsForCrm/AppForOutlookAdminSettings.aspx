...
<loc:Text ID="subtitle" runat="server" /></span>
...
<loc:Text ResourceId="MailApp.Generic.LearnMore" runat="server" /></a>
</div>
<div style="padding-top:20px;">
<span id="headerSubTitle" tabindex="0" class="ms-crm-CrmAppForOutlook-subtitle" title="<loc:Text Encoding='HtmlAttribute' ResourceId='MailApp.RootPage.Subtitle' runat='server'/>">
<div id="divExternalSearch" runat="server">
<loc:Text ID="ExternalSearchSubtitle" ResourceId = "MailApp.RootPage.OnlineOrg.RelevanceSearch" runat="server" /></span>
...
<loc:Text ResourceId="MailApp.Generic.LookHere" runat="server" /></a>
</div>
</div>
...
<loc:Text ResourceId="MailApp.RootPage.Info.OrgEmailSettings" runat="server" /></span>
</div>
</div>
...
<loc:Text ResourceId="MailApp.RootPage.Setup.Header" runat="server" /></span>&nbsp;
...
<span>
[&nbsp<a id="doneLink" tabindex="0" href="#" class="ms-crm-CrmAppForOutlook-editLink" runat="server"><loc:Text ResourceId="MailApp.Setup.Done" runat="server" /></a>&nbsp]
</span>
</div>
</div>
<div>
...
<loc:Text ResourceId="MailApp.RootPage.Settings.Header" runat="server" /></span>&nbsp;
<span>
[&nbsp<a id="editLink" tabindex="0" href="#" class="ms-crm-CrmAppForOutlook-editLink" runat="server"><loc:Text ResourceId="MailApp.Generic.Edit" runat="server" /></a>&nbsp]
</span>
</div>
<div id="settingBody" runat="server" style="padding-top:12px; margin-left:-2px;">
<table id="bodyContainer">
<tr>
<td style="width:340px;"><span tabindex= "0" class="ms-crm-CrmAppForOutlook-autoAddTitle" title="<loc:Text Encoding='HtmlAttribute' ResourceId='MailApp.RootPage.Settings.AutoAdd.Title' runat='server'/>">
<loc:Text ResourceId="MailApp.RootPage.Settings.AutoAdd.Title" runat="server" /></span>
</td>
</tr>
<tr>
<td style="width:340px;">
<label tabindex="0" class="ms-crm-CrmAppForOutlook-autoAddSubtitle" title="<loc:Text Encoding='HtmlAttribute' ResourceId='MailApp.RootPage.Settings.AutoAdd.Subtitle' runat='server'/>"><loc:Text ResourceId="MailApp.RootPage.Settings.AutoAdd.Subtitle" runat="server" /></label>
</td>
...
<label tabindex="0" class="ms-crm-CrmAppForOutlook-autoAddDescription" title="<loc:Text Encoding='HtmlAttribute' ResourceId='MailApp.RootPage.Settings.AutoAdd.Description' runat='server'/>"><loc:Text ResourceId="MailApp.RootPage.Settings.AutoAdd.Description" runat="server" /></label>
</td>
</tr>
<tr>
