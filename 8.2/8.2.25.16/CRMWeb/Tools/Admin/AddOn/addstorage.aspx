...
XUI.Html.SetText($get('LicenseToAddTableHeader'), <%=Microsoft.Crm.CrmEncodeDecode.CrmJavaScriptEncode(CurrentResourceManager.GetString("AddOnWizard.StorageLicenseInputPage.LicenseToAddHeaderAfterChange"))%>);
$get('UserInputTable').setAttribute('summary', <%=Microsoft.Crm.CrmEncodeDecode.CrmJavaScriptEncode(CurrentResourceManager.GetString("AddOnWizard.StorageLicenseInputPage.LicenseToAddHeaderAfterChange"))%>);
...
var postData = CrmEncodeDecode.CrmXmlEncode($get('NumberOfStorageLicensesToAdd').value) + ";" + CURRENT_MONTHLY_CHARGES_USER_LICENSES_QUANTITY + ";" + CURRENT_MONTHLY_CHARGES_STORAGE_QUANTITY;
...
XUI.Html.SetText($get('LicenseToAddTableHeader'), <%=Microsoft.Crm.CrmEncodeDecode.CrmJavaScriptEncode(CurrentResourceManager.GetString("AddOnWizard.StorageLicenseInputPage.LicenseToAddHeader"))%>);
$get('UserInputTable').setAttribute('summary', <%=Microsoft.Crm.CrmEncodeDecode.CrmJavaScriptEncode(CurrentResourceManager.GetString("AddOnWizard.StorageLicenseInputPage.LicenseToAddHeader"))%>);
...
setStorageLicenseUsageInfoText(STORAGE_LICENSES_TO_ADD_USAGE_INFO_PURCHASE_PAGE,(CURRENT_MONTHLY_CHARGES_STORAGE_QUANTITY * 1 + STORAGE_LICENSES_INCLUDED * 1).toFixed(NUMBER_OF_DIGITS_AFTER_DECIMAL_POINT_FOR_STORAGE), STORAGE_LICENSES_AVAILABLE);
}
...
{
$get('InvalidLicenseCountErrorMessage').innerHTML = <%=Microsoft.Crm.CrmEncodeDecode.CrmJavaScriptEncode(Microsoft.Crm.Application.Utility.Util.HtmlEncodeResource("AddOnWizard.LicenseInputPage.OutOfRangeAddStorageCountErrorMessage", Microsoft.Crm.Application.Utility.Util.CreateContactSupportHtml()))%>;
}
else
{
$get('InvalidLicenseCountErrorMessage').innerHTML = <%=Microsoft.Crm.CrmEncodeDecode.CrmJavaScriptEncode(Microsoft.Crm.Application.Utility.Util.HtmlEncodeResource("AddOnWizard.LicenseInputPage.InvalidAddStorageCountErrorMessage", Microsoft.Crm.Application.Utility.Util.CreateContactSupportHtml()))%>;
}
}
else
{
...
FormatToCurrencyAsync('StorageLicensesToAddPrice', storageLicensesToAddPrice.toFixed(NUMBER_OF_DIGITS_AFTER_DECIMAL_POINT));
...
setStorageLicenseUsageInfoText(STORAGE_LICENSES_TO_ADD_USAGE_INFO_PURCHASE_PAGE,CURRENT_MONTHLY_CHARGES_STORAGE_QUANTITY * 1 + STORAGE_LICENSES_INCLUDED * 1, STORAGE_LICENSES_AVAILABLE);
...
FormatToCurrencyAsync('StorageLicensesUnitPriceBeforePromotion', CURRENT_MONTHLY_CHARGES_STORAGE_UNIT_PRICE);
FormatToCurrencyAsync('StorageLicensesToAddUnitPriceBeforePromotion', CURRENT_MONTHLY_CHARGES_STORAGE_UNIT_PRICE);
