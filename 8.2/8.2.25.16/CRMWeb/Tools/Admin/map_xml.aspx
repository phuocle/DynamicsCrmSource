...
%>
<page id="26">
<title><loc:Text ResourceId="Web.Tools.TextAnalyticsConnection.Config.Title" runat="server"/></title>
...
<help><loc:Text ResourceId="Web.Tools.TextAnalyticsConnection.Config.Title.Help" runat="server"/></help>
</page>
<%
}
%>
