...
<td id="nameLabel" class="ms-crm-Field-Required"><label for="viewName"><loc:Text ResourceId="Web.Tools.ViewEditor.dialogs.ViewProperties.aspx_54" runat="server"/><img src="/_imgs/frm_required.gif" alt="<loc:Text Encoding='HtmlAttribute' ResourceId='Forms.Required.AltTag' runat='server'/>"/></label></td>
<td><ui:TextBox id="viewName" name="viewName" onblur="value = Trim(value);" maxlength="100" onkeyup="updateUI();" runat="server"/></td></tr>
<tr>
<td valign="top"><label for="viewDescId"><loc:Text ResourceId="Web.Tools.ViewEditor.dialogs.ViewProperties.aspx_57" runat="server"/></label></td>
<td valign="top"><ui:Textarea id="viewDescId" name="viewDesc" maxlength="200" style="height:400px;overflow-y:auto;" onkeyup="updateUI();" runat="server"/></td>
</tr>
</table>
</td>
</tr>
