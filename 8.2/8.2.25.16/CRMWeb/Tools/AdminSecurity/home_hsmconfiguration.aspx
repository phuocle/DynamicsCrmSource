...
if (!IsNull(ckEnableHSMConfiguration) && ckEnableHSMConfiguration.checked == true && ckEnableHSMConfiguration.disabled == false)
{
return true;
}
else
...
<loc:Text ResourceId="Web.Tools.aspx_xml.aspx_HSMLable" runat="server" /></label>
</div>
...
<loc:Text ResourceId="Web.Tools.aspx_xml.aspx_HSMLableTurn" runat="server" /></label>
</div>
<div id="hsmRadioControls">
<div class="ms-SelectHSM">
<label>
<loc:Text ResourceId="Web.Tools.aspx_xml.aspx_HSMLableSelect" runat="server" /></label>
</div>
<div class="ms-RadioControlHSM">
<ui:Radio id="rdSelectHierarchyType" runat="server" />
</div>
<div class="ms-crm-ManagerLinkButton">
<a href="#" onclick="OpenUserWindow()"><span style="color: Blue;" id="aUserLink">
<loc:Text ResourceId="HSM_Configure" runat="server" /></span></a>
</div>
<div class="ms-crm-PositionLinkButton">
<a href="#" onclick="OpenPositionWindow()"><span style="color: Blue;" id="aPositionLink">
<loc:Text ResourceId="HSM_Configure" runat="server" /></span></a>
</div>
...
<loc:Text ResourceId="Web.Tools.aspx_xml_HierarchyDepth" class="mx-BoldText" runat="server" /></label>
</td>
<td>
...
<div class="ms-SelectHSM">
<label>
<loc:Text ResourceId="Web.Tools.aspx_xml.aspx_HSMLableExcludeEntity" runat="server" /></label>
</div>
</div>
</div>
