...
var _dpPreviewMode = Mscrm.Utilities.parseBoolean(<%= Microsoft.Crm.CrmEncodeDecode.CrmJavaScriptEncode(dpPreviewMode) %>) ;
var _typeCode = parseInt(<%= Microsoft.Crm.CrmEncodeDecode.CrmJavaScriptEncode(otc) %>);
var _isReadOnly = Mscrm.Utilities.parseBoolean(<%= Microsoft.Crm.CrmEncodeDecode.CrmJavaScriptEncode(isReadOnly) %>);

function OnDynamicPropertyWindowLoad() {
crmCreate(Mscrm.DynamicPropertyListControl,{},null,{},$get('DynamicPropertiesList_LinkControl_dynamicPropertyListControl'));
Mscrm.DynamicPropertyListControl.control.set_renderType( _dpPreviewMode ? Mscrm.DynamicPropertyListControlRenderType.designPreview : Mscrm.DynamicPropertyListControlRenderType.runtime);
