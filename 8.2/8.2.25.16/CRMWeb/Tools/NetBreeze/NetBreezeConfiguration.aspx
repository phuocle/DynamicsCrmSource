...
<div class="claims" tabindex="0">
<p><loc:text resourceid="Web.Tools.NetBreeze.Config.ProvisioningTemporaryError" runat="server" /></p>
</div>
</div>
</div>
...
<div tabindex="0"><loc:text resourceid="Web.Tools.NetBreeze.Config.OnPremiseInstanceSelection.Step1.Title" runat="server" /></div>
<div tabindex="0">
<loc:text resourceid="Web.Tools.NetBreeze.Config.OnPremiseInstanceSelection.Step1.Description" runat="server" />
</div>
<ol type="a">
<li tabindex="0" aria-labelledby="step1"><div role="row" id="step1"><loc:text resourceid="Web.Tools.NetBreeze.Config.OnPremiseInstanceSelection.ConfigureMSL.Step1" runat="server" /></div></li>
...
<li tabindex="0" aria-labelledby="step3"><div role="row" id="step3"><loc:text resourceid="Web.Tools.NetBreeze.Config.OnPremiseInstanceSelection.ConfigureMSL.Step3" runat="server" /></div></li>
<li tabindex="0" aria-labelledby="step4"><div role="row" id="step4"><loc:text resourceid="Web.Tools.NetBreeze.Config.OnPremiseInstanceSelection.ConfigureMSL.Step4" runat="server" /></div></li>
<li tabindex="0" aria-labelledby="step5"><div role="row" id="step5"><loc:text resourceid="Web.Tools.NetBreeze.Config.OnPremiseInstanceSelection.ConfigureMSL.Step5" runat="server" /></div></li>
</ol>
</li>
<li class="configurecrm">
<div tabindex="0"><loc:text resourceid="Web.Tools.NetBreeze.Config.OnPremiseInstanceSelection.Step2.Title" runat="server" /></div>
<table>
...
<label for="ConnectMslCheckBox"><loc:text resourceid="Web.Tools.NetBreeze.Config.OnPremiseInstanceSelection.ConnectToMSL.CheckBoxLabel" runat="server" /></label>
</td>
</tr>
...
<td>
<label for="MslUrlText"><loc:text resourceid="Web.Tools.NetBreeze.Config.OnPremiseInstanceSelection.EnterSolutionUrl" runat="server" /></label>
</td>
</tr>
...
<button id="mslUrlTestButton" class="basic-button" tabindex="0"><loc:text resourceid="Web.Tools.NetBreeze.Config.OnPremiseInstanceSelection.TestSolutionUrl" runat="server" /></button>
</td>
</tr>
...
<td>
<button id="mslUrlSaveButton" class="basic-button" tabindex="0"><loc:text resourceid="Web.Tools.NetBreeze.Config.OnPremiseInstanceSelection.SaveSolutionUrl" runat="server" /></button>
</td>
</tr>
