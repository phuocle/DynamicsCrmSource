...
<a href="{{html CrmEncodeDecode.CrmHtmlEncode(serverErrorHelpLinkBase)}}" target="_blank"><loc:Text Encoding='HtmlAttribute' ResourceId='Web.Tools.ViewEditor.viewmanager.aspx_98' runat='server'/></a>
{{/if}}
</div>
</div>
{{/if}}
