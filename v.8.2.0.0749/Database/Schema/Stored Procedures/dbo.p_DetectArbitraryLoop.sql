...
create procedure [dbo].[p_DetectArbitraryLoop](@parentid uniqueidentifier, @childid uniqueidentifier, @basetablename sysname, @pkattributename sysname, @fkattributename sysname, @fktypeidattributename sysname, @otc int) as
BEGIN
set nocount on
...
begin  
   ...
   begin  
      ...
      begin  
         if exists (select 1 from @visited where @currentparentid = visited)  
         begin  
