...
BEGIN
		 ...
		 SELECT @start = [BootstrapTargetPointer] FROM [RollupPropertiesBase]		 WHERE [RollupPropertiesId] = 'e10cdd44-5c7f-4ac8-a5d1-b2118926f2bd'
...
BEGIN
		 ...
		 FROM [RollupPropertiesBase] WHERE [RollupPropertiesId] = 'e10cdd44-5c7f-4ac8-a5d1-b2118926f2bd'
