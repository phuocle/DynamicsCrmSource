...
begin
	select @parentId = ParentSiteOrLocation, @objectTypeCode = ParentSiteOrLocationTypeCode , @relativeUrl = RelativeUrl , @absoluteLocationUrl = AbsoluteURL,
		@siteCollectionId = SiteCollectionId, @servicetype = ServiceType
	...
	begin
		...
		if(@isGridPresent = 1)
			begin
				select @absoluteUrl as 'AbsoluteURL', @siteCollectionUrl as 'SiteCollectionUrl' , @siteRelativeUrl as 'SiteRelativeUrl' , @servicetype as 'ServiceType'
				return
			end
		else
			begin
				select @absoluteUrl as 'AbsoluteURL', '' as 'SiteCollectionUrl' ,  @siteRelativeUrl as 'SiteRelativeUrl' , @servicetype as 'ServiceType'
				return
			end
	end
	...
	begin
		...
		begin
			select '' as 'AbsoluteURL', '' as 'SiteCollectionUrl' , '' as 'SiteRelativeUrl' , @servicetype as 'ServiceType'
		return
		end		
	end
...
begin
	...
	begin
		...
		begin
			...
			if(@isGridPresent = 1)
			begin
				select @absoluteUrl as 'AbsoluteURL', @absoluteSiteUrl as 'SiteCollectionUrl',@siteRelativeUrl as 'SiteRelativeUrl' , @servicetype as 'ServiceType'
				return
			end
		...
		begin
			select '' as 'AbsoluteUrl', '' as 'SiteCollectionUrl',@siteRelativeUrl as 'SiteRelativeUrl' , @servicetype as 'ServiceType'
			return
		end
	end
	else
