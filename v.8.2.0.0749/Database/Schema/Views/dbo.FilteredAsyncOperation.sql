...
(
	...
	(
		...
		[AsyncOperation].[OwningBusinessUnit] in (select BusinessUnitId from SystemUserBusinessUnitEntityMap WITH (NOLOCK) where SystemUserId = u.SystemUserId and ObjectTypeCode = 4700)
	) 
	or
	(
		-- global security
...
GO
GRANT SELECT ON  [dbo].[FilteredAsyncOperation] TO [CRMReaderRole]
GO
GRANT SELECT ON  [dbo].[FilteredAsyncOperation] TO [PHUOCLE\ReportingGroup {8ff092ff-6d16-41c8-aeb9-43e799050400}]
GO
