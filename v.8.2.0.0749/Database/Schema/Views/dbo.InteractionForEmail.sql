...
from [InteractionForEmailBase] 
    left join [SystemUserBase] [lk_interactionforemail_createdby] with(nolock) on ([InteractionForEmailBase].[CreatedBy] = [lk_interactionforemail_createdby].[SystemUserId])
    left join [SystemUserBase] [lk_interactionforemail_createdonbehalfby] with(nolock) on ([InteractionForEmailBase].[CreatedOnBehalfBy] = [lk_interactionforemail_createdonbehalfby].[SystemUserId])
    left join [SystemUserBase] [lk_interactionforemail_modifiedby] with(nolock) on ([InteractionForEmailBase].[ModifiedBy] = [lk_interactionforemail_modifiedby].[SystemUserId])
    left join [SystemUserBase] [lk_interactionforemail_modifiedonbehalfby] with(nolock) on ([InteractionForEmailBase].[ModifiedOnBehalfBy] = [lk_interactionforemail_modifiedonbehalfby].[SystemUserId])
    ...
    left join OwnerBase XXowner with(nolock) on ([InteractionForEmailBase].OwnerId = XXowner.OwnerId)
GO
