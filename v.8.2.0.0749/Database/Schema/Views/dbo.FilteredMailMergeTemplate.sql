...
(
	...
	[MailMergeTemplate].OwnerId in 
		(select OwnerId from [dbo].[fn_GetOwnerIdsForFilteredView](u.SystemUserId, 9106))
...
(
	...
	[MailMergeTemplate].[MailMergeTemplateId] in 
		(select ObjectId from [dbo].[fn_GetSharedRecordIdsForFilteredView](u.SystemUserId, 9106))
	)
)
GO
GRANT SELECT ON  [dbo].[FilteredMailMergeTemplate] TO [CRMReaderRole]
GO
GRANT SELECT ON  [dbo].[FilteredMailMergeTemplate] TO [PHUOCLE\ReportingGroup {8ff092ff-6d16-41c8-aeb9-43e799050400}]
GO
