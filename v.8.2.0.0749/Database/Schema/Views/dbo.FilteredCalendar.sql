...
(
	...
	(
		...
		[Calendar].[BusinessUnitId] in (select BusinessUnitId from SystemUserBusinessUnitEntityMap WITH (NOLOCK) where SystemUserId = u.SystemUserId and ObjectTypeCode = 4003)
	) 
	or
	(
		-- global security
...
GO
GRANT SELECT ON  [dbo].[FilteredCalendar] TO [CRMReaderRole]
GO
GRANT SELECT ON  [dbo].[FilteredCalendar] TO [PHUOCLE\ReportingGroup {8ff092ff-6d16-41c8-aeb9-43e799050400}]
GO
