...
from [KnowledgeArticleBase] 
    ...
    left join [SystemUserBase] [knowledgearticle_primaryauthorid] with(nolock) on ([KnowledgeArticleBase].[primaryauthorid] = [knowledgearticle_primaryauthorid].[SystemUserId])
    ...
    left join [SystemUserBase] [lk_knowledgearticle_createdby] with(nolock) on ([KnowledgeArticleBase].[CreatedBy] = [lk_knowledgearticle_createdby].[SystemUserId])
    left join [SystemUserBase] [lk_knowledgearticle_createdonbehalfby] with(nolock) on ([KnowledgeArticleBase].[CreatedOnBehalfBy] = [lk_knowledgearticle_createdonbehalfby].[SystemUserId])
    left join [SystemUserBase] [lk_knowledgearticle_modifiedby] with(nolock) on ([KnowledgeArticleBase].[ModifiedBy] = [lk_knowledgearticle_modifiedby].[SystemUserId])
    left join [SystemUserBase] [lk_knowledgearticle_modifiedonbehalfby] with(nolock) on ([KnowledgeArticleBase].[ModifiedOnBehalfBy] = [lk_knowledgearticle_modifiedonbehalfby].[SystemUserId])
    ...
    left join OwnerBase XXowner with(nolock) on ([KnowledgeArticleBase].OwnerId = XXowner.OwnerId)
GO
