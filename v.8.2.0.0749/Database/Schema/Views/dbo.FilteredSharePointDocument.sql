...
(
	...
	[SharePointDocument].OwnerId in 
		(select OwnerId from [dbo].[fn_GetOwnerIdsForFilteredView](u.SystemUserId, 9507))
...
(
	...
	[SharePointDocument].[SharePointDocumentId] in 
		(select ObjectId from [dbo].[fn_GetSharedRecordIdsForFilteredView](u.SystemUserId, 9507))
	)
)
GO
GRANT SELECT ON  [dbo].[FilteredSharePointDocument] TO [CRMReaderRole]
GO
GRANT SELECT ON  [dbo].[FilteredSharePointDocument] TO [PHUOCLE\ReportingGroup {8ff092ff-6d16-41c8-aeb9-43e799050400}]
GO
