...
(
	...
	[ImportFile].OwnerId in 
		(select OwnerId from [dbo].[fn_GetOwnerIdsForFilteredView](u.SystemUserId, 4412))
...
(
	...
	[ImportFile].[ImportFileId] in 
		(select ObjectId from [dbo].[fn_GetSharedRecordIdsForFilteredView](u.SystemUserId, 4412))
	)
)
GO
GRANT SELECT ON  [dbo].[FilteredImportFile] TO [CRMReaderRole]
GO
GRANT SELECT ON  [dbo].[FilteredImportFile] TO [PHUOCLE\ReportingGroup {8ff092ff-6d16-41c8-aeb9-43e799050400}]
GO
