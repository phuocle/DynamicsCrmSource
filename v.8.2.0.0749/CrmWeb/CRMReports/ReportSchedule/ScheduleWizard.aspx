...
<title>
    <loc:Text ResourceId="Title_Wizard" runat="server"/>
</title>
<script language="javascript">
    ...
    Sys.Application.add_load(function() {
        ...
        if (_iWizardType == WIZARD_TYPE_CREATE) {
            ...
            _sFirstSlide = (_iWizardObject == WIZARD_OBJECT_SCHEDULE)
                ? "spnUpdateScheduleFirst"
                : "spnUpdateSnapshotFirst";
        }
    ...
    function buildXml() {
        ...
        var returnFilter = !FilterEditor.get_isDisabled() &&
            (_iWizardType == WIZARD_TYPE_CREATE || _bIsDefaultFilterDirty);
    ...
    function preProcessSlide(slideName) {
        ...
        case "spnScheduleSummary":
            ...
            XUI.Html.SetText($get('spnScheduleSummaryDesc'),
            (_iWizardType == WIZARD_TYPE_CREATE ? LOCID_DESC_SCHED_CREATE_SUMMARY : LOCID_DESC_SCHED_UPDATE_SUMMARY
            ));


            XUI.Html.SetText($get('spnScheduleSummaryBaseReport'), _sReportBaseName);
            XUI.Html.SetText($get('spnScheduleSummaryScheduleName'),
                formatString(getReportCopySuffix(), _sReportBaseName));
            XUI.Html.SetText($get('spnScheduleSummaryFrequency'), frequencyControl.GetFrequencySummary());
            XUI.Html.SetText($get('spnScheduleSummaryStart'),
                formatString(LOCID_DATE_TIME_ORDER_FORMAT,
                    Mscrm.DateTimeUtility.formatDate(frequencyControl.get_startDate()),
                    timeToString(frequencyControl.get_startDate(), 0)));
            XUI.Html.SetText($get('spnScheduleSummaryEnd'),
                IsNull(frequencyControl.get_endDate())
                ? LOCID_LABEL_NO_END_DATE
                : Mscrm.DateTimeUtility.formatDate(frequencyControl.get_endDate()));
            ...
            XUI.Html
                .SetText(_btnNext, (_iWizardType == WIZARD_TYPE_CREATE) ? LOCID_BUTTON_CREATE : LOCID_BUTTON_UPDATE);
        ...
        case "spnSnapshotSummary":
            XUI.Html.SetText($get('spnReportCopyNameLabelSnapshotSummary'),
                formatString(getReportCopySuffix(), _sReportBaseName));
    ...
    function getReportCopySuffix() {
        ...
        var sCopySuffixFormat = (_iWizardObject == WIZARD_OBJECT_SCHEDULE
            ? LOCID_SCHEDULE_COPY_SUFFIX
            : LOCID_SNAPSHOT_COPY_SUFFIX);
    ...
    function submitWizardDone(oResult) {
        ...
        if (oResult.Success) {
            ...
            if (oResult.ReturnValue.Warnings.string != null) {
                ...
                var aResultWarnings = (typeof(oResult.ReturnValue.Warnings.string) == "string")
                    ? new Array(oResult.ReturnValue.Warnings.string)
                    : oResult.ReturnValue.Warnings.string;
...
<div>
    <table class="ReportName" width="99%">
        <tr valign="top">
            <td width="100%">
                <span id="spnReportName" class="ReportName"></span>
            </td>
        </tr>
    </table>
</div>
...
<div id="spnNewFirst" class="slide">
    ...
    <ul class="ms-crm-ReportScheduleList">
        <li>
            <loc:Text ResourceId="Desc_NewFirstItem2" runat="server"/>
        </li>
        <li>
            <loc:Text ResourceId="Desc_NewFirstItem1" runat="server"/>
        </li>
    </ul><br/>
    ...
    <table cellspacing="10" cellpadding="0">
        <tr>
            <td valign="top">
                <input type="radio" name="radNewFirstObject" id="roNewSnapshot" class="radio" checked>
            </td>
            <td>
                <label for="roNewSnapshot">
                    <loc:Text ResourceId="Label_CreateOneTimeSnapshot" runat="server"/>
                </label>
            </td>
        </tr>
        <tr>
            <td valign="top">
                <input type="radio" name="radNewFirstObject" id="roNewSchedule" class="radio">
            </td>
            <td>
                <label for="roNewSchedule">
                    <loc:Text ResourceId="Label_CreateSchedule" runat="server"/>
                </label>
            </td>
        </tr>
    </table>
...
<div id="spnDatesSlide" class="slide">
    <span id="spnDatesText">
        <loc:Text ResourceId="Desc_Dates" runat="server"/>
    </span>
    <span id="spnDateText" style="display: none">
        <loc:Text ResourceId="Desc_DateOnce" runat="server"/>
    </span>
        ...
        <tr>
            <td style="width: 75px">
                <span id="spnStartDate">
                    <loc:Text ResourceId="Label_StartDate" runat="server"/>
                </span>
                <span id="spnDate" style="display: none">
                    <label for="dtuiStart">
                        <loc:Text ResourceId="Label_Date" runat="server"/>
                    </label>
                </span>
            </td>
            <td style="padding-left: 80px;">
                <ui:DateTimeUI id="dtuiStart" runat="server" DisplayFormat="date"/>
            </td>
        </tr>
        <tr id="trEndDate">
            <td valign="top" style="width: 50px">
                <loc:Text ResourceId="Label_EndDate" runat="server"/>
            </td>
            <td>
                <table cellspacing="2" cellpadding="0" style="width: 200px;">
                    ...
                    <tr>
                        <td>
                            <input type="radio" name="radEndDate" id="roNoEndDate" class="radio" runat="server" onclick="toggleEndDateOptions()" checked>
                        </td>
                        <td colspan="2">
                            <label for="roNoEndDate">
                                <loc:Text ResourceId="Label_NoEndDate" runat="server"/>
                            </label>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <input type="radio" name="radEndDate" id="roEndDate" class="radio" onclick="toggleEndDateOptions()" runat="server">
                        </td>
                        <td>
                            <label for="roEndDate">
                                <loc:Text ResourceId="Label_EndOn" runat="server"/>
                            </label>
                        </td>
                        <td>
                            <label class="ms-crm-Hidden" for="dtuiEnd">
                                <loc:Text ResourceId="ReportScheduling.EndDate.label" runat="server"/>
                            </label><ui:DateTimeUI id="dtuiEnd" runat="server" DisplayFormat="date"/>
                        </td>
                    </tr>
                </table>
            </td>
...
<div id="spnScheduleSummary" class="slide">
    <table cellspacing="10" cellpadding="0">
        ...
        <tr valign="top">
            <td class="ScheduleWizard_td_Text">
                <loc:Text ResourceId="Label_ReportColon" runat="server"/>
            </td>
        ...
        <tr valign="top">
            <td class="ScheduleWizard_td_Text">
                <nobr>
                    <loc:Text ResourceId="Label_ScheduleName" runat="server"/>
                </nobr>
            </td>
        ...
        <tr valign="top">
            <td class="ScheduleWizard_td_Text">
                <loc:Text ResourceId="Label_Frequency" runat="server"/>
            </td>
            <td><span id="spnScheduleSummaryFrequency"></span><td>
        </tr>
        <tr valign="top">
            <td class="ScheduleWizard_td_Text">
                <loc:Text ResourceId="Label_Start" runat="server"/>
            </td>
            <td><span id="spnScheduleSummaryStart"></span><td>
        </tr>
        <tr valign="top">
            <td class="ScheduleWizard_td_Text">
                <loc:Text ResourceId="Label_End" runat="server"/>
            </td>
...
<div id="spnSnapshotSummary" class="slide">
    <table cellspacing="10" cellpadding="0">
        ...
        <tr valign="top">
            ...
            <td colspan="2">
                <nobr>
                    <loc:Text ResourceId="Label_SettingName" runat="server"/>
                </nobr>
            </td>
            <td>
                <span id="spnReportCopyNameLabelSnapshotSummary"></span>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td></td>
            <td valign="top">
                <input type="radio" name="radGenerateSnapshot" id="roGenerateSnapshotYes" class="radio" checked>
            </td>
            <td colspan="2"><label for="roGenerateSnapshotYes">
                <loc:Text ResourceId="Label_GenerateSnapshotYes" runat="server"/>
            </label><td>
        </tr>
        <tr>
            <td></td>
            <td valign="top">
                <input type="radio" name="radGenerateSnapshot" id="roGenerateSnapshotNo" class="radio">
            </td>
            <td colspan="2"><label for="roGenerateSnapshotNo">
                <loc:Text ResourceId="Label_GenerateSnapshotNo" runat="server"/>
            </label><td>
        </tr>
    </table><br><br>
...
<div id="spnSuccessFailure" class="slide">
    ...
    <span id="spnSuccessFailureExplanation" style="display: none;">
        <ul class="ms-crm-ReportScheduleList">
            <li>
                <loc:Text ResourceId="Desc_SnapshotOperationSuccess1" runat="server"/>
            </li>
            <li>
                <loc:Text ResourceId="Desc_SnapshotOperationSuccess2" runat="server"/>
            </li>
            <li>
                <loc:Text ResourceId="Desc_SnapshotOperationSuccess3" runat="server"/>
            </li>
        </ul>
    </span>
