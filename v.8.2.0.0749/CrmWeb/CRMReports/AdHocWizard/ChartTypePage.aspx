    ...
    <script language="javascript" type="text/javascript">
        ...
        function chartTypePage_onload() {
            ...
            if (!pieValueAxesAvailable()) {
                ...
                $find("notifications").AddNotification("pieChartUnavailable",
                    Mscrm.Severity.SEVERITYINFORMATION,
                    "",
                    LOCID_PIE_CHART_UNAVAILABLE);
            }
        }
...
<frm:WizardForm id="crmForm" runat="server">
    ...
    <ul>
        <li>
            ...
            <label for="typeColumn">
                <loc:Text ResourceId="CustomReporting.AdHocWizard.ChartTypePage.ColumnChart" runat="server"/>
            </label>
        </li>
        <li>
            ...
            <label for="typeBar">
                <loc:Text ResourceId="CustomReporting.AdHocWizard.ChartTypePage.BarChart" runat="server"/>
            </label>
        </li>
        <li>
            ...
            <label for="typeLine">
                <loc:Text ResourceId="CustomReporting.AdHocWizard.ChartTypePage.LineChart" runat="server"/>
            </label>
        </li>
        <li>
            ...
            <label for="typePie">
                <loc:Text ResourceId="CustomReporting.AdHocWizard.ChartTypePage.PieChart" runat="server"/>
            </label>
        </li>
    </ul>
</frm:WizardForm>
