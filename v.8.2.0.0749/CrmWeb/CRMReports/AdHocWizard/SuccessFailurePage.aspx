...
<frm:WizardForm id="crmForm" runat="server">
    ...
    <ul class="WelcomeSteps">
        <li>
            <loc:Text ResourceId="CustomReporting.AdHocWizard.SuccessFailurePage.List1" runat="server"/>
        </li>
        <li>
            <loc:Text ResourceId="CustomReporting.AdHocWizard.SuccessFailurePage.List2" runat="server"/>
        </li>
    </ul>
</frm:WizardForm>
</body>
