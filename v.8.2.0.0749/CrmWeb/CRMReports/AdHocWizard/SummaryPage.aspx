    ...
    <script language="javascript" type="text/javascript">
        ...
        function getNextPageUrl() {
            ...
            var oUrl = Mscrm.CrmUri.create("/CRMReports/AdHocWizard/SuccessFailurePage.aspx?" +
                <%= Microsoft.Crm.CrmEncodeDecode.CrmJavaScriptEncode(CurrentWrpcContext.GetWrpcTokenAsQueryString(Microsoft.Crm.Application.Utility.CrmUri.Create("/CRMReports/AdHocWizard/SuccessFailurePage.aspx", Microsoft.Crm.Application.Security.UserInformation.Current))) %>);
            ...
            oUrl.get_query()["id"] = (WizardGetProperty("WizardMode") == EDIT_MODE_UPDATE)
                ? WizardGetProperty("ReportId")
                : "";
...
<frm:WizardForm id="crmForm" runat="server">
    <table>
        ...
        <tr>
            <td>
                <loc:Text ResourceId="CustomReporting.AdHocWizard.ReportMetadataPage.ReportName" runat="server"/>
            </td>
            <td id="nameCell"></td>
        </tr>
        <tr id="descriptionRow">
            <td>
                <loc:Text ResourceId="CustomReporting.AdHocWizard.ReportMetadataPage.ReportDescription" runat="server"/>
            </td>
            <td id="descriptionCell"></td>
        </tr>
        <tr>
            <td>
                <loc:Text ResourceId="CustomReporting.AdHocWizard.ReportMetadataPage.PrimaryEntity" runat="server"/>
            </td>
            <td id="primaryEntityCell"></td>
        </tr>
        <tr id="secondaryEntityRow">
            <td>
                <loc:Text ResourceId="CustomReporting.AdHocWizard.ReportMetadataPage.SecondaryEntity" runat="server"/>
            </td>
