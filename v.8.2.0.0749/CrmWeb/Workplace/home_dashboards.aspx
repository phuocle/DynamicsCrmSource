...
<head>
    ...
    <style>
        ...
        #dashboardFrameRow { margin-top: 4px; }
        ...
        .dashboard-brdr { border: 1px solid; }
        ...
        img.ms-crm-View-icon { margin-top: 1px; }

        .ms-crm-Dashboard-Body { position: relative; }
        ...
        .ms-crm-InlineTabHeaderExpander a { display: none; }
            ...
            <div style="height: 100%" class="ms-crm-absolutePosition">
                <table class="ms-crm-Form-Dashboard" style="height: 100%; width: 100%">
                    <tr>
                        <td align="center">
                            <div>
                                <loc:Text ResourceId="Dashboards_Not_Available" runat="server"/>
                            </div>
                        </td>
                    </tr>
                </table>
