...
function registerNodeTypes(oTree) {
    ...
    oTree.RegisterNodeType("constraintbasedgroup",
        "/_imgs/ico_16_4007.gif",
        "/_imgs/ico_16_4007.gif",
        "/_imgs/ico_16_4007.gif",
        "ua_label",
        "description");
    oTree.RegisterNodeType("team",
        "/_imgs/ico_16_9.gif",
        "/_imgs/ico_16_9.gif",
        "/_imgs/ico_16_9.gif",
        "ua_label",
...
function setUaLabels(oTree) {
    for (var oXml = oTree.get_xmlNode(),
        ...
        oCData = oXml.ownerDocument
            .createCDATASection(getRuleDisplayText(bHasParent, iQuantity, sObjective, bSameSite));
        oCData != null &&
