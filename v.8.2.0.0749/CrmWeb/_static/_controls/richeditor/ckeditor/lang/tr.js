...
CKEDITOR.lang['tr'] = {
    ...
    table:
    {
        ...
        cell:
        {
            ...
            mergeRight: 'Birleştir - Sağdakiyle',
            mergeDown: 'Birleştir - Aşağıdakiyle',
            splitHorizontal: 'Hücreyi Yatay Böl',
            splitVertical: 'Hücreyi Dikey Böl',
            title: 'Hücre Özellikleri',
            cellType: 'Hücre Türü',
            rowSpan: 'Satır Sayısı',
            colSpan: 'Sütün Sayısı',
            ...
            invalidRowSpan: 'Satır sayısı tam sayı olmalıdır.',
            invalidColSpan: 'Sütun sayısı tam sayı olmalıdır.',
            chooseColor: 'Seçin'
        },
        ...
        {
            menu: 'Sütun',
            insertBefore: 'Sütun Ekle - Önce',
            insertAfter: 'Sütun Ekle - Sonra',
        ...
        invalidBorder: 'Kenarlık boyutu sayı olmalıdır.',
        invalidCellPadding: 'Hücre doldurma pozitif sayı olmalıdır.',
        invalidCellSpacing: 'Hücre aralığı pozitif sayı olmalıdır.',
        invalidCols: 'Sütun sayısı 0\'dan büyük olmalıdır.',
        invalidHeight: 'Tablo yüksekliği sayı olmalıdır.',
        invalidRows: 'Satır sayısı 0\'dan büyük olmalıdır.',
    ...
    {
        confirmCleanup:
            'Yapıştırmaya çalıştığınız metnin Word\'den kopyalandığı anlaşılıyor. Yapıştırmadan önce temizlemek ister misiniz?',
        error: 'Yapıştırılan veri dahili bir hata nedeniyle temizlenemedi',
    ...
    link:
    {
        ...
        advanced: 'Gelişmiş',
        advisoryContentType: 'Öneri İçerik Türü',
        advisoryTitle: 'Öneri Başlığı',
        anchor:
        {
            toolbar: 'Bağlayıcı',
            menu: 'Bağlayıcıyı Düzenle',
            title: 'Bağlayıcı Özellikleri',
            name: 'Bağlayıcı Adı',
            errorName: 'Lütfen bağlayıcı adını yazın',
            remove: 'Bağlayıcıyı Kaldır'
        },
        anchorId: 'Öğe Kimliğine Göre',
        anchorName: 'Bağlayıcı Adına Göre',
        charset: 'Bağlantılı Kaynak Karakter Kümesi',
        ...
        name: 'Ad',
        noAnchors: '(Belgede hiç bağlayıcı yok)',
        ...
        title: 'Bağlantı',
        toAnchor: 'Metindeki bağlayıcıya bağlantı',
        toEmail: 'E-posta',
        toUrl: 'URL',
        toolbar: 'Bağlantı',
        type: 'Bağlantı Türü',
    ...
    image:
    {
        ...
        hSpace: 'HSpace',
        img2Button: 'Seçili resmi bir resim düğmesine dönüştürmek istiyor musunuz?',
        ...
        upload: 'Karşıya Yükle',
        urlMissing: 'Resim kaynağı URL\'si eksik.',
        vSpace: 'VSpace',
        validateBorder: 'Kenarlık tam sayı olmalıdır.',
    ...
    embedmedia:
    {
        ...
        title: 'Medya Ekle',
        button: 'Medya Ekle',
        mediaHtml: 'Medya HTML\'si',
        unacceptedContent: '(Tüm &lt;script&gt; ve &lt;style&gt; etiketleri kaldırılacak)'
    },
    div:
    {
        IdInputLabel: 'Kimlik',
    ...
    clipboard:
    {
        copy: 'Kopyala',
        copyError:
            'Tarayıcınızın güvenlik ayarları, düzenleyicinin otomatik kopyalama işlemleri yapmasına izin vermiyor. İşlem için lütfen Ctrl/Cmd+C tuşlarını kullanın.',
        cut: 'Kes',
        cutError:
            'Tarayıcınızın güvenlik ayarları, düzenleyicinin otomatik kesme işlemleri yapmasına izin vermiyor. İşlem için lütfen Ctrl/Cmd+X tuşlarını kullanın.',
        paste: 'Yapıştır',
        pasteArea: 'Yapıştırma Alanı',
        pasteMsg:
            'Lütfen klavyeyi kullanarak (<strong>Ctrl/Cmd+V</strong>) aşağıdaki kutunun içine yapıştırın ve Tamam\'a tıklayın.',
        securityMsg:
            'Tarayıcınızın güvenlik ayarları nedeniyle, düzenleyici, pano verilerinize doğrudan erişemiyor. Bu pencere içine yeniden yapıştırmalısınız.',
        title: 'Yapıştır'
    },
    button:
    {
        selectedLabel: '%1 (Seçilen)'
    },
    blockquote:
    {
        toolbar: 'Alıntı Bloğu'
    },
    basicstyles:
    {
        bold: 'Kalın',
    ...
    common:
    {
        editorHelp: 'Yardım için ALT ve 0 tuşlarına basın',
        ...
        invalidCssLength:
            '"%1" alanı için belirtilen değer, geçerli bir CSS ölçü birimi (px, %, in, cm, mm, em, ex, pt, pc) olsun olmasın, pozitif bir sayı olmalıdır.',
        invalidHtmlLength:
            '"%1" alanı için belirttiğiniz değer, geçerli bir HTML ölçü birimi (px veya %) olsun olmasın, pozitif bir sayı olmalıdır.',
        invalidInlineStyle:
            'Satır içi stil için belirtilen değer, "ad : değer" biçiminde, birbirinden noktalı virgüllerle ayrılan bir veya daha fazla kayıt düzeninden oluşmalıdır.',
        cssLengthTooltip:
            'Piksel türünde bir değer veya geçerli bir CSS ölçü birimi (px, %, in, cm, mm, em, ex, pt, pc) içeren bir sayı girin.',
        unavailable: '%1<span class="cke_accessibility">, kullanılamaz</span>',
        invalidURL: 'URL geçerli bir web adresi olmalıdır.'
    },
    langSizing:
    {
