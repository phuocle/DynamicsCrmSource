        ...
        var switchLockRatio = function(dialog, value) {
            ...
            if (value == 'check') {
                if (!dialog.userlockRatio && oImageOriginal.getCustomData('isReady') == 'true') {
                    var width = Number.parseInt(dialog.getValueOf('info', 'txtWidth')),
                        height = Number.parseInt(dialog.getValueOf('info', 'txtHeight')),
                        originalWidth = oImageOriginal.$.width,
                        originalHeight = oImageOriginal.$.height,
                        expectedWidth = Math.round(originalWidth * (height / originalHeight)),
                        expectedHeight = Math.round(originalHeight * (width / originalWidth));
                                    ...
                                    children: [
                                        {
                                            ...
                                            setup: function(type, element) {
                                                if (type == IMAGE) {
                                                    ...
                                                    field
                                                        .setValue(CrmEncodeDecode.CrmNameValueDecode(url));
// And call this.onChange()
                                            ...
                                            validate: CKEDITOR.dialog.validate.imageUrl(editor.lang.common.invalidURL)
                                        },
                                        {
                                            type: 'button',
                                            id: 'browse',
                                            ...
                                            children: [
                                                {
                                                    ...
                                                    validate: CKEDITOR.dialog.validate
                                                        .integer(editor.lang.image.validateBorder),
                                                    setup: function(type, element) {
                                                        if (type == IMAGE) {
                                                            var value,
                                                ...
                                                },
                                                {
                                                    ...
                                                    validate: CKEDITOR.dialog.validate
                                                        .integer(editor.lang.image.validateHSpace),
                                                    setup: function(type, element) {
                                                        if (type == IMAGE) {
                                                            var value,
                                                                marginLeftPx,
                                                            ...
                                                            marginLeftStyle =
                                                                marginLeftStyle && marginLeftStyle.match(pxLengthRegex);
                                                            marginRightStyle =
                                                                marginRightStyle &&
                                                ...
                                                },
                                                {
                                                    ...
                                                    validate: CKEDITOR.dialog.validate
                                                        .integer(editor.lang.image.validateVSpace),
                                                    setup: function(type, element) {
                                                        if (type == IMAGE) {
                                                            var value,
                                                                marginTopPx,
                                                            ...
                                                            marginTopStyle =
                                                                marginTopStyle && marginTopStyle.match(pxLengthRegex);
                                                            marginBottomStyle =
                                                                marginBottomStyle &&
                                                ...
                                                },
                                                {
                                                    ...
                                                    setup: function(type, element) {
                                                        if (type == IMAGE) {
                                                            ...
                                                            !value &&
                                                            (value = (element.getAttribute('align') || '')
                                                                .toLowerCase());
                                                            this.setValue(value);
                                                        }
                                                    },
                    ...
                    elements: [
                        {
                            ...
                            setup: function(type, element) {
                                if (type == LINK) {
                                    ...
                                    this.setValue(CrmEncodeDecode.CrmNameValueDecode(href));
                                }
                            },
                            commit: function(type, element) {
                                if (type == LINK) {
                            ...
                            children: [
                                {
                                    type: 'html',
                                    id: 'htmlPreview',
                                    className: 'cke_dialog_ui_vbox_child_html_preview',
                                    html:
                                        '<div class="cke_dialog_ui_vbox_child_html_preview_container"><div class="cke_dialog_ui_vbox_child_html_preview_label">' +
