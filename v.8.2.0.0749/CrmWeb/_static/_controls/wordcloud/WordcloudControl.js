...
var WordCloudControl = React.createClass({
    ...
    renderWords: function(data) {
        ...
        return data.map(function(word, i) {
            ...
            return React.DOM.span({
                    className: className,
                    onClick: _this.handleWordClick.bind(_this, word),
                    style: currentStyle,
                    title: word.tooltip
                },
                word.text)
    ...
    update: function() {
        ...
        this.wordCloudData = new Wordcloud(document.getElementsByClassName(this.props.parentClass)[0],
            words,
            this.props.colors);
    ...
    render: function() {
        if (this.state.loaded)
            return React.DOM.div({ className: this.props.parentClass + " wordcloud-container" },
                this.renderWords(this.state.series));
        else
