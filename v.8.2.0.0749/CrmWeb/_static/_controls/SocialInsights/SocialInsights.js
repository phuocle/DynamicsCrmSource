...
Mscrm.Lazy$1 = function(generator) {
    this.$31_0 = ((this.$$gta['Mscrm.Lazy$1']['T'] === Number || Type.isEnum(this.$$gta['Mscrm.Lazy$1']['T']))
        ? 0
        : (this.$$gta['Mscrm.Lazy$1']['T'] === Boolean) ? false : null);
    if (IsNull(generator)) {
...
Mscrm.SocialInsights.SocialInsightsConfigurationService.prototype = {
    ...
    retrieve: function(configuration) {
        ...
        var $v_2 = jQueryApi.jQueryDeferredFactory.Deferred(Microsoft.Crm.Core.Application.WebServices
...
Mscrm.SocialInsights.Common.DependencyInstanceContainer.get_urlServiceInstance = function() {
    if (IsNull(Mscrm.SocialInsights.Common.DependencyInstanceContainer.$1p)) {
        Mscrm.SocialInsights.Common.DependencyInstanceContainer.$1p = new Mscrm.SocialInsights.Runtime.Services
            .UrlService();
    }
...
Mscrm.SocialInsights.Views.SpinnerView.prototype = {
    show: function() {
        ...
        if (IsNull(this.$1I_2)) {
            this.$1I_2 = new Mscrm.SocialInsights.Common.Views
                .KeepFocusBehavior(this.get_uiElement()[0], this.get_uiElement()[0], this.get_uiElement()[0]);
            var $$t_0 = this;
...
Mscrm.SocialInsights.Views.ChooseTopicTypeView.prototype = {
    ...
    $3C_3: function($p0, $p1) {
        ...
        this.keepFocus.$u_1 = ($v_0)
            ? this.get_uiElement().find('#buttonNext')[0]
            : this.get_uiElement().find('#buttonSettings')[0];
    },
...
Mscrm.SocialInsights.Views.MslSignInView.prototype = {
    ...
    $5i_3: function($p0) {
        Mscrm.SocialInsights.Configuration.Views.WizardPageHandler
            .showSpinner(Xrm.Internal.getResourceString('LOCID_NETBREEZE_SPINNER_SIGNIN'));
        this.$S_3 = Mscrm.SocialInsights.Shared.SignInUtility.maxSignInChecks;
        this.$3S_3();
    },
...
Mscrm.SocialInsights.Views.SearchTopicItemsListView.prototype = {
    ...
    initialize: function() {
        ...
        if (!this.$0_2.get_itemCount()) {
            var $v_0 = String.format(Xrm.Internal.getResourceString('LOCID_NETBREEZE_NO_TOPICS'),
                Xrm.Internal.getResourceString('LOCID_NETBREEZE_TOPIC'));
    ...
    $62_2: function($p0) {
        ...
        if (Object.getType($p0) !== Mscrm.SocialInsights.ViewModels.SearchTopicItemViewModel) {
            throw Error.argumentType('viewModel',
                Object.getType($p0),
                Mscrm.SocialInsights.ViewModels.SearchTopicItemViewModel);
        }
...
Mscrm.SocialInsights.Views.CreateTopicView.prototype = {
    ...
    handleNextForCreate: function(e) {
        ...
        var $v_2 = !isNullOrEmptyString(this.$1L_2.val()) &&
            !isNullOrEmptyString(this.$1J_2.val()) &&
            !isNullOrEmptyString(this.$w_2.val());
        if (!$v_0 || $v_2) {
            $v_1 = true;
        }
    ...
    $5k_2: function($p0) {
        ...
        for (var $$arr_1 = $p0, $$len_2 = $$arr_1.length, $$idx_3 = 0; $$idx_3 < $$len_2; ++$$idx_3) {
            var $v_0 = $$arr_1[$$idx_3];
            this.$w_2.append(String.format('<option value=\'{0}\'>{1}</option>',
                CrmEncodeDecode.CrmHtmlAttributeEncode($v_0.id),
                CrmEncodeDecode.CrmHtmlEncode($v_0.name)));
        }
    },
    ...
    LaunchNetBreeze: function(result) {
        ...
        window.open(Mscrm.SocialInsights.Runtime.Services.UrlService
            .getAdvancedSetupLink(this.$4_2.get_searchItem().id));
...
Mscrm.SocialInsights.Views.WidgetListEditorView.prototype = {
    ...
    $6P_2: function($p0) {
        ...
        if (IsNull($v_0)) {
            throw Error.argumentType('viewModel',
                Object.getType($p0),
                Mscrm.SocialInsights.ViewModels.WidgetTypeViewModel);
        }
...
Mscrm.SocialInsights.Configuration.AdvancedSettingsHandler.showAdvancedSettings = function() {
    ...
    var $v_1 = Mscrm.CrmUri.create('/Tools/FormEditor/Dialogs/SocialInsight.aspx?mode=' +
        $v_0.mode +
        '&datatype=iframe&editorType=dashboardEditor&scrolling=auto');
    var $v_2 = new Xrm.DialogOptions();
    $v_2.height = 660;
    $v_2.width = 470;
    var $v_3 = Mscrm.SocialInsights.SocialInsightUtility
        .createCallbackFunctionFactory(Mscrm.SocialInsights.Configuration.AdvancedSettingsHandler.getUpdatedField, []);
...
Mscrm.SocialInsights.Configuration.SelectSearchTopicCategoryHandler = function($p0) {
    ...
    this.checkSignInAndInitialize(this.$$d_$5I_3,
        '/SocialInsight/ConfigurationWizard/SelectSearchTopicCategoryPage.aspx');
}
...
Mscrm.SocialInsights.Configuration.SelectSearchTopicCategoryHandler.prototype = {
    ...
    $3h_3: function($p0) {
        this.$36_3.text(String.format(Xrm.Internal
            .getResourceString('LOCID_NETBREEZE_CONTAINS_TOPICS'),
            $p0.toString()));
    ...
    $5O_3: function() {
        ...
        Mscrm.SocialInsights.Runtime.Services.AjaxService.makeRequest(0, $v_0, null).done(this.$$d_$4n_3)
            .fail(this.$$d_$4z_3);
    },
...
Mscrm.SocialInsights.Configuration.Models.NetBreezeDataItemType
    .registerEnum('Mscrm.SocialInsights.Configuration.Models.NetBreezeDataItemType', false);
...
Mscrm.SocialInsights.ViewModels.SearchTopicItemViewModel.getSearchItem = function(itemID) {
    var $v_0 = jQueryApi.jQueryDeferredFactory.Deferred(Mscrm.SocialInsights.ViewModels.SearchTopicItemViewModel,
        String);
...
Mscrm.SocialInsights.ViewModels.SearchTopicItemViewModel.getSearchItems = function() {
    ...
    Mscrm.SocialInsights.Runtime.Services.AjaxService
        .makeRequest(0, Mscrm.SocialInsights.Runtime.Services.UrlService.getSearchItemsUrl(), null)
        .done(function($p1_0) {
            var $v_1 = new Array(0);
            var $v_2 = $p1_0;
...
Mscrm.SocialInsights.ViewModels.CreateTopicViewModel.$60 = function($p0, $p1) {
    ...
    Mscrm.SocialInsights.Runtime.Services.AjaxService
        .makeRequest(($v_0) ? 1 : 2,
            ($v_0)
            ? Mscrm.SocialInsights.Runtime.Services.UrlService.getCreateOrEditSearchItemsUrl()
            : Mscrm.SocialInsights.Runtime.Services.UrlService.getEditSearchItemUrl($p0.id),
            JSON.stringify($v_1),
            Mscrm.SocialInsights.ViewModels.CreateTopicViewModel.$x).done(function($p1_0) {
            var $v_2 = $p1_0;
...
Mscrm.SocialInsights.ViewModels.CreateTopicViewModel.prototype = {
    ...
    $6L_0: function($p0) {
        ...
        Mscrm.SocialInsights.Runtime.Services.AjaxService
            .makeRequest(1,
                Mscrm.SocialInsights.Runtime.Services.UrlService.getSearchQueriesUrl(),
                JSON.stringify(this.$N_0.searchQuerySet[0]),
                Mscrm.SocialInsights.ViewModels.CreateTopicViewModel.$x).done(function($p1_0) {
                var $v_3 = $p1_0;
    ...
    $5m_0: function() {
        var $$t_2 = this, $$t_3 = this;
        Mscrm.SocialInsights.Runtime.Services.AjaxService
            .makeRequest(0, Mscrm.SocialInsights.Runtime.Services.UrlService.getCategoriesUrl(), null)
            .done(function($p1_0) {
    ...
    $5n_0: function() {
        var $$t_2 = this, $$t_3 = this;
        Mscrm.SocialInsights.Runtime.Services.AjaxService
            .makeRequest(0, Mscrm.SocialInsights.Runtime.Services.UrlService.getNetBreezeDefaultsUrl(), null)
            .done(function($p1_0) {
...
Mscrm.SocialInsights.ViewModels.WidgetTypeViewModel.getWidgetTypes = function(isCategory) {
    var $v_0 = jQueryApi.jQueryDeferredFactory.Deferred(Array, String);
    Mscrm.SocialInsights.Runtime.Services.AjaxService
        .makeRequest(0, Mscrm.SocialInsights.Runtime.Services.UrlService.getAllWidgetsUrl(), null)
        .done(function($p1_0) {
            var $v_1 = $p1_0;
            var $v_2 = new Array(0);
...
Mscrm.SocialInsights.ViewModels.WidgetTypeViewModel
    .fromControlParameters = function(currentSocialDataParameters, supportedTypes) {
        var $v_0 = [];
        ...
        for (var $$arr_8 = currentSocialDataParameters.split('-'), $$len_9 = $$arr_8.length, $$idx_A = 0;
            $$idx_A < $$len_9;
            ++$$idx_A) {
            var $v_3 = $$arr_8[$$idx_A];
            var $v_4 = $v_1[$v_3];
...
Mscrm.SocialInsights.ViewModels.WidgetTypeViewModel
    .hasUnsupportedWidgets = function(currentSocialDataParameters, supportedTypes) {
        if (isNullOrEmptyString(currentSocialDataParameters)) {
            return false;
        }
        var $v_0 = {};
        ...
        for (var $$arr_7 = currentSocialDataParameters.split('-'), $$len_8 = $$arr_7.length, $$idx_9 = 0;
            $$idx_9 < $$len_8;
            ++$$idx_9) {
            var $v_2 = $$arr_7[$$idx_9];
            var $v_3 = $v_0[$v_2];
...
Mscrm.SocialInsights.ViewModels.WidgetTypeViewModel.$4f = function($p0) {
    ...
    return new Mscrm.SocialInsights.ViewModels
        .WidgetTypeViewModel(new Mscrm.SocialInsights.Models
            .WidgetType($p0.key, $p0.title, $v_0, $p0.description, $p0.restriction));
}
...
Mscrm.SocialInsights.Configuration.Views.SocialInsightsWizardStartPage
    .registerEnum('Mscrm.SocialInsights.Configuration.Views.SocialInsightsWizardStartPage', false);
...
Mscrm.SocialInsights.Configuration.Views.SearchTopicPageView.prototype = {
    ...
    wizardNavigate: function(navigationTarget) {
        ...
        Mscrm.SocialInsights.Configuration.Views.WizardPageHandler.prototype.wizardNavigate
            .call(this, navigationTarget);
    },

    save: function() {
        if (Mscrm.SocialInsights.Configuration.Views.WizardPageHandler.get_wasShowingTopicEditor() &&
            (!IsNull(this.get_editSearchItemAllowed()) && this.get_editSearchItemAllowed())) {
    ...
    $4y_3: function($p0) {
        ...
        Mscrm.SocialInsights.Configuration.Views.WizardPageHandler.prototype.wizardNavigate
            .call(this, _WizardNavigateEnum.NEXT);
    },
    ...
    $48_3: function($p0) {
        ...
        if (!this.$Q_3.$2V_2) {
            var $$t_2 = this;
            this.$Q_3.initialize((Mscrm.SocialInsights.Configuration.Views.WizardPageHandler
                    .get_editExistingSearchItem())
                ? this.get_baseConfiguration().SocialDataItemId
                : null).fail(function($p1_0) {
                $$t_2.$4A_3(null);
    ...
    $5P_3: function() {
        Mscrm.SocialInsights.ViewModels.SearchTopicItemViewModel.getSearchItems().done(this.$$d_$4o_3)
            .fail(this.$$d_$5t_3).always(this.$$d_$3i_3);
    },
...
Mscrm.SocialInsights.Configuration.Views.VisualizationsPageView.get_hasSkippedOtherPages = function() {
    if (Mscrm.SocialInsights.Configuration.Views.WizardPageHandler.get_wizardPageToShow() === 4 &&
        IsNull(WizardGetProperty('wasShowingTopicEditor'))) {
        return true;
    }
    return false;
}
...
Mscrm.SocialInsights.Configuration.Views.VisualizationsPageView.prototype = {
    $5J_3: function() {
        ...
        Mscrm.SocialInsights.Configuration.Views.WizardPageHandler.showSpinner();
        Mscrm.SocialInsights.ViewModels.WidgetTypeViewModel.getWidgetTypes($v_0).done(this.$$d_$3k_3)
            .fail(this.$$d_$6M_3);
        if ($v_0) {
            ...
            if (!Mscrm.SocialInsights.Configuration.Views.WizardPageHandler.get_wasShowingTopicEditor()) {
                Mscrm.SocialInsights.ViewModels.SearchTopicItemViewModel.getSearchItem(this.get_currentDataItemId())
                    .done(this.$$d_$5N_3);
            } else if (Mscrm.SocialInsights.Configuration.Views.VisualizationsPageView.get_hasSkippedOtherPages() ||
                (!IsNull(this.get_editSearchItemAllowed()) && !this.get_editSearchItemAllowed())) {
                Mscrm.SocialInsights.ViewModels.SearchTopicItemViewModel
                    .getSearchItem(this.get_baseConfiguration().SocialDataItemId).done(this.$$d_$5N_3);
                this.set_currentDataItemId(this.get_baseConfiguration().SocialDataItemId);
            } else {
                this.$3F_3((IsNull(Mscrm.SocialInsights.Configuration.Views.WizardPageHandler.get_proposedSearchItem()
                        .name))
                    ? ''
                    : Mscrm.SocialInsights.Configuration.Views.WizardPageHandler.get_proposedSearchItem().name);
            }
        }
    },
    ...
    save: function() {
        ...
        this.set_currentSocialDataParameters(Mscrm.SocialInsights.ViewModels.WidgetTypeViewModel
            .toControlParameters($v_0));
        return true;
    },
    ...
    saveAndClose: function() {
        ...
        this.save();
        Mscrm.SocialInsights.Configuration.Views.WizardPageHandler
            .showSpinner(Xrm.Internal.getResourceString('LOCID_NETBREEZE_SAVING_WIDGETS'));
        if (!Mscrm.SocialInsights.Configuration.Views.VisualizationsPageView.get_hasSkippedOtherPages() &&
            Mscrm.SocialInsights.Configuration.Views.WizardPageHandler.get_wasShowingTopicEditor() &&
            this.get_currentDataItemType() === 1 &&
            (!IsNull(this.get_editSearchItemAllowed()) && this.get_editSearchItemAllowed())) {
            Mscrm.CrmDebug.assert(!IsNull(Mscrm.SocialInsights.Configuration.Views.WizardPageHandler
                    .get_proposedSearchItem()),
                'expected proposed search item to be saved but was null');
            Mscrm.SocialInsights.ViewModels.CreateTopicViewModel
                .saveTopic(Mscrm.SocialInsights.Configuration.Views.WizardPageHandler.get_proposedSearchItem())
                .done(this.$$d_$5g_3).fail(this.$$d_$5V_3);
        } else {
            this.$3x_3();
        }
    },
    ...
    $3x_3: function() {
        this.$E_3.hideVisualNotFoundMessage();
        this.$b_3 = Mscrm.SocialInsights.Configuration.Views.WizardPageHandler
            .cloneSocialInsightsConfiguration(this.get_baseConfiguration());
    ...
    $3k_3: function($p0) {
        ...
        this.$E_3.initialize();
        var $v_0 = Mscrm.SocialInsights.ViewModels.WidgetTypeViewModel
            .fromControlParameters(this.get_currentSocialDataParameters(), $p0);
        ...
        Mscrm.SocialInsights.Configuration.Views.WizardPageHandler.hideSpinner();
        if (Mscrm.SocialInsights.ViewModels.WidgetTypeViewModel
            .hasUnsupportedWidgets(this.get_currentSocialDataParameters(), $p0)) {
...
Mscrm.SocialInsights.Configuration.Views.WizardPageHandler.shouldSkipPage = function(currentPage) {
    return !(!Mscrm.SocialInsights.Configuration.Views.WizardPageHandler.get_wizardPageToShow() ||
        Mscrm.SocialInsights.Configuration.Views.WizardPageHandler.get_wizardPageToShow() === currentPage);
}
...
Mscrm.SocialInsights.Configuration.Views.WizardPageHandler.showSpinner = function(actionString) {
    if (IsNull(Mscrm.SocialInsights.Configuration.Views.WizardPageHandler.$8)) {
        Mscrm.SocialInsights.Configuration.Views.WizardPageHandler.$8 = Mscrm.SocialInsights.Views.SpinnerView
            .createNetBreezeDefault();
...
Mscrm.SocialInsights.Configuration.Views.WizardPageHandler.$4O = function() {
    if (window.parent.parent.$P_CRM('#InlineDialog').height() !==
        Mscrm.SocialInsights.Shared.SocialInsightsConstants.get_wizardHeight()) {
        return;
    }
...
Mscrm.SocialInsights.Configuration.Views.WizardPageHandler.prototype = {
    checkSignInAndInitialize: function(InitializePage, navigateBackUrl) {
        if (Xrm.Page.context.isCrmOnline()) {
            ...
            if (Mscrm.SocialInsights.Configuration.Views.WizardPageHandler.get_signInAutoNavigate() &&
                Mscrm.SocialInsights.Configuration.Views.WizardPageHandler.get_signedIn()) {
    ...
    get_currentDataItemId: function() {
        ...
        var $v_1 = $v_0[Mscrm.SocialInsights.Configuration.Models.NetBreezeDataItemType
            .toString(this.get_currentDataItemType())];
        if (!IsNull($v_1)) {
            return $v_1;
    ...
    set_currentDataItemId: function(value) {
        ...
        $v_0[Mscrm.SocialInsights.Configuration.Models.NetBreezeDataItemType
            .toString(this.get_currentDataItemType())] = value;
    ...
    $54_2: function() {
        if (this.get_launchedFromRuntimeControl() &&
            this.get_baseConfiguration().SocialDataItemType &&
            isNullOrEmptyString(this.get_baseConfiguration().SocialInsightsConfigurationId)) {
            this.$3v_2();
        }
    },
    ...
    $5G_2: function() {
        if (IsNull(Mscrm.SocialInsights.Configuration.Views.WizardPageHandler.get_wizardPageToShow())) {
            Mscrm.SocialInsights.Configuration.Views.WizardPageHandler
                .set_wizardPageToShow(window.inlineDialogArguments.passedArguments.wizardPageToShow);
        }
        Mscrm.SocialInsights.Configuration.Views.WizardPageHandler
            .set_editExistingSearchItem((this.get_baseConfiguration().SocialDataItemType === 1));
    ...
    $5C_2: function() {
        if (IsNull(this.get_baseConfiguration())) {
            this.set_baseConfiguration(Mscrm.SocialInsights.Configuration.Views.WizardPageHandler
                .cloneSocialInsightsConfiguration(window.inlineDialogArguments.passedArguments
                    .socialInsightsConfiguration));
            if (IsNull(this.get_baseConfiguration())) {
                this.set_baseConfiguration(new Microsoft.Crm.Core.Application.WebServices
                    .SocialInsightsConfiguration());
    ...
    $3v_2: function() {
        return new Mscrm.SocialInsights.SocialInsightsConfigurationService().retrieve(this.get_baseConfiguration())
            .done(this.$$d_$5W_2);
    },
...
Mscrm.SocialInsights.Provisioning.NetBreezeConfigurationHandler = function($p0) {
    this.$$d_applyNewNetBreezeInstanceForOnPrem = Function
        .createDelegate(this, this.applyNewNetBreezeInstanceForOnPrem);
    ...
    if (Xrm.Page.context.isCrmOnline()) {
        ...
        Mscrm.SocialInsights.Provisioning.NetBreezeConfigurationHandler.$i = new Mscrm.SocialInsights.Provisioning
            .NetBreezeOnPremiseConfigurationHandler($p0, this);
    }
    this.$L_2();
...
Mscrm.SocialInsights.Provisioning.NetBreezeConfigurationHandler.run = function() {
    ...
    Mscrm.SocialInsights.Provisioning.NetBreezeConfigurationHandler.$1Z = new Mscrm.SocialInsights.Provisioning
        .NetBreezeConfigurationHandler($P_CRM(document));
...
Mscrm.SocialInsights.Provisioning.NetBreezeConfigurationHandler.prototype = {
    ...
    $4Z_2: function($p0) {
        ...
        this.$1G_2();
        var $v_0 = this.$Y_2.val();
        Mscrm.CrmDebug.assert(this.get_$z_2() !== $v_0,
            'Current instance and changed instance should not be same. Select should have been disabled.');
...
Mscrm.SocialInsights.Provisioning.NetBreezeOnPremiseConfigurationHandler.prototype = {
    ...
    $4F_2: function($p0) {
        var $v_0 = this.$3_2.val().trim();
        if ($v_0.indexOf('/api/') === -1 ||
            $v_0.indexOf('/version/') === -1 ||
            $v_0.indexOf('/solutions/') === -1 ||
            $v_0.indexOf('/discovery') === -1) {
            this.$2t_2.show();
            return;
        }
        this.$3_2.attr('disabled', 'disabled');
    ...
    $3w_2: function() {
        if (this.$1c_2) {
            ...
            Mscrm.SocialInsights.Shared.SocialInsightsWebService.setSocialInsightsEnabled(this.$W_2.is(':checked'))
                .done(this.$$d_$5x_2).fail(this.$$d_$5w_2);
        }
    },
    ...
    $4E_2: function($p0) {
        ...
        Mscrm.SocialInsights.Shared.SocialInsightsWebService
            .switchInstanceAndSetEnabled(this.$3_2.val().trim(), this.$W_2.is(':checked')).done(this.$$d_$5x_2)
            .fail(this.$$d_$5w_2);
    },
...
Mscrm.SocialInsights.Runtime.Controls.SocialInsightControl = function(element) {
    ...
    this.$$d_displaySignInScreenBasedOnConfiguration = Function
        .createDelegate(this, this.displaySignInScreenBasedOnConfiguration);
...
Mscrm.SocialInsights.Runtime.Controls.SocialInsightControl.prototype = {
    ...
    get_hasConfiguration: function() {
        return !IsNull(this.$1_4) &&
            !isNullOrEmptyString(this.$1_4.SocialDataItemId) &&
            !isNullOrEmptyString(this.$1_4.SocialDataParameters);
    },
    ...
    get_editButtonIcon: function() {
        if (IsNull(this.$1w_4)) {
            this.$1w_4 = Mscrm.ImageStrip.getImageInfo(Mscrm.CrmUri
                .create(window.CDNURL + '/_imgs/socialinsight/nbediticon.png'));
        }
        return this.$1w_4;
    },
    ...
    get_editVisualizationButtonIcon: function() {
        if (IsNull(this.$1z_4)) {
            this.$1z_4 = Mscrm.ImageStrip.getImageInfo(Mscrm.CrmUri
                .create(window.CDNURL + '/_imgs/socialinsight/nbeditvisualizationicon.png'));
        }
        return this.$1z_4;
    },
    ...
    get_deleteButtonIcon: function() {
        if (IsNull(this.$1t_4)) {
            this.$1t_4 = Mscrm.ImageStrip.getImageInfo(Mscrm.CrmUri
                .create(window.CDNURL + '/_imgs/socialinsight/nbdeleteicon.png'));
        }
        return this.$1t_4;
    },
    ...
    get_editButtonHoverIcon: function() {
        if (IsNull(this.$1v_4)) {
            this.$1v_4 = Mscrm.ImageStrip.getImageInfo(Mscrm.CrmUri
                .create(window.CDNURL + '/_imgs/socialinsight/nbhoverediticon.png'));
        }
        return this.$1v_4;
    },
    ...
    get_editVisualizationButtonHoverIcon: function() {
        if (IsNull(this.$1y_4)) {
            this.$1y_4 = Mscrm.ImageStrip.getImageInfo(Mscrm.CrmUri
                .create(window.CDNURL + '/_imgs/socialinsight/nbhovereditvisualizationicon.png'));
        }
        return this.$1y_4;
    },
    ...
    get_deleteButtonHoverIcon: function() {
        if (IsNull(this.$1s_4)) {
            this.$1s_4 = Mscrm.ImageStrip.getImageInfo(Mscrm.CrmUri
                .create(window.CDNURL + '/_imgs/socialinsight/nbhoverdeleteicon.png'));
        }
        return this.$1s_4;
    },
    ...
    $5E_4: function() {
        ...
        this.get_editVisualizationButton().append(String
            .format('<img src=\'{0}\' class=\'{1}\' tabindex=\'0\'></img>',
                CrmEncodeDecode.CrmHtmlAttributeEncode(this.get_editVisualizationButtonIcon().source),
                CrmEncodeDecode.CrmHtmlAttributeEncode(this.get_editVisualizationButtonIcon().cssClass)));
        this.get_editButton().append(String.format('<img src=\'{0}\' class=\'{1}\' tabindex=\'0\'></img>',
            CrmEncodeDecode.CrmHtmlAttributeEncode(this.get_editButtonIcon().source),
            CrmEncodeDecode.CrmHtmlAttributeEncode(this.get_editButtonIcon().cssClass)));
        this.get_deleteButton().append(String.format('<img src=\'{0}\' class=\'{1}\' tabindex=\'0\'></img>',
            CrmEncodeDecode.CrmHtmlAttributeEncode(this.get_deleteButtonIcon().source),
            CrmEncodeDecode.CrmHtmlAttributeEncode(this.get_deleteButtonIcon().cssClass)));
        this.get_$34_4().unbind('click', this.$$d_$4Y_4);
        this.get_$34_4().click(this.$$d_$4Y_4);
        this.$33_4(this.get_editVisualizationButton(),
            this.get_editVisualizationButtonIcon(),
            this.get_editVisualizationButtonHoverIcon());
    ...
    $1f_4: function($p0) {
        ...
        Xrm.Internal.openDialog(Mscrm.CrmUri
            .create('/WebWizard/WizardContainer.aspx?WizardId=2F705211-E38E-4CF8-A0E3-980FC83025C6').toString(),
            $v_1,
            $v_0,
            null,
            $v_3);
    ...
    $46_4: function() {
        ...
        var $v_1 = Mscrm.SocialInsights.Common.DependencyInstanceContainer.get_urlServiceInstance()
            .createDisplayUrl(this.$1_4.SocialDataItemId, this.$1_4.SocialDataParameters.split('-'));
...
Mscrm.SocialInsights.Runtime.Services.IUrlService
    .registerInterface('Mscrm.SocialInsights.Runtime.Services.IUrlService');
...
Mscrm.SocialInsights.Runtime.Services.UrlService.get_restUrl = function() {
    ...
    return Mscrm.SocialInsights.Common.InternalDataHelper.get_$g().RestUrl ||
        Mscrm.SocialInsights.Runtime.Services.UrlService.get_rootUrl() +
        'api/' +
        Mscrm.SocialInsights.Runtime.Services.UrlService.get_versionInfo() +
        'solutions/' +
        Mscrm.SocialInsights.Runtime.Services.UrlService.get_orgInfo();
}
Mscrm.SocialInsights.Runtime.Services.UrlService.getAllWidgetsUrl = function() {
    return Mscrm.SocialInsights.Runtime.Services.UrlService.get_rootUrl() +
        'widgetapi/' +
        Mscrm.SocialInsights.Runtime.Services.UrlService.get_versionInfo() +
        'solutions/' +
        Mscrm.SocialInsights.Runtime.Services.UrlService.get_orgInfo() +
...
Mscrm.SocialInsights.Runtime.Services.UrlService.getNetBreezeOrigin = function() {
    return Mscrm.SocialInsights.Runtime.Services.UrlService.get_rootUrl()
        .substring(0, Mscrm.SocialInsights.Runtime.Services.UrlService.get_rootUrl().length - 1);
}
...
Mscrm.SocialInsights.Runtime.Services.UrlService.prototype = {
    createDisplayUrl: function(searchTerms, visualizationIds) {
        return Mscrm.SocialInsights.Runtime.Services.UrlService
            .getWidgets(visualizationIds) +
            '&nodeIds=' +
            searchTerms;
    }
}
...
Mscrm.SocialInsights.Runtime.Services.AjaxService.$4T = function() {
    ...
    (Mscrm.SocialInsights.Runtime.Services.AjaxService.$J).on('load',
        function() {
            Mscrm.SocialInsights.Runtime.Services.AjaxService.$5s();
            Mscrm.SocialInsights.Runtime.Services.AjaxService.$3B = true;
        });
    Mscrm.SocialInsights.Runtime.Services.AjaxService.$J
        .attr('src', Mscrm.SocialInsights.Runtime.Services.UrlService.getCorsWorkaroundUrl());
}
...
Mscrm.SocialInsights.Runtime.Services.AjaxService.RequestType
    .registerEnum('Mscrm.SocialInsights.Runtime.Services.AjaxService.RequestType', false);
...
Mscrm.SocialInsights.Runtime.Services.AuthCheckService.$5B = function() {
    ...
    (Mscrm.SocialInsights.Runtime.Services.AuthCheckService.$K).on('load',
        function() {
            Mscrm.SocialInsights.Runtime.Services.AuthCheckService.$3t();
        });
    Mscrm.SocialInsights.Runtime.Services.AuthCheckService.$27 = Mscrm.SocialInsights.Runtime.Services.UrlService
        .getAuthStatusUrl();
    Mscrm.SocialInsights.Runtime.Services.AuthCheckService.$K
        .attr('src', Mscrm.SocialInsights.Runtime.Services.AuthCheckService.$27);
}
...
Mscrm.SocialInsights.Runtime.Services.AuthCheckService.get_checkSignedIn = function() {
    if (Mscrm.SocialInsights.Runtime.Services.AuthCheckService.$27 !==
        Mscrm.SocialInsights.Runtime.Services.UrlService.getAuthStatusUrl()) {
        Mscrm.SocialInsights.Runtime.Services.AuthCheckService.$O = null;
        Mscrm.SocialInsights.Runtime.Services.AuthCheckService.$37();
    }
    if (IsNull(Mscrm.SocialInsights.Runtime.Services.AuthCheckService.$O)) {
        Mscrm.SocialInsights.Runtime.Services.AuthCheckService.$O = jQueryApi.jQueryDeferredFactory
...
Mscrm.SocialInsights.Shared.SignInUtility.launchSignIn = function() {
    ...
    openStdWin($v_0,
        null,
        Mscrm.SocialInsights.Shared.SocialInsightsConstants.get_signInWindowWidth(),
        Mscrm.SocialInsights.Shared.SocialInsightsConstants.get_signInWindowHeight(),
        '');
}
...
Mscrm.SocialInsights.SocialInsightsConfigurationService
    .registerClass('Mscrm.SocialInsights.SocialInsightsConfigurationService');
Mscrm.SocialInsights.SocialInsightUtility.registerClass('Mscrm.SocialInsights.SocialInsightUtility');
Mscrm.SocialInsights.Common.SocialInsightControlJsonWrapper
    .registerClass('Mscrm.SocialInsights.Common.SocialInsightControlJsonWrapper');
Mscrm.SocialInsights.Common.Constants.registerClass('Mscrm.SocialInsights.Common.Constants');
Mscrm.SocialInsights.Common.DependencyInstanceContainer
    .registerClass('Mscrm.SocialInsights.Common.DependencyInstanceContainer');
...
Mscrm.SocialInsights.Views.BaseView.registerClass('Mscrm.SocialInsights.Views.BaseView',
    Mscrm.SocialInsights.Common.Disposable);
Mscrm.SocialInsights.Views.ContainerView.registerClass('Mscrm.SocialInsights.Views.ContainerView',
    Mscrm.SocialInsights.Views.BaseView);
Mscrm.SocialInsights.Views.CssClasses.registerClass('Mscrm.SocialInsights.Views.CssClasses');
Mscrm.SocialInsights.Views.ListItemMoveControlsView
    .registerClass('Mscrm.SocialInsights.Views.ListItemMoveControlsView', Mscrm.SocialInsights.Views.BaseView);
Mscrm.SocialInsights.Views.ListView.registerClass('Mscrm.SocialInsights.Views.ListView',
    Mscrm.SocialInsights.Views.BaseView);
Mscrm.SocialInsights.Views.ListViewItem.registerClass('Mscrm.SocialInsights.Views.ListViewItem',
    Mscrm.SocialInsights.Views.ContainerView,
    Mscrm.SocialInsights.Common.Views.ISupportFocus);
Mscrm.SocialInsights.Views.SpinnerView.registerClass('Mscrm.SocialInsights.Views.SpinnerView',
    Mscrm.SocialInsights.Views.BaseView);
Mscrm.SocialInsights.Configuration.Views.WizardPageHandler
    .registerClass('Mscrm.SocialInsights.Configuration.Views.WizardPageHandler', Mscrm.SocialInsights.Views.BaseView);
Mscrm.SocialInsights.Views.ChooseTopicTypeView
    .registerClass('Mscrm.SocialInsights.Views.ChooseTopicTypeView',
        Mscrm.SocialInsights.Configuration.Views.WizardPageHandler);
Mscrm.SocialInsights.Views.MslSignInView.registerClass('Mscrm.SocialInsights.Views.MslSignInView',
    Mscrm.SocialInsights.Configuration.Views.WizardPageHandler);
Mscrm.SocialInsights.Views.SearchTopicItemView
    .registerClass('Mscrm.SocialInsights.Views.SearchTopicItemView', Mscrm.SocialInsights.Views.BaseView);
Mscrm.SocialInsights.Views.SearchTopicItemsListView
    .registerClass('Mscrm.SocialInsights.Views.SearchTopicItemsListView', Mscrm.SocialInsights.Views.BaseView);
Mscrm.SocialInsights.Views.CreateTopicView.registerClass('Mscrm.SocialInsights.Views.CreateTopicView',
    Mscrm.SocialInsights.Views.BaseView);
Mscrm.SocialInsights.Views.WidgetListEditorStrings.registerClass('Mscrm.SocialInsights.Views.WidgetListEditorStrings');
Mscrm.SocialInsights.Views.WidgetListEditorView
    .registerClass('Mscrm.SocialInsights.Views.WidgetListEditorView', Mscrm.SocialInsights.Views.BaseView);
Mscrm.SocialInsights.Views.WidgetTypeView.registerClass('Mscrm.SocialInsights.Views.WidgetTypeView',
    Mscrm.SocialInsights.Views.BaseView,
    Mscrm.SocialInsights.Common.Views.ISupportFocus);
...
Mscrm.Views.CrmMoveControlsView.registerClass('Mscrm.Views.CrmMoveControlsView',
    Mscrm.SocialInsights.Views.ListItemMoveControlsView);
Mscrm.SocialInsights.Common.Views.KeepFocusBehavior
    .registerClass('Mscrm.SocialInsights.Common.Views.KeepFocusBehavior', Mscrm.SocialInsights.Common.Disposable);
Mscrm.SocialInsights.Configuration.AdvancedSettingsHandler
    .registerClass('Mscrm.SocialInsights.Configuration.AdvancedSettingsHandler');
Mscrm.SocialInsights.Configuration.SelectSearchTopicCategoryHandler
    .registerClass('Mscrm.SocialInsights.Configuration.SelectSearchTopicCategoryHandler',
        Mscrm.SocialInsights.Configuration.Views.WizardPageHandler);
Mscrm.SocialInsights.Configuration.Models.InlineDialogArguments
    .registerClass('Mscrm.SocialInsights.Configuration.Models.InlineDialogArguments');
Mscrm.SocialInsights.Configuration.Models.SocialInsightObj
    .registerClass('Mscrm.SocialInsights.Configuration.Models.SocialInsightObj');
Mscrm.SocialInsights.Configuration.Models.Label.registerClass('Mscrm.SocialInsights.Configuration.Models.Label');
Mscrm.SocialInsights.Configuration.Models.WidgetRestriction
    .registerClass('Mscrm.SocialInsights.Configuration.Models.WidgetRestriction');
...
Mscrm.SocialInsights.ViewModels.SearchTopicItemViewModel
    .registerClass('Mscrm.SocialInsights.ViewModels.SearchTopicItemViewModel');
Mscrm.SocialInsights.ViewModels.CreateTopicViewModel
    .registerClass('Mscrm.SocialInsights.ViewModels.CreateTopicViewModel');
Mscrm.SocialInsights.ViewModels.WidgetTypeViewModel
    .registerClass('Mscrm.SocialInsights.ViewModels.WidgetTypeViewModel');
Mscrm.SocialInsights.Configuration.Views.SearchTopicPageView
    .registerClass('Mscrm.SocialInsights.Configuration.Views.SearchTopicPageView',
        Mscrm.SocialInsights.Configuration.Views.WizardPageHandler);
Mscrm.SocialInsights.Configuration.Views.VisualizationsPageView
    .registerClass('Mscrm.SocialInsights.Configuration.Views.VisualizationsPageView',
        Mscrm.SocialInsights.Configuration.Views.WizardPageHandler);
Mscrm.SocialInsights.Provisioning.NetBreezeConfigurationHandler
    .registerClass('Mscrm.SocialInsights.Provisioning.NetBreezeConfigurationHandler',
        Mscrm.SocialInsights.Views.BaseView);
Mscrm.SocialInsights.Provisioning.NetBreezeConfirmationDialogDefaults
    .registerClass('Mscrm.SocialInsights.Provisioning.NetBreezeConfirmationDialogDefaults');
Mscrm.SocialInsights.Provisioning.NetBreezeOnPremiseConfigurationHandler
    .registerClass('Mscrm.SocialInsights.Provisioning.NetBreezeOnPremiseConfigurationHandler',
        Mscrm.SocialInsights.Views.BaseView);
Mscrm.SocialInsights.Runtime.Controls.SocialInsightControl
    .registerClass('Mscrm.SocialInsights.Runtime.Controls.SocialInsightControl', Mscrm.UIControl);
Mscrm.SocialInsights.Runtime.Services.UrlService
    .registerClass('Mscrm.SocialInsights.Runtime.Services.UrlService',
        null,
        Mscrm.SocialInsights.Runtime.Services.IUrlService);
Mscrm.SocialInsights.Runtime.Services.AjaxService.registerClass('Mscrm.SocialInsights.Runtime.Services.AjaxService');
Mscrm.SocialInsights.Runtime.Services.AuthCheckService
    .registerClass('Mscrm.SocialInsights.Runtime.Services.AuthCheckService');
Mscrm.SocialInsights.Shared.SignInUtility.registerClass('Mscrm.SocialInsights.Shared.SignInUtility');
Mscrm.SocialInsights.Shared.SocialInsightsConstants
    .registerClass('Mscrm.SocialInsights.Shared.SocialInsightsConstants');
Mscrm.SocialInsights.Shared.SocialInsightsWebService
    .registerClass('Mscrm.SocialInsights.Shared.SocialInsightsWebService');
Microsoft.Crm.Core.Application.WebServices.SocialInsightsConfiguration
    .registerClass('Microsoft.Crm.Core.Application.WebServices.SocialInsightsConfiguration');
...
Mscrm.SocialInsights.Views.ChooseTopicTypeView.$4J = Mscrm.Views.CrmMoveIcons
    .$9(window.CDNURL + '/_imgs/socialinsight/topicdefault.png');
Mscrm.SocialInsights.Views.ChooseTopicTypeView.$4I = Mscrm.Views.CrmMoveIcons
    .$9(window.CDNURL + '/_imgs/socialinsight/topichover.png');
Mscrm.SocialInsights.Views.ChooseTopicTypeView.$4K = Mscrm.Views.CrmMoveIcons
    .$9(window.CDNURL + '/_imgs/socialinsight/topicselect.png');
Mscrm.SocialInsights.Views.ChooseTopicTypeView.$3P = Mscrm.Views.CrmMoveIcons
    .$9(window.CDNURL + '/_imgs/socialinsight/categorydefault.png');
Mscrm.SocialInsights.Views.ChooseTopicTypeView.$3O = Mscrm.Views.CrmMoveIcons
    .$9(window.CDNURL + '/_imgs/socialinsight/categoryhover.png');
Mscrm.SocialInsights.Views.ChooseTopicTypeView.$3Q = Mscrm.Views.CrmMoveIcons
    .$9(window.CDNURL + '/_imgs/socialinsight/categoryselect.png');
...
Mscrm.SocialInsights.Views.WidgetListEditorView
    .visualNotSupportedInfoIconCssClass = 'WidgetListEditor-VisualNotSupportedInfoIcon';
Mscrm.SocialInsights.Views.WidgetListEditorView
    .visualNotSupportedMessageCssClass = 'WidgetListEditor-VisualNotSupportedMessage';
...
Mscrm.SocialInsights.Views.WidgetTypeView
    .defaultLayoutFormat =
    '<div class=\'widget-type-view\'>\r\n\t\t\t\t<select class=\'widget-type\' title=\'{0}\' tabindex=\'-1\'></select>\r\n\t\t\t\t<div class=\'widget-type-description\'>\r\n\t\t\t\t\t<div class=\'widget-type-description-cell\'>\r\n\t\t\t\t\t\t<div class=\'widget-type-description-text\' direction=\'{1}\' tabindex=\'-1\'><div/></div>\r\n\t\t\t\t\t</div>\r\n\t\t\t\t</div>\r\n\t\t\t\t<img class=\'widget-type-preview\'>\r\n\t\t\t\t<button class=\'{2}\' title=\'{3}\' tabindex=\'-1\'><img alt=\'{3}\'/></button>\r\n\t\t\t</div>';
Mscrm.Views.CrmMoveIcons.enabledUpArrowInfo = Mscrm.Views.CrmMoveIcons
    .$9('/_imgs/SocialInsight/Arrow_Up_active_30.png');
Mscrm.Views.CrmMoveIcons.disabledUpArrowInfo = Mscrm.Views.CrmMoveIcons
    .$9('/_imgs/SocialInsight/Arrow_Up_inactive_30.png');
Mscrm.Views.CrmMoveIcons.hoverUpArrowInfo = Mscrm.Views.CrmMoveIcons
    .$9('/_imgs/SocialInsight/Arrow_Up_active_hover_30.png');
Mscrm.Views.CrmMoveIcons.enabledDownArrowInfo = Mscrm.Views.CrmMoveIcons
    .$9('/_imgs/SocialInsight/Arrow_Down_active_30.png');
Mscrm.Views.CrmMoveIcons.disabledDownArrowInfo = Mscrm.Views.CrmMoveIcons
    .$9('/_imgs/SocialInsight/Arrow_Down_inactive_30.png');
Mscrm.Views.CrmMoveIcons.hoverDownArrowInfo = Mscrm.Views.CrmMoveIcons
    .$9('/_imgs/SocialInsight/Arrow_Down_active_hover_30.png');
Mscrm.Views.CrmMoveIcons.enabledDeleteInfo = Mscrm.Views.CrmMoveIcons
    .$9('/_imgs/SocialInsight/Delete_visualization_12.png');
Mscrm.Views.CrmMoveIcons.hoverDeleteInfo = Mscrm.Views.CrmMoveIcons
    .$9('/_imgs/SocialInsight/Delete_visualization_hover_12.png');
