...
Mscrm.ImportVisualizationDialog.get_isReplaceAllowed = function() {
    return (Mscrm.ImportVisualizationDialog.$3 &&
        ((Mscrm.ImportVisualizationDialog.$0 === 1111) ||
            (Number.parseInvariant(Mscrm.ImportVisualizationDialog.paramObj.duplicateVisType) === 1112)) &&
        Mscrm.ImportVisualizationDialog.paramObj.duplicateCount === 1);
}
...
Mscrm.ImportVisualizationDialog
    .proceedWithImport = function(visualizationXml,
        visualizationName,
        description,
        duplicateFound,
        suggestedName,
...
Mscrm.ImportVisualizationDialog.$7 = function() {
    ...
    if (!isNullOrEmptyString(Mscrm.ImportVisualizationDialog.paramObj.duplicateVisId) &&
        Mscrm.ImportVisualizationDialog.paramObj.duplicateVisId.toUpperCase() ===
        Mscrm.ImportVisualizationDialog.paramObj.visualizationId.toUpperCase()) {
        if (Mscrm.ImportVisualizationDialog.paramObj.duplicateVisType === '1111' &&
            Mscrm.ImportVisualizationDialog.$0 !== 1111) {
            $v_0 = String.format(window.LOCID_VPD_IV_DUPE_SYS_ID_TEXT,
                Mscrm.ImportVisualizationDialog.paramObj.duplicateVisIdName,
                Mscrm.ImportVisualizationDialog.paramObj.entityPluralDisplayName);
        } else {
            $v_0 = String.format(window.LOCID_VPD_IV_DUPE_USER_ID_TEXT,
                Mscrm.ImportVisualizationDialog.paramObj.duplicateVisIdName,
                Mscrm.ImportVisualizationDialog.paramObj.entityPluralDisplayName);
        }
    } else {
        if (Mscrm.ImportVisualizationDialog.paramObj.duplicateVisType === '1111' &&
            Mscrm.ImportVisualizationDialog.$0 !== 1111) {
            $v_0 = String.format(window.LOCID_VPD_IV_DUPE_SYS_NAME_TEXT,
                Mscrm.ImportVisualizationDialog.paramObj.visualizationName,
                Mscrm.ImportVisualizationDialog.paramObj.entityPluralDisplayName);
        } else {
            $v_0 = String.format(window.LOCID_VPD_IV_DUPE_USER_NAME_TEXT,
                Mscrm.ImportVisualizationDialog.paramObj.visualizationName,
                Mscrm.ImportVisualizationDialog.paramObj.entityPluralDisplayName);
        }
    }
...
Mscrm.ImportVisualizationDialog.$D = function() {
    ...
    if (isNullOrEmptyString(Mscrm.ImportVisualizationDialog.paramObj.visualizationName)) {
        Mscrm.ImportVisualizationDialog.paramObj.visualizationName = Mscrm.ImportVisualizationDialog.paramObj
            .duplicateVisIdName;
    }
}
...
Mscrm.ImportVisualizationDialog.$B = function($p0) {
    ...
    if (!isNullOrEmptyString(Mscrm.ImportVisualizationDialog.paramObj.visualizationId)) {
        if (Number.parseInvariant(Mscrm.ImportVisualizationDialog.paramObj.duplicateVisType) === 1111 &&
            Mscrm.ImportVisualizationDialog.$0 !== 1111) {
        }
    }
    var $v_0 = null;
...
Mscrm.ImportVisualizationDialog.$9 = function($p0, $p1) {
    ...
    if (!IsNull($p1)) {
        ...
        $v_1 = Mscrm.ErrorInformation.createFromDoc(XUI.Xml
            .LoadXml(XUI.Xml.XMLSerializer.serializeToString(XUI.Xml.SelectSingleNode($p1, 'error', null))));
    }
    var $v_2 = Mscrm.Utilities
        .createCallbackFunctionObject('closeDialog', Mscrm.ImportVisualizationDialog, null, false);
...
Mscrm.ImportVisualizationDialog.$A = function($p0) {
    ...
    $v_0.style.display = 'inline';
    $v_1.style.display = 'inline';
    var $v_2 = String.format(window.LOCID_VPD_MSG_IMPORTSUCCESS,
        Mscrm.ImportVisualizationDialog.paramObj.entityDisplayName);
    var $v_3 = $get('successMessageLabel');
    $v_3.innerHTML = CrmEncodeDecode.CrmHtmlEncode($v_2);
    $addHandler(Mscrm.ImportVisualizationDialog.get_$4(),
        'click',
        function($p1_0) {
