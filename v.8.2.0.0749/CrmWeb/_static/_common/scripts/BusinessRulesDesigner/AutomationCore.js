        ...
        Automation.ActivityDefinitionModel = Backbone.Model.extend({
                ...
                */
                createSubsequentActivity: function() {
                    ...
                    var childPromises = [];
                    var deferred = $.Deferred();
                    var activities = Automation.CurrentAutomationControl.settings.getSubsequentActivityGenerator()
                ...
                convertToConcreteActivity: function() {
                    ...
                    var convertedActivity = Automation.CurrentAutomationControl.settings.getActivityDefinitionFactory()
            ...
            */
            Graphics.createRectangleDOM = function(rectangle, segmentClass, lineWidth) {
                ...
                var leftLine = Graphics.createLineDOM(new Automation.Point(rectangle.getLeft(), rectangle.getTop()),
                    ...
                    rectangle.getHeight(),
                    segmentClass);
                var rightLine = Graphics.createLineDOM(new Automation.Point(rectangle.getRight(), rectangle.getTop()),
                    lineWidth,
                    rectangle.getHeight(),
                    segmentClass);
                var topLine = Graphics.createLineDOM(new Automation.Point(rectangle.getLeft(), rectangle.getTop()),
                    rectangle.getWidth(),
                    lineWidth,
                    segmentClass);
                var bottomLine = Graphics.createLineDOM(new Automation
        ...
        var ActivityDropController = (function() {
            ...
            */
            ActivityDropController.prototype.dropLibraryElement = function(slot, libraryElement) {
                ...
                var dropHandler = Automation.CurrentAutomationControl.settings.getSlotHandlerProvider()
    ...
    (function(Automation) {
        ...
        var TileFactoryView = (function(_super) {
            ...
            TileFactoryView.prototype.renderTile = function(itemId, zoom) {
                ...
                var tileInformation = Automation.CurrentAutomationControl.settings.getTileInformationFactory()
        ...
        var ContainerEdgeScroller = (function() {
            ...
            */
            function ContainerEdgeScroller(container, scrollOptions) {
                if (typeof scrollOptions === "undefined") {
                    scrollOptions = {};
                }
            ...
            */
            ...
            ContainerEdgeScroller.prototype.scrollIfCursorOnEdge = function(cursorPageX, cursorPageY) {
                ...
                if (Math.abs(cursorPageX - this.containerOffset.left) <= this.scrollOptions.scrollTriggerMargin) {
                    ...
                    .abs(cursorPageX - this.containerOffset.right) <=
                    this.scrollOptions.scrollTriggerMargin) {
                ...
                if (Math.abs(cursorPageY - this.containerOffset.top) <= this.scrollOptions.scrollTriggerMargin) {
                    ...
                    .abs(cursorPageY - this.containerOffset.bottom) <=
                    this.scrollOptions.scrollTriggerMargin) {
    ...
    (function(Automation) {
        var CanvasView = (function(_super) {
            ...
            CanvasView.prototype.fetchProcess = function() {
                var self = this;
                var promise = Automation.CurrentAutomationControl.activityTree
            ...
            */
            ...
            CanvasView.prototype.drawConnector = function(parentActivity, childActivity) {
                var _this = this;
                var connectorSegments = Automation.CurrentAutomationControl.settings
    ...
    (function(Automation) {
        ...
        var LibraryElementView = (function(_super) {
            ...
            LibraryElementView.prototype.initialize = function() {
                this.libraryElementTemplate = _.template("<span class='lib-iconContainer'>" +
                    "<span class ='lib-img-content lib-img-cont-float'>" +
                    "<img src = '<%- Image %>' />" +
                    "</span >" +
                    "</span>" +
                    "<span class ='lib-rowLabel ellipsis' title = " +
                    "'<%= Title %>'" +
                    "><%= Title %></span > ");
        ...
        var LibraryCollectionView = (function(_super) {
            ...
            LibraryCollectionView.prototype.render = function() {
                ...
                for (var i = 0; i < nodes.length; i++) {
                    ...
                    var groupNode = $("<li class='listitem'><div class='hitarea'></div><span class='folder ellipsis'>" +
                        nodename +
                        "</span></li>");
    ...
    (function(Automation) {
        ...
        var PropertyView = (function(_super) {
            ...
            PropertyView.prototype.shouldPropagate = function() {
                ...
                var shouldPropagate = confirm(Automation.CurrentAutomationControl.settings
        ...
        var MultiSelectMode = (function() {
            ...
            MultiSelectMode.prototype.isActivityInsideRectangle = function(activity, latticePointRectangle) {
                ...
                if (latticePointRectangle
                    ...
                    latticePointRectangle.isPointInsideHeight(point)) {
                    return true;
                }
        ...
        var DefaultLineConnectorProvider = (function() {
            ...
            */
            DefaultLineConnectorProvider.prototype.getLineConnectorsWithLineClass = function(lineClass) {
                ...
                var positionCalculator = new Automation
                    .PositionCalculator(Automation.CurrentAutomationControl.settings.getLayoutProperties());

                var startPoint = new Automation.Point(positionCalculator.computeLeft(col1),
                    positionCalculator.computeTop(row1));
                var endPoint = new Automation.Point(positionCalculator.computeLeft(col2),
                    positionCalculator.computeTop(row2));

                var lines = Automation.CurrentAutomationControl.settings.getConnectorDOMProvider()
    ...
    (function(Automation) {
        ...
        var ErrorStatusView = (function(_super) {
            ...
            ErrorStatusView.prototype.render = function() {
                ...
                var html = '<span class="tileError">' +
                    '<img src="images/error_16.png" class="tileErrorImg" title="' +
                    statusMessage +
                    '">' +
                    '</span>';
        ...
        var DefaultContextFlyoutHandler = (function() {
            ...
            */
            DefaultContextFlyoutHandler.prototype.click = function(event) {
                var contextMenu = Automation.CurrentAutomationControl.settings.getSlotContextMenu();
                var content = Automation.CurrentAutomationControl.settings.getFlyoutContentProvider()
        ...
        var EmptyMultiDropHandler = (function() {
            ...
            */
            EmptyMultiDropHandler.prototype.drop = function(activityComponents) {
                ...
                var insertHorizontalDropHandler = new Automation
        ...
        var InsertSlotHorizontalMultiDropHandler = (function() {
            ...
            */
            InsertSlotHorizontalMultiDropHandler.prototype.drop = function(activityComponents) {
                ...
                var insertSlotHorizontalDropHandler = Automation.CurrentAutomationControl.settings
                    .getSlotHandlerProvider().createDropHandler(this.slot);
                var defaultActivityDropHandler = Automation.CurrentAutomationControl.settings.getSlotHandlerProvider()
            ...
            */
            DefaultSlotInsertHorizontalHandlerFactory.getInstance = function() {
                if (DefaultSlotInsertHorizontalHandlerFactory.instance == null) {
                    DefaultSlotInsertHorizontalHandlerFactory
                        .instance = new DefaultSlotInsertHorizontalHandlerFactory();
                }
            ...
            */
            DefaultPropertyPanelActionHandlerProvider.getInstance = function() {
                if (DefaultPropertyPanelActionHandlerProvider.instance == null) {
                    DefaultPropertyPanelActionHandlerProvider
                        .instance = new DefaultPropertyPanelActionHandlerProvider();
                }
    ...
    (function(Automation) {
        ...
        var InsertSlotHorizontalView = (function(_super) {
            ...
            InsertSlotHorizontalView.prototype.render = function() {
                ...
                var left = positionCalculator.computeLeft(this.model.getActivity().getCol() - 1) +
                    width +
