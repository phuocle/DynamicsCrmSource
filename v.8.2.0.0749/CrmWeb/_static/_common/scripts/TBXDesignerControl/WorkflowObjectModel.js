...
Microsoft.Crm.Workflow.ObjectModel.AssignVariableStep.prototype = {
    ...
    toJson: function Microsoft_Crm_Workflow_ObjectModel_AssignVariableStep$toJson() {
        ...
        sb.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder
            .getObjectJson('direction',
                ...
                true));
        sb.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder
            .getObjectJson('dataType', this._getDataTypeJson$p$1(this.dataType), true));
    ...
    _getDataTypeJson$p$1: function
        Microsoft_Crm_Workflow_ObjectModel_AssignVariableStep$_getDataTypeJson$p$1(attributeType) {
...
Microsoft.Crm.Workflow.ObjectModel
    .ProcessTriggerData = function Microsoft_Crm_Workflow_ObjectModel_ProcessTriggerData() {
    }
Microsoft.Crm.Workflow.ObjectModel.ProcessTriggerData.prototype = {
    ...
    initializeFromDynamic: function
        Microsoft_Crm_Workflow_ObjectModel_ProcessTriggerData$initializeFromDynamic(deserialized) {
            var sourceObject = deserialized;
            if (sourceObject) {
...
Microsoft.Crm.Workflow.ObjectModel.InteractiveWorkflowInputDictionary.prototype = {
    ...
    get_keys: function Microsoft_Crm_Workflow_ObjectModel_InteractiveWorkflowInputDictionary$get_keys() {
        var keys = new (Microsoft.Crm.Client.Core.Framework.List$1
            .$$(Microsoft.Crm.Workflow.ObjectModel.CustomActivityParameterInfo))();
...
Microsoft.Crm.Workflow.ObjectModel
    .WorkflowStep = function Microsoft_Crm_Workflow_ObjectModel_WorkflowStep(primaryEntityName, category) {
        ...
        this._workflowStepVariables$p$2 = new (Microsoft.Crm.Client.Core.Framework.List$1
            .$$(Microsoft.Crm.Workflow.ObjectModel.WorkflowArgument))();
        this._workflowStepInputs$p$2 = new (Microsoft.Crm.Client.Core.Framework.List$1
            .$$(Microsoft.Crm.Workflow.ObjectModel.WorkflowArgument))();
        // TODO: add guid
...
Microsoft.Crm.Workflow.ObjectModel.WorkflowStep.prototype = {
    ...
    toJson: function Microsoft_Crm_Workflow_ObjectModel_WorkflowStep$toJson() {
        ...
        var argumentJsonString = '[' +
            Microsoft.Crm.Workflow.Utils.StringUtility.join(String, ',', argumentJsonList.toArray()) +
            ']';
        sb.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder
    ...
    initializeFromDynamic: function
        Microsoft_Crm_Workflow_ObjectModel_WorkflowStep$initializeFromDynamic(deserialized) {
            if (deserialized) {
                ...
                this._arguments = new (Microsoft.Crm.Client.Core.Framework.List$1
                    .$$(Microsoft.Crm.Workflow.ObjectModel.WorkflowArgument))();
                var sourceArgumentArray = new (Microsoft.Crm.Client.Core.Framework.List$1
...
Microsoft.Crm.Workflow.Utils.StringUtility
    .join = function Microsoft_Crm_Workflow_Utils_StringUtility$join(T, connector, items) {
        var sb = new Sys.StringBuilder();
        if (!items.length) {
            return sb.toString();
        }
...
Microsoft.Crm.Workflow.Validators
    .MethodCallEvaluateExpressionValidatorBase = function
    Microsoft_Crm_Workflow_Validators_MethodCallEvaluateExpressionValidatorBase(operands, expressionOperator, context) {
...
Microsoft.Crm.Workflow.Validators.MethodCallEvaluateExpressionValidatorBase.prototype = {
    ...
    set_operands: function
        Microsoft_Crm_Workflow_Validators_MethodCallEvaluateExpressionValidatorBase$set_operands(value) {
    ...
    get_behaviorType: function
        Microsoft_Crm_Workflow_Validators_MethodCallEvaluateExpressionValidatorBase$get_behaviorType() {
            return this._behaviorType$0;
        },

    set_behaviorType: function
        Microsoft_Crm_Workflow_Validators_MethodCallEvaluateExpressionValidatorBase$set_behaviorType(value) {
    ...
    set_context: function
        Microsoft_Crm_Workflow_Validators_MethodCallEvaluateExpressionValidatorBase$set_context(value) {
            this._context$0 = value;
            return value;
        },
    ...
    set_operator: function
        Microsoft_Crm_Workflow_Validators_MethodCallEvaluateExpressionValidatorBase$set_operator(value) {
...
Microsoft.Crm.Workflow.Validators
    .MethodCallEvaluateExpressionValidatorFactory = function
    Microsoft_Crm_Workflow_Validators_MethodCallEvaluateExpressionValidatorFactory() {
    }
Microsoft.Crm.Workflow.Validators.MethodCallEvaluateExpressionValidatorFactory
    .getValidator = function
    Microsoft_Crm_Workflow_Validators_MethodCallEvaluateExpressionValidatorFactory$getValidator(expressionOperator,
        expressions,
        context) {
...
Microsoft.Crm.Workflow.Validators.MethodCallExpressionValidator.prototype = {
    ...
    _validateEvaluateExpression$p$1: function
        Microsoft_Crm_Workflow_Validators_MethodCallExpressionValidator$_validateEvaluateExpression$p$1() {
            ...
            var validator = Microsoft.Crm.Workflow.Validators.MethodCallEvaluateExpressionValidatorFactory
                .getValidator(expressionOperator, methodCallExpressions, this._context$0);
            validator.validate();
