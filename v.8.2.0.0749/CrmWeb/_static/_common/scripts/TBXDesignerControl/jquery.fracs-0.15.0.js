    ...
    extend(Rect,
    {
        ...
        ofContent: function(element, inContentSpace) {
            ...
            if (inContentSpace) {
                ...
                return new Rect(element.getBoundingClientRect().left - element.scrollLeft,
...
// ### Prototype
    extend(FracsCallbacks.prototype,
        callbacksMixIn,
        {
...
// ### Prototype
    extend(GroupCallbacks.prototype,
        callbacksMixIn,
        {
            updatedValue: function() {
...
// ### Prototype
    extend(ScrollStateCallbacks.prototype,
        callbacksMixIn,
        {
            updatedValue: function() {
    ...
    modplug(namespace,
    {
        ...
        methods: {
            ...
            sort: function(property, ascending, viewport) {
                ...
                return this.pushStack($.map(new Group(this, viewport).sorted(property, !ascending),
                    function(entry) {
                        return entry.el;
                    }));
            },
