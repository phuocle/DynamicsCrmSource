...
jQuery.fn.barChart = function(target) {
    ...
    var g = {
        ...
        Initialize: function() {
            ...
            if (g.IsNextVersionOfSlider) {
                g.seriesLength = g.seriesLength - 1;
            }
        ...
        OverrideGlobalgForSlider: function() {
            if (g.sliderWidthFixed) {
                ...
                case 1:
                    throw new
                        Error('You can not provide single value for Bar Chart Slider. Provided values must be more than one.');
                    break;
                case 2:
                    g.leftConstant = 75;
                    break;
    ...
    var main = {
        ...
        prepareHTML: function() {
            ...
            var currentElement = [
                ["class", "ms-ref-refiner"], ["name", "Group"], ["style", "display:block;"], ["id", elementId]
            ];
            ...
            currentElement = [
                ["class", "ms-displayInlineBlock facetsname_RecordOwnerCreatedModified"],
                ["id", g.u + "ctl00_PlaceHolderLeftNavBar_ctl00_csr_RefinerHeading_LastModifiedTime"],
                ["tabindex", "-1"]
            ];
            if (g.IsRTLSelected()) {
            ...
            currentElement = [
                ["class", "ms-ref-unselSec"], ["style", "display:block"],
                ["id", g.u + "_ctl00_PlaceHolderLeftNavBar_ctl00_csr6s1"]
            ];
            ...
            currentElement = [
                ["class", "histogram_container"], [
                    "id", g.u + "_ctl00_PlaceHolderLeftNavBar_ctl00_csr6HistogramContainer"
                ], ["style", "width:" + g.CalContainerWidth + "px;"]
            ];
            main.createHTML("div", currentElement, elementId);
            ...
            for (var i = 0; i < g.seriesLength; i++) {
                ...
                currentElement = [
                    ["class", "histogram_bar_link"], ["id", g.u + "_histogram_bar_link" + i],
                    ["title", "" + g.t.xAxis.categories[i] + " (" + g.t.series[0].data[i] + ")"],
                    ["href", "javascript:void(0)"], ["style", "bottom:0px; left:" + k + "px; width:" + barWidth + "px"]
                ];
                ...
                currentElement = [
                    ["class", "histogram_bar_background"], [
                        "id", g.u + "_ctl00_PlaceHolderLeftNavBar_ctl00_csr6_HistogramBgBar" + i
                    ]
                ];
                main.createHTML("div", currentElement, elementId);
                ...
                currentElement = [
                    ["class", "histogram_bar_active"], [
                        "id", g.u + "_ctl00_PlaceHolderLeftNavBar_ctl00_csr6_HistogramActiveBar" + i
                    ], ["style", "height:" + heightArray[i] + "px; margin-top:0px"],
                    [
                        "onclick", g.cl +
                        ".InvokeBarClickEvent(" +
                        i +
            ...
            currentElement = [
                ...
                ["id", g.u + "_ctl00_PlaceHolderLeftNavBar_ctl00_csr6SliderContainer_ExtentLabelSection"]
            ];
            main.createHTML("div", currentElement, elementId);
            ...
            currentElement = [
                ["class", "slider_extent_label_right"], [
                    "id", g.u + "ctl00_PlaceHolderLeftNavBar_ctl00_csr6SliderContainer_ExtentLabelMax"
                ]
            ];
            ...
            elementId = g.u + "_ctl00_PlaceHolderLeftNavBar_ctl00_csr6s1";
            currentElement = [
                ["class", "slideronly_container"], [
                    "id", g.u + "_ctl00_PlaceHolderLeftNavBar_ctl00_csr6SliderContainer"
                ], ["style", "width:" + g.CalContainerWidth + "px;"]
            ];
            main.createHTML("div", currentElement, elementId);
            ...
            currentElement = [
                ...
                ["id", g.u + "_ctl00_PlaceHolderLeftNavBar_ctl00_csr6SliderBehaviourRailSection"]
            ];
            main.createHTML("div", currentElement, elementId);
            -1
            ...
            currentElement = [
                ["class", "ajax__multi_slider_default"], [
                    "id", g.u +
                    "_ctl00_PlaceHolderLeftNavBar_ctl00_csr6SliderBehaviourRailSection_ajax__multi_slider_default"
                ]
            ];
            main.createHTML("div", currentElement, elementId);
            ...
            elementId = g.u +
                "_ctl00_PlaceHolderLeftNavBar_ctl00_csr6SliderBehaviourRailSection_ajax__multi_slider_default";
            currentElement = [
                ["class", "ajax__multi_slider_default outer_rail_horizontal"],
                ["id", g.u + "_ctl00_PlaceHolderLeftNavBar_ctl00_csr6SliderBehaviour_outer"], ["tabindex", "-1"],
                ["style", "outline:none; width:" + (g.CalContainerWidth - g.innerCssWidth) + "px;"]
            ];
            main.createHTML("div", currentElement, elementId);

            elementId = g.u + "_ctl00_PlaceHolderLeftNavBar_ctl00_csr6SliderBehaviour_outer";
            currentElement = [
                ["class", "ajax__multi_slider_default handle_horizontal_left handle_noforcepressed"],
                ["role", "slider"], ["aria-valuemin", g.t.xAxis.start], ["aria-valuemax", g.t.xAxis.end],
                ["aria-labelledby", g.u + "_ctl00_PlaceHolderLeftNavBar_ctl00_csr6RangeLabel"], ["tabindex", "0"],
                ["id", g.u + "_ctl00_PlaceHolderLeftNavBar_ctl00_csr6SliderBehaviour_handle_0"],
            ...
            currentElement = [
                ...
                ["role", "slider"], ["aria-valuemin", g.t.xAxis.start], ["aria-valuemax", g.t.xAxis.end],
                ["aria-labelledby", g.u + "_ctl00_PlaceHolderLeftNavBar_ctl00_csr6RangeLabel"], ["tabindex", "0"],
                ["id", g.u + "_ctl00_PlaceHolderLeftNavBar_ctl00_csr6SliderBehaviour_handle_1"],
                [
                    "style", "overflow:hidden;cursor:pointer; top:0px;left:" +
                    (g.CalContainerWidth - g.handle1Left) +
                    "px;"
                ]
            ];
            main.createHTML("a", currentElement, elementId);
            ...
            elementId = g.u + "_ctl00_PlaceHolderLeftNavBar_ctl00_csr6SliderBehaviour_outer";
            currentElement = [
                ["class", "ajax__multi_slider_default inner_rail_horizontal"],
                ["id", g.u + "_ctl00_PlaceHolderLeftNavBar_ctl00_csr6SliderBehaviour_inner"],
                ["style", "outline:none; left:0px; width:" + (g.CalContainerWidth - g.innerCssWidth) + "px"],
                ["tabindex", "-1"]
            ];
            main.createHTML("a", currentElement, elementId);
            ...
            for (var i = 0; i <= g.seriesLength; i++) {
                ...
                currentElement = [
                    ["class", "slider_tick_active"], [
                        "id", g.u + "_ctl00_PlaceHolderLeftNavBar_ctl00_csr6Boundary_Tick_" + i
                    ], ["style", "left:" + p + "px"], ["title", ""]
                ];
                main.createHTML("div", currentElement, elementId);
                ...
                currentElement = [
                    ["class", "slider_tick_targetbox"], [
                        "id", g.u + "_ctl00_PlaceHolderLeftNavBar_ctl00_csr6Boundary_TickTouchTarget_" + i
                    ], ["style", "left:" + q + "px; width:27px"], ["title", ""]
                ];
                main.createHTML("div", currentElement, elementId);
            ...
            elementId = g.u + "_ctl00_PlaceHolderLeftNavBar_ctl00_csr6_SliderLoadContainer";
            currentElement = [
                ["class", "handle_label_section ms-ref-allSec"],
                ["id", g.u + "_ctl00_PlaceHolderLeftNavBar_ctl00_csr6LabelSection"]
            ];
            if (g.IsRTLSelected()) {
                var rtlCss = ["style", "direction:rtl"]
                currentElement.push(rtlCss);
            ...
            currentElement = [
                ["class", "handle_label"], ["id", g.u + "_ctl00_PlaceHolderLeftNavBar_ctl00_csr6RangeLabel"]
            ];
        ...
        SetBarAndTickClickEventForSingleBar: function(barElementId1,
            tickElementId1,
            tickElementId2,
            handle1Value,
            handle2Value,
            ...
            $("#" + g.u + "_ctl00_PlaceHolderLeftNavBar_ctl00_csr6SliderBehaviour_handle_0")
                .css("left", handle1Value + "px");
            $("#" + g.u + "_ctl00_PlaceHolderLeftNavBar_ctl00_csr6SliderBehaviour_handle_1")
                .css("left", handle2Value + "px");
            $("#" + g.u + "_ctl00_PlaceHolderLeftNavBar_ctl00_csr6SliderBehaviour_inner")
                .css({ "width": innerWidth + "px", "left": innerLeft + "px" });

            //change bar top color to gray
            $("#" + g.u + "_ctl00_PlaceHolderLeftNavBar_ctl00_csr6_HistogramActiveBar" + barElementId1)
                .css("border-top", "2px solid #2a8dd4");

            //Change slider color
            $("#" + g.u + "_ctl00_PlaceHolderLeftNavBar_ctl00_csr6Boundary_Tick_" + tickElementId1)
                .css({ "background-color": "#2a8dd4", "border": "1px solid #2a8dd4" });
            $("#" + g.u + "_ctl00_PlaceHolderLeftNavBar_ctl00_csr6Boundary_Tick_" + tickElementId2)
                .css({ "background-color": "#2a8dd4", "border": "1px solid #2a8dd4" });
        },
        UpdateRangeBarTextAtBottom: function() {
            var textToUpdate;
            var lf = parseInt($("#" + g.u + "_ctl00_PlaceHolderLeftNavBar_ctl00_csr6SliderBehaviour_handle_0")
                .css('left'),
                10);
            var rt = parseInt($("#" + g.u + "_ctl00_PlaceHolderLeftNavBar_ctl00_csr6SliderBehaviour_handle_1")
                .css('left'),
                10);
            var rtSlierDisplay = '';
            if (g.isBarChartEnabled) {
                ...
                if (lf == 0) {
                    g.finalTextToAppend = "< ";
                } else if (rt == (g.CalContainerWidth - g.handle1Left) || rt > (g.CalContainerWidth - g.handle1Left)) {
                    rtSlierDisplay = "> ";
                }
            }
            ...
            if (!((lf % g.leftConstant == 0) && (rt % g.leftConstant == 0))) {
                return;
            }
            ...
            if (lf == 0) {
                ...
                rt != (g.CalContainerWidth - g.handle1Left) &&
                rt < (g.CalContainerWidth - g.handle1Left)) {
            ...
            if (lf == 0 && (rt == (g.CalContainerWidth - g.handle1Left) || rt >= 150)) {
                textToUpdate = g._BarChartTextToDisplay[t];
                if (!g.isBarChartEnabled) {
                    textToUpdate = Mscrm.ExternalSearch.getBarChartAllTextToDisplay();
                }
            }
        ...
        UnsetAndDehighLightTracksAndBars: function() {
            ...
            for (var i = 0; i < g.seriesLength; i++) {
                $("#" + g.u + "_ctl00_PlaceHolderLeftNavBar_ctl00_csr6Boundary_Tick_" + i)
                    .css({ "background-color": "#c6c6c6", "border": "1px solid #c6c6c6" });
                $("#" + g.u + "_ctl00_PlaceHolderLeftNavBar_ctl00_csr6_HistogramActiveBar" + i)
                    .css("border-top", "2px solid #ababab");
            }
                ...
                $(document).mousemove(main.mouseL)
                    .mouseup(function(e) {
                        ...
                        var currentPosition = parseInt($("#" +
                                g.u +
                                "_ctl00_PlaceHolderLeftNavBar_ctl00_csr6SliderBehaviour_handle_0").css('left'),
                            10);
                        main
                            .SetRangeBarPositionToTrackPoints(g.u +
                                "_ctl00_PlaceHolderLeftNavBar_ctl00_csr6SliderBehaviour_handle_0",
                                main.FindClosest(currentPosition),
                                'LHSH');
                    });
            });
        },
        mouseL: function(e) {
            if (main._MouseDownForLeftBar) {
                if (e.pageX >= g.leftConstant && e.pageX < (g.CalContainerWidth - g.handle1Left) + 1) {
                    main.LeftMostRangeBarMove(e.pageX - g.leftConstant);
                }
            } else {
                e.stopPropagation();
                e.cancelBubble = true;
        ...
        LeftMostRangeBarMove: function(shiftLeft) {
            var rightBarCssPosition = parseInt($("#" +
                    g.u +
                    "_ctl00_PlaceHolderLeftNavBar_ctl00_csr6SliderBehaviour_handle_1").css('left'),
                10);
            if (rightBarCssPosition >= shiftLeft + g.leftConstant) {
                $("#" + g.u + "_ctl00_PlaceHolderLeftNavBar_ctl00_csr6SliderBehaviour_handle_0")
                    .css("left", shiftLeft + "px");
            }
        },
            ...
            rightRangeBar.mousedown(function(e) {
                ...
                $(document).mousemove(main.mouseR)
                    .mouseup(function(e) {
                        ...
                        main
                            .SetRangeBarPositionToTrackPoints(g.u +
                                "_ctl00_PlaceHolderLeftNavBar_ctl00_csr6SliderBehaviour_handle_1",
                                main.FindClosest(currentPosition),
                                'RHSH');
                    });
            });
        ...
        mouseR: function(e) {
            ...
            if (main._MouseDownForRightBar) {
                if (e.pageX - g.leftConstant < (g.CalContainerWidth - g.handle1Left) + 1 && e.pageX >= g.leftConstant) {
                    main.RightMostRangeBarMove(e.pageX - g.leftConstant);
                }
            } else {
                e.stopPropagation();
                e.cancelBubble = true;
        ...
        RightMostRangeBarMove: function(shiftLeft) {
            var LeftBarCssPosition = parseInt($("#" +
                    g.u +
                    "_ctl00_PlaceHolderLeftNavBar_ctl00_csr6SliderBehaviour_handle_0").css('left'),
                10);
        ...
        RememberHandlesLastPosition: function() {
            var leftHandlecurrentPosition = parseInt($("#" +
                    g.u +
                    "_ctl00_PlaceHolderLeftNavBar_ctl00_csr6SliderBehaviour_handle_0").css('left'),
                10);
            var rightHandlecurrentPosition = parseInt($("#" +
                    g.u +
                    "_ctl00_PlaceHolderLeftNavBar_ctl00_csr6SliderBehaviour_handle_1").css('left'),
                10);
        ...
        CallKeyEvents: function() {
            ...
            if (currentFocusId.length > 0) {
                ...
                var lt = parseInt($("#" + g.u + "_ctl00_PlaceHolderLeftNavBar_ctl00_csr6SliderBehaviour_handle_0")
                    .css('left'),
                    10);
                var rt = parseInt($("#" + g.u + "_ctl00_PlaceHolderLeftNavBar_ctl00_csr6SliderBehaviour_handle_1")
                    .css('left'),
                ...
                if (currentFocusId[0].id == g.u + "_ctl00_PlaceHolderLeftNavBar_ctl00_csr6SliderBehaviour_handle_0") {
                    if (g.KeyValue == 38 || g.KeyValue == 39) {
                        lt = lt + g.leftConstant;
                    } else if (g.KeyValue == 40 || g.KeyValue == 37) {
                        lt = lt - g.leftConstant;
                    }
                    if (lt < rt) {
                        g.secondTimeClickEvent = true;
                ...
                } else if (currentFocusId[0].id ==
                    g.u + "_ctl00_PlaceHolderLeftNavBar_ctl00_csr6SliderBehaviour_handle_1") {
                    if (g.KeyValue == 38 || g.KeyValue == 39) {
                        rt = rt + g.leftConstant;
                    } else if (g.KeyValue == 40 || g.KeyValue == 37) {
                        rt = rt - g.leftConstant;
                    }
                    if (lt < rt) {
        ...
        RepositionsBarsOn13: function() {
            ...
            if (currentFocusId.length > 0) {
                if (currentFocusId[0].id.indexOf(barElementSubId) !== -1) {
                    ...
                    main.RememberHandlesLastPosition();
                    var d = document.getElementById(x[0] +
                        "_ctl00_PlaceHolderLeftNavBar_ctl00_csr6_HistogramActiveBar" +
                        activeBar);
                    d.click();
                }
            }
        ...
        SetHighLightTracksAndBars: function() {
            ...
            for (var i = 0; i < main._BarHighlightArray[lf / g.leftConstant][1]; i++) {
                $("#" + g.u + "_ctl00_PlaceHolderLeftNavBar_ctl00_csr6Boundary_Tick_" + i)
                    .css({ "background-color": "#ababab", "border": "1px solid #ababab" });
                $("#" + g.u + "_ctl00_PlaceHolderLeftNavBar_ctl00_csr6_HistogramActiveBar" + i)
                    .css("border-top", "2px solid #ababab");
            }
            ...
            for (var i = 0; i < main._BarHighlightArray[rt / g.leftConstant][2]; i++) {
                $("#" + g.u + "_ctl00_PlaceHolderLeftNavBar_ctl00_csr6Boundary_Tick_" + k)
                    .css({ "background-color": "#ababab", "border": "1px solid #ababab" });
                $("#" + g.u + "_ctl00_PlaceHolderLeftNavBar_ctl00_csr6_HistogramActiveBar" + k)
                    .css("border-top", "2px solid #ababab");
                k--;
            }
        },
        ...
        SetSpecifiedBars: function(recieveBarsArr) {
            ...
            main.SetRangeBarPositionToTrackPoints(g.u +
                "_ctl00_PlaceHolderLeftNavBar_ctl00_csr6SliderBehaviour_handle_0",
                main.FindClosest(currentPosition),
                'LHSH');
        ...
        SendReponseBackToParentPage: function() {
            if (g.secondTimeClickEvent) {
                ...
                var a = [
                    document.getElementById("entityCombo").value, g.columnname, g.isBarChartEnabled, isResultsRefresh, g
                    .c[0].id, isResultsRefreshWhenNoChange
                ];
