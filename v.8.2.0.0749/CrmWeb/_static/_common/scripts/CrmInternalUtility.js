...
Mscrm.CrmCrossBrowser.get_hash = function() { return Mscrm.CrmCrossBrowser.getHash(window.self.location) };
Mscrm.CrmCrossBrowser.getHash = function(location) {
    if (!location) throw Error.argumentNull("location");
    var $v_0 = location.href.split("#");
    return $v_0.length > 1 ? $v_0[1] : ""
};
Mscrm.CrmCrossBrowser.getLocalStorage = function($sn_window) {
    if (!$sn_window) throw Error.argumentNull("window");
...
Mscrm.CrmDisposeHelper = function() { this.$3_0 = [] };
Mscrm.CrmDisposeHelper.prototype = {
    schedule: function(disposeAction) {
        if (!this.$3_0) throw Error.invalidOperation("Object is already disposed");
        if (!disposeAction) throw Error.argumentNull("disposeAction");
...
jQueryApi.jQueryDeferredFactory.Deferred = function(TData, TError, initializer) {
    if (initializer === undefined || !initializer) return $P_CRM.Deferred();
    else return $P_CRM.Deferred(initializer)
};
...
jQueryApi.JSTreeOptions = function() { this.$2_0 = [] };
jQueryApi.JSTreeOptions.prototype = {
    $2_0: null,
    get_plugins: function() { return this.$2_0 },
    set_plugins: function(value) {
        this.$2_0 = value;
        return value
    },
    getJSTreeConfig: function() {
        for (var $v_0 = '{ "plugins" : [ ', $v_2 = 0; $v_2 < this.$2_0.length; $v_2++) {
            var $v_3 = this.$2_0[$v_2];
            if ($v_2 !== this.$2_0.length - 1) $v_0 += $v_3.$1_0 + ",";
            else $v_0 += $v_3.$1_0 + "],"
        }
...
jQueryApi.JSTreePlugin = function() { this.$0_0 = {} };
jQueryApi.JSTreePlugin.prototype = {
    ...
    get_configuration: function() { return this.$0_0 },
...
jQueryApi.JSTreeCorePlugin.prototype = {
    get_animation: function() { return this.$0_0['"animation"'].toString() },
    set_animation: function(value) {
        this.$0_0['"animation"'] = value;
        return value
    },
    get_rightToLeft: function() { return this.$0_0['"rtl"'].toString() },
    set_rightToLeft: function(value) {
        this.$0_0['"rtl"'] = value;
        return value
    },
    get_loadOpen: function() { return this.$0_0['"load_open"'].toString() },
    set_loadOpen: function(value) {
        this.$0_0['"load_open"'] = value;
        return value
    },
    get_loadingString: function() { return this.$0_0['"strings"'].toString() },
...
jQueryApi.JSTreeUIPlugin.prototype = {
    get_selectLimit: function() { return this.$0_0['"select_limit"'].toString() },
    set_selectLimit: function(value) {
        this.$0_0['"select_limit"'] = value;
        return value
    },
    get_selectMultipleModifier: function() { return this.$0_0['"select_multiple_modifier"'].toString() },
    set_selectMultipleModifier: function(value) {
        this.$0_0['"select_multiple_modifier"'] = '"' + value + '"';
        return value
    },
    get_selectRangeModifier: function() { return this.$0_0['"select_range_modifier"'].toString() },
    set_selectRangeModifier: function(value) {
        this.$0_0['"select_range_modifier"'] = '"' + value + '"';
        return value
    },
    get_selectedParentClose: function() { return this.$0_0['"selected_parent_close"'].toString() },
    set_selectedParentClose: function(value) {
        if (value === "false") this.$0_0['"selected_parent_close"'] = value;
        else this.$0_0['"selected_parent_close"'] = '"' + value + '"';
        return value
    },
    get_selectedParentOpen: function() { return this.$0_0['"selected_parent_open"'].toString() },
    set_selectedParentOpen: function(value) {
        this.$0_0['"selected_parent_open"'] = value;
        return value
    },
    get_selectPreviousOnDelete: function() { return this.$0_0['"select_prev_on_delete"'].toString() },
    set_selectPreviousOnDelete: function(value) {
        this.$0_0['"select_prev_on_delete"'] = value;
        return value
    },
    get_disableSelectingChildren: function() { return this.$0_0['"disable_selecting_children"'].toString() },
    set_disableSelectingChildren: function(value) {
        this.$0_0['"disable_selecting_children"'] = value;
        return value
    },
    get_initiallySelectedList: function() { return this.$0_0['"initially_select"'].toString() },
...
jQueryApi.JSTreeJsonDataPlugin.prototype = {
    get_progressiveRender: function() { return this.$0_0['"progressive_render"'].toString() },
    set_progressiveRender: function(value) {
        this.$0_0['"progressive_render"'] = value;
        return value
    },
    get_progressiveUnload: function() { return this.$0_0['"progressive_unload"'].toString() },
...
jQueryApi.JSTreeThemesPlugin.prototype = {
    get_theme: function() { return this.$0_0['"theme"'].toString() },
    set_theme: function(value) {
        this.$0_0['"theme"'] = '"' + value + '"';
        return value
    },
    get_icons: function() { return this.$0_0['"icons"'].toString() },
    set_icons: function(value) {
        this.$0_0['"icons"'] = value;
        return value
    },
    get_dots: function() { return this.$0_0['"dots"'].toString() },
    set_dots: function(value) {
        this.$0_0['"dots"'] = value;
        return value
    },
    get_url: function() { return this.$0_0['"url"'].toString() },
...
jQueryUIApi.WidgetOptions.prototype = { disabled: false, hide: false, show: false, create: null, isRTL: false };
...
jQueryUIApi.WidgetFactory.createInstance = function(TWidget, element, options) {
    var $v_0 = TWidget.getName().split("."), $v_1 = $v_0[1], $v_2 = $P_CRM(element)[$v_1](options);
    return $v_2.data($v_1)
};
