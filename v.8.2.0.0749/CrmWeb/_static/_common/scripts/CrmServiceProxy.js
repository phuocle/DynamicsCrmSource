...
Microsoft.Crm.Client.Core.Models.FormModel = function() {
    ...
    this.$i_1 = new (Microsoft.Crm.Client.Core.Framework.TypedDictionary$1
        .$$(Microsoft.Crm.Client.Core.Framework.TypedDictionary$1
            .$$(Microsoft.Crm.Client.Core.Models.Validation.IIsRequiredValidator)))();
...
Microsoft.Crm.Client.Core.Models.FormModel.prototype = {
    ...
    get_userCurrencyPrecision: function() {
        var $v_0 = Microsoft.Crm.Client.Core.Storage.DataApi.DataSource.$4.$B_0
            .get_externalContext()['transactioncurrencybyid'];
        var $v_1 = $v_0.get_item(this.get_transactionCurrencyId());
        return ($v_1)
            ? $v_1.get_currencyPrecision()
            : Microsoft.Crm.Client.Core.Storage.DataApi.DataSource.$4.$B_0.get_UserSettings()
            .get_numberFormatInfo()['CurrencyDecimalDigits'];
    },
    ...
    setValidator: function(fieldName, validatorType, validator) {
        var $v_0 = this.$i_1.get_item(fieldName);
        if (!$v_0) {
            $v_0 = this.$i_1.set_item(fieldName,
                new (Microsoft.Crm.Client.Core.Framework.TypedDictionary$1
                    .$$(Microsoft.Crm.Client.Core.Models.Validation.IIsRequiredValidator))());
        }
    ...
    getAttributePrecision: function(attributeMetadata) {
        ...
        case 8:
            ...
            case 1:
                return Microsoft.Crm.Client.Core.Storage.DataApi.DataSource.$4.$B_0.get_organizationSettings()
                    .get_pricingDecimalPrecision();
            default:
    ...
    GetEffectiveAttributeFormat: function(fieldName) {
        fieldName = Microsoft.Crm.Client.Core.Models.FormModel.removeFormat(fieldName);
        if (!_Script.isNullOrUndefined(this.$O_1) &&
            this.$O_1.containsKey(fieldName) &&
            !Microsoft.Crm.Client.Core.Framework._String.isNullOrWhiteSpace(this.$O_1.get_item(fieldName))) {
...
Microsoft.Crm.Client.Core.Models.RecordModel.prototype = {
    ...
    get_namedReference: function() {
        if (_Script.isNullOrUndefined(this.$E_2)) {
            ...
            if (_Script.isNullOrUndefined(this.$E_2.Name)) {
                var $v_0 = Microsoft.Crm.Client.Core.Storage.DataApi.DataSource.$4.$I_0
                    .getEntityMetadata(this.$E_2.get_modelType());
    ...
    get_activityPartyRecord: function() {
        if (_Script.isNullOrUndefined(this.$z_2)) {
            if (_Script.isNullOrUndefined(this.$E_2)) {
                this.$E_2 = this.$0_2.get_actionableIdentifier();
                if (_Script.isNullOrUndefined(this.$E_2.Name)) {
                    var $v_3 = Microsoft.Crm.Client.Core.Storage.DataApi.DataSource.$4.$I_0
                        .getEntityMetadata(this.$E_2.get_modelType());
            ...
            var $v_1 = { partyid: 6 };
            var $v_2 = new Xrm.Objects.EntityReference('activityparty',
                Microsoft.Crm.Client.Core.Framework.Guid.get_empty());
            this.$z_2 = new Microsoft.Crm.Client.Core.Storage.Common.ObjectModel
                .EntityRecord($v_2,
                    $v_0,
                    $v_1,
                    {},
    ...
    get_isDisabled: function() {
        ...
        if (Microsoft.Crm.Client.Core.Storage.Common.ObjectModel.OptionMetadata.isInstanceOfType($v_0)) {
            ...
            if (this.$0_2.get_actionableIdentifier().LogicalName === 'knowledgearticle') {
                if (!_Script.isNullOrUndefined(this.$0_2.get_fields()['majorversionnumber']) &&
                    !_Script.isNullOrUndefined(this.$0_2.get_fields()['minorversionnumber']) &&
                    !(this.$0_2.get_fields()['majorversionnumber']) &&
                    !(this.$0_2.get_fields()['minorversionnumber'])) {
                    return true;
                }
                if ($v_1 === 2 || $v_1 === 3) {
    ...
    get_$1Z_2: function() {
        return Microsoft.Crm.Client.Core.Framework.DefaultContext
            .tryCreate(this.get_actionableIdentifier().toString(),
                'RecordModel:' + this.get_actionableIdentifier().toString());
    },
    ...
    update: function(record) {
        ...
        for (var $$arr_9 = record
            ...
            var $v_A = this.$Q_2(record, $v_8, $v_9) || record.get_formattedValues()[$v_8];
            if (!_Script.isNullOrUndefined($v_3)) {
                if ((($v_8) in $v_3.get_fieldTypes())) {
                    this.$3D_2($v_3, $v_8, $v_9, $v_A);
                } else {
                    var $v_B = this.$q_2(record, $v_8, $v_9);
                    this.$1V_2(record, $v_8, $v_A, $v_B);
                    if ($v_4) {
        ...
        for (var $$arr_I = $v_6.get_columns(), $$len_J = $$arr_I.length, $$idx_K = 0; $$idx_K < $$len_J; ++$$idx_K) {
            var $v_C = $$arr_I[$$idx_K];
            this.SetValue($v_C, null);
        }
        if ($v_0 && this.$0_2.get_accessRights() !== this.$2_2.get_accessRights()) {
            var $v_D = this.eventHandlers.getHandler('PropertyChanged');
            if ($v_D) {
                $v_D(this, 'accessrights');
            }
        } else {
            this.$3M_2(record, $v_2, $v_1);
        }
        if ($v_0 &&
            !Microsoft.Crm.Client.Core.Imported.MscrmComponents
            .ObjectsEqual(this.$0_2
                .get_userSharedAttributePrivileges(),
                this.$2_2.get_userSharedAttributePrivileges())) {
            var $v_E = this.eventHandlers.getHandler('PropertyChanged');
            if ($v_E) {
                $v_E(this, 'usersharedattributeprivileges');
            }
        } else {
            this.$3Q_2(record, $v_2, $v_1);
        }
        this.$0_2.resetChanges();
    },

    $3Q_2: function($p0, $p1, $p2) {
        if (!_Script.isNullOrUndefined($p1)) {
            if (!Microsoft.Crm.Client.Core.Imported.MscrmComponents
                .ObjectsEqual($p1.get_userSharedAttributePrivileges(), $p0.get_userSharedAttributePrivileges())) {
    ...
    $3M_2: function($p0, $p1, $p2) {
        if (!_Script.isNullOrUndefined($p1)) {
            ...
            for (var $$arr_4 = $p0.get_relatedEntities().get_entityCollections(), $$len_5 = $$arr_4.length, $$idx_6 = 0;
                $$idx_6 < $$len_5;
                ++$$idx_6) {
                var $v_1 = $$arr_4[$$idx_6];
    ...
    checkMoneyFieldWithValues: function() {
        for (var $$arr_0 = this.$0_2.get_fieldNames(), $$len_1 = $$arr_0.length, $$idx_2 = 0;
            $$idx_2 < $$len_1;
            ++$$idx_2) {
            var $v_0 = $$arr_0[$$idx_2];
            if (this.$0_2.get_fieldTypes()[$v_0] === 8) {
                ...
                if (!_Script.isNullOrUndefined($v_1) &&
                    !Microsoft.Crm.Client.Core.Framework._String.isNullOrWhiteSpace($v_1.toString())) {
                    return true;
                }
            }
        }
    ...
    GetValue: function(fieldName) {
        var $v_0 = [
            Mscrm.InternalUtilities.OpportunityProduct, Mscrm.InternalUtilities.InvoiceDetail, Mscrm.InternalUtilities
            .QuoteDetail, Mscrm.InternalUtilities.SalesOrderDetail
        ];
        var $v_1 = 'productid';
        var $v_2 = 'productdescription';
        var $v_3 = ['productid!name', 'productidname'];
        if (Array.indexOf($v_0, this.$0_2.get_actionableIdentifier().LogicalName.toLowerCase()) > -1 &&
            Array.indexOf($v_3, fieldName.toLowerCase()) > -1) {
    ...
    SetValue: function(fieldName, value, formattedValue, numericFormattedValue) {
        if (!_Script.isNullOrUndefined(this.$2_2)) {
            this.$3D_2(this.$2_2, fieldName, value, formattedValue, numericFormattedValue, true, false);
        }
        this.$3D_2(this.$0_2, fieldName, value, formattedValue, numericFormattedValue);
    },

    $3D_2: function($p0, $p1, $p2, $p3, $p4, $p5, $p6) {
        ...
        var $v_6 = (_Script.isNullOrUndefined($v_1))
            ? this.$1Y_2($p0, $v_0 + Microsoft.Crm.Client.Core.Framework.FieldFormat.raw)
            : $v_5;
        if (Microsoft.Crm.Client.Core.Framework.DeviceConfiguration.get_isInteractionCentricDashboard() &&
            $p1 === 'processid') {
            $v_6 = null;
        }
        if (!Microsoft.Crm.Client.Core.Framework.ObjectComparer.areValuesEqual($v_5, $p2) &&
            !Microsoft.Crm.Client.Core.Framework.ObjectComparer.areValuesEqual($v_6, $p2)) {
            if (_Script.isUndefined($p3)) {
                $p3 = this.$Q_2($p0, $v_0, $p2);
            }
            if (_Script.isUndefined($p4)) {
                $p4 = this.$q_2($p0, $v_0, $p2);
            }
            this.$2H_2($v_0);
            this.$2P_2($p0, $v_0, $v_1, $p2, $p3, $p4);
    ...
    reformatValue: function(record, fieldName, allDayDisplay) {
        if (!_Script.isUndefined(allDayDisplay) &&
            !Microsoft.Crm.Client.Core.Framework._String.isNullOrWhiteSpace(fieldName)) {
            if (allDayDisplay) {
    ...
    getFieldValidator: function(fieldName, validatorType, isCreateExperience) {
        fieldName = Microsoft.Crm.Client.Core.Models.FormModel.removeFormat(fieldName);
        var $v_0 = Microsoft.Crm.Client.Core.Imported.MscrmComponents
            .deferredPromiseFactory(Microsoft.Crm.Client.Core.Models.Validation.IIsRequiredValidator,
                Microsoft.Crm.Client.Core.Framework.ErrorStatus);
                    ...
                    $$t_B.getFieldRequiredLevel(fieldName).then(function($p2_0) {
                            ...
                            if (!$v_1) {
                                ...
                                if ($v_2 && $p1_0.get_isSecured()) {
                                    $v_3 = isCreateExperience ||
                                        Microsoft.Crm.Client.Core.Storage.DataApi.DataSource.$4.$B_0
                                        .hasAttributeAccessRights($p1_0, 2, $$t_B.$0_2);
                                }
                                switch (validatorType) {
                                case 2:
                                    $v_1 = new Microsoft.Crm.Client.Core.Models.Validation
                                        .IntegerValidator($v_2,
                                            $v_3,
                                            Math.floor($p1_0.get_minValue()),
                                            Math.floor($p1_0.get_maxValue()));
                                    break;
                                case 3:
                                    $v_1 = new Microsoft.Crm.Client.Core.Models.Validation
                                        .DecimalValidator($v_2,
                                            $v_3,
                                            $$t_B.GetEffectiveMinValue(fieldName),
                                            $$t_B.GetEffectiveMaxValue(fieldName),
                                            $$t_B.GetEffectivePrecisionValue(fieldName));
                                    break;
                                case 4:
                                    $v_1 = new Microsoft.Crm.Client.Core.Models.Validation
                                        .MoneyValidator($v_2,
                                ...
                                case 7:
                                    $v_1 = new Microsoft.Crm.Client.Core.Models.Validation
                                        .CurrencyValidator($v_2, $v_3, false);
                                    break;
                                case 8:
                                    $v_1 = new Microsoft.Crm.Client.Core.Models.Validation
                                        .DateTimeValidator($v_2,
                                            $v_3,
                                            $$t_B.getAttributeBehavior(fieldName),
                                            $$t_B.GetMinDate(fieldName));
                                    break;
                                default:
                                    $v_1 = new Microsoft.Crm.Client.Core.Models.Validation
                                        .IsRequiredValidator($v_2, $v_3);
                                    break;
                                }
    ...
    getFieldMaxLength: function(fieldName) {
        fieldName = Microsoft.Crm.Client.Core.Models.FormModel.removeFormat(fieldName);
        var $v_0 = Microsoft.Crm.Client.Core.Imported.MscrmComponents
            .deferredPromiseFactory(Number, Microsoft.Crm.Client.Core.Framework.ErrorStatus);
    ...
    getFieldRequiredLevel: function(fieldName) {
        fieldName = Microsoft.Crm.Client.Core.Models.FormModel.removeFormat(fieldName);
        var $v_0 = Microsoft.Crm.Client.Core.Imported.MscrmComponents
            .deferredPromiseFactory(Microsoft.Crm.Client.Core.Framework.ValueRequiredLevel,
                Microsoft.Crm.Client.Core.Framework.ErrorStatus);
    ...
    onRecordChanged: function(sender, eventArgs) {
        if (!eventArgs.get_updateRecord() && !eventArgs.get_sourceStore()) {
            ...
            this.fireEventHandler('RecordUpdate',
                new Microsoft.Crm.Client.Core.Storage.DataApi
                .RecordUpdateEventArgs(eventArgs.get_retrieveState(), eventArgs.get_sourceStore()));
            return;
        }
        if (eventArgs.get_retrieveState() === 2) {
            ...
            if (!_Script.isNullOrUndefined(this.$a_2)) {
                var $v_0 = (_Script.isNullOrUndefined(eventArgs.get_errorStatus()))
                    ? Microsoft.Crm.Client.Core.Framework.ErrorStatus.fromErrorCode(0)
                    : eventArgs.get_errorStatus();
                this.$a_2($v_0);
            }
            this.dispose();
            return;
            ...
            this.$m_2 = 3;
            if (!_Script.isNullOrUndefined(this.$a_2)) {
                var $v_1 = (_Script.isNullOrUndefined(eventArgs.get_errorStatus()))
                    ? Microsoft.Crm.Client.Core.Framework.ErrorStatus.fromErrorCode(0)
                    : eventArgs.get_errorStatus();
                this.$a_2($v_1);
                return;
                ...
                throw Error.create(String
                    .format('OnRecordsChanged has failed in RecordModel, EventArgs.RetrieveState not Success. EventArgs.RetrieveState is {0}', Microsoft.Crm.Client.Core.Storage.DataApi.RetrieveState.toString(eventArgs.get_retrieveState())));
            }
        }
        if (this.$k_2 === 1) {
            if (!(Microsoft.Crm.Client.Core.Framework.DeviceConfiguration.get_isInteractionCentricDashboard() &&
    ...
    $3N_2: function($p0) {
        if (Microsoft.Crm.Client.Core.Storage.Common.OfflineState
            .isEntityOfflineEnabled($p0.get_identifier().LogicalName)) {
            for (var $$arr_1 = $p0.get_fieldNames(), $$len_2 = $$arr_1.length, $$idx_3 = 0;
                $$idx_3 < $$len_2;
                ++$$idx_3) {
                var $v_0 = $$arr_1[$$idx_3];
                switch ($p0.get_fieldTypes()[$v_0]) {
            ...
            if (!_Script.isNullOrUndefined($p0.getValue('scheduledstart'))) {
                $p0.get_formattedValues()['scheduledstart'] = this
                    .$Q_2($p0, 'scheduledstart', $p0.getValue('scheduledstart'));
            }
            if (!_Script.isNullOrUndefined($p0.getValue('scheduledend'))) {
                $p0.get_formattedValues()['scheduledend'] = this
                    .$Q_2($p0, 'scheduledend', $p0.getValue('scheduledend'));
            }
            if (!_Script.isNullOrUndefined($p0.getValue('actualdurationminutes'))) {
                $p0.get_formattedValues()['actualdurationminutes'] = this
                    .$Q_2($p0, 'actualdurationminutes', $p0.getValue('actualdurationminutes'));
            }
        }
    },
    ...
    $2P_2: function($p0, $p1, $p2, $p3, $p4, $p5) {
    ...
    getAttributeFormat: function(fieldName) {
        var $v_0 = this.$8_2.get_metadataCache()
            .getAttributeMetadata(this.$0_2.get_actionableIdentifier().LogicalName, fieldName);
    ...
    getFieldAttributeValues: function(fieldName, valueNames) {
        var $v_0 = Microsoft.Crm.Client.Core.Imported.MscrmComponents
            .deferredPromiseFactory(Object, Microsoft.Crm.Client.Core.Framework.ErrorStatus);
        var $$t_7 = this, $$t_8 = this;
        this.$1M_2(fieldName).then(function($p1_0) {
                var $v_1 = {};
                for (var $v_2 = 0; $v_2 < valueNames.length; $v_2++) {
                    $v_1[valueNames[$v_2]] = $$t_7.$2k_2(valueNames[$v_2], $p1_0);
                }
                $v_0.resolve($v_1);
            },
            function($p1_0) {
    ...
    $2k_2: function($p0, $p1) {
        ...
        case 'issecured':
            ...
            break;
        case 'type':
            $v_0 = (_Script.isNullOrUndefined($p1.get_type()))
                ? 'unknown'
                : Xrm.Objects.AttributeType.toString($p1.get_type()).toLowerCase();
            break;
        case 'format':
            $v_0 = $p1.get_format();
            break;
        ...
        case 'options':
            ...
            break;
        case 'defaultvalue':
            $v_0 = (_Script.isNullOrUndefined($p1.get_defaultValue()))
                ? $p1.get_defaultFormValue()
                : $p1.get_defaultValue();
            break;
        case 'precision':
    ...
    $1u_2: function($p0, $p1) {
        ...
        if ($p0.hasField('transactioncurrencyid') || $p0.hasFieldType(8)) {
            ...
            if (_Script.isNullOrUndefined($v_0) && $p1) {
                ...
                if (!_Script.isNullOrUndefined($v_1)) {
                    $v_0 = new Xrm.Objects.EntityReference('transactioncurrency',
                        $v_1.get_transactionCurrencyId(),
                        $v_1.get_currencyName());
                    $p0.get_fieldTypes()['transactioncurrencyid'] = 6;
                    this.$2H_2('transactioncurrencyid');
                    this.$2P_2($p0, 'transactioncurrencyid', null, $v_0, null, null);
                }
            }
    ...
    $1M_2: function($p0) {
        var $v_0 = Microsoft.Crm.Client.Core.Imported.MscrmComponents
            .deferredPromiseFactory(Microsoft.Crm.Client.Core.Storage.Common.IAttributeMetadata,
                Microsoft.Crm.Client.Core.Framework.ErrorStatus);
        ...
        this.$8_2.retrieveMultipleAttributeMetadata($v_3, this.get_$1Z_2()).then(function($p1_0) {
                $$t_C.$2V_2($v_1, $p0, $p1_0.get_item(0));
                $v_0.resolve($p1_0.get_item(0));
            },
            function($p1_0) {
                if (!_Script.isNullOrUndefined($$t_D.$2_2)) {
                    $v_3 = new Microsoft.Crm.Client.Core.Storage.DataApi
                        .AttributeMetadataQuery($$t_D.$2_2.get_actionableIdentifier().LogicalName, [$p0]);
                    ...
                    $$t_D.$0_2.get_actionableIdentifier().LogicalName !== $$t_D.$0_2.get_identifier().LogicalName) {
                    $v_3 = new Microsoft.Crm.Client.Core.Storage.DataApi
                        .AttributeMetadataQuery($$t_D.$0_2.get_identifier().LogicalName, [$p0]);
                    $$t_D.$8_2.retrieveMultipleAttributeMetadata($v_3, $$t_D.get_$1Z_2()).then(function($p2_0) {
                            $v_0.resolve($p2_0.get_item(0));
                        },
                        function($p2_0) {
...
Microsoft.Crm.Client.Core.Models.Validation.ICurrencyValidator
    .registerInterface('Microsoft.Crm.Client.Core.Models.Validation.ICurrencyValidator');


Microsoft.Crm.Client.Core.Models.Validation.IDateTimeValidator = function() {}
Microsoft.Crm.Client.Core.Models.Validation.IDateTimeValidator
    .registerInterface('Microsoft.Crm.Client.Core.Models.Validation.IDateTimeValidator');


Microsoft.Crm.Client.Core.Models.Validation.IDecimalValidator = function() {}
Microsoft.Crm.Client.Core.Models.Validation.IDecimalValidator
    .registerInterface('Microsoft.Crm.Client.Core.Models.Validation.IDecimalValidator');


Microsoft.Crm.Client.Core.Models.Validation.IIsRequiredValidator = function() {}
Microsoft.Crm.Client.Core.Models.Validation.IIsRequiredValidator
    .registerInterface('Microsoft.Crm.Client.Core.Models.Validation.IIsRequiredValidator');


Microsoft.Crm.Client.Core.Models.Validation.IMoneyValidator = function() {}
Microsoft.Crm.Client.Core.Models.Validation.IMoneyValidator
    .registerInterface('Microsoft.Crm.Client.Core.Models.Validation.IMoneyValidator');


Microsoft.Crm.Client.Core.Models.Validation
    .CurrencyValidator = function(isRequired, hasUserReadPermission, hasMoneyFieldValuesWithoutCurrency) {
        Microsoft.Crm.Client.Core.Models.Validation.CurrencyValidator
            .initializeBase(this, [isRequired, hasUserReadPermission]);
...
Microsoft.Crm.Client.Core.Models.Validation.CurrencyValidator.prototype = {
    ...
    validate: function(value, isValueChanging, isDisabled) {
        var $v_0 = Microsoft.Crm.Client.Core.Models.Validation.IsRequiredValidator.prototype.validate
            .call(this, value, false, isDisabled);
        if (isValueChanging || isDisabled) {
            return $v_0;
        }
        if ($v_0.get_isValueValid() &&
        (_Script.isNullOrUndefined(value) ||
            Microsoft.Crm.Client.Core.Framework._String.isNullOrWhiteSpace(value.toString()))) {
            $v_0.set_isValueValid(!this.$t_1);
            $v_0.set_errorMessage(($v_0.get_isValueValid())
                ? null
                : this.getLocalizedMessage('Error_Message_0x80048cfb'));
        }
        return $v_0;
    }
}
...
Microsoft.Crm.Client.Core.Models.Validation
    .DateTimeValidator = function(isRequired, hasUserReadPermission, behavior, minDate) {
...
Microsoft.Crm.Client.Core.Models.Validation.DateTimeValidator.prototype = {
    ...
    get_errorMessage: function() {
        return String.format(this.getLocalizedMessage('L_Decimal_Error_Message_FormatString_Text'),
            Microsoft.Crm.Client.Core.Storage.Common.CrmFormatter.get_instance()
            .formatShortDateTimeValue(this.$j_1, this.$c_1));
    },

    copy: function() {
        return new Microsoft.Crm.Client.Core.Models.Validation
            .DateTimeValidator(this.$A_0, this.$G_0, this.$c_1, this.$j_1);
    },
    ...
    validate: function(value, isValueChanging, isDisabled) {
        ...
        if ($v_0.get_isValueValid()) {
            ...
            var $v_2 = !Microsoft.Crm.Client.Core.Framework._String.isNullOrEmpty(value) &&
                Microsoft.Crm.Client.Core.Storage.Common.CrmFormatter.isDateTime(value) &&
                !isNaN((value).getTime());
            if ($v_2) {
                var $v_3 = Microsoft.Crm.Client.Core.Framework.UserDateTimeUtils
                    .convertTimeToBehaviorDisplay(value, 0, this.$c_1, null);
                $v_1 = $v_3 >= this.$j_1;
            } else {
                value = null;
            }
...
Microsoft.Crm.Client.Core.Models.Validation
    .DecimalValidator = function(isRequired, hasUserReadPermission, minValue, maxValue, precisionValue) {
...
Microsoft.Crm.Client.Core.Models.Validation.DecimalValidator.prototype = {
    ...
    get_errorMessage: function() {
        return String.format(this.getLocalizedMessage('L_Decimal_Error_Message_FormatString_Text'),
            Microsoft.Crm.Client.Core.Storage.Common.CrmFormatter.get_instance()
            .formatDecimalValue(this.$D_1, this.$R_1),
            Microsoft.Crm.Client.Core.Storage.Common.CrmFormatter.get_instance()
            .formatDecimalValue(this.$C_1, this.$R_1));
    },
    ...
    copy: function() {
        return new Microsoft.Crm.Client.Core.Models.Validation
            .DecimalValidator(this.$A_0, this.$G_0, this.$D_1, this.$C_1, this.$R_1);
    },
    ...
    validate: function(value, isValueChanging, isDisabled) {
        ...
        if ($v_0.get_isValueValid()) {
            ...
            var $v_2 = !Microsoft.Crm.Client.Core.Framework._String.isNullOrEmpty(value);
            if ($v_2) {
                var $v_3 = Microsoft.Crm.Client.Core.Storage.Common.CrmFormatter.get_instance()
                    .parseDecimalValue(value.toString(), this.$R_1);
...
Microsoft.Crm.Client.Core.Models.Validation.EmailAddressValidator.prototype = {
    ...
    $2x_1: function($p0) {
        var $v_0 = $p0;
        return Microsoft.Crm.Client.Core.Models.Validation.EmailAddressValidator.$1x.test($v_0) || this.$2y_1($v_0);
    },
    ...
    $2y_1: function($p0) {
        ...
        if (!$v_0 && $v_1 !== -1 && $v_1 > 1) {
            ...
            if (!Microsoft.Crm.Client.Core.Models.Validation.EmailAddressValidator.$20.test($v_2) &&
                Microsoft.Crm.Client.Core.Models.Validation.EmailAddressValidator.$1x.test($v_3)) {
                return true;
            }
        }
        return false;
...
Microsoft.Crm.Client.Core.Models.Validation
    .IntegerValidator = function(isRequired, hasUserReadPermission, minValue, maxValue) {
        Microsoft.Crm.Client.Core.Models.Validation.IntegerValidator
            .initializeBase(this, [isRequired, hasUserReadPermission]);
        this.$D_1 = minValue;
        this.$C_1 = maxValue;
        this.$1e_1 = String.format(this.getLocalizedMessage('L_Integer_Error_Message_FormatString_Text'),
            Microsoft.Crm.Client.Core.Storage.Common.CrmFormatter.get_instance().formatIntegerValue(this.$D_1),
            Microsoft.Crm.Client.Core.Storage.Common.CrmFormatter.get_instance().formatIntegerValue(this.$C_1));
    }
Microsoft.Crm.Client.Core.Models.Validation.IntegerValidator.prototype = {
    ...
    copy: function() {
        return new Microsoft.Crm.Client.Core.Models.Validation
            .IntegerValidator(this.$A_0, this.$G_0, this.$D_1, this.$C_1);
    },
    ...
    validate: function(value, isValueChanging, isDisabled) {
        ...
        if ($v_0.get_isValueValid()) {
            ...
            if ($v_2) {
                var $v_3 = Microsoft.Crm.Client.Core.Storage.Common.CrmFormatter.get_instance()
                    .parseIntegerValue(value.toString());
                var $v_4 = !_Script.isNullOrUndefined($v_3) && !isNaN($v_3);
                $v_1 = $v_4 && $v_3 >= this.$D_1 && $v_3 <= this.$C_1;
                value = ($v_1) ? $v_3 : value;
            } else {
    ...
    validate: function(value, isValueChanging, isDisabled) {
        ...
        if (!_Script.isNullOrUndefined(isDisabled) && isDisabled) {
            ...
            if (Microsoft.Crm.Client.Core.Framework.ICollection.isInstanceOfType(value)) {
                ...
                $v_2 = !_Script.isNullOrUndefined(value) &&
                    !Microsoft.Crm.Client.Core.Framework._String.isNullOrWhiteSpace(value.toString());
            }
            $v_0 = !this.$A_0 || $v_2;
        }
...
Microsoft.Crm.Client.Core.Models.Validation
    .MoneyValidator = function(isRequired,
        ...
        Microsoft.Crm.Client.Core.Models.Validation.MoneyValidator
            .initializeBase(this, [isRequired, hasUserReadPermission, minValue, maxValue, precisionValue]);
...
Microsoft.Crm.Client.Core.Models.Validation.MoneyValidator.prototype = {
    ...
    copy: function() {
        return new Microsoft.Crm.Client.Core.Models.Validation
            .MoneyValidator(this.$A_0, this.$G_0, this.$D_1, this.$C_1, this.$R_1, this.$s_2);
    },

    validate: function(value, isValueChanging, isDisabled) {
        var $v_0 = Microsoft.Crm.Client.Core.Models.Validation.DecimalValidator.prototype.validate
            .call(this, value, false, isDisabled);
        if (isValueChanging || isDisabled) {
            return $v_0;
        }
        if ($v_0.get_isValueValid() &&
            ...
            $v_0.set_errorMessage(($v_0
                    .get_isValueValid())
                ? null
                : this.getLocalizedMessage('Currency_Not_Specified'));
        }
        return $v_0;
    }
}
...
Microsoft.Crm.Client.Core.Models.Validation.UrlValidator.prototype = {
    ...
    $2J_1: function($p0) {
        if (!Microsoft.Crm.Client.Core.Models.Validation.UrlValidator.$2Q.test($p0)) {
            return 'http://' + $p0;
        }
        return $p0;
    },
...
Microsoft.Crm.Client.Core.Storage.DataApi.RetrieveState
    .registerEnum('Microsoft.Crm.Client.Core.Storage.DataApi.RetrieveState', false);
...
Microsoft.Crm.Client.Core.Storage.DataApi.RetrieveType
    .registerEnum('Microsoft.Crm.Client.Core.Storage.DataApi.RetrieveType', false);


Microsoft.Crm.Client.Core.Storage.DataApi.IDataSource = function() {}
Microsoft.Crm.Client.Core.Storage.DataApi.IDataSource
    .registerInterface('Microsoft.Crm.Client.Core.Storage.DataApi.IDataSource');
...
Microsoft.Crm.Client.Core.Storage.DataApi
    .DataRetrievedEventArgs$1 = function(key, data, retrieveState, store, errorStatus, updateRecord) {
        this.$1b_2 = ((this
                .$$gta['Microsoft.Crm.Client.Core.Storage.DataApi.DataRetrievedEventArgs$1']['T'] ===
                Number ||
                Type.isEnum(this.$$gta['Microsoft.Crm.Client.Core.Storage.DataApi.DataRetrievedEventArgs$1']['T']))
            ? 0
            : (this.$$gta['Microsoft.Crm.Client.Core.Storage.DataApi.DataRetrievedEventArgs$1']['T'] === Boolean)
            ? false
            : null);
        Microsoft.Crm.Client.Core.Storage.DataApi.DataRetrievedEventArgs$1
            .$$(this.$$gta['Microsoft.Crm.Client.Core.Storage.DataApi.DataRetrievedEventArgs$1']['T'])
            .initializeBase(this, ['retrieved', key]);
        this.$1b_2 = data;
...
Microsoft.Crm.Client.Core.Storage.DataApi.DataRetrievedEventArgs$1.$$ = function(T) {
    ...
    if (!Microsoft.Crm.Client.Core.Storage.DataApi[$$cn]) {
        var $$ccr = Microsoft.Crm.Client.Core.Storage.DataApi[$$cn] = function() {
            (this.$$gta = this
                .$$gta ||
                {})['Microsoft.Crm.Client.Core.Storage.DataApi.DataRetrievedEventArgs$1'] = { 'T': T };
            var $v_0 = [];
        ...
        $$ccr.registerClass('Microsoft.Crm.Client.Core.Storage.DataApi.' + $$cn,
            Microsoft.Crm.Client.Core.Storage.DataApi.DataOperationEventArgs);
...
Microsoft.Crm.Client.Core.Storage.DataApi.DataRetrievingEventArgs$1 = function(key) {
    Microsoft.Crm.Client.Core.Storage.DataApi.DataRetrievingEventArgs$1
        .$$(this.$$gta['Microsoft.Crm.Client.Core.Storage.DataApi.DataRetrievingEventArgs$1']['T'])
        .initializeBase(this, ['retrieving', key]);
}
Microsoft.Crm.Client.Core.Storage.DataApi.DataRetrievingEventArgs$1.$$ = function(T) {
    ...
    if (!Microsoft.Crm.Client.Core.Storage.DataApi[$$cn]) {
        var $$ccr = Microsoft.Crm.Client.Core.Storage.DataApi[$$cn] = function() {
            (this.$$gta = this
                .$$gta ||
                {})['Microsoft.Crm.Client.Core.Storage.DataApi.DataRetrievingEventArgs$1'] = { 'T': T };
            var $v_0 = [];
            for (var $v_1 = 0; $v_1 < arguments.length; ++$v_1) {
                $v_0[$v_1] = arguments[$v_1];
            }
...
Microsoft.Crm.Client.Core.Storage.DataApi.MetadataCache = function(dataSource) {
    this.$8_0 = dataSource;
    this.$7_0 = new (Microsoft.Crm.Client.Core.Framework.TypedDictionary$1
        .$$(Microsoft.Crm.Client.Core.Storage.Common.EntityAttributeMetadataPair))();
    this.$1J_0 = new (Microsoft.Crm.Client.Core.Framework.TypedDictionary$1
        .$$(Microsoft.Crm.Client.Core.Storage.Common.EntityAttributeMetadataPair))();
    this.$1K_0 = new (Microsoft.Crm.Client.Core.Framework.TypedDictionary$1
        .$$(Microsoft.Crm.Client.Core.Storage.Common.EntityAttributeMetadataPair))();
    this.$13_0 = {};
}
Microsoft.Crm.Client.Core.Storage.DataApi.MetadataCache.prototype = {
    ...
    cacheEntityMetadata: function(entityMetadata) {
        if (!_Script.isNullOrUndefined(entityMetadata)) {
            var $v_0 = new Microsoft.Crm.Client.Core.Storage.Common
                .EntityAttributeMetadataPair(entityMetadata,
                    new Microsoft.Crm.Client.Core.Storage.Common.ObjectModel
                    .AttributeMetadataCollection(entityMetadata.get_logicalName()));
    ...
    cacheAttributeMetadata: function(entityLogicalName, allAttributes, attributeMetadata) {
        ...
        this.$7_0.get_item(entityLogicalName).get_attributeMetadataCollection()
            .mergeAttributeMetadata(attributeMetadata.toArray(), allAttributes);
    },
...
Microsoft.Crm.Client.Core.Storage.DataApi.DataSource.initialize = function() {
    if (!_Script.isNullOrUndefined(Microsoft.Crm.Client.Core.Storage.DataApi.DataSource.$J) &&
        Microsoft.Crm.Client.Core.Storage.DataApi.DataSource.$J.state() !== 'rejected') {
    ...
    $v_0.start();
    Microsoft.Crm.Client.Core.Storage.DataApi.DataSource.$J = Microsoft.Crm.Client.Core.Imported.MscrmComponents
        .deferredPromiseFactory(Boolean, Microsoft.Crm.Client.Core.Framework.ErrorStatus);
    ...
    Xrm.Internal.messages.retrieveWebClientUserContext().done(function($p1_0) {
        if (!$p1_0.$1B_0) {
            Microsoft.Crm.Client.Core.Storage.DataApi.DataSource.$J
                .reject(Microsoft.Crm.Client.Core.Framework.ErrorStatus.fromMessage($p1_0.get_errorMessage()));
            return;
        }
        var $v_2 = $p1_0.$1D_1;
        var $v_3 = $v_2.get_externalContext()['timezonedefinitionbycode'];
        Microsoft.Crm.Client.Core.Storage.Formatting.CrmNumericFormatter.$Z = new Microsoft.Crm.Client.Core.Storage
            .Formatting.CrmNumericFormatter($v_3);
        Microsoft.Crm.Client.Core.Storage.Common.CrmFormatter
            .set_instance(new Microsoft.Crm.Client.Core.Storage.Common
                .CrmFormatter($v_2.get_timeZoneUtcOffsetMinutes(), $v_2.get_timeZoneAdjusters()));
        Microsoft.Crm.Client.Core.Storage.DataApi.DataSource.$4 = new Microsoft.Crm.Client.Core.Storage.DataApi
            .DataSource($v_2);
        Microsoft.Crm.Client.Core.Storage.DataApi.DataSource.$J.resolve(true);
    }).fail(function($p1_0) {
        Microsoft.Crm.Client.Core.Storage.DataApi.DataSource.$J
            .reject(Microsoft.Crm.Client.Core.Framework.ErrorStatus
                .fromMessage($p1_0.get_localizedMessage() || $p1_0.get_message()));
    });
    return Microsoft.Crm.Client.Core.Storage.DataApi.DataSource.$J.promise();
}
Microsoft.Crm.Client.Core.Storage.DataApi.DataSource.$2j = function($p0) {
...
Microsoft.Crm.Client.Core.Storage.DataApi.DataSource.$1l = function($p0, $p1, $p2) {
    return Microsoft.Crm.Client.Core.Framework.ErrorStatus
        .fromErrorData(new Microsoft.Crm.Client.Core.Framework
            .ErrorData($p1, '[CrmServerDataSource - ' + $p0 + '] ' + $p2));
}
Microsoft.Crm.Client.Core.Storage.DataApi.DataSource.prototype = {
    ...
    retrieveMultipleAttributeMetadata: function(query, context) {
        var $v_0 = Microsoft.Crm.Client.Core.Imported.MscrmComponents
            .deferredPromiseFactory(Microsoft.Crm.Client.Core.Framework.CallbackSafeArray$1
                .$$(Microsoft.Crm.Client.Core.Storage.Common.IAttributeMetadata),
                Microsoft.Crm.Client.Core.Framework.ErrorStatus);
        var $v_1;
        var $v_2;
        var $$t_P, $$t_Q, $$t_R;
        var $v_3 = (($$t_R = this.$3L_0(query, ($$t_P = { 'val': $v_1 }), ($$t_Q = { 'val': $v_2 }))), $v_1 = $$t_P
            .val, $v_2 = $$t_Q.val, $$t_R);
        if ($v_3) {
            return $v_0.resolve(new (Microsoft.Crm.Client.Core.Framework.CallbackSafeArray$1
                .$$(Microsoft.Crm.Client.Core.Storage.Common.IAttributeMetadata))($v_1));
        }
        var $v_4 = {};
        ...
        var $v_5 = new Microsoft.Crm.Client.Core.Storage.DataApi
            .AttributeMetadataQuery(query.get_entityLogicalName(), $v_2);
        var $$t_S = this, $$t_T = this;
        Xrm.Internal.messages.retrieveMultipleAttributeMetadata($v_5, this.$B_0.get_UserSettings().get_languageId())
            .then(function($p1_0) {
                    if ($p1_0.$L_1.get_length() > 0) {
                        var $v_7 = $p1_0.$L_1.toArray();
                        $$t_S.$I_0.cacheAttributeMetadata(query.get_entityLogicalName(),
                            _Script.isNullOrUndefined(query.get_attributeNames()),
                            new (Microsoft.Crm.Client.Core.Framework.CallbackSafeArray$1
                                .$$(Microsoft.Crm.Client.Core.Storage.Common.IAttributeMetadata))($v_7));
                        ...
                        if (_Script.isNullOrUndefined(query.get_attributeNames())) {
                            ...
                            $v_8 = new Array(0);
                            for (var $$arr_J = query.get_attributeNames(), $$len_K = $$arr_J.length, $$idx_L = 0;
                                $$idx_L < $$len_K;
                                ++$$idx_L) {
                                var $v_A = $$arr_J[$$idx_L];
                                $v_8.push($v_4[$v_A]);
                        ...
                        $v_0.resolve(new (Microsoft.Crm.Client.Core.Framework.CallbackSafeArray$1
                            .$$(Microsoft.Crm.Client.Core.Storage.Common.IAttributeMetadata))($v_8));
                    } else {
                        $v_0.reject(Microsoft.Crm.Client.Core.Storage.DataApi.DataSource
                            .$1l('RetrieveMultipleAttributeMetadata',
                                0,
                                'Entity ' +
                                query.get_entityLogicalName() +
                                ' has none of the AttributeMetadata requested: ' +
                                query.get_attributeNames()));
                    }
                },
                function($p1_0) {
                    var $v_B = Microsoft.Crm.Client.Core.Framework.ErrorStatus.fromMessage($p1_0.get_message());
                    $v_0.reject(Microsoft.Crm.Client.Core.Storage.DataApi.DataSource.$2j($p1_0));
                });
        return $v_0.promise();
    },
    ...
    retrieveRecordRelatedEntities: function(entityMetadata, source, identifier, columnSet, record) {
        ...
        var $v_1 = new Array(0);
        var $$t_A = this;
        this.$2W_0(entityMetadata,
            columnSet,
            null,
            function($p1_0) {
                if (Microsoft.Crm.Client.Core.Storage.Common.ObjectModel.EntityMetadata
                    .hasAccessRights(identifier.LogicalName, $$t_A.$I_0)) {
                    $v_1.push(new Xrm.Gen
                        .RetrievePrincipalAccessRequest(identifier,
                            new Xrm.Objects.EntityReference('systemuser',
                                Microsoft.Crm.Client.Core.Storage.DataApi.DataSource.$4.$B_0.get_userId())));
                }
                if (!$p1_0) {
                    $v_1.push(new Xrm.Gen.RetrieveMultipleRequest($$t_A.$2w_0(identifier)));
                }
                if (!$v_1.length) {
                    $v_0.resolve(true);
                    return;
                }
                Xrm.Internal.messages.execute(new Xrm.Gen
                        .ExecuteMultipleRequest($v_1, new Xrm.Gen.ExecuteMultipleSettings(false, true)))
                    .then(function($p2_0) {
                            $$t_A.$2Y_0($p2_0, source, $v_0, record);
                        },
                        function($p2_0) {
                            $v_0.reject(Microsoft.Crm.Client.Core.Framework.ErrorStatus
                                .fromMessage($p2_0.get_localizedMessage() || $p2_0.get_message()));
                        });
            });
        return $v_0.promise();
    },

    $2Y_0: function($p0, $p1, $p2, $p3) {
        var $v_0 = $p0;
        if ($v_0.isFaulted) {
            var $v_1 = null;
            for (var $$arr_6 = $v_0.responses, $$len_7 = $$arr_6.length, $$idx_8 = 0; $$idx_8 < $$len_7; ++$$idx_8) {
                ...
                if (!_Script.isNullOrUndefined($v_2) && !_Script.isNullOrUndefined($v_2.get_fault())) {
                    var $v_3 = Microsoft.Crm.Client.Core.Storage.DataApi.DataSource
                        .$1l($p1,
                            $v_2.get_fault().get_errorCode(),
                            'ExecuteMultiple faulted with message: ' + $v_2.get_fault().get_message());
                    if (_Script.isNullOrUndefined($v_1)) {
                        $v_1 = $v_3;
                        break;
                    }
            ...
            if (!_Script.isNullOrUndefined($v_1)) {
                ...
                $p2.reject(Microsoft.Crm.Client.Core.Storage.DataApi.DataSource
                    .$1l($p1, 0, 'ExecuteMultiple faulted with unknown fault'));
            }
        } else {
            var $v_4 = null;
            var $v_5 = null;
            ...
            if (!_Script.isNullOrUndefined($v_5)) {
                $p3.set_userSharedAttributePrivileges(this.$2v_0($v_5.entityCollection));
            }
            $p2.resolve(true);
        }
    },

    $2W_0: function($p0, $p1, $p2, $p3) {
        if ($p0.get_hasSecuredAttributes()) {
            var $v_0 = null;
            if (Microsoft.Crm.Client.Core.Storage.Common.ColumnSet.isInstanceOfType($p1)) {
                $v_0 = ($p1).get_columns();
            }
            var $v_1 = Microsoft.Crm.Client.Core.Storage.DataApi.DataSource.$4.$I_0
                .getMultipleAttributeMetadata($p0.get_logicalName(), $v_0);
            if (_Script.isNullOrUndefined($v_1) || $v_1.length !== $v_0.length) {
                var $$t_8 = this, $$t_9 = this;
                Microsoft.Crm.Client.Core.Storage.DataApi.DataSource.$4
                    .retrieveMultipleAttributeMetadata(new Microsoft.Crm.Client.Core.Storage.DataApi
                        .AttributeMetadataQuery($p0.get_logicalName(), $v_0),
                        $p2).then(function($p1_0) {
                            $p3($$t_8.$21_0($p1_0));
                        },
                        function($p1_0) {
                            $p3(false);
                ...
                $p3(this.$21_0(new (Microsoft.Crm.Client.Core.Framework.CallbackSafeArray$1
                    .$$(Microsoft.Crm.Client.Core.Storage.Common.IAttributeMetadata))($v_1)));
            }
        } else {
            $p3(true);
    ...
    $21_0: function($p0) {
        ...
        for (var $v_1 = 0; $v_1 < $p0.get_length(); $v_1++) {
            if ($p0.get_item($v_1).get_isSecured()) {
                var $v_2 = Microsoft.Crm.Client.Core.Storage.DataApi.DataSource.$4.$B_0.get_attributePrivileges()
                    .get_item($p0.get_item($v_1).get_id().toString());
    ...
    $2v_0: function($p0) {
        var $v_0 = new (Microsoft.Crm.Client.Core.Framework.TypedDictionary$1
            .$$(Microsoft.Crm.Client.Core.Storage.Common.ObjectModel.AttributePrivilege))();
        ...
        for (var $v_1 = 0; $v_1 < $p0.get_count(); $v_1++) {
            var $v_2 = new Microsoft.Crm.Client.Core.Storage.Common.ObjectModel
                .AttributePrivilege($p0.get_item($v_1).getValue('attributeid'),
                    false,
                    ($p0.get_item($v_1).getValue('readaccess')).get_value() === 1,
                    ($p0.get_item($v_1).getValue('updateaccess')).get_value() === 1);
            $v_0.set_item($v_2.get_attributeId().toString(), $v_2);
        }
        return $v_0;
    },

    $3L_0: function($p0, $p1, $p2) {
        ...
        if ($v_1 && $v_2 || !$v_1 && !_Script.isNullOrUndefined($v_0) && $v_0.length === $p0.get_attributeNames().length
            ...
            for (var $$arr_B = $p0.get_attributeNames(), $$len_C = $$arr_B.length, $$idx_D = 0;
                $$idx_D < $$len_C;
                ++$$idx_D) {
                var $v_5 = $$arr_B[$$idx_D];
                if ((($v_5) in $v_3)) {
...
Microsoft.Crm.Client.Core.Storage.DataApi.TimeZoneAdjustersResponse = function(response) {
    ...
    for (var $$arr_2 = $v_0, $$len_3 = $$arr_2.length, $$idx_4 = 0; $$idx_4 < $$len_3; ++$$idx_4) {
        var $v_1 = $$arr_2[$$idx_4];
        var $v_2 = Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.JsonSerializers.TimeZoneAdjusterSerializer
            .loadFromJson($v_1);
        this.$1C_0.push($v_2);
    }
}
...
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.ICrmSoapService
    .registerInterface('Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.ICrmSoapService');


Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy
    .CrmSoapService = function(serverUri, authenticationManager, callerOriginProvider) {
        Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapService
            .initializeBase(this, [serverUri, authenticationManager, callerOriginProvider]);
        Microsoft.Crm.Client.Core.Framework.Utils.ExceptionHelpers
            .throwOnNullOrUndefinedArgument(serverUri, 'serverUri');
        this.$x_1 = 0;
        this.$H_1 = this.$F_0 + '/XRMServices/2011/Organization.svc/web';
        this.$1I_1 = this.$F_0 + '/AppWebServices/ApplicationMetadataService.asmx/';
        this.$l_1 = this.$F_0 + '/AppWebServices/ProcessControl.asmx/';
...
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapService.get_$1d = function() {
    return Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapService.get_$2L() +
        ((Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapService.get_$2F())
            ? ''
            : '<d:string>Attributes</d:string>') +
        '<d:string>DisplayCollectionName</d:string>' +
        '<d:string>DisplayName</d:string>' +
        '<d:string>IsActivity</d:string>' +
        '<d:string>IsActivityParty</d:string>' +
        '<d:string>IsChildEntity</d:string>' +
        '<d:string>IsConnectionsEnabled</d:string>' +
        '<d:string>IsCustomEntity</d:string>' +
        '<d:string>IsCustomizable</d:string>' +
        '<d:string>IsEnabledForCharts</d:string>' +
        '<d:string>IsImportable</d:string>' +
        '<d:string>IsMailMergeEnabled</d:string>' +
        '<d:string>IsReadOnlyInMobileClient</d:string>' +
        '<d:string>IsVisibleInMobileClient</d:string>' +
        '<d:string>IsOfflineInMobileClient</d:string>' +
        '<d:string>IsOptimisticConcurrencyEnabled</d:string>' +
        '<d:string>IsValidForAdvancedFind</d:string>' +
        '<d:string>ManyToOneRelationships</d:string>' +
        '<d:string>OneToManyRelationships</d:string>' +
        '<d:string>ObjectTypeCode</d:string>' +
        '<d:string>PrimaryIdAttribute</d:string>' +
        '<d:string>IsStateModelAware</d:string>' +
        '<d:string>EnforceStateTransitions</d:string>' +
        '<d:string>PrimaryNameAttribute</d:string>' +
        '<d:string>Privileges</d:string>' +
        '<d:string>IsValidForQueue</d:string>' +
        '<d:string>ActivityTypeMask</d:string>' +
        '<d:string>OwnershipType</d:string>' +
        '<d:string>IsBusinessProcessEnabled</d:string>' +
        '<d:string>IsDocumentManagementEnabled</d:string>' +
        '<d:string>EntityColor</d:string>' +
        '<d:string>IsInteractionCentricEnabled</d:string>' +
        '<d:string>IsQuickCreateEnabled</d:string>' +
        '<d:string>IsKnowledgeManagementEnabled</d:string>' +
        '<d:string>IsDocumentRecommendationsEnabled</d:string>' +
        '<d:string>IsIntersect</d:string>' +
        '<d:string>UsesBusinessDataLabelTable</d:string>';
}
...
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapService.prototype = {
    ...
    retrieveWebClientUserContext: function() {
        ...
        var $v_1 = Microsoft.Crm.Client.Core.Imported.MscrmComponents
            .deferredPromiseFactory(Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.JsonResponses
                .UserContextResponse,
                Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.Responses.CrmErrorResponse);
        var $$t_4 = this, $$t_5 = this;
        this.executeJsonRequest(Microsoft.Crm.Client.Core.Storage.WebService.WebServiceBase.RequestData
            .create($v_0, '', this.createJsonRequestOptions($v_0))).then(function($p1_0) {
                if (!_Script.isNullOrUndefined($p1_0) && !_Script.isNullOrUndefined($p1_0['d'])) {
                    ($p1_0['d'])['FullServerVersion'] = $$t_4.$v_1;
                }
                $v_1.resolve($$t_4.$2a_1($p1_0,
                    Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.JsonResponses.UserContextResponse));
            },
            function($p1_0) {
                $v_1.reject($p1_0);
            });
    ...
    execute: function(request, context, doAuthentication) {
        var $v_0 = Microsoft.Crm.Client.Core.Imported.MscrmComponents
            .deferredPromiseFactory(Xrm.Sdk.Response,
                Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.Responses.CrmErrorResponse);
        var $v_1;
        var $v_2;
        var $v_3;
        if (request.name === 'ScriptError') {
            ...
            $v_3 = this.$H_1;
            $v_1 = this.createCrmExecuteRequestBody(request.name,
                request.name + 'Request',
                Xrm.Soap.Serializer.parametersToCrmSoap(request),
                'b',
                request.xmlNamespace);
            $v_2 = 'http://schemas.microsoft.com/xrm/2011/Contracts/Services/IOrganizationService/Execute';
        }
        var $v_4 = null;
        if (request.name === 'ExecuteMultiple') {
            $v_4 = new Array(0);
            for (var $$arr_8 = (request)
                         .requests,
                $$len_9 = $$arr_8.length,
                $$idx_A = 0;
                $$idx_A < $$len_9;
        ...
        this.executeSoapRequest(Microsoft.Crm.Client.Core.Storage.WebService.WebServiceBase.RequestData
            .create(request.name, $v_1, $v_5, context, $v_4)).then(function($p1_0) {
    ...
    executeExternalSearch: function(requestData, context) {
        ...
        this.executeJsonRequest(Microsoft.Crm.Client.Core.Storage.WebService.WebServiceBase.RequestData
                .create(this.$1L_1, requestData, this.createJsonRequestOptions(this.$1L_1, 'GET'), context))
            .then(function($p1_0) {
                    $v_0.resolve($p1_0);
                },
                function($p1_0) {
    ...
    retrieveUserLocalFacets: function(requestData, context) {
        var $v_0 = Microsoft.Crm.Client.Core.Imported.MscrmComponents
            .deferredPromiseFactory(Object,
                Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.Responses.CrmErrorResponse);
        var $v_1 = this.$1n_1;
        var $v_2 = 'http://schemas.microsoft.com/crm/2009/WebServices/GetLocalFacets';
        var $v_3 = this
            .createSoapRequestBody('<GetLocalFacets xmlns=\"http://schemas.microsoft.com/crm/2009/WebServices\"><entityName>' + requestData + '</entityName></GetLocalFacets>');
        var $v_4 = this.createSoapRequestOptions($v_1, $v_2);
        var $$t_A = this, $$t_B = this;
        this.executeSoapRequest(Microsoft.Crm.Client.Core.Storage.WebService.WebServiceBase.RequestData
            .create('GetLocalFacets', $v_3, $v_4)).then(function($p1_0) {
                var $v_5 = $p1_0.childNodes().get_item(0).childNodes().get_item(0).childNodes().get_item(0).childNodes()
                    .get_item(0);
    ...
    executeXml: function(requestName, requestParameters, context, doAuthentication) {
        var $v_0 = Microsoft.Crm.Client.Core.Imported.MscrmComponents
            .deferredPromiseFactory(Xrm.Sdk.Response,
                Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.Responses.CrmErrorResponse);
        var $v_1 = this.$H_1;
        var $v_2 = this.createCrmExecuteRequestBody(requestName,
            requestName + 'Request',
            requestParameters,
            'b',
        ...
        var $$t_F = this, $$t_G = this;
        this.executeSoapRequest(Microsoft.Crm.Client.Core.Storage.WebService.WebServiceBase.RequestData
            .create(requestName, $v_2, $v_5, context, $v_4)).then(function($p1_0) {
    ...
    retrieve: function(identifier, columnSet, relatedEntitiesQuery, context) {
        var $v_0 = 'Retrieve';
        var $v_1 = this.createCrmExecuteRequestBody($v_0,
            $v_0 + 'Request',
            Xrm.Soap.EntityRecordSerializer.fieldToCrmSoap('Target', identifier, 6) +
            Xrm.Soap.EntityRecordSerializer.fieldToCrmSoap('ColumnSet', columnSet, -1, 'a:ColumnSet') +
            Xrm.Soap.EntityRecordSerializer.fieldToCrmSoap('RelatedEntitiesQuery',
                relatedEntitiesQuery,
                -1,
                'a:RelationshipQueryCollection'));
        var $v_2 = Microsoft.Crm.Client.Core.Imported.MscrmComponents
            .deferredPromiseFactory(Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.Responses
        ...
        this.executeSoapRequest(Microsoft.Crm.Client.Core.Storage.WebService.WebServiceBase.RequestData
            .create($v_0,
                $v_1,
                this.createSoapRequestOptions(this.$H_1,
                    'http://schemas.microsoft.com/xrm/2011/Contracts/Services/IOrganizationService/Execute'),
                context)).then(function($p1_0) {
                $v_2.resolve(new Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.Responses
                    .RetrieveEntityResponse($p1_0, columnSet, relatedEntitiesQuery));
            },
            function($p1_0) {
                $v_2.reject($p1_0);
            });
    ...
    create: function(entity, suppressDuplicateDetection, context) {
        var $v_0 = Microsoft.Crm.Client.Core.Imported.MscrmComponents
            .deferredPromiseFactory(Xrm.Gen.CreateResponse,
                Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.Responses.CrmErrorResponse);
    ...
    deleteEntity: function(identifier, context) {
        var $v_0 = 'Delete';
        var $v_1 = this.$2Z_1($v_0,
            '<entityName>' +
            Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.EncodeDecode.xmlEncode(identifier.LogicalName) +
            '</entityName>' +
            '<id>' +
            Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.EncodeDecode.xmlEncode(identifier.Id.toString()) +
            '</id>');
        var $v_2 = Microsoft.Crm.Client.Core.Imported.MscrmComponents
            .deferredPromiseFactory(Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.Responses
    ...
    retrieveMetadataChanges: function(clientVersionStamp, languageCode) {
        ...
        var $v_1 = Microsoft.Crm.Client.Core.Imported.MscrmComponents
            .deferredPromiseFactory(Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.Responses
                ...
                Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.Responses.CrmErrorResponse);
        var $v_2 = this.createSoapRequestOptions(this.$H_1,
            'http://schemas.microsoft.com/xrm/2011/Contracts/Services/IOrganizationService/Execute');
        $v_2.dataType = 'text';
        var $$t_7 = this, $$t_8 = this;
        this.executeSoapRequest(Microsoft.Crm.Client.Core.Storage.WebService.WebServiceBase.RequestData
            .create('RetrieveMetadataChanges', $v_0, $v_2)).then(function($p1_0) {
                $v_1.resolve(new Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.Responses
                    .RetrieveMetadataChangesResponse($p1_0));
            },
            function($p1_0) {
                $v_1.reject($p1_0);
            });
    ...
    retrieveMultipleEntityMetadata: function(languageCode, columnSet, entities, context) {
        ...
        if (_Script.isNullOrUndefined(columnSet) ||
            Microsoft.Crm.Client.Core.Storage.Common.AllColumns.isInstanceOfType(columnSet)) {
            ...
            for (var $$arr_5 = (columnSet).get_columns(), $$len_6 = $$arr_5.length, $$idx_7 = 0;
                $$idx_7 < $$len_6;
                ++$$idx_7) {
                var $v_4 = $$arr_5[$$idx_7];
        ...
        if (_Script.isNullOrUndefined(entities) || !entities.length) {
            ...
            for (var $$arr_A = entities, $$len_B = $$arr_A.length, $$idx_C = 0; $$idx_C < $$len_B; ++$$idx_C) {
                var $v_5 = $$arr_A[$$idx_C];
                $v_1 +=
                    '<c:MetadataConditionExpression><c:ConditionOperator>Equals</c:ConditionOperator><c:PropertyName>LogicalName</c:PropertyName><c:Value i:type=\"d:string\" xmlns:d=\"http://www.w3.org/2001/XMLSchema\">' + Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.EncodeDecode.xmlEncode($v_5) + '</c:Value>' + '</c:MetadataConditionExpression>';
            }
            $v_1 += '</c:Conditions><c:FilterOperator>Or</c:FilterOperator><c:Filters /></c:Criteria>';
        }
        var $v_2 = this.createCrmExecuteRequestBody('RetrieveMetadataChanges',
            'RetrieveMetadataChangesRequest',
            '<a:KeyValuePairOfstringanyType><b:key>Query</b:key><b:value i:type=\"c:EntityQueryExpression\" xmlns:c=\"http://schemas.microsoft.com/xrm/2011/Metadata/Query\">' + $v_1 + '<c:Properties>' + '<c:AllProperties>false</c:AllProperties>' + '<c:PropertyNames xmlns:d=\"http://schemas.microsoft.com/2003/10/Serialization/Arrays\">' + $v_0 + '</c:PropertyNames>' + '</c:Properties>' + '<c:AttributeQuery i:nil=\"true\" />' + '<c:LabelQuery>' + '<c:FilterLanguages xmlns:d=\"http://schemas.microsoft.com/2003/10/Serialization/Arrays\">' + '<d:int>' + languageCode + '</d:int>' + '</c:FilterLanguages>' + '<c:MissingLabelBehavior>1</c:MissingLabelBehavior>' + '</c:LabelQuery>' + '<c:RelationshipQuery i:nil=\"true\" />' + '</b:value>' + '</a:KeyValuePairOfstringanyType>');
        var $v_3 = Microsoft.Crm.Client.Core.Imported.MscrmComponents
            .deferredPromiseFactory(Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.Responses
                .RetrieveMetadataChangesResponse,
                Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.Responses.CrmErrorResponse);
        var $$t_I = this, $$t_J = this;
        this.executeSoapRequest(Microsoft.Crm.Client.Core.Storage.WebService.WebServiceBase.RequestData
            .create('RetrieveMetadataChanges',
                $v_2,
                this.createSoapRequestOptions(this.$H_1,
                    'http://schemas.microsoft.com/xrm/2011/Contracts/Services/IOrganizationService/Execute'),
                context)).then(function($p1_0) {
                $v_3.resolve(new Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.Responses
                    .RetrieveMetadataChangesResponse($p1_0));
            },
            function($p1_0) {
                $v_3.reject($p1_0);
    ...
    retrieveMultipleAttributeMetadata: function(query, languageCode, context) {
        ...
        this.executeSoapRequest(Microsoft.Crm.Client.Core.Storage.WebService.WebServiceBase.RequestData
            .create('RetrieveMetadataChanges',
                ...
                context)).then(function($p1_0) {
                $v_1.resolve(new Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.Responses
                    .RetrieveMultipleAttributeMetadataResponse($p1_0));
            },
            function($p1_0) {
                $v_1.reject($p1_0);
            });
    ...
    retrieveNavigationEntities: function(currentEntityId,
        referencedEntityLogicalName,
        referencingEntityLogicalName,
        referencingEntityAttributeName,
        context) {
        var $v_0 = this.$l_1 + 'GetForwardNavigationEntities';
        var $v_1 = JSON.stringify({
            currentEntityId: currentEntityId,
            referencedEntityLogicalName: referencedEntityLogicalName,
            referencingEntityLogicalName: referencingEntityLogicalName,
            referencingEntityAttributeName: referencingEntityAttributeName
        });
        var $v_2 = Microsoft.Crm.Client.Core.Imported.MscrmComponents
            .deferredPromiseFactory(Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.JsonResponses.JsonResponse,
                Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.Responses.CrmErrorResponse);
        var $$t_A = this, $$t_B = this;
        this.executeJsonRequest(Microsoft.Crm.Client.Core.Storage.WebService.WebServiceBase.RequestData
            .create($v_0, $v_1, this.createJsonRequestOptions($v_0), context)).then(function($p1_0) {
    ...
    changeProcessAndStage: function(currentEntityId,
        ...
        var $v_1 = JSON.stringify({
            currentEntityId: currentEntityId,
            currentEntityTypeName: currentEntityLogicalName,
            newProcessId: newProcessId,
            newProcessInstanceId: newProcessInstanceId,
            newStageId: newStageId,
            traversedPath: newTraversalPath
        });
        var $v_2 = Microsoft.Crm.Client.Core.Imported.MscrmComponents
            .deferredPromiseFactory(Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.JsonResponses.JsonResponse,
                Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.Responses.CrmErrorResponse);
    ...
    createNavigationEntity: function(sourceEntityLogicalName,
        sourceEntityId,
        ...
        var $v_1 = JSON.stringify({
            sourceEntityLogicalName: sourceEntityLogicalName,
            sourceEntityId: sourceEntityId.toString(),
            targetEntityLogicalName: targetEntityLogicalName,
            targetEntityAttributeName: targetEntityAttribute
        });
        var $v_2 = Microsoft.Crm.Client.Core.Imported.MscrmComponents
            .deferredPromiseFactory(Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.JsonResponses.JsonResponse,
                Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.Responses.CrmErrorResponse);
    ...
    $2D_1: function($p0, $p1, $p2) {
        var $v_0 = '<a:KeyValuePairOfstringanyType><b:key>ClientVersionStamp</b:key>' +
            ((!_Script.isNullOrUndefined($p0))
                ? ('<b:value i:type=\"c:string\" xmlns:c=\"http://www.w3.org/2001/XMLSchema\">' +
                    Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.EncodeDecode.xmlEncode($p0) +
                    '</b:value>')
                : '<b:value i:nil=\"true\" />') +
            '</a:KeyValuePairOfstringanyType>' +
            '<a:KeyValuePairOfstringanyType>' +
            '<b:key>DeletedMetadataFilters</b:key>' +
            '<b:value i:type=\"c:DeletedMetadataFilters\" xmlns:c=\"http://schemas.microsoft.com/xrm/2011/Metadata/Query\">Entity Attribute Relationship Label OptionSet</b:value>' +
            '</a:KeyValuePairOfstringanyType>' +
            '<a:KeyValuePairOfstringanyType>' +
            '<b:key>Query</b:key>' +
    ...
    createCrmExecuteRequestBody: function(requestName,
        ...
        if (requestName === 'RetrieveRecordWall') {
            $v_0 =
                '<Execute xmlns=\"http://schemas.microsoft.com/xrm/2011/Contracts/Services\"><request i:type=\"a:OrganizationRequest\" xmlns:a=\"http://schemas.microsoft.com/xrm/2011/Contracts\" xmlns:i=\"http://www.w3.org/2001/XMLSchema-instance\">';
        } else {
            $v_0 =
                '<Execute xmlns=\"http://schemas.microsoft.com/xrm/2011/Contracts/Services\" xmlns:i=\"http://www.w3.org/2001/XMLSchema-instance\"><request i:type=\"' + requestNamespaceAlias + ':' + requestType + '\" xmlns:a=\"http://schemas.microsoft.com/xrm/2011/Contracts\"';
        ...
        if (Microsoft.Crm.Client.Core.Framework._String.isNullOrEmpty(requestParameters)) {
            ...
            $v_0 += '<a:Parameters xmlns:b=\"http://schemas.datacontract.org/2004/07/System.Collections.Generic\">' +
                requestParameters +
                '</a:Parameters>';
        }
        $v_0 += '<a:RequestId i:nil=\"true\" /><a:RequestName>' +
            requestName +
            '</a:RequestName>' +
            '</request>' +
            '</Execute>';
    ...
    $2m_1: function() {
        if (this.$x_1 > 0) {
            return '<LanguageCodeOverride xmlns=\"http://schemas.microsoft.com/xrm/2011/Contracts\">' +
                this.$x_1 +
    ...
    $2u_1: function() {
        return '<SdkClientVersion xmlns=\"http://schemas.microsoft.com/xrm/2011/Contracts\">' +
            this.$v_1 +
            '</SdkClientVersion>';
    },

    $2i_1: function() {
        var $v_0 = (!_Script.isNullOrUndefined(this.callerOriginProvider))
            ? this.callerOriginProvider.get_uniqueId()
            : '';
        if (!Microsoft.Crm.Client.Core.Framework._String.isNullOrEmpty($v_0)) {
            return '<CrmMobileClientUniqueId xmlns=\"http://schemas.microsoft.com/xrm/2011/Contracts\">' +
                Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.EncodeDecode.xmlEncode($v_0) +
                '</CrmMobileClientUniqueId>';
        }
        return '';
    },
    ...
    createErrorResponseWithSource: function(request, textStatus, error, source) {
        return new Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.Responses
            .CrmErrorResponse(request, textStatus, error, source);
    },

    createErrorResponseFromHtml: function(responseString, source) {
        var $v_0 = Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.Responses.CrmErrorResponse
            .createFromHtml(responseString, source);
        $v_0.$d_0 = source;
        return $v_0;
    },
    ...
    getMetrics: function(requestId) {
        ...
        var $$t_8 = this, $$t_9 = this;
        this.executeJsonRequest(Microsoft.Crm.Client.Core.Storage.WebService.WebServiceBase.RequestData
            .create(this.$1N_1, $v_1, this.createJsonRequestOptions(this.$1N_1, 'POST'))).then(function($p1_0) {
                var $v_2;
                var $v_3 = null;
                var $v_4 = new Array(0);
                if (_Script.isNullOrUndefined($p1_0) || _Script.isNullOrUndefined($p1_0['d'])) {
                    $v_2 = false;
                    $v_4.push(new Microsoft.Crm.Client.Core.Framework
                        .ErrorData(0, 'JSON response is null or undefined.'));
                } else {
                    $v_3 = $p1_0['d'];
                    $v_2 = true;
                }
                $v_0.resolve(new Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.JsonResponses
                    .JsonResponse($v_2, $v_3, $v_4));
            },
            function($p1_0) {
                $v_0.reject($p1_0);
            });
    ...
    resolveEmails: function(emails) {
        ...
        this.executeJsonRequest(Microsoft.Crm.Client.Core.Storage.WebService.WebServiceBase.RequestData
            .create($v_1, $v_2, this.createJsonRequestOptions($v_1, 'POST'))).then(function($p1_0) {
                var $v_7 = $p1_0['d'];
                if (_Script.isNullOrUndefined($p1_0) || _Script.isNullOrUndefined($v_7)) {
                    var $v_8 = new Array(0);
                    $v_8.push(new Microsoft.Crm.Client.Core.Framework
                        .ErrorData(0, 'JSON response is null or undefined.'));
                    $v_3.resolve(new Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.JsonResponses
                        .JsonResponse(false, null, $v_8));
                    return;
                }
                $v_3.resolve(new Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.JsonResponses
                    .JsonResponse(true, $v_7, null));
            },
            function($p1_0) {
                $v_3.reject($p1_0);
            });
    ...
    createResponseData: function(xhr, data) {
        var $v_0 = Microsoft.Crm.Client.Core.Storage.WebService.WebServiceBase.prototype.createResponseData
            .call(this, xhr, data);
        return $v_0;
    },
    ...
    $2a_1: function($p0, $p1) {
        ...
        if (_Script.isNullOrUndefined($p0) || _Script.isNullOrUndefined($p0['d'])) {
            ...
            var $v_3 = $v_1['Status'];
            $v_0 = $v_3['Success'];
            $v_2 = Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.JsonResponses.JsonResponse
                .createErrorData($v_3['Errors']);
        }
        if (!_Script.isNullOrUndefined($p1)) {
            if ($p1 === Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.JsonResponses.UserContextResponse) {
                return new Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.JsonResponses
                    .UserContextResponse($v_0, $v_1, $v_2);
            }
        }
    ...
    getInstantiatedEmailTemplate: function(templateId, objectId, objectTypeCode) {
        var $v_0 = Microsoft.Crm.Client.Core.Imported.MscrmComponents
            .deferredPromiseFactory(Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.Responses
                .InstantiatedEmailTemplateResponse,
                Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.Responses.CrmErrorResponse);
        ...
        var $v_3 = '<' +
            $v_1 +
            ' xmlns=\"http://schemas.microsoft.com/crm/2009/WebServices\">' +
            $v_2 +
            '</' +
            $v_1 +
            '>';
        var $v_4 = this.createSoapRequestBody($v_3);
        var $v_5 = this.createSoapRequestOptions(this.$1m_1,
            'http://schemas.microsoft.com/crm/2009/WebServices/GetInstantiatedEmailTemplate');
        var $$t_B = this, $$t_C = this;
        this.executeSoapRequest(Microsoft.Crm.Client.Core.Storage.WebService.WebServiceBase.RequestData
            .create($v_1, $v_4, $v_5)).then(function($p1_0) {
                $v_0.resolve(new Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.Responses
                    .InstantiatedEmailTemplateResponse($p1_0));
            },
            function($p1_0) {
                $v_0.reject($p1_0);
            });
    ...
    generateAttachmentUrl: function(attachmentId, attachmentType) {
        var $v_0 = Microsoft.Crm.Client.Core.Imported.MscrmComponents
            .deferredPromiseFactory(String,
                Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.Responses.CrmErrorResponse);
        var $v_1 = this.$1h_1 + '?fileId=' + attachmentId + '&entityType=' + attachmentType;
        var $v_2 = Microsoft.Crm.Client.Core.Storage.WebService.WebServiceBase.RequestOptions
            .create($v_1, 'GET', '', '', $v_1, this.get_doAuthentication());
        var $$t_7 = this, $$t_8 = this;
        this.executeSoapRequest(Microsoft.Crm.Client.Core.Storage.WebService.WebServiceBase.RequestData
            .create('GenerateAttachmentUrl', '', $v_2)).then(function($p1_0) {
    ...
    formatDateTimeFieldValue: function(fieldName, rawValue) {
        ...
        case 'dateandtime':
            if (_Script.isNullOrUndefined($v_0.$0_2)) {
                return Microsoft.Crm.Client.Core.Storage.Common.CrmFormatter.get_instance()
                    .formatShortDateTimeValue(rawValue, $v_2);
            }
            ...
            if (!_Script.isNullOrUndefined($v_3) && $v_3.get_value() === $v_4) {
                return Microsoft.Crm.Client.Core.Storage.Common.CrmFormatter.get_instance()
                    .formatShortDateValue(rawValue, $v_2);
            } else {
                return Microsoft.Crm.Client.Core.Storage.Common.CrmFormatter.get_instance()
                    .formatShortDateTimeValue(rawValue, $v_2);
            }
        case 'dateonly':
            return Microsoft.Crm.Client.Core.Storage.Common.CrmFormatter.get_instance()
                .formatShortDateValue(rawValue, $v_2);
        default:
            var $v_5 = Microsoft.Crm.Client.Core.Storage.Common.CrmFormatter.get_instance()
                .formatShortDateTimeValue(rawValue, $v_2);
            if (!_Script.isNullOrUndefined($v_0.$0_2) &&
                !_Script.isNullOrUndefined($v_0.$0_2.get_formattedValues()) &&
                !Microsoft.Crm.Client.Core.Framework._String
                .isNullOrWhiteSpace($v_0.$0_2.get_formattedValues()[fieldName]) &&
                $v_0.$0_2.get_formattedValues()[fieldName] === $v_5) {
...
Microsoft.Crm.Client.Core.Models.Formatters.FormFieldFormatter.prototype = {
    ...
    formatFieldValue: function(fieldAttributeType, fieldName, rawValue) {
        ...
        if (Microsoft.Crm.Client.Core.Framework.IPicklistItem.isInstanceOfType(rawValue)) {
            ...
            case 8:
                return this.$2f_0(fieldName, rawValue);
            case 2:
    ...
    $2f_0: function($p0, $p1) {
        ...
        var $v_1 = this.$2q_0();
        return Microsoft.Crm.Client.Core.Storage.Common.CrmFormatter.get_instance()
            .formatCurrencyValue($p1, $v_1, $v_0);
    },
    ...
    $2q_0: function() {
        return Microsoft.Crm.Client.Core.Storage.DataApi.DataSource.$4.$B_0
            .getTransactionCurrencySymbol(this.$9_0.get_transactionCurrencyId());
    }
}
...
Xrm.Soap.AttributeMetadataSerializer.$38 = function($p0) {
    var $v_0 = new (Microsoft.Crm.Client.Core.Framework.CallbackSafeArray$1
        .$$(Microsoft.Crm.Client.Core.Storage.Common.ObjectModel.AttributeMetadata))();
    if (!_Script.isNullOrUndefined($p0)) {
        for (var $v_1 = 0; $v_1 < $p0.get_count(); $v_1++) {
    ...
    try {
        ...
        for (var $v_V = 0, $v_W = $p0.childNodes.length; $v_V < $v_W; $v_V++) {
            ...
            if ($v_X.namespaceURI === 'http://schemas.microsoft.com/xrm/2011/Metadata') {
                var $v_Y = Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.SerializerUtility
                    .$3($v_X.nodeName);
                switch ($v_Y) {
                case 'MetadataId':
                ...
                case 'EntityLogicalName':
                    ...
                    break;
                case 'DisplayName':
                    $v_3 = Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.LabelSerializer
                        .loadLocalizedLabelFromCrmSoap($v_X);
                    break;
                case 'AttributeType':
                    $v_4 = Xrm.Soap.AttributeMetadataSerializer.$31($v_X.firstChild.nodeValue);
                    break;
                case 'RequiredLevel':
                    $v_5 = Xrm.Soap.AttributeMetadataSerializer.$39($v_X.childNodes[2].firstChild.nodeValue);
                    break;
                case 'IsSecured':
                ...
                case 'DateTimeBehavior':
                    ...
                    $v_H = Xrm.Soap.AttributeMetadataSerializer.$32($v_X.firstChild.firstChild.nodeValue);
                    break;
                ...
                case 'DefaultValue':
                    ...
                    break;
                case 'OptionSet':
                    $v_L = Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers
                        .OptionSetMetadataSerializer.$17($v_X);
                    break;
                case 'IsBaseCurrency':
                    $v_K = Boolean.parse($v_X.firstChild.nodeValue);
                    break;
                case 'ImeMode':
                    $v_S = Microsoft.Crm.Client.Core.Framework._Enum
                        .parse(Microsoft.Crm.Client.Core.Framework.Common.ImeMode, $v_X.firstChild.nodeValue);
                    break;
                case 'Targets':
                ...
                case 'IsSortableEnabled':
                    ...
                    if ($v_b.length >= 2 &&
                        $v_b[2].nodeName === 'a:Value' &&
                        $v_b[2].firstChild &&
                        $v_b[2].firstChild.nodeValue) {
        ...
        Microsoft.Crm.Client.Core.Framework.DynamicsTrace
            .logInfo('AttributeMetadataSerializer',
                1005,
                String
                .format('Error extracting attribute metadata from SOAP response. Exception: {0}', $v_e.toString()));
        return null;
    }
}
Xrm.Soap.AttributeMetadataSerializer.$31 = function($p0) {
    switch ($p0) {
    case 'Boolean':
        return 0;
    case 'Customer':
...
Xrm.Soap.AttributeMetadataSerializer.$39 = function($p0) {
    switch ($p0) {
    case 'None':
        return 0;
...
Xrm.Soap.AttributeMetadataSerializer.$32 = function($p0) {
    switch ($p0) {
    case 'None':
        return 0;
    case 'UserLocal':
...
Xrm.Soap.BusinessNotificationParameterSerializer.loadFromCrmSoap = function(xml) {
    ...
    if ($v_1) {
        $v_0 = Microsoft.Crm.Client.Core.Framework._Enum
            .parse(Xrm.Gen.BusinessNotificationParameterType, $v_1.get_innerText());
    }
    var $v_2 = '';
...
Xrm.Soap.BusinessNotificationSerializer.loadFromCrmSoap = function(xml) {
    ...
    if ($v_1) {
        $v_0 = Microsoft.Crm.Client.Core.Framework._Enum
            .parse(Xrm.Gen.BusinessNotificationSeverity, $v_1.get_innerText());
    }
    var $v_2 = '';
...
Xrm.Soap.ColumnSetSerializer.toCrmSoap = function(columnSet) {
    ...
    $v_0.append('<a:AllColumns i:type=\"c:boolean\" xmlns:c=\"http://www.w3.org/2001/XMLSchema\">' +
        ((Microsoft.Crm.Client.Core.Storage.Common.AllColumns.isInstanceOfType(columnSet)) ? 'true' : 'false') +
        '</a:AllColumns>');
    if (Microsoft.Crm.Client.Core.Storage.Common.AllColumns.isInstanceOfType(columnSet)) {
        ...
        for (var $$arr_2 = (columnSet).get_columns(), $$len_3 = $$arr_2.length, $$idx_4 = 0;
            $$idx_4 < $$len_3;
            ++$$idx_4) {
            var $v_1 = $$arr_2[$$idx_4];
...
Xrm.Soap.CrmDateTimeSerializer.get_$2T = function() {
    return Xrm.Soap.CrmDateTimeSerializer.$1y || (Xrm.Soap.CrmDateTimeSerializer.$1y = new RegExp('[Z,T]', 'ig'));
}
Xrm.Soap.CrmDateTimeSerializer.get_$2b = function() {
...
Xrm.Soap.CrmDateTimeSerializer.loadFromCrmSoap = function(xml) {
    if (_Script.isNullOrUndefined(xml.firstChild) ||
        Microsoft.Crm.Client.Core.Framework._String.isNullOrEmpty(xml.firstChild.nodeValue)) {
        return Xrm.Soap.CrmDateTimeSerializer.get_$1c();
    }
    var $v_0 = xml.firstChild.nodeValue.replace(Xrm.Soap.CrmDateTimeSerializer.get_$2T(), ' ');
...
Xrm.Soap.CrmDateTimeSerializer.parseSqlToUtcDateTime = function(dateString) {
    ...
    return dateString.replace(Xrm.Soap.CrmDateTimeSerializer.get_$2b(), '/') + ' UTC';
}
Xrm.Soap.CrmDateTimeSerializer.toSqlDateTime = function(dateString) {
    return dateString.replace(Xrm.Soap.CrmDateTimeSerializer.get_$2T(), ' ').trimEnd();
}
...
Xrm.Soap.EntityCollectionSerializer.$1s = function($p0, $p1) {
    ...
    for (var $v_7 = 0, $v_8 = $p0.childNodes.length; $v_7 < $v_8; $v_7++) {
        ...
        if ($v_9.namespaceURI === 'http://schemas.microsoft.com/xrm/2011/Contracts') {
            var $v_A = Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.SerializerUtility
                .$3($v_9.nodeName);
            switch ($v_A) {
            case 'Entities':
                $v_6 = $v_9;
                break;
            case 'MoreRecords':
                if (!_Script.isNullOrUndefined($v_9.firstChild) &&
                    !Microsoft.Crm.Client.Core.Framework._String.isNullOrEmpty($v_9.firstChild.nodeValue)) {
    ...
    if ($v_6) {
        ...
        for (var $v_C = 0, $v_D = $v_6.childNodes.length; $v_C < $v_D; $v_C++) {
            ...
            if ($v_E.namespaceURI === 'http://schemas.microsoft.com/xrm/2011/Contracts' &&
                Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.SerializerUtility
                .$3($v_E.nodeName) ===
                'Entity') {
    ...
    $v_0.stop();
    return new Microsoft.Crm.Client.Core.Storage.Common.ObjectModel
        .EntityCollection($v_1, $v_2, $v_3, $v_4, $p1, null, $v_5);
}
Xrm.Soap.EntityCollectionSerializer.$2R = function($p0) {
    var $v_0 = new Sys.StringBuilder();
...
Xrm.Soap.EntityCollectionSerializer.$3I = function($p0) {
    var $v_0 = '';
    if (!$p0.get_count()) {
        return $v_0;
    }
    ...
    for (var $$arr_4 = $p0.get_entities(), $$len_5 = $$arr_4.length, $$idx_6 = 0; $$idx_6 < $$len_5; ++$$idx_6) {
        var $v_3 = $$arr_4[$$idx_6];
        for (var $$arr_8 = $v_3.get_changedFieldNames().toArray(), $$len_9 = $$arr_8.length, $$idx_A = 0;
            $$idx_A < $$len_9;
            ++$$idx_A) {
            var $v_4 = $$arr_8[$$idx_A];
            if (!Microsoft.Crm.Client.Core.Framework._String.isNullOrWhiteSpace($v_4) &&
                $v_4 === 'partyid' &&
                ($v_3.get_fieldTypes()[$v_4]) === 6) {
                $v_0 += '<' + $v_2 + '>';
                $v_0 += Xrm.Soap.EntityRecordSerializer
                    .toCrmFieldDataXml($v_4, $v_3.getValue($v_4), $v_3.get_fieldTypes()[$v_4]);
                $v_0 += '</' + $v_2 + '>';
                break;
            }
        }
...
Xrm.Soap.EntityMetadataCollectionSerializer.$17 = function($p0) {
    var $v_0 = $p0.selectSingleNode('.//a:KeyValuePairOfstringanyType[b:key=\'ServerVersionStamp\']/b:value')
        .get_innerText();
    ...
    var $v_2 = $p0
        .selectNodes('.//a:KeyValuePairOfstringanyType[b:key=\'DeletedMetadata\']/b:value/c:KeyValuePairOfDeletedMetadataFiltersArrayOfguidPlUv_PKtF[b:key=\'Attribute\']/b:value/d:guid');
    var $v_3 = new Array(0);
    ...
    return new Microsoft.Crm.Client.Core.Storage.Common.ObjectModel
        .EntityMetadataCollection($v_1, $v_0, $v_3, Xrm.Soap.EntityMetadataCollectionSerializer.$33);
}
Xrm.Soap.EntityMetadataCollectionSerializer.$33 = function($p0) {
    var $v_0 = Xrm.Soap.EntityMetadataCollectionSerializer.$30($p0);
    var $v_1 = Xrm.Soap.EntityMetadataCollectionSerializer.$34($p0, $v_0);
    return new Microsoft.Crm.Client.Core.Storage.Common.EntityAttributeMetadataPair($v_1, $v_0.$L_0);
}
Xrm.Soap.EntityMetadataCollectionSerializer.$34 = function($p0, $p1) {
    var $v_0 = null;
    var $v_1 = null;
    var $v_2 = true;
    var $v_3 = false;
    ...
    for (var $v_h = 0, $v_i = $p0.childNodes.length; $v_h < $v_i; $v_h++) {
        ...
        if ($v_j.namespaceURI === 'http://schemas.microsoft.com/xrm/2011/Metadata') {
            ...
            var $v_k = Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.SerializerUtility
                .$3($v_j.nodeName);
            switch ($v_k) {
            case 'DisplayCollectionName':
                $v_1 = Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.LabelSerializer
                    .loadLocalizedLabelFromCrmSoap($v_j);
                break;
            case 'DisplayName':
                $v_0 = Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.LabelSerializer
                    .loadLocalizedLabelFromCrmSoap($v_j);
                break;
            case 'HasChanged':
            ...
            case 'OwnershipType':
                $v_S = Microsoft.Crm.Client.Core.Framework._Enum
                    .parse(Microsoft.Crm.Client.Core.Storage.Common.ObjectModel.OwnershipTypes,
                        $v_j.firstChild.nodeValue);
                break;
    ...
    if ($v_4 && $v_f) {
        var $v_l = Xrm.Soap.EntityMetadataCollectionSerializer.$2p($v_f);
...
Xrm.Soap.EntityMetadataCollectionSerializer.$24 = function($p0, $p1, $p2) {
    for (var $v_0 = 0, $v_1 = $p0.childNodes.length; $v_0 < $v_1; $v_0++) {
        var $v_2 = $p0.childNodes[$v_0];
        if ($v_2.namespaceURI === 'http://schemas.microsoft.com/xrm/2011/Metadata' &&
            Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.SerializerUtility
            .$3($v_2.nodeName) ===
            ...
            for (var $v_5 = 0, $v_6 = $v_2.childNodes.length; $v_5 < $v_6; $v_5++) {
                ...
                if ($v_7.namespaceURI === 'http://schemas.microsoft.com/xrm/2011/Metadata' && $v_7.firstChild) {
                    var $v_8 = Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers
                        .SerializerUtility.$3($v_7.nodeName);
...
Xrm.Soap.EntityMetadataCollectionSerializer.$2p = function($p0) {
    for (var $v_0 = 0, $v_1 = $p0.childNodes.length; $v_0 < $v_1; $v_0++) {
        var $v_2 = $p0.childNodes[$v_0];
        if ($v_2.namespaceURI === 'http://schemas.microsoft.com/xrm/2011/Metadata' &&
            Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.SerializerUtility
            ...
            for (var $v_6 = 0, $v_7 = $v_2.childNodes.length; $v_6 < $v_7; $v_6++) {
                ...
                if ($v_8.namespaceURI === 'http://schemas.microsoft.com/xrm/2011/Metadata' && $v_8.firstChild) {
                    var $v_9 = Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers
                        .SerializerUtility.$3($v_8.nodeName);
                    switch ($v_9) {
                    case 'SecurityTypes':
...
Xrm.Soap.EntityMetadataCollectionSerializer.$30 = function($p0) {
    var $v_0 = null;
    var $v_1 = false;
    var $v_2 = false;
    var $v_3 = new (Microsoft.Crm.Client.Core.Framework.List$1
        .$$(Microsoft.Crm.Client.Core.Storage.Common.ObjectModel.AttributeMetadata))();
    for (var $v_5 = 0, $v_6 = $p0.childNodes.length; $v_5 < $v_6; $v_5++) {
        ...
        if ($v_7.namespaceURI === 'http://schemas.microsoft.com/xrm/2011/Metadata') {
            ...
            var $v_8 = Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.SerializerUtility
                .$3($v_7.nodeName);
            if ($v_8 === 'Attributes') {
                for (var $v_9 = 0, $v_A = $v_7.childNodes.length; $v_9 < $v_A; $v_9++) {
                    var $v_B = $v_7.childNodes[$v_9];
                    if ($v_B.namespaceURI === 'http://schemas.microsoft.com/xrm/2011/Metadata' &&
                        Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.SerializerUtility
                        .$3($v_B.nodeName) ===
                        'AttributeMetadata') {
    ...
    return new Xrm.Soap.EntityMetadataCollectionSerializer
        .AttributeMetadataCollectionSerializerResult($v_4, $v_1, $v_2);
}
Xrm.Soap.EntityMetadataCollectionSerializer.$1O = function($p0, $p1) {
    for (var $v_0 = 0, $v_1 = $p0.childNodes.length; $v_0 < $v_1; $v_0++) {
        if ($p0.childNodes[$v_0].namespaceURI === 'http://schemas.microsoft.com/xrm/2011/Contracts' &&
            Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.SerializerUtility
            .$3($p0.childNodes[$v_0].nodeName) ===
            'Value') {
...
Xrm.Soap.EntityRecordSerializer.loadFromCrmSoapNode = function(xml, relatedEntitiesQuery) {
    ...
    for (var $v_A = 0, $v_B = xml.childNodes.length; $v_A < $v_B; $v_A++) {
        ...
        if ($v_C.namespaceURI === 'http://schemas.microsoft.com/xrm/2011/Contracts') {
            var $v_D = Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.SerializerUtility
                .$3($v_C.nodeName);
            switch ($v_D) {
            case 'Id':
                if ($v_C.textContent) {
    ...
    Xrm.Soap.EntityRecordSerializer.$37(xml, $v_0, $v_1, $v_2);
    var $v_9 = null;
    if ($v_7) {
        $v_9 = Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers
            .RelatedEntityCollectionSerializer.$17($v_8, $v_7, relatedEntitiesQuery);
    } else {
...
Xrm.Soap.EntityRecordSerializer.toCrmSoap = function(entityRecord, includeEntityNode) {
    ...
    var $v_1 = ((includeEntityNode)
            ? String.format('<entity xmlns:a=\"{0}\" xmlns:i=\"http://www.w3.org/2001/XMLSchema-instance\">',
                'http://schemas.microsoft.com/xrm/2011/Contracts')
            : '') +
        Xrm.Soap.EntityRecordSerializer.$2c(entityRecord) +
        '<a:EntityState i:nil=\"true\"/>' +
        String.format('<a:FormattedValues xmlns:b=\"{0}\"/>',
            'http://schemas.datacontract.org/2004/07/System.Collections.Generic') +
        (($v_0.Id === Microsoft.Crm.Client.Core.Framework.Guid.get_empty())
            ? ''
            : '<a:Id>' +
            Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.EncodeDecode.xmlEncode($v_0.Id.toString()) +
            '</a:Id>') +
        '<a:LogicalName>' +
        Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.EncodeDecode.xmlEncode($v_0.LogicalName) +
        '</a:LogicalName>' +
        ((entityRecord.hasField('versionnumber') && !_Script.isNullOrUndefined(entityRecord.getValue('versionnumber')))
            ? '<a:RowVersion>' +
            Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.EncodeDecode
            .xmlEncode(entityRecord.getValue('versionnumber').toString()) +
            '</a:RowVersion>'
            : '') +
        Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.RelatedEntityCollectionSerializer
        .$2R(entityRecord.get_relatedEntities()) +
        ((includeEntityNode) ? '</entity>' : '');
    return $v_1;
}
Xrm.Soap.EntityRecordSerializer.toCrmEntityDataXml = function(entityRecord, changedFieldsOnly) {
    ...
    for (var $$arr_6 = $v_2, $$len_7 = $$arr_6.length, $$idx_8 = 0; $$idx_8 < $$len_7; ++$$idx_8) {
        var $v_4 = $$arr_6[$$idx_8];
        if (!Microsoft.Crm.Client.Core.Framework._String.isNullOrWhiteSpace($v_4)) {
            $v_3 += Xrm.Soap.EntityRecordSerializer
                .toCrmFieldDataXml($v_4, entityRecord.getValue($v_4), entityRecord.get_fieldTypes()[$v_4]);
        }
    }
    $v_3 += '</' + $v_1 + '>';
    return $v_3;
}
Xrm.Soap.EntityRecordSerializer.fieldToCrmSoap = function(fieldName,
    value,
    fieldType,
    fieldTypeName,
    namespaceDeclaration) {
    if (fieldType !== -1) {
        fieldTypeName = Xrm.Soap.EntityRecordSerializer.$2d(fieldType);
    } else {
        fieldType = Xrm.Soap.EntityRecordSerializer.$1r(fieldTypeName);
    }
    if (_Script.isNullOrUndefined(namespaceDeclaration)) {
        namespaceDeclaration = Xrm.Soap.EntityRecordSerializer.$2l(fieldType);
    }
    var $v_0 = '<a:KeyValuePairOfstringanyType>';
    $v_0 += '<b:key>' +
        Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.EncodeDecode.xmlEncode(fieldName) +
        '</b:key>';
    if (_Script.isNullOrUndefined(value)) {
        ...
        case 8:
            ...
            break;
        case 10:
            $v_0 += Xrm.Soap.EntityCollectionSerializer.$2R(value);
            break;
        case 22:
        case -1:
            $v_0 += Xrm.Soap.EntityRecordSerializer.$2X(fieldTypeName, value);
            break;
        default:
...
Xrm.Soap.EntityRecordSerializer.$3H = function($p0) {
    var $v_0 = '';
    for (var $$arr_2 = $p0, $$len_3 = $$arr_2.length, $$idx_4 = 0; $$idx_4 < $$len_3; ++$$idx_4) {
        var $v_1 = $$arr_2[$$idx_4];
        $v_0 += '<sa:string>' +
            Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.EncodeDecode.xmlEncode($v_1) +
            '</sa:string>';
    }
    return $v_0;
}
Xrm.Soap.EntityRecordSerializer.$2X = function($p0, $p1) {
    if ($p0 === 'a:FetchExpression') {
        return '<a:Query>' +
            Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.EncodeDecode.xmlEncode($p1) +
            '</a:Query>';
        ...
        return Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.SerializerUtility
            .$12(Xrm.Gen.TargetFieldType, $p1);
        ...
        return Xrm.Soap.EntityRecordSerializer.$3H($p1);
    } else if ($p0 === 'a:RollupType') {
        return Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.SerializerUtility
            .$12(Xrm.Gen.RollupType, $p1);
    } else if ($p0 === 'c:ConcurrencyBehavior') {
        return Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.SerializerUtility
            .$12(Xrm.Gen.ConcurrencyBehavior, $p1);
    } else {
        return Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.EncodeDecode.xmlEncode($p1);
    }
}
Xrm.Soap.EntityRecordSerializer.$37 = function($p0, $p1, $p2, $p3) {
    var $v_0 = null;
    var $v_1 = null;
    for (var $v_2 = 0, $v_3 = $p0.childNodes.length; $v_2 < $v_3; $v_2++) {
        ...
        if ($v_4.namespaceURI === 'http://schemas.microsoft.com/xrm/2011/Contracts') {
            var $v_5 = Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.SerializerUtility
                .$3($v_4.nodeName);
            switch ($v_5) {
            case 'Attributes':
                $v_0 = $v_4;
    ...
    Xrm.Soap.EntityRecordSerializer.$35($v_0, $p1, $p2);
    if (!_Script.isNullOrUndefined($v_1)) {
        Xrm.Soap.EntityRecordSerializer.$36($v_1, $p1, $p2, $p3);
    }
}
Xrm.Soap.EntityRecordSerializer.$35 = function($p0, $p1, $p2) {
    for (var $v_0 = 0, $v_1 = $p0.childNodes.length; $v_0 < $v_1; $v_0++) {
        var $v_2 = $p0.childNodes[$v_0];
        if ($v_2.namespaceURI === 'http://schemas.microsoft.com/xrm/2011/Contracts' &&
            Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.SerializerUtility
            .$3($v_2.nodeName) ===
            ...
            for (var $v_8 = 0, $v_9 = $v_2.childNodes.length; $v_8 < $v_9; $v_8++) {
                ...
                if ($v_A.namespaceURI === 'http://schemas.datacontract.org/2004/07/System.Collections.Generic') {
                    var $v_B = Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers
                        .SerializerUtility.$3($v_A.nodeName);
                    switch ($v_B) {
                    case 'key':
            ...
            if ($v_6 === 21) {
                ...
                for (var $v_E = 0, $v_F = $v_4.childNodes.length; $v_E < $v_F; $v_E++) {
                    ...
                    if ($v_G.namespaceURI === 'http://schemas.microsoft.com/xrm/2011/Contracts') {
                        var $v_H = Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers
                            .SerializerUtility.$3($v_G.nodeName);
                        switch ($v_H) {
                        case 'EntityLogicalName':
            ...
            if ($v_6 !== -1) {
                ...
                case 6:
                    ...
                    break;
                case 10:
                    $v_I = Xrm.Soap.EntityCollectionSerializer
                        .$1s($v_4, Microsoft.Crm.Client.Core.Storage.DataApi.Query.get_empty());
                    break;
                case 2:
                ...
                case 15:
                    if (!_Script.isNullOrUndefined($v_4.firstChild) &&
                        !Microsoft.Crm.Client.Core.Framework._String.isNullOrEmpty($v_4.firstChild.nodeValue)) {
                        if ($v_4.textContent) {
                            $v_I = new Microsoft.Crm.Client.Core.Framework.Guid($v_4.textContent);
                        } else {
                            $v_I = ($v_4.hasChildNodes())
                                ? new Microsoft.Crm.Client.Core.Framework.Guid($v_4.firstChild.nodeValue)
                                : Microsoft.Crm.Client.Core.Framework.Guid.get_empty();
                        }
                    } else {
                ...
                case 0:
                    if (!_Script.isNullOrUndefined($v_4.firstChild) &&
                        ...
                        if ($v_J) {
                            $v_I = new Microsoft.Crm.Client.Core.Storage.Common.ObjectModel
                                .OptionMetadata(null, 1, -1, -1, null, null, null);
                        } else {
                            $v_I = new Microsoft.Crm.Client.Core.Storage.Common.ObjectModel
                                .OptionMetadata(null, 0, -1, -1, null, null, null);
                        }
                    }
                    break;
                case 8:
                ...
                case 11:
                    $v_I = new Microsoft.Crm.Client.Core.Storage.Common.ObjectModel
                        .OptionMetadata(null,
                            parseInt(Xrm.Soap.EntityRecordSerializer.$2E($v_4)),
                            -1,
                            -1,
                            null,
                            null,
...
Xrm.Soap.EntityRecordSerializer.$36 = function($p0, $p1, $p2, $p3) {
    for (var $v_0 = 0, $v_1 = $p0.childNodes.length; $v_0 < $v_1; $v_0++) {
        var $v_2 = $p0.childNodes[$v_0];
        if ($v_2.namespaceURI === 'http://schemas.microsoft.com/xrm/2011/Contracts' &&
            Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.SerializerUtility
...
Xrm.Soap.EntityRecordSerializer.$2c = function($p0) {
    var $v_0 = '<a:Attributes xmlns:b=\"http://schemas.datacontract.org/2004/07/System.Collections.Generic\">';
    for (var $$arr_2 = $p0.get_changedFieldNames().toArray(), $$len_3 = $$arr_2.length, $$idx_4 = 0;
        $$idx_4 < $$len_3;
        ++$$idx_4) {
        var $v_1 = $$arr_2[$$idx_4];
        if (!Microsoft.Crm.Client.Core.Framework._String.isNullOrWhiteSpace($v_1)) {
            $v_0 += Xrm.Soap.EntityRecordSerializer
                .fieldToCrmSoap($v_1, $p0.getValue($v_1), $p0.get_fieldTypes()[$v_1]);
        }
    }
    $v_0 += '</a:Attributes>';
    return $v_0;
...
Xrm.Soap.EntityRecordSerializer.toCrmFieldDataXml = function(fieldName, value, fieldType) {
    ...
    case 12:
        if (String.isInstanceOfType(value)) {
            ...
            $v_0 += Xrm.Soap.EntityRecordSerializer.$3J(fieldName, $v_3.toString(), $v_4);
        }
        break;
    case 10:
        $v_0 = '<' + Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.EncodeDecode.xmlEncode(fieldName) + '>';
        $v_0 += Xrm.Soap.EntityCollectionSerializer.$3I(value);
        $v_0 += '<' + Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.EncodeDecode.xmlEncode(fieldName) + '/>';
        break;
    default:
        break;
...
Xrm.Soap.EntityRecordSerializer.$3J = function($p0, $p1, $p2) {
    var $v_0 = document.createElementNS(null, $p0);
    var $v_1 = document.createTextNode($p1);
    $v_0.appendChild($v_1);
    if (!_Script.isNullOrUndefined($p2)) {
...
Xrm.Soap.EntityRecordSerializer.$2l = function($p0) {
    switch ($p0) {
    case 14:
    case 2:
    case 3:
...
Xrm.Soap.EntityRecordSerializer.$2E = function($p0) {
    var $v_0 = null;
    if (!_Script.isNullOrUndefined($p0.firstElementChild) &&
        !_Script.isNullOrUndefined($p0.firstElementChild.firstChild) &&
        !Microsoft.Crm.Client.Core.Framework._String.isNullOrEmpty($p0.firstElementChild.firstChild.nodeValue)) {
        $v_0 = $p0.firstElementChild.firstChild.nodeValue;
    } else if (!_Script.isNullOrUndefined($p0.firstChild) &&
        !_Script.isNullOrUndefined($p0.firstChild.firstChild) &&
        !Microsoft.Crm.Client.Core.Framework._String.isNullOrEmpty($p0.firstChild.firstChild.nodeValue)) {
...
Xrm.Soap.EntityReferenceSerializer.loadFromCrmSoapNode = function(xml) {
    ...
    for (var $v_4 = 0, $v_5 = xml.childNodes.length; $v_4 < $v_5; $v_4++) {
        ...
        if ($v_6.namespaceURI === 'http://schemas.microsoft.com/xrm/2011/Contracts' && $v_6.firstChild) {
            var $v_7 = Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.SerializerUtility
                .$3($v_6.nodeName);
            switch ($v_7) {
            case 'Id':
                if ($v_6.textContent) {
                    ...
                    $v_0 = ($v_6.hasChildNodes())
                        ? new Microsoft.Crm.Client.Core.Framework.Guid($v_6.firstChild.nodeValue)
                        : Microsoft.Crm.Client.Core.Framework.Guid.get_empty();
                }
                break;
            case 'LogicalName':
...
Xrm.Soap.EntityReferenceSerializer.toCrmSoap = function(entityReference) {
    var $v_0 = '<a:Id>' +
        Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.EncodeDecode.xmlEncode(entityReference.Id.toString()) +
        '</a:Id>';
    $v_0 += '<a:LogicalName>' +
        Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.EncodeDecode.xmlEncode(entityReference.LogicalName) +
        '</a:LogicalName>';
    $v_0 += (!_Script.isNullOrUndefined(entityReference.getValue('RowVersion')))
        ? '<a:RowVersion>' +
        Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.EncodeDecode
        .xmlEncode(entityReference.getValue('RowVersion').toString()) +
        '</a:RowVersion>'
        : '';
    if (!Microsoft.Crm.Client.Core.Framework._String.isNullOrEmpty(entityReference.Name)) {
        $v_0 += '<a:Name>' +
            Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.EncodeDecode.xmlEncode(entityReference.Name) +
            '</a:Name>';
    }
    return $v_0;
}
...
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.GuidArraySerializer
    .loadFromCrmSoap = function(node) {
...
Xrm.Soap.ExecuteMultipleResponseItemCollectionSerializer.loadFromCrmSoap = function(xml, request) {
    ...
    for (var $v_3 = 0; $v_3 < $v_2.get_count(); $v_3++) {
        ...
        if (!_Script.isNullOrUndefined($v_6) && $v_6.getAttribute('i:nil') !== 'true') {
            $v_4 = Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.Faults.OrganizationServiceFault
                .parseFromXml($v_6);
        }
...
Xrm.Soap.ExecuteMultipleSettingsSerializer.toCrmSoap = function(settings) {
    return '<c:ContinueOnError>' +
        settings.get_continueOnError() +
        '</c:ContinueOnError>' +
        '<c:ReturnResponses>' +
        settings.get_returnResponses() +
        '</c:ReturnResponses>';
}
...
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.LabelSerializer
    .loadLocalizedLabelFromCrmSoap = function($p0) {
        var $v_0 = null;
        var $v_1 = null;
        ...
        for (var $v_3 = 0, $v_4 = $p0.childNodes.length; $v_3 < $v_4; $v_3++) {
            ...
            if ($v_5.nodeName === 'a:UserLocalizedLabel') {
                var $v_6 = Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.LabelSerializer
                    .$2S($v_2, $v_5);
                $v_0 = $v_0 || $v_6;
            }
...
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.LabelSerializer.$2S = function($p0, $p1) {
    var $v_0 = null;
    var $v_1 = null;
...
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.OptionSetMetadataSerializer
    .$17 = function($p0) {
        var $v_0 = {};
        for (var $v_1 = 0, $v_2 = $p0.childNodes.length; $v_1 < $v_2; $v_1++) {
            var $v_3 = $p0.childNodes[$v_1];
            if ($v_3.namespaceURI === 'http://schemas.microsoft.com/xrm/2011/Metadata' &&
                Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.SerializerUtility
                .$3($v_3.nodeName) ===
                'Options') {
                for (var $v_4 = 0, $v_5 = $v_3.childNodes.length; $v_4 < $v_5; $v_4++) {
                    $v_0 = Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers
                        .OptionSetMetadataSerializer.$2I($v_0, $v_3, $v_3.childNodes[$v_4], $v_4);
                }
            } else if ($v_3.namespaceURI === 'http://schemas.microsoft.com/xrm/2011/Metadata' &&
            (Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.SerializerUtility
                .$3($v_3.nodeName) ===
                'FalseOption' ||
                Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.SerializerUtility
    ...
    .$2I = function($p0, $p1, $p2, $p3) {
        ...
        for (var $v_7 = 0, $v_8 = $p2.childNodes.length; $v_7 < $v_8; $v_7++) {
            ...
            if ($p1.namespaceURI === 'http://schemas.microsoft.com/xrm/2011/Metadata') {
                ...
                case 'Label':
                    $v_1 = Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.LabelSerializer
                        .loadLocalizedLabelFromCrmSoap($v_9);
                    break;
                case 'State':
                ...
                case 'TransitionData':
                    if ($v_9.childNodes.length > 0) {
                        if (!IsNull($v_9.firstChild.nodeValue.toString())) {
                            $v_4 = new Array(0);
                            var $v_B = Microsoft.Crm.Client.Core.Storage.Common.Xml.XmlNodeFactory
                                .parseXmlDocument($v_9.firstChild.nodeValue.toString());
                            ...
                            if ($v_D.get_count() > 0) {
                                ...
                                for (var $v_F = 0; $v_F < $v_D.get_count(); $v_F++) {
                                    if ($v_D.get_item($v_F).getAttribute('tostatusid')) {
                                        var $v_G = Number
                                            .parseInvariant($v_D.get_item($v_F).getAttribute('tostatusid').toString());
                                        $v_4[$v_E] = $v_G;
                                        $v_E++;
                                    }
                                }
        ...
        $p0[$p3.toString()] = new Microsoft.Crm.Client.Core.Storage.Common.ObjectModel
            .OptionMetadata($v_1, $v_0, $v_2, $v_3, $v_4, $v_5, $v_6);
        return $p0;
    }
...
Xrm.Soap.Parser.load = function(T, data, key, serializedType) {
    if (_Script.isNullOrUndefined(serializedType)) {
        serializedType = Xrm.Soap.Parser.$2o(T);
    }
    var $v_0 = Xrm.Soap.Parser.$2e(serializedType);
    if ($v_0) {
    ...
    if (!$v_3) {
        ...
        if (serializedType === 'EntityReference') {
            $v_2 = (!_Script.isNullOrUndefined($v_2) &&
                    Microsoft.Crm.Client.Core.Framework._String.isNullOrEmpty(Xrm.Soap.Parser.$2n(data, key)))
                ? null
                : $v_2;
        }
    }
...
Xrm.Soap.Parser.$2n = function($p0, $p1) {
...
Xrm.Soap.Parser.$2o = function($p0) {
    var $v_0 = $p0.getName();
    var $v_1 = $v_0.lastIndexOf('.');
    return ($v_1 < 0) ? $v_0 : $v_0.substr($v_1 + 1);
}
Xrm.Soap.Parser.$2e = function($p0) {
...
Xrm.Soap.Parser.parseGuid = function(data, key) {
    ...
    return (_Script
        ...
        ? null
        : new Microsoft.Crm.Client.Core.Framework.Guid($v_0.get_innerText());
}
...
Xrm.Soap.Parser.parseEntityCollection = function(data, key) {
    var $v_0 = data.selectSingleNode('.//a:KeyValuePairOfstringanyType[b:key=\'' +
        key +
        '\']/b:value[@i:type=\'a:EntityCollection\']');
    return (_Script.isNullOrUndefined($v_0))
        ? null
        : Xrm.Soap.EntityCollectionSerializer
        .loadFromCrmSoap($v_0, Microsoft.Crm.Client.Core.Storage.DataApi.Query.get_empty());
}
Xrm.Soap.Parser.parseQueryByEntityName = function(data, key) {
    ...
    var $v_0 = data.selectNodes('.//a:KeyValuePairOfstringanyType[b:key=\'' +
        key +
        '\']/b:value[@i:type=\'c:QueryByEntityNameDictionary\']/c:KeyValuePairOfstringQueryBasegUGIFE1S');
    if (_Script.isNullOrUndefined($v_0)) {
        return null;
    }
    return Xrm.Soap.Parser.$3A($v_0);
}
Xrm.Soap.Parser.parseInputArgumentCollection = function(data, key) {
    data.addNamespace('c', 'http://schemas.microsoft.com/crm/2011/Contracts');
    var $v_0 = data.selectNodes('.//a:KeyValuePairOfstringanyType[b:key=\'' +
        key +
        '\']/b:value[@i:type=\'c:InputArgumentCollection\']/c:Arguments/b:KeyValuePairOfstringanyType');
    if (_Script.isNullOrUndefined($v_0)) {
        return null;
    }
    var $v_1 = {};
...
Xrm.Soap.Parser.parseBusinessNotificationArray = function(data, key) {
    ...
    return (_Script
            .isNullOrUndefined($v_0))
        ? null
        : Xrm.Soap.BusinessNotificationArraySerializer.loadFromCrmSoap($v_0);
}
Xrm.Soap.Parser.parseEntityReferenceArray = function(data, key) {
    ...
    return (_Script
            .isNullOrUndefined($v_0))
        ? null
        : Xrm.Soap.EntityReferenceCollectionSerializer.loadFromCrmSoap($v_0);
}
...
Xrm.Soap.Parser.$3A = function($p0) {
    var $v_0 = {};
    for (var $v_1 = 0; $v_1 < $p0.get_count(); $v_1++) {
...
Xrm.Soap.PrincipalAccessArraySerializer.loadFromCrmSoap = function(xml) {
    ...
    var $v_1 = new (Microsoft.Crm.Client.Core.Framework.List$1
        .$$(Microsoft.Crm.Client.Core.Storage.Common.ObjectModel.PrincipalAccess))();
    for (var $v_2 = 0; $v_2 < $v_0.childNodes.length; $v_2++) {
        ...
        for (var $v_6 = 0; $v_6 < $v_3.childNodes.length; $v_6++) {
            ...
            if ($v_7.namespaceURI === 'http://schemas.microsoft.com/crm/2011/Contracts') {
                ...
                case 'AccessMask':
                    $v_4 = Microsoft.Crm.Client.Core.Framework._Enum
                        .parse(Xrm.Gen.AccessRights, $v_7.firstChild.nodeValue);
                    break;
                case 'Principal':
                    var $v_8 = $v_7;
...
Xrm.Soap.QueryByEntityNameDictionarySerializer.toCrmSoap = function(dictionary) {
    ...
    for (var $$key_4 in $$dict_3) {
        ...
        $v_0.append('<b:key>' +
            Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.EncodeDecode.xmlEncode($v_1.key) +
            '</b:key>');
        $v_0.append('<b:value i:type=\"a:FetchExpression\"><a:Query>' +
            Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.EncodeDecode.xmlEncode($v_1.value) +
            '</a:Query></b:value>');
        $v_0.append('</c:KeyValuePairOfstringQueryBasegUGIFE1S>');
    }
    return $v_0.toString();
...
Xrm.Soap.InputArgumentCollectionSerializer.toCrmSoap = function(dictionary) {
    ...
    for (var $$key_5 in $$dict_4) {
        ...
        $v_0.append('<b:key>' +
            Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.EncodeDecode.xmlEncode($v_1.key) +
            '</b:key>');
        $v_0.append('<b:value xmlns:c=\"http://www.w3.org/2001/XMLSchema\" i:type=\"c:' +
            $v_2 +
            '\">' +
            Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.EncodeDecode.xmlEncode($v_1.value.toString()) +
            '</b:value>');
        $v_0.append('</b:KeyValuePairOfstringanyType>');
    }
    $v_0.append('</c:Arguments>');
...
Xrm.Soap.QuickFindResultSerializer.loadFromCrmSoap = function(xml) {
    if (xml.get_tagName() === 'a:QuickFindResult') {
        ...
        if ($v_0) {
            var $v_1 = Xrm.Soap.EntityCollectionSerializer
                .loadFromCrmSoap($v_0, new Microsoft.Crm.Client.Core.Storage.DataApi.Query(''));
...
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers
    .RelatedEntityCollectionSerializer = function() {
    }
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.RelatedEntityCollectionSerializer
    .$17 = function($p0, $p1, $p2) {
        ...
        if (!_Script.isNullOrUndefined($p2)) {
            ...
            for (var $v_2 = 0; $v_2 < $p2.length; $v_2++) {
                $v_0[$v_2] = new Microsoft.Crm.Client.Core.Storage.DataApi
                    .RelatedEntityQuery($p2[$v_2].get_key(), $p0, $p2[$v_2].get_value());
            }
        }
        var $v_1 = new (Microsoft.Crm.Client.Core.Framework.List$1
            .$$(Microsoft.Crm.Client.Core.Framework.KeyValuePair$2
                .$$(Microsoft.Crm.Client.Core.Storage.Common.ObjectModel.Relationship,
        ...
        for (var $v_3 = 0, $v_4 = $p1.childNodes.length; $v_3 < $v_4; $v_3++) {
            ...
            for (var $v_9 = 0, $v_A = $v_5.childNodes.length; $v_9 < $v_A; $v_9++) {
                ...
                if ($v_B.namespaceURI === 'http://schemas.datacontract.org/2004/07/System.Collections.Generic') {
                    var $v_C = Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers
                        .SerializerUtility.$3($v_B.nodeName);
                    switch ($v_C) {
                    case 'key':
                        $v_6 = $v_B;
                        break;
            ...
            if ($v_8 && $v_7) {
                ...
                $v_1.add(new (Microsoft.Crm.Client.Core.Framework.KeyValuePair$2
                    .$$(Microsoft.Crm.Client.Core.Storage.Common.ObjectModel.Relationship,
                        Microsoft.Crm.Client.Core.Storage.Common.ObjectModel.EntityCollection))($v_8, $v_E));
            }
        }
        return new Microsoft.Crm.Client.Core.Storage.Common.ObjectModel.RelatedEntityCollection($v_1.toArray());
    }
    ...
    for (var $$arr_2 = collection, $$len_3 = $$arr_2.length, $$idx_4 = 0; $$idx_4 < $$len_3; ++$$idx_4) {
        ...
        if ($v_1.get_key().get_primaryEntityRole() !== -1) {
            $v_0.append('<a:PrimaryEntityRole>' +
                Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.SerializerUtility
                .$12(Microsoft.Crm.Client.Core.Storage.Common.ObjectModel.EntityRole,
                    $v_1.get_key().get_primaryEntityRole()) +
                '</a:PrimaryEntityRole>');
        }
        $v_0.append('<a:SchemaName>' +
            Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.EncodeDecode
            .xmlEncode($v_1.get_key().get_schemaName()) +
            '</a:SchemaName>');
        $v_0.append('</b:key>');
        $v_0.append('<b:value i:type=\"a:FetchExpression\"><a:Query>' +
            Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.EncodeDecode.xmlEncode($v_1.get_value()) +
            '</a:Query></b:value>');
        $v_0.append('</a:KeyValuePairOfRelationshipQueryBaseX_PsK4FkN>');
    }
    return $v_0.toString();
...
Xrm.Soap.RelationshipQueryCollectionSerializer.loadFromCrmSoap = function(data) {
    ...
    for (var $v_2 = 0; $v_2 < $v_0.get_count(); $v_2++) {
        ...
        var $v_5 = -1;
        if (!_Script.isNullOrUndefined($v_4)) {
            $v_5 = Microsoft.Crm.Client.Core.Framework._Enum
                .parse(Microsoft.Crm.Client.Core.Storage.Common.ObjectModel.EntityRole, $v_4.get_innerText());
        }
        var $v_6 = $v_0.get_item($v_2).selectSingleNode('b:value/a:Query').get_innerText();
        $v_1[$v_2] = new (Microsoft.Crm.Client.Core.Framework.KeyValuePair$2
            .$$(Microsoft.Crm.Client.Core.Storage.Common.ObjectModel
                .Relationship,
                String))(new Microsoft.Crm.Client.Core.Storage.Common.ObjectModel.Relationship($v_3, $v_5), $v_6);
    }
    return $v_1;
}
...
Xrm.Soap.RelationshipSerializer.loadFromCrmSoapNode = function(xml) {
    ...
    for (var $v_3 = 0, $v_4 = xml.childNodes.length; $v_3 < $v_4; $v_3++) {
        ...
        if ($v_5.namespaceURI === 'http://schemas.microsoft.com/xrm/2011/Contracts' && $v_5.firstChild) {
            var $v_6 = Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.SerializerUtility
                .$3($v_5.nodeName);
            switch ($v_6) {
            case 'SchemaName':
            ...
            case 'PrimaryEntityRole':
                if ($v_5.getAttribute('i:nil') !== 'true') {
                    $v_2 = Microsoft.Crm.Client.Core.Framework._Enum
                        .parse(Microsoft.Crm.Client.Core.Storage.Common.ObjectModel.EntityRole,
                            $v_5.firstChild.nodeValue);
                }
                break;
            }
        }
...
Xrm.Soap.RelationshipSerializer.toCrmSoap = function(relationship) {
    var $v_0 = '';
    if (!_Script.isNullOrUndefined(relationship
            .get_primaryEntityRole()) &&
        relationship.get_primaryEntityRole() !== -1) {
        $v_0 += '<a:PrimaryEntityRole>' +
            Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.SerializerUtility
            .$12(Microsoft.Crm.Client.Core.Storage.Common.ObjectModel
                .EntityRole,
                relationship.get_primaryEntityRole()) +
            '</a:PrimaryEntityRole>';
    }
    $v_0 += '<a:SchemaName>' +
        Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.EncodeDecode.xmlEncode(relationship.get_schemaName()) +
        '</a:SchemaName>';
    return $v_0;
}
...
Xrm.Soap.Serializer.parametersToCrmSoap = function(request) {
    ...
    if (!_Script.isNullOrUndefined(request) &&
        !_Script.isNullOrUndefined(request.offlineData) &&
        Microsoft.Crm.Client.Core.Framework._Dictionary.count(request.offlineData) > 0) {
        $v_0 = $v_0 +
            '<a:KeyValuePairOfstringanyType><b:key>OfflineData</b:key><b:value xmlns:c=\"http://schemas.microsoft.com/2003/10/Serialization/Arrays\" i:type=\"c:ArrayOfKeyValueOfstringstring\">';
        var $$dict_4 = request.offlineData;
        for (var $$key_5 in $$dict_4) {
            var $v_2 = { key: $$key_5, value: $$dict_4[$$key_5] };
            $v_0 = $v_0 +
                String
                .format('<c:KeyValueOfstringstring><c:Key>{0}</c:Key><c:Value>{1}</c:Value></c:KeyValueOfstringstring>',
                    Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.EncodeDecode.xmlEncode($v_2.key),
                    Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.EncodeDecode
                    .xmlEncode(request.offlineData[$v_2.key].toString()));
        }
...
Xrm.Soap.Serializer.$14 = function($p0, $p1) {
    ...
    var $v_1 = Xrm.Soap.Serializer.$2M[$p1];
    for (var $$arr_4 = Xrm.Soap.Serializer.$2N, $$len_5 = $$arr_4.length, $$idx_6 = 0; $$idx_6 < $$len_5; ++$$idx_6) {
        var $v_2 = $$arr_4[$$idx_6];
        if ((($v_0) in $v_2)) {
            var $v_3 = $v_2[$v_0];
            if ((($v_1) in $v_3)) {
...
Xrm.Soap.SecurityPrivilegeMetadataCollectionSerializer.loadFromCrmSoap = function(xml) {
    var $v_0 = new (Microsoft.Crm.Client.Core.Framework.List$1
        .$$(Microsoft.Crm.Client.Core.Storage.Common.ObjectModel.SecurityPrivilegeMetadata))();
    for (var $v_1 = 0, $v_2 = xml.childNodes.length; $v_1 < $v_2; $v_1++) {
        ...
        for (var $v_B = 0, $v_C = $v_3.childNodes.length; $v_B < $v_C; $v_B++) {
            ...
            if ($v_D.namespaceURI === 'http://schemas.microsoft.com/xrm/2011/Metadata') {
                var $v_E = Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.SerializerUtility
                    .$3($v_D.nodeName);
                switch ($v_E) {
                case 'Name':
                ...
                case 'PrivilegeId':
                    ...
                    break;
                case 'PrivilegeType':
                    $v_6 = Microsoft.Crm.Client.Core.Framework._Enum
                        .parse(Xrm.Gen.PrivilegeType, $v_D.firstChild.nodeValue);
                    break;
                case 'CanBeBasic':
        ...
        $v_0.add(new Microsoft.Crm.Client.Core.Storage.Common.ObjectModel
            .SecurityPrivilegeMetadata($v_4, $v_5, $v_6, $v_7, $v_8, $v_9, $v_A));
    }
    return $v_0.toArray();
}
...
Xrm.Soap.Write.f = function(fieldName, value, fieldType, fieldTypeName, namespaceDeclaration) {
    return Xrm.Soap.EntityRecordSerializer.fieldToCrmSoap(fieldName,
        value,
        fieldType,
        fieldTypeName,
        namespaceDeclaration);
...
Xrm.Soap.ConvertKitToProductRequestSerializer.$$cctor = function() {
    Xrm.Soap.Serializer.registerSerializer('ConvertKitToProduct',
        Xrm.Soap.ConvertKitToProductRequestSerializer.parametersToCrmSoap);
    Xrm.Soap.Serializer.registerDeserializer('ConvertKitToProduct',
        Xrm.Soap.ConvertKitToProductRequestSerializer.loadFromCrmSoap);
}
...
Xrm.Soap.ConvertProductToKitRequestSerializer.$$cctor = function() {
    Xrm.Soap.Serializer.registerSerializer('ConvertProductToKit',
        Xrm.Soap.ConvertProductToKitRequestSerializer.parametersToCrmSoap);
    Xrm.Soap.Serializer.registerDeserializer('ConvertProductToKit',
        Xrm.Soap.ConvertProductToKitRequestSerializer.loadFromCrmSoap);
}
...
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.Generated
    .CalculateActualValueOpportunityRequestSerializer.$$cctor = function() {
        Xrm.Soap.Serializer.registerSerializer('CalculateActualValueOpportunity',
            Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.Generated
            .CalculateActualValueOpportunityRequestSerializer.parametersToCrmSoap);
        Xrm.Soap.Serializer.registerDeserializer('CalculateActualValueOpportunity',
            Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.Generated
            .CalculateActualValueOpportunityRequestSerializer.loadFromCrmSoap);
    }
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.Generated
    .CalculateActualValueOpportunityRequestSerializer.parametersToCrmSoap = function(request) {
        var $v_0 = request;
        return Xrm.Soap.EntityRecordSerializer.fieldToCrmSoap('OpportunityId', $v_0.opportunityId, 15);
    }
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.Generated
    .CalculateActualValueOpportunityRequestSerializer.loadFromCrmSoap = function(data) {
        if (_Script.isNullOrUndefined(data)) {
            return null;
        }
...
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.Generated
    .CalculateActualValueOpportunityResponseSerializer.$$cctor = function() {
        Xrm.Soap.ResponseSerializer.registerSerializer('CalculateActualValueOpportunity',
            Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.Generated
            .CalculateActualValueOpportunityResponseSerializer.loadFromCrmSoap);
    }
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.Generated
    .CalculateActualValueOpportunityResponseSerializer.loadFromCrmSoap = function(soapResponse, request) {
        if (!_Script.isNullOrUndefined(soapResponse)) {
            Xrm.Soap.ResponseSerializer.addCrmSoapNamespaces(soapResponse);
            var $v_0 = null;
            $v_0 = soapResponse.selectSingleNode('.//a:Results');
...
Xrm.Gen.AddItemCampaignRequestSerializer.parametersToCrmSoap = function(request) {
    return Xrm.Soap.Write.f('CampaignId', (request).campaignId, 15) +
        Xrm.Soap.Write.f('EntityId', (request).entityId, 15) +
        Xrm.Soap.Write.f('EntityName', (request).entityName, 14);
}
Xrm.Gen.AddItemCampaignRequestSerializer.loadFromCrmSoap = function(data) {
    if (_Script.isNullOrUndefined(data)) {
        return null;
    }
    return new Xrm.Gen.AddItemCampaignRequest(Xrm.Soap.Parser
        .load(Microsoft.Crm.Client.Core.Framework.Guid, data, 'CampaignId'),
        Xrm.Soap.Parser.load(Microsoft.Crm.Client.Core.Framework.Guid, data, 'EntityId'),
        Xrm.Soap.Parser.load(String, data, 'EntityName'));
}
...
Xrm.Gen.AddItemCampaignResponseSerializer.loadFromCrmSoap = function(soapResponse, request) {
    return Xrm.Soap.ResponseSerializer.deserialize(soapResponse,
        request,
        function($p1_0) {
            return new Xrm.Gen.AddItemCampaignResponse(Xrm.Soap.Parser
                .load(Microsoft.Crm.Client.Core.Framework.Guid, $p1_0, 'CampaignItemId'));
        });
}
...
Xrm.Gen.CloseQuoteRequestSerializer.parametersToCrmSoap = function(request) {
    return Xrm.Soap.Write.f('QuoteClose', (request).quoteClose, -1, 'a:Entity') +
        Xrm.Soap.Write.f('Status', (request).status, 11);
}
Xrm.Gen.CloseQuoteRequestSerializer.loadFromCrmSoap = function(data) {
    if (_Script.isNullOrUndefined(data)) {
        return null;
    }
    return new Xrm.Gen.CloseQuoteRequest(Xrm.Soap.Parser
        .load(Microsoft.Crm.Client.Core.Storage.Common.ObjectModel.EntityRecord, data, 'QuoteClose'),
        Xrm.Soap.Parser.load(Number, data, 'Status', 'OptionSet'));
}
...
Xrm.Gen.ConvertQuoteToSalesOrderResponseSerializer.loadFromCrmSoap = function(soapResponse, request) {
    return Xrm.Soap.ResponseSerializer.deserialize(soapResponse,
        ...
        function($p1_0) {
            return new Xrm.Gen
                .ConvertQuoteToSalesOrderResponse(Xrm.Soap.Parser
                    .load(Microsoft.Crm.Client.Core.Storage.Common.ObjectModel.EntityRecord, $p1_0, 'Entity'));
        });
}
...
Xrm.Gen.ConvertQuoteToSalesOrderRequestSerializer.parametersToCrmSoap = function(request) {
    return Xrm.Soap.Write.f('QuoteId', (request).quoteId, 15) +
        Xrm.Soap.Write.f('ColumnSet', (request).columnSet, -1, 'a:ColumnSet') +
        Xrm.Soap.Write.f('QuoteCloseDate', (request).quoteCloseDate, 2) +
        Xrm.Soap.Write.f('QuoteCloseStatus', (request).quoteCloseStatus, 11) +
        Xrm.Soap.Write.f('QuoteCloseSubject', (request).quoteCloseSubject, 14) +
        Xrm.Soap.Write.f('QuoteCloseDescription', (request).quoteCloseDescription, 14) +
        Xrm.Soap.Write.f('ProcessInstanceId', (request).processInstanceId, 6);
}
Xrm.Gen.ConvertQuoteToSalesOrderRequestSerializer.loadFromCrmSoap = function(data) {
    if (_Script.isNullOrUndefined(data)) {
        return null;
    }
    return new Xrm.Gen.ConvertQuoteToSalesOrderRequest(Xrm.Soap.Parser
        .load(Microsoft.Crm.Client.Core.Framework.Guid, data, 'QuoteId'),
        Xrm.Soap.Parser.load(Microsoft.Crm.Client.Core.Storage.Common.IColumnSet, data, 'ColumnSet', 'ColumnSet'),
        Xrm.Soap.Parser.load(Date, data, 'QuoteCloseDate'),
        Xrm.Soap.Parser.load(Number, data, 'QuoteCloseStatus', 'OptionSet'),
        Xrm.Soap.Parser.load(String, data, 'QuoteCloseSubject'),
        Xrm.Soap.Parser.load(String, data, 'QuoteCloseDescription'),
...
Xrm.Gen.CalculateTotalTimeIncidentRequestSerializer.loadFromCrmSoap = function(data) {
    ...
    return new Xrm.Gen.CalculateTotalTimeIncidentRequest(Xrm.Soap.Parser
        .load(Microsoft.Crm.Client.Core.Framework.Guid, data, 'IncidentId'));
}
...
Xrm.Gen.CalculateTotalTimeIncidentResponseSerializer.loadFromCrmSoap = function(soapResponse, request) {
    return Xrm.Soap.ResponseSerializer.deserialize(soapResponse,
        ...
        function($p1_0) {
            return new Xrm.Gen
                .CalculateTotalTimeIncidentResponse(Xrm.Soap.Parser.load(String, $p1_0, 'TotalTime', 'Int64'));
        });
}
...
Xrm.Gen.RetrieveCardDataRequestSerializer.parametersToCrmSoap = function(request) {
    return Xrm.Soap.Write.f('CardTypeId', (request).cardTypeId, 15) +
        Xrm.Soap.Write.f('AdditionalParameter', (request).additionalParameter, 14);
}
Xrm.Gen.RetrieveCardDataRequestSerializer.loadFromCrmSoap = function(data) {
    if (_Script.isNullOrUndefined(data)) {
        return null;
    }
    return new Xrm.Gen.RetrieveCardDataRequest(Xrm.Soap.Parser
        .load(Microsoft.Crm.Client.Core.Framework.Guid, data, 'CardTypeId'),
        Xrm.Soap.Parser.load(String, data, 'AdditionalParameter'));
}
...
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.Generated.GetQuantityDecimalRequestSerializer
    .$$cctor = function() {
        Xrm.Soap.Serializer.registerSerializer('GetQuantityDecimal',
            Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.Generated
            .GetQuantityDecimalRequestSerializer.parametersToCrmSoap);
        Xrm.Soap.Serializer.registerDeserializer('GetQuantityDecimal',
            Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.Generated
            .GetQuantityDecimalRequestSerializer.loadFromCrmSoap);
    }
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.Generated.GetQuantityDecimalRequestSerializer
    .parametersToCrmSoap = function(request) {
        var $v_0 = request;
        return Xrm.Soap.EntityRecordSerializer.fieldToCrmSoap('Target', $v_0.target, 6) +
            Xrm.Soap.EntityRecordSerializer.fieldToCrmSoap('ProductId', $v_0.productId, 15) +
            Xrm.Soap.EntityRecordSerializer.fieldToCrmSoap('UoMId', $v_0.uoMId, 15);
    }
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.Generated.GetQuantityDecimalRequestSerializer
    .loadFromCrmSoap = function(data) {
        if (_Script.isNullOrUndefined(data)) {
            return null;
        }
        ...
        var $v_3 = (!_Script.isNullOrUndefined($v_2))
            ? new Microsoft.Crm.Client.Core.Framework.Guid($v_2.get_innerText())
            : null;
        var $v_4 = data.selectSingleNode('.//a:KeyValuePairOfstringanyType[b:key=\'UoMId\']/b:value');
        var $v_5 = (!_Script.isNullOrUndefined($v_4))
            ? new Microsoft.Crm.Client.Core.Framework.Guid($v_4.get_innerText())
            : null;
...
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.Generated.GetQuantityDecimalResponseSerializer
    .$$cctor = function() {
        Xrm.Soap.ResponseSerializer.registerSerializer('GetQuantityDecimal',
            Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.Generated
            .GetQuantityDecimalResponseSerializer.loadFromCrmSoap);
    }
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.Generated.GetQuantityDecimalResponseSerializer
    .loadFromCrmSoap = function(soapResponse, request) {
        if (!_Script.isNullOrUndefined(soapResponse)) {
            Xrm.Soap.ResponseSerializer.addCrmSoapNamespaces(soapResponse);
            var $v_0 = null;
            $v_0 = soapResponse.selectSingleNode('.//a:Results');
...
Xrm.Gen.CanCloseOpportunityRequestSerializer.parametersToCrmSoap = function(request) {
    return Xrm.Soap.Write.f('OpportunityId', (request).opportunityId, 15) +
        Xrm.Soap.Write.f('QuoteId', (request).quoteId, 15) +
        Xrm.Soap.Write.f('NewStatus', (request).newStatus, 5);
}
Xrm.Gen.CanCloseOpportunityRequestSerializer.loadFromCrmSoap = function(data) {
    if (_Script.isNullOrUndefined(data)) {
        return null;
    }
    return new Xrm.Gen.CanCloseOpportunityRequest(Xrm.Soap.Parser
        .load(Microsoft.Crm.Client.Core.Framework.Guid, data, 'OpportunityId'),
        Xrm.Soap.Parser.load(Microsoft.Crm.Client.Core.Framework.Guid, data, 'QuoteId'),
        Xrm.Soap.Parser.load(Number, data, 'NewStatus'));
}
...
Xrm.Gen.ExportTemplateToWordResponseSerializer.loadFromCrmSoap = function(soapResponse, request) {
    return Xrm.Soap.ResponseSerializer.deserialize(soapResponse,
        request,
        function($p1_0) {
            return new Xrm.Gen.ExportTemplateToWordResponse(Xrm.Soap.Parser
                .load(String, $p1_0, 'WordFile', 'ByteArray'));
        });
}
...
Xrm.Gen.ExportTemplateToWordRequestSerializer.parametersToCrmSoap = function(request) {
    return Xrm.Soap.Write.f('EntityTypeCode', (request).entityTypeCode, 5) +
        Xrm.Soap.Write.f('SelectedEntities', (request).selectedEntities, 14);
}
Xrm.Gen.ExportTemplateToWordRequestSerializer.loadFromCrmSoap = function(data) {
    if (_Script.isNullOrUndefined(data)) {
        return null;
    }
    return new Xrm.Gen.ExportTemplateToWordRequest(Xrm.Soap.Parser.load(Number, data, 'EntityTypeCode'),
        Xrm.Soap.Parser.load(String, data, 'SelectedEntities'));
}
...
Xrm.Gen.ExportWordDocumentRequestSerializer.parametersToCrmSoap = function(request) {
    return Xrm.Soap.Write.f('EntityTypeCode', (request).entityTypeCode, 5) +
        Xrm.Soap.Write.f('SelectedTemplate', (request).selectedTemplate, 6) +
        Xrm.Soap.Write.f('SelectedRecords', (request).selectedRecords, 14);
}
Xrm.Gen.ExportWordDocumentRequestSerializer.loadFromCrmSoap = function(data) {
    if (_Script.isNullOrUndefined(data)) {
        return null;
    }
    return new Xrm.Gen.ExportWordDocumentRequest(Xrm.Soap.Parser.load(Number, data, 'EntityTypeCode'),
        Xrm.Soap.Parser.load(Xrm.Objects.EntityReference, data, 'SelectedTemplate'),
        Xrm.Soap.Parser.load(String, data, 'SelectedRecords'));
}
...
Xrm.Gen.SetWordTemplateRequestSerializer.loadFromCrmSoap = function(data) {
    ...
    return new Xrm.Gen.SetWordTemplateRequest(Xrm.Soap.Parser.load(Xrm.Objects.EntityReference, data, 'Target'),
        Xrm.Soap.Parser.load(Xrm.Objects.EntityReference, data, 'SelectedTemplate'));
}
...
Xrm.Gen.AddDynamicPropertyRequestSerializer.parametersToCrmSoap = function(request) {
    return Xrm.Soap.Write.f('RegardingObject', (request).regardingObject, 6) +
        Xrm.Soap.Write.f('DynamicProperty', (request).dynamicProperty, -1, 'a:Entity');
}
Xrm.Gen.AddDynamicPropertyRequestSerializer.loadFromCrmSoap = function(data) {
    if (_Script.isNullOrUndefined(data)) {
        return null;
    }
    return new Xrm.Gen.AddDynamicPropertyRequest(Xrm.Soap.Parser
        .load(Xrm.Objects.EntityReference, data, 'RegardingObject'),
        Xrm.Soap.Parser.load(Microsoft.Crm.Client.Core.Storage.Common.ObjectModel
            .EntityRecord,
            data,
            'DynamicProperty'));
}
...
Xrm.Gen.AddDynamicPropertyResponseSerializer.loadFromCrmSoap = function(soapResponse, request) {
    return Xrm.Soap.ResponseSerializer.deserialize(soapResponse,
        request,
        function($p1_0) {
            return new Xrm.Gen.AddDynamicPropertyResponse(Xrm.Soap.Parser
                .load(Microsoft.Crm.Client.Core.Framework.Guid, $p1_0, 'Id'),
                Xrm.Soap.Parser.load(Microsoft.Crm.Client.Core.Framework.Guid, $p1_0, 'DynamicPropertyId'));
        });
}
...
Xrm.Gen.AddItemCampaignActivityRequestSerializer.parametersToCrmSoap = function(request) {
    return Xrm.Soap.Write.f('CampaignActivityId', (request).campaignActivityId, 15) +
        Xrm.Soap.Write.f('ItemId', (request).itemId, 15) +
        Xrm.Soap.Write.f('EntityName', (request).entityName, 14);
}
Xrm.Gen.AddItemCampaignActivityRequestSerializer.loadFromCrmSoap = function(data) {
    ...
    return new Xrm.Gen.AddItemCampaignActivityRequest(Xrm.Soap.Parser
        .load(Microsoft.Crm.Client.Core.Framework.Guid, data, 'CampaignActivityId'),
        Xrm.Soap.Parser.load(Microsoft.Crm.Client.Core.Framework.Guid, data, 'ItemId'),
        Xrm.Soap.Parser.load(String, data, 'EntityName'));
}
...
Xrm.Gen.AddItemCampaignActivityResponseSerializer.loadFromCrmSoap = function(soapResponse, request) {
    return Xrm.Soap.ResponseSerializer.deserialize(soapResponse,
        ...
        function($p1_0) {
            return new Xrm.Gen
                .AddItemCampaignActivityResponse(Xrm.Soap.Parser
                    .load(Microsoft.Crm.Client.Core.Framework.Guid, $p1_0, 'CampaignActivityItemId'));
        });
}
...
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.Generated.AddItemRequestSerializer
    .$$cctor = function() {
        Xrm.Soap.Serializer.registerSerializer('AddItem',
            Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.Generated.AddItemRequestSerializer
            .parametersToCrmSoap);
        Xrm.Soap.Serializer.registerDeserializer('AddItem',
            Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.Generated.AddItemRequestSerializer
            .loadFromCrmSoap);
    }
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.Generated.AddItemRequestSerializer
    .parametersToCrmSoap = function(request) {
        var $v_0 = request;
        return Xrm.Soap.EntityRecordSerializer.fieldToCrmSoap('CampaignId', $v_0.campaignId, 15) +
            Xrm.Soap.EntityRecordSerializer.fieldToCrmSoap('EntityId', $v_0.entityId, 15) +
            Xrm.Soap.EntityRecordSerializer.fieldToCrmSoap('ObjectTypeCode', $v_0.objectTypeCode, 5);
    }
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.Generated.AddItemRequestSerializer
    .loadFromCrmSoap = function(data) {
        if (_Script.isNullOrUndefined(data)) {
...
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.Generated.AddItemResponseSerializer
    .$$cctor = function() {
        Xrm.Soap.ResponseSerializer.registerSerializer('AddItem',
            Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.Generated.AddItemResponseSerializer
            .loadFromCrmSoap);
    }
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.Generated.AddItemResponseSerializer
    .loadFromCrmSoap = function(soapResponse, request) {
        if (!_Script.isNullOrUndefined(soapResponse)) {
            ...
            if (!_Script.isNullOrUndefined($v_0)) {
                ...
                var $v_2 = (!_Script.isNullOrUndefined($v_1))
                    ? new Microsoft.Crm.Client.Core.Framework.Guid($v_1.get_innerText())
                    : null;
...
Xrm.Gen.AddRecurrenceRequestSerializer.parametersToCrmSoap = function(request) {
    return Xrm.Soap.Write.f('Target', (request).target, -1, 'a:Entity') +
        Xrm.Soap.Write.f('AppointmentId', (request).appointmentId, 15);
}
Xrm.Gen.AddRecurrenceRequestSerializer.loadFromCrmSoap = function(data) {
    if (_Script.isNullOrUndefined(data)) {
        return null;
    }
    return new Xrm.Gen.AddRecurrenceRequest(Xrm.Soap.Parser
        .load(Microsoft.Crm.Client.Core.Storage.Common.ObjectModel.EntityRecord, data, 'Target'),
        Xrm.Soap.Parser.load(Microsoft.Crm.Client.Core.Framework.Guid, data, 'AppointmentId'));
}
...
Xrm.Gen.AddRecurrenceResponseSerializer.loadFromCrmSoap = function(soapResponse, request) {
    return Xrm.Soap.ResponseSerializer.deserialize(soapResponse,
        request,
        function($p1_0) {
            return new Xrm.Gen.AddRecurrenceResponse(Xrm.Soap.Parser
                .load(Microsoft.Crm.Client.Core.Framework.Guid, $p1_0, 'id'));
        });
}
...
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.Generated.AddToQueueRequestSerializer
    .$$cctor = function() {
        Xrm.Soap.Serializer.registerSerializer('AddToQueue',
            Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.Generated
            .AddToQueueRequestSerializer.parametersToCrmSoap);
        Xrm.Soap.Serializer.registerDeserializer('AddToQueue',
            Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.Generated
            .AddToQueueRequestSerializer.loadFromCrmSoap);
    }
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.Generated.AddToQueueRequestSerializer
    .parametersToCrmSoap = function(request) {
        var $v_0 = request;
        return Xrm.Soap.EntityRecordSerializer.fieldToCrmSoap('Target', $v_0.target, 6) +
            Xrm.Soap.EntityRecordSerializer.fieldToCrmSoap('SourceQueueId', $v_0.sourceQueueId, 15) +
            Xrm.Soap.EntityRecordSerializer.fieldToCrmSoap('DestinationQueueId', $v_0.destinationQueueId, 15) +
            Xrm.Soap.EntityRecordSerializer.fieldToCrmSoap('QueueItemProperties',
                $v_0.queueItemProperties,
                -1,
                'a:Entity');
    }
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.Generated.AddToQueueRequestSerializer
...
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.Generated.AddToQueueResponseSerializer
    .$$cctor = function() {
        Xrm.Soap.ResponseSerializer.registerSerializer('AddToQueue',
            Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.Generated
            .AddToQueueResponseSerializer.loadFromCrmSoap);
    }
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.Generated.AddToQueueResponseSerializer
    .loadFromCrmSoap = function(soapResponse, request) {
        if (!_Script.isNullOrUndefined(soapResponse)) {
...
Xrm.Gen.BestTimeToEmailRequestSerializer.parametersToCrmSoap = function(request) {
    return Xrm.Soap.Write.f('EntityReferenceCollection',
        (request).entityReferenceCollection,
        -1,
...
Xrm.Gen.BestTimeToEmailRequestSerializer.loadFromCrmSoap = function(data) {
    ...
    return new Xrm.Gen.BestTimeToEmailRequest(Xrm.Soap.Parser
        .load(Array, data, 'EntityReferenceCollection', 'EntityReferenceArray'));
}
...
Xrm.Gen.FollowEmailAttachmentRequestSerializer.loadFromCrmSoap = function(data) {
    ...
    return new Xrm.Gen.FollowEmailAttachmentRequest(Xrm.Soap.Parser
        .load(Microsoft.Crm.Client.Core.Framework.Guid, data, 'ActivityMimeAttachmentId'));
}
...
Xrm.Gen.GenerateQuoteFromOpportunityRequestSerializer.loadFromCrmSoap = function(data) {
    ...
    return new Xrm.Gen.GenerateQuoteFromOpportunityRequest(Xrm.Soap.Parser
        .load(Microsoft.Crm.Client.Core.Framework.Guid, data, 'OpportunityId'),
        Xrm.Soap.Parser.load(Microsoft.Crm.Client.Core.Storage.Common.IColumnSet, data, 'ColumnSet', 'ColumnSet'));
}
...
Xrm.Gen.GenerateQuoteFromOpportunityResponseSerializer.loadFromCrmSoap = function(soapResponse, request) {
    return Xrm.Soap.ResponseSerializer.deserialize(soapResponse,
        ...
        function($p1_0) {
            return new Xrm.Gen
                .GenerateQuoteFromOpportunityResponse(Xrm.Soap.Parser
                    .load(Microsoft.Crm.Client.Core.Storage.Common.ObjectModel.EntityRecord, $p1_0, 'Entity'));
        });
}
...
Xrm.Gen.GenerateSalesOrderFromOpportunityRequestSerializer.loadFromCrmSoap = function(data) {
    ...
    return new Xrm.Gen
        .GenerateSalesOrderFromOpportunityRequest(Xrm.Soap.Parser
            .load(Microsoft.Crm.Client.Core.Framework.Guid, data, 'OpportunityId'),
            Xrm.Soap.Parser.load(Microsoft.Crm.Client.Core.Storage.Common.IColumnSet, data, 'ColumnSet', 'ColumnSet'));
}
...
Xrm.Gen.CancelContractRequestSerializer.parametersToCrmSoap = function(request) {
    return Xrm.Soap.Write.f('ContractId', (request).contractId, 15) +
        Xrm.Soap.Write.f('CancelDate', (request).cancelDate, 2) +
        Xrm.Soap.Write.f('Status', (request).status, 11);
}
Xrm.Gen.CancelContractRequestSerializer.loadFromCrmSoap = function(data) {
    ...
    return new Xrm.Gen.CancelContractRequest(Xrm.Soap.Parser
        .load(Microsoft.Crm.Client.Core.Framework.Guid, data, 'ContractId'),
        Xrm.Soap.Parser.load(Date, data, 'CancelDate'),
        Xrm.Soap.Parser.load(Number, data, 'Status', 'OptionSet'));
}
...
Xrm.Gen.GenerateSalesOrderFromOpportunityResponseSerializer.loadFromCrmSoap = function(soapResponse, request) {
    return Xrm.Soap.ResponseSerializer.deserialize(soapResponse,
        ...
        function($p1_0) {
            return new Xrm.Gen
                .GenerateSalesOrderFromOpportunityResponse(Xrm.Soap.Parser
                    .load(Microsoft.Crm.Client.Core.Storage.Common.ObjectModel.EntityRecord, $p1_0, 'Entity'));
        });
}
...
Xrm.Gen.GenerateInvoiceFromOpportunityRequestSerializer.loadFromCrmSoap = function(data) {
    ...
    return new Xrm.Gen
        .GenerateInvoiceFromOpportunityRequest(Xrm.Soap.Parser
            .load(Microsoft.Crm.Client.Core.Framework.Guid, data, 'OpportunityId'),
            Xrm.Soap.Parser.load(Microsoft.Crm.Client.Core.Storage.Common.IColumnSet, data, 'ColumnSet', 'ColumnSet'));
}
...
Xrm.Gen.GenerateInvoiceFromOpportunityResponseSerializer.loadFromCrmSoap = function(soapResponse, request) {
    return Xrm.Soap.ResponseSerializer.deserialize(soapResponse,
        ...
        function($p1_0) {
            return new Xrm.Gen
                .GenerateInvoiceFromOpportunityResponse(Xrm.Soap.Parser
                    .load(Microsoft.Crm.Client.Core.Storage.Common.ObjectModel.EntityRecord, $p1_0, 'Entity'));
        });
}
...
Xrm.Gen.GetRIProvisioningStatusResponseSerializer.loadFromCrmSoap = function(soapResponse, request) {
    return Xrm.Soap.ResponseSerializer.deserialize(soapResponse,
        ...
        function($p1_0) {
            return new Xrm.Gen
                .GetRIProvisioningStatusResponse(Xrm.Soap.Parser.load(String, $p1_0, 'ProvisioningStatus'));
        });
}
...
Xrm.Gen.ApplyRecordCreationAndUpdateRuleRequestSerializer.loadFromCrmSoap = function(data) {
    ...
    return new Xrm.Gen
        .ApplyRecordCreationAndUpdateRuleRequest(Xrm.Soap.Parser.load(Xrm.Objects.EntityReference, data, 'Target'));
}
...
Xrm.Gen.AssignRequestSerializer.loadFromCrmSoap = function(data) {
    ...
    return new Xrm.Gen.AssignRequest(Xrm.Soap.Parser.load(Xrm.Objects.EntityReference, data, 'Target'),
        Xrm.Soap.Parser.load(Xrm.Objects.EntityReference, data, 'Assignee'));
}
...
Xrm.Gen.AssociateRequestSerializer.parametersToCrmSoap = function(request) {
    return Xrm.Soap.Write.f('Target', (request).target, 6) +
        Xrm.Soap.Write.f('Relationship', (request).relationship, -1, 'a:Relationship') +
        Xrm.Soap.Write.f('RelatedEntities', (request).relatedEntities, -1, 'a:EntityReferenceCollection');
}
Xrm.Gen.AssociateRequestSerializer.loadFromCrmSoap = function(data) {
    if (_Script.isNullOrUndefined(data)) {
        return null;
    }
    return new Xrm.Gen.AssociateRequest(Xrm.Soap.Parser.load(Xrm.Objects.EntityReference, data, 'Target'),
        Xrm.Soap.Parser.load(Microsoft.Crm.Client.Core.Storage.Common.ObjectModel.Relationship, data, 'Relationship'),
        Xrm.Soap.Parser.load(Array, data, 'RelatedEntities', 'EntityReferenceArray'));
}
...
Xrm.Gen.CloneContractRequestSerializer.parametersToCrmSoap = function(request) {
    return Xrm.Soap.Write.f('ContractId', (request).contractId, 15) +
        Xrm.Soap.Write.f('IncludeCanceledLines', (request).includeCanceledLines, 0);
}
Xrm.Gen.CloneContractRequestSerializer.loadFromCrmSoap = function(data) {
    if (_Script.isNullOrUndefined(data)) {
        return null;
    }
    return new Xrm.Gen.CloneContractRequest(Xrm.Soap.Parser
        .load(Microsoft.Crm.Client.Core.Framework.Guid, data, 'ContractId'),
        Xrm.Soap.Parser.load(Boolean, data, 'IncludeCanceledLines'));
}
...
Xrm.Gen.CloneContractResponseSerializer.loadFromCrmSoap = function(soapResponse, request) {
    return Xrm.Soap.ResponseSerializer.deserialize(soapResponse,
        request,
        function($p1_0) {
            return new Xrm.Gen.CloneContractResponse(Xrm.Soap.Parser
                .load(Microsoft.Crm.Client.Core.Storage.Common.ObjectModel.EntityRecord, $p1_0, 'Entity'));
        });
}
...
Xrm.Gen.RenewContractRequestSerializer.parametersToCrmSoap = function(request) {
    return Xrm.Soap.Write.f('ContractId', (request).contractId, 15) +
        Xrm.Soap.Write.f('Status', (request).status, 5) +
        Xrm.Soap.Write.f('IncludeCanceledLines', (request).includeCanceledLines, 0);
}
Xrm.Gen.RenewContractRequestSerializer.loadFromCrmSoap = function(data) {
    ...
    return new Xrm.Gen.RenewContractRequest(Xrm.Soap.Parser
        .load(Microsoft.Crm.Client.Core.Framework.Guid, data, 'ContractId'),
        Xrm.Soap.Parser.load(Number, data, 'Status'),
        Xrm.Soap.Parser.load(Boolean, data, 'IncludeCanceledLines'));
}
...
Xrm.Gen.RenewContractResponseSerializer.loadFromCrmSoap = function(soapResponse, request) {
    return Xrm.Soap.ResponseSerializer.deserialize(soapResponse,
        request,
        function($p1_0) {
            return new Xrm.Gen.RenewContractResponse(Xrm.Soap.Parser
                .load(Microsoft.Crm.Client.Core.Storage.Common.ObjectModel.EntityRecord, $p1_0, 'Entity'));
        });
}
...
Xrm.Gen.RemoveDynamicPropertyRequestSerializer.parametersToCrmSoap = function(request) {
    return Xrm.Soap.Write.f('RegardingObject', (request).regardingObject, 6) +
        Xrm.Soap.Write.f('DynamicProperty', (request).dynamicProperty, 6);
}
Xrm.Gen.RemoveDynamicPropertyRequestSerializer.loadFromCrmSoap = function(data) {
    if (_Script.isNullOrUndefined(data)) {
        return null;
    }
    return new Xrm.Gen.RemoveDynamicPropertyRequest(Xrm.Soap.Parser
        .load(Xrm.Objects.EntityReference, data, 'RegardingObject'),
        Xrm.Soap.Parser.load(Xrm.Objects.EntityReference, data, 'DynamicProperty'));
}
...
Xrm.Gen.OverrideDynamicPropertyResponseSerializer.loadFromCrmSoap = function(soapResponse, request) {
    return Xrm.Soap.ResponseSerializer.deserialize(soapResponse,
        ...
        function($p1_0) {
            return new Xrm.Gen
                .OverrideDynamicPropertyResponse(Xrm.Soap.Parser
                    .load(Microsoft.Crm.Client.Core.Framework.Guid, $p1_0, 'Id'),
                    Xrm.Soap.Parser.load(Microsoft.Crm.Client.Core.Framework.Guid, $p1_0, 'DynamicPropertyId'));
        });
}
...
Xrm.Gen.OverrideDynamicPropertyRequestSerializer.loadFromCrmSoap = function(data) {
    ...
    return new Xrm.Gen.OverrideDynamicPropertyRequest(Xrm.Soap.Parser
        .load(Xrm.Objects.EntityReference, data, 'RegardingObject'),
        Xrm.Soap.Parser.load(Xrm.Objects.EntityReference, data, 'DynamicProperty'));
}
...
Xrm.Gen.OverwriteDynamicPropertyRequestSerializer.loadFromCrmSoap = function(data) {
    ...
    return new Xrm.Gen.OverwriteDynamicPropertyRequest(Xrm.Soap.Parser
        .load(Xrm.Objects.EntityReference, data, 'RegardingObject'),
        Xrm.Soap.Parser.load(Xrm.Objects.EntityReference, data, 'DynamicProperty'));
}
...
Xrm.Gen.OverwriteDynamicPropertyResponseSerializer.loadFromCrmSoap = function(soapResponse, request) {
    return Xrm.Soap.ResponseSerializer.deserialize(soapResponse,
        ...
        function($p1_0) {
            return new Xrm.Gen
                .OverwriteDynamicPropertyResponse(Xrm.Soap.Parser
                    .load(Microsoft.Crm.Client.Core.Framework.Guid, $p1_0, 'Id'),
                    Xrm.Soap.Parser.load(Microsoft.Crm.Client.Core.Framework.Guid, $p1_0, 'DynamicPropertyId'));
        });
}
...
Xrm.Gen.BulkDeleteImportedRecordsRequestSerializer.parametersToCrmSoap = function(request) {
    return Xrm.Soap.Write.f('TargetEntityName', (request).targetEntityName, 14) +
        Xrm.Soap.Write.f('ImportSequenceNumber', (request).importSequenceNumber, 5) +
        Xrm.Soap.Write.f('ImportId', (request).importId, 15) +
        Xrm.Soap.Write.f('DeleteImportHistory', (request).deleteImportHistory, 0) +
        Xrm.Soap.Write.f('JobName', (request).jobName, 14) +
        Xrm.Soap.Write.f('SendEmailNotification', (request).sendEmailNotification, 0) +
        Xrm.Soap.Write.f('ToRecipients', (request).toRecipients, 14) +
        Xrm.Soap.Write.f('CCRecipients', (request).ccRecipients, 14) +
        Xrm.Soap.Write.f('RecurrencePattern', (request).recurrencePattern, 14) +
        Xrm.Soap.Write.f('SourceImportId', (request).sourceImportId, 15);
}
Xrm.Gen.BulkDeleteImportedRecordsRequestSerializer.loadFromCrmSoap = function(data) {
    if (_Script.isNullOrUndefined(data)) {
        return null;
    }
    return new Xrm.Gen.BulkDeleteImportedRecordsRequest(Xrm.Soap.Parser.load(String, data, 'TargetEntityName'),
        Xrm.Soap.Parser.load(Number, data, 'ImportSequenceNumber'),
        Xrm.Soap.Parser.load(Microsoft.Crm.Client.Core.Framework.Guid, data, 'ImportId'),
        Xrm.Soap.Parser.load(Boolean, data, 'DeleteImportHistory'),
        Xrm.Soap.Parser.load(String, data, 'JobName'),
        Xrm.Soap.Parser.load(Boolean, data, 'SendEmailNotification'),
        Xrm.Soap.Parser.load(String, data, 'ToRecipients'),
        Xrm.Soap.Parser.load(String, data, 'CCRecipients'),
        Xrm.Soap.Parser.load(String, data, 'RecurrencePattern'),
        Xrm.Soap.Parser.load(Microsoft.Crm.Client.Core.Framework.Guid, data, 'SourceImportId'));
}
...
Xrm.Gen.BulkDeleteImportedRecordsResponseSerializer.loadFromCrmSoap = function(soapResponse, request) {
    return Xrm.Soap.ResponseSerializer.deserialize(soapResponse,
        ...
        function($p1_0) {
            return new Xrm.Gen
                .BulkDeleteImportedRecordsResponse(Xrm.Soap.Parser
                    .load(Microsoft.Crm.Client.Core.Framework.Guid, $p1_0, 'JobId'));
        });
}
...
Xrm.Gen.BookRequestSerializer.parametersToCrmSoap = function(request) {
    return Xrm.Soap.Write.f('Target', (request).target, -1, 'a:Entity') +
        Xrm.Soap.Write.f('MaintainLegacyAppServerBehavior', (request).maintainLegacyAppServerBehavior, 0) +
        Xrm.Soap.Write.f('ReturnNotifications', (request).returnNotifications, 0);
}
Xrm.Gen.BookRequestSerializer.loadFromCrmSoap = function(data) {
    if (_Script.isNullOrUndefined(data)) {
        return null;
    }
    return new Xrm.Gen.BookRequest(Xrm.Soap.Parser.load(Microsoft.Crm.Client.Core.Storage.Common.ObjectModel
            .EntityRecord,
            data,
            'Target'),
        Xrm.Soap.Parser.load(Boolean, data, 'MaintainLegacyAppServerBehavior'),
        Xrm.Soap.Parser.load(Boolean, data, 'ReturnNotifications'));
}
...
Xrm.Gen.BookResponseSerializer.loadFromCrmSoap = function(soapResponse, request) {
    if (!_Script.isNullOrUndefined(soapResponse)) {
        ...
        if (!_Script.isNullOrUndefined($v_0)) {
            ...
            var $v_2 = (!_Script.isNullOrUndefined($v_1))
                ? Xrm.Soap.ValidationResultSerializer.loadFromCrmSoap($v_1)
                : null;
            var $v_3 = $v_0.selectSingleNode('.//a:KeyValuePairOfstringanyType[c:key=\'Notifications\']/c:value');
            var $v_4 = (!_Script.isNullOrUndefined($v_3))
                ? Xrm.Soap.BusinessNotificationArraySerializer.loadFromCrmSoap($v_3)
                : null;
...
Xrm.Gen.CreateAndAssociateRequestSerializer.parametersToCrmSoap = function(request) {
    return Xrm.Soap.Write.f('RegardingObjectId', (request).regardingObjectId, 15) +
        Xrm.Soap.Write.f('RegardingObjectTypeCode', (request).regardingObjectTypeCode, 5) +
        Xrm.Soap.Write.f('AssociationRelationshipName', (request).associationRelationshipName, 14) +
        Xrm.Soap.Write.f('Article', (request).article, -1, 'a:Entity');
}
Xrm.Gen.CreateAndAssociateRequestSerializer.loadFromCrmSoap = function(data) {
    if (_Script.isNullOrUndefined(data)) {
        return null;
    }
    return new Xrm.Gen.CreateAndAssociateRequest(Xrm.Soap.Parser
        .load(Microsoft.Crm.Client.Core.Framework.Guid, data, 'RegardingObjectId'),
        Xrm.Soap.Parser.load(Number, data, 'RegardingObjectTypeCode'),
        Xrm.Soap.Parser.load(String, data, 'AssociationRelationshipName'),
        Xrm.Soap.Parser.load(Microsoft.Crm.Client.Core.Storage.Common.ObjectModel.EntityRecord, data, 'Article'));
}
...
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.Generated
    .AssociateKnowledgeArticleRequestSerializer.$$cctor = function() {
        Xrm.Soap.Serializer.registerSerializer('AssociateKnowledgeArticle',
            Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.Generated
            .AssociateKnowledgeArticleRequestSerializer.parametersToCrmSoap);
        Xrm.Soap.Serializer.registerDeserializer('AssociateKnowledgeArticle',
            Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.Generated
            .AssociateKnowledgeArticleRequestSerializer.loadFromCrmSoap);
    }
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.Generated
    .AssociateKnowledgeArticleRequestSerializer.parametersToCrmSoap = function(request) {
        var $v_0 = request;
        return Xrm.Soap.EntityRecordSerializer.fieldToCrmSoap('RegardingObjectId', $v_0.regardingObjectId, 15) +
            Xrm.Soap.EntityRecordSerializer.fieldToCrmSoap('RegardingObjectTypeCode', $v_0.regardingObjectTypeCode, 5) +
            Xrm.Soap.EntityRecordSerializer.fieldToCrmSoap('AssociationRelationshipName',
                $v_0.associationRelationshipName,
                14) +
            Xrm.Soap.EntityRecordSerializer.fieldToCrmSoap('KnowledgeArticleId', $v_0.knowledgeArticleId, 15);
    }
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.Generated
    .AssociateKnowledgeArticleRequestSerializer.loadFromCrmSoap = function(data) {
        if (_Script.isNullOrUndefined(data)) {
            return null;
        }
        ...
        var $v_4 = data
            .selectSingleNode('.//a:KeyValuePairOfstringanyType[b:key=\'AssociationRelationshipName\']/b:value');
        ...
        var $v_7 = (!_Script.isNullOrUndefined($v_6))
            ? new Microsoft.Crm.Client.Core.Framework.Guid($v_6.get_innerText())
            : null;
...
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.Generated
    .DisassociateKnowledgeArticleRequestSerializer.$$cctor = function() {
        Xrm.Soap.Serializer.registerSerializer('DisassociateKnowledgeArticle',
            Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.Generated
            .DisassociateKnowledgeArticleRequestSerializer.parametersToCrmSoap);
        Xrm.Soap.Serializer.registerDeserializer('DisassociateKnowledgeArticle',
            Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.Generated
            .DisassociateKnowledgeArticleRequestSerializer.loadFromCrmSoap);
    }
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.Generated
    .DisassociateKnowledgeArticleRequestSerializer.parametersToCrmSoap = function(request) {
        var $v_0 = request;
        return Xrm.Soap.EntityRecordSerializer.fieldToCrmSoap('RegardingObjectId', $v_0.regardingObjectId, 15) +
            Xrm.Soap.EntityRecordSerializer.fieldToCrmSoap('RegardingObjectTypeCode', $v_0.regardingObjectTypeCode, 5) +
            Xrm.Soap.EntityRecordSerializer.fieldToCrmSoap('AssociationRelationshipName',
...
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.Generated
    .DisassociateKnowledgeArticleRequestSerializer.loadFromCrmSoap = function(data) {
        if (_Script.isNullOrUndefined(data)) {
            return null;
        }
        var $v_0 = data.selectSingleNode('.//a:KeyValuePairOfstringanyType[b:key=\'RegardingObjectId\']/b:value');
...
Xrm.Gen.CancelSalesOrderRequestSerializer.parametersToCrmSoap = function(request) {
    return Xrm.Soap.Write.f('OrderClose', (request).orderClose, -1, 'a:Entity') +
        Xrm.Soap.Write.f('Status', (request).status, 11);
}
Xrm.Gen.CancelSalesOrderRequestSerializer.loadFromCrmSoap = function(data) {
    ...
    return new Xrm.Gen.CancelSalesOrderRequest(Xrm.Soap.Parser
        .load(Microsoft.Crm.Client.Core.Storage.Common.ObjectModel.EntityRecord, data, 'OrderClose'),
        Xrm.Soap.Parser.load(Number, data, 'Status', 'OptionSet'));
}
...
Xrm.Gen.CloneProductResponseSerializer.loadFromCrmSoap = function(soapResponse, request) {
    return Xrm.Soap.ResponseSerializer.deserialize(soapResponse,
        request,
        function($p1_0) {
            return new Xrm.Gen.CloneProductResponse(Xrm.Soap.Parser
                .load(Xrm.Objects.EntityReference, $p1_0, 'ClonedProduct'));
        });
}
...
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.Generated
    .CloneMobileOfflineProfileRequestSerializer.$$cctor = function() {
        Xrm.Soap.Serializer.registerSerializer('CloneMobileOfflineProfile',
            Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.Generated
            .CloneMobileOfflineProfileRequestSerializer.parametersToCrmSoap);
        Xrm.Soap.Serializer.registerDeserializer('CloneMobileOfflineProfile',
            Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.Generated
            .CloneMobileOfflineProfileRequestSerializer.loadFromCrmSoap);
    }
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.Generated
    .CloneMobileOfflineProfileRequestSerializer.parametersToCrmSoap = function(request) {
        var $v_0 = request;
        return Xrm.Soap.EntityRecordSerializer.fieldToCrmSoap('Source', $v_0.source, 6);
    }
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.Generated
    .CloneMobileOfflineProfileRequestSerializer.loadFromCrmSoap = function(data) {
        if (_Script.isNullOrUndefined(data)) {
            return null;
        }
...
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.Generated
    .CloneMobileOfflineProfileResponseSerializer.$$cctor = function() {
        Xrm.Soap.ResponseSerializer.registerSerializer('CloneMobileOfflineProfile',
            Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.Generated
            .CloneMobileOfflineProfileResponseSerializer.loadFromCrmSoap);
    }
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.Generated
    .CloneMobileOfflineProfileResponseSerializer.loadFromCrmSoap = function(soapResponse, request) {
        if (!_Script.isNullOrUndefined(soapResponse)) {
            Xrm.Soap.ResponseSerializer.addCrmSoapNamespaces(soapResponse);
            var $v_0 = null;
            $v_0 = soapResponse.selectSingleNode('.//a:Results');
            if (!_Script.isNullOrUndefined($v_0)) {
                var $v_1 = $v_0
                    .selectSingleNode('.//a:KeyValuePairOfstringanyType[b:key=\'CloneMobileOfflineProfile\']/b:value');
                var $v_2 = (!_Script.isNullOrUndefined($v_1))
                    ? Xrm.Soap.EntityReferenceSerializer.loadFromCrmSoap($v_1)
                    : null;
...
Xrm.Gen.CheckInDocumentRequestSerializer.parametersToCrmSoap = function(request) {
    return Xrm.Soap.Write.f('Entity', (request).entity, -1, 'a:Entity') +
        Xrm.Soap.Write.f('CheckInComments', (request).checkInComments, 14) +
        Xrm.Soap.Write.f('RetainCheckout', (request).retainCheckout, 0);
}
Xrm.Gen.CheckInDocumentRequestSerializer.loadFromCrmSoap = function(data) {
    if (_Script.isNullOrUndefined(data)) {
        return null;
    }
    return new Xrm.Gen.CheckInDocumentRequest(Xrm.Soap.Parser
        .load(Microsoft.Crm.Client.Core.Storage.Common.ObjectModel.EntityRecord, data, 'Entity'),
        Xrm.Soap.Parser.load(String, data, 'CheckInComments'),
        Xrm.Soap.Parser.load(Boolean, data, 'RetainCheckout'));
}
...
Xrm.Gen.CheckoutDocumentRequestSerializer.loadFromCrmSoap = function(data) {
    ...
    return new Xrm.Gen.CheckoutDocumentRequest(Xrm.Soap.Parser
        .load(Microsoft.Crm.Client.Core.Storage.Common.ObjectModel.EntityRecord, data, 'Entity'));
}
...
Xrm.Gen.ConvertSalesOrderToInvoiceRequestSerializer.loadFromCrmSoap = function(data) {
    ...
    return new Xrm.Gen.ConvertSalesOrderToInvoiceRequest(Xrm.Soap.Parser
        .load(Microsoft.Crm.Client.Core.Framework.Guid, data, 'SalesOrderId'),
        Xrm.Soap.Parser.load(Microsoft.Crm.Client.Core.Storage.Common.IColumnSet, data, 'ColumnSet', 'ColumnSet'));
}
...
Xrm.Gen.ConvertSalesOrderToInvoiceResponseSerializer.loadFromCrmSoap = function(soapResponse, request) {
    return Xrm.Soap.ResponseSerializer.deserialize(soapResponse,
        ...
        function($p1_0) {
            return new Xrm.Gen
                .ConvertSalesOrderToInvoiceResponse(Xrm.Soap.Parser
                    .load(Microsoft.Crm.Client.Core.Storage.Common.ObjectModel.EntityRecord, $p1_0, 'Entity'));
        });
}
...
Xrm.Gen.ExecuteWorkflowRequestSerializer.parametersToCrmSoap = function(request) {
    return Xrm.Soap.Write.f('EntityId', (request).entityId, 15) +
        Xrm.Soap.Write.f('WorkflowId', (request).workflowId, 15) +
...
Xrm.Gen.ExecuteWorkflowRequestSerializer.loadFromCrmSoap = function(data) {
    ...
    return new Xrm.Gen.ExecuteWorkflowRequest(Xrm.Soap.Parser
        .load(Microsoft.Crm.Client.Core.Framework.Guid, data, 'EntityId'),
        Xrm.Soap.Parser.load(Microsoft.Crm.Client.Core.Framework.Guid, data, 'WorkflowId'),
        Xrm.Soap.Parser.load(Object, data, 'InputArguments', 'InputArgumentCollection'));
}
...
Xrm.Gen.ExecuteWorkflowResponseSerializer.loadFromCrmSoap = function(soapResponse, request) {
    return Xrm.Soap.ResponseSerializer.deserialize(soapResponse,
        request,
        function($p1_0) {
            return new Xrm.Gen.ExecuteWorkflowResponse(Xrm.Soap.Parser
                .load(Microsoft.Crm.Client.Core.Framework.Guid, $p1_0, 'Id'));
        });
}
...
Xrm.Gen.RetrieveUserDefaultCurrencyResponseSerializer.loadFromCrmSoap = function(soapResponse, request) {
    return Xrm.Soap.ResponseSerializer.deserialize(soapResponse,
        ...
        function($p1_0) {
            return new Xrm.Gen
                .RetrieveUserDefaultCurrencyResponse(Xrm.Soap.Parser
                    .load(Xrm.Objects.EntityReference, $p1_0, 'Currency'));
        });
}
...
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.Generated
    .GetDataForTopicWordCloudRequestSerializer.$$cctor = function() {
        Xrm.Soap.Serializer.registerSerializer('GetDataForTopicWordCloud',
            Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.Generated
            .GetDataForTopicWordCloudRequestSerializer.parametersToCrmSoap);
        Xrm.Soap.Serializer.registerDeserializer('GetDataForTopicWordCloud',
            Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.Generated
            .GetDataForTopicWordCloudRequestSerializer.loadFromCrmSoap);
    }
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.Generated
    .GetDataForTopicWordCloudRequestSerializer.parametersToCrmSoap = function(request) {
        var $v_0 = request;
        return Xrm.Soap.EntityRecordSerializer.fieldToCrmSoap('Filter', $v_0.filter, 14);
    }
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.Generated
    .GetDataForTopicWordCloudRequestSerializer.loadFromCrmSoap = function(data) {
        if (_Script.isNullOrUndefined(data)) {
            return null;
        }
...
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.Generated
    .GetDataForTopicWordCloudResponseSerializer.$$cctor = function() {
        Xrm.Soap.ResponseSerializer.registerSerializer('GetDataForTopicWordCloud',
            Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.Generated
            .GetDataForTopicWordCloudResponseSerializer.loadFromCrmSoap);
    }
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.Generated
    .GetDataForTopicWordCloudResponseSerializer.loadFromCrmSoap = function(soapResponse, request) {
        if (!_Script.isNullOrUndefined(soapResponse)) {
            Xrm.Soap.ResponseSerializer.addCrmSoapNamespaces(soapResponse);
            var $v_0 = null;
            $v_0 = soapResponse.selectSingleNode('.//a:Results');
...
Xrm.Gen.GetFieldListForAzureMLRequestSerializer.loadFromCrmSoap = function(data) {
    ...
    return new Xrm.Gen.GetFieldListForAzureMLRequest(Xrm.Soap.Parser.load(String, data, 'EntityName'),
        Xrm.Soap.Parser.load(String, data, 'Filter'));
}
...
Xrm.Gen.GetRelationshipsForAzureMLRequestSerializer.loadFromCrmSoap = function(data) {
    ...
    return new Xrm.Gen.GetRelationshipsForAzureMLRequest(Xrm.Soap.Parser.load(String, data, 'EntityName'),
        Xrm.Soap.Parser.load(String, data, 'Filter'));
}
...
Xrm.Gen.CopyDynamicListToStaticRequestSerializer.loadFromCrmSoap = function(data) {
    ...
    return new Xrm.Gen.CopyDynamicListToStaticRequest(Xrm.Soap.Parser
        .load(Microsoft.Crm.Client.Core.Framework.Guid, data, 'ListId'));
}
...
Xrm.Gen.CopyDynamicListToStaticResponseSerializer.loadFromCrmSoap = function(soapResponse, request) {
    return Xrm.Soap.ResponseSerializer.deserialize(soapResponse,
        ...
        function($p1_0) {
            return new Xrm.Gen
                .CopyDynamicListToStaticResponse(Xrm.Soap.Parser
                    .load(Microsoft.Crm.Client.Core.Framework.Guid, $p1_0, 'StaticListId'));
        });
}
...
Xrm.Gen.DeleteOpenInstancesRequestSerializer.parametersToCrmSoap = function(request) {
    return Xrm.Soap.Write.f('Target', (request).target, -1, 'a:Entity') +
        Xrm.Soap.Write.f('SeriesEndDate', (request).seriesEndDate, 2) +
        Xrm.Soap.Write.f('StateOfPastInstances', (request).stateOfPastInstances, 5);
}
Xrm.Gen.DeleteOpenInstancesRequestSerializer.loadFromCrmSoap = function(data) {
    if (_Script.isNullOrUndefined(data)) {
        return null;
    }
    return new Xrm.Gen.DeleteOpenInstancesRequest(Xrm.Soap.Parser
        .load(Microsoft.Crm.Client.Core.Storage.Common.ObjectModel.EntityRecord, data, 'Target'),
        Xrm.Soap.Parser.load(Date, data, 'SeriesEndDate'),
        Xrm.Soap.Parser.load(Number, data, 'StateOfPastInstances'));
}
...
Xrm.Gen.NewDocumentRequestSerializer.parametersToCrmSoap = function(request) {
    return Xrm.Soap.Write.f('FileName', (request).fileName, 14) +
        Xrm.Soap.Write.f('RegardingObjectId', (request).regardingObjectId, 14) +
        Xrm.Soap.Write.f('RegardingObjectTypeCode', (request).regardingObjectTypeCode, 14) +
        Xrm.Soap.Write.f('LocationId', (request).locationId, 14);
}
Xrm.Gen.NewDocumentRequestSerializer.loadFromCrmSoap = function(data) {
    if (_Script.isNullOrUndefined(data)) {
        return null;
    }
    return new Xrm.Gen.NewDocumentRequest(Xrm.Soap.Parser.load(String, data, 'FileName'),
        Xrm.Soap.Parser.load(String, data, 'RegardingObjectId'),
        Xrm.Soap.Parser.load(String, data, 'RegardingObjectTypeCode'),
        Xrm.Soap.Parser.load(String, data, 'LocationId'));
}
...
Xrm.Gen.ReleaseToQueueRequestSerializer.loadFromCrmSoap = function(data) {
    ...
    return new Xrm.Gen.ReleaseToQueueRequest(Xrm.Soap.Parser
        .load(Microsoft.Crm.Client.Core.Framework.Guid, data, 'QueueItemId'));
}
...
Xrm.Gen.RemoveFromQueueRequestSerializer.loadFromCrmSoap = function(data) {
    ...
    return new Xrm.Gen.RemoveFromQueueRequest(Xrm.Soap.Parser
        .load(Microsoft.Crm.Client.Core.Framework.Guid, data, 'QueueItemId'));
}
...
Xrm.Gen.SendFaxRequestSerializer.loadFromCrmSoap = function(data) {
    ...
    return new Xrm.Gen.SendFaxRequest(Xrm.Soap.Parser.load(Microsoft.Crm.Client.Core.Framework.Guid, data, 'FaxId'),
        Xrm.Soap.Parser.load(Boolean, data, 'IssueSend'));
}
...
Xrm.Gen.SetBusinessSystemUserRequestSerializer.parametersToCrmSoap = function(request) {
    return Xrm.Soap.Write.f('UserId', (request).userId, 15) +
        Xrm.Soap.Write.f('BusinessId', (request).businessId, 15) +
        Xrm.Soap.Write.f('ReassignPrincipal', (request).reassignPrincipal, 6);
}
Xrm.Gen.SetBusinessSystemUserRequestSerializer.loadFromCrmSoap = function(data) {
    if (_Script.isNullOrUndefined(data)) {
        return null;
    }
    return new Xrm.Gen.SetBusinessSystemUserRequest(Xrm.Soap.Parser
        .load(Microsoft.Crm.Client.Core.Framework.Guid, data, 'UserId'),
        Xrm.Soap.Parser.load(Microsoft.Crm.Client.Core.Framework.Guid, data, 'BusinessId'),
        Xrm.Soap.Parser.load(Xrm.Objects.EntityReference, data, 'ReassignPrincipal'));
}
...
Xrm.Gen.CloseIncidentRequestSerializer.parametersToCrmSoap = function(request) {
    return Xrm.Soap.Write.f('IncidentResolution', (request).incidentResolution, -1, 'a:Entity') +
        Xrm.Soap.Write.f('Status', (request).status, 11);
}
Xrm.Gen.CloseIncidentRequestSerializer.loadFromCrmSoap = function(data) {
    ...
    return new Xrm.Gen.CloseIncidentRequest(Xrm.Soap.Parser
        .load(Microsoft.Crm.Client.Core.Storage.Common.ObjectModel.EntityRecord, data, 'IncidentResolution'),
        Xrm.Soap.Parser.load(Number, data, 'Status', 'OptionSet'));
}
...
Xrm.Gen.ConvertActivityRequestSerializer.parametersToCrmSoap = function(request) {
    return Xrm.Soap.Write.f('ActivityId', (request).activityId, 15) +
        Xrm.Soap.Write.f('ActivityEntityName', (request).activityEntityName, 14) +
        Xrm.Soap.Write.f('TargetEntity', (request).targetEntity, -1, 'a:Entity') +
        Xrm.Soap.Write.f('TargetEntityName', (request).targetEntityName, 14) +
        Xrm.Soap.Write.f('CreateCampaignResponse', (request).createCampaignResponse, 0);
}
Xrm.Gen.ConvertActivityRequestSerializer.loadFromCrmSoap = function(data) {
    if (_Script.isNullOrUndefined(data)) {
        return null;
    }
    return new Xrm.Gen.ConvertActivityRequest(Xrm.Soap.Parser
        .load(Microsoft.Crm.Client.Core.Framework.Guid, data, 'ActivityId'),
        Xrm.Soap.Parser.load(String, data, 'ActivityEntityName'),
        Xrm.Soap.Parser.load(Microsoft.Crm.Client.Core.Storage.Common.ObjectModel.EntityRecord, data, 'TargetEntity'),
        Xrm.Soap.Parser.load(String, data, 'TargetEntityName'),
        Xrm.Soap.Parser.load(Boolean, data, 'CreateCampaignResponse'));
}
...
Xrm.Gen.ConvertActivityResponseSerializer.loadFromCrmSoap = function(soapResponse, request) {
    return Xrm.Soap.ResponseSerializer.deserialize(soapResponse,
        request,
        function($p1_0) {
            return new Xrm.Gen.ConvertActivityResponse(Xrm.Soap.Parser
                .load(Microsoft.Crm.Client.Core.Framework.Guid, $p1_0, 'RecordId'));
        });
}
...
Xrm.Gen.CreateFolderRequestSerializer.parametersToCrmSoap = function(request) {
    return Xrm.Soap.Write.f('FolderName', (request).folderName, 14) +
        Xrm.Soap.Write.f('RegardingObjectType', (request).regardingObjectType, 5) +
        Xrm.Soap.Write.f('RegardingObjectId', (request).regardingObjectId, 14) +
        Xrm.Soap.Write.f('DocumentType', (request).documentType, 5) +
        Xrm.Soap.Write.f('ParentLocationId', (request).parentLocationId, 14) +
        Xrm.Soap.Write.f('SiteType', (request).siteType, 5) +
        Xrm.Soap.Write.f('ValidateFolder', (request).validateFolder, 0);
}
Xrm.Gen.CreateFolderRequestSerializer.loadFromCrmSoap = function(data) {
    if (_Script.isNullOrUndefined(data)) {
        return null;
    }
    return new Xrm.Gen.CreateFolderRequest(Xrm.Soap.Parser.load(String, data, 'FolderName'),
        Xrm.Soap.Parser.load(Number, data, 'RegardingObjectType'),
        Xrm.Soap.Parser.load(String, data, 'RegardingObjectId'),
        Xrm.Soap.Parser.load(Number, data, 'DocumentType'),
        Xrm.Soap.Parser.load(String, data, 'ParentLocationId'),
        Xrm.Soap.Parser.load(Number, data, 'SiteType'),
        Xrm.Soap.Parser.load(Boolean, data, 'ValidateFolder'));
}
...
Xrm.Gen.CreateFolderResponseSerializer.loadFromCrmSoap = function(soapResponse, request) {
    return Xrm.Soap.ResponseSerializer.deserialize(soapResponse,
        request,
        function($p1_0) {
            return new Xrm.Gen.CreateFolderResponse(Xrm.Soap.Parser
                .load(Microsoft.Crm.Client.Core.Framework.Guid, $p1_0, 'LocationId'));
        });
}
...
Xrm.Gen.SearchDocumentRequestSerializer.parametersToCrmSoap = function(request) {
    return Xrm.Soap.Write.f('RegardingObjectType', (request).regardingObjectType, 5) +
        Xrm.Soap.Write.f('RegardingObjectId', (request).regardingObjectId, 14) +
        Xrm.Soap.Write.f('DocumentId', (request).documentId, 14);
}
Xrm.Gen.SearchDocumentRequestSerializer.loadFromCrmSoap = function(data) {
    if (_Script.isNullOrUndefined(data)) {
        return null;
    }
    return new Xrm.Gen.SearchDocumentRequest(Xrm.Soap.Parser.load(Number, data, 'RegardingObjectType'),
        Xrm.Soap.Parser.load(String, data, 'RegardingObjectId'),
        Xrm.Soap.Parser.load(String, data, 'DocumentId'));
}
...
Xrm.Gen.SearchDocumentResponseSerializer.loadFromCrmSoap = function(soapResponse, request) {
    return Xrm.Soap.ResponseSerializer.deserialize(soapResponse,
        request,
        function($p1_0) {
            return new Xrm.Gen.SearchDocumentResponse(Xrm.Soap.Parser.load(String, $p1_0, 'SearchLocation'),
                Xrm.Soap.Parser.load(String, $p1_0, 'DocumentLocation'));
        });
}
...
Xrm.Gen.SendEmailRequestSerializer.parametersToCrmSoap = function(request) {
    return Xrm.Soap.Write.f('EmailId', (request).emailId, 15) +
        Xrm.Soap.Write.f('IssueSend', (request).issueSend, 0) +
        Xrm.Soap.Write.f('TrackingToken', (request).trackingToken, 14);
}
Xrm.Gen.SendEmailRequestSerializer.loadFromCrmSoap = function(data) {
    if (_Script.isNullOrUndefined(data)) {
        return null;
    }
    return new Xrm.Gen.SendEmailRequest(Xrm.Soap.Parser.load(Microsoft.Crm.Client.Core.Framework.Guid, data, 'EmailId'),
        Xrm.Soap.Parser.load(Boolean, data, 'IssueSend'),
        Xrm.Soap.Parser.load(String, data, 'TrackingToken'));
}
...
Xrm.Gen.SetBusinessEquipmentRequestSerializer.parametersToCrmSoap = function(request) {
    return Xrm.Soap.Write.f('EquipmentId', (request).equipmentId, 15) +
        Xrm.Soap.Write.f('BusinessUnitId', (request).businessUnitId, 15);
}
Xrm.Gen.SetBusinessEquipmentRequestSerializer.loadFromCrmSoap = function(data) {
    if (_Script.isNullOrUndefined(data)) {
        return null;
    }
    return new Xrm.Gen.SetBusinessEquipmentRequest(Xrm.Soap.Parser
        .load(Microsoft.Crm.Client.Core.Framework.Guid, data, 'EquipmentId'),
        Xrm.Soap.Parser.load(Microsoft.Crm.Client.Core.Framework.Guid, data, 'BusinessUnitId'));
}
...
Xrm.Gen.SetParentBusinessUnitRequestSerializer.parametersToCrmSoap = function(request) {
    return Xrm.Soap.Write.f('BusinessUnitId', (request).businessUnitId, 15) +
        Xrm.Soap.Write.f('ParentId', (request).parentId, 15);
}
Xrm.Gen.SetParentBusinessUnitRequestSerializer.loadFromCrmSoap = function(data) {
    if (_Script.isNullOrUndefined(data)) {
        return null;
    }
    return new Xrm.Gen.SetParentBusinessUnitRequest(Xrm.Soap.Parser
        .load(Microsoft.Crm.Client.Core.Framework.Guid, data, 'BusinessUnitId'),
        Xrm.Soap.Parser.load(Microsoft.Crm.Client.Core.Framework.Guid, data, 'ParentId'));
}
...
Xrm.Gen.SetParentTeamRequestSerializer.loadFromCrmSoap = function(data) {
    ...
    return new Xrm.Gen.SetParentTeamRequest(Xrm.Soap.Parser
        .load(Microsoft.Crm.Client.Core.Framework.Guid, data, 'TeamId'),
        Xrm.Soap.Parser.load(Microsoft.Crm.Client.Core.Framework.Guid, data, 'BusinessId'));
}
...
Xrm.Gen.CreateDocumentLibrariesRequestSerializer.parametersToCrmSoap = function(request) {
    return Xrm.Soap.Write.f('DocumentLibraryNames', (request).documentLibraryNames, 14) +
        Xrm.Soap.Write.f('Url', (request).url, 14);
}
Xrm.Gen.CreateDocumentLibrariesRequestSerializer.loadFromCrmSoap = function(data) {
    if (_Script.isNullOrUndefined(data)) {
        return null;
    }
    return new Xrm.Gen.CreateDocumentLibrariesRequest(Xrm.Soap.Parser.load(String, data, 'DocumentLibraryNames'),
        Xrm.Soap.Parser.load(String, data, 'Url'));
}
...
Xrm.Gen.CreateDocumentLibrariesResponseSerializer.loadFromCrmSoap = function(soapResponse, request) {
    return Xrm.Soap.ResponseSerializer.deserialize(soapResponse,
        ...
        function($p1_0) {
            return new Xrm.Gen
                .CreateDocumentLibrariesResponse(Xrm.Soap.Parser.load(String, $p1_0, 'DocumentLibraryResult'));
        });
}
...
Xrm.Gen.UnfollowEmailAttachmentRequestSerializer.loadFromCrmSoap = function(data) {
    ...
    return new Xrm.Gen.UnfollowEmailAttachmentRequest(Xrm.Soap.Parser
        .load(Microsoft.Crm.Client.Core.Framework.Guid, data, 'ActivityMimeAttachmentId'));
}
...
Xrm.Gen.GetEmailLinkTrackingUrlsRequestSerializer.parametersToCrmSoap = function(request) {
    return Xrm.Soap.Write.f('TrackingId', (request).trackingId, 15) +
        Xrm.Soap.Write.f('ConversationTrackingId', (request).conversationTrackingId, 15) +
        Xrm.Soap.Write.f('ClientType', (request).clientType, 14) +
        Xrm.Soap.Write.f('EmailLinkUrls',
            (request).emailLinkUrls,
            -1,
            'sa:ArrayOfstring',
...
Xrm.Gen.GetEmailLinkTrackingUrlsRequestSerializer.loadFromCrmSoap = function(data) {
    ...
    return new Xrm.Gen.GetEmailLinkTrackingUrlsRequest(Xrm.Soap.Parser
        .load(Microsoft.Crm.Client.Core.Framework.Guid, data, 'TrackingId'),
        Xrm.Soap.Parser.load(Microsoft.Crm.Client.Core.Framework.Guid, data, 'ConversationTrackingId'),
        Xrm.Soap.Parser.load(String, data, 'ClientType'),
        Xrm.Soap.Parser.load(Array, data, 'EmailLinkUrls', 'StringArray'));
}
...
Xrm.Gen.GetEmailTrackingPixelUrlRequestSerializer.loadFromCrmSoap = function(data) {
    ...
    return new Xrm.Gen.GetEmailTrackingPixelUrlRequest(Xrm.Soap.Parser
        .load(Microsoft.Crm.Client.Core.Framework.Guid, data, 'TrackingId'),
        Xrm.Soap.Parser.load(Microsoft.Crm.Client.Core.Framework.Guid, data, 'ConversationTrackingId'),
        Xrm.Soap.Parser.load(String, data, 'ClientType'));
}
...
Xrm.Gen.UpdateDocumentManagementSettingsRequestSerializer.parametersToCrmSoap = function(request) {
    return Xrm.Soap.Write.f('SiteCollection', (request).siteCollection, 14) +
        Xrm.Soap.Write.f('FolderStructureEntity', (request).folderStructureEntity, 5) +
        Xrm.Soap.Write.f('EntityDocMgmtXml', (request).entityDocMgmtXml, 14) +
        Xrm.Soap.Write.f('ValidateStatus', (request).validateStatus, 5) +
        Xrm.Soap.Write.f('ValidateStatusReason', (request).validateStatusReason, 5);
}
Xrm.Gen.UpdateDocumentManagementSettingsRequestSerializer.loadFromCrmSoap = function(data) {
    ...
    return new Xrm.Gen
        .UpdateDocumentManagementSettingsRequest(Xrm.Soap.Parser.load(String, data, 'SiteCollection'),
            Xrm.Soap.Parser.load(Number, data, 'FolderStructureEntity'),
            Xrm.Soap.Parser.load(String, data, 'EntityDocMgmtXml'),
            Xrm.Soap.Parser.load(Number, data, 'ValidateStatus'),
            Xrm.Soap.Parser.load(Number, data, 'ValidateStatusReason'));
}
...
Xrm.Gen.MigrateToS2SRequestSerializer.parametersToCrmSoap = function(request) {
    return Xrm.Soap.Write.f('SiteUrl', (request).siteUrl, 14) +
        Xrm.Soap.Write.f('EnableOneDrive', (request).enableOneDrive, 0);
}
Xrm.Gen.MigrateToS2SRequestSerializer.loadFromCrmSoap = function(data) {
    if (_Script.isNullOrUndefined(data)) {
        return null;
    }
    return new Xrm.Gen.MigrateToS2SRequest(Xrm.Soap.Parser.load(String, data, 'SiteUrl'),
        Xrm.Soap.Parser.load(Boolean, data, 'EnableOneDrive'));
}
...
Xrm.Gen.UpdateGlobalSharePointSettingsRequestSerializer.parametersToCrmSoap = function(request) {
    return Xrm.Soap.Write.f('SharePointRealm', (request).sharePointRealm, 14) +
        Xrm.Soap.Write.f('IsSharePointOnline', (request).isSharePointOnline, 0) +
        Xrm.Soap.Write.f('UseAuthorizationServer', (request).useAuthorizationServer, 0);
}
Xrm.Gen.UpdateGlobalSharePointSettingsRequestSerializer.loadFromCrmSoap = function(data) {
    ...
    return new Xrm.Gen
        .UpdateGlobalSharePointSettingsRequest(Xrm.Soap.Parser.load(String, data, 'SharePointRealm'),
            Xrm.Soap.Parser.load(Boolean, data, 'IsSharePointOnline'),
            Xrm.Soap.Parser.load(Boolean, data, 'UseAuthorizationServer'));
}
...
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.Generated
    .ShouldDisplaySLALimitNotificationRequestSerializer.$$cctor = function() {
        Xrm.Soap.Serializer.registerSerializer('ShouldDisplaySLALimitNotification',
            Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.Generated
            .ShouldDisplaySLALimitNotificationRequestSerializer.parametersToCrmSoap);
        Xrm.Soap.Serializer.registerDeserializer('ShouldDisplaySLALimitNotification',
            Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.Generated
            .ShouldDisplaySLALimitNotificationRequestSerializer.loadFromCrmSoap);
    }
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.Generated
    .ShouldDisplaySLALimitNotificationRequestSerializer.parametersToCrmSoap = function(request) {
        var $v_0 = request;
        return Xrm.Soap.EntityRecordSerializer
            .fieldToCrmSoap('RegardingObjectTypeCode', $v_0.regardingObjectTypeCode, 5);
    }
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.Generated
    .ShouldDisplaySLALimitNotificationRequestSerializer.loadFromCrmSoap = function(data) {
        if (_Script.isNullOrUndefined(data)) {
            return null;
        }
...
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.Generated
    .ShouldDisplaySLALimitNotificationResponseSerializer.$$cctor = function() {
        Xrm.Soap.ResponseSerializer.registerSerializer('ShouldDisplaySLALimitNotification',
            Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.Generated
            .ShouldDisplaySLALimitNotificationResponseSerializer.loadFromCrmSoap);
    }
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.Generated
    .ShouldDisplaySLALimitNotificationResponseSerializer.loadFromCrmSoap = function(soapResponse, request) {
        if (!_Script.isNullOrUndefined(soapResponse)) {
            Xrm.Soap.ResponseSerializer.addCrmSoapNamespaces(soapResponse);
            var $v_0 = null;
            $v_0 = soapResponse.selectSingleNode('.//a:Results');
...
Xrm.Gen.RetrieveSharePointGlobalSettingsResponseSerializer.loadFromCrmSoap = function(soapResponse, request) {
    return Xrm.Soap.ResponseSerializer.deserialize(soapResponse,
        ...
        function($p1_0) {
            return new Xrm.Gen
                .RetrieveSharePointGlobalSettingsResponse(Xrm.Soap.Parser
                    .load(String, $p1_0, 'SharePointGlobalSetting'));
        });
}
...
Xrm.Gen.AssignAllRecordsTeamRequestSerializer.parametersToCrmSoap = function(request) {
    return Xrm.Soap.Write.f('OldOwnerId', (request).oldOwnerId, 15) +
        Xrm.Soap.Write.f('OldOwnerType', (request).oldOwnerType, 5) +
        Xrm.Soap.Write.f('NewOwnerId', (request).newOwnerId, 15) +
        Xrm.Soap.Write.f('NewOwnerType', (request).newOwnerType, 5);
}
Xrm.Gen.AssignAllRecordsTeamRequestSerializer.loadFromCrmSoap = function(data) {
    if (_Script.isNullOrUndefined(data)) {
        return null;
    }
    return new Xrm.Gen.AssignAllRecordsTeamRequest(Xrm.Soap.Parser
        .load(Microsoft.Crm.Client.Core.Framework.Guid, data, 'OldOwnerId'),
        Xrm.Soap.Parser.load(Number, data, 'OldOwnerType'),
        Xrm.Soap.Parser.load(Microsoft.Crm.Client.Core.Framework.Guid, data, 'NewOwnerId'),
        Xrm.Soap.Parser.load(Number, data, 'NewOwnerType'));
}
...
Xrm.Gen.CreateRequestSerializer.parametersToCrmSoap = function(request) {
    return Xrm.Soap.Write.f('Target', (request).target, -1, 'a:Entity') +
        Xrm.Soap.Write.f('SuppressDuplicateDetection', (request).suppressDuplicateDetection, 0) +
        Xrm.Soap.Write.f('CalculateMatchCodeSynchronously', (request).calculateMatchCodeSynchronously, 0) +
        Xrm.Soap.Write.f('SolutionUniqueName', (request).solutionUniqueName, 14) +
        Xrm.Soap.Write.f('MaintainLegacyAppServerBehavior', (request).maintainLegacyAppServerBehavior, 0) +
        Xrm.Soap.Write.f('ReturnRowVersion', (request).returnRowVersion, 0);
}
Xrm.Gen.CreateRequestSerializer.loadFromCrmSoap = function(data) {
    if (_Script.isNullOrUndefined(data)) {
        return null;
    }
    return new Xrm.Gen.CreateRequest(Xrm.Soap.Parser.load(Microsoft.Crm.Client.Core.Storage.Common.ObjectModel
            .EntityRecord,
            data,
            'Target'),
        Xrm.Soap.Parser.load(Boolean, data, 'SuppressDuplicateDetection'),
        Xrm.Soap.Parser.load(Boolean, data, 'CalculateMatchCodeSynchronously'),
        Xrm.Soap.Parser.load(String, data, 'SolutionUniqueName'),
        Xrm.Soap.Parser.load(Boolean, data, 'MaintainLegacyAppServerBehavior'),
        Xrm.Soap.Parser.load(Boolean, data, 'ReturnRowVersion'));
}
...
Xrm.Gen.CreateResponseSerializer.loadFromCrmSoap = function(soapResponse, request) {
    return Xrm.Soap.ResponseSerializer.deserialize(soapResponse,
        request,
        function($p1_0) {
            return new Xrm.Gen.CreateResponse(Xrm.Soap.Parser
                .load(Microsoft.Crm.Client.Core.Framework.Guid, $p1_0, 'id'),
                Xrm.Soap.Parser.load(Xrm.Objects.EntityReference, $p1_0, 'EntityReference'));
        });
}
...
Xrm.Gen.DeleteDocumentRequestSerializer.loadFromCrmSoap = function(data) {
    ...
    return new Xrm.Gen.DeleteDocumentRequest(Xrm.Soap.Parser
        .load(Microsoft.Crm.Client.Core.Storage.Common.ObjectModel.EntityCollection, data, 'Entities'));
}
...
Xrm.Gen.DeleteRequestSerializer.loadFromCrmSoap = function(data) {
    ...
    return new Xrm.Gen.DeleteRequest(Xrm.Soap.Parser.load(Xrm.Objects.EntityReference, data, 'Target'),
        Xrm.Soap.Parser.load(String, data, 'SolutionUniqueName'),
        Xrm.Soap.Parser.load(Xrm.Gen.ConcurrencyBehavior, data, 'ConcurrencyBehavior', 'Enum'));
}
...
Xrm.Gen.DisassociateRequestSerializer.loadFromCrmSoap = function(data) {
    ...
    return new Xrm.Gen.DisassociateRequest(Xrm.Soap.Parser.load(Xrm.Objects.EntityReference, data, 'Target'),
        Xrm.Soap.Parser.load(Microsoft.Crm.Client.Core.Storage.Common.ObjectModel.Relationship, data, 'Relationship'),
        Xrm.Soap.Parser.load(Array, data, 'RelatedEntities', 'EntityReferenceArray'));
}
...
Xrm.Gen.DiscardDocumentCheckoutRequestSerializer.loadFromCrmSoap = function(data) {
    ...
    return new Xrm.Gen.DiscardDocumentCheckoutRequest(Xrm.Soap.Parser
        .load(Microsoft.Crm.Client.Core.Storage.Common.ObjectModel.EntityRecord, data, 'Entity'));
}
...
Xrm.Gen.EditDocumentPropertiesRequestSerializer.loadFromCrmSoap = function(data) {
    ...
    return new Xrm.Gen.EditDocumentPropertiesRequest(Xrm.Soap.Parser
        .load(Microsoft.Crm.Client.Core.Storage.Common.ObjectModel.EntityRecord, data, 'Entity'));
}
...
Xrm.Gen.ExecuteMultipleRequestSerializer.$$cctor = function() {
    Xrm.Soap.Serializer.registerSerializer('ExecuteMultiple',
        Xrm.Gen.ExecuteMultipleRequestSerializer.parametersToCrmSoap);
    Xrm.Soap.Serializer.registerDeserializer('ExecuteMultiple',
        Xrm.Gen.ExecuteMultipleRequestSerializer.loadFromCrmSoap);
}
Xrm.Gen.ExecuteMultipleRequestSerializer.parametersToCrmSoap = function(request) {
    var $v_0 = request;
    return Xrm.Soap.EntityRecordSerializer.fieldToCrmSoap('Requests',
            $v_0.requests,
            -1,
            'c:OrganizationRequestCollection',
            'xmlns:c=\"http://schemas.microsoft.com/xrm/2012/Contracts\"') +
        Xrm.Soap.EntityRecordSerializer.fieldToCrmSoap('Settings',
            $v_0.settings,
            -1,
...
Xrm.Gen.ExecuteMultipleRequestSerializer.loadFromCrmSoap = function(data) {
    ...
    var $v_1 = (!_Script.isNullOrUndefined($v_0))
        ? Xrm.Soap.OrganizationRequestCollectionSerializer.loadFromCrmSoap($v_0)
        : null;
    var $v_2 = data.selectSingleNode('.//a:KeyValuePairOfstringanyType[b:key=\'Settings\']/b:value');
    var $v_3 = (!_Script.isNullOrUndefined($v_2))
        ? Xrm.Soap.ExecuteMultipleSettingsSerializer.loadFromCrmSoap($v_2)
        : null;
...
Xrm.Gen.ExecuteMultipleResponseSerializer.$$cctor = function() {
    Xrm.Soap.ResponseSerializer.registerSerializer('ExecuteMultiple',
        Xrm.Gen.ExecuteMultipleResponseSerializer.loadFromCrmSoap);
}
Xrm.Gen.ExecuteMultipleResponseSerializer.loadFromCrmSoap = function(soapResponse, request) {
    if (!_Script.isNullOrUndefined(soapResponse)) {
        ...
        if (!_Script.isNullOrUndefined($v_0)) {
            ...
            var $v_4 = (!_Script.isNullOrUndefined($v_3))
                ? Xrm.Soap.ExecuteMultipleResponseItemCollectionSerializer.loadFromCrmSoap($v_3, request)
                : null;
...
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.Generated.ExecuteQuickFindRequestSerializer
    .$$cctor = function() {
        Xrm.Soap.Serializer.registerSerializer('ExecuteQuickFind',
            Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.Generated
            .ExecuteQuickFindRequestSerializer.parametersToCrmSoap);
        Xrm.Soap.Serializer.registerDeserializer('ExecuteQuickFind',
            Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.Generated
            .ExecuteQuickFindRequestSerializer.loadFromCrmSoap);
    }
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.Generated.ExecuteQuickFindRequestSerializer
    .parametersToCrmSoap = function(request) {
        var $v_0 = request;
        return Xrm.Soap.EntityRecordSerializer.fieldToCrmSoap('SearchText', $v_0.searchText, 14) +
            Xrm.Soap.EntityRecordSerializer.fieldToCrmSoap('EntityGroupName', $v_0.entityGroupName, 14) +
            Xrm.Soap.EntityRecordSerializer.fieldToCrmSoap('EntityNames',
                $v_0.entityNames,
                -1,
                'sa:ArrayOfstring',
                'xmlns:sa=\"http://schemas.microsoft.com/2003/10/Serialization/Arrays\"');
...
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.Generated.ExecuteQuickFindResponseSerializer
    .$$cctor = function() {
        Xrm.Soap.ResponseSerializer.registerSerializer('ExecuteQuickFind',
            Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.Generated
            .ExecuteQuickFindResponseSerializer.loadFromCrmSoap);
    }
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.Generated.ExecuteQuickFindResponseSerializer
    .loadFromCrmSoap = function(soapResponse, request) {
        if (!_Script.isNullOrUndefined(soapResponse)) {
            ...
            if (!_Script.isNullOrUndefined($v_0)) {
                var $v_1 = $v_0
                    .selectSingleNode('.//a:KeyValuePairOfstringanyType[c:key=\'Result\']/c:value[@i:type=\'a:QuickFindResultCollection\']');
                if (!_Script.isNullOrUndefined($v_1)) {
...
Xrm.Gen.ExportTemplateToExcelOnlineRequestSerializer.parametersToCrmSoap = function(request) {
    return Xrm.Soap.Write.f('Template', (request).template, 6) +
        Xrm.Soap.Write.f('FetchXml', (request).fetchXml, 14) +
        Xrm.Soap.Write.f('QueryApi', (request).queryApi, 14) +
...
Xrm.Gen.ExportTemplateToExcelOnlineRequestSerializer.loadFromCrmSoap = function(data) {
    ...
    return new Xrm.Gen.ExportTemplateToExcelOnlineRequest(Xrm.Soap.Parser
        .load(Xrm.Objects.EntityReference, data, 'Template'),
        Xrm.Soap.Parser.load(String, data, 'FetchXml'),
        Xrm.Soap.Parser.load(String, data, 'QueryApi'),
        Xrm.Soap.Parser.load(Object, data, 'QueryParameters', 'InputArgumentCollection'));
}
...
Xrm.Gen.ExportToExcelOnlineRequestSerializer.parametersToCrmSoap = function(request) {
    return Xrm.Soap.Write.f('View', (request).view, 6) +
        Xrm.Soap.Write.f('FetchXml', (request).fetchXml, 14) +
        Xrm.Soap.Write.f('LayoutXml', (request).layoutXml, 14) +
        Xrm.Soap.Write.f('QueryApi', (request).queryApi, 14) +
        Xrm.Soap.Write.f('QueryParameters',
            (request).queryParameters,
            -1,
...
Xrm.Gen.ExportToExcelOnlineRequestSerializer.loadFromCrmSoap = function(data) {
    ...
    return new Xrm.Gen.ExportToExcelOnlineRequest(Xrm.Soap.Parser.load(Xrm.Objects.EntityReference, data, 'View'),
        Xrm.Soap.Parser.load(String, data, 'FetchXml'),
        Xrm.Soap.Parser.load(String, data, 'LayoutXml'),
        Xrm.Soap.Parser.load(String, data, 'QueryApi'),
        Xrm.Soap.Parser.load(Object, data, 'QueryParameters', 'InputArgumentCollection'));
}
...
Xrm.Gen.ExportToExcelRequestSerializer.loadFromCrmSoap = function(data) {
    ...
    return new Xrm.Gen.ExportToExcelRequest(Xrm.Soap.Parser.load(Xrm.Objects.EntityReference, data, 'View'),
        Xrm.Soap.Parser.load(String, data, 'FetchXml'),
        Xrm.Soap.Parser.load(String, data, 'LayoutXml'),
        Xrm.Soap.Parser.load(String, data, 'QueryApi'),
        Xrm.Soap.Parser.load(Object, data, 'QueryParameters', 'InputArgumentCollection'));
...
Xrm.Gen.RetrieveDocumentTemplatesRequestSerializer.loadFromCrmSoap = function(data) {
    ...
    return new Xrm.Gen.RetrieveDocumentTemplatesRequest(Xrm.Soap.Parser.load(Number, data, 'EntityTypeCode'),
        Xrm.Soap.Parser.load(Number, data, 'DocumentType'));
}
...
Xrm.Gen.RetrieveDocumentTemplatesResponseSerializer.loadFromCrmSoap = function(soapResponse, request) {
    return Xrm.Soap.ResponseSerializer.deserialize(soapResponse,
        ...
        function($p1_0) {
            return new Xrm.Gen
                .RetrieveDocumentTemplatesResponse(Xrm.Soap.Parser
                    .load(Microsoft.Crm.Client.Core.Storage.Common.ObjectModel.EntityCollection,
                        $p1_0,
                        'DocumentTemplateEntityCollection'));
        });
}
...
Xrm.Gen.GetQuoteProductsFromOpportunityRequestSerializer.loadFromCrmSoap = function(data) {
    ...
    return new Xrm.Gen
        .GetQuoteProductsFromOpportunityRequest(Xrm.Soap.Parser
            .load(Microsoft.Crm.Client.Core.Framework.Guid, data, 'OpportunityId'),
            Xrm.Soap.Parser.load(Microsoft.Crm.Client.Core.Framework.Guid, data, 'QuoteId'));
}
...
Xrm.Gen.FulfillSalesOrderRequestSerializer.loadFromCrmSoap = function(data) {
    ...
    return new Xrm.Gen.FulfillSalesOrderRequest(Xrm.Soap.Parser
        .load(Microsoft.Crm.Client.Core.Storage.Common.ObjectModel.EntityRecord, data, 'OrderClose'),
        Xrm.Soap.Parser.load(Number, data, 'Status', 'OptionSet'));
}
...
Xrm.Gen.FullTextSearchKnowledgeArticleRequestSerializer.parametersToCrmSoap = function(request) {
    return Xrm.Soap.Write.f('SearchText', (request).searchText, 14) +
        Xrm.Soap.Write.f('UseInflection', (request).useInflection, 0) +
        Xrm.Soap.Write.f('RemoveDuplicates', (request).removeDuplicates, 0) +
        Xrm.Soap.Write.f('StateCode', (request).stateCode, 5) +
        Xrm.Soap.Write.f('QueryExpression', (request).queryExpression, -1, 'a:FetchExpression');
}
Xrm.Gen.FullTextSearchKnowledgeArticleRequestSerializer.loadFromCrmSoap = function(data) {
    ...
    return new Xrm.Gen
        .FullTextSearchKnowledgeArticleRequest(Xrm.Soap.Parser.load(String, data, 'SearchText'),
            Xrm.Soap.Parser.load(Boolean, data, 'UseInflection'),
            Xrm.Soap.Parser.load(Boolean, data, 'RemoveDuplicates'),
            Xrm.Soap.Parser.load(Number, data, 'StateCode'),
            Xrm.Soap.Parser.load(String, data, 'QueryExpression', 'Query'));
}
...
Xrm.Gen.FullTextSearchKnowledgeArticleResponseSerializer.loadFromCrmSoap = function(soapResponse, request) {
    return Xrm.Soap.ResponseSerializer.deserialize(soapResponse,
        ...
        function($p1_0) {
            return new Xrm.Gen
                .FullTextSearchKnowledgeArticleResponse(Xrm.Soap.Parser
                    .load(Microsoft.Crm.Client.Core.Storage.Common.ObjectModel.EntityCollection,
                        $p1_0,
                        'EntityCollection'));
        });
...
Xrm.Gen.InstantiateTemplateRequestSerializer.parametersToCrmSoap = function(request) {
    return Xrm.Soap.Write.f('TemplateId', (request).templateId, 15) +
        Xrm.Soap.Write.f('ObjectType', (request).objectType, 14) +
        Xrm.Soap.Write.f('ObjectId', (request).objectId, 15);
}
Xrm.Gen.InstantiateTemplateRequestSerializer.loadFromCrmSoap = function(data) {
    if (_Script.isNullOrUndefined(data)) {
        return null;
    }
    return new Xrm.Gen.InstantiateTemplateRequest(Xrm.Soap.Parser
        .load(Microsoft.Crm.Client.Core.Framework.Guid, data, 'TemplateId'),
        Xrm.Soap.Parser.load(String, data, 'ObjectType'),
        Xrm.Soap.Parser.load(Microsoft.Crm.Client.Core.Framework.Guid, data, 'ObjectId'));
}
...
Xrm.Gen.InstantiateTemplateResponseSerializer.loadFromCrmSoap = function(soapResponse, request) {
    return Xrm.Soap.ResponseSerializer.deserialize(soapResponse,
        request,
        function($p1_0) {
            return new Xrm.Gen.InstantiateTemplateResponse(Xrm.Soap.Parser
                .load(Microsoft.Crm.Client.Core.Storage.Common.ObjectModel
                    .EntityCollection,
                    $p1_0,
                    'EntityCollection'));
        });
...
Xrm.Gen.GetSalesOrderProductsFromOpportunityRequestSerializer.parametersToCrmSoap = function(request) {
    return Xrm.Soap.Write.f('OpportunityId', (request).opportunityId, 15) +
        Xrm.Soap.Write.f('SalesOrderId', (request).salesOrderId, 15);
}
Xrm.Gen.GetSalesOrderProductsFromOpportunityRequestSerializer.loadFromCrmSoap = function(data) {
    ...
    return new Xrm.Gen
        .GetSalesOrderProductsFromOpportunityRequest(Xrm.Soap.Parser
            .load(Microsoft.Crm.Client.Core.Framework.Guid, data, 'OpportunityId'),
            Xrm.Soap.Parser.load(Microsoft.Crm.Client.Core.Framework.Guid, data, 'SalesOrderId'));
}
...
Xrm.Gen.GetValidStatusTransitionRequestSerializer.parametersToCrmSoap = function(request) {
    return Xrm.Soap.Write.f('IncidentId', (request).incidentId, 14) +
        Xrm.Soap.Write.f('ToStateCode', (request).toStateCode, 5);
}
Xrm.Gen.GetValidStatusTransitionRequestSerializer.loadFromCrmSoap = function(data) {
    if (_Script.isNullOrUndefined(data)) {
        return null;
    }
    return new Xrm.Gen.GetValidStatusTransitionRequest(Xrm.Soap.Parser.load(String, data, 'IncidentId'),
        Xrm.Soap.Parser.load(Number, data, 'ToStateCode'));
}
...
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.Generated.GrantAccessRequestSerializer
    .$$cctor = function() {
        Xrm.Soap.Serializer.registerSerializer('GrantAccess',
            Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.Generated
            .GrantAccessRequestSerializer.parametersToCrmSoap);
        Xrm.Soap.Serializer.registerDeserializer('GrantAccess',
            Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.Generated
            .GrantAccessRequestSerializer.loadFromCrmSoap);
    }
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.Generated.GrantAccessRequestSerializer
    .parametersToCrmSoap = function(request) {
        var $v_0 = request;
        return Xrm.Soap.EntityRecordSerializer.fieldToCrmSoap('Target', $v_0.target, 6) +
            Xrm.Soap.EntityRecordSerializer.fieldToCrmSoap('PrincipalAccess',
                $v_0.principalAccess,
                -1,
                'a:PrincipalAccess');
    }
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.Generated.GrantAccessRequestSerializer
    .loadFromCrmSoap = function(data) {
        ...
        var $v_3 = (!_Script.isNullOrUndefined($v_2))
            ? Xrm.Soap.PrincipalAccessArraySerializer.loadFromCrmSoap($v_2)[0]
            : null;
...
Xrm.Gen.InitializeFromRequestSerializer.parametersToCrmSoap = function(request) {
    return Xrm.Soap.Write.f('EntityMoniker', (request).entityMoniker, 6) +
        Xrm.Soap.Write.f('TargetEntityName', (request).targetEntityName, 14) +
        Xrm.Soap.Write.f('TargetFieldType', (request).targetFieldType, -1, 'a:TargetFieldType');
}
Xrm.Gen.InitializeFromRequestSerializer.loadFromCrmSoap = function(data) {
    if (_Script.isNullOrUndefined(data)) {
        return null;
    }
    return new Xrm.Gen.InitializeFromRequest(Xrm.Soap.Parser.load(Xrm.Objects.EntityReference, data, 'EntityMoniker'),
        Xrm.Soap.Parser.load(String, data, 'TargetEntityName'),
        Xrm.Soap.Parser.load(Xrm.Gen.TargetFieldType, data, 'TargetFieldType', 'Enum'));
}
...
Xrm.Gen.InitializeFromResponseSerializer.loadFromCrmSoap = function(soapResponse, request) {
    return Xrm.Soap.ResponseSerializer.deserialize(soapResponse,
        request,
        function($p1_0) {
            return new Xrm.Gen.InitializeFromResponse(Xrm.Soap.Parser
                .load(Microsoft.Crm.Client.Core.Storage.Common.ObjectModel.EntityRecord, $p1_0, 'Entity'));
        });
}
...
Xrm.Gen.InviteUserRequestSerializer.loadFromCrmSoap = function(data) {
    ...
    return new Xrm.Gen.InviteUserRequest(Xrm.Soap.Parser
        .load(Microsoft.Crm.Client.Core.Framework.Guid, data, 'UserId'));
}
...
Xrm.Gen.IsPartnerSolutionInstalledResponseSerializer.loadFromCrmSoap = function(soapResponse, request) {
    return Xrm.Soap.ResponseSerializer.deserialize(soapResponse,
        ...
        function($p1_0) {
            return new Xrm.Gen
                .IsPartnerSolutionInstalledResponse(Xrm.Soap.Parser.load(Boolean, $p1_0, 'IsPartnerSolutionInstalled'));
        });
}
...
Xrm.Gen.LockSalesOrderPricingRequestSerializer.loadFromCrmSoap = function(data) {
    ...
    return new Xrm.Gen.LockSalesOrderPricingRequest(Xrm.Soap.Parser
        .load(Microsoft.Crm.Client.Core.Framework.Guid, data, 'SalesOrderId'));
}
...
Xrm.Gen.LoseOpportunityRequestSerializer.parametersToCrmSoap = function(request) {
    return Xrm.Soap.Write.f('OpportunityClose', (request).opportunityClose, -1, 'a:Entity') +
        Xrm.Soap.Write.f('Status', (request).status, 11);
}
Xrm.Gen.LoseOpportunityRequestSerializer.loadFromCrmSoap = function(data) {
    ...
    return new Xrm.Gen.LoseOpportunityRequest(Xrm.Soap.Parser
        .load(Microsoft.Crm.Client.Core.Storage.Common.ObjectModel.EntityRecord, data, 'OpportunityClose'),
        Xrm.Soap.Parser.load(Number, data, 'Status', 'OptionSet'));
}
...
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.Generated.ModifyAccessRequestSerializer
    .$$cctor = function() {
        Xrm.Soap.Serializer.registerSerializer('ModifyAccess',
            Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.Generated
            .ModifyAccessRequestSerializer.parametersToCrmSoap);
        Xrm.Soap.Serializer.registerDeserializer('ModifyAccess',
            Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.Generated
            .ModifyAccessRequestSerializer.loadFromCrmSoap);
    }
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.Generated.ModifyAccessRequestSerializer
    .parametersToCrmSoap = function(request) {
        var $v_0 = request;
...
Xrm.Gen.PickFromQueueRequestSerializer.parametersToCrmSoap = function(request) {
    return Xrm.Soap.Write.f('QueueItemId', (request).queueItemId, 15) +
        Xrm.Soap.Write.f('WorkerId', (request).workerId, 15) +
        Xrm.Soap.Write.f('RemoveQueueItem', (request).removeQueueItem, 0);
}
Xrm.Gen.PickFromQueueRequestSerializer.loadFromCrmSoap = function(data) {
    if (_Script.isNullOrUndefined(data)) {
        return null;
    }
    return new Xrm.Gen.PickFromQueueRequest(Xrm.Soap.Parser
        .load(Microsoft.Crm.Client.Core.Framework.Guid, data, 'QueueItemId'),
        Xrm.Soap.Parser.load(Microsoft.Crm.Client.Core.Framework.Guid, data, 'WorkerId'),
        Xrm.Soap.Parser.load(Boolean, data, 'RemoveQueueItem'));
}
...
Xrm.Gen.QualifyLeadRequestSerializer.parametersToCrmSoap = function(request) {
    return Xrm.Soap.Write.f('LeadId', (request).leadId, 6) +
        Xrm.Soap.Write.f('CreateAccount', (request).createAccount, 0) +
        Xrm.Soap.Write.f('CreateContact', (request).createContact, 0) +
        Xrm.Soap.Write.f('CreateOpportunity', (request).createOpportunity, 0) +
        Xrm.Soap.Write.f('OpportunityCurrencyId', (request).opportunityCurrencyId, 6) +
        Xrm.Soap.Write.f('OpportunityCustomerId', (request).opportunityCustomerId, 6) +
        Xrm.Soap.Write.f('SourceCampaignId', (request).sourceCampaignId, 6) +
        Xrm.Soap.Write.f('Status', (request).status, 11) +
        Xrm.Soap.Write.f('SuppressDuplicateDetection', (request).suppressDuplicateDetection, 0) +
        Xrm.Soap.Write.iof('ProcessInstanceId', (request).processInstanceId, 6);
}
Xrm.Gen.QualifyLeadRequestSerializer.loadFromCrmSoap = function(data) {
    if (_Script.isNullOrUndefined(data)) {
        return null;
    }
    return new Xrm.Gen.QualifyLeadRequest(Xrm.Soap.Parser.load(Xrm.Objects.EntityReference, data, 'LeadId'),
        Xrm.Soap.Parser.load(Boolean, data, 'CreateAccount'),
        Xrm.Soap.Parser.load(Boolean, data, 'CreateContact'),
        Xrm.Soap.Parser.load(Boolean, data, 'CreateOpportunity'),
        Xrm.Soap.Parser.load(Xrm.Objects.EntityReference, data, 'OpportunityCurrencyId'),
        Xrm.Soap.Parser.load(Xrm.Objects.EntityReference, data, 'OpportunityCustomerId'),
        Xrm.Soap.Parser.load(Xrm.Objects.EntityReference, data, 'SourceCampaignId'),
        Xrm.Soap.Parser.load(Number, data, 'Status', 'OptionSet'),
        Xrm.Soap.Parser.load(Boolean, data, 'SuppressDuplicateDetection'),
        Xrm.Soap.Parser.load(Xrm.Objects.EntityReference, data, 'ProcessInstanceId'));
}
...
Xrm.Gen.QualifyLeadResponseSerializer.loadFromCrmSoap = function(soapResponse, request) {
    return Xrm.Soap.ResponseSerializer.deserialize(soapResponse,
        request,
        function($p1_0) {
            return new Xrm.Gen.QualifyLeadResponse(Xrm.Soap.Parser
                .load(Array, $p1_0, 'CreatedEntities', 'EntityReferenceArray'));
        });
}
...
Xrm.Gen.RenewEntitlementResponseSerializer.loadFromCrmSoap = function(soapResponse, request) {
    return Xrm.Soap.ResponseSerializer.deserialize(soapResponse,
        request,
        function($p1_0) {
            return new Xrm.Gen.RenewEntitlementResponse(Xrm.Soap.Parser
                .load(Microsoft.Crm.Client.Core.Storage.Common.ObjectModel.EntityRecord, $p1_0, 'Entity'));
        });
}
...
Xrm.Gen.RenewEntitlementRequestSerializer.parametersToCrmSoap = function(request) {
    return Xrm.Soap.Write.f('EntitlementId', (request).entitlementId, 15) +
        Xrm.Soap.Write.f('Status', (request).status, 5);
}
Xrm.Gen.RenewEntitlementRequestSerializer.loadFromCrmSoap = function(data) {
    ...
    return new Xrm.Gen.RenewEntitlementRequest(Xrm.Soap.Parser
        .load(Microsoft.Crm.Client.Core.Framework.Guid, data, 'EntitlementId'),
        Xrm.Soap.Parser.load(Number, data, 'Status'));
}
...
Xrm.Gen.RescheduleRequestSerializer.loadFromCrmSoap = function(data) {
    ...
    return new Xrm.Gen.RescheduleRequest(Xrm.Soap.Parser
        .load(Microsoft.Crm.Client.Core.Storage.Common.ObjectModel.EntityRecord, data, 'Target'),
        Xrm.Soap.Parser.load(Boolean, data, 'MaintainLegacyAppServerBehavior'),
        Xrm.Soap.Parser.load(Boolean, data, 'ReturnNotifications'));
}
...
Xrm.Gen.RetrieveDefaultStatusForStateRequestSerializer.loadFromCrmSoap = function(data) {
    ...
    return new Xrm.Gen.RetrieveDefaultStatusForStateRequest(Xrm.Soap.Parser.load(String, data, 'EntityName'),
        Xrm.Soap.Parser.load(Number, data, 'State', 'OptionSet'));
}
...
Xrm.Gen.RetrieveDefaultStatusForStateResponseSerializer.loadFromCrmSoap = function(soapResponse, request) {
    return Xrm.Soap.ResponseSerializer.deserialize(soapResponse,
        ...
        function($p1_0) {
            return new Xrm.Gen
                .RetrieveDefaultStatusForStateResponse(Xrm.Soap.Parser.load(Number, $p1_0, 'Status', 'OptionSet'));
        });
}
...
Xrm.Gen.RetrieveFilteredProcessesResponseSerializer.loadFromCrmSoap = function(soapResponse, request) {
    return Xrm.Soap.ResponseSerializer.deserialize(soapResponse,
        ...
        function($p1_0) {
            return new Xrm.Gen
                .RetrieveFilteredProcessesResponse(Xrm.Soap.Parser
                    .load(Microsoft.Crm.Client.Core.Storage.Common.ObjectModel.EntityCollection, $p1_0, 'Processes'));
        });
}
...
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.Generated
    .RetrieveKeyPhrasesForKnowledgeSearchRequestSerializer.$$cctor = function() {
        Xrm.Soap.Serializer.registerSerializer('RetrieveKeyPhrasesForKnowledgeSearch',
            Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.Generated
            .RetrieveKeyPhrasesForKnowledgeSearchRequestSerializer.parametersToCrmSoap);
        Xrm.Soap.Serializer.registerDeserializer('RetrieveKeyPhrasesForKnowledgeSearch',
            Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.Generated
            .RetrieveKeyPhrasesForKnowledgeSearchRequestSerializer.loadFromCrmSoap);
    }
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.Generated
    .RetrieveKeyPhrasesForKnowledgeSearchRequestSerializer.parametersToCrmSoap = function(request) {
        var $v_0 = request;
        return Xrm.Soap.EntityRecordSerializer.fieldToCrmSoap('Target', $v_0.target, 6);
    }
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.Generated
    .RetrieveKeyPhrasesForKnowledgeSearchRequestSerializer.loadFromCrmSoap = function(data) {
        if (_Script.isNullOrUndefined(data)) {
            return null;
        }
        var $v_0 = data.selectSingleNode('.//a:KeyValuePairOfstringanyType[b:key=\'Target\']/b:value');
...
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.Generated
    .RetrieveKeyPhrasesForKnowledgeSearchResponseSerializer.$$cctor = function() {
        Xrm.Soap.ResponseSerializer.registerSerializer('RetrieveKeyPhrasesForKnowledgeSearch',
            Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.Generated
            .RetrieveKeyPhrasesForKnowledgeSearchResponseSerializer.loadFromCrmSoap);
    }
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.Generated
    .RetrieveKeyPhrasesForKnowledgeSearchResponseSerializer.loadFromCrmSoap = function(soapResponse, request) {
        if (!_Script.isNullOrUndefined(soapResponse)) {
            Xrm.Soap.ResponseSerializer.addCrmSoapNamespaces(soapResponse);
            var $v_0 = null;
            $v_0 = soapResponse.selectSingleNode('.//a:Results');
            if (!_Script.isNullOrUndefined($v_0)) {
                ...
                var $v_2 = (!_Script.isNullOrUndefined($v_1))
                    ? Xrm.Soap.StringArraySerializer.loadFromCrmSoap($v_1)
                    : null;
...
Xrm.Gen.RetrieveKeyPhrasesForSimilaritySearchRequestSerializer.loadFromCrmSoap = function(data) {
    ...
    return new Xrm.Gen
        .RetrieveKeyPhrasesForSimilaritySearchRequest(Xrm.Soap.Parser
            .load(Xrm.Objects.EntityReference, data, 'Target'));
}
...
Xrm.Gen.RetrieveKeyPhrasesForSimilaritySearchResponseSerializer.loadFromCrmSoap = function(soapResponse, request) {
    return Xrm.Soap.ResponseSerializer.deserialize(soapResponse,
        ...
        function($p1_0) {
            return new Xrm.Gen
                .RetrieveKeyPhrasesForSimilaritySearchResponse(Xrm.Soap.Parser
                    .load(Array, $p1_0, 'KeyPhrases', 'StringArray'));
        });
}
...
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.Generated.RetrieveAncestorsRequestSerializer
    .$$cctor = function() {
        Xrm.Soap.Serializer.registerSerializer('RetrieveAncestors',
            Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.Generated
            .RetrieveAncestorsRequestSerializer.parametersToCrmSoap);
        Xrm.Soap.Serializer.registerDeserializer('RetrieveAncestors',
            Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.Generated
            .RetrieveAncestorsRequestSerializer.loadFromCrmSoap);
    }
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.Generated.RetrieveAncestorsRequestSerializer
    .parametersToCrmSoap = function(request) {
        var $v_0 = request;
        return Xrm.Soap.EntityRecordSerializer.fieldToCrmSoap('Entity', $v_0.entity, 6) +
            Xrm.Soap.EntityRecordSerializer.fieldToCrmSoap('Columns', $v_0.columns, -1, 'a:ColumnSet');
    }
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.Generated.RetrieveAncestorsRequestSerializer
    .loadFromCrmSoap = function(data) {
        if (_Script.isNullOrUndefined(data)) {
...
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.Generated.RetrieveAncestorsResponseSerializer
    .$$cctor = function() {
        Xrm.Soap.ResponseSerializer.registerSerializer('RetrieveAncestors',
            Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.Generated
            .RetrieveAncestorsResponseSerializer.loadFromCrmSoap);
    }
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.Generated.RetrieveAncestorsResponseSerializer
    .loadFromCrmSoap = function(soapResponse, request) {
        if (!_Script.isNullOrUndefined(soapResponse)) {
            ...
            if (!_Script.isNullOrUndefined($v_0)) {
                var $v_1 = $v_0
                    .selectSingleNode('.//a:KeyValuePairOfstringanyType[b:key=\'EntityCollection\']/b:value[@i:type=\'a:EntityCollection\']');
                var $v_2 = null;
                if (!_Script.isNullOrUndefined($v_1)) {
                    $v_2 = Xrm.Soap.EntityCollectionSerializer
                        .loadFromCrmSoap($v_1, Microsoft.Crm.Client.Core.Storage.DataApi.Query.get_empty());
                }
...
Xrm.Gen.RetrieveProductPropertiesRequestSerializer.loadFromCrmSoap = function(data) {
    ...
    return new Xrm.Gen.RetrieveProductPropertiesRequest(Xrm.Soap.Parser
        .load(Xrm.Objects.EntityReference, data, 'ParentObject'));
}
...
Xrm.Gen.RetrieveProductPropertiesResponseSerializer.loadFromCrmSoap = function(soapResponse, request) {
    return Xrm.Soap.ResponseSerializer.deserialize(soapResponse,
        ...
        function($p1_0) {
            return new Xrm.Gen
                .RetrieveProductPropertiesResponse(Xrm.Soap.Parser
                    .load(Microsoft.Crm.Client.Core.Storage.Common.ObjectModel.EntityCollection,
                        $p1_0,
                        'EntityCollection'));
        });
...
Xrm.Gen.RetrieveEntityDynamicPropertyDefinitionsRequestSerializer.parametersToCrmSoap = function(request) {
    return Xrm.Soap.Write.f('RegardingObject', (request).regardingObject, 6) +
        Xrm.Soap.Write.f('ForDraftRegarding', (request).forDraftRegarding, 0);
}
Xrm.Gen.RetrieveEntityDynamicPropertyDefinitionsRequestSerializer.loadFromCrmSoap = function(data) {
    ...
    return new Xrm.Gen
        .RetrieveEntityDynamicPropertyDefinitionsRequest(Xrm.Soap.Parser
            .load(Xrm.Objects.EntityReference, data, 'RegardingObject'),
            Xrm.Soap.Parser.load(Boolean, data, 'ForDraftRegarding'));
}
...
Xrm.Gen.RetrieveEntityDynamicPropertyDefinitionsResponseSerializer.loadFromCrmSoap = function(soapResponse, request) {
    return Xrm.Soap.ResponseSerializer.deserialize(soapResponse,
        ...
        function($p1_0) {
            return new Xrm.Gen
                .RetrieveEntityDynamicPropertyDefinitionsResponse(Xrm.Soap.Parser
                    .load(Microsoft.Crm.Client.Core.Storage.Common.ObjectModel.EntityCollection,
                        $p1_0,
                        'EntityCollection'));
        });
...
Xrm.Gen.RescheduleResponseSerializer.loadFromCrmSoap = function(soapResponse, request) {
    return Xrm.Soap.ResponseSerializer.deserialize(soapResponse,
        request,
        function($p1_0) {
            return new Xrm.Gen.RescheduleResponse(Xrm.Soap.Parser
                .load(Xrm.Gen.ValidationResult, $p1_0, 'ValidationResult'),
                Xrm.Soap.Parser.load(Array, $p1_0, 'Notifications', 'BusinessNotificationArray'));
        });
}
...
Xrm.Gen.RetrieveEntitiesForAggregateQueryRequestSerializer.parametersToCrmSoap = function(request) {
    return Xrm.Soap.Write.f('OuterQuery', (request).outerQuery, -1, 'a:FetchExpression') +
...
Xrm.Gen.RetrieveEntitiesForAggregateQueryRequestSerializer.loadFromCrmSoap = function(data) {
    ...
    return new Xrm.Gen
        .RetrieveEntitiesForAggregateQueryRequest(Xrm.Soap.Parser.load(String, data, 'OuterQuery', 'Query'),
            Xrm.Soap.Parser.load(Object, data, 'SubQueries', 'QueryByEntityName'));
}
...
Xrm.Gen.RetrieveEntitiesForAggregateQueryResponseSerializer.loadFromCrmSoap = function(soapResponse, request) {
    return Xrm.Soap.ResponseSerializer.deserialize(soapResponse,
        ...
        function($p1_0) {
            return new Xrm.Gen
                .RetrieveEntitiesForAggregateQueryResponse(Xrm.Soap.Parser
                    .load(Microsoft.Crm.Client.Core.Storage.Common.ObjectModel.EntityCollection,
                        $p1_0,
                        'EntityCollection'));
        });
...
Xrm.Gen.RetrieveMultipleResponseSerializer.loadFromCrmSoap = function(soapResponse, request) {
    return Xrm.Soap.ResponseSerializer.deserialize(soapResponse,
        request,
        function($p1_0) {
            return new Xrm.Gen.RetrieveMultipleResponse(Xrm.Soap.Parser
                .load(Microsoft.Crm.Client.Core.Storage.Common.ObjectModel
                    .EntityCollection,
                    $p1_0,
                    'EntityCollection'));
...
Xrm.Gen.RetrieveUnpublishedMultipleResponseSerializer.loadFromCrmSoap = function(soapResponse, request) {
    return Xrm.Soap.ResponseSerializer.deserialize(soapResponse,
        ...
        function($p1_0) {
            return new Xrm.Gen
                .RetrieveUnpublishedMultipleResponse(Xrm.Soap.Parser
                    .load(Microsoft.Crm.Client.Core.Storage.Common.ObjectModel.EntityCollection,
                        $p1_0,
                        'EntityCollection'));
        });
...
Xrm.Gen.RetrievePrincipalAccessRequestSerializer.loadFromCrmSoap = function(data) {
    ...
    return new Xrm.Gen.RetrievePrincipalAccessRequest(Xrm.Soap.Parser.load(Xrm.Objects.EntityReference, data, 'Target'),
        Xrm.Soap.Parser.load(Xrm.Objects.EntityReference, data, 'Principal'));
}
...
Xrm.Gen.RetrievePrincipalAccessResponseSerializer.loadFromCrmSoap = function(soapResponse, request) {
    return Xrm.Soap.ResponseSerializer.deserialize(soapResponse,
        ...
        function($p1_0) {
            return new Xrm.Gen
                .RetrievePrincipalAccessResponse(Xrm.Soap.Parser
                    .load(Xrm.Gen.AccessRights, $p1_0, 'AccessRights', 'FlagsEnum'));
        });
}
...
Xrm.Gen.RetrieveRequestSerializer.parametersToCrmSoap = function(request) {
    var $v_0 = request;
    return Xrm.Soap.EntityRecordSerializer.fieldToCrmSoap('Target', $v_0.target, 6) +
        Xrm.Soap.EntityRecordSerializer.fieldToCrmSoap('ColumnSet', $v_0.columnSet, -1, 'a:ColumnSet') +
        Xrm.Soap.EntityRecordSerializer.fieldToCrmSoap('RelatedEntitiesQuery',
            $v_0.relatedEntitiesQuery,
            -1,
            'a:RelationshipQueryCollection') +
        Xrm.Soap.EntityRecordSerializer.fieldToCrmSoap('ReturnNotifications', $v_0.returnNotifications, 0);
}
Xrm.Gen.RetrieveRequestSerializer.loadFromCrmSoap = function(data) {
    ...
    var $v_5 = (!_Script.isNullOrUndefined($v_4))
        ? Xrm.Soap.RelationshipQueryCollectionSerializer.loadFromCrmSoap($v_4)
        : null;
    ...
    if (!_Script.isNullOrUndefined(soapResponse)) {
        ...
        if (!_Script.isNullOrUndefined($v_0)) {
            ...
            if (!_Script.isNullOrUndefined($v_2)) {
                ...
                var $v_6 = (!_Script.isNullOrUndefined($v_1.get_relatedEntities()))
                    ? $v_1.get_relatedEntities().get_relatedEntityQueries()
                    : new Array(0);
...
Xrm.Gen.ReviseQuoteRequestSerializer.loadFromCrmSoap = function(data) {
    ...
    return new Xrm.Gen.ReviseQuoteRequest(Xrm.Soap.Parser
        .load(Microsoft.Crm.Client.Core.Framework.Guid, data, 'QuoteId'),
        Xrm.Soap.Parser.load(Microsoft.Crm.Client.Core.Storage.Common.IColumnSet, data, 'ColumnSet', 'ColumnSet'));
}
...
Xrm.Gen.ReviseQuoteResponseSerializer.loadFromCrmSoap = function(soapResponse, request) {
    return Xrm.Soap.ResponseSerializer.deserialize(soapResponse,
        request,
        function($p1_0) {
            return new Xrm.Gen.ReviseQuoteResponse(Xrm.Soap.Parser
                .load(Microsoft.Crm.Client.Core.Storage.Common.ObjectModel.EntityRecord, $p1_0, 'Entity'));
        });
}
...
Xrm.Gen.RouteToRequestSerializer.loadFromCrmSoap = function(data) {
    ...
    return new Xrm.Gen.RouteToRequest(Xrm.Soap.Parser.load(Xrm.Objects.EntityReference, data, 'Target'),
        Xrm.Soap.Parser.load(Microsoft.Crm.Client.Core.Framework.Guid, data, 'QueueItemId'));
}
...
Xrm.Gen.RevokeAccessRequestSerializer.loadFromCrmSoap = function(data) {
    ...
    return new Xrm.Gen.RevokeAccessRequest(Xrm.Soap.Parser.load(Xrm.Objects.EntityReference, data, 'Target'),
        Xrm.Soap.Parser.load(Xrm.Objects.EntityReference, data, 'Revokee'));
}
...
Xrm.Gen.PublishProductHierarchyRequestSerializer.loadFromCrmSoap = function(data) {
    ...
    return new Xrm.Gen.PublishProductHierarchyRequest(Xrm.Soap.Parser
        .load(Xrm.Objects.EntityReference, data, 'Target'));
}
...
Xrm.Gen.SetDevErrorsRequestSerializer.parametersToCrmSoap = function(request) {
    return Xrm.Soap.Write.f('UserId', (request).userId, 15) +
        Xrm.Soap.Write.f('OrganizationId', (request).organizationId, 15) +
        Xrm.Soap.Write.f('Value', (request).value, 0);
}
Xrm.Gen.SetDevErrorsRequestSerializer.loadFromCrmSoap = function(data) {
    if (_Script.isNullOrUndefined(data)) {
        return null;
    }
    return new Xrm.Gen.SetDevErrorsRequest(Xrm.Soap.Parser
        .load(Microsoft.Crm.Client.Core.Framework.Guid, data, 'UserId'),
        Xrm.Soap.Parser.load(Microsoft.Crm.Client.Core.Framework.Guid, data, 'OrganizationId'),
        Xrm.Soap.Parser.load(Boolean, data, 'Value'));
}
...
Xrm.Gen.SetFeatureStatusRequestSerializer.parametersToCrmSoap = function(request) {
    return Xrm.Soap.Write.f('FetaureType', (request).fetaureType, 5) +
        Xrm.Soap.Write.f('Status', (request).status, 0) +
        Xrm.Soap.Write.f('IsSolutionUninstall', (request).isSolutionUninstall, 0);
}
Xrm.Gen.SetFeatureStatusRequestSerializer.loadFromCrmSoap = function(data) {
    if (_Script.isNullOrUndefined(data)) {
        return null;
    }
    return new Xrm.Gen.SetFeatureStatusRequest(Xrm.Soap.Parser.load(Number, data, 'FetaureType'),
        Xrm.Soap.Parser.load(Boolean, data, 'Status'),
        Xrm.Soap.Parser.load(Boolean, data, 'IsSolutionUninstall'));
}
...
Xrm.Gen.SetStateRequestSerializer.parametersToCrmSoap = function(request) {
    return Xrm.Soap.Write.f('EntityMoniker', (request).entityMoniker, 6) +
        Xrm.Soap.Write.f('State', (request).state, 11) +
        Xrm.Soap.Write.f('Status', (request).status, 11) +
        Xrm.Soap.Write.f('MaintainLegacyAppServerBehavior', (request).maintainLegacyAppServerBehavior, 0);
}
Xrm.Gen.SetStateRequestSerializer.loadFromCrmSoap = function(data) {
    ...
    return new Xrm.Gen.SetStateRequest(Xrm.Soap.Parser.load(Xrm.Objects.EntityReference, data, 'EntityMoniker'),
        Xrm.Soap.Parser.load(Number, data, 'State', 'OptionSet'),
        Xrm.Soap.Parser.load(Number, data, 'Status', 'OptionSet'),
        Xrm.Soap.Parser.load(Boolean, data, 'MaintainLegacyAppServerBehavior'));
}
...
Xrm.Gen.StartRIProvisioningRequestSerializer.parametersToCrmSoap = function(request) {
    return Xrm.Soap.Write
        .f('HubName', (request).hubName, 14) +
        Xrm.Soap.Write.f('PrimaryKey', (request).primaryKey, 14);
}
Xrm.Gen.StartRIProvisioningRequestSerializer.loadFromCrmSoap = function(data) {
    if (_Script.isNullOrUndefined(data)) {
        return null;
    }
    return new Xrm.Gen.StartRIProvisioningRequest(Xrm.Soap.Parser.load(String, data, 'HubName'),
        Xrm.Soap.Parser.load(String, data, 'PrimaryKey'));
}
...
Xrm.Gen.UnlockSalesOrderPricingRequestSerializer.loadFromCrmSoap = function(data) {
    ...
    return new Xrm.Gen.UnlockSalesOrderPricingRequest(Xrm.Soap.Parser
        .load(Microsoft.Crm.Client.Core.Framework.Guid, data, 'SalesOrderId'));
}
...
Xrm.Gen.UpdateRequestSerializer.loadFromCrmSoap = function(data) {
    ...
    return new Xrm.Gen.UpdateRequest(Xrm.Soap.Parser.load(Microsoft.Crm.Client.Core.Storage.Common.ObjectModel
            .EntityRecord,
            data,
            'Target'),
        Xrm.Soap.Parser.load(Boolean, data, 'SuppressDuplicateDetection'),
...
Xrm.Gen.UpdateProductPropertiesRequestSerializer.loadFromCrmSoap = function(data) {
    ...
    return new Xrm.Gen.UpdateProductPropertiesRequest(Xrm.Soap.Parser
        .load(Microsoft.Crm.Client.Core.Storage.Common.ObjectModel.EntityCollection, data, 'PropertyInstanceList'));
}
...
Xrm.Gen.UpdateRITenantInfoRequestSerializer.loadFromCrmSoap = function(data) {
    ...
    return new Xrm.Gen.UpdateRITenantInfoRequest(Xrm.Soap.Parser.load(String, data, 'HubName'),
        Xrm.Soap.Parser.load(String, data, 'PrimaryKey'));
}
...
Xrm.Gen.UpdateDelveActionStatusRequestSerializer.parametersToCrmSoap = function(request) {
    return Xrm.Soap.Write.f('MessageId', (request).messageId, 14) +
        Xrm.Soap.Write.f('ActionState', (request).actionState, 5) +
        Xrm.Soap.Write.f('RecordId', (request).recordId, 14);
}
Xrm.Gen.UpdateDelveActionStatusRequestSerializer.loadFromCrmSoap = function(data) {
    if (_Script.isNullOrUndefined(data)) {
        return null;
    }
    return new Xrm.Gen.UpdateDelveActionStatusRequest(Xrm.Soap.Parser.load(String, data, 'MessageId'),
        Xrm.Soap.Parser.load(Number, data, 'ActionState'),
        Xrm.Soap.Parser.load(String, data, 'RecordId'));
}
...
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.Generated
    .CreateEmailReplyDraftRequestSerializer.$$cctor = function() {
        Xrm.Soap.Serializer.registerSerializer('CreateEmailReplyDraft',
            Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.Generated
            .CreateEmailReplyDraftRequestSerializer.parametersToCrmSoap);
        Xrm.Soap.Serializer.registerDeserializer('CreateEmailReplyDraft',
            Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.Generated
            .CreateEmailReplyDraftRequestSerializer.loadFromCrmSoap);
    }
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.Generated
    .CreateEmailReplyDraftRequestSerializer.parametersToCrmSoap = function(request) {
        var $v_0 = request;
        return Xrm.Soap.EntityRecordSerializer.fieldToCrmSoap('MessageId', $v_0.messageId, 14) +
            Xrm.Soap.EntityRecordSerializer.fieldToCrmSoap('ReplyText', $v_0.replyText, 14);
    }
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.Generated
    .CreateEmailReplyDraftRequestSerializer.loadFromCrmSoap = function(data) {
        if (_Script.isNullOrUndefined(data)) {
            return null;
        }
...
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.Generated
    .CreateEmailReplyDraftResponseSerializer.$$cctor = function() {
        Xrm.Soap.ResponseSerializer.registerSerializer('CreateEmailReplyDraft',
            Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.Generated
            .CreateEmailReplyDraftResponseSerializer.loadFromCrmSoap);
    }
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.Generated
    .CreateEmailReplyDraftResponseSerializer.loadFromCrmSoap = function(soapResponse, request) {
        if (!_Script.isNullOrUndefined(soapResponse)) {
            Xrm.Soap.ResponseSerializer.addCrmSoapNamespaces(soapResponse);
            var $v_0 = null;
            $v_0 = soapResponse.selectSingleNode('.//a:Results');
...
Xrm.Gen.SetActionCardStateRequestSerializer.parametersToCrmSoap = function(request) {
    return Xrm.Soap.Write.f('ActionCardId', (request).actionCardId, 15) +
        Xrm.Soap.Write.f('ActionState', (request).actionState, 11) +
        Xrm.Soap.Write.f('MessageId', (request).messageId, 14);
}
Xrm.Gen.SetActionCardStateRequestSerializer.loadFromCrmSoap = function(data) {
    if (_Script.isNullOrUndefined(data)) {
        return null;
    }
    return new Xrm.Gen.SetActionCardStateRequest(Xrm.Soap.Parser
        .load(Microsoft.Crm.Client.Core.Framework.Guid, data, 'ActionCardId'),
        Xrm.Soap.Parser.load(Number, data, 'ActionState', 'OptionSet'),
        Xrm.Soap.Parser.load(String, data, 'MessageId'));
}
...
Xrm.Gen.SnoozeActionCardRequestSerializer.loadFromCrmSoap = function(data) {
    ...
    return new Xrm.Gen.SnoozeActionCardRequest(Xrm.Soap.Parser
        .load(Microsoft.Crm.Client.Core.Framework.Guid, data, 'ActionCardId'));
}
...
Xrm.Gen.PopulateCardRequestSerializer.loadFromCrmSoap = function(data) {
    ...
    return new Xrm.Gen.PopulateCardRequest(Xrm.Soap.Parser
        .load(Microsoft.Crm.Client.Core.Framework.Guid, data, 'UserId'));
}
...
Xrm.Gen.CopySharePointDocumentsRequestSerializer.$$cctor = function() {
    Xrm.Soap.Serializer.registerSerializer('CopySharePointDocuments',
        Xrm.Gen.CopySharePointDocumentsRequestSerializer.parametersToCrmSoap);
    Xrm.Soap.Serializer.registerDeserializer('CopySharePointDocuments',
        Xrm.Gen.CopySharePointDocumentsRequestSerializer.loadFromCrmSoap);
}
Xrm.Gen.CopySharePointDocumentsRequestSerializer.parametersToCrmSoap = function(request) {
    var $v_0 = request;
    return Xrm.Soap.EntityRecordSerializer.fieldToCrmSoap('DestinationLocation', $v_0.destinationLocation, 14) +
        Xrm.Soap.EntityRecordSerializer.fieldToCrmSoap('AbsoluteUrls',
            $v_0.absoluteUrls,
            -1,
            'sa:ArrayOfstring',
            'xmlns:sa=\"http://schemas.microsoft.com/2003/10/Serialization/Arrays\"') +
        Xrm.Soap.EntityRecordSerializer.fieldToCrmSoap('RelativeUrls',
            $v_0.relativeUrls,
            -1,
            'sa:ArrayOfstring',
            'xmlns:sa=\"http://schemas.microsoft.com/2003/10/Serialization/Arrays\"') +
        Xrm.Soap.EntityRecordSerializer.fieldToCrmSoap('Source', $v_0.source, 14);
}
...
Xrm.Gen.CopySharePointDocumentsResponseSerializer.$$cctor = function() {
    Xrm.Soap.ResponseSerializer.registerSerializer('CopySharePointDocuments',
        Xrm.Gen.CopySharePointDocumentsResponseSerializer.loadFromCrmSoap);
}
...
Xrm.Gen.OverrideDynamicPropertiesRequestSerializer.parametersToCrmSoap = function(request) {
    return Xrm.Soap.Write.f('RegardingObject', (request).regardingObject, 6) +
        Xrm.Soap.Write.f('DynamicPropertyCollection', (request).dynamicPropertyCollection, -1, 'a:EntityCollection');
}
Xrm.Gen.OverrideDynamicPropertiesRequestSerializer.loadFromCrmSoap = function(data) {
    if (_Script.isNullOrUndefined(data)) {
        return null;
    }
    return new Xrm.Gen.OverrideDynamicPropertiesRequest(Xrm.Soap.Parser
        .load(Xrm.Objects.EntityReference, data, 'RegardingObject'),
        Xrm.Soap.Parser.load(Microsoft.Crm.Client.Core.Storage.Common.ObjectModel.EntityCollection,
            data,
...
Xrm.Gen.WhoAmIResponseSerializer.loadFromCrmSoap = function(soapResponse, request) {
    return Xrm.Soap.ResponseSerializer.deserialize(soapResponse,
        request,
        function($p1_0) {
            return new Xrm.Gen.WhoAmIResponse(Xrm.Soap.Parser
                .load(Microsoft.Crm.Client.Core.Framework.Guid, $p1_0, 'UserId'),
                Xrm.Soap.Parser.load(Microsoft.Crm.Client.Core.Framework.Guid, $p1_0, 'BusinessUnitId'),
                Xrm.Soap.Parser.load(Microsoft.Crm.Client.Core.Framework.Guid, $p1_0, 'OrganizationId'));
        });
}
...
Xrm.Gen.WinOpportunityRequestSerializer.loadFromCrmSoap = function(data) {
    ...
    return new Xrm.Gen.WinOpportunityRequest(Xrm.Soap.Parser
        .load(Microsoft.Crm.Client.Core.Storage.Common.ObjectModel.EntityRecord, data, 'OpportunityClose'),
        Xrm.Soap.Parser.load(Number, data, 'Status', 'OptionSet'));
}
...
Xrm.Gen.AddOrEditLocationRequestSerializer.parametersToCrmSoap = function(request) {
    return Xrm.Soap.Write.f('LocationName', (request).locationName, 14) +
        Xrm.Soap.Write.f('AbsUrl', (request).absUrl, 14) +
        Xrm.Soap.Write.f('RegardingObjectId', (request).regardingObjectId, 14) +
        Xrm.Soap.Write.f('RelativePath', (request).relativePath, 14) +
        Xrm.Soap.Write.f('RegardingObjType', (request).regardingObjType, 5) +
        Xrm.Soap.Write.f('ParentType', (request).parentType, 5) +
        Xrm.Soap.Write.f('ParentId', (request).parentId, 14) +
        Xrm.Soap.Write.f('IsAddOrEditMode', (request).isAddOrEditMode, 0) +
        Xrm.Soap.Write.f('IsCreateFolder', (request).isCreateFolder, 0) +
        Xrm.Soap.Write.f('DocumentId', (request).documentId, 14);
}
Xrm.Gen.AddOrEditLocationRequestSerializer.loadFromCrmSoap = function(data) {
    ...
    return new Xrm.Gen.AddOrEditLocationRequest(Xrm.Soap.Parser.load(String, data, 'LocationName'),
        Xrm.Soap.Parser.load(String, data, 'AbsUrl'),
        Xrm.Soap.Parser.load(String, data, 'RegardingObjectId'),
        Xrm.Soap.Parser.load(String, data, 'RelativePath'),
        Xrm.Soap.Parser.load(Number, data, 'RegardingObjType'),
        Xrm.Soap.Parser.load(Number, data, 'ParentType'),
        Xrm.Soap.Parser.load(String, data, 'ParentId'),
        Xrm.Soap.Parser.load(Boolean, data, 'IsAddOrEditMode'),
        Xrm.Soap.Parser.load(Boolean, data, 'IsCreateFolder'),
        Xrm.Soap.Parser.load(String, data, 'DocumentId'));
}
...
Xrm.Gen.FetchSiteUrlRequestSerializer.parametersToCrmSoap = function(request) {
    return Xrm.Soap.Write.f('DocumentId', (request).documentId, 14) +
        Xrm.Soap.Write.f('RegardingObjectId', (request).regardingObjectId, 14) +
        Xrm.Soap.Write.f('RegardingObjType', (request).regardingObjType, 5);
}
Xrm.Gen.FetchSiteUrlRequestSerializer.loadFromCrmSoap = function(data) {
    ...
    return new Xrm.Gen.FetchSiteUrlRequest(Xrm.Soap.Parser.load(String, data, 'DocumentId'),
        Xrm.Soap.Parser.load(String, data, 'RegardingObjectId'),
        Xrm.Soap.Parser.load(Number, data, 'RegardingObjType'));
}
...
Xrm.Gen.GetDefaultPriceLevelRequestSerializer.parametersToCrmSoap = function(request) {
    return Xrm.Soap.Write.f('EntityName', (request).entityName, 14) +
        Xrm.Soap.Write.f('ColumnSet', (request).columnSet, -1, 'a:ColumnSet');
}
Xrm.Gen.GetDefaultPriceLevelRequestSerializer.loadFromCrmSoap = function(data) {
    ...
    return new Xrm.Gen.GetDefaultPriceLevelRequest(Xrm.Soap.Parser.load(String, data, 'EntityName'),
        Xrm.Soap.Parser.load(Microsoft.Crm.Client.Core.Storage.Common.IColumnSet, data, 'ColumnSet', 'ColumnSet'));
}
...
Xrm.Gen.GetDefaultPriceLevelResponseSerializer.loadFromCrmSoap = function(soapResponse, request) {
    return Xrm.Soap.ResponseSerializer.deserialize(soapResponse,
        request,
        function($p1_0) {
            return new Xrm.Gen.GetDefaultPriceLevelResponse(Xrm.Soap.Parser
                .load(Microsoft.Crm.Client.Core.Storage.Common.ObjectModel.EntityCollection, $p1_0, 'PriceLevels'));
        });
}
...
Xrm.Gen.RetrieveSharedPrincipalsAndAccessRequestSerializer.loadFromCrmSoap = function(data) {
    ...
    return new Xrm.Gen
        .RetrieveSharedPrincipalsAndAccessRequest(Xrm.Soap.Parser.load(Xrm.Objects.EntityReference, data, 'Target'));
}
...
Xrm.Gen.RetrieveSharedPrincipalsAndAccessResponseSerializer.loadFromCrmSoap = function(soapResponse, request) {
    return Xrm.Soap.ResponseSerializer.deserialize(soapResponse,
        ...
        function($p1_0) {
            return new Xrm.Gen
                .RetrieveSharedPrincipalsAndAccessResponse(Xrm.Soap.Parser
                    .load(Array, $p1_0, 'PrincipalAccesses', 'PrincipalAccessArray'));
        });
}
...
Xrm.Gen.LockInvoicePricingRequestSerializer.loadFromCrmSoap = function(data) {
    ...
    return new Xrm.Gen.LockInvoicePricingRequest(Xrm.Soap.Parser
        .load(Microsoft.Crm.Client.Core.Framework.Guid, data, 'InvoiceId'));
}
...
Xrm.Gen.CopyCampaignRequestSerializer.parametersToCrmSoap = function(request) {
    return Xrm.Soap.Write.f('BaseCampaign', (request).baseCampaign, 15) +
        Xrm.Soap.Write.f('SaveAsTemplate', (request).saveAsTemplate, 0);
}
Xrm.Gen.CopyCampaignRequestSerializer.loadFromCrmSoap = function(data) {
    if (_Script.isNullOrUndefined(data)) {
        return null;
    }
    return new Xrm.Gen.CopyCampaignRequest(Xrm.Soap.Parser
        .load(Microsoft.Crm.Client.Core.Framework.Guid, data, 'BaseCampaign'),
        Xrm.Soap.Parser.load(Boolean, data, 'SaveAsTemplate'));
}
...
Xrm.Gen.CopyCampaignResponseSerializer.loadFromCrmSoap = function(soapResponse, request) {
    return Xrm.Soap.ResponseSerializer.deserialize(soapResponse,
        request,
        function($p1_0) {
            return new Xrm.Gen.CopyCampaignResponse(Xrm.Soap.Parser
                .load(Microsoft.Crm.Client.Core.Framework.Guid, $p1_0, 'CampaignCopyId'));
        });
}
...
Xrm.Gen.GetInvoiceProductsFromOpportunityRequestSerializer.parametersToCrmSoap = function(request) {
    return Xrm.Soap.Write.f('OpportunityId', (request).opportunityId, 15) +
        Xrm.Soap.Write.f('InvoiceId', (request).invoiceId, 15);
}
Xrm.Gen.GetInvoiceProductsFromOpportunityRequestSerializer.loadFromCrmSoap = function(data) {
    ...
    return new Xrm.Gen
        .GetInvoiceProductsFromOpportunityRequest(Xrm.Soap.Parser
            .load(Microsoft.Crm.Client.Core.Framework.Guid, data, 'OpportunityId'),
            Xrm.Soap.Parser.load(Microsoft.Crm.Client.Core.Framework.Guid, data, 'InvoiceId'));
}
...
Xrm.Gen.UnlockInvoicePricingRequestSerializer.loadFromCrmSoap = function(data) {
    ...
    return new Xrm.Gen.UnlockInvoicePricingRequest(Xrm.Soap.Parser
        .load(Microsoft.Crm.Client.Core.Framework.Guid, data, 'InvoiceId'));
}
...
Xrm.Gen.TrackEmailRequestSerializer.parametersToCrmSoap = function(request) {
    return Xrm.Soap.Write.f('ExchangeItemId', (request).exchangeItemId, 14) +
        Xrm.Soap.Write.f('Regarding', (request).regarding, 6);
}
Xrm.Gen.TrackEmailRequestSerializer.loadFromCrmSoap = function(data) {
    if (_Script.isNullOrUndefined(data)) {
        return null;
    }
    return new Xrm.Gen.TrackEmailRequest(Xrm.Soap.Parser.load(String, data, 'ExchangeItemId'),
        Xrm.Soap.Parser.load(Xrm.Objects.EntityReference, data, 'Regarding'));
}
...
Xrm.Gen.ExecuteDataPerformanceActionRequestSerializer.parametersToCrmSoap = function(request) {
    return Xrm.Soap.Write.f('QueryingUnitId', (request).queryingUnitId, 15) +
        Xrm.Soap.Write.f('ActionName', (request).actionName, 14);
}
Xrm.Gen.ExecuteDataPerformanceActionRequestSerializer.loadFromCrmSoap = function(data) {
    if (_Script.isNullOrUndefined(data)) {
        return null;
    }
    return new Xrm.Gen.ExecuteDataPerformanceActionRequest(Xrm.Soap.Parser
        .load(Microsoft.Crm.Client.Core.Framework.Guid, data, 'QueryingUnitId'),
        Xrm.Soap.Parser.load(String, data, 'ActionName'));
}
...
Xrm.Gen.WinQuoteRequestSerializer.loadFromCrmSoap = function(data) {
    ...
    return new Xrm.Gen.WinQuoteRequest(Xrm.Soap.Parser.load(Microsoft.Crm.Client.Core.Storage.Common.ObjectModel
            .EntityRecord,
            data,
            'QuoteClose'),
        Xrm.Soap.Parser.load(Number, data, 'Status', 'OptionSet'));
...
Xrm.Gen.RenderTemplateRequestSerializer.loadFromCrmSoap = function(data) {
    ...
    return new Xrm.Gen.RenderTemplateRequest(Xrm.Soap.Parser.load(Xrm.Objects.EntityReference, data, 'Template'),
        Xrm.Soap.Parser.load(String, data, 'FetchXml'),
        Xrm.Soap.Parser.load(String, data, 'QueryApi'),
        Xrm.Soap.Parser.load(Object, data, 'QueryParameters', 'InputArgumentCollection'));
}
...
Xrm.Gen.RenderTemplateFromViewRequestSerializer.loadFromCrmSoap = function(data) {
    ...
    return new Xrm.Gen.RenderTemplateFromViewRequest(Xrm.Soap.Parser
        .load(Xrm.Objects.EntityReference, data, 'Template'),
        Xrm.Soap.Parser.load(Xrm.Objects.EntityReference, data, 'View'));
}
...
Xrm.Gen.RenderTemplateFromViewResponseSerializer.loadFromCrmSoap = function(soapResponse, request) {
    return Xrm.Soap.ResponseSerializer.deserialize(soapResponse,
        ...
        function($p1_0) {
            return new Xrm.Gen
                .RenderTemplateFromViewResponse(Xrm.Soap.Parser.load(String, $p1_0, 'ExcelFile', 'ByteArray'));
        });
}
...
Xrm.Gen.CreateProductsRequestSerializer.parametersToCrmSoap = function(request) {
    return Xrm.Soap.Write.f('Entities', (request).entities, -1, 'a:EntityCollection') +
        Xrm.Soap.Write.f('ParentEntity', (request).parentEntity, -1, 'a:Entity');
}
Xrm.Gen.CreateProductsRequestSerializer.loadFromCrmSoap = function(data) {
    if (_Script.isNullOrUndefined(data)) {
        return null;
    }
    return new Xrm.Gen.CreateProductsRequest(Xrm.Soap.Parser
        .load(Microsoft.Crm.Client.Core.Storage.Common.ObjectModel.EntityCollection, data, 'Entities'),
        Xrm.Soap.Parser.load(Microsoft.Crm.Client.Core.Storage.Common.ObjectModel.EntityRecord, data, 'ParentEntity'));
}
...
Xrm.Gen.CreateProductsResponseSerializer.loadFromCrmSoap = function(soapResponse, request) {
    return Xrm.Soap.ResponseSerializer.deserialize(soapResponse,
        request,
        function($p1_0) {
            return new Xrm.Gen.CreateProductsResponse(Xrm.Soap.Parser
                .load(Microsoft.Crm.Client.Core.Storage.Common.ObjectModel
                    .EntityCollection,
                    $p1_0,
                    'EntityCollection'));
...
Xrm.Gen.CopyCampaignResponseRequestSerializer.loadFromCrmSoap = function(data) {
    ...
    return new Xrm.Gen.CopyCampaignResponseRequest(Xrm.Soap.Parser
        .load(Xrm.Objects.EntityReference, data, 'CampaignResponseId'));
}
...
Xrm.Gen.CopyCampaignResponseResponseSerializer.loadFromCrmSoap = function(soapResponse, request) {
    return Xrm.Soap.ResponseSerializer.deserialize(soapResponse,
        request,
        function($p1_0) {
            return new Xrm.Gen.CopyCampaignResponseResponse(Xrm.Soap.Parser
                .load(Microsoft.Crm.Client.Core.Framework.Guid, $p1_0, 'CampaignResponseId'));
        });
}
...
Xrm.Gen.ConvertCampaignResponseRequestSerializer.parametersToCrmSoap = function(request) {
    return Xrm.Soap.Write.f('CampaignResponse', (request).campaignResponse, 6) +
        Xrm.Soap.Write.f('EntityName', (request).entityName, 14) +
        Xrm.Soap.Write.f('CreateOpportunityForExistingCustomer', (request).createOpportunityForExistingCustomer, 0) +
        Xrm.Soap.Write.f('Customer', (request).customer, 6) +
        Xrm.Soap.Write.f('Currency', (request).currency, 6) +
        Xrm.Soap.Write.f('Owner', (request).owner, 6);
}
Xrm.Gen.ConvertCampaignResponseRequestSerializer.loadFromCrmSoap = function(data) {
    if (_Script.isNullOrUndefined(data)) {
        return null;
    }
    return new Xrm.Gen.ConvertCampaignResponseRequest(Xrm.Soap.Parser
        .load(Xrm.Objects.EntityReference, data, 'CampaignResponse'),
        Xrm.Soap.Parser.load(String, data, 'EntityName'),
        Xrm.Soap.Parser.load(Boolean, data, 'CreateOpportunityForExistingCustomer'),
        Xrm.Soap.Parser.load(Xrm.Objects.EntityReference, data, 'Customer'),
        Xrm.Soap.Parser.load(Xrm.Objects.EntityReference, data, 'Currency'),
        Xrm.Soap.Parser.load(Xrm.Objects.EntityReference, data, 'Owner'));
}
...
Xrm.Gen.ConvertCampaignResponseResponseSerializer.loadFromCrmSoap = function(soapResponse, request) {
    return Xrm.Soap.ResponseSerializer.deserialize(soapResponse,
        ...
        function($p1_0) {
            return new Xrm.Gen
                .ConvertCampaignResponseResponse(Xrm.Soap.Parser
                    .load(Xrm.Objects.EntityReference, $p1_0, 'EntityReference'));
        });
}
...
Xrm.Gen.CreateKnowledgeArticleVersionRequestSerializer.loadFromCrmSoap = function(data) {
    ...
    return new Xrm.Gen.CreateKnowledgeArticleVersionRequest(Xrm.Soap.Parser
        .load(Xrm.Objects.EntityReference, data, 'Source'),
        Xrm.Soap.Parser.load(Boolean, data, 'IsMajor'));
}
...
Xrm.Gen.CreateKnowledgeArticleVersionResponseSerializer.loadFromCrmSoap = function(soapResponse, request) {
    return Xrm.Soap.ResponseSerializer.deserialize(soapResponse,
        ...
        function($p1_0) {
            return new Xrm.Gen
                .CreateKnowledgeArticleVersionResponse(Xrm.Soap.Parser
                    .load(Xrm.Objects.EntityReference, $p1_0, 'CreateKnowledgeArticleVersion'));
        });
}
...
Xrm.Gen.CreateKnowledgeArticleTranslationRequestSerializer.parametersToCrmSoap = function(request) {
    return Xrm.Soap.Write.f('Source', (request).source, 6) +
        Xrm.Soap.Write.f('Language', (request).language, 6) +
        Xrm.Soap.Write.f('IsMajor', (request).isMajor, 0);
}
Xrm.Gen.CreateKnowledgeArticleTranslationRequestSerializer.loadFromCrmSoap = function(data) {
    ...
    return new Xrm.Gen
        .CreateKnowledgeArticleTranslationRequest(Xrm.Soap.Parser.load(Xrm.Objects.EntityReference, data, 'Source'),
            Xrm.Soap.Parser.load(Xrm.Objects.EntityReference, data, 'Language'),
            Xrm.Soap.Parser.load(Boolean, data, 'IsMajor'));
}
...
Xrm.Gen.CreateKnowledgeArticleTranslationResponseSerializer.loadFromCrmSoap = function(soapResponse, request) {
    return Xrm.Soap.ResponseSerializer.deserialize(soapResponse,
        ...
        function($p1_0) {
            return new Xrm.Gen
                .CreateKnowledgeArticleTranslationResponse(Xrm.Soap.Parser
                    .load(Xrm.Objects.EntityReference, $p1_0, 'CreateKnowledgeArticleTranslation'));
        });
}
...
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.Generated.GetSimilarRecordsRequestSerializer
    .$$cctor = function() {
        Xrm.Soap.Serializer.registerSerializer('GetSimilarRecords',
            Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.Generated
            .GetSimilarRecordsRequestSerializer.parametersToCrmSoap);
        Xrm.Soap.Serializer.registerDeserializer('GetSimilarRecords',
            Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.Generated
            .GetSimilarRecordsRequestSerializer.loadFromCrmSoap);
    }
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.Generated.GetSimilarRecordsRequestSerializer
    .parametersToCrmSoap = function(request) {
        var $v_0 = request;
        return Xrm.Soap.EntityRecordSerializer.fieldToCrmSoap('Id', $v_0.id, 6) +
            Xrm.Soap.EntityRecordSerializer.fieldToCrmSoap('Filter', $v_0.filter, 14) +
            Xrm.Soap.EntityRecordSerializer.fieldToCrmSoap('ReturnFields', $v_0.returnFields, -1, 'a:ColumnSet');
    }
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.Generated.GetSimilarRecordsRequestSerializer
    .loadFromCrmSoap = function(data) {
        if (_Script.isNullOrUndefined(data)) {
...
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.Generated.GetSimilarRecordsResponseSerializer
    .$$cctor = function() {
        Xrm.Soap.ResponseSerializer.registerSerializer('GetSimilarRecords',
            Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.Generated
            .GetSimilarRecordsResponseSerializer.loadFromCrmSoap);
    }
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.Generated.GetSimilarRecordsResponseSerializer
    .loadFromCrmSoap = function(soapResponse, request) {
        if (!_Script.isNullOrUndefined(soapResponse)) {
...
Xrm.Gen.IncrementKnowledgeArticleViewCountRequestSerializer.parametersToCrmSoap = function(request) {
    return Xrm.Soap.Write.f('Source', (request).source, 6) +
        Xrm.Soap.Write.f('ViewDate', (request).viewDate, 2) +
        Xrm.Soap.Write.f('Location', (request).location, 5) +
        Xrm.Soap.Write.f('Count', (request).count, 5);
}
Xrm.Gen.IncrementKnowledgeArticleViewCountRequestSerializer.loadFromCrmSoap = function(data) {
    ...
    return new Xrm.Gen
        .IncrementKnowledgeArticleViewCountRequest(Xrm.Soap.Parser.load(Xrm.Objects.EntityReference, data, 'Source'),
            Xrm.Soap.Parser.load(Date, data, 'ViewDate'),
            Xrm.Soap.Parser.load(Number, data, 'Location'),
            Xrm.Soap.Parser.load(Number, data, 'Count'));
}
...
Xrm.Gen.IncrementKnowledgeArticleViewCountResponseSerializer.loadFromCrmSoap = function(soapResponse, request) {
    return Xrm.Soap.ResponseSerializer.deserialize(soapResponse,
        ...
        function($p1_0) {
            return new Xrm.Gen
                .IncrementKnowledgeArticleViewCountResponse(Xrm.Soap.Parser
                    .load(Xrm.Objects.EntityReference, $p1_0, 'IncrementKnowledgeArticleViewCount'));
        });
}
...
Xrm.Gen.PublishKnowledgeArticleRequestSerializer.parametersToCrmSoap = function(request) {
    return Xrm.Soap.Write.f('Entity', (request).entity, -1, 'a:Entity') +
        Xrm.Soap.Write.f('CopyRelatedProductFromAssociatedPrimary',
            (request).copyRelatedProductFromAssociatedPrimary,
            0) +
        Xrm.Soap.Write.f('CopyRelatedCategoryFromAssociatedPrimary',
            (request).copyRelatedCategoryFromAssociatedPrimary,
            0) +
        Xrm.Soap.Write.f('PublishApprovedRelatedTranslations', (request).publishApprovedRelatedTranslations, 0);
}
Xrm.Gen.PublishKnowledgeArticleRequestSerializer.loadFromCrmSoap = function(data) {
    if (_Script.isNullOrUndefined(data)) {
        return null;
    }
    return new Xrm.Gen.PublishKnowledgeArticleRequest(Xrm.Soap.Parser
        .load(Microsoft.Crm.Client.Core.Storage.Common.ObjectModel.EntityRecord, data, 'Entity'),
        Xrm.Soap.Parser.load(Boolean, data, 'CopyRelatedProductFromAssociatedPrimary'),
        Xrm.Soap.Parser.load(Boolean, data, 'CopyRelatedCategoryFromAssociatedPrimary'),
        Xrm.Soap.Parser.load(Boolean, data, 'PublishApprovedRelatedTranslations'));
}
...
Xrm.Gen.IntersectRecordsWithQueueAndAggregateRequestSerializer.parametersToCrmSoap = function(request) {
    return Xrm.Soap.Write.f('QueueId', (request).queueId, 15) +
        Xrm.Soap.Write.f('ViewId', (request).viewId, 15) +
        Xrm.Soap.Write.f('VisualizationId', (request).visualizationId, 15) +
        Xrm.Soap.Write.f('InteractionCentricFilterXml', (request).interactionCentricFilterXml, 14);
}
Xrm.Gen.IntersectRecordsWithQueueAndAggregateRequestSerializer.loadFromCrmSoap = function(data) {
    ...
    return new Xrm.Gen
        .IntersectRecordsWithQueueAndAggregateRequest(Xrm.Soap.Parser
            .load(Microsoft.Crm.Client.Core.Framework.Guid, data, 'QueueId'),
            Xrm.Soap.Parser.load(Microsoft.Crm.Client.Core.Framework.Guid, data, 'ViewId'),
            Xrm.Soap.Parser.load(Microsoft.Crm.Client.Core.Framework.Guid, data, 'VisualizationId'),
            Xrm.Soap.Parser.load(String, data, 'InteractionCentricFilterXml'));
}
...
Xrm.Gen.IntersectRecordsWithQueueAndAggregateResponseSerializer.loadFromCrmSoap = function(soapResponse, request) {
    return Xrm.Soap.ResponseSerializer.deserialize(soapResponse,
        ...
        function($p1_0) {
            return new Xrm.Gen
                .IntersectRecordsWithQueueAndAggregateResponse(Xrm.Soap.Parser
                    .load(Microsoft.Crm.Client.Core.Storage.Common.ObjectModel.EntityCollection,
                        $p1_0,
                        'EntityCollection'));
        });
...
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.Generated
    .PopulateRecommendationCacheForRecordRequestSerializer.$$cctor = function() {
        Xrm.Soap.Serializer.registerSerializer('PopulateRecommendationCacheForRecord',
            Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.Generated
            .PopulateRecommendationCacheForRecordRequestSerializer.parametersToCrmSoap);
        Xrm.Soap.Serializer.registerDeserializer('PopulateRecommendationCacheForRecord',
            Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.Generated
            .PopulateRecommendationCacheForRecordRequestSerializer.loadFromCrmSoap);
    }
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.Generated
    .PopulateRecommendationCacheForRecordRequestSerializer.parametersToCrmSoap = function(request) {
        var $v_0 = request;
        return Xrm.Soap.EntityRecordSerializer.fieldToCrmSoap('ParentRecord', $v_0.parentRecord, 6);
    }
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.Generated
    .PopulateRecommendationCacheForRecordRequestSerializer.loadFromCrmSoap = function(data) {
        if (_Script.isNullOrUndefined(data)) {
            return null;
        }
...
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.Generated
    .PopulateRecommendationCacheForRecordResponseSerializer.$$cctor = function() {
        Xrm.Soap.ResponseSerializer.registerSerializer('PopulateRecommendationCacheForRecord',
            Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.Generated
            .PopulateRecommendationCacheForRecordResponseSerializer.loadFromCrmSoap);
    }
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.Generated
    .PopulateRecommendationCacheForRecordResponseSerializer.loadFromCrmSoap = function(soapResponse, request) {
        if (!_Script.isNullOrUndefined(soapResponse)) {
            Xrm.Soap.ResponseSerializer.addCrmSoapNamespaces(soapResponse);
            var $v_0 = null;
            $v_0 = soapResponse.selectSingleNode('.//a:Results');
            if (!_Script.isNullOrUndefined($v_0)) {
                var $v_1 = $v_0
                    .selectSingleNode('.//a:KeyValuePairOfstringanyType[b:key=\'ShowAzureRecommendations\']/b:value');
                var $v_2;
                if (!_Script.isNullOrUndefined($v_1)) {
                    $v_2 = Boolean.parse($v_1.get_innerText());
                } else {
...
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.Generated
    .PopulateRecommendationCacheRequestSerializer.$$cctor = function() {
        Xrm.Soap.Serializer.registerSerializer('PopulateRecommendationCache',
            Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.Generated
            .PopulateRecommendationCacheRequestSerializer.parametersToCrmSoap);
        Xrm.Soap.Serializer.registerDeserializer('PopulateRecommendationCache',
            Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.Generated
            .PopulateRecommendationCacheRequestSerializer.loadFromCrmSoap);
    }
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.Generated
    .PopulateRecommendationCacheRequestSerializer.parametersToCrmSoap = function(request) {
        var $v_0 = request;
        return Xrm.Soap.EntityRecordSerializer.fieldToCrmSoap('EntityName', $v_0.entityName, 14) +
            Xrm.Soap.EntityRecordSerializer.fieldToCrmSoap('ItemId', $v_0.itemId, 15);
    }
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.Generated
    .PopulateRecommendationCacheRequestSerializer.loadFromCrmSoap = function(data) {
        if (_Script.isNullOrUndefined(data)) {
            return null;
        }
...
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.Generated
    .PopulateRecommendationCacheResponseSerializer.$$cctor = function() {
        Xrm.Soap.ResponseSerializer.registerSerializer('PopulateRecommendationCache',
            Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.Generated
            .PopulateRecommendationCacheResponseSerializer.loadFromCrmSoap);
    }
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.Generated
    .PopulateRecommendationCacheResponseSerializer.loadFromCrmSoap = function(soapResponse, request) {
        if (!_Script.isNullOrUndefined(soapResponse)) {
            Xrm.Soap.ResponseSerializer.addCrmSoapNamespaces(soapResponse);
            var $v_0 = null;
            $v_0 = soapResponse.selectSingleNode('.//a:Results');
...
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.Generated
    .RetrieveItemIdsForRecordRequestSerializer.$$cctor = function() {
        Xrm.Soap.Serializer.registerSerializer('RetrieveItemIdsForRecord',
            Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.Generated
            .RetrieveItemIdsForRecordRequestSerializer.parametersToCrmSoap);
        Xrm.Soap.Serializer.registerDeserializer('RetrieveItemIdsForRecord',
            Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.Generated
            .RetrieveItemIdsForRecordRequestSerializer.loadFromCrmSoap);
    }
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.Generated
    .RetrieveItemIdsForRecordRequestSerializer.parametersToCrmSoap = function(request) {
        var $v_0 = request;
        return Xrm.Soap.EntityRecordSerializer.fieldToCrmSoap('ParentRecord', $v_0.parentRecord, 6);
    }
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.Generated
    .RetrieveItemIdsForRecordRequestSerializer.loadFromCrmSoap = function(data) {
        if (_Script.isNullOrUndefined(data)) {
            return null;
        }
        var $v_0 = data.selectSingleNode('.//a:KeyValuePairOfstringanyType[b:key=\'ParentRecord\']/b:value');
...
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.Generated
    .RetrieveItemIdsForRecordResponseSerializer.$$cctor = function() {
        Xrm.Soap.ResponseSerializer.registerSerializer('RetrieveItemIdsForRecord',
            Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.Generated
            .RetrieveItemIdsForRecordResponseSerializer.loadFromCrmSoap);
    }
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.Generated
    .RetrieveItemIdsForRecordResponseSerializer.loadFromCrmSoap = function(soapResponse, request) {
        if (!_Script.isNullOrUndefined(soapResponse)) {
            Xrm.Soap.ResponseSerializer.addCrmSoapNamespaces(soapResponse);
            var $v_0 = null;
            $v_0 = soapResponse.selectSingleNode('.//a:Results');
...
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.Generated
    .RetrieveRecommendationsCountRequestSerializer.$$cctor = function() {
        Xrm.Soap.Serializer.registerSerializer('RetrieveRecommendationsCount',
            Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.Generated
            .RetrieveRecommendationsCountRequestSerializer.parametersToCrmSoap);
        Xrm.Soap.Serializer.registerDeserializer('RetrieveRecommendationsCount',
            Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.Generated
            .RetrieveRecommendationsCountRequestSerializer.loadFromCrmSoap);
    }
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.Generated
    .RetrieveRecommendationsCountRequestSerializer.parametersToCrmSoap = function(request) {
        var $v_0 = request;
        return Xrm.Soap.EntityRecordSerializer.fieldToCrmSoap('ParentRecord', $v_0.parentRecord, 6) +
            Xrm.Soap.EntityRecordSerializer.fieldToCrmSoap('PriceLevelId', $v_0.priceLevelId, 15);
    }
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.Generated
    .RetrieveRecommendationsCountRequestSerializer.loadFromCrmSoap = function(data) {
        if (_Script.isNullOrUndefined(data)) {
            return null;
        }
        var $v_0 = data.selectSingleNode('.//a:KeyValuePairOfstringanyType[b:key=\'ParentRecord\']/b:value');
...
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.Generated
    .RetrieveRecommendationsCountResponseSerializer.$$cctor = function() {
        Xrm.Soap.ResponseSerializer.registerSerializer('RetrieveRecommendationsCount',
            Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.Generated
            .RetrieveRecommendationsCountResponseSerializer.loadFromCrmSoap);
    }
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.Generated
    .RetrieveRecommendationsCountResponseSerializer.loadFromCrmSoap = function(soapResponse, request) {
        if (!_Script.isNullOrUndefined(soapResponse)) {
            Xrm.Soap.ResponseSerializer.addCrmSoapNamespaces(soapResponse);
            var $v_0 = null;
            $v_0 = soapResponse.selectSingleNode('.//a:Results');
            if (!_Script.isNullOrUndefined($v_0)) {
                var $v_1 = $v_0
                    .selectSingleNode('.//a:KeyValuePairOfstringanyType[b:key=\'RecommendationsCount\']/b:value');
                var $v_2;
                if (!_Script.isNullOrUndefined($v_1)) {
                    $v_2 = parseInt($v_1.get_innerText());
                } else {
...
Xrm.Gen.RetrieveRecommendationLineItemMetadataRequestSerializer.loadFromCrmSoap = function(data) {
    ...
    return new Xrm.Gen
        .RetrieveRecommendationLineItemMetadataRequest(Xrm.Soap.Parser.load(String, data, 'ParentEntityName'));
}
...
Xrm.Gen.RetrieveRecommendationLineItemMetadataResponseSerializer.loadFromCrmSoap = function(soapResponse, request) {
    return Xrm.Soap.ResponseSerializer.deserialize(soapResponse,
        ...
        function($p1_0) {
            return new Xrm.Gen
                .RetrieveRecommendationLineItemMetadataResponse(Xrm.Soap.Parser
                    .load(String, $p1_0, 'RecommendationLineItemMetadata'));
        });
}
...
Xrm.Gen.RetrieveRecommendationLineItemProductsRequestSerializer.parametersToCrmSoap = function(request) {
    return Xrm.Soap.Write.f('ParentEntityName', (request).parentEntityName, 14) +
        Xrm.Soap.Write.f('ParentEntityId', (request).parentEntityId, 15);
}
Xrm.Gen.RetrieveRecommendationLineItemProductsRequestSerializer.loadFromCrmSoap = function(data) {
    ...
    return new Xrm.Gen
        .RetrieveRecommendationLineItemProductsRequest(Xrm.Soap.Parser.load(String, data, 'ParentEntityName'),
            Xrm.Soap.Parser.load(Microsoft.Crm.Client.Core.Framework.Guid, data, 'ParentEntityId'));
}
...
Xrm.Gen.RetrieveRecommendationLineItemProductsResponseSerializer.loadFromCrmSoap = function(soapResponse, request) {
    return Xrm.Soap.ResponseSerializer.deserialize(soapResponse,
        ...
        function($p1_0) {
            return new Xrm.Gen
                .RetrieveRecommendationLineItemProductsResponse(Xrm.Soap.Parser
                    .load(String, $p1_0, 'RecommendationLineItemProducts'));
        });
}
...
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.JsonResponses.JsonResponse
    .createErrorData = function(errorDataJson) {
        var $v_0 = new Array(0);
...
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.JsonResponses
    .UserContextResponse = function(success, response, errors) {
        Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.JsonResponses.UserContextResponse
            .initializeBase(this, [success, response, errors]);
        if (this.$1B_0) {
            this.$1D_1 = Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.JsonSerializers.UserContextSerializer
                .loadFromJson(this.$1S_0);
        }
    }
...
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.JsonSerializers.AttributePrivilegeSerializer
    .loadFromJson = function(attributePrivilegeJson) {
        var $v_0 = attributePrivilegeJson;
        return new Microsoft.Crm.Client.Core.Storage.Common.ObjectModel
            .AttributePrivilege(new Microsoft.Crm.Client.Core.Framework.Guid($v_0.AttributeId),
                $v_0.CanCreate,
                $v_0.CanRead,
                $v_0.CanUpdate);
    }
...
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.JsonSerializers.AttributePrivilegeSerializer
    .AttributePrivilegeRecord = function() {
...
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.JsonSerializers.FeatureDetailsSerializer
    .loadFromJson = function(featureDetailsJson) {
        var $v_0 = featureDetailsJson;
        return new Microsoft.Crm.Client.Core.Storage.DataApi
            .FeatureDetails($v_0.FeatureName, $v_0.FeatureControlBitName, $v_0.Value);
    }


Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.JsonSerializers.FeatureDetailsSerializer
    .FeatureDetailsRecord = function() {}


Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.JsonSerializers.OfflineProfileSerializer = function() {
}
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.JsonSerializers.OfflineProfileSerializer
    .loadFromJson = function(offlineProfileJson) {
        var $v_0 = offlineProfileJson;
        return new Microsoft.Crm.Client.Core.Storage.Common.ObjectModel
            .OfflineProfile(new Microsoft.Crm.Client.Core.Framework.Guid($v_0.ProfileId),
                $v_0.OfflineAvailableEntities,
                $v_0.ProfileVersion);
    }


Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.JsonSerializers.OfflineProfileSerializer
    .OfflineProfileRecord = function() {
        this.ProfileId = null;
...
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.JsonSerializers.OrganizationSettingsSerializer
    .loadFromJson = function(organizationSettingsJson) {
        var $v_0 = organizationSettingsJson;
        var $v_1 = new Microsoft.Crm.Client.Core.Storage.Common.ObjectModel
            .OrganizationSettings(new Microsoft.Crm.Client.Core.Framework.Guid($v_0.OrganizationId),
                $v_0.OrganizationName,
                $v_0.LanguageCode,
                $v_0.EnabledLanguages,
                $v_0.CurrencyDisplayOption,
                $v_0.BlockedAttachmentExtensions,
                $v_0.MaxUploadFileSize,
                $v_0.ReportScriptErrors,
                $v_0.IsAutoSaveEnabled,
                $v_0.IsDuplicateDetectionEnabled,
                $v_0.IsDuplicateDetectionEnabledForOnlineCreateUpdate,
                $v_0.OrgCultureInfoLcid,
                $v_0.FullNameConventionCode,
                $v_0.FiscalCalendarStart,
                $v_0.FiscalPeriodFormatPeriod,
                $v_0.FiscalYearFormatPrefix,
                $v_0.FiscalYearFormatYear,
                $v_0.FiscalYearFormatSuffix,
                $v_0.FiscalPeriodType,
                $v_0.FiscalYearDisplayCode,
                $v_0.FiscalPeriodConnector,
                $v_0.IsSOPIntegrationEnabled,
                new Microsoft.Crm.Client.Core.Framework.Guid($v_0.BaseCurrencyId),
                $v_0.OrganizationUniqueName,
                $v_0.UseSkypeProtocol,
                $v_0.DefaultCountryCode,
                $v_0.PricingDecimalPrecision,
                $v_0.IsTelemetryEnabled,
                $v_0.IsTrialOrganization,
                $v_0.IsMocaOfflineFeatureEnabled,
                $v_0.MobileOfflineSyncInterval,
                $v_0.NorsyncServerConnectionString,
                $v_0.OverrideTrackInCrmBehaviour,
                $v_0.ShowWeekNumber,
                $v_0.DefaultThemeData,
                $v_0.DelveUrl,
                $v_0.KmUseExternalPortal,
                $v_0.KmExternalPortalUrl,
                $v_0.IsParature,
                $v_0.IsKMConfigured,
                $v_0.MaxIncidentMergeNumber,
                $v_0.MaxChildIncidentNumber,
                $v_0.IsConflictDetectionEnabledForMobileClient,
                $v_0.EnableMicrosoftFlowIntegration,
                $v_0.IsMobileClientOnDemandSyncEnabled,
                $v_0.IsExternalSearchIndexEnabled);
...
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.JsonSerializers.OrganizationSettingsSerializer
    .OrganizationSettingsRecord = function() {
...
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.JsonSerializers.RolePrivilegeSerializer
    .loadFromJson = function(rolePrivilegeJson) {
        var $v_0 = rolePrivilegeJson;
        return new Microsoft.Crm.Client.Core.Storage.Common.ObjectModel
            .RolePrivilege(new Microsoft.Crm.Client.Core.Framework.Guid($v_0.PrivilegeId),
                new Microsoft.Crm.Client.Core.Framework.Guid($v_0.BusinessUnitId),
                $v_0.Depth);
    }


Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.JsonSerializers.RolePrivilegeSerializer
    .RolePrivilegeRecord = function() {
...
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.JsonSerializers.ServerContextSerializer
    .loadFromJson = function(serverContextJson) {
        var $v_0 = serverContextJson;
        return new Microsoft.Crm.Client.Core.Storage.Common.ObjectModel
            .ServerContext($v_0.ServerVersion, $v_0.DatabaseVersion);
    }


Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.JsonSerializers.ServerContextSerializer
    .ServerContextRecord = function() {
...
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.JsonSerializers.TimeZoneAdjusterSerializer
    .loadFromJson = function(data) {
        ...
        var $v_4 = new Microsoft.Crm.Client.Core.Framework
            .TransitionConstraint($v_0.DaylightTransitionStart.Day,
                $v_0.DaylightTransitionStart.DayOfWeek,
                $v_0.DaylightTransitionStart.Month - 1,
                $v_0.DaylightTransitionStart.Week,
                Microsoft.Crm.Client.Core.Framework.UserDateTimeUtils
                .parseDateTimeFromJSONString($v_0.DaylightTransitionStart.TimeOfDay),
                $v_0.DaylightTransitionStart.IsFixedDateRule);
        var $v_5 = new Microsoft.Crm.Client.Core.Framework
            .TransitionConstraint($v_0.DaylightTransitionEnd.Day,
                $v_0.DaylightTransitionEnd.DayOfWeek,
                $v_0.DaylightTransitionEnd.Month - 1,
                $v_0.DaylightTransitionEnd.Week,
                Microsoft.Crm.Client.Core.Framework.UserDateTimeUtils
                .parseDateTimeFromJSONString($v_0.DaylightTransitionEnd.TimeOfDay),
                $v_0.DaylightTransitionEnd.IsFixedDateRule);
        return new Microsoft.Crm.Client.Core.Framework.TimeZoneAdjuster($v_2, $v_1, $v_3, $v_4, $v_5);
    }


Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.JsonSerializers.TimeZoneAdjusterSerializer
    .AdjustmentRuleRecord = function() {
        this.DateEnd = null;
        this.DateStart = null;
...
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.JsonSerializers.TimeZoneAdjusterSerializer
    .TransitionConstraintRecord = function() {
        this.Day = 0;
        this.DayOfWeek = 0;
        this.Month = 0;
        this.Week = 0;
...
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.JsonSerializers.TimeZoneDefinitionSerializer
    .loadFromJson = function(timeZoneDefinitionJson) {
        var $v_0 = timeZoneDefinitionJson;
        return new Microsoft.Crm.Client.Core.Storage.Common.ObjectModel
            .TimeZoneDefinition($v_0.Bias, $v_0.TimeZoneCode, $v_0.UserInterfaceName);
    }


Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.JsonSerializers.TimeZoneDefinitionSerializer
    .TimeZoneDefinitionRecord = function() {}


Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.JsonSerializers.TransactionCurrencySerializer = function() {
}
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.JsonSerializers.TransactionCurrencySerializer
    .loadFromJson = function(transactionCurrencyJson) {
        var $v_0 = transactionCurrencyJson;
        return new Microsoft.Crm.Client.Core.Storage.Common.ObjectModel
            .TransactionCurrency(new Microsoft.Crm.Client.Core.Framework.Guid($v_0.CurrencyId),
                $v_0.CurrencyName,
                $v_0.CurrencySymbol,
                $v_0.CurrencyCode,
                $v_0.CurrencyPrecision);
    }


Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.JsonSerializers.TransactionCurrencySerializer
    .TransactionCurrencyRecord = function() {}


Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.JsonSerializers.UserContextSerializer = function() {
}
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.JsonSerializers.UserContextSerializer
    .loadFromJson = function(userContextJson) {
        ...
        if ($v_0.ParentRootRoles) {
            for (var $$arr_B = $v_0.ParentRootRoles, $$len_C = $$arr_B.length, $$idx_D = 0;
                $$idx_D < $$len_C;
                ++$$idx_D) {
                var $v_O = $$arr_B[$$idx_D];
        ...
        var $v_7 = Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.JsonSerializers.OrganizationSettingsSerializer
            .loadFromJson($v_0.OrganizationSettings);
        var $v_8 = Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.JsonSerializers.UserSettingsSerializer
            .loadFromJson($v_0.UserSettings);
        var $v_9 = Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.JsonSerializers.OfflineProfileSerializer
            .loadFromJson($v_0.OfflineProfile);
        var $v_A = new (Microsoft.Crm.Client.Core.Framework.TypedDictionary$1
            .$$(Microsoft.Crm.Client.Core.Storage.Common.ObjectModel.RolePrivilege))();
        for (var $$arr_K = $v_0.RolePrivileges, $$len_L = $$arr_K.length, $$idx_M = 0; $$idx_M < $$len_L; ++$$idx_M) {
            var $v_P = $$arr_K[$$idx_M];
            var $v_Q = Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.JsonSerializers.RolePrivilegeSerializer
                .loadFromJson($v_P);
            $v_A.set_item($v_Q.get_privilegeId().toString(), $v_Q);
        }
        var $v_B = new (Microsoft.Crm.Client.Core.Framework.TypedDictionary$1
            .$$(Microsoft.Crm.Client.Core.Storage.Common.ObjectModel.AttributePrivilege))();
        for (var $$arr_Q = $v_0.AttributePrivileges, $$len_R = $$arr_Q.length, $$idx_S = 0;
            $$idx_S < $$len_R;
            ++$$idx_S) {
            var $v_R = $$arr_Q[$$idx_S];
            var $v_S = Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.JsonSerializers
                .AttributePrivilegeSerializer.loadFromJson($v_R);
            $v_B.set_item($v_S.get_attributeId().toString(), $v_S);
        }
        var $v_C = Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.JsonSerializers.ServerContextSerializer
            .loadFromJson($v_0.ServerContext);
        ...
        var $v_I = new (Microsoft.Crm.Client.Core.Framework.TypedDictionary$1
            .$$(Microsoft.Crm.Client.Core.Storage.Common.ObjectModel.TransactionCurrency))();
        for (var $$arr_c = $v_0.TransactionCurrencies, $$len_d = $$arr_c.length, $$idx_e = 0;
            $$idx_e < $$len_d;
            ++$$idx_e) {
            var $v_T = $$arr_c[$$idx_e];
            var $v_U = Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.JsonSerializers
                .TransactionCurrencySerializer.loadFromJson($v_T);
            $v_I.set_item($v_U.get_transactionCurrencyId().toString(), $v_U);
        }
        var $v_J = new (Microsoft.Crm.Client.Core.Framework.TypedDictionary$1
            .$$(Microsoft.Crm.Client.Core.Storage.Common.ObjectModel.TimeZoneDefinition))();
        for (var $$arr_i = $v_0.TimeZoneDefinitions, $$len_j = $$arr_i.length, $$idx_k = 0;
            $$idx_k < $$len_j;
            ++$$idx_k) {
            var $v_V = $$arr_i[$$idx_k];
            var $v_W = Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.JsonSerializers
                .TimeZoneDefinitionSerializer.loadFromJson($v_V);
        ...
        for (var $$key_s in $$dict_r) {
            ...
            var $v_Y = Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.JsonSerializers.FeatureDetailsSerializer
                .loadFromJson($v_X.value);
            if (!_Script.isNullOrUndefined($v_Y)) {
                $v_L[$v_Y.get_featureName()] = $v_Y;
            }
        }
        var $v_M = new Microsoft.Crm.Client.Core.Storage.DataApi
            .UserContext($v_1,
                $v_2,
                $v_4.toArray(),
                $v_5.toArray(),
...
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.JsonSerializers.UserSettingsSerializer
    .loadFromJson = function(userSettingsJson) {
        var $v_0 = userSettingsJson;
        var $v_1 = $P_CRM.parseJSON($v_0.ClientCultureInfo);
        var $v_2 = $v_1['dateTimeFormat'];
        $v_2['eras'] = $v_1['eras'];
        var $v_3 = new (Microsoft.Crm.Client.Core.Framework.List$1
            .$$(Microsoft.Crm.Client.Core.Framework.TimeZoneAdjuster))();
        for (var $$arr_5 = $v_0.TimeZoneAdjustmentRules, $$len_6 = $$arr_5.length, $$idx_7 = 0;
            $$idx_7 < $$len_6;
            ++$$idx_7) {
            var $v_4 = $$arr_5[$$idx_7];
            var $v_5 = Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.JsonSerializers.TimeZoneAdjusterSerializer
                .loadFromJson($v_4);
            $v_3.add($v_5);
        }
        return new Microsoft.Crm.Client.Core.Storage.Common.ObjectModel
            .UserSettings($v_0.LanguageId,
                $v_0.UserCultureLcid,
                $v_1['name'],
                $v_1['numberFormat'],
                $v_2,
                $v_0.TimeZoneUtcOffsetMinutes,
                $v_3.toArray(),
                $v_0.RecordsPerPage,
                $v_0.ReportScriptErrors,
                $v_0.IsGuidedHelpEnabled,
                $v_0.ShowCalendarWeeks,
                $v_0.DefaultSearchExperience);
    }


Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.JsonSerializers.UserSettingsSerializer
    .UserSettingsRecord = function() {
        this.LanguageId = 0;
...
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.Responses
    .CrmErrorResponse = function(request, textStatus, error, source) {
        Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.Responses.CrmErrorResponse
            .initializeBase(this, [request, textStatus, error, source]);
        try {
            if (!_Script.isNullOrUndefined(request) && request.readyState === 4) {
                if (textStatus === 'parsererror' &&
                    !_Script.isNullOrUndefined(error) &&
                    error.indexOf('<!DOCTYPE html') > -1) {
                    this.$5_1 = Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.Faults.OrganizationServiceFault
                        .parseFromHtml(error.substr(error.indexOf('<')));
                } else {
                    this.$5_1 = (_Script.isNullOrUndefined(request.responseXML))
                        ? null
                        : Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.Faults.OrganizationServiceFault
                        .parseFromXml(Microsoft.Crm.Client.Core.Storage.Common.Xml.XmlNodeFactory
                            .create(request.responseXML));
                    if (_Script.isNull(this.$5_1) && !_Script.isNullOrUndefined(request.responseText)) {
                        var $v_0 = Sys.Net.XMLDOM(request.responseText);
                        this.$5_1 = Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.Faults
                            .OrganizationServiceFault
                            .parseFromXml(Microsoft.Crm.Client.Core.Storage.Common.Xml.XmlNodeFactory.create($v_0));
                    }
                }
            }
        } catch ($v_1) {
            var $v_2 = (!_Script.isNullOrUndefined(error)) ? error : 'Unknown Error';
            this.$g_0 = 'Creating the error response failed for error: \'' +
                $v_2 +
                '\' due to exception: ' +
                $v_1.message;
        }
...
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.Responses.CrmErrorResponse.$22 = function() {
    return new Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.Responses
        .CrmErrorResponse(new XMLHttpRequest(), '', '');
}
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.Responses.CrmErrorResponse.fromErrorCode = function(errorCode) {
    ...
    $v_0.$5_1 = Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.Faults.OrganizationServiceFault
        .fromErrorCode(errorCode);
    return $v_0;
}
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.Responses.CrmErrorResponse
    .fromErrorStatus = function(errorStatus) {
        var $v_0 = Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.Responses.CrmErrorResponse.$22();
        if (!_Script.isNullOrUndefined(errorStatus)) {
            $v_0.$5_1 = Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.Faults.OrganizationServiceFault
                .fromErrorStatus(errorStatus);
        }
        return $v_0;
    }
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.Responses.CrmErrorResponse
    .createFromHtml = function(errorHtml, source) {
        errorHtml = (!_Script.isNullOrUndefined(errorHtml)) ? errorHtml : '';
        var $v_0 = new Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.Responses
            .CrmErrorResponse(new XMLHttpRequest(), '', '', source);
        try {
            if (errorHtml.indexOf('<!DOCTYPE html') > -1) {
                $v_0.$5_1 = Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.Faults.OrganizationServiceFault
                    .parseFromHtml(errorHtml.substr(errorHtml.indexOf('<')));
            } else {
                $v_0.$g_0 = 'Creating the error response from HTML failed due to unexpected format for error: ' +
                    errorHtml;
            }
        } catch ($v_1) {
...
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.Responses.CrmErrorResponse.prototype = {
    ...
    get_responseMessage: function() {
        return (_Script.isNullOrUndefined(this.$5_1) || _Script.isNullOrUndefined(this.$5_1.get_message()))
            ? Microsoft.Crm.Client.Core.Storage.WebService.ServiceErrorResponse.prototype.get_responseMessage.call(this)
            : this.$5_1.get_message();
    }
}
...
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.Responses
    .RetrieveEntityResponse = function(soapResponse, columnSet, relatedEntitiesQuery) {
        Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.Responses.RetrieveEntityResponse
            .initializeBase(this, [soapResponse]);
        if (soapResponse) {
            ...
            this.$0_1 = Xrm.Soap.EntityRecordSerializer
                .loadFromCrmSoap(soapResponse
            ...
            if (!_Script.isNullOrUndefined(this.$0_1)) {
                var $v_0 = (!_Script.isNullOrUndefined(this.$0_1.get_relatedEntities()))
                    ? this.$0_1.get_relatedEntities().get_relatedEntityQueries()
                    : new Array(0);
...
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.Responses
    .RetrieveMetadataChangesResponse = function(soapResponse) {
        Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.Responses.RetrieveMetadataChangesResponse
            .initializeBase(this, [soapResponse]);
        if (soapResponse) {
            this.$K_0 = soapResponse.selectSingleNode('.//d:ExecuteResult/a:ResponseName').get_innerText();
...
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.Responses
    .RetrieveMultipleAttributeMetadataResponse = function(soapResponse) {
        Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.Responses.RetrieveMultipleAttributeMetadataResponse
            .initializeBase(this, [soapResponse]);
        if (soapResponse) {
            soapResponse.addNamespace('c', 'http://schemas.microsoft.com/xrm/2011/Metadata');
            this.$K_0 = soapResponse.selectSingleNode('.//d:ExecuteResult/a:ResponseName').get_innerText();
            var $v_0 = soapResponse
                .selectNodes('.//d:ExecuteResult/a:Results/a:KeyValuePairOfstringanyType/b:value[@i:type=\'a:EntityMetadataCollection\']/a:EntityMetadata/c:Attributes/c:AttributeMetadata');
            this.$L_1 = Xrm.Soap.AttributeMetadataSerializer.$38($v_0);
        } else {
...
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.Responses
    .InstantiatedEmailTemplateResponse = function(soapResponse) {
        if (!_Script.isNullOrUndefined(soapResponse)) {
        ...
        if (!_Script.isNullOrUndefined(value)) {
            ...
            if (!isNaN($v_3)) {
                if ($v_3 < 60) {
                    ...
                    if ($v_3 === 1) {
                        $v_0 = String.localeFormat(Microsoft.Crm.Client.Core.Framework.Common.ResourceManager
                            .getLocalizedString('AppDurationControl_Minute'),
                            $v_1);
                    } else {
                        $v_0 = String.localeFormat(Microsoft.Crm.Client.Core.Framework.Common.ResourceManager
                            .getLocalizedString('AppDurationControl_Minutes'),
                            $v_1);
                    }
                    ...
                    if (Math.abs($v_4 - 1) <= $v_2) {
                        $v_0 = String.localeFormat(Microsoft.Crm.Client.Core.Framework.Common.ResourceManager
                            .getLocalizedString('AppDurationControl_Hour'),
                            $v_1);
                    } else {
                        $v_0 = String.localeFormat(Microsoft.Crm.Client.Core.Framework.Common.ResourceManager
                            .getLocalizedString('AppDurationControl_Hours'),
                            $v_1);
                    }
                } else {
                    var $v_5 = $v_3 / 1440;
                    ...
                    if (Math.abs($v_5 - 1) <= $v_2) {
                        $v_0 = String.localeFormat(Microsoft.Crm.Client.Core.Framework.Common.ResourceManager
                            .getLocalizedString('AppDurationControl_Day'),
                            $v_1);
                    } else {
                        $v_0 = String.localeFormat(Microsoft.Crm.Client.Core.Framework.Common.ResourceManager
                            .getLocalizedString('AppDurationControl_Days'),
                            $v_1);
                    }
                }
            }
...
Microsoft.Crm.Client.Core.Storage.WebService.ICallerOriginProvider
    .registerInterface('Microsoft.Crm.Client.Core.Storage.WebService.ICallerOriginProvider');


Microsoft.Crm.Client.Core.Storage.WebService.ISettings = function() {}
Microsoft.Crm.Client.Core.Storage.WebService.ISettings
    .registerInterface('Microsoft.Crm.Client.Core.Storage.WebService.ISettings');
...
Microsoft.Crm.Client.Core.Storage.WebService.ServiceErrorResponse.prototype = {
    ...
    get_responseMessage: function() {
        if (!_Script.isNullOrUndefined(this.$S_0) &&
            this.$S_0.readyState === 4 &&
            !_Script.isNullOrUndefined(this.get_responseMessage())) {
...
Microsoft.Crm.Client.Core.Storage.WebService
    .WebServiceBase = function(serverUri, authenticationManager, callerOriginProvider) {
...
Microsoft.Crm.Client.Core.Storage.WebService.WebServiceBase.prototype = {
    ...
    createSoapRequestBody: function(soapBody) {
        return '<s:Envelope xmlns:s=\"http://schemas.xmlsoap.org/soap/envelope/\"><s:Header>' +
            this.getSoapHeaders() +
            '</s:Header>' +
            '<s:Body>' +
            soapBody +
    ...
    executeJsonRequest: function(requestData) {
        var $v_0 = Microsoft.Crm.Client.Core.Imported.MscrmComponents
            .deferredPromiseFactory(Object, Microsoft.Crm.Client.Core.Storage.WebService.ServiceErrorResponse);
        ...
        this.$26_0(requestData).then(function($p1_0) {
                ...
                if ($v_2.indexOf('<!DOCTYPE html') > -1) {
                    ...
                    try {
                        ...
                        $v_0.reject($$t_7
                            .createErrorResponseWithSource(new XMLHttpRequest(),
                                '',
                                'Exception when parsing JSON: ' + $v_2 + '\nException: ' + $v_3,
                                $v_1));
                    }
                }
            },
    ...
    executeSoapRequest: function(requestData) {
        var $v_0 = Microsoft.Crm.Client.Core.Imported.MscrmComponents
            .deferredPromiseFactory(Microsoft.Crm.Client.Core.Storage.Common.Xml.XmlNode,
                Microsoft.Crm.Client.Core.Storage.WebService.ServiceErrorResponse);
        var $v_1 = this.get_name() + ' - ' + requestData.name;
        var $$t_5 = this, $$t_6 = this;
        this.$26_0(requestData).then(function($p1_0) {
    ...
    $26_0: function($p0) {
        ...
        var $v_2 = Microsoft.Crm.Client.Core.Imported.MscrmComponents
            .deferredPromiseFactory(Object, Microsoft.Crm.Client.Core.Storage.WebService.ServiceErrorResponse);
        var $v_3 = Microsoft.Crm.Client.Core.Imported.MscrmComponents
            .deferredPromiseFactory(Microsoft.Crm.Client.Core.Storage.WebService.WebServiceBase.ResponseData,
                Microsoft.Crm.Client.Core.Storage.WebService.ServiceErrorResponse);
        var $v_4 = new Microsoft.Crm.Client.Core.Framework.PerformanceStopwatch(this.get_performanceStopwatch());
        $v_4.start();
        var $$t_D;
        ($$t_D = Microsoft.Crm.Client.Core.Storage.WebService.WebServiceBase)
            .set_$2K(Microsoft.Crm.Client.Core.Storage.WebService.WebServiceBase.$19 + 1);
        var $$t_G = this, $$t_H = this, $$t_I = this;
        $v_3.always(function($p1_0) {
            $v_4.stop();
            $$t_G.$3E_0($v_4, $p0, $p1_0);
            var $$t_E;
            ($$t_E = Microsoft.Crm.Client.Core.Storage.WebService.WebServiceBase)
                .set_$2K(Microsoft.Crm.Client.Core.Storage.WebService.WebServiceBase.$19 - 1);
        }).then(function($p1_0) {
    ...
    $p_0: function($p0, $p1, $p2, $p3, $p4, $p5, $p6, $p7) {
        if ($p7 && !_Script.isNullOrUndefined(this.$P_0)) {
            ...
            case 0:
                this.$23_0($p0, $p1, $p2, $p3, $p4, $p5, $p6, $p7);
                return;
            case 2:
        ...
        $v_0.success(function($p1_0) {
            ...
            if ($p1_0.status === 401 && !_Script.isNullOrUndefined($$t_F.$P_0)) {
                if ($p7) {
                    $$t_F.$23_0($p0, $p1, $p2, $p3, $p4, $p5, $p6, $p7);
                ...
                ++$p5;
                $$t_F.$p_0($p0, $p1, $p2, $p3, $p4, $p5, $p6, $p7);
            } else if ($p1_0.status === 500 &&
                $$t_F.canRetryServerError($$t_F.createErrorResponse($p1_0, $p1_1, $p1_2.toString())) &&
                $p6 > 0) {
                ...
                Microsoft.Crm.Client.Core.Framework.DynamicsTrace
                    .logInfo($$t_F.get_name() + '_ExecuteRequestWithRetry_Failure',
                        1005,
                        String.format('Response: {0}, Exception: {1}', $p1_0.responseText, $p1_2.toString()));
    ...
    $23_0: function($p0, $p1, $p2, $p3, $p4, $p5, $p6, $p7) {
    ...
    createJsonRequestOptions: function(endPoint, method) {
        ...
        return Microsoft.Crm.Client.Core.Storage.WebService.WebServiceBase.RequestOptions
            .create(endPoint, method, 'application/json; charset=utf-8', 'text', endPoint, this.get_doAuthentication());
    },
    ...
    createSoapRequestOptions: function(endPoint, soapAction) {
        ...
        $v_0 = 'xml';
        return Microsoft.Crm.Client.Core.Storage.WebService.WebServiceBase.RequestOptions
            .create(endPoint, 'POST', 'text/xml; charset=utf-8', $v_0, soapAction, this.get_doAuthentication());
    },
...
Microsoft.Crm.Client.Core.Storage.WebService.WebServiceBase.RequestOptions
    .create = function($p0, $p1, $p2, $p3, $p4, $p5) {
...
Microsoft.Crm.Client.Core.Framework.DisposableBase
    .registerClass('Microsoft.Crm.Client.Core.Framework.DisposableBase', null, Sys.IDisposable);
Microsoft.Crm.Client.Core.Storage.Common.OfflineState
    .registerClass('Microsoft.Crm.Client.Core.Storage.Common.OfflineState');
Microsoft.Crm.Client.Core.Models.FormModel.registerClass('Microsoft.Crm.Client.Core.Models.FormModel',
    Microsoft.Crm.Client.Core.Framework.DisposableBase,
    Microsoft.Crm.Client.Core.Models.IFormModel,
    Microsoft.Crm.Client.Core.Framework.INotifyPropertyChanged);
Microsoft.Crm.Client.Core.Models.RecordModel.registerClass('Microsoft.Crm.Client.Core.Models.RecordModel',
    Microsoft.Crm.Client.Core.Models.FormModel,
    ...
    Microsoft.Crm.Client.Core.Framework.IRootModel,
    Microsoft.Crm.Client.Core.Framework.INotifyPropertyChanged,
...
Microsoft.Crm.Client.Core.Models.Validation.UrlValidator
    .registerClass('Microsoft.Crm.Client.Core.Models.Validation.UrlValidator',
        Microsoft.Crm.Client.Core.Models.Validation.IsRequiredValidator);
Microsoft.Crm.Client.Core.Storage.DataApi.DataOperationEventArgs
    .registerClass('Microsoft.Crm.Client.Core.Storage.DataApi.DataOperationEventArgs', Sys.EventArgs);
Microsoft.Crm.Client.Core.Storage.DataApi.DataOperationEvents
    .registerClass('Microsoft.Crm.Client.Core.Storage.DataApi.DataOperationEvents');
Microsoft.Crm.Client.Core.Storage.DataApi.RecordUpdateEventArgs
    .registerClass('Microsoft.Crm.Client.Core.Storage.DataApi.RecordUpdateEventArgs', Sys.EventArgs);
Microsoft.Crm.Client.Core.Storage.DataApi.MetadataCache
    .registerClass('Microsoft.Crm.Client.Core.Storage.DataApi.MetadataCache',
        null,
        Microsoft.Crm.Client.Core.Storage.DataApi.IMetadataCache);
Microsoft.Crm.Client.Core.Storage.DataApi.DataSource
    .registerClass('Microsoft.Crm.Client.Core.Storage.DataApi.DataSource',
        null,
        Microsoft.Crm.Client.Core.Storage.DataApi.IDataSource);
Microsoft.Crm.Client.Core.Storage.DataApi.TimeZoneAdjustersResponse
    .registerClass('Microsoft.Crm.Client.Core.Storage.DataApi.TimeZoneAdjustersResponse');
Microsoft.Crm.Client.Core.Storage.WebService.WebServiceBase
    .registerClass('Microsoft.Crm.Client.Core.Storage.WebService.WebServiceBase');
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapService
    .registerClass('Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapService',
        Microsoft.Crm.Client.Core.Storage.WebService.WebServiceBase,
        Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.ICrmSoapService);
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmWebServiceSettings
    .registerClass('Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmWebServiceSettings',
        null,
        Microsoft.Crm.Client.Core.Storage.WebService.ISettings);
Microsoft.Crm.Client.Core.Models.Constants.AttributeSubmitModes
    .registerClass('Microsoft.Crm.Client.Core.Models.Constants.AttributeSubmitModes');
Microsoft.Crm.Client.Core.Models.Formatters.FormFieldFormatter
    .registerClass('Microsoft.Crm.Client.Core.Models.Formatters.FormFieldFormatter');
Microsoft.Crm.Client.Core.Models.Formatters.EntityFormFieldFormatter
    .registerClass('Microsoft.Crm.Client.Core.Models.Formatters.EntityFormFieldFormatter',
        Microsoft.Crm.Client.Core.Models.Formatters.FormFieldFormatter);
...
Xrm.Soap.EntityMetadataCollectionSerializer.AttributeMetadataCollectionSerializerResult
    .registerClass('Xrm.Soap.EntityMetadataCollectionSerializer.AttributeMetadataCollectionSerializerResult');
...
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.GuidArraySerializer
    .registerClass('Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.GuidArraySerializer');
Xrm.Soap.StringArraySerializer.registerClass('Xrm.Soap.StringArraySerializer');
Xrm.Soap.ExecuteMultipleResponseItemCollectionSerializer
    .registerClass('Xrm.Soap.ExecuteMultipleResponseItemCollectionSerializer');
Xrm.Soap.ExecuteMultipleSettingsSerializer.registerClass('Xrm.Soap.ExecuteMultipleSettingsSerializer');
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.LabelSerializer
    .registerClass('Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.LabelSerializer');
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.OptionSetMetadataSerializer
    .registerClass('Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.OptionSetMetadataSerializer');
...
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.RelatedEntityCollectionSerializer
    .registerClass('Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.RelatedEntityCollectionSerializer');
...
Xrm.Soap.SecurityPrivilegeMetadataCollectionSerializer
    .registerClass('Xrm.Soap.SecurityPrivilegeMetadataCollectionSerializer');
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.SerializerUtility
    .registerClass('Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.SerializerUtility');
...
Xrm.Gen.CalculateTotalTimeIncidentRequestSerializer
    .registerClass('Xrm.Gen.CalculateTotalTimeIncidentRequestSerializer');
Xrm.Gen.CalculateTotalTimeIncidentResponseSerializer
    .registerClass('Xrm.Gen.CalculateTotalTimeIncidentResponseSerializer');
...
Xrm.Gen.RetrieveDocumentTemplatesResponseSerializer
    .registerClass('Xrm.Gen.RetrieveDocumentTemplatesResponseSerializer');
...
Xrm.Gen.IntersectRecordsWithQueueAndAggregateRequestSerializer
    .registerClass('Xrm.Gen.IntersectRecordsWithQueueAndAggregateRequestSerializer');
Xrm.Gen.IntersectRecordsWithQueueAndAggregateResponseSerializer
    .registerClass('Xrm.Gen.IntersectRecordsWithQueueAndAggregateResponseSerializer');
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapSerializers.Generated
...
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.JsonResponses.JsonResponse
    .registerClass('Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.JsonResponses.JsonResponse');
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.JsonResponses.JsonResponse.ErrorDataRecord
    .registerClass('Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.JsonResponses.JsonResponse.ErrorDataRecord');
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.JsonResponses.UserContextResponse
    .registerClass('Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.JsonResponses.UserContextResponse',
        Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.JsonResponses.JsonResponse);
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.JsonSerializers.AttributePrivilegeSerializer
    .registerClass('Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.JsonSerializers.AttributePrivilegeSerializer');
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.JsonSerializers.AttributePrivilegeSerializer
    .AttributePrivilegeRecord
    .registerClass('Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.JsonSerializers.AttributePrivilegeSerializer.AttributePrivilegeRecord');
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.JsonSerializers.FeatureDetailsSerializer
    .registerClass('Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.JsonSerializers.FeatureDetailsSerializer');
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.JsonSerializers.FeatureDetailsSerializer.FeatureDetailsRecord
    .registerClass('Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.JsonSerializers.FeatureDetailsSerializer.FeatureDetailsRecord');
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.JsonSerializers.OfflineProfileSerializer
    .registerClass('Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.JsonSerializers.OfflineProfileSerializer');
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.JsonSerializers.OfflineProfileSerializer.OfflineProfileRecord
    .registerClass('Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.JsonSerializers.OfflineProfileSerializer.OfflineProfileRecord');
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.JsonSerializers.OrganizationSettingsSerializer
    .registerClass('Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.JsonSerializers.OrganizationSettingsSerializer');
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.JsonSerializers.OrganizationSettingsSerializer
    .OrganizationSettingsRecord
    .registerClass('Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.JsonSerializers.OrganizationSettingsSerializer.OrganizationSettingsRecord');
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.JsonSerializers.RolePrivilegeSerializer
    .registerClass('Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.JsonSerializers.RolePrivilegeSerializer');
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.JsonSerializers.RolePrivilegeSerializer.RolePrivilegeRecord
    .registerClass('Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.JsonSerializers.RolePrivilegeSerializer.RolePrivilegeRecord');
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.JsonSerializers.ServerContextSerializer
    .registerClass('Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.JsonSerializers.ServerContextSerializer');
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.JsonSerializers.ServerContextSerializer.ServerContextRecord
    .registerClass('Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.JsonSerializers.ServerContextSerializer.ServerContextRecord');
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.JsonSerializers.TimeZoneAdjusterSerializer
    .registerClass('Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.JsonSerializers.TimeZoneAdjusterSerializer');
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.JsonSerializers.TimeZoneAdjusterSerializer.AdjustmentRuleRecord
    .registerClass('Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.JsonSerializers.TimeZoneAdjusterSerializer.AdjustmentRuleRecord');
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.JsonSerializers.TimeZoneAdjusterSerializer
    .TransitionConstraintRecord
    .registerClass('Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.JsonSerializers.TimeZoneAdjusterSerializer.TransitionConstraintRecord');
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.JsonSerializers.TimeZoneAdjusterSerializer.TimeSpanRecord
    .registerClass('Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.JsonSerializers.TimeZoneAdjusterSerializer.TimeSpanRecord');
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.JsonSerializers.TimeZoneDefinitionSerializer
    .registerClass('Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.JsonSerializers.TimeZoneDefinitionSerializer');
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.JsonSerializers.TimeZoneDefinitionSerializer
    .TimeZoneDefinitionRecord
    .registerClass('Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.JsonSerializers.TimeZoneDefinitionSerializer.TimeZoneDefinitionRecord');
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.JsonSerializers.TransactionCurrencySerializer
    .registerClass('Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.JsonSerializers.TransactionCurrencySerializer');
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.JsonSerializers.TransactionCurrencySerializer
    .TransactionCurrencyRecord
    .registerClass('Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.JsonSerializers.TransactionCurrencySerializer.TransactionCurrencyRecord');
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.JsonSerializers.UserContextSerializer
    .registerClass('Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.JsonSerializers.UserContextSerializer');
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.JsonSerializers.UserContextSerializer.UserContextRecord
    .registerClass('Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.JsonSerializers.UserContextSerializer.UserContextRecord');
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.JsonSerializers.UserSettingsSerializer
    .registerClass('Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.JsonSerializers.UserSettingsSerializer');
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.JsonSerializers.UserSettingsSerializer.UserSettingsRecord
    .registerClass('Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.JsonSerializers.UserSettingsSerializer.UserSettingsRecord');
Microsoft.Crm.Client.Core.Storage.WebService.ServiceErrorResponse
    .registerClass('Microsoft.Crm.Client.Core.Storage.WebService.ServiceErrorResponse');
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.Responses.CrmErrorResponse
    .registerClass('Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.Responses.CrmErrorResponse',
        Microsoft.Crm.Client.Core.Storage.WebService.ServiceErrorResponse);
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.Responses.OrganizationResponse
    .registerClass('Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.Responses.OrganizationResponse');
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.Responses.RetrieveEntityResponse
    .registerClass('Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.Responses.RetrieveEntityResponse',
        Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.Responses.OrganizationResponse);
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.Responses.RetrieveMetadataChangesResponse
    .registerClass('Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.Responses.RetrieveMetadataChangesResponse',
        Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.Responses.OrganizationResponse);
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.Responses.RetrieveMultipleAttributeMetadataResponse
    .registerClass('Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.Responses.RetrieveMultipleAttributeMetadataResponse', Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.Responses.OrganizationResponse);
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.Responses.InstantiatedEmailTemplateResponse
    .registerClass('Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.Responses.InstantiatedEmailTemplateResponse');
Microsoft.Crm.Client.Core.Storage.Formatting.CrmNumericFormatter
    .registerClass('Microsoft.Crm.Client.Core.Storage.Formatting.CrmNumericFormatter');
Microsoft.Crm.Client.Core.Storage.WebService.WebServiceBase.RequestData
    .registerClass('Microsoft.Crm.Client.Core.Storage.WebService.WebServiceBase.RequestData');
Microsoft.Crm.Client.Core.Storage.WebService.WebServiceBase.RequestOptions
    .registerClass('Microsoft.Crm.Client.Core.Storage.WebService.WebServiceBase.RequestOptions');
Microsoft.Crm.Client.Core.Storage.WebService.WebServiceBase.ResponseData
    .registerClass('Microsoft.Crm.Client.Core.Storage.WebService.WebServiceBase.ResponseData');
...
Microsoft.Crm.Client.Core.Models.Validation.UrlValidator.$2Q = new RegExp('^\\w+:');
...
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapService
    .xrm2011MetadataNamespace = 'http://schemas.microsoft.com/xrm/2011/Metadata';
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapService
    .xrm2011MetadataQueryNamespace = 'http://schemas.microsoft.com/xrm/2011/Metadata/Query';
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapService
    .xrm2011ContractsNamespace = 'http://schemas.microsoft.com/xrm/2011/Contracts';
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.CrmSoapService
    .crm2011ContractsNamespace = 'http://schemas.microsoft.com/crm/2011/Contracts';
...
Xrm.Soap.Serializer.$2M = { serialize: 'parametersToCrmSoap', deserialize: 'loadFromCrmSoap' };
Xrm.Soap.Serializer.$2N = [Xrm.Soap, Xrm.Gen];
...
Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.JsonResponses.JsonResponse
    .invalidResponseMessage = 'JSON response is null or undefined.';
Microsoft.Crm.Client.Core.Storage.Formatting.CrmNumericFormatter.$Z = null;
Microsoft.Crm.Client.Core.Storage.WebService.WebServiceBase
    .microsoft2003SerializationArraysNamespace = 'http://schemas.microsoft.com/2003/10/Serialization/Arrays';
Microsoft.Crm.Client.Core.Storage.WebService.WebServiceBase
    .genericCollectionsNamespace = 'http://schemas.datacontract.org/2004/07/System.Collections.Generic';
...
Microsoft.Crm.Client.Core.Storage.WebService.WebServiceBase.RequestOptions
    .formSubmitType = 'application/x-www-form-urlencoded';
