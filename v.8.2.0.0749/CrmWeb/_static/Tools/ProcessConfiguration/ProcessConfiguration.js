...
ProcessControl.Configuration.IRelationshipPickerDialogArguments
    .registerInterface('ProcessControl.Configuration.IRelationshipPickerDialogArguments');
...
ProcessControl.Configuration.IExtensibleProcessControlView$2.$$ = function(TChildView, TChildViewModel) {
    var $$cn = 'IExtensibleProcessControlView$2' +
        '$' +
        TChildView.getName().replace(/\./g, '_') +
        '$' +
        TChildViewModel.getName().replace(/\./g, '_');
...
ProcessControl.Configuration.IExtensibleProcessControlView$2
    .registerInterface('ProcessControl.Configuration.IExtensibleProcessControlView$2');
...
ProcessControl.Configuration.IProcessControlViewBase$1
    .registerInterface('ProcessControl.Configuration.IProcessControlViewBase$1');
...
ProcessControl.Configuration.ProcessControlPageView.prototype = {
    ...
    $9B_6: function() {
        ...
        var $v_2 = {};
        var $v_3 = ProcessControl.Configuration.ProcessConfigurationUtility
            .getStepLabelForCurrentUser(this.get_dataContext().get_stepLabels(),
                (this.get_dataContext()).get_pageLayoutId());
        $v_2['value'] = CrmEncodeDecode.CrmHtmlEncode(CrmEncodeDecode.CrmHtmlEncode($v_3.get_description()));
        this._stageNameView = Mscrm.InlineControlFactory
            .createInlineTextBoxControlForDom($v_1, $v_0, 100, $v_2, 'pcc', 'normal');
...
ProcessControl.Configuration.Initializer.initialize = function() {
    ProcessControl.Configuration.Initializer.$9v();
    ProcessConfiguration.Behavior.ExpandCollapseBehavior.setBehavior();
    var $v_0 = new ProcessConfiguration.InitializationContext();
    ProcessControl.Configuration.Initializer.$92($v_0);
    ProcessControl.Configuration.Initializer.$8z($v_0);
    ...
    if ($v_0.get_businessProcessFlowModel().get_workflowBusinessProcessType() === 1) {
        ProcessConfiguration.Behavior.ShowImageUploaderBehavior.get_instance()
            .setBehavior($v_0.get_businessProcessFlowModel().get_workflowEntityId());
    }
    ProcessControl.Configuration.Initializer.$7k();
...
ProcessControl.Configuration.Initializer.$92 = function($p0) {
    ...
    Mscrm.BusinessRules.BusinessRuleInitializer
        .set_readOnly(ProcessControl.Configuration.ProcessConfigurationUtility.isProcessReadonly());
    ...
    if (Mscrm.BusinessRules.BusinessRuleManager.get_instance().get_rootWorkflowStep()
        .get_workflowBusinessProcessType() ===
        1) {
...
ProcessControl.Configuration.Initializer.$8z = function($p0) {
    ...
    var $v_2 = ProcessControl.Configuration.Initializer.$99($p0, $v_1);
    var $v_3 = ProcessControl.Configuration.Initializer.$91($p0);
    var $v_4 = ProcessControl.Configuration.Initializer.$9V($v_3);
    var $v_5 = ProcessControl.Configuration.Initializer.$9P($v_3, $v_0);
    var $v_6 = new Mscrm.Proxies.JQueryProxy();
    var $v_7 = new ProcessConfiguration.Behavior.BehaviorsFactory();
    var $v_8 = ProcessControl.Configuration.Initializer.$9T($v_6, $v_7);
    var $v_9 = ProcessControl.Configuration.Initializer.$98($v_6);
    var $v_A = new Mscrm.Proxies.ImageStripProxy();
    var $v_B = ProcessControl.Configuration.Initializer.$6T($v_6, $v_A);
    var $v_C = ProcessControl.Configuration.Initializer.$93($v_6, $v_B);
    var $v_D = ProcessControl.Configuration.Initializer.$9O($v_6, $v_C, $v_B, $v_9, $p0);
    var $v_E = ProcessControl.Configuration.Initializer.$9J($v_6, $v_C, $v_D, $v_9, $v_B, $v_A, $p0);
    var $v_F = ProcessControl.Configuration.Initializer.$9U($v_6, $v_8, $v_7, $v_D, $v_E);
    var $v_G = $v_4.createProcessConfigurationViewModel($p0, $v_2, $v_5);
    $v_G.initialize();
    var $v_H = $v_F.createProcessConfigurationView($v_G);
    $v_H.initialize();
    ProcessControl.Configuration.Initializer.$9F($v_2, $v_F);
    ...
    ProcessConfiguration.Behavior.ConfiguratorUnloadBehavior
        .setUnloadBehavior($v_I, window.LOCID_PROCESS_UNSAVED_MESSAGE);
...
ProcessControl.Configuration.Initializer.$9F = function($p0, $p1) {
...
ProcessControl.Configuration.Initializer.$6T = function($p0, $p1) {
    var $v_0 = new ProcessConfiguration.Builder.ImageBuilder();
    $v_0.set_imageStripProxy($p1);
    $v_0.set_jQueryProxy($p0);
    return $v_0;
}
ProcessControl.Configuration.Initializer.$98 = function($p0) {
    var $v_0 = new ProcessConfiguration.Builder.InlineEditControlBuilder();
    $v_0.set_jQueryProxy($p0);
    return $v_0;
}
ProcessControl.Configuration.Initializer.$9O = function($p0, $p1, $p2, $p3, $p4) {
    var $v_0 = ProcessConfiguration.Builder.StepBuilder
        .createStepBuilder($p4.get_businessProcessFlowModel().get_workflowBusinessProcessType());
...
ProcessControl.Configuration.Initializer.$93 = function($p0, $p1) {
    var $v_0 = new ProcessConfiguration.Builder.ButtonBuilder();
    $v_0.set_jQueryProxy($p0);
    $v_0.set_imageBuilder($p1);
    return $v_0;
}
ProcessControl.Configuration.Initializer.$9J = function($p0, $p1, $p2, $p3, $p4, $p5, $p6) {
    var $v_0 = ProcessConfiguration.Builder.StageBuilder
        .createBuilder($p6.get_businessProcessFlowModel().get_workflowBusinessProcessType());
...
ProcessControl.Configuration.Initializer.$9U = function($p0, $p1, $p2, $p3, $p4) {
...
ProcessControl.Configuration.Initializer.$9T = function($p0, $p1) {
    var $v_0 = new ProcessConfiguration.View.ViewAdapterFactory();
    $v_0.set_jQueryProxy($p0);
    $v_0.set_behaviorsFactory($p1);
    return $v_0;
}
ProcessControl.Configuration.Initializer.$9P = function($p0, $p1) {
...
ProcessControl.Configuration.Initializer.$9V = function($p0) {
...
ProcessControl.Configuration.Initializer.$9v = function() {
    ...
    ProcessControl.Configuration.Initializer.$79();
    ProcessControl.Configuration.Initializer.$7A();
    ProcessControl.Configuration.Initializer.$88();
}
ProcessControl.Configuration.Initializer.$88 = function() {
...
ProcessControl.Configuration.Initializer.$7A = function() {
    ...
    var $v_5 = String.format(ProcessControl.Configuration.HtmlTemplate.$6d, $v_4, $v_3);
    var $v_6 = $P_CRM($v_5);
    $v_6.insertAfter($v_2);
}
ProcessControl.Configuration.Initializer.$79 = function() {
    var $v_0 = $P_CRM('.tabLink');
    $v_0.each(ProcessControl.Configuration.Initializer.$9W);
}
ProcessControl.Configuration.Initializer.$9W = function($p0, $p1) {
    if ($p0 >= 4 || IsNull($p1)) {
        return false;
    }
    var $v_0 = $P_CRM($p1);
    var $v_1 = String.format('breadcrumb_{0}', $p0);
    var $v_2 = String.format(ProcessControl.Configuration.HtmlTemplate.$5s, $v_1);
    var $v_3 = $P_CRM($v_2);
    $v_3.insertAfter($v_0);
...
ProcessControl.Configuration.Initializer.dispose = function() {
    ...
    ProcessControl.Configuration.Initializer.$80();
}
...
ProcessControl.Configuration.Initializer.$80 = function() {
    var $v_0 = $find('pcc');
    if (!IsNull($v_0)) {
        $v_0.dispose();
    }
...
ProcessControl.Configuration.RelationshipPickerDialogInitializer.initialize = function() {
    ...
    var $v_7 = ProcessControl.Configuration.RelationshipPickerDialogInitializer.$6T($v_3, $v_4);
    ProcessControl.Configuration.RelationshipPickerDialogInitializer.$4t = $v_1
        .createRelationshipPickerView(ProcessControl.Configuration.RelationshipPickerDialogInitializer.$12, $v_6, $v_7);
    ProcessControl.Configuration.RelationshipPickerDialogInitializer.$4t.initialize();
}
ProcessControl.Configuration.RelationshipPickerDialogInitializer.applyChanges = function() {
    return ProcessControl.Configuration.RelationshipPickerDialogInitializer.$4t.getRelationshipModelList().toArray();
}
ProcessControl.Configuration.RelationshipPickerDialogInitializer.$6T = function($p0, $p1) {
    var $v_0 = new ProcessConfiguration.Builder.ImageBuilder();
    $v_0.set_imageStripProxy($p1);
    $v_0.set_jQueryProxy($p0);
    return $v_0;
...
ProcessControl.Configuration.HtmlTemplate.$62 = function($p0, $p1) {
...
ProcessControl.Configuration.AddBranchConditionBehavior.prototype = {
    ...
    initialize: function() {
        this.$1n_3 = $P_CRM(this.get_element()).children(':first-child');
    ...
    $77_4: function($p0) {
        if (!ProcessControl.Configuration.ProcessConfigurationUtility.isProcessReadonly()) {
            this.$4u_4 = this.$4u_4 + 1;
            var $v_0 = new ProcessControl.Configuration.ConditionBuilder(this.$2D_4.get_workflowBusinessProcessType());
            $v_0.set_jQueryProxy(this.$8_4);
            $v_0.set_buttonBuilder(this.$M_4.get_stageBuilder().get_buttonBuilder());
            var $v_1 = !!this.$1Y_4.get_conditionView();
            if ($v_1) {
                this.$7C_4($v_0);
            } else {
                this.$7D_4($v_0);
                this.$1Y_4.toggleInsertStageButtonViewLabel();
            }
        }
    },

    $7D_4: function($p0) {
        var $v_0 = this.$32_4.createNewConditionModel(this.$2D_4, this.$d_4.get_stageModel().get_stageStep());
        ...
        $v_2.append($v_5);
        this.$1Y_4.get_element().after($v_2);
        var $v_6 = this.$M_4.createConditionView($v_2, $v_1);
        $v_6.initialize();
        $v_6.set_parent(this.$1Y_4);
        this.$1Y_4.set_conditionView($v_6);
        ($v_6.get_children().get_item(0)).get_conditionsSectionsView().addNewExpressions(null);
    },

    $7C_4: function($p0) {
        var $v_0 = this.$1Y_4.get_conditionView();
        var $v_1 = $v_0.get_dataContext();
        var $v_2 = $v_1.get_conditionModel();
        var $v_3 = this.$32_4.createNewConditionBranchModel(this.$2D_4, $v_2);
        var $v_4 = $v_3.get_conditionBranchStep().get_Id();
        var $v_5 = $p0.buildConditionBranchElement($v_4);
        ...
        $v_8.initialize();
        var $$t_A = $v_0;
        $v_8.get_conditionsSectionsView()
            .set_deleteHandler(($$t_A.$$d_deleteConditionBranchHandler ||
            ($$t_A.$$d_deleteConditionBranchHandler = Function
                .createDelegate($$t_A, $$t_A.deleteConditionBranchHandler))));
...
ProcessControl.Configuration.AddChildControlBehavior = function(element) {
    this.$$d_$9a_3 = Function.createDelegate(this, this.$9a_3);
...
ProcessControl.Configuration.AddChildControlBehavior.prototype = {
    initialize: function() {
        ...
        if (!IsNull(this.$Q_3)) {
            ...
            this.$Q_3.bind('keydown', this.$$d_$9a_3);
        }
    },
    ...
    enableDisableAddIcon: function(enable, message) {
        if (!enable) {
            this.$18_3 = false;
            this.$Q_3.attr('src', this.get_$5R_3().source);
            this.$Q_3.removeClass(this.get_enabledIconInfo().cssClass);
            this.$Q_3.addClass(this.get_$5R_3().cssClass);
        } else {
            this.$18_3 = true;
            this.$Q_3.attr('src', this.get_enabledIconInfo().source);
            this.$Q_3.removeClass(this.get_$5R_3().cssClass);
    ...
    get_enabledIconInfo: function() {
        if (IsNull(this.$3s_3)) {
            this.$3s_3 = Mscrm.ImageStrip.getImageInfo(Mscrm.CrmUri
                .create(window.CDNURL + '/_imgs/processcontrol/21_orangeplus.png'));
        }
        return this.$3s_3;
    },
    ...
    get_$5R_3: function() {
        if (IsNull(this.$3o_3)) {
            this.$3o_3 = Mscrm.ImageStrip.getImageInfo(Mscrm.CrmUri
                .create(window.CDNURL + '/_imgs/processcontrol/21_inactiveplus.png'));
        }
        return this.$3o_3;
    },
    ...
    dispose: function() {
        ...
        if (!IsNull(this.$1n_3)) {
            this.$1n_3.unbind('click');
            this.$1n_3.unbind('keydown');
        }
...
ProcessControl.Configuration.AddStageBehavior.prototype = {
    initialize: function() {
        ...
        ProcessControl.Configuration.AddChildControlBehavior.prototype.initialize.call(this);
        (this.$F_3).get_dataContext().get_Steps().add_stepCollectionChanged(this.$$d_$7l_4);
        this.$3S_4();
    },

    $7l_4: function($p0, $p1) {
        if (IsNull(this.$F_3) ||
            IsNull((this.$F_3).get_dataContext()) ||
            IsNull((this.$F_3).get_dataContext().get_Steps())) {
            return;
        }
        this.$3S_4();
    },
    ...
    $9Y_4: function() {
        ...
        var $v_0 = ProcessControl.Configuration.AddChildControlBehavior.prototype.isChildControlMaxLimitReached
            .call(this, (this.$F_3).get_dataContext().get_Steps().get_Count(), 30);
        if ($v_0) {
            Mscrm.MetricsReporting.instance().addMetric('Sales Process Configurator',
                'Stage max limit reached for ' + (this.$F_3).get_dataContext().get_EntityLogicalName());
        }
        return $v_0;
    },
    ...
    addChild: function(eventObject) {
        ...
        var $v_0 = ProcessControl.Configuration.ProcessConfigurationUtility
            .createEmptyStageData((this.$F_3).get_dataContext().get_parent());
    ...
    dispose: function() {
        ...
        if ((this.$F_3).get_dataContext() && (this.$F_3).get_dataContext().get_Steps()) {
            (this.$F_3).get_dataContext().get_Steps().remove_stepCollectionChanged(this.$$d_$7l_4);
        }
        ProcessControl.Configuration.AddChildControlBehavior.prototype.dispose.call(this);
    }
}
...
ProcessControl.Configuration.AddStepBehavior = function(element) {
    this.$$d_$8i_4 = Function.createDelegate(this, this.$8i_4);
    this.$$d_$AH_4 = Function.createDelegate(this, this.$AH_4);
    ...
    this.$$d_$8l_4 = Function.createDelegate(this, this.$8l_4);
    this.$$d_$4n_4 = Function.createDelegate(this, this.$4n_4);
    this.$$d_$8o_4 = Function.createDelegate(this, this.$8o_4);
    this.$$d_$5q_4 = Function.createDelegate(this, this.$5q_4);
    this.$$d_$AS_4 = Function.createDelegate(this, this.$AS_4);
    this.$$d_$8x_4 = Function.createDelegate(this, this.$8x_4);
    this.$$d_$AG_4 = Function.createDelegate(this, this.$AG_4);
    this.$$d_$7I_4 = Function.createDelegate(this, this.$7I_4);
...
ProcessControl.Configuration.AddStepBehavior.prototype = {
    initialize: function() {
        this.$3q_4 = $P_CRM(this.get_element());
        this.$Q_3 = $P_CRM('#' + String.format('{0}_plusimg', this.get_element().id));
        if (ProcessControl.Configuration.ProcessConfigurationUtility.isProcessReadonly()) {
            this.$Q_3.hide();
        }
        $addHandler(this.$Q_3.parents('.ui-dialog-content').get(0), 'keydown', this.$$d_$7I_4);
        ProcessControl.Configuration.AddChildControlBehavior.prototype.initialize.call(this);
        ProcessControl.Configuration.ProcessEventAggregator.get_instance().subscribe('stageselected', this.$$d_$AG_4);
        this.$3S_4();
    },
    ...
    $72_4: function() {
        ...
        this.$2A_4.parents('span').first().unbind();
    ...
    $7O_4: function() {
        ...
        this.$u_4.find('li').focus(this.$$d_$8x_4).mouseover(this.$$d_$8x_4).mouseleave(this.$$d_$AS_4)
            .click(this.$$d_$5q_4).keydown(this.$$d_$8o_4);
        this.$2A_4 = $P_CRM('#' + String.format('{0}_arrowimg', this.get_element().id));
        this.$2A_4.parents('span').first().click(this.$$d_$4n_4).keydown(this.$$d_$8l_4);
        this.$v_4 = this.$Q_3.parents().first();
        this.$i_4 = this.$2A_4.parents().first();
        this.$v_4.mouseenter(this.$$d_$8q_4);
        this.$v_4.mouseleave(this.$$d_$8r_4);
        (this.$v_4).focusin(this.$$d_$8q_4);
        (this.$v_4).focusout(this.$$d_$8r_4);
        this.$3q_4.mouseleave(this.$$d_$8p_4);
        this.$i_4.mouseenter(this.$$d_$8m_4);
        this.$i_4.mouseleave(this.$$d_$8n_4);
        (this.$i_4).focusin(this.$$d_$8m_4);
        (this.$i_4).focusout(this.$$d_$8n_4);
        this.$3M_4 = true;
    },
    ...
    $AF_4: function() {
        ...
        this.$41_4 = this.$u_4.find($v_1).css('display', '').size() > 0;
    },
    ...
    $AG_4: function($p0, $p1) {
        ...
        this.$1w_4 = ProcessConfiguration.Behavior.StageFocusBehavior.$6;
        this.$1w_4.get_dataContext().get_Steps().add_stepCollectionChanged(this.$$d_$AH_4);
        this.$3S_4();
    },
    ...
    $AH_4: function($p0, $p1) {
        ...
        if (IsNull(this.$1w_4) ||
            IsNull(this.$1w_4.get_dataContext()) ||
            IsNull(this.$1w_4.get_dataContext().get_Steps())) {
            return;
        }
        this.$3S_4();
    },
    ...
    $9Z_4: function() {
        ...
        var $v_1 = ProcessControl.Configuration.AddChildControlBehavior.prototype.isChildControlMaxLimitReached
            .call(this, $v_0.get_dataContext().get_Steps().get_Count(), 30);
        if ($v_1) {
            Mscrm.MetricsReporting.instance().addMetric('Sales Process Configurator',
                'Step max limit reached for ' + (this.$F_3).get_dataContext().get_EntityLogicalName());
        }
        return $v_1;
    },
    ...
    $2x_4: function() {
        if (IsNull(ProcessConfiguration.Behavior.StageFocusBehavior.$6) ||
            ProcessConfiguration.Behavior.StageFocusBehavior.$6.$s_5 !== this.$F_3) {
            return false;
        }
        return true;
    },
    ...
    addChild: function(eventObject) {
        ...
        var $v_0 = ProcessControl.Configuration.ProcessConfigurationUtility
            .createEmptyStepData((this.$F_3).get_dataContext().get_parent());
    ...
    $5q_4: function($p0) {
        ...
        var $v_3 = (ProcessConfiguration.Behavior.StageFocusBehavior.$6.get_dataContext().get_parent())
        ...
        ProcessControl.Configuration.ProcessConfigurationUtility
            .refreshAvailableSystemControls(ProcessConfiguration.Behavior.StageFocusBehavior.$6.$s_5.get_parent());
    },
    ...
    $4n_4: function($p0) {
        ...
        if (!this.$5L_4) {
            $P_CRM('body').bind('click', this.$$d_$8i_4);
            this.$5L_4 = true;
        }
        if (this.$2I_4) {
            this.$6P_4();
            ...
            if (!this.$54_4) {
                ...
                var $v_1 = Number.parseInvariant(this.$v_4.css('margin-left').replace('px', '')) +
                    Number.parseInvariant(this.$v_4.css('margin-right').replace('px', ''));
    ...
    $7I_4: function($p0) {
        ...
        if (!this.$2I_4 && this.$41_4 && this.$v_4.is(':visible') && $p0.keyCode === 77 && $p0.altKey && $p0.shiftKey) {
            $p0.stopPropagation();
            this.$5i_4();
            this.$2A_4.click();
            return;
    ...
    $8x_4: function($p0) {
        $P_CRM($p0.currentTarget).siblings().removeClass('pc_en_colh_ss_hover')
            .addClass('pc_en_colh_ss_menu_li_normal');
    ...
    dispose: function() {
        ...
        $P_CRM('body').unbind('click', this.$$d_$8i_4);
        $removeHandler(this.$Q_3.parents('.ui-dialog-content').get(0), 'keydown', this.$$d_$7I_4);
        this.$72_4();
        ProcessControl.Configuration.ProcessEventAggregator.get_instance().unsubscribe('stageselected', this.$$d_$AG_4);
        ProcessControl.Configuration.AddChildControlBehavior.prototype.dispose.call(this);
    },
    ...
    $AN_4: function() {
        ...
        try {
            this.$1w_4.get_dataContext().get_Steps().remove_stepCollectionChanged(this.$$d_$AH_4);
        } catch ($$e_0) {
        }
    },
...
ProcessControl.Configuration.ConditionBuilder = function(businessProcessType) {
    this.$4v_0 = new Mscrm.BusinessRules.Builders.ConditionBranchStepSectionViewViewBuilder(null, null);
    this.$5O_0 = businessProcessType;
}
ProcessControl.Configuration.ConditionBuilder.prototype = {
    ...
    $7P_0: function($p0) {
        ...
        var $v_1 = this.$4v_0.buildConditionHtmlForBranching($p0, '');
        var $v_2 = this.$8_0.fromHtml($v_1);
        var $v_3 = $v_2.find('.sectionbody');
        var $v_4 = this.$8Y_0();
        var $v_5 = this.$k_0.build($v_4, 'add-stage', '/_imgs/processcontrol/grey_plus_16.png', $v_4, $v_4)
            .addClass('conditions');
        $v_3.append($v_5);
        $v_0.append($v_2);
        return $v_0;
...
ProcessControl.Configuration.ProcessEventAggregator.get_instance = function() {
    if (IsNull(ProcessControl.Configuration.ProcessEventAggregator.$3v)) {
        ProcessControl.Configuration.ProcessEventAggregator.$3v = $find('pcc_event');
    }
    return ProcessControl.Configuration.ProcessEventAggregator.$3v;
}
...
ProcessControl.Configuration.BpfMenuActions.openProcessRoleAssignment = function(eventData) {
    ...
    ProcessControl.Configuration.BpfMenuActions.$3Y($v_0);
}
ProcessControl.Configuration.BpfMenuActions.openProcessOrder = function(eventData) {
    if (!ProcessControl.Configuration.BpfMenuActions.$Z(eventData)) {
        return;
    }
    var $v_0 = '/tools/dialogs/componentorder.aspx?etn=' +
        CrmEncodeDecode.CrmUrlEncode(ProcessControl.Configuration.BpfMenuActions.$R.get_dataContext()
            .get_primaryEntityName());
    ProcessControl.Configuration.BpfMenuActions.$3Y($v_0);
}
...
ProcessControl.Configuration.BpfMenuActions.openBusinessRules = function(eventData) {
    ...
    $v_0.get_query()['entityId'] = (ProcessControl.Configuration.BpfMenuActions.$R.get_entityMetadata()[ProcessControl
        .Configuration.BpfMenuActions.$R.get_dataContext().get_primaryEntityName()])['EntityMetadataId'];
...
ProcessControl.Configuration.BpfMenuActions.openVisualizeProcess = function(eventData) {
    ...
    openStdWin($v_0,
        'VisualizeProcess',
        ProcessControl.Configuration.BpfMenuActions.$5g,
        ProcessControl.Configuration.BpfMenuActions.$5f,
        null);
}
ProcessControl.Configuration.BpfMenuActions.bindMenuActions = function() {
    ...
    ProcessControl.Configuration.BpfMenuActions.$X('#_MBSaveAs',
        ProcessControl.Configuration.BpfMenuActions.saveProcessAs);
    ProcessControl.Configuration.BpfMenuActions.$X('#_MBActivate',
        ProcessControl.Configuration.BpfMenuActions.activateBusinessProcessFlow);
    ProcessControl.Configuration.BpfMenuActions.$X('#_MBDeactivate',
        ProcessControl.Configuration.BpfMenuActions.deactivateBusinessProcessFlow);
    ProcessControl.Configuration.BpfMenuActions.$X('#_MBDelete',
        ProcessControl.Configuration.BpfMenuActions.deleteBusinessProcessFlow);
    ProcessControl.Configuration.BpfMenuActions.$X('#_MBOrder',
        ProcessControl.Configuration.BpfMenuActions.openProcessOrder);
    ProcessControl.Configuration.BpfMenuActions.$X('#_MBRoleAssignment',
        ProcessControl.Configuration.BpfMenuActions.openProcessRoleAssignment);
    ProcessControl.Configuration.BpfMenuActions.$X('#_MBDependencies',
        ProcessControl.Configuration.BpfMenuActions.showBusinessProcessFlowDependencies);
    ProcessControl.Configuration.BpfMenuActions.$X('#_MBVisualizeProcess',
        ProcessControl.Configuration.BpfMenuActions.openVisualizeProcess);
    ProcessControl.Configuration.BpfMenuActions.$X('#_MBBusinessRules',
        ProcessControl.Configuration.BpfMenuActions.openBusinessRules);
    ProcessControl.Configuration.BpfMenuActions.$4V('#ProcessName',
        ProcessControl.Configuration.BpfMenuActions.$R.$$d_titleOrDescriptionChanged);
    ProcessControl.Configuration.BpfMenuActions.$4V('#Description',
        ProcessControl.Configuration.BpfMenuActions.$R.$$d_titleOrDescriptionChanged);
    var $v_0 = {};
    $v_0['Action'] = 'Shortcut';
    $P_CRM(window).bind('keydown', $v_0, ProcessControl.Configuration.BpfMenuActions.$6W);
}
ProcessControl.Configuration.BpfMenuActions.$6W = function($p0) {
...
ProcessControl.Configuration.BpfMenuActions.$3Y = function($p0) {
...
ProcessControl.Configuration.BpfMenuActions.$4V = function($p0, $p1) {
    var $v_0 = $P_CRM($p0);
    $v_0.bind('change', $p1);
}
...
ProcessControl.Configuration.BpfDataUtility
    .executeConfiguratorActionCommand = function(serializedData, action, callback, errorHandler) {
...
ProcessControl.Configuration.BPFClientProxy.getEntityAndRelationshipMetadata = function(entityLogicalName, callback) {
    if (!ProcessControl.Configuration.BPFClientProxy.$2o) {
        ProcessControl.Configuration.BPFClientProxy.initializeClientProxy();
    }
    var $v_0 = ProcessControl.Configuration.BPFClientProxy.$1Q
        .retrieveEntityAndRelationshipMetadataAsync(entityLogicalName);
    $v_0.done(function() {
        var $v_1 = ProcessControl.Configuration.BPFClientProxy.$1Q.$2T_0[entityLogicalName];
        callback($v_1);
    });
}
ProcessControl.Configuration.BPFClientProxy.getStepAttributeListMetadata = function(entityLogicalName, callback) {
    ...
    var $v_0 = ProcessControl.Configuration.BPFClientProxy.$1Q.retrieveEntityMetadataAsync(entityLogicalName);
    $v_0.done(function() {
        callback(ProcessControl.Configuration.BPFClientProxy.$1Q.$E_0[entityLogicalName]);
    });
}
ProcessControl.Configuration.BPFClientProxy.getSystemControlAttributeMetadataModel = function(entityLogicalName) {
    var $v_0 = ProcessControl.Configuration.BPFClientProxy.$1Q.retrieveEntityMetadataSync(entityLogicalName);
...
ProcessControl.Configuration.BPFClientProxy.getLoadedRelationshipEntityMetadata = function() {
    if (!ProcessControl.Configuration.BPFClientProxy.$4X) {
        ProcessControl.Configuration.BPFClientProxy.$4X = $P_CRM
            .parseJSON(window._BusinessRuleEditorJsonData.substr(8));
    }
    return ProcessControl.Configuration.BPFClientProxy.$4X.RelatedLinkedEntities;
}
...
ProcessControl.Configuration.BPFClientProxy.initializeClientProxy = function() {
    ProcessControl.Configuration.BPFClientProxy.$1Q = new ProcessConfiguration.Services.MetadataService();
    var $v_0 = new ProcessConfiguration.Models.SystemControlMetadataModel();
    var $v_1 = ProcessControl.Configuration.Initializer.initializeMetadataModelFactory($v_0);
    ProcessControl.Configuration.BPFClientProxy.$1Q.$Y_0 = $v_1;
    ProcessControl.Configuration.BPFClientProxy.$1Q.initialize(ProcessControl.Configuration.BPFClientProxy.$4k);
    ProcessControl.Configuration.ProcessDesignerMenuActions.bindMenuActions();
    ProcessControl.Configuration.BPFClientProxy.$2o = true;
}
ProcessControl.Configuration.BPFClientProxy.getEntityMetadata = function(entityLogicalName, callback) {
    ...
    var $v_0 = ProcessControl.Configuration.BPFClientProxy.$1Q.retrieveEntityMetadataAsync(entityLogicalName);
    $v_0.done(function() {
        var $v_1 = ProcessControl.Configuration.BPFClientProxy.$1Q.$E_0[entityLogicalName];
        callback($v_1);
    });
}
ProcessControl.Configuration.BPFClientProxy
    .launchLookupDialog = function(entityLogicalName, attributeLogicalName, callback) {
        ...
        var $v_5 = '/_controls/lookup/lookupinfo.aspx?DefaultType=' +
            $v_3 +
            '&IsInlineMultiLookup=0&LookupStyle=single&ShowNewButton=1&ShowPropButton=1&browse=false&dType=1&mrsh=false&objecttypes=' +
            $v_4;
        var $v_6 = Mscrm.CrmUri.create($v_5);
...
ProcessControl.Configuration.BPFClientProxy.launchWorkflowLookupDialog = function(callback) {
    window.TabSessionId = Mscrm.Utilities.createGuid();
    window.NavigationCounter = 0;
    var $v_0 =
        '/_controls/lookup/lookupinfo.aspx?DefaultType=4703&DefaultViewId=45102185-B1B4-422b-A3BF-F1BA9C6E130A&IsInlineMultiLookup=0&LookupStyle=single&ShowNewButton=1&ShowPropButton=1&browse=true&dType=1&mrsh=false&objecttypes=4703';
...
ProcessControl.Configuration.BPFClientProxy.launchWorkflowNewDialog = function() {
    ...
    var $v_1 = Mscrm.CrmUri.create($v_0 + 'workflowTemplate/workflowTemplatePage.aspx');
    var $v_2 = getWindowInformation(4703);
    var $v_3 = $v_2['windowInfo'];
    var $v_4 = '1472468033315';
    var $v_5 = Mscrm.CrmUri.create($v_0 + 'edit.aspx');
    var $v_6 = null;
    var $v_7 = null;
...
ProcessControl.Configuration.BPFClientProxy
    .createInlineDateTimeControl = function(element, attributeName, initialDateTime, parentContainerId, isDateOnly) {
        var $v_0;
        if (isDateOnly) {
            $v_0 = 'date';
        } else {
        ...
        var $v_1 = {};
        $v_1['raw'] = (IsNull(initialDateTime))
            ? null
            : (ProcessControl.Configuration.BPFClientProxy.convertToUserSettingTime(initialDateTime, isDateOnly))
            .localeFormat('s');
        return Mscrm.InlineControlFactory
            .createInlineDateTimeControlForDom(element, attributeName, $v_0, 1, $v_1, parentContainerId);
    }
ProcessControl.Configuration.BPFClientProxy.updateDateTimeControl = function(dateTimeControlEditView) {
    dateTimeControlEditView.get_dataContext()
        .setPropertyWithoutRaisingEvent('EditValue', dateTimeControlEditView.get_editElementValue());
...
ProcessControl.Configuration.BPFClientProxy.getUserSettingTime = function(value, isDateOnly) {
    ...
    if (isDateOnly) {
        ...
        var $v_2 = $v_0.getTime();
        var $v_3 = ProcessControl.Configuration.BPFClientProxy.$6L($v_0);
...
ProcessControl.Configuration.BPFClientProxy.convertToUserSettingTime = function(dateTimeValue, isDateOnly) {
    ...
    if (isDateOnly) {
        ...
        var $v_1 = ProcessControl.Configuration.BPFClientProxy.$6L(dateTimeValue);
...
ProcessControl.Configuration.BPFClientProxy.$6L = function($p0) {
...
ProcessControl.Configuration.BPFClientProxy.getFormId = function() {
    return ProcessControl.Configuration.BPFClientProxy.$4k.get_businessProcessFlowModel().get_formId();
}
ProcessControl.Configuration.BPFClientProxy.getStageCategoryMetadata = function() {
    return ProcessControl.Configuration.BPFClientProxy.$4k.get_stageCategoryMetadata();
}
...
ProcessControl.Configuration.ProcessDesignerMenuActions.saveProcess = function(eventData) {
    ...
    if ($v_0) {
        var $v_2 = isTaskFlow;
        if ($v_2) {
            MscrmControls.ProcessDesigner.TBXDesignerControl.validationMode = GenericWorkflowDesigner.ValidationMode
                .Error;
        } else {
            MscrmControls.ProcessDesigner.ProcessDesignerControl.validationMode = GenericWorkflowDesigner.ValidationMode
                .Error;
        }
        MscrmControls.ProcessDesigner.Validation.Engine
            .setAction(MscrmControls.ProcessDesigner.Validation.Level.Activate);
    } else {
        MscrmControls.ProcessDesigner.Validation.Engine.setAction(MscrmControls.ProcessDesigner.Validation.Level.Save);
    }
    var $v_1 = MscrmControls.ProcessDesigner.ValidateBPF.validate();
    if (!$v_1) {
        return;
    }
    if (window._OverwriteOnSave) {
        var $v_3 = new Xrm.ConfirmDialogStrings();
        $v_3.title = Xrm.Internal.getResourceString('ProcessControl.Configurator.OverwriteWarning.Title');
        $v_3.text = Xrm.Internal.getResourceString('ProcessControl.Configurator.OverwriteWarning');
        $v_3.confirmButtonLabel = Xrm.Internal.getResourceString('Button_Label_OK');
        $v_3.cancelButtonLabel = Xrm.Internal.getResourceString('Button_Label_Cancel');
        var $v_4 = new Xrm.DialogOptions();
        $v_4.height = 250;
        $v_4.width = 550;
        Xrm.Dialog.openConfirmDialog($v_3,
            $v_4,
            function() {
                window._OverwriteOnSave = false;
                ProcessControl.Configuration.ProcessConfigurationUtility.resetFocusOnActiveControl();
                ProcessControl.Configuration.ProcessDesignerMenuActions.$4q(null);
            },
            function() {
                ProcessControl.Configuration.ProcessConfigurationUtility.resetFocusOnActiveControl();
                return;
...
ProcessControl.Configuration.ProcessDesignerMenuActions.get_$2O = function() {
    if (IsNull(ProcessControl.Configuration.ProcessDesignerMenuActions.$1u)) {
        ProcessControl.Configuration.ProcessDesignerMenuActions.$1u = new Mscrm.ProgressControl();
    }
    return ProcessControl.Configuration.ProcessDesignerMenuActions.$1u;
}
ProcessControl.Configuration.ProcessDesignerMenuActions.$4q = function($p0) {
    if (ProcessControl.Configuration.ProcessDesignerMenuActions.$1k) {
    ...
    ProcessControl.Configuration.ProcessDesignerMenuActions.$4o('UpdateProcess',
        function($p1_0, $p1_1) {
            ProcessControl.Configuration.ProcessDesignerMenuActions.get_$2O().hide();
            ProcessControl.Configuration.ProcessDesignerMenuActions.$6m($p1_0, $p1_1);
            if (!IsNull($p0)) {
                $p0($p1_0, $p1_1);
            }
        });
...
ProcessControl.Configuration.ProcessDesignerMenuActions.saveProcessAs = function(eventData) {
    ...
    ProcessControl.Configuration.ProcessConfigurationUtility.resetFocusOnActiveControl();
    ProcessControl.Configuration.ProcessDesignerMenuActions.$A4();
}
ProcessControl.Configuration.ProcessDesignerMenuActions.$A4 = function() {
    ProcessControl.Configuration.ProcessDesignerMenuActions
        .$4o('SaveAsBpf', ProcessControl.Configuration.ProcessDesignerMenuActions.$6l);
}
ProcessControl.Configuration.ProcessDesignerMenuActions.$5V = function($p0, $p1) {
    window.top.opener.AppDesignerCallback($p0, 'BPC', null, $p1);;
}
ProcessControl.Configuration.ProcessDesignerMenuActions.$6l = function($p0, $p1) {
    ProcessControl.Configuration.ProcessDesignerMenuActions.get_$2O().hide();
    ...
    if (!isNullOrEmptyString($p0.ReturnValue) && $v_0.indexOf('_error') < 0) {
        ...
        if (ProcessControl.Configuration.ProcessDesignerMenuActions.$5l()) {
            var $v_2 = new Mscrm.AppDesignerResult();
            if (!isNullOrEmptyString($v_1)) {
                $v_2.id = $v_1.toLowerCase();
                ProcessControl.Configuration.ProcessDesignerMenuActions.$5V($v_2, false);
                return;
            }
        }
        ProcessControl.Configuration.ProcessDesignerMenuActions.$4p();
        Mscrm.BpfConfiguratorUtils.launchConfigurator($v_1);
    } else {
        var $v_3 = ProcessControl.Configuration.ProcessDesignerMenuActions.$4f($p0);
        if (!IsNull($v_3)) {
...
ProcessControl.Configuration.ProcessDesignerMenuActions.$4o = function($p0, $p1) {
    ...
    if (!isNullOrEmptyString($v_0)) {
        ProcessControl.Configuration.ProcessDesignerMenuActions.get_$2O().forceShow();
        ProcessControl.Configuration.BpfDataUtility
            .executeConfiguratorActionCommand($v_0,
                $p0,
                $p1,
                Mscrm.RemoteCommandXml.remoteCommandXmlDefaultErrorHandler);
    }
}
    ...
    if ($p0.Success) {
        ...
        if (ProcessControl.Configuration.ProcessDesignerMenuActions.$5l()) {
            ...
            if (!isNullOrEmptyString($v_2)) {
                ...
                ProcessControl.Configuration.ProcessDesignerMenuActions.$5V($v_1, false);
            }
        }
        ProcessControl.Configuration.ProcessDesignerMenuActions.$22('UpdateProcess');
    } else {
        var $v_3 = ProcessControl.Configuration.ProcessDesignerMenuActions.$4f($p0);
        if (!IsNull($v_3)) {
            var $v_4 = Mscrm.ErrorInformation.createErrorInfo($v_3.Code, $v_3.DisplayText, $v_3.SerializedException);
...
ProcessControl.Configuration.ProcessDesignerMenuActions.activateBusinessProcessFlow = function(eventData) {
    ...
    var $v_0 = MscrmControls.ProcessDesigner.ValidateBPF.validate();
    if (!$v_0) {
        return;
    }
    var $v_1 = window.isDirty;
    if ($v_1) {
        ProcessControl.Configuration.ProcessDesignerMenuActions.$4q(function($p1_0, $p1_1) {
            if (!$p1_0.Success) {
                return;
            }
            ProcessControl.Configuration.ProcessDesignerMenuActions
                .$31('/_grid/cmds/dlg_activate.aspx',
                    ProcessControl.Configuration.ProcessDesignerMenuActions.activateProcessConfirmationCallback);
        });
    } else {
        ProcessControl.Configuration.ProcessDesignerMenuActions
            .$31('/_grid/cmds/dlg_activate.aspx',
...
ProcessControl.Configuration.ProcessDesignerMenuActions.activateProcessConfirmationCallback = function(confirmation) {
    ...
    if (!IsNull(confirmation) && confirmation) {
        ProcessControl.Configuration.ProcessDesignerMenuActions.$22('ActivateBusinessProcess');
    }
}
ProcessControl.Configuration.ProcessDesignerMenuActions.$31 = function($p0, $p1) {
    ...
    $v_0.content = {};
    $v_0.callback = $p1;
    var $v_1 = new Mscrm.CrmDialog(ProcessControl.Configuration.ProcessDesignerMenuActions.$4e($p0),
        [window._Process_Id],
        500,
        200,
        null);
...
ProcessControl.Configuration.ProcessDesignerMenuActions.deactivateProcessConfirmationCallback = function(confirmation) {
    ...
    if (!IsNull(confirmation) && confirmation) {
        ProcessControl.Configuration.ProcessDesignerMenuActions.$22('DeactivateBusinessProcess');
    }
}
ProcessControl.Configuration.ProcessDesignerMenuActions.$4e = function($p0) {
    var $v_0 = Mscrm.CrmUri.create($p0);
...
ProcessControl.Configuration.ProcessDesignerMenuActions.deleteBusinessProcessFlow = function(eventData) {
    ...
    ProcessControl.Configuration.ProcessDesignerMenuActions.$7u();
}
ProcessControl.Configuration.ProcessDesignerMenuActions.$7u = function() {
    ProcessControl.Configuration.ProcessDesignerMenuActions.$6X();
}
ProcessControl.Configuration.ProcessDesignerMenuActions.$6X = function() {
    ProcessControl.Configuration.ProcessDesignerMenuActions
        .$9d('/_grid/cmds/dlg_delete.aspx',
            ProcessControl.Configuration.ProcessDesignerMenuActions.deleteProcessConfirmationCallback);
}
    ...
    if (!IsNull(confirmation) && confirmation) {
        if (ProcessControl.Configuration.ProcessDesignerMenuActions.$5l()) {
            ...
            if (!isNullOrEmptyString($v_1)) {
                ...
                ProcessControl.Configuration.ProcessDesignerMenuActions.$5V($v_0, true);
            }
        }
    }
    ProcessControl.Configuration.ProcessDesignerMenuActions.$22('DeleteBusinessProcess');
}
ProcessControl.Configuration.ProcessDesignerMenuActions.deactivateBusinessProcessFlow = function(eventData) {
    ...
    MscrmControls.ProcessDesigner.Validation.Engine
        .setAction(MscrmControls.ProcessDesigner.Validation.Level.Deactivate);
    var $v_0 = MscrmControls.ProcessDesigner.ValidateBPF.validate();
    if (!$v_0) {
        return;
    }
    ...
    if ($v_1) {
        ProcessControl.Configuration.ProcessDesignerMenuActions.$4q(function($p1_0, $p1_1) {
            ...
            ProcessControl.Configuration.ProcessDesignerMenuActions
                .$31('/_grid/cmds/dlg_deactivate.aspx',
                    ProcessControl.Configuration.ProcessDesignerMenuActions.deactivateProcessConfirmationCallback);
        });
    } else {
        ProcessControl.Configuration.ProcessDesignerMenuActions
            .$31('/_grid/cmds/dlg_deactivate.aspx',
...
ProcessControl.Configuration.ProcessDesignerMenuActions.$22 = function($p0) {
    var $v_0 = false;
    var $v_1 = false;
    var $v_2 = false;
    ...
    case 'UpdateProcess':
        if (ProcessControl.Configuration.ProcessDesignerMenuActions.$1k) {
            ...
            ProcessControl.Configuration.ProcessDesignerMenuActions.$6s($v_4);
            ProcessControl.Configuration.ProcessDesignerMenuActions.$1k = false;
            if (!IsNull($v_3) && Mscrm.FeatureControl.get_Current().isFeatureEnabled('FCB.UnifiedProcessDesigner')) {
                window.designerSave();
            }
        }
    ...
    if ($v_1) {
        ProcessControl.Configuration.ProcessDesignerMenuActions.$6e(true);
    }
    if ($v_2) {
        ProcessControl.Configuration.ProcessDesignerMenuActions.$5v();
    }
}
ProcessControl.Configuration.ProcessDesignerMenuActions.$6s = function($p0) {
    var $v_0 = $P_CRM('#ProcessTitle');
    $v_0.text($p0);
    $v_0.attr('title', $p0);
}
ProcessControl.Configuration.ProcessDesignerMenuActions.$5v = function() {
    window.top.close();
}
ProcessControl.Configuration.ProcessDesignerMenuActions.$6e = function($p0) {
    window.location.reload($p0);
}
ProcessControl.Configuration.ProcessDesignerMenuActions.$5l = function() {
    if (Mscrm.FeatureControl.get_Current().areFeaturesEnabled(['FCB.AppModuleForOrganization', 'FCB.AppDesigner'])) {
        return !IsNull(window.top) && !IsNull(window.top.opener) && !IsNull(window.top.opener.AppDesignerCallback);
    }
    return false;
}
ProcessControl.Configuration.ProcessDesignerMenuActions.$4p = function() {
    if (!IsNull(window.top.opener) && !IsNull(window.top.opener.auto)) {
...
ProcessControl.Configuration.ProcessDesignerMenuActions.openProcessRoleAssignment = function(eventData) {
    ...
    if ($v_0) {
        ...
        ProcessControl.Configuration.ProcessDesignerMenuActions.$3Y($v_1);
    } else {
...
ProcessControl.Configuration.ProcessDesignerMenuActions.openProcessOrder = function(eventData) {
    ...
    var $v_0 = '/tools/dialogs/componentorder.aspx?etn=' +
        CrmEncodeDecode.CrmUrlEncode(MscrmControls.ProcessDesigner.primaryEntity);
    ProcessControl.Configuration.ProcessDesignerMenuActions.$3Y($v_0);
}
...
ProcessControl.Configuration.ProcessDesignerMenuActions.validateProcess = function(eventData) {
    ...
    if (eventData.which === 13 || eventData.type === 'click') {
        ProcessControl.Configuration.ProcessDesignerMenuActions.$AK();
    }
    GenericWorkflowDesigner.StaticStopwatch.stop();
    var $v_0 = GenericWorkflowDesigner.StaticStopwatch.elapsedMilliseconds;
...
ProcessControl.Configuration.ProcessDesignerMenuActions.validationButtonOn = function() {
    ...
    if (!ProcessControl.Configuration.ProcessDesignerMenuActions.isValidationOn()) {
        ...
        $v_0.attr('title', ProcessDesignerControl_BPF_ValidateMode_On);
    }
}
ProcessControl.Configuration.ProcessDesignerMenuActions.validationButtonOff = function() {
    ...
    if (ProcessControl.Configuration.ProcessDesignerMenuActions.isValidationOn()) {
        ...
        $v_0.attr('title', ProcessDesignerControl_BPF_ValidateMode_Off);
    }
}
ProcessControl.Configuration.ProcessDesignerMenuActions.titleOrDescriptionChanged = function(eventData) {
    ProcessControl.Configuration.ProcessDesignerMenuActions.$1k = true;
}
ProcessControl.Configuration.ProcessDesignerMenuActions.bindMenuActions = function() {
    ProcessControl.Configuration.ProcessDesignerMenuActions
        .$X('#_MBSave', ProcessControl.Configuration.ProcessDesignerMenuActions.saveProcess);
    ProcessControl.Configuration.ProcessDesignerMenuActions
        .$X('#_MBUpdate', ProcessControl.Configuration.ProcessDesignerMenuActions.saveProcess);
    ProcessControl.Configuration.ProcessDesignerMenuActions
        .$X('#_MBSaveAs', ProcessControl.Configuration.ProcessDesignerMenuActions.saveProcessAs);
    ProcessControl.Configuration.ProcessDesignerMenuActions
        .$X('#_MBActivate', ProcessControl.Configuration.ProcessDesignerMenuActions.activateBusinessProcessFlow);
    ProcessControl.Configuration.ProcessDesignerMenuActions
        .$X('#_MBDeactivate', ProcessControl.Configuration.ProcessDesignerMenuActions.deactivateBusinessProcessFlow);
    ProcessControl.Configuration.ProcessDesignerMenuActions
        .$X('#_MBDelete', ProcessControl.Configuration.ProcessDesignerMenuActions.deleteBusinessProcessFlow);
    ProcessControl.Configuration.ProcessDesignerMenuActions
        .$X('#_MBOrder', ProcessControl.Configuration.ProcessDesignerMenuActions.openProcessOrder);
    ProcessControl.Configuration.ProcessDesignerMenuActions
        .$X('#_MBRoleAssignment', ProcessControl.Configuration.ProcessDesignerMenuActions.openProcessRoleAssignment);
    ProcessControl.Configuration.ProcessDesignerMenuActions
        .$X('#_MBDependencies',
            ProcessControl.Configuration.ProcessDesignerMenuActions.showBusinessProcessFlowDependencies);
    ProcessControl.Configuration.ProcessDesignerMenuActions
        .$X('#_MBBusinessRules', ProcessControl.Configuration.ProcessDesignerMenuActions.openBusinessRules);
    ProcessControl.Configuration.ProcessDesignerMenuActions
        .$X('#_MBValidateOn', ProcessControl.Configuration.ProcessDesignerMenuActions.validateProcess);
    ProcessControl.Configuration.ProcessDesignerMenuActions
        .$4V('#ProcessName', ProcessControl.Configuration.ProcessDesignerMenuActions.titleOrDescriptionChanged);
    ProcessControl.Configuration.ProcessDesignerMenuActions
        .$4V('#Description', ProcessControl.Configuration.ProcessDesignerMenuActions.titleOrDescriptionChanged);
    var $v_0 = {};
    $v_0['Action'] = 'Shortcut';
    $P_CRM(window).bind('keydown', $v_0, ProcessControl.Configuration.ProcessDesignerMenuActions.$6W);
}
...
ProcessControl.Configuration.ProcessDesignerMenuActions.$AQ = function() {
    var $v_0 = isTaskFlow;
    if ($v_0) {
...
ProcessControl.Configuration.ProcessDesignerMenuActions.$AP = function() {
    GenericWorkflowDesigner.StaticStopwatch = new GenericWorkflowDesigner.Stopwatch();
    GenericWorkflowDesigner.StaticStopwatch.reset();
    GenericWorkflowDesigner.StaticStopwatch.start();
...
ProcessControl.Configuration.ProcessDesignerMenuActions.$AK = function() {
    if (ProcessControl.Configuration.ProcessDesignerMenuActions.isValidationOn()) {
        ProcessControl.Configuration.ProcessDesignerMenuActions.validationButtonOff();
        ProcessControl.Configuration.ProcessDesignerMenuActions.$AP();
    } else {
        ProcessControl.Configuration.ProcessDesignerMenuActions.validationButtonOn();
        ProcessControl.Configuration.ProcessDesignerMenuActions.$AQ();
    }
}
ProcessControl.Configuration.ProcessDesignerMenuActions.$6W = function($p0) {
...
ProcessControl.Configuration.ProcessDesignerMenuActions.$3Y = function($p0) {
    var $v_0 = Mscrm.CrmUri.create($p0);
    $v_0 = Mscrm.CrmUri.updateCrmUriHostAndScheme($v_0);
    var $v_1 = new Xrm.DialogOptions();
    $v_1.width = 660;
...
ProcessControl.Configuration.ProcessDesignerMenuActions.$9d = function($p0, $p1) {
    var $v_0 = ProcessControl.Configuration.ProcessDesignerMenuActions.$4e($p0);
    var $v_1 = openStdDlgWithCallback($v_0, [window._Process_Id], 500, 200, $p1);
    return $v_1;
}
ProcessControl.Configuration.ProcessDesignerMenuActions.$4V = function($p0, $p1) {
    var $v_0 = $P_CRM($p0);
    $v_0.bind('change', $p1);
}
...
ProcessControl.Configuration.EntityTabsControl.prototype = {
    initialize: function() {
        ...
        this.get_tabsContentjQueryObject().height(this.get_tabsControljQueryObject().height() -
            this.get_tabsHeaderjQueryObject().height());
...
ProcessControl.Configuration.ProcessConfigurationUtility.isLinkControl = function(stepStep) {
    ...
    return ($v_1 ===
            '<parameters><LinkControlDefinitionId>{0F337699-D595-48D9-B733-6479E5F5EB07}</LinkControlDefinitionId></parameters>') ||
        ($v_1 ===
            '<parameters><LinkControlDefinitionId>{26cf241a-886d-4870-a22a-356cad9a75dd}</LinkControlDefinitionId></parameters>');
}
ProcessControl.Configuration.ProcessConfigurationUtility.getSystemStepTypeFromControlParameters = function(control) {
    ...
    case
        '<parameters><IsDeDupLookup>true</IsDeDupLookup><InlineViewIds>{f9e54d49-0c76-4cbd-979b-5fe94b496be0}</InlineViewIds></parameters>':
        return 'IdentifyAccount';
    case
        '<parameters><IsInlineNewEnabled>true</IsInlineNewEnabled><EntityLogicalName>Incident</EntityLogicalName><InlineViewIds>{06D2061B-703E-465B-B8AD-FD69C6157127}</InlineViewIds></parameters>':
        return 'IdentifyCase';
    case
        '<parameters><IsDeDupLookup>true</IsDeDupLookup><InlineViewIds>{c14e0638-4996-4720-97cd-c58f0df74220}</InlineViewIds></parameters>':
        return 'LeadIdentifyContact';
    case
        '<parameters><IsInlineNewEnabled>true</IsInlineNewEnabled><EntityLogicalName>Contact</EntityLogicalName><InlineViewIds>{c14e0638-4996-4720-97cd-c58f0df74228},{f9e54d49-0c76-4cbd-979b-5fe94b496beb}</InlineViewIds></parameters>':
...
ProcessControl.Configuration.ProcessConfigurationUtility.refreshAvailableSystemControls = function(processControlView) {
    ...
    ProcessControl.Configuration.ProcessConfigurationUtility.$AE(processControlView);
    ...
    for (var $v_1 = 0; $v_1 < $v_0.get_Steps().get_Count(); $v_1++) {
        ...
        for (var $v_3 = 0; $v_3 < $v_2.get_Steps().get_Count(); $v_3++) {
            ...
            for (var $v_5 = 0; $v_5 < $v_4.get_Steps().get_Count(); $v_5++) {
                ...
                ProcessControl.Configuration.ProcessConfigurationUtility.$8w($v_7, processControlView);
            }
        }
    }
}
...
ProcessControl.Configuration.ProcessConfigurationUtility.$AE = function($p0) {
    for (var $v_0 = 0; $v_0 < $p0.get_$Aa_3().length; $v_0++) {
        ($p0.get_$Aa_3()[$v_0]).configureControlStepMenu();
    }
}
ProcessControl.Configuration.ProcessConfigurationUtility.$8w = function($p0, $p1) {
...
ProcessControl.Configuration.ProcessConfigurationUtility
    .generateStepLabelForCurrentUser = function(labelValue, labelId) {
        return ProcessControl.Configuration.ProcessConfigurationUtility
            .generateStepLabel(labelValue, window._Process_CurrentLCID, labelId);
    }
ProcessControl.Configuration.ProcessConfigurationUtility.createEmptyStageData = function(workflowStep) {
    ...
    ProcessControl.Configuration.ProcessConfigurationUtility.$AD(workflowStep, $v_0);
...
ProcessControl.Configuration.ProcessConfigurationUtility.createEmptyPageData = function(workflowStep) {
    ...
    ProcessControl.Configuration.ProcessConfigurationUtility.$AA(workflowStep, $v_0);
    var $v_1 = ProcessControl.Configuration.ProcessConfigurationUtility.createEmptyStepData(workflowStep);
    $v_1.set_parent($v_0);
    $v_1.get_parent().set_workflow(workflowStep);
    $v_1.setJQueryFriendlyNameAndId(workflowStep.get_currentStepId());
...
ProcessControl.Configuration.ProcessConfigurationUtility.$AD = function($p0, $p1) {
    var $v_0 = ProcessControl.Configuration.ProcessConfigurationUtility.getCleanGuid();
    $p1.addLabel(ProcessControl.Configuration.ProcessConfigurationUtility
        .generateStepLabel(window.LOCID_PROCESS_NEWSTAGETEXTKEY, window._Process_CurrentLCID, $v_0));
    $p1.set_workflow($p0);
    $p1.setJQueryFriendlyNameAndId($p0.get_currentStepId());
    $p1.set_stageId($v_0);
    $p1.set_stageCategory('-1');
}
ProcessControl.Configuration.ProcessConfigurationUtility.$AA = function($p0, $p1) {
    var $v_0 = ProcessControl.Configuration.ProcessConfigurationUtility.getCleanGuid();
    $p1.addLabel(ProcessControl.Configuration.ProcessConfigurationUtility
        .generateStepLabel(window.LOCID_PROCESS_NEWPAGETEXTKEY, window._Process_CurrentLCID, $v_0));
    $p1.set_workflow($p0);
    $p1.setJQueryFriendlyNameAndId($p0.get_currentStepId());
...
ProcessControl.Configuration.ProcessConfigurationUtility
    .getSystemStep = function(workflowStep, parameters, dataFieldName, classId, controlDisplayName) {
        var $v_0 = ProcessControl.Configuration.ProcessConfigurationUtility.getCleanGuid();
        var $v_1;
        ...
        $v_2.addLabel(ProcessControl.Configuration.ProcessConfigurationUtility
            .generateStepLabel($v_1, window._Process_CurrentLCID, $v_0));
...
ProcessControl.Configuration.ProcessConfigurationUtility
    .generateSystemStep = function(stepType, workflowStep, entityMetadata, displayName) {
        switch (stepType) {
        case 'IdentifyAccount':
            return ProcessControl.Configuration.ProcessConfigurationUtility
                .getIdentifyAccountStep(workflowStep, entityMetadata, displayName);
        case 'IdentifyCase':
            return ProcessControl.Configuration.ProcessConfigurationUtility
                .getIdentifyCaseStep(workflowStep, entityMetadata, displayName);
        case 'LeadIdentifyContact':
            return ProcessControl.Configuration.ProcessConfigurationUtility
                .getIdentifyContactStep(workflowStep, entityMetadata, displayName);
        case 'IdentifyCustomer':
            return ProcessControl.Configuration.ProcessConfigurationUtility
                .getIdentifyCustomerStep(workflowStep, entityMetadata, displayName);
        case 'Resolve':
            return ProcessControl.Configuration.ProcessConfigurationUtility
                .getResolveStep(workflowStep, entityMetadata, displayName);
        case 'Solution':
            return ProcessControl.Configuration.ProcessConfigurationUtility
                .getSolutionStep(workflowStep, entityMetadata, displayName);
        default:
            return null;
        }
    }
ProcessControl.Configuration.ProcessConfigurationUtility
    .getIdentifyContactStep = function(workflowStep, entityMetadata, displayName) {
        return ProcessControl.Configuration.ProcessConfigurationUtility
            .getSystemStep(workflowStep,
                '<parameters><IsDeDupLookup>true</IsDeDupLookup><InlineViewIds>{c14e0638-4996-4720-97cd-c58f0df74220}</InlineViewIds></parameters>',
                'parentcontactid',
...
ProcessControl.Configuration.ProcessConfigurationUtility
    .getIdentifyAccountStep = function(workflowStep, entityMetadata, displayName) {
        return ProcessControl.Configuration.ProcessConfigurationUtility
            .getSystemStep(workflowStep,
                '<parameters><IsDeDupLookup>true</IsDeDupLookup><InlineViewIds>{f9e54d49-0c76-4cbd-979b-5fe94b496be0}</InlineViewIds></parameters>',
                'parentaccountid',
...
ProcessControl.Configuration.ProcessConfigurationUtility
    .getIdentifyCustomerStep = function(workflowStep, entityMetadata, displayName) {
        return ProcessControl.Configuration.ProcessConfigurationUtility
            .getSystemStep(workflowStep,
                '<parameters><IsInlineNewEnabled>true</IsInlineNewEnabled><EntityLogicalName>Contact</EntityLogicalName><InlineViewIds>{c14e0638-4996-4720-97cd-c58f0df74228},{f9e54d49-0c76-4cbd-979b-5fe94b496beb}</InlineViewIds></parameters>',
                'customerid',
...
ProcessControl.Configuration.ProcessConfigurationUtility
    .getIdentifyCaseStep = function(workflowStep, entityMetadata, displayName) {
        return ProcessControl.Configuration.ProcessConfigurationUtility
            .getSystemStep(workflowStep,
                '<parameters><IsInlineNewEnabled>true</IsInlineNewEnabled><EntityLogicalName>Incident</EntityLogicalName><InlineViewIds>{06D2061B-703E-465B-B8AD-FD69C6157127}</InlineViewIds></parameters>',
                'existingcase',
...
ProcessControl.Configuration.ProcessConfigurationUtility
    .getSolutionStep = function(workflowStep, entityMetadata, displayName) {
        return ProcessControl.Configuration.ProcessConfigurationUtility
            .getSystemStep(workflowStep,
                '<parameters><LinkControlDefinitionId>{0F337699-D595-48D9-B733-6479E5F5EB07}</LinkControlDefinitionId></parameters>',
                '',
                'DFDF1CDE-837B-4AC9-98CF-AC74361FD89D',
                displayName);
    }
ProcessControl.Configuration.ProcessConfigurationUtility
    .getResolveStep = function(workflowStep, entityMetadata, displayName) {
        return ProcessControl.Configuration.ProcessConfigurationUtility
            .getSystemStep(workflowStep,
                '<parameters><LinkControlDefinitionId>{26cf241a-886d-4870-a22a-356cad9a75dd}</LinkControlDefinitionId></parameters>',
                '',
...
ProcessControl.Configuration.ProcessConfigurationUtility
    .replaceStepLabelForCurrentUser = function(labels, newLabelValue, labelId) {
...
ProcessControl.Configuration.ProcessConfigurationUtility
    .getCloseLoopEntityList = function(relationshipDictionary, entityList, lastEntity) {
...
ProcessControl.Configuration.ProcessConfigurationUtility.getFirstDoNotPersistEntityStep = function(workflowStep) {
    var $v_0 = ProcessControl.Configuration.ProcessConfigurationUtility
        .getIndexOfFirstDoNotPersistEntityStep(workflowStep);
...
ProcessControl.Configuration.ProcessConfigurationUtility
    .getLastValidProcessControlEntityView = function(processControlView) {
        var $v_0 = ProcessControl.Configuration.ProcessConfigurationUtility
            .getIndexOfFirstDoNotPersistEntityStep(processControlView.get_dataContext().get_workflow());
        return ($v_0 <= 5) ? processControlView.get_$Aa_3()[$v_0 - 1] : null;
    }
...
ProcessControl.Configuration.ProcessConfigurationUtility
    .getIndexOfFirstDoNotPersistEntityStep = function(workflowStep) {
        for (var $v_0 = 0; $v_0 < workflowStep.get_Steps().get_Count(); $v_0++) {
            var $v_1 = workflowStep.get_Steps().get_item($v_0);
            if (!(Microsoft.Crm.Workflow.ObjectModel.EntityStep.isInstanceOfType($v_1))) {
                continue;
...
ProcessControl.Configuration.ProcessConfigurationUtility
    .createAttributeMetadataModel = function(displayText, entityLogicalName, lcid) {
...
ProcessControl.Configuration.ProcessSaveEventArgs = function(status, statusReason, serverException) {
    this.$5H_0 = status;
    this.$5I_0 = statusReason;
    this.$5D_0 = serverException;
}
...
ProcessControl.Configuration.StageCategory.initialize = function(stageCategories) {
    ProcessControl.Configuration.StageCategory.$1o = stageCategories;
    var $v_0 = new Mscrm.EnumOptionJsonWrapper();
    $v_0.Value = -1;
    $v_0.Label = '';
    Array.insert(ProcessControl.Configuration.StageCategory.$1o, 0, $v_0);
}
ProcessControl.Configuration.StageCategory.getStageCategories = function() {
    return ProcessControl.Configuration.StageCategory.$1o;
}
ProcessControl.Configuration.StageCategory.getLabelByValue = function(value) {
    if (IsNull(ProcessControl.Configuration.StageCategory.$1o)) {
        return '';
    }
    for (var $v_0 = 0; $v_0 < ProcessControl.Configuration.StageCategory.$1o.length; $v_0++) {
        if (ProcessControl.Configuration.StageCategory.$1o[$v_0].Value.toString() === value) {
            return ProcessControl.Configuration.StageCategory.$1o[$v_0].Label;
        }
    }
    return '';
}
...
ProcessControl.Configuration.ProcessEnabledEntities.initialize = function(entities) {
    ...
    ProcessControl.Configuration.ProcessEnabledEntities.$4B = {};
    for (var $v_0 = 0; $v_0 < entities.length; $v_0++) {
        var $v_1 = new Mscrm.EnumOptionJsonWrapper();
        $v_1.Value = $v_0;
        $v_1.Label = entities[$v_0].DisplayName;
        ProcessControl.Configuration.ProcessEnabledEntities.$4B[$v_0.toString()] = entities[$v_0].LogicalName;
...
ProcessControl.Configuration.ProcessEnabledEntities.getLogicalNameByValue = function(value) {
    ...
    for (var $v_0 = 0; $v_0 < ProcessControl.Configuration.ProcessEnabledEntities.$w.length; $v_0++) {
        if (ProcessControl.Configuration.ProcessEnabledEntities.$w[$v_0].Value.toString() === value) {
            return ProcessControl.Configuration.ProcessEnabledEntities.$4B[value];
        }
    }
    return '';
}
ProcessControl.Configuration.ProcessEnabledEntities.getLabelByLogicalName = function(logicalName) {
    ...
    for (var $$arr_1 = ProcessControl.Configuration.ProcessEnabledEntities.$3B, $$len_2 = $$arr_1.length, $$idx_3 = 0;
        $$idx_3 < $$len_2;
        ++$$idx_3) {
        var $v_0 = $$arr_1[$$idx_3];
...
ProcessControl.Configuration.ProcessControlEntityView.prototype = {
    ...
    set_dataContext: function(value) {
        ...
        $v_0.add_stepCollectionChanged(this.$$d_$9p_5);
        return value;
    },
    ...
    renderView: function() {
        ...
        var $v_0 = {};
        $v_0['entityView'] = this;
        this.$35_5 = $create(ProcessControl.Configuration.AddStageBehavior,
            $v_0,
            null,
            null,
            $get(String.format('{0}_add{1}', this.get_id(), 'stage')));
        this.$25_5 = $create(ProcessControl.Configuration.AddStepBehavior,
            $v_0,
            null,
            null,
            $get(String.format('{0}_add{1}', this.get_id(), 'step')));
    },

    configureControlStepMenu: function() {
        if (!IsNull(this.$25_5)) {
            this.$25_5.configureMenu();
        }
    },

    setFocus: function() {
        if (this.get_$Aa_3().length > 0) {
            (this.get_$Aa_3()[0]).setFocus(false);
        } else {
    ...
    move: function(args) {
        ...
        this.$5Y_5([args.get_oldStartingIndex(), args.get_newStartingIndex()]);
    },
    ...
    executePostAddSteps: function() {
        ...
        var $v_0 = this.get_$Aa_3().length - 1;
        this.$5Y_5([$v_0 - 1, $v_0, $v_0 + 1]);
    },
    ...
    $5Y_5: function($p0) {
        for (var $v_0 = 0; $v_0 < $p0.length; $v_0++) {
            var $v_1 = this.get_$Aa_3()[$p0[$v_0]];
            if (IsNull($v_1)) {
                continue;
            }
            if (this.get_$Aa_3().length > $p0[$v_0] + 1) {
                $v_1.get_$1z_5().children(':nth-child(2)').css('display', 'block');
            } else {
                $v_1.get_$1z_5().children(':nth-child(2)').css('display', 'none');
            }
            if ($p0[$v_0] > 0) {
                $v_1.get_$1z_5().children(':first-child').css('display', 'block');
            } else {
                $v_1.get_$1z_5().children(':first-child').css('display', 'none');
            }
        }
    },
    ...
    dispose: function() {
        ...
        if (!IsNull(this.get_dataContext()) || !IsNull(this.get_dataContext().get_Steps())) {
            this.get_dataContext().get_Steps().remove_stepCollectionChanged(this.$$d_$9p_5);
        }
        if (!IsNull(this.$35_5)) {
            this.$35_5.dispose();
            this.$35_5 = null;
...
ProcessControl.Configuration.ProcessControlExtensibleView$2 = function(element) {
    ProcessControl.Configuration.ProcessControlExtensibleView$2
        .$$(this.$$gta['ProcessControl.Configuration.ProcessControlExtensibleView$2']['TChildView'],
            this.$$gta['ProcessControl.Configuration.ProcessControlExtensibleView$2']['TChildViewModel'])
...
ProcessControl.Configuration.ProcessControlExtensibleView$2.$$ = function(TChildView, TChildViewModel) {
    var $$cn = 'ProcessControlExtensibleView$2' +
        '$' +
        TChildView.getName().replace(/\./g, '_') +
        '$' +
        TChildViewModel.getName().replace(/\./g, '_');
    if (!ProcessControl.Configuration[$$cn]) {
        var $$ccr = ProcessControl.Configuration[$$cn] = function() {
            (this.$$gta = this
                    .$$gta ||
                    {})['ProcessControl.Configuration.ProcessControlExtensibleView$2'] =
                { 'TChildView': TChildView, 'TChildViewModel': TChildViewModel };
            var $v_0 = [];
            for (var $v_1 = 0; $v_1 < arguments.length; ++$v_1) {
                $v_0[$v_1] = arguments[$v_1];
            }
        ...
        $$ccr.registerClass('ProcessControl.Configuration.' + $$cn,
            ProcessControl.Configuration.ProcessControlViewBase$2.$$(TChildViewModel, TChildView),
            ProcessControl.Configuration.IExtensibleProcessControlView$2.$$(TChildView, TChildViewModel));
...
ProcessControl.Configuration.ProcessControlExtensibleView$2.prototype = {
    addChildView: function(viewModel) {
        ...
        Array.insert(this.get_$Aa_3(), this.get_$Aa_3().length, $v_1);
        $v_1.renderView();
        this.executePostAddSteps();
        return $v_1;
    },
    ...
    move: function(args) {
        ...
        var $v_1 = this.get_$Aa_3()[args.get_oldStartingIndex()];
        var $v_2 = this.get_$Aa_3()[args.get_newStartingIndex()];
        ...
        Array.removeAt(this.get_$Aa_3(), args.get_oldStartingIndex());
        Array.insert(this.get_$Aa_3(), args.get_newStartingIndex(), $v_1);
        $v_0.focus();
        if (Mscrm.CrmBrowser.get_currentBrowser().get_agent() === (1)) {
            this.$87_4($v_1);
        }
    ...
    createNewViewControl: function(viewModel, newViewDom) {
        ...
        $v_0['parentView'] = this;
        return Mscrm.CrmUIComponent.crmCreate(this
            .$$gta['ProcessControl.Configuration.ProcessControlExtensibleView$2']['TChildView'],
            $v_0,
            null,
            null,
            newViewDom.get(0));
    ...
    removeChildView: function(index) {
        var $v_0 = this.get_$Aa_3()[index];
        Array.removeAt(this.get_$Aa_3(), index);
        var $v_1 = $v_0.get_elementWrapper();
        ($v_0).dispose();
        $v_0 = ((this.$$gta['ProcessControl.Configuration.ProcessControlExtensibleView$2']['TChildView'] === Number ||
                Type.isEnum(this.$$gta['ProcessControl.Configuration.ProcessControlExtensibleView$2']['TChildView']))
            ? 0
            : (this.$$gta['ProcessControl.Configuration.ProcessControlExtensibleView$2']['TChildView'] === Boolean)
            ? false
            : null);
        $v_1.remove();
    ...
    findBestChildViewForFocus: function(index) {
        if (!this.get_$Aa_3().length) {
            return null;
        }
        if (index === this.get_$Aa_3().length) {
            return this.get_$Aa_3()[this.get_$Aa_3().length - 1];
        }
        return this.get_$Aa_3()[index];
    }
}
...
ProcessControl.Configuration.ProcessControlStageView = function(element) {
    ...
    this.$$d_$7g_5 = Function.createDelegate(this, this.$7g_5);
    this.$$d_$9o_5 = Function.createDelegate(this, this.$9o_5);
    this.$$d_$9m_5 = Function.createDelegate(this, this.$9m_5);
    this.$$d_$9c_5 = Function.createDelegate(this, this.$9c_5);
...
ProcessControl.Configuration.ProcessControlStageView.prototype = {
    ...
    renderView: function() {
        this.$9N_5(window.LOCID_PROCESS_NEWSTAGETEXTKEY);
        this.$9K_5();
        var $$t_0 = this;
    ...
    $96_5: function() {
        ...
        var $v_2 = this.$8X_5();
        this.$2g_5 = Mscrm.InlineControlFactory
            .createInlinePicklistControlForDomByControlMode($v_1,
                $v_0,
                ProcessControl.Configuration.ProcessEnabledEntities.getEnumOptions(),
                '',
                'normal',
                $v_2.toString());
        this.$2g_5.initializeAndRenderEditView();
        this.fixStageControl(ProcessControl.Configuration.ProcessEnabledEntities
            .getLabelByLogicalName(this.$d_5.get_entityLogicalName()),
            this.$2g_5);
        ProcessControl.Configuration.ProcessConfigurationUtility.setStatusBasedOnReadOnly(this.$2g_5);
        this.$2g_5.get_chromeElement().bind('attribute-changed', this.$$d_$9m_5);
    },
    ...
    $9N_5: function($p0) {
        ...
        var $v_2 = {};
        var $v_3 = ProcessControl.Configuration.ProcessConfigurationUtility
            .getStepLabelForCurrentUser(this.get_dataContext().get_stepLabels(), this.get_dataContext().get_stageId());
        $v_2['value'] = CrmEncodeDecode.CrmHtmlEncode(CrmEncodeDecode.CrmHtmlEncode($v_3.get_description()));
        this._stageNameView = Mscrm.InlineControlFactory
            .createInlineTextBoxControlForDom($v_1, $v_0, 100, $v_2, 'pcc', 'normal');
    ...
    $9K_5: function() {
        ...
        if ($v_1.length > 0) {
            var $v_2 = this.$8W_5();
            this.$2E_5 = Mscrm.InlineControlFactory
                .createInlinePicklistControlForDomByControlMode($v_1,
                    $v_0,
                    ProcessControl.Configuration.StageCategory.getStageCategories(),
                    '',
                    'normal',
                    $v_2);
            this.$2E_5.initializeAndRenderEditView();
            this.fixStageControl(ProcessControl.Configuration.StageCategory
                .getLabelByValue(this.$2E_5.get_dataContext().get_editValue()),
                this.$2E_5);
            ProcessControl.Configuration.ProcessConfigurationUtility.setStatusBasedOnReadOnly(this.$2E_5);
            this.$2E_5.get_chromeElement().bind('attribute-changed', this.$$d_$9o_5);
        }
    },
    ...
    $8X_5: function() {
        return ProcessControl.Configuration.ProcessEnabledEntities
            .getValueByLogicalName(this.$d_5.get_entityLogicalName());
    },
    ...
    onStageNameChanged: function(eventHandler) {
        if (arguments.length > 1) {
            ...
            ProcessControl.Configuration.ProcessConfigurationUtility
                .replaceStepLabelForCurrentUser(this.get_dataContext().get_stepLabels(),
                    $v_0,
                    this.get_dataContext().get_stageId());
        }
    },
    ...
    addStepKeyBoardShortcut: function(eventObject) {
        if (eventObject.altKey && eventObject.shiftKey && eventObject.keyCode === 78) {
            var $v_0 = ProcessControl.Configuration.ProcessConfigurationUtility
                .createEmptyStepData(this.get_dataContext().get_workflow());
            var $v_1 = ProcessConfiguration.Behavior.StageFocusBehavior.$6.$2_5.get_stepBuilder()
                .buildProcessComponent($v_0, $v_0.get_Id());
            ...
            var $v_5 = this.$2_5.get_viewAdapterFactory()
                .createStepViewAdapter(this.$2_5,
                    $v_1,
                    $v_4,
                    this.$1M_5.get_viewFactory().getStageViewById(this.get_id()));
    ...
    get_$23_5: function() {
        if (IsNull(this.$4O_5)) {
            this.$4O_5 = this.get_elementWrapper();
        }
        return this.$4O_5;
    },
    ...
    get_$1z_5: function() {
        if (IsNull(this.$3d_5)) {
            this.$3d_5 = this.get_elementWrapper().children(':first-child').children(':first-child')
    ...
    get_$1A_5: function() {
        if (IsNull(this.$1p_5)) {
            this.$1p_5 = this.get_elementWrapper().children(':first-child').children(':nth-child(3)')
    ...
    dispose: function() {
        ...
        if (!IsNull(this.get_dataContext()) || !IsNull(this.get_dataContext().get_Steps())) {
            this.get_dataContext().get_Steps().remove_stepCollectionChanged(this.$$d_$7g_5);
        }
        this.$71_5();
        ProcessControl.Configuration.ProcessControlViewBase$2.prototype.dispose.call(this);
    },
...
ProcessControl.Configuration.ProcessControlStepView = function(element) {
    this.$$d_$9q_4 = Function.createDelegate(this, this.$9q_4);
...
ProcessControl.Configuration.ProcessControlStepView.prototype = {
    ...
    $5r_4: function() {
        ...
        var $$t_2 = this;
        this.get_$1R_4().bind('click',
            function($p1_0) {
                $$t_2.$6c_4($p1_0);
            });
        var $$t_3 = this;
        this.get_$1R_4().bind('keydown',
            function($p1_0) {
                switch ($p1_0.which) {
                case 13:
                case 32:
    ...
    $9Q_4: function() {
        ...
        var $v_3 = ProcessControl.Configuration.ProcessConfigurationUtility
            .getStepLabelForCurrentUser(this.get_dataContext().get_stepLabels(),
                this.get_dataContext().get_stepStepId());
        $v_2['value'] = CrmEncodeDecode.CrmHtmlEncode(CrmEncodeDecode.CrmHtmlEncode($v_3.get_description()));
        if (ProcessControl.Configuration.Initializer.get_isProcessUnificationDebugMode()) {
            if (Microsoft.Crm.Workflow.ObjectModel.ActionStep
                .isInstanceOfType(this.get_dataContext().get_Steps().get_item(0))) {
                var $v_4 = this.get_dataContext().get_Steps().get_item(0).toJson();
                $v_3.set_description($v_4);
                $v_2['value'] = CrmEncodeDecode.CrmHtmlEncode(CrmEncodeDecode.CrmHtmlEncode($v_3.get_description()));
            }
            this.$V_4 = Mscrm.InlineControlFactory
                .createInlineTextControlForDom($v_1, $v_0, 10000000, 'ntext', $v_2, 'pcc', 'alwaysedit');
        ...
        this.$61_4($v_3.get_description());
        this.$V_4.get_chromeElement().bind('attribute-changed', this.$$d_$9q_4);
    },
    ...
    $6c_4: function($p0) {
        var $v_0 = this.get_$1R_4().children('img');
    ...
    get_$1R_4: function() {
        if (IsNull(this.$4I_4)) {
            this.$4I_4 = this.get_elementWrapper().children(':nth-child(2)').children(':first-child');
        }
        return this.$4I_4;
    },

    $6t_4: function() {
        this.get_$1R_4().children('img').attr('src', this.get_$5t_4().source);
        this.get_$1R_4().children('img').attr('class', this.get_$5t_4().cssClass);
        this.get_$1R_4().children('img').attr('required', 'required');
    },

    $6v_4: function() {
        this.get_$1R_4().children('img').attr('src', this.get_$73_4().source);
        this.get_$1R_4().children('img').attr('class', this.get_$73_4().cssClass);
        this.get_$1R_4().children('img').removeAttr('required');
    },

    get_$5t_4: function() {
        if (IsNull(this.$3g_4)) {
            this.$3g_4 = Mscrm.ImageStrip.getImageInfo(Mscrm.CrmUri
                .create(window.CDNURL + '/_imgs/processcontrol/12_checkbox_on.png'));
        }
        return this.$3g_4;
    },
    ...
    get_$73_4: function() {
        if (IsNull(this.$4R_4)) {
            this.$4R_4 = Mscrm.ImageStrip.getImageInfo(Mscrm.CrmUri
                .create(window.CDNURL + '/_imgs/processcontrol/12_checkbox_off.png'));
        }
        return this.$4R_4;
    },
    ...
    $9q_4: function($p0) {
        ...
        var $v_0 = arguments[1];
        if (isNullOrEmptyString($v_0)) {
            this.$V_4.get_dataContext().get_attribute().set_rawValue(this.$8R_4());
            return;
        }
        ProcessControl.Configuration.ProcessConfigurationUtility
            .replaceStepLabelForCurrentUser(this.get_dataContext().get_stepLabels(),
    ...
    get_$4r_4: function() {
        if (IsNull(this.$4P_4)) {
            this.$4P_4 = this.get_elementWrapper().children(':first-child');
        }
        return this.$4P_4;
    },
    ...
    get_$4W_4: function() {
        if (IsNull(this.$3f_4)) {
            this.$3f_4 = this.get_elementWrapper().children(':nth-child(2)');
        }
        return this.$3f_4;
    },
    ...
    get_$1A_4: function() {
        if (IsNull(this.$1p_4)) {
            this.$1p_4 = this.get_elementWrapper().children('.button.delete-step');
        }
        return this.$1p_4;
    },
    ...
    $6r_4: function($p0) {
        var $v_0 = ProcessControl.Configuration.ProcessConfigurationUtility
            .getStepLabelForCurrentUser(this.get_dataContext().get_stepLabels(),
                this.get_dataContext().get_stepStepId()).get_description();
    ...
    $71_4: function() {
        ...
        this.get_$1R_4().unbind('click');
        this.get_$1R_4().unbind('keydown');
        if (!this.$V_4.get_isDisposed()) {
            this.$V_4.get_chromeElement().unbind('attribute-changed', this.$$d_$9q_4);
        }
    },
...
ProcessControl.Configuration.ProcessControlView = function(element, entityMetadata) {
    this.$$d_$6l_5 = Function.createDelegate(this, this.$6l_5);
...
ProcessControl.Configuration.ProcessControlView.$6X = function() {
    var $v_0 = ProcessControl.Configuration.ProcessControlView.$3Y('/_grid/cmds/dlg_delete.aspx');
...
ProcessControl.Configuration.ProcessControlView.deleteProcessConfirmationCallback = function(confirmation) {
    if (!IsNull(confirmation) && confirmation) {
        ProcessControl.Configuration.ProcessControlView.$22('DeleteBusinessProcess');
    }
}
ProcessControl.Configuration.ProcessControlView.get_$2O = function() {
    if (IsNull(ProcessControl.Configuration.ProcessControlView.$1u)) {
        ProcessControl.Configuration.ProcessControlView.$1u = new Mscrm.ProgressControl();
    }
    return ProcessControl.Configuration.ProcessControlView.$1u;
}
ProcessControl.Configuration.ProcessControlView.activateProcessConfirmationCallback = function(confirmation) {
    if (!IsNull(confirmation) && confirmation) {
        ProcessControl.Configuration.ProcessControlView.$22('ActivateBusinessProcess');
    }
}
ProcessControl.Configuration.ProcessControlView.$31 = function($p0, $p1) {
    ...
    $v_0.content = {};
    $v_0.callback = $p1;
    var $v_1 = new Mscrm.CrmDialog(ProcessControl.Configuration.ProcessControlView.$4e($p0),
        [window._Process_Id],
        500,
        200,
        null);
...
ProcessControl.Configuration.ProcessControlView.deactivateProcessConfirmationCallback = function(confirmation) {
    if (!IsNull(confirmation) && confirmation) {
        ProcessControl.Configuration.ProcessControlView.$22('DeactivateBusinessProcess');
    }
}
ProcessControl.Configuration.ProcessControlView.$3Y = function($p0) {
    var $v_0 = ProcessControl.Configuration.ProcessControlView.$4e($p0);
    var $v_1 = openStdDlgWithCallback($v_0, [window._Process_Id], 500, 200, null);
    return $v_1;
}
ProcessControl.Configuration.ProcessControlView.$4e = function($p0) {
    var $v_0 = Mscrm.CrmUri.create($p0);
    $v_0.get_query()['iObjType'] = 4703;
    $v_0.get_query()['iTotal'] = '1';
    $v_0.get_query()['sIds'] = window._Process_Id;
...
ProcessControl.Configuration.ProcessControlView.$6M = function() {
    var $v_0 = $P_CRM('#ProcessName');
    return $v_0.val();
}
ProcessControl.Configuration.ProcessControlView.$6m = function($p0, $p1) {
    ProcessControl.Configuration.ProcessControlView.get_$2O().hide();
    if (!$p0.Success) {
        return;
    }
    if ($p0.ReturnValue === 'success') {
        ProcessControl.Configuration.ProcessControlView.$47 = ProcessControl.Configuration.ProcessControlView.$3I;
        ProcessControl.Configuration.ProcessControlView.$22($p1.Command);
    } else {
        var $v_0 = ProcessControl.Configuration.ProcessControlView.$4f($p0);
        ProcessControl.Configuration.ProcessControlView.$6N($v_0);
    }
}
ProcessControl.Configuration.ProcessControlView.$22 = function($p0) {
    var $v_0 = false;
    var $v_1 = false;
    var $v_2 = false;
    switch ($p0) {
    ...
    case 'DeactivateBusinessProcess':
        ...
        break;
    case 'UpdateProcess':
        if (ProcessControl.Configuration.ProcessControlView.$1k) {
            $v_0 = true;
            var $v_3 = ProcessControl.Configuration.ProcessControlView.$6M();
            ProcessControl.Configuration.ProcessControlView.$6s($v_3);
            ProcessControl.Configuration.ProcessControlView.$1k = false;
        }
        break;
    }
    if ($v_0) {
        ProcessControl.Configuration.ProcessControlView.$4p();
    }
    if ($v_1) {
        ProcessControl.Configuration.ProcessControlView.$6e(true);
    }
    if ($v_2) {
        ProcessControl.Configuration.ProcessControlView.$5v();
    }
}
ProcessControl.Configuration.ProcessControlView.$6s = function($p0) {
    var $v_0 = $P_CRM('#ProcessTitle');
    $v_0.text($p0);
    $v_0.attr('title', $p0);
}
ProcessControl.Configuration.ProcessControlView.$5v = function() {
    window.top.close();
}
ProcessControl.Configuration.ProcessControlView.$6e = function($p0) {
    window.location.reload($p0);
}
ProcessControl.Configuration.ProcessControlView.$4p = function() {
    if (!IsNull(window.top.opener)) {
        window.top.opener.auto('4703');
    }
}
ProcessControl.Configuration.ProcessControlView.$6N = function($p0) {
}
...
ProcessControl.Configuration.ProcessControlView.$84 = function($p0, $p1) {
    ProcessControl.Configuration.ProcessControlView.get_$2O().hide();
    Mscrm.RemoteCommandXml.remoteCommandXmlDefaultErrorHandler($p0, $p1);
}
ProcessControl.Configuration.ProcessControlView.$6u = function() {
    var $v_0 = window.LOCID_PROCESS_SAVEERROR;
    if (IsNull(ProcessControl.Configuration.ProcessControlView.$1E)) {
        ProcessControl.Configuration.ProcessControlView.$1E = new Mscrm
            .BusinessRuleErrorFlyout($P_CRM('#bpfConfContent'));
    }
...
ProcessControl.Configuration.ProcessControlView.prototype = {
    ...
    get_initialJson: function() {
        return ProcessControl.Configuration.ProcessControlView.$47;
    },

    set_initialJson: function(value) {
        ProcessControl.Configuration.ProcessControlView.$47 = value;
        return value;
    },
    ...
    saveProcess: function(callback) {
        var $$t_3 = this;
        this.$4o_5('UpdateProcess',
            function($p1_0, $p1_1) {
                ProcessControl.Configuration.ProcessControlView.$6m($p1_0, $p1_1);
                if (!IsNull(callback)) {
                    callback($p1_0, $p1_1);
                }
            });
    ...
    saveProcessAs: function() {
        this.$4o_5('SaveAsBpf', this.$$d_$6l_5);
    },

    activateProcess: function() {
        this.validate();
        if (!this.get_validationResult().isValid) {
            ProcessControl.Configuration.ProcessControlView.$6u();
            return;
        }
        this.$6g_5('ActivateBusinessProcess');
        ProcessControl.Configuration.ProcessControlView.$31('/_grid/cmds/dlg_activate.aspx',
            ProcessControl.Configuration.ProcessControlView.activateProcessConfirmationCallback);
    },

    deactivateProcess: function() {
        ProcessControl.Configuration.ProcessControlView.$31('/_grid/cmds/dlg_deactivate.aspx',
            ProcessControl.Configuration.ProcessControlView.deactivateProcessConfirmationCallback);
    },

    deleteProcess: function() {
        ProcessControl.Configuration.ProcessControlView.$6X();
    },
    ...
    $4o_5: function($p0, $p1) {
        ...
        this.$6g_5($p0);
        ProcessControl.Configuration.ProcessControlView.$3I = this.$8Q_5();
        if (!isNullOrEmptyString(ProcessControl.Configuration.ProcessControlView.$3I)) {
            ProcessControl.Configuration.ProcessControlView.get_$2O().forceShow();
            ProcessControl.Configuration.BpfDataUtility
                .executeConfiguratorActionCommand(ProcessControl.Configuration.ProcessControlView.$3I,
                    $p0,
                    $p1,
                    ProcessControl.Configuration.ProcessControlView.$84);
        }
    },
    ...
    titleOrDescriptionChanged: function(eventData) {
        ProcessControl.Configuration.ProcessControlView.$1k = true;
    },

    setTitleAndDescriptionFromForm: function() {
        var $v_0 = this.$8S_5();
        var $v_1 = ProcessControl.Configuration.ProcessControlView.$6M();
        var $v_2 = '';
        if (isNullOrEmptyString($v_1)) {
            $v_1 = $v_2;
        }
            ...
            for (var $v_4 = 0; $v_4 < $v_3.get_Steps().get_Count(); $v_4++) {
                ...
                for (var $v_6 = 0; $v_6 < $v_5.get_Steps().get_Count(); $v_6++) {
                    ...
                    for (var $v_9 = 0; $v_9 < $v_8.get_Steps().get_Count(); $v_9++) {
                        var $v_A = Microsoft.Crm.Workflow.ObjectModel.ControlStep
                            .getControlStep($v_8.get_Steps().get_item($v_9));
                        if (ProcessControl.Configuration.Initializer.get_isProcessUnificationDebugMode()) {
                            if (IsNull($v_A)) {
                                continue;
                            }
                        }
                        var $v_B = ($v_A.get_isSystemControl())
                            ? ProcessControl.Configuration.ProcessConfigurationUtility.getSystemStepControlId($v_A)
                            : $v_A.get_dataFieldName();
    ...
    $6l_5: function($p0, $p1) {
        ...
        if (!isNullOrEmptyString($p0.ReturnValue) && $v_0.indexOf('_error') < 0) {
            ...
            var $v_2 = ProcessControl.Configuration.ProcessControlView.$4f($p0);
            ProcessControl.Configuration.ProcessControlView.$6N($v_2);
        }
    },
...
ProcessControl.Configuration.ProcessControlViewBase$2 = function(element) {
    this.$1H_3 = [];
    this.$b_3 = ((this.$$gta['ProcessControl.Configuration.ProcessControlViewBase$2']['TViewModel'] === Number ||
            Type.isEnum(this.$$gta['ProcessControl.Configuration.ProcessControlViewBase$2']['TViewModel']))
        ? 0
        : (this
            .$$gta['ProcessControl.Configuration.ProcessControlViewBase$2']['TViewModel'] ===
            Boolean)
        ? false
        : null);
    ProcessControl.Configuration.ProcessControlViewBase$2
        .$$(this.$$gta['ProcessControl.Configuration.ProcessControlViewBase$2']['TViewModel'],
            this.$$gta['ProcessControl.Configuration.ProcessControlViewBase$2']['TChildView'])
        .initializeBase(this, [element]);
    this.$4y_3 = $P_CRM(element);
}
ProcessControl.Configuration.ProcessControlViewBase$2.$$ = function(TViewModel, TChildView) {
    var $$cn = 'ProcessControlViewBase$2' +
        '$' +
        TViewModel.getName().replace(/\./g, '_') +
        '$' +
        TChildView.getName().replace(/\./g, '_');
    if (!ProcessControl.Configuration[$$cn]) {
        var $$ccr = ProcessControl.Configuration[$$cn] = function() {
            (this.$$gta = this
                    .$$gta ||
                    {})['ProcessControl.Configuration.ProcessControlViewBase$2'] =
                { 'TViewModel': TViewModel, 'TChildView': TChildView };
            var $v_0 = [];
            for (var $v_1 = 0; $v_1 < arguments.length; ++$v_1) {
                $v_0[$v_1] = arguments[$v_1];
            }
        ...
        $$ccr.registerClass('ProcessControl.Configuration.' + $$cn,
            Mscrm.CrmUIControl,
            ProcessControl.Configuration.IProcessControlViewBase$1.$$(TViewModel),
            ProcessControl.Configuration.IProcessControlView);
...
ProcessControl.Configuration.ProcessControlViewBase$2.prototype = {
    renderView: function() {
        for (var $v_0 = 0; $v_0 < this.$1H_3.length; $v_0++) {
            (this.$1H_3[$v_0]).set_entityMetadata(this.get_entityMetadata());
            (this.$1H_3[$v_0]).renderView();
        }
    },
    ...
    disposeChildViews: function() {
        for (var $v_0 = 0; $v_0 < this.$1H_3.length; $v_0++) {
            if (Sys.IDisposable.isInstanceOfType(this.$1H_3[$v_0])) {
    ...
    validate: function() {
        var $v_0 = true;
        if (IsNull(this.$1H_3)) {
            this.$2m_3 = new Mscrm.ValidationResult(true, null);
            return;
        }
        for (var $v_1 = this.$1H_3.length - 1; $v_1 >= 0; $v_1--) {
            var $v_2 = this.$1H_3[$v_1];
            $v_2.validate();
            if (!IsNull($v_2.get_validationResult()) && !$v_2.get_validationResult().isValid && $v_0) {
                this.$2m_3 = new Mscrm.ValidationResult(false, $v_2.get_validationResult().errorText);
                $v_0 = false;
                this.$A8_3($v_2);
            }
        }
    ...
    $A8_3: function($p0) {
        var $v_0 = ($p0).$s_5;
        if (!IsNull($v_0)) {
            var $v_1 = ProcessControl.Configuration.ProcessConfigurationUtility
                .getIndexFromTabContentId($v_0.get_element().id);
...
ProcessConfiguration.InitializationContext.prototype = {
    ...
    get_$2n_0: function() {
        if (IsNull(this.$3i_0)) {
            this.$3i_0 = $P_CRM.parseJSON(window._Process_JsonData.substr(8));
        }
        return this.$3i_0;
    },
    ...
    get_businessProcessFlowModel: function() {
        if (IsNull(this.$1b_0)) {
            var $v_0 = $P_CRM.parseJSON(this.get_$2n_0().Process.ProcessJson);
            var $v_1 = new Microsoft.Crm.Workflow.ObjectModel.WorkflowStep(this.get_$2n_0().Process.PrimaryEntity, 4);
    ...
    get_entityMetadata: function() {
        if (IsNull(this.$E_0)) {
            this.$E_0 = $P_CRM.parseJSON(this.get_$2n_0().EntityMetadata);
        }
        return this.$E_0;
    },
    ...
    get_relationshipMetadata: function() {
        if (IsNull(this.$t_0)) {
            this.$t_0 = $P_CRM.parseJSON(this.get_$2n_0().RelationshipMetadata);
        }
        return this.$t_0;
    },

    get_stageCategoryMetadata: function() {
        return this.get_$2n_0().StageCategoryMetadata;
    },

    get_processEnabledEntityMetadata: function() {
        return this.get_$2n_0().ProcessEnabledEntityMetadata;
    }
}
...
ProcessConfiguration.Behavior.IStageFocusBehaviorAdapter
    .registerInterface('ProcessConfiguration.Behavior.IStageFocusBehaviorAdapter');


ProcessConfiguration.Behavior.IStageHoverBehaviorAdapter = function() {}
ProcessConfiguration.Behavior.IStageHoverBehaviorAdapter
    .registerInterface('ProcessConfiguration.Behavior.IStageHoverBehaviorAdapter');


ProcessConfiguration.Behavior.IStepFocusBehaviorAdapter = function() {}
ProcessConfiguration.Behavior.IStepFocusBehaviorAdapter
    .registerInterface('ProcessConfiguration.Behavior.IStepFocusBehaviorAdapter');
...
ProcessConfiguration.Behavior.IAddBranchConditionBehaviorAdapter
    .registerInterface('ProcessConfiguration.Behavior.IAddBranchConditionBehaviorAdapter');


ProcessConfiguration.Behavior.IStepHoverBehaviorAdapter = function() {}
ProcessConfiguration.Behavior.IStepHoverBehaviorAdapter
    .registerInterface('ProcessConfiguration.Behavior.IStepHoverBehaviorAdapter');
...
ProcessConfiguration.Behavior.StageFocusEventBubbleBehavior.prototype = {
    onFocused: function(eventHandler) {
        ...
        if (isNullOrEmptyString($v_1) || !Boolean.parse($v_1)) {
            ...
            ProcessConfiguration.Behavior.StageFocusBehavior.set_$3T(null);
        }
...
ProcessConfiguration.Behavior.StageHoverBehavior.prototype = {
    ...
    $5e_4: function() {
        this.get_view().get_$23_5().addClass('pc_stagemo');
        if (Mscrm.InternalUtilities.Utilities.isHighContrastEnabled()) {
            this.get_view().get_$1z_5().addClass('pc_highContrastHover');
            this.get_view().get_$23_5().addClass('pc_highContrastHover');
        }
    },

    $30_4: function() {
        this.get_view().get_$23_5().removeClass('pc_stagemo');
        if (Mscrm.InternalUtilities.Utilities.isHighContrastEnabled()) {
            this.get_view().get_$1z_5().removeClass('pc_highContrastHover');
            this.get_view().get_$23_5().removeClass('pc_highContrastHover');
        }
    }
}
...
ProcessConfiguration.Behavior.StepFocusEventCapturingBehavior.prototype = {
    onFocused: function(eventHandler) {
        ProcessConfiguration.Behavior.StepFocusBehavior.prototype.onFocused.call(this, eventHandler);
        if (this.$1L_4.get_processControlStageViewAdapter() ===
            ProcessConfiguration.Behavior.StageFocusBehavior.$6.$1M_5) {
            return;
        }
        ProcessConfiguration.Behavior.StageFocusBehavior.$6.$1M_5.get_stageFocusBehaviorAdapter().get_instance()
            .$30_4();
    }
}
...
ProcessConfiguration.Behavior.StepHoverBehavior.prototype = {
    onHover: function(eventHandler) {
        ProcessConfiguration.Behavior.StepHoverBehavior.$44 = this.get_view();
        this.$5e_4();
    },
    ...
    onHoverOut: function(eventHandler) {
        ProcessConfiguration.Behavior.StepHoverBehavior.$44 = null;
        this.$30_4();
    },
    ...
    $5e_4: function() {
        ...
        if (Mscrm.InternalUtilities.Utilities.isHighContrastEnabled()) {
            this.get_view().get_$4r_4().addClass('pc_highContrastHover');
            this.get_view().get_$4W_4().addClass('pc_highContrastHover');
        }
    },
    ...
    $30_4: function() {
        ...
        if (Mscrm.InternalUtilities.Utilities.isHighContrastEnabled()) {
            this.get_view().get_$4r_4().removeClass('pc_highContrastHover');
            this.get_view().get_$4W_4().removeClass('pc_highContrastHover');
        }
    },
...
ProcessConfiguration.Behavior.AddEntityBehavior = function(element) {
    ...
    this.$$d_$97_4 = Function.createDelegate(this, this.$97_4);
...
ProcessConfiguration.Behavior.AddEntityBehavior.$AB = function($p0, $p1, $p2) {
...
ProcessConfiguration.Behavior.AddEntityBehavior.prototype = {
    initialize: function() {
        ...
        this.$5r_4();
        this.$9x_4();
        ProcessConfiguration.Behavior.ConfiguratorFlyout
            .createFlyOutMenuDescriptor(this.get_$9_4().$3F_5,
                ProcessControl.Configuration.ProcessConfigurationUtility
                .getEntitiesInProcess(this.get_$9_4().get_dataContext()),
                this.get_$9_4().$t_5,
                this.$$d_clickHandler,
                this.get_$9_4().$1S_5);
    },
    ...
    handleOptionIconClick: function(jQueryEvent) {
        if (IsNull(ProcessConfiguration.Behavior.ConfiguratorFlyout.$m) ||
            ProcessConfiguration.Behavior.ConfiguratorFlyout.$m.get_isDisposed() ||
            !ProcessConfiguration.Behavior.ConfiguratorFlyout.$m.get_visible()) {
            ProcessConfiguration.Behavior.ConfiguratorFlyout.showFlyout();
        } else {
    ...
    get_canAddEntity: function() {
        return !this.get_$9_4().$1S_5 && !this.$8t_4();
    },
    ...
    addChild: function(eventObject) {
        ...
        var $v_2 = ProcessControl.Configuration.ProcessConfigurationUtility
            .getFirstDoNotPersistEntityStep(this.get_$13_4());
        ...
        this.$6p_4($v_3, eventObject);
        ProcessConfiguration.Utility.LabelDictionary.insertIfNotPresent($v_0, $v_1);
        ProcessControl.Configuration.BpfDataUtility.getEntityAndRelationshipMetadata($v_0, this.$$d_$97_4);
    },
    ...
    removeChild: function(eventObject) {
        ...
        this.$9y_4($v_0.get_EntityLogicalName());
        this.$A2_4($v_0);
        this.$A1_4();
        $v_0 = ProcessControl.Configuration.ProcessConfigurationUtility.getLastValidEntityStep(this.get_$13_4());
        this.$A0_4($v_0);
        this.get_$9_4().$1S_5 = false;
        this.$5h_4($v_0.get_EntityLogicalName());
        this.$5j_4($v_0.get_EntityLogicalName());
        ProcessConfiguration.Behavior.ConfiguratorFlyout.hideFlyout();
    ...
    $A1_4: function() {
        var $v_0 = this.get_$9_4().get_$Aa_3().length;
        var $v_1 = null;
        for (var $v_3 = 0; $v_3 < $v_0; $v_3++) {
            if ((this.get_$9_4().get_$Aa_3()[$v_3]).get_dataContext().get_Description() ===
                'DoNotPersist33F3B39A-9705-11E2-B7C4-67BF6188709B') {
                $v_1 = this.get_$9_4().get_$Aa_3()[$v_3];
                break;
            }
        }
        if (!$v_1) {
    ...
    $9x_4: function() {
        for (var $v_0 = 0; $v_0 <= this.get_$9_4().$1D_5; $v_0++) {
            ...
            ProcessConfiguration.Utility.LabelDictionary
                .insertIfNotPresent(this.get_$13_4().get_Steps().get_item($v_0).get_Description(), $v_2.text());
        }
    },

    $8t_4: function() {
        var $v_0 = ProcessControl.Configuration.ProcessConfigurationUtility.getEntitiesInProcess(this.get_$13_4())
            .length;
        return $v_0 >= 5;
    },
    ...
    $7e_4: function($p0) {
        return !(!isNullOrEmptyString($p0) && this.get_$9_4().$1S_5);
    },
    ...
    $5h_4: function($p0) {
        ProcessConfiguration.Behavior.ConfiguratorFlyout
            .createFlyOutMenuDescriptor($p0,
                ProcessControl.Configuration.ProcessConfigurationUtility.getEntitiesInProcess(this.get_$13_4()),
                this.get_$9_4().$t_5,
                this.$$d_clickHandler,
                this.get_$9_4().$1S_5);
    },
    ...
    $8v_4: function() {
        ...
        this.get_$9_4().$1i_5.hideTab($v_0);
        if ($v_0 === this.get_$9_4().$1i_5.getActiveTabId()) {
            this.get_$9_4().$1i_5.showTab($v_1);
            this.get_$9_4().$1i_5.setActiveTab($v_1);
        }
    ...
    get_$13_4: function() {
        if (IsNull(this.$4U_4)) {
            this.$4U_4 = (this.$F_3).get_dataContext().get_parent();
        }
        return this.$4U_4;
    },
    ...
    $6p_4: function($p0, $p1) {
        ...
        ProcessConfiguration.Behavior.AddEntityBehavior.$AB($p0, $v_0, $v_1);
    },
    ...
    $6Z_4: function($p0) {
        ...
        $v_3.text($p0);
        $v_3.attr('title', $p0);
        this.get_$9_4().$1i_5.showTab($v_0);
        this.get_$9_4().$1i_5.setActiveTab($v_0);
    },
...
ProcessConfiguration.Behavior.BehaviorsFactory.prototype = {
    ...
    createAddBranchConditionBehavior: function($p0, $p1, $p2) {
        ...
        $v_0.$2D_4 = $p1.get_stageModel().get_rootWorkflow();
        $v_0.$d_4 = $p1;
        $v_0.$1Y_4 = $p2;
    ...
    createStageFocusBehaviorAdapter: function($p0, $p1) {
        ...
        $v_0.set_instance(this.$7p_0($p0, $p1));
        return $v_0;
    }
}
...
ProcessConfiguration.Behavior.ConfiguratorFlyout.showFlyout = function() {
    ProcessConfiguration.Behavior.ConfiguratorFlyout.$m = Mscrm.FlyOutMenu
        .createFlyOut(ProcessConfiguration.Behavior.ConfiguratorFlyout.$3E);
    ...
    if (!IsNull(ProcessConfiguration.Behavior.ConfiguratorFlyout.$m) &&
        ...
        if (!IsNull($v_1)) {
            ...
            $v_1.bind('click', ProcessConfiguration.Behavior.ConfiguratorFlyout.$9u);
        }
        ProcessConfiguration.Behavior.ConfiguratorFlyout.$86();
        ProcessConfiguration.Behavior.ConfiguratorFlyout.$7B();
    }
}
ProcessConfiguration.Behavior.ConfiguratorFlyout.$9u = function($p0) {
    ProcessConfiguration.Behavior.ConfiguratorFlyout.hideFlyout();
    $p0.preventDefault();
    $p0.stopImmediatePropagation();
}
ProcessConfiguration.Behavior.ConfiguratorFlyout.$7B = function() {
    var $v_0 = $P_CRM('.menuItemName');
    $v_0.wrap('<div class=\'menuItem\'/>');
}
ProcessConfiguration.Behavior.ConfiguratorFlyout.$86 = function() {
...
ProcessConfiguration.Behavior.ConfiguratorFlyout
    .createFlyOutMenuDescriptor = function(lastEntity,
        entitiesInProcess,
        ...
        var $v_2 = ProcessConfiguration.Behavior.ConfiguratorFlyout.$8K(clickHandler);
        $v_2.cssClass = 'sectionTitle';
        var $v_3 = ProcessConfiguration.Behavior.ConfiguratorFlyout.$8J($v_1, entitiesInProcess, clickHandler);
        $v_3.cssClass = $v_0;
        var $v_4 = false;
        if ($v_3.menuListItems.length > 1) {
            $v_4 = true;
        }
        var $v_5 = ProcessConfiguration.Behavior.ConfiguratorFlyout.$8A(entitiesInProcess, isProcessClosed, $v_4);
        var $v_6 = ProcessConfiguration.Behavior.ConfiguratorFlyout.$8P(clickHandler);
        $v_6.cssClass = 'sectionTitle';
        var $v_7 = ProcessConfiguration.Behavior.ConfiguratorFlyout
            .$8O(relationshipDictionary, entitiesInProcess, clickHandler, lastEntity);
        $v_7.cssClass = $v_0;
        var $v_8 = ProcessConfiguration.Behavior.ConfiguratorFlyout.$8c(clickHandler);
...
ProcessConfiguration.Behavior.ConfiguratorFlyout.$8J = function($p0, $p1, $p2) {
    var $v_0 = new Mscrm.MenuSectionDescriptor();
    $v_0.menuListItems = ProcessConfiguration.Behavior.ConfiguratorFlyout.$8I($p0, $p1);
    $v_0.clickHandler = $p2;
    return $v_0;
}
ProcessConfiguration.Behavior.ConfiguratorFlyout.$8O = function($p0, $p1, $p2, $p3) {
    var $v_0 = new Mscrm.MenuSectionDescriptor();
    $v_0.menuListItems = ProcessConfiguration.Behavior.ConfiguratorFlyout.$8N($p0, $p1, $p3);
    $v_0.clickHandler = $p2;
    return $v_0;
}
ProcessConfiguration.Behavior.ConfiguratorFlyout.$8K = function($p0) {
    return ProcessConfiguration.Behavior.ConfiguratorFlyout
        .$4g(window.LOCID_PROCESS_ADDENTITY, 'AddEntity', $p0, window.LOCID_PROCESS_ADDENTITY_TOOLTIP, false);
}
ProcessConfiguration.Behavior.ConfiguratorFlyout.$8A = function($p0, $p1, $p2) {
    var $v_0 = '';
    var $v_1 = false;
    if (!$p2) {
    ...
    var $v_2 = ProcessConfiguration.Behavior.ConfiguratorFlyout.$8T($v_0);
...
ProcessConfiguration.Behavior.ConfiguratorFlyout.$8T = function($p0) {
    return ProcessConfiguration.Behavior.ConfiguratorFlyout.$4g($p0,
        'NoOp',
        function($p1_0) {
        },
        '',
...
ProcessConfiguration.Behavior.ConfiguratorFlyout.$8P = function($p0) {
    return ProcessConfiguration.Behavior.ConfiguratorFlyout
        .$4g(window.LOCID_PROCESS_CLOSELOOP, 'CloseLoop', $p0, window.LOCID_PROCESS_CLOSELOOP_TOOLTIP, false);
}
ProcessConfiguration.Behavior.ConfiguratorFlyout.$8c = function($p0) {
    return ProcessConfiguration.Behavior.ConfiguratorFlyout
        .$4g(window.LOCID_PROCESS_REMOVEENTITY, 'RemoveEntity', $p0, '', true);
}
ProcessConfiguration.Behavior.ConfiguratorFlyout.$4g = function($p0, $p1, $p2, $p3, $p4) {
    var $v_0 = new Mscrm.MenuListItemDescriptor();
    $v_0.title = $v_0.displayName = $p0;
    $v_0.data = ProcessConfiguration.Behavior.ConfiguratorFlyout.$8H($p1);
    if ($p4) {
        $v_0.tabIndex = '0';
    }
...
ProcessConfiguration.Behavior.ConfiguratorFlyout.$8H = function($p0) {
    var $v_0 = {};
    $v_0['Action'] = $p0;
    return $v_0;
}
ProcessConfiguration.Behavior.ConfiguratorFlyout.$8I = function($p0, $p1) {
    var $v_0 = new Array(ProcessConfiguration.Behavior.ConfiguratorFlyout.$8U($p0, $p1) + 1);
    $p0.sort();
    var $v_1 = 0;
    for (var $v_3 = 0; $v_3 < $p0.length; $v_3++) {
        ...
        $v_5.title = $v_5.displayName = ProcessConfiguration.Behavior.ConfiguratorFlyout.$8V($v_4);
        $v_5.data = ProcessConfiguration.Behavior.ConfiguratorFlyout.$8b($v_4);
        $v_5.cssClass = 'menuItemName';
        $v_5.tabIndex = '0';
        $v_0[$v_1++] = $v_5;
    }
    $v_0.sort(ProcessConfiguration.Behavior.ConfiguratorFlyout.$9f);
...
ProcessConfiguration.Behavior.ConfiguratorFlyout.$9f = function($p0, $p1) {
    var $v_0 = ($p0).displayName.toUpperCase();
    var $v_1 = ($p1).displayName.toUpperCase();
    return $v_0.localeCompare($v_1);
}
ProcessConfiguration.Behavior.ConfiguratorFlyout.$8U = function($p0, $p1) {
    var $v_0 = 0;
...
ProcessConfiguration.Behavior.ConfiguratorFlyout.$8N = function($p0, $p1, $p2) {
    ...
    if (!IsNull($v_1)) {
        for (var $v_3 = 0; $v_3 < $v_1.length; $v_3++) {
            ...
            $v_6.data = ProcessConfiguration.Behavior.ConfiguratorFlyout.$8M($v_4);
...
ProcessConfiguration.Behavior.ConfiguratorFlyout.$8M = function($p0) {
    var $v_0 = ProcessConfiguration.Behavior.ConfiguratorFlyout.$6H($p0);
    $v_0['Action'] = 'CloseLoop';
    return $v_0;
}
ProcessConfiguration.Behavior.ConfiguratorFlyout.$8V = function($p0) {
    return String.format('{0} ({1})', $p0.ReferencingEntityLabel, $p0.AttributeLabel);
}
ProcessConfiguration.Behavior.ConfiguratorFlyout.$8b = function($p0) {
    var $v_0 = ProcessConfiguration.Behavior.ConfiguratorFlyout.$6H($p0);
    $v_0['Action'] = 'AddEntity';
    return $v_0;
}
ProcessConfiguration.Behavior.ConfiguratorFlyout.$6H = function($p0) {
    var $v_0 = {};
    if (IsNull($p0)) {
        return $v_0;
    }
...
ProcessConfiguration.Behavior.ConfiguratorUnloadBehavior.setUnloadBehavior = function(pcView, message) {
    ProcessConfiguration.Behavior.ConfiguratorUnloadBehavior.$1t = pcView;
    attachWindowOnBeforeUnload(ProcessConfiguration.Behavior.ConfiguratorUnloadBehavior.$9i, window);
    ProcessConfiguration.Behavior.ConfiguratorUnloadBehavior.$5N = message;
}
ProcessConfiguration.Behavior.ConfiguratorUnloadBehavior.$9i = function($p0) {
    ProcessControl.Configuration.ProcessConfigurationUtility.resetFocusOnActiveControl();
    if (!(IsNull(ProcessConfiguration.Behavior.ConfiguratorUnloadBehavior.$1t)) &&
        !ProcessConfiguration.Behavior.ConfiguratorUnloadBehavior.$1t.get_isDirty()) {
        return;
    }
    $p0.rawEvent.returnValue = ProcessConfiguration.Behavior.ConfiguratorUnloadBehavior.$5N;
...
ProcessConfiguration.Behavior.ExpandCollapseBehavior.setBehavior = function() {
    if (ProcessConfiguration.Behavior.ExpandCollapseBehavior.get_$2r().length > 0) {
        ProcessConfiguration.Behavior.ExpandCollapseBehavior.get_$2r()
            .bind('click', ProcessConfiguration.Behavior.ExpandCollapseBehavior.expandHandler);
        ProcessConfiguration.Behavior.ExpandCollapseBehavior.get_$2r()
            .bind('keyup', ProcessConfiguration.Behavior.ExpandCollapseBehavior.keyUpExpandHandler);
    }
    if (ProcessConfiguration.Behavior.ExpandCollapseBehavior.get_$3O().length > 0) {
        ProcessConfiguration.Behavior.ExpandCollapseBehavior.get_$3O()
            .bind('click', ProcessConfiguration.Behavior.ExpandCollapseBehavior.collapseHandler);
        ProcessConfiguration.Behavior.ExpandCollapseBehavior.get_$3O()
            .bind('keyup', ProcessConfiguration.Behavior.ExpandCollapseBehavior.keyUpCollapseHandler);
    }
}
...
ProcessConfiguration.Behavior.ExpandCollapseBehavior.expandHandler = function(jQueryEvent) {
    ProcessConfiguration.Behavior.ExpandCollapseBehavior.get_$5w().removeClass('collapsed');
    ProcessConfiguration.Behavior.ExpandCollapseBehavior.get_$6z().removeClass('expanded');
    ProcessConfiguration.Behavior.ExpandCollapseBehavior.get_$6R().removeClass('collapsed');
    ProcessConfiguration.Behavior.ExpandCollapseBehavior.get_$6h().slideDown('fast');
    ProcessConfiguration.Behavior.ExpandCollapseBehavior.get_$2r().hide();
    ProcessConfiguration.Behavior.ExpandCollapseBehavior.get_$3O().show();
    ProcessConfiguration.Behavior.ExpandCollapseBehavior.get_$9w().focus();
...
ProcessConfiguration.Behavior.ExpandCollapseBehavior.collapseHandler = function(jQueryEvent) {
    ProcessConfiguration.Behavior.ExpandCollapseBehavior.get_$5w().addClass('collapsed');
    ProcessConfiguration.Behavior.ExpandCollapseBehavior.get_$6z().addClass('expanded');
    ProcessConfiguration.Behavior.ExpandCollapseBehavior.get_$6R().addClass('collapsed');
    ProcessConfiguration.Behavior.ExpandCollapseBehavior.get_$6h().slideUp('fast');
    ProcessConfiguration.Behavior.ExpandCollapseBehavior.get_$3O().hide();
    ProcessConfiguration.Behavior.ExpandCollapseBehavior.get_$2r().show();
    ProcessConfiguration.Behavior.ExpandCollapseBehavior.get_$2r().focus();
    if (IsNull(jQueryEvent)) {
        return;
    }
    jQueryEvent.preventDefault();
...
ProcessConfiguration.Behavior.ExpandCollapseBehavior.get_$6h = function() {
    if (IsNull(ProcessConfiguration.Behavior.ExpandCollapseBehavior.$4E)) {
        ProcessConfiguration.Behavior.ExpandCollapseBehavior.$4E = $P_CRM('#processDetailArea');
    }
    return ProcessConfiguration.Behavior.ExpandCollapseBehavior.$4E;
}
ProcessConfiguration.Behavior.ExpandCollapseBehavior.get_$2r = function() {
    if (IsNull(ProcessConfiguration.Behavior.ExpandCollapseBehavior.$3y)) {
        ProcessConfiguration.Behavior.ExpandCollapseBehavior.$3y = $P_CRM('#expandContainer');
    }
    return ProcessConfiguration.Behavior.ExpandCollapseBehavior.$3y;
}
ProcessConfiguration.Behavior.ExpandCollapseBehavior.get_$3O = function() {
    if (IsNull(ProcessConfiguration.Behavior.ExpandCollapseBehavior.$3j)) {
        ProcessConfiguration.Behavior.ExpandCollapseBehavior.$3j = $P_CRM('#collapseContainer');
    }
    return ProcessConfiguration.Behavior.ExpandCollapseBehavior.$3j;
}
ProcessConfiguration.Behavior.ExpandCollapseBehavior.get_$9w = function() {
    if (IsNull(ProcessConfiguration.Behavior.ExpandCollapseBehavior.$4F)) {
        ProcessConfiguration.Behavior.ExpandCollapseBehavior.$4F = $P_CRM('#ProcessName');
    }
    return ProcessConfiguration.Behavior.ExpandCollapseBehavior.$4F;
}
ProcessConfiguration.Behavior.ExpandCollapseBehavior.get_$5w = function() {
    if (IsNull(ProcessConfiguration.Behavior.ExpandCollapseBehavior.$3k)) {
        ProcessConfiguration.Behavior.ExpandCollapseBehavior.$3k = $P_CRM('#pcc');
    }
    return ProcessConfiguration.Behavior.ExpandCollapseBehavior.$3k;
}
ProcessConfiguration.Behavior.ExpandCollapseBehavior.get_$6z = function() {
    if (IsNull(ProcessConfiguration.Behavior.ExpandCollapseBehavior.$4Q)) {
        ProcessConfiguration.Behavior.ExpandCollapseBehavior.$4Q = $P_CRM('.pc_en_slc');
    }
    return ProcessConfiguration.Behavior.ExpandCollapseBehavior.$4Q;
}
ProcessConfiguration.Behavior.ExpandCollapseBehavior.get_$6R = function() {
    if (IsNull(ProcessConfiguration.Behavior.ExpandCollapseBehavior.$46)) {
        ProcessConfiguration.Behavior.ExpandCollapseBehavior.$46 = $P_CRM('#includedEntities');
    }
    return ProcessConfiguration.Behavior.ExpandCollapseBehavior.$46;
}
...
ProcessConfiguration.Behavior.ShowImageUploaderBehavior.get_instance = function() {
    if (IsNull(ProcessConfiguration.Behavior.ShowImageUploaderBehavior._instance)) {
        ProcessConfiguration.Behavior.ShowImageUploaderBehavior._instance = new ProcessConfiguration.Behavior
            .ShowImageUploaderBehavior();
    }
...
ProcessConfiguration.Behavior.MoveBehavior.prototype = {
    initialize: function() {
        Mscrm.CrmUIBehavior.prototype.initialize.call(this);
        this.$5o_3 = $find('pcc_tabs');
        if (!$P_CRM('#pcc_up_img').length &&
            !ProcessControl.Configuration.ProcessConfigurationUtility.isProcessReadonly()) {
            this.renderUpAndDownArrows();
        }
        this.$U_3 = $P_CRM('#pcc_up_img');
        this.$T_3 = $P_CRM('#pcc_down_img');
        this.$1j_3 = $P_CRM('#pcc_updown_arrows_text');
        this.disableUpAndDownArrows();
        ProcessControl.Configuration.ProcessEventAggregator.get_instance()
            .subscribe('stageselected', this.$$d_enableDisableUpDownArrows);
        ProcessControl.Configuration.ProcessEventAggregator.get_instance()
            .subscribe('stepselected', this.$$d_enableDisableUpDownArrows);
    },

    renderUpAndDownArrows: function() {
        var $v_0 = $P_CRM(String.format('<img tabIndex=0 id=\'{0}\' title=\'{1}\'/>',
            CrmEncodeDecode.CrmHtmlAttributeEncode('pcc_up_img'),
            CrmEncodeDecode.CrmHtmlAttributeEncode(window.LOCID_PROCESS_MOVE_UP)));
        var $v_1 = $P_CRM(String.format('<img tabIndex=0 id=\'{0}\' title=\'{1}\'/>',
            CrmEncodeDecode.CrmHtmlAttributeEncode('pcc_down_img'),
            CrmEncodeDecode.CrmHtmlAttributeEncode(window.LOCID_PROCESS_MOVE_DOWN)));
        var $v_2 = $P_CRM(String.format('<p id=\'{0}\' class=\'{1}\'>{2}</p>',
            CrmEncodeDecode.CrmHtmlAttributeEncode('pcc_updown_arrows_text'),
            CrmEncodeDecode.CrmHtmlAttributeEncode('pcc_updown_text'),
            CrmEncodeDecode.CrmHtmlEncode(window.LOCID_PROCESS_MOVE)));
    ...
    handleStepFocus: function() {
        if (!IsNull(ProcessConfiguration.Behavior.StepFocusBehavior.$j)) {
            ...
            if (ProcessConfiguration.Behavior.StageFocusBehavior.$6.get_$Aa_3().length === 1) {
                this.disableText();
            }
            return true;
        }
    ...
    handleStageFocus: function() {
        ...
        if (!IsNull($v_0) && !IsNull((($v_0.get_id()) in $v_0.$2_5.get_stageViewsById()))) {
            ...
            if (IsNull($v_1.get_previousNavigationInfo()) ||
                IsNull($v_1.get_previousNavigationInfo().get_previousNavigationInfo())) {
                this.disableUpArrow();
            }
            ...
            if (!IsNull(ProcessConfiguration.Behavior.StageFocusBehavior.$6.$s_5)) {
                if (ProcessConfiguration.Behavior.StageFocusBehavior.$6.$s_5.get_$Aa_3().length === 1) {
                    this.disableText();
                }
            }
            return true;
    ...
    enableText: function() {
        this.$1j_3.removeClass('pcc_updown_text_disabled');
        this.$1j_3.text(window.LOCID_PROCESS_MOVE);
    },

    enableUpArrow: function() {
        this.$U_3.removeClass(this.get_$3R_3().cssClass);
        this.$U_3.addClass(this.get_$2q_3().cssClass);
        this.$U_3.attr('src', this.get_$2q_3().source);
    ...
    enableDownArrow: function() {
        ...
        this.$T_3.addClass(this.get_$2p_3().cssClass);
        this.$T_3.attr('src', this.get_$2p_3().source);
    ...
    disableText: function() {
        this.$1j_3.addClass('pcc_updown_text_disabled');
    },
    ...
    disableUpArrow: function() {
        this.$U_3.removeClass(this.get_$2q_3().cssClass);
        this.$U_3.removeClass(this.get_$4j_3().cssClass);
    ...
    disableDownArrow: function() {
        this.$T_3.removeClass(this.get_$2p_3().cssClass);
        this.$T_3.removeClass(this.get_$4i_3().cssClass);
    ...
    upArrowMouseEnter: function($p0) {
        ...
        this.$U_3.removeClass(this.get_$2q_3().cssClass);
        this.$U_3.attr('src', this.get_$4j_3().source);
        this.$U_3.addClass(this.get_$4j_3().cssClass);
        this.$1j_3.text(window.LOCID_PROCESS_MOVE_UP);
    },
    ...
    downArrowMouseEnter: function($p0) {
        ...
        this.$T_3.removeClass(this.get_$2p_3().cssClass);
        this.$T_3.attr('src', this.get_$4i_3().source);
        this.$T_3.addClass(this.get_$4i_3().cssClass);
        this.$1j_3.text(window.LOCID_PROCESS_MOVE_DOWN);
    },
    ...
    handleKeyboardUp: function($p0) {
        if ($p0.which === 38 && !this.$70_3($p0.target)) {
            $p0.preventDefault();
            $p0.stopPropagation();
            this.moveUp($p0);
        }
    ...
    handleKeyboardDown: function($p0) {
        if ($p0.which === 40 && !this.$70_3($p0.target)) {
            $p0.preventDefault();
            $p0.stopPropagation();
            this.moveDown($p0);
        }
    ...
    $70_3: function($p0) {
        if ($p0.id
            .endsWith('_sp_f_i') ||
            $p0.id.endsWith('_StageCategory_i') ||
            $p0.id.endsWith('_StageParentEntity_i')) {
            return true;
        }
        return false;
    },
    ...
    moveUp: function($p0) {
        ...
        $p0.stopPropagation();
        if (IsNull(ProcessConfiguration.Behavior.StageFocusBehavior.$6) ||
            Mscrm.MaskPanel.get_instance().get_isDisplayed()) {
            return;
        }
        if (!IsNull(ProcessConfiguration.Behavior.StepFocusBehavior.$j)) {
            this.$6b_3(-1);
    ...
    get_$2q_3: function() {
        if (IsNull(this.$3t_3)) {
            this.$3t_3 = Mscrm.ImageStrip.getImageInfo(Mscrm.CrmUri
                .create(window.CDNURL + '/_imgs/processcontrol/30_enabled_move_up.png'));
        }
        return this.$3t_3;
    },
    ...
    get_$2p_3: function() {
        if (IsNull(this.$3r_3)) {
            this.$3r_3 = Mscrm.ImageStrip.getImageInfo(Mscrm.CrmUri
                .create(window.CDNURL + '/_imgs/processcontrol/30_enabled_move_down.png'));
        }
        return this.$3r_3;
    },
    ...
    get_$4j_3: function() {
        if (IsNull(this.$45_3)) {
            this.$45_3 = Mscrm.ImageStrip.getImageInfo(Mscrm.CrmUri
                .create(window.CDNURL + '/_imgs/processcontrol/30_moveuphover.png'));
        }
        return this.$45_3;
    },
    ...
    get_$4i_3: function() {
        if (IsNull(this.$42_3)) {
            this.$42_3 = Mscrm.ImageStrip.getImageInfo(Mscrm.CrmUri
                .create(window.CDNURL + '/_imgs/processcontrol/30_movedownhover.png'));
        }
        return this.$42_3;
    },
    ...
    get_$3R_3: function() {
        if (IsNull(this.$3p_3)) {
            this.$3p_3 = Mscrm.ImageStrip.getImageInfo(Mscrm.CrmUri
                .create(window.CDNURL + '/_imgs/processcontrol/30_disabled_move_up.png'));
        }
        return this.$3p_3;
    },
    ...
    get_$3Q_3: function() {
        if (IsNull(this.$3n_3)) {
            this.$3n_3 = Mscrm.ImageStrip.getImageInfo(Mscrm.CrmUri
                .create(window.CDNURL + '/_imgs/processcontrol/30_disabled_move_down.png'));
        }
        return this.$3n_3;
    },
...
ProcessConfiguration.Behavior.ResizeBehavior.setResizeBehavior = function() {
    $P_CRM(window).resize(ProcessConfiguration.Behavior.ResizeBehavior.$AZ);
}
ProcessConfiguration.Behavior.ResizeBehavior.$AZ = function($p0) {
...
ProcessConfiguration.Behavior.AddBranchConditionBehaviorAdapter.prototype = {
    initialize: function() {
        ...
        var $v_0 = this.$b_0;
        this.$5_1 = this.$J_1.createAddBranchConditionBehavior(this.$B_1, $v_0, this.$1T_0);
        this.$5_1.initialize();
    },
...
ProcessConfiguration.Behavior.FocusBehaviorBase$1 = function(element) {
    this.$$d_$89_3 = Function.createDelegate(this, this.$89_3);
    this.$$d_onFocused = Function.createDelegate(this, this.onFocused);
    this.$1N_3 = ((this.$$gta['ProcessConfiguration.Behavior.FocusBehaviorBase$1']['T'] === Number ||
            Type.isEnum(this.$$gta['ProcessConfiguration.Behavior.FocusBehaviorBase$1']['T']))
        ? 0
        : (this.$$gta['ProcessConfiguration.Behavior.FocusBehaviorBase$1']['T'] === Boolean) ? false : null);
    ProcessConfiguration.Behavior.FocusBehaviorBase$1.$$(this
        .$$gta['ProcessConfiguration.Behavior.FocusBehaviorBase$1']['T']).initializeBase(this, [element]);
...
ProcessConfiguration.Behavior.FocusBehaviorBase$1.prototype = {
    ...
    dispose: function() {
        ...
        if (Sys.Browser.agent === Sys.Browser.InternetExplorer) {
            ...
            this.$y_3.get(0).removeEventListener('focus', this.$40_3, true);
        }
        Mscrm.CrmUIBehavior.prototype.dispose.call(this);
    },
    ...
    bindEvents: function() {
        if (Sys.Browser.agent === Sys.Browser.InternetExplorer) {
            ...
            this.$40_3 = this.$$d_$89_3;
            this.$y_3.get(0).addEventListener('focus', this.$40_3, true);
        }
    },
...
ProcessConfiguration.Behavior.HoverBehavior$1 = function(element) {
    ...
    ProcessConfiguration.Behavior.HoverBehavior$1.$$(this.$$gta['ProcessConfiguration.Behavior.HoverBehavior$1']['T'])
        .initializeBase(this, [element]);
    this.$y_3 = $P_CRM(element);
}
...
ProcessConfiguration.Behavior.HoverBehavior$1.prototype = {
    ...
    bindEvents: function() {
        ...
        this.get_deleteIcon().bind('mouseover', this.$$d_$9k_3);
        this.get_deleteIcon().bind('mouseout', this.$$d_$9l_3);
    },

    $9k_3: function($p0) {
        var $v_0 = this.get_deleteIcon().children(':first-child');
        $v_0.attr('src', this.get_$6Q_3().source);
        $v_0.attr('class', this.get_$6Q_3().cssClass + ' ' + 'pc_step_d_img');
    },

    $9l_3: function($p0) {
        var $v_0 = this.get_deleteIcon().children(':first-child');
        $v_0.attr('src', this.get_$5z_3().source);
        $v_0.attr('class', this.get_$5z_3().cssClass + ' ' + 'pc_step_d_img');
    },
    ...
    get_$6Q_3: function() {
        if (IsNull(this.$43_3)) {
            this.$43_3 = Mscrm.ImageStrip.getImageInfo(Mscrm.CrmUri
                .create(window.CDNURL + '/_imgs/processcontrol/12_active_config_delete.png'));
        }
        return this.$43_3;
    },
    ...
    get_$5z_3: function() {
        if (IsNull(this.$3m_3)) {
            this.$3m_3 = Mscrm.ImageStrip.getImageInfo(Mscrm.CrmUri
                .create(window.CDNURL + '/_imgs/processcontrol/12_inactive_config_delete.png'));
        }
        return this.$3m_3;
    },
...
ProcessConfiguration.Behavior.StageFocusBehavior = function(element) {
    this.$$d_$9b_4 = Function.createDelegate(this, this.$9b_4);
    ProcessConfiguration.Behavior.StageFocusBehavior.initializeBase(this, [element]);
}
ProcessConfiguration.Behavior.StageFocusBehavior.set_$3T = function($p0) {
    if (ProcessConfiguration.Behavior.StageFocusBehavior.$6 !== $p0) {
        ...
        if (!IsNull(ProcessConfiguration.Behavior.StageFocusBehavior.$6)) {
            try {
                $removeHandler(ProcessConfiguration.Behavior.StageFocusBehavior.$6.get_element(),
                    'keydown',
                    ProcessConfiguration.Behavior.StageFocusBehavior.$6.$$d_addStepKeyBoardShortcut);
            } catch ($$e_1) {
            }
            $addHandler(ProcessConfiguration.Behavior.StageFocusBehavior.$6.get_element(),
                'keydown',
                ProcessConfiguration.Behavior.StageFocusBehavior.$6.$$d_addStepKeyBoardShortcut);
        }
        ProcessConfiguration.Behavior.StageFocusBehavior.$6i();
    }
    return $p0;
}
ProcessConfiguration.Behavior.StageFocusBehavior.$6i = function() {
    var $v_0 = ProcessControl.Configuration.ProcessEventAggregator.get_instance();
    try {
...
ProcessConfiguration.Behavior.StageFocusBehavior.prototype = {
    ...
    onFocused: function(eventHandler) {
        ProcessConfiguration.Behavior.StageFocusBehavior.set_$3T(this.get_view());
    },

    $30_4: function() {
        this.get_view().get_$23_5().removeClass('pc_stagehl');
        if (Mscrm.InternalUtilities.Utilities.isHighContrastEnabled()) {
            this.get_view().get_$23_5().removeClass('pc_highContrastFocused');
            this.get_view().get_$1z_5().removeClass('pc_highContrastFocused');
        }
    },

    makeSelection: function() {
        this.get_view().get_$23_5().addClass('pc_stagehl');
        if (Mscrm.InternalUtilities.Utilities.isHighContrastEnabled()) {
            this.get_view().get_$23_5().addClass('pc_highContrastFocused');
            this.get_view().get_$1z_5().addClass('pc_highContrastFocused');
        }
        this.get_view().get_elementWrapper().bind('keydown', this.$$d_$9b_4);
    },
    ...
    $Z_4: function($p0) {
        return this.get_view().get_$1A_5().is(':visible') &&
            ProcessControl.Configuration.BpfMenuActions.isCtrlKeyPressed($p0);
    }
}
...
ProcessConfiguration.Behavior.StepFocusBehavior.set_focusedStep = function(value) {
    if (!IsNull(ProcessConfiguration.Behavior.StepFocusBehavior.$j) &&
        ProcessConfiguration.Behavior.StepFocusBehavior.$j.$19_4) {
    ...
    if (!IsNull(ProcessConfiguration.Behavior.StepFocusBehavior.$j) &&
        ProcessConfiguration.Behavior.StepFocusBehavior.$j.$19_4) {
        ProcessConfiguration.Behavior.StepFocusBehavior.$j.$19_4.get_stepFocusBehaviorAdapter().get_instance().$5e_4();
    }
    ProcessConfiguration.Behavior.StepFocusBehavior.$6i();
    return value;
}
ProcessConfiguration.Behavior.StepFocusBehavior.$6i = function() {
    var $v_0 = ProcessControl.Configuration.ProcessEventAggregator.get_instance();
    try {
...
ProcessConfiguration.Behavior.StepFocusBehavior.prototype = {
    ...
    $30_4: function() {
        ...
        if (Mscrm.InternalUtilities.Utilities.isHighContrastEnabled()) {
            this.get_view().get_$4r_4().removeClass('pc_highContrastFocused');
            this.get_view().get_$4W_4().removeClass('pc_highContrastFocused');
        }
    }
}
...
ProcessConfiguration.Builder.IInlineEditControlBuilder
    .registerInterface('ProcessConfiguration.Builder.IInlineEditControlBuilder');


ProcessConfiguration.Builder.IRelationshipsTableBuilder = function() {}
ProcessConfiguration.Builder.IRelationshipsTableBuilder
    .registerInterface('ProcessConfiguration.Builder.IRelationshipsTableBuilder');
...
ProcessConfiguration.Builder.ImageBuilder.prototype = {
    build: function(iconPath, title, altText) {
        var $v_0 = this.$2B_0.getImageFromPath(iconPath);
...
ProcessConfiguration.Builder.PageBuilder.prototype = {
    buildStageDetailsColumn: function(stageViewModel) {
        ...
        $v_0.addClass('column');
        var $v_1 = this.$7T_2(stageViewModel);
        $v_0.append($v_1);
        var $v_2 = this.$7U_2(stageViewModel);
        $v_0.append($v_2);
        var $v_3 = this.$7V_2(stageViewModel);
        $v_0.append($v_3);
        return $v_0;
    },
    ...
    buildStageStepsColumn: function(pageViewModel) {
        ...
        $v_0.append($v_2);
        var $v_3 = this.$k_1.build(null,
            'add-step',
            '/_imgs/processcontrol/white_plus_16.png',
            window.LOCID_PROCESS_ADDSTEP,
            window.LOCID_PROCESS_ADDSTEP);
        $v_0.append($v_3);
        return $v_0;
    },
    ...
    $7V_2: function($p0) {
        ...
        var $v_1 = this.buildInlineEditControl($p0.get_stageModel().get_stageStep().get_Name(),
            window.LOCID_PROCESS_STAGEUNIQUENAME,
            'page-unique-name',
            $v_0,
            false);
        return $v_1;
    ...
    $7U_2: function($p0) {
        var $v_0 = ProcessControl.Configuration.ProcessEnabledEntities
            .getLabelByLogicalName($p0.get_entityLogicalName());
        var $v_1 = String.format('{0}_PageParentEntity', $p0.get_stageId());
        var $v_2 = this.buildInlineEditControl($v_0,
            window.LOCID_PROCESS_STAGE_ENTITYNAME,
            'stage-parent-entity',
            $v_1,
            true);
        return $v_2;
...
ProcessConfiguration.Builder.RelationshipsTableBuilder.prototype = {
    build: function($p0, $p1) {
        ...
        for (var $v_6 = 0; $v_6 < $p0.get_picklistCount(); $v_6++) {
            ...
            var $v_H = Mscrm.InlineControlFactory
                .createInlineAutoCompletePicklistControlForDom($v_G.get_jQueryObject(),
                    'inlineControl' + $v_6,
                    $v_8,
                    $p0.getDefaultRelationshiupEnum($v_6.toString()).toString(),
                    '',
                    0,
                    'alwaysedit',
                    '',
...
ProcessConfiguration.Builder.StageBuilder.prototype = {
    ...
    buildStageDeleteColumn: function(stageViewModel) {
        ...
        $v_0.addClass('delete');
        $v_0.addClass('column');
        var $v_1 = this.$7Z_1(stageViewModel);
        $v_0.append($v_1);
        return $v_0;
    },
    ...
    buildStageDetailsColumn: function(stageViewModel) {
        ...
        $v_0.addClass('details');
        $v_0.addClass('column');
        var $v_1 = this.$7b_1(stageViewModel);
        $v_0.append($v_1);
        var $v_2 = this.$7c_1(stageViewModel);
        $v_0.append($v_2);
        var $v_3 = this.$7d_1(stageViewModel);
        $v_0.append($v_3);
        var $v_4 = this.$7X_1(stageViewModel);
        $v_0.append($v_4);
        return $v_0;
    },
    ...
    $7X_1: function($p0) {
        ...
        var $v_2 = this.buildInlineEditControl($v_1,
            window.LOCID_PROCESS_STAGE_CATEGORYNAME,
            'stage-category',
            $v_0,
            false);
        return $v_2;
    ...
    $7d_1: function($p0) {
        var $v_0 = this.$6k_1(window.LOCID_PROCESS_RELATION_TITLE, false);
    ...
    $7Z_1: function($p0) {
        var $v_0 = this.$7Y_1('', 'delete-stage');
        return $v_0;
    },
    ...
    $7Y_1: function($p0, $p1) {
        ...
        $v_0.addClass('row');
        var $v_2 = this.$k_1.build(null,
            'delete-stage',
            window.CDNURL + '/_imgs/processcontrol/12_inactive_config_delete.png',
            $v_1,
            $v_1);
        $v_0.append($v_2);
        return $v_0;
    ...
    buildInlineEditControl: function(valueText, labelText, className, controlId, isRequired) {
        var $v_0 = this.$6k_1(labelText, isRequired);
    ...
    buildStageElement: function(stageViewModel) {
        ...
        var $v_1 = this.$7W_1(stageViewModel);
        $v_0.append($v_1);
        var $v_2 = this.$7a_1();
        $v_0.append($v_2);
        return $v_0;
...
ProcessConfiguration.Builder.StepBuilder.createStepBuilder = function(businessProcessType) {
    return (businessProcessType === 1)
        ? new ProcessConfiguration.Builder.PageStepBuilder()
        : new ProcessConfiguration.Builder.StepBuilder();
}
ProcessConfiguration.Builder.StepBuilder.prototype = {
    ...
    renderStepName: function(wrapper, stepId) {
        ...
        var $v_3 = ProcessControl.Configuration.ProcessConfigurationUtility
            .getStepLabelForCurrentUser(wrapper.get_stepLabels(), wrapper.get_stepStepId()).get_description();
    ...
    renderStepOptions: function(stepId, stepElementIdFormat) {
        ...
        var $v_3 = (stepElementIdFormat === '{0}_s')
            ? window.LOCID_PROCESS_PAGE_SOURCENAME
            : window.LOCID_PROCESS_PAGE_FIELDNAME;
        var $v_4 = this.$17_1.build(null, $v_2, $v_3);
        $v_0.append($v_4);
        return $v_0;
    },
...
ProcessConfiguration.Models.ISystemControlAttributeMetadataModel
    .registerInterface('ProcessConfiguration.Models.ISystemControlAttributeMetadataModel');


ProcessConfiguration.Models.ISystemControlMetadataModel = function() {}
ProcessConfiguration.Models.ISystemControlMetadataModel
    .registerInterface('ProcessConfiguration.Models.ISystemControlMetadataModel');


ProcessConfiguration.Models.IMetadataModelFactory = function() {}
ProcessConfiguration.Models.IMetadataModelFactory
    .registerInterface('ProcessConfiguration.Models.IMetadataModelFactory');


ProcessConfiguration.Models.IAttributeMetadataModel = function() {}
ProcessConfiguration.Models.IAttributeMetadataModel
    .registerInterface('ProcessConfiguration.Models.IAttributeMetadataModel');
    ...
    isValid: function(allAvailableRelationships) {
        ...
        if (((this._sourceStageId) in allAvailableRelationships)) {
            ...
            for (var $v_2 = 0; $v_2 < $v_1.get_count(); $v_2++) {
                ...
                if ($v_3.get_targetStageId() === this._targetStageId &&
                    $v_3.get_attributeLogicalName() === this._attributeLogicalName &&
                    $v_3.get_relationshipName() === this._relationshipName &&
                    $v_3.get_targetStageEntityLogicalName() === this._targetStageEntityLogicalName) {
                    $v_0 = true;
...
ProcessConfiguration.Models.EntityMetadataModel.prototype = {
    $90_0: function() {
        this.$26_0 = new (Sales.Common.Framework.List$1.$$(ProcessConfiguration.Models.IAttributeMetadataModel))();
        var $v_0 = this.$E_0.Fields;
        var $v_1 = this.$W_0.retrieveSystemControlsForEntity(this.$K_0);
        for (var $v_2 = 0; $v_2 < $v_1.get_count(); $v_2++) {
            this.$26_0.add($v_1.get_item($v_2));
        }
    ...
    $9I_0: function() {
        this.$1h_0 = new (Sales.Common.Framework.List$1.$$(ProcessControl.Configuration.SourceData))();
        ...
        if ($v_4) {
            for (var $v_5 = 0; $v_5 < $v_4.length; $v_5++) {
                var $v_6 = $v_4[$v_5];
                var $v_7 = String.format('{0} ({1})',
                    $v_6.RelationshipAttribute.Label.Description,
                    $v_6.RelationshipEntity.DisplayName);
                var $v_8 = ProcessControl.Configuration.SourceData
                    .create($v_6.RelationshipEntity.EntityLogicalName, $v_7, 0);
                $v_8.$1F_0 = $v_6.RelationshipName;
                $v_8.$2C_0 = $v_6.RelationshipAttribute.LogicalName;
                this.$1h_0.add($v_8);
            }
        }
    },
...
ProcessConfiguration.Models.AttributeMetadataModel.prototype = {
    ...
    get_logicalName: function() {
        return this.$56_0 || (this.$56_0 = this.$I_0.LogicalName);
    },
...
ProcessConfiguration.Models.SystemControlMetadataModel.prototype = {
    ...
    get_$5U_0: function() {
        return this.$52_0 || (this.$52_0 = new ProcessConfiguration.Events.EventManager());
    },
    ...
    get_$6x_0: function() {
        ...
        this.$2G_0 = {};
        this.$2G_0['lead'] = this.get_$2z_0();
        this.$2G_0['incident'] = this.get_$1m_0();
        return this.$2G_0;
    },
    ...
    get_$6y_0: function() {
        ...
        for (var $v_0 = 0; $v_0 < this.get_$2z_0().get_count(); $v_0++) {
            ...
            this.$2H_0[$v_1.get_logicalName()] = $v_1;
        }
        for (var $v_2 = 0; $v_2 < this.get_$1m_0().get_count(); $v_2++) {
            var $v_3 = this.get_$1m_0().get_item($v_2);
            this.$2H_0[$v_3.get_logicalName()] = $v_3;
        }
        return this.$2H_0;
    },
    ...
    get_$4s_0: function() {
        return this.$5M_0 || (this.$5M_0 = {});
    },

    $7Q_0: function() {
        this.$2V_0 = new (Sales.Common.Framework.List$1.$$(ProcessConfiguration.Models
            .ISystemControlAttributeMetadataModel))();
        var $v_0 = this.$Y_0.createSystemControlMetadata(3);
        this.get_$1m_0().add($v_0);
        ...
        this.get_$1m_0().add($v_0);
        return this.get_$1m_0();
    },

    $7S_0: function() {
        this.$2X_0 = new (Sales.Common.Framework.List$1.$$(ProcessConfiguration.Models
            .ISystemControlAttributeMetadataModel))();
    ...
    add_availableSystemControlsRefreshed: function(value) {
        this.get_$5U_0().addHandler('AvailableSystemControlsRefreshed', value);
    },

    remove_availableSystemControlsRefreshed: function(value) {
        this.get_$5U_0().removeHandler('AvailableSystemControlsRefreshed', value);
    },

    retrieveSystemControlsForEntity: function(entityLogicalName) {
        var $v_0 = new (Sales.Common.Framework.List$1.$$(ProcessConfiguration.Models
            .ISystemControlAttributeMetadataModel))();
        if (!((entityLogicalName) in this.get_$6x_0())) {
            return $v_0;
        }
        $v_0 = this.get_$6x_0()[entityLogicalName];
        return $v_0;
    },
    ...
    retrieveMetadataByLogicalName: function(logicalName) {
        if (!((logicalName) in this.get_$6y_0())) {
            return null;
        }
        var $v_0 = this.get_$6y_0()[logicalName];
        return $v_0;
    },
    ...
    refreshAvailableSystemControls: function(oldAttributeLogicalName, newAttributeLogicalName) {
        ...
        var $v_0 = !_String.isNullOrWhiteSpace(oldAttributeLogicalName) &&
            ((oldAttributeLogicalName) in this.get_$4s_0());
        if ($v_0) {
            delete this.get_$4s_0()[oldAttributeLogicalName];
        }
        if (!_String.isNullOrWhiteSpace(newAttributeLogicalName)) {
            this.get_$4s_0()[newAttributeLogicalName] = 1;
        }
        var $v_1 = new ProcessConfiguration.Models.AvailableSystemControlsRefreshedEventArgs();
        $v_1.$4A_1 = oldAttributeLogicalName;
        $v_1.$48_1 = newAttributeLogicalName;
        this.get_$5U_0().fireEvent('AvailableSystemControlsRefreshed', this, $v_1);
    },

    checkAvailability: function(systemStepMetadata) {
        var $v_0 = ((systemStepMetadata.get_logicalName()) in this.get_$4s_0());
        return !$v_0;
    }
}
...
ProcessConfiguration.Services.IRelationshipFilteringService
    .registerInterface('ProcessConfiguration.Services.IRelationshipFilteringService');
...
ProcessConfiguration.Services.RelationshipFilteringService.prototype = {
    getAllAvailableRelationships: function(targetStageId) {
        ...
        var $v_1 = {};
        var $v_2 = this.$AL_0($v_0);
        for (var $v_3 = 0; $v_3 < $v_2.get_count(); ++$v_3) {
            var $v_4 = this.$2_0.getStageViewById($v_2.get_item($v_3));
            $v_1[$v_2.get_item($v_3)] = this.$85_0(this.$1_0.get_entityRelationshipMetadata()[$v_4.get_viewModel()
                    .get_entityLogicalName()],
                $v_2.get_item($v_3),
                $v_0.get_viewModel().get_stageId(),
                $v_0.get_viewModel().get_entityLogicalName());
        }
        return $v_1;
    },
                ...
                if (!$v_1.contains($v_2)) {
                    ...
                    if ($v_3.get_conditionView() && $v_3.get_conditionView().get_children().get_count() > 0) {
                        for (var $v_4 = 0; $v_4 < $v_3.get_conditionView().get_children().get_count(); ++$v_4) {
                            var $v_5 = this.$6j_0($v_3.get_conditionView().get_children().get_item($v_4), $v_2);
                            $v_0.addRange($v_5.toArray());
                        }
                    }
                }
            } else if (ProcessConfiguration.View.IConditionBranchView
                .isInstanceOfType($p0.get_previousNavigationInfo())) {
        ...
        while ($v_2) {
            if ($v_2.get_conditionView() && $v_2.get_conditionView().get_children().get_count() > 0) {
                for (var $v_3 = 0; $v_3 < $v_2.get_conditionView().get_children().get_count(); ++$v_3) {
                    var $v_4 = this.$6j_0($v_2.get_conditionView().get_children().get_item($v_3), $p1);
            ...
            if ($v_2.get_nextStageView()) {
                ...
                if (!$v_0.contains($p1) && $v_2.get_viewModel().get_entityLogicalName() !== $p1 && !this.$6O_0($v_2)) {
    ...
    $85_0: function($p0, $p1, $p2, $p3) {
        ...
        for (var $v_1 = 0; $v_1 < $p0.get_count(); ++$v_1) {
            if ($p0.get_item($v_1).get_targetStageEntityLogicalName() === $p3) {
                var $v_2 = this.$7i_0($p0.get_item($v_1));
...
ProcessConfiguration.Services.MetadataService.prototype = {
    ...
    initialize: function(initializationContext) {
        ...
        this.$2T_0 = this.$7o_0(initializationContext.get_relationshipMetadata());
        this.$4N_0 = initializationContext.get_stageCategoryMetadata();
        ProcessControl.Configuration.StageCategory.initialize(this.$4N_0);
        ProcessControl.Configuration.ProcessEnabledEntities
            .initialize(initializationContext.get_processEnabledEntityMetadata());
        this.$5A_0 = ProcessControl.Configuration.ProcessEnabledEntities.getEnumOptions();
    },
    ...
    retrieveEntityMetadataAsync: function(entityLogicalName) {
        ...
        if (Microsoft.Crm.Workflow.Utils.SharedUtility
            .dictionaryContainKey(String, Object, this.$E_0, entityLogicalName)) {
            $v_0.resolve();
        } else {
            var $$t_7 = this;
            ProcessControl.Configuration.BpfDataUtility.getEntityMetadata(entityLogicalName,
                function($p1_0, $p1_1) {
                    var $v_1 = $P_CRM.parseJSON($p1_0.ReturnValue.toString().substr(8));
                    var $v_2 = $p1_1.GetParameter('entityName').Value;
                    var $v_3 = $P_CRM.parseJSON($v_1.EntityMetadata);
                    $$t_7.$E_0[$v_2] = $v_3[$v_2];
                    $v_0.resolve($v_1);
                });
        }
    ...
    retrieveEntityAndRelationshipMetadataAsync: function(entityLogicalName) {
        var $v_0 = jQueryApi.jQueryDeferredFactory.Deferred(ProcessControl.Configuration.ClientDataJsonWrapper, Object);
        if (this.$8s_0(entityLogicalName)) {
            $v_0.resolve();
        } else {
            var $$t_8 = this;
            ProcessControl.Configuration.BpfDataUtility.getEntityAndRelationshipMetadata(entityLogicalName,
                function($p1_0, $p1_1) {
                    var $v_1 = $P_CRM.parseJSON($p1_0.ReturnValue.toString().substr(8));
                    var $v_2 = $p1_1.GetParameter('entityName').Value;
                    var $v_3 = $P_CRM.parseJSON($v_1.RelationshipMetadata);
                    $$t_8.$2T_0[$v_2] = $$t_8.$5x_0($v_3[$v_2]);
                    var $v_4 = $P_CRM.parseJSON($v_1.EntityMetadata);
                    $$t_8.$E_0[$v_2] = $v_4[$v_2];
                    $v_0.resolve($v_1);
                });
        }
    ...
    $8s_0: function($p0) {
        return Microsoft.Crm.Workflow.Utils.SharedUtility.dictionaryContainKey(String, Object, this.$E_0, $p0) &&
            Microsoft.Crm.Workflow.Utils.SharedUtility.dictionaryContainKey(String, Object, this.$2T_0, $p0);
    },
    ...
    $7o_0: function($p0) {
        ...
        for (var $$key_4 in $$dict_3) {
            ...
            $v_0[$v_1.key] = this.$5x_0($v_1.value);
        }
        return $v_0;
    },
...
ProcessConfiguration.Utility.IRelationshipPickerDialogLauncher
    .registerInterface('ProcessConfiguration.Utility.IRelationshipPickerDialogLauncher');
...
ProcessConfiguration.Utility.RelationshipFilteringModule.get_instance = function() {
    if (!ProcessConfiguration.Utility.RelationshipFilteringModule.$4l) {
        ProcessConfiguration.Utility.RelationshipFilteringModule.$4l = new ProcessConfiguration.Services
            .RelationshipFilteringService();
    }
    return ProcessConfiguration.Utility.RelationshipFilteringModule.$4l;
}
...
ProcessConfiguration.Utility.ProcessViewVisitor.prototype = {
    ...
    $5n_0: function($p0) {
        var $v_0 = (($p0.get_stageId()) in this.get_$76_0());
        if (!$v_0) {
            if (this.$3A_0) {
                var $v_1 = $p0.validate();
                this.$1V_0.get_nestedResults().add($v_1);
            }
            if (!$p0.get_nextStageViewModel() && !this.$1W_0.get_firstLevelStageViewModels().contains($p0)) {
                var $v_2 = this.$AM_0($p0);
                if ($v_2) {
                    $p0.get_stageModel().set_nextStageId($v_2.get_stageModel().get_nextStageId());
                }
            }
            this.$7K_0($p0);
            this.get_$76_0()[$p0.get_stageId()] = $p0;
        }
        if ($p0.get_childConditionViewModel()) {
            ...
            for (var $v_4 = 0; $v_4 < $v_3.get_childConditionBranchViewModels().get_count(); $v_4++) {
                ...
                if ($v_5.get_nextStageViewModel()) {
                    this.$5n_0($v_5.get_nextStageViewModel());
                }
            }
        }
        if ($p0.get_nextStageViewModel()) {
            this.$5n_0($p0.get_nextStageViewModel());
        }
    },
    ...
    get_$76_0: function() {
        return this.$4T_0 || (this.$4T_0 = {});
    },

    $7L_0: function() {
        this.$2d_0 = new Microsoft.Crm.Workflow.ObjectModel.RelationshipCollectionStep(this.$14_0);
        this.$2d_0.setJQueryFriendlyNameAndId(this.$14_0.get_currentStepId());
        this.$6q_0(this.$2d_0);
        this.$14_0.appendStep(this.$2d_0);
    },
    ...
    validate: function() {
        this.$14_0 = new Microsoft.Crm.Workflow.ObjectModel
            .WorkflowStep(this.$1W_0.get_businessProcessFlowModel().get_primaryEntityName(),
                this.$1W_0.get_businessProcessFlowModel().get_workflowCategory());
        this.$14_0.initializeBusinessProcess(this.$1W_0.get_businessProcessFlowModel()
            .get_workflowBusinessProcessType(),
            this.$1W_0.get_businessProcessFlowModel().get_formId());
        this.$7L_0();
        this.$4T_0 = {};
        this.$1V_0 = new ProcessConfiguration.ViewModels.ProcessConfigurationValidationResult(true, '');
        this.$5n_0(this.$1W_0.get_firstLevelStageViewModels().get_item(0));
        this.$14_0.set_Id(this.$1W_0.get_businessProcessFlowModel().get_Id());
        this.$14_0.set_nextStepIndex(this.$1W_0.get_businessProcessFlowModel().get_nextStepIndex());
        return this.$1V_0;
    },
...
ProcessConfiguration.Utility.RelationshipPickerDialogLauncher.get_instance = function() {
    if (IsNull(ProcessConfiguration.Utility.RelationshipPickerDialogLauncher.$5)) {
        ProcessConfiguration.Utility.RelationshipPickerDialogLauncher.$5 = new ProcessConfiguration.Utility
            .RelationshipPickerDialogLauncher();
    }
...
ProcessConfiguration.Utility.RelationshipPickerDialogLauncher.prototype = {
    ...
    openDialog: function(model, targetStageId) {
        ...
        $v_0.set_allAvailableRelationships(ProcessConfiguration.Utility.RelationshipFilteringModule.get_instance()
            .getAllAvailableRelationships(targetStageId));
        $v_0.set_selectedRelationships(ProcessConfiguration.Utility.RelationshipFilteringModule.get_instance()
            .getSelectedRelationships(targetStageId));
        $v_0.set_stageById(ProcessConfiguration.Utility.RelationshipFilteringModule.get_instance().get_viewFactory()
            .get_stageViewsById());
...
ProcessConfiguration.ViewModels.IStepListViewModel
    .registerInterface('ProcessConfiguration.ViewModels.IStepListViewModel');
...
ProcessConfiguration.ViewModels.IRelationshipControlViewModel
    .registerInterface('ProcessConfiguration.ViewModels.IRelationshipControlViewModel');


ProcessConfiguration.ViewModels.IRelationshipPickerPicklistViewModel = function() {}
ProcessConfiguration.ViewModels.IRelationshipPickerPicklistViewModel
    .registerInterface('ProcessConfiguration.ViewModels.IRelationshipPickerPicklistViewModel');


ProcessConfiguration.ViewModels.ICompositeViewModel = function() {}
ProcessConfiguration.ViewModels.ICompositeViewModel
    .registerInterface('ProcessConfiguration.ViewModels.ICompositeViewModel');


ProcessConfiguration.ViewModels.IConditionBranchModel = function() {}
ProcessConfiguration.ViewModels.IConditionBranchModel
    .registerInterface('ProcessConfiguration.ViewModels.IConditionBranchModel');


ProcessConfiguration.ViewModels.IConditionBranchViewModel = function() {}
ProcessConfiguration.ViewModels.IConditionBranchViewModel
    .registerInterface('ProcessConfiguration.ViewModels.IConditionBranchViewModel');
...
ProcessConfiguration.ViewModels.IConditionViewModel
    .registerInterface('ProcessConfiguration.ViewModels.IConditionViewModel');


ProcessConfiguration.ViewModels.ISetNextStageModel = function() {}
ProcessConfiguration.ViewModels.ISetNextStageModel
    .registerInterface('ProcessConfiguration.ViewModels.ISetNextStageModel');
...
ProcessConfiguration.ViewModels.IStepModelFactory
    .registerInterface('ProcessConfiguration.ViewModels.IStepModelFactory');


ProcessConfiguration.ViewModels.IViewModelFactory = function() {}
ProcessConfiguration.ViewModels.IViewModelFactory
    .registerInterface('ProcessConfiguration.ViewModels.IViewModelFactory');


ProcessConfiguration.ViewModels.IRelationshipPickerViewModel = function() {}
ProcessConfiguration.ViewModels.IRelationshipPickerViewModel
    .registerInterface('ProcessConfiguration.ViewModels.IRelationshipPickerViewModel');


ProcessConfiguration.ViewModels.IProcessConfigurationViewModel = function() {}
ProcessConfiguration.ViewModels.IProcessConfigurationViewModel
    .registerInterface('ProcessConfiguration.ViewModels.IProcessConfigurationViewModel');
...
ProcessConfiguration.ViewModels.ControlModel.prototype = {
    ...
    get_attributeLogicalName: function() {
        return (this.get_isSystemStep() && _String.isNullOrWhiteSpace(this.get_dataFieldName()))
            ? this.get_controlId()
            : this.get_dataFieldName();
    },

    set_attributeLogicalName: function(value) {
        var $v_0 = this.$W_0.retrieveMetadataByLogicalName(value);
        var $v_1 = !!$v_0 &&
        (ProcessConfiguration.Models.ResolveSystemControlMetadataModel.isInstanceOfType($v_0) ||
            ProcessConfiguration.Models.SolutionSystemControlMetadataModel.isInstanceOfType($v_0));
        if ($v_1) {
    ...
    get_entity: function() {
        ...
        if (!this.$c_0.$g_0 && this.$A_0.get_entity()) {
            ...
            if (Microsoft.Crm.Workflow.Expressions.RelatedEntityLinked.isInstanceOfType(this.$A_0.get_entity())) {
                ...
                this.$c_0.$2C_0 = $v_0.get_relatedAttributeName();
    ...
    set_entity: function(value) {
        ...
        if (!this.$c_0.$g_0) {
            if (isNullOrEmptyString(this.$c_0.$1F_0)) {
                if (!this.$A_0.get_entity() ||
                    Microsoft.Crm.Workflow.Expressions.RelatedEntityLinked.isInstanceOfType(this.$A_0.get_entity())) {
                    this.$A_0.set_entity(new Microsoft.Crm.Workflow.Expressions
                        .PrimaryEntity(this.$A_0.get_workflow()));
                }
            } else {
                if (!this.$A_0.get_entity() ||
                    Microsoft.Crm.Workflow.Expressions.PrimaryEntity.isInstanceOfType(this.$A_0.get_entity())) {
                    this.$A_0.set_entity(new Microsoft.Crm.Workflow.Expressions
                        .RelatedEntityLinked(this.$A_0
                            .get_workflow(),
                            this.$c_0.$2C_0,
                            this.$c_0.$x_0,
                            this.$c_0.$1F_0));
                    ...
                    var $v_0 = this.$A_0.get_entity();
                    $v_0.set_relatedAttributeName(this.$c_0.$2C_0);
...
ProcessConfiguration.ViewModels.PageStepViewModel.prototype = {
    initialize: function() {
        ...
        this.$1e_1.refreshAvailableSystemControls(null, this._attributeLogicalName);
    },
    ...
    set_source: function(value) {
        ...
        $v_0.$1s_1 = this.$P_1.get_source().$x_0;
        $v_0.$1r_1 = value.$x_0;
        $v_0.$2a_2 = this.$P_1.get_source().$g_0;
        $v_0.$2Y_2 = value.$g_0;
        $v_0.$2b_2 = this.$P_1.get_source().$1F_0;
        $v_0.$2Z_2 = value.$1F_0;
    ...
    validateAttributeLogicalName: function(value) {
        ...
        if (isNullOrEmptyString(value)) {
            $v_0 = new ProcessConfiguration.ViewModels
                .ProcessConfigurationValidationResult(false, window.LOCID_PROCESS_FIELDISBESELECTED);
        }
...
ProcessConfiguration.ViewModels.RelationshipControlViewModel.prototype = {
    ...
    get_relationshipsCollection: function() {
        return this.$4G_1 ||
            (this.$4G_1 = new (Sales.Common.Framework.List$1.$$(ProcessConfiguration.Models.IRelationshipModel))());
    },
    ...
    validate: function() {
        ...
        var $v_1 = ProcessConfiguration.Utility.RelationshipFilteringModule.get_instance()
            .getAllAvailableRelationships(this.$1Z_1);
        for (var $v_2 = 0; $v_2 < this.get_relationshipsCollection().get_count(); $v_2++) {
            if (!this.get_relationshipsCollection().get_item($v_2).isValid($v_1)) {
                $v_0 = new ProcessConfiguration.ViewModels
                    .ProcessConfigurationValidationResult(false, 'Invalid relationship');
                break;
            }
        }
...
ProcessConfiguration.ViewModels.StepListViewModel = function() {
    ...
    this.$$d_handleChildStepViewModelAttributeLogicalNameChanged = Function
        .createDelegate(this, this.handleChildStepViewModelAttributeLogicalNameChanged);
...
ProcessConfiguration.ViewModels.StepListViewModel.prototype = {
    ...
    createAttributeLogicalName: function(attributeLogicalName) {
        var $v_0 = this.$74_1(attributeLogicalName);
        if (!$v_0.get_success()) {
            return;
        }
    ...
    $74_1: function($p0) {
        ...
        if (isNullOrEmptyString($p0)) {
            $v_0 = new ProcessConfiguration.ViewModels
                .ProcessConfigurationValidationResult(false, 'attribute logical name cannot be empty');
            return $v_0;
        }
        var $v_1 = (($p0) in this._attributeMetadataModelsByLogicalName);
        if (!$v_1) {
            $v_0 = new ProcessConfiguration.ViewModels
                .ProcessConfigurationValidationResult(false, 'attribute must exist on parent entity.');
            return $v_0;
        }
        return $v_0;
    },
    ...
    handleChildStepViewModelAttributeLogicalNameChanged: function(sender, eventArgs) {
        this.$AT_1(eventArgs.$1s_1, eventArgs.$1r_1);
    },
    ...
    get_childStepViewModels: function() {
        return this.$4x_1 ||
            (this.$4x_1 = new (Sales.Common.Framework.List$1.$$(ProcessConfiguration.ViewModels.IStepViewModel))());
    },
    ...
    addStepViewModel: function(newStepModel) {
        this._entityMetadataModel = this.$1_1.retrieveEntityMetadataSync(this._entityLogicalName);
        var $v_0 = this.$H_1.createStepViewModel(newStepModel,
            this.$1_1,
            this._entityLogicalName,
            this._entityMetadataModel,
            this._attributeMetadataModelsByLogicalName);
...
ProcessConfiguration.ViewModels.StepModel.prototype = {
    ...
    set_parentStage: function(value) {
        this.$z_0 = value;
        this.$2l_0.set_parent(this.$z_0.get_stageStep());
        return value;
    },
    ...
    get_controlModel: function() {
        ...
        var $v_0 = Microsoft.Crm.Workflow.ObjectModel.ControlStep.getControlStep(this.$2l_0.get_Steps().get_item(0));
    ...
    $6w_0: function($p0) {
        ...
        this.$z_0.get_stageStep().get_Steps().move($v_1, this.$2l_0);
    }
}
...
ProcessConfiguration.ViewModels.StepViewModel.prototype = {
    validateAttributeLogicalName: function(value) {
        var $v_0 = new ProcessConfiguration.ViewModels.ProcessConfigurationValidationResult(true, null);
        if (isNullOrEmptyString(value) || !((value) in this.$2P_1)) {
            $v_0 = new ProcessConfiguration.ViewModels
                .ProcessConfigurationValidationResult(false, window.LOCID_PROCESS_FIELDISBESELECTED);
        }
        var $v_1 = new ProcessConfiguration.ViewModels.AttributeValidatedEventArgs();
    ...
    set_attributeLogicalName: function(value) {
        ...
        $v_2.$1s_1 = $v_0;
        $v_2.$1r_1 = this._attributeLogicalName;
    ...
    changeEntity: function(entityMetadataModel, attributeMetadataModelsByLogicalName) {
        ...
        this.$2P_1 = attributeMetadataModelsByLogicalName;
        this.set_attributeLogicalName(null);
    },

    deleteStep: function() {
        if (!IsNull(this.$1e_1)) {
            this.$1e_1.refreshAvailableSystemControls(this._attributeLogicalName, null);
        }
        var $v_0 = new ProcessConfiguration.ViewModels.StepEventArgs();
        $v_0.$4_1 = this;
        this.fireEvent('Deleting', $v_0);
            ...
            for (var $v_2 = 0; $v_2 < $v_1.get_stepLabels().get_count(); $v_2++) {
                if ($v_1.get_stepLabels().get_item($v_2).get_labelId() === $v_1.get_stepStepId()) {
                    ...
                    if ($v_4.startsWith('{')) {
                        ...
                        var $v_6 = Microsoft.Crm.Workflow.ObjectModel.NullObjectsFactory
                            .buildStep('ActionStep:#Microsoft.Crm.Workflow.ObjectModel');
                        ...
                        if (!IsNull($v_6.get_actionControl())) {
                            ...
                            $v_6.get_actionControl()
                                .set_controlId(Microsoft.Crm.Client.Core.Framework.Guid.newGuid().toString());
                            $v_7.set_nextStepIndex($v_7.get_nextStepIndex() + 1);
    ...
    updateSystemStepProperties: function(systemControlMetadata) {
        ...
        this.$1e_1.refreshAvailableSystemControls($v_0, this._attributeLogicalName);
    },
...
ProcessConfiguration.ViewModels.ProcessConfigurationValidationResult.prototype = {
    ...
    get_nestedResults: function() {
        return this.$58_0 ||
            (this.$58_0 = new (Microsoft.Crm.Client.Core.Framework.List$1.$$(Mscrm.IValidationResult))());
    }
}
...
ProcessConfiguration.ViewModels.ConditionBranchModel.prototype = {
    ...
    set_setNextStage: function(value) {
        this.$1X_0 = value;
        if (!this.$1X_0 && this.$q_0.get_Steps().get_Count() > 0) {
            var $v_0 = this.$q_0.get_Steps().get_item(0);
            this.$q_0.remove($v_0);
            return value;
        }
        if (this.$1X_0 && this.$q_0.get_Steps().get_Count() > 0) {
            ...
            this.$q_0.remove($v_1);
            this.$q_0.appendStep(this.$1X_0.get_setNextStageStep());
            return value;
        }
        if (this.$1X_0 && !this.$q_0.get_Steps().get_Count()) {
            this.$q_0.appendStep(this.$1X_0.get_setNextStageStep());
        }
        return value;
    },
...
ProcessConfiguration.ViewModels.ConditionBranchViewModel.prototype = {
    ...
    set_nextStageViewModel: function(value) {
        this.$N_1 = value;
        if (!value) {
            this.$1J_1.get_setNextStage().get_setNextStageStep().set_stageId(null);
        }
        return value;
    },
    ...
    set_entityLogicalName: function(value) {
        this.$K_1 = value;
        if (!IsNull(this.$1c_1)) {
            this.$1c_1.set_entityLogicName(this.$K_1);
        }
        return value;
    },
    ...
    initialize: function() {
        this.$1c_1 = new Mscrm.BusinessRules.ViewModels
            .BranchingConditionBranchSectionViewModel(this.$1J_1.get_conditionBranchStep(), this.$K_1);
        var $v_0 = this.$1J_1.get_setNextStage();
        var $v_1 = $v_0.get_nextStage();
        if (!$v_1) {
            return;
        }
        var $v_2 = this.$H_1.createStageViewModel(this.$1_1,
            $v_1,
            this.get_parentStageViewModel(),
            $v_1.get_entityLogicalName());
        $v_2.initialize();
        this.$N_1 = $v_2;
    },
    ...
    insertNextStageViewModel: function(nextStageViewModel) {
        var $v_0 = this.$1J_1.get_stepModelFactory()
            .createNewSetNextStageModel(this.$1J_1, nextStageViewModel, this.get_parentStageViewModel());
        if (this.$N_1) {
            var $v_1 = this.$N_1;
        ...
        this.$1J_1.set_setNextStage($v_0);
    },
    ...
    validate: function() {
        var $v_0 = new ProcessConfiguration.ViewModels.ProcessConfigurationValidationResult(true, '');
        if (!this.$1J_1.get_rootWorkflow().get_workflowBusinessProcessType()) {
            for (var $v_1 = 0; $v_1 < this.$1c_1.get_conditions().get_expressionViewModels().get_count(); $v_1++) {
                var $v_2 = this.$1c_1.get_conditions().get_expressionViewModels().get_item($v_1);
                if ($v_2.get_conditionBranchDisplayMode() !== 2) {
                    $v_0.get_nestedResults().add(this.$AX_1($v_2));
                }
            }
        }
        return $v_0;
        ...
        if ($p0.get_alwaysShowWarning()) {
            ...
            if (!IsNull($v_2.get_expressions())) {
                for (var $v_3 = 0; $v_3 < $v_2.get_expressions().get_count(); $v_3++) {
                    if (IsNull(this.$1G_1) ||
                        !(($v_2.get_expressions().get_item($v_3).get_attributeName()) in this.$1G_1) ||
                        this.$K_1 !== $v_2.get_expressions().get_item($v_3).get_entity().get_entityName()) {
                        $v_0 = true;
...
ProcessConfiguration.ViewModels.ConditionModel.prototype = {
    $95_0: function() {
        this.$2Q_0 = new (Sales.Common.Framework.List$1.$$(ProcessConfiguration.ViewModels.IConditionBranchModel))();
        for (var $v_0 = 0; $v_0 < this.$2S_0.get_Steps().get_Count(); $v_0++) {
            var $v_1 = this.$2S_0.get_Steps().get_item($v_0);
            var $v_2 = $v_1;
    ...
    deleteConditionBranch: function(conditionBranchModel) {
        this.$2S_0.remove(conditionBranchModel.get_conditionBranchStep());
...
ProcessConfiguration.ViewModels.ConditionViewModel.prototype = {
    ...
    get_childConditionBranchViewModels: function() {
        return this.$3h_1 ||
        (this.$3h_1 = new (Sales.Common.Framework.List$1
            .$$(ProcessConfiguration.ViewModels.IConditionBranchViewModel))());
    },
    ...
    initialize: function() {
        var $v_0 = this.$2R_1.get_conditionBranches();
    ...
    deleteConditionBranch: function(conditionBranchViewModel) {
        this.$2R_1.deleteConditionBranch(conditionBranchViewModel.get_conditionBranchModel());
...
ProcessConfiguration.ViewModels.SetNextStageModel.prototype = {
    ...
    get_nextStage: function() {
        if (!this.$1K_0 && !isNullOrEmptyString(this.$1v_0.get_stageId())) {
            var $v_0 = this.$1v_0.get_stageId();
            this.$1K_0 = this.$C_0.createStageModelForExistingStage($v_0);
        }
        return this.$1K_0;
    },
    ...
    set_nextStage: function(value) {
        this.$1K_0 = value;
        this.$1v_0.set_stageId(this.$1K_0.get_id());
        return value;
    },
    ...
    get_parentStageId: function() {
        return this.$1v_0.get_parentStageId();
    },

    set_parentStageId: function(value) {
        this.$1v_0.set_parentStageId(value);
        return value;
    }
}
...
ProcessConfiguration.ViewModels.StageModel.prototype = {
    ...
    $6S_0: function() {
        ...
        for (var $v_0 = 0; $v_0 < this.$h_0.get_Steps().get_Count(); $v_0++) {
            ...
            if (Microsoft.Crm.Workflow.ObjectModel.ConditionStep.isInstanceOfType($v_1)) {
                var $v_2 = $v_1;
                this.$1I_0 = this.$C_0.createConditionModel($v_2);
            }
    ...
    set_condition: function(value) {
        if (!value && this.$1I_0) {
            this.$h_0.get_Steps().remove(this.$1I_0.get_conditionStep());
            this.$1I_0 = null;
            return value;
        }
        if (value && !this.$1I_0) {
            ...
            this.$1I_0 = value;
            for (var $v_0 = 0; $v_0 < this.$1I_0.get_conditionBranches().get_count(); $v_0++) {
                var $v_1 = this.$1I_0.get_conditionBranches().get_item($v_0);
    ...
    get_nextStage: function() {
        ...
        this.$1K_0 = this.$C_0.createStageModelForExistingStage(this.$h_0.get_nextStageId());
        return this.$1K_0;
    },
...
ProcessConfiguration.ViewModels.StageViewModel.prototype = {
    $94_1: function() {
        ...
        this.$15_1.add_propertyChanged(this.$$d_$8e_1);
        this.$15_1.add_stepDeleting(this.$$d_$8g_1);
        this.$15_1.add_stepAdding(this.$$d_$8f_1);
    },
    ...
    get_relationships: function() {
        return this.$27_1.get_relationshipsCollection();
    },
    ...
    initialize: function() {
        ...
        if (!$v_2 && ($v_4 || $v_3) && !((this.$S_1.get_nextStageId()) in this.$3z_1)) {
    ...
    $9D_1: function() {
        this.$27_1 = this.$H_1.createRelationshipControlViewModel(this);
    },

    insertNextStageViewModel: function(nextStageViewModel) {
        if (!this.$N_1) {
            this.$5k_1(nextStageViewModel);
            return;
        }
    ...
    validate: function() {
        ...
        if (!this.$S_1.get_rootWorkflow().get_workflowBusinessProcessType()) {
            $v_0.get_nestedResults().add(this.$75_1());
            if (this.$27_1) {
                $v_0.get_nestedResults().add(this.$27_1.validate());
            }
        }
        return $v_0;
    },
    ...
    dispose: function() {
        if (!IsNull(this.$15_1)) {
            this.$15_1.remove_propertyChanged(this.$$d_$8e_1);
            this.$15_1 = null;
        }
        this.$27_1 = null;
        this.$l_1 = null;
...
ProcessConfiguration.ViewModels.StepModelFactory.prototype = {
    ...
    createStageModel: function($p0) {
        if (!(($p0.get_stageId()) in this.$2i_0)) {
            this.$2i_0[$p0.get_stageId()] = $p0;
        }
    ...
    createNewConditionBranchModel: function($p0, $p1) {
        var $v_0 = this.$5y_0($p0, $p1.get_conditionStep());
    ...
    createStageModelForExistingStage: function($p0) {
        var $v_0 = this.createStageModel(this.$2i_0[$p0]);
        return $v_0;
    },
...
ProcessConfiguration.ViewModels.ViewModelBase = function() {
    this.$3x_0 = new Sys.EventHandlerList();
}
ProcessConfiguration.ViewModels.ViewModelBase.prototype = {
    ...
    addEventHandler: function(eventHandler, eventName) {
        this.$3x_0.addHandler(eventName, eventHandler);
    },

    removeEventHandler: function(eventHandler, eventName) {
        this.$3x_0.removeHandler(eventName, eventHandler);
    },

    getHandler: function(eventName) {
        return this.$3x_0.getHandler(eventName);
    },
...
ProcessConfiguration.ViewModels.ViewModelFactory.prototype = {
    ...
    createStageViewModel: function($p0, $p1, $p2, $p3) {
        ...
        $v_0.set_firstLevelStagesById(this.$1f_0);
    ...
    createProcessConfigurationViewModel: function($p0, $p1, $p2) {
        ...
        $v_0.set_firstLevelStages(this.$1f_0);
    ...
    createRelationshipControlViewModel: function($p0) {
        ...
        var $v_1 = this.$3e_0.getRelationshipStepsByTargetStage($p0.get_stageId());
        if ($v_1) {
            var $$dict_6 = $v_1;
            for (var $$key_7 in $$dict_6) {
        ...
        for (var $$key_D in $$dict_C) {
            ...
            if ($v_2.get_count() > 0) {
                ...
                for (var $v_7 = 0; $v_7 < $v_2.get_count(); $v_7++) {
                    ...
                    Array.add($v_3, $v_5);
                    for (var $$arr_7 = this.$1g_1.get_items(), $$len_8 = $$arr_7.length, $$idx_9 = 0;
                        $$idx_9 < $$len_8;
                        ++$$idx_9) {
                        var $v_8 = $$arr_7[$$idx_9];
                        if ($v_8.get_attributeLogicalName() === $v_2.get_item($v_7).get_attributeLogicalName() &&
                            $v_8.get_relationshipName() === $v_2.get_item($v_7).get_relationshipName() &&
                            $v_8.get_sourceStageId() === $v_2.get_item($v_7).get_sourceStageId() &&
                            $v_8.get_targetStageId() === $v_2.get_item($v_7).get_targetStageId() &&
                            $v_8.get_targetStageEntityLogicalName() ===
                            $v_2.get_item($v_7).get_targetStageEntityLogicalName()) {
                            $v_4 = $v_7 + 1;
                        }
                    }
                }
                var $v_6 = this.$H_1.createRelationshipPickerPicklistViewModel($v_2, $v_1.key, $v_4, $v_3);
                this.$2c_1[$v_0.toString()] = $v_6;
                $v_0++;
            }
        }
        this.$59_1 = $v_0;
...
ProcessConfiguration.ViewModels.ProcessConfigurationViewModel.prototype = {
    ...
    get_firstLevelStageViewModels: function() {
        return this.$5W_1 ||
            (this.$5W_1 = new (Sales.Common.Framework.List$1.$$(ProcessConfiguration.ViewModels.IStageViewModel))());
    },

    initialize: function() {
        this.$4C_1 = this.$1_1.get_entityMetadata();
        this.$4D_1 = this.$1_1.get_entityRelationshipMetadata();
        var $v_0 = null;
        var $$dict_6 = this.$1f_1;
        for (var $$key_7 in $$dict_6) {
            var $v_2 = { key: $$key_7, value: $$dict_6[$$key_7] };
            var $v_3 = $v_2.value;
            var $v_4 = $v_3;
    ...
    get_businessProcessFlowModelJson: function() {
        return (IsNull(this.$1b_1)) ? '' : this.$1b_1.toJson();
    }
}
...
ProcessConfiguration.View.IRelationshipControlView
    .registerInterface('ProcessConfiguration.View.IRelationshipControlView');
...
ProcessConfiguration.View.IProcessControlStepViewAdapter
    .registerInterface('ProcessConfiguration.View.IProcessControlStepViewAdapter');
...
ProcessConfiguration.View.ILegacyProcessControlView
    .registerInterface('ProcessConfiguration.View.ILegacyProcessControlView');
...
ProcessConfiguration.View.IProcessControlViewAdapter
    .registerInterface('ProcessConfiguration.View.IProcessControlViewAdapter');


ProcessConfiguration.View.IProcessControlStageViewAdapter = function() {}
ProcessConfiguration.View.IProcessControlStageViewAdapter
    .registerInterface('ProcessConfiguration.View.IProcessControlStageViewAdapter');


ProcessConfiguration.View.IProcessConfigurationView = function() {}
ProcessConfiguration.View.IProcessConfigurationView
    .registerInterface('ProcessConfiguration.View.IProcessConfigurationView');
...
ProcessConfiguration.View.IRelationshipPickerView
    .registerInterface('ProcessConfiguration.View.IRelationshipPickerView');
...
ProcessConfiguration.View.PageView.prototype = {
    initialize: function() {
        ...
        if (this.get_viewModel().get_nextStageViewModel() &&
            !this.$G_1 &&
            !((this.get_viewModel().get_nextStageViewModel().get_stageId()) in
                this.get_viewModel().get_firstLevelStagesById())) {
...
ProcessConfiguration.View.ProcessControlPageStepViewAdapter = function() {
    this.$$d_$8k_2 = Function.createDelegate(this, this.$8k_2);
...
ProcessConfiguration.View.ProcessControlPageStepViewAdapter.prototype = {
    ...
    initialize: function() {
        ...
        (this.get_viewModel()).add_sourceLogicalNameChanged(this.$$d_$8k_2);
    ...
    $9R_2: function() {
        ...
        this.$4L_2 = this.$M_1.createStepSourceControlView($v_2, this.get_viewModel(), this._stepView);
        this.$4L_2.initialize();
        this.$4L_2.renderView();
    },

    $8k_2: function($p0, $p1) {
        if ($p1.$1r_1 === $p1.$1s_1 && $p1.$2Y_2 === $p1.$2a_2 && $p1.$2Z_2 === $p1.$2b_2) {
            return;
        }
        var $v_0 = this._fieldControlView;
        if ($p1.$1r_1 !== $p1.$1s_1 || $p1.$2Y_2 !== $p1.$2a_2) {
            $v_0.clearValidation();
            $v_0.updateEntityOptionsList(true);
        } else if ($p1.$2Z_2 !== $p1.$2b_2) {
            $v_0.set_$6n_5(-1);
        }
    }
}
...
ProcessConfiguration.View.ProcessControlStageViewAdapter.prototype = {
    ...
    $9C_1: function() {
        this.$1N_1 = this.$2_1.createProcessControlStageView(this, this.$B_1, this.get_$a_1());
        this.$1N_1.renderView();
    },
    ...
    $9L_1: function() {
        this.$2h_1 = this.$J_1.createStageFocusBehaviorAdapter(this.$B_1, this);
        this.$2h_1.initialize();
    },
...
ProcessConfiguration.View.ConditionBranchView.prototype = {
    ...
    $5p_1: function($p0, $p1) {
        if (!ProcessControl.Configuration.ProcessConfigurationUtility.isProcessReadonly()) {
            ...
            var $v_1 = this.$p_1.createEmptyStageData(this.get_viewModel().get_conditionBranchModel()
                .get_rootWorkflow());
            var $v_2 = this.get_viewModel().get_conditionBranchModel().get_stepModelFactory().createStageModel($v_1);
            var $v_3 = this.get_viewModel().get_viewModelFactory()
                .createStageViewModel($v_0,
                    $v_2,
                    this.get_viewModel().get_parentStageViewModel(),
                    this.get_viewModel().get_entityLogicalName());
    ...
    dispose: function() {
        ...
        if (!IsNull(this.$f_1)) {
            this.$f_1.remove_clicked(this.$$d_$5p_1);
            this.$f_1.dispose();
            this.$f_1 = null;
        }
        var $v_0 = this.get_$7J_1();
        if (!IsNull($v_0)) {
    ...
    initialize: function() {
        ...
        var $v_1 = String.format('{0}_{1}',
            this.get_viewModel().get_conditionBranchStepSectionViewModel().get_stepId(),
            $v_0);
        ...
        this.$f_1.initialize();
        this.$f_1.add_clicked(this.$$d_$5p_1);
    },
...
ProcessConfiguration.View.ConditionView.prototype = {
    ...
    dispose: function() {
        if (!IsNull(this.$28_1)) {
            for (var $v_0 = this.$28_1.get_count() - 1; $v_0 >= 0; $v_0--) {
                this.$28_1.get_item($v_0).dispose();
                this.$28_1.removeAt($v_0);
            }
        }
        if (!IsNull(this.$3_1)) {
            this.$3_1.dispose();
    ...
    get_children: function() {
        return this.$28_1 || (this.$28_1 = new (Sales.Common.Framework.List$1.$$(Mscrm.BusinessRules.Views.IView))());
    }
}
...
ProcessConfiguration.View.ProcessControlStepViewAdapter.prototype = {
    ...
    handleAttributeValidated: function(sender, args) {
        if (this._fieldControlView.tryAddAndShowValidationResult(args.$1V_1)) {
    ...
    $8d_1: function() {
        this.$1d_1.set_visible(this.get_viewModel().get_canDelete());
    },
    ...
    initializeDeleteStepButtonView: function() {
        ...
        this.$1d_1 = this.$M_1.createButtonView($v_0);
        this.$1d_1.initialize();
        this.$1d_1.add_clicked(this.$$d_$7x_1);
        this.$1d_1.set_visible(this.get_viewModel().get_canDelete());
    },
    ...
    initializeStepFocusBehavior: function() {
        this.$2j_1 = this.$J_1.createStepFocusBehaviorAdapter(this.$L_1, this, this.get_parentStageView());
    ...
    dispose: function() {
        ...
        this.$1d_1.remove_clicked(this.$$d_$7x_1);
        this.$1d_1.dispose();
        this.$1d_1 = null;
...
ProcessConfiguration.View.StageView = function() {
    ...
    this.$$d_$7w_1 = Function.createDelegate(this, this.$7w_1);
    this.$$d_$5p_1 = Function.createDelegate(this, this.$5p_1);
...
ProcessConfiguration.View.StageView.prototype = {
    ...
    get_$2J_1: function() {
        if (IsNull(this.$24_1)) {
            this.$24_1 = this.get_element().find('.button.add-branch');
        }
        return this.$24_1;
    },
    ...
    $9E_1: function() {
        ...
        if ($v_0.get_length() > 0) {
            this.$2e_1 = this.$2_1
                .createRelationshipControlView($v_0, this.get_viewModel().get_childRelationshipControlViewModel());
            this.$2e_1.initialize();
    ...
    initializeStepListView: function() {
        ...
        this.$2k_1 = this.$2_1.createStepListView(this,
            $v_0,
            this.get_viewModel().get_childStepListViewModel(),
            this.get_viewModel().get_stageModel().get_stepModelFactory());
        this.$2k_1.initialize();
    },

    initializeProcessControlStageViewAdapter: function() {
        this.$3c_1 = this.$1O_1
            .createAddBranchConditionBehaviorAdapter(this.get_$2J_1(), this.$J_1, this.get_viewModel(), this);
        this.$3c_1.initialize();
        this.$3G_1 = this.$1O_1.createStageViewAdapter(this.$2_1, this.get_viewModel(), this.get_element());
    ...
    initializeDeleteStageButtonView: function() {
        ...
        this.$1q_1 = this.$2_1.createButtonView($v_0);
        this.$1q_1.initialize();
        this.$1q_1.add_clicked(this.$$d_$7w_1);
        if (this.get_viewModel().get_isFirstStage()) {
            $v_0.get_jQueryObject().parent().hide();
        }
    },
    ...
    initializeAddBranchButtonView: function() {
        this.$5P_1(this.get_$4m_1());
        this.get_$2J_1().click(this.$$d_$9g_1);
        this.get_$2J_1().mouseEnter(this.$$d_$9h_1);
    },

    $9g_1: function($p0) {
        if (!this.get_$4m_1()) {
            this.$3c_1.get_instance().$77_4($p0);
        }
        this.$5P_1(this.get_$4m_1());
    },
    ...
    get_$4m_1: function() {
        if (this.get_viewModel().get_childConditionViewModel()) {
            ...
            if ($v_0.get_childConditionBranchViewModels().get_count() > 0 &&
                $v_0.get_childConditionBranchViewModels().last().get_conditionBranchStepSectionViewModel()
                .get_conditions().get_conditionBranchDisplayMode() ===
                2) {
                return true;
            }
    ...
    $5P_1: function($p0) {
        if ($p0) {
            this.get_$2J_1().addClass('default-cursor');
            var $v_0 = this.get_$2J_1().children('*');
            if ($v_0) {
                $v_0.addClass('default-cursor');
            }
        } else {
            this.get_$2J_1().removeClass('default-cursor');
            var $v_1 = this.get_$2J_1().children('*');
            if ($v_1) {
    ...
    $5p_1: function($p0, $p1) {
        if (!ProcessControl.Configuration.ProcessConfigurationUtility.isProcessReadonly()) {
            ...
            var $v_3 = this.get_viewModel().get_viewModelFactory()
                .createStageViewModel($v_0,
                    $v_2,
                    this.get_viewModel().get_parentStage(),
                    this.get_viewModel().get_entityLogicalName());
            this.get_viewModel().insertNextStageViewModel($v_3);
            $v_3.initialize();
            var $v_4 = this.$p_1.buildStageElement($v_3);
    ...
    dispose: function() {
        if (!IsNull(this.$D_1)) {
            this.$D_1.remove_conditionDelete(this.$$d_$9j_1);
            this.$D_1.dispose();
            this.$D_1 = null;
        }
        if (!IsNull(this.$2k_1)) {
        ...
        if (!IsNull(this.$1q_1)) {
            this.$1q_1.remove_clicked(this.$$d_$7w_1);
            this.$1q_1.dispose();
            this.$1q_1 = null;
        }
        if (!IsNull(this.$24_1)) {
    ...
    set_conditionView: function(value) {
        ...
        this.$D_1 = value;
        if (!IsNull(this.$D_1)) {
            this.$D_1.add_conditionDelete(this.$$d_$9j_1);
        }
        return value;
    },
    ...
    getAllChildStagesPointingToTargetStage: function(currentStages, targetStageId) {
        ...
        for (var $v_1 = 0; $v_1 < $v_0.get_count(); ++$v_1) {
            ...
            while ($v_3) {
                ...
                if ($v_3.get_nextStageView().get_viewModel().get_stageId()
                    .toLowerCase() ===
                    targetStageId.toLowerCase()) {
                    Array.add(currentStages, $v_3);
                    break;
                }
...
ProcessConfiguration.View.RelationshipControlView = function() {
    ...
    this.$$d_$9r_1 = Function.createDelegate(this, this.$9r_1);
...
ProcessConfiguration.View.RelationshipControlView.prototype = {
    ...
    get_$6o_1: function() {
        if (IsNull(this.$4J_1)) {
            this.$4J_1 = this.$0_0.selectInElement('.stage-relationship-link', this.$B_1);
        }
        return this.$4J_1;
    },
    ...
    initialize: function() {
        if (!this.get_$a_1().get_readOnly()) {
            this.get_$a_1().add_propertyChanged(this.$$d_$9r_1);
            this.$7N_1();
        }
    },
    ...
    $7N_1: function() {
        this.get_$6o_1().click(this.$$d_$9n_1);
    },

    $AR_1: function() {
        this.get_$6o_1().unbind('click', this.$$d_$9n_1);
    },

    $9n_1: function($p0) {
        ProcessConfiguration.Utility.RelationshipPickerDialogLauncher.get_instance()
            .openDialog(this.get_$a_1(), this.get_$a_1().get_targetStageId());
    },
    ...
    dispose: function() {
        ...
        if (!IsNull(this.$1y_1)) {
            this.$1y_1.unbind('mouseenter', this.$$d_$9s_1).unbind('mouseleave', this.$$d_$9t_1);
        }
        if (!IsNull(this.get_$a_1())) {
            this.get_$a_1().remove_propertyChanged(this.$$d_$9r_1);
    ...
    get_warningIcon: function() {
        if (IsNull(this.$1y_1)) {
            this.$1y_1 = this.$0_0.fromHtml('<span></span>').addClass('ms-crm-Inline-WarningIcon')
                .append(this.$0_0.fromElement(Mscrm.ImageStrip
                        .getImage(Mscrm.CrmUri.create('/_imgs/inlineedit/warning.png')))
                    .attribute('alt', window.LOCID_WARNINGICON_ALTTEXT).attribute('id', this.get_$5S_1() + '_warn'))
                .append(this.$0_0.fromHtml('<div></div>').attribute('id', this.get_$5S_1() + '_w')
                    .addClass('ms-crm-Hidden-NoBehavior')).attribute('title', '');
            this.$B_1.append(this.$1y_1);
            this.$1y_1.mouseEnter(this.$$d_$9s_1).mouseLeave(this.$$d_$9t_1).hide();
        }
        return this.$1y_1;
    },

    $9s_1: function($p0) {
        this.get_$83_1().showError(window.LOCID_PROCESS_RELATION_WARNING);
    },
    ...
    get_$83_1: function() {
        if (IsNull(this.$1E_1)) {
            this.$1E_1 = new Mscrm.ErrorFlyout(this.get_warningIcon().get_jQueryObject(),
                this.get_$AY_1().get_jQueryObject(),
                this.get_$60_1().get_jQueryObject());
        }
        return this.$1E_1;
    },
    ...
    get_$AY_1: function() {
        if (IsNull(this.$3N_1)) {
            this.$3N_1 = this.$0_0.fromHtml('<div></div>').addClass('ms-crm-Inline-Validation').hide()
                .attribute('id', this.get_$5S_1() + '_err');
            this.get_$60_1().append(this.$3N_1);
        }
        return this.$3N_1;
    },
...
ProcessConfiguration.View.StepFieldViewBase.prototype = {
    ...
    initializePicklistInlineControl: function() {
        ...
        var $v_6 = this.$8L_5($v_5, this.$4_5);
...
ProcessConfiguration.View.StepListView.prototype = {
    ...
    get_$5m_1: function() {
        return this.$5J_1 ||
        (this.$5J_1 = new (Sales.Common.Framework.List$1
            .$$(ProcessConfiguration.View.IProcessControlStepViewAdapter))());
    },
    ...
    $7H_1: function($p0, $p1) {
        if (!ProcessControl.Configuration.ProcessConfigurationUtility.isProcessReadonly()) {
            ...
            var $v_4 = this.$3b_1.createStepViewAdapter(this.$M_1, $v_1, $v_3, this.get_$6f_1());
            this.$2W_1.set_nextStepViewAdapter($v_4);
            this.$2W_1 = $v_4;
            $v_4.initialize();
            $v_4.add_deleting(this.$$d_$AJ_1);
        }
    },

    $AJ_1: function($p0, $p1) {
        $p1.$2F_1.remove_deleting(this.$$d_$AJ_1);
        if ($p1.$2F_1 === this.$2W_1) {
            this.$2W_1 = $p1.$2F_1.get_previousStepViewAdapter();
        }
    },

    $9S_1: function($p0, $p1) {
        var $v_0 = this.$3b_1.createStepViewAdapter(this.$M_1, $p0, $p1, this.get_$6f_1());
        $v_0.initialize();
        $v_0.add_deleting(this.$$d_$AJ_1);
        this.get_$5m_1().add($v_0);
        return $v_0;
    },
    ...
    $8y_1: function() {
        ...
        this.$36_1.add_clicked(this.$$d_$7H_1);
    },

    dispose: function() {
        this.$36_1.remove_clicked(this.$$d_$7H_1);
        for (var $v_0 = 0; $v_0 < this.get_$5m_1().get_count(); $v_0++) {
            var $v_1 = this.get_$5m_1().get_item($v_0);
            $v_1.remove_deleting(this.$$d_$AJ_1);
            $v_1.dispose();
        }
    },
    ...
    initialize: function() {
        ...
        for (var $v_2 = 0; $v_2 < this.get_$a_1().get_childStepViewModels().get_count(); $v_2++) {
            var $v_3 = this.$9S_1(this.$0_0.fromElement($v_0.get_item($v_2)),
                this.get_$a_1().get_childStepViewModels().get_item($v_2));
            if ($v_1) {
...
ProcessConfiguration.View.PageStepSourceView.prototype = {
    ...
    get_$2K_6: function() {
        ...
        this.$2U_6 = this.$4_5.get_entityMetadataModel().get_sources();
        return this.$2U_6;
    },

    setStepControlValue: function(stepFieldControlView) {
        stepFieldControlView.get_valueElement().text(this.get_$3Z_6().get_source().$29_0 ||
            window.LOCID_PROCESS_PAGE_SOURCENAME);
    },

    get_$6n_5: function() {
        var $v_0 = this.get_$3Z_6().get_source().$g_0;
        var $v_1 = this.get_$3Z_6().get_source().$x_0;
        var $v_2 = $v_1 + '#' + this.get_$3Z_6().get_source().$1F_0;
        if (!$v_0 && isNullOrEmptyString($v_1)) {
            return -1;
        }
        for (var $v_3 = 0; $v_3 < this.get_$2K_6().get_count(); $v_3++) {
            if ($v_0) {
                if ($v_0 === this.get_$2K_6().get_item($v_3).$g_0) {
                    return $v_3;
                }
            } else {
                var $v_4 = this.get_$2K_6().get_item($v_3).$x_0 + '#' + this.get_$2K_6().get_item($v_3).$1F_0;
                if ($v_2 === $v_4) {
                    return $v_3;
                }
            }
    ...
    set_$6n_5: function($p0) {
        if ($p0 < 0 || $p0 >= this.$4_5.get_entityMetadataModel().get_sources().get_count()) {
            return $p0;
        }
        var $v_0 = this.get_$2K_6().get_item($p0);
        if ($v_0.$g_0) {
            this.$s_4.$6r_4($v_0.$29_0);
        }
        this.$AV_6($v_0);
        return $p0;
    },
    ...
    $AV_6: function($p0) {
        this.get_$3Z_6().updateStepSourceProperties($p0);
    },

    getEntityOptionsList: function() {
        var $v_0 = new Array(0);
        this.$2U_6 = null;
        for (var $v_1 = 0; $v_1 < this.get_$2K_6().get_count(); $v_1++) {
            var $v_2 = new Mscrm.EnumOptionJsonWrapper();
            $v_2.Value = $v_1;
            $v_2.Label = this.get_$2K_6().get_item($v_1).$29_0;
            Array.add($v_0, $v_2);
        }
        return $v_0;
    },
...
ProcessConfiguration.View.StepFieldView = function(element) {
    this.$$d_onAvailableSystemControlsRefreshed = Function
        .createDelegate(this, this.onAvailableSystemControlsRefreshed);
...
ProcessConfiguration.View.StepFieldView.prototype = {
    ...
    get_filteredOptions: function() {
        ...
        this._filteredOptions = this.$4_5.get_entityMetadataModel()
            .retrieveAttributesExcludingUsedSystemSteps(this.$4_5.get_attributeLogicalName());
        this.$4_5.get_entityMetadataModel().get_systemControlMetadataModel()
            .add_availableSystemControlsRefreshed(this.$$d_onAvailableSystemControlsRefreshed);
        return this._filteredOptions;
    },

    setStepControlValue: function(StepValueControlView) {
        StepValueControlView.get_valueElement().text(this.$4_5.get_fieldDisplayText() ||
            window.LOCID_PROCESS_NEWFIELDTEXTKEY);
    },
    ...
    set_$6n_5: function($p0) {
        ...
        this.$s_4.$6r_4($v_0.get_displayText());
        this.get_elementWrapper().children(':first').removeClass('pc_inline_empty_value');
        return $p0;
    },
    ...
    dispose: function() {
        ...
        this.$O_5.get_chromeElement().unbind('attribute-changed', this.$$d_onFieldChanged);
        this.$4_5.get_entityMetadataModel().get_systemControlMetadataModel()
            .remove_availableSystemControlsRefreshed(this.$$d_onAvailableSystemControlsRefreshed);
        ProcessControl.Configuration.ProcessControlViewBase$2.prototype.dispose.call(this);
    }
}
...
ProcessConfiguration.View.ViewFactory.prototype = {
    ...
    createProcessConfigurationView: function($p0) {
        ...
        var $v_1 = this.$1O_0.createProcessControlViewAdapter(this, $v_0, $p0);
    ...
    createProcessControlView: function($p0, $p1, $p2) {
        var $v_0 = new ProcessControl.Configuration
            .ProcessControlView($p0.get_item(0), $p2.get_primaryEntityMetadata());
    ...
    createStepListView: function($p0, $p1, $p2, $p3) {
        ...
        $v_0.set_element($p1);
        $v_0.set_viewFactory(this);
        $v_0.set_viewAdapterFactory(this.$1O_0);
        $v_0.set_jQueryProxy(this.$0_0);
...
ProcessConfiguration.View.ProcessConfigurationView.prototype = {
    ...
    get_firstLevelStageViews: function() {
        return this.$5X_1 ||
            (this.$5X_1 = new (Sales.Common.Framework.List$1.$$(ProcessConfiguration.View.IStageView))());
    }
}
...
ProcessConfiguration.View.ProcessControlViewAdapter.prototype = {
    ...
    initialize: function() {
        ...
        this.$5_1 = this.$2_1.createProcessControlView($v_2, this.$1U_1, $v_0);
        this.$5_1.initialize();
...
ProcessConfiguration.View.PageStepFieldView.prototype = {
    ...
    updateEntityOptionsList: function(resetToDefault) {
        ...
        if ($v_0.$g_0) {
            ...
            if ($v_1.state() === 'pending') {
                ...
                if ($v_5.get_length() < 1) {
                    this.$7E_7(this.$0_7.fromElement(this.get_element()));
                }
    ...
    $7E_7: function($p0) {
        $p0.before(this.$0_7.fromHtml(String.format('<span class=\'{0}\'><img src=\'{1}\' /></span>',
            'processing',
            Mscrm.CrmUri.create('/_imgs/ico/16_progress.gif'))));
    },
    ...
    $6Y_7: function($p0) {
        var $v_0 = new Array(0);
        this._filteredOptions = new (Sales.Common.Framework.List$1
            .$$(ProcessConfiguration.Models.IAttributeMetadataModel))();
        for (var $v_1 = 0; $v_1 < $p0.length; $v_1++) {
            var $v_2 = ProcessControl.Configuration.ProcessConfigurationUtility
                .createAttributeMetadataModel($p0[$v_1].Label.Description, $p0[$v_1].LogicalName, $p0[$v_1].Label.LCID);
    ...
    setStepControlValue: function(StepValueControlView) {
        ...
        if (this.$4_5.get_stepModel().get_source().$g_0) {
            ...
            $v_0 = (!isNullOrEmptyString(this.$4_5.get_fieldDisplayText()))
                ? this.$4_5.get_fieldDisplayText()
                : window.LOCID_PROCESS_NEWFIELDTEXTKEY;
        }
...
ProcessConfiguration.View.ViewAdapterFactory.prototype = {
    ...
    createStepViewAdapter: function($p0, $p1, $p2, $p3) {
        var $v_0;
        if ($p2.get_stepModel().get_controlModel().get_controlStep().get_workflow()
            .get_workflowBusinessProcessType() ===
            1) {
...
ProcessConfiguration.View.ViewBase.prototype = {
    ...
    get_$5T_0: function() {
        return this.$51_0 || (this.$51_0 = new Sys.EventHandlerList());
    },
    ...
    addEventHandler: function(eventName, eventHandler) {
        this.get_$5T_0().addHandler(eventName, eventHandler);
    },

    removeEventHandler: function(eventName, eventHandler) {
        this.get_$5T_0().removeHandler(eventName, eventHandler);
    },

    getHandler: function(eventName) {
        return this.get_$5T_0().getHandler(eventName);
    },
...
ProcessConfiguration.View.RelationshipPickerView.prototype = {
    ...
    initialize: function() {
        this.$2f_1 = Mscrm.BusinessRules.SharedMethods.getList(Mscrm.SimpleInlineControlView);
        this.$0_0 = new Mscrm.Proxies.JQueryProxy();
        if (this.get_viewModel().get_picklistCount() > 0) {
            var $v_0 = this.$4H_1.build(this.get_viewModel(), this.$2f_1);
        ...
        if (this.get_viewModel().get_numberOfInvalidRelationships() > 0) {
            var $v_2 = this.$n_1.build('/_imgs/inlineedit/alert.png',
                window.LOCID_PROCESS_DIALOG_INVALID,
                window.LOCID_PROCESS_DIALOG_INVALID);
    ...
    getRelationshipModelList: function() {
        ...
        for (var $v_1 = 0; $v_1 < this.$2f_1.get_count(); $v_1++) {
            var $v_2 = this.get_viewModel().get_picklistViewModelDictionary()[$v_1.toString()];
            var $v_3 = (this.$2f_1.get_item($v_1).get_editView()).get_dataContext().get_attribute().get_rawValue();
            if (!IsNull($v_3) && $v_3) {
...
ProcessControl.Configuration.FieldMetadataJsonWrapper
    .registerClass('ProcessControl.Configuration.FieldMetadataJsonWrapper');
...
ProcessControl.Configuration.EntityRelationshipMetadataWrapper
    .registerClass('ProcessControl.Configuration.EntityRelationshipMetadataWrapper');
ProcessControl.Configuration.EntityMetadataJsonWrapper
    .registerClass('ProcessControl.Configuration.EntityMetadataJsonWrapper');
ProcessControl.Configuration.SourceData.registerClass('ProcessControl.Configuration.SourceData');
ProcessControl.Configuration.EmptyView.registerClass('ProcessControl.Configuration.EmptyView',
    null,
    ProcessControl.Configuration.IProcessControlView);
ProcessControl.Configuration.StepControlViewBase
    .registerClass('ProcessControl.Configuration.StepControlViewBase',
        ProcessControl.Configuration.ProcessControlViewBase$2
        .$$(Microsoft.Crm.Workflow.ObjectModel.StepBase, ProcessControl.Configuration.EmptyView),
        ProcessControl.Configuration.IProcessControlView);
ProcessControl.Configuration.ProcessControlStepView
    .registerClass('ProcessControl.Configuration.ProcessControlStepView',
        ProcessControl.Configuration.ProcessControlViewBase$2
        .$$(Microsoft.Crm.Workflow.ObjectModel.StepStep, ProcessControl.Configuration.StepControlViewBase),
        ProcessConfiguration.View.ILegacyProcessControlView);
ProcessControl.Configuration.ProcessControlStageView
    .registerClass('ProcessControl.Configuration.ProcessControlStageView',
        ProcessControl.Configuration.ProcessControlExtensibleView$2
        .$$(ProcessControl.Configuration.ProcessControlStepView, Microsoft.Crm.Workflow.ObjectModel.StageStep),
        ProcessConfiguration.View.ILegacyProcessControlView);
ProcessControl.Configuration.ProcessControlPageView
    .registerClass('ProcessControl.Configuration.ProcessControlPageView',
        ProcessControl.Configuration.ProcessControlStageView);
ProcessControl.Configuration.Initializer.registerClass('ProcessControl.Configuration.Initializer');
ProcessControl.Configuration.RelationshipPickerDialogInitializer
    .registerClass('ProcessControl.Configuration.RelationshipPickerDialogInitializer');
...
ProcessControl.Configuration.AddChildControlBehavior
    .registerClass('ProcessControl.Configuration.AddChildControlBehavior', Mscrm.CrmUIBehavior);
ProcessControl.Configuration.AddBranchConditionBehavior
    .registerClass('ProcessControl.Configuration.AddBranchConditionBehavior',
        ProcessControl.Configuration.AddChildControlBehavior);
ProcessControl.Configuration.AddStageBehavior.registerClass('ProcessControl.Configuration.AddStageBehavior',
    ProcessControl.Configuration.AddChildControlBehavior);
ProcessControl.Configuration.AddStepBehavior.registerClass('ProcessControl.Configuration.AddStepBehavior',
    ProcessControl.Configuration.AddChildControlBehavior);
ProcessControl.Configuration.ConditionBuilder.registerClass('ProcessControl.Configuration.ConditionBuilder',
    null,
    ProcessControl.Configuration.IConditionBuilder);
ProcessControl.Configuration.ProcessEventAggregator
    .registerClass('ProcessControl.Configuration.ProcessEventAggregator',
        Mscrm.CrmUIControl,
        ProcessControl.Configuration.IEventAggregator);
...
ProcessControl.Configuration.ProcessDesignerMenuActions
    .registerClass('ProcessControl.Configuration.ProcessDesignerMenuActions');
ProcessControl.Configuration.EntityTabsControl
    .registerClass('ProcessControl.Configuration.EntityTabsControl', Mscrm.FormInputControl.Tabs.TabsControl);
ProcessControl.Configuration.ProcessConfigurationUtility
    .registerClass('ProcessControl.Configuration.ProcessConfigurationUtility');
...
ProcessControl.Configuration.ProcessEnabledEntities
    .registerClass('ProcessControl.Configuration.ProcessEnabledEntities');
ProcessControl.Configuration.RelationshipPickerDialogArguments
    .registerClass('ProcessControl.Configuration.RelationshipPickerDialogArguments',
        null,
        ProcessControl.Configuration.IRelationshipPickerDialogArguments);
ProcessControl.Configuration.EmptyJsonWrapper.registerClass('ProcessControl.Configuration.EmptyJsonWrapper');
ProcessControl.Configuration.EmptyViewModel.registerClass('ProcessControl.Configuration.EmptyViewModel',
    null,
    Sys.IDisposable);
ProcessControl.Configuration.ProcessControlEntityView
    .registerClass('ProcessControl.Configuration.ProcessControlEntityView',
        ProcessControl.Configuration.ProcessControlExtensibleView$2
        .$$(ProcessControl.Configuration.ProcessControlStageView, Microsoft.Crm.Workflow.ObjectModel.EntityStep));
ProcessControl.Configuration.ProcessControlView
    .registerClass('ProcessControl.Configuration.ProcessControlView',
        ProcessControl.Configuration.ProcessControlExtensibleView$2
        .$$(ProcessControl.Configuration.ProcessControlEntityView, Microsoft.Crm.Workflow.ObjectModel.WorkflowStep),
        ProcessConfiguration.View.ILegacyProcessControlView);
ProcessConfiguration.InitializationContext.registerClass('ProcessConfiguration.InitializationContext',
    null,
    ProcessConfiguration.IInitializationContext);
ProcessConfiguration.Behavior.StageFocusBehaviorAdapter
    .registerClass('ProcessConfiguration.Behavior.StageFocusBehaviorAdapter',
        null,
        ProcessConfiguration.Behavior.IStageFocusBehaviorAdapter);
ProcessConfiguration.Behavior.StageFocusBehavior
    .registerClass('ProcessConfiguration.Behavior.StageFocusBehavior',
        ProcessConfiguration.Behavior.FocusBehaviorBase$1.$$(ProcessControl.Configuration.ProcessControlStageView));
ProcessConfiguration.Behavior.StageFocusEventBubbleBehavior
    .registerClass('ProcessConfiguration.Behavior.StageFocusEventBubbleBehavior',
        ProcessConfiguration.Behavior.StageFocusBehavior);
ProcessConfiguration.Behavior.StageFocusEventCapturingBehavior
    .registerClass('ProcessConfiguration.Behavior.StageFocusEventCapturingBehavior',
        ProcessConfiguration.Behavior.StageFocusBehavior);
ProcessConfiguration.Behavior.StageHoverBehavior
    .registerClass('ProcessConfiguration.Behavior.StageHoverBehavior',
        ProcessConfiguration.Behavior.HoverBehavior$1.$$(ProcessControl.Configuration.ProcessControlStageView));
ProcessConfiguration.Behavior.StageHoverBehaviorAdapter
    .registerClass('ProcessConfiguration.Behavior.StageHoverBehaviorAdapter',
        null,
        ProcessConfiguration.Behavior.IStageHoverBehaviorAdapter);
ProcessConfiguration.Behavior.StepFocusBehaviorAdapter
    .registerClass('ProcessConfiguration.Behavior.StepFocusBehaviorAdapter',
        null,
        ProcessConfiguration.Behavior.IStepFocusBehaviorAdapter);
ProcessConfiguration.Behavior.StepFocusBehavior
    .registerClass('ProcessConfiguration.Behavior.StepFocusBehavior',
        ProcessConfiguration.Behavior.FocusBehaviorBase$1.$$(ProcessControl.Configuration.ProcessControlStepView));
ProcessConfiguration.Behavior.StepFocusEventBubbleBehavior
    .registerClass('ProcessConfiguration.Behavior.StepFocusEventBubbleBehavior',
        ProcessConfiguration.Behavior.StepFocusBehavior);
ProcessConfiguration.Behavior.StepFocusEventCapturingBehavior
    .registerClass('ProcessConfiguration.Behavior.StepFocusEventCapturingBehavior',
        ProcessConfiguration.Behavior.StepFocusBehavior);
ProcessConfiguration.Behavior.StepHoverBehavior
    .registerClass('ProcessConfiguration.Behavior.StepHoverBehavior',
        ProcessConfiguration.Behavior.HoverBehavior$1.$$(ProcessControl.Configuration.ProcessControlStepView));
ProcessConfiguration.Behavior.StepHoverBehaviorAdapter
    .registerClass('ProcessConfiguration.Behavior.StepHoverBehaviorAdapter',
        null,
        ProcessConfiguration.Behavior.IStepHoverBehaviorAdapter,
        Sys.IDisposable);
ProcessConfiguration.Behavior.AddEntityBehavior
    .registerClass('ProcessConfiguration.Behavior.AddEntityBehavior',
        ProcessControl.Configuration.AddChildControlBehavior);
ProcessConfiguration.Behavior.BehaviorsFactory
    .registerClass('ProcessConfiguration.Behavior.BehaviorsFactory',
        null,
        ProcessConfiguration.Behavior.IBehaviorsFactory);
ProcessConfiguration.Behavior.ConfiguratorFlyout.registerClass('ProcessConfiguration.Behavior.ConfiguratorFlyout');
ProcessConfiguration.Behavior.ConfiguratorUnloadBehavior
    .registerClass('ProcessConfiguration.Behavior.ConfiguratorUnloadBehavior');
ProcessConfiguration.Behavior.ExpandCollapseBehavior
    .registerClass('ProcessConfiguration.Behavior.ExpandCollapseBehavior');
ProcessConfiguration.Behavior.ShowImageUploaderBehavior
    .registerClass('ProcessConfiguration.Behavior.ShowImageUploaderBehavior');
ProcessConfiguration.Behavior.MoveBehavior.registerClass('ProcessConfiguration.Behavior.MoveBehavior',
    Mscrm.CrmUIBehavior);
...
ProcessConfiguration.Behavior.AddBranchConditionBehaviorAdapter
    .registerClass('ProcessConfiguration.Behavior.AddBranchConditionBehaviorAdapter',
        ProcessConfiguration.View.ViewBase,
        ProcessConfiguration.Behavior.IAddBranchConditionBehaviorAdapter,
        Mscrm.BusinessRules.Views.IView,
        Sys.IDisposable);
ProcessConfiguration.Builder.ButtonBuilder.registerClass('ProcessConfiguration.Builder.ButtonBuilder',
    null,
    ProcessConfiguration.Builder.IButtonBuilder);
ProcessConfiguration.Builder.ImageBuilder.registerClass('ProcessConfiguration.Builder.ImageBuilder',
    null,
    ProcessConfiguration.Builder.IImageBuilder);
ProcessConfiguration.Builder.InlineEditControlBuilder
    .registerClass('ProcessConfiguration.Builder.InlineEditControlBuilder',
        null,
        ProcessConfiguration.Builder.IInlineEditControlBuilder);
ProcessConfiguration.Builder.StageBuilder.registerClass('ProcessConfiguration.Builder.StageBuilder',
    ProcessControl.Configuration.ProcessBuilder$1.$$(Microsoft.Crm.Workflow.ObjectModel.StepBase),
    ProcessConfiguration.Builder.IStageBuilder);
ProcessConfiguration.Builder.PageBuilder.registerClass('ProcessConfiguration.Builder.PageBuilder',
    ProcessConfiguration.Builder.StageBuilder);
ProcessConfiguration.Builder.StepBuilder.registerClass('ProcessConfiguration.Builder.StepBuilder',
    ProcessControl.Configuration.ProcessBuilder$1.$$(Microsoft.Crm.Workflow.ObjectModel.StepBase),
    ProcessConfiguration.Builder.IStepBuilder);
ProcessConfiguration.Builder.PageStepBuilder.registerClass('ProcessConfiguration.Builder.PageStepBuilder',
    ProcessConfiguration.Builder.StepBuilder);
ProcessConfiguration.Builder.RelationshipsTableBuilder
    .registerClass('ProcessConfiguration.Builder.RelationshipsTableBuilder',
        null,
        ProcessConfiguration.Builder.IRelationshipsTableBuilder);
ProcessConfiguration.Events.EventManager.registerClass('ProcessConfiguration.Events.EventManager',
    null,
    ProcessConfiguration.Events.IEventManager);
ProcessConfiguration.Models.IdentifyAccountSystemControlMetadataModel
    .registerClass('ProcessConfiguration.Models.IdentifyAccountSystemControlMetadataModel',
        null,
        ProcessConfiguration.Models.ISystemControlAttributeMetadataModel,
        ProcessConfiguration.Models.IAttributeMetadataModel);
ProcessConfiguration.Models.IdentifyCaseSystemControlMetadataModel
    .registerClass('ProcessConfiguration.Models.IdentifyCaseSystemControlMetadataModel',
        null,
        ProcessConfiguration.Models.ISystemControlAttributeMetadataModel,
        ProcessConfiguration.Models.IAttributeMetadataModel);
ProcessConfiguration.Models.IncidentIdentifyContactSystemControlMetadataModel
    .registerClass('ProcessConfiguration.Models.IncidentIdentifyContactSystemControlMetadataModel',
        null,
        ProcessConfiguration.Models.ISystemControlAttributeMetadataModel,
        ProcessConfiguration.Models.IAttributeMetadataModel);
ProcessConfiguration.Models.LeadIdentifyContactSystemControlMetadataModel
    .registerClass('ProcessConfiguration.Models.LeadIdentifyContactSystemControlMetadataModel',
        null,
        ProcessConfiguration.Models.ISystemControlAttributeMetadataModel,
        ProcessConfiguration.Models.IAttributeMetadataModel);
ProcessConfiguration.Models.IdentifyCustomerSystemControlMetadataModel
    .registerClass('ProcessConfiguration.Models.IdentifyCustomerSystemControlMetadataModel',
        null,
        ProcessConfiguration.Models.ISystemControlAttributeMetadataModel,
        ProcessConfiguration.Models.IAttributeMetadataModel);
ProcessConfiguration.Models.AvailableSystemControlsRefreshedEventArgs
    .registerClass('ProcessConfiguration.Models.AvailableSystemControlsRefreshedEventArgs', Sys.EventArgs);
ProcessConfiguration.Models.RelationshipModel.registerClass('ProcessConfiguration.Models.RelationshipModel',
    null,
    ProcessConfiguration.Models.IRelationshipModel);
ProcessConfiguration.Models.MetadataModelFactory
    .registerClass('ProcessConfiguration.Models.MetadataModelFactory',
        null,
        ProcessConfiguration.Models.IMetadataModelFactory);
ProcessConfiguration.Models.EntityMetadataModel
    .registerClass('ProcessConfiguration.Models.EntityMetadataModel',
        null,
        ProcessConfiguration.Models.IEntityMetadataModel);
ProcessConfiguration.Models.AttributeMetadataModel
    .registerClass('ProcessConfiguration.Models.AttributeMetadataModel',
        null,
        ProcessConfiguration.Models.IAttributeMetadataModel);
ProcessConfiguration.Models.ResolveSystemControlMetadataModel
    .registerClass('ProcessConfiguration.Models.ResolveSystemControlMetadataModel',
        null,
        ProcessConfiguration.Models.ISystemControlAttributeMetadataModel,
        ProcessConfiguration.Models.IAttributeMetadataModel);
ProcessConfiguration.Models.SolutionSystemControlMetadataModel
    .registerClass('ProcessConfiguration.Models.SolutionSystemControlMetadataModel',
        null,
        ProcessConfiguration.Models.ISystemControlAttributeMetadataModel,
        ProcessConfiguration.Models.IAttributeMetadataModel);
ProcessConfiguration.Models.SystemControlMetadataModel
    .registerClass('ProcessConfiguration.Models.SystemControlMetadataModel',
        null,
        ProcessConfiguration.Models.ISystemControlMetadataModel);
ProcessConfiguration.Services.RelationshipFilteringService
    .registerClass('ProcessConfiguration.Services.RelationshipFilteringService',
        null,
        ProcessConfiguration.Services.IRelationshipFilteringService);
ProcessConfiguration.Services.MetadataService.registerClass('ProcessConfiguration.Services.MetadataService',
    null,
    ProcessConfiguration.Services.IMetadataService,
    Sys.IDisposable);
ProcessConfiguration.Utility.RelationshipFilteringModule
    .registerClass('ProcessConfiguration.Utility.RelationshipFilteringModule');
ProcessConfiguration.Utility.LabelDictionary.registerClass('ProcessConfiguration.Utility.LabelDictionary');
ProcessConfiguration.Utility.ProcessViewVisitor
    .registerClass('ProcessConfiguration.Utility.ProcessViewVisitor',
        null,
        ProcessConfiguration.Utility.IProcessViewVisitor);
ProcessConfiguration.Utility.RelationshipPickerDialogLauncher
    .registerClass('ProcessConfiguration.Utility.RelationshipPickerDialogLauncher',
        null,
        ProcessConfiguration.Utility.IRelationshipPickerDialogLauncher);
ProcessConfiguration.ViewModels.AttributeLogicalNameChangedEventArgs
    .registerClass('ProcessConfiguration.ViewModels.AttributeLogicalNameChangedEventArgs', Sys.EventArgs);
ProcessConfiguration.ViewModels.AttributeValidatedEventArgs
    .registerClass('ProcessConfiguration.ViewModels.AttributeValidatedEventArgs', Sys.EventArgs);
ProcessConfiguration.ViewModels.ControlModel.registerClass('ProcessConfiguration.ViewModels.ControlModel',
    null,
    ProcessConfiguration.ViewModels.IControlModel);
ProcessConfiguration.ViewModels.EntityModel.registerClass('ProcessConfiguration.ViewModels.EntityModel',
    null,
    ProcessConfiguration.ViewModels.IEntityModel);
ProcessConfiguration.ViewModels.ViewModelBase.registerClass('ProcessConfiguration.ViewModels.ViewModelBase');
ProcessConfiguration.ViewModels.StepViewModel.registerClass('ProcessConfiguration.ViewModels.StepViewModel',
    ProcessConfiguration.ViewModels.ViewModelBase,
    ProcessConfiguration.ViewModels.IStepViewModel,
    Mscrm.BusinessRules.ViewModels.IViewModel,
    Sys.INotifyPropertyChange,
    Sys.IDisposable);
ProcessConfiguration.ViewModels.PageStepViewModel
    .registerClass('ProcessConfiguration.ViewModels.PageStepViewModel', ProcessConfiguration.ViewModels.StepViewModel);
ProcessConfiguration.ViewModels.RelationshipControlViewModel
    .registerClass('ProcessConfiguration.ViewModels.RelationshipControlViewModel',
        ProcessConfiguration.ViewModels.ViewModelBase,
        ProcessConfiguration.ViewModels.IRelationshipControlViewModel,
        Mscrm.BusinessRules.ViewModels.IViewModel,
        Sys.INotifyPropertyChange,
        Sys.IDisposable);
ProcessConfiguration.ViewModels.SourceLogicalNameChangedEventArgs
    .registerClass('ProcessConfiguration.ViewModels.SourceLogicalNameChangedEventArgs',
        ProcessConfiguration.ViewModels.AttributeLogicalNameChangedEventArgs);
ProcessConfiguration.ViewModels.StepEventArgs.registerClass('ProcessConfiguration.ViewModels.StepEventArgs',
    Sys.EventArgs);
ProcessConfiguration.ViewModels.StepListViewModel
    .registerClass('ProcessConfiguration.ViewModels.StepListViewModel',
        ProcessConfiguration.ViewModels.ViewModelBase,
        ProcessConfiguration.ViewModels.IStepListViewModel,
        Mscrm.BusinessRules.ViewModels.IViewModel,
        Sys.INotifyPropertyChange,
        Sys.IDisposable);
ProcessConfiguration.ViewModels.PageStepListViewModel
    .registerClass('ProcessConfiguration.ViewModels.PageStepListViewModel',
        ProcessConfiguration.ViewModels.StepListViewModel);
ProcessConfiguration.ViewModels.StepModel.registerClass('ProcessConfiguration.ViewModels.StepModel',
    null,
    ProcessConfiguration.ViewModels.IStepModel);
ProcessConfiguration.ViewModels.ProcessConfigurationValidationResult
    .registerClass('ProcessConfiguration.ViewModels.ProcessConfigurationValidationResult',
        null,
        Mscrm.IValidationResult);
ProcessConfiguration.ViewModels.RelationshipPickerPicklistViewModel
    .registerClass('ProcessConfiguration.ViewModels.RelationshipPickerPicklistViewModel',
        null,
        ProcessConfiguration.ViewModels.IRelationshipPickerPicklistViewModel);
ProcessConfiguration.ViewModels.ConditionBranchModel
    .registerClass('ProcessConfiguration.ViewModels.ConditionBranchModel',
        null,
        ProcessConfiguration.ViewModels.IConditionBranchModel);
ProcessConfiguration.ViewModels.ConditionBranchViewModel
    .registerClass('ProcessConfiguration.ViewModels.ConditionBranchViewModel',
        ProcessConfiguration.ViewModels.ViewModelBase,
        ProcessConfiguration.ViewModels.IConditionBranchViewModel,
        Mscrm.BusinessRules.ViewModels.IViewModel,
        Sys.INotifyPropertyChange,
        Sys.IDisposable);
ProcessConfiguration.ViewModels.ConditionModel
    .registerClass('ProcessConfiguration.ViewModels.ConditionModel',
        null,
        ProcessConfiguration.ViewModels.IConditionModel);
ProcessConfiguration.ViewModels.ConditionViewModel
    .registerClass('ProcessConfiguration.ViewModels.ConditionViewModel',
        ProcessConfiguration.ViewModels.ViewModelBase,
        ProcessConfiguration.ViewModels.IConditionViewModel,
        Mscrm.BusinessRules.ViewModels.IViewModel,
        Sys.INotifyPropertyChange,
        Sys.IDisposable);
ProcessConfiguration.ViewModels.SetNextStageModel
    .registerClass('ProcessConfiguration.ViewModels.SetNextStageModel',
        null,
        ProcessConfiguration.ViewModels.ISetNextStageModel);
ProcessConfiguration.ViewModels.StageModel.registerClass('ProcessConfiguration.ViewModels.StageModel',
    null,
    ProcessConfiguration.ViewModels.IStageModel);
ProcessConfiguration.ViewModels.StageViewModel
    .registerClass('ProcessConfiguration.ViewModels.StageViewModel',
        ProcessConfiguration.ViewModels.ViewModelBase,
        ProcessConfiguration.ViewModels.IStageViewModel,
        Mscrm.BusinessRules.ViewModels.IViewModel,
        Sys.INotifyPropertyChange,
        Sys.IDisposable);
ProcessConfiguration.ViewModels.StepModelFactory
    .registerClass('ProcessConfiguration.ViewModels.StepModelFactory',
        null,
        ProcessConfiguration.ViewModels.IStepModelFactory);
ProcessConfiguration.ViewModels.ViewModelFactory
    .registerClass('ProcessConfiguration.ViewModels.ViewModelFactory',
        null,
        ProcessConfiguration.ViewModels.IViewModelFactory);
ProcessConfiguration.ViewModels.RelationshipPickerViewModel
    .registerClass('ProcessConfiguration.ViewModels.RelationshipPickerViewModel',
        ProcessConfiguration.ViewModels.ViewModelBase,
        ProcessConfiguration.ViewModels.IRelationshipPickerViewModel,
        Mscrm.BusinessRules.ViewModels.IViewModel,
        Sys.INotifyPropertyChange,
...
ProcessConfiguration.ViewModels.ProcessConfigurationViewModel
    .registerClass('ProcessConfiguration.ViewModels.ProcessConfigurationViewModel',
        ProcessConfiguration.ViewModels.ViewModelBase,
        ProcessConfiguration.ViewModels.IProcessConfigurationViewModel,
        Mscrm.BusinessRules.ViewModels.IViewModel,
        Sys.INotifyPropertyChange,
        Sys.IDisposable);
ProcessConfiguration.View.ButtonView.registerClass('ProcessConfiguration.View.ButtonView',
    ProcessConfiguration.View.ViewBase,
    ProcessConfiguration.View.IButtonView,
    Mscrm.BusinessRules.Views.IView,
    Sys.IDisposable);
ProcessConfiguration.View.ButtonClickedEventArgs
    .registerClass('ProcessConfiguration.View.ButtonClickedEventArgs', Sys.EventArgs);
ProcessConfiguration.View.StageView.registerClass('ProcessConfiguration.View.StageView',
    ProcessConfiguration.View.ViewBase,
    ProcessConfiguration.View.IStageView,
    Mscrm.BusinessRules.Views.IView,
    Sys.IDisposable,
    ProcessConfiguration.View.INavigationInfo);
ProcessConfiguration.View.PageView.registerClass('ProcessConfiguration.View.PageView',
    ProcessConfiguration.View.StageView);
ProcessConfiguration.View.ProcessControlStepViewAdapter
    .registerClass('ProcessConfiguration.View.ProcessControlStepViewAdapter',
        ProcessConfiguration.View.ViewBase,
        ProcessConfiguration.View.IProcessControlStepViewAdapter,
        Mscrm.BusinessRules.Views.IView,
        Sys.IDisposable);
ProcessConfiguration.View.ProcessControlPageStepViewAdapter
    .registerClass('ProcessConfiguration.View.ProcessControlPageStepViewAdapter',
        ProcessConfiguration.View.ProcessControlStepViewAdapter);
ProcessConfiguration.View.ProcessEditorErrorContainerProvider
    .registerClass('ProcessConfiguration.View.ProcessEditorErrorContainerProvider',
        null,
        Mscrm.IErrorDisplayContainerProvider);
ProcessConfiguration.View.ProcessControlStageViewAdapter
    .registerClass('ProcessConfiguration.View.ProcessControlStageViewAdapter',
        ProcessConfiguration.View.ViewBase,
        ProcessConfiguration.View.IProcessControlStageViewAdapter,
        Mscrm.BusinessRules.Views.IView,
        Sys.IDisposable);
ProcessConfiguration.View.ConditionBranchView.registerClass('ProcessConfiguration.View.ConditionBranchView',
    ProcessConfiguration.View.ViewBase,
    ProcessConfiguration.View.IConditionBranchView,
    Mscrm.BusinessRules.Views.IView,
    Sys.IDisposable,
    ProcessConfiguration.View.INavigationInfo);
ProcessConfiguration.View.ConditionView.registerClass('ProcessConfiguration.View.ConditionView',
    ProcessConfiguration.View.ViewBase,
    ProcessConfiguration.View.IConditionView,
    Mscrm.BusinessRules.Views.IView,
    Sys.IDisposable,
    ProcessConfiguration.View.ICompositeView);
ProcessConfiguration.View.RelationshipControlView
    .registerClass('ProcessConfiguration.View.RelationshipControlView',
        ProcessConfiguration.View.ViewBase,
        ProcessConfiguration.View.IRelationshipControlView,
        Mscrm.BusinessRules.Views.IView,
        Sys.IDisposable);
ProcessConfiguration.View.StepFieldViewBase.registerClass('ProcessConfiguration.View.StepFieldViewBase',
    ProcessControl.Configuration.StepControlViewBase,
    ProcessConfiguration.View.IStepFieldControlView);
ProcessConfiguration.View.StepListView.registerClass('ProcessConfiguration.View.StepListView',
    ProcessConfiguration.View.ViewBase,
    ProcessConfiguration.View.IStepListView,
    Mscrm.BusinessRules.Views.IView,
    Sys.IDisposable);
ProcessConfiguration.View.PageStepSourceView.registerClass('ProcessConfiguration.View.PageStepSourceView',
    ProcessConfiguration.View.StepFieldViewBase);
ProcessConfiguration.View.StepFieldView.registerClass('ProcessConfiguration.View.StepFieldView',
    ProcessConfiguration.View.StepFieldViewBase);
ProcessConfiguration.View.ViewFactory.registerClass('ProcessConfiguration.View.ViewFactory',
    null,
    ProcessConfiguration.View.IViewFactory);
ProcessConfiguration.View.ProcessConfigurationView
    .registerClass('ProcessConfiguration.View.ProcessConfigurationView',
        ProcessConfiguration.View.ViewBase,
        ProcessConfiguration.View.IProcessConfigurationView,
        Mscrm.BusinessRules.Views.IView,
        Sys.IDisposable);
ProcessConfiguration.View.ProcessControlViewAdapter
    .registerClass('ProcessConfiguration.View.ProcessControlViewAdapter',
        ProcessConfiguration.View.ViewBase,
        ProcessConfiguration.View.IProcessControlViewAdapter,
        Mscrm.BusinessRules.Views.IView,
        Sys.IDisposable);
ProcessConfiguration.View.PageStepFieldView.registerClass('ProcessConfiguration.View.PageStepFieldView',
    ProcessConfiguration.View.StepFieldView);
ProcessConfiguration.View.ViewAdapterFactory.registerClass('ProcessConfiguration.View.ViewAdapterFactory',
    null,
    ProcessConfiguration.View.IViewAdapterFactory);
ProcessConfiguration.View.RelationshipPickerView
    .registerClass('ProcessConfiguration.View.RelationshipPickerView',
        ProcessConfiguration.View.ViewBase,
        ProcessConfiguration.View.IRelationshipPickerView,
        Mscrm.BusinessRules.Views.IView,
        Sys.IDisposable);
...
ProcessControl.Configuration.RelationshipPickerDialogInitializer.$4t = null;
...
ProcessControl.Configuration.SystemStepParams
    .identifyContactParams =
    '<parameters><IsDeDupLookup>true</IsDeDupLookup><InlineViewIds>{c14e0638-4996-4720-97cd-c58f0df74220}</InlineViewIds></parameters>';
ProcessControl.Configuration.SystemStepParams
    .identifyAccountParams =
    '<parameters><IsDeDupLookup>true</IsDeDupLookup><InlineViewIds>{f9e54d49-0c76-4cbd-979b-5fe94b496be0}</InlineViewIds></parameters>';
ProcessControl.Configuration.SystemStepParams
...
ProcessControl.Configuration.HtmlTemplate.$AI = ProcessControl.Configuration.HtmlTemplate
    .$62('<span class=\'{0}\'><div class=\'{1}\'><img src=\'{2}\' class=\'{3}\' tabindex=\'0\' title=\'{4}\' alt=\'{5}\' id=\'{6}\'/></div></span>', ['pc_step_dc', 'pc_step_del', '{0}', '{1}', '{2}', '{3}', '{4}']);
ProcessControl.Configuration.HtmlTemplate.$9z = ProcessControl.Configuration.HtmlTemplate
    .$62('<span class=\'{0}\'><div class=\'{1}\'><img src=\'{2}\' tabindex=\'0\' title=\'{3}\' alt=\'{4}\' id=\'{5}\'/></div></span>', ['pc_step_req', '{0}', '{1}', '{2}', '{3}', '{4}']);
ProcessControl.Configuration.HtmlTemplate
    .$5s = '<img src=\'/_imgs/processcontrol/6x8_breadcrumb_config.png\' id = \'{0}\' class=\'bpfConfBreadcrumbImg\'>';
ProcessControl.Configuration.HtmlTemplate
    .$6d =
    '<a id=\'pcc_options\' class=\'pcc_options\' title=\'{0}\'><img src=\'/_imgs/processcontrol/23_addminus_config.png\' id=\'pcc_options_img\' class=\'bpfConfOptionsImg\' alt=\'{0}\' title=\'{0}\' tabindex=\'0\'>{1}</a>';
ProcessControl.Configuration.ProcessEventAggregator.$3v = null;
...
ProcessControl.Configuration.BpfMenuActions.$5f = window.screen.availHeight;
ProcessControl.Configuration.BpfMenuActions.$5g = window.screen.availWidth - 10;
ProcessControl.Configuration.BPFClientProxy.$2o = false;
ProcessControl.Configuration.BPFClientProxy.$4X = null;
ProcessControl.Configuration.BPFClientProxy.$1Q = null;
ProcessControl.Configuration.BPFClientProxy.$4k = new ProcessConfiguration.InitializationContext();
ProcessControl.Configuration.ProcessDesignerMenuActions.$1k = false;
ProcessControl.Configuration.ProcessDesignerMenuActions.$1u = null;
ProcessControl.Configuration.ProcessDesignerMenuActions.$5f = window.screen.availHeight;
ProcessControl.Configuration.ProcessDesignerMenuActions.$5g = window.screen.availWidth - 10;
...
ProcessConfiguration.Behavior.ConfiguratorUnloadBehavior.$1t = null;
ProcessConfiguration.Behavior.ConfiguratorUnloadBehavior.$5N = null;
ProcessConfiguration.Behavior.ExpandCollapseBehavior.$4E = null;
ProcessConfiguration.Behavior.ExpandCollapseBehavior.$3y = null;
ProcessConfiguration.Behavior.ExpandCollapseBehavior.$3j = null;
ProcessConfiguration.Behavior.ExpandCollapseBehavior.$4F = null;
ProcessConfiguration.Behavior.ExpandCollapseBehavior.$3k = null;
ProcessConfiguration.Behavior.ExpandCollapseBehavior.$4Q = null;
ProcessConfiguration.Behavior.ExpandCollapseBehavior.$46 = null;
...
ProcessConfiguration.Utility.RelationshipFilteringModule.$4l = null;
