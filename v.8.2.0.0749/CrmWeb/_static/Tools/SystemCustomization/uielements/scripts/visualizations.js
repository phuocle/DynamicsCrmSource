...
var _oErrors = { sNoneSelected: LOCID_MANUIE_MUSTSELECT },
    _oConst = {
        entityOtc: "entityOtc",
        visualizationsFilters: "visualizationsFilters",
        sEditAction: "edit",
    ...
    _entityOtc,
    _oVisualizationActions = {
        GetAction: _oVisualizationActions_getAction,
        actions: { $edit: editVisualization, $delete: deleteVisualization, $export: exportVisualization }
    };
...
function onFilterChange() {
    var gridVisualizations = $find("gridVisualizations");
    gridVisualizations.SetParameter(_oConst.visualizationsFilters,
        Mscrm.FormControlInputBehavior.GetBehavior("selectFilter").get_dataValue());
...
function exportVisualization(sOid) {
    Mscrm.VisualizationActions.exportVisualization(sOid,
        Mscrm.EntityTypeCode.SavedQueryVisualization,
        true,
        document.getElementById("exportChartDiv"))
}
