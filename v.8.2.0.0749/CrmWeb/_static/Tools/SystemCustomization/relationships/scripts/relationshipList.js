...
var _oMessages = { sNoSelectedRelationship: LOCID_RELLST_MUSTSELECT },
    _oConst = {
        ...
        sCreateRelationshipUrlFormat:
            "/tools/systemcustomization/relationships/manageRelationship.aspx?entityRole={0}&entityId={1}",
        sUpdateRelationshipUrlFormat:
...
function dispatchAction(sRelationshipOid, sAction) {
    ...
    case _oConst.sDeleteAction:
        ...
        Mscrm.GridRibbonActions.deleteRecords(gridControl,
            gridControl.get_selectedRecords(),
            Mscrm.EntityTypeCode.EntityRelationship);
        break;
    case _oConst.sShowDependencyAction:
        Mscrm.Dependency.launchDependencyDlg(Mscrm.EntityTypeCode.EntityRelationship,
            getRelationshipId(sRelationshipOid));
        break;
    case _oConst.sManagedPropertyAction:
        Mscrm.ManagedPropertyUtil.launchManagedPropertyDlg(Mscrm.EntityTypeCode.EntityRelationship,
            getRelationshipId(sRelationshipOid));
        break;
...
function updateRelationshipAction(sRelationshipOid) {
    var sRelationshipId = getRelationshipId(sRelationshipOid),
        ...
        oUrl = Mscrm.CrmUri.create(formatString(_oConst.sUpdateRelationshipUrlFormat,
            sRelationshipRole,
            sRelationshipId,
            _sEntityId)),
        windowInfo = Mscrm.WindowInformation.getWindowInformation(Mscrm.EntityTypeCode.Relationship);
