...
var _oMessages = { sNoSelectedAttribute: LOCID_ATTRLST_MUSTSELECT, sOnlySelectOne: LOCID_ONLYSELECTONE_WARN },
    _oConst = {
        ...
        sMultipleItemsSelected: "2",
        sCreateAttributeUrlFormat: "/tools/systemcustomization/attributes/manageAttribute.aspx?entityId={0}",
        sUpdateAttributeUrlFormat:
            "/tools/systemcustomization/attributes/manageAttribute.aspx?attributeId={0}&entityId={1}",
        sBulkUpdateAttributeUrlFormat: "/_grid/cmds/dlg_editattribute.aspx?iTotal={0}&iEntityId={1}",
...
function dispatchAction(sAttributeOid, sAction) {
    ...
    case _oConst.sDeleteAction:
        ...
        var retVal = Mscrm.GridRibbonActions.deleteRecords(gridControl,
            ...
            Mscrm.EntityTypeCode.Attribute);
        break;
    ...
    case _oConst.sManagedPropertyAction:
        Mscrm.ManagedPropertyUtil.launchManagedPropertyDlg(Mscrm.EntityTypeCode.Attribute,
            getAttributeId(sAttributeOid));
        break;
...
function updateAttributeAction(sAttributeOid) {
    ...
    if (sAttributeIds.length > 1) {
        oUrl = Mscrm.CrmUri.create(formatString(_oConst
            .sBulkUpdateAttributeUrlFormat,
            sAttributeIds.length,
            _sEntityId));
...
function onFilterChange() {
    var gridAttributes = $find("gridAttributes");
    gridAttributes.SetParameter(_oConst.attributeFilter,
