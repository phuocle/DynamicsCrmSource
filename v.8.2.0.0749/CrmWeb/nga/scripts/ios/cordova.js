 ...
 */
            ...
            }, { "cordova-plugin-camera.Camera": "cordova-plugin-camera.Camera" }
        ],
 ...
 */
                ...
                "cordova-plugin-camera.Camera": "cordova-plugin-camera.Camera",
                "cordova/argscheck": "cordova/argscheck",
                "cordova/exec": "cordova/exec"
            }
        ],
 ...
 */
                DirectoryReader.prototype.readEntries = function(successCallback, errorCallback) {
                    ...
                    var reader = this;
                    var win = typeof successCallback !== 'function'
                        ? null
                        : function(result) {
                            var retVal = [];
                            for (var i = 0; i < result.length; i++) {
                                ...
                                entry
                                    .filesystem = new (require('cordova-plugin-file.FileSystem')
                    ...
                    var fail = typeof errorCallback !== 'function'
                        ? null
                        : function(code) {
                            errorCallback(new FileError(code));
                        };
                            ...
                            if (entry) {
                                if (successCallback) {
                                    ...
                                    var result = (entry.isDirectory)
                                        ? new (require('cordova-plugin-file.DirectoryEntry')
...
// States
                ...
                utils.defineGetter(FileReader.prototype,
                    'readyState',
                    function() {
                ...
                function defineEvent(eventName) {
                    utils.defineGetterSetter(FileReader.prototype,
                        eventName,
                        function() {
                ...
                function readSuccessCallback(readType, encoding, offset, totalSize, accumulate, r) {
                    ...
                    if (typeof r !== "undefined") {
                        ...
                        if (typeof this.onprogress === "function") {
                            this
                                .onprogress(new
                                    ProgressEvent("progress", { loaded: this._progress, total: totalSize }));
                        }
                    }
 ...
 */
                FileReader.prototype.readAsText = function(file, encoding) {
                    ...
                    readSuccessCallback.bind(this)("readAsText",
                        enc,
                        file.start,
                        totalSize,
                        function(r) {
 ...
 */
                FileReader.prototype.readAsDataURL = function(file) {
                    ...
                    var totalSize = file.end - file.start;
                    readSuccessCallback.bind(this)("readAsDataURL",
                        null,
                        file.start,
                        totalSize,
                        function(r) {
 ...
 */
                FileReader.prototype.readAsBinaryString = function(file) {
                    ...
                    var totalSize = file.end - file.start;
                    readSuccessCallback.bind(this)("readAsBinaryString",
                        null,
                        file.start,
                        totalSize,
                        function(r) {
 ...
 */
                FileReader.prototype.readAsArrayBuffer = function(file) {
                    ...
                    var totalSize = file.end - file.start;
                    readSuccessCallback.bind(this)("readAsArrayBuffer",
                        null,
                        file.start,
                        totalSize,
                        function(r) {
                            var resultArray = (this._progress === 0
                ...
                "cordova/exec": "cordova/exec",
                "cordova/modulemapper": "cordova/modulemapper",
                "cordova/utils": "cordova/utils"
            }
        ],
 ...
 */
                FileWriter.prototype.write = function(data, isPendingBlobReadResult) {
                    ...
                    var that = this;
                    var supportsBinary = (typeof window.Blob !== 'undefined' &&
                        typeof window.ArrayBuffer !== 'undefined');
                    var isProxySupportBlobNatively = (cordova
                        .platformId ===
                        "windows8" ||
...
*/
            ...
            }, { "cordova/channel": "cordova/channel", "cordova/exec": "cordova/exec" }
        ],
...
// Overridden by Android, BlackBerry 10 and iOS to populate fsMap.
        ...
        "cordova-plugin-file.iosFileSystem": [
            function(require, module, exports) {
/*
 *
 * Licensed to the Apache Software Foundation (ASF) under one
                    ...
                    var requestFileSystem = function(type, size, successCallback, errorCallback) {
                        ...
                        if (type < 0) {
                            ...
                            var success = function(file_system) {
                                if (file_system) {
                                    if (successCallback) {
                                        fileSystems.getFs(file_system.name,
                                            function(fs) {
...
*/
                                    ...
                                    if (successCallback) {
                                        ...
                                        fileSystems.getFs(fsName,
                                            function(fs) {
                                                ...
                                                var result = (entry.isDirectory)
                                                    ? new
                                                    DirectoryEntry(entry.name, entry.fullPath, fs, entry.nativeURL)
        ...
        "cordova-plugin-geolocation.Coordinates": [
            function(require, module, exports) {
/*
 *
 * Licensed to the Apache Software Foundation (ASF) under one
 ...
 */
        ...
        "cordova-plugin-geolocation.Position": [
            function(require, module, exports) {
/*
 *
 * Licensed to the Apache Software Foundation (ASF) under one
...
*/
                ...
                var Coordinates = require('cordova-plugin-geolocation.Coordinates');
            ...
            }, { "cordova-plugin-geolocation.Coordinates": "cordova-plugin-geolocation.Coordinates" }
        ],
...
*/
                ...
                var argscheck = require('cordova/argscheck'),
                    ...
                    Position = require('cordova-plugin-geolocation.Position');
...
// Returns a timeout failure, closed over a specified timeout value and error callback.
                ...
                "cordova-plugin-geolocation.Position": "cordova-plugin-geolocation.Position",
                "cordova-plugin-geolocation.PositionError": "cordova-plugin-geolocation.PositionError",
                "cordova/argscheck": "cordova/argscheck",
                "cordova/exec": "cordova/exec",
                "cordova/utils": "cordova/utils"
            }
        ],
        "cordova-plugin-media-capture.CaptureAudioOptions": [
            function(require, module, exports) {
/*
 *
 * Licensed to the Apache Software Foundation (ASF) under one
 ...
 */
        ...
        "cordova-plugin-media-capture.CaptureError": [
            function(require, module, exports) {
/*
 *
 * Licensed to the Apache Software Foundation (ASF) under one
...
// The requested capture operation is not supported.
        ...
        "cordova-plugin-media-capture.CaptureImageOptions": [
            function(require, module, exports) {
/*
 *
 * Licensed to the Apache Software Foundation (ASF) under one
 ...
 */
        ...
        "cordova-plugin-media-capture.CaptureVideoOptions": [
            function(require, module, exports) {
/*
 *
 * Licensed to the Apache Software Foundation (ASF) under one
 ...
 */
        ...
        "cordova-plugin-media-capture.MediaFileData": [
            function(require, module, exports) {
/*
 *
 * Licensed to the Apache Software Foundation (ASF) under one
 ...
 */
        ...
        "cordova-plugin-media-capture.MediaFile": [
            function(require, module, exports) {
/*
 *
 * Licensed to the Apache Software Foundation (ASF) under one
...
*/
                ...
                var utils = require('cordova/utils'),
                    exec = require('cordova/exec'),
                    File = require('cordova-plugin-file.File'),
                    CaptureError = require('cordova-plugin-media-capture.CaptureError');
/**
 ...
 */
                ...
                "cordova-plugin-file.File": "cordova-plugin-file.File",
                "cordova-plugin-media-capture.CaptureError": "cordova-plugin-media-capture.CaptureError",
                "cordova/exec": "cordova/exec",
                "cordova/utils": "cordova/utils"
            }
        ],
        "cordova-plugin-media-capture.capture": [
            function(require, module, exports) {
/*
 *
 * Licensed to the Apache Software Foundation (ASF) under one
...
*/
                ...
                var exec = require('cordova/exec'),
                    MediaFile = require('cordova-plugin-media-capture.MediaFile');
 ...
 */
                ...
                "cordova-plugin-media-capture.MediaFile": "cordova-plugin-media-capture.MediaFile",
                "cordova/exec": "cordova/exec"
            }
        ],
        "cordova/argscheck": [
...
*/
                ...
                base64.toArrayBuffer = function(str) {
                    var decodedStr = typeof atob != 'undefined'
                        ? atob(str)
 ...
 */
                ...
                function iOSExec() {
                    ...
                    if (typeof arguments[0] !== 'string') {
                        ...
                        throw new
                            Error('The old format of this exec call has been removed (deprecated since 2.1). Change to: ' +
                    ...
                    if (CordovaNavigator.bind) {
                        for (var key in origNavigator) {
                            if (typeof origNavigator[key] == 'function') {
                                ...
                                (function(k) {
                                    utils.defineGetterSetter(newNavigator,
                                        key,
                                        function() {
 ...
 */
                ...
                "cordova": "cordova",
                "cordova/channel": "cordova/channel",
                "cordova/exec": "cordova/exec",
                "cordova/modulemapper": "cordova/modulemapper",
                "cordova/platform": "cordova/platform",
                "cordova/pluginloader": "cordova/pluginloader",
                "cordova/utils": "cordova/utils"
            }
        ],
...
// Note: Android 2.3 does have Function.bind().
                ...
                exports.mapModules = function(context) {
                    ...
                    for (var i = 0, len = symbolList.length; i < len; i += 3) {
                        ...
                        var deprecationMsg = symbolPath in deprecationMap
        ...
        "cordova/plugin_list": [
            function(require, module, exports) {
                ...
                module.exports = [
                    ...
                    {
                        "file": "www/ios/CameraPopoverHandle.js",
...
// no plugins to load, or they are all done.
            ...
            }, { "cordova/modulemapper": "cordova/modulemapper", "cordova/plugin_list": "cordova/plugin_list" }
        ],
        "cordova/urlutil": [
            function(require, module, exports) {
/*
 ...
 */
        ...
        "phonegap-plugin-barcodescanner.BarcodeScanner": [
            function(require, module, exports) {
/**
