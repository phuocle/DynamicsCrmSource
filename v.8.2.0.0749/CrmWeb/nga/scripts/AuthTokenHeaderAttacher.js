...
(function(xhr) {
    ...
    var isMailApp = window.location.pathname.indexOf("mail.aspx") != -1 ||
        window.location.pathname.indexOf("mail.htm") != -1;
    var clientUrl = isMailApp
        ? "/AppWebServices/MetricsReportingService.asmx/Report"
        : parent.Xrm.Page.context.getClientUrl() + "/XRMServices/2011/Organization.svc/web";
                ...
                if (!headerSet) {
                    if (!authenticationManager) {
                        authenticationManager = isMailApp
                            ...
                            : window.parent.Microsoft.Crm.Client.Core.Framework.AuthenticationManager
                            .get_defaultInstance();
                    }
