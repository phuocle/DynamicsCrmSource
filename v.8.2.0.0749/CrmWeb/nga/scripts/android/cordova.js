...
*/
                ...
                var utils = require('cordova/utils');
                var PositionError = require('cordova-plugin-geolocation.PositionError');
...
// So we use additional map and own ids to return watch id synchronously.
                ...
                module.exports = {
                    getCurrentPosition: function(success, error, args) {
                        var win = function() {
                            var geo = cordova.require('cordova/modulemapper')
                                .getOriginalSymbol(window, 'navigator.geolocation');
 ...
 */
            ...
            }, { "cordova/android/promptbasednativeapi": "cordova/android/promptbasednativeapi" }
        ],
 ...
 */
                ...
                var nextTick = resolvedPromise
                    ? function(fn) { resolvedPromise.then(fn); }
...
// Processes a single message, as encoded by NativeToJsMessageQueue.java.
                ...
                "cordova": "cordova",
                "cordova/android/nativeapiprovider": "cordova/android/nativeapiprovider",
...
// The last resume event that was received that had the result of a plugin call.
                ...
                module.exports = {
                    ...
                    bootstrap: function() {
                        ...
                        var APP_PLUGIN_NAME = Number(cordova.platformVersion
                            .split('.')[0]) >=
                        4
                        ? 'CoreAndroid'
                        : 'App';
...
*/
                ...
                var exec = require('cordova/exec');
                var APP_PLUGIN_NAME = Number(require('cordova').platformVersion.split('.')[0]) >= 4
                    ? 'CoreAndroid'
                    : 'App';
            ...
            }, { "cordova": "cordova", "cordova/exec": "cordova/exec" }
        ],
        "cordova/plugin_list": [
            function(require, module, exports) {
                module.exports.metadata = {
