...
<head>
    ...
    <script type="text/javascript">
        ...
        var PageLoadStartTime = (window.performance.timing && window.performance.timing.navigationStart) ||
            __pageStartDate;
        ...
        var _fullText = _userEducationHeader +
            " " +
            _tip1Heading +
            " " +
            _tip1 +
    ...
    <!-- css -->
    <link href="resources/styles/ishLoadingCssDependencies.css?v=8200000749" rel="stylesheet" type="text/css"/>
    <link href="resources/styles/ishCssDependencies.css?v=8200000749" rel="stylesheet" type="text/css"/>
</head>
<body>
<% if (isIFrameNeeded)
   { %>
...
<!-- Script libraries -->
<script type="text/javascript" src="scripts/ishOssDependencies.js?v=8200000749"></script>
<script type="text/javascript" src="scripts/MicrosoftAjax.js?v=8200000749"></script>
<script type="text/javascript">
...
<div id="UserEducation" class="interactionCentricUserEducation" style="display: none" tabindex="-1" aria-label="Interactive Service Hub">
    ...
    <div id="userEducationWrapper">
        ...
        <div id="UserEducationTips" class="interactionCentricUserEducationTips">
            <div class="helpTip">
                <label id="UserEducationHelpTip1Heading" class="helpTipHeading"></label><label id="UserEducationHelpTip1" class="helpTipDescription"></label>
            </div>
            <div class="helpTip">
                <label id="UserEducationHelpTip2Heading" class="helpTipHeading"></label><label id="UserEducationHelpTip2" class="helpTipDescription"></label>
            </div>
            <div class="helpTip helpTipLast">
                <label id="UserEducationHelpTip3Heading" class="helpTipHeading"></label><label id="UserEducationHelpTip3" class="helpTipDescription"></label>
            </div>
        </div>
        ...
        <div id="ieSafriSpecificMsgWrapper">
            <div id="infoIcon"></div><span id="ieSafariSpecificMsg"></span>
        </div>
    </div>
    ...
    <!-- CRM Libraries -->
    <script type="text/javascript" src="scripts/ishMocaCoreDependencies.js?v=8200000749"></script>
    <script type="text/javascript" src="scripts/ishViewModelDependencies.js?v=8200000749"></script>
    <script type="text/javascript" src="scripts/ishViewDependencies.js?v=8200000749"></script>
    <script type="text/javascript" src="scripts/react.js?v=8200000749"></script>
    ...
    <script type="text/javascript">
        ...
        APIs -- >
            ISHNavigationEvents.Subscribe = function(handler) {
                return Microsoft.Crm.Client.Core.ViewModels.InteractionCentricNavigationEventManager.get_Instance()
                    .AddHandler(handler);
            };
    ...
    <script type="text/javascript">
        var VERSION_NUMERIC_VALUE = "8200000749";
        var require = {
    ...
    <script type="text/javascript" src="scripts/require.js?v=8200000749" data-main="scripts/main"></script>
</body>
</html>