...
<head>
    <title>
        <loc:Text ResourceId="Title_Condition" runat="server"/>
    </title>
    ...
    <script language="Javascript">
        ...
        function LoadConditionXml() {
            ...
            $find("appConditionBuilder")
                .set_expressionType("<%= Microsoft.Crm.CrmEncodeDecode.CrmNameValueEncode(ExpressionType) %>");
            if (oArgs.Xml != null) {
    ...
    <style type="text/css">
        ...
        SPAN.ms-crm-AdvFind-OperatorList { width: 150px; }

        .cndCondition > div { min-width: 770px; }
    </style>
</head>
