...
<HEAD>
    ...
    <title>
        <loc:Text ResourceId="Dialog_BulkEmail_Template_Title" runat="server"/>
    </title>
    <style type="text/css">
        .listRow {
            cursor: pointer;
    ...
    <script language="javascript">
        ...
        function applychanges() {
            Mscrm.Utilities.setReturnValue(new ObjectName(_oSelected.getAttribute("objectId"),
                _oSelected.getAttribute("objectType")));
            closeWindow(true);
        }
            ...
            <td class="dlg_template_target_td_List">
                <div style="position: absolute; height: 100%; width: 100%; top: 0px; left: 0px; overflow-y: auto; background-color: #FFFFFF; border: 1px solid #949E9C">
                    <table id="ListTable" cellspacing="4" cellpadding="0" width="100%">
                        ...
                        %>
                            <tr>
                                <td style="border-bottom: 2px solid #949e9c">
                                    <b>
                                        <loc:Text ResourceId="EE9154E4-B2BE-4FB1-91AE-9A88EE43D709" runat="server"/>
                                    </b>
                                </td>
                            </tr>
                        ...
                        %>
                            <tr>
                                <td style="border-bottom: 2px solid #949e9c">
                                    <b>
                                        <loc:Text ResourceId="4DE6C786-7193-4FB3-B7A4-CDD088130452" runat="server"/>
                                    </b>
                                </td>
                            </tr>
                        ...
                        %>
                            <tr>
                                <td style="border-bottom: 2px solid #949e9c">
                                    <b>
                                        <loc:Text ResourceId="0A5A5BAE-8282-4EB1-99F5-C2401632A767" runat="server"/>
                                    </b>
                                </td>
                            </tr>
