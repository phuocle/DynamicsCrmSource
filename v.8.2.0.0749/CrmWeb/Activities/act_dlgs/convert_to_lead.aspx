                    ...
                    <td>
                        <table width="100%" style="table-layout: fixed">
                            <tr>
                                <td>
                                    <label for="FirstName">
                                        <loc:Text ResourceId="FirstName_Label" runat="server"/>
                                    </label>
                                </td>
                                <td>
                    ...
                    <td>
                        <table width="100%" style="table-layout: fixed">
                            <tr>
                                <td>
                                    <label for="LastName">
                                        <loc:Text ResourceId="LastName_Label" runat="server"/>
                                    </label>
                                </td>
                                <td>
                    ...
                    <td>
                        <table width="100%" style="table-layout: fixed">
                            <tr>
                                <td >
                                    <label for="Company">
                                        <loc:Text ResourceId="Company_Label" runat="server"/>
                                    </label>
                                </td>
                                <td>
                            ...
                            <tr>
                                <td>
                                    <label for="EmailAddress">
                                        <loc:Text ResourceId="EmailAddress_Label" runat="server"/>
                                    </label>
                                </td>
                                <td>
                    ...
                    <td valign=top>
                        ...
                        <tr>
                            <td>
                                ...
                                <td>
                                    <label for="cbOpenNew"><loc:Text ResourceId="ConvertActivity_Action_OpenNewLead" runat="server"/>
                                </td>
                            </td>
                        </tr>
                        <tr>
