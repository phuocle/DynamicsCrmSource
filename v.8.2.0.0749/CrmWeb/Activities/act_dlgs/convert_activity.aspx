...
<script language="javascript">
    ...
    function onSubjectInit() {
        ...
        if (IsNull(subjectControl.get_dataValue()) || subjectControl.get_dataValue() == "") {
            if (
                "<%= Microsoft.Crm.Security.User.GetPrivilege(Privileges.ReadOpportunity, Microsoft.Crm.Application.Security.UserInformation.Current) %>" == "True") {
        ...
        var campaignType = "<%= Request.QueryString["campaignType"] %>";
        if (campaignType == "<%= Util.BulkOperation.ToString() %>") {
            _cbLogResponse.disabled = true;
        }
    }
...
<table width="100%">
    <tr class="main">
        <td>
                        ...
                        <table width="100%" style="table-layout: fixed">
                            <tr>
                                <td class="ms-crm-Field-Required">
                                    <label for="LeadLookup">
                                        <loc:Text ResourceId="ConvertActivity_Lead_Label" runat="server"/><img src="/_imgs/frm_required.gif" alt="<loc:Text Encoding='HtmlAttribute' ResourceId='Forms.Required.AltTag' runat='server'/>"/>
                                    </label>
                                </td>
                                <td>
                        ...
                        <tr>
                            <td class="ms-crm-Field-Required">
                                <label for="CustomerLookup">
                                    <loc:Text ResourceId="ConvertActivity_Opportunity_Label" runat="server"/><img src="/_imgs/frm_required.gif" alt="<loc:Text Encoding='HtmlAttribute' ResourceId='Forms.Required.AltTag' runat='server'/>"/>
                                </label>
                            </td>
                            <td>
            ...
            <tr>
                <td>
                    <table width="100%" style="table-layout: fixed">
                        <tr>
                            <td class="ms-crm-Field-Required">
                                <label for="CurrencyLookup">
                                    <loc:Text ResourceId="ConvertActivity_Currency_Label" runat="server"/><img src="/_imgs/frm_required.gif" alt="<loc:Text Encoding='HtmlAttribute' ResourceId='Forms.Required.AltTag' runat='server'/>"/>
                                </label>
                            </td>
                    ...
                    <table width="100%" style="table-layout: fixed">
                        <tr>
                            <td id="campaignTd" class="ms-crm-Field-Required">
                                <label for="CampaignLookup">
                                    <loc:Text ResourceId="ConvertActivity_Campaign_Label" runat="server"/><img src="/_imgs/frm_required.gif" alt="<loc:Text Encoding='HtmlAttribute' ResourceId='Forms.Required.AltTag' runat='server'/>"/>
                                </label>
                            </td>
                            <td>
                ...
                <td valign=top>
                    ...
                    <tr>
                        <td>
                            ...
                            <td>
                                <label for="cbOpenNew"><loc:Text ResourceId="ConvertActivity_Action_OpenNewRecord" runat="server"/>
                            </td>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <td>
                        <label for="cbSaveActivity"><asp:Label id="closeActivity" runat="server"/>
                    </td>
                </td>
            </tr>
            <tr>
            ...
            <td>
                <label for="cbLogResponse"><loc:Text ResourceId="ConvertActivity_Action_LogResponse" runat="server"/>
            </td>
        </td>
    </tr>
</table>
