                ...
                <table width="100%" height="100%" cellspacing="4" cellpadding="0" style="table-layout: fixed;">
                    ...
                    <tr>
                        <td class="ms-crm-Field-Label-Print">
                            <loc:Text ResourceId="Web.CS.articles.print.aspx_23" runat="server"/>
                        </td>
                        <cnt:AppPrintFieldControl runat='server' id='printtitle'/>
                        <td></td>
                        <td class="ms-crm-Field-Label-Print">
                            <loc:Text ResourceId="Web.CS.articles.print.aspx_26" runat="server"/>
                        </td>
                        <cnt:AppPrintLookupFieldControl runat='server' id='printsubjectid'/>
                    </tr>
                    <tr>
                        <td class="ms-crm-Field-Label-Print">
                            <loc:Text ResourceId="Web.CS.articles.print.aspx_30" runat="server"/>
                        </td>
                        <cnt:AppPrintFieldControl runat='server' id='printkeywords'/>
                    </tr>
                    <tr>
                        <td class="ms-crm-Field-Label-Print">
                            <loc:Text ResourceId="Web.CS.articles.print.aspx_34" runat="server"/>
                        </td>
                    </tr>
                    <tr height="100%">
                        <td colspan="5">
