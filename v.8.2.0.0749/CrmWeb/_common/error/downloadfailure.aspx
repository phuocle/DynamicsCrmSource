...
<table cellpadding="0" cellspacing="0" width="100%" style="table-layout: fixed;" class="ms-crm-Dialog-Error">
    ...
    <tr>
        <td>&nbsp;</td>
        <td class="ms-crm-Dialog-Error-Icon" style="vertical-align: middle;">
    ...
    <tr>
        ...
        <td style="padding-top: 8px">
            <a href="javascript:resizeToOriginalAndReturn()" class="ms-crm-Dialog-Error-Link">
                <loc:Text ResourceId="Web._common.error.downloadfailure.aspx_45" runat="server"/>
            </a>
        </td>
        <td>&nbsp;</td>
    </tr>
