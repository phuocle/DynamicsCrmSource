...
<head>
    ...
    <title>
        <loc:Text ResourceId="Web._common.error.unsupportedSecurity.aspx_10" CheckForLive="true" runat="server"/>
    </title>
</head>
...
<table width="100%" cellspacing="0" cellpadding="0" border="0" style="table-layout: fixed" class="ms-crm-Dialog-Error">
    ...
    <tr>
        ...
        <td class="ms-crm-Dialog-Error-Icon" style="vertical-align: top;">
            <img alt="" src="/_imgs/error/notif_SecurityBadgeWarning32.png"/>
        </td>
