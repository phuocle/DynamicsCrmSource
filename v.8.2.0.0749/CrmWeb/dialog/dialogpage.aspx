...
<head>
    ...
    <script>
        ...
        function validate() {
            var result = null;
            if (!IsNull(Mscrm.TurboForm.Control.PageManager.get_instance().get_primaryForm().getPageData()
                .getEntity())) {
                result = Mscrm.TurboForm.Control.PageManager.get_instance().get_primaryForm().getPageData().getEntity()
                    .validateAttributes();
            }
            return result;
        };
