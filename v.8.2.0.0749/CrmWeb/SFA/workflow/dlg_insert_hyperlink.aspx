    ...
    <script language="javascript" type="text/javascript">
        ...
        function GetXmlForSlugifiedControl(control, controlId) {
            ...
            if (IsDataSlugSpecified(control)) {
                ...
                sXml = CrmEncodeDecode.CrmXmlDecode(slugBehavior.get_slugValue()) +
                    '<slugtext>' +
                    CrmEncodeDecode.CrmXmlEncode(slugText) +
                    '</slugtext>';
            } else {
...
<frm:DialogForm id="hyperlinkDialog" showheader="false" runat="server">
    <div class="prDesignerCulture prDesigner">
        <table cellspacing="0" width="100%" cellpadding="3" style="table-layout: fixed;">
            ...
            <tr>
                <td class="TextBoxHyperlink" colspan="3">
                    <loc:Text ResourceId="Web.SFA.Workflow.InsertHyperlinkDialog.DisplayText" runat="server"/>
                </td>
            </tr>
            <tr>
                <tr>
                    <td class="TextBoxHyperlink" colspan="3">
                        <ui:TextBox id="DisplayText" TabIndex="1" runat="server"/>
                    </td>
                </tr>
            </tr>
            <tr>
                <td class="TextBoxHyperlink" colspan="3">
                    <loc:Text ResourceId="Web.SFA.Workflow.InsertHyperlinkDialog.Url" runat="server"/>
                </td>
            </tr>
            <tr>
                <td class="TextBoxHyperlink" colspan="3">
                    <ui:TextBox id="staticUrlTextbox" TabIndex="1" runat="server"/>
                </td>
            </tr>
        </table>
    </div>
