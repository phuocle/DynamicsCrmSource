...
<script language="javascript" type="text/javascript">
    ...
    Sys.Application.add_load(function() {
        ...
        var notificationString =
            <%= Microsoft.Crm.CrmEncodeDecode.CrmJavaScriptEncode(LoadWorkflowCurrencyNotification()) %>;
        ...
        if (notificationString.length > 0) {
            ...
            $find("WorkflowNotifications").AddNotification("invalidCurrency",
    ...
    function AddStageFilter(sender, args) {
        if (!IsNull(_processId)) {
            var fetchXml = '<filter type="and"><condition attribute="processid" operator="eq" value="' +
                _processId +
                '"/></filter>';
