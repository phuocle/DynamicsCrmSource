...
<script language="javascript">
    ...
    Sys.Application.add_load(function() {
        ...
        resultRenderElement.action = Mscrm.CrmUri
    ...
    function ExecuteQuery() {
        ...
        resultFrame.document.body
            .innerHTML =
            "<table height='100%' width='100%' style='cursor:wait'><tr><td valign='middle' align='center' style='height:100%'><img alt='' src='/_imgs/AdvFind/progress.gif'/><br>" + LOCID_AF_EXECUTINGSEARCH + "</td></tr></table>";
        switchTo("SEARCH");
