...
<script language="javascript">
    ...
    function lookupParent(fldName, fldId) {
        ...
        if (XUI.Xml.GetText(oXml) != "") {
            fldName.innerHTML = "<img alt='' src='/_imgs/ico_18_129.gif' align='absmiddle' class='icon'>" +
                XUI.Xml.GetText(XUI.Xml.SelectSingleNode(oXml, "/objects/subject/name", null));
            XUI.Html
                .SetText(fldId, XUI.Xml.GetText(XUI.Xml.SelectSingleNode(oXml, "/objects/subject/subjectid", null)));
        }
    }
    ...
    function updateUIState() {
        ...
        if ($get("radUnqualify").checked) {
            ...
            if (cbAddOpportunity.checked) {
                ...
                if ((cbAddContact.checked || cbAddAccount.checked || _crmOwnerLookup.get_dataValue() != null) &&
                    _crmCurrencyLookup.get_dataValue() != null) {
                    butBegin.disabled = false;
                } else {
                    butBegin.disabled = true;
                }
        ...
        <td>
            ...
            <table width="100%" style="table-layout: fixed">
                ...
                <tr>
                    ...
                    <td>
                        <label for="radQualify" style="FONT-WEIGHT: <%= Microsoft.Crm.Application.Utility.WebUtility.GetFontResourceAttribute("General.Bold.font_weight") %>">
                            <loc:Text ResourceId="Web.SFA.leads.dialogs.conv_lead.aspx_162" runat="server"/>
                        </label>
                    </td>
                </tr>
                <tr>
                    <td>
                        <table width="100%" style="table-layout: fixed">
                            ...
                            <tr>
                                <td>
                                    <label id="lbSelectQualifyStateCode" for="selQualifyStatus">
                                        <loc:Text ResourceId="Web.SFA.leads.dialogs.conv_lead.aspx_165" runat="server"/>
                                    </label>
                                </td>
                                <td>
                    ...
                    <td>
                        <table width="100%" style="table-layout: fixed">
                            ...
                            <tr>
                                ...
                                <td>
                                    <table width="100%" style="table-layout: fixed">
                                        <col width="130"><col>
                                        <tr>
                                            <td class="ms-crm-Field-Normal" id="lbSelectParent">
                                        ...
                                        <tr>
                                            <td class="ms-crm-Field-Normal" id="lbSelectCurrency">
                            ...
                            <tr>
                                ...
                                <td>
                                    <label for="cbShowNew">
                                        <loc:Text ResourceId="Web.SFA.leads.dialogs.conv_lead.aspx_145" runat="server"/>
                                    </label>
                                </td>
                            </tr>
                        </table>
            ...
            <table width="100%" style="table-layout: fixed">
                ...
                <tr>
                    <td rowspan="2" valign="top">
                        <input class="radio" type="radio" tabindex="9" id="radUnqualify" name="radQualifyGroup" onclick="updateUIState()" <% if (!_canConvertLead)
                                                                                                                                             { %>checked<% } %>>
                    </td>
                    <td>
                        <label for="radUnqualify" style="FONT-WEIGHT: <%= Microsoft.Crm.Application.Utility.WebUtility.GetFontResourceAttribute("General.Bold.font_weight") %>">
                            <loc:Text ResourceId="Web.SFA.leads.dialogs.conv_lead.aspx_155" runat="server"/>
                        </label>
                    </td>
                </tr>
                <tr>
                    <td>
                        <table width="100%" style="table-layout: fixed">
                            ...
                            <tr>
                                <td>
                                    <label disabled id="lbSelectStateCode" for="selStatus">
                                        <loc:Text ResourceId="Web.SFA.leads.dialogs.conv_lead.aspx_165" runat="server"/>
                                    </label>
                                </td>
                                <td>
