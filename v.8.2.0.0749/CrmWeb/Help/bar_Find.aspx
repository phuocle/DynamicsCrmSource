        ...
        <tr>
            <td style="width: 100%; overflow: hidden;">
                <div style="position: relative; height: 100%;">
                    <label for="findCriteria" id="findHintText" class="ms-crm-Dialog-Lookup-QuickFindHint" style="display: inline-block;">
                        <loc:Text ResourceId="Field_Label_Find_Contents" runat="server"/>
                    </label>
                </div>
