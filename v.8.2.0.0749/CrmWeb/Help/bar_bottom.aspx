...
<table style="width: 100%; height: 100%" cellspacing="0" cellpadding="0" style="table-layout: fixed;">
    ...
    <tr style="height: 26px">
        <td onclick="top.document.getElementById('helpContents').src = '<%= Microsoft.Crm.CrmEncodeDecode.CrmHtmlAttributeEncode(Microsoft.Crm.CrmEncodeDecode.CrmJavaScriptEncodeNoQuotes(copyrightFile)) %>';" class="ms-crm-StatusBar-Copyright">
