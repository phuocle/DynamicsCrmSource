    ...
    %>
                    <tr>
                        <td colspan="2" class="ms-crm-Emphasis-None" style="padding-bottom: 8px;">
                            <loc:Text ResourceId="Web.Help.find.aspx_33" runat="server">
                                <loc:Argument runat="server">
                                    <b><%= Microsoft.Crm.CrmEncodeDecode.CrmHtmlEncode(UserQuery) %></b>
                                </loc:Argument>
                            </loc:Text>
                        </td>
                    </tr>
        ...
        %>
                    <tr>
                        <td colspan="2" class="ms-crm-Emphasis-None" style="padding-bottom: 8px;">
                            <% if (iTitleCount > 0)
                               { %>
                                <loc:Text ResourceId="Web.Help.find.aspx_34" runat="server">
                                    <loc:Argument runat="server">
                                        <b><%= Microsoft.Crm.CrmEncodeDecode.CrmHtmlEncode(UserQuery) %></b>
                                    </loc:Argument>
                                </loc:Text>
                            <% }
                               ...
                               { %>
                                <loc:Text ResourceId="Web.Help.find.aspx_35" runat="server">
                                    <loc:Argument runat="server">
                                        <b><%= Microsoft.Crm.CrmEncodeDecode.CrmHtmlEncode(UserQuery) %></b>
                                    </loc:Argument>
                                </loc:Text><br>
    ...
    %>
        <tr>
            <td colspan="2" class="ms-crm-Emphasis-None">
                <loc:Text ResourceId="Web.Help.find.aspx_57" runat="server">
                    <loc:Argument runat="server">
                        <b><%= Microsoft.Crm.CrmEncodeDecode.CrmHtmlEncode(UserQuery) %></b>
                    </loc:Argument>
                </loc:Text>
                    ...
                    <table width="100%" cellspacing="0" cellpadding="0" class="err">
                        <tr>
                            <td>
                                ...
                                <loc:Text ResourceId="Web.Help.find.aspx_72" runat="server"/>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                ...
                                <loc:Text ResourceId="Web.Help.find.aspx_71" runat="server"/>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                ...
                                <loc:Text ResourceId="Web.Help.find.aspx_74" runat="server"/>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                ...
                                <loc:Text ResourceId="Web.Help.find.aspx_73" runat="server"/>
                            </td>
                        </tr>
                    </table>
                </span>
