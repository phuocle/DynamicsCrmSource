...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:msxsl="urn:schemas-microsoft-com:xslt"
                xmlns:crm="http://mscrm" version="1.0" exclude-result-prefixes="msxsl crm">
            ...
            <table class="tocPageOff">
              ...
              <tr level="0" onclick="toggle(this);" style="cursor:hand;">
                ...
                <xsl:attribute name="href">
                  <xsl:if test="@topic">
                    /help/<xsl:value-of select="$helpVersionPath" /><xsl:value-of select="$lcid" />
                    /<xsl:value-of select="$helpSku" />/content/<xsl:value-of select="@topic" />.htm
                  </xsl:if>
                </xsl:attribute>
                <td>
                  <img>
