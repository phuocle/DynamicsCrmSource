...
<script language="javascript">
    ...
    function SetupAndExecuteSearch() {
        ...
        if (IsRelevanceSearchEnabledInOrgSettings) {
            Mscrm.Utilities
                .setCookie("persistentSearchTypeCookie", MultiEntityQuickFindSearchType, 60 * 24 * 365 * 100);
        }
    ...
    <div class="primaryConductor" id="contentContainer">
        <div class="rootViewControl_content conductorContent RootView-searchPage" style="visibility: visible;" tabindex="-1">
            ...
            <div class="form_header meqfformHeader">
                ...
                <span></span>
                <div id="searchBoxHeader" class="searchBoxHeader meqfsearchBoxHeader" style="z-index: 1500;">
                                   ...
                                   { %>
                                    ...
                                    <div id="searchDiagolue" class="ms-crm-VS-Menu" style="width: 220px; display: none; margin-top: 35px; position: fixed; z-index: 1000;">
                                        <ul class="ms-crm-VS-Menu" id="searchDiagolueUL" style="padding: 0px 0px;" role="listbox">
                                            <li id="relevanceSearchLi" role="option" aria-selected="true" aria-label="<% = CurrentResourceManager.GetString("ExternalSearch_Label_Tooltip") %>" class="ms-crm-MenuItem-NoOutline ms-crm-VS-header-MenuItem ms-crm-VS-header-MenuItem-Rest" style="float: none;">
                                                <a href="#" class="ms-crm-VS-header-MenuItem-Aux ms-crm-VS-header-MenuItem-Aux-Rest" style="float: right; display: none;">
                                                    <span class="ms-crm-VS-header-MenuItem-Aux ms-crm-VS-header-MenuItem-Aux-Rest">
                                                        <img alt="" class="ms-crm-VS-header-MenuItem-Aux ms-crm-VS-header-MenuItem-Aux-Rest"/>
                                                    </span>
                                                </a><a class="crmntfcoverride ms-crm-VS-header-MenuItem-Anchor-Rest" style="cursor: default; background-color: none;" onclick="onSelectionBoxChange('1')">
                                                    <span>
                                                        <span class="ms-crm-VS-header-MenuItem-Icon ms-crm-VS-header-MenuItem-Icon-Rest">
                                                            <img style="padding-top: 4px;" src="/_imgs/DashboardSelector/crm_dashboard.png" class="ms-crm-VS-header-MenuItem-Icon ms-crm-VS-header-MenuItem-Icon-Rest">
                                            ...
                                            <li id="categorizedSearchLi" role="option" aria-selected="false" aria-label="<%= CurrentResourceManager.GetString("CategorizedSearch_Label_Tooltip") %>" class="ms-crm-MenuItem-NoOutline ms-crm-VS-header-MenuItem ms-crm-VS-header-MenuItem-Rest selected" style="float: none;">
                                                <a href="#" class="ms-crm-VS-header-MenuItem-Aux ms-crm-VS-header-MenuItem-Aux-Rest" style="float: right; display: none;">
                                                    <span class="ms-crm-VS-header-MenuItem-Aux ms-crm-VS-header-MenuItem-Aux-Rest">
                                                        <img alt="" class="ms-crm-VS-header-MenuItem-Aux ms-crm-VS-header-MenuItem-Aux-Rest"/>
                                                    </span>
                                ...
                                <% }
                                   ...
                                   { %>
                                    <span id="meqfStartLabel" class="meqfStartLabel" runat="server">
                                        <loc:Text ResourceId="Search_Label_Meqf" runat="server"/>
                                    </span>
                                <% } %>
                            </div>
