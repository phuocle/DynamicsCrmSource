...
#if DEBUG
%>
<span id="TurboNotifier" class="TurboNotifier">
    TurboForm
</span>
<%
#endif
...
<script>
    ...
    function loadForm() {
        ...
        if (IsNullOrEmptyString(navigatingAway) && IsNullOrEmptyString(entityTypeCode)) {
            Xrm.Internal.trace.warning("Form\\Page.aspx",
                "ignoring hash change: hash not recognized in {0}",
                window.location);
            return;
        }
...
<script>
    ...
    var createFormControlLite =
        "crmCreate(Mscrm.FormControlLite, { \"entityPermissions\": 255, \"subscribedEvents\": [102, 46, 98] }, null, { \"eventManager\": \"__Page_crmEventManager\" }, $get('crmForm'))";
    var createPageManager =
