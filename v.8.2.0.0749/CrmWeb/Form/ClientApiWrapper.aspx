...
<html>
<head>
<script language="javascript" src="<%= Microsoft.Crm.Application.Utility.CrmUri.Create(Microsoft.Crm.Application.ContentDelivery.HostBasedContentDeliveryService.GetCDNUrl().TrimEnd('/') + "/_static/_common/scripts/MicrosoftAjax.js") %>"></script>
<script language="javascript">
    ...
    function RunHandlers() {
        ...
        if (pendingScriptLoadCounts == 0) {
            while (currentHandlerIndex < handlerQueue.length) {
                ...
                RunHandlerInternal(handlerInfo.method,
                    handlerInfo.parameters,
                    handlerInfo.executionContext,
                    handlerInfo.executeIfAvailableOnly);
    ...
    function FireDataLoad() {
        ...
        window.parent.Mscrm.TurboForm.Control.PageManager.get_instance().get_primaryForm().getPageData()
            .invokeDataOnLoadHandlers(1);
