    ...
    <script language="JavaScript" type="text/javascript">
        ...
        function onload_handler() {
            if (window.opener && window.opener.RegisterAuthExpiryReminder) {
                window.opener.RegisterAuthExpiryReminder(REMIND_AUTH_EXPIRATION,
                    AUTH_EXPIRATION_REMINDER_TIME_IN_MINUTES);

                if (window.opener.Mscrm &&
                    window.opener.Mscrm.PageManager &&
                    window.opener.Mscrm.PageManager.get_instance()) {
...
<frm:DialogForm id="crmForm" runat="server">
    <table>
        ...
        <tr>
            <td>
                <loc:Text ResourceId="Dialog_Reauthenticate_Success_Description" runat="server"></loc:Text>
            </td>
        </tr>
    </table>
</frm:DialogForm>
