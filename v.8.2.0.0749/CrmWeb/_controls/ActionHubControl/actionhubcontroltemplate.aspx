...
<table id="noRecordForActionHub" class="noRecordForActionHub" cellpadding="0" cellspacing="0" border="0" style="display: none">
    <tr>
        <td>
            <div class="panel">
                <div class="text no-action-message" style="text-align: center;">
                    <img id="imgNoRecordForActionHub" tabindex="0" alt="<%= CrmEncodeDecode.CrmHtmlEncode(AppResourceManager.Default.GetString("DelveActionHub.NoRecordsMessage")) %>" class="imageAction no-record" src="/_imgs/delve_noactions.png"/>
