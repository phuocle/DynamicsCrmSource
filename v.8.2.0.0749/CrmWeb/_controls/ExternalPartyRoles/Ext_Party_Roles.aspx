...
<script language="javascript" type="text/javascript">
    ...
    function Save(sender, args) {
        ...
        try {
            ...
            CAPService.SetParameter("privilege",
                Mscrm.FormControlInputBehavior.GetBehavior("privilegeinfo").get_dataValue());
                    ...
                    <td style="width: 35%; vertical-align: top;">
                        ...
                        <fieldset>
                            ...
                            <table>
                                <tr>
                                    <td>
                                        <img alt="<% = Microsoft.Crm.CrmEncodeDecode.CrmHtmlAttributeEncode(CurrentResourceManager.GetString("Web.Biz.Roles.edit_role.aspx_externalparty_none_tooltip")) %>" src="/_imgs/ico_18_role_X.gif">
                                    </td>
                                    ...
                                    <td style="padding-left: 90px">
                                        <img alt="<% = Microsoft.Crm.CrmEncodeDecode.CrmHtmlAttributeEncode(CurrentResourceManager.GetString("Web.Biz.Roles.edit_role.aspx_externalparty_basic_tooltip")) %>" src='/_imgs/ico_18_role_B.gif'>
                                    </td>
                                ...
                                <tr>
                                    <td>
                                        <img alt="<% = Microsoft.Crm.CrmEncodeDecode.CrmHtmlAttributeEncode(CurrentResourceManager.GetString("Web.Biz.Roles.edit_role.aspx_externalparty_local_tooltip")) %>" src='/_imgs/ico_18_role_L.gif'>
                                    </td>
                                    ...
                                    <td style="padding-left: 90px">
                                        <img alt="<% = Microsoft.Crm.CrmEncodeDecode.CrmHtmlAttributeEncode(CurrentResourceManager.GetString("Web.Biz.Roles.edit_role.aspx_externalparty_global_tooltip")) %>" src='/_imgs/ico_18_role_G.gif'>
                                    </td>
