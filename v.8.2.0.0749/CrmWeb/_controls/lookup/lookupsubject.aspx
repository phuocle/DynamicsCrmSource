    ...
    function applychanges() {
        if (currentSubject != null) {
            ...
            if (currentSubject != "") {
                ...
                oLookupItem.html = "<img alt=\"\" class=\"ms-crm-Lookup-Item\" src=\"/_imgs/ico_16_129.gif\">" +
                    CrmEncodeDecode.CrmHtmlEncode(currentSubject.Name);
...
<div style="width: 100%; height: 100%; position: relative">
    <div class="ms-crm-Dialog-Lookup-ListHeaderBar">
        <div class="ms-crm-Dialog-Lookup-ListColumn">
            <loc:Text ResourceId="Web._controls.lookup.lookupsubject.aspx_105" runat="server"/>
        </div>
    </div>
