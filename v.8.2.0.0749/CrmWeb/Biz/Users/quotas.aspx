...
<head>
    ...
    <script language="javascript" type="text/javascript">
        ...
        function openFormObj(sAction, sGrid) {
            ...
            case "addquota":
                oUrl = Mscrm.CrmUri
                    .create("/_grid/cmds/dlg_addquota.aspx?iObjType=<%= Util.SystemUser.ToString("D", CultureInfo.InvariantCulture) %>&iTotal=1&uid=" + _oId[0]);
                iX = 600;
                iY = 425;
                bRefresh = false;
                break;
...
<div width="100%" height="100%" cellspacing="0" cellpadding="0">
    ...
    <div style="vertical-align: top;">
        <div id="tab1" class="ms-crm-Tab" style="display: inline; padding: 10px; overflow: hidden;">
            <div width="100%" height="100%" cellspacing="0" cellpadding="0">
                <div style="margin: 0px; padding: 0px; vertical-align: top;">
                    <cnt:AppQuotaGrid id="crmQuotaGrid" Disabled='true' ShowHeader='true' runat="server"/>
                </div>
            </div>
        </div>
        ...
        <div id="tab2" class="ms-crm-Tab" style="padding: 10px; overflow: hidden;">
            <div width="100%" height="100%" cellspacing="0" cellpadding="0">
                <div height="23">
                    <ui:MenuBar id="crmMenuBar2" runat="server"/>
                </div>
                <div style="margin: 0px; padding: 0px; vertical-align: top;">
                    <cnt:AppQuotaGrid id="crmQuotaGrid2" ShowHeader='true' runat="server"/>
                </div>
            </div>
        </div>
    </div>
