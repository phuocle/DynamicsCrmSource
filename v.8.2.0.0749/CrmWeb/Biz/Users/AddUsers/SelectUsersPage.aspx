...
<head>
    ...
    <script language="javascript" type="text/javascript">
        ...
        function lookupChange() {
            ...
            for (var i = 0; i < oaLookupItems.length; i++) {
                ...
                if (IsNull(oLookupItem.category) ||
                    isNaN(oLookupItem.category) ||
                    oLookupItem.category == LookupItemCategories.NONE) {
            ...
            WizardSetButtonEnabled(oaLookupItems.length > 0 && iValidItemCount == oaLookupItems.length,
    ...
    <style type="text/css">
        DIV.ms-crm-Lookup { height: 35px; }

        INPUT.ms-crm-Normal { height: 32px !important; }

        TD.Lookup_RenderButton_td { vertical-align: top; }
    </style>
</head>
<body>
