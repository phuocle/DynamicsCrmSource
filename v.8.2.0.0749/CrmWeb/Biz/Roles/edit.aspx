...
<script language="javascript" type="text/javascript">
    ...
    var _roleFormReadOnlyOrDisabled =
        <%= (crmForm.ReadOnly || crmForm.Disabled || _isSystemAdministrator) ? "true" : "false" %>;
    ...
    function Validate(roleName) {
        ...
        if (privs.indexOf(PRIVILEGE_CREATEUSER) != -1) {
            if (privs.indexOf(PRIVILEGE_CREATEUSERSETTINGS) == -1) {
                ...
                cus_depth = privs.substr(privs.indexOf(PRIVILEGE_CREATEUSERSETTINGS) +
                    PRIVILEGE_CREATEUSERSETTINGS.length +
                    1,
                    1);
    ...
    function CreatePrivilegeValue() {
        ...
        Mscrm.FormControlInputBehavior.GetBehavior("privilegeinfo")
            .set_dataValue((retval +
                <%= Microsoft.Crm.CrmEncodeDecode.CrmJavaScriptEncode(privilegesNotOnUI.ToString()) %>));
        <%
            }
        %>
    }
    ...
    function GetEncodedPrivilegeAltTag(objectTypeName, privilegeTypeCode, currentPrivilegeDepth) {
        return formatString(LOCID_FORMAT_ALTTAG,
            GetDisplayPrivilegeType(privilegeTypeCode),
            objectTypeName,
            GetTitle(currentPrivilegeDepth));
    }
...
<style type="text/css">
    ...
    TR.ms-crm-TitleRowBkgd { text-align: center; }
    ...
    <div id="tdAreas" class="ms-crm-Form-Background" style="min-height: 150px;">
        <div id="areaForm" style="padding-left: 10px; padding-right: 10px;">
            <frm:HardcodedForm id="crmForm" SupportsDefaultData="true" runat="server">
                            ...
                            <table class="ms-crm-TabMargin" width="98%" cellspacing="0" cellpadding="3px" class="ms-crm-ChartText" style="table-layout: fixed;">
                                ...
                                <tr>
                                    <td id="name_c" class="ms-crm-Field-Required">
                                        <label for="name">
                                            <loc:Text ResourceId="Web.Biz.Roles.edit_role.aspx_482" runat="server"/><img src="/_imgs/frm_required.gif" alt="<loc:Text Encoding='HtmlAttribute' ResourceId='Forms.Required.AltTag' runat='server'/>"/>
                                        </label>
                                    </td>
                                    <td onkeydown="BlockEnter(new Sys.UI.DomEvent(event));">
                                        <sdk:TextBoxControl id="name" Required="true" MaxLength="50" runat="server"/>
                                    </td>
                                    <td id="businessunitid_c" class="ms-crm-Field-Required">
                                        <label for="businessunitid">
                                            <loc:Text ResourceId="Web.Biz.Roles.edit_role.aspx_484" runat="server"/><img src="/_imgs/frm_required.gif" alt="<loc:Text Encoding='HtmlAttribute' ResourceId='Forms.Required.AltTag' runat='server'/>"/>
                                        </label>
                                    </td>
                                    <td id="businessunitid_d">
                                        <sdk:LookupControl id="businessunitid" AccessibilityLabelResourceId="Web.Biz.Roles.edit_role.aspx_484" LookupStyle="single" runat="server"/>
                                    </td>
                                </tr>
                            </table>
                        </div>
                ...
                <div class="legend">
                    <fieldset>
                        <legend>&nbsp;<span class="ms-crm-Emphasis-Strong">
                                <loc:Text ResourceId="Web.Biz.Roles.edit_role.aspx_1073" runat="server"/>
                            </span>&nbsp;
                        </legend>
                        <table width="100%" height="100%" cellspacing="3" style="margin-top: 3px;" onmouseover="SetAltText(new Sys.UI.DomEvent(event));">
                            ...
                            <tr class="ms-crm-ChartText">
                                <td>
                                    <img alt="<% = Microsoft.Crm.CrmEncodeDecode.CrmHtmlAttributeEncode(CurrentResourceManager.GetString("Web.Biz.Roles.edit_role.aspx_none_tooltip")) %>" src="/_imgs/ico_18_role_X.gif">
                                </td>
                                ...
                                <td>
                                    <img alt="<% = Microsoft.Crm.CrmEncodeDecode.CrmHtmlAttributeEncode(CurrentResourceManager.GetString("Web.Biz.Roles.edit_role.aspx_basic_tooltip")) %>" src='/_imgs/ico_18_role_B.gif'>
                                </td>
                                ...
                                <td>
                                    <img alt="<% = Microsoft.Crm.CrmEncodeDecode.CrmHtmlAttributeEncode(CurrentResourceManager.GetString("Web.Biz.Roles.edit_role.aspx_local_tooltip")) %>" src='/_imgs/ico_18_role_L.gif'>
                                </td>
                                ...
                                <td>
                                    <img alt="<% = Microsoft.Crm.CrmEncodeDecode.CrmHtmlAttributeEncode(CurrentResourceManager.GetString("Web.Biz.Roles.edit_role.aspx_deep_tooltip")) %>" src='/_imgs/ico_18_role_D.gif'>
                                </td>
                                ...
                                <td>
                                    <img alt="<% = Microsoft.Crm.CrmEncodeDecode.CrmHtmlAttributeEncode(CurrentResourceManager.GetString("Web.Biz.Roles.edit_role.aspx_global_tooltip")) %>" src='/_imgs/ico_18_role_G.gif'>
                                </td>
