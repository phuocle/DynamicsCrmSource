...
<head>
    ...
    <script language="JavaScript">
            ...
            if (viewEditor.contentWindow.ValidateView()) {
                ...
                if (result != null && result.length > 1) {
                    ...
                    if (oOutArgs.FetchXml.match(attributeRegEx) == null) {
                        ...
                        oOutArgs.FetchXml = oOutArgs.FetchXml
                            .replace(/<\/entity>/, "<attribute name=\"" + fieldName + "\" /></entity>");
                    }
                }


                if (Mscrm.Utilities.isEdge()) {
                    if (oInArgs.layoutXml != null) {
        ...
        function setReturnValue() {
            if (_bFromExportExcel || fromTemplate) {
                var oReturnValue = new Object();
    ...
    <table cellpadding="0" cellspacing="0" style="width: 100%; height: 100%">
        <tr>
            <td style="vertical-align: top">
                <iframe name="viewEditor" id="viewEditor" src="<%= Microsoft.Crm.CrmEncodeDecode.CrmHtmlAttributeEncode(Microsoft.Crm.Application.Utility.CrmUri.Create("/_static/blank.htm", Microsoft.Crm.Application.Security.UserInformation.Current).ToString()) %>" style="position: absolute; width: 100%; height: 100%;" scrolling="no" frameborder="0"></iframe>
            </td>
        </tr>
    </table>
</frm:DialogForm>
