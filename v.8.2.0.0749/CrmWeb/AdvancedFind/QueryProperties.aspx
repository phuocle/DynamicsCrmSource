...
<head>
    ...
    <script language="Javascript">
        ...
        function QueryPropertiesOnload() {
            ...
            if (IsNull(oArgs.sIsTabletEnabled)) {
                ...
                queryTabEnableControl.checked = (oArgs.sIsTabletEnabled.toString() == "True" ||
                    oArgs.sIsTabletEnabled.toString() == "true");
                if (!IsNull(oArgs.sFormId)) {

                    if (oArgs.sFormId.toLowerCase() == "d1f511a8-1ead-e211-bb72-00155da9a201" ||
                        oArgs.sFormId.toLowerCase() == "{d1f511a8-1ead-e211-bb72-00155da9a201}") {
    ...
    <style>
        ...
        .tabletcontainer { top: 90px !important; }
        ...
        .ms-crm-IE7-Height-Fix-Dummy-Container { height: 93%; }

        DIV.ms-crm-RefreshDialog-Header-Title { font-size: 36px !important; }
    </style>
    </script>
</head>
<body>
