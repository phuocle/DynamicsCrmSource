...
<style type="text/css">
    ...
    .ms-crm-RefreshDialog-Warning { bottom: 5px; }
...
<script language="javascript" type="text/javascript">
    ...
    var _activityTypes = new Array(<% = Util.PhoneCall %>,
        <% = Util.Letter %>,
        <% = Util.Fax %>,
        <% = Util.Email %>,
        <% = Util.Appointment %>);
    ...
    function closeWizard(bCompleted) {
        ...
        this.document.body
            .innerHTML =
            "<table height='100%' width='100%' style='cursor:wait'><tr><td valign='middle' align='center'><img alt='' src='/_imgs/AdvFind/progress.gif'/><br>" + LOCID_MC_PROGRESS_CLOSE + "</td></tr></table>";
    ...
    function overrideClose() {
        if ($get('activityFormFrame') &&
            !IsNull($get('activityFormFrame').contentWindow.$find) &&
            $get('activityFormFrame').contentWindow.$find("crmForm")) {
    ...
    function btnNext(domEvent) {
        ...
        if (_currentPageIndex == _totalPages) {
            ...
            mcPageBody5
                .innerHTML =
                "<table height='100%' width='100%' style='cursor:wait'><tr><td valign='middle' align='center'><img alt='' src='/_imgs/AdvFind/progress.gif'/><br>" + LOCID_MC_PROGRESS_CREATE + "</td></tr></table>";
            ...
            case _typeOwnerPageIndex:
                ...
                if (_selectedText == <% = Util.Email %> &&
                    !(IsNull(_activityFormFrame) ||
                        _activityFormFrame.document.readyState != "complete" ||
                        IsNull(_activityFormFrame.Mscrm))) {
            ...
            if (_currentSelectedItem == -1 ||
                ...
                if (isMailMergeOption(_selectedItem)) {
                    ...
                    var queryString = Mscrm.CrmUri.create("/MA/MiniCampaign/iframes/activityForm.aspx?objectTypeCode=" +
                        CrmEncodeDecode.CrmUrlEncode(_id)).toString();
                                ...
                                <td>
                                    <div id="temp1" ime-mode="auto" tabindex="2" onkeypress="if (event.keyCode == 32) selectEmailTemplate()">
                                        <a id="selectTemplate" href="#" onclick="selectEmailTemplate()" disabled="true">
                                            <img id="insertTemplateImg" src="/_imgs/htmlbar/cmd-insertField.gif" alt="<loc:Text Encoding='HtmlAttribute' ResourceId='Dialog_BulkEmail_Template_SubTitle' runat='server'/>" title="<loc:Text Encoding='HtmlAttribute' ResourceId='Dialog_BulkEmail_Template_SubTitle' runat='server'/>"/>
                                        </a>
                                    </div>
                                </td>
                            </tr>
