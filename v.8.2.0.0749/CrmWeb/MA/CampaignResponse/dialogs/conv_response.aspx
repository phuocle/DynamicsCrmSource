                    ...
                    <td>
                        <table width="100%" style="table-layout: fixed">
                            ...
                            <tr>
                                ...
                                <td>
                                    <label for="radCreateNewLead" style="FONT-WEIGHT: <%= WebUtility.GetFontResourceAttribute("General.Bold.font_weight") %>">
                                        <loc:Text ResourceId="MA.CampaignResponse.Dialogs.conv_response.aspx_CreateNewLead" runat="server"/>
                                    </label>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <table width="100%" style="table-layout: fixed">
                                        <tr valign="top">
                                            <td>
                                                <label>
                                                    <loc:Text ResourceId="MA.CampaignResponse.Dialogs.conv_response.aspx_CreateNewLead_Description" runat="server"/>
                                                </label>
                                            </td>
                                        </tr>
                                    </table>
                            ...
                            <tr>
                                ...
                                <td>
                                    <label for="radConvertExistingLead" style="FONT-WEIGHT: <%= WebUtility.GetFontResourceAttribute("General.Bold.font_weight") %>">
                                        <loc:Text ResourceId="MA.CampaignResponse.Dialogs.conv_response.aspx_ConvertExistingLead" runat="server"/>
                                    </label>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <table width="100%" style="table-layout: fixed">
                                        <tr valign="top">
                                            <td>
                                                <label for="LeadLookup" style="vertical-align: text-top">
                                                    <loc:text resourceid="MA.CampaignResponse.Dialogs.conv_response.aspx_ConvertExistingLead_Description" runat="server"/>
                                                </label>
                                            </td>
                                            <td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <label for="radCustomer" style="FONT-WEIGHT: <%= WebUtility.GetFontResourceAttribute("General.Bold.font_weight") %>">
                                        <loc:text resourceid="MA.CampaignResponse.Dialogs.conv_response.aspx_Customer" runat="server"/>
                                    </label>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <table width="100%" style="table-layout: fixed">
                                        <tr>
                                            <td valign="top">
                                                <label for="AcctContLookup" style="vertical-align: text-bottom">
                                                    <loc:Text ResourceId="MA.CampaignResponse.Dialogs.conv_response.aspx_Customer_Description" runat="server"/>
                                                </label>
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td valign="top">
                                                <label for="CreateNewRecordPicklist" style="vertical-align: text-bottom">
                                                    <loc:Text ResourceId="MA.CampaignResponse.Dialogs.conv_response.aspx_Customer_Sel_Rec" runat="server"/>
                                                </label>
                                            </td>
                                            <td valign="top">
                            ...
                            <tr>
                                <td valign="top">
                                    <input class="radio" type="radio" id="radClose" name="radLevel1Group" onclick="updateUIState()" <% if (!CanConvertResponse)
                                                                                                                                       { %>checked<% } %>>
                                </td>
                                <td>
                                    <label for="radClose" style="FONT-WEIGHT: <%= WebUtility.GetFontResourceAttribute("General.Bold.font_weight") %>">
                                        <loc:Text ResourceId="MA.CampaignResponse.Dialogs.conv_response.aspx_CloseResponse" runat="server"/>
                                    </label>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <table width="100%" style="table-layout: fixed">
                                        <tr>
                                            <td>
                                                <label id="lbSelectStateCode" for="ResponseStatePicklist" style="vertical-align: text-top">
                                                    <loc:Text ResourceId="MA.CampaignResponse.Dialogs.conv_response.aspx_Status" runat="server"/>
                                                </label>
                                            </td>
                                            <td>
