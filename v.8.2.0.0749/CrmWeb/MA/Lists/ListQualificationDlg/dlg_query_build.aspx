...
<head>
<title>
    <loc:Text ResourceId="MA.List.Dialogs.ManageMembers.Title" runat="server"/>
</title>
...
<script language="Javascript">
    ...
    function QueryBuilderOnLoad() {
        ...
        $get("resultRender").action = Mscrm.CrmUri.create("/AdvancedFind/fetchData.aspx" +
            ((window.location.search && window.location.search.length > 0) ? window.location.search + "&" : "?") +
            "dispActions=false").toString();
    ...
    function ExecuteQuery() {
        ...
        if (_sInvokeType == "lqRemove" || _sInvokeType == "lqKeep") {
            ...
            case "account":
                entityId =
                    <%= Microsoft.Crm.CrmEncodeDecode.CrmJavaScriptEncode(Microsoft.Crm.Metadata.MetadataCache.GetInstance(new OrganizationContext(UserInformation.Current.OrganizationId)).GetEntity(Util.Account).PrimaryKey.LogicalName) %>;
                break;

            case "lead":
                entityId =
                    <%= Microsoft.Crm.CrmEncodeDecode.CrmJavaScriptEncode(Microsoft.Crm.Metadata.MetadataCache.GetInstance(new OrganizationContext(UserInformation.Current.OrganizationId)).GetEntity(Util.Lead).PrimaryKey.LogicalName) %>;
                break;

            case "contact":
                entityId =
                    <%= Microsoft.Crm.CrmEncodeDecode.CrmJavaScriptEncode(Microsoft.Crm.Metadata.MetadataCache.GetInstance(new OrganizationContext(UserInformation.Current.OrganizationId)).GetEntity(Util.Contact).PrimaryKey.LogicalName) %>;
                break;
            }
    ...
    function LqAction() {
        ...
        case "lqUseQuery":
            ...
            ProcessLQUseQuery(lqAdvFind.get_fetchXml(), oParams);
            break;
    ...
    function RemoveFromList() {
        ...
        var oParams = "iListId=" +
            ...
            sIds +
            "&savedQueryId=" +
            lqAdvFind.get_queryId() +
            "&savedQueryType=" +
            lqAdvFind.get_queryObjectType() +
            "&isDirty=" +
            lqAdvFind.get_isDirty();
                                ...
                                <td>
                                    <table class="stdTable" cellpadding="0" cellspacing="0">
                                        ...
                                        <tr>
                                            ...
                                            <td align="center">
                                                <span class="dlg_query_build_span_QuickFindSpacer">&nbsp;</span>
                                            </td>
                                            <td nowrap class="dlg_query_build_td_RecordType">
                                                <b style="color: #666666;">
                                                    <loc:Text ResourceId="Web.Record_Type_Label" runat="server"/>
                                                </b>
                                            </td>
                                            <td valign="center">
                                                <cui:Select id="crmSelectType" OnChange="FilterGridByType()" runat="server"/>
                                            </td>
                                            <td align="center">
                                                <span class="dlg_query_build_span">&nbsp;</span>
                                            </td>
                                            <td nowrap class="dlg_query_build_td_ViewSelector">
