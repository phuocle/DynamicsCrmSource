<%@ Page language="c#" Inherits="Microsoft.Crm.Web.Tools.BulkDelete.SearchCriteriaPage" %>
...
<head>
    ...
    <script language="javascript">
        ...
        function SearchCriteriaPageOnLoad() {
            ...
            document.getElementById("resultRender").action = Mscrm.CrmUri
                .create("/AdvancedFind/fetchData.aspx?dispActions=false&dispMenuBar=false").toString();
        ...
        function ExecuteQuery() {
            ...
            resultFrame.document.body
                .innerHTML =
                "<table height='100%' width='100%' style='cursor:wait'><tr><td valign='middle' align='center'><img alt='' src='/_imgs/AdvFind/progress.gif'/><br>" + CrmEncodeDecode.CrmHtmlEncode(LOCID_AF_EXECUTINGSEARCH) + "</td></tr></table>";
            switchTo("SEARCH");
    ...
    <style>
        ...
        .ms-crm-GridActionBar { height: 25px; }
    </style>
