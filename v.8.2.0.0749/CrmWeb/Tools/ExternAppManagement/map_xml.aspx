...
<page id="0">
    <title>
        <loc:Text ResourceId="Web.Tools.ExternAppManagement.map_xml.aspx.title" runat="server"/>
    </title>
    ...
    <sections>
        <section>
            ...
            %>
                <page id="01">
                    <title>
                        <loc:Text ResourceId="Web.Tools.ExternAppManagement.Profiles" runat="server"/>
                    </title>
                    <showstagetitle>1</showstagetitle>
                    ...
                    <url>
                        <app:FlatHomepageUrlControl EntityLogicalName="channelaccessprofile" XmlEncode="true" runat="server"/>
                    </url>
                    <help>
                        <loc:Text ResourceId="Web.Tools.ExternAppManagement.Profiles.Description" runat="server"/>
                    </help>
                </page>
            <%
               }
            ...
            %>
                <page id="02">
                    <title>
                        <loc:Text ResourceId="Web.Tools.ExternAppManagement.ProfileRules" runat="server"/>
                    </title>
                    <showstagetitle>1</showstagetitle>
                    ...
                    <url>
                        <app:FlatHomepageUrlControl EntityLogicalName="channelaccessprofilerule" XmlEncode="true" runat="server"/>
                    </url>
                    <help>
                        <loc:Text ResourceId="Web.Tools.ExternAppManagement.ProfileRules.Description" runat="server"/>
                    </help>
                </page>
            <%
               }
            ...
            %>
                <page id="03">
                    <title>
                        <loc:Text ResourceId="Web.Tools.ExternAppManagement.ExternUsers" runat="server"/>
                    </title>
                    <showstagetitle>1</showstagetitle>
                    ...
                    <url>
                        <app:FlatHomepageUrlControl EntityLogicalName="externalparty" XmlEncode="true" runat="server"/>
                    </url>
                    <help>
                        <loc:Text ResourceId="Web.Tools.ExternAppManagement.ExternUsers.Description" runat="server"/>
                    </help>
                </page>
            <%
               }
            ...
            %>
                <page id="04">
                    <title>
                        <loc:Text ResourceId="Web.Tools.ExternAppManagement.ExternalPartyItems" runat="server"/>
                    </title>
                    <showstagetitle>1</showstagetitle>
                    ...
                    <url>
                        <app:FlatHomepageUrlControl EntityLogicalName="externalpartyitem" XmlEncode="true" runat="server"/>
                    </url>
                    <help>
                        <loc:Text ResourceId="Web.Tools.ExternAppManagement.ExternalPartyItem.Description" runat="server"/>
                    </help>
                </page>
            <%
               }
