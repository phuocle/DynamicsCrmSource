...
<head>
    ...
    <title>
        <loc:Text ResourceId="Web.Tools.ViewEditor.dialogs.AdvancedProperties.aspx_3" runat="server"/>
    </title>
    ...
    <tr>
        <td class="ms-crm-Dialog-Header">
            <div class="ms-crm-Dialog-Header-Title">
                <loc:Text ResourceId="Web.Tools.ViewEditor.dialogs.AdvancedProperties.aspx_156" runat="server"/>
            </div>
            <div class="ms-crm-Dialog-Header-Desc">
                <loc:Text ResourceId="Web.Tools.ViewEditor.dialogs.AdvancedProperties.aspx_157" runat="server"/>
            </div>
        </td>
    </tr>
    <tr>
        <td class="ms-crm-Dialog-Main override-height-Auto">
            ...
            <table width="100%" cellspacing="0" cellpadding="4">
                ...
                <tr>
                    <td colspan="2">
                        <div class="secTitle">
                            <loc:Text ResourceId="Web.Tools.ViewEditor.dialogs.AdvancedProperties.aspx_166" runat="server"/>
                        </div>
                    </td>
                </tr>
                <tr height="20">
                    <td>
                        <loc:Text ResourceId="Web.Tools.ViewEditor.dialogs.AdvancedProperties.aspx_169" runat="server"/>
                    </td>
                ...
                <tr title="<loc:Text Encoding='HtmlAttribute' ResourceId='Web.Tools.ViewEditor.dialogs.AdvancedProperties.aspx_172' runat='server'/>">
                    <td>
                        <label for="objectTypeId">
                            <loc:Text ResourceId="Web.Tools.ViewEditor.dialogs.AdvancedProperties.aspx_173" runat="server"/>
                        </label>
                    </td>
                    <td>
                        <input type="text" id="objectTypeId" name="objectType" onkeyup="updateUI();" maxlength="4"/>
                    </td>
                </tr>
                <tr>
                    <td colspan="2">
                        <div class="secTitle" style="margin-top: 10px;">
                            <loc:Text ResourceId="Web.Tools.ViewEditor.dialogs.AdvancedProperties.aspx_177" runat="server"/>
                        </div>
                    </td>
                </tr>
                <tr title="<loc:Text Encoding='HtmlAttribute' ResourceId='Web.Tools.ViewEditor.dialogs.AdvancedProperties.aspx_179' runat='server'/>">
                    <td>
                        <label for="queryApiId">
                            <loc:Text ResourceId="Web.Tools.ViewEditor.dialogs.AdvancedProperties.aspx_180" runat="server"/>
                        </label>
                    </td>
                    <td>
                        <input type="text" id="queryApiId" name="queryApi" onkeyup="updateUI();" maxlength="100"/>
                    </td>
                </tr>
                <tr title="<loc:Text Encoding='HtmlAttribute' ResourceId='Web.Tools.ViewEditor.dialogs.AdvancedProperties.aspx_183' runat='server'/>">
                    <td>
                        <label for="rootNameId">
                            <loc:Text ResourceId="Web.Tools.ViewEditor.dialogs.AdvancedProperties.aspx_184" runat="server"/>
                        </label>
                    </td>
                    <td>
                        <input type="text" id="rootNameId" name="rootName" onkeyup="updateUI();" maxlength="50" disabled/>
                    </td>
                </tr>
                <tr title="<loc:Text Encoding='HtmlAttribute' ResourceId='Web.Tools.ViewEditor.dialogs.AdvancedProperties.aspx_187' runat='server'/>">
                    <td>
                        <label for="rowNameId">
                            <loc:Text ResourceId="Web.Tools.ViewEditor.dialogs.AdvancedProperties.aspx_188" runat="server"/>
                        </label>
                    </td>
                    <td>
                        <input type="text" id="rowNameId" name="rowName" onkeyup="updateUI();" maxlength="50" disabled/>
                    </td>
                </tr>
                <tr title="<loc:Text Encoding='HtmlAttribute' ResourceId='Web.Tools.ViewEditor.dialogs.AdvancedProperties.aspx_191' runat='server'/>">
                    <td>
                        <label for="idColumnId">
                            <loc:Text ResourceId="Web.Tools.ViewEditor.dialogs.AdvancedProperties.aspx_193" runat="server"/>
                        </label>
                    </td>
                    <td>
                        <input type="text" id="idColumnId" name="idColumn" onkeyup="updateUI();" maxlength="50"/>
                    </td>
                </tr>
                <tr title="<loc:Text Encoding='HtmlAttribute' ResourceId='Web.Tools.ViewEditor.dialogs.AdvancedProperties.aspx_195' runat='server'/>">
                    <td>
                        <label for="objIdColumnId">
                            <loc:Text ResourceId="Web.Tools.ViewEditor.dialogs.AdvancedProperties.aspx_196" runat="server"/>
                        </label>
                    </td>
                    <td>
                        <input type="text" id="objIdColumnId" name="objIdColumn" onkeyup="updateUI();" maxlength="50"/>
                    </td>
                </tr>
            </table>
            ...
            <table cellpadding="0" width="100%" style="table-layout: fixed; margin-top: 13px;">
                ...
                <tr>
                    <td valign="top">
                        ...
                        <div class="secTitle">
                            <loc:Text ResourceId="Web.Tools.ViewEditor.dialogs.AdvancedProperties.aspx_206" runat="server"/>
                        </div>
                        ...
                        <table width="100%" cellspacing="0" cellpadding="4" class="AdvancedProperties_table">
                            ...
                            <tr>
                                <td>
                                    <input type="checkbox" class="checkbox" onclick="updateUI();" id="ckIcon">
                                </td>
                                <td>
                                    <label for="ckIcon">
                                        <loc:Text ResourceId="Web.Tools.ViewEditor.dialogs.AdvancedProperties.aspx_212" runat="server"/>
                                    </label>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <input type="checkbox" class="checkbox" onclick="updateUI();" id="ckPreview">
                                </td>
                                <td>
                                    <label for="ckPreview">
                                        <loc:Text ResourceId="Web.Tools.ViewEditor.dialogs.AdvancedProperties.aspx_216" runat="server"/>
                                    </label>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <input type="checkbox" class="checkbox" onclick="updateUI();" id="ckCheck">
                                </td>
                                <td>
                                    <label for="ckCheck">
                                        <loc:Text ResourceId="Web.Tools.ViewEditor.dialogs.AdvancedProperties.aspx_220" runat="server"/>
                                    </label>
                                </td>
                            </tr>
                        </table>
                    ...
                    <td valign="top">
                        <div class="secTitle">
                            <loc:Text ResourceId="Web.Tools.ViewEditor.dialogs.AdvancedProperties.aspx_227" runat="server"/>
                        </div>
                        ...
                        <table width="100%" cellspacing="0" cellpadding="4" class="AdvancedProperties_table_Title">
                            ...
                            <tr>
                                <td>
                                    <input type="checkbox" class="checkbox" onclick="updateUI();" id="ckCust">
                                </td>
                                <td>
                                    <label for="ckCust">
                                        <loc:Text ResourceId="Web.Tools.ViewEditor.dialogs.AdvancedProperties.aspx_233" runat="server"/>
                                    </label>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <input type="checkbox" class="checkbox" onclick="updateUI();" id="ckQuickFind">
                                </td>
                                <td>
                                    <label for="ckQuickFind">
                                        <loc:Text ResourceId="Web.Tools.ViewEditor.dialogs.AdvancedProperties.aspx_237" runat="server"/>
                                    </label>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <input type="checkbox" class="checkbox" onclick="updateUI();" id="ckDefault">
                                </td>
                                <td>
                                    <label for="ckDefault">
                                        <loc:Text ResourceId="Web.Tools.ViewEditor.dialogs.AdvancedProperties.aspx_241" runat="server"/>
                                    </label>
                                </td>
                            </tr>
                        </table>
