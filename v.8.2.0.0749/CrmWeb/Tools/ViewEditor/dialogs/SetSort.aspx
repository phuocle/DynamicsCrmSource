...
<head>
    ...
    <title>
        <loc:Text ResourceId="Web.Tools.ViewEditor.dialogs.SetSort.aspx_14" runat="server"/>
    </title>
    ...
    <script language="javascript">
        ...
        function PageLoad() {
            ...
            for (var i = 0; i < iLen; i++) {
                ...
                if (isSortableField(oArgs.oFieldsXml, sEntityName, sFieldName)) {
                    SelectSortCol.AddOption(GetFieldDisplayName(oArgs.oPropertiesXml, sEntityName, sFieldName),
                        sFieldName);
                    if (sFieldName != pAttrSort) {
                        SelectSortCol2.AddOption(GetFieldDisplayName(oArgs.oPropertiesXml, sEntityName, sFieldName),
                            sFieldName);
                    }
                }
            }
        ...
        function applychanges() {
            ...
            if (sortCol2Ctrl.get_defaultValue() == "undefinedselectattribute" &&
                sortColSelectedValue2 != "undefinedselectattribute") {
                change = true;
            } else if (sortCol2Ctrl.get_defaultValue() != "undefinedselectattribute" &&
                (sAttrSortOrder != checkedDesc2 || sortCol2Ctrl.get_defaultValue() != sortColSelectedValue2)) {
                change = true
            }
            Mscrm.Utilities.setReturnValue(new Array(change,
                checkedDesc,
                sortColSelectedValue,
                checkedDesc2,
                sortColSelectedValue2));
            closeWindow();
        }
            ...
            for (var i = 0, j = 0; i < iLen; i++) {
                ...
                if (isSortableField(getDialogArguments().oFieldsXml, sEntityName, sFieldName)) {
                    if (sFieldName != sortColCtrl.get_dataValue()) {
                        sortCol2Ctrl
                            .AddOption(GetFieldDisplayName(getDialogArguments()
                                    .oPropertiesXml,
                                    sEntityName,
                                    sFieldName),
                                sFieldName);
    ...
    <table cellpadding="0" cellspacing="5" width="100%" style="table-layout: fixed;">
        ...
        <tr height="25">
            <td style="overflow: hidden; text-overflow: ellipsis;">
                <nobr>
                    <loc:Text ResourceId="Web.Tools.ViewEditor.dialogs.SetSort.aspx_64" runat="server"/>
                </nobr>
            </td>
            <td id="sortColumn"></td>
        </tr>
        <tr>
            ...
            <td>
                <table width="100%" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                        <td>
                            <input type="radio" class="radio" name="rdDir" id="rdAscend">
                        </td>
                        <td>
                            <label for="rdAscend">
                                <loc:Text ResourceId="Web.Tools.ViewEditor.dialogs.SetSort.aspx_74" runat="server"/>
                            </label>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <input type="radio" class="radio" name="rdDir" id="rdDescend">
                        </td>
                        <td>
                            <label for="rdDescend">
                                <loc:Text ResourceId="Web.Tools.ViewEditor.dialogs.SetSort.aspx_78" runat="server"/>
                            </label>
                        </td>
                    </tr>
                </table>
        ...
        <tr height="25">
            <td style="overflow: hidden; text-overflow: ellipsis;">
                <nobr>
                    <loc:Text ResourceId="Web.Tools.ViewEditor.dialogs.SetSort.aspx_68" runat="server"/>
                </nobr>
            </td>
        ...
        <tr>
            ...
            <td>
                <table width="100%" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                        <td>
                            <input type="radio" class="radio" name="rdDir2" id="rdAscend2">
                        </td>
                        <td>
                            <label for="rdAscend2">
                                <loc:Text ResourceId="Web.Tools.ViewEditor.dialogs.SetSort.aspx_74" runat="server"/>
                    ...
                    <tr>
                        <td>
                            <input type="radio" class="radio" name="rdDir2" id="rdDescend2">
                        </td>
                        <td>
                            <label for="rdDescend2">
                                <loc:Text ResourceId="Web.Tools.ViewEditor.dialogs.SetSort.aspx_78" runat="server"/>
                            </label>
                        </td>
                    </tr>
