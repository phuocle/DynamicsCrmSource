...
<title>
    <loc:Text ResourceId="Web.Tools.OrganizationSqmSetting.Dialogs.CustFeedbackTab.DialogTitle" runat="server"/>
</title>
...
<script type="text/javascript">
    ...
    Sys.Application.add_load(function() {
        ...
        if (!IS_LIVE) {
            $get("privacy").style.display = "none";
        } else {
    ...
    function applychanges() {
        ...
        if ((!IsNull(_checkSqmAcceptControl) && _checkSqmAcceptControl.get_isDirty()) ||
            ...
            if (!IsNull(_checkSqmAcceptControl) && _checkSqmAcceptControl.get_isDirty()
            ) retval += "<sqmenabled>" + ((_checkSqmAcceptControl.get_dataValue()) ? "1" : "0") + "</sqmenabled>";
    ...
    <table width="100%" cellspacing="0" cellpadding="3">
        ...
        <tr height="19">
            <td colspan="2" class="ms-crm-Form-Section ms-crm-Form-SectionBar">
                <loc:Text ResourceId="Web.Tools.personalsettings.dialogs.personalsettings.CustFeedbackTab.SectionHeader" runat="server"/>
            </td>
        </tr>
        <tr height="5">
            <td colspan="2"></td>
        ...
        <tr >
            <td colspan="2">
                <loc:Text ResourceId="Web.Tools.personalsettings.dialogs.personalsettings.CustFeedbackTab.Invite" runat="server"/>
            </td>
        </tr>
        <tr >
            <td colspan="2">
                <loc:Text ResourceId="Web.Tools.personalsettings.dialogs.personalsettings.CustFeedbackTab.DataInfo1" runat="server"/>
            </td>
        </tr>
        <tr >
            <td colspan="2">
                <loc:Text ResourceId="Web.Tools.personalsettings.dialogs.personalsettings.CustFeedbackTab.DataInfo2" runat="server"/>
            </td>
        </tr>
        <tr >
            <td colspan="2" nowrap>
                <a id="learnmore" class="ms-crm-Link" HREF="http://go.microsoft.com/fwlink/p/?LinkID=627379">
                    <loc:Text ResourceId="Web.Tools.personalsettings.dialogs.personalsettings.CustFeedbackTab.LearnMoreText" runat="server"/>
                </a>
            </td>
        </tr>
        <tr>
            <td>
                <ui:CheckBox id="checkSqmAccept" runat="server"/>
            </td>
            <td nowrap class="sqmsettings_td_AcceptBox">
                <label for="checkSqmAccept">
                    <nobr>
                        <loc:Text ResourceId="Web.Tools.personalsettings.dialogs.personalsettings.CustFeedbackTab.AcceptCheckbox" runat="server"/>
                    </nobr>
                </label>
            </td>
        </tr>
    ...
    <table width="100%" cellspacing="0" cellpadding="3" style="table-layout: fixed">
        ...
        <tr height="19">
            <td colspan="4" class="ms-crm-Form-Section ms-crm-Form-SectionBar">
                <loc:Text ResourceId="Web.Tools.OrganizationSqmSetting.Dialogs.ErrorReportingTab.Heading" runat="server"/>
            </td>
        </tr>
        <tr height="5">
            <td colspan="4"></td>
        ...
        <tr>
            <td>&nbsp;</td>
            <td>
                <ui:CheckBox id="checkPrivacy" onclick="onPrivacyClick();" runat="server"/>
            </td>
            <td nowrap class="sqmsettings_td_AcceptBox" colspan="2">
                &nbsp;
                <label for="checkPrivacy">
                    <nobr>
                        <loc:Text ResourceId="Web.Tools.OrganizationSqmSetting.Dialogs.ErrorReportingTab.PrivacyCheckbox" runat="server"/>
                    </nobr>
                </label>
            </td>
        </tr>
        <tr>
            ...
            <td>&nbsp;</td>
            <td colspan="2">
                <loc:Text ResourceId="Web.Tools.OrganizationSqmSetting.Dialogs.ErrorReportingTab.Text1" runat="server"/>
            </td>
        </tr>
        <tr>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
            <td>
                <input type="radio" class="radio" id="Sel_privacyoption1" name="crmFormprivacyOption" onclick="onPrivacyOptionClick(this);" value="1">
            </td>
            <td>&nbsp;<label for="Sel_privacyoption1">
                    <loc:Text ResourceID="Organization_Script_Error_Reporting_Option_AskToReport" runat="server"/>
                </label>
            </td>
        </tr>
        <tr>
            ...
            <td>&nbsp;</td>
            <td>
                <input type="radio" class="radio" id="Sel_privacyoption2" name="crmFormprivacyOption" onclick="onPrivacyOptionClick(this);" value="2">
            </td>
            <td>&nbsp;<label for="Sel_privacyoption2">
                    <loc:Text ResourceID="Organization_Script_Error_Reporting_Option_AutoReport" runat="server"/>
                </label>
            </td>
        </tr>
        <tr>
            ...
            <td>&nbsp;</td>
            <td>
                <input type="radio" class="radio" id="Sel_privacyoption3" name="crmFormprivacyOption" onclick="onPrivacyOptionClick(this);" value="3">
            </td>
            <td>&nbsp;<label for="Sel_privacyoption3">
                    <loc:Text ResourceID="Organization_Script_Error_Reporting_Option_NeverReport" runat="server"/>
                </label>
            </td>
        </tr>
        <tr id="privacyStatementRow">
            <td colspan="4">
                <table width="100%" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                        <td colspan="3">
                            <loc:Text ResourceId="Web.Tools.OrganizationSqmSetting.Dialogs.PrivacyStatement.Description" runat="server"/><br/><br/>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="3">
                            <loc:Text ResourceId="Organization_Privacy_Statement_OptionsIntro" runat="server"/>
                        </td>
                    </tr>
                    <tr>
                        <td>&nbsp;</td>
                        <td width="10">
                            <input type="radio" class="radio" id="Sel_showprivacystatementlinkoption1" name="crmFormshowPrivacyStatementLinkOption" value="1" onclick="onShowPrivacyStatementOptionClick(this);">
                        </td>
                        <td>
                            <label for="Sel_showprivacystatementlinkoption1">
                                <loc:Text ResourceId="Organization_Privacy_Statement_NoLink" runat="server"/>
                            </label>
                        </td>
                    </tr>
                    <tr>
                        <td>&nbsp;</td>
                        <td width="10">
                            <input type="radio" class="radio" id="Sel_showprivacystatementlinkoption2" name="crmFormshowPrivacyStatementLinkOption" value="2" onclick="onShowPrivacyStatementOptionClick(this);">
                        </td>
                        <td>
                            <label for="Sel_showprivacystatementlinkoption2">
                                <loc:Text ResourceId="Organization_Privacy_Statement_ShowLink" runat="server"/>
                            </label>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td colspan="2">
                            <table width="100%" cellspacing="0" cellpadding="0">
                                <tr>
                                    <td width="23">&nbsp;</td>
                                    <td>
                                        <label for="txtPrivacyStatementUrl">
                                            <loc:Text ResourceId="Organization_Privacy_Statement_Url" runat="server"/>
                                        </label>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <table width="100%" cellspacing="0" cellpadding="0">
                                            <tr>
                                                ...
                                                <td width="20%">
                                                    &nbsp;<a id="viewprivacyStatement" class="ms-crm-Link" style="text-decoration: underline; cursor: hand; cursor: pointer">
                                                        <loc:Text ResourceId="Organization_Privacy_Statement_Url_Test" runat="server"/>
                                                    </a>
                                                </td>
                                            </tr>
                                        </table>
