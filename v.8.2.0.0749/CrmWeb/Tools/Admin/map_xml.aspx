...
<title>
    <loc:Text ResourceId="Web.Tools.map_xml.aspx_5" runat="server"/>
</title>
<showstagetitle>1</showstagetitle>
<subtitle>
    <loc:Text ResourceId="Web.Tools.map_xml.aspx_6" runat="server"/>
</subtitle>
...
%>
    <page id="01">
        <title>
            <loc:Text ResourceId="NamePlural_NewsArticle" runat="server"/>
        </title>
        <showstagetitle>1</showstagetitle>
        <icon>/_imgs/tools/ico_annoucement.gif</icon>
        <help>
            <loc:Text ResourceId="Web.Tools.map_xml.aspx_190" runat="server"/>
        </help>
...
%>
    ...
    <page id="02">
        <title>
            <loc:Text ResourceId="SystemCustomization.SettingsPage.AutoNumbering.Title" runat="server"/>
        </title>
        <subtitle>
            <loc:Text ResourceId="SystemCustomization.SettingsPage.AutoNumbering.Subtitle" runat="server"/>
        </subtitle>
        <icon>/_imgs/tools/ico_autoNumbering.gif</icon>
        <help>
            <loc:Text ResourceId="SystemCustomization.SettingsPage.AutoNumbering.Help" runat="server"/>
        </help>
...
%>
    <page id="05">
        <title>
            <loc:Text ResourceId="SystemCustomization.SettingsPage.SystemSettings.Title" runat="server"/>
        </title>
        <subtitle>
            <loc:Text ResourceId="SystemCustomization.SettingsPage.SystemSettings.Subtitle" runat="server"/>
        </subtitle>
        <icon>/_imgs/tools/ico_systemSettings.gif</icon>
        <help>
            <loc:Text ResourceId="SystemCustomization.SettingsPage.SystemSettings.Help" runat="server"/>
        </help>
...
%>
    <page id="08">
        <title>
            <loc:Text ResourceId="NamePlural_Language" runat="server"/>
        </title>
        ...
        <help>
            <loc:Text ResourceId="Web.Tools.admin.map_xml.aspx_1" runat="server"/>
        </help>
    </page>
<%
    }
...
%>
    <page id="09">
        <title>
            <loc:Text ResourceId="SystemCustomization.SettingsPage.OrganizationSqmSetting.Title" runat="server"/>
        </title>
        <icon>/_imgs/tools/ico_PrivacyPreferences.gif</icon>
        <link inline="0">var dialogOptions = new Xrm.DialogOptions();dialogOptions.height = <% = Microsoft.Crm.Application.Utility.Util.IsLive() ? 600 : 370 %>;dialogOptions.width = 700;Xrm.Internal.openDialog(Mscrm.CrmUri.create("/tools/OrganizationSqmSetting/dialogs/sqmsettings.aspx").toString(), dialogOptions, null, null, null);</link>
        <help>
            <loc:Text ResourceId="SystemCustomization.SettingsPage.OrganizationSqmSetting.Help" runat="server"/>
        </help>
    </page>
<%
    }
...
%>
    <page id="10">
        ...
        %>
            <title>
                <loc:Text ResourceId="Web.Tools.admin.map_xml.aspx_4" runat="server"/>
            </title>
            <link inline="0">openStdDlg(Mscrm.CrmUri.create('https://billing.microsoft.com'),null,800,600,true);</link>
            <help>
                <loc:Text ResourceId="Web.Tools.admin.map_xml.aspx_5" runat="server"/>
            </help>
        <%
            }
            else
        ...
        %>
            <title>
                <loc:Text ResourceId="System.AddOn.Title" runat="server"/>
            </title>
            ...
            <help>
                <loc:Text ResourceId="System.BillingOsdp.Help" runat="server"/>
            </help>
        <%
            }
        %>
...
%>
    <page id="11">
        <title>
            <loc:Text ResourceId="Web.Tools.admin.map_xml.aspx_6" runat="server"/>
        </title>
        ...
        <help>
            <loc:Text ResourceId="Web.Tools.admin.map_xml.aspx_7" runat="server"/>
        </help>
    </page>
<%
    }
...
%>
    <page id="13">
        ...
        %>
            ...
            <help>
                <loc:Text ResourceId="System.AddOn.Help" runat="server"/>
            </help>
        <%
            }
            else
        ...
        %>
            <title>
                <loc:Text ResourceId="System.ResourceUsage.Title" runat="server"/>
            </title>
            <showstagetitle>1</showstagetitle>
            <url>resourceusage.aspx</url>
            <help>
                <loc:Text ResourceId="System.ResourceUsage.Help" runat="server"/>
            </help>
        <%
            }
        %>
...
%>
    <page id="16">
        ...
        <help>
            <loc:Text ResourceId="Web.Tools.Yammer.Config.Title.Help" runat="server"/>
        </help>
    </page>
<%
    }
...
%>
    <page id="17">
        <title>
            <loc:Text ResourceId="Data.Performance.Dashboard.Title" runat="server"/>
        </title>
        <showstagetitle>1</showstagetitle>
        <icon>/_imgs/tools/DataPerformance_48.png</icon>
        <help>
            <loc:Text ResourceId="Data.Performance.Dashboard.Help" runat="server"/>
        </help>
        <link inline="1" entitytype="<%= Microsoft.Crm.Application.Utility.EntityNames.DataPerformance %>">/_static/loading.htm</link>
        <url>
            <app:FlatHomepageUrlControl EntityLogicalName="dataperformance" XmlEncode="true" runat="server"/>
        </url>
    </page>
<%
    }
...
%>
    <page id="22">
        ...
        <help>
            <loc:Text ResourceId="Web.Tools.NetBreeze.Config.Title.Help" runat="server"/>
        </help>
    </page>
<%
    }
...
<%
    if (FeatureEnabledHelper.IsNonOrgFeatureEnabled(FeatureControl.Current.Features.MocaOffline, UserInformation.Current))
    {
...
%> <page id="24">
    ...
    %>
    <help>
        <loc:Text ResourceId="Web.Tools.MobileOfflineProvisioning.Config.Title.Help" runat="server"/>
    </help>
</page>
    <%
        }
...
%>
    <page id="25">
        <title>
            <loc:Text ResourceId="Web.Tools.ProductRecommendationConnection.Config.Title" runat="server"/>
        </title>
        ...
        <help>
            <loc:Text ResourceId="Web.Tools.ProductRecommendationConnection.Config.Title.Help" runat="server"/>
        </help>
    </page>
<%
    }
...
<%
    if (ShouldAzureTextAnalyticsConnectionBeVisible())
    {
%>
    <page id="26">
        <title>
            <loc:Text ResourceId="Web.Tools.TextAnalyticsConnection.Config.Title" runat="server"/>
        </title>
        <icon>/_imgs/Tools/RecommendationTextConfig_48.png</icon>
        <url>../AzureMachineLearning/AzureMLUserConsentPage.aspx?connectionType=<%= (int) AzureServiceConnectionType.TextAnalytics %></url>
        <help>
            <loc:Text ResourceId="Web.Tools.TextAnalyticsConnection.Config.Title.Help" runat="server"/>
        </help>
    </page>
<%
    }
