...
<script type="text/javascript" language="javascript">
    ...
    function PageLoad() {
        ...
        if (rdBoth.checked == true) {
            _aOriginalRoles.push(scenario.Both);
        }
    ...
    function applychanges() {
        ...
        if ($get("rdBoth").checked && _aOriginalRoles.indexOf(scenario.Both) == -1) {
            _boAnySettingChanged = true;
            scenariosToAdd += "<scenario>" + scenario.Both + "</scenario>";
        }
    ...
    function PrepUI() {
        ...
        if (_renderFillBar) {
            ...
            var nVerticalPosition = ((nDialogHeight - (nHeaderHeight + nFooterHeight)) / 2) +
                nHeaderHeight -
                (nFillBarHeight / 2);
...
<style type="text/css">
    ...
    .ms-crm-RefreshDialog-Header { padding-top: 0px; }
    ...
    .ms-crm-Input-Container { overflow: hidden; }
    ...
    .radioLabelBoth { color: #000000; }

    #rdBoth { border: 1px solid black; }
    ...
    #SalesTile:hover { background-color: #000460; }
    ...
    #ServiceTile:hover { background-color: #063D81; }
    ...
    #FSTile:hover { background-color: #0F4E1D; }
    ...
    #PSTile:hover { background-color: #340C61; }
    ...
    #AllTile:hover { background-color: #FFDC70; }
