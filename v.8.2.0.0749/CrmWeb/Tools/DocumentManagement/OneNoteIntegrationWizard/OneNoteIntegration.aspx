...
<frm:WizardForm id="crmForm" runat="server">
    ...
    <table id="entityTable" width="100%" cellpadding=1 cellspacing=1>
        <tr>
            <td width="100%" id="oneNoteDescription" runat="server">
                <label>
                    <loc:Text ResourceId="Web.Tools.OneNoteSettings.SettingsPage.EntityTable.Description" runat="server"/>
                </label>
            </td>
        </tr>
        <tr>
    ...
    <table id="autoCreationTable" width="100%" cellpadding="1" cellspacing="1">
        <tr>
            <td width="100%" id="autoOneNoteDescription" runat="server">
                <label>
                    <loc:Text ResourceId="Web.Tools.OneNoteSettings.SettingsPage.AutoCreation.Description" runat="server"/>
                </label>
            </td>
        </tr>
        <tr>
