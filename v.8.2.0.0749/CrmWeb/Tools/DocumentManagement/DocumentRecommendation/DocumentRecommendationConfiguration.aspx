    ...
    <script language="javascript" type="text/javascript">
        ...
        function pageLoad() {
            ...
            if (ENTITY_COUNT == 0) {
                ...
                _pageNotificationLabel
                    .innerHTML = ('<%= EntitiesNotConfiguredForDocumentRecommendationsNotificationText %>');
                pageNotification.appendChild(_pageNotificationLabel);
                _pageNotificationDiv
                    .innerHTML = (
                        '<%= EntitiesNotConfiguredForDocumentRecommendationsNotificationTextWithoutAnchorTag %>')
            ...
            if (_isDocumentRecommendationsEnabled.toLowerCase() != "true") {
                ...
                var _pageNotificationDiv = document.getElementById("pageNotificationDiv");
                _pageNotificationLabel
                    .innerHTML = ('<%= PreRequisiteForDocumentRecommendationsNotMetNotificationText %>');
                pageNotification.appendChild(_pageNotificationLabel);
                _pageNotificationDiv
                    .innerHTML = ('<%= PreRequisiteForDocumentRecommendationsNotMetNotificationTextWithoutAnchorTag %>'
                    );
                document.getElementById("entitySelectionTableDiv").style.overflow = "hidden";
                disableSelectAllCheckBoxAndApplyButton();
            }

            document.getElementById("pageNotificationRow").style
                .display = ((_isDocumentRecommendationsEnabled.toLowerCase() == "true") &&
                    (_isEntitiesConfiguredForDocumentRecommendations == "true"))
                ? 'none'
                : 'block';
            ...
            if (Mscrm.DocumentRecommendationPageHelper.savePageProperties(ENTITY_COUNT)) {
                ...
                if (!isNullOrEmptyString(entitydocumentRecommendedXml)) {
                    ...
                    Mscrm.DocumentRecommendationPageHelper
                        .saveDocumentRecommendationSettings(SaveDocumentRecommendedSettingsCallBackFunction,
                            externalBaseUrl);
                } else {
                }
            }
            ...
            <tr>
                    ...
                    <table id="entityTable" class="mscrm-documentRecommendation-EntityTable" cellpadding="1" cellspacing="1">
                        ...
                        <tr id="pageNotificationRow" style="background-color: #fff19e; border: 1px solid #D7D889;">
                            <td class="mscrm-documentRecommendation-PageNotificationImageTd">
                                <img src="/_imgs\Tools\RecommendedDocuments_NotificationImage_16.gif" width="16" height="16" alt="Alert"/>
                            </td>
                        ...
                        <tr style="display: block; margin-top: 6px; border-top: thin solid; border-color: #BFBFBF;">
                            <td>
                                <img src="/_imgs/ico/16_info.gif" alt="" style="margin-top: 6px;" width="16" height="16"/>
                            </td>
                            <td>
                ...
                <td width="50%" style="vertical-align: top;">
                    <table id="externalSuggestions" class="mscrm-documentRecommendation-ExternalSuggestions" cellpadding="1" cellspacing="1">
                        ...
                        <tr style="display: block; margin-top: 6px; border-top: thin solid; border-color: #BFBFBF;">
                            <td>
                                <img src="/_imgs/ico/16_info.gif" alt="" width="16" height="16" style="margin-top: 6px;"/>
                            </td>
                            <td>
