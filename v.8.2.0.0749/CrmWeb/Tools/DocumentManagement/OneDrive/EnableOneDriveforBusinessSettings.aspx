...
<head>
    ...
    <script type="text/javascript">
        ...
        function windowOnLoad() {
            ...
            if (_chkEnableOneDriveValue.toLowerCase() == "false") {
                document.getElementById("chkEnableOneDrive")
                    .disabled = (_isFcbEnabledAndActiveSiteNotPresent.toLowerCase() != "false") ? true : false;
            }
            document.getElementById("lblOneDriveError").style
                .display = (_displayError.toLowerCase() != "false") ? 'block' : 'none';
    ...
    <style type="text/css">
        ...
        .ms-crm-RefreshDialog-Main { top: 70px; }
    </style>
</head>
<body>
