...
<head>
    ...
    <style type="text/css">
        td.sectionHeader { font-weight: <%= WebUtility.GetFontResourceForStyle("General.Bold.font_weight") %>; }

        td.sectionSubHeader { font-size: <%= WebUtility.GetFontResourceForStyle("General.8pt.font_size") %>; }
        ...
        <table cellpadding="0" cellspacing="0" width="100%" style="table-layout: fixed">
            ...
            <tr>
                ...
                <td colspan="2">
                    ...
                    <label for="absoluteUrl">
                        <loc:Text ResourceId="DocumentManagement.AddLocation.SharePointLocation.Label" runat="server"/>
                    </label>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td style="padding-left: 20">
                    <label for="locationLookup">
                        <loc:Text ResourceId="DocumentManagement.AddLocation.ParentURL.Label" runat="server"/>
                    </label>
                </td>
                <td>
