...
<head>
    ...
    <script type="text/javascript">
        ...
        function ConfigAlternateKeys() {
            ...
            window.dialogArguments["valuesXml"] = Mscrm.SelectAlternateKey
                .createKeysAvailableFieldsXml(XUI.Xml.LoadXml(ATTRIBUTES_XML), 1);
            window.dialogArguments["sSelectedValues"] = PAUSE_STATES;
            window.dialogArguments["keyAttributesXml"] = Mscrm.SelectAlternateKey
                .createKeysSelectedFieldsXml(XUI.Xml.LoadXml(KEYS_XML), 1);
        }
                                                                            ...
                                                                            <td valign="center" style="text-align: left; width: 30%; padding: 10px;">
                                                                                <table width="100%" cellspacing="0" cellpadding="0" dir="ltr">
                                                                                    <tr>
                                                                                        ...
                                                                                        <td width="100%">
                                                                                            <ui:textbox id="txtKeyName" runat="server"/>
                                                                                        </td>
                                                                                    </tr>
                                                                                </table>
                                                                            </td>
