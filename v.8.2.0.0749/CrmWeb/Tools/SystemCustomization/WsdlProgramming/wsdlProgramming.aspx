...
<table class="wsdlMargin devresourcepage-link-container">
    <tr>
        <td class="devresourcepage-link">
            <a href="<%= this.developerCenterLink.ToString() %>" class="wsdlLink" target="_blank" title="<%= this.developerCenterLinkTitle.ToString() %>">
                <loc:text resourceid="SystemCustomization.WsdlProgramming.DeveloperCenter" runat="server"/>
            </a>
        </td>
        <td class="devresourcepage-link">
            <a href="<%= this.developerForumsLink.ToString() %>" class="wsdlLink" target="_blank" title="<%= this.developerForumsLinkTitle.ToString() %>">
                <loc:text resourceid="SystemCustomization.WsdlProgramming.DeveloperForums" runat="server"/>
            </a>
        </td>
        <td class="devresourcepage-link">
            <a href="<%= this.sdkNugetPackagesLink.ToString() %>" class="wsdlLink" target="_blank" title="<%= this.sdkNugetPackagesLinkTitle.ToString() %>">
    ...
    <tr>
        <td class="devresourcepage-link">
            <a href="<%= this.sdkDownloadLink.ToString() %>" class="wsdlLink" target="_blank" title="<%= this.sdkDownloadLinkTitle.ToString() %>">
                <loc:text resourceid="SystemCustomization.WsdlProgramming.SDKDownload" runat="server"/>
            </a>
        </td>
        <td class="devresourcepage-link">
            <a href="<%= this.sampleCodeLink.ToString() %>" class="wsdlLink" target="_blank" title="<%= this.sampleCodeLinkTitle.ToString() %>">
                <loc:text resourceid="SystemCustomization.WsdlProgramming.SampleCode" runat="server"/>
            </a>
        </td>
        <td class="devresourcepage-link">
            <a href="<%= this.developerOverviewLink.ToString() %>" class="wsdlLink" target="_blank" title="<%= this.developerOverviewLinkTitle.ToString() %>">
...
<div class="wsdlMargin" cellspacing="0" cellpadding="0">
    ...
    <div>
        <div class="wsdlData">
            ...
            <a href="<%= this.oDataV4EndpointDescriptionSeeMoreLink.ToString() %>" class="wsdlLink" target="_blank" title="<%= this.oDataV4EndpointDescriptionSeeMoreLinkText.ToString() %>">
...
<div class="wsdlMargin" cellspacing="0" cellpadding="0">
    ...
    <div>
        <div class="wsdlData">
            ...
            <a href="<%= this.organizationServiceEndpointDescriptionSeeMoreLink.ToString() %>" class="wsdlLink" target="_blank" title="<%= this.organizationServiceEndpointDescriptionSeeMoreLinkText.ToString() %>">
...
<div class="wsdlMargin" cellspacing="0" cellpadding="0">
    ...
    <div>
        <div class="wsdlData">
            ...
            <a href="<%= this.instanceReferenceInformationSeeMoreLink.ToString() %>" class="wsdlLink" target="_blank" title="<%= this.instanceReferenceInformationSeeMoreLinkText.ToString() %>">
...
<div class="wsdlMargin" cellspacing="0" cellpadding="0">
    ...
    <div>
        <div class="wsdlData">
            ...
            <a href="<%= this.discoveryServiceWebAPISeeMoreLink.ToString() %>" class="wsdlLink" target="_blank" title="<%= this.discoveryServiceWebAPISeeMoreLinkText.ToString() %>">
...
<div class="wsdlMargin" cellspacing="0" cellpadding="0">
    ...
    <div>
        <div class="wsdlData">
            ...
            <a href="<%= this.discoveryServiceSeeMoreLink.ToString() %>" class="wsdlLink" target="_blank" title="<%= this.discoveryServiceSeeMoreLinkText.ToString() %>">
...
<div id="AppFabricIssuerSpan" style="clear: both">
    <table cellspacing="0" cellpadding="0" width="98%">
        <tr>
            <td class="wsdlTitle ms-crm-Form-SectionBar">
                <loc:text resourceid="SystemCustomization.WsdlProgramming.ServiceBusInformationHeader" runat="server"/>
            </td>
        </tr>
    </table>
    ...
    <div class="wsdlMargin" cellspacing="0" cellpadding="0">
        <div>
            <div class="wsdlSubTitle">
                <loc:text resourceid="SystemCustomization.WsdlProgramming.ServiceBusAuthentication" runat="server"/>
            </div>
        </div>
        <div>
            <div class="wsdlData">
                <loc:text resourceid="SystemCustomization.WsdlProgramming.ServiceBusAuthenticationDescription" runat="server"/>
                <a href="<%= this.serviceBusAuthSeeMoreLink.ToString() %>" class="wsdlLink" target="_blank" title="<%= this.serviceBusAuthSeeMoreLinkText.ToString() %>">
                    <loc:text resourceid="SystemCustomization.WsdlProgramming.ServiceBusAuthenticationDescriptionSeeMoreLinkText" runat="server" class="wsdlLink"/>
                </a>
            </div>
        </div>
        <div>
            <div class="mscrm-link-container">
                <span class="mscrm-link-title">
                    <loc:text resourceid="SystemCustomization.WsdlProgramming.CrmAppFabricIssuerName" runat="server"/>
                </span>
                <input class="wsdlLink" value="<%= appFabricIssuerName %>" title="<%= appFabricIssuerName %>" disabled="disabled"/>
            </div>
        </div>
        <%
            if (!Microsoft.Crm.Util.IsIosDevice(Page.Request))
                ...
                <div>
                    <a class="wsdlLink" id="linkAppFabricIssuer" runat="server">
                        <img class="wsdlIcon" src="/_imgs/DownloadDocument_16.png" align="absmiddle"><loc:text
                                                                                                         resourceid="SystemCustomization.WsdlProgramming.DownloadCertificate" runat="server"/>
                    </a>
                </div>
            </div>
        <%
