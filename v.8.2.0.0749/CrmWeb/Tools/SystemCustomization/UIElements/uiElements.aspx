...
<head>
    ...
    <script type="text/javascript" language="javascript">
        var _bCanUpdateForms =
            <% = Microsoft.Crm.Security.User.GetPrivilege(Privileges.WriteCustomization, Microsoft.Crm.Application.Security.UserInformation.Current) ? "true" : "false" %>;
