                        ...
                        <table width="100%" height="100%" cellspacing="3" cellpadding="0" style="table-layout: fixed;">
                            ...
                            <tr>
                                <td id="name_c" class="ms-crm-Field-Required">
                                    <label for="name">
                                        <loc:Text ResourceId="RelationshipRoleEditor_Name_Label" runat="server"/><img src="/_imgs/frm_required.gif" alt="<loc:Text Encoding='HtmlAttribute' ResourceId='Forms.Required.AltTag' runat='server'/>"/>
                                    </label>
                                </td>
                                <td colspan="3">
                            ...
                            <tr>
                                <td class="ms-crm-Form-Section ms-crm-Form-SectionBar" colspan="4">
                                    <loc:Text ResourceId="RelationshipRoleEditor_Section_Title" runat="server"/>
                                </td>
                            </tr>
                            <tr height="5px"></tr>
                            <tr>
                                        ...
                                        <tr>
                                            <td class="header" onclick="ToggleRow(this)">
                                                <loc:Text ResourceId="RelationshipRoleEditor_Row_Title_Mask" runat="server">
                                                    <loc:Argument runat="server"><%= Microsoft.Crm.CrmEncodeDecode.CrmHtmlEncode(Microsoft.Crm.Application.Utility.WebUtility.GetFmtObjName(Util.Account, NameFormatStyle.Singular)) %></loc:Argument>
                                                </loc:Text>
                                            </td>
