...
<head>
<title>
    <loc:Text ResourceId="ImportTranslations_DialogTitle" runat="server"/>
</title>
                ...
                if (!IsNull(oDataXml)) {
                    ...
                    if (!IsNull(oStatusNode)) {
                        ...
                        case "Succeeded":
                            ...
                            var dialogDescription = this.parent.document
                                .getElementById("ImportTranslationsDialogDescription");
                            dialogDescription.innerHTML = LOCID_IMPORT_SMRY_DLG_DSC;
        ...
        <tr valign="middle" style="height: 40px">
            <td valign="middle" style="width: 20%">
                <label for="fileUpload">
                    <loc:Text ResourceId="UploadTranslationsFile_Label" runat="server"/>
                </label>
            </td>
            <td valign="middle" style="width: 61%">
            ...
            <td class="ImportCustomizationsForm_td_BtnImportFile" valign="middle" align="left" style="width: 19%;">
                <button id="btnImportFile" onclick="uploadFile();" class="button" style="width: 90px">
                    <loc:Text ResourceId="ImportTranslationsButton_Label" runat="server"/>
                </button>
            </td>
        </tr>
    </form>
