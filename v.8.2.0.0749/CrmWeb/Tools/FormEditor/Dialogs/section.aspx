...
<script type="text/javascript" language="javascript">
    ...
    function OnLoad() {
        ...
        if (_oSection.LabelWidth != null) {
            $get('labelWidth').value = _oSection.LabelWidth;
        } else {
        ...
        if (FORM_TYPE == "mainInteractionCentric" && _oSection.IsReferencePanelSection) {
...
<div id="tab0" class="ms-crm-Tab ms-crm-TabContainer" style="display: inline;">
    <fieldset id="nameSection">
        ...
        <table cellpadding="0" cellspacing="5" width="100%" style="table-layout: fixed;">
            ...
            <tr id="sectionNameRow">
                ...
                <td>
                    <sdk:TextBoxControl id="txtName" runat="server"/>
                </td>
            </tr>
            <tr>
                <td class="ms-crm-Field-Required">
                    <label for="Description">
                        <loc:Text ResourceId="Formeditor_Dialogs_Tab_Label_Caption" runat="server"/><img src="/_imgs/frm_required.gif" alt="<loc:Text Encoding='HtmlAttribute' ResourceId='Forms.Required.AltTag' runat='server'/>"/>
                    </label>
                </td>
                <td>
                    <sdk:TextBoxControl id="Description" runat="server"/>
                </td>
            </tr>
        </table>
        ...
        <table cellpadding="0" cellspacing="5" width="100%" style="table-layout: fixed;">
            ...
            <tr>
                <td>
                    <ui:CheckBox id="ShowLabel" name="ShowLabel" class="checkbox" runat="server"/>
                </td>
                <td >
                    <label id="showLabelID" for="ShowLabel" runat="server"></label>
                </td>
            </tr>
            <tr id="showBarRow">
                <td>
                    <ui:CheckBox id="ShowBar" name="ShowBar" runat="server"/>
                </td>
                <td>
                    <label id="ShowBarLabel" for="ShowBar">
                        <loc:Text ResourceId="Web.Tools.FormEditor.Dialogs.section.aspx_show_divider" runat="server"/>
                    </label>
                </td>
            </tr>
        </table>
                ...
                <tr>
                    <td class="ms-crm-Field-Required">
                        <label for="labelWidth">
                            <loc:Text ResourceId="FormEditor.Dialogs.section.LabelWidth.Width" runat="server"/><img src="/_imgs/frm_required.gif" alt="<loc:Text Encoding='HtmlAttribute' ResourceId='Forms.Required.AltTag' runat='server'/>"/>
                        </label>
                    </td>
                    <td>
                        <ui:Number id="labelWidth" runat="server"/>
                    </td>
                </tr>
            </table>
        </fieldset>
    ...
    <div id="divVisibilitySection">
        ...
        <fieldset>
            ...
            <table cellpadding="0" cellspacing="5" width="100%" style="table-layout: fixed;">
                ...
                <tr>
                    <td colspan="2">
                        <loc:Text ResourceId="FormEditor_Dialogs_Section_Visible_Section_Heading" runat="server"/>
                    </td>
                </tr>
    ...
    <div id="divAvailabilitySection">
        ...
        <fieldset>
            ...
            <table cellpadding="0" cellspacing="5" width="100%" style="table-layout: fixed;">
                ...
                <tr>
                    <td colspan="2">
                        <loc:Text ResourceId="FormEditor_Dialogs_Section_Available_Section_Heading" runat="server"/>
                    </td>
                </tr>
    ...
    <table id="tblLockSectionMessage" style="display: none" cellpadding="0" width="100%" style="table-layout: fixed;">
        ...
        <tr>
            ...
            <td>
                <loc:Text ResourceId="Web.Tools.FormEditor.Dialogs.section.aspx_236" runat="server"/>
            </td>
        </tr>
    </table>
</div>
    ...
    <table cellpadding="0" cellspacing="5" width="100%" style="table-layout: fixed;">
        ...
        <tr>
            ...
            <td>
                <table cellpadding="0" cellspacing="4" width="75" class="example">
                    <tr>
                        <td class="example">&nbsp;</td><td class="example">&nbsp;</td>
                    </tr>
                    <tr>
                        <td class="example">&nbsp;</td><td class="example">&nbsp;</td>
                    </tr>
        ...
        <tr>
            ...
            <td>
                <label for="rdColumnSpan3">
                    <loc:Text ResourceId="Web.Tools.FormEditor.Dialogs.field-text.aspx_206" runat="server"/>
                </label>
            </td>

            <td>
                <table cellpadding="0" cellspacing="4" style="width: 75px" class="example">
                    <tr>
                        <td class="example">&nbsp;</td><td class="example">&nbsp;</td><td class="example">&nbsp;</td>
                    </tr>
                    <tr>
                        <td class="example">&nbsp;</td><td class="example">&nbsp;</td><td class="example">&nbsp;</td>
                    </tr>
        ...
        <tr>
            ...
            <td>
                <table cellpadding="0" cellspacing="4" style="width: 75px" class="example">
                    <tr>
                        <td class="example">&nbsp;</td><td class="example">&nbsp;</td><td class="example">&nbsp;</td><td class="example">&nbsp;</td>
                    </tr>
                    <tr>
                        <td class="example">&nbsp;</td><td class="example">&nbsp;</td><td class="example">&nbsp;</td><td class="example">&nbsp;</td>
                    </tr>
...
<fieldset id="fieldLabelAlignmentFieldSet">
    ...
    <table cellpadding="0" cellspacing="5" width="100%" style="table-layout: fixed;">
        ...
        <tr>
            <td>
                <input id="Radio_Just_Left" type="radio" name="LabJust" class="radio"/>
            </td>
            <td>
                <label for="Radio_Just_Left">
                    <loc:Text ResourceId="Tools.FormEditor.Dialogs.SecPropDialog.Left.Caption" runat="server"/>
                </label>
            </td>
            <td>
                <IMG alt="" src="/_imgs/tools/label_leftalign.gif"/>
            </td>
        </tr>
        <tr>
            <td colspan="3" style="height: 10px"></td>
        ...
        <tr>
            <td>
                <input id="Radio_Just_Right" type="radio" name="LabJust" class="radio"/>
            </td>
            <td>
                <label for="Radio_Just_Right">
                    <loc:Text ResourceId="Tools.FormEditor.Dialogs.SecPropDialog.Right.Caption" runat="server"/>
                </label>
            </td>
            <td>
                <IMG alt="" src="/_imgs/tools/label_rtalign.gif"/>
            </td>
        </tr>
        <tr>
            <td colspan="3" style="height: 10px"></td>
        ...
        <tr>
            <td>
                <input id="Radio_Just_Center" type="radio" name="LabJust" class="radio"/>
            </td>
            <td>
                <label for="Radio_Just_Center">
                    <loc:Text ResourceId="Tools.FormEditor.Dialogs.SecPropDialog.Center.Caption" runat="server"/>
                </label>
            </td>
            <td>
                <IMG alt="" src="/_imgs/tools/label_centeralign.gif"/>
            </td>
        </tr>
        <tr>
            <td colspan="3" style="height: 10px"></td>
...
<fieldset id="fieldLabelPositionFieldSet">
    ...
    <table cellpadding="0" cellspacing="5" width="100%" style="table-layout: fixed;">
        ...
        <tr>
            <td>
                <input id="Radio_Pos_Left" type="radio" name="LabPos" class="radio"/>
            </td>
            <td>
                <label for="Radio_Pos_Left">
                    <loc:Text ResourceId="Tools.FormEditor.Dialogs.SecPropDialog.Side.Caption" runat="server"/>
                </label>
            </td>
            <td>
                <IMG alt="" src="/_imgs/tools/field_positionleft.gif"/>
            </td>
        </tr>
        <tr>
            <td colspan="3" style="height: 10px"></td>
        ...
        <tr>
            <td>
                <input id="Radio_Pos_Top" type="radio" name="LabPos" class="radio"/>
            </td>
            <td>
                <label for="Radio_Pos_Top">
                    <loc:Text ResourceId="Tools.FormEditor.Dialogs.SecPropDialog.Top.Caption" runat="server"/>
                </label>
            </td>
            <td>
                <IMG alt="" src="/_imgs/tools/field_positiontop.gif"/>
            </td>
        </tr>
        <tr>
            <td colspan="3" style="height: 10px"></td>
...
<fieldset id="sectionHeightFieldSet">
    ...
    <table cellpadding="0" cellspacing="5" width="100%" style="table-layout: fixed;">
        ...
        <tr>
            <td colspan="3">
                <loc:Text ResourceId="Tools.FormEditor.Dialogs.SecPropDialog.RowHeightDesc" runat="server"/>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td>
                <ui:Number id="rowHeight" runat="server"/>
            </td>
        </tr>
