...
<script type="text/javascript" language="javascript">
    ...
    Sys.Application.add_load(function() {
        ...
        Mscrm.FormLibraryAndEventHandlerUtils.formXml = XUI.Xml
            .LoadXml(XUI.Xml.XMLSerializer.serializeToString(oIframe.FormXml));
...
<div id="tab0" class="ms-crm-Tab" style="display: block;">
    <fieldset>
        ...
        <table cellpadding="0" cellspacing="5" width="100%" style="table-layout: fixed;">
            ...
            <tr>
                <td colspan="2" class="ms-crm-Field-Required">
                    <label for="FieldName">
                ...
                %>
                    <td>
                        <input id="FieldName" name="FieldName" type="text" class="ms-crm-Text" maxlength="100"/>
                    </td>
                <%
                   }
                %>
            ...
            <tr>
                <td colspan="2" class="ms-crm-Field-Required">
                    <label for="Url">
                        <loc:Text ResourceId="Web.Tools.FormEditor.Dialogs.iframe.aspx_157" runat="server"/><img src="/_imgs/frm_required.gif" alt="<loc:Text Encoding='HtmlAttribute' ResourceId='Forms.Required.AltTag' runat='server'/>"/>
                    </label>
                </td>
                <td>
                    <sdk:UrlControl id="Url" name="Url" class="ms-crm-Text" maxlength="2048" runat="server"/>
                </td>
            </tr>
            <tr>
                <td>
                    <ui:CheckBox id="PassParams" name="PassParams" runat="server"/>
                </td>
                <td colspan="2">
    ...
    <fieldset>
        ...
        <table cellpadding="0" cellspacing="5" width="100%" style="table-layout: fixed;">
            <col width="15"><col width="60"><col>
            <tr>
                <td class="ms-crm-Field-Required" colspan="2">
                    <label for="Label">
    ...
    <fieldset>
        ...
        <table cellpadding="0" cellspacing="5" width="100%" style="table-layout: fixed;">
            ...
            <tr>
                <td vAlign="top">
                    <ui:CheckBox id="Restricted" name="Restricted" runat="server" style="margin-top: 0px"/>
                </td>
                <td colspan="2">
                    ...
                    <br/>
                    <a href="http://go.microsoft.com/fwlink/?LinkId=249177" class="ms-crm-FormEditor-Iframe-GlobalColor" target="_blank">
                        <loc:Text ResourceId="Web.Tools.FormEditor.Dialogs.iframe.aspx_176" runat="server"/>
                    </a>
                </td>
            </tr>
        </table>
    ...
    <div id="divVisibilitySection">
        ...
        <fieldset>
            ...
            <table cellpadding="0" cellspacing="5" width="100%" style="table-layout: fixed;">
                ...
                <tr>
                    <td>
                        <ui:CheckBox id="ShowOnMobileClient" name="ShowOnMobileClient" runat="server"/>
                    </td>
                    <td>
                        <label id="chkShowOnMobileClientLabel" for="ShowOnMobileClient">
