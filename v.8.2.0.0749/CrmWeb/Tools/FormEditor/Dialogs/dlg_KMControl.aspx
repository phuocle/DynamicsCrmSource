...
<script type="text/javascript" language="javascript">
    ...
    function populateActionList() {
        ...
        var retVal = '<select id="ActionListSelector" name="ActionListSelector" class="ms-crm-SelectBox&#32;">' +
            ...
            (LOCID_ACTIONS_ASSOCIATE) +
            '">' +
            CrmEncodeDecode.CrmHtmlEncode(LOCID_ACTIONS_ASSOCIATE) +
            '</option>' +
            '<option value="1" title="' +
            (LOCID_ACTIONS_DISASSOCIATE) +
            '">' +
            CrmEncodeDecode.CrmHtmlEncode(LOCID_ACTIONS_DISASSOCIATE) +
            '</option>' +
            '<option value="2" title="' +
            (LOCID_ACTIONS_COPY) +
            '">' +
            CrmEncodeDecode.CrmHtmlEncode(LOCID_ACTIONS_COPY) +
            '</option>' +
            '<option value="3" title="' +
            (LOCID_ACTIONS_EMAIL) +
            '">' +
            CrmEncodeDecode.CrmHtmlEncode(LOCID_ACTIONS_EMAIL) +
            '</option>' +
            '<option value="5" title="' +
            (LOCID_ACTIONS_EMAILCONTENT) +
            '">' +
            CrmEncodeDecode.CrmHtmlEncode(LOCID_ACTIONS_EMAILCONTENT) +
            '</option>' +
            '<option value="4" title="' +
            (LOCID_ACTIONS_POPOUT) +
            '">' +
            CrmEncodeDecode.CrmHtmlEncode(LOCID_ACTIONS_POPOUT) +
            '</option>' +
            '</select>';
...
<fieldset>
    ...
    <table cellpadding="0" cellspacing="5" width="100%" style="table-layout: fixed;">
        ...
        <tr>
            ...
            <td title="<loc:Text Encoding='HtmlAttribute' ResourceId='Forms.Name.TooltipTag' runat='server'/>">
                <ui:TextBox id="txtControlName" MaxLength="100" runat="server"/>
            </td>
        </tr>
        <tr>
            ...
            <td>
                <input type="text" id="txtControlLabel" onkeypress="_labelDirty = true;" title="<loc:Text Encoding='HtmlAttribute' ResourceId='Forms.Label.TooltipTag' runat='server'/>" maxlength="100" class="ms-crm-Text"/>
            </td>
        </tr>
    </table>
    <table cellpadding="0" cellspacing="5" width="100%" style="table-layout: fixed;">
        ...
        <tr>
            <td>
                <ui:CheckBox id="chkDisplayLabel" runat="server"/>
            </td>
            <td >
                <label for="chkDisplayLabel" id="displayLabel" runat="server"></label>
            </td>
        </tr>
    </table>
</fieldset>
