...
<div id="tab0" class="ms-crm-Tab" style="display: block;">
    <fieldset>
        ...
        <table cellpadding="0" cellspacing="5" width="100%" style="table-layout: fixed;">
            ...
            <tr>
                ...
                <td >
                    <input id="Label" name="Label" type="text" class="ms-crm-Text" maxlength="100"/>
                </td>
            </tr>
            <tr>
                <td>
    ...
    <fieldset>
        ...
        <table cellpadding="0" cellspacing="5" width="100%" style="table-layout: fixed;">
            ...
            <tr>
                <td>
                    <label for="addressFieldSelector">
                        <loc:Text ResourceId="Web.Tools.FormEditor.Dialogs.BingMap.AddressFieldSection.AddressSelectorLabel" runat="server"/>
                    </label>
                </td>
                <td>
                    <ui:Select id="addressFieldSelector" runat="server"/>
                </td>
            </tr>
        </table>
    </fieldset>
