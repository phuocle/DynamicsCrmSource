...
<script type="text/javascript" language="javascript">
    ...
    function applychanges() {
        ...
        if ($get("queueEntity").selectedIndex >= 0 &&
            typeof $get("queueEntity")[$get("queueEntity").selectedIndex].title !== undefined) {
        ...
        if ($get("queueName").value == PUBLIC_QUEUES ||
            $get("queueName").value == PRIVATE_QUEUES ||
            $get("queueName").value == ALL_QUEUES)
            ret = new QueueObj("Component" + Mscrm.Utilities.createGuid(),
                $get("queueName").value,
                $get("queueItemView").value,
                $get("entityPicker").value,
                $get("viewPicker").value,
                $get("queueViewRadio").checked,
                $get("entityViewRadio").checked,
                false,
                false,
                "true",
                queueName,
        ...
        <div style="vertical-align: top">
            <div id="tab2" class="ms-crm-Tab" style="display: block; width: auto; position: fixed; top: 80px; bottom: 0px;">
                <table width="100%" style="table-layout: fixed;">
                    <tr>
                        <td title="<loc:Text ResourceId='SystemCustomization.InteractionCentricDashboardPage.Dialogs.AddQueueDialog.Labels.DisplayEntityViewLabel.Tooltip' runat='server'/>">
                            <input name="rdColumnSpan" id="entityViewRadio" type="radio" class="radio" onclick="showEntityViewTable()">
                        ...
                        <td title="<loc:Text ResourceId='SystemCustomization.InteractionCentricDashboardPage.Dialogs.AddQueueDialog.Labels.DisplayQueueLabel.Tooltip' runat='server'/>">
                            <input name="rdColumnSpan" id="queueViewRadio" type="radio" class="radio" onclick="showQueueViewTable()">
            ...
            <div id="tab0" class="ms-crm-Tab" style="display: block; width: auto; position: fixed; top: 135px; bottom: 0px;">
                <table width="100%" style="table-layout: fixed;" cellspacing="10">
                    <tr title="<loc:Text ResourceId='SystemCustomization.InteractionCentricDashboardPage.Dialogs.AddQueueDialog.Labels.QueueNameLabel.Tooltip' runat='server'/>">
                        ...
                        <td>
                            <ui:select id="queueName" runat="server"/>
                        </td>
                    </tr>
                    <tr title="<loc:Text ResourceId='SystemCustomization.InteractionCentricDashboardPage.Dialogs.AddQueueDialog.Labels.QueueItemViewLabel.Tooltip' runat='server'/>">
                        ...
                        <td>
                            <ui:select id="queueItemView" runat="server"/>
                        </td>
                    </tr>
                    <tr title="<loc:Text ResourceId='SystemCustomization.InteractionCentricDashboardPage.Dialogs.AddQueueDialog.Labels.QueueEntityLabel.Tooltip' runat='server'/>">
                        ...
                        <td>
                            <ui:select id="queueEntity" runat="server"/>
                        </td>
                    </tr>
                </table>
                <br/>
            ...
            <div id="tab1" class="ms-crm-Tab" style="display: block; width: auto; position: fixed; top: 135px; bottom: 0px;">
                <table width="100%" style="table-layout: fixed;" cellspacing="10">
                    <tr title="<loc:Text ResourceId='SystemCustomization.InteractionCentricDashboardPage.Dialogs.AddQueueDialog.Labels.EntityLabel.Tooltip' runat='server'/>">
                        ...
                        <td>
                            <ui:select id="entityPicker" onchange="populateViewsForSelectedEntity()" runat="server"/>
                        </td>
                    </tr>
                    <tr title="<loc:Text ResourceId='SystemCustomization.InteractionCentricDashboardPage.Dialogs.AddQueueDialog.Labels.ViewNameLabel.Tooltip' runat='server'/>">
                        ...
                        <td>
                            <ui:select id="viewPicker" runat="server"/>
                        </td>
                    </tr>
                </table>
                <br/>
