<%@ Page language="c#" Inherits="Microsoft.Crm.Application.Pages.Tools.FormEditor.Dialogs.SocialInsight" %>
...
<script type="text/javascript" language="javascript">
    ...
    Sys.Application.add_load(function() {
        ...
        var controlIdLength = oIframe.Id.length;
        if (_mode == "add" && oIframe.Id.substr(0, 7) == 'IFRAME_') {
            oIframe.Id = oIframe.Id.substr(7, controlIdLength - 7);
        }
    ...
    function applychanges() {
            ...
            if (Mscrm.FormControlInputBehavior.GetElementBehavior(_fieldName).get_isDirty()) {
                {
                    ...
                    var oNodes = XUI.Xml.SelectNodes(_oFormXml,
                        ...
                        _ControlClassIds.socialInsight +
                        "']",
                        null);
        ...
        Mscrm.Utilities.setReturnValue(new SocialInsightObj(
            _fieldName.value,
            null,
            _PassParams.checked,
    ...
    <fieldset>
        ...
        <table cellpadding="0" cellspacing="5" width="100%" style="table-layout: fixed;">
            ...
            <tr>
                ...
                <td >
                    <input id="Label" name="Label" type="text" value="<%= Microsoft.Crm.CrmEncodeDecode.CrmHtmlEncode(defaultLabel) %>" class="ms-crm-Text" maxlength="100"/>
                </td>
            </tr>
            <tr>
                <td>
