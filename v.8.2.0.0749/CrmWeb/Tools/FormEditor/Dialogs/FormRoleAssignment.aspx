...
<script type="text/javascript" language="javascript">
    ...
    function applychanges() {
        if ($get('fallBackCheckBox').checked == false &&
            Mscrm.FormRoleAssignment.totalFallbackForms == 1 &&
    ...
    <div style="height: 50px; top: 0px; position: absolute; width: 100%;">
        <table cellpadding="0" cellspacing="0" height="100%" width="100%" style="table-layout: fixed;">
            ...
            <tr style="height: 25px">
                <td>
                    <input name="visibleToEveryone" id="visibleToEveryone" type="radio" onclick="Mscrm.FormRoleAssignment.onClickVisibleToEveryone();" class="radio">
                </td>
                <td colspan="2">
                    <label for="visibleToEveryone">
                        <loc:Text ResourceId="Dlg_Form_Role_Assignment_DisplayToEveryOne" runat="server"/>
                    </label>
                </td>
            </tr>
            <tr style="height: 25px">
                <td>
                    <input name="visibleToSelectedRoles" id="visibleToSelectedRoles" type="radio" onclick="Mscrm.FormRoleAssignment.onClickVisibleToSelectedRoles();" class="radio">
                </td>
                <td>
                    <label for="visibleToSelectedRoles">
                        <loc:Text ResourceId="Dlg_Form_Role_Assignment_DisplayToSelectedRoles" runat="server"/>
                    </label>
                </td>
                <td>
                ...
                <td>
                    <fieldset>
                        ...
                        <table cellpadding="0" cellspacing="3" width="100%" style="table-layout: fixed;">
                            ...
                            <tr>
                                <td>
                                    <ui:CheckBox id="fallBackCheckBox" onclick="Mscrm.FormRoleAssignment.onClickFallbackCheckBox();" runat="server"/>
                                </td>
                                <td>
                                    <label for="fallBackCheckBox">
                                        <loc:Text ResourceId="Dlg_Form_Role_Assignment_EnabledForFallBack" runat="server"/>
                                    </label>
                                </td>
                            </tr>
                            <tr id="fallBackFormInfoRow">
                                ...
                                <td>
                                    <loc:Text ResourceId="Dlg_Form_Role_Assignment_FallBackFormDescription" runat="server"/>
                                </td>
                            </tr>
                        </table>
                    </fieldset>
