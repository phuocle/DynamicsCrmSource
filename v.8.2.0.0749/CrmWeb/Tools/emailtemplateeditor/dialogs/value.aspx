...
<head>
    ...
    <script language="javascript" type="text/javascript">
        ...
        function applychanges() {
            Mscrm.Utilities.setReturnValue(new ValueObj(_sEntLogName,
                _sEntDispName,
                _sAttrLogName,
                _sAttrDispName,
                _sDataType));
        ...
        function BuildEntity() {
            ...
            _sEntDispName = XUI.Xml.SelectSingleNode(_oXml, "/entities/entity[@name = '" + _sEntLogName + "']", null)
                .getAttribute("desc");
        }
        ...
        function BuildAttribute(s) {
            ...
            Attribute.innerHTML = XUI.Xml.XMLSerializer
                .serializeToString(XUI.Xml
                    .SelectSingleNode(_oXml, "/entities/entity[@name = '" + s + "']/select", null));
...
<form name="crmDialog" style="height: 100%; width: 100%">
    <frm:DialogForm id="crmForm" runat="server">
        <table cellpadding="0" cellspacing="5">
            ...
            <tr>
                <td nowrap>
                    <loc:Text ResourceId="Web.Tools.emailtemplateeditor.dialogs.value.aspx_173" runat="server"/>
                </td>
                <td id="Entity"></td>
            </tr>
            <tr>
                <td nowrap>
                    <loc:Text ResourceId="Web.Tools.emailtemplateeditor.dialogs.value.aspx_177" runat="server"/>
                </td>
                <td id="Attribute"></td>
            </tr>
        </table>
