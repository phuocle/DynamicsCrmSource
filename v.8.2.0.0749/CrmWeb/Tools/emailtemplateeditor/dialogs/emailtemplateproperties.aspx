...
<head>
    <title>
        <loc:Text ResourceId="Web.Tools.emailtemplateeditor.dialogs.emailtemplateproperties.aspx_4" runat="server"/>
    </title>
    <cnt:AppHeader runat="server" id="crmHeader"/>
    <script language="javascript">
        function applychanges() {
            var oUrl = Mscrm.CrmUri.create("/Tools/EmailTemplateEditor/emailtemplateeditor.aspx?templateTypeCode=" +
                CrmEncodeDecode.CrmUrlEncode($get('templateType').value) +
                "&isPersonal=<%= Util.GetInt(Request.QueryString["isPersonal"]) %>");
        ...
        <tr>
            <td>
                <label for="templateType">
                    <loc:Text ResourceId="Web.Tools.emailtemplateeditor.dialogs.emailtemplateproperties.aspx_37" runat="server"/>
                </label>
            </td>
            <td>
