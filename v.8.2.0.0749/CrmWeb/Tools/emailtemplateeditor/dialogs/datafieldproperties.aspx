...
<head>
    ...
    <title>
        <loc:Text ResourceId="Web.Tools.emailtemplateeditor.dialogs.datafieldproperties.aspx_22" runat="server"/>
    </title>
    ...
    <script language="javascript">
        ...
        function document_onkeydown(eventObj) {
            if (eventObj.target.tagName != "BUTTON" &&
                eventObj.keyCode == KEY_ENTER &&
                eventObj.target.tagName == "INPUT") {
            ...
            <div id="tab0" class="ms-crm-Tab">
                <fieldset>
                    ...
                    <table cellpadding="0" cellspacing="5" width="100%" style="table-layout: fixed;">
                        ...
                        <tr>
                            <td>
                                <label for="DefaultTextId">
                                    <loc:Text ResourceId="Web.Tools.emailtemplateeditor.dialogs.datafieldproperties.aspx_130" runat="server"/>
                                </label>
                            </td>
                            <td>
