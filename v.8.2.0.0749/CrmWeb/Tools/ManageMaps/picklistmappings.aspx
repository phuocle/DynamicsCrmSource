...
<script language=javascript>
    ...
    var emptyLabel =
        <%= Microsoft.Crm.CrmEncodeDecode.CrmJavaScriptEncode(CurrentResourceManager.GetString("DataManagement.ImportMap.PicklistMap.EmptySourceValue.Label")) %>;
    var unmappedLabel =
        <%= Microsoft.Crm.CrmEncodeDecode.CrmJavaScriptEncode(CurrentResourceManager.GetString("DataManagement.ImportMap.PicklistMap.UnmappedSourceValue.Label")) %>;
    ...
    function PopulateAttributeMappings() {
        ...
        if (!IsNull(nodeList)) {
            for (var i = 0; i < nodeList.length; i++) {
                sourceAttributelist[i] = XUI.Xml.GetText(XUI.Xml
                    .SelectSingleNode(nodeList[i], "SourceAttributeName", null));
            }
        }
        ...
        for (var i = 0; i < sourceAttributelist.length; i++) {
            ...
            if (!IsNull(pickListNode)) {
                ...
                if (!IsNull(XUI.Xml.SelectSingleNode(attributeNode,
                    "PicklistMaps/PicklistMap[(SourceValue = \"\" and ProcessCode=\"Process\")]",
                    null))) {
                    emptyAndUnmappedMappingPresent = true;
                }

                if (emptyAndUnmappedMappingPresent &&
                    IsNull(XUI.Xml.SelectSingleNode(attributeNode,
                        "PicklistMaps/PicklistMap[ProcessCode = \"Unmapped\"]",
                        null))) {
                ...
                if (emptyAndUnmappedMappingPresent) {
                    ...
                    if (nodes.length == 0) {
                        imgHtml =
                            "<img alt='' align='absmiddle' CLASS='dlg_create_RenderListItem_img' src='/_imgs/allpicklistvaluesmapped.gif'>";
                    }
                }
            }

            sourceAttributelistItemsHtml[i] =
                "<li class='ms-crm-Dialog-ListItem-ImportMap' style='width:190' onmouseover='OnSourceItem(this)' onmouseout='OffSourceItem(this)' onclick='SelectSourceItem(this)' id='sourceattributeitem" + i + "'>" + imgHtml + CrmEncodeDecode.CrmHtmlEncode(XUI.Xml.GetText(sourceAttributeNode)) + "</li>";
            targetAttributelistItemsHtml[i] =
                "<li class='ms-crm-Dialog-ListItem-ImportMap' style='max-height:20px;width:190' onmouseover='OnTargetItem(this)' onmouseout='OffTargetItem(this)' onclick='SelectTargetItem(this)' id='targetattributeitem" + i + "'>" + CrmEncodeDecode.CrmHtmlEncode(displayName) + "<input type='hidden'  style='max-height:20px' id='targetattributehiddenitem" + i + "' value='" + CrmEncodeDecode.CrmHtmlAttributeEncode(logicalName) + "' /></li>";
    ...
    function PopulatePickListOptionsListItems() {
        ...
        if (result.Success == true) {
            ...
            if (optionNodeList != null) {
                ...
                sourceValuelistItemsHtml[0] =
                    "<li class='ms-crm-Dialog-ListItem-ImportMap' style='width:165;max-height:20px' onmouseover='OnSourceValueItem(this)' onmouseout='OffSourceValueItem(this)' onclick='SelectSourceValueItem(this)' title='" + CrmEncodeDecode.CrmHtmlAttributeEncode(emptyLabel) + "' id='sourcevalueitem0'>" + CrmEncodeDecode.CrmHtmlEncode(emptyLabel) + "</li>";
                targetValuelistItemsHtml[0] =
                    "<li class='ms-crm-Dialog-ListItem-ImportMap' style='width:165;max-height:20px' onmouseover='OnTargetValueItem(this)' onmouseout='OffTargetValueItem(this)' onclick='SelectTargetValueItem(this)' id='targetvalueitem0'></li>";


                sourceValuelistItemsHtml[1] =
                    "<li class='ms-crm-Dialog-ListItem-ImportMap' style='max-height:20px' onmouseover='OnSourceValueItem(this)' onmouseout='OffSourceValueItem(this)' onclick='SelectSourceValueItem(this)' title='" + CrmEncodeDecode.CrmHtmlAttributeEncode(unmappedLabel) + "' id='sourcevalueitem1'>" + CrmEncodeDecode.CrmHtmlEncode(unmappedLabel) + "</li>";
                targetValuelistItemsHtml[1] =
                    "<li class='ms-crm-Dialog-ListItem-ImportMap' style='width:165;max-height:20px' onmouseover='OnTargetValueItem(this)' onmouseout='OffTargetValueItem(this)' onclick='SelectTargetValueItem(this)' id='targetvalueitem1'></li>";
                ...
                for (var i = 0; i < pickListMapNodes.length; i++) {
                    ...
                    if (sourceValueText == "" && processCodeText == "Process") {
                        targetValuelistItemsHtml[0] =
                            "<li class='ms-crm-Dialog-ListItem-ImportMap' style='width:165;max-height:20px' onmouseover='OnTargetValueItem(this)' onmouseout='OffTargetValueItem(this)' onclick='SelectTargetValueItem(this)' title='" + CrmEncodeDecode.CrmHtmlAttributeEncode(displayName) + "' id='targetvalueitem0'>" + targetDisplayName + "</li>";
                    ...
                    if (processCodeText == "Unmapped") {
                        targetValuelistItemsHtml[1] =
                            "<li class='ms-crm-Dialog-ListItem-ImportMap' style='width:165;max-height:20px' onmouseover='OnTargetValueItem(this)' onmouseout='OffTargetValueItem(this)' onclick='SelectTargetValueItem(this)' title='" + CrmEncodeDecode.CrmHtmlAttributeEncode(displayName) + "' id='targetvalueitem1'>" + targetDisplayName + "</li>";

                        continue;
                    }

                    sourceValuelistItemsHtml[sourceValuelistItemsHtml
                            .length] =
                        "<li class='ms-crm-Dialog-ListItem-ImportMap' style='width:165;max-height:20px' onmouseover='OnSourceValueItem(this)' onmouseout='OffSourceValueItem(this)' onclick='SelectSourceValueItem(this)' title='" + CrmEncodeDecode.CrmHtmlAttributeEncode(sourceValueText) + "' id='sourcevalueitem" + sourceValuelistItemsHtml.length + "'>" + CrmEncodeDecode.CrmHtmlEncode(sourceValueText) + "</li>";
                    targetValuelistItemsHtml[targetValuelistItemsHtml
                            .length] =
                        "<li class='ms-crm-Dialog-ListItem-ImportMap' style='width:165;max-height:20px' onmouseover='OnTargetValueItem(this)' title='" + CrmEncodeDecode.CrmHtmlAttributeEncode(displayName) + "' onmouseout='OffTargetValueItem(this)' onclick='SelectTargetValueItem(this)' id='targetvalueitem" + targetValuelistItemsHtml.length + "'>" + targetDisplayName + "</li>";
                }
    ...
    function btnMap() {
        ...
        if (XUI.Html.GetText(_selectedSourceValueItem) == emptyLabel) {
            ...
            xpath = "PicklistMaps/PicklistMap[SourceValue=\"" +
                escapeSingleQuotesAndBackSlashes(XUI.Html.GetText(_selectedSourceValueItem)) +
                "\"]";
        }
    ...
    function UpdateMappingInAttributeMappings(node) {
        var xpath = "//AttributeMap[TargetAttributeName=\"" +
            XUI.Xml.GetText(XUI.Xml.SelectSingleNode(node, "TargetAttributeName", null)) +
            "\" and SourceAttributeName=\"" +
            escapeSingleQuotesAndBackSlashes(XUI.Xml
                .GetText(XUI.Xml.SelectSingleNode(node, "SourceAttributeName", null))) +
            "\"]";
        var attributeMapNode = XUI.Xml.SelectSingleNode(parent.document.frames["areaAttributesFrame"].mapXmlDoc,
            xpath,
            null);
    ...
    function IsAttributeMapped(pickListNodeParent) {
        ...
        if ((!IsNull(XUI.Xml.SelectSingleNode(pickListNodeParent,
                "PicklistMaps/PicklistMap[(SourceValue = \"\" and ProcessCode=\"Process\")]",
                null))) &&
            (!IsNull(XUI.Xml.SelectSingleNode(pickListNodeParent,
                "PicklistMaps/PicklistMap[ProcessCode = \"Unmapped\"]",
                null)))) {
            var pickListXpath = "PicklistMaps/PicklistMap[TargetValue=\"\"]";
    ...
    function ShowCheckMark() {
        ...
        if (allPicklistMapped) {
            _selectedSourceItem
                .innerHTML =
                "<img alt='' align='absmiddle' CLASS='dlg_create_RenderListItem_img' src='/_imgs/allpicklistvaluesmapped.gif'>" + XUI.Html.GetText(_selectedSourceItem);
        } else {
            ...
            <table style="margin-left: 5px">
                <tr style="padding-top: 20px">
                    <td style="padding-left: 10px">
                        <b>
                            <loc:Text ResourceId="DataManagement.ImportMap.PicklistMap.SourceHeader.Label" runat="server"/>
                        </b>
                    </td>
                    <td style="padding-left: 10px">
                        <b>
                            <loc:Text ResourceId="DataManagement.ImportMap.PicklistMap.TargetHeader.Label" runat="server"/>
                        </b>
                    </td>
                </tr>
                <tr>
                                                ...
                                                <tr>
                                                    <td class="ms-crm-List-Header" field="cn">
                                                        <label style="width: 184; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;" title="<%= Microsoft.Crm.CrmEncodeDecode.CrmHtmlAttributeEncode(AppResourceManager.Default.GetString("DataManagement.ImportMap.PicklistMap.SourceHeaderList.Label")) %>">
                                                            <nobr>
                                                                <b>
                                                                    <loc:Text ResourceId="DataManagement.ImportMap.PicklistMap.SourceHeaderList.Label" runat="server"/>
                                                                </b><img alt="" src="/_imgs/grid/bar_up.gif" class="addFields_img_barUp">
                                                            </nobr>
                                                        </label>
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td class="ms-crm-List-Header" field="cn">
                                                        <label style="width: 184; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;" title="<%= Microsoft.Crm.CrmEncodeDecode.CrmHtmlAttributeEncode(AppResourceManager.Default.GetString("DataManagement.ImportMap.PicklistMap.TargetHeaderList.Label")) %>">
                                                            <nobr>
                                                                <b>
                                                                    <loc:Text ResourceId="DataManagement.ImportMap.PicklistMap.TargetHeaderList.Label" runat="server"/>
                                                                </b>
                                                            </nobr>
                                                        </label>
                                                    </td>
                        ...
                        <div style="padding: 5px; background-color: #C4DDFF; width: 340px; height: 450px; margin-left: 10px; margin-right: 10px; border: 1px solid #8C8E94;">
                            ...
                            <table width="345" id="pickListOptions" style="margin-top: 10px">
                                <tr>
                                    <td>
                                        <b>
                                            <loc:Text ResourceId="DataManagement.ImportMap.AttributeMap.PickValue.Label" runat="server"/>
                                        </b>
                                    </td>
                                </tr>
                                <tr height="135">
