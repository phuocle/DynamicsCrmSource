...
<page id="0">
    <title>
        <loc:Text ResourceId="Web.Tools.map_xml.aspx_139" runat="server"/>
    </title>
    <showstagetitle>1</showstagetitle>
    <subtitle>
        <loc:Text ResourceId="Web.Tools.map_xml.aspx_140" runat="server"/>
    </subtitle>
    ...
    %>
        <page id="04">
            ...
            <help>
                <loc:Text ResourceId="Web.Tools.map_xml.aspx_175" runat="server"/>
            </help>
        </page>
    <%
        }
    ...
    %>
        <page id="05">
            <title>
                <loc:Text ResourceId="Web.Tools.DocumentTemplateTitle" runat="server"/>
            </title>
            ...
            <url>
                <app:FlatHomepageUrlControl EntityLogicalName="documenttemplate" XmlEncode="true" runat="server"/>
            </url>
            <help>
                <loc:Text ResourceId="Web.Tools.DocumentTemplateHelp" runat="server"/>
            </help>
        </page>
    <%
        }
    ...
    %>
        <page id="06">
            <title>
                <loc:Text ResourceId="Web.Tools.EmailSignaturesTitle" runat="server"/>
            </title>
            ...
            <help>
                <loc:Text ResourceId="Web.Tools.EmailSignaturesHelp" runat="server"/>
            </help>
        </page>
    <%
        }
