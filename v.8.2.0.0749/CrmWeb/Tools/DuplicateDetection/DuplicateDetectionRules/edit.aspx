...
<head>
    ...
    <script type="text/javascript" language="javascript">
        ...
        var aspxVars_MaximumMatchcodeLength =
        ...
        var aspxVars_IsDuplicateRulePublished =
            <%= (((int) this.CurrentEntity["statuscode"] == (int) DuplicateRuleStatus.Published) ? "'true'" : "'false'") %>;
        var aspxVars_isNewform = <%= ((CurrentForm.State == FormState.New) ? "'true'" : "'false'") %>;
        var aspxVars_UnpublishedStatusCode =
            <%= ((int) DuplicateRuleStatus.Unpublished).ToString("D", System.Globalization.CultureInfo.InvariantCulture) %>;
        var aspxVars_CurrentEntityId = <%= Microsoft.Crm.CrmEncodeDecode.CrmJavaScriptEncode(this.CurrentEntity.Id) %>;
        var aspxVars_DuplicateRule =
            <%= Microsoft.Crm.Util.DuplicateRule.ToString("D", System.Globalization.CultureInfo.InvariantCulture) %>;
