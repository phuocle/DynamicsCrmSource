    ...
    <script language="javascript" type="text/javascript">
        ...
        function GetNextPageDefinition() {
            ...
            if (ddWizardMode == Mscrm.DuplicateDetectionWizardMode.systemWide)
                nextPageUrl = Mscrm.CrmUri
                    .create("/Tools/DuplicateDetection/DuplicateDetectionJobWizard/SearchCriteriaContainerPage.aspx");
            else
                nextPageUrl = Mscrm.CrmUri
                    .create("/Tools/DuplicateDetection/DuplicateDetectionJobWizard/AdditionalOptionsPage.aspx?ddWizardMode=" + ddWizardMode);
        ...
        function OnLoad() {
            ...
            if (ddWizardMode == Mscrm.DuplicateDetectionWizardMode.forSelectedRecords) {
                ...
                jobName = formatString(LOCID_DD_JOBNAME_SELECTED_STR,
