...
<script type="text/javascript">
    ...
    function ConfirmIsFullTextSearchEnabled(returnValue, isFullTextSearchEnabled) {
        if (returnValue != null && returnValue == false) {
            Mscrm.FormControlInputBehavior.GetBehavior("rdIsFullTextSearchEnabled")
                .set_dataValue(isFullTextSearchEnabled);
        }
    }
    ...
    function applychanges() {
        ...
        if (!IsNull(document.getElementById("ckEnableDefaultCountryCode")) &&
            $get("ckEnableDefaultCountryCode").checked == true) {
        ...
        if (isNullOrEmptyString(Mscrm.FormControlInputBehavior.GetBehavior('numMinOutlookSyncInterval')
            .get_dataValue())) {
        ...
        if (externalPartyEnabledEntitiesSettingsXml != "") {
            _boAnySettingChanged = true;
            retval.Append("<externalpartyentitysettings>" +
                CrmEncodeDecode.CrmXmlEncode(externalPartyEnabledEntitiesSettingsXml) +
                "</externalpartyentitysettings>");
        }

        if (externalPartyCorrKeyMapDataXml != "") {
            _boAnySettingChanged = true;
            retval.Append("<externalpartycorrelationkeys>" +
                CrmEncodeDecode.CrmXmlEncode(externalPartyCorrKeyMapDataXml) +
    ...
    function GetOtherSyncSettings() {
        ...
        if (ckIsAppointmentAttachmentSyncEnabled != null &&
            Mscrm.FormUtility.isControlDirty(ckIsAppointmentAttachmentSyncEnabled)) {
            _boAnySettingChanged = true;
            returnValue = "<isappointmentattachmentsyncenabled>" +
                (ckIsAppointmentAttachmentSyncEnabled.checked ? "1" : "0") +
        ...
        if (ckIsAssignedTasksSyncEnabled != null && Mscrm.FormUtility.isControlDirty(ckIsAssignedTasksSyncEnabled)) {
            ...
            returnValue = returnValue +
                ...
                (ckIsAssignedTasksSyncEnabled.checked ? "1" : "0") +
                "</isassignedtaskssyncenabled>";
        }

        var ckIsResourceBookingExchangeSyncEnabled = $get("ckIsResourceBookingExchangeSyncEnabled");
        if (ckIsResourceBookingExchangeSyncEnabled != null &&
            Mscrm.FormUtility.isControlDirty(ckIsResourceBookingExchangeSyncEnabled)) {
            _boAnySettingChanged = true;
            returnValue = returnValue +
                "<isresourcebookingexchangesyncenabled>" +
                (ckIsResourceBookingExchangeSyncEnabled.checked ? "1" : "0") +
                "</isresourcebookingexchangesyncenabled>";
        }

        var rdIsContactMailingAddressSyncEnabled = $get("rdIsContactMailingAddressSyncEnabled");
        if (rdIsContactMailingAddressSyncEnabled != null &&
            Mscrm.FormUtility.isControlDirty(rdIsContactMailingAddressSyncEnabled)) {
    ...
    function checkRelationshipIntelligenceDependencies() {
        ...
        if (infoText != null) {
            ...
            if (radioEmailEnagnement != null) {
                ...
                if (controlEmailEngagement != null &&
                    controlEmailEngagement.get_dataValue() &&
                    radioRelationshipAssistance != null) {
                    var controlRelationshipAssistant = Mscrm.FormControlInputBehavior
                        .GetBehavior(radioRelationshipAssistanceId);
    ...
    function GetFeatureSetSettings() {
        ...
        AppendFeatureSetXml(result,
            "rdGuidedHelpEnabled",
            CrmEncodeDecode.CrmXmlEncode('<%= GetGuidedHelpFeatureXml(true) %>'),
            CrmEncodeDecode.CrmXmlEncode('<%= GetGuidedHelpFeatureXml(false) %>'));
    ...
    function onEmailConnectionChannelChange() {
        ...
        var currentSelection = CrmEncodeDecode.CrmXmlEncode(Mscrm.FormControlInputBehavior
            .GetBehavior('picklistEmailConnectionChannel').get_dataValue());

        if (HAS_PASSWORD_FOR_A_MAILBOX == '1' &&
            EMAIL_CONNECTION_CHANNEL == emailChannelEnum.HostedEmailConnector &&
            currentSelection == emailChannelEnum.EmailRouter) {
    ...
    function onDefaultCountryCodeChange() {
        ...
        if (!IsNull(document.getElementById("ckEnableDefaultCountryCode")) &&
            $get("ckEnableDefaultCountryCode").checked == true &&
            !IsNull(document.getElementById("txtDefaultCountryCode"))) {
            txtDefaultCountryCodeControl.set_disabled(false);
        } else if (!IsNull(document.getElementById("ckEnableDefaultCountryCode")) &&
            $get("ckEnableDefaultCountryCode").checked == false &&
            !IsNull(document.getElementById("txtDefaultCountryCode"))) {
    ...
    function onEnableBingMapsChange() {
        ...
        if (IsNull(enableBingMapsRadioControl) ||
            IsNull(enableBingMapsRadioControl.get_dataValue()) ||
            !enableBingMapsRadioControl.get_dataValue()) {
    ...
    function onIsFullTextSearchEnabledChange() {
        var isFullTextEnabled = Mscrm.FormControlInputBehavior.GetBehavior("rdIsFullTextSearchEnabled").get_dataValue()
            ? true
            : false;

        var oUrl = Mscrm.CrmUri.create("/Tools/SystemSettings/Dialogs/dlg_confirm_enablefulltextsearch.aspx");
        oUrl.get_query()["resource_description"] = isFullTextEnabled
            ? String.format(LOCID_FULLTEXTSEARCHENABLEDDESC)
    ...
    function onAddressBookSyncToggled() {
        ...
        Mscrm.FormControlInputBehavior.GetBehavior('numMinAddressBookSyncInterval')
            .set_disabled(!Mscrm.FormControlInputBehavior.GetBehavior("rdAllowAddressBookSyncs").get_dataValue());
    ...
    function onEnableLPAuthoringChange() {
        if (Mscrm.FormControlInputBehavior.GetBehavior("rdLPAuthoringEnabled").get_dataValue()) {
            ...
            if (window.parent._MicrosoftMars &&
                window.parent._MicrosoftMars.Client.Utility &&
                window.parent._MicrosoftMars.Client.Utility.Util &&
                window.parent._MicrosoftMars.Client.Utility.Util.CreateGroup) {
                ...
                createGroupPromise.done(function(value) {
                    if (value) {
                        var oUrl = Mscrm.CrmUri
                            .create("/Tools/SystemSettings/Dialogs/dlg_confirm_enablelpauthoring.aspx");
                        ...
                        errorStrings.text = window.parent._MicrosoftMars.Client.Loader.marsLocale
                            .SecurityGroupCreationFailedMessage;
                ...
                createGroupPromise.fail(function() {
                    Mscrm.FormControlInputBehavior.GetBehavior("rdLPAuthoringEnabled").set_dataValue(false);
                    var errorStrings = new Xrm.AlertDialogStrings();
                    errorStrings.text = String.format(Xrm.Internal
                        .getResourceString("Error_Message_Generic_Instruction"),
                        Xrm.Internal.getResourceString("CRM_Dynamics_Community"),
                        Xrm.Internal.getResourceString("Microsoft_Support"));
                    var options = new Xrm.DialogOptions;
                    options.width = 600;
                    options.height = 150;
                    Xrm.Dialog.openAlertDialog(errorStrings, options, null);
                ...
                Mscrm.FormControlInputBehavior.GetBehavior("rdLPAuthoringEnabled").set_dataValue(false);
                var errorStrings = new Xrm.AlertDialogStrings();
                errorStrings.text = String.format(Xrm.Internal.getResourceString("Error_Message_Generic_Instruction"),
                    Xrm.Internal.getResourceString("CRM_Dynamics_Community"),
                    Xrm.Internal.getResourceString("Microsoft_Support"));
                var options = new Xrm.DialogOptions;
                options.width = 600;
    ...
    function validateMarketingControlsStatus() {
        ...
        if (!IsNull(ctrl) && !IsNull(ctrl.get_dataValue()) && !IsNull(ackCtrl.get_dataValue())) {
            if (ctrl.get_dataValue() && ackCtrl.get_dataValue()) {
                if (IsNull(luTemplateLookupCtrl
                        .get_dataValue()) ||
                    IsNull(luTemplateLookupCtrl.get_dataValue()[0].id)) {
    ...
    function GetTagPollingPeriod() {
        if (Mscrm.FormUtility.isControlDirty($get('numTagPollingPeriod'))) {
            _boAnySettingChanged = true;
            return "<tagpollingperiod>" +
                Mscrm.FormControlInputBehavior.GetBehavior('numTagPollingPeriod').get_dataValue() * 60 * 1000 +
                "</tagpollingperiod>";
        }
    ...
    function GetSendPollingPeriod() {
        if (Mscrm.FormUtility.isControlDirty($get('numSendPollingPeriod'))) {
            _boAnySettingChanged = true;
            return "<emailsendpollingperiod>" +
                Mscrm.FormControlInputBehavior.GetBehavior('numSendPollingPeriod').get_dataValue() * 60 * 1000 +
    ...
    function GetAllowScheduledSyncs() {
        ...
        if (Mscrm.FormUtility.isControlDirty($get("rdAllowScheduledSyncs"))) {
            _boAnySettingChanged = true;
            return "<allowoutlookscheduledsyncs>" +
                (ctrl.get_dataValue() ? "true" : "false") +
    ...
    function GetOfflinePollingPeriod() {
        if (Mscrm.FormUtility.isControlDirty($get('numMinOfflineSyncInterval'))) {
            ...
            return "<minofflinesyncinterval>" +
                Mscrm.FormControlInputBehavior.GetBehavior('numMinOfflineSyncInterval').get_dataValue() * 60 * 1000 +
    ...
    function GetAllowOfflineScheduledSyncs() {
        ...
        if (Mscrm.FormUtility.isControlDirty($get("rdAllowOfflineScheduledSyncs"))) {
            _boAnySettingChanged = true;
            return "<allowofflinescheduledsyncs>" +
                (ctrl.get_dataValue() ? "true" : "false") +
    ...
    function GetAddressBookPollingPeriod() {
        if (Mscrm.FormUtility.isControlDirty($get('numMinAddressBookSyncInterval'))) {
            ...
            return "<minaddressbooksyncinterval>" +
                Mscrm.FormControlInputBehavior.GetBehavior('numMinAddressBookSyncInterval').get_dataValue() *
                60 *
                60 *
                1000 +
    ...
    function GetEmailConnectionChannel() {
        if (Mscrm.FormUtility.isControlDirty($get("picklistEmailConnectionChannel"))) {
            _boAnySettingChanged = true;
            return "<emailconnectionchannel>" +
                CrmEncodeDecode.CrmXmlEncode(Mscrm.FormControlInputBehavior
                    .GetBehavior('picklistEmailConnectionChannel').get_dataValue()) +
    ...
    function GetOutlookSyncInterval() {
        if (Mscrm.FormUtility.isControlDirty($get('numMinOutlookSyncInterval'))) {
            ...
            return "<minoutlooksyncinterval>" +
                Mscrm.FormControlInputBehavior.GetBehavior('numMinOutlookSyncInterval').get_dataValue() * 60 * 1000 +
    ...
    function GetAllowClientMessageBarAd() {
        ...
        if (Mscrm.FormUtility.isControlDirty($get("rdAllowClientMessageBarAd"))) {
            _boAnySettingChanged = true;
            return "<allowclientmessagebarad>" +
                (ctrl.get_dataValue() ? "true" : "false") +
    ...
    function GetCortanaProactiveExperienceEnabled() {
        ...
        if (rdCortanaProactiveExperienceEnabled != null) {
            ...
            _boAnySettingChanged = true;
            return "<cortanaproactiveexperienceenabled>" +
                (ctrl.get_dataValue() ? "true" : "false") +
    ...
    function GetDelveActionHubIntegrationEnabled() {
        ...
        if (rdDelveActionHubIntegrationEnabled != null) {
            ...
            if (ctrl.get_dataValue() != null)
                return "<isdelveactionhubintegrationenabled>" +
                    (ctrl.get_dataValue() ? "true" : "false") +
    ...
    function GetAppendURLParametersEnabled() {
        ...
        if (Mscrm.FormUtility.isControlDirty($get("rdAppendURLParametersEnabled"))) {
            _boAnySettingChanged = true;
            return "<globalappendurlparametersenabled>" +
                (ctrl.get_dataValue() ? "true" : "false") +
    ...
    function GetQuickFindRecordLimitEnabled() {
        if (!IsNull(rdQuickFindRecordLimitEnabled) &&
            Mscrm.FormUtility.isControlDirty($get("rdQuickFindRecordLimitEnabled"))) {
            _boAnySettingChanged = true;
            return "<quickfindrecordlimitenabled>" +
                (Mscrm.FormControlInputBehavior.GetBehavior("rdQuickFindRecordLimitEnabled").get_dataValue()
                    ? "true"
                    : "false") +
    ...
    function GetIsFullTextSearchEnabled() {
        if (typeof(rdIsFullTextSearchEnabled) != "undefined" &&
            !IsNull(rdIsFullTextSearchEnabled) &&
            Mscrm.FormUtility.isControlDirty($get("rdIsFullTextSearchEnabled"))) {
            _boAnySettingChanged = true;
            return "<isfulltextsearchenabled>" +
                (Mscrm.FormControlInputBehavior.GetBehavior("rdIsFullTextSearchEnabled").get_dataValue()
                    ? "true"
                    : "false") +
    ...
    function GetIsExternalSearchEnabled() {
        ...
        if ((!IsNull(ckEnableExternalSearchValue) && Mscrm.FormUtility.isControlDirty(ckEnableExternalSearchValue))) {
            ...
            return "<isexternalsearchindexenabled>" +
                (ckEnableExternalSearchValue.checked ? "true" : "false") +
    ...
    function GetProductRecommendationsPreviewEnabled() {
        ...
        if (!IsNull(rdProductRecommendationsPreview) &&
            Mscrm.FormUtility.isControlDirty(rdProductRecommendationsPreview)) {
            _boAnySettingChanged = true;
            var ctrl = Mscrm.FormControlInputBehavior.GetBehavior("rdProductRecommendationsPreview");
            return "<productrecommendationsenabled>" +
                (ctrl.get_dataValue() ? "true" : "false") +
    ...
    function GetAllowUsersSeeAppDownloadMessage() {
        ...
        if (Mscrm.FormUtility.isControlDirty($get("rdAllowUsersSeeAppDownloadMessage"))) {
            _boAnySettingChanged = true;
            return "<allowusersseeappdownloadmessage>" +
                (ctrl.get_dataValue() ? "true" : "false") +
    ...
    function getReportCategoryUpdate() {
        ...
        if (!IsNull(edtCategory_listEditComponent)) {
            reportCategoryData += "<reportcategories>" +
                edtCategory_listEditComponent.get_xmlData() +
                "</reportcategories>";
        }
    ...
    function GetRollupConfiguration() {
        ...
        if (Mscrm.FormUtility.isControlDirty($get('rollupExpiryTime'))) {
            _boAnySettingChanged = true;
            rollupConfigurationData += "<goalrollupexpirytime>" +
                Mscrm.FormControlInputBehavior.GetBehavior('rollupExpiryTime').get_dataValue() +
                "</goalrollupexpirytime>";
        }

        if (Mscrm.FormUtility.isControlDirty($get('rollupFrequency'))) {
            _boAnySettingChanged = true;
            rollupConfigurationData += "<goalrollupfrequency>" +
                Mscrm.FormControlInputBehavior.GetBehavior('rollupFrequency').get_dataValue() +
                "</goalrollupfrequency>";
        }
    ...
    function GetIsSLASuppressed() {
        if (typeof(rdIsSLASuppressed) != "undefined" &&
            !IsNull(rdIsSLASuppressed) &&
            Mscrm.FormUtility.isControlDirty($get("rdIsSLASuppressed"))) {
            _boAnySettingChanged = true;
            return "<suppresssla>" +
                (Mscrm.FormControlInputBehavior.GetBehavior("rdIsSLASuppressed").get_dataValue() ? "true" : "false") +
                "</suppresssla>";
        }
    ...
    function GetAutoApplySLA() {
        if (typeof(rdAutoApplySLA) != "undefined" &&
            !IsNull(rdAutoApplySLA) &&
            Mscrm.FormUtility.isControlDirty($get("rdAutoApplySLA"))) {
            _boAnySettingChanged = true;
            return "<autoapplysla>" +
                (Mscrm.FormControlInputBehavior.GetBehavior("rdAutoApplySLA").get_dataValue() ? "true" : "false") +
                "</autoapplysla>";
        }
    ...
    function GetAutoApplyDefaultOnCaseCreate() {
        if (typeof(rdAutoApplyDefaultOnCaseCreate) != "undefined" &&
            !IsNull(rdAutoApplyDefaultOnCaseCreate) &&
            Mscrm.FormUtility.isControlDirty($get("rdAutoApplyDefaultOnCaseCreate"))) {
            _boAnySettingChanged = true;
            return "<autoapplydefaultoncasecreate>" +
                (Mscrm.FormControlInputBehavior.GetBehavior("rdAutoApplyDefaultOnCaseCreate").get_dataValue()
                    ? "true"
                    : "false") +
    ...
    function GetAutoApplyDefaultOnCaseUpdate() {
        if (typeof(rdAutoApplyDefaultOnCaseUpdate) != "undefined" &&
            !IsNull(rdAutoApplyDefaultOnCaseUpdate) &&
            Mscrm.FormUtility.isControlDirty($get("rdAutoApplyDefaultOnCaseUpdate"))) {
            _boAnySettingChanged = true;
            return "<autoapplydefaultoncaseupdate>" +
                (Mscrm.FormControlInputBehavior.GetBehavior("rdAutoApplyDefaultOnCaseUpdate").get_dataValue()
                    ? "true"
                    : "false") +
    ...
    function GetIsSocialCareDisabled() {
        if (typeof(rdIsSocialCareDisabled) != "undefined" &&
            !IsNull(rdIsSocialCareDisabled) &&
            Mscrm.FormUtility.isControlDirty($get("rdIsSocialCareDisabled"))) {
            _boAnySettingChanged = true;
            return "<disablesocialcare>" +
                (Mscrm.FormControlInputBehavior.GetBehavior("rdIsSocialCareDisabled")
                    .get_dataValue()
                    ? "true"
                    : "false") +
                "</disablesocialcare>";
    ...
    function GetDisplayNavigationTour() {
        if (typeof(rdDisplayNavigationTour) != "undefined" &&
            !IsNull(rdDisplayNavigationTour) &&
            Mscrm.FormUtility.isControlDirty($get("rdDisplayNavigationTour"))) {
            _boAnySettingChanged = true;
            return "<displaynavigationtour>" +
                (Mscrm.FormControlInputBehavior.GetBehavior("rdDisplayNavigationTour").get_dataValue()
                    ? "true"
                    : "false") +
    ...
    function GetUseLegacyRendering() {
        if (typeof(rdUseLegacyFormRendering) != "undefined" &&
            !IsNull(rdUseLegacyFormRendering) &&
            Mscrm.FormUtility.isControlDirty($get("rdUseLegacyFormRendering"))) {
            _boAnySettingChanged = true;
            return "<uselegacyrendering>" +
                (Mscrm.FormControlInputBehavior.GetBehavior("rdUseLegacyFormRendering").get_dataValue()
                    ? "true"
                    : "false") +
                "</uselegacyrendering>";
        }
    ...
    function GetEnableLPAuthoring() {
        if (typeof(rdLPAuthoringEnabled) != "undefined" &&
            !IsNull(rdLPAuthoringEnabled) &&
            Mscrm.FormUtility.isControlDirty($get("rdLPAuthoringEnabled"))) {
            _boAnySettingChanged = true;
            return "<enablelpauthoring>" +
                (Mscrm.FormControlInputBehavior.GetBehavior("rdLPAuthoringEnabled")
                    .get_dataValue()
                    ? "true"
                    : "false") +
                "</enablelpauthoring>";
    ...
    function GetPowerBIFeatureEnabled() {
        if (typeof(rdPowerBiFeatureEnabled) != "undefined" &&
            !IsNull(rdPowerBiFeatureEnabled) &&
            Mscrm.FormUtility.isControlDirty($get("rdPowerBiFeatureEnabled"))) {
            _boAnySettingChanged = true;
            return "<powerbifeatureenabled>" +
                (Mscrm.FormControlInputBehavior.GetBehavior("rdPowerBiFeatureEnabled").get_dataValue()
                    ? "true"
                    : "false") +
    ...
    function GetApplicationMetadataOnDemandSyncSettings() {
        if (typeof(ckIsMobileClientOnDemandSyncEnabled) != "undefined" &&
            !IsNull(ckIsMobileClientOnDemandSyncEnabled) &&
            Mscrm.FormUtility.isControlDirty($get("ckIsMobileClientOnDemandSyncEnabled"))) {
            _boAnySettingChanged = true;
            return "<ismobileclientondemandsyncenabled>" +
                (Mscrm.FormControlInputBehavior.GetBehavior("ckIsMobileClientOnDemandSyncEnabled").get_dataValue()
                    ? "true"
                    : "false") +
    ...
    function GetConflictDetectionSettings() {
        if (typeof(rdIsConflictDetectionEnabledForMobileClient) != "undefined" &&
            !IsNull(rdIsConflictDetectionEnabledForMobileClient) &&
            Mscrm.FormUtility.isControlDirty($get("rdIsConflictDetectionEnabledForMobileClient"))) {
            _boAnySettingChanged = true;
            return "<isconflictdetectionenabledformobileclient>" +
                (Mscrm.FormControlInputBehavior.GetBehavior("rdIsConflictDetectionEnabledForMobileClient")
                    .get_dataValue()
                    ? "true"
                    : "false") +
    ...
    function GetIsMicrosoftFlowEnabled() {
        ...
        if (Mscrm.FormUtility.isControlDirty($get("rdIsMicrosoftFlowEnabled"))) {
            _boAnySettingChanged = true;
            return "<enablemicrosoftflowintegration>" +
                (ctrl.get_dataValue() ? "true" : "false") +
    ...
    function GetFullNameConventionCode() {
        if (Mscrm.FormUtility.isControlDirty($get("selectFullNameConventionCode"))) {
            _boAnySettingChanged = true;
            return "<fullnameconventioncode>" +
                CrmEncodeDecode.CrmXmlEncode($get("selectFullNameConventionCode").value) +
    ...
    function GetTrackingIdBase() {
        if (Mscrm.FormUtility.isControlDirty($get('numTrackingIdBase'))) {
            _boAnySettingChanged = true;
            return "<trackingtokenidbase>" +
                CrmEncodeDecode.CrmXmlEncode(Mscrm.FormControlInputBehavior.GetBehavior('numTrackingIdBase')
                    .get_dataValue()) +
                "</trackingtokenidbase>";
        }
    ...
    function GetTrackingIdLength() {
        if (Mscrm.FormUtility.isControlDirty($get("selTrackingIdLength"))) {
            _boAnySettingChanged = true;
            return "<trackingtokeniddigits>" +
                CrmEncodeDecode.CrmXmlEncode(selTrackingIdLengthCtrl.get_dataValue()) +
    ...
    function GetEnableEmailCorrelation() {
        if (Mscrm.FormUtility.isControlDirty($get("ckEnableEmailCorrelation"))) {
            _boAnySettingChanged = true;
            return "<emailcorrelationenabled>" +
                CrmEncodeDecode.CrmXmlEncode(Mscrm.FormControlInputBehavior.GetBehavior('ckEnableEmailCorrelation')
                    .get_dataValue()) +
    ...
    function GetEnableFolderBasedTracking() {
        if (Mscrm.FormUtility.isControlDirty($get("ckEnableFolderBasedTracking"))) {
            _boAnySettingChanged = true;
            return "<isfolderbasedtrackingenabled>" +
                CrmEncodeDecode.CrmXmlEncode(Mscrm.FormControlInputBehavior.GetBehavior('ckEnableFolderBasedTracking')
                    .get_dataValue()) +
    ...
    function GetEnableSmartMatching() {
        if (Mscrm.FormUtility.isControlDirty($get("ckEnableSmartMatching"))) {
            ...
            return "<enablesmartmatching>" +
                CrmEncodeDecode.CrmXmlEncode(Mscrm.FormControlInputBehavior.GetBehavior("ckEnableSmartMatching")
                    .get_dataValue()) +
                "</enablesmartmatching>";
        }
    }
    ...
    function GetEnableConversationTracking() {
        if (Mscrm.FormUtility.isControlDirty($get("ckEnableConversationTracking"))) {
            _boAnySettingChanged = true;
            return "<enableconversationtracking>" +
                CrmEncodeDecode.CrmXmlEncode(Mscrm.FormControlInputBehavior.GetBehavior('ckEnableConversationTracking')
                    .get_dataValue()) +
    ...
    function GetSMFilter() {
        if (Mscrm.FormUtility.isControlDirty($get("txtSMFilter"))) {
            _boAnySettingChanged = true;
            return "<hashfilterkeywords>" +
                CrmEncodeDecode.CrmXmlEncode(txtSMFilterCtrl.get_dataValue()) +
                "</hashfilterkeywords>";
        }
    }
    ...
    function GetSMKeywordLimit() {
        if (Mscrm.FormUtility.isControlDirty($get('numSMKeywordLimit'))) {
            _boAnySettingChanged = true;
            return "<hashmaxcount>" +
                CrmEncodeDecode.CrmXmlEncode(Mscrm.FormControlInputBehavior.GetBehavior('numSMKeywordLimit')
                    .get_dataValue()) +
                "</hashmaxcount>";
        }
    }
    ...
    function GetSMMaxDifference() {
        if (Mscrm.FormUtility.isControlDirty($get('numSMMaxDifference'))) {
            _boAnySettingChanged = true;
            return "<hashdeltasubjectcount>" +
                CrmEncodeDecode.CrmXmlEncode(Mscrm.FormControlInputBehavior.GetBehavior('numSMMaxDifference')
                    .get_dataValue()) +
    ...
    function GetSMMinRecipients() {
        if (Mscrm.FormUtility.isControlDirty($get('numSMMinRecipients'))) {
            _boAnySettingChanged = true;
            return "<hashminaddresscount>" +
                CrmEncodeDecode.CrmXmlEncode(Mscrm.FormControlInputBehavior.GetBehavior('numSMMinRecipients')
                    .get_dataValue()) +
                "</hashminaddresscount>";
        }
    }
    ...
    function GetShareOnAssign() {
        ...
        if (Mscrm.FormUtility.isControlDirty($get("rdShareOnAssign"))) {
            _boAnySettingChanged = true;
            return "<sharetopreviousowneronassign>" +
                (ctrl.get_dataValue() ? "true" : "false") +
    ...
    function GetCurrencyDisplayOption() {
        if (Mscrm.FormUtility.isControlDirty($get("picklistCurrencyDisplayOption"))) {
            ...
            return "<currencydisplayoption>" +
                CrmEncodeDecode.CrmXmlEncode(Mscrm.FormControlInputBehavior.GetBehavior("picklistCurrencyDisplayOption")
                    .get_dataValue()) +
    ...
    function GetHelpURL() {
        if (Mscrm.FormUtility.isControlDirty($get("txtURLHelp"))) {
            ...
            return "<globalhelpurl>" +
                CrmEncodeDecode.CrmXmlEncode(txtURLHelpControl
                    .get_dataValue()
                    ? txtURLHelpControl.get_dataValue()
                    : "") +
                "</globalhelpurl>";
        }
    ...
    function GetBlockedAttachment() {
        if (Mscrm.FormUtility.isControlDirty($get("txtBlockedAttachment"))) {
            ...
            var dataValue = txtBlockedAttachmentControl.get_dataValue()
                ? txtBlockedAttachmentControl.get_dataValue()
                : "";
            txtBlockedAttachmentControl.set_dataValue(dataValue.replace(/[\n\r]+/g, ""));
            return "<blockedattachments>" +
                CrmEncodeDecode.CrmXmlEncode(txtBlockedAttachmentControl.get_dataValue()
                    ? txtBlockedAttachmentControl.get_dataValue()
                    : "") +
                "</blockedattachments>";
        }
    ...
    function GetUseSecureFrame() {
        ...
        if (Mscrm.FormUtility.isControlDirty($get("rdUseSecureFrame"))) {
            _boAnySettingChanged = true;
            return "<rendersecureiframeforemail>" +
                (ctrl.get_dataValue() ? "true" : "false") +
    ...
    function GetAllowUnresolvedParty() {
        ...
        if (Mscrm.FormUtility.isControlDirty($get("rdAllowUnresolvedParty"))) {
            _boAnySettingChanged = true;
            return "<allowunresolvedpartiesonemailsend>" +
                (ctrl.get_dataValue() ? "true" : "false") +
    ...
    function GetUnresolveIfMultipleMatch() {
        ...
        if (Mscrm.FormUtility.isControlDirty($get("rdUnresolveIfMultipleMatch"))) {
            _boAnySettingChanged = true;
            return "<unresolveemailaddressifmultiplematch>" +
                (ctrl.get_dataValue() ? "true" : "false") +
    ...
    function GetEmailMonitoring() {
        ...
        if (Mscrm.FormUtility.isControlDirty($get("rdAllowEmailMonitoring"))) {
            _boAnySettingChanged = true;
            return "<isemailmonitoringallowed>" +
                (ctrl.get_dataValue() ? "true" : "false") +
    ...
    function GetEnableExecution() {
        ...
        if (Mscrm.FormUtility.isControlDirty($get("rdEnableExecution"))) {
            _boAnySettingChanged = true;
            return "<allowmarketingemailexecution>" +
                (ctrl.get_dataValue() ? "1" : "0") +
    ...
    function GetEnableDefaultCountryCodeFlag() {
        ...
        if (!IsNull(document.getElementById("ckEnableDefaultCountryCode"))) {
            if (Mscrm.FormUtility.isControlDirty($get("ckEnableDefaultCountryCode"))) {
                return "<isdefaultcountrycodecheckenabled>" +
                    ($get("ckEnableDefaultCountryCode").checked ? "true" : "false") +
    ...
    function GetEnableDefaultCountryCodeValue() {
        ...
        if (!IsNull(document.getElementById("txtDefaultCountryCode"))) {
            if (Mscrm.FormUtility.isControlDirty($get("txtDefaultCountryCode"))) {
                var txtDefaultCountryCodeControl = Mscrm.FormControlInputBehavior.GetBehavior("txtDefaultCountryCode");
                var dataValue = txtDefaultCountryCodeControl.get_dataValue()
                    ? txtDefaultCountryCodeControl.get_dataValue()
                    : "";
    ...
    function GetEnableUnsubscriptionAcknowledgement() {
        ...
        if (Mscrm.FormUtility.isControlDirty($get("rdEnableUnsubscriptionAcknowledgement"))) {
            _boAnySettingChanged = true;
            return "<allowautounsubscribeacknowledgement>" +
                (ctrl.get_dataValue() ? "1" : "0") +
    ...
    function GetTemplateLookup() {
        if (Mscrm.FormUtility.isControlDirty($get("luTemplateLookup"))) {
            ...
            return "<acknowledgementtemplateid>" +
                ((IsNull(lookupValue) || IsNull(lookupValue[0].id))
                    ? ""
                    : CrmEncodeDecode.CrmXmlEncode(lookupValue[0].id)) +
    ...
    function openEntityCustomization() {
        openObj(7100,
            '<%= SolutionConstants.DefaultSolutionId.ToString("B") %>',
            'def_category=<%= Microsoft.Crm.Application.Utility.Util.Entity %>',
            null,
            true,
            null);
    }
    ...
    function GetEnableUserAccessAudit() {
        if (Mscrm.FormUtility.isControlDirty($get("ckEnableUserAccessAudit"))) {
            _boAnySettingChanged = true;
            return "<isuseraccessauditenabled>" +
                ($get("ckEnableUserAccessAudit").checked ? "true" : "false") +
        ...
        if (document.getElementById("ckCommonAudit") != null) {
            if (Mscrm.FormUtility.isControlDirty($get("ckCommonAudit"))) {
                ...
                auditAreaXml = auditAreaXml +
                    "<commonarea enable=\"" +
                    ($get("ckCommonAudit").checked ? "true" : "false") +
                    "\">";
            ...
            if (Mscrm.FormUtility.isControlDirty($get("ckSFAAudit"))) {
                ...
                auditAreaXml = auditAreaXml +
                    "<sfaarea enable=\"" +
                    ($get("ckSFAAudit").checked ? "true" : "false") +
                    "\">";
            ...
            if (Mscrm.FormUtility.isControlDirty($get("ckMAAudit"))) {
                ...
                auditAreaXml = auditAreaXml +
                    "<maaarea enable=\"" +
                    ($get("ckMAAudit").checked ? "true" : "false") +
                    "\">";
            ...
            if (Mscrm.FormUtility.isControlDirty($get("ckCSAudit"))) {
                ...
                auditAreaXml = auditAreaXml +
                    "<csarea enable=\"" +
                    ($get("ckCSAudit").checked ? "true" : "false") +
                    "\">";
    ...
    function GetPricingDecimalPrecision() {
        if (Mscrm.FormUtility.isControlDirty($get("selectPricingDecimalPrecision"))) {
            _boAnySettingChanged = true;
            return "<pricingdecimalprecision>" +
                CrmEncodeDecode.CrmXmlEncode($get("selectPricingDecimalPrecision").value) +
    ...
    function GetMaxUploadFileSize() {
        if (Mscrm.FormUtility.isControlDirty($get('numberMaxUploadFileSize'))) {
            ...
            return "<maxuploadfilesize>" +
                Mscrm.FormControlInputBehavior.GetBehavior('numberMaxUploadFileSize').get_dataValue() * 1024 +
                "</maxuploadfilesize>";
        }
    ...
    function GetEmailServerProfileOption() {
        if (Mscrm.FormUtility.isControlDirty($get("emailServerProfile"))) {
            ...
            return "<defaultemailserverprofileid>" +
                ((IsNull(oEmailServerProfile.get_dataValue()) || IsNull(oEmailServerProfile.get_dataValue()[0].id))
                    ? ""
                    : CrmEncodeDecode.CrmXmlEncode(oEmailServerProfile.get_dataValue()[0].id)) +
        ...
        if (Mscrm.FormUtility.isControlDirty($get("incomingEmailDeliveryMethod")) ||
            ...
            return "<defaultemailsettings>" +
                CrmEncodeDecode.CrmXmlEncode("<EmailSettings>" +
                    ...
                    CrmEncodeDecode.CrmXmlEncode(Mscrm.FormControlInputBehavior
                        .GetBehavior('incomingEmailDeliveryMethod').get_dataValue()) +
                    "</IncomingEmailDeliveryMethod>" +
                    "<OutgoingEmailDeliveryMethod>" +
                    CrmEncodeDecode.CrmXmlEncode(Mscrm.FormControlInputBehavior
                        .GetBehavior('outgoingEmailDeliveryMethod').get_dataValue()) +
                    "</OutgoingEmailDeliveryMethod>" +
                    "<ACTDeliveryMethod>" +
                    CrmEncodeDecode.CrmXmlEncode(Mscrm.FormControlInputBehavior.GetBehavior('actDeliveryMethod')
                        .get_dataValue()) +
                    "</ACTDeliveryMethod>" +
                    "</EmailSettings>") +
    ...
    function GetIgnoreInternalEmail() {
        if (Mscrm.FormUtility.isControlDirty($get("ckEnableExclude"))) {
            _boAnySettingChanged = true;
            return "<ignoreinternalemail>" +
                ($get("ckEnableExclude").checked ? "false" : "true") +
                "</ignoreinternalemail>";
        }
    ...
    function GetEnableBingMapsIntegration() {
        if (Mscrm.FeatureControl.get_Current().isFeatureEnabled(Mscrm.FeatureNames.RefreshSales)) {
            if (Mscrm.FormUtility.isControlDirty($get("rdEnableBingIntegration"))) {
                _boAnySettingChanged = true;
                return "<enablebingmapsintegration>" +
                    (Mscrm.FormControlInputBehavior.GetBehavior("rdEnableBingIntegration").get_dataValue()
                        ? "true"
                        : "false") +
    ...
    function GetBingMapsApiKey() {
        if (!IsNull(document.getElementById("txtBingMapsApiKey"))) {
            if (Mscrm.FormUtility.isControlDirty($get("txtBingMapsApiKey"))) {
                _boAnySettingChanged = true;
                var txtBingMapsApiKeyControl = Mscrm.FormControlInputBehavior.GetBehavior("txtBingMapsApiKey");
                var dataValue = txtBingMapsApiKeyControl
                    .get_dataValue()
                    ? txtBingMapsApiKeyControl.get_dataValue()
                    : "";
    ...
    function GetPluginTracing() {
        if (Mscrm.FormUtility.isControlDirty($get("selectPluginTracingLevels"))) {
            _boAnySettingChanged = true;
            return "<plugintracelogsetting>" +
                CrmEncodeDecode.CrmXmlEncode($get("selectPluginTracingLevels").value) +
    ...
    function GetDefaultCrmCustomName() {
        if (Mscrm.FormUtility.isControlDirty($get("txtDefaultCrmCustomName"))) {
            ...
            var dataValue = txtDefaultCrmCustomNameControl.get_dataValue()
                ? txtDefaultCrmCustomNameControl.get_dataValue()
                : "";
            txtDefaultCrmCustomNameControl.set_dataValue(dataValue);
            return "<defaultcrmcustomname>" +
                CrmEncodeDecode.CrmXmlEncode(txtDefaultCrmCustomNameControl.get_dataValue()
                    ? txtDefaultCrmCustomNameControl.get_dataValue()
                    : "") +
    ...
    function GetEnableBusinessNetwork() {
        if (Mscrm.FormUtility.isControlDirty($get('rdIsBusinessNetworkEnabled'))) {
            _boAnySettingChanged = true;
            return "<isbusinessnetworkenabled>" +
                ($get('rdIsBusinessNetworkEnabled').checked ? "true" : "false") +
                "</isbusinessnetworkenabled>";
        }
        return "";
    }
    ...
    function GetDisableIECompatibilityMode() {
        ...
        if (!IsNull(chkIECompatMode)) {
            if (Mscrm.FormUtility.isControlDirty(chkIECompatMode)) {
                _boAnySettingChanged = true;
                return "<DisableIECompatMode>" +
                    (chkIECompatMode.checked ? "true" : "false"
                    ) +
                    "</DisableIECompatMode>";
            }
        }
    ...
    function GetDefaultDiscountSetting() {
        if (Mscrm.FormUtility.isControlDirty($get("picklistDiscountTypeOptionMethod"))) {
            ...
            return "<discountcalculationmethod>" +
                CrmEncodeDecode.CrmXmlEncode(Mscrm.FormControlInputBehavior
                    .GetBehavior("picklistDiscountTypeOptionMethod").get_dataValue()) +
    ...
    function GetDefaultPriceListRuleEnabled() {
        if (Mscrm.FormUtility.isControlDirty($get('rdDefaultPricelistRuleEnabled'))) {
            ...
            _boAnySettingChanged = true;
            return "<useinbuiltrulefordefaultpricelistselection>" +
                (Mscrm.FormControlInputBehavior.GetBehavior("rdDefaultPricelistRuleEnabled").get_dataValue()
                    ? "true"
                    : "false") +
    ...
    function GetOOBPriceCalculationEnabled() {
        if (Mscrm.FormUtility.isControlDirty($get("rdOOBPriceCalculationEnabled"))) {
            _boAnySettingChanged = true;
            return "<oobpricecalculationenabled>" +
                (Mscrm.FormControlInputBehavior.GetBehavior("rdOOBPriceCalculationEnabled").get_dataValue()
                    ? "false"
                    : "true") +
    ...
    function GetCreateProductsWithoutParentInActiveStateEnabled() {
        if (Mscrm.FormUtility.isControlDirty($get('rdCreateProductsWithoutParentInActiveState'))) {
            ...
            _boAnySettingChanged = true;
            return "<createproductswithoutparentinactivestate>" +
                (Mscrm.FormControlInputBehavior.GetBehavior("rdCreateProductsWithoutParentInActiveState")
                    .get_dataValue()
                    ? "true"
                    : "false") +
    ...
    function handleEntityTypeChange() {
        ...
        for (var i = 0; i < visibleAttributeRows.length; i++) {
            ...
            if ((visibleAttributeRows[i].getAttribute("name") == "independentMapping") ||
                (visibleAttributeRows[i].getAttribute("name") == "computedMapping")) {
    ...
    function GetMaximumDynamicPropertiesAllowed() {
        if (Mscrm.FormUtility.isControlDirty($get('numberMaximumDynamicPropertiesAllowed'))) {
            _boAnySettingChanged = true;
            var value = Mscrm.FormControlInputBehavior.GetBehavior('numberMaximumDynamicPropertiesAllowed')
                .get_dataValue();
    ...
    function GetEmailApprovalValue() {
        ...
        if (Mscrm.FormUtility.isControlDirty($get("ckUserApproval"))) {
            _boAnySettingChanged = true;
            returnValue = "<requireapprovalforuseremail>" +
                ($get("ckUserApproval").checked ? "1" : "0") +
        ...
        if (Mscrm.FormUtility.isControlDirty($get("ckQueueApproval"))) {
            ...
            returnValue = returnValue +
                ...
                ($get("ckQueueApproval").checked ? "1" : "0") +
                "</requireapprovalforqueueemail>";
        }
    ...
    function GetTrackingNumberLength() {
        ...
        if (Mscrm.FormUtility.isControlDirty(ckEnableTracking) ||
            Mscrm.FormUtility.isControlDirty(selTrackingNumberLengthElement)) {
            _boAnySettingChanged = true;
            return "<maximumtrackingnumber>" +
                (ckEnableTracking.checked
                    ? CrmEncodeDecode.CrmXmlEncode(selTrackingNumberLengthCtrl.get_dataValue())
                    : "0") +
    ...
    function GetAlertSettings() {
        ...
        if (Mscrm.FormUtility.isControlDirty(ckGenerateAlertsForErrors)) {
            _boAnySettingChanged = true;
            returnValue = "<generatealertsforerrors>" +
                (ckGenerateAlertsForErrors.checked ? "1" : "0") +
        ...
        if (Mscrm.FormUtility.isControlDirty(ckGenerateAlertsForWarnings)) {
            ...
            returnValue = returnValue +
                ...
                (ckGenerateAlertsForWarnings.checked ? "1" : "0") +
                "</generatealertsforwarnings>";
        }
        if (Mscrm.FormUtility.isControlDirty(ckGenerateAlertsForInformation)) {
            ...
            returnValue = returnValue +
                ...
                (ckGenerateAlertsForInformation.checked ? "1" : "0") +
                "</generatealertsforinformation>";
        }
        if (Mscrm.FormUtility.isControlDirty(ckNotifyMailboxOwnerOfEmailServerLevelAlerts)) {
            ...
            returnValue = returnValue +
                ...
                (ckNotifyMailboxOwnerOfEmailServerLevelAlerts.checked ? "1" : "0") +
                "</notifymailboxownerofemailserverlevelalerts>";
        }
        return returnValue;
    }
    ...
    function updateTrackingTokenExample() {
        ...
        var sOnlineFlag = "0";
        var sTrackingId = "000000000" +
            (Mscrm.FormControlInputBehavior.GetBehavior('numTrackingIdBase').get_dataValue() + 1).toString();
        ...
        sTrackingNumber = sTrackingNumber.substring(sTrackingNumber.length - iTrackingNumberLength,
            sTrackingNumber.length);
    ...
    function GetSLAPauseStates() {
        ...
        for (var rowId = 0; rowId < oRows.length; rowId++) {
            slaPauseStates = slaPauseStates +
                (rowId == 0 ? "" : ";") +
                XUI.Html.DomUtils.GetFirstChild(oRows[rowId])
                .id;
        }
    ...
    function ConfigServiceTab() {
        ...
        if (pauseStatesXmlDoc
            .documentElement ==
            null ||
            pauseStatesXmlDoc.documentElement.nodeName != "entitiesstates") {
            var pausevalues = PAUSE_STATES;
            PAUSE_STATES = "<entitiesstates><entity value=\"incident\">" +
                CrmEncodeDecode.CrmXmlEncode(pausevalues) +
                "</entity></entitiesstates>";
        ...
        for (var nodeId = 0; nodeId < entityNodeList.length; nodeId++) {
            if (entityNodeList[nodeId].getAttribute("value") == Mscrm.InternalUtilities.EntityNames.Incident) {
                incidentPauseStates = (entityNodeList[nodeId].firstChild)
                    ? ((entityNodeList[nodeId].firstChild).data)
                    : "";
                break;
            }
        }
        ...
        if (isOutlookHostedWindow()) {
            ...
            window.dialogArguments["valuesXml"] = Mscrm.SelectStatusTransition
                .createAvailableFieldsXml(XUI.Xml.LoadXml(statusXML), 1);
            ...
            window.inlineDialogArguments["valuesXml"] = Mscrm.SelectStatusTransition
                .createAvailableFieldsXml(XUI.Xml.LoadXml(statusXML), 1);
    ...
    function OnChangePrimaryEntity() {
        ...
        for (var nodeId = 0; nodeId < entityNodeList.length; nodeId++) {
            if (entityNodeList[nodeId].getAttribute("value") == primaryEntity) {
                primaryEntityPauseStates = (entityNodeList[nodeId].firstChild)
                    ? ((entityNodeList[nodeId].firstChild).data)
                    : "";
                break;
            }
        ...
        if (isOutlookHostedWindow()) {
            ...
            window.dialogArguments["valuesXml"] = Mscrm.SelectStatusTransition
                .createAvailableFieldsXml(XUI.Xml.LoadXml(primaryEntityStatusXmlString), 1);
...
<style type="text/css">
    ...
    DIV.listEdit_valuelist { height: 168px; }
    ...
    div.ms-crm-Input-Container { padding-left: 2px !important; }

    TD.currSel { border-bottom: 1px solid white; }
</style>
</head>
<body>
<form name="crmForm">
...
<tr>
    <td class="ms-crm-Form-Section ms-crm-Form-SectionBar" colspan="3" valign="bottom" nowrap>
        <loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.MiscTab.IsAutoSaveEnabled.Title" runat="server"/>
    </td>
</tr>
<tr>
    <td nowrap valign="center">
        <label for="rdIsAutoSaveEnabled">
            <loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.MiscTab.IsAutoSaveEnabled.Labels.IsAutoSaveEnabled" runat="server"/>
        </label>
    </td>
    <td valign="center">
        <crm:Radio id="rdIsAutoSaveEnabled" runat="server"/>
    </td>
    <td></td>
</tr>
<tr>
    <td class="ms-crm-Form-Section ms-crm-Form-SectionBar" colspan="3" valign="bottom" nowrap>
        <loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.MiscTab.IsPresenceEnabled.Title" runat="server"/>
    </td>
</tr>
<tr>
    <td nowrap valign="center">
        <label for="rdIsPresenceEnabled">
            <loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.MiscTab.IsPresenceEnabled.Labels.IsPresenceEnabled" runat="server"/>
        </label>
    </td>
    <td valign="center">
        <crm:Radio id="rdIsPresenceEnabled" runat="server"/>
    </td>
    <td></td>
</tr>
<tr>
    <td class="ms-crm-Form-Section ms-crm-Form-SectionBar" colspan="3" valign="bottom" nowrap>
        <loc:Text ResourceId="Web.Tools.SystemSettings.Dialogs.systemsettings.aspx_105" runat="server"/>
    </td>
</tr>
<tr>
    <td nowrap valign="center">
        <label for="selectFullNameConventionCode">
            <loc:Text ResourceId="Web.Tools.SystemSettings.Dialogs.systemsettings.aspx_110" runat="server"/>
        </label>
    </td>
    <td valign="center">
...
<tr>
    <td class="ms-crm-Form-Section ms-crm-Form-SectionBar" colspan="3" valign="bottom" nowrap>
        <BR><loc:Text ResourceId="Web.Tools.SystemSettings.Dialogs.systemsettings.aspx_157" runat="server"/>
    </td>
</tr>
<tr>
    <td nowrap valign="center">
        <label for="selectPricingDecimalPrecision">
            <loc:Text ResourceId="Web.Tools.SystemSettings.Dialogs.systemsettings.aspx_160" runat="server"/>
        </label>
    </td>
    <td valign="center">
...
<tr>
    <td class="ms-crm-Form-Section ms-crm-Form-SectionBar" colspan="3" valign="bottom" nowrap>
        <BR><loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.MiscTab.AssigningObjectsSection.Tite" runat="server"/>
    </td>
</tr>
<tr>
    <td nowrap valign="center">
        <label for="rdShareOnAssign">
            <loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.MiscTab.AssigningObjectsSection.Labels.ShareOnAssign" runat="server"/>
        </label>
    </td>
    <td valign="center">
        <crm:Radio id="rdShareOnAssign" runat="server"/>
    </td>
    <td></td>
</tr>
<tr>
...
<tr>
    <td class="ms-crm-Form-Section ms-crm-Form-SectionBar" colspan="3" valign="bottom" nowrap>
        <label for="txtBlockedAttachment">
            <loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.MiscTab.BlockedAttachment.Title" runat="server"/>
        </label>
    </td>
</tr>
<tr>
...
<tr>
    <td class="ms-crm-Form-Section ms-crm-Form-SectionBar" colspan="3" valign="bottom">
        <BR><loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.MiscTab.CurrencyDisplayOption.Title" runat="server"/>
    </td>
</tr>
<tr>
    <td nowrap valign="center">
        <label for="picklistCurrencyDisplayOption">
            <loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.MiscTab.CurrencyDisplayOption.Label" runat="server"/>
        </label>
    </td>
    <td valign="center">
        <sdk:PicklistControl id="picklistCurrencyDisplayOption" runat="server"/>
    </td>
    <td></td>
</tr>
<% if (ShowExternalSearchOption || IsQuickFindRecordLimitEnabledDefined || IsFullTextSearchEnabledDefined)
   {
       ...
       { %>
        <tr>
            <td class="ms-crm-Form-Section ms-crm-Form-SectionBar" colspan="3" valign="bottom" nowrap>
                <BR><loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.MiscTab.QuickFindConfiguration.SectionHeader" runat="server"/>
            </td>
        </tr>
    <% }
       else
       { %>
        <tr>
            <td class="ms-crm-Form-Section ms-crm-Form-SectionBar" colspan="3" valign="bottom" nowrap>
                <BR><loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.MiscTab.QuickFindConfiguration.SectionHeader.QuickFind" runat="server"/>
            </td>
...
<% if (IsQuickFindRecordLimitEnabledDefined)
   { %>
    <tr>
        <td nowrap valign="center">
            <label for="rdQuickFindRecordLimitEnabled">
                <loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.MiscTab.QuickFindRecordLimitEnabled.Labels.QuickFindRecordLimitEnabled" runat="server"/>
            </label>
        </td>
        <td valign="center">
            <crm:Radio id="rdQuickFindRecordLimitEnabled" runat="server"/>
        </td>
        <td></td>
    </tr>
    <% if (IsFullTextSearchEnabledDefined)
       { %>
        <tr>
            <td nowrap valign="center">
                <label for="rdIsFullTextSearchEnabled">
                    <loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.MiscTab.IsFullTextSearchEnabled.Labels.IsFullTextSearchEnabled" runat="server"/>
                </label>
            </td>
            <td valign="center">
                <crm:Radio id="rdIsFullTextSearchEnabled" runat="server" OnChange="onIsFullTextSearchEnabledChange()"/>
            </td>
            <td></td>
        </tr>
    <% } %>
    <tr>
        <% if (IsRelevanceSearchFeatureEnabled)
           { %>
            <td nowrap valign="center">
                <label for="btnConfigureQuickFind">
                    <loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.MiscTab.QuickFindConfiguration.DescriptionTextForCategorizedSearch" runat="server"/>
                </label>
            </td>
        <% }
           else
           { %>
            <td nowrap valign="center">
                <label for="btnConfigureQuickFind">
                    <loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.MiscTab.QuickFindConfiguration.DescriptionText" runat="server"/>
                </label>
            </td>
        <% } %>
        <td valign="center">
            <ui:Button CssClass="ms-crm-RefreshDialog-Button" id="btnConfigureQuickFind" OnClick="OpenQuickFindConfigDialog()" ResourceId="SystemCustomization.SystemSettingsDialog.MiscTab.QuickFindConfiguration.ButtonText" runat="server"></ui:Button>
        </td>
        <td></td>
    </tr>
<% } %>
<% if (ShowBingMapsOption)
   { %>
    <tr>
        <td class="ms-crm-Form-Section ms-crm-Form-SectionBar" colspan="3" valign="bottom" nowrap>
            <BR><loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.MiscTab.IsBingMapsIntegrationEnabled.Title" runat="server"/>
        </td>
    </tr>
    <tr>
        <td valign="center" colspan="2">
    ...
    <tr>
        <td nowrap valign="center">
            <label for="rdEnableBingIntegration">
                <loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.MiscTab.IsBingMapsIntegrationEnabled.Labels.IsBingMapsIntegrationEnabled" runat="server"/>
            </label>
        </td>
        <td valign="center">
            <crm:Radio id="rdEnableBingIntegration" runat="server" OnChange="onEnableBingMapsChange()"/>
        </td>
...
<% if (Microsoft.Crm.Caching.FeatureEnabledHelper.IsFeatureEnabled(FeatureControl.Current.Features.RefreshCommonInfrastructure, Microsoft.Crm.Application.Security.UserInformation.Current))
   { %>
    <tr>
        <td class="ms-crm-Form-Section ms-crm-Form-SectionBar" colspan="3" valign="bottom" nowrap>
            <BR><loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.MiscTab.Labels.Title" runat="server"/>
        </td>
    </tr>
    <tr>
        <td valign="center">
    ...
    <tr>
        <td class="ms-crm-Form-Section ms-crm-Form-SectionBar" colspan="3" valign="bottom" nowrap>
            <BR><loc:Text ResourceId="defaultprotocolsectionlabel" runat="server"/>
        </td>
    </tr>
    <tr>
        <td colspan="3" valign="bottom" nowrap>
            <loc:Text ResourceId="defaultprotocollabel" runat="server"/>
        </td>
    </tr>
    <tr>
        <td>
            <table width="100%">
                ...
                <tr>
                    ...
                    <td colspan="3" nowrap valign="center">
                        <crm:Radio id="rdUseSkypeProtocol" runat="server"/>
                    </td>
                </tr>
            </table>
        </td>
    ...
    <tr>
        <td class="ms-crm-Form-Section ms-crm-Form-SectionBar" colspan="3" valign="bottom" nowrap>
            <BR><loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.MiscTab.MobileAppNotificationDisplayOption.Title" runat="server"/>
        </td>
    </tr>
    <tr>
        <td nowrap valign="center">
            <label for="rdAllowUsersSeeAppDownloadMessage">
                <loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.OSTab.MobileAppNotificationDisplayOption.Labels.AllowUsersSeeAppDownloadMessage" runat="server"/>
            </label>
        </td>
        <td valign="center">
            <crm:Radio id="rdAllowUsersSeeAppDownloadMessage" runat="server"/>
        </td>
        <td></td>
    </tr>
<% } %>
...
<% if (IsCustomHelpDefined)
   { %>
    <tr>
        <td class="ms-crm-Form-Section ms-crm-Form-SectionBar" colspan="3" valign="bottom" nowrap>
            <loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.MiscTab.URLHelp.SetURLTitle" runat="server"/>
        </td>
    </tr>
    <tr>
        <td nowrap valign="center">
            <label for="rdCustomizedHelpEnabled">
                <loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.MiscTab.URLHelp.RLabel" runat="server"/>
            </label>
        </td>
        <td valign="center">
            <crm:Radio id="rdCustomizedHelpEnabled" OnChange="onEnableCustomizableHelpChange();" runat="server"/>
        </td>
        <td></td>
    </tr>
    <tr>
        <td nowrap valign="center">
            <label for="txtURLHelp">
                <loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.MiscTab.URLHelp.SetURL" runat="server"/>
            </label>
        </td>
    ...
    <tr>
        <td nowrap valign="center">
            <label for="rdAppendURLParametersEnabled">
                <loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.MiscTab.URLHelp.AppendURLParameters" runat="server"/>
            </label>
        </td>
        <td valign="center">
            <crm:Radio id="rdAppendURLParametersEnabled" runat="server"/>
        </td>
        <td></td>
    </tr>
    <% if (FeatureEnabledHelper.IsNonOrgFeatureEnabled(FeatureControl.Current.Features.InContextHelp, Microsoft.Crm.Application.Security.UserInformation.Current))
       { %>
        <tr>
            <td nowrap valign="center">
                <label id="labelGuidedHelpEnabled" for="rdGuidedHelpEnabled" runat="server">
                    <loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.MiscTab.URLHelp.LearningPath" runat="server"/>
                </label>
            </td>
            <td valign="center">
                <crm:Radio id="rdGuidedHelpEnabled" runat="server"/>
            </td>
            <td></td>
        </tr>
        <tr>
            <td nowrap valign="center">
                <label id="labelLPAuthoringEnabled" for="rdLPAuthoringEnabled" runat="server">
                    <loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.MiscTab.URLHelp.LearningPathAuthoring" runat="server"/>
                </label>
            </td>
            <td valign="center">
                <crm:Radio id="rdLPAuthoringEnabled" OnChange="onEnableLPAuthoringChange();" runat="server"/>
            </td>
            <td></td>
        </tr>
    <% } %>
...
<tr>
    <td class="ms-crm-Form-Section ms-crm-Form-SectionBar" colspan="3" valign="bottom" nowrap>
        <BR><loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.GenTab.DisableSocialCare.Title" runat="server"/>
    </td>
</tr>
<tr>
    <td nowrap valign="center">
        <label for="rdIsSocialCareDisabled">
            <loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.GenTab.DisableSocialCare.Label" runat="server"/>
        </label>
    </td>
    <td valign="center">
        <crm:Radio id="rdIsSocialCareDisabled" runat="server"/>
    </td>
    <td></td>
</tr>
<tr>
    <td class="ms-crm-Form-Section ms-crm-Form-SectionBar" colspan="3" valign="bottom" nowrap>
        <BR><loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.GenTab.DisplayNavigationTour.Title" runat="server"/>
    </td>
</tr>
<tr>
    <td nowrap valign="center">
        <label for="rdDisplayNavigationTour">
            <loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.GenTab.DisplayNavigationTour.Label" runat="server"/>
        </label>
    </td>
    <td valign="center">
        <crm:Radio id="rdDisplayNavigationTour" runat="server"/>
    </td>
    <td></td>
</tr>
<tr>
    <td class="ms-crm-Form-Section ms-crm-Form-SectionBar" colspan="3" valign="bottom" nowrap>
        <BR><label id="labelUseLegacyFormRenderingTitle" runat="server">
            <loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.GenTab.LegacyFormRendering.Title" runat="server"/>
        </label>
    </td>
</tr>
<tr>
    <td nowrap valign="center">
        <label id="labelUseLegacyFormRendering" for="rdUseLegacyFormRendering" runat="server">
            <loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.GenTab.LegacyFormRendering.Label" runat="server"/>
        </label>
    </td>
    <td valign="center">
        <crm:Radio id="rdUseLegacyFormRendering" runat="server"/>
    </td>
    <td></td>
</tr>
<% if (ShowMicrosoftFlowOption)
   { %>
    <tr>
        <td class="ms-crm-Form-Section ms-crm-Form-SectionBar" colspan="3" valign="bottom" nowrap>
            <BR><loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.MiscTab.IsMicrosoftFlowEnabled.Title" runat="server"/>
        </td>
    </tr>
    <tr>
        <td nowrap valign="center">
            <label for="rdIsMicrosoftFlowEnabled">
                <loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.MiscTab.IsMicrosoftFlowEnabled.Labels.IsMicrosoftFlowEnabled" runat="server"/>
            </label>
        </td>
        <td valign="center">
            <crm:Radio id="rdIsMicrosoftFlowEnabled" runat="server"/>
        </td>
        <td></td>
    </tr>
<% } %>
...
<tr>
    <td class="ms-crm-Form-Section ms-crm-Form-SectionBar" colspan="3" valign="bottom" nowrap>
        <loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.MiscTab.IsEnabledForAllRoles.Title" runat="server"/>
    </td>
</tr>
<tr>
    <td nowrap valign="center">
        <label for="rdIsEnabledForAllRoles">
            <loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.MiscTab.IsEnabledForAllRoles.Labels.IsEnabledForAllRoles" runat="server"/>
        </label>
    </td>
    <td valign="center">
        <crm:Radio id="rdIsEnabledForAllRoles" runat="server"/>
    </td>
    <td></td>
</tr>
<tr>
...
<div id="tab1" class="ms-crm-Tab TabContent">
    <table width="100%">
        ...
        <tr>
            <td nowrap valign="center">
                <label for="numberMaximumAppointmentDuration">
                    <loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.CalendarSection.Scheduling.Label.MaximumAppointmentDuration" runat="server"/>
                </label>
            </td>
            <td valign="center">
                <crm:Number id="numberMaximumAppointmentDuration" runat="server"/>
            </td>
            <td></td>
        </tr>
    </table>
        ...
        %>
            ...
            <tr>
                <td>
                    ...
                    <loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.AuditTab.AreasSection.Customize" runat="server">
                        <loc:Argument runat="server">
                            <a runat="server" class="default-link" id="CrmCustomizationLink" href="#" onclick="openEntityCustomization();">
                                <loc:Text ResourceId="Audit.EntitySettings.Title" runat="server"/>
                            </a>
                        </loc:Argument>
                    </loc:Text>
                </td>
...
<tr>
    <td class="ms-crm-Form-Section ms-crm-Form-SectionBar" colspan="3" valign="bottom" nowrap>
        <loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.TrackingTab.EmailConnectorType.Title" runat="server"/>
    </td>
</tr>
<tr>
    <td colspan="3">
        <loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.TrackingTab.EmailConnectorType.Description" runat="server"/>
    </td>
</tr>
<tr>
    <td></td>
    <td colspan="2">
        <table id="EmailChannelTable" width="100%">
            ...
            <tr>
                <td nowrap valign="center">
                    <label for="picklistEmailConnectionChannel">
                        <loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.TrackingTab.EmailConnectorType.SelectUsing" runat="server"/>
                    </label>
                </td>
                <td valign="center">
                    <sdk:PicklistControl id="picklistEmailConnectionChannel" runat="server" OnChange="onEmailConnectionChannelChange();"/>
                </td>
            </tr>
        </table>
    </td>
...
<tr>
    <td class="ms-crm-Form-Section ms-crm-Form-SectionBar" colspan="4" valign="bottom" nowrap>
        <loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.Email.DefaultOption.Title" runat="server"/>
    </td>
</tr>
<tr>
    <td colspan="4" nowrap>
        <loc:Text ResourceId="SysCustomization.SysSettingsDlg.Email.ControlSection.Labels.EmailDefaultOptionInfo" runat="server"/>
    </td>
</tr>
<tr>
    <td></td>
    <td colspan="2">
        <table id="Table1" width="100%">
            ...
            <tr>
                <td nowrap valign="center">
                    <label for="emailServerProfile">
                        <loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.Email.DefaultOption.Labels.EmailServerProfile" runat="server"/>
                    </label>
                </td>
                <td valign="center">
                    <sdk:LookupControl id="emailServerProfile" AccessibilityLabelResourceId="SystemCustomization.SystemSettingsDialog.Email.DefaultOption.Labels.EmailServerProfile" LookupBrowse="true" runat="server"/>
                </td>
            </tr>
            <tr>
                <td nowrap valign="center">
                    <label for="incomingEmailDeliveryMethod">
                        <loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.Email.DefaultOption.Labels.IncomingEmailDeliveryMethod" runat="server"/>
                    </label>
                </td>
                <td valign="center">
                    <sdk:PicklistControl id="incomingEmailDeliveryMethod" runat="server"/>
                </td>
            </tr>
            <tr>
                <td nowrap valign="center">
                    <label for="outgoingEmailDeliveryMethod">
                        <loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.Email.DefaultOption.Labels.OutgoingEmailDeliveryMethod" runat="server"/>
                    </label>
                </td>
                <td valign="center">
                    <sdk:PicklistControl id="outgoingEmailDeliveryMethod" runat="server"/>
                </td>
            </tr>
            <tr>
                <td nowrap valign="center">
                    <label for="actDeliveryMethod">
                        <loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.Email.DefaultOption.Labels.ACTDeliveryMethod" runat="server"/>
                    </label>
                </td>
                <td valign="center">
                    <sdk:PicklistControl id="actDeliveryMethod" runat="server"/>
                </td>
            </tr>
        </table>
    </td>
...
<tr>
    <td class="ms-crm-Form-Section ms-crm-Form-SectionBar" colspan="3" valign="bottom" nowrap>
        <loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.TrackingTab.ApprovalSection.Title" runat="server"/>
    </td>
</tr>
<tr>
    <td colspan="3">
        <loc:Text ResourceId="SysCustomization.SysSettingsDlg.TrackingTab.ControlSection.Labels.EmailApprovalInfo" runat="server"/>
    </td>
</tr>
<tr>
    <td colspan="3" nowrap valign="center">
        <crm:CheckBox id="ckUserApproval" runat="server"/><label for="ckUserApproval">
            <loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.TrackingTab.ControlSection.Labels.UserApproval" runat="server"/>
        </label>
    </td>
</tr>
<tr>
    <td colspan="3" nowrap valign="center">
        <crm:CheckBox id="ckQueueApproval" runat="server"/><label for="ckQueueApproval">
            <loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.TrackingTab.ControlSection.Labels.QueueApproval" runat="server"/>
        </label>
    </td>
</tr>
...
<tr>
    <td class="ms-crm-Form-Section ms-crm-Form-SectionBar" colspan="4" valign="bottom" nowrap>
        <loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.TrackingTab.ControlSection.Title" runat="server"/>
    </td>
</tr>
<tr>
    <td colspan="3">
        <loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.TrackingTab.ControlSection.Labels.MessageToEnableServerSideSync" runat="server"/>
    </td>
</tr>
<tr>
    <td colspan="4" nowrap>
        <crm:CheckBox id="ckEnableFolderBasedTracking" runat="server"/><label id="labelEnableFolderBasedTracking" for="ckEnableFolderBasedTracking" runat="server">
            <loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.TrackingTab.ControlSection.Labels.ControlFolderBasedTracking" runat="server"/>
        </label>
    </td>
</tr>
<tr>
    <td colspan="4" nowrap>
        <crm:CheckBox id="ckEnableEmailCorrelation" OnClick="onEnableEmailCorrelationChange();" runat="server"/><label for="ckEnableEmailCorrelation">
            <loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.TrackingTab.ControlSection.Labels.ControlCorrelation" runat="server"/>
        </label>
    </td>
</tr>
<tr>
    <td></td>
    <td colspan="3" nowrap valign="center">
        <crm:CheckBox id="ckEnableTracking" OnClick="onEnableTrackingChange();" runat="server"/><label for="ckEnableTracking">
            <loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.TrackingTab.ControlSection.Labels.ControlTracking" runat="server"/>
        </label>
    </td>
</tr>
<tr>
    ...
    <td>
        <table id="tokenConfig" width="100%">
            ...
            <tr>
                <td nowrap valign="center">
                    <label for="txtTrackingPrefix">
                        <loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.TrackingTab.PrefixSection.Labels.Prefix" runat="server"/>
                    </label>
                </td>
                <td valign="center" class="systemsettings_td_trackingpref">
                    <crm:TextBox id="txtTrackingPrefix" OnChange="onTrackingPrefixChange();" runat="server"/>
                </td>
            </tr>
            <tr>
                <td nowrap valign="center">
                    <label for="numTrackingIdBase">
                        <loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.TrackingTab.IdBaseSection.Labels.IdBase" runat="server"/>
                    </label>
                </td>
                <td valign="center">
                    <crm:Number id="numTrackingIdBase" OnChange="updateTrackingTokenExample();" runat="server"/>
                </td>
            </tr>
            <tr>
                <td nowrap valign="center">
                    <label for="selTrackingIdLength">
                        <loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.TrackingTab.IdLengthSection.Labels.IdLength" runat="server"/>
                    </label>
                </td>
                <td valign="center">
                    <crm:Select id="selTrackingIdLength" OnChange="updateTrackingTokenExample();" runat="server"/>
                </td>
            </tr>
            <tr>
                <td nowrap valign="center">
                    <label for="selTrackingNumberLength">
                        <loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.TrackingTab.NumberLengthSection.Labels.NumberLength" runat="server"/>
                    </label>
                </td>
                <td valign="center">
                    <crm:Select id="selTrackingNumberLength" OnChange="updateTrackingTokenExample();" runat="server"/>
                </td>
            </tr>
            <tr>
                <td nowrap valign="center">
                    <loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.TrackingTab.ExampleSection.Labels.Example" runat="server"/>
                </td>
...
<tr>
    <td></td>
    <td colspan="3" nowrap valign="center">
        <crm:CheckBox id="ckEnableSmartMatching" OnClick="onEnableSmartMatchingChange();" runat="server"/><label for="ckEnableSmartMatching">
            <loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.TrackingTab.ControlSection.Labels.ControlSmartMatching" runat="server"/>
        </label>
    </td>
</tr>
<tr>
    ...
    <td>
        <table id="smartmatching" width="100%">
            ...
            <tr>
                <td nowrap valign="center">
                    <label for="txtSMFilter">
                        <loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.TrackingTab.FilterSection.Labels.SMFilter" runat="server"/>
                    </label>
                </td>
                <td valign="center" class="systemsettings_td_smfilter">
                    <crm:TextBox id="txtSMFilter" runat="server"/>
                </td>
            </tr>
            <tr>
                <td nowrap valign="center">
                    <label for="numSMKeywordLimit">
                        <loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.TrackingTab.KeywordLimitSection.Labels.SMKeywordLimit" runat="server"/>
                    </label>
                </td>
                <td valign="center">
                    <crm:Number id="numSMKeywordLimit" runat="server"/>
                </td>
            </tr>
            <tr>
                <td nowrap valign="center">
                    <label for="numSMMaxDifference">
                        <loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.TrackingTab.MaxDifferenceSection.Labels.SMMaxDifference" runat="server"/>
                    </label>
                </td>
                <td valign="center">
                    <crm:Number id="numSMMaxDifference" runat="server"/>
                </td>
            </tr>
            <tr>
                <td nowrap valign="center">
                    <label for="numSMMinRecipients">
                        <loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.TrackingTab.MinRecipientsSection.Labels.SMMinRecipients" runat="server"/>
                    </label>
                </td>
                <td valign="center">
                    <crm:Number id="numSMMinRecipients" runat="server"/>
                </td>
            </tr>
        </table>
    </td>
...
<tr>
    <td class="ms-crm-Form-Section ms-crm-Form-SectionBar" colspan="4" valign="bottom" nowrap>
        <loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.TrackingTab.ExcludeSection.Title" runat="server"/>
    </td>
</tr>
<tr>
    <td colspan="3">
        <loc:Text ResourceId="SysCustomization.SysSettingsDlg.TrackingTab.ExcludeSection.Labels.ControlExcludeInfo" runat="server"/>
    </td>
</tr>
<tr>
    <td></td>
    <td colspan="3" nowrap valign="center">
        <crm:CheckBox id="ckEnableExclude" runat="server"/><label for="ckEnableExclude">
            <loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.TrackingTab.ExcludeSection.Labels.ControlExclude" runat="server"/>
        </label>
    </td>
</tr>
</table>
<table width="100%">
    ...
    <tr>
        <td class="ms-crm-Form-Section ms-crm-Form-SectionBar" colspan="3" valign="bottom" nowrap>
            <loc:Text ResourceId="SysCustomization.SysSettingsDlg.EmailTab.UseSecureFrame.Title" runat="server"/>
        </td>
    </tr>
    <tr>
        <td nowrap valign="center">
            <label for="rdUseSecureFrame">
                <loc:Text ResourceId="SysCustomization.SysSettingsDlg.EmailTab.UseSecureFrame.Label" runat="server"/>
            </label>
        </td>
        <td valign="center">
            <crm:Radio id="rdUseSecureFrame" runat="server"/>
        </td>
        <td></td>
    </tr>
    ...
    <tr>
        <td nowrap valign="center">
            <label for="rdAllowUnresolvedParty">
                <loc:Text ResourceId="SysCustomization.SysSettingsDlg.EmailTab.AllowUnresolvedParty.Title" runat="server"/>
            </label>
        </td>
        <td valign="center">
            <crm:Radio id="rdAllowUnresolvedParty" runat="server"/>
        </td>
        <td></td>
    </tr>
    <% if (IsMultipleContactResolutionFCBEnabled)
       { %>
        <tr>
            <td nowrap valign="center">
                <label id="labelUnresolveIfMultipleMatch" for="rdUnresolveIfMultipleMatch" runat="server">
                    <loc:Text ResourceId="SysCustomization.SysSettingsDlg.EmailTab.UnresolveEmailAddressIfMultipleMatch.Title" runat="server"/>
                </label>
            </td>
            <td valign="center">
                <crm:Radio id="rdUnresolveIfMultipleMatch" runat="server"/>
            </td>
            <td></td>
        </tr>
    <% } %>
    <tr>
        <td class="ms-crm-Form-Section ms-crm-Form-SectionBar" colspan="3" valign="bottom" nowrap>
            <loc:Text ResourceId="SysCustomization.SysSettingsDlg.EmailTab.MaxFileSize.Title" runat="server"/>
        </td>
    </tr>
    <tr>
        <td nowrap valign="center">
            <label for="numberMaxUploadFileSize">
                <loc:Text ResourceId="SysCustomization.SysSettingsDlg.EmailTab.MaxFileSize.Label" runat="server"/>
            </label>
        </td>
        <td valign="center">
            <crm:Number id="numberMaxUploadFileSize" runat="server"/>
        </td>
        <td></td>
    </tr>
</table>
<table width="100%" style="table-layout: fixed;">
    ...
    <tr>
        <td class="ms-crm-Form-Section ms-crm-Form-SectionBar" colspan="4" valign="bottom" nowrap>
            <loc:Text ResourceId="SysCustomization.SysSettingsDlg.EmailTab.AlertsSection.Title" runat="server"/>
        </td>
    </tr>
    <tr>
        <td colspan="3">
            <loc:Text ResourceId="SysCustomization.SysSettingsDlg.EmailTab.AlertsSection.SeverityFilter.Description" runat="server"/>
        </td>
    </tr>
    <tr>
        <td></td>
        <td colspan="3" nowrap valign="center">
            <crm:CheckBox id="ckGenerateAlertsForErrors" runat="server"/><label for="ckGenerateAlertsForErrors">
                <loc:Text ResourceId="SysCustomization.SysSettingsDlg.EmailTab.AlertsSection.Severity.Error" runat="server"/>
            </label>
        </td>
        <td></td>
    </tr>
    <tr>
        <td></td>
        <td colspan="3" nowrap valign="center">
            <crm:CheckBox id="ckGenerateAlertsForWarnings" runat="server"/><label for="ckGenerateAlertsForWarnings">
                <loc:Text ResourceId="SysCustomization.SysSettingsDlg.EmailTab.AlertsSection.Severity.Warning" runat="server"/>
            </label>
        </td>
        <td></td>
    </tr>
    <tr>
        <td></td>
        <td colspan="3" nowrap valign="center">
            <crm:CheckBox id="ckGenerateAlertsForInformation" runat="server"/><label for="ckGenerateAlertsForInformation">
                <loc:Text ResourceId="SysCustomization.SysSettingsDlg.EmailTab.AlertsSection.Severity.Information" runat="server"/>
            </label>
        </td>
        <td></td>
    </tr>
    <tr>
        <td colspan="3">
            <loc:Text ResourceId="SysCustomization.SysSettingsDlg.EmailTab.AlertsSection.MailboxNotification.Description" runat="server"/>
        </td>
    </tr>
    <tr>
        <td></td>
        <td colspan="3" nowrap valign="center">
            <crm:CheckBox id="ckNotifyMailboxOwnerOfEmailServerLevelAlerts" runat="server"/><label for="ckNotifyMailboxOwnerOfEmailServerLevelAlerts">
                <loc:Text ResourceId="SysCustomization.SysSettingsDlg.EmailTab.AlertsSection.MailboxNotification.Label" runat="server"/>
            </label>
        </td>
        <td></td>
    </tr>
...
<div id="tab3" class="ms-crm-Tab TabContent">
    <table width="100%">
        ...
        <tr>
            <td class="ms-crm-Form-Section ms-crm-Form-SectionBar" colspan="3" valign="bottom" nowrap>
                <loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.MarketingTab.ExecutionSection.Title" runat="server"/>
            </td>
        </tr>
        <tr>
            <td nowrap valign="center">
                <label for="rdEnableExecution">
                    <loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.MarketingTab.ExecutionSection.Labels.Execution" runat="server"/>
                </label>
            </td>
            <td valign="center">
                <crm:Radio id="rdEnableExecution" runat="server"/>
            </td>
            <td></td>
        </tr>
        ...
        <tr>
            <td class="ms-crm-Form-Section ms-crm-Form-SectionBar" colspan="3" valign="bottom" nowrap>
                <loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.MarketingTab.ResponseSection.Title" runat="server"/>
            </td>
        </tr>
        <tr>
            <td nowrap valign="center">
                <label for="rdEnableResponseCreation">
                    <loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.MarketingTab.ResponseSection.Labels.ResponseCreation" runat="server"/>
                </label>
            </td>
            <td valign="center">
                <crm:Radio id="rdEnableResponseCreation" runat="server"/>
            </td>
            <td></td>
        </tr>
        ...
        <tr>
            <td class="ms-crm-Form-Section ms-crm-Form-SectionBar" colspan="3" valign="bottom" nowrap>
                <loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.MarketingTab.UnsubscribeSection.Title" runat="server"/>
            </td>
        </tr>
        <tr>
            <td nowrap valign="center">
                <label for="rdEnableUnsubscription">
                    <loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.MarketingTab.UnsubscribeSection.Labels.Unsubscription" runat="server"/>
                </label>
            </td>
            <td valign="center">
                <crm:Radio id="rdEnableUnsubscription" OnChange="onEnableUnsubscriptionChange();" runat="server"/>
            </td>
        ...
        <tr>
            <td nowrap valign="center">
                <label for="rdEnableUnsubscriptionAcknowledgement">
                    <loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.MarketingTab.UnsubscribeSection.Labels.UnsubscriptionAcknowledgement" runat="server"/>
                </label>
            </td>
            <td valign="center">
                <crm:Radio id="rdEnableUnsubscriptionAcknowledgement" OnChange="onEnableUnsubscriptionAcknowledgementChange();" runat="server"/>
            </td>
        ...
        <tr>
            <td nowrap valign="center">
                <label for="luTemplateLookup">
                    <loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.MarketingTab.UnsubscribeSection.Labels.UATemplate" runat="server"/>
                </label>
            </td>
            <td valign="center">
                <sdk:LookupControl id="luTemplateLookup" AccessibilityLabelResourceId="SystemCustomization.SystemSettingsDialog.MarketingTab.UnsubscribeSection.Labels.UATemplate" DefaultViewId="4D5BE2E9-6828-482b-99AA-2387AFED7B37" LookupBrowse="true" runat="server"/>
            </td>
            <td></td>
        </tr>
    </table>
        ...
        <table width="100%">
            ...
            <% if (IsApplicationMetadataOnDemandSyncFeatureAvailable)
               { %>
                <tr>
                    <td class="ms-crm-Form-Section ms-crm-Form-SectionBar" colspan="3" valign="bottom" nowrap>
                        <br><loc:text resourceid="SystemCustomization.SystemSettingsDialog.MobileClientTab.MobileClientSettings.Title" runat="server"/>
                    </td>
                </tr>
                <tr>
                    <td nowrap valign="center">
                        <label id="labelIsMobileClientOnDemandSyncEnabled" for="ckIsMobileClientOnDemandSyncEnabled" runat="server">
                            <loc:text resourceid="SystemCustomization.SystemSettingsDialog.MobileClientTab.MobileClientSettings.IsMobileClientOnDemandSyncEnabled" runat="server"/>
                        </label>
                    </td>
                    <td valign="center">
                        <crm:Checkbox id="ckIsMobileClientOnDemandSyncEnabled" runat="server"/>
                    </td>
                    <td></td>
                </tr>
            <% } %>
            <% if (IsMocaOfflineFeatureAvailable)
               { %>
                <tr>
                    <td class="ms-crm-Form-Section ms-crm-Form-SectionBar" colspan="3" valign="bottom" nowrap>
                        <br><loc:text resourceid="SystemCustomization.SystemSettingsDialog.GeneralTab.IsConflictDetectionForMobileEnabled.Title" runat="server"/>
                    </td>
                </tr>
                <tr>
                    <td nowrap valign="center">
                        <label id="labelIsConflictDetectionEnabledForMobileClient" for="rdIsConflictDetectionEnabledForMobileClient" runat="server">
                            <loc:text resourceid="SystemCustomization.SystemSettingsDialog.GeneralTab.Label.IsConflictDetectionForMobileEnabled" runat="server"/>
                        </label>
                    </td>
                    <td valign="center">
                        <crm:Radio id="rdIsConflictDetectionEnabledForMobileClient" runat="server"/>
                    </td>
                    <td></td>
                </tr>
            <% } %>
...
<div id="tab4" class="ms-crm-Tab TabContent">
    <table width="100%">
        ...
        <tr>
            <td class="ms-crm-Form-Section ms-crm-Form-SectionBar" colspan="3" valign="bottom" nowrap>
                <BR><loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.CustomizationTab.AppMode.Title" runat="server"/>
            </td>
        </tr>
        <tr>
            <td colspan="3" valign="bottom" nowrap>
                <loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.CustomizationTab.AppMode.Description" runat="server"/>
            </td>
        </tr>
        <tr>
            <td>
                <table width="100%">
                    ...
                    <tr>
                        <td></td>
                        <td colspan="3" nowrap valign="center">
                            <crm:CheckBox id="ckEnableAppMode" runat="server"/><label for="ckEnableAppMode">
                                <loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.CustomizationTab.AppMode.Labels.mode" runat="server"/>
                            </label>
                        </td>
                    </tr>
                </table>
        ...
        <% if (IsPluginTracingFeatureEnabled)
           { %>
            <tr>
                <td class="ms-crm-Form-Section ms-crm-Form-SectionBar" colspan="3" valign="bottom" nowrap>
                    <BR><label id="pluginTracingTitle" runat="server">
                        <loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.CustomizationTab.PluginTracing.Title" runat="server"/>
                    </label>
                </td>
            </tr>
            <tr>
                <td nowrap valign="center">
                    <label id="enablePluginTracingLevel" for="selectPluginTracingLevels" runat="server">
                        <loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.CustomizationTab.PluginTracing.Labels.EnableTracing" runat="server"/>
                    </label>
                </td>
                <td valign="center">
                    <crm:Select id="selectPluginTracingLevels" runat="server"/>
                </td>
                <td></td>
            </tr>
        <% } %>
...
<div id="tab5" class="ms-crm-Tab TabContent">
    <table width="100%">
        ...
        <tr>
            <td class="ms-crm-Form-Section ms-crm-Form-SectionBar" colspan="3" valign="bottom" nowrap>
                <BR><loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.OSTab.EmailSection.Title" runat="server"/>
            </td>
        </tr>
        <tr>
            <td nowrap valign="center">
                <label for="rdTagMaxAggressiveCycles">
                    <loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.OSTab.EmailSection.Labels.TagMaxACycles" runat="server"/>
                </label>
            </td>
            <td valign="center">
                <crm:Radio id="rdTagMaxAggressiveCycles" runat="server"/>
            </td>
            <td></td>
        </tr>
        <tr>
            <td nowrap valign="center">
                <label for="numTagPollingPeriod">
                    <loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.OSTab.EmailSection.Labels.TagPollPeriod" runat="server"/>
                </label>
            </td>
            <td>
                <table>
                    <tr>
                        <td valign="center" width="50">
                            <crm:Number id="numTagPollingPeriod" runat="server"/>
                        </td>
                        <td nowrap valign="center" class="systemsettings_td_Mins">
                            <loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.OSTab.EmailSection.Labels.Minutes" runat="server"/>
                        </td>
                    </tr>
                </table>
            </td>
        ...
        <tr>
            <td nowrap valign="center">
                <label for="numSendPollingPeriod">
                    <loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.OSTab.EmailSection.Labels.SendPollPeriod" runat="server"/>
                </label>
            </td>
            <td>
                <table>
                    <tr>
                        <td valign="center" width="50">
                            <crm:Number id="numSendPollingPeriod" runat="server"/>
                        </td>
                        <td nowrap valign="center" class="systemsettings_td_Mins">
                            <loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.OSTab.EmailSection.Labels.Minutes" runat="server"/>
                        </td>
        ...
        <tr>
            <td class="ms-crm-Form-Section ms-crm-Form-SectionBar" colspan="3" valign="bottom" nowrap>
                <BR><loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.OSTab.ControlSchedSyncSection.Title" runat="server"/>
            </td>
        </tr>
        <tr>
            <td nowrap valign="center">
                <label for="rdAllowScheduledSyncs">
                    <loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.OSTab.ControlSchedSyncSection.Labels.AllowScheduledSyncs" runat="server"/>
                </label>
            </td>
            <td valign="center">
                <crm:Radio OnChange="onScheduledSyncToggled();" id="rdAllowScheduledSyncs" runat="server"/>
            </td>
            <td></td>
        </tr>
        ...
        <tr>
            <td nowrap valign="center">
                <label for="numMinOutlookSyncInterval">
                    <loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.OSTab.SetMiminumSyncInterval.Labels.MinimumInterval" runat="server"/>
                </label>
            </td>
            <td>
                <table>
                    <tr>
                        <td valign="center" width="50">
                            <crm:Number id="numMinOutlookSyncInterval" runat="server"/>
                        </td>
                        <td nowrap valign="center" class="systemsettings_td_Mins">
                            <loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.OSTab.EmailSection.Labels.Minutes" runat="server"/>
                        </td>
        ...
        <tr>
            <td class="ms-crm-Form-Section ms-crm-Form-SectionBar" colspan="3" valign="bottom" nowrap>
                <BR><loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.OSTab.ControlOfflineSyncSection.Title" runat="server"/>
            </td>
        </tr>
        <tr>
            <td nowrap valign="center">
                <label for="rdAllowOfflineScheduledSyncs">
                    <loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.OSTab.ControlOfflineSchedSyncSection.Labels.AllowOfflineSyncs" runat="server"/>
                </label>
            </td>
            <td valign="center">
                <crm:Radio OnChange="onOfflineSyncToggled();" id="rdAllowOfflineScheduledSyncs" runat="server"/>
            </td>
            <td></td>
        </tr>
        ...
        <tr>
            <td nowrap valign="center">
                <label for="numMinOfflineSyncInterval">
                    <loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.OSTab.SetMiminumOfflineSyncInterval.Labels.MinimumInterval" runat="server"/>
                </label>
            </td>
            <td>
                <table>
                    <tr>
                        <td valign="center" width="50">
                            <crm:Number id="numMinOfflineSyncInterval" runat="server"/>
                        </td>
                        <td nowrap valign="center" class="systemsettings_td_Mins">
                            <loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.OSTab.EmailSection.Labels.Minutes" runat="server"/>
                        </td>
        ...
        <tr>
            <td class="ms-crm-Form-Section ms-crm-Form-SectionBar" colspan="3" valign="bottom" nowrap>
                <BR><loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.OSTab.ControlAddressBookSyncSection.Title" runat="server"/>
            </td>
        </tr>
        <tr>
            <td nowrap valign="center">
                <label for="rdAllowAddressBookSyncs">
                    <loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.OSTab.ControlAddressBookSyncSection.Labels.AllowAddressBookSyncs" runat="server"/>
                </label>
            </td>
            <td valign="center">
                <crm:Radio OnChange="onAddressBookSyncToggled();" id="rdAllowAddressBookSyncs" runat="server"/>
            </td>
            <td></td>
        </tr>
        <tr>
            <td nowrap valign="center">
                <label for="numMinAddressBookSyncInterval">
                    <loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.OSTab.SetMiminumAddressBookSyncInterval.Labels.MinimumInterval" runat="server"/>
                </label>
            </td>
            <td>
                <table>
                    <tr>
                        <td valign="center" width="50">
                            <crm:Number id="numMinAddressBookSyncInterval" runat="server"/>
                        </td>
                        <td nowrap valign="center" class="systemsettings_td_Mins">
                            <loc:Text ResourceId="Web.Tools.personalsettings.dialogs.personalsettings.Labels.SyncPeriod.Hours" runat="server"/>
                        </td>
                    </tr>
                </table>
            </td>
        ...
        <tr>
            <td class="ms-crm-Form-Section ms-crm-Form-SectionBar" colspan="3" valign="bottom" nowrap>
                <BR><loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.OSTab.ControlMessageBarSection.Title" runat="server"/>
            </td>
        </tr>
        <tr>
            <td nowrap valign="center">
                <label for="rdAllowClientMessageBarAd">
                    <loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.OSTab.ControlMessageBarSection.Labels.AllowClientMessageBarAd" runat="server"/>
                </label>
            </td>
            <td valign="center">
                <crm:Radio id="rdAllowClientMessageBarAd" runat="server"/>
            </td>
            <td></td>
        </tr>
    </table>
...
<div id="tab9" class="ms-crm-Tab TabContent">
    <table width="100%">
        ...
        <tr>
            <td class="ms-crm-Form-Section ms-crm-Form-SectionBar" colspan="3" valign="bottom" nowrap>
                <BR><loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.GoalTab.Labels.Title" runat="server"/>
            </td>
        </tr>
        <tr>
            <td nowrap valign="center">
            ...
            <td>
                <table>
                    <tr>
                        ...
                        <td>
                            <loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.GoalTab.Labels.RollupExpiryTimeUnit" runat="server"/>
                        </td>
                    </tr>
                </table>
            </td>
            ...
            <td>
                <table>
                    <tr>
                        ...
                        <td>
                            <loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.GoalTab.Labels.RollupFrequencyUnit" runat="server"/>
                        </td>
                    </tr>
                </table>
            </td>
...
<div id="tab10" class="ms-crm-Tab TabContent">
    <table width="75%" border="0">
        ...
        <tr>
            <td class="ms-crm-Form-Section ms-crm-Form-SectionBar" colspan="3" valign="bottom" nowrap>
                <BR><loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.SalesTab.CreateProductsWithoutParentInActiveState.Title" runat="server"/>
            </td>
        </tr>
        <tr>
            <td nowrap valign="center">
                <label for="rdCreateProductsWithoutParentInActiveState">
                    <loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.SalesTab.Label.CreateProductsWithoutParentInActiveState" runat="server"/>
                </label>
            </td>
            <td valign="center">
                <crm:Radio id="rdCreateProductsWithoutParentInActiveState" runat="server"/>
            </td>
            <td></td>
        </tr>
        <tr>
        ...
        <tr>
            <td nowrap valign="center">
                <label for="rdDefaultPricelistRuleEnabled">
                    <loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.SalesTab.Label.UseInbuiltRuleForDefaultPricelistSelection" runat="server"/>
                </label>
            </td>
            <td valign="center" width="30%">
                <crm:Radio id="rdDefaultPricelistRuleEnabled" runat="server"/>
            </td>
            <td></td>
        </tr>
        <tr>
        ...
        <tr>
            <td nowrap valign="center">
                <label for="numberMaximumBundleItems">
                    <loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.SalesTab.Label.MaximumBundleItems" runat="server"/>
                </label>
            </td>
            <td valign="center">
                <crm:Number id="numberMaximumBundleItems" runat="server"/>
            </td>
            <td></td>
        </tr>
        <tr>
            <td class="ms-crm-Form-Section ms-crm-Form-SectionBar" colspan="3" valign="bottom" nowrap>
                <BR><loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.SalesTab.OOBPriceCalculationEnabled.Title" runat="server"/>
            </td>
        </tr>
        <tr>
            <td nowrap valign="center">
                <label for="rdOOBPriceCalculationEnabled">
                    <loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.SalesTab.Label.OOBPriceCalculationEnabled" runat="server"/>
                </label>
            </td>
            <td valign="center">
                <crm:Radio id="rdOOBPriceCalculationEnabled" runat="server"/>
            </td>
            <td></td>
        </tr>
        <tr>
            <td class="ms-crm-Form-Section ms-crm-Form-SectionBar" colspan="3" valign="bottom" nowrap>
                <BR><loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.SalesTab.DiscountType.Title" runat="server"/>
            </td>
        </tr>
        <tr>
            <td nowrap valign="center">
                <label for="picklistDiscountTypeOptionMethod">
                    <loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.SalesTab.Label.DiscountType" runat="server"/>
                </label>
            </td>
            <td valign="center">
                <sdk:PicklistControl id="picklistDiscountTypeOptionMethod" runat="server"/>
            </td>
            <td></td>
        </tr>
        <tr>
            <td class="ms-crm-Form-Section ms-crm-Form-SectionBar" colspan="3" valign="bottom" nowrap>
                <BR><loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.SalesTab.MaximumDynamicPropertiesAllowed.Title" runat="server"/>
            </td>
        </tr>
        <tr>
            <td nowrap valign="center">
                <label for="numberMaximumDynamicPropertiesAllowed">
                    <loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.SalesTab.Label.MaximumDynamicPropertiesAllowed" runat="server"/>
                </label>
            </td>
            <td valign="center">
                <crm:Number id="numberMaximumDynamicPropertiesAllowed" runat="server"/>
            </td>
            <td></td>
        </tr>
    </table>
...
<div id="tab11" class="ms-crm-Tab TabContent">
    <table width="100%" border="0">
        ...
        <tr>
            <td class="ms-crm-Form-Section ms-crm-Form-SectionBar" colspan="3" valign="bottom" nowrap>
                <BR><loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.GenTab.SuppressSLA.Title" runat="server"/>
            </td>
        </tr>
        <tr>
            <% if (IsSLAEnabled)
               { %>
                <td nowrap valign="center">
                    <label for="rdIsSLASuppressed">
                        <loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.GenTab.SuppressEntitySLA.Label" runat="server"/>
                    </label>
                </td>
            <% } %>
            <%
               ...
               { %>
                <td nowrap valign="center">
                    <label for="rdIsSLASuppressed">
                        <loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.GenTab.SuppressSLA.Label" runat="server"/>
                    </label>
                </td>
            <% } %>
            <td valign="center">
                <crm:Radio id="rdIsSLASuppressed" runat="server"/>
            </td>
            <td></td>
        </tr>
        <tr>
            <td class="ms-crm-Form-Section ms-crm-Form-SectionBar" colspan="3" valign="bottom" nowrap>
                <BR><loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.ServiceTab.AutoApplySLA.Title" runat="server"/>
            </td>
        </tr>
        <tr>
            <% if (IsSLAEnabled)
               { %>
                <td nowrap valign="center">
                    <label for="rdAutoApplySLA">
                        <loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.ServiceTab.AutoApplySLAEntity.Label" runat="server"/>
                    </label>
                </td>
            <% } %>
            <%
               ...
               { %>
                <td nowrap valign="center">
                    <label for="rdAutoApplySLA">
                        <loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.ServiceTab.AutoApplySLA.Label" runat="server"/>
                    </label>
                </td>
            <% } %>
            <td valign="center">
                <crm:Radio id="rdAutoApplySLA" runat="server"/>
            </td>
            <td></td>
        </tr>
        <% if (IsSLAEnabled)
           { %>
            <tr>
                <td class="ms-crm-Form-Section ms-crm-Form-SectionBar" colspan="3" valign="bottom" nowrap>
                    <BR><loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.ServiceTab.Labels.HoldEntityStatus" runat="server"/>
                </td>
            </tr>
            <tr>
                <td nowrap valign="center">
            ...
            <tr>
                <td colspan="3">
                    <loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.ServiceTab.HoldEntity.Description" runat="server"/>
                </td>
            </tr>
        <% } %>
        <%
           ...
           { %>
            <tr>
                <td class="ms-crm-Form-Section ms-crm-Form-SectionBar" colspan="3" valign="bottom" nowrap>
                    <BR><loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.ServiceTab.Labels.HoldCaseStatus" runat="server"/>
                </td>
            </tr>
            <tr>
                <td colspan="3">
                    <loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.ServiceTab.HoldCase.Description" runat="server"/>
                </td>
            </tr>
        <% } %>
        <tr>
        ...
        <tr>
            <td valign="center">
                <label for="rdAutoApplyDefaultOnCaseCreate" id="labelAutoApplyDefaultOnCaseCreate" runat="server">
                    <loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.GenTab.AutoApplyDefaultonCaseCreate.Label" runat="server"/>
                </label>
            </td>
            <td valign="center">
                <crm:Radio id="rdAutoApplyDefaultOnCaseCreate" runat="server"/>
            </td>
            <td></td>
        </tr>
        <tr>
            <td valign="center">
                <label id="labelAutoApplyDefaultOnCaseUpdate" for="rdAutoApplyDefaultOnCaseUpdate" runat="server">
                    <loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.GenTab.AutoApplyDefaultonCaseUpdate.Label" runat="server"/>
                </label>
            </td>
            <td valign="center">
                <crm:Radio id="rdAutoApplyDefaultOnCaseUpdate" runat="server"/>
            </td>
            <td></td>
        </tr>
    </table>
...
<tr>
    <td colspan="3" valign="bottom" nowrap>
        <loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.PreviewTab.Preview.Information" runat="server"/>
    </td>
</tr>
<tr>
    <td>
        <table width="100%">
            ...
            <tr>
                <td colspan="3" nowrap valign="center">
                    <crm:CheckBox id="cbPreviewEULA" runat="server" onClick="onPreviewEULAChange();"/><label for="cbPreviewEULA"><%= PreviewEULALink %></label>
                </td>
            </tr>
        </table>
    </td>
...
<% if (ShouldShowTaskBasedFlowItem)
   { %>
    <tr>
        <td class="ms-crm-Form-Section ms-crm-Form-SectionBar" colspan="3" valign="bottom" nowrap>
            <BR><loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.PreviewTab.TaskBasedFlowPreview.Title" runat="server"/>
        </td>
    </tr>
    <tr>
        <td nowrap valign="center">
            <label for="rdTaskBasedFlowPreview">
                <loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.PreviewTab.TaskBasedFlowPreview" runat="server"/>
            </label>
        </td>
        <td valign="center" colspan="2">
            <crm:Radio id="rdTaskBasedFlowPreview" runat="server"/>
        </td>
    </tr>
    <tr>
        <td>
...
<% if (IsOrgInsightsFeatureEnabled)
   { %>
    <tr>
        <td class="ms-crm-Form-Section ms-crm-Form-SectionBar" colspan="3" valign="bottom" nowrap>
            <BR><loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.PreviewTab.OrganizationInsightsPreview.Title" runat="server"/>
        </td>
    </tr>
    <tr>
        <td nowrap valign="center">
            <label for="rdorgInsightsPreview">
                <loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.PreviewTab.OrganizationInsightsPreview" runat="server"/>
            </label>
        </td>
        <td valign="center" colspan="2">
            <crm:Radio id="rdorgInsightsPreview" runat="server"/>
        </td>
    </tr>
    <tr>
        <td>
...
<% if (IsCortanaProactiveExperienceFeatureEnabled)
   { %>
    <tr>
        <td class="ms-crm-Form-Section ms-crm-Form-SectionBar" colspan="3" valign="bottom" nowrap>
            <BR><loc:Text ResourceId="Cortana.CRM.Feature.Title" runat="server"/>
        </td>
    </tr>
    <tr>
        <td valign="center">
            <label for="rdCortanaProactiveExperiencePreview">
                <loc:Text ResourceId="Cortana.CRM.Feature.Description" runat="server"/>
            </label>
        </td>
        <td valign="center" colspan="2">
            <crm:Radio id="rdCortanaProactiveExperiencePreview" runat="server"/>
        </td>
    </tr>
    <tr>
        <td>
...
<% if (IsDelveActionHubIntegrationFeatureEnabled)
   { %>
    <tr>
        <td class="ms-crm-Form-Section ms-crm-Form-SectionBar" colspan="3" valign="bottom" nowrap>
            <BR><loc:Text ResourceId="DelveAction.CRM.Feature.Title" runat="server"/>
        </td>
    </tr>
    <tr>
        <td valign="center">
            <label for="rdDelveActionHubPreview">
                <loc:Text ResourceId="DelveAction.CRM.Feature.Description" runat="server"/>
            </label>
        </td>
        <td valign="center" colspan="2">
            <crm:Radio id="rdDelveActionHubPreview" runat="server"/>
        </td>
    </tr>
    <tr>
        <td>
...
<% if (IsRelationshipIntelligenceEnabled)
   { %>
    <tr>
        <td class="ms-crm-Form-Section ms-crm-Form-SectionBar" colspan="3" valign="bottom" nowrap>
            <BR><loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.PreviewTab.RelationshipIntelligence.Title" runat="server"/>
        </td>
    </tr>
    <% if (IsAutoCaptureEnabled)
       { %>
        <tr>
            <td nowrap valign="center">
                <label for="rdAutoDataCapture"><%= AutoDataCapturePreviewText %></label>
            </td>
            <td valign="center" colspan="2">
    ...
    <% if (IsRelationshipAssistantEnabled)
       { %>
        <tr>
            <td nowrap valign="center">
                <label for="rdRelationshipAssistantPreview"><%= RelationshipAssistantPreviewText %></label>
            </td>
            <td valign="center" colspan="2">
                <crm:Radio id="rdRelationshipAssistantPreview" runat="server" onChange="checkRelationshipIntelligenceDependencies();"/>
            </td>
        </tr>
    <% } %>
    <% if (IsEmailEngagementEnabled)
       { %>
        <tr>
            <td nowrap valign="center">
                <label for="rdEmailEngagementPreview"><%= EmailEngagementPreviewText %></label>
            </td>
            <td valign="center" colspan="2">
                <crm:Radio id="rdEmailEngagementPreview" runat="server" onChange="checkRelationshipIntelligenceDependencies();"/>
            </td>
        </tr>
    ...
    <% if (IsRelationshipAnalyticsEnabled && IsRelationshipAnalyticsSolutionInstalled)
       { %>
        <tr>
            <td nowrap valign="center">
                <label for="rdRelationshipAnalyticsPreview"><%= RelationshipAnalyticsPreviewText %></label>
            </td>
            <td valign="center" colspan="2">
                <crm:Radio id="rdRelationshipAnalyticsPreview" runat="server"/>
            </td>
        </tr>
    <% } %>
    <%
