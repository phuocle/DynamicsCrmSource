<!DOCTYPE html >
<%@ Page Language="c#" Inherits="Microsoft.Crm.Web.Tools.SystemSettings.ConfirmEnableExternalSearchDialog" CodeBehind="Microsoft.Crm.Application.Pages.dll" %>
...
<head>
    ...
    <style type="text/css">
        .ms-crm-RefreshDialog-Header { height: 60px !important; }

        .ms-crm-RefreshDialog-Main { top: 55px; }
    </style>
