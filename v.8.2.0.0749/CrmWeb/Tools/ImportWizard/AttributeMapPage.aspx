...
<style type="text/css">
    ...
    tr.mscrm-iw-ContainerTable-Row td { height: auto; }
            ...
            <tr class="mscrm-iw-AMP-PopupHeader">
                ...
                <td>
                    <span class="mscrm-iw-AMP-CrossImage">
                        <a id="closeCreateDivLink" onclick="Mscrm.AttributeMapPage.createNewOnCancel();">
    ...
    <div class="mscrm-iw-PopupDivInner">
        <table width="100%" cellpadding="0" cellspacing="0">
            <tr class="mscrm-iw-AMP-PopupHeader">
                ...
                <td>
                    <span class="mscrm-iw-AMP-CrossImage">
                        <a tabindex="0" id="closeLookupDivLink" onclick="Mscrm.AttributeMapPage.processLookupMappingOnCancel();">
                            <img src="/_imgs/importwizard_cross.gif"/>
                        </a>
                    </span>
                </td>
    ...
    <div class="mscrm-iw-PopupDivInner">
        <table width="100%" cellpadding="0" cellspacing="0">
            <tr class="mscrm-iw-AMP-PopupHeader">
                ...
                <td>
                    <span class="mscrm-iw-AMP-CrossImage">
                        <a id="closePicklistDivLink" onclick="Mscrm.AttributeMapPage.processPicklistMappingOnCancel();">
                            <img src="/_imgs/importwizard_cross.gif"/>
                        </a>
                    </span>
                </td>
