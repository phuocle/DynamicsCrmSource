...
<page id="0">
    <title>
        <loc:Text ResourceId="Audit.RootPage.Title" runat="server"/>
    </title>
    ...
    %>
        <page id="01">
            <title>
                <loc:Text ResourceId="Audit.GlobalSettings.Title" runat="server"/>
            </title>
            <subtitle>
                <loc:Text ResourceId="Audit.GlobalSettings.Subtitle" runat="server"/>
            </subtitle>
            <icon>/_imgs/tools/ico_systemSettings.gif</icon>
            <help>
                <loc:Text ResourceId="Audit.GlobalSettings.Help" runat="server"/>
            </help>
    ...
    %>
        <page id="02">
            ...
            <subtitle>
                <loc:Text ResourceId="Audit.EntitySettings.Subtitle" runat="server"/>
            </subtitle>
            ...
            <help>
                <loc:Text ResourceId="Audit.EntitySettings.Help" runat="server"/>
            </help>
        </page>
    <%
        }
    ...
    %>
        <page id="03">
            ...
            <showstagetitle>1</showstagetitle>
            <subtitle>
                <loc:Text ResourceId="Audit.SummaryView.Subtitle" runat="server"/>
            </subtitle>
            <icon>/_imgs/AuditingSummaryView_48.png</icon>
            <help>
                <loc:Text ResourceId="Audit.SummaryView.Help" runat="server"/>
            </help>
    ...
    %>
        <page id="04">
            <title>
                <loc:Text ResourceId="Audit.LogManagement.Title" runat="server"/>
            </title>
            <showstagetitle>1</showstagetitle>
            <subtitle>
                <loc:Text ResourceId="Audit.LogManagement.Subtitle" runat="server"/>
            </subtitle>
            <icon>/_imgs/AuditLogManagement_48.png</icon>
            <help>
                <loc:Text ResourceId="Audit.LogManagement.Help" runat="server"/>
            </help>
    ...
    %>
        <subtitle>
            <loc:Text ResourceId="Audit.AuditTab.NoLinksVisible" runat="server"/>
        </subtitle>
    <%
        }
        else
    ...
    %>
        <subtitle>
            <loc:Text ResourceId="Audit.RootPage.Subtitle" runat="server"/>
        </subtitle>
    <%
        }
    %>
