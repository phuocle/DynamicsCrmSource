...
<head>
    ...
    <script language="JavaScript">
        ...
        function toggleCmdOk() {
            ...
            if (!IsNull(txtName.get_dataValue()) <% if (_ObjType == Util.UoMSchedule)
                                                    { %> &&
                !IsNull(txtBaseName.get_dataValue()) <% }
                                                    else
                                                    { %> &&
                ((amountTypeValue == 0) ||
                (amountTypeValue == 1 &&
                    !IsNull(Mscrm.FormControlInputBehavior.GetBehavior("transactioncurrencyid")
                        .get_dataValue())))<% } %>) {
        ...
        function applychanges() {
            ...
            %>
            s += "&_basename=" +
                CrmEncodeDecode.CrmUrlEncode(txtBaseName.get_dataValue()) +
                <%= Microsoft.Crm.CrmEncodeDecode.CrmJavaScriptEncode(CurrentWrpcContext.GetWrpcTokenAsQueryString(Microsoft.Crm.Application.Utility.CrmUri.Create("/userdefined/edit.aspx", Microsoft.Crm.Application.Security.UserInformation.Current))) %>;
            <%
                                                            break;
            ...
            %>
            var amountTypeValue = Mscrm.FormControlInputBehavior.GetBehavior("isamounttype").get_dataValue();
            var transactionCurrencyValue = Mscrm.FormControlInputBehavior.GetBehavior("transactioncurrencyid")
                .get_dataValue();
...
<frm:DialogForm id="crmForm" runat="server">
    ...
    <table cellspacing="0" cellpadding="3" width="100%">
        ...
        %>
            <tr>
                <td class="ms-crm-Field-Required" id="basename_c">
                    <label for="txtBaseName">
            ...
            <tr id="trCurrency">
                <td class="ms-crm-Field-Required" id="transactioncurrencyid_c">
