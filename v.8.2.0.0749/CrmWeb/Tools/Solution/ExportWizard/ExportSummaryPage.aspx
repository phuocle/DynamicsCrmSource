...
<head>
    ...
    <script language="javascript" type="text/javascript">
        ...
        function ExportSolution() {
            ...
            WizardSetDialogReturnValue(new
                ReturnExportResult(true,
                    WizardGetProperty("exportAsProtected"),
                    WizardGetProperty("optionsXml"),
                    WizardGetProperty("targetVersion"),
                    fileContent,
    ...
    <style>
        TH.ms-crm-Dialog-HeaderColumn { border-width: 1px 0px 2px 1px; }

        DIV.ms-crm-Dialog-TableMembers { height: 80%; }
    </style>
</head>
<body>
