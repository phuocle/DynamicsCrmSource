...
<head>
    ...
    <style type="text/css">
        ...
        .runButton { width: 70px; }

        .normalButton { width: 130px; }
    </style>
    <script language=javascript>
        ...
        var ORG_UNIQUE_NAME =
            '<%= Microsoft.Crm.Application.Utility.Util.RetrieveOrganizationName(UserInformation.Current) %>';
...
<script language=javascript>
    Sys.UI.DomEvent.addHandler(window,
        "load",
        function() {
