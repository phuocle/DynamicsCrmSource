            ...
            <ol class="list">
                <li class="item-auth">
                    <div id="stepAuthorize" class="list-item">
                        <p>
                            <span>
                                <a href="#" class="authorizeLink" onpremise="<%= IsOrgOnPremise %>">
                                    <% if (!IsOrgOnPremise)
                                       { %>
                        ...
                        <div class="textBlock authPara indent overlay-holder" tabindex="0">
                            ...
                            <p>
                                ...
                                <span class="networkName">
                                    <%= Microsoft.Crm.CrmEncodeDecode.CrmHtmlEncode(Config.YammerNetworkName) %>
                                </span>
                            </p>
                        </div>
                    </div>
                    ...
                    <div id="stepSelectGroup" class="list-item">
                        ...
                        <div class="indent textBlock groupPara">
                            <p>
                                ...
                                <input class="groupSelect" id="yammerGroupSelect" type="text"
                                       value="<%= Microsoft.Crm.CrmEncodeDecode.CrmHtmlAttributeEncode(SelectedGroup) %>">
                            </p>
                        </div>
                    </div>
                </li>
                    ...
                    <div id="stepSetSecurity" class="list-item">
                        ...
                        <div class="indent">
                            ...
                            <div class="radioLabel spacer" tabindex="0">
                                <input id="radioSecurityPublic" class="securitySelect" name="securitySelect" type="radio" value="0" <%= HasValidConfig && Config.YammerPostMethod == YammerPostMethod.Public ? "checked='checked'" : "" %>/>
                            ...
                            <div class="radioLabel" tabindex="0">
                                <input id="radioSecurityPrivate" class="securitySelect" name="securitySelect" type="radio" value="1" <%= HasValidConfig && Config.YammerPostMethod == YammerPostMethod.Private ? "checked='checked'" : "" %>/>
        ...
        <div class='footer <%= HasValidConfig ? "" : "hide" %>'>
            ...
            <div class="textBlock congratsFirstPara">
                <p>
                    ...
                    <span tabindex="0">
                        <loc:text resourceid="Web.Tools.Yammer.Config.SelectMessages" runat="server"/>
                    </span>
