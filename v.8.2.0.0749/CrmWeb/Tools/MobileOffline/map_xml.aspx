...
%>
    <page id="0">
        <title>
            <loc:Text ResourceId="Homepage_MobileOffline" runat="server"/>
        </title>
        <showstagetitle>1</showstagetitle>
        <subtitle>
            <loc:Text ResourceId="MobileOffline_SubArea_Description" runat="server"/>
        </subtitle>
        ...
        %>
            <page id="01">
                <title>
                    <loc:Text ResourceId="MO_MobileOfflineProfile_Link_Title" runat="server"/>
                </title>
                <showstagetitle>1</showstagetitle>
                ...
                <url>
                    <app:FlatHomepageUrlControl EntityLogicalName="mobileofflineprofile" XmlEncode="true" runat="server"/>
                </url>
                <help>
                    <loc:Text ResourceId="MO_MobileOfflineProfile_Link_Description" runat="server"/>
                </help>
            </page>
        <%
            }
        ...
        %>
            <page id="02">
                <title>
                    <loc:Text ResourceId="MobileOfflineProfile.SettingsPage.MobileOfflineSettings.Title" runat="server"/>
                </title>
                <icon>/_imgs/MobileOfflineConfigurationSetting_48.png</icon>
                <help>
                    <loc:Text ResourceId="MobileOfflineProfile.SettingsPage.MobileOfflineSettings.Title.Help" runat="server"/>
                </help>
