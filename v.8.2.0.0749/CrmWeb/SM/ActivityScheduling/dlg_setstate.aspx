...
<script type="text/javascript" language="JavaScript">
            ...
            if (oResult.Success) {
                if (oResult.ReturnValue.OperationSuccess) {
                    ...
                    var oUrl = Mscrm.CrmUri
                        .create("/SM/ActivityScheduling/SchedulingNotificationsDialog.aspx?AllowSchedule=true");
    ...
    function StatusToState(status) {
        ...
        XUI.Html.DomUtils.ForEachChild(statusCode,
            function(optionGroup) {


                XUI.Html.DomUtils.ForEachChild(optionGroup,
                    function(option) {
...
<table cellpadding="0" cellspacing="0" width="100%" style="table-layout: fixed; margin-top: 5px;">
    <col width="80"><col>
    <tr>
        <td class="dlg_setstate_td_LblStatus">
            <label for="statusCode">
                <loc:Text ResourceId="Dialog_Label_Status" runat="server"/>
            </label>
        </td>
        <td>
