...
<body>
<div id="RenderStartTimeControl" style="display: none;">
    <ui:DateTimeUI id="startTC" AllowBlankDate="False" runat="server"/><label class="ms-crm-Hidden" for="startTC">
        <loc:Text ResourceId="Timesheetdata.start.time" runat="server"/>
    </label>
</div>
<div id="RenderEndTimeControl" style="display: none;">
    <ui:DateTimeUI id="endTC" AllowBlankDate="False" runat="server"/><label class="ms-crm-Hidden" for="endTC">
        <loc:Text ResourceId="Timesheetdata.end.time" runat="server"/>
    </label>
</div>
