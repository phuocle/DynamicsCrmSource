    ...
    <script language="javascript">
        ...
        function setupDefaultTimes() {
            ...
            if ($get("calendarruleid").value != "") {
                oLookupItem = new LookupControlItem(XUI.Xml.GetText(oRet.serviceId),
                    Service,
                    XUI.Xml.GetText(oRet.serviceName));
                aoItems = new Array();
            ...
            <table width="100%">
                <tr height="24">
                    <td class="ms-crm-Form-Section ms-crm-Form-SectionBar" colspan="2" valign="bottom">
                        <loc:Text ResourceId="Web.SM.WorkPlans.Dialogs.serviceavailability.aspx__118" runat="server"/>
                    </td>
                </tr>
                <tr height="28">
                    <td colspan="2" nowrap valign="center">
                        <table width="100%">
                            <tr>
                                <td width="15%">
                                    <label for="serviceid">
                                        <loc:Text ResourceId="Web.SM.WorkPlans.Dialogs.serviceavailability.aspx__124" runat="server"/>
                                    </label>
                                </td>
                ...
                <tr height="24">
                    <td class="ms-crm-Form-Section ms-crm-Form-SectionBar" colspan="2" valign="bottom">
                        <loc:Text ResourceId="Web.SM.WorkPlans.Dialogs.serviceavailability.aspx__131" runat="server"/>
                    </td>
                </tr>
                <tr>
                    <td colspan="2" nowrap valign="center">
                        <div id="ondaydiv" style="display: <%= Microsoft.Crm.CrmEncodeDecode.CrmHtmlAttributeEncode(OnDayDisplay) %>">
                            <table width="100%">
                                <tr>
                                    <td width="15%">
                                        <label for="onday">
                                            <loc:Text ResourceId="Web.SM.WorkPlans.Dialogs.serviceavailability.aspx__138" runat="server"/>
                                        </label>
                                    </td>
                                    <td width="20%">
                                        <ui:Select id="onday" runat="server" tabindex="0"/>
                                    </td>
                                    <td width="65%"></td>
                                </tr>
                            </table>
                            ...
                            <tr>
                                <td width="30%">
                                    <label for="scheduledstart">
                                        <loc:Text ResourceId="Web.SM.WorkPlans.Dialogs.serviceavailability.aspx__150" runat="server"/>
                                    </label>
                                </td>
                                <td width="70%">
                                    <ui:DateTimeUI id="scheduledstart" tabindex="0" runat="server" AllowBlankDate="False"/>
                                </td>
                            </tr>
                        </table>
                    </td>
                    <td width="50%" nowrap valign="center">
                        <div id="allday0" style="display: none">
                            <label for="isalldayevent">
                                <loc:Text ResourceId="Web.SM.WorkPlans.Dialogs.serviceavailability.aspx__157" runat="server"/>
                            </label>
                            ...
                            <tr>
                                <td width="30%">
                                    <label for="scheduledend">
                                        <loc:Text ResourceId="Web.SM.WorkPlans.Dialogs.serviceavailability.aspx__167" runat="server"/>
                                    </label>
                                </td>
                                <td width="70%">
                                    <ui:DateTimeUI id="scheduledend" tabindex="0" runat="server" AllowBlankDate="False"/>
                                </td>
                            </tr>
                        </table>
                    </td>
                                ...
                                <tr>
                                    <td width="30%">
                                        <label for="scheduleddurationminutes">
                                            <loc:Text ResourceId="Web.SM.WorkPlans.Dialogs.serviceavailability.aspx__175" runat="server"/>
                                        </label>
                                    </td>
                                    <td width="70%">
                                        <ui:Duration id="scheduleddurationminutes" tabindex="0" runat="server"/>
                                    </td>
                                </tr>
                            </table>
                        </div>
