...
<script language="JavaScript">
    ...
    function GetProductList() {
        ...
        if ($get('butBegin').disabled == false) {
            $get('butBegin').disabled = IsNull(_lookupModelVersion1.get_dataValue() ||
                _lookupModelVersion2.get_dataValue() ||
                _lookupModelVersion3.get_dataValue());
        }
    }
    ...
    function RetrieveVersionDetails(versionId, catalogLabel, rankLabel) {
        ...
        Xrm.Internal.messages.retrieve(Mscrm.InternalUtilities.EntityNames.RecommendationModelVersion,
            versionId,
            columns).then(function(retrieveResponse) {
    ...
    function applychanges() {
        ...
        if (versionId1 != emptyGuid &&
            (prvProductIds != productIds || prvVersionId1 != versionId1 || prvNumberOfResults != numberOfResults)) {
        ...
        if (versionId2 != emptyGuid &&
            (prvProductIds != productIds || prvVersionId2 != versionId2 || prvNumberOfResults != numberOfResults)) {
        ...
        if (versionId3 != emptyGuid &&
            (prvProductIds != productIds || prvVersionId3 != versionId3 || prvNumberOfResults != numberOfResults)) {
