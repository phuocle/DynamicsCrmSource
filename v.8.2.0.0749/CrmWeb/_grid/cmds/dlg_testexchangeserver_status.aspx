...
<head>
    ...
    <script type="text/javascript" language="JavaScript">
        ...
        function showHideRequestResonseLog() {
            document.getElementById('requestResponseLogid').value = CrmEncodeDecode
                .CrmHtmlDecode(XUI.Html.GetText(document.getElementById('requestResponseLogid')));
            if (document.getElementById('requestResponseTextHolder').style.display == 'inline') {
                ...
                document.getElementById('expandCollapseIcon')
                    .className = "ms-crm-TestExchangeServerProfile-img-collapse";
            }
        }
        ...
        <div style="float: left; width: 80%">
            <table cellpadding="0" cellspacing="0" class="ms-crm-TestExchangeServerProfile-bodytable">
                <tr>
                    <td class="ms-crm-TestExchangeServerProfile-title" tabindex="0">
                        <b>
                            <span id="dialogOptionHeadingSpan">
                                <loc:Text ID="dialogOptionHeading" runat="server" tabindex="0"/>
                            </span>
                        </b>
                    </td>
                </tr>
            ...
            <table id="sitesValidationStatus" runat="server" width="50%" cellpadding="0" cellspacing="0">
                ...
                <tr>
                    ...
                    <td class="mscrm-text-regular">
                        <label id="totalValidationSteps" tabindex="0"></label>
                    </td>
                </tr>
                <tr>
                    <td class="mscrm-text-semiBold" tabindex="0">
                        <loc:Text ID="statusText" runat="server"/>
                    </td>
                    <td class="mscrm-text-regular">
                        <label id="validationStatusMessage" tabindex="0">
                            <loc:Text ID="statusProgress" runat="server"/>
                        </label>
                    </td>
                </tr>
                <tr style="display: none" id="elapsedTimeRow">
                    ...
                    <td class="mscrm-text-regular">
                        <label id="elapsedTimeText" tabindex="0"></label>
                    </td>
                </tr>
            </table>
        </div>
    ...
    <table class="ms-crm-TestExchangeServerProfile-Footer" id="validationFooter" cellpadding="0" cellspacing="0">
        <tr height="25">
            ...
            <td class="ms-crm-TestExchangeServerProfile-close-buttonTd">
                <span class='ms-crm-RefreshDialog-Button ms-crm-TestExchangeServerProfile-Hidebutton-hover'>
                    <a href="#" target="_self" id="hideDialog" onclick="cancel()">
                        <loc:Text resourceid="EmailConnector.TestExchangeServerProfile.CloseButton" runat="server"/>
                    </a>
                </span>
            </td>
        </tr>
