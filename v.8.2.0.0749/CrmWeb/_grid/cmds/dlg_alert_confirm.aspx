...
<script id="alertDialog" type="text/html">
    <div id="dvImg" class="ms-crm-Alert-Img">
        <img src="/_imgs/error/warning_52.gif"/ title="<loc:Text Encoding='HtmlAttribute' ResourceId='SysCustomization.SysSettingsDlg.EmailTab.AlertsSection.Severity.Warning' runat='server'/>" alt="<loc:Text Encoding='HtmlAttribute' ResourceId='SysCustomization.SysSettingsDlg.EmailTab.AlertsSection.Severity.Warning' runat='server'/>"/>
    </div>
    ...
    <div id="dvFooter" class="ms-crm-RefreshDialog-Footer">
        <button id="{{html Mscrm.InlineDialogUtility.okButton}}" class="ms-crm-RefreshDialog-Button ms-crm-Cancel-Button" type="button" title="${CrmEncodeDecode.CrmHtmlAttributeEncode(confirmButtonLabel)}">
...
<script id="confirmDialog" type="text/html">
    ...
    <div class="ms-crm-RefreshDialog-Main ms-crm-RefreshDialog-Main-Top" id="DlgHdBodyContainer">
    ...
    <div id="dvFooter" class="ms-crm-RefreshDialog-Footer">
        <button id="{{html Mscrm.InlineDialogUtility.okButton}}" class="ms-crm-RefreshDialog-Button ms-crm-Confirm-Button" type="button" title="${CrmEncodeDecode.CrmHtmlAttributeEncode(confirmButtonLabel)}">
            <div class="ms-crm-Button-Text">
                ${CrmEncodeDecode.CrmHtmlEncode(confirmButtonLabel)}
            </div>
        </button>
