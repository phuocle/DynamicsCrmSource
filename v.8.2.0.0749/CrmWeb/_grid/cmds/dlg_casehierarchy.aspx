...
<head>
    ...
    <script type="text/javascript">
        ...
        var _sEntintyMapId = XUI.Xml.GetText(XUI.Xml
            .SelectSingleNode(dialogArguments.valuesXml, "//@EntityMapId", null));
        var _sAttributeMapIds = getAttributeValuesFromDoc(dialogArguments,
            "select/option[@AttributeMapId!='']",
            "AttributeMapId");
        var _sSystemRequiredAttributes =
            getAttributeValuesFromDoc(dialogArguments, "select/option[@IsSystemRequired='true']", "value");
        var _sBusinessRequiredAttributes =
            getAttributeValuesFromDoc(dialogArguments, "select/option[@IsBusinessRequired='true']", "value");

        dialogArguments["sSelectedValues"] =
            getAttributeValuesFromDoc(dialogArguments, "select/option[@IsSelected='true']", "value").join(';');
    ...
    <table border="0">
        ...
        <tr>
            ...
            <td align="right" style="width: 1%">
                <crm:CheckBox id="checkBoxCaseCascade" onclick="onCaseCascadeClick();" runat="server"/>
            </td>
            <td>
        ...
        <tr>
            ...
            <td>
                <table border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        <td align="left">
                            <input type="radio" class="radio" name="radioCases" id="rdChildCases" runat="server"/>
                        </td>
                        <td align="left">
                            <label for="rdChildCases" style="vertical-align: text-top">
                                <loc:Text ResourceId="Web._grid.cmds.dlg_casehierarchy.aspx_4" runat="server"/>
                            </label>
                        </td>
                    </tr>
                    <tr>
                        <td align="left">
                            <input type="radio" class="radio" name="radioCases" id="rdRestrict" runat="server"/>
                        </td>
                        <td align="left">
                            <label for="rdRestrict" style="vertical-align: text-top">
                                <loc:Text ResourceId="Web._grid.cmds.dlg_casehierarchy.aspx_5" runat="server"/>
                            </label>
                        </td>
                    </tr>
                </table>
