...
<loc:Text ResourceId="Web._grid.cmds.dlg_addtolist.aspx_55" runat="server">
    <loc:Argument runat="server"><% = Microsoft.Crm.CrmEncodeDecode.CrmHtmlEncode(ObjName) %></loc:Argument><loc:Argument runat="server"><% = Microsoft.Crm.CrmEncodeDecode.CrmHtmlEncode(listName) %></loc:Argument>
</loc:Text>