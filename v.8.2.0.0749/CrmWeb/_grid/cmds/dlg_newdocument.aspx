...
<head>
    ...
    <style type="text/css">
        .ms-crm-RefreshDialog-Main { top: 74px !important; }
    ...
    <script type="text/javascript" language="javascript">
        ...
        function validateAndShowError() {
            hideErrors();
            if (Mscrm.Utilities.isNullOrEmptyGuid($get("documentLocations").value) &&
                isNullOrEmptyString($get("documentNameText").value)) {
    ...
    <table id="documentProperties" style="width: 100%">
        ...
        <tr>
            <td class="mscrm-docmgmt-LeftColumn">
                <label for="documentLocations" class="ms-crm-dlglabel" title="<loc:Text Encoding='HtmlAttribute' ResourceId='Odb_DlgSettings_Label_Text' runat='server'/>">
