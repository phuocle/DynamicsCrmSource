...
<head>
    <title>
        <loc:Text ResourceId="Web._grid.cmds.dlg_delete_contact.aspx_26" runat="server"/>
    </title>
    ...
    <script language="JavaScript">
        ...
        function button_delete() {
            ...
            var crmDialog = new Mscrm.CrmDialog(Mscrm.CrmUri
                .create("/_grid/cmds/dlg_confirm_delete.aspx?ObjectTypeId=" +
...
<frm:DialogForm id="crmForm" runat="server">
    ...
    <loc:Text ResourceId="Web._grid.cmds.dlg_delete_contact.aspx_54" runat="server">
