...
<head>
    ...
    <script language="JavaScript">
        ...
        function getCustParamsForItem(i) {
            ...
            var sCustParamsForItem = "&recommendationVersionName=" +
    ...
    <style type="text/css">
        ...
        .ms-crm-RefreshDialog-Main { margin-top: 42px; }
            ...
            <td colspan="2">
                <div id="error_name" style="display: none;" tabindex="0">
                    <table>
                        <tr>
                            <td>
                                <img style="margin-right: 10px" src="/_imgs/tools/Notification_Error_16.png" alt="<loc:Text Encoding='HtmlAttribute' ResourceId='buildModel_Dlg_Error_Msg_Name' runat='server'/>"/>
                            </td>
                            <td>
