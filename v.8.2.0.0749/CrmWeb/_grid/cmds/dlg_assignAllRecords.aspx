...
<head>
    ...
    <style type="text/css">
        ...
        div.ms-crm-RefreshDialog-Main { top: 95px !important; }

        div.ms-crm-RefreshDialog-Header { height: 85px !important; }
    </style>
    ...
    <script language="JavaScript">
        ...
        function getCustParamsForItem(index) {
            ...
            return "&newBUId=" +
                CrmEncodeDecode.CrmUrlEncode(_crmBULookup.get_dataValue()[0].id) +
                "&oldBUId=" +
                CrmEncodeDecode.CrmUrlEncode(url.get_query()["oldBUId"]);
        }
...
<frm:DialogForm id="crmForm" runat="server">
        ...
        <tr>
            ...
            <td valign="top">
                <label for="rdoMe" hidefocus="true">
                    <b>
                        <loc:Text ResourceId="Web._grid.cmds.dlg_assignallrecords.aspx_104" runat="server"/>
                    </b>
                    <br>
                    <div class="Desc">
                        <loc:Text ResourceId="Web._grid.cmds.dlg_assignallrecords.aspx_106" runat="server"/>
                    </div>
                </label>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td valign="top">
                <label for="rdoOther" hidefocus="true">
                    <b>
                        <loc:Text ResourceId="Web._grid.cmds.dlg_assignallrecords.aspx_115" runat="server"/>
                    </b>
                    <br>
                    <div class="Desc" style="padding-bottom: 10px;">
                        <label for="crmOwnerLookup">
                            <loc:Text ResourceId="Web._grid.cmds.dlg_assignallrecords.aspx_117" runat="server"/>
                        </label>
                    </div>
    ...
    <table id="tableBusinessUnit" runat="server">
        ...
        <tr>
            <td>
                <loc:Text ResourceId="Dialog_BUReassignRecords_BodyMessage" runat="server"/>
            </td>
        </tr>
    </table>
</frm:DialogForm>
