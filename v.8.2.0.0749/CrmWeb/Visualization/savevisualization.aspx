    ...
    <script language="Javascript">
        ...
        function PageLoad() {
            ...
            if (!IsNull(oArgs) && !IsNull(oArgs.rc) && !IsNull(oArgs.visInfo)) {
                ...
                visualizationName.defaultValue = Mscrm.FormControlInputBehavior.GetBehavior("visualizationName")
                    .get_dataValue();
                Mscrm.FormControlInputBehavior.GetBehavior("visualizationDescription")
                    .set_dataValue(CrmEncodeDecode.CrmXmlDecode(rc.GetParameter("description").Value));
                ...
                if (!Mscrm.Utilities.parseBoolean(saveAs)) {
                    duplicateNotification = notificationObj
                        .CreateNotification("duplicateName",
                            2,
                            "visualization",
                            String.format(LOCID_DUPE_OF_SUGGNAME, oldName));
        ...
        function TrySaveChart() {
            ...
            if (result.Success) {
                ...
                if (!visualizationInfo.DuplicateFound) {
                    ...
                    oldName = visName;
                    Mscrm.FormControlInputBehavior.GetBehavior("visualizationName")
                        .set_dataValue(visualizationInfo.SuggestedName);
                    ...
                    if (IsNull(duplicateNotification)) {
                        duplicateNotification = notificationObj
                            .CreateNotification("duplicateName",
                                2,
                                "visualization",
                                String.format(LOCID_DUPE_OF_USERNAME, oldName));
                    } else {
...
<frm:DialogForm id="crmForm" runat="server">
    <table cellpadding="0" cellspacing="2" width="100%" height="100%" style="table-layout: fixed">
        ...
        <tr style="height: 20px">
            ...
            <td class="ms-crm-Field-Required" valign="bottom">
                <label for="visualizationName">
        ...
        <tr style="height: 25px">
            <td style="width: 22px"></td>
            <td valign="top">
                <sdk:TextBoxControl id="visualizationName" MaxLength="100" runat="server"/>
            </td>
        ...
        <tr style="height: 20px">
            ...
            <td valign="bottom" colspan="3">
                <label for="visualizationDescription">
                    <loc:Text ResourceId="Web.Visualization.Designer.Description" runat="server"/>
                </label>
            </td>
            <td style="width: 22px"></td>
        </tr>
        <tr style="height: 70px">
            ...
            <td valign="top" style="height: 70px">
                <sdk:TextAreaControl id="visualizationDescription" MaxLength="200" runat="server"/>
            </td>
            <td style="width: 22px"></td>
        </tr>
        <tr >
