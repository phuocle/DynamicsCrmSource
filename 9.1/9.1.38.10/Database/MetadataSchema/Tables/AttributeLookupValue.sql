...
GO
ALTER TABLE [MetadataSchema].[AttributeLookupValue] SET (LOCK_ESCALATION = DISABLE);
...
GO
CREATE UNIQUE NONCLUSTERED INDEX [ndx_AttributeLookupValue_RowId]
    ON [MetadataSchema].[AttributeLookupValue]([AttributeLookupValueRowId] ASC, [AttributeLookupValueId] ASC);
