...
GO
ALTER TABLE [MetadataSchema].[ViewAttribute] SET (LOCK_ESCALATION = DISABLE);


GO
CREATE NONCLUSTERED INDEX [ndx_RemoteAttributeId]
    ON [MetadataSchema].[ViewAttribute]([RemoteAttributeId] ASC);


GO
CREATE NONCLUSTERED INDEX [ndx_RelationshipId]
    ON [MetadataSchema].[ViewAttribute]([RelationshipId] ASC);
...
GO
CREATE UNIQUE NONCLUSTERED INDEX [ndx_ViewAttribute_RowId]
    ON [MetadataSchema].[ViewAttribute]([ViewAttributeRowId] ASC, [ViewAttributeId] ASC);
