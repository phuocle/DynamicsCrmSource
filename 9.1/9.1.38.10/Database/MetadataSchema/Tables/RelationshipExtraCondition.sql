...
GO
ALTER TABLE [MetadataSchema].[RelationshipExtraCondition] SET (LOCK_ESCALATION = DISABLE);


GO
CREATE NONCLUSTERED INDEX [ndx_AttributeId]
    ON [MetadataSchema].[RelationshipExtraCondition]([AttributeId] ASC);


GO
CREATE NONCLUSTERED INDEX [ndx_RelationshipId]
    ON [MetadataSchema].[RelationshipExtraCondition]([RelationshipId] ASC);


GO
CREATE UNIQUE NONCLUSTERED INDEX [ndx_RelationshipExtraCondition_RowId]
    ON [MetadataSchema].[RelationshipExtraCondition]([RelationshipExtraConditionRowId] ASC, [ConditionId] ASC);
