CREATE TABLE [XrmTds].[sys_columns] (
    ...
    [encryption_algorithm_name]           [sysname]        DEFAULT (NULL) NULL,
    ...
    [is_masked]                           BIT              DEFAULT ((0)) NULL,
    [AttributeId]                         UNIQUEIDENTIFIER NOT NULL
);


GO
CREATE CLUSTERED INDEX [cndx_sys_columns]
    ON [XrmTds].[sys_columns]([object_id] ASC, [column_id] ASC);


GO
GRANT SELECT
    ON OBJECT::[XrmTds].[sys_columns] TO [CRMReaderRole]
    AS [dbo];
