...
GO
ALTER TABLE [dbo].[Rollup_Bootstrap_Orphans_306845ef446a42e58df811c31bafaded] SET (LOCK_ESCALATION = DISABLE);


GO
CREATE NONCLUSTERED INDEX [ndx_ParentEntityId_Source]
    ON [dbo].[Rollup_Bootstrap_Orphans_306845ef446a42e58df811c31bafaded]([ParentEntityId] ASC, [Id] ASC)
    INCLUDE([EntityId], [Status], [ExchangeRate], [OutputValue]);


GO
CREATE NONCLUSTERED INDEX [ndx_EntityId]
    ON [dbo].[Rollup_Bootstrap_Orphans_306845ef446a42e58df811c31bafaded]([EntityId] ASC);
