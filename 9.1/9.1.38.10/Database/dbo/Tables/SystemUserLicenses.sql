CREATE TABLE [dbo].[SystemUserLicenses] (
    ...
    CONSTRAINT [UQ_SystemUserLicenses] UNIQUE NONCLUSTERED ([SystemUserId] ASC, [LicenseId] ASC) WITH (FILLFACTOR = 80)
);


GO
ALTER TABLE [dbo].[SystemUserLicenses] SET (LOCK_ESCALATION = DISABLE);
