CREATE TABLE [dbo].[RoleTemplatePrivileges] (
    ...
    CONSTRAINT [role_template_privileges] FOREIGN KEY ([RoleTemplateId]) REFERENCES [dbo].[RoleTemplateBase] ([RoleTemplateId]),
    CONSTRAINT [UQ_RoleTemplatePrivileges] UNIQUE NONCLUSTERED ([RoleTemplateId] ASC, [PrivilegeId] ASC) WITH (FILLFACTOR = 80)
);


GO
ALTER TABLE [dbo].[RoleTemplatePrivileges] SET (LOCK_ESCALATION = DISABLE);
