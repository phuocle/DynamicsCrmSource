CREATE TABLE [dbo].[ImportBase] (
    ...
    CONSTRAINT [BusinessUnit_Imports] FOREIGN KEY ([OwningBusinessUnit]) REFERENCES [dbo].[BusinessUnitBase] ([BusinessUnitId]),
    CONSTRAINT [owner_imports] FOREIGN KEY ([OwnerId]) REFERENCES [dbo].[OwnerBase] ([OwnerId])
);


GO
ALTER TABLE [dbo].[ImportBase] SET (LOCK_ESCALATION = DISABLE);
