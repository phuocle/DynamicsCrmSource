...
GO
ALTER TABLE [dbo].[Rollup_Bootstrap_Orphans_bacebbde18e243a7b3fb4bbdf2b2c0e5] SET (LOCK_ESCALATION = DISABLE);


GO
CREATE NONCLUSTERED INDEX [ndx_ParentEntityId_Source]
    ON [dbo].[Rollup_Bootstrap_Orphans_bacebbde18e243a7b3fb4bbdf2b2c0e5]([ParentEntityId] ASC, [Id] ASC)
    INCLUDE([EntityId], [Status], [ExchangeRate], [OutputValue]);


GO
CREATE NONCLUSTERED INDEX [ndx_EntityId]
    ON [dbo].[Rollup_Bootstrap_Orphans_bacebbde18e243a7b3fb4bbdf2b2c0e5]([EntityId] ASC);
