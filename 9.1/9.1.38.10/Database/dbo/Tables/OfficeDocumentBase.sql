...
GO
EXECUTE sp_tableoption @TableNamePattern = N'[dbo].[OfficeDocumentBase]', @OptionName = N'large value types out of row', @OptionValue = N'1';


GO
ALTER TABLE [dbo].[OfficeDocumentBase] SET (LOCK_ESCALATION = DISABLE);
