CREATE TABLE [dbo].[msdyn_wallsavedqueryBase] (
    ...
    CONSTRAINT [msdyn_postconfig_wallsavedquery] FOREIGN KEY ([msdyn_postconfigurationid]) REFERENCES [dbo].[msdyn_PostConfigBase] ([msdyn_PostConfigId])
);


GO
ALTER TABLE [dbo].[msdyn_wallsavedqueryBase] SET (LOCK_ESCALATION = DISABLE);
...
GO
CREATE NONCLUSTERED INDEX [ndx_QF_SortedScan_B1D25B67DE82410BA6E0AC901AF6F5BE]
    ON [dbo].[msdyn_wallsavedqueryBase]([msdyn_savedqueryname] ASC, [msdyn_wallsavedqueryId] ASC)
    INCLUDE([CreatedOn], [statecode], [VersionNumber]) WITH (FILLFACTOR = 100, DATA_COMPRESSION = ROW);


GO
CREATE NONCLUSTERED INDEX [ndx_QF_Scan_B1D25B67DE82410BA6E0AC901AF6F5BE]
    ON [dbo].[msdyn_wallsavedqueryBase]([msdyn_wallsavedqueryId] ASC)
...
CREATE NONCLUSTERED INDEX [ndx_QF_msdyn_savedqueryname]
    ON [dbo].[msdyn_wallsavedqueryBase]([msdyn_savedqueryname] ASC) WITH (FILLFACTOR = 100, DATA_COMPRESSION = ROW);


GO
CREATE NONCLUSTERED INDEX [ndx_QF_Seek_B1D25B67DE82410BA6E0AC901AF6F5BE]
    ON [dbo].[msdyn_wallsavedqueryBase]([msdyn_wallsavedqueryId] ASC)
