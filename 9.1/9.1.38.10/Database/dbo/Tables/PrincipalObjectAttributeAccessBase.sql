...
GO
ALTER TABLE [dbo].[PrincipalObjectAttributeAccessBase] SET (LOCK_ESCALATION = DISABLE);
...
CREATE UNIQUE NONCLUSTERED INDEX [fndx_Sync_VersionNumber]
    ON [dbo].[PrincipalObjectAttributeAccessBase]([VersionNumber] ASC) WITH (FILLFACTOR = 100);
