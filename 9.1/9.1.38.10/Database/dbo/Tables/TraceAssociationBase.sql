CREATE TABLE [dbo].[TraceAssociationBase] (
    ...
    CONSTRAINT [traceassociation_TraceLog] FOREIGN KEY ([TraceLogId]) REFERENCES [dbo].[TraceLogBase] ([TraceLogId])
);


GO
ALTER TABLE [dbo].[TraceAssociationBase] SET (LOCK_ESCALATION = DISABLE);
