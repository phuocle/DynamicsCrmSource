CREATE TABLE [dbo].[TraceRegardingBase] (
    ...
    CONSTRAINT [business_unit_TraceRegarding] FOREIGN KEY ([RegardingObjectOwningBusinessUnit]) REFERENCES [dbo].[BusinessUnitBase] ([BusinessUnitId])
);


GO
ALTER TABLE [dbo].[TraceRegardingBase] SET (LOCK_ESCALATION = DISABLE);
