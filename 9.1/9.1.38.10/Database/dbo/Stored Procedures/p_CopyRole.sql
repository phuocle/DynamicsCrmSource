...
begin;
    ...
    begin;
        ...
        select @newRoleId, RoleTemplateId, OrganizationId, Name, @rootId, getutcdate(), null, @userid, null, @currParentRoleId, @activeSolutionId, @isInherited,
