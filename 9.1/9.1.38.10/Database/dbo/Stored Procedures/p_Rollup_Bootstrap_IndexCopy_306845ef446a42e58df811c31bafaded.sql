...
IF(@copyType = 2) -- Source Copy
 ...
 SELECT TOP (@batchSize) [aggregateEntity].[OpportunityId] , [aggregateEntity].[ParentAccountId] , ROUND([aggregateEntity].[EstimatedValue]/NULLIF([aggregateEntity].[ExchangeRate],0),10) 
