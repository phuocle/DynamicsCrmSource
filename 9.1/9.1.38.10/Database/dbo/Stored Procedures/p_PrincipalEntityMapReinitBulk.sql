...
insert into #Old(ObjectTypeCode, PrincipalId) 
	...
	join PrivilegeObjectTypeCodeView potc on potc.ObjectTypeCode = pem.ObjectTypeCode
...
(  
	...
	select ObjectTypeCode, PrincipalId from #New
		...
		on deletedRows.PrincipalId = pem.PrincipalId and deletedRows.ObjectTypeCode=pem.ObjectTypeCode option (recompile)
