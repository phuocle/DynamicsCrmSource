create   procedure dbo.p_RetrieveDependenciesForDelete
(
...
begin
	...
	select 
		...
		DependencyType, 
		DependentComponentObjectId, DependentComponentType, DependentComponentParentId, DependentComponentBaseSolutionId, DependencyId
		from Dependency d
