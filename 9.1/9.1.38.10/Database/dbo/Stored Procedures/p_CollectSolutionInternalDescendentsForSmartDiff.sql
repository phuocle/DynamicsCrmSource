create   procedure dbo.p_CollectSolutionInternalDescendentsForSmartDiff
(
...
begin
	...
	begin
		...
		IF @level = 1
		    ...
		    and (DependentComponentType not in (Select componentType from EnabledComponents)) --and (DependentComponentObjectId in (Select objectid from PatchedComponents) or DependentComponentObjectId in (Select objectid from DeletedComponents))
