...
begin	
	...
	declare @Soft int = 8 -- constant representing all soft dependencies
	...
	exec sp_executesql @InsertionSql	
	...
	begin
		...
		-- find all Required or Unpublished or Soft dependencies for the given set of active components. Always include parent-child
		-- report dependencies.
		insert into #ComponentSet
			...
			where 
				(d.DependencyType = @Required or d.DependencyType = @Unpublished or d.DependencyType = @Soft)
