...
begin
	...
	declare @SoftDependency int = 8 -- SoftDependency
	...
	where (d.DependencyType = @PublishedDependency or d.DependencyType = @SoftDependency) and er.IsCustomRelationship = 0 
	and not exists
	(
