...
select
    ...
    [SiteBase].[TimeZoneRuleVersionNumber],
    [SiteBase].[UTCConversionTimeZoneCode],
    [SiteBase].[Name],
...
from [SiteBase] 
    ...
    left join [SystemUserBase] [lk_sitebase_createdby] on ([SiteBase].[CreatedBy] = [lk_sitebase_createdby].[SystemUserId])
    left join [SystemUserBase] [lk_sitebase_createdonbehalfby] on ([SiteBase].[CreatedOnBehalfBy] = [lk_sitebase_createdonbehalfby].[SystemUserId])
    left join [SystemUserBase] [lk_sitebase_modifiedby] on ([SiteBase].[ModifiedBy] = [lk_sitebase_modifiedby].[SystemUserId])
    left join [SystemUserBase] [lk_sitebase_modifiedonbehalfby] on ([SiteBase].[ModifiedOnBehalfBy] = [lk_sitebase_modifiedonbehalfby].[SystemUserId])
    left join [OrganizationBase] [organization_sites] on ([SiteBase].[OrganizationId] = [organization_sites].[OrganizationId])
