...
from [RelationshipRoleMapBase] 
    left join [SystemUserBase] [createdby_relationship_role_map]  on ([RelationshipRoleMapBase].[CreatedBy] = [createdby_relationship_role_map].[SystemUserId])
    left join [SystemUserBase] [createdonbehalfby_relationship_role_map]  on ([RelationshipRoleMapBase].[CreatedOnBehalfBy] = [createdonbehalfby_relationship_role_map].[SystemUserId])
    left join [SystemUserBase] [modifiedby_relationship_role_map]  on ([RelationshipRoleMapBase].[ModifiedBy] = [modifiedby_relationship_role_map].[SystemUserId])
    left join [SystemUserBase] [modifiedonbehalfby_relationship_role_map]  on ([RelationshipRoleMapBase].[ModifiedOnBehalfBy] = [modifiedonbehalfby_relationship_role_map].[SystemUserId])
