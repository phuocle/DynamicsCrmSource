...
from [SubjectBase] 
    ...
    left join [SystemUserBase] [lk_subjectbase_createdby]  on ([SubjectBase].[CreatedBy] = [lk_subjectbase_createdby].[SystemUserId])
    left join [SystemUserBase] [lk_subjectbase_createdonbehalfby]  on ([SubjectBase].[CreatedOnBehalfBy] = [lk_subjectbase_createdonbehalfby].[SystemUserId])
    left join [SystemUserBase] [lk_subjectbase_modifiedby]  on ([SubjectBase].[ModifiedBy] = [lk_subjectbase_modifiedby].[SystemUserId])
    left join [SystemUserBase] [lk_subjectbase_modifiedonbehalfby]  on ([SubjectBase].[ModifiedOnBehalfBy] = [lk_subjectbase_modifiedonbehalfby].[SystemUserId])
