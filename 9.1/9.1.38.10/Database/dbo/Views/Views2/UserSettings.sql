...
select
    ...
    [UserSettingsBase].[SelectedGlobalFilterId],
    [UserSettingsBase].[IsEmailConversationViewEnabled],
    [UserSettingsBase].[AutoCaptureUserStatus],
...
from [UserSettingsBase] 
    ...
    left join [SystemUserBase] [lk_usersettingsbase_createdby] on ([UserSettingsBase].[CreatedBy] = [lk_usersettingsbase_createdby].[SystemUserId])
    left join [SystemUserBase] [lk_usersettingsbase_createdonbehalfby] on ([UserSettingsBase].[CreatedOnBehalfBy] = [lk_usersettingsbase_createdonbehalfby].[SystemUserId])
    left join [SystemUserBase] [lk_usersettingsbase_modifiedby] on ([UserSettingsBase].[ModifiedBy] = [lk_usersettingsbase_modifiedby].[SystemUserId])
    left join [SystemUserBase] [lk_usersettingsbase_modifiedonbehalfby] on ([UserSettingsBase].[ModifiedOnBehalfBy] = [lk_usersettingsbase_modifiedonbehalfby].[SystemUserId])
