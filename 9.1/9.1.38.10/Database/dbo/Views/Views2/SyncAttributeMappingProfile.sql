...
from [SyncAttributeMappingProfileBase] 
    left join [SystemUserBase] [lk_syncattributemappingprofile_createdby]  on ([SyncAttributeMappingProfileBase].[CreatedBy] = [lk_syncattributemappingprofile_createdby].[SystemUserId])
    left join [SystemUserBase] [lk_syncattributemappingprofile_createdonbehalfby]  on ([SyncAttributeMappingProfileBase].[CreatedOnBehalfBy] = [lk_syncattributemappingprofile_createdonbehalfby].[SystemUserId])
    left join [SystemUserBase] [lk_syncattributemappingprofile_modifiedby]  on ([SyncAttributeMappingProfileBase].[ModifiedBy] = [lk_syncattributemappingprofile_modifiedby].[SystemUserId])
    left join [SystemUserBase] [lk_syncattributemappingprofile_modifiedonbehalfby]  on ([SyncAttributeMappingProfileBase].[ModifiedOnBehalfBy] = [lk_syncattributemappingprofile_modifiedonbehalfby].[SystemUserId])
    left join [OrganizationBase] [lk_syncattributemappingprofile_organizationid]  on ([SyncAttributeMappingProfileBase].[OrganizationId] = [lk_syncattributemappingprofile_organizationid].[OrganizationId])
