...
select
    ...
    [SharePointDocumentBase].[DocumentLocationType],
    [SharePointDocumentBase].[IsRecursiveFetch],
    [SharePointDocumentBase].[ServiceType],
    [SharePointDocumentBase].[IconClassName],
    [SharePointDocumentBase].[LocationName]
from [SharePointDocumentBase] 
    ...
    left join [SystemUserBase] [lk_sharepointdocumentbase_createdby] on ([SharePointDocumentBase].[CreatedBy] = [lk_sharepointdocumentbase_createdby].[SystemUserId])
    left join [SystemUserBase] [lk_sharepointdocumentbase_createdonbehalfby] on ([SharePointDocumentBase].[CreatedOnBehalfBy] = [lk_sharepointdocumentbase_createdonbehalfby].[SystemUserId])
    left join [SystemUserBase] [lk_sharepointdocumentbase_modifiedby] on ([SharePointDocumentBase].[ModifiedBy] = [lk_sharepointdocumentbase_modifiedby].[SystemUserId])
    left join [SystemUserBase] [lk_sharepointdocumentbase_modifiedonbehalfby] on ([SharePointDocumentBase].[ModifiedOnBehalfBy] = [lk_sharepointdocumentbase_modifiedonbehalfby].[SystemUserId])
    left join [OrganizationBase] [organization_sharepointdocument] on ([SharePointDocumentBase].[OrganizationId] = [organization_sharepointdocument].[OrganizationId])
    ...
    left join OwnerBase XXowner on ([SharePointDocumentBase].OwnerId = XXowner.OwnerId)
