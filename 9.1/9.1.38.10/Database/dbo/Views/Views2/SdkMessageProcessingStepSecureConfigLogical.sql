...
--
-- logical view for SdkMessageProcessingStepSecureConfigLogical
--
create view dbo.[SdkMessageProcessingStepSecureConfigLogical]
 (
    -- logical attributes
...
from [SdkMessageProcessingStepSecureConfigBase] [T1]
    left join [SystemUserBase] [createdby_sdkmessageprocessingstepsecureconfig]  on ([T1].[CreatedBy] = [createdby_sdkmessageprocessingstepsecureconfig].[SystemUserId])
    left join [SystemUserBase] [createdonbehalfby_sdkmessageprocessingstepsecureconfig]  on ([T1].[CreatedOnBehalfBy] = [createdonbehalfby_sdkmessageprocessingstepsecureconfig].[SystemUserId])
    left join [SystemUserBase] [modifiedby_sdkmessageprocessingstepsecureconfig]  on ([T1].[ModifiedBy] = [modifiedby_sdkmessageprocessingstepsecureconfig].[SystemUserId])
    left join [SystemUserBase] [modifiedonbehalfby_sdkmessageprocessingstepsecureconfig]  on ([T1].[ModifiedOnBehalfBy] = [modifiedonbehalfby_sdkmessageprocessingstepsecureconfig].[SystemUserId])
