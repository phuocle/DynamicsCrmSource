...
from [TimeZoneLocalizedNameBase] 
    left join [SystemUserBase] [lk_timezonelocalizedname_createdonbehalfby]  on ([TimeZoneLocalizedNameBase].[CreatedOnBehalfBy] = [lk_timezonelocalizedname_createdonbehalfby].[SystemUserId])
    left join [SystemUserBase] [lk_timezonelocalizedname_modifiedonbehalfby]  on ([TimeZoneLocalizedNameBase].[ModifiedOnBehalfBy] = [lk_timezonelocalizedname_modifiedonbehalfby].[SystemUserId])
