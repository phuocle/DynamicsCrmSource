...
from [ReportCategoryBase] [T1]
    left join [SystemUserBase] [lk_reportcategorybase_createdby] on ([T1].[CreatedBy] = [lk_reportcategorybase_createdby].[SystemUserId])
    left join [SystemUserBase] [lk_reportcategorybase_createdonbehalfby] on ([T1].[CreatedOnBehalfBy] = [lk_reportcategorybase_createdonbehalfby].[SystemUserId])
    left join [SystemUserBase] [lk_reportcategorybase_modifiedby] on ([T1].[ModifiedBy] = [lk_reportcategorybase_modifiedby].[SystemUserId])
    left join [SystemUserBase] [lk_reportcategorybase_modifiedonbehalfby] on ([T1].[ModifiedOnBehalfBy] = [lk_reportcategorybase_modifiedonbehalfby].[SystemUserId])
