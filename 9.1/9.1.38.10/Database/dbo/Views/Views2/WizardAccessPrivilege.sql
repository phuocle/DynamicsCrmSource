...
from [WizardAccessPrivilegeBase] 
    left join [SystemUserBase] [lk_wizardaccessprivilege_createdonbehalfby] on ([WizardAccessPrivilegeBase].[CreatedOnBehalfBy] = [lk_wizardaccessprivilege_createdonbehalfby].[SystemUserId])
    left join [SystemUserBase] [lk_wizardaccessprivilege_modifiedonbehalfby] on ([WizardAccessPrivilegeBase].[ModifiedOnBehalfBy] = [lk_wizardaccessprivilege_modifiedonbehalfby].[SystemUserId])
