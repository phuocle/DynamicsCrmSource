...
from [SocialInsightsConfigurationBase] 
    left join [SystemUserBase] [lk_socialinsightsconfiguration_createdby]  on ([SocialInsightsConfigurationBase].[CreatedBy] = [lk_socialinsightsconfiguration_createdby].[SystemUserId])
    left join [SystemUserBase] [lk_socialinsightsconfiguration_createdonbehalfby]  on ([SocialInsightsConfigurationBase].[CreatedOnBehalfBy] = [lk_socialinsightsconfiguration_createdonbehalfby].[SystemUserId])
    left join [SystemUserBase] [lk_socialinsightsconfiguration_modifiedby]  on ([SocialInsightsConfigurationBase].[ModifiedBy] = [lk_socialinsightsconfiguration_modifiedby].[SystemUserId])
    left join [SystemUserBase] [lk_socialinsightsconfiguration_modifiedonbehalfby]  on ([SocialInsightsConfigurationBase].[ModifiedOnBehalfBy] = [lk_socialinsightsconfiguration_modifiedonbehalfby].[SystemUserId])
    left join [OrganizationBase] [organization_socialinsightsconfiguration]  on ([SocialInsightsConfigurationBase].[OrganizationId] = [organization_socialinsightsconfiguration].[OrganizationId])
