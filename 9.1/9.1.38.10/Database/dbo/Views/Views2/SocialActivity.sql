...
from [ActivityPointerBase] 
    left join [SystemUserBase] [lk_socialactivitybase_createdonbehalfby] on ([ActivityPointerBase].[CreatedOnBehalfBy] = [lk_socialactivitybase_createdonbehalfby].[SystemUserId])
    left join [SystemUserBase] [lk_socialactivitybase_modifiedonbehalfby] on ([ActivityPointerBase].[ModifiedOnBehalfBy] = [lk_socialactivitybase_modifiedonbehalfby].[SystemUserId])
    ...
    left join [ServiceBase] [service_socialactivities] on ([ActivityPointerBase].[ServiceId] = [service_socialactivities].[ServiceId])
