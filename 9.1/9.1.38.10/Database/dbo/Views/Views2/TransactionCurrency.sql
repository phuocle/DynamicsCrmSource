...
from [TransactionCurrencyBase] 
    ...
    left join [SystemUserBase] [lk_transactioncurrencybase_createdby] on ([TransactionCurrencyBase].[CreatedBy] = [lk_transactioncurrencybase_createdby].[SystemUserId])
    left join [SystemUserBase] [lk_transactioncurrencybase_createdonbehalfby] on ([TransactionCurrencyBase].[CreatedOnBehalfBy] = [lk_transactioncurrencybase_createdonbehalfby].[SystemUserId])
    left join [SystemUserBase] [lk_transactioncurrencybase_modifiedby] on ([TransactionCurrencyBase].[ModifiedBy] = [lk_transactioncurrencybase_modifiedby].[SystemUserId])
    left join [SystemUserBase] [lk_transactioncurrencybase_modifiedonbehalfby] on ([TransactionCurrencyBase].[ModifiedOnBehalfBy] = [lk_transactioncurrencybase_modifiedonbehalfby].[SystemUserId])
