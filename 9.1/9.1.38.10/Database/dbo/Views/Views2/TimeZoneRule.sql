...
from [TimeZoneRuleBase] 
    left join [SystemUserBase] [lk_timezonerule_createdonbehalfby]  on ([TimeZoneRuleBase].[CreatedOnBehalfBy] = [lk_timezonerule_createdonbehalfby].[SystemUserId])
    left join [SystemUserBase] [lk_timezonerule_modifiedonbehalfby]  on ([TimeZoneRuleBase].[ModifiedOnBehalfBy] = [lk_timezonerule_modifiedonbehalfby].[SystemUserId])
