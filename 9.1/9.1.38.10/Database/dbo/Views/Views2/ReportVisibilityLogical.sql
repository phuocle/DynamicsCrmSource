...
from [ReportVisibilityBase] [T1]
    left join [SystemUserBase] [lk_reportvisibilitybase_createdby] on ([T1].[CreatedBy] = [lk_reportvisibilitybase_createdby].[SystemUserId])
    left join [SystemUserBase] [lk_reportvisibilitybase_createdonbehalfby] on ([T1].[CreatedOnBehalfBy] = [lk_reportvisibilitybase_createdonbehalfby].[SystemUserId])
    left join [SystemUserBase] [lk_reportvisibilitybase_modifiedby] on ([T1].[ModifiedBy] = [lk_reportvisibilitybase_modifiedby].[SystemUserId])
    left join [SystemUserBase] [lk_reportvisibilitybase_modifiedonbehalfby] on ([T1].[ModifiedOnBehalfBy] = [lk_reportvisibilitybase_modifiedonbehalfby].[SystemUserId])
