...
from [WebResourceBase] [T1]
    left join [SystemUserBase] [lk_webresourcebase_createdonbehalfby] on ([T1].[CreatedOnBehalfBy] = [lk_webresourcebase_createdonbehalfby].[SystemUserId])
    left join [SystemUserBase] [lk_webresourcebase_modifiedonbehalfby] on ([T1].[ModifiedOnBehalfBy] = [lk_webresourcebase_modifiedonbehalfby].[SystemUserId])
    left join [OrganizationBase] [webresource_organization] on ([T1].[OrganizationId] = [webresource_organization].[OrganizationId])
