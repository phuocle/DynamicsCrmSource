...
--
-- logical view for ReportLogical
--
create view dbo.[ReportLogical]
 (
    -- logical attributes
...
select
    ...
    [T1].[CreatedInMajorVersion],
    [T1].[RdlHash]
from [ReportBase] [T1]
    left join [SystemUserBase] [lk_reportbase_createdby] on ([T1].[CreatedBy] = [lk_reportbase_createdby].[SystemUserId])
    left join [SystemUserBase] [lk_reportbase_createdonbehalfby] on ([T1].[CreatedOnBehalfBy] = [lk_reportbase_createdonbehalfby].[SystemUserId])
    left join [SystemUserBase] [lk_reportbase_modifiedby] on ([T1].[ModifiedBy] = [lk_reportbase_modifiedby].[SystemUserId])
    left join [SystemUserBase] [lk_reportbase_modifiedonbehalfby] on ([T1].[ModifiedOnBehalfBy] = [lk_reportbase_modifiedonbehalfby].[SystemUserId])
