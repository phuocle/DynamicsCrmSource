...
select
    ...
    [T1].[slaversion]
from [SLABase] [T1]
    left join [SystemUserBase] [lk_slabase_createdby] on ([T1].[CreatedBy] = [lk_slabase_createdby].[SystemUserId])
    left join [SystemUserBase] [lk_slabase_createdonbehalfby] on ([T1].[CreatedOnBehalfBy] = [lk_slabase_createdonbehalfby].[SystemUserId])
    left join [SystemUserBase] [lk_slabase_modifiedby] on ([T1].[ModifiedBy] = [lk_slabase_modifiedby].[SystemUserId])
    left join [SystemUserBase] [lk_slabase_modifiedonbehalfby] on ([T1].[ModifiedOnBehalfBy] = [lk_slabase_modifiedonbehalfby].[SystemUserId])
