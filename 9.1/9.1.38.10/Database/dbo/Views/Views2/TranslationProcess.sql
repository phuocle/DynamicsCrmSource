...
from [TranslationProcessBase] 
    ...
    left join [SystemUserBase] [lk_translationprocess_createdby]  on ([TranslationProcessBase].[CreatedBy] = [lk_translationprocess_createdby].[SystemUserId])
    left join [SystemUserBase] [lk_translationprocess_createdonbehalfby]  on ([TranslationProcessBase].[CreatedOnBehalfBy] = [lk_translationprocess_createdonbehalfby].[SystemUserId])
    ...
    left join [SystemUserBase] [lk_translationprocess_modifiedby]  on ([TranslationProcessBase].[ModifiedBy] = [lk_translationprocess_modifiedby].[SystemUserId])
    left join [SystemUserBase] [lk_translationprocess_modifiedonbehalfby]  on ([TranslationProcessBase].[ModifiedOnBehalfBy] = [lk_translationprocess_modifiedonbehalfby].[SystemUserId])
    ...
    left join [OrganizationBase] [organization_translationprocess]  on ([TranslationProcessBase].[OrganizationId] = [organization_translationprocess].[OrganizationId])
