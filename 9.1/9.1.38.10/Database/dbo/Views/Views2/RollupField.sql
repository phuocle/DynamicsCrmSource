...
from [RollupFieldBase] 
    left join [SystemUserBase] [lk_rollupfield_createdby]  on ([RollupFieldBase].[CreatedBy] = [lk_rollupfield_createdby].[SystemUserId])
    left join [SystemUserBase] [lk_rollupfield_createdonbehalfby]  on ([RollupFieldBase].[CreatedOnBehalfBy] = [lk_rollupfield_createdonbehalfby].[SystemUserId])
    left join [SystemUserBase] [lk_rollupfield_modifiedby]  on ([RollupFieldBase].[ModifiedBy] = [lk_rollupfield_modifiedby].[SystemUserId])
    left join [SystemUserBase] [lk_rollupfield_modifiedonbehalfby]  on ([RollupFieldBase].[ModifiedOnBehalfBy] = [lk_rollupfield_modifiedonbehalfby].[SystemUserId])
