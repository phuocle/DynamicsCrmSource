...
from [ActivityPointerBase] 
    left join [SystemUserBase] [lk_untrackedemail_createdby]  on ([ActivityPointerBase].[CreatedBy] = [lk_untrackedemail_createdby].[SystemUserId])
    left join [SystemUserBase] [lk_untrackedemail_createdonbehalfby]  on ([ActivityPointerBase].[CreatedOnBehalfBy] = [lk_untrackedemail_createdonbehalfby].[SystemUserId])
    left join [SystemUserBase] [lk_untrackedemail_modifiedby]  on ([ActivityPointerBase].[ModifiedBy] = [lk_untrackedemail_modifiedby].[SystemUserId])
    left join [SystemUserBase] [lk_untrackedemail_modifiedonbehalfby]  on ([ActivityPointerBase].[ModifiedOnBehalfBy] = [lk_untrackedemail_modifiedonbehalfby].[SystemUserId])
