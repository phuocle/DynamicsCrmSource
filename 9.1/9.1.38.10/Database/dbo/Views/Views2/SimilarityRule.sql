...
--
-- base view for SimilarityRule
--
create view dbo.[SimilarityRule]
 (
    -- logical attributes
...
from [SimilarityRuleBase] [T1]
    left join [SystemUserBase] [lk_similarityrule_createdonbehalfby] on ([T1].[CreatedOnBehalfBy] = [lk_similarityrule_createdonbehalfby].[SystemUserId])
    left join [SystemUserBase] [lk_similarityrule_modifiedonbehalfby] on ([T1].[ModifiedOnBehalfBy] = [lk_similarityrule_modifiedonbehalfby].[SystemUserId])
    left join [OrganizationBase] [organization_similarityrule] on ([T1].[OrganizationId] = [organization_similarityrule].[OrganizationId])
