...
from [SocialProfileBase] 
    left join [SystemUserBase] [lk_socialprofileBase_createdonbehalfby] on ([SocialProfileBase].[CreatedOnBehalfBy] = [lk_socialprofileBase_createdonbehalfby].[SystemUserId])
    left join [SystemUserBase] [lk_socialprofileBase_modifiedonbehalfby] on ([SocialProfileBase].[ModifiedOnBehalfBy] = [lk_socialprofileBase_modifiedonbehalfby].[SystemUserId])
    ...
    left join OwnerBase XXowner on ([SocialProfileBase].OwnerId = XXowner.OwnerId)
