...
from [ReportEntityBase] [T1]
    left join [SystemUserBase] [lk_reportentitybase_createdby] on ([T1].[CreatedBy] = [lk_reportentitybase_createdby].[SystemUserId])
    left join [SystemUserBase] [lk_reportentitybase_createdonbehalfby] on ([T1].[CreatedOnBehalfBy] = [lk_reportentitybase_createdonbehalfby].[SystemUserId])
    left join [SystemUserBase] [lk_reportentitybase_modifiedby] on ([T1].[ModifiedBy] = [lk_reportentitybase_modifiedby].[SystemUserId])
    left join [SystemUserBase] [lk_reportentitybase_modifiedonbehalfby] on ([T1].[ModifiedOnBehalfBy] = [lk_reportentitybase_modifiedonbehalfby].[SystemUserId])
