...
from [SolutionComponentBase] 
    left join [SystemUserBase] [lk_solutioncomponentbase_createdonbehalfby]  on ([SolutionComponentBase].[CreatedOnBehalfBy] = [lk_solutioncomponentbase_createdonbehalfby].[SystemUserId])
    left join [SystemUserBase] [lk_solutioncomponentbase_modifiedonbehalfby]  on ([SolutionComponentBase].[ModifiedOnBehalfBy] = [lk_solutioncomponentbase_modifiedonbehalfby].[SystemUserId])
