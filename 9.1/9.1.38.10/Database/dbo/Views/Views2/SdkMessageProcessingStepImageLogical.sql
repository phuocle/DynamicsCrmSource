...
from [SdkMessageProcessingStepImageBase] [T1]
    left join [SystemUserBase] [createdby_sdkmessageprocessingstepimage] on ([T1].[CreatedBy] = [createdby_sdkmessageprocessingstepimage].[SystemUserId])
    left join [SystemUserBase] [createdonbehalfby_sdkmessageprocessingstepimage] on ([T1].[CreatedOnBehalfBy] = [createdonbehalfby_sdkmessageprocessingstepimage].[SystemUserId])
    left join [SystemUserBase] [modifiedby_sdkmessageprocessingstepimage] on ([T1].[ModifiedBy] = [modifiedby_sdkmessageprocessingstepimage].[SystemUserId])
    left join [SystemUserBase] [modifiedonbehalfby_sdkmessageprocessingstepimage] on ([T1].[ModifiedOnBehalfBy] = [modifiedonbehalfby_sdkmessageprocessingstepimage].[SystemUserId])
