...
from [RoleBase] [T1]
    ...
    left join [SystemUserBase] [lk_rolebase_createdby] on ([T1].[CreatedBy] = [lk_rolebase_createdby].[SystemUserId])
    left join [SystemUserBase] [lk_rolebase_createdonbehalfby] on ([T1].[CreatedOnBehalfBy] = [lk_rolebase_createdonbehalfby].[SystemUserId])
    left join [SystemUserBase] [lk_rolebase_modifiedby] on ([T1].[ModifiedBy] = [lk_rolebase_modifiedby].[SystemUserId])
    left join [SystemUserBase] [lk_rolebase_modifiedonbehalfby] on ([T1].[ModifiedOnBehalfBy] = [lk_rolebase_modifiedonbehalfby].[SystemUserId])
    left join [OrganizationBase] [organization_roles] on ([T1].[OrganizationId] = [organization_roles].[OrganizationId])
