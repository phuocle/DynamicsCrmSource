...
select
    ...
    [SystemApplicationMetadataBase].[Dependency]
from [SystemApplicationMetadataBase] 
    left join [SystemUserBase] [lk_systemapplicationmetadata_createdby] on ([SystemApplicationMetadataBase].[CreatedBy] = [lk_systemapplicationmetadata_createdby].[SystemUserId])
    left join [SystemUserBase] [lk_systemapplicationmetadata_createdonbehalfby] on ([SystemApplicationMetadataBase].[CreatedOnBehalfBy] = [lk_systemapplicationmetadata_createdonbehalfby].[SystemUserId])
    left join [SystemUserBase] [lk_systemapplicationmetadata_modifiedby] on ([SystemApplicationMetadataBase].[ModifiedBy] = [lk_systemapplicationmetadata_modifiedby].[SystemUserId])
    left join [SystemUserBase] [lk_systemapplicationmetadata_modifiedonbehalfby] on ([SystemApplicationMetadataBase].[ModifiedOnBehalfBy] = [lk_systemapplicationmetadata_modifiedonbehalfby].[SystemUserId])
