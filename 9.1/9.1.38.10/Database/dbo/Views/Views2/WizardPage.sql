...
from [WizardPageBase] 
    left join [SystemUserBase] [lk_wizardpage_createdby]  on ([WizardPageBase].[CreatedBy] = [lk_wizardpage_createdby].[SystemUserId])
    left join [SystemUserBase] [lk_wizardpage_createdonbehalfby]  on ([WizardPageBase].[CreatedOnBehalfBy] = [lk_wizardpage_createdonbehalfby].[SystemUserId])
    left join [SystemUserBase] [lk_wizardpage_modifiedby]  on ([WizardPageBase].[ModifiedBy] = [lk_wizardpage_modifiedby].[SystemUserId])
    left join [SystemUserBase] [lk_wizardpage_modifiedonbehalfby]  on ([WizardPageBase].[ModifiedOnBehalfBy] = [lk_wizardpage_modifiedonbehalfby].[SystemUserId])
