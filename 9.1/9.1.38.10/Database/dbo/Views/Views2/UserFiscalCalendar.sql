...
from [UserFiscalCalendarBase] 
    left join [SystemUserBase] [lk_userfiscalcalendar_createdby]  on ([UserFiscalCalendarBase].[CreatedBy] = [lk_userfiscalcalendar_createdby].[SystemUserId])
    left join [SystemUserBase] [lk_userfiscalcalendar_createdonbehalfby]  on ([UserFiscalCalendarBase].[CreatedOnBehalfBy] = [lk_userfiscalcalendar_createdonbehalfby].[SystemUserId])
    left join [SystemUserBase] [lk_userfiscalcalendar_modifiedby]  on ([UserFiscalCalendarBase].[ModifiedBy] = [lk_userfiscalcalendar_modifiedby].[SystemUserId])
    left join [SystemUserBase] [lk_userfiscalcalendar_modifiedonbehalfby]  on ([UserFiscalCalendarBase].[ModifiedOnBehalfBy] = [lk_userfiscalcalendar_modifiedonbehalfby].[SystemUserId])
    left join [SystemUserBase] [system_user_quotas]  on ([UserFiscalCalendarBase].[SalesPersonId] = [system_user_quotas].[SystemUserId])
