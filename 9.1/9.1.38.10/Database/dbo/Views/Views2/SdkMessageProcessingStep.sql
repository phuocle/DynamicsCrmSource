...
from [SdkMessageProcessingStepBase] [T1]
    left join [SystemUserBase] [createdby_sdkmessageprocessingstep] on ([T1].[CreatedBy] = [createdby_sdkmessageprocessingstep].[SystemUserId])
    left join [SystemUserBase] [createdonbehalfby_sdkmessageprocessingstep] on ([T1].[CreatedOnBehalfBy] = [createdonbehalfby_sdkmessageprocessingstep].[SystemUserId])
    left join [SystemUserBase] [impersonatinguserid_sdkmessageprocessingstep] on ([T1].[ImpersonatingUserId] = [impersonatinguserid_sdkmessageprocessingstep].[SystemUserId])
    left join [SystemUserBase] [modifiedby_sdkmessageprocessingstep] on ([T1].[ModifiedBy] = [modifiedby_sdkmessageprocessingstep].[SystemUserId])
    left join [SystemUserBase] [modifiedonbehalfby_sdkmessageprocessingstep] on ([T1].[ModifiedOnBehalfBy] = [modifiedonbehalfby_sdkmessageprocessingstep].[SystemUserId])
    ...
    left join [SdkMessageBase] [sdkmessageid_sdkmessageprocessingstep] on ([T1].[SdkMessageId] = [sdkmessageid_sdkmessageprocessingstep].[SdkMessageId] and [sdkmessageid_sdkmessageprocessingstep].OverwriteTime = 0 and [sdkmessageid_sdkmessageprocessingstep].ComponentState = 0)
