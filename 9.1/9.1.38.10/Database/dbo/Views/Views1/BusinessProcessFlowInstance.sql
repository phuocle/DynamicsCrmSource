...
from [BusinessProcessFlowInstanceBase] 
    left join [SystemUserBase] [lk_businessprocessflowinstancebase_createdby]  on ([BusinessProcessFlowInstanceBase].[CreatedBy] = [lk_businessprocessflowinstancebase_createdby].[SystemUserId])
    left join [SystemUserBase] [lk_businessprocessflowinstancebase_createdonbehalfby]  on ([BusinessProcessFlowInstanceBase].[CreatedOnBehalfBy] = [lk_businessprocessflowinstancebase_createdonbehalfby].[SystemUserId])
    left join [SystemUserBase] [lk_businessprocessflowinstancebase_modifiedby]  on ([BusinessProcessFlowInstanceBase].[ModifiedBy] = [lk_businessprocessflowinstancebase_modifiedby].[SystemUserId])
    left join [SystemUserBase] [lk_businessprocessflowinstancebase_modifiedonbehalfby]  on ([BusinessProcessFlowInstanceBase].[ModifiedOnBehalfBy] = [lk_businessprocessflowinstancebase_modifiedonbehalfby].[SystemUserId])
