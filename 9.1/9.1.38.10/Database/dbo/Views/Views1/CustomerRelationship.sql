...
from [CustomerRelationshipBase] 
    left join [SystemUserBase] [createdby_customer_relationship]  on ([CustomerRelationshipBase].[CreatedBy] = [createdby_customer_relationship].[SystemUserId])
    left join [SystemUserBase] [createdonbehalfby_customer_relationship]  on ([CustomerRelationshipBase].[CreatedOnBehalfBy] = [createdonbehalfby_customer_relationship].[SystemUserId])
    left join [SystemUserBase] [modifiedby_customer_relationship]  on ([CustomerRelationshipBase].[ModifiedBy] = [modifiedby_customer_relationship].[SystemUserId])
    left join [SystemUserBase] [modifiedonbehalfby_customer_relationship]  on ([CustomerRelationshipBase].[ModifiedOnBehalfBy] = [modifiedonbehalfby_customer_relationship].[SystemUserId])
    ...
    left join OwnerBase XXowner  on ([CustomerRelationshipBase].OwnerId = XXowner.OwnerId)
