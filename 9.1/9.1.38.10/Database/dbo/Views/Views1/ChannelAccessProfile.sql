...
--
-- base view for ChannelAccessProfile
--
create view dbo.[ChannelAccessProfile]
 (
    -- logical attributes
    [CreatedByName],
    [CreatedByYomiName],
...
from [ChannelAccessProfileBase] [T1]
    left join [SystemUserBase] [lk_channelaccessprofile_createdby] on ([T1].[CreatedBy] = [lk_channelaccessprofile_createdby].[SystemUserId])
    left join [SystemUserBase] [lk_channelaccessprofile_createdonbehalfby] on ([T1].[CreatedOnBehalfBy] = [lk_channelaccessprofile_createdonbehalfby].[SystemUserId])
    left join [SystemUserBase] [lk_channelaccessprofile_modifiedby] on ([T1].[ModifiedBy] = [lk_channelaccessprofile_modifiedby].[SystemUserId])
    left join [SystemUserBase] [lk_channelaccessprofile_modifiedonbehalfby] on ([T1].[ModifiedOnBehalfBy] = [lk_channelaccessprofile_modifiedonbehalfby].[SystemUserId])
