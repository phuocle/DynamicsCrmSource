...
select
    ...
    [email_email_CorrelatedActivityId].[Subject],
    ...
    [ActivityPointerBase].[IsEmailReminderSet],
    [ActivityPointerBase].[ServiceId],
    [ActivityPointerBase].[ReservedForInternalUse],
    [ActivityPointerBase].[CorrelatedActivityId]
from [ActivityPointerBase] 
    left join [ActivityPointerBase] [email_email_CorrelatedActivityId] on ([ActivityPointerBase].[CorrelatedActivityId] = [email_email_CorrelatedActivityId].[ActivityId] and [email_email_CorrelatedActivityId].[ActivityTypeCode] = 4202)
    ...
    left join [SystemUserBase] [lk_email_createdby] on ([ActivityPointerBase].[CreatedBy] = [lk_email_createdby].[SystemUserId])
    left join [SystemUserBase] [lk_email_createdonbehalfby] on ([ActivityPointerBase].[CreatedOnBehalfBy] = [lk_email_createdonbehalfby].[SystemUserId])
    left join [SystemUserBase] [lk_email_modifiedby] on ([ActivityPointerBase].[ModifiedBy] = [lk_email_modifiedby].[SystemUserId])
    left join [SystemUserBase] [lk_email_modifiedonbehalfby] on ([ActivityPointerBase].[ModifiedOnBehalfBy] = [lk_email_modifiedonbehalfby].[SystemUserId])
    ...
    left join [ServiceBase] [service_emails] on ([ActivityPointerBase].[ServiceId] = [service_emails].[ServiceId])
