...
select
    ...
    dbo.fn_UTCToTzCodeSpecificLocalTime([Resource].[OverriddenCreatedOn],
			us.TimeZoneCode),
        [Resource].[OverriddenCreatedOn],
    [Resource].[ResourceId],
    [Resource].[SiteId],
    [Resource].[SiteIdName],
    [Resource].[TimeZoneRuleVersionNumber],
    [Resource].[UTCConversionTimeZoneCode],
...
GO
GRANT SELECT
    ON OBJECT::[dbo].[FilteredResource] TO [D365\ReportingGroup {17e68c54-332d-46c1-9c02-8ffa9543cd64}]
    AS [dbo];
