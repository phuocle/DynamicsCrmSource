...
from [PostLikeBase] 
    left join [SystemUserBase] [lk_postlike_createdby]  on ([PostLikeBase].[CreatedBy] = [lk_postlike_createdby].[SystemUserId])
    left join [SystemUserBase] [lk_postlike_createdonbehalfby]  on ([PostLikeBase].[CreatedOnBehalfBy] = [lk_postlike_createdonbehalfby].[SystemUserId])
    left join [OrganizationBase] [organization_postlike]  on ([PostLikeBase].[OrganizationId] = [organization_postlike].[OrganizationId])
