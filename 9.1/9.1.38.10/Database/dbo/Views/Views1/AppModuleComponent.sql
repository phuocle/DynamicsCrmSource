...
from [AppModuleComponentBase] 
    ...
    left join [SystemUserBase] [lk_appmodulecomponent_createdby]  on ([AppModuleComponentBase].[CreatedBy] = [lk_appmodulecomponent_createdby].[SystemUserId])
    left join [SystemUserBase] [lk_appmodulecomponent_createdonbehalfby]  on ([AppModuleComponentBase].[CreatedOnBehalfBy] = [lk_appmodulecomponent_createdonbehalfby].[SystemUserId])
    left join [SystemUserBase] [lk_appmodulecomponent_modifiedby]  on ([AppModuleComponentBase].[ModifiedBy] = [lk_appmodulecomponent_modifiedby].[SystemUserId])
    left join [SystemUserBase] [lk_appmodulecomponent_modifiedonbehalfby]  on ([AppModuleComponentBase].[ModifiedOnBehalfBy] = [lk_appmodulecomponent_modifiedonbehalfby].[SystemUserId])
