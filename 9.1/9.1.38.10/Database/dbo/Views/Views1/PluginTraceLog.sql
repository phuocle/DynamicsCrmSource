...
from [PluginTraceLogBase] 
    left join [SystemUserBase] [createdby_plugintracelog]  on ([PluginTraceLogBase].[CreatedBy] = [createdby_plugintracelog].[SystemUserId])
    left join [SystemUserBase] [lk_plugintracelogbase_createdonbehalfby]  on ([PluginTraceLogBase].[CreatedOnBehalfBy] = [lk_plugintracelogbase_createdonbehalfby].[SystemUserId])
