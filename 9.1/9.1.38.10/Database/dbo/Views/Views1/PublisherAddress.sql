...
from [PublisherAddressBase] 
    left join [SystemUserBase] [lk_publisheraddressbase_createdby]  on ([PublisherAddressBase].[CreatedBy] = [lk_publisheraddressbase_createdby].[SystemUserId])
    left join [SystemUserBase] [lk_publisheraddressbase_createdonbehalfby]  on ([PublisherAddressBase].[CreatedOnBehalfBy] = [lk_publisheraddressbase_createdonbehalfby].[SystemUserId])
    left join [SystemUserBase] [lk_publisheraddressbase_modifiedby]  on ([PublisherAddressBase].[ModifiedBy] = [lk_publisheraddressbase_modifiedby].[SystemUserId])
    left join [SystemUserBase] [lk_publisheraddressbase_modifiedonbehalfby]  on ([PublisherAddressBase].[ModifiedOnBehalfBy] = [lk_publisheraddressbase_modifiedonbehalfby].[SystemUserId])
