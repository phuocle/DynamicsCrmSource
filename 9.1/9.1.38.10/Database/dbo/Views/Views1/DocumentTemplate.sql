...
from [DocumentTemplateBase] 
    left join [SystemUserBase] [lk_documenttemplatebase_createdby] on ([DocumentTemplateBase].[CreatedBy] = [lk_documenttemplatebase_createdby].[SystemUserId])
    left join [SystemUserBase] [lk_documenttemplatebase_createdonbehalfby] on ([DocumentTemplateBase].[CreatedOnBehalfBy] = [lk_documenttemplatebase_createdonbehalfby].[SystemUserId])
    left join [SystemUserBase] [lk_documenttemplatebase_modifiedby] on ([DocumentTemplateBase].[ModifiedBy] = [lk_documenttemplatebase_modifiedby].[SystemUserId])
    left join [SystemUserBase] [lk_documenttemplatebase_modifiedonbehalfby] on ([DocumentTemplateBase].[ModifiedOnBehalfBy] = [lk_documenttemplatebase_modifiedonbehalfby].[SystemUserId])
    left join [OrganizationBase] [lk_documenttemplatebase_organization] on ([DocumentTemplateBase].[OrganizationId] = [lk_documenttemplatebase_organization].[OrganizationId])
