...
from [RecurrenceRuleBase] 
    left join [SystemUserBase] [lk_recurrencerule_createdby]  on ([RecurrenceRuleBase].[CreatedBy] = [lk_recurrencerule_createdby].[SystemUserId])
    left join [SystemUserBase] [lk_recurrencerule_modifiedby]  on ([RecurrenceRuleBase].[ModifiedBy] = [lk_recurrencerule_modifiedby].[SystemUserId])
    left join [SystemUserBase] [lk_recurrencerulebase_createdonbehalfby]  on ([RecurrenceRuleBase].[CreatedOnBehalfBy] = [lk_recurrencerulebase_createdonbehalfby].[SystemUserId])
    left join [SystemUserBase] [lk_recurrencerulebase_modifiedonbehalfby]  on ([RecurrenceRuleBase].[ModifiedOnBehalfBy] = [lk_recurrencerulebase_modifiedonbehalfby].[SystemUserId])
    left join OwnerBase XXowner  on ([RecurrenceRuleBase].OwnerId = XXowner.OwnerId)
