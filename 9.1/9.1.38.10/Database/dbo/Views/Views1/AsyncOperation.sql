...
select
    ...
    [FileAttachment_AsyncOperation_DataBlobId].[FileName],
    ...
    [AsyncOperationBase].[ParentPluginExecutionId],
    [AsyncOperationBase].[RootExecutionContext],
    [AsyncOperationBase].[Workload],
    [AsyncOperationBase].[ExpanderStartTime],
    [AsyncOperationBase].[CallerOrigin],
    [AsyncOperationBase].[BreadcrumbId],
    [AsyncOperationBase].[RetainJobHistory],
    [AsyncOperationBase].[DataBlobId]
from [AsyncOperationBase] 
    left join [FileAttachmentBase] [FileAttachment_AsyncOperation_DataBlobId] on ([AsyncOperationBase].[DataBlobId] = [FileAttachment_AsyncOperation_DataBlobId].[FileAttachmentId])
    left join [SystemUserBase] [lk_asyncoperation_createdby] on ([AsyncOperationBase].[CreatedBy] = [lk_asyncoperation_createdby].[SystemUserId])
    left join [SystemUserBase] [lk_asyncoperation_createdonbehalfby] on ([AsyncOperationBase].[CreatedOnBehalfBy] = [lk_asyncoperation_createdonbehalfby].[SystemUserId])
    left join [SystemUserBase] [lk_asyncoperation_modifiedby] on ([AsyncOperationBase].[ModifiedBy] = [lk_asyncoperation_modifiedby].[SystemUserId])
    left join [SystemUserBase] [lk_asyncoperation_modifiedonbehalfby] on ([AsyncOperationBase].[ModifiedOnBehalfBy] = [lk_asyncoperation_modifiedonbehalfby].[SystemUserId])
    ...
    left join OwnerBase XXowner on ([AsyncOperationBase].OwnerId = XXowner.OwnerId)
