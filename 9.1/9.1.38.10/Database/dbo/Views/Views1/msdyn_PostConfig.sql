...
from [msdyn_PostConfigBase] 
    left join [SystemUserBase] [lk_msdyn_postconfig_createdby] on ([msdyn_PostConfigBase].[CreatedBy] = [lk_msdyn_postconfig_createdby].[SystemUserId])
    left join [SystemUserBase] [lk_msdyn_postconfig_createdonbehalfby] on ([msdyn_PostConfigBase].[CreatedOnBehalfBy] = [lk_msdyn_postconfig_createdonbehalfby].[SystemUserId])
    left join [SystemUserBase] [lk_msdyn_postconfig_modifiedby] on ([msdyn_PostConfigBase].[ModifiedBy] = [lk_msdyn_postconfig_modifiedby].[SystemUserId])
    left join [SystemUserBase] [lk_msdyn_postconfig_modifiedonbehalfby] on ([msdyn_PostConfigBase].[ModifiedOnBehalfBy] = [lk_msdyn_postconfig_modifiedonbehalfby].[SystemUserId])
    left join [OrganizationBase] [organization_msdyn_postconfig] on ([msdyn_PostConfigBase].[OrganizationId] = [organization_msdyn_postconfig].[OrganizationId])
