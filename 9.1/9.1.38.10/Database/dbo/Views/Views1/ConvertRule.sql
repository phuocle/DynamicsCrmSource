...
from [ConvertRuleBase] [T1]
    ...
    left join [SystemUserBase] [lk_convertrule_createdby] on ([T1].[CreatedBy] = [lk_convertrule_createdby].[SystemUserId])
    left join [SystemUserBase] [lk_ConvertRule_createdonbehalfby] on ([T1].[CreatedOnBehalfBy] = [lk_ConvertRule_createdonbehalfby].[SystemUserId])
    left join [SystemUserBase] [lk_ConvertRule_modifiedby] on ([T1].[ModifiedBy] = [lk_ConvertRule_modifiedby].[SystemUserId])
    left join [SystemUserBase] [lk_ConvertRule_modifiedonbehalfby] on ([T1].[ModifiedOnBehalfBy] = [lk_ConvertRule_modifiedonbehalfby].[SystemUserId])
