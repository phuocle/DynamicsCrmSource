...
from [DuplicateRuleBase] 
    left join [SystemUserBase] [lk_duplicaterulebase_createdby]  on ([DuplicateRuleBase].[CreatedBy] = [lk_duplicaterulebase_createdby].[SystemUserId])
    left join [SystemUserBase] [lk_duplicaterulebase_createdonbehalfby]  on ([DuplicateRuleBase].[CreatedOnBehalfBy] = [lk_duplicaterulebase_createdonbehalfby].[SystemUserId])
    left join [SystemUserBase] [lk_duplicaterulebase_modifiedby]  on ([DuplicateRuleBase].[ModifiedBy] = [lk_duplicaterulebase_modifiedby].[SystemUserId])
    left join [SystemUserBase] [lk_duplicaterulebase_modifiedonbehalfby]  on ([DuplicateRuleBase].[ModifiedOnBehalfBy] = [lk_duplicaterulebase_modifiedonbehalfby].[SystemUserId])
    left join OwnerBase XXowner  on ([DuplicateRuleBase].OwnerId = XXowner.OwnerId)
