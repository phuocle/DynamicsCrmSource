...
from [PrincipalSyncAttributeMapBase] 
    left join [OrganizationBase] [lk_principalsyncattributemap_organizationid]  on ([PrincipalSyncAttributeMapBase].[OrganizationId] = [lk_principalsyncattributemap_organizationid].[OrganizationId])
