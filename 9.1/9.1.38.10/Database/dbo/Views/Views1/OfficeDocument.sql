...
from [OfficeDocumentBase] 
    left join [SystemUserBase] [lk_officedocumentbase_createdonbehalfby]  on ([OfficeDocumentBase].[CreatedOnBehalfBy] = [lk_officedocumentbase_createdonbehalfby].[SystemUserId])
    left join [SystemUserBase] [lk_officedocumentbase_modifiedonbehalfby]  on ([OfficeDocumentBase].[ModifiedOnBehalfBy] = [lk_officedocumentbase_modifiedonbehalfby].[SystemUserId])
