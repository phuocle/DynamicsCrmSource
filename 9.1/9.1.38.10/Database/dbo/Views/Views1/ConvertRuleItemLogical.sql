...
select
    ...
    [T1].[PrimaryCreateEntityLogicalName]
from [ConvertRuleItemBase] [T1]
    ...
    left join [SystemUserBase] [lk_convertruleitembase_createdby] on ([T1].[CreatedBy] = [lk_convertruleitembase_createdby].[SystemUserId])
    left join [SystemUserBase] [lk_convertruleitembase_createdonbehalfby] on ([T1].[CreatedOnBehalfBy] = [lk_convertruleitembase_createdonbehalfby].[SystemUserId])
    left join [SystemUserBase] [lk_convertruleitembase_modifiedby] on ([T1].[ModifiedBy] = [lk_convertruleitembase_modifiedby].[SystemUserId])
    left join [SystemUserBase] [lk_convertruleitembase_modifiedonbehalfby] on ([T1].[ModifiedOnBehalfBy] = [lk_convertruleitembase_modifiedonbehalfby].[SystemUserId])
