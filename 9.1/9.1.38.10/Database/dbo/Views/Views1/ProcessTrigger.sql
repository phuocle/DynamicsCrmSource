...
--
-- base view for ProcessTrigger
--
create view dbo.[ProcessTrigger]
 (
    -- logical attributes
    [OwningBusinessUnit],
    [OwningUser],
...
from [ProcessTriggerBase] [T1]
    left join [SystemUserBase] [lk_processtriggerbase_createdby] on ([T1].[CreatedBy] = [lk_processtriggerbase_createdby].[SystemUserId])
    left join [SystemUserBase] [lk_processtriggerbase_createdonbehalfby] on ([T1].[CreatedOnBehalfBy] = [lk_processtriggerbase_createdonbehalfby].[SystemUserId])
    left join [SystemUserBase] [lk_processtriggerbase_modifiedby] on ([T1].[ModifiedBy] = [lk_processtriggerbase_modifiedby].[SystemUserId])
    left join [SystemUserBase] [lk_processtriggerbase_modifiedonbehalfby] on ([T1].[ModifiedOnBehalfBy] = [lk_processtriggerbase_modifiedonbehalfby].[SystemUserId])
