...
from [CalendarBase] 
    ...
    left join [SystemUserBase] [lk_calendar_createdby] on ([CalendarBase].[CreatedBy] = [lk_calendar_createdby].[SystemUserId])
    left join [SystemUserBase] [lk_calendar_createdonbehalfby] on ([CalendarBase].[CreatedOnBehalfBy] = [lk_calendar_createdonbehalfby].[SystemUserId])
    left join [SystemUserBase] [lk_calendar_modifiedby] on ([CalendarBase].[ModifiedBy] = [lk_calendar_modifiedby].[SystemUserId])
    left join [SystemUserBase] [lk_calendar_modifiedonbehalfby] on ([CalendarBase].[ModifiedOnBehalfBy] = [lk_calendar_modifiedonbehalfby].[SystemUserId])
