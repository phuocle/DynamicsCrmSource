...
from PluginAssembly
    ...
    left outer join StringMap [AuthTypePLTable] on 
		...
		and [AuthTypePLTable].ObjectTypeCode = 4605
		and [AuthTypePLTable].AttributeValue = [PluginAssembly].[AuthType]
...
GO
GRANT SELECT
    ON OBJECT::[dbo].[FilteredPluginAssembly] TO [D365\ReportingGroup {17e68c54-332d-46c1-9c02-8ffa9543cd64}]
    AS [dbo];
