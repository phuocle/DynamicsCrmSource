...
--
-- logical view for ChannelAccessProfileRuleLogical
--
create view dbo.[ChannelAccessProfileRuleLogical]
 (
    -- logical attributes
    [CreatedByName],
    [CreatedByYomiName],
...
from [ChannelAccessProfileRuleBase] [T1]
    left join [SystemUserBase] [lk_profilerule_createdby] on ([T1].[CreatedBy] = [lk_profilerule_createdby].[SystemUserId])
    left join [SystemUserBase] [lk_profilerule_createdonbehalfby] on ([T1].[CreatedOnBehalfBy] = [lk_profilerule_createdonbehalfby].[SystemUserId])
    left join [SystemUserBase] [lk_profilerule_modifiedby] on ([T1].[ModifiedBy] = [lk_profilerule_modifiedby].[SystemUserId])
    left join [SystemUserBase] [lk_profilerule_modifiedonbehalfby] on ([T1].[ModifiedOnBehalfBy] = [lk_profilerule_modifiedonbehalfby].[SystemUserId])
