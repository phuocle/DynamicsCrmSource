...
GO
GRANT SELECT
    ON OBJECT::[dbo].[FilteredCustomerRelationship] TO [D365\ReportingGroup {17e68c54-332d-46c1-9c02-8ffa9543cd64}]
    AS [dbo];


GO
GRANT SELECT
    ON OBJECT::[dbo].[FilteredCustomerRelationship] TO [CRMReaderRole]
    AS [dbo];
