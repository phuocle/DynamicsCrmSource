...
from [ActivityPointerBase] 
    ...
    left join [SystemUserBase] [lk_activitypointer_createdby] on ([ActivityPointerBase].[CreatedBy] = [lk_activitypointer_createdby].[SystemUserId])
    left join [SystemUserBase] [lk_activitypointer_createdonbehalfby] on ([ActivityPointerBase].[CreatedOnBehalfBy] = [lk_activitypointer_createdonbehalfby].[SystemUserId])
    left join [SystemUserBase] [lk_activitypointer_modifiedby] on ([ActivityPointerBase].[ModifiedBy] = [lk_activitypointer_modifiedby].[SystemUserId])
    left join [SystemUserBase] [lk_activitypointer_modifiedonbehalfby] on ([ActivityPointerBase].[ModifiedOnBehalfBy] = [lk_activitypointer_modifiedonbehalfby].[SystemUserId])
