...
from [BusinessUnitNewsArticleBase] 
    left join [SystemUserBase] [lk_businessunitnewsarticlebase_createdby]  on ([BusinessUnitNewsArticleBase].[CreatedBy] = [lk_businessunitnewsarticlebase_createdby].[SystemUserId])
    left join [SystemUserBase] [lk_businessunitnewsarticlebase_createdonbehalfby]  on ([BusinessUnitNewsArticleBase].[CreatedOnBehalfBy] = [lk_businessunitnewsarticlebase_createdonbehalfby].[SystemUserId])
    left join [SystemUserBase] [lk_businessunitnewsarticlebase_modifiedby]  on ([BusinessUnitNewsArticleBase].[ModifiedBy] = [lk_businessunitnewsarticlebase_modifiedby].[SystemUserId])
    left join [SystemUserBase] [lk_businessunitnewsarticlebase_modifiedonbehalfby]  on ([BusinessUnitNewsArticleBase].[ModifiedOnBehalfBy] = [lk_businessunitnewsarticlebase_modifiedonbehalfby].[SystemUserId])
