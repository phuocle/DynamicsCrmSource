...
select
    ...
    CAST(case when [EmailServerProfileBase].[DataEncryptionKey] is null then 0 else 1 end as bit),
    CAST(case when [EmailServerProfileBase].[IncomingPassword] is null then 0 else 1 end as bit),
    CAST(case when [EmailServerProfileBase].[OauthClientSecret] is null then 0 else 1 end as bit),
    ...
    [EmailServerProfileBase].[DataEncryptionKey],
    [EmailServerProfileBase].[CredentialInfo],
    ...
    [EmailServerProfileBase].[VersionNumber],
    [EmailServerProfileBase].[OauthClientId],
    [EmailServerProfileBase].[OauthClientSecret]
from [EmailServerProfileBase] 
    ...
    left join [SystemUserBase] [lk_emailserverprofile_createdby] on ([EmailServerProfileBase].[CreatedBy] = [lk_emailserverprofile_createdby].[SystemUserId])
    left join [SystemUserBase] [lk_emailserverprofile_createdonbehalfby] on ([EmailServerProfileBase].[CreatedOnBehalfBy] = [lk_emailserverprofile_createdonbehalfby].[SystemUserId])
    ...
    left join [SystemUserBase] [lk_emailserverprofile_modifiedby] on ([EmailServerProfileBase].[ModifiedBy] = [lk_emailserverprofile_modifiedby].[SystemUserId])
    left join [SystemUserBase] [lk_emailserverprofile_modifiedonbehalfby] on ([EmailServerProfileBase].[ModifiedOnBehalfBy] = [lk_emailserverprofile_modifiedonbehalfby].[SystemUserId])
    left join [OrganizationBase] [organization_emailserverprofile] on ([EmailServerProfileBase].[OrganizationId] = [organization_emailserverprofile].[OrganizationId])
    left join OwnerBase XXowner on ([EmailServerProfileBase].OwnerId = XXowner.OwnerId)
