...
AnnotationBase.ObjectTypeCode,    -- physical attribute
    ...
    [AnnotationBase].[Prefix],
    [AnnotationBase].[StoragePointer],
    [AnnotationBase].[FilePointer]
from [AnnotationBase] 
    left join [SystemUserBase] [lk_annotationbase_createdby] on ([AnnotationBase].[CreatedBy] = [lk_annotationbase_createdby].[SystemUserId])
    left join [SystemUserBase] [lk_annotationbase_createdonbehalfby] on ([AnnotationBase].[CreatedOnBehalfBy] = [lk_annotationbase_createdonbehalfby].[SystemUserId])
    left join [SystemUserBase] [lk_annotationbase_modifiedby] on ([AnnotationBase].[ModifiedBy] = [lk_annotationbase_modifiedby].[SystemUserId])
    left join [SystemUserBase] [lk_annotationbase_modifiedonbehalfby] on ([AnnotationBase].[ModifiedOnBehalfBy] = [lk_annotationbase_modifiedonbehalfby].[SystemUserId])
    left join OwnerBase XXowner on ([AnnotationBase].OwnerId = XXowner.OwnerId)
