...
from [ImportBase] 
    left join [SystemUserBase] [lk_importbase_createdby]  on ([ImportBase].[CreatedBy] = [lk_importbase_createdby].[SystemUserId])
    left join [SystemUserBase] [lk_importbase_createdonbehalfby]  on ([ImportBase].[CreatedOnBehalfBy] = [lk_importbase_createdonbehalfby].[SystemUserId])
    left join [SystemUserBase] [lk_importbase_modifiedby]  on ([ImportBase].[ModifiedBy] = [lk_importbase_modifiedby].[SystemUserId])
    left join [SystemUserBase] [lk_importbase_modifiedonbehalfby]  on ([ImportBase].[ModifiedOnBehalfBy] = [lk_importbase_modifiedonbehalfby].[SystemUserId])
    left join OwnerBase XXowner  on ([ImportBase].OwnerId = XXowner.OwnerId)
