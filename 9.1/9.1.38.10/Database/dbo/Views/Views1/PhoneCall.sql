...
from [ActivityPointerBase] 
    left join [SystemUserBase] [lk_phonecall_createdby] on ([ActivityPointerBase].[CreatedBy] = [lk_phonecall_createdby].[SystemUserId])
    left join [SystemUserBase] [lk_phonecall_createdonbehalfby] on ([ActivityPointerBase].[CreatedOnBehalfBy] = [lk_phonecall_createdonbehalfby].[SystemUserId])
    left join [SystemUserBase] [lk_phonecall_modifiedby] on ([ActivityPointerBase].[ModifiedBy] = [lk_phonecall_modifiedby].[SystemUserId])
    left join [SystemUserBase] [lk_phonecall_modifiedonbehalfby] on ([ActivityPointerBase].[ModifiedOnBehalfBy] = [lk_phonecall_modifiedonbehalfby].[SystemUserId])
    ...
    left join [ServiceBase] [service_phonecalls] on ([ActivityPointerBase].[ServiceId] = [service_phonecalls].[ServiceId])
