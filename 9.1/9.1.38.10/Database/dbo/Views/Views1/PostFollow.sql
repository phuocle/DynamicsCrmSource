...
from [PostFollowBase] 
    left join [SystemUserBase] [lk_PostFollow_createdby]  on ([PostFollowBase].[CreatedBy] = [lk_PostFollow_createdby].[SystemUserId])
    left join [SystemUserBase] [lk_postfollow_createdonbehalfby]  on ([PostFollowBase].[CreatedOnBehalfBy] = [lk_postfollow_createdonbehalfby].[SystemUserId])
    left join OwnerBase XXowner  on ([PostFollowBase].OwnerId = XXowner.OwnerId)
