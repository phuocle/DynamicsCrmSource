...
from [KnowledgeArticleViewsBase] 
    ...
    left join [SystemUserBase] [lk_knowledgearticleviews_createdby]  on ([KnowledgeArticleViewsBase].[CreatedBy] = [lk_knowledgearticleviews_createdby].[SystemUserId])
    left join [SystemUserBase] [lk_knowledgearticleviews_createdonbehalfby]  on ([KnowledgeArticleViewsBase].[CreatedOnBehalfBy] = [lk_knowledgearticleviews_createdonbehalfby].[SystemUserId])
    left join [SystemUserBase] [lk_knowledgearticleviews_modifiedby]  on ([KnowledgeArticleViewsBase].[ModifiedBy] = [lk_knowledgearticleviews_modifiedby].[SystemUserId])
    left join [SystemUserBase] [lk_knowledgearticleviews_modifiedonbehalfby]  on ([KnowledgeArticleViewsBase].[ModifiedOnBehalfBy] = [lk_knowledgearticleviews_modifiedonbehalfby].[SystemUserId])
