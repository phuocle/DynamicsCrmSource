...
select
    ...
    [RecurringAppointmentMaster].[IsUnsafe],
    ...
    --[RecurringAppointmentMaster].[SafeDescription]
    ...
    [RecurringAppointmentMaster].[ServiceIdName],
...
(
	...
	(
		...
		[RecurringAppointmentMaster].[OwningBusinessUnit] in (select BusinessUnitId from SystemUserBusinessUnitEntityMap where SystemUserId = u.SystemUserId and ObjectTypeCode = 4200)
	) 
	or
	(
		-- global security
...
GO
GRANT SELECT
    ON OBJECT::[dbo].[FilteredRecurringAppointmentMaster] TO [D365\ReportingGroup {17e68c54-332d-46c1-9c02-8ffa9543cd64}]
    AS [dbo];
