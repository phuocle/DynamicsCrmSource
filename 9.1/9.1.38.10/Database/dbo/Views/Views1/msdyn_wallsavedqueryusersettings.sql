...
from [msdyn_wallsavedqueryusersettingsBase] 
    left join [SystemUserBase] [lk_msdyn_wallsavedqueryusersettings_createdby] on ([msdyn_wallsavedqueryusersettingsBase].[CreatedBy] = [lk_msdyn_wallsavedqueryusersettings_createdby].[SystemUserId])
    left join [SystemUserBase] [lk_msdyn_wallsavedqueryusersettings_createdonbehalfby] on ([msdyn_wallsavedqueryusersettingsBase].[CreatedOnBehalfBy] = [lk_msdyn_wallsavedqueryusersettings_createdonbehalfby].[SystemUserId])
    left join [SystemUserBase] [lk_msdyn_wallsavedqueryusersettings_modifiedby] on ([msdyn_wallsavedqueryusersettingsBase].[ModifiedBy] = [lk_msdyn_wallsavedqueryusersettings_modifiedby].[SystemUserId])
    left join [SystemUserBase] [lk_msdyn_wallsavedqueryusersettings_modifiedonbehalfby] on ([msdyn_wallsavedqueryusersettingsBase].[ModifiedOnBehalfBy] = [lk_msdyn_wallsavedqueryusersettings_modifiedonbehalfby].[SystemUserId])
    left join [SystemUserBase] [msdyn_systemuser_wallsavedqueryusersettings_userid] on ([msdyn_wallsavedqueryusersettingsBase].[msdyn_userid] = [msdyn_systemuser_wallsavedqueryusersettings_userid].[SystemUserId])
    ...
    left join OwnerBase XXowner on ([msdyn_wallsavedqueryusersettingsBase].OwnerId = XXowner.OwnerId)
