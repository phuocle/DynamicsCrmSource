...
from msdyn_PostConfig
    ...
    left outer join StringMap [msdyn_ConfigureWallPLTable] on 
		...
		and [msdyn_ConfigureWallPLTable].ObjectTypeCode = 10006
...
GO
GRANT SELECT
    ON OBJECT::[dbo].[Filteredmsdyn_PostConfig] TO [D365\ReportingGroup {17e68c54-332d-46c1-9c02-8ffa9543cd64}]
    AS [dbo];


GO
GRANT SELECT
    ON OBJECT::[dbo].[Filteredmsdyn_PostConfig] TO [CRMReaderRole]
    AS [dbo];
