...
from [ExternalPartyBase] 
    left join [SystemUserBase] [lk_externalparty_createdby]  on ([ExternalPartyBase].[CreatedBy] = [lk_externalparty_createdby].[SystemUserId])
    left join [SystemUserBase] [lk_externalparty_createdonbehalfby]  on ([ExternalPartyBase].[CreatedOnBehalfBy] = [lk_externalparty_createdonbehalfby].[SystemUserId])
    left join [SystemUserBase] [lk_externalparty_modifiedby]  on ([ExternalPartyBase].[ModifiedBy] = [lk_externalparty_modifiedby].[SystemUserId])
    left join [SystemUserBase] [lk_externalparty_modifiedonbehalfby]  on ([ExternalPartyBase].[ModifiedOnBehalfBy] = [lk_externalparty_modifiedonbehalfby].[SystemUserId])
    ...
    left join OwnerBase XXowner  on ([ExternalPartyBase].OwnerId = XXowner.OwnerId)
