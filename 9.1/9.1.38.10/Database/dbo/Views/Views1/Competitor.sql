...
from [CompetitorBase] 
    ...
    left join [SystemUserBase] [lk_competitorbase_createdby] on ([CompetitorBase].[CreatedBy] = [lk_competitorbase_createdby].[SystemUserId])
    left join [SystemUserBase] [lk_competitorbase_createdonbehalfby] on ([CompetitorBase].[CreatedOnBehalfBy] = [lk_competitorbase_createdonbehalfby].[SystemUserId])
    left join [SystemUserBase] [lk_competitorbase_modifiedby] on ([CompetitorBase].[ModifiedBy] = [lk_competitorbase_modifiedby].[SystemUserId])
    left join [SystemUserBase] [lk_competitorbase_modifiedonbehalfby] on ([CompetitorBase].[ModifiedOnBehalfBy] = [lk_competitorbase_modifiedonbehalfby].[SystemUserId])
