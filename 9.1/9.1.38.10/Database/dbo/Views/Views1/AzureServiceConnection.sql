...
from [AzureServiceConnectionBase] 
    left join [SystemUserBase] [lk_azureserviceconnection_createdby]  on ([AzureServiceConnectionBase].[CreatedBy] = [lk_azureserviceconnection_createdby].[SystemUserId])
    left join [SystemUserBase] [lk_azureserviceconnection_createdonbehalfby]  on ([AzureServiceConnectionBase].[CreatedOnBehalfBy] = [lk_azureserviceconnection_createdonbehalfby].[SystemUserId])
    left join [SystemUserBase] [lk_azureserviceconnection_modifiedby]  on ([AzureServiceConnectionBase].[ModifiedBy] = [lk_azureserviceconnection_modifiedby].[SystemUserId])
    left join [SystemUserBase] [lk_azureserviceconnection_modifiedonbehalfby]  on ([AzureServiceConnectionBase].[ModifiedOnBehalfBy] = [lk_azureserviceconnection_modifiedonbehalfby].[SystemUserId])
    left join [OrganizationBase] [organization_azureserviceconnection]  on ([AzureServiceConnectionBase].[OrganizationId] = [organization_azureserviceconnection].[OrganizationId])
