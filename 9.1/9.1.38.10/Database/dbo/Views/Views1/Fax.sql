...
from [ActivityPointerBase] 
    left join [SystemUserBase] [lk_fax_createdby] on ([ActivityPointerBase].[CreatedBy] = [lk_fax_createdby].[SystemUserId])
    left join [SystemUserBase] [lk_fax_createdonbehalfby] on ([ActivityPointerBase].[CreatedOnBehalfBy] = [lk_fax_createdonbehalfby].[SystemUserId])
    left join [SystemUserBase] [lk_fax_modifiedby] on ([ActivityPointerBase].[ModifiedBy] = [lk_fax_modifiedby].[SystemUserId])
    left join [SystemUserBase] [lk_fax_modifiedonbehalfby] on ([ActivityPointerBase].[ModifiedOnBehalfBy] = [lk_fax_modifiedonbehalfby].[SystemUserId])
    ...
    left join [ServiceBase] [service_faxes] on ([ActivityPointerBase].[ServiceId] = [service_faxes].[ServiceId])
