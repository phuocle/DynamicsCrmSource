...
from [AccountBase] 
    ...
    left join [SystemUserBase] [lk_accountbase_createdby] on ([AccountBase].[CreatedBy] = [lk_accountbase_createdby].[SystemUserId])
    left join [SystemUserBase] [lk_accountbase_createdonbehalfby] on ([AccountBase].[CreatedOnBehalfBy] = [lk_accountbase_createdonbehalfby].[SystemUserId])
    left join [SystemUserBase] [lk_accountbase_modifiedby] on ([AccountBase].[ModifiedBy] = [lk_accountbase_modifiedby].[SystemUserId])
    left join [SystemUserBase] [lk_accountbase_modifiedonbehalfby] on ([AccountBase].[ModifiedOnBehalfBy] = [lk_accountbase_modifiedonbehalfby].[SystemUserId])
    ...
    left join [SystemUserBase] [system_user_accounts] on ([AccountBase].[PreferredSystemUserId] = [system_user_accounts].[SystemUserId])
    ...
    left join OwnerBase XXowner on ([AccountBase].OwnerId = XXowner.OwnerId)
