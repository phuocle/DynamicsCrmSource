...
CASE 
WHEN (SELECT CAST(current_value as int) FROM sys.sequences WHERE name = '') < MaximumTrackingNumber THEN  (SELECT CAST(current_value as int) + 1 FROM sys.sequences WHERE name = '') 
ELSE 0
END as [NextTrackingNumber],    [OrganizationBase].[TagMaxAggressiveCycles],
    ...
    [OrganizationBase].[TraceLogMaximumAgeInDays],
    ...
    [OrganizationBase].[OrganizationState],
    ...
    [OrganizationBase].[EnableImmersiveSkypeIntegration],
    ...
    [OrganizationBase].[ResolveSimilarUnresolvedEmailAddress],
    [OrganizationBase].[IsTextWrapEnabled],
    [OrganizationBase].[SessionTimeoutEnabled],
    [OrganizationBase].[SessionTimeoutInMins],
    [OrganizationBase].[SessionTimeoutReminderInMins],
    [OrganizationBase].[MicrosoftFlowEnvironment],
    ...
    [OrganizationBase].[SyncOptInSelection],
    [OrganizationBase].[SyncOptInSelectionStatus],
    [OrganizationBase].[IsActionSupportFeatureEnabled],
    [OrganizationBase].[IsBPFEntityCustomizationFeatureEnabled],
    [OrganizationBase].[BoundDashboardDefaultCardExpanded],
    [OrganizationBase].[MaxActionStepsInBPF],
    [OrganizationBase].[ServeStaticResourcesFromAzureCDN],
    [OrganizationBase].[IsExternalFileStorageEnabled],
    [OrganizationBase].[ClientFeatureSet],
    [OrganizationBase].[IsReadAuditEnabled],
    [OrganizationBase].[IsNotesAnalysisEnabled],
    [OrganizationBase].[AllowLegacyDialogsEmbedding],
    [OrganizationBase].[AllowLegacyClientExperience],
    [OrganizationBase].[IsMSTeamsEnabled],
    [OrganizationBase].[IsLUISEnabledforD365Bot],
    [OrganizationBase].[SyncBulkOperationBatchSize],
    [OrganizationBase].[SyncBulkOperationMaxLimit],
    [OrganizationBase].[EnableUnifiedInterfaceShellRefresh],
    [OrganizationBase].[IsMSTeamsSettingChangedByUser],
    [OrganizationBase].[EnableLivePersonaCardUCI],
    [OrganizationBase].[IsMSTeamsCollaborationEnabled],
    [OrganizationBase].[IsMSTeamsUserSyncEnabled],
    [OrganizationBase].[IsManualSalesForecastingEnabled],
    [OrganizationBase].[IsPDFGenerationEnabled],
    [OrganizationBase].[IsCustomControlsInCanvasAppsEnabled],
    [OrganizationBase].[IsPAIEnabled],
    [OrganizationBase].[IsQuickCreateEnabledForOpportunityClose],
    [OrganizationBase].[ContentSecurityPolicyConfiguration],
    [OrganizationBase].[IsContentSecurityPolicyEnabled],
    [OrganizationBase].[IsPriceListMandatory],
    [OrganizationBase].[EnableLivePersonCardIntegrationInOffice],
    [OrganizationBase].[IsContextualEmailEnabled],
    [OrganizationBase].[QualifyLeadAdditionalOptions],
    [OrganizationBase].[BusinessCardOptions],
    [OrganizationBase].[IsPlaybookEnabled],
    [OrganizationBase].[PaiPreviewScenarioEnabled],
    [OrganizationBase].[IsContextualHelpEnabled],
    [OrganizationBase].[IsSalesAssistantEnabled],
    [OrganizationBase].[IsAutoDataCaptureV2Enabled],
    [OrganizationBase].[IsNewAddProductExperienceEnabled],
    [OrganizationBase].[AuditRetentionPeriod],
    [OrganizationBase].[UseQuickFindViewForGridSearch],
    [OrganizationBase].[IsRichTextNotesEnabled],
    [OrganizationBase].[SendBulkEmailInUCI],
    [OrganizationBase].[IsAllMoneyDecimal],
    [OrganizationBase].[IsWriteInProductsAllowed],
    [OrganizationBase].[IsGeospatialAzureMapsIntegrationEnabled],
    [OrganizationBase].[AuditRetentionPeriodV2],
    [OrganizationBase].[IsModelDrivenAppsInMSTeamsEnabled],
    [OrganizationBase].[AppointmentRichEditorExperience],
    [OrganizationBase].[SchedulingEngine],
    [OrganizationBase].[MaxSLAItemsPerSLA]
from [OrganizationBase] 
    ...
    left join [SystemUserBase] [lk_organizationbase_createdby] on ([OrganizationBase].[CreatedBy] = [lk_organizationbase_createdby].[SystemUserId])
    left join [SystemUserBase] [lk_organizationbase_createdonbehalfby] on ([OrganizationBase].[CreatedOnBehalfBy] = [lk_organizationbase_createdonbehalfby].[SystemUserId])
    left join [SystemUserBase] [lk_organizationbase_modifiedby] on ([OrganizationBase].[ModifiedBy] = [lk_organizationbase_modifiedby].[SystemUserId])
    left join [SystemUserBase] [lk_organizationbase_modifiedonbehalfby] on ([OrganizationBase].[ModifiedOnBehalfBy] = [lk_organizationbase_modifiedonbehalfby].[SystemUserId])
