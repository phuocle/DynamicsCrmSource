...
--
-- base view for HierarchyRule
--
create view dbo.[HierarchyRule]
 (
    -- logical attributes
    [OrganizationIdName],
...
from [HierarchyRuleBase] [T1]
    left join [OrganizationBase] [organization_hierarchyrules] on ([T1].[OrganizationId] = [organization_hierarchyrules].[OrganizationId])
