...
from [ExternalPartyItemBase] 
    ...
    left join [SystemUserBase] [lk_externalpartyitem_createdby]  on ([ExternalPartyItemBase].[CreatedBy] = [lk_externalpartyitem_createdby].[SystemUserId])
    left join [SystemUserBase] [lk_externalpartyitem_createdonbehalfby]  on ([ExternalPartyItemBase].[CreatedOnBehalfBy] = [lk_externalpartyitem_createdonbehalfby].[SystemUserId])
    left join [SystemUserBase] [lk_externalpartyitem_modifiedby]  on ([ExternalPartyItemBase].[ModifiedBy] = [lk_externalpartyitem_modifiedby].[SystemUserId])
    left join [SystemUserBase] [lk_externalpartyitem_modifiedonbehalfby]  on ([ExternalPartyItemBase].[ModifiedOnBehalfBy] = [lk_externalpartyitem_modifiedonbehalfby].[SystemUserId])
