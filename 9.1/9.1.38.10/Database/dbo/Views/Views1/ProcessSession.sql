...
from [ProcessSessionBase] 
    left join [SystemUserBase] [lk_processsession_canceledby] on ([ProcessSessionBase].[CanceledBy] = [lk_processsession_canceledby].[SystemUserId])
    left join [SystemUserBase] [lk_processsession_completedby] on ([ProcessSessionBase].[CompletedBy] = [lk_processsession_completedby].[SystemUserId])
    left join [SystemUserBase] [lk_processsession_createdby] on ([ProcessSessionBase].[CreatedBy] = [lk_processsession_createdby].[SystemUserId])
    left join [SystemUserBase] [lk_processsession_executedby] on ([ProcessSessionBase].[ExecutedBy] = [lk_processsession_executedby].[SystemUserId])
    left join [SystemUserBase] [lk_processsession_modifiedby] on ([ProcessSessionBase].[ModifiedBy] = [lk_processsession_modifiedby].[SystemUserId])
    ...
    left join [SystemUserBase] [lk_processsession_startedby] on ([ProcessSessionBase].[StartedBy] = [lk_processsession_startedby].[SystemUserId])
    left join [SystemUserBase] [lk_processsessionbase_createdonbehalfby] on ([ProcessSessionBase].[CreatedOnBehalfBy] = [lk_processsessionbase_createdonbehalfby].[SystemUserId])
    left join [SystemUserBase] [lk_processsessionbase_modifiedonbehalfby] on ([ProcessSessionBase].[ModifiedOnBehalfBy] = [lk_processsessionbase_modifiedonbehalfby].[SystemUserId])
    left join OwnerBase XXowner on ([ProcessSessionBase].OwnerId = XXowner.OwnerId)
