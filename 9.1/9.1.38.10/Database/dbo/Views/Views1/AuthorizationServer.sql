...
select
    ...
    [AuthorizationServerBase].[VersionNumber]
from [AuthorizationServerBase] 
    left join [SystemUserBase] [lk_authorizationserver_createdby]  on ([AuthorizationServerBase].[CreatedBy] = [lk_authorizationserver_createdby].[SystemUserId])
    left join [SystemUserBase] [lk_authorizationserver_createdonbehalfby]  on ([AuthorizationServerBase].[CreatedOnBehalfBy] = [lk_authorizationserver_createdonbehalfby].[SystemUserId])
    left join [SystemUserBase] [lk_authorizationserver_modifiedby]  on ([AuthorizationServerBase].[ModifiedBy] = [lk_authorizationserver_modifiedby].[SystemUserId])
    left join [SystemUserBase] [lk_authorizationserver_modifiedonbehalfby]  on ([AuthorizationServerBase].[ModifiedOnBehalfBy] = [lk_authorizationserver_modifiedonbehalfby].[SystemUserId])
    left join [OrganizationBase] [lk_authorizationserver_organizationid]  on ([AuthorizationServerBase].[OrganizationId] = [lk_authorizationserver_organizationid].[OrganizationId])
