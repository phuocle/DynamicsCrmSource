...
from [msdyn_wallsavedqueryBase] 
    left join [SystemUserBase] [lk_msdyn_wallsavedquery_createdby] on ([msdyn_wallsavedqueryBase].[CreatedBy] = [lk_msdyn_wallsavedquery_createdby].[SystemUserId])
    left join [SystemUserBase] [lk_msdyn_wallsavedquery_createdonbehalfby] on ([msdyn_wallsavedqueryBase].[CreatedOnBehalfBy] = [lk_msdyn_wallsavedquery_createdonbehalfby].[SystemUserId])
    left join [SystemUserBase] [lk_msdyn_wallsavedquery_modifiedby] on ([msdyn_wallsavedqueryBase].[ModifiedBy] = [lk_msdyn_wallsavedquery_modifiedby].[SystemUserId])
    left join [SystemUserBase] [lk_msdyn_wallsavedquery_modifiedonbehalfby] on ([msdyn_wallsavedqueryBase].[ModifiedOnBehalfBy] = [lk_msdyn_wallsavedquery_modifiedonbehalfby].[SystemUserId])
    ...
    left join [OrganizationBase] [organization_msdyn_wallsavedquery] on ([msdyn_wallsavedqueryBase].[OrganizationId] = [organization_msdyn_wallsavedquery].[OrganizationId])
