...
from [ConnectionBase] 
    ...
    left join [SystemUserBase] [createdby_connection] on ([ConnectionBase].[CreatedBy] = [createdby_connection].[SystemUserId])
    ...
    left join [SystemUserBase] [lk_connectionbase_createdonbehalfby] on ([ConnectionBase].[CreatedOnBehalfBy] = [lk_connectionbase_createdonbehalfby].[SystemUserId])
    left join [SystemUserBase] [lk_connectionbase_modifiedonbehalfby] on ([ConnectionBase].[ModifiedOnBehalfBy] = [lk_connectionbase_modifiedonbehalfby].[SystemUserId])
    left join [SystemUserBase] [modifiedby_connection] on ([ConnectionBase].[ModifiedBy] = [modifiedby_connection].[SystemUserId])
    ...
    left join OwnerBase XXowner on ([ConnectionBase].OwnerId = XXowner.OwnerId)
