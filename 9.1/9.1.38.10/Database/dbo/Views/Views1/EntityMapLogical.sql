...
from [EntityMapBase] [T1]
    left join [SystemUserBase] [createdonbehalfby_entitymap] on ([T1].[CreatedOnBehalfBy] = [createdonbehalfby_entitymap].[SystemUserId])
    left join [SystemUserBase] [modifiedonbehalfby_entitymap] on ([T1].[ModifiedOnBehalfBy] = [modifiedonbehalfby_entitymap].[SystemUserId])
