...
select
    ...
    [PartnerApplicationBase].[VersionNumber]
from [PartnerApplicationBase] 
    left join [SystemUserBase] [lk_partnerapplication_createdby]  on ([PartnerApplicationBase].[CreatedBy] = [lk_partnerapplication_createdby].[SystemUserId])
    left join [SystemUserBase] [lk_partnerapplication_createdonbehalfby]  on ([PartnerApplicationBase].[CreatedOnBehalfBy] = [lk_partnerapplication_createdonbehalfby].[SystemUserId])
    left join [SystemUserBase] [lk_partnerapplication_modifiedby]  on ([PartnerApplicationBase].[ModifiedBy] = [lk_partnerapplication_modifiedby].[SystemUserId])
    left join [SystemUserBase] [lk_partnerapplication_modifiedonbehalfby]  on ([PartnerApplicationBase].[ModifiedOnBehalfBy] = [lk_partnerapplication_modifiedonbehalfby].[SystemUserId])
    left join [OrganizationBase] [lk_partnerapplication_organizationid]  on ([PartnerApplicationBase].[OrganizationId] = [lk_partnerapplication_organizationid].[OrganizationId])
