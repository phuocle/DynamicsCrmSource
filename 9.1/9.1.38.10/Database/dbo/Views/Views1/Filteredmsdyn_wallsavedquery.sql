...
from msdyn_wallsavedquery
    ...
    left outer join StringMap [msdyn_IsVirtualPLTable] on 
		...
		and [msdyn_IsVirtualPLTable].ObjectTypeCode = 10008
    ...
    left outer join StringMap [msdyn_IsVisiblePLTable] on 
		...
		and [msdyn_IsVisiblePLTable].ObjectTypeCode = 10008
    ...
    cross join dbo.fn_GetMaxPrivilegeDepthMask(10008) pdm
where
(
    -- privilege check
...
GO
GRANT SELECT
    ON OBJECT::[dbo].[Filteredmsdyn_wallsavedquery] TO [D365\ReportingGroup {17e68c54-332d-46c1-9c02-8ffa9543cd64}]
    AS [dbo];
