...
from [PrincipalObjectAttributeAccessBase] 
    left join [OrganizationBase] [lk_principalobjectattributeaccessbase_organizationid] on ([PrincipalObjectAttributeAccessBase].[OrganizationId] = [lk_principalobjectattributeaccessbase_organizationid].[OrganizationId])
    left join [SystemUserBase] [systemuser_principalobjectattributeaccess_principalid] on ([PrincipalObjectAttributeAccessBase].[PrincipalId] = [systemuser_principalobjectattributeaccess_principalid].[SystemUserId])
