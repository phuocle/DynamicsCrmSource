...
from [GoalRollupQueryBase] 
    left join [SystemUserBase] [lk_goalrollupquery_createdby]  on ([GoalRollupQueryBase].[CreatedBy] = [lk_goalrollupquery_createdby].[SystemUserId])
    left join [SystemUserBase] [lk_goalrollupquery_createdonbehalfby]  on ([GoalRollupQueryBase].[CreatedOnBehalfBy] = [lk_goalrollupquery_createdonbehalfby].[SystemUserId])
    left join [SystemUserBase] [lk_goalrollupquery_modifiedby]  on ([GoalRollupQueryBase].[ModifiedBy] = [lk_goalrollupquery_modifiedby].[SystemUserId])
    left join [SystemUserBase] [lk_goalrollupquery_modifiedonbehalfby]  on ([GoalRollupQueryBase].[ModifiedOnBehalfBy] = [lk_goalrollupquery_modifiedonbehalfby].[SystemUserId])
    left join OwnerBase XXowner  on ([GoalRollupQueryBase].OwnerId = XXowner.OwnerId)
