...
--
-- base view for AdvancedSimilarityRule
--
create view dbo.[AdvancedSimilarityRule]
 (
    -- logical attributes
    [CreatedByName],
...
from [AdvancedSimilarityRuleBase] [T1]
    ...
    left join [SystemUserBase] [lk_advancedsimilarityrule_createdby] on ([T1].[CreatedBy] = [lk_advancedsimilarityrule_createdby].[SystemUserId])
    left join [SystemUserBase] [lk_advancedsimilarityrule_createdonbehalfby] on ([T1].[CreatedOnBehalfBy] = [lk_advancedsimilarityrule_createdonbehalfby].[SystemUserId])
    left join [SystemUserBase] [lk_advancedsimilarityrule_modifiedby] on ([T1].[ModifiedBy] = [lk_advancedsimilarityrule_modifiedby].[SystemUserId])
    left join [SystemUserBase] [lk_advancedsimilarityrule_modifiedonbehalfby] on ([T1].[ModifiedOnBehalfBy] = [lk_advancedsimilarityrule_modifiedonbehalfby].[SystemUserId])
    left join [OrganizationBase] [organization_advancedsimilarityrule] on ([T1].[OrganizationId] = [organization_advancedsimilarityrule].[OrganizationId])
