...
from [PluginTypeBase] [T1]
    left join [SystemUserBase] [createdby_plugintype] on ([T1].[CreatedBy] = [createdby_plugintype].[SystemUserId])
    left join [SystemUserBase] [createdonbehalfby_plugintype] on ([T1].[CreatedOnBehalfBy] = [createdonbehalfby_plugintype].[SystemUserId])
    left join [SystemUserBase] [modifiedby_plugintype] on ([T1].[ModifiedBy] = [modifiedby_plugintype].[SystemUserId])
    left join [SystemUserBase] [modifiedonbehalfby_plugintype] on ([T1].[ModifiedOnBehalfBy] = [modifiedonbehalfby_plugintype].[SystemUserId])
