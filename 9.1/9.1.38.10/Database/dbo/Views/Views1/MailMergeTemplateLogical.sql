...
--
-- logical view for MailMergeTemplateLogical
--
create view dbo.[MailMergeTemplateLogical]
 (
    -- logical attributes
    [ModifiedByName],
    [CreatedByYomiName],
...
from [MailMergeTemplateBase] [T1]
    left join [SystemUserBase] [lk_mailmergetemplatebase_createdby] on ([T1].[CreatedBy] = [lk_mailmergetemplatebase_createdby].[SystemUserId])
    left join [SystemUserBase] [lk_mailmergetemplatebase_createdonbehalfby] on ([T1].[CreatedOnBehalfBy] = [lk_mailmergetemplatebase_createdonbehalfby].[SystemUserId])
    left join [SystemUserBase] [lk_mailmergetemplatebase_modifiedby] on ([T1].[ModifiedBy] = [lk_mailmergetemplatebase_modifiedby].[SystemUserId])
    left join [SystemUserBase] [lk_mailmergetemplatebase_modifiedonbehalfby] on ([T1].[ModifiedOnBehalfBy] = [lk_mailmergetemplatebase_modifiedonbehalfby].[SystemUserId])
