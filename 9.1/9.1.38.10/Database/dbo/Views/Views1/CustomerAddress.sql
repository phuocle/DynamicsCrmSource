...
from [CustomerAddressBase] 
    ...
    left join [SystemUserBase] [lk_customeraddressbase_createdby] on ([CustomerAddressBase].[CreatedBy] = [lk_customeraddressbase_createdby].[SystemUserId])
    left join [SystemUserBase] [lk_customeraddressbase_createdonbehalfby] on ([CustomerAddressBase].[CreatedOnBehalfBy] = [lk_customeraddressbase_createdonbehalfby].[SystemUserId])
    left join [SystemUserBase] [lk_customeraddressbase_modifiedby] on ([CustomerAddressBase].[ModifiedBy] = [lk_customeraddressbase_modifiedby].[SystemUserId])
    left join [SystemUserBase] [lk_customeraddressbase_modifiedonbehalfby] on ([CustomerAddressBase].[ModifiedOnBehalfBy] = [lk_customeraddressbase_modifiedonbehalfby].[SystemUserId])
