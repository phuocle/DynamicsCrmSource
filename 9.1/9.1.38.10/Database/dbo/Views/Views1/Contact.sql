...
select
    ...
    [ContactBase].[TeamsFollowed],
    [ContactBase].[BusinessCard],
    [ContactBase].[BusinessCardAttributes],
    [ContactBase].[msdyn_orgchangestatus]
from [ContactBase] 
    ...
    left join [SystemUserBase] [lk_contactbase_createdby] on ([ContactBase].[CreatedBy] = [lk_contactbase_createdby].[SystemUserId])
    left join [SystemUserBase] [lk_contactbase_createdonbehalfby] on ([ContactBase].[CreatedOnBehalfBy] = [lk_contactbase_createdonbehalfby].[SystemUserId])
    left join [SystemUserBase] [lk_contactbase_modifiedby] on ([ContactBase].[ModifiedBy] = [lk_contactbase_modifiedby].[SystemUserId])
    left join [SystemUserBase] [lk_contactbase_modifiedonbehalfby] on ([ContactBase].[ModifiedOnBehalfBy] = [lk_contactbase_modifiedonbehalfby].[SystemUserId])
    ...
    left join [SystemUserBase] [system_user_contacts] on ([ContactBase].[PreferredSystemUserId] = [system_user_contacts].[SystemUserId])
    ...
    left join OwnerBase XXowner on ([ContactBase].OwnerId = XXowner.OwnerId)
