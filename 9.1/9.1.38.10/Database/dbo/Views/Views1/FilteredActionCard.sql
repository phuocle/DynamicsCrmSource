...
select
    ...
    [ActionCard].[msdyn_actioncardregardingid],
    [ActionCard].[msdyn_regardingobjectid],
    [ActionCard].[msdyn_regardingobjectlogicalname],
    ...
    [ActionCard].[ParentRegardingObjectId],
    [ActionCard].[ParentRegardingObjectIdData],
    [ActionCard].[ParentRegardingObjectTypeCode],
    [ActionCard].[Priority],
    [ActionCard].[RecordId],
    [ActionCard].[RecordIdName],
    [ActionCard].[RecordIdObjectTypeCode],
    [ActionCard].[RecordIdObjectTypeCode2],
...
(
	...
	(
		...
		[ActionCard].[OwningBusinessUnit] in (select BusinessUnitId from SystemUserBusinessUnitEntityMap where SystemUserId = u.SystemUserId and ObjectTypeCode = 9962)
	) 
	or
	(
		-- global security
...
GO
GRANT SELECT
    ON OBJECT::[dbo].[FilteredActionCard] TO [D365\ReportingGroup {17e68c54-332d-46c1-9c02-8ffa9543cd64}]
    AS [dbo];
