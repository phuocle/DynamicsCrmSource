...
from [KbArticleBase] 
    ...
    left join [SystemUserBase] [lk_kbarticlebase_createdby]  on ([KbArticleBase].[CreatedBy] = [lk_kbarticlebase_createdby].[SystemUserId])
    left join [SystemUserBase] [lk_kbarticlebase_createdonbehalfby]  on ([KbArticleBase].[CreatedOnBehalfBy] = [lk_kbarticlebase_createdonbehalfby].[SystemUserId])
    left join [SystemUserBase] [lk_kbarticlebase_modifiedby]  on ([KbArticleBase].[ModifiedBy] = [lk_kbarticlebase_modifiedby].[SystemUserId])
    left join [SystemUserBase] [lk_kbarticlebase_modifiedonbehalfby]  on ([KbArticleBase].[ModifiedOnBehalfBy] = [lk_kbarticlebase_modifiedonbehalfby].[SystemUserId])
