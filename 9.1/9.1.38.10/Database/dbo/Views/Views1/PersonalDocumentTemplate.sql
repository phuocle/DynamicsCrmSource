...
from [PersonalDocumentTemplateBase] 
    left join [SystemUserBase] [lk_personaldocumenttemplatebase_createdby] on ([PersonalDocumentTemplateBase].[CreatedBy] = [lk_personaldocumenttemplatebase_createdby].[SystemUserId])
    left join [SystemUserBase] [lk_personaldocumenttemplatebase_createdonbehalfby] on ([PersonalDocumentTemplateBase].[CreatedOnBehalfBy] = [lk_personaldocumenttemplatebase_createdonbehalfby].[SystemUserId])
    left join [SystemUserBase] [lk_personaldocumenttemplatebase_modifiedby] on ([PersonalDocumentTemplateBase].[ModifiedBy] = [lk_personaldocumenttemplatebase_modifiedby].[SystemUserId])
    left join [SystemUserBase] [lk_personaldocumenttemplatebase_modifiedonbehalfby] on ([PersonalDocumentTemplateBase].[ModifiedOnBehalfBy] = [lk_personaldocumenttemplatebase_modifiedonbehalfby].[SystemUserId])
    left join OwnerBase XXowner on ([PersonalDocumentTemplateBase].OwnerId = XXowner.OwnerId)
