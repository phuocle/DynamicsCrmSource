...
select
    ...
    dbo.fn_UTCToTzCodeSpecificLocalTime([PublisherAddress].[CreatedOn],
			us.TimeZoneCode),
    ...
    dbo.fn_UTCToTzCodeSpecificLocalTime([PublisherAddress].[ModifiedOn],
			us.TimeZoneCode),
...
GO
GRANT SELECT
    ON OBJECT::[dbo].[FilteredPublisherAddress] TO [D365\ReportingGroup {17e68c54-332d-46c1-9c02-8ffa9543cd64}]
    AS [dbo];
