...
from [PublisherBase] 
    ...
    left join [SystemUserBase] [lk_publisher_createdby] on ([PublisherBase].[CreatedBy] = [lk_publisher_createdby].[SystemUserId])
    ...
    left join [SystemUserBase] [lk_publisher_modifiedby] on ([PublisherBase].[ModifiedBy] = [lk_publisher_modifiedby].[SystemUserId])
    left join [SystemUserBase] [lk_publisherbase_createdonbehalfby] on ([PublisherBase].[CreatedOnBehalfBy] = [lk_publisherbase_createdonbehalfby].[SystemUserId])
    left join [SystemUserBase] [lk_publisherbase_modifiedonbehalfby] on ([PublisherBase].[ModifiedOnBehalfBy] = [lk_publisherbase_modifiedonbehalfby].[SystemUserId])
    left join [OrganizationBase] [organization_publisher] on ([PublisherBase].[OrganizationId] = [organization_publisher].[OrganizationId])
