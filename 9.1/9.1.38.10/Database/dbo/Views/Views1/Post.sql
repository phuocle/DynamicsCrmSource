...
from [PostBase] 
    left join [SystemUserBase] [lk_post_createdby]  on ([PostBase].[CreatedBy] = [lk_post_createdby].[SystemUserId])
    left join [SystemUserBase] [lk_post_createdonbehalfby]  on ([PostBase].[CreatedOnBehalfBy] = [lk_post_createdonbehalfby].[SystemUserId])
    left join [SystemUserBase] [lk_post_modifiedby]  on ([PostBase].[ModifiedBy] = [lk_post_modifiedby].[SystemUserId])
    left join [SystemUserBase] [lk_post_modifiedonbehalfby]  on ([PostBase].[ModifiedOnBehalfBy] = [lk_post_modifiedonbehalfby].[SystemUserId])
    left join [OrganizationBase] [organization_post]  on ([PostBase].[OrganizationId] = [organization_post].[OrganizationId])
