...
from [BusinessUnitBase] 
    ...
    left join [SystemUserBase] [lk_businessunitbase_createdby] on ([BusinessUnitBase].[CreatedBy] = [lk_businessunitbase_createdby].[SystemUserId])
    left join [SystemUserBase] [lk_businessunitbase_createdonbehalfby] on ([BusinessUnitBase].[CreatedOnBehalfBy] = [lk_businessunitbase_createdonbehalfby].[SystemUserId])
    left join [SystemUserBase] [lk_businessunitbase_modifiedby] on ([BusinessUnitBase].[ModifiedBy] = [lk_businessunitbase_modifiedby].[SystemUserId])
    left join [SystemUserBase] [lk_businessunitbase_modifiedonbehalfby] on ([BusinessUnitBase].[ModifiedOnBehalfBy] = [lk_businessunitbase_modifiedonbehalfby].[SystemUserId])
