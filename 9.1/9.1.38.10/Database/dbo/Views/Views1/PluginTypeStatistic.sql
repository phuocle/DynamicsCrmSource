...
from [PluginTypeStatisticBase] 
    left join [SystemUserBase] [createdby_plugintypestatistic]  on ([PluginTypeStatisticBase].[CreatedBy] = [createdby_plugintypestatistic].[SystemUserId])
    left join [SystemUserBase] [lk_plugintypestatisticbase_createdonbehalfby]  on ([PluginTypeStatisticBase].[CreatedOnBehalfBy] = [lk_plugintypestatisticbase_createdonbehalfby].[SystemUserId])
    left join [SystemUserBase] [lk_plugintypestatisticbase_modifiedonbehalfby]  on ([PluginTypeStatisticBase].[ModifiedOnBehalfBy] = [lk_plugintypestatisticbase_modifiedonbehalfby].[SystemUserId])
    left join [SystemUserBase] [modifiedby_plugintypestatistic]  on ([PluginTypeStatisticBase].[ModifiedBy] = [modifiedby_plugintypestatistic].[SystemUserId])
