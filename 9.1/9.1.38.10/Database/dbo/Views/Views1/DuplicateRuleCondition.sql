...
from [DuplicateRuleConditionBase] 
    ...
    left join [SystemUserBase] [lk_duplicateruleconditionbase_createdby] on ([DuplicateRuleConditionBase].[CreatedBy] = [lk_duplicateruleconditionbase_createdby].[SystemUserId])
    left join [SystemUserBase] [lk_duplicateruleconditionbase_createdonbehalfby] on ([DuplicateRuleConditionBase].[CreatedOnBehalfBy] = [lk_duplicateruleconditionbase_createdonbehalfby].[SystemUserId])
    left join [SystemUserBase] [lk_duplicateruleconditionbase_modifiedby] on ([DuplicateRuleConditionBase].[ModifiedBy] = [lk_duplicateruleconditionbase_modifiedby].[SystemUserId])
    left join [SystemUserBase] [lk_duplicateruleconditionbase_modifiedonbehalfby] on ([DuplicateRuleConditionBase].[ModifiedOnBehalfBy] = [lk_duplicateruleconditionbase_modifiedonbehalfby].[SystemUserId])
