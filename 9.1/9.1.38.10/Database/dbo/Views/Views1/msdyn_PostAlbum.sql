...
from [msdyn_PostAlbumBase] 
    left join [SystemUserBase] [lk_msdyn_postalbum_createdby] on ([msdyn_PostAlbumBase].[CreatedBy] = [lk_msdyn_postalbum_createdby].[SystemUserId])
    left join [SystemUserBase] [lk_msdyn_postalbum_createdonbehalfby] on ([msdyn_PostAlbumBase].[CreatedOnBehalfBy] = [lk_msdyn_postalbum_createdonbehalfby].[SystemUserId])
    left join [SystemUserBase] [lk_msdyn_postalbum_modifiedby] on ([msdyn_PostAlbumBase].[ModifiedBy] = [lk_msdyn_postalbum_modifiedby].[SystemUserId])
    left join [SystemUserBase] [lk_msdyn_postalbum_modifiedonbehalfby] on ([msdyn_PostAlbumBase].[ModifiedOnBehalfBy] = [lk_msdyn_postalbum_modifiedonbehalfby].[SystemUserId])
    left join OwnerBase XXowner on ([msdyn_PostAlbumBase].OwnerId = XXowner.OwnerId)
