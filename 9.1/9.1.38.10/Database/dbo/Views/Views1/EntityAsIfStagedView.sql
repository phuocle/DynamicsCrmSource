...
create view dbo.[EntityAsIfStagedView] as SELECT A1.* FROM (SELECT * FROM [Entity] WHERE OverwriteTime = 0) A1 LEFT OUTER JOIN (SELECT * FROM [Entity] WHERE OverwriteTime = 0) A2 ON
