...
--
-- base view for MobileOfflineProfileItemAssociation
--
create view dbo.[MobileOfflineProfileItemAssociation]
 (
    -- logical attributes
    [ModifiedByName],
    [ModifiedByYomiName],
...
from [MobileOfflineProfileItemAssociationBase] [T1]
    left join [SystemUserBase] [lk_MobileOfflineProfileItemAssociation_createdby] on ([T1].[CreatedBy] = [lk_MobileOfflineProfileItemAssociation_createdby].[SystemUserId])
    left join [SystemUserBase] [lk_mobileofflineprofileitemassociation_createdonbehalfby] on ([T1].[CreatedOnBehalfBy] = [lk_mobileofflineprofileitemassociation_createdonbehalfby].[SystemUserId])
    left join [SystemUserBase] [lk_mobileofflineprofileitemassociation_modifiedby] on ([T1].[ModifiedBy] = [lk_mobileofflineprofileitemassociation_modifiedby].[SystemUserId])
    left join [SystemUserBase] [lk_mobileofflineprofileitemassociation_modifiedonbehalfby] on ([T1].[ModifiedOnBehalfBy] = [lk_mobileofflineprofileitemassociation_modifiedonbehalfby].[SystemUserId])
    ...
    left join [OrganizationBase] [MobileOfflineProfileItemAssociation_organization] on ([T1].[OrganizationId] = [MobileOfflineProfileItemAssociation_organization].[OrganizationId])
