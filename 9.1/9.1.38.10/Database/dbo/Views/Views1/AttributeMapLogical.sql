...
from [AttributeMapBase] [T1]
    left join [SystemUserBase] [createdonbehalfby_attributemap] on ([T1].[CreatedOnBehalfBy] = [createdonbehalfby_attributemap].[SystemUserId])
    left join [SystemUserBase] [modifiedonbehalfby_attributemap] on ([T1].[ModifiedOnBehalfBy] = [modifiedonbehalfby_attributemap].[SystemUserId])
