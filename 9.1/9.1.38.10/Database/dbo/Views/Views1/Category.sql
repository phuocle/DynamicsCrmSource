...
from [CategoryBase] 
    ...
    left join [SystemUserBase] [lk_category_createdby]  on ([CategoryBase].[CreatedBy] = [lk_category_createdby].[SystemUserId])
    left join [SystemUserBase] [lk_category_createdonbehalfby]  on ([CategoryBase].[CreatedOnBehalfBy] = [lk_category_createdonbehalfby].[SystemUserId])
    left join [SystemUserBase] [lk_category_modifiedby]  on ([CategoryBase].[ModifiedBy] = [lk_category_modifiedby].[SystemUserId])
    left join [SystemUserBase] [lk_category_modifiedonbehalfby]  on ([CategoryBase].[ModifiedOnBehalfBy] = [lk_category_modifiedonbehalfby].[SystemUserId])
    ...
    left join OwnerBase XXowner  on ([CategoryBase].OwnerId = XXowner.OwnerId)
