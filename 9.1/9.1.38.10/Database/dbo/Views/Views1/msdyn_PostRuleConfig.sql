...
from [msdyn_PostRuleConfigBase] 
    left join [SystemUserBase] [lk_msdyn_postruleconfig_createdby] on ([msdyn_PostRuleConfigBase].[CreatedBy] = [lk_msdyn_postruleconfig_createdby].[SystemUserId])
    left join [SystemUserBase] [lk_msdyn_postruleconfig_createdonbehalfby] on ([msdyn_PostRuleConfigBase].[CreatedOnBehalfBy] = [lk_msdyn_postruleconfig_createdonbehalfby].[SystemUserId])
    left join [SystemUserBase] [lk_msdyn_postruleconfig_modifiedby] on ([msdyn_PostRuleConfigBase].[ModifiedBy] = [lk_msdyn_postruleconfig_modifiedby].[SystemUserId])
    left join [SystemUserBase] [lk_msdyn_postruleconfig_modifiedonbehalfby] on ([msdyn_PostRuleConfigBase].[ModifiedOnBehalfBy] = [lk_msdyn_postruleconfig_modifiedonbehalfby].[SystemUserId])
    ...
    left join [OrganizationBase] [organization_msdyn_postruleconfig] on ([msdyn_PostRuleConfigBase].[OrganizationId] = [organization_msdyn_postruleconfig].[OrganizationId])
