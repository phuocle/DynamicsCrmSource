...
from msdyn_PostRuleConfig
    ...
    left outer join StringMap [msdyn_PostToYammerPLTable] on 
		...
		and [msdyn_PostToYammerPLTable].ObjectTypeCode = 10007
...
GO
GRANT SELECT
    ON OBJECT::[dbo].[Filteredmsdyn_PostRuleConfig] TO [D365\ReportingGroup {17e68c54-332d-46c1-9c02-8ffa9543cd64}]
    AS [dbo];
