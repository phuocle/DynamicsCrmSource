...
select
    ...
    [WorkflowLog].[ErrorText],
    [WorkflowLog].[Inputs],
    [WorkflowLog].[Inputs_Name],
    [WorkflowLog].[InteractionActivityResult],
    [WorkflowLog].[IterationCount],
    [WorkflowLog].[Message],
    ...
    [WorkflowLog].[RepetitionCount],
    [WorkflowLog].[RepetitionId],
...
GO
GRANT SELECT
    ON OBJECT::[dbo].[FilteredWorkflowLog] TO [D365\ReportingGroup {17e68c54-332d-46c1-9c02-8ffa9543cd64}]
    AS [dbo];
