...
var imgNames = new Array("/_imgs/ico_16_calmonth.gif", "/_imgs/ico_16_calweek.gif", "/_imgs/ico_16_calday.gif");
...
$get('DateCalendar').contentWindow.location.href = Mscrm.CrmUri.create("/calendar/" + CrmEncodeDecode.CrmUrlEncode(_sViewMode) + ".aspx?date=" + CrmEncodeDecode.CrmUrlEncode(FormatUtcDate(D))).toString();
}
...
<a href="#" role="link" aria-labelledby="MonthViewSpanText" aria-describedby="MonthViewSpanText" onclick="new Sys.UI.DomEvent(event).preventDefault();"><img class="ms-crm-AlignToSpan"  alt="<loc:Text Encoding='HtmlAttribute' ResourceId='Web.Workplace.home_calendar.aspx_MonthAction' runat='server'/>" title="<loc:Text Encoding='HtmlAttribute' ResourceId='Web.Workplace.home_calendar.aspx_MonthAction' runat='server'/>" id="calrMonth" /></a>
<span id="MonthViewSpanText" tabindex="-1" class="ms-crm-AlignTo16Image"><loc:Text ResourceId="Web.Workplace.home_calendar.aspx_193" runat="server"/></span>
</li>
<li id="WeekView" onclick="SwapView('Week');">
<a href="#" role="link" aria-labelledby="WeekViewSpanText" aria-describedby="WeekViewSpanText" onclick="new Sys.UI.DomEvent(event).preventDefault();"><img class="ms-crm-AlignToSpan"  alt="<loc:Text Encoding='HtmlAttribute' ResourceId='Web.Workplace.home_calendar.aspx_WeekAction' runat='server'/>" title="<loc:Text Encoding='HtmlAttribute' ResourceId='Web.Workplace.home_calendar.aspx_WeekAction' runat='server'/>" id="calrWeek" /></a>
<span id="WeekViewSpanText" tabindex="-1" class="ms-crm-AlignTo16Image"><loc:Text ResourceId="Web.Workplace.home_calendar.aspx_196" runat="server"/></span>
</li>
<li id="DayView" onclick="SwapView('Day');">
<a href="#" role="link" aria-labelledby="DayViewSpanText" aria-describedby="DayViewSpanText" onclick="new Sys.UI.DomEvent(event).preventDefault();"><img class="ms-crm-AlignToSpan" alt="<loc:Text Encoding='HtmlAttribute' ResourceId='Web.Workplace.home_calendar.aspx_DayAction' runat='server'/>" title="<loc:Text Encoding='HtmlAttribute' ResourceId='Web.Workplace.home_calendar.aspx_DayAction' runat='server'/>" id="calrDay" /></a>
<span id="DayViewSpanText" tabindex="-1" class="ms-crm-AlignTo16Image"><loc:Text ResourceId="Web.Workplace.home_calendar.aspx_199" runat="server"/></span>
</li>
</ul>
<%
if( Microsoft.Crm.Security.User.GetPrivilege(Microsoft.Crm.Privileges.CreateActivity, Microsoft.Crm.Application.Security.UserInformation.Current) )
...
<a href="#" onclick="new Sys.UI.DomEvent(event).preventDefault();"><img class="ms-crm-AlignToSpan" alt="" src="/_imgs/ico_16_<%=Microsoft.Crm.Util.Appointment%>.gif"><span class="ms-crm-AlignTo16Image"><loc:EntityNameArgument runat="server" EntityNameFormatStyle="Singular" EntityType="appointment" /></span></a>
</li>
<li runat="server" id="CreateServiceActivityRow" onclick="CreateNewAppointment(ServiceAppointment)">
<a href="#" onclick="new Sys.UI.DomEvent(event).preventDefault();"><img class="ms-crm-AlignToSpan" alt="" src="/_imgs/ico_16_<%=Microsoft.Crm.Util.ServiceAppointment%>.gif"><span class="ms-crm-AlignTo16Image"><loc:EntityNameArgument runat="server" EntityNameFormatStyle="Singular" EntityType="serviceappointment" /></span></a>
</li>
</ul>
</div>
<%
