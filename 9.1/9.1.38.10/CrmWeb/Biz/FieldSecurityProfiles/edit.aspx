<%@ Page language="c#" Inherits="Microsoft.Crm.Web.BusinessManagement.FieldSecurityProfileDetailPage" %>
...
var _oId = new Array(<%= Microsoft.Crm.CrmEncodeDecode.CrmJavaScriptEncode(Request.QueryString["id"]) %>);
Sys.Application.add_load(WindowOnLoad);
Sys.Application.add_unload(WindowOnUnLoad);
function WindowOnLoad()
{
$addHandler($get("crmForm"), "submit", CancelFormSubmit);
}

function WindowOnUnLoad()
{
$removeHandler($get("crmForm"), "submit", CancelFormSubmit);
}
