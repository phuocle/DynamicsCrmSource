...
#MEQFActivitiesFlyout::-webkit-scrollbar
{
display:none;
}
...
{
<% if (CrmStyles.IsRightToLeft && !this.IsVisualRefreshEnabled) { %>
...
.SearchButton, #inputContainer, .meqfSearchTextBoxWidth
{
<% if (CrmStyles.IsRightToLeft) { %>
float: right;
<%} else { %>
...
.searchBoxHeader .leftcolumn .startwithrow
{
display: inline-block !important;
}
.searchBoxHeader .leftcolumn .searchboxrow
{
display: inline-block;
width: auto;
<% if (CrmStyles.IsRightToLeft) { %>
...
font-size: 14px;
line-height: 16px;
font: normal normal normal 14px / 20px <%= WebUtility.GetFontResourceForStyle("Microsoft_Crm_Web_Fonts")%>;
...
.searchBoxHeader .leftcolumn .searchboxrow .ms-crm-metaphor-searchBoxIconContainer .searchText
{
border-color: #BDC3C7 !important;
border-width: 1px;
}

.ms-crm-meqfFontMetaphor
{
...
float: left;
<% } %>
font: normal normal normal 18px/20px  <%= WebUtility.GetFontResourceForStyle("ProcessSwitcher_ProcessTitle.Font")%>, <%= WebUtility.GetFontResourceForStyle("Dynamic_Property_Flyout.Font")%>;
color: #505050;
}

.attributePrimary
{
font: normal normal normal 18px/20px  <%= WebUtility.GetFontResourceForStyle("Dynamic_Property_Flyout.Font")%>;
color: #505050;
margin-top: 0px;
<% if (Request.Browser.Browser == "Firefox" || Request.Browser.Browser == "IE") { %>
line-height:21.8px;
...
.RootView-workspace .listItem,
.RootView-searchPage .listItem,
.RootView-draftsPage .listItem
{
padding: 10px;
<% if (CrmStyles.IsRightToLeft) { %>
...
.panoramaContainer .panoramaContainer-content .panoramaItem
{
float: none;
}
...
{
margin: 0 auto;
margin-bottom: calc((100% - 1860px)/2);
width: 1860px;
}
