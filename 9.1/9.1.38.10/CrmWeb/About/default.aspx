	...
	<div runat="server" id="PageBody">
		...
		<col width="65px"><col>
							...
							<span id="USCanadaText"  runat="server">
								...
								<loc:Text ResourceId="AboutBox_US_Support_Message" runat="server">
									<loc:Argument runat="server">
										<a runat="server" class="ms-crm-Link" id="DynamicsCustomerSourceSupportLink" target="_blank" rel="noopener noreferrer" href="http://go.microsoft.com/fwlink/?LinkId=52446"><loc:Text ResourceId="AboutBox_US_Support_Message_MBS_CustomerSource" runat="server" /></a>
									</loc:Argument>								
									<loc:Argument runat="server"><a runat="server" class="ms-crm-Link" id="DynamicsSupportLink" target="_blank" rel="noopener noreferrer" href="http://go.microsoft.com/fwlink/?LinkId=50896&amp;clcid=0x409"><loc:Text ResourceId="AboutBox_US_Support_Message_MS_HelpSupport" runat="server" /></a></loc:Argument>
								</loc:Text>
								<br>
								<br>
							</span>
							<loc:Text ResourceId="AboutBox_International_Support_Message" runat="server">
								<loc:Argument runat="server"><a runat="server" class="ms-crm-Link" id="InternationalSupportLink" target="_blank" rel="noopener noreferrer" href="http://go.microsoft.com/fwlink/?LinkID=390992"><loc:Text ResourceId="AboutBox_International_Support_Message_MS_HelpSupport" runat="server" /></a></loc:Argument>
							</loc:Text>
							<br>
							<br>
							<loc:Text ResourceId="Web.About.default.aspx_88" runat="server"><loc:Argument runat="server"><a runat="server" class="ms-crm-Link" id="CrmLink" target="_blank" rel="noopener noreferrer" href="http://go.microsoft.com/fwlink/?LinkId=52444"><loc:Text ResourceId="AboutBox_AdditionInformation_Microsoft_CRM" runat="server" /></a></loc:Argument></loc:Text>
							<br>
							<span id="crmLiveText"  runat="server">
							<a class="ms-crm-Link" runat="server" id="PrivacyLinkLive" target="_blank" rel="noopener noreferrer"><loc:Text ResourceId="AboutBox_Privacy_CrmLive" runat="server" /></a>
							</span>
							<br><br>
			...
			<tr>
				<td></td>
				<td class="realm">
					<loc:Text ResourceId="Web.About.default.RealmID" Encoding="None" runat="server"/>  
					<span id="RealmID" runat="server"/>
				</td>
			</tr>
			<% } %>
			<tr>
