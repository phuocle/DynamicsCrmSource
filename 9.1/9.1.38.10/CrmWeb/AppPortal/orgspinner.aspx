...
<h1><loc:Text runat="server" ID="PageTitle" />
...
<div><loc:Text ResourceId="OrgWaiting.Organization.Bookmark.Instruction" runat="server"/></div>
<div class="padb5"></div>
<span class="LabelHeading"><asp:Literal ID="CrmLink" runat="server"/></span>
</div>
<div class="padb20"></div>
<div style="word-wrap:break-word;">
<div><loc:Text ResourceId="AppPortal.Office365.Instruction" runat="server"/></div>
<div class="padb5"></div>
<span class="LabelHeading"><asp:Literal ID="OSDPLink" runat="server"/></span>
</div>
</div>
</form>
</div>
