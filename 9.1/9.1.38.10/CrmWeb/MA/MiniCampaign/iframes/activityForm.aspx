...
var colgroup = data.querySelector('colgroup');
if(colgroup != null){
var col= colgroup.getElementsByTagName('col');
$.each(col,function(index,data){
var initialColWidth = data.getAttribute("width");
if(initialColWidth != null && initialColWidth.indexOf('%') == -1){


var newColWidth = ((initialColWidth - 15)/1.2);
if(newColWidth > 0){
data.setAttribute("width", newColWidth);
}
}
})
}
