...
<div id="noCardMessageDiv"><%= CrmEncodeDecode.CrmHtmlEncode(AppResourceManager.Default.GetString("DelveActionHub.NoRecordsMessage")) %></div>
</div>
</div>
</td>
</tr>
...
<div id="actionhubControlWallContainer" class="wallContainer" style="height:100%;">
</div>
