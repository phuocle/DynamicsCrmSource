...
{
if (!IsNull(window.parent.Mscrm.ReadFormUtilities) && window.parent.Mscrm.ReadFormUtilities.isRefreshForm())
{
window.parent.Mscrm.AddActivity.addActivityFromRefreshForm(Email, _guidContentId);
isEmailSent = true;
}
else if (!IsNull(window.parent.document.getElementById('crmFormSubmit')) && window.parent.document.getElementById('crmFormSubmit').crmFormSubmitId.value != "")
{
...
var messageSpan = Mscrm.Utilities.getChildElementsByClassName($get('mnuShowComments'), 'ms-crm-VS-MenuItem-Title')[1];
