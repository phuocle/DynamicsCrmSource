...
DIV.ms-crm-QuickForm-Container
{
position:absolute;
<% if (CrmStyles.IsRightToLeft) { %>
right:20px;
...
.ms-crm-Form-FooterContainer div.ms-crm-Inline-Value.ms-crm-Inline-Locked
{
<% if (CrmStyles.IsTextWrapEnabled) { %>
line-height: 16px;
max-height: 32px;
...
.refresh-form TD.ms-crm-quick-form-table-header-alignment
{
<% if (CrmStyles.IsRightToLeft) { %>
padding-right: 15px;
<% } else { %>
...
.refresh-form DIV.ms-crm-FieldLabel-LeftAlign.ms-crm-Field-Normal
{
padding-left: 0px;
padding-top: 10px;
}
...
.refresh-form table.ms-crm-QuickFormSection
{
margin: 0;
margin-top: 11px;
<% if (CrmStyles.IsRightToLeft) { %>
...
{
.NNN .ms-crm-quickform-resize-float
{
<% if (CrmStyles.IsRightToLeft) { %>
float :right;
<% } else { %>
...
.ms-crm-RefreshDialog-Main-Container table.ms-crm-FormSection {
border: none;
}


td.ms-crm-Field-Data-Print div.ms-crm-Field-Data-Print .containerClass
{
padding-bottom:20px;
}

div.ms-crm-Field-Data-Print div.ms-crm-Field-Data-Print .containerClass
{
padding-bottom:10px;
}

.ms-crm-Field-Data-Print .ms-crm-Field-Data-Print .containerClass iframe.ms-crm-Custom
{
padding-bottom:0px !important;
}

.containerPaddingOverrideClass {
margin: 0px -15px -10px -15px;
}

<% if (this.IsVisualRefreshEnabled) { %>

TABLE.ms-crm-FormSection[name="Responses"] tr:empty,
TABLE.ms-crm-FormSection[name="RESPONSES"] tr:empty,
TABLE.ms-crm-FormSection[name="members"] tr:empty,
TABLE.ms-crm-FormSection[name="campaigns"] tr:empty,
TABLE.ms-crm-FormSection[name="quickcampaigns"] tr:empty,
TABLE.ms-crm-FormSection[name="selectedMembers"] tr:empty,
TABLE.ms-crm-FormSection[name="excludedMembers"] tr:empty
{
height: 0px;
}

TABLE.ms-crm-FormSection[name="Responses"] tr td[toptdid="Responses_TopTD"],
TABLE.ms-crm-FormSection[name="RESPONSES"] tr td[toptdid="Responses_TopTD"],
TABLE.ms-crm-FormSection[name="members"] tr td[toptdid="accounts_TopTD"],
TABLE.ms-crm-FormSection[name="members"] tr td[toptdid="contacts_TopTD"],
TABLE.ms-crm-FormSection[name="members"] tr td[toptdid="leads_TopTD"],
TABLE.ms-crm-FormSection[name="campaigns"] tr td[toptdid="Campaigns_TopTD"],
TABLE.ms-crm-FormSection[name="quickcampaigns"] tr td[toptdid="QuickCampaigns_TopTD"],
TABLE.ms-crm-FormSection[name="selectedMembers"] tr td[toptdid="accounts_TopTD"],
TABLE.ms-crm-FormSection[name="excludedMembers"] tr td[toptdid="excluded_TopTD"]
{
padding-top: 0px;
}

<% if (Request.Browser.Browser == "IE" || Request.Browser.MajorVersion < 9) { %>
TABLE.ms-crm-FormSection[name="Responses"],
TABLE.ms-crm-FormSection[name="RESPONSES"],
TABLE.ms-crm-FormSection[name="members"],
TABLE.ms-crm-FormSection[name="campaigns"],
TABLE.ms-crm-FormSection[name="quickcampaigns"],
TABLE.ms-crm-FormSection[name="selectedMembers"],
TABLE.ms-crm-FormSection[name="excludedMembers"]
{
table-layout:auto !important;
}
<% }  %>

.refresh-form .ms-crm-FormBodyContainer TABLE.ms-crm-FormSection[name="EmailCaseConditions"],
.refresh-form .ms-crm-FormBodyContainer TABLE.ms-crm-FormSection[name="AutoResponseSettings"]{
table-layout: auto !important;
}

@media screen and (max-width: 1028px)
{
DIV#general_content TABLE.ms-crm-FormSection TR TD.ms-crm-Field-Data-Print:not([colspan])
{
<% if (CrmStyles.IsRightToLeft) { %>
...
DIV#general_content TABLE.ms-crm-FormSection TR TD.ms-crm-Field-Data-Print:not([colspan]) DIV.ms-crm-Inline-Value
{
<% if (CrmStyles.IsRightToLeft) { %>
...
.ms-crm-RefreshDialog-Main-MDD DIV.ms-crm-FieldLabel-LeftAlign.ms-crm-Field-Normal
{
padding-left: 0px;
padding-top: 0px;
}

div#header_process_d.ms-crm-Field-Data-Print
{
<% if (Request.Browser.Browser != "IE") { %>
padding-top:12px;
<% }  %>
...
.W.ms-crm-InlineTabBody-Read #activityfeedscontrol_notescontrol_container .recordWall
{
overflow: auto;
}

.ms-crm-Form-Empty-Grey-Filler
{
width:100%;
...
.ms-crm-QuickForm-Empty-Grey-Filler
{
background-color: #FFFFFF;
}

DIV.ms-crm-readForm-Container
{
...
.refresh-form TD.ms-crm-QuickForm-Section-Print
{
...
TABLE.ms-crm-QuickFormSection.ms-crm-FormSectionNoBorder,
TABLE.ms-crm-FormSection .ms-crm-FormSection{
border:none !important;
}
...
TABLE.ms-crm-FormSection td#discountpercentage_d
{
padding: 10px;
}


TABLE.ms-crm-FormSection tr:nth-child(2) td[colspan]:not(#description_id_d):not(#regardingobjectid_d):not(#from_d):not(#requiredattendees_d):not(#subject_d):not(.ms-crm-Inline-DynamicGutter)
{
padding: 0px 15px 10px 15px !important;
}


table.ms-crm-FormSection tr:nth-child(2) td[colspan] div#description_d,
table.ms-crm-FormSection tr:nth-child(2) td[colspan] div#mapcontrol_d,
TABLE[name='product information'].ms-crm-FormSection tr:nth-child(2) td[colspan] div#name,
TABLE[name='product information'].ms-crm-FormSection tr:nth-child(2) td[colspan] SPAN.ms-crm-Inline-WarningIcon
{
padding-top: 10px;
}

TD.ms-crm-InlineDuration-IconCell{
padding:0px !important;
}

TABLE.ms-crm-QuickFormSection td
{
padding-top: 10px;
padding-bottom : 10px;
}

.ms-crm-Form-Quick .ms-crm-InlineTabContainer-Read
{
padding-left: 0px !important;
padding-right: 0px !important;
}

.ms-crm-Form-Quick .ms-crm-tabcolumn0
{
<% if (CrmStyles.IsRightToLeft) { %>
padding-right: 1px;
<% } else { %>
...
.ms-crm-Form-Quick .ms-crm-tabcolumn1,
.ms-crm-Form-Quick .ms-crm-tabcolumn2
{
<% if (CrmStyles.IsRightToLeft) { %>
padding-right: 15px;
<% } else { %>
...
.ms-crm-FormSection .qfclass-td-padding .ms-crm-QuickForm #formBodyContainerqf_fde_ .ms-crm-InlineTabContainer-Read
{
padding:0px !important;
margin-left:-15px;
margin-right:-15px;
...
.ms-crm-FormSection
.qfclass-td-padding TABLE.ms-crm-FormSection > TBODY > TR > TD
{
<% if (CrmStyles.IsRightToLeft) { %>
...
.ms-crm-Form-AreaContainer .ms-crm-FormSection td.ms-crm-ReadField-Normal
{
height: 17px;
}

TABLE.ms-crm-QuickFormSection.ms-crm-FormSectionNoBorder td.ms-crm-Field-Data-Print
{
<% if (CrmStyles.IsRightToLeft) { %>
padding-right:15px;
<% }else{ %>
...
TABLE.ms-crm-FormSection tr:first-child
{
height:40px;
}

#crmFormHeader tbody tr
{
<% if (Request.Browser.Browser != "IE") { %>
...
<% if (this.IsVisualRefreshEnabled) { %>
<% if (!string.IsNullOrEmpty(Request.UserAgent) && Request.UserAgent.IndexOf("Edge/12", StringComparison.OrdinalIgnoreCase) > -1) { %>
div.ms-crm-FormSection-Container table.ms-crm-FormSection[name="RESPONSES"]
{
table-layout:auto !important;
}
<% }  %>
...
DIV#formFooterContainer  TABLE.ms-crm-Form-StandaloneSection
{
padding-top: 0px !important;
}
}

.ms-crm-FormSection-Container table.ms-crm-FormSection tr.ms-crm-Form-SectionGapRow
{
height:5px;
}

.ms-crm-FormSection-Container table.ms-crm-FormSection tr.ms-crm-Form-SectionGapRow td
{
padding-top:0px;
padding-bottom:0px;
}
...
td.ms-crm-FieldLabel-LeftAlign{
position:relative;
}
...
.refresh-form  .ms-crm-RefreshDialog-Main-MDD .ms-crm-Inline-Edit .ms-crm-InlineInput
{
box-sizing: content-box;
}

.refresh-form  .ms-crm-RefreshDialog-Main-MDD TD.ms-crm-Form-Section,
.refresh-form .ms-crm-RefreshDialog-Main-MDD DIV.ms-crm-Form-Section
{
border:none;
}

td.ms-crm-Field-Data-Print div.ms-crm-Field-Data-Print .ms-crm-List-DataAreaEx-Lite .ms-crm-grid-Title-Data-Lite{
position: relative;
top: 50%;
text-align: center;
}

.ms-crm-quickform-twocolumns-divider
{
display: table-cell;
<% if (CrmStyles.IsRightToLeft) { %>
padding-left: 15px;
border-left:#BFC5C6 1px solid;
float:right;
<% } else { %>
padding-right: 15px;
border-right:#BFC5C6 1px solid;
float:left;
<% } %>
}

.ms-crm-quickform-divider
{
display: table-cell;
padding: 0px;
<% if (CrmStyles.IsRightToLeft) { %>
...
table.ms-crm-FormSection td.ms-crm-Inline-DynamicGutter
{
position:relative;
}

DIV#quickFormTemplate_contactquickform_quickform_contact TABLE.ms-crm-FormSection
{
margin-top: 0px;
}

DIV#quickFormTemplate_contactquickform_quickform_contact TABLE.ms-crm-FormSection TR.ms-crm-Form-SectionGapRow TD
{
padding : 0px;
}
...
@media screen and (max-width:1024px) and (min-width:768px)
{
.WN .ms-crm-tabcolumn0 .ms-crm-Form-Empty-Grey-Filler
{
display : none !important;
}
.NNN .ms-crm-tabcolumn2 .ms-crm-Form-Empty-Grey-Filler, .WN .ms-crm-tabcolumn1 .ms-crm-Form-Empty-Grey-Filler
{
display : none !important;
}
}
...
.refresh-form .tabsControl .tabsHeader {
border-spacing:0px;
}
