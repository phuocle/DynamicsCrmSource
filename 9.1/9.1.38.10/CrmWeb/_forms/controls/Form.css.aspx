...
.ms-crm-Field-Float.ms-crm-rightmostRow
{
<% if (CrmStyles.IsRightToLeft) { %>
float: left ;
<% } else { %>
...
{
.ms-crm-dashboardOddCell:not(.ms-crm-fullWidthRow),
.ms-crm-dashboardEvenCell:not(.ms-crm-fullWidthRow),
.ms-crm-dashboardFirstCell:not(.ms-crm-fullWidthRow)
{
width: 50%  !important;
<% if (CrmStyles.IsRightToLeft) { %>
...
span iframe#WebResource_PersonalWall {
height: auto;
}
...
.ms-crm-TabContainer .ms-crm-Field-Required Label,
.ms-crm-TabContainer .ms-crm-FieldLabel-LeftAlign Label{
<% if (CrmStyles.IsRightToLeft) { %>
padding-right:10px;
<% } else { %>
padding-left:10px;
...
.ms-crm-TabContainer .ms-crm-Field-Required Label img,
.ms-crm-TabContainer .ms-crm-FieldLabel-LeftAlign Label img{
position:absolute;
top :5px;
<% if (CrmStyles.IsRightToLeft) { %>
right:0;
...
#dashboardTable DIV.ms-crm-InlineTabContainer,
.ms-crm-metaphor-dashboard-container DIV.ms-crm-InlineTabContainer
{
padding: 10px;
background-color:#ffffff;
}

#dashboardTable DIV.ms-crm-InlineTab,
.ms-crm-metaphor-dashboard-container DIV.ms-crm-InlineTab
{
padding: 0px;
}

DIV.ms-crm-Field-Data-Print > span[type="subgrid"]{
border:1px solid #BFC5C6;
}

DIV.ms-crm-Field-Data-Print > span{
height:100%;
width:100%;
}

DIV.ms-crm-Field-Data-Print > span >img{
height:100% !important;
width:100% !important;
border:1px solid #BFC5C6;
}

DIV.ms-crm-Field-Data-Print > span >img.ms-crm-Lookup-Item{
height:auto !important;
width:auto !important;
border:0px;
}
