...
div.linkControlLabel , .processControlContainer .stageNameContent span{
font-size: <%= WebUtility.GetFontResourceForStyle("General.14px.font_size") %>;
}

.processControlContainer .collapsibleView .collapsibleFloatContainer .processActionsContainer .processName .processNameText span
{
font-size: <%= WebUtility.GetFontResourceForStyle("General.14px.font_size") %>;
}
...
div.ms-crm-IE7-Height-Fix-Dummy-Container-Ex > div#ActionCards_divDataBody
{
height: 145px;
}

div.ms-crm-IE7-Height-Fix-Dummy-Container-Ex > div#ActionCards_divDataArea
{
height: 202px;
}
.tabsControl .tabsContent .tabContainer #actionhubcontrol_notescontrol_container
{
height:100%;
overflow:hidden;
}
