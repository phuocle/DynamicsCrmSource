...
#cc_ContractCalendar>div:first-child
{
width:auto;
left:0px;
}
...
.ms-crm-RefreshDialog-Main-MDD .ms-crm-Inline-Value.ms-crm-Inline-FlowsValue
{
width: 97%;
height: 430px;
min-height: 16px;
...
border:			1px solid rgba(174, 174, 174, 1.0);
}
...
outline-offset: 2px;
outline-color:rgba(0, 120, 215, 1.0) !important;
<% if (Request.Browser.Browser == "IE") { %>
box-shadow: 0 0 0 2px #fff, 0 0 0 3px #BDC3C7;
<% } %>
}

.ms-crm-RefreshDialog-Button::-moz-focus-inner
{
border: 0;
}
...
TD.ms-crm-Dialog-Lookup-Types .ms-crm-SelectBox:disabled
{
...
div#DlgHdBodyContainer span#description_id{
...
div#DlgHdContainer div#DlgHdDesc{
...
.ms-crm-RefreshDialog-closeButton{
border: 0;
...
<% if(this.IsVisualRefreshEnabled) { %>
.ms-crm-RefreshDialog-Main-MDD table.ms-crm-FormSection tr:first-child
{
height:auto;
}
...
.ms-crm-RefreshDialog-Main-MDD table.ms-crm-InlineDuration-InputTable td,
.ms-crm-RefreshDialog-Main-MDD .ms-crm-Inline-Edit table.ms-crm-Duration td
{
padding: 0px;
}

.ms-crm-RefreshDialog-Main-MDD table.ms-crm-FormSection td .ms-crm-Inline-Edit,
.ms-crm-RefreshDialog-Main-MDD table.ms-crm-FormSection td .ms-crm-Inline-Edit.ms-crm-Inline-OptionSet
{
<% if (CrmStyles.IsRightToLeft) { %>
margin-right: 23px;
<% } else { %>
...
.ms-crm-RefreshDialog-Main-MDD #selectAttributeDescription_id,
.ms-crm-RefreshDialog-Main-MDD #specifyClosurePreferenceDescription_id,
.ms-crm-RefreshDialog-Main-MDD [id^="lbl_"]
{
<% if (CrmStyles.IsRightToLeft){ %>
padding-right: 15px;
<%} else { %>
...
.ms-crm-RefreshDialog-Main-MDD .ms-crm-Inline-Edit img.ms-crm-InlineLookupEdit
{
padding-top: 4px;
padding-bottom: 2px;
}
...
.ms-crm-RefreshDialog-Main-MDD td.FormSection_CellPadding Span#message_id,
.ms-crm-RefreshDialog-Main-MDD td.FormSection_CellPadding Span#lbl_textcancelcase
{
<% if (CrmStyles.IsRightToLeft) { %>
padding-right: 15px;
<% } else { %>
...
#description_id.ms-crm-TextAutoEllipsis-Multiline
{
overflow : visible !important;
}

.ms-crm-FormSection .FormSection_CellPadding span#lbl_fileuploadlimit
{
<% if (CrmStyles.IsRightToLeft) { %>
padding-right: 15px;
<% } else { %>
...
.ms-crm-RefreshDialog-TabHeader-MDD
{
top: -60px;
}

.ms-crm-RefreshDialog-Header-TabHeader-MDD
{
top: -18px;
}

.ms-crm-RefreshDialog-Main-MDD-TabHeader
{
top: 62px;
overflow: initial;
}

.ms-crm-RefreshDialog-Main-MDD-FormHeader
{
top: 62px;
}

.ms-crm-RefreshDialog-Main-MDD-FormHeader-TabHeader
{
top: 62px;
}

.ms-crm-RefreshDialog-Main-MDD-FormHeader-TabHeader.ms-crm-RefreshDialog-Main-MDD-TabFooter
{
height: calc(100% - 125px);
}

.ms-crm-RefreshDialog-Main-MDD-TabFooter
{
height: calc(100% - 62px);
}

.ms-crm-dynamics-sdk-address {
line-height: 12px;
padding-top:5px;
position:absolute;
bottom:0px;
