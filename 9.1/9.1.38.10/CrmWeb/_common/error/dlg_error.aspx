...
var opener = window.top.document.getElementById(window.opener.name)
if (opener != null && opener.parentNode != null) {
if (opener.src.indexOf("export_progress") != -1) {
Mscrm.InlineDialogUtility.close(opener.parentNode.id);
}
}
...
if (window.opener != null && window.opener.self != null && !IsNull(errInfo) && !isNullOrEmptyString(errorMsg)) {
...
var historyManager = window.top.$find("crmHistoryManager");


if(historyManager && historyManager.isFirstItem && historyManager.isFirstItem())
{
var okButton = document.getElementById("butBegin");
if(okButton)
{
var butDialogCopy = document.getElementById("butDialogCopy");
if (butDialogCopy)
{

butDialogCopy.style.marginLeft =  okButton.style.marginLeft;
butDialogCopy.style.marginRight =  okButton.style.marginRight;
}
...
|| errInfo.get_code() == "0x80044290" || errInfo.get_code() == "0x80044286" || errInfo.get_code() == "0x80092002" || errInfo.get_code() == "0x80060376"
|| errInfo.get_code() == "0x80061773" || errInfo.get_code() == "0x80071154") {
...
const errCode = errInfo.get_code();
if (errCode == "0x80061007" || errCode == "0x80071132" || errCode == "0x80071134" || errCode == "0x80071135" || errCode == "0x80071136" || errCode == "0x80071137" || errCode == "0x80071138" || errCode == "0x80071139" || errCode == "0x80071140" || errCode == "0x80071141" || errCode == "0x80071142")
{
...
else if ((errInfo.get_code() == "0x8004F020") && !IsNull(errInfo.get_description())) {

var url = '/WebResources/msdyn_/solutionlayers/index.html#/componentlayers/';
var parameters = errInfo.get_parameters();
var description = errInfo.get_description();

url = Xrm.Page.context.prependOrgName(url);
url += parameters[0] + '/' + parameters[1].split("(")[0];

var errorDetails = "";
errorDetails = description + " " + "<a style='color: #0000FF' href=" + url + " target='_blank'>" + CrmEncodeDecode.CrmHtmlEncode("<%=AppResourceManager.Default.GetString("Error_Message_0x8004f020_See_Solution_Layers")%>") + "</a>";

msg = errorDetails;
}
else if ((errInfo.get_code() == "0x80071151")
&& !IsNull(errInfo.get_description())
) {
var url = '/main.aspx?etn=msdyn_solutionhistory&page=Settings&pageType=EntityList&web=true'
var description = errInfo.get_description();


description = description.replace(" -- The solution installation or removal failed due to the installation or removal of another solution at the same time. Please try again later.", "");

url = Xrm.Page.context.prependOrgName(url);

var errorDetails = description + " " + "<a href=" + url + " target='_blank' style='text-decoration: underline;'>" + CrmEncodeDecode.CrmHtmlEncode("<%=AppResourceManager.Default.GetString("See_Solution_History")%>") + "</a>";
...
try {
var exceptionDetails = JSON.parse(serializedException);
if (exceptionDetails != null)
return exceptionDetails[nodeName];
else
return null;
}
catch (err) {
...
{
if (errorCode == "0X8004F976" || errorCode == "0X8003F452" || errorCode == "0X8003F451" || errorCode == "0X80044331"
|| errorCode == "0X8008100D" || errorCode == "0X8008100F" || errorCode == "0X8008100E" || errorCode == "0X8004F985"
|| errorCode == "0X80060861" || errorCode == "0X80060892" || errorCode == "0X80060893" || errorCode == "0X80060897"
|| errorCode == "0X800609A0" || errorCode == "0X8006098E" || errorCode == "0X80060441" || errorCode == "0X80060373"
|| errorCode == "0X80071123" || errorCode == "0X80071121" || errorCode == "0X80071119" || errorCode == "0X80060376")
{
return true;
}
return false;
