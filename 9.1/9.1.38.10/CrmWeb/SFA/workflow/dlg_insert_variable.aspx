...
sXml += "<VariableDataType>" + CrmEncodeDecode.CrmXmlEncode(oDataTypeCtrl.get_dataValue()) + "</VariableDataType>";
...
switch (dataType) {
case LOCID_VARIABLE_TEXT:
sXml += ((_variableDefaultValueText.get_dataValue() != null) ? CrmEncodeDecode.CrmXmlEncode(_variableDefaultValueText.get_dataValue()) : "");
break;
case LOCID_VARIABLE_INTEGER:
sXml += !IsNull(_variableDefaultValueInteger.get_dataValue()) ? _variableDefaultValueInteger.get_dataValue() : "";
break;
case LOCID_VARIABLE_FLOAT:
sXml += !IsNull(_variableDefaultValueFloat.get_dataValue()) ? _variableDefaultValueFloat.get_dataValue() : "";
break;
case LOCID_VARIABLE_DATEONLY:
...
_variableDefaultValueInteger.get_element().style.display = (dataType == LOCID_VARIABLE_INTEGER ? "inline" : "none");
