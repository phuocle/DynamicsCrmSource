...
PopulateSlugControlsWithCallback(CrmEncodeDecode.CrmXmlDecode(document.getElementById('hidSlugInfo').value), "deleteslugbody", OnAssigneeSlugDelete);
}
...
<tr>
<td style="padding:2px;"><div id="PublicationParameterArea" runat="server"></div></td>
</tr>
</table>
</td>
</tr>
...
<tr height="25">
<td><mnu:AppGridMenuBar id="WorkflowStepMenuBar" runat="server"/></td>
</tr>



<tr height="100%">
<td valign="top" style="height: 100%"><div id='gridDefinitionContainer' runat="server" class="wfWorkflowStepArea"></div></td>
</tr>
</table>
</div>
</td>
