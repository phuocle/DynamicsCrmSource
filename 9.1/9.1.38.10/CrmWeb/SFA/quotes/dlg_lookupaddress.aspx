...
_lookupAddress.AddParam("parentType", <%= Microsoft.Crm.CrmEncodeDecode.CrmJavaScriptEncode(_parentType) %>);
...
_oAddress.FreightTerms		= GetKeyValue(li.keyValues, "freighttermscode_Hidden");
_oAddress.ShippingMethod	= GetKeyValue(li.keyValues, "shippingmethodcode_Hidden");
...
{
$get("butBegin").disabled = !(<% if ( _headerForm ) { %> ( $get("BillTo").checked || $get("ShipTo").checked) && <% } %> _oAddress);
}
