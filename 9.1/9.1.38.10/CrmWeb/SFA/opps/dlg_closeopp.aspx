...
var actualrevenueValue = <%= Double.Parse(EstimatedRevenue, CultureInfo.InvariantCulture).ToString(CultureInfo.InvariantCulture) %>;
...
alert(formatString(LOCID_INCORRECT_ACTUAL_REVENUE, Mscrm.NumberUtility.addFormatting(_actualrevenueControl.get_min(), _actualrevenueControl.get_precision()), Mscrm.NumberUtility.addFormatting(_actualrevenueControl.get_max(), _actualrevenueControl.get_precision())));
}
<%}%>
if (isWon)
{
...
xml += "<activityid><%= SequentialGuid.CreateGuid().ToString("B", CultureInfo.InvariantCulture).ToUpper(CultureInfo.InvariantCulture).Replace("{", "").Replace("}", "") %></activityid>";
...
SetFieldRequiredOrRecommended($get('tdActualRevenue'), Mscrm.FormFieldType.FIELD_REQUIRED, LOCID_FORM_REQUIRED_ALT);
...
<col />
<tr height="20">
<td class="ms-crm-Field-Required"><label for="selWinStatus"><loc:Text ResourceId="Web.SFA.opps.dlg_closeopp.aspx_197" runat="server"/><img src="/_imgs/frm_required.gif" alt="<loc:Text Encoding='HtmlAttribute' ResourceId='Forms.Required.AltTag' runat='server'/>"/></label></td>
<td>
...
<tr>
<td id="tdActualRevenue" class="ms-crm-Field-Required"><label for="actualrevenue"><loc:Text ResourceId="Web.SFA.opps.dlg_closeopp.aspx_183" runat="server"/><img src="/_imgs/frm_required.gif" alt="<loc:Text Encoding='HtmlAttribute' ResourceId='Forms.Required.AltTag' runat='server'/>"/></label></td>
<td><sdk:MoneyControl tabindex="3" id="actualrevenue" runat="server"/></td>
</tr>
<tr>
<td id="tdCloseDate" class="ms-crm-Field-Required"><label for="actualend	"><loc:Text ResourceId="Web.SFA.opps.dlg_closeopp.aspx_187" runat="server"/><img src="/_imgs/frm_required.gif" alt="<loc:Text Encoding='HtmlAttribute' ResourceId='Forms.Required.AltTag' runat='server'/>"/></label></td>
<td><sdk:DateTimeControl TabIndex="4" id="actualend" runat="server" ShowTime="false"/></td>
</tr>
<tr>
<td id="tdCompetitor"><label for="crmLookup"><loc:Text ResourceId="Web.SFA.opps.dlg_closeopp.aspx_191" runat="server"/></label></td>
<td>
...
<td style="padding-top:20px" colspan="2"><label for="description"><loc:Text ResourceId="Web.SFA.salesorders.aspx_60.dlg_close" runat="server"/></label></td>
</tr>
<tr>
<td colspan="2" height="95px"><sdk:TextAreaControl TabIndex="6" id="description" MaxLength="2000" runat="server"/></td>
</tr>
</table>
