...
<title><loc:Text ResourceId="Web.Tools.FiscalSettings.Dialogs.fiscalsettings.aspx_10" runat="server"/></title>
...
retval += "<fiscalyeardisplaycode>" + Mscrm.FormControlInputBehavior.GetBehavior('selectFiscalYearDisplay').get_dataValue() + "</fiscalyeardisplaycode>";
retval += "<fiscalperiodformatperiod>" + $get("fiscalPeriodFormatPeriod").value + "</fiscalperiodformatperiod>";
retval += "<fiscalyearperiodconnect>" + Mscrm.FormControlInputBehavior.GetBehavior('selectFiscalYearPeriodConnect').get_dataValue() + "</fiscalyearperiodconnect>";
retval += "</organization>";
...
<tr>
<td class="ms-crm-Form-Section ms-crm-Form-SectionBar" colspan="5" valign="bottom"><loc:Text ResourceId="Web.Tools.FiscalSettings.Dialogs.fiscalsettings.aspx_235" runat="server"/>
</td>
</tr>
<tr>
<td id="fiscalstartdate_c" nowrap class="ms-crm-Field-Required" valign="center"><label for="fiscalStartDate"><loc:Text ResourceId="Web.Tools.FiscalSettings.Dialogs.fiscalsettings.aspx_104" runat="server"/><img src="/_imgs/frm_required.gif" alt="<loc:Text Encoding='HtmlAttribute' ResourceId='Forms.Required.AltTag' runat='server'/>"/></label></td>
<td valign="center">
...
<tr>
<td id="fiscalperiodtype_c" nowrap class="ms-crm-Field-Required" valign="center"><label for="selectFiscalPeriodType"><loc:Text ResourceId="Web.Tools.FiscalSettings.Dialogs.fiscalsettings.aspx_109" runat="server"/></label></td>
<td valign="center">
...
<tr>
<td class="ms-crm-Form-Section ms-crm-Form-SectionBar" colspan="5" valign="bottom"><BR><loc:Text ResourceId="Web.Tools.FiscalSettings.Dialogs.fiscalsettings.aspx_128" runat="server"/>
</td></tr>
<tr>
<td />
<td>
...
<tr>
<td id="namedbasedon_c" nowrap class="ms-crm-Field-Required" valign="center"><label for="selectFiscalYearDisplay"><loc:Text ResourceId="Web.Tools.FiscalSettings.Dialogs.fiscalsettings.aspx_115" runat="server"/></label></td>
<td valign="center">
...
<tr>
<td nowrap valign="center"><label for="selectFiscalYearPeriodConnect"><loc:Text ResourceId="Web.Tools.FiscalSettings.Dialogs.fiscalsettings.aspx_169" runat="server"/></label></td>
<td valign="center">
