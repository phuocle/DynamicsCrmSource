...
<html>
<head>
<title>Dynamics 365 Diagnostics</title>
<style type="text/css">
body
{
...
<script type="text/javascript" src="<%=GetJSPath("/_static/_common/scripts/MicrosoftAjax.js")%>"></script>
<script type="text/javascript" src="<%=GetJSPath("/_static/_common/scripts/Microsoft.Crm.Client.Core.js")%>"></script>
