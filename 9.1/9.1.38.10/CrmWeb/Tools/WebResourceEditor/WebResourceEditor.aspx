...
var _sName,_sDisplayName,_sDescription,_sType,_sLanguageCode,_sIsEnabledForMobileClient, _sIsAvailableForMobileOffline, _sDependencyXML;
...
if (typeof _sDependencyXML !== "string" || !_sDependencyXML)
{
_sDependencyXML = serializeWebResourceDependencyXML(createEmptyWebResourceDependencyXml());
}
...
docString += isNullOrEmptyString(doctypeObject.publicId) && !isNullOrEmptyString(doctypeObject.systemId) ? ' SYSTEM' : "";
...
if (IsNull(altText))
altText = "";
editor.InsertValue("<p><IMG height='50' alt='"+CrmEncodeDecode.CrmHtmlAttributeEncode(altText)+"' title='"+CrmEncodeDecode.CrmHtmlAttributeEncode(altText)+"' src="+CrmEncodeDecode.CrmHtmlAttributeEncode(src)+" width='60'> </IMG></p>");
break;
case 'hyperlink':
editor.InsertValue("<p><a href="+CrmEncodeDecode.CrmHtmlAttributeEncode(src)+">"+CrmEncodeDecode.CrmHtmlEncode(itemObj.name)+"</a></p>");
break;
}
}
}
...
<div class="ms-crm-dynamics-sdk-address">
<span>
