...
var activityFeedsService = window.ActivityFeeds && window.ActivityFeeds.Services
? ActivityFeeds.Services.IActivityFeedService
: window.parent.ActivityFeeds.Services.IActivityFeedService;
...
Xrm.Internal.trace.warning("YammerEmbed", "Yammer security check skipped: IActivityFeedService was not found");
return true;
}
...
Xrm.Internal.trace.log("YammerEmbed", "embedding Yammer with {0}", JSON.stringify(<%= FeedOptionsString %>));
pageState = "embedded";
}
}
