...
if (_bNewForm && (!isEntityDeprecated)) {
...
<table class="ms-crm-TemplateEditorTable ms-crm-ZeroedCellPadding ms-crm-ZeroedCellSpacing" style="position:fixed;top:48px;height:calc(100% - 48px)">
<%
}
else
{
...
{ %>
<asp:PlaceHolder id="deprecatedContent" runat="server"/>
<% } %>
</table>
