...
<page id="01">
<title><loc:Text ResourceId="NamePlural_ProdFamily" runat="server"/></title>
<icon>/_imgs/Tools/ico_product.gif</icon>
<help><loc:Text ResourceId="Web.Tools.ProductCatalog.productManager.Families.1" runat="server"/>
<loc:Text ResourceId="Web.Tools.ProductCatalog.productManager.Families.2" runat="server"/></help>
...
%>
<page id="06">
<title><loc:Text ResourceId="NamePlural_RecommendationModel" runat="server"/></title>
<icon>/_imgs/Tools/ProductRecommendations_48.png</icon>
<url>../RecommendationModel/RecommendationModelRedirectionPage.aspx</url>
<help><loc:Text ResourceId="NamePlural_RecommendationModel.Help" runat="server"/></help>
</page>
<%
}
%>
