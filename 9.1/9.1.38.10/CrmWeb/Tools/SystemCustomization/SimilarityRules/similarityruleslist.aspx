...
gridSimilarityRules.SetParameter("similarityFilter", Mscrm.FormControlInputBehavior.GetBehavior("selFilter").get_dataValue());
...
<tr>
<td class="similarityRuleList_td_Filter" style="white-space: nowrap" ><label for="selFilter"><span class="ms-crm-Bold-Header"><loc:Text ResourceId="SystemCustomization.SimilarityRulesListPage.Labels.Filter" runat="server"/></span></label></td>
