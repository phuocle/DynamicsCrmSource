...
var aspxVars_IsSimilarityRuleActivated =  <%= ((this.CurrentEntity["statecode"] == SimilarityRuleState.Active.ToString())?"'true'":"'false'") %>;
var aspxVars_isNewform  = <%= ((CurrentForm.State == FormState.New)?"'true'":"'false'") %>;
var aspxVars_DraftStateCode = <%= ((int)SimilarityRuleState.Draft).ToString("D", System.Globalization.CultureInfo.InvariantCulture) %>;
var aspxVars_CurrentEntityId = <%= Microsoft.Crm.CrmEncodeDecode.CrmJavaScriptEncode(this.CurrentEntity.Id) %>;
var aspxVars_SimilarityRule = <%=Microsoft.Crm.Util.SimilarityRule.ToString("D", System.Globalization.CultureInfo.InvariantCulture) %>;
