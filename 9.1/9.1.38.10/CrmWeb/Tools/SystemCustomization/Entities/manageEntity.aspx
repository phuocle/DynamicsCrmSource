...
_mobileOfflineFilters = <%= Microsoft.Crm.CrmEncodeDecode.CrmJavaScriptEncode(_entityMD.EntityInfo.MobileOfflineFilters) %>;
<%} %>
...
function onClickSetVEControlsVisibilty()
{
var _chkIsVirtualEntity = $get('chkIsVirtualEntity');
if (_chkIsVirtualEntity.checked)
{
ExternalNameRow.style.display = "table-row";
ExternalCollectionNameRow.style.display = "table-row";
AttributeExternalNameRow.style.display = "table-row";
selDataSourceType.disabled = false;
checkIsActivity.checked = false;
chkEnableDupCheck.checked = false;
chkIsReadingPaneEnabled.checked = false;
}
if (!_chkIsVirtualEntity.checked)
{
ExternalNameRow.style.display = "none";
ExternalCollectionNameRow.style.display = "none";
AttributeExternalNameRow.style.display = "none";
selDataSourceType.disabled = true;
}
$get('selOwnershipType').value =_ownershipTypeOrgOwned;
selOwnershipType.disabled = _chkIsVirtualEntity.checked;
checkIsActivity.disabled = _chkIsVirtualEntity.checked;
chkIsBusinessProcessEnabled.disabled = _chkIsVirtualEntity.checked;
enableAutoCreateAccessTeams.disabled = _chkIsVirtualEntity.checked;
chkIsReadingPaneEnabled.disabled = _chkIsVirtualEntity.checked;
chkEnableDupCheck.disabled = _chkIsVirtualEntity.checked;
chkIsAuditingEnabled.disabled = _chkIsVirtualEntity.checked;
chkChangeTrackingEnabled.disabled = _chkIsVirtualEntity.checked;
enableSla.disabled = _chkIsVirtualEntity.checked;
enableKnowledgeMgmt.disabled = _chkIsVirtualEntity.checked;
chkCollaboration.disabled = _chkIsVirtualEntity.checked;
chkRCOffline.disabled = _chkIsVirtualEntity.checked;
chkIsQuickCreateEnabled.disabled = _chkIsVirtualEntity.checked;
chkIsSolutionAwareEnabled.disabled = _chkIsVirtualEntity.checked;
}
...
var chkRetrieveAuditing = $get('chkRetrieveAuditing');
var chkRetrieveMultipleAuditing = $get('chkRetrieveMultipleAuditing');
}
...
if (_isActivityLoggingFeatureEnabled) {
chkRetrieveAuditing.checked = false;
chkRetrieveMultipleAuditing.checked = false;
$get('trWarningMessageForRecordAudit').style.display = "none";
}
}
else
{
...
if (_isActivityLoggingFeatureEnabled) {
$get('trWarningMessageForRecordAudit').style.display = "inline";
}
}

if (_isActivityLoggingFeatureEnabled) {
chkRetrieveAuditing.disabled = !chkIsAuditingEnabled.checked;
chkRetrieveMultipleAuditing.disabled = !chkIsAuditingEnabled.checked;
}
...
Xrm.Internal.openDialog(oUrl.toString(), options, oDialog, null, function(oReturned) { setMobileOfflineFiltersCallbackFunction(oReturned);});
}
<% } %>
}
...
<td><ui:TextBox id="txtPluralName" TabIndex="4" runat="server"/></td>
</tr>
...
%>
<td width="100%"><ui:TextBox id="txtSchemaName" TabIndex="7" runat="server"/></td>
</tr>
</table>
</td>
</tr>

<tr class="param" id="ExternalNameRow" runat="server">
<td id="txtExternalNameLabel" class="ms-crm-Field-Required"><label for="txtExternalName"><loc:Text ResourceId="SystemCustomization.ManageEntityPage.EntitySection.Labels.ExternalName" runat="server"/><img src="/_imgs/frm_required.gif" alt="<loc:Text Encoding='HtmlAttribute' ResourceId='Forms.Required.AltTag' runat='server'/>"/></label></td>
<td><ui:TextBox id="txtExternalName" TabIndex="8" runat="server"/></td>
</tr>

<tr class="param" id="ExternalCollectionNameRow" runat="server">
<td id="txtExternalCollectionNameLabel" class="ms-crm-Field-Required"><label for="txtExternalCollectionName"><loc:Text ResourceId="SystemCustomization.ManageEntityPage.EntitySection.Labels.ExternalCollectionName" runat="server"/><img src="/_imgs/frm_required.gif" alt="<loc:Text Encoding='HtmlAttribute' ResourceId='Forms.Required.AltTag' runat='server'/>"/></label></td>
<td><ui:TextBox id="txtExternalCollectionName" TabIndex="9" runat="server"/></td>
</tr>
...
<td><ui:Select id="selPrimaryImage" TabIndex="10" runat="server"/></td>
</tr>
...
<tr class="param">
<td id="txtentityColor"><label for="entityColor"><loc:Text ResourceId="SystemCustomization.ManageEntityPage.EntitySection.Labels.Color" runat="server"/></label></td>
</td>
<td>
<table width="100%" cellspacing="0" cellpadding="0" dir="ltr">
<tr>
<td>
<ui:textbox id="entityColor" OnChange="onEntityColorChange();" tabindex="11" runat="server" />
</td>
<td style="width: 15%;">
...
<%if (FeatureEnabledHelper.IsFeatureEnabled(FeatureControl.Current.Features.VirtualEntity.Name, Microsoft.Crm.Application.Security.UserInformation.Current))
{ %>
<td colspan="2">
<ui:Checkbox id="chkIsVirtualEntity"  OnClick="onClickSetVEControlsVisibilty();" TabIndex="2" runat="server"/>
<label id="chkIsVirtualEntityLabel" for="chkIsVirtualEntity"><loc:Text ResourceId="SystemCustomization.ManageEntityPage.EntitySection.Labels.IsVirtualEntity" runat="server" /></label>
</td>
<% } %>
</tr>
...
<%if (FeatureEnabledHelper.IsFeatureEnabled(FeatureControl.Current.Features.VirtualEntity.Name, Microsoft.Crm.Application.Security.UserInformation.Current))
{ %>
<tr class="param" id ="DataSourceRow" runat="server">
<td id="selDataSourceLabel" class="ms-crm-Field-Required"><label for="selDataSourceType"><loc:Text ResourceId="SystemCustomization.ManageEntityPage.EntitySection.Labels.DataSourceType" runat="server"/></label></td>
<td><ui:Select id="selDataSourceType" TabIndex="3" runat="server" /></td>
</tr>
<% } %>
...
<td><ui:Select id="selOwnershipType" TabIndex="5" onchange="enableDisableAutoRoute();" runat="server"/></td>
</tr>

<tr class="param" >
<td colspan="2">
<ui:CheckBox id="checkIsActivity" OnClick="Mscrm.CustomActivity.onIsActivityCheckBoxClick(this);" TabIndex="12" runat="server"/>
...
<td>
<ui:CheckBox id="checkIsCommunicationActivity" OnClick="Mscrm.CustomActivity.onSurfaceActivityCheckBoxClick(this);" TabIndex="13" runat="server"/>
...
<% if (FeatureEnabledHelper.IsFeatureEnabled(FeatureControl.Current.Features.SolutionSimplificationCheckbox, Microsoft.Crm.Application.Security.UserInformation.Current) == true) { %>
<tr>
<td>
<ui:CheckBox  id="chkIsSolutionAwareEnabled" TabIndex="39" runat="server"/>
<label id="chkIsSolutionAwareEnabledLabel" for="chkIsSolutionAwareEnabled"><loc:Text ResourceId="SystemCustomization.ManageEntityPage.EntitySection.Labels.SolutionComponent" runat="server"/></label>
</td>
</tr>
<%	} %>
</table>
...
<td><ui:TextArea id="txtDescription" Height="50px" TabIndex="14" runat="server"/></td>
</tr>
</table>
</td>
</tr>
...
<label id="chkAEFeedbackLabel" for="chkAEFeedback"><loc:Text ResourceId="SystemCustomization.ManageEntityPage.OptionsSection.EnableOnly.Labels.Feedback" runat="server"/></label>
</td>
</tr>
<%	} %>
...
<label id="enableOneNoteIntegrationLabel" for="enableOneNoteIntegration"><loc:Text ResourceId="SystemCustomization.ManageEntityPage.OptionsSection.EnableDisable.Labels.OneNoteIntegration" runat="server"/></label>
</td>
</tr>
<%
}
...
<label id="enableKnowledgeMgmtLabel" for="enableKnowledgeMgmt"><loc:Text ResourceId="SystemCustomization.ManageEntityPage.OptionsSection.EnableDisable.Labels.KnowledgeMgmt" runat="server"/></label>
</td>
</tr>
<%
}
...
<label id="chkChangeTrackingEnabledLabel" for="chkChangeTrackingEnabled"><loc:Text ResourceId="SystemCustomization.ManageEntityPage.OptionsSection.EnableDisable.Labels.ChangeTracking" runat="server"/></label>
</td>
</tr>
...
<label id="chkExternalChannelsEnabledLabel" for="chkExternalChannelsEnabled"><loc:Text ResourceId="SystemCustomization.ManageEntityPage.OptionsSection.EnableDisable.Labels.ExternalChannelsEnabled" runat="server"/></label>
</td>
</tr>
<%
}
...
<td class="ms-crm-Form-Section" style="vertical-align: bottom">
<nobr>
<loc:Text ResourceId="SystemCustomization.ManageEntityPage.OptionsSection.Auditing.Title" runat="server"/>
</nobr>
</td>
</tr>
<tr style="height:10px"><td></td></tr>
...
<tr>
<td>
<ui:CheckBox id="chkRetrieveAuditing" TabIndex="45" runat="server"/>
<label id="chkRetrieveAuditingLabel" for="chkRetrieveAuditing"><loc:Text ResourceId="SystemCustomization.ManageEntityPage.OptionsSection.EnableDisable.Labels.RetrieveRecord" runat="server"/></label>
</td>
</tr>
...
<tr>
<td>
<ui:CheckBox id="chkRetrieveMultipleAuditing" TabIndex="46" runat="server"/>
<label id="chkRetrieveMultipleAuditingLabel" for="chkRetrieveMultipleAuditing"><loc:Text ResourceId="SystemCustomization.ManageEntityPage.OptionsSection.EnableDisable.Labels.RetrieveMultiple" runat="server"/></label>
</td>
</tr>
<tr><td style="height: 4px"></td></tr>
<tr class="param" id="trWarningMessageForRecordAudit"  runat="server">
<td class="globalAuditWarningTD">
<% = String.Format(CultureInfo.InvariantCulture, CrmEncodeDecode.CrmHtmlEncodeForFormatString(AppResourceManager.Default.GetString("SystemCustomization.ManageEntityPage.OptionsSection.EnableDisable.Labels.NoteMessageReadAuditEntity")), "<a id='NoteMessageReadAuditEntityLink' class='default-link' target='_blank' href='https://go.microsoft.com/fwlink/p/?linkid=866445'>","</a>") %>
</td>
</tr>
</table>
</td>
...
<%
if (Microsoft.Crm.VersionUtility.IsAraVersion(version) && IsMocaOfflineFeatureAvailable && !Microsoft.Crm.Application.Utility.Util.IsOnPremise())
{
%>
<tr>
<td style="width:5%">
...
<label id="chkIsOfflineForMobileClientLabel" for="chkIsOfflineForMobileClient"><loc:Text ResourceId="SystemCustomization.ManageEntityPage.OptionsSection.EnableDisable.Labels.MobileClientOffline" runat="server"/></label>
</td>
</tr>
<tr>
<td style="width:5%">
...
%>
<td style="width:20%">
<label for="numDaysSinceRecordLastModified"><loc:Text ResourceId="SystemCustomization.ManageEntityPage.OptionsSection.Number.Labels.DaysSinceRecordLastModified" runat="server"/></label>
</td>
<td style="width:10%">
...
else if (DisplayMobileOfflineFiltersLink)
{
%>
<td class="enhancedFiltersLink">
<a id="mobileOfflineFilters" href="#" style="cursor:pointer"  onclick="onClickMobileOfflineFilters();" TabIndex="54"><u><loc:Text  ResourceId="SystemCustomization.ManageEntityPage.OptionsSection.Button.Labels.MobileOfflineFilters_ButtonName" runat="server"/></u></a>
</td>
<%
}
%>
...
<label id="checkCustomizedHelpLabel" for="checkCustomizedHelp"><loc:Text ResourceId="SystemCustomization.ManageEntityPage.EntitySection.Labels.RHelpEnabled" runat="server"/></label>
</td>
</tr>
<tr>
<td colspan="3">
...
<col width="23%"><col>
<tr class="param">
<td id="txtHelpURLLabel" valign="top"><label for="txtHelpURL"><loc:Text ResourceId="SystemCustomization.ManageEntityPage.EntitySection.Labels.HelpEnabledBox" runat="server"/></label></td>

<td ><ui:TextBox id="txtHelpURL" Height="50px" TabIndex="58"  runat="server" /></td>
</tr>
</table>
</td>
</tr>
...
<a target="_blank" rel="noopener noreferrer" TabIndex="61" href="<%=CurrentResourceManager.GetString("CRM_Dynamics_SDK_Address")%>" class="help_link">
...
<tr class="param" id="AttributeExternalNameRow" runat="server">
<td id="txtAttributeExternalNameLabel"><label for="txtAttributeExternalName"><loc:Text ResourceId="SystemCustomization.ManageAttributePage.SchemaSection.Labels.ExternalName" runat="server"/></label></td>
<td>
<table width="100%" cellspacing="0" cellpadding="0" dir="ltr">
<tr>
<td width="100%"><ui:TextBox id="txtAttributeExternalName" runat="server"/></td>
</tr>
</table>
</td>
</tr>
...
<% } %>
<th style="width: 15%" class="customcontrol-text-ellipses" title="<loc:Text ResourceId='CustomControls_Configuration_Phone' runat='server'/>"><b><loc:Text ResourceId="CustomControls_Configuration_Phone" runat="server"/></b></th>
<th style="width: 15%" class="customcontrol-text-ellipses" title="<loc:Text ResourceId='CustomControls_Configuration_Tablet' runat='server'/>"><b><loc:Text ResourceId="CustomControls_Configuration_Tablet" runat="server"/></b></th>
...
<u><loc:Text ResourceId="CustomControls_Configuration_AddControl" runat="server"/></u>
</span>
</a>
</div>
</div>
...
<tr>
<td style="display:inline"><sdk:LookupControl id="libraryLookup" DisableViewPicker="true" DefaultViewId="125A31CE-0F5E-4957-8AA3-7A10C0713886" LookupBrowse="false" LookupStyle="single" runat="server" />
</td>
</tr>
</table>
</fieldset>
