...
<td class="control"><ui:Select id="selReferencingEntityName" OnChange="onReferencingEntityChange();" runat="server"/></td>
</tr>
</table>
</td>
</tr>
...
<col style="width:150px" /><col />
<tr class="param">
<td id="selectIsHierarchicalLabel" class="ms-crm-Field-Normal"><label for="selectIsHierarchical"><loc:text resourceid="SystemCustomization.ManageRelationshipPage.DefinitionSection.Labels.IsHierarchical" runat="server" /></label></td>
<td class="control">
...
<% if ((_dataProviderId != null && _entityRole == EntityRole.referencing) || (_isReferencingEntityVE && _entityRole == EntityRole.referenced))
{
%>
<tr class="param" id="attributeExternalNamerow">
<%
}
else
{
%>
<tr class="param" id="attributeExternalNamerow" style="display:none">
<%
}
%>
<td id="txtAttributeExternalNameLabel" class="ms-crm-Field-Required"><label for="txtAttributeExternalName"><loc:Text ResourceId="SystemCustomization.ManageRelationshipPage.AttributeSection.Labels.ExternalName" runat="server"/><img src="/_imgs/frm_required.gif" alt="<loc:Text Encoding='HtmlAttribute' ResourceId='Forms.Required.AltTag' runat='server'/>"/></label></td>
<td class="control">
<table width="100%"  cellspacing="0" cellpadding="0" dir="ltr">
<tr>
...
<td class="control"><sdk:IntegerControl id="txtDisplayOrder" Precision="0" runat="server"/></td>
</tr>
</table>
</td>
</tr>
...
<tr class="param">
<td id="txtCascadeRollupViewLabel" class="ms-crm-Field-Required"><label for="selCascadeRollupView"><loc:Text ResourceId="SystemCustomization.ManageRelationshipPage.TypeSection.Labels.RollupView" runat="server"/><img src="/_imgs/frm_required.gif" alt="<loc:Text Encoding='HtmlAttribute' ResourceId='Forms.Required.AltTag' runat='server'/>"/></label></td>
<td class="control"><ui:Select id="selCascadeRollupView" runat="server"/></td>
</tr>
</table>
</td>
