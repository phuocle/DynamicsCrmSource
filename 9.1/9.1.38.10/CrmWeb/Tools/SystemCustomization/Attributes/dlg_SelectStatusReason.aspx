...
dialogArguments["valuesXml"] = Mscrm.SelectStatusTransition.createAvailableFieldsXml(_oStatusTransitionXml, _oSrcStatusValue);

var allowedStatusTransitions = Mscrm.SelectStatusTransition.getAllowedTransitionsForSelectedState(_oStatusTransitionXml, "states/state/values/value[@value='" + CrmEncodeDecode.CrmXmlAttributeEncode(_oSrcStatusValue) + "']/*[local-name() = 'allowedtransitions']/*[local-name() = 'allowedtransition']");
