...
<%@ Import Namespace="Microsoft.Crm.Application.Platform.Utility" %>
...
<page id="0">
<title><loc:Text ResourceId="Web.Tools.Business.map_xml.aspx_1" runat="server"/></title>
<showstagetitle>1</showstagetitle>
<subtitle><loc:Text ResourceId="Web.Tools.Business.map_xml.aspx_2" runat="server"/></subtitle>
...
%>
<page id="01">
<title><loc:Text ResourceId="SystemCustomization.SettingsPage.FiscalYearSettings.Title" runat="server"/></title>
<subtitle><loc:Text ResourceId="SystemCustomization.SettingsPage.FiscalYearSettings.Subtitle" runat="server"/></subtitle>
<icon>/_imgs/tools/ico_fiscalYearSettings.gif</icon>
<help><loc:Text ResourceId="SystemCustomization.SettingsPage.FiscalYearSettings.Help" runat="server"/></help>
...
<%
if (Microsoft.Crm.Security.User.GetPrivilege(Privileges.ReadMetric, Microsoft.Crm.Application.Security.UserInformation.Current) && IsCRMOrganization())
{
%>
<page id="14">
<title><loc:Text ResourceId="NamePlural_Metric" runat="server"/></title>
<icon>/_imgs/Tools/ico_metric.png</icon>
<help><loc:Text ResourceId="Web.Settings.BusinessManagement.Metric" runat="server"/>
</help>
<link inline="1" entitytype="<%=Microsoft.Crm.Application.Utility.EntityNames.Metric%>">/_static/loading.htm</link>
<url><app:FlatHomepageUrlControl EntityLogicalName="metric" XmlEncode="true" runat="server" /></url>
</page>
<%
}
%>
...
<%
if (IsCRMOrganization() && !UnifiedResourceSchedulingUtility.IsURSEnabled())
{
%>
<page id="02">
<title><loc:Text ResourceId="SM_Business_Closures_Title" runat="server"/></title>
<showstagetitle>1</showstagetitle>
...
!UnifiedResourceSchedulingUtility.IsURSEnabled())
{
%>
<page id="03">
...
%>
<page id="04">
<title><loc:Text ResourceId="NamePlural_Queue" runat="server"/></title>
<showstagetitle>1</showstagetitle>
...
<%
if (Microsoft.Crm.Security.User.GetPrivilege(Privileges.ReadTerritory, Microsoft.Crm.Application.Security.UserInformation.Current) && IsCRMOrganization())
{
%>
<page id="07">
<title><loc:Text ResourceId="Web.Tools.map_xml.aspx_119" runat="server"/></title>
...
<url><app:FlatHomepageUrlControl EntityLogicalName="territory" XmlEncode="true" runat="server" /></url>
<help><loc:Text ResourceId="Web.Tools.map_xml.aspx_123" runat="server"/></help>
</page>
<%
}
%>
...
<%
if (Microsoft.Crm.Security.User.GetPrivilege(Privileges.ReadSubject, Microsoft.Crm.Application.Security.UserInformation.Current) && IsCRMOrganization())
{
%>
<page id="10">
...
<help><loc:Text ResourceId="Web.Tools.map_xml.aspx_280" runat="server"/></help>
<link inline="1">/_static/loading.htm</link>
...
if (Microsoft.Crm.Security.User.GetPrivilege(Privileges.ReadTransactionCurrency, Microsoft.Crm.Application.Security.UserInformation.Current) && IsCRMOrganization())
{
%>
<page id="11">
<title><loc:Text ResourceId="TransactionCurrencyAreaTitle" runat="server"/></title>
<showstagetitle>1</showstagetitle>
...
<help><loc:Text ResourceId="TransactionCurrencyAreaDescription" runat="server"/></help>
</page>
<%
}
%>
...
%>
<page id="12">
<title><loc:Text ResourceId="ConnectionRole_Title" runat="server"/></title>
...
<help><loc:Text ResourceId="ConnectionRole_Help" runat="server"/></help>
</page>
<%
}
%>
...
%>
<page id="13">
<title><loc:Text ResourceId="RelationshipRole_Title" runat="server"/></title>
<showstagetitle>1</showstagetitle>
...
<help><loc:Text ResourceId="RelationshipRole_Help" runat="server"/></help>
</page>
<%
}
%>
...
<page id="13">
<title><loc:Text ResourceId="OLM.Area.Title" runat="server"/></title>
<help><loc:Text ResourceId="OLM.Area.Help" runat="server"/></help>
...
<%
if (Microsoft.Crm.Security.User.GetPrivilege(Privileges.ReadConvertRule, Microsoft.Crm.Application.Security.UserInformation.Current) && IsCRMOrganization())
{
%>
...
%>
<%
if (Microsoft.Crm.Security.User.GetPrivilege(Privileges.ReadGoalRollupQuery, Microsoft.Crm.Application.Security.UserInformation.Current) && IsCRMOrganization())
{
%>

<page id="19">
<title><loc:Text ResourceId="NamePlural_GoalRollupQuery" runat="server"/></title>
<showstagetitle>1</showstagetitle>
<icon>/_imgs/tools/RollupQueries_44.png</icon>
<link inline="1" entitytype="<%=Microsoft.Crm.Application.Utility.EntityNames.GoalRollupQuery%>">/_static/loading.htm</link>
<url><app:FlatHomepageUrlControl EntityLogicalName="goalrollupquery" XmlEncode="true" runat="server" /></url>
<help><loc:Text ResourceId="GoalQueries_SubArea_HelpDescription" runat="server"/></help>
</page>
<%
}
%>
...
<%
if (ShouldLIIntegrationSettingsBeVisible())
{
%>

<page id="20">
<title><loc:Text ResourceId="SystemCustomization.SettingsPage.LIIntegrationSettings.Title" runat="server"/></title>
<icon>/_imgs/tools/li_integration_48.png</icon>
<help><loc:Text ResourceId="SystemCustomization.SettingsPage.LIIntegrationSettings.Help" runat="server"/></help>
<%
if (isLinkedInSPAProvisioningEnabled())
{
%>
<link inline="0">
function GetServiceEndPointBasedOnOrgUrl(clientUrl){
let segments = clientUrl.split(".");
let serviceEndPoint;
switch (segments[segments.length - 3]) {
case "crm":
serviceEndPoint = "https://nam.sales.ai.dynamics.com";
break;
case "crm2":
serviceEndPoint = "https://ssam.sales.ai.dynamics.com";
break;
case "crm3":
serviceEndPoint = "https://ccan.sales.ai.dynamics.com";
break;
case "crm4":
serviceEndPoint = "https://weur.sales.ai.dynamics.com";
break;
case "crm5":
serviceEndPoint = "https://seapj.sales.ai.dynamics.com";
break;
case "crm6":
serviceEndPoint = "https://eoce.sales.ai.dynamics.com";
break;
case "crm7":
serviceEndPoint = "https://ejpn.sales.ai.dynamics.com";
break;
case "crm8":
serviceEndPoint = "https://cind.sales.ai.dynamics.com";
break;
case "crm10":
serviceEndPoint = "https://tip1.sales.ai.dynamics.com";
break;
case "crm11":
serviceEndPoint = "https://gbr.sales.ai.dynamics.com";
break;
case "crm12":
serviceEndPoint = "https://cfra.sales.ai.dynamics.com";
break;
default:
throw new Error("ServiceEndPoint Not Found For this Org Url");

}
return serviceEndPoint;
}

Xrm.Utility.getEntityMetadata("sales_linkedin_configuration", "sales_linkedin_configurationId").then(
function success(result) {
var dialogOptions = new Xrm.DialogOptions();
dialogOptions.height = 500;dialogOptions.width = 700;
Xrm.Internal.addMetric("salesoperationevents",{moduleName:"LinkedIn", componentName:"LIIntegrationSettings", functionName:"OnClick", eventType:"Info", eventDetails:"LIIntegrationSettingsDialog"});
Xrm.Navigation.openDialog("LIIntegrationAdminSettingsDialog", dialogOptions, null, null, null);
},
function (error)
{
var errorResponse = JSON.parse(error.message);
if(errorResponse.error.code === "0x80040217")
{
let context = Xrm.Utility.getGlobalContext();
let clientUrl = context.getClientUrl();
let appUrl = GetServiceEndPointBasedOnOrgUrl(clientUrl) + "/LinkedInProvisioning/index";
let orgId = context.organizationSettings.organizationId;
orgId = orgId.replace("{", "").replace("}", "");
appUrl = appUrl + <%=Microsoft.Crm.CrmEncodeDecode.CrmXmlEncode("'?orgId='")%> + orgId + <%=Microsoft.Crm.CrmEncodeDecode.CrmXmlEncode("'&lcid='")%> + Xrm.Page.context.getUserLcid();
window.open(appUrl);
Xrm.Internal.addMetric("salesoperationevents",{moduleName:"LinkedIn", componentName:"LIIntegrationSettings", functionName:"OnClick", eventType:"Info", eventDetails:"LIIntegrationSettingsSPA"});
}
else
{
var _options = { errorCode:parseInt(errorResponse.error.code,16), message:errorResponse.error.message, details:JSON.stringify(errorResponse.error.innererror) };
Xrm.Internal.addMetric("salesoperationevents",{moduleName:"LinkedIn", componentName:"LIIntegrationSettings", functionName:"OnClick", eventType:"Error", eventDetails:error.message});
Xrm.Navigation.openErrorDialog(_options);
}
}
);
</link>
...
{
%>
<link inline="0">var dialogOptions = new Xrm.DialogOptions();dialogOptions.height = 500;dialogOptions.width = 700;
Xrm.Internal.addMetric("salesoperationevents",{moduleName:"LinkedIn", componentName:"LIIntegrationSettings", functionName:"OnClick", eventType:"Info", eventDetails:"LIIntegrationSettingsDialog"});
Xrm.Navigation.openDialog("LIIntegrationAdminSettingsDialog", dialogOptions, null, null, null);
</link>
<%
