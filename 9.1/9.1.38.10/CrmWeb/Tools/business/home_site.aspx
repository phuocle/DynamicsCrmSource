<%@ Page language="c#" Inherits="Microsoft.Crm.Service.Application.Pages.Tools.Business.Site" %>
...
<tr>
<td><label class="ms-crm-Setting-ContextHeader-Title"><loc:Text ResourceId="SM_Title_Sites" runat="server"/></label></td>
...
<tr>
<td nowrap class="home_site_td_AppViewSelector"><label for="crmGrid_SavedQuerySelector"><span class="ms-crm-Bold-Header"><loc:Text ResourceId="Web.Tools.business.home_team.aspx_86" runat="server"/></span></label></td>
<td><cnt:AppViewSelector runat="server" id="crmViewSelector"/></td>
<td align="center"><span class="home_site_span_QuickFindSpacer">&nbsp;</span></td>
</tr>
</table>
</div>
