...
<tr>
<td><label class="ms-crm-Setting-ContextHeader-Title"><loc:Text ResourceId="SM_Title_Services" runat="server"/></label></td>
...
<tr>
<td nowrap class="home_service_td_AppViewSelector"><label for="crmGrid_SavedQuerySelector"><span class="ms-crm-Bold-Header"><loc:Text ResourceId="Web.View_Label_70" runat="server"/></span></label></td>
<td><cnt:AppViewSelector runat="server" id="crmViewSelector"/></td>
<td align="center"><span class="home_service_span_QuickFindSpacer">&nbsp;</span></td>
</tr>
</table>
</div>
