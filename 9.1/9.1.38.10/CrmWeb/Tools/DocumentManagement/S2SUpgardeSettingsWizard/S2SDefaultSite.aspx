...
var oUrl = Mscrm.CrmUri.create("/Tools/DocumentManagement/S2SUpgardeSettingsWizard/S2SSharePointRealm.aspx");
...
Mscrm.S2SUpgradePageHelper.logMetricsforWizard(Mscrm.S2SUpgradePageHelper.TelemetryLogEventWizardCancel, "S2SDefaultSite");
...
<div class ="mscrm-noSitesMessage mscrm-text-S2Swizard" style="margin-top:10px;"><loc:Text ResourceId="Web.Tools.DocumentManagement.S2SUpgrade.AbsoluteUrlWarning1" runat="server"/></div>
<div id="absoluteURLWarningLabel" class="mscrm-noSitesMessage mscrm-text-S2Swizard" style="margin-top:20px;" runat="server"><ui:LabelUI  runat="server"/></div>
<div class ="mscrm-noSitesMessage mscrm-text-S2Swizard" style="margin-top:20px;"><loc:Text ResourceId="Web.Tools.DocumentManagement.S2SUpgrade.AbsoluteUrlWarning3" runat="server"/></div>
</td>
</tr>
</table>
