...
<label for="locationLookup" class="ms-crm-dlglabel" title="<loc:Text Encoding='HtmlAttribute' ResourceId='AddLocationParentSiteLabel' runat='server'/>"><loc:Text ResourceId="AddLocationParentSiteLabel" runat="server" /></label>
</div>
