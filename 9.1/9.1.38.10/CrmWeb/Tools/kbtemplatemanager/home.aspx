...
<tr>
<td><label class="ms-crm-Setting-ContextHeader-Title"><loc:Text ResourceId="Web.Tools.map_xml.aspx_144" runat="server"/></label></td>
...
<tr>
<td nowrap class="KBTempMgr_home_td_Value"><label for="crmGrid_SavedQuerySelector"><span class="ms-crm-Bold-Header"><loc:Text ResourceId="Web.View_Label_70" runat="server"/></span></label></td>
<td><cnt:AppViewSelector runat="server" id="crmViewSelector"/></td>
<td align="center"><span class="KBTempMgr_home_span_Spacer">&nbsp;</span></td>
</tr>
</table>
</div>
