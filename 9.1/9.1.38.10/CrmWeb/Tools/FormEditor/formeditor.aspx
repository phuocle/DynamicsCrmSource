...
Mscrm.FormEditorVariables.supportRICards	= '<%= supportRAControl.ToString() %>';
...
var raSection = document.getElementById("{ea3bb0a6-b9dc-1b0e-5e7d-74a380ee79a3}");
if(raSection && Mscrm.FormEditorVariables.supportRICards === "False"){
raSection.setAttribute("style", "display:none");
}
...
if (Mscrm.FormEditorVariables.FormType == 'main' && (_isRefreshForm == '1' || _isRefreshForm == '2') && _isFormMergeFcbEnabled=="True" && _isCustomEntity != "True")
return true;
return false;
}
...
<div id="crmNotificationsForHeaderDensityDefault"  class="Notifications Notifications-strict " style="position:static;left:0px;right:0px;width:100%;display:none;border-bottom-style:solid;border-color:#c5c5c5;border-width:1px;border-top-style:none;">
<div role="alert" aria-live="polite" class="Notification">
<table cellpadding="0" cellspacing="0">
<tbody>
<tr>
<td valign="top">
<img alt="" src="/_imgs/messagebar/msgbar_icn_info.png" class="ms-crm-ImageStrip-msgbar_icn_info">
</td>
<td style="padding-left: 6px">
<span>
<loc:text resourceid="FormEditor_HeaderDensityDefaulted_Notification" runat="server" />
<a id="crmNotificationsForHeaderDensityDefault_learnMoreLink" href="https://aka.ms/paformheaderdensity" target="_blank" rel="noopener noreferrer" class="ms-crm-FormEditor-learnMoreLink" title="<loc:Text Encoding='HtmlAttribute' ResourceId='MailApp.Generic.LearnMore' runat='server'/>">
...
<div id="crmNotificationsForHeaderDensityLow"  class="Notifications Notifications-strict " style="position:static;left:0px;right:0px;width:100%;display:none;border-bottom-style:solid;border-color:#c5c5c5;border-width:1px;border-top-style:none;">
<div role="alert" aria-live="polite" class="Notification">
<table cellpadding="0" cellspacing="0">
<tbody>
<tr>
...
<td style="padding-left: 6px">
<span>
<loc:text resourceid="FormEditor_LowHeaderDensity_Warning" runat="server" />
<a id="crmNotificationsForHeaderDensityLow_learnMoreLink" href="https://aka.ms/paformheaderdensity" target="_blank" rel="noopener noreferrer" class="ms-crm-FormEditor-learnMoreLink" title="<loc:Text Encoding='HtmlAttribute' ResourceId='MailApp.Generic.LearnMore' runat='server'/>">
<loc:Text ResourceId="MailApp.Generic.LearnMore" runat="server" />
</a>
</span>
</td>
...
<div id="crmNotificationsForHeaderDensityHigh"  class="Notifications Notifications-strict " style="position:static;left:0px;right:0px;width:100%;display:none;border-bottom-style:solid;border-color:#c5c5c5;border-width:1px;border-top-style:none;">
<div role="alert" aria-live="polite" class="Notification">
<table cellpadding="0" cellspacing="0">
<tbody>
<tr>
...
<td style="padding-left: 6px">
<span>
<loc:text resourceid="FormEditor_HighHeaderDensity_Warning" runat="server" />
<a id="crmNotificationsForHeaderDensityHigh_learnMoreLink" href="https://aka.ms/paformheaderdensity" target="_blank" rel="noopener noreferrer" class="ms-crm-FormEditor-learnMoreLink" title="<loc:Text Encoding='HtmlAttribute' ResourceId='MailApp.Generic.LearnMore' runat='server'/>">
<loc:Text ResourceId="MailApp.Generic.LearnMore" runat="server" />
</a>
</span>
</td>
