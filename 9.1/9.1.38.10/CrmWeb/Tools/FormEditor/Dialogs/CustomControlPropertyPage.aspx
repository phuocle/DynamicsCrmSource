...
var sep = '.';
function populateRelFiltersSection(entityTypeCode, attributeId, filterRelationshipName, dependentAttributeName, dependentAttributeType, allowFilterOff, disableQuickFind) {
try {
var relName = null,
...
_chkShowQuickFindControl = document.getElementById('chkShowQuickFind');
_chkShowQuickFindControl.checked = disableQuickFind;
ToggleRelFilter()
}
catch (e) {
