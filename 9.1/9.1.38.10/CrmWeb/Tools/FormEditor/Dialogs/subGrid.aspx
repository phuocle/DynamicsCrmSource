...
var _txtHexCode = null;
var _txtColor = null;
var _subgridHeaderColor = null;
...
<% if (Microsoft.Crm.Caching.FeatureEnabledHelper.IsFeatureEnabled(Microsoft.Crm.FeatureControl.Current.Features.WebClientVisualRefresh.Name, Microsoft.Crm.Application.Security.UserInformation.Current)) { %>
_txtHexCode = $get('txtHexCode');
_txtColor = $get('txtColor');
<% } %>
...
$get('panelColorSet').style.display = 'none';
}
else {
...
_bIsValid = true;
<% if (Microsoft.Crm.Caching.FeatureEnabledHelper.IsFeatureEnabled(Microsoft.Crm.FeatureControl.Current.Features.WebClientVisualRefresh.Name, Microsoft.Crm.Application.Security.UserInformation.Current)) { %>
if (typeof (_txtHexCode) !== "undefined" && _txtHexCode !== null) {
if (!isNullOrEmptyString(_oField.HeaderColorCode)) {
_txtHexCode.value = _oField.HeaderColorCode;
_subgridHeaderColor = _oField.HeaderColorCode;
if (typeof (_txtColor) !== "undefined" && _txtColor !== null) {
_txtColor.style.backgroundColor = _txtHexCode.value;
}
}
}
<% } %>
...
function HideAdvanceViews(){

$get('dataSourceFieldset').style.display = 'none';
$get('additionalOptionsFieldset').style.display = 'none';
$get('chartOptionsFieldset').style.display = 'none';
if(_sDashboardType != 'dashboardEditor')
{
$get('divAvailabilitySection').style.display = 'none';
$get('labelChkBox').style.display = 'none';
$get('labelfieldset').style.display = 'none';
}
$get('txtDescription').setAttribute('tabindex', '0');
$get('txtDescription').setAttribute('aria-labelledby', 'dvEmptyTitle');
}
...
if (OnColorChange()) {
if (typeof (_txtHexCode) !== "undefined" && _txtHexCode !== null) {
headerColorCode = _txtHexCode.value;
if (!headerColorCode.startsWith("#")) {
headerColorCode = "#" + headerColorCode;
}
var arguments = {};
arguments["isSubgridHeaderColorChanged"] = _subgridHeaderColor !== headerColorCode;
Mscrm.MetricsReporting.instance().addMetric("subgridheadercolor", arguments);
}
}
else {
...
function validateColorValue(headerColorValue) {
var validation = true;
if (headerColorValue != null) {
if (headerColorValue.startsWith('#')) {
headerColorValue = headerColorValue.substr(1);
}
var isHexValue = /^[0-9A-F]{6}$/i.test(headerColorValue);
if (!isHexValue) {
alert(LOCID_SYSCUST_INVALIDCOLORVALUE);
validation = false;
}
}
return validation;
...
var oHeaderColor = $get("txtHexCode");
var oPreviewHeaderColor = $get("txtColor");
var headerColorValue = "";
if (oHeaderColor != "undefined" && oHeaderColor != null)
{
headerColorValue = oHeaderColor.value;
}
if (validateColorValue(headerColorValue)) {
if (!headerColorValue.startsWith("#")) {
headerColorValue = "#" + headerColorValue;
}
if (oPreviewHeaderColor != "undefined" && oPreviewHeaderColor.style != null) {
oPreviewHeaderColor.style.backgroundColor = headerColorValue;
return true;
}
}
}
...
<table id="labelChkBox" cellpadding="0" cellspacing="5" width="100%" style="table-layout: fixed;">
...
<% if (Microsoft.Crm.Caching.FeatureEnabledHelper.IsFeatureEnabled(Microsoft.Crm.FeatureControl.Current.Features.WebClientVisualRefresh.Name, Microsoft.Crm.Application.Security.UserInformation.Current)) { %>
<table id="panelColorSet" cellpadding="0" cellspacing="5" width="100%" style="table-layout: fixed;">
<col width="30"/><col width="70"/>
<tr>
<td>
<label for="txtHexCode" title="<loc:Text ResourceId='Web.Tools.FormEditor.Dialogs.subgrid.aspx.PanelHeaderColorLabel' runat='server'/>">
<loc:Text ResourceId="Web.Tools.FormEditor.Dialogs.subgrid.aspx.PanelHeaderColorLabel"  runat="server"/>
</label>
</td>
<td>
<ui:TextBox id="txtHexCode" OnChange="OnColorChange();" maxlength="7"  runat="server" />
<ui:TextBox id="txtColor"  runat="server" disabled="disabled"/>
</td>
</tr>
</table>
<%} %>
...
<fieldset id="dataSourceFieldset">
...
<fieldset id="additionalOptionsFieldset">
...
<fieldset id="chartOptionsFieldset">
...
<fieldset style="height: 119px; border:thin; border-style: none;border-collapse:collapse" >

<div id="subgridTopDiv"style="margin-bottom:10px;width:100%;align:center;overflow-y:auto;height: 120px">
