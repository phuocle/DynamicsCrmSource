...
<a id="DelveLink" href="<%= delveLink%>" target="_blank" rel="noopener noreferrer" class="delveLink" title="<%= Microsoft.Crm.CrmEncodeDecode.CrmHtmlEncode(AppResourceManager.Default.GetString("Web.Dashboard.OpenOfficeDelve.HoverText"))%> Office Delve">
Office Delve
</a>
<% }%>
<% else {%>
<a id="DelveLink" href="http://go.microsoft.com/fwlink/?LinkID=620878" target="_blank" rel="noopener noreferrer" class="delveLink" title="<%= Microsoft.Crm.CrmEncodeDecode.CrmHtmlEncode(AppResourceManager.Default.GetString("Web.Dashboard.OpenOfficeDelve.HoverText"))%> Office Delve">
Office Delve
</a>
<% }%>
</fieldset>
