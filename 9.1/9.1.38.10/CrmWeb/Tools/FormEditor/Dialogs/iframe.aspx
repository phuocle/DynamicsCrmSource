...
if(!IsNull(_url))
{
_url.setAttribute("tabindex","0");
}
if(!IsNull(_fieldName))
{
_fieldName.setAttribute("tabindex","0");
}
...
<br />
<a href="http://go.microsoft.com/fwlink/?LinkId=249177" class="ms-crm-FormEditor-Iframe-GlobalColor" target="_blank" rel="noopener noreferrer"><loc:Text ResourceId="Web.Tools.FormEditor.Dialogs.iframe.aspx_176" runat="server"/></a>
</td>
</tr>
</table>
</fieldset>
