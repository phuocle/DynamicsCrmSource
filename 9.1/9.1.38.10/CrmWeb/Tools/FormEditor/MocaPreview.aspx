...
var serializedPreviewData = <%= Microsoft.Crm.CrmEncodeDecode.CrmJavaScriptEncode(Request.Form["formPreviewData"]) %>;
if (serializedPreviewData) {
var formPreviewData = JSON.parse(serializedPreviewData);

Mscrm.CrmSessionStorage.setItem('<%= PreviewPageFormXmlKey %>', formPreviewData['<%= PreviewPageFormXmlKey %>']);
Mscrm.CrmSessionStorage.setItem('<%= PreviewPageEntityLogicalNameKey %>', formPreviewData['<%= PreviewPageEntityLogicalNameKey %>']);
Mscrm.CrmSessionStorage.setItem('<%= PreviewPageDashboardNameKey %>', formPreviewData['<%= PreviewPageDashboardNameKey %>']);
Mscrm.CrmSessionStorage.setItem('<%= PreviewPageEntityFormTypeKey %>', formPreviewData['<%= PreviewPageEntityFormTypeKey %>']);
Mscrm.CrmSessionStorage.setItem('<%= PreviewPageFormIdKey %>', formPreviewData['<%= PreviewPageFormIdKey %>']);
Mscrm.CrmSessionStorage.setItem('<%= PreviewPageEntityTypeCodeKey %>', formPreviewData['<%= PreviewPageEntityTypeCodeKey %>']);
Mscrm.CrmSessionStorage.setItem('<%= PreviewPageFormAccessTypeKey %>', formPreviewData['<%= PreviewPageFormAccessTypeKey %>']);
}
