...
<td><input name="enableVisibility" id="visibleToEveryone" type="radio" onclick="Mscrm.RoleAssignment.onClickVisibleToEveryone();" class="radio"></td>
...
<tr style="height:25px">
<td><input name="enableVisibility" id="visibleToSelectedRoles" type="radio" onclick="Mscrm.RoleAssignment.onClickVisibleToSelectedRoles();" class="radio"></td>
