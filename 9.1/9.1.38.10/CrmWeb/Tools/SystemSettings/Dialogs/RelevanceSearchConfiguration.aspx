<%@ Page Language="c#" Inherits="Microsoft.Crm.Web.Tools.SystemSettings.RelevanceSearchConfiguration" CodeBehind="Microsoft.Crm.Application.Pages.dll" EnableViewState="false" %>
...
<div id="QuickFindConfigBody" class="ms-crm-QuickFindConfigDialog-Main" style="margin-bottom:20px;">
...
<div id="ProgressBar" class="ms-crm-RelevanceSearchProgressBar" runat="server"></div>
</frm:DialogForm>
</body>
</html>