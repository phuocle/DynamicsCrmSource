...
var _isTextwrapEnabled = IS_TEXT_WRAP_ENABLED;
...
radioElements[i].onchange = function(e) {
var element = document.querySelectorAll("[name=" + e.target.getAttribute("name") +"]");
...
{
element[i].setAttribute("tabindex","-1");
}
}
...
<% if (RemoveAbilityToDisableFlowsIntegration){%>
var rdIsMicrosoftFlowEnabledControl = Mscrm.FormControlInputBehavior.GetBehavior("rdIsMicrosoftFlowEnabled");

if (!IsNull(rdIsMicrosoftFlowEnabledControl))
{
var controlValue = rdIsMicrosoftFlowEnabledControl.get_dataValue();
if (controlValue)
{


rdIsMicrosoftFlowEnabledControl.set_disabled(true);
}
}
<% } %>
}
...
function ConfirmIsMSTeamsFeatureEnabled(returnValue, radioId, disablePreviewRadioValue)
{
...
var control = Mscrm.FormControlInputBehavior.GetBehavior("rdMSTeamsEnhancedCollaboration");
...
function ConfirmIsMSTeamsEnhancedCollaborationEnabled(returnValue, radioId, disableRadioValue)
{

if (!(returnValue != null && returnValue == true))
{
Mscrm.FormControlInputBehavior.GetBehavior(radioId).set_dataValue(disableRadioValue);
}
}

function ConfirmIsMicrosoftFlowIntegrationEnabled(returnValue)
{

if (!(returnValue != null && returnValue == true))
{
Mscrm.FormControlInputBehavior.GetBehavior("rdIsMicrosoftFlowEnabled").set_dataValue(false);
}
}


function GetIsTextWrapEnabled()
{
var ctrl = Mscrm.FormControlInputBehavior.GetBehavior("rbEnableTextWrap");
if(ctrl != null && !Mscrm.FormUtility.isControlDirty(ctrl))
{
_boAnySettingChanged = true;

if(_isTextwrapEnabled != ctrl.get_dataValue()){
var arguments = { };
arguments["textWrapState"] = ctrl.get_dataValue();
Mscrm.MetricsReporting.instance().addMetric("wordwrapsettingconfiguration", arguments);
}

return "<istextwrapenabled>" + (ctrl.get_dataValue() ? "true" : "false") + "</istextwrapenabled>";
}
return Mscrm.InternalUtilities._String.Empty;
}

function ConfirmIsAzureSyncServiceEnabled(returnValue, radioId, disablePreviewRadioValue)
{
...
{
$get("syncOptInSelectionStatus").value = "";
}
}
...
{
$find("crmTabBar").down(tab2Tab, true);
...
retval.Append(GetEnableImmersiveSkypeIntegration());
...
retval.Append(GetResolveSimilarEmailAddress());
...
retval.Append(GetSchedulingEngine());
...
<% if (IsApril2020UpdateEnabled && IsGridSearchCanUseCurrentViewFeatureEnabled && UseQuickFindViewForGridSearchOption) {%>
retval.Append(GetUseQuickFindViewForGridSearch());
<% } %>

<% if (IsSendBulkEmailInUciFeatureEnabled) { %>
retval.Append(GetBulkEmailInUci());
<% } %>
...
<% if (IsMSTeamsFeatureEnabledForOrg) {%>
retval.Append(GetMSTeamsEnabled());
<% } %>

<% if (IsMSTeamsFeatureEnabledForOrg) {%>
retval.Append(GetMSTeamsEnhancedCollaborationEnabled());
<% } %>

<% if (IsContextualEmailFeatureEnabledForOrg) {%>
retval.Append(GetIsContextualEmailEnabled());
<% } %>

<% if (IsRichTextNotesFeatureEnabledForOrg) {%>
retval.Append(GetIsRichTextNotesEnabled());
<% } %>

<% if (IsSalesAssistantFeatureEnabled) {%>
retval.Append(GetIsSalesAssistantEnabled());
<% } %>

<% if (IsD365BotFeatureAvailable) {%>
retval.Append(GetLUISConsentEnabled());
<% } %>
...
<% if (IsQuickCreateEnabledForOpportunityClose) {%>
retval.Append(GetIsQuickCreateEnabledForOpportunityClose());
<% } %>

<% if (IsPriceListMandatory) {%>
retval.Append(IsPriceListMandatory());
<% } %>
...
retval.Append(GetSyncFeatureEnabled());
<% } %>
...
<% if (IsOctober2019UpdateEnabled) {%>
retval.Append(GetQualifyLeadAdditionalOptions());
<% } %>

<% if (ShowBusinessCardOptions) {%>
retval.Append(GetBusinessCardOptions());
<% } %>
...
retval.Append(GetUseUnifiedClientExperienceSetting());
retval.Append(GetAllowLegacyDialogsEmbeddingSetting());
retval.Append(GetEnableUnifiedInterfaceShellRefreshSetting());
retval.Append(GetEnableLivePersonaCardUCISetting());
retval.Append(GetBoundDashboardDefaultCardExpanded());
retval.Append(GetEnableLPAuthoring());
retval.Append(GetIsContextualHelpEnabled());
...
retval.Append(GetIsTextWrapEnabled());
retval.Append( "</organization>");
...
SetEnabledStateForRadio("rdMSTeamsPreview", shouldEnableRadioButton);
SetEnabledStateForRadio("rdSalesAssistant", shouldEnableRadioButton);
SetEnabledStateForRadio("rdLUISforD365Bot", shouldEnableRadioButton);
SetEnabledStateForRadio("rdProductRecommendationsPreview", shouldEnableRadioButton);
SetEnabledStateForSyncOptInSelectionRadio("rdSyncOptInSelection", shouldEnableRadioButton);
}
...
function SetEnabledStateForSyncOptInSelectionRadio(radioId, isEnabled)
{
var radio = $get(radioId);
var status = $get("syncOptInSelectionStatus");

if (status != null && radio != null)
{
var control = Mscrm.FormControlInputBehavior.GetBehavior(radioId);
if (control != null)
{
...
{
control.set_dataValue(false);
control.set_disabled(!isEnabled);
}
}
}
}
...
result.Append('<%=FeatureXmlSetOfOtherItems%>');
result.Append(CrmEncodeDecode.CrmXmlEncode("</features>"));
result.Append("</featureset>");
...
function onSyncOptInSelectionChange(radioId)
{
document.getElementById("syncOptInSelectionStatus").disabled = true;
...
{
alert(LOCID_SSS_OPTIN_DISALLOWED);
Mscrm.FormControlInputBehavior.GetBehavior(radioId).set_dataValue(false);
}
else
{
var oUrl = Mscrm.CrmUri.create("/Tools/SystemSettings/Dialogs/dlg_confirm_enableazuresyncservice.aspx");

var crmDialog = new Mscrm.CrmDialog(oUrl, null, 800, 200, null);
var parameters = new Array(radioId, false);
crmDialog.setCallbackInfo("ConfirmIsAzureSyncServiceEnabled", this, parameters);
crmDialog.show();
}
}
}
...
var currentSelection = CrmEncodeDecode.CrmXmlEncode(Mscrm.FormControlInputBehavior.GetBehavior('picklistEmailConnectionChannel').get_dataValue());
if (currentSelection === emailChannelEnum.EmailRouter && Mscrm.FormControlInputBehavior.GetBehavior('rdSyncOptInSelection').get_dataValue())
{
alert(LOCID_SSS_EMAILROUTER_DISALLOWED);
...
if (isEnableExternalSearch == false)
{
...
function onMSTeamsFeatureSelectionChanged(radioId)
{
var previewFlag = (radioId == 'rdMSTeamsPreview') ? true : false;

if (Mscrm.FormControlInputBehavior.GetBehavior(radioId).get_dataValue()) {
var oUrl = Mscrm.CrmUri.create("/Tools/SystemSettings/Dialogs/dlg_confirm_enablemsteamsfeature.aspx?previewFlag=" + previewFlag);
var crmDialog = new Mscrm.CrmDialog(oUrl, null, 800, 200, null);
var parameters = new Array(radioId, false);
crmDialog.setCallbackInfo("ConfirmIsMSTeamsFeatureEnabled", this, parameters);
crmDialog.show();
}
else
{
<% %>
var ctrl = Mscrm.FormControlInputBehavior.GetBehavior("rdMSTeamsEnhancedCollaboration");
if (ctrl != null)
{
ctrl.set_dataValue(false);
ctrl.set_disabled(true);
}
}
}

function onMSTeamsEnhancedCollaborationSelectionChanged(radioId, featureName)
{

if ( Mscrm.FormControlInputBehavior.GetBehavior(radioId).get_dataValue())
{
var oUrl = Mscrm.CrmUri.create("/Tools/SystemSettings/Dialogs/dlg_confirm_enablemsteamsadvancedfeatures.aspx?advancedFeatureName="+featureName);
var crmDialog = new Mscrm.CrmDialog(oUrl, null, 800, 200, null);
var parameters = new Array(radioId, false);
crmDialog.setCallbackInfo("ConfirmIsMSTeamsEnhancedCollaborationEnabled", this, parameters);
crmDialog.show();
}
}


function onLUISConsentSelectionChanged(radioId)
{
var val = Mscrm.FormControlInputBehavior.GetBehavior(radioId).get_dataValue();
Mscrm.FormControlInputBehavior.GetBehavior(radioId).set_dataValue(val);
}


function onConfirmEnableMicrosoftFlowIntegration()
{

if ( Mscrm.FormControlInputBehavior.GetBehavior("rdIsMicrosoftFlowEnabled").get_dataValue())
{
var oUrl = Mscrm.CrmUri.create("/Tools/SystemSettings/Dialogs/dlg_confirm_enablemicrosoftflowintegration.aspx");
var crmDialog = new Mscrm.CrmDialog(oUrl, null, 500, 200, null);
crmDialog.setCallbackInfo("ConfirmIsMicrosoftFlowIntegrationEnabled", this, null);
crmDialog.show();
}
}
...
<%if (IsNewSessionManagerEnabled) {%>
$('tr.sessionTimeoutValues').toggle(Mscrm.FormControlInputBehavior.GetBehavior("rdSessionTimeoutEnabled").get_dataValue());
<% } %>
}
...
var rdGuidedHelpUCIEnabled = Mscrm.FormControlInputBehavior.GetBehavior("rdGuidedHelpUCIEnabled");
...
if(rdGuidedHelpUCIEnabled)
{
rdGuidedHelpUCIEnabled.set_disabled(true);
}
if(rdInAppSupportEnabled){
...
if(rdInAppSupportEnabled && rdGuidedHelpEnabled.get_dataValue())
{
...
if (rdGuidedHelpUCIEnabled) {
rdGuidedHelpUCIEnabled.set_disabled(false);
}
}
}
...
function GetMSTeamsEnabled()
{
var rdMSTeamsPreview = $get("rdMSTeamsPreview");
if (rdMSTeamsPreview != null && Mscrm.FormUtility.isControlDirty(rdMSTeamsPreview))
{
var ctrlMSTeamsPreview = Mscrm.FormControlInputBehavior.GetBehavior("rdMSTeamsPreview");
_boAnySettingChanged = true;
return "<ismsteamsenabled>" + (ctrlMSTeamsPreview.get_dataValue() ? "true" : "false") + "</ismsteamsenabled>";
}

var rdMSTeamsSetting = $get("rdMSTeamsIntegration");
if (rdMSTeamsSetting != null && Mscrm.FormUtility.isControlDirty(rdMSTeamsSetting))
{
var ctrlMSTeamsSetting = Mscrm.FormControlInputBehavior.GetBehavior("rdMSTeamsIntegration");
_boAnySettingChanged = true;
return "<ismsteamsenabled>" + (ctrlMSTeamsSetting.get_dataValue() ? "true" : "false") + "</ismsteamsenabled>";
}

return "";
}

function GetMSTeamsEnhancedCollaborationEnabled()
{
var rdMSTeamsEnhancedCollaboration = $get("rdMSTeamsEnhancedCollaboration");
if (rdMSTeamsEnhancedCollaboration != null && Mscrm.FormUtility.isControlDirty(rdMSTeamsEnhancedCollaboration)) {
var ctrlMSTeamsEnhancedCollaboration = Mscrm.FormControlInputBehavior.GetBehavior("rdMSTeamsEnhancedCollaboration");
_boAnySettingChanged = true;
return "<ismsteamscollaborationenabled>" + (ctrlMSTeamsEnhancedCollaboration.get_dataValue() ? "true" : "false") + "</ismsteamscollaborationenabled>";
}
...
function GetIsSalesAssistantEnabled() {
var rdSalesAssistant = $get("rdSalesAssistant");
if (rdSalesAssistant != null && Mscrm.FormUtility.isControlDirty(rdSalesAssistant))
{
this._boAnySettingChanged = true;
return "<issalesassistantenabled>" + (Mscrm.FormControlInputBehavior.GetBehavior("rdSalesAssistant").get_dataValue() ? "true" : "false") + "</issalesassistantenabled>";
}
...
function GetUseQuickFindViewForGridSearch() {
var rdUseQuickFindViewForGridSearch = $get("rdUseQuickFindViewForGridSearch");
if (rdUseQuickFindViewForGridSearch != null && Mscrm.FormUtility.isControlDirty(rdUseQuickFindViewForGridSearch))
{
this._boAnySettingChanged = true;
return "<usequickfindviewforgridsearch>" + (Mscrm.FormControlInputBehavior.GetBehavior("rdUseQuickFindViewForGridSearch").get_dataValue() ? "true" : "false") + "</usequickfindviewforgridsearch>";
}

return "";
}

function GetBulkEmailInUci() {
var rdBulkEmailUCI = $get("rdBulkEmailUCI");
if (rdBulkEmailUCI != null && Mscrm.FormUtility.isControlDirty(rdBulkEmailUCI))
{
this._boAnySettingChanged = true;
return "<sendbulkemailinuci>" + (Mscrm.FormControlInputBehavior.GetBehavior("rdBulkEmailUCI").get_dataValue() ? "true" : "false") + "</sendbulkemailinuci>";
}
return "";
}


function GetLUISConsentEnabled()
{
var rdLUISforD365Bot = $get("rdLUISforD365Bot");
if (rdLUISforD365Bot != null && Mscrm.FormUtility.isControlDirty(rdLUISforD365Bot))
{
var ctrl = Mscrm.FormControlInputBehavior.GetBehavior("rdLUISforD365Bot");
_boAnySettingChanged = true;
return "<isluisenabledford365bot>" + (ctrl.get_dataValue() ? "true" : "false") + "</isluisenabledford365bot>";
}
...
function GetIsContextualEmailEnabled()
{
var ckContextualEmailEnabledValue = $get("ckContextualEmail");


if ((!IsNull(ckContextualEmailEnabledValue) && Mscrm.FormUtility.isControlDirty(ckContextualEmailEnabledValue)))
{
_boAnySettingChanged = true;

return "<iscontextualemailenabled>" + (ckContextualEmailEnabledValue.checked ? "true" : "false") + "</iscontextualemailenabled>";
}

return "";
}

function GetIsRichTextNotesEnabled()
{
var ckRichTextNotesEnabledValue = $get("ckRichTextNotesForTimeline");


if ((!IsNull(ckRichTextNotesEnabledValue) && Mscrm.FormUtility.isControlDirty(ckRichTextNotesEnabledValue)))
{
_boAnySettingChanged = true;

return "<isrichtextnotesenabled>" + (ckRichTextNotesEnabledValue.checked ? "true" : "false") + "</isrichtextnotesenabled>";
}
...
function GetUseUnifiedClientExperienceSetting()
{
if (typeof (rdUseUnifiedClientExperience) != "undefined" && !IsNull(rdUseUnifiedClientExperience) && Mscrm.FormUtility.isControlDirty($get("rdUseUnifiedClientExperience")))
{
_boAnySettingChanged = true;
return "<allowlegacyclientexperience>" + (!Mscrm.FormControlInputBehavior.GetBehavior("rdUseUnifiedClientExperience").get_dataValue() ? "true" : "false") + "</allowlegacyclientexperience>";
...
function GetAllowLegacyDialogsEmbeddingSetting()
{
if (typeof(rdAllowLegacyDialogsEmbedding) != "undefined" && !IsNull(rdAllowLegacyDialogsEmbedding) && Mscrm.FormUtility.isControlDirty($get("rdAllowLegacyDialogsEmbedding")))
{
_boAnySettingChanged = true;
return "<allowlegacydialogsembedding>" + (Mscrm.FormControlInputBehavior.GetBehavior("rdAllowLegacyDialogsEmbedding").get_dataValue() ? "true" : "false") + "</allowlegacydialogsembedding>";
}
...
function GetEnableUnifiedInterfaceShellRefreshSetting()
{
if (typeof(rdEnableUnifiedInterfaceShellRefresh) != "undefined" && !IsNull(rdEnableUnifiedInterfaceShellRefresh) && Mscrm.FormUtility.isControlDirty($get("rdEnableUnifiedInterfaceShellRefresh")))
{
_boAnySettingChanged = true;
return "<enableunifiedinterfaceshellrefresh>" + (Mscrm.FormControlInputBehavior.GetBehavior("rdEnableUnifiedInterfaceShellRefresh").get_dataValue() ? "true" : "false") + "</enableunifiedinterfaceshellrefresh>";
}

return "";
}

function GetEnableLivePersonaCardUCISetting()
{
if (typeof(rdEnableLivePersonaCardUCI) != "undefined" && !IsNull(rdEnableLivePersonaCardUCI) && Mscrm.FormUtility.isControlDirty($get("rdEnableLivePersonaCardUCI")))
{
_boAnySettingChanged = true;
return "<enablelivepersonacarduci>" + (Mscrm.FormControlInputBehavior.GetBehavior("rdEnableLivePersonaCardUCI").get_dataValue() ? "true" : "false") + "</enablelivepersonacarduci>";
}

return "";
}

function GetBoundDashboardDefaultCardExpanded()
{
if (typeof(rdBoundDashboardDefaultCardExpanded) != "undefined" && !IsNull(rdBoundDashboardDefaultCardExpanded) && Mscrm.FormUtility.isControlDirty($get("rdBoundDashboardDefaultCardExpanded")))
{
_boAnySettingChanged = true;
return "<bounddashboarddefaultcardexpanded>" + (Mscrm.FormControlInputBehavior.GetBehavior("rdBoundDashboardDefaultCardExpanded").get_dataValue() ? "true" : "false") + "</bounddashboarddefaultcardexpanded>";
}
...
function GetIsContextualHelpEnabled()
{
if (typeof(rdGuidedHelpUCIEnabled) != "undefined" && !IsNull(rdGuidedHelpUCIEnabled) && Mscrm.FormUtility.isControlDirty($get("rdGuidedHelpUCIEnabled")))
{
_boAnySettingChanged = true;
return "<iscontextualhelpenabled>" + (Mscrm.FormControlInputBehavior.GetBehavior("rdGuidedHelpUCIEnabled").get_dataValue() ? "true" : "false") + "</iscontextualhelpenabled>";
}
...
function GetSyncFeatureEnabled()
{
if (!IsNull(rdSyncOptInSelection) && Mscrm.FormUtility.isControlDirty($get("rdSyncOptInSelection")))
{
_boAnySettingChanged = true;
return "<syncoptinselection>" + (Mscrm.FormControlInputBehavior.GetBehavior("rdSyncOptInSelection").get_dataValue() ? "1" : "0") + "</syncoptinselection>" +
"<syncoptinselectionstatus>" + "1" + "</syncoptinselectionstatus>";
}
...
if (ctrl.get_dataValue())
{
return "<enablemicrosoftflowintegration>true</enablemicrosoftflowintegration>"
}

else
{
return "<enablemicrosoftflowintegration>false</enablemicrosoftflowintegration>";
}
}
return "";
}

function onMicrosoftFlowsEnabled()
{
if(Mscrm.FormControlInputBehavior.GetBehavior("rdIsMicrosoftFlowEnabled").get_dataValue())
{
onConfirmEnableMicrosoftFlowIntegration("rdIsMicrosoftFlowEnabled");
}
}

function GetIsQuickCreateEnabledForOpportunityClose()
{
if (!IsNull(rdIsQuickCreateEnabledForOpportunityClose) && Mscrm.FormUtility.isControlDirty($get("rdIsQuickCreateEnabledForOpportunityClose")))
{
_boAnySettingChanged = true;
return "<isquickcreateenabledforopportunityclose>" + (Mscrm.FormControlInputBehavior.GetBehavior("rdIsQuickCreateEnabledForOpportunityClose").get_dataValue() ? "true" : "false") + "</isquickcreateenabledforopportunityclose>";
}
return "";
}

function IsPriceListMandatory()
{
if (!IsNull(rdIsPriceListMandatory) && Mscrm.FormUtility.isControlDirty($get("rdIsPriceListMandatory")))
{
_boAnySettingChanged = true;
return "<ispricelistmandatory>" + (Mscrm.FormControlInputBehavior.GetBehavior("rdIsPriceListMandatory").get_dataValue() ? "false" : "true") + "</ispricelistmandatory>";
}
return "";
}

function GetQualifyLeadAdditionalOptions()
{
if (!IsNull(rdQualifyLeadAdditionalOptions) && Mscrm.FormUtility.isControlDirty($get("rdQualifyLeadAdditionalOptions")))
{
_boAnySettingChanged = true;
var qualifyLeadOptions = GetOptionsFromOrgSettings("rdQualifyLeadAdditionalOptions");
var qualifyLeadOptionsJson = JSON.stringify(qualifyLeadOptions);
try{

var event = {};
event["moduleName"] = "AdminSystemSettings";
event["componentName"] = "Sales";
event["functionName"] = "GetQualifyLeadAdditionalOptions";
event["eventType"] = "information";
event["eventDetails"] = qualifyLeadOptionsJson;
...
return "<qualifyleadadditionaloptions>" + qualifyLeadOptionsJson + "</qualifyleadadditionaloptions>";
}
return "";
}

function GetBusinessCardOptions()
{
if (!IsNull(rdBusinessCardOptions) && Mscrm.FormUtility.isControlDirty($get("rdBusinessCardOptions")))
{
_boAnySettingChanged = true;
var businessCardOptions = GetOptionsFromOrgSettings("rdBusinessCardOptions");
return "<businesscardoptions>" + JSON.stringify(businessCardOptions) + "</businesscardoptions>";
}
return "";
}

function GetOptionsFromOrgSettings(buttonId) {
var orgSettings = Xrm.Utility.getGlobalContext().organizationSettings;
var options = {};
var settingName = "";
try {
switch (buttonId) {
case "rdQualifyLeadAdditionalOptions":
options = JSON.parse(orgSettings.attributes.qualifyLeadAdditionalOptions);
settingName = "DefaultQualifyFlow";
break;
case "rdBusinessCardOptions":
options = JSON.parse(orgSettings.attributes.businessCardOptions);
settingName = "StoreBusinessCardImage";
break;
}
}
catch(e)
...
break;
case "rdBusinessCardOptions":
options = { "StoreBusinessCardImage": "true" };
break;
}
}
var chosenOption = Mscrm.FormControlInputBehavior.GetBehavior(buttonId).get_dataValue();
options[settingName] = chosenOption ? "true" : "false";
return options;
}
...
{
alert(LOCID_GLOBAL_HELP_URL_INVALID);
}
}
...
{
if (!IsNull(document.getElementById("picklistSchedulingEngine")))
{
if (Mscrm.FormUtility.isControlDirty($get("picklistSchedulingEngine")))
{
_boAnySettingChanged = true;
return "<schedulingengine>" + CrmEncodeDecode.CrmXmlEncode(Mscrm.FormControlInputBehavior.GetBehavior("picklistSchedulingEngine").get_dataValue() || 0) + "</schedulingengine>";
}
}
...
function GetResolveSimilarEmailAddress()
{
var ctrl = Mscrm.FormControlInputBehavior.GetBehavior("rdResolveSimilarUnresolvedEmailAddress");
if (Mscrm.FormUtility.isControlDirty($get("rdResolveSimilarUnresolvedEmailAddress")))
{
_boAnySettingChanged = true;
return "<resolvesimilarunresolvedemailaddress>" + (ctrl.get_dataValue() ? "true" : "false") + "</resolvesimilarunresolvedemailaddress>";
}
...
function ResolveSimilarEmailAddress_OnChange()
{
var ctrl = Mscrm.FormControlInputBehavior.GetBehavior("rdUnresolveIfMultipleMatch");
var unresolveValue = ctrl.get_dataValue();
var rd = Mscrm.FormControlInputBehavior.GetBehavior("rdResolveSimilarUnresolvedEmailAddress");

if (!unresolveValue)
{
rd.set_dataValue(true);
rd.set_disabled(true);
}
else
{
rd.set_disabled(false);
}
}
...
function GetEnableImmersiveSkypeIntegration()
{
if (Mscrm.FeatureControl.get_Current().isFeatureEnabled(Mscrm.FeatureNames.ImmersiveSkype))
{
if (Mscrm.FormUtility.isControlDirty($get("rdEnableSkypeIntegration")))
{
_boAnySettingChanged = true;
return "<enableimmersiveskypeintegration>" + (Mscrm.FormControlInputBehavior.GetBehavior("rdEnableBingIntegration").get_dataValue() ? "true" : "false") + "</enableimmersiveskypeintegration>";
}
}
return "";
}
...
var _oResult = {};
if(!IsNull(document.getElementById("rtnObjList"))){
var rtn = XUI.Html.DomUtils.GetFirstChild($get("rtnObjList"));
if(typeof(rtn) != 'undefined' && !IsNull(rtn) ){
var oRows = rtn.rows;
var slaPauseStates="" ;
...
if (incidentStatusXml != undefined)
{
...
<%}%>
if(!Mscrm.InternalUtilities.JSTypes.isNull($get("PrimaryEntity")))
{
var primaryEntity = $get("PrimaryEntity").value;
...
<tr>
<td class="ms-crm-Form-Section ms-crm-Form-SectionBar" tabindex="-1" id="labelEnableTextWrap" valign="bottom" nowrap><loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.MiscTab.IsTextWrapEnable.Title" runat="server"/></td>
<td valign="center" role="radiogroup" aria-labelledby="labelEnableTextWrap" ><crm:Radio id="rbEnableTextWrap"  runat="server"/></td>
</tr>
<tr>
...
<tr>
<td nowrap valign="center"><label tabindex="-1" id="labelIsAutoSaveEnabled" for="rdIsAutoSaveEnabled"><loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.MiscTab.IsAutoSaveEnabled.Labels.IsAutoSaveEnabled" runat="server"/></label></td>
<td valign="center" role="radiogroup" aria-labelledby="labelIsAutoSaveEnabled"><crm:Radio id="rdIsAutoSaveEnabled" runat="server"/></td>
<td></td>
</tr>
<tr>
<td class="ms-crm-Form-Section ms-crm-Form-SectionBar" colspan="3" valign="bottom" nowrap><BR><loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.MiscTab.IsImmersiveSkypeIntegrationEnabled.Title" runat="server"/></td>
</tr>
<tr>
<td nowrap valign="center"><label tabindex="-1" id="labelIsPresenceEnabled" for="rdIsPresenceEnabled"><loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.MiscTab.IsPresenceEnabled.Label" runat="server"/></label></td>
<td valign="center" role="radiogroup" aria-labelledby="labelIsPresenceEnabled"><crm:Radio id="rdIsPresenceEnabled" runat="server"/></td>
<td></td>
</tr>
<% if (ShowImmersiveSkypeOption) {%>
<tr>
<td nowrap valign="center"><label tabindex="-1" id="labelEnableSkypeIntegration" for="rdEnableSkypeIntegration"><loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.MiscTab.IsImmersiveSkypeIntegrationEnabled.Label" runat="server"/></label></td>
<td valign="center" role="radiogroup" aria-labelledby="labelEnableSkypeIntegration"><crm:Radio id="rdEnableSkypeIntegration" runat="server"/></td>
<td></td>
</tr>
<% } %>
<% if (IsMSTeamsFeatureEnabledForOrg && IsMSTeamsSettingFeatureEnabled) {%>
<tr>
<td class="ms-crm-Form-Section ms-crm-Form-SectionBar" colspan="3" valign="bottom" nowrap><BR><loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.MSTeamsIntegration.Title" runat="server"/></td>
</tr>
<tr>
<td nowrap valign="center">
<label tabindex="-1" id="labelMSteamsSetting" for="rdMSTeamsIntegration">
<loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.MSTeamsIntegration" runat="server"/>
</label>
</td>
<td valign="center" colspan="2" role="radiogroup" aria-labelledby="labelMSteamsSetting">
<crm:Radio id="rdMSTeamsIntegration" OnChange="onMSTeamsFeatureSelectionChanged('rdMSTeamsIntegration');" runat="server"/>
</td>
</tr>

<% } %>

<% if (IsMSTeamsFeatureEnabledForOrg && IsMSTeamsSettingFeatureEnabled && IsMSTeamsEnhancedFeatureEnabled && IsOctober2019UpdateEnabled) {%>
<tr>
<td nowrap valign="center">
<label tabindex="-1" id="labelMSteamsEnhancedCollaboration" for="rdMSTeamsEnhancedCollaboration">
<loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.MSTeamsEnhancedCollaboration" runat="server"/>
</label>
</td>
<td valign="center" colspan="2" role="radiogroup" aria-labelledby="labelMSteamsEnhancedCollaboration">
<crm:Radio id="rdMSTeamsEnhancedCollaboration" OnChange="onMSTeamsEnhancedCollaborationSelectionChanged('rdMSTeamsEnhancedCollaboration', 'MSTeamsCollaboration');" runat="server"/>
</td>
</tr>
...
<tr>
<td nowrap valign="center"><label tabindex="-1" id="labelShareOnAssign" for="rdShareOnAssign"><loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.MiscTab.AssigningObjectsSection.Labels.ShareOnAssign" runat="server"/></label></td>
<td valign="center" role="radiogroup" aria-labelledby="labelShareOnAssign"><crm:Radio id="rdShareOnAssign" runat="server"/></td>
<td></td>
</tr>
<tr>
...
<% if(ShowExternalSearchOption || IsQuickFindRecordLimitEnabledDefined || IsFullTextSearchEnabledDefined || (IsApril2020UpdateEnabled && IsGridSearchCanUseCurrentViewFeatureEnabled && UseQuickFindViewForGridSearchOption)) {
...
<tr>
<td nowrap valign="center"><label tabindex="-1" id="labelQuickFindRecordLimitEnabled" for="rdQuickFindRecordLimitEnabled"><loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.MiscTab.QuickFindRecordLimitEnabled.Labels.QuickFindRecordLimitEnabled" runat="server"/></label></td>
<td valign="center" role="radiogroup" aria-labelledby="labelQuickFindRecordLimitEnabled"><crm:Radio id="rdQuickFindRecordLimitEnabled" runat="server"/></td>
<td></td>
</tr>
<% if (IsFullTextSearchEnabledDefined) {%>
<tr>
<td nowrap valign="center"><label tabindex="-1" id="labelIsFullTextSearchEnabled" for="rdIsFullTextSearchEnabled"><loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.MiscTab.IsFullTextSearchEnabled.Labels.IsFullTextSearchEnabled" runat="server"/></label></td>
<td valign="center" role="radiogroup" aria-labelledby="labelIsFullTextSearchEnabled"><crm:Radio id="rdIsFullTextSearchEnabled" runat="server" OnChange="onIsFullTextSearchEnabledChange()"/></td>
<td></td>
</tr>
<%} %>
<% if (IsApril2020UpdateEnabled && IsGridSearchCanUseCurrentViewFeatureEnabled & UseQuickFindViewForGridSearchOption)
{%>
<tr>
<td nowrap valign="center"><label tabindex="-1" id="labelUseQuickFindViewForGridSearch" for="rdUseQuickFindViewForGridSearch"><loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.MiscTab.UseQuickFindViewForGridSearch.Labels.UseQuickFindViewForGridSearch" runat="server"/></label></td>
<td valign="center" role="radiogroup" aria-labelledby="labelUseQuickFindViewForGridSearch"><crm:Radio id="rdUseQuickFindViewForGridSearch" runat="server"/></td>
<td></td>
</tr>
<%} %>
<tr>
...
<tr>
<td nowrap valign="center"><label tabindex="-1" id="labelEnableBingIntegration" for="rdEnableBingIntegration"><loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.MiscTab.IsBingMapsIntegrationEnabled.Labels.IsBingMapsIntegrationEnabled" runat="server"/></label></td>
<td valign="center" role="radiogroup" aria-labelledby="labelEnableBingIntegration"><crm:Radio id="rdEnableBingIntegration" runat="server" OnChange="onEnableBingMapsChange()"/></td>
...
<tr>
<td colspan="3" valign="bottom" nowrap tabindex="-1" id="labelUseSkypeProtocol"><loc:Text ResourceId="defaultprotocollabel" runat="server"/></td>
</tr>
<tr>
<td>
<table width="100%">
...
<tr>
<td></td>
<td colspan="3" nowrap valign="center" role="radiogroup" aria-labelledby="labelUseSkypeProtocol"><crm:Radio id="rdUseSkypeProtocol" runat="server"/></td>
</tr>
</table>
</td>
</tr>
...
<tr>
<td nowrap valign="center" ><label tabindex="-1" id="labelAllowUsersSeeAppDownloadMessage" for="rdAllowUsersSeeAppDownloadMessage"><loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.OSTab.MobileAppNotificationDisplayOption.Labels.AllowUsersSeeAppDownloadMessage" runat="server"/></label></td>
<td valign="center" role="radiogroup" aria-labelledby="labelAllowUsersSeeAppDownloadMessage"><crm:Radio id="rdAllowUsersSeeAppDownloadMessage" runat="server"/></td>
<td></td>
</tr>
<%} %>
...
<tr>
<td nowrap valign="center"><label tabindex="-1" id="labelCustomizedHelpEnabled" for="rdCustomizedHelpEnabled"><loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.MiscTab.URLHelp.RLabel" runat="server"/></label></td>
<td valign="center" role="radiogroup" aria-labelledby="labelCustomizedHelpEnabled"><crm:Radio id="rdCustomizedHelpEnabled" OnChange="onEnableCustomizableHelpChange();" runat="server"/></td>
<td></td>
</tr>
<tr>
...
<tr>
<td nowrap valign="center"><label tabindex="-1" id="labelAppendURLParametersEnabled" for="rdAppendURLParametersEnabled"><loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.MiscTab.URLHelp.AppendURLParameters" runat="server"/></label></td>
<td valign="center" role="radiogroup" aria-labelledby="labelAppendURLParametersEnabled"><crm:Radio id="rdAppendURLParametersEnabled" runat="server"/></td>
<td></td>
</tr>
<%if (FeatureEnabledHelper.IsNonOrgFeatureEnabled(FeatureControl.Current.Features.InContextHelp, Microsoft.Crm.Application.Security.UserInformation.Current)) {%>
<tr>
<td nowrap valign="center"><label tabindex="-1" id="labelGuidedHelpEnabled" for="rdGuidedHelpEnabled" runat="server"><loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.MiscTab.URLHelp.LearningPath" runat="server"/></label></td>
...
<tr>
<td nowrap valign="center"><label tabindex="-1" id="labelLPAuthoringEnabled" for="rdLPAuthoringEnabled" runat="server"><loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.MiscTab.URLHelp.LearningPathAuthoring" runat="server"/></label></td>
...
<%} %>
<tr>
<td nowrap valign="center"><label tabindex="-1" id="labelGuidedHelpUCIEnabled" for="rdGuidedHelpUCIEnabled" runat="server"><loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.MiscTab.URLHelp.LearningPathUCI" runat="server"/></label></td>
<td valign="center" role="radiogroup" aria-labelledby="labelGuidedHelpUCIEnabled"><crm:Radio id="rdGuidedHelpUCIEnabled" runat="server"/></td>
<td></td>
</tr>
<%} %>
<tr>
...
<tr>
<td nowrap valign="center"><label tabindex="-1" id="labelIsSocialCareDisabled" for="rdIsSocialCareDisabled"><loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.GenTab.DisableSocialCare.Label" runat="server"/></label></td>
<td valign="center" role="radiogroup" aria-labelledby="labelIsSocialCareDisabled"><crm:Radio id="rdIsSocialCareDisabled" runat="server" /></td>
<td></td>
</tr>
<tr>
...
<tr>
<td nowrap valign="center"><label tabindex="-1" id="labelDisplayNavigationTour" for="rdDisplayNavigationTour"><loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.GenTab.DisplayNavigationTour.Label" runat="server"/></label></td>
<td valign="center" role="radiogroup" aria-labelledby="labelDisplayNavigationTour"><crm:Radio id="rdDisplayNavigationTour" runat="server" /></td>
<td></td>
</tr>
<% if (ShowUseUnifiedClientExperienceSetting){ %>
<tr>
<td class="ms-crm-Form-Section ms-crm-Form-SectionBar" colspan="3" valign="bottom" nowrap><BR><label id="labelUseUnifiedClientExperienceTitle" runat="server"><loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.GenTab.UseUnifiedClientExperience.Title" runat="server"/></label></td>
</tr>
<tr>
<td nowrap valign="center"><label tabindex="-1" id="labelUseUnifiedClientExperience" for="rdUseUnifiedClientExperience" runat="server"><loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.GenTab.UseUnifiedClientExperience.Label" runat="server"/></label>
<p tabindex="-1" id="P1" for="rdUseUnifiedClientExperience" runat="server"> <%=SupportedClassicWebText%> </p>
</td>
<td valign="top" role="radiogroup" aria-labelledby="labelUseUnifiedClientExperience"><crm:Radio id="rdUseUnifiedClientExperience" runat="server" /></td>
<td></td>
</tr>
<% } %>

<tr id="IsEnabledForAllRolesTitle_tr">
<td class="ms-crm-Form-Section ms-crm-Form-SectionBar" colspan="3" valign="bottom" nowrap><BR><loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.MiscTab.IsEnabledForAllRoles.Title" runat="server"/></td>
</tr>
<tr id="IsEnabledForAllRoles_tr">
<td nowrap valign="center"><label tabindex="-1" id="labelIsEnabledForAllRoles" for="rdIsEnabledForAllRoles" runat="server"><loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.MiscTab.IsEnabledForAllRoles.Labels.IsEnabledForAllRoles" runat="server"/></label>
<p tabindex="-1" id="label4" for="rdIsEnabledForAllRoles" runat="server"> <%=SupportedCustomD365Text%> </p>
</td>
<td valign="top" role="radiogroup" aria-labelledby="labelIsEnabledForAllRoles"><crm:Radio id="rdIsEnabledForAllRoles" runat="server"/></td>
<td></td>
</tr>
<tr id="DefaultCrmCustomName_tr">
...
<tr id = "labelUseLegacyFormRenderingTitle_tr">
...
<tr id = "labelUseLegacyFormRendering_tr">
<td nowrap valign="center"><label tabindex="-1" id="labelUseLegacyFormRendering" for="rdUseLegacyFormRendering" runat="server"><loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.GenTab.LegacyFormRendering.Label" runat="server"/></label></td>
<td valign="center" role="radiogroup" aria-labelledby="labelUseLegacyFormRendering"><crm:Radio id="rdUseLegacyFormRendering" runat="server" /></td>
<td></td>
</tr>
<tr>
<td class="ms-crm-Form-Section ms-crm-Form-SectionBar" colspan="3" valign="bottom" nowrap><BR><label id="boundDashboardDefaultCardExpandedTitle" runat="server"><loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.GenTab.BoundDashboardDefaultCardExpanded.Title" runat="server"/></label></td>
</tr>
<tr>
<td nowrap valign="center"><label tabindex="-1" id="boundDashboardDefaultCardExpandedlabel" for="rdBoundDashboardDefaultCardExpanded" runat="server"><loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.GenTab.BoundDashboardDefaultCardExpanded.Label" runat="server"/></label></td>
<td valign="center" role="radiogroup" aria-labelledby="boundDashboardDefaultCardExpandedlabel"><crm:Radio id="rdBoundDashboardDefaultCardExpanded" runat="server" /></td>
<td></td>
</tr>
<% if (IsCustomSessionTimeoutEnabled){%>
...
<tr>
<td nowrap valign="center">
<label tabindex="-1" id="labelSessionTimeoutEnabled" for="rdSessionTimeoutEnabled">
...
<tr>
<td nowrap valign="center">
<label tabindex="-1" id="labelInactivityTimeoutEnabled" for="rdInactivityTimeoutEnabled">
...
<% } %>
<% if (IsAllowLegacyDialogUCIFCBEnabled){ %>
<tr>
<td class="ms-crm-Form-Section ms-crm-Form-SectionBar" colspan="3" valign="bottom" nowrap><BR><label id="labelAllowLegacyDialogsEmbeddingTitle" runat="server"><loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.GenTab.AllowLegacyDialogsEmbedding.Title" runat="server"/></label></td>
</tr>
<tr>
<td nowrap valign="center"><label tabindex="-1" id="labelAllowLegacyDialogsEmbedding" for="rdAllowLegacyDialogsEmbedding" runat="server"><%=SupportedHybridDialogText%></label></td>
<td valign="center" role="radiogroup" aria-labelledby="labelAllowLegacyDialogsEmbedding"><crm:Radio id="rdAllowLegacyDialogsEmbedding" runat="server" /></td>
<td></td>
</tr>
<% } %>
<% if (IsLivePersonaCardUCIFCBEnabled) {%>
<tr>
<td class="ms-crm-Form-Section ms-crm-Form-SectionBar" colspan="3" valign="bottom" nowrap><BR><label id="labelEnableLivePersonaCardUCITitle" runat="server"><loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.GenTab.EnableLivePersonaCardUCI.Title" runat="server"/></label></td>
</tr>
<tr>
<td nowrap valign="center"><label tabindex="-1" id="labelEnableLivePersonaCardUCI" for="rdEnableLivePersonaCardUCI"><loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.GenTab.EnableLivePersonaCardUCI.Label" runat="server"/></label></td>
<td valign="center" role="radiogroup" aria-labelledby="labelEnableLivePersonaCardUCI"><crm:Radio id="rdEnableLivePersonaCardUCI" runat="server"/></td>
<td></td>
</tr>
<% } %>
<% if (IsUciShellRefreshFCBEnabled){ %>
<tr>
<td class="ms-crm-Form-Section ms-crm-Form-SectionBar" colspan="3" valign="bottom" nowrap><BR><label id="labelEnableUnifiedInterfaceShellRefreshTitle" runat="server"><loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.GenTab.EnableUnifiedInterfaceShellRefresh.Title" runat="server"/></label></td>
</tr>
<tr>
<td nowrap valign="center"><label tabindex="-1" id="labelEnableUnifiedInterfaceShellRefresh" for="rdEnableUnifiedInterfaceShellRefresh" runat="server"><%=UnifiedInterfaceShellRefreshLink%></label></td>
<td valign="center" role="radiogroup" aria-labelledby="labelEnableUnifiedInterfaceShellRefresh"><crm:Radio id="rdEnableUnifiedInterfaceShellRefresh" runat="server" /></td>
<td></td>
</tr>
<% } %>
<tr>
...
{%>
<tr>
<td class="ms-crm-Form-Section ms-crm-Form-SectionBar" colspan="4" valign="bottom" nowrap><loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.GenTab.TimelineRichTextNotes.Title" runat="server"/></td>
</tr>
<tr>
<td colspan="4"><loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.GenTab.TimelineRichTextNotes.Labels.Info" runat="server"/></td>
</tr>
<tr>
<td colspan="4" nowrap valign="center"><crm:CheckBox id="ckRichTextNotesForTimeline" runat="server"/><label for="ckRichTextNotesForTimeline"><loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.GenTab.TimelineRichTextNotes.Labels.Description" runat="server"/></label></td>
</tr>
<tr>
<td colspan="4"><loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.GenTab.TimelineRichTextNotes.Labels.Warning" runat="server"/></td>
<%}%>
</table>
</div>
...
<% if (ShowSchedulingEngineOption) {%>
<tr>
<td nowrap valign="center"><label for="picklistSchedulingEngine"><loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.CalendarSection.Scheduling.Label.SchedulingEngine" runat="server"/></label></td>
<td valign="center"><sdk:PicklistControl id="picklistSchedulingEngine" runat="server"/></td>
<td></td>
</tr>
<% } %>
</table>
...
<tr>
<td  nowrap valign="center"><label tabindex="-1" id="labelUseSecureFrame" for="rdUseSecureFrame"><loc:Text ResourceId="SysCustomization.SysSettingsDlg.EmailTab.UseSecureFrame.Label" runat="server"/></label></td>
<td valign="center" role="radiogroup" aria-labelledby="labelUseSecureFrame"><crm:Radio id="rdUseSecureFrame"  runat="server"/></td>
<td></td>
</tr>

<tr>
<td  nowrap valign="center"><label tabindex="-1" id="labelAllowUnresolvedParty" for="rdAllowUnresolvedParty"><loc:Text ResourceId="SysCustomization.SysSettingsDlg.EmailTab.AllowUnresolvedParty.Title" runat="server" /></label></td>
<td valign="center" role="radiogroup" aria-labelledby="labelAllowUnresolvedParty"><crm:Radio id="rdAllowUnresolvedParty"  runat="server"/></td>
<td></td>
</tr>
<% if (IsMultipleContactResolutionFCBEnabled){ %>
<tr>
<td nowrap valign="center"><label tabindex="-1" id="labelUnresolveIfMultipleMatch" for="rdUnresolveIfMultipleMatch" runat="server"><loc:Text ResourceId="SysCustomization.SysSettingsDlg.EmailTab.UnresolveEmailAddressIfMultipleMatch.Title" runat="server" /></label></td>
<td valign="center" role="radiogroup" aria-labelledby="labelUnresolveIfMultipleMatch"><crm:Radio id="rdUnresolveIfMultipleMatch" onchange="ResolveSimilarEmailAddress_OnChange();" runat="server"/></td>
<td></td>
</tr>
<tr>
<td nowrap valign="center"><label tabindex="-1" id="labelResolveSimilarUnresolvedEmailAddress" for="rdResolveSimilarUnresolvedEmailAddress" runat="server"><loc:Text ResourceId="SysCustomization.SysSettingsDlg.EmailTab.ResolveSimilarUnresolvedEmailAddress.Title" runat="server" /></label></td>
<td valign="center" role="radiogroup" aria-labelledby="labelResolveSimilarUnresolvedEmailAddress"><crm:Radio id="rdResolveSimilarUnresolvedEmailAddress" runat="server"/></td>
<td></td>
</tr>
<% } %>
<tr>
...
{%>
<tr>
<td class="ms-crm-Form-Section ms-crm-Form-SectionBar" colspan="4" valign="bottom" nowrap><loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.EmailTab.TimelineEnhancedEmail.Labels.Title" runat="server"/></td>
</tr>
<tr>
<td colspan="3"><loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.EmailTab.TimelineEnhancedEmail.Labels.Info" runat="server"/></td>
</tr>
<tr>
<td></td>
<td colspan="3" nowrap valign="center"><crm:CheckBox id="ckContextualEmail" runat="server"/><label for="ckContextualEmail"><loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.EmailTab.TimelineEnhancedEmail.Labels.Description" runat="server"/></label></td>
</tr>
<%}%>
...
<col width="67%"><col width="31%"><col/>
<tr>
<td class="ms-crm-Form-Section ms-crm-Form-SectionBar" colspan="3" valign="bottom" nowrap><loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.EmailTab.BulkEmail.Title" runat="server"/></td>
</tr>
<tr>
<td nowrap valign="center"><label tabindex="-1" id="labelBulkEmailUCI" for="rdBulkEmailUCI"><loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.EmailTab.BulkEmail.Label" runat="server"/></label></td>
<td valign="center" role="radiogroup" aria-labelledby="labelBulkEmailUCI"><crm:Radio id="rdBulkEmailUCI"  runat="server"/></td>
<td></td>
</tr>
</table>
<% } %>
...
<tr>
<td nowrap valign="center"><label tabindex="-1" id="labelEnableExecution" for="rdEnableExecution"><loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.MarketingTab.ExecutionSection.Labels.Execution" runat="server"/></label></td>
<td valign="center" role="radiogroup" aria-labelledby="labelEnableExecution"><crm:Radio id="rdEnableExecution"  runat="server"/></td>
<td></td>
</tr>
...
<tr>
<td nowrap valign="center"><label tabindex="-1" id="labelEnableResponseCreation" for="rdEnableResponseCreation"><loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.MarketingTab.ResponseSection.Labels.ResponseCreation" runat="server"/></label></td>
<td valign="center" role="radiogroup" aria-labelledby="labelEnableResponseCreation"><crm:Radio id="rdEnableResponseCreation"  runat="server"/></td>
<td></td>
</tr>
...
<tr>
<td nowrap valign="center"><label tabindex="-1" id="labelEnableUnsubscription" for="rdEnableUnsubscription"><loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.MarketingTab.UnsubscribeSection.Labels.Unsubscription" runat="server"/></label></td>
<td valign="center" role="radiogroup" aria-labelledby="labelEnableUnsubscription"><crm:Radio id="rdEnableUnsubscription" OnChange="onEnableUnsubscriptionChange();" runat="server"/></td>

<td></td>
</tr>
<tr height="7px"><td></td></tr>
<tr>
<td nowrap valign="center"><label tabindex="-1" id="labelEnableUnsubscriptionAcknowledgement" for="rdEnableUnsubscriptionAcknowledgement"><loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.MarketingTab.UnsubscribeSection.Labels.UnsubscriptionAcknowledgement" runat="server"/></label></td>
<td valign="center" role="radiogroup" aria-labelledby="labelEnableUnsubscriptionAcknowledgement"><crm:Radio id="rdEnableUnsubscriptionAcknowledgement" OnChange="onEnableUnsubscriptionAcknowledgementChange();" runat="server"/></td>
...
<tr>
<td nowrap valign="center"><label tabindex="-1" id="labelIsConflictDetectionEnabledForMobileClient" for="rdIsConflictDetectionEnabledForMobileClient" runat="server"><loc:text resourceid="SystemCustomization.SystemSettingsDialog.GeneralTab.Label.IsConflictDetectionForMobileEnabled" runat="server" /></label></td>
<td valign="center" role="radiogroup" aria-labelledby="labelIsConflictDetectionEnabledForMobileClient"><crm:Radio id="rdIsConflictDetectionEnabledForMobileClient" runat="server" /></td>
<td></td>
</tr>
<% } %>
</table>
...
<% if (ShowMicrosoftFlowOption) {%>
<tr>
<td class="ms-crm-Form-Section ms-crm-Form-SectionBar" colspan="3" valign="bottom" nowrap><BR><loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.PreviewTab.IsMicrosoftFlowEnabled.Title" runat="server"/></td>
</tr>
<tr>
<td nowrap valign="center">
<label tabindex="-1" id="labelIsMicrosoftFlowEnabled" for="rdIsMicrosoftFlowEnabled">
<% if (RemoveAbilityToDisableFlowsIntegration){%>
<loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.PreviewTab.IsMicrosoftFlowEnabled.Labels.IsMicrosoftFlowEnabledAndCannotDisableFlowIntegration" runat="server"/>
<% } else { %>
<loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.PreviewTab.IsMicrosoftFlowEnabled.Labels.IsMicrosoftFlowEnabled" runat="server"/>
<% } %>
</label>
</td>
<td valign="center" colspan="2" role="radiogroup" aria-labelledby="labelIsMicrosoftFlowEnabled">
<table>
<tr>
<td><crm:Radio id="rdIsMicrosoftFlowEnabled" OnChange="onMicrosoftFlowsEnabled();" runat="server" /></td>
</tr>
</table>
</td>
</tr>
...
<tr>
<td nowrap valign="center"><label tabindex="-1" id="labelTagMaxAggressiveCycles" for="rdTagMaxAggressiveCycles"><loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.OSTab.EmailSection.Labels.TagMaxACycles" runat="server"/></label></td>
<td valign="center" role="radiogroup" aria-labelledby="labelTagMaxAggressiveCycles"><crm:Radio id="rdTagMaxAggressiveCycles" runat="server"/></td>
<td></td>
</tr>
<tr>
...
<tr>
<td nowrap valign="center"><label tabindex="-1" id="labelAllowScheduledSyncs" for="rdAllowScheduledSyncs"><loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.OSTab.ControlSchedSyncSection.Labels.AllowScheduledSyncs" runat="server"/></label></td>
<td valign="center" role="radiogroup" aria-labelledby="labelAllowScheduledSyncs"><crm:Radio OnChange="onScheduledSyncToggled();" id="rdAllowScheduledSyncs" runat="server"/></td>
<td></td>
</tr>
...
<tr>
<td nowrap valign="center"><label tabindex="-1" id="labelAllowOfflineScheduledSyncs" for="rdAllowOfflineScheduledSyncs"><loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.OSTab.ControlOfflineSchedSyncSection.Labels.AllowOfflineSyncs" runat="server"/></label></td>
<td valign="center" role="radiogroup" aria-labelledby="labelAllowOfflineScheduledSyncs"><crm:Radio OnChange="onOfflineSyncToggled();" id="rdAllowOfflineScheduledSyncs" runat="server"/></td>
<td></td>
</tr>
...
<tr>
<td nowrap valign="center"><label tabindex="-1" id="labelAllowAddressBookSyncs" for="rdAllowAddressBookSyncs"><loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.OSTab.ControlAddressBookSyncSection.Labels.AllowAddressBookSyncs" runat="server"/></label></td>
<td valign="center" role="radiogroup" aria-labelledby="labelAllowAddressBookSyncs"><crm:Radio OnChange="onAddressBookSyncToggled();" id="rdAllowAddressBookSyncs" runat="server"/></td>
<td></td>
</tr>
<tr>
...
<tr>
<td nowrap valign="center"><label tabindex="-1" id="labelAllowClientMessageBarAd" for="rdAllowClientMessageBarAd"><loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.OSTab.ControlMessageBarSection.Labels.AllowClientMessageBarAd" runat="server"/></label></td>
<td valign="center" role="radiogroup" aria-labelledby="labelAllowClientMessageBarAd"><crm:Radio id="rdAllowClientMessageBarAd" runat="server"/></td>
<td></td>
</tr>
</table>
</div>
...
<% if (Microsoft.Crm.ObjectModel.PowerBIUtility.IsPowerBIEmbedFCBEnabled(Microsoft.Crm.Application.Security.UserInformation.Current) && !Microsoft.Crm.Application.Utility.Util.IsOnPremise())
{%>
<tr>
<td class="ms-crm-Form-Section ms-crm-Form-SectionBar" colspan="3" valign="bottom" nowrap>
<br>
...
<tr>
<td nowrap valign="center">
<label tabindex="-1" id="labelUsePowererBiFeature" for="rdPowerBiFeatureEnabled" runat="server">
<loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.ReportTab.PowerBISection.Selection" runat="server" />
</label>
</td>
<td valign="center" role="radiogroup" aria-labelledby="labelUsePowererBiFeature">
...
<tr>
<td nowrap valign="center"><label tabindex="-1" id="labelCreateProductsWithoutParentInActiveState" for="rdCreateProductsWithoutParentInActiveState"><loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.SalesTab.Label.CreateProductsWithoutParentInActiveState" runat="server"/></label></td>
<td valign="center" role="radiogroup" aria-labelledby="labelCreateProductsWithoutParentInActiveState"><crm:Radio id="rdCreateProductsWithoutParentInActiveState" runat="server"/></td>
<td></td>
</tr>
<tr>
<td>
...
<tr>
<td nowrap valign="center"><label tabindex="-1" id="labelDefaultPricelistRuleEnabled" for="rdDefaultPricelistRuleEnabled"><loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.SalesTab.Label.UseInbuiltRuleForDefaultPricelistSelection" runat="server"/></label></td>
<td valign="center" width ="30%" role="radiogroup" aria-labelledby="labelDefaultPricelistRuleEnabled"><crm:Radio id="rdDefaultPricelistRuleEnabled" runat="server"/></td>
<td></td>
</tr>
<tr>
...
<tr>
<td nowrap valign="center"><label tabindex="-1" id="labelOOBPriceCalculationEnabled" for="rdOOBPriceCalculationEnabled"><loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.SalesTab.Label.OOBPriceCalculationEnabled" runat="server"/></label></td>
<td valign="center" role="radiogroup" aria-labelledby="labelOOBPriceCalculationEnabled"><crm:Radio id="rdOOBPriceCalculationEnabled" runat="server"/></td>
<td></td>
</tr>
<tr>
...
<% if (IsQuickCreateEnabledForOpportunityClose) {%>
<tr>
<td class="ms-crm-Form-Section ms-crm-Form-SectionBar" colspan="3" valign="bottom" nowrap><BR><loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.SalesTab.QuickCreateForOpportunityClose.Title" runat="server"/>
</tr>
<tr>
<td nowrap valign="center"><label tabindex="-1" id="labelQuickCreateEnabledForOpportunityClose" for="rdIsQuickCreateEnabledForOpportunityClose" runat="server"><%=QuickCreateOpportunityCloseLinkText%></label></td>
<td valign="center" role="radiogroup" aria-labelledby="labelQuickCreateEnabledForOpportunityClose"><crm:Radio id="rdIsQuickCreateEnabledForOpportunityClose" runat="server"/></td>
<td></td>
</tr>
<%} %>
<% if (IsPriceListMandatory) {%>
...
<td class="ms-crm-Form-Section ms-crm-Form-SectionBar" colspan="3" valign="bottom" nowrap>
<br>
<loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.SalesTab.IsPriceListMandatory.Title" runat="server" />
</tr>
<tr>
<td nowrap valign="center">
<label tabindex="-1" id="labelIsPriceListMandatory" for="rdIsPriceListMandatory" runat="server"><%=IsPriceListMandatoryLinkText%></label></td>
<td valign="center" role="radiogroup" aria-labelledby="labelIsPriceListMandatory"><crm:Radio id="rdIsPriceListMandatory" runat="server" />
</td>
<td></td>
</tr>
<%} %>
<% if (IsOctober2019UpdateEnabled) {%>
<tr>
<td class="ms-crm-Form-Section ms-crm-Form-SectionBar" colspan="3" valign="bottom" nowrap><BR><loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.SalesTab.QualifyLeadAdditionalOptions.Title" runat="server"/></td>
</tr>
<tr>
<td nowrap valign="center"><label tabindex="-1" id="labelQualifyLeadAdditionalOptions" for="rdQualifyLeadAdditionalOptions"><loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.SalesTab.Label.QualifyLeadAdditionalOptions" runat="server"/></label></td>
<td valign="center" role="radiogroup" aria-labelledby="labelQualifyLeadAdditionalOptions"><crm:Radio id="rdQualifyLeadAdditionalOptions" runat="server"/></td>
<td></td>
</tr>
<tr>
<td>
<loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.SalesTab.Note.QualifyLeadAdditionalOptions" runat="server"></loc:Text>
</td>
</tr>
<%} %>
<% if (ShowBusinessCardOptions) {%>
<tr>
<td class="ms-crm-Form-Section ms-crm-Form-SectionBar" colspan="3" valign="bottom" nowrap><BR><loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.SalesTab.BusinessCardOptions.Title" runat="server"/></td>
</tr>
<tr>
<td nowrap valign="center"><label tabindex="-1" id="labelBusinessCardOptions" for="rdBusinessCardOptions"><loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.SalesTab.Label.BusinessCardOptions" runat="server"/></label></td>
<td valign="center" role="radiogroup" aria-labelledby="labelBusinessCardOptions"><crm:Radio id="rdBusinessCardOptions" runat="server"/></td>
<td></td>
</tr>
<%} %>
</table>
...
<tr>
<% if (IsSLAEnabled) {%>
<td nowrap valign="center"><label id="labelIsSLASuppressed" for="rdIsSLASuppressed"><loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.GenTab.SuppressEntitySLA.Label" runat="server"/></label></td>
<%} %>
<% else {%>
<td nowrap valign="center"><label tabindex="-1" id="labelIsSLASuppressed"  for="rdIsSLASuppressed"><loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.GenTab.SuppressSLA.Label" runat="server"/></label></td>
<%} %>
<td valign="center" role="radiogroup" aria-labelledby="labelIsSLASuppressed"><crm:Radio id="rdIsSLASuppressed" runat="server" /></td>
<td></td>
</tr>
<tr>
...
<tr>
<% if (IsSLAEnabled) {%>
<td nowrap valign="center"><label tabindex="-1" id="labelAutoApplySLA" for="rdAutoApplySLA"><loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.ServiceTab.AutoApplySLAEntity.Label" runat="server"/></label></td>
<%} %>
<% else {%>
<td nowrap valign="center"><label tabindex="-1" id="labelAutoApplySLA" for="rdAutoApplySLA"><loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.ServiceTab.AutoApplySLA.Label" runat="server"/></label></td>
<%} %>
<td valign="center" role="radiogroup" aria-labelledby="labelAutoApplySLA"><crm:Radio id="rdAutoApplySLA" runat="server" /></td>
<td></td>
</tr>
<% if (IsSLAEnabled) {%>
<tr>
...
<tr>
<td valign="center"><label tabindex="-1" for="rdAutoApplyDefaultOnCaseCreate" id="labelAutoApplyDefaultOnCaseCreate" runat="server"><loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.GenTab.AutoApplyDefaultonCaseCreate.Label" runat="server"/></label></td>
<td valign="center"  role="radiogroup" aria-labelledby="labelAutoApplyDefaultOnCaseCreate"><crm:Radio id="rdAutoApplyDefaultOnCaseCreate" runat="server" /></td>
<td></td>
</tr>
<tr>
<td valign="center"><label tabindex="-1" id="labelAutoApplyDefaultOnCaseUpdate" for="rdAutoApplyDefaultOnCaseUpdate" runat="server"><loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.GenTab.AutoApplyDefaultonCaseUpdate.Label" runat="server"/></label></td>
<td valign="center" role="radiogroup" aria-labelledby="labelAutoApplyDefaultOnCaseUpdate"><crm:Radio id="rdAutoApplyDefaultOnCaseUpdate" runat="server" /></td>
<td></td>
</tr>
</table>
</div>
...
<%if (!Microsoft.Crm.Application.Utility.Util.IsOnPremise())
{%>
...
<tr>
<td tabindex="-1" id="labelIsContactMailingAddressSyncEnabled" class="ms-crm-Form-Section ms-crm-Form-SectionBar" valign="bottom" nowrap><BR>
<loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.SyncInfoTab.SyncSettings.Contacts.Title" runat="server"/>
</td>
</tr>
<tr>
<td nowrap valign="center" role="radiogroup" aria-labelledby="labelIsContactMailingAddressSyncEnabled">
...
<%if (Microsoft.Crm.Application.Utility.Util.IsResourceBookingExchangeSyncFeatureEnabledForOrganization(Microsoft.Crm.Application.Security.UserInformation.Current) && !Microsoft.Crm.Application.Utility.Util.IsOnPremise())
{%>
<tr>
<td class="ms-crm-Form-Section ms-crm-Form-SectionBar" valign="bottom" nowrap><BR>
...
<td valign="center" nowrap>
<label>
<% = String.Format(CultureInfo.InvariantCulture, CrmEncodeDecode.CrmHtmlEncodeForFormatString(AppResourceManager.Default.GetString("SystemCustomization.SystemSettingsDialog.SyncInfoTab.SyncSettings.FeatureDeprecatedWithInfoLink")), "<a href='https://go.microsoft.com/fwlink/?linkid=2096305' target='_blank' class='default-link'>", "</a>") %>
</label>
</td>
</tr>
<%}%>
...
<tr>
<td nowrap valign="center"><label tabindex="-1" id="labelTaskBasedFlowPreview" for="rdTaskBasedFlowPreview"><loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.PreviewTab.TaskBasedFlowPreview" runat="server"/></label></td>
<td valign="center" colspan="2" role="radiogroup" aria-labelledby="labelTaskBasedFlowPreview"><crm:Radio id="rdTaskBasedFlowPreview" runat="server"/></td>
</tr>
<tr>
<td>
<img src="/_imgs/info_16.gif" alt=""/>
...
<tr>
<td nowrap valign="center"><label tabindex="-1" id="labelorgInsightsPreview" for="rdorgInsightsPreview"><loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.PreviewTab.OrganizationInsightsPreview" runat="server"/></label></td>
<td valign="center" colspan="2" role="radiogroup" aria-labelledby="labelorgInsightsPreview"><crm:Radio id="rdorgInsightsPreview" runat="server"/></td>
</tr>
<tr>
<td>
<img src="/_imgs/info_16.gif" alt=""/>
...
<tr>
<td valign="center"><label tabindex="-1" id="labelCortanaProactiveExperiencePreview" for="rdCortanaProactiveExperiencePreview"><loc:Text ResourceId="Cortana.CRM.Feature.Description" runat="server"/></label></td>
<td valign="center" colspan="2" role="radiogroup" aria-labelledby="labelCortanaProactiveExperiencePreview"><crm:Radio id="rdCortanaProactiveExperiencePreview" runat="server"/></td>
</tr>
<tr>
<td>
<img src="/_imgs/info_16.gif" alt=""/>
...
<tr>
<td nowrap valign="center">
<label tabindex="-1" id="labelProductRecommendationsPreview" for="rdProductRecommendationsPreview">
<loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.PreviewTab.ProductRecommendationsPreview" runat="server" />
</label>
</td>
<td valign="center" colspan="2" role="radiogroup" aria-labelledby="labelProductRecommendationsPreview">
...
<%}%>
<%if (IsMSTeamsFeatureEnabledForOrg && !IsMSTeamsSettingFeatureEnabled || IsSalesAssistantFeatureEnabled)
{%>
<tr>
<td class="ms-crm-Form-Section ms-crm-Form-SectionBar" colspan="3" valign="bottom" nowrap><BR><loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.PreviewTab.MSTeamsPreview.Title" runat="server"/></td>
</tr>
<%}%>
<%if (IsMSTeamsFeatureEnabledForOrg && !IsMSTeamsSettingFeatureEnabled)
{%>
<tr>
<td nowrap valign="center">
<label tabindex="-1" id="labelMSteamsPreview" for="rdMSTeamsPreview">
<loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.PreviewTab.MSTeamsPreview" runat="server"/>
</label>
</td>
<td valign="center" colspan="2" role="radiogroup" aria-labelledby="labelMSteamsPreview">
<crm:Radio id="rdMSTeamsPreview" OnChange="onMSTeamsFeatureSelectionChanged('rdMSTeamsPreview');" runat="server"/>
</td>
</tr>
<tr>
<td>
<img src="/_imgs/info_16.gif" alt="" />
<%= MSTeamsPreviewHelpLink %>
</td>
</tr>
<%}%>
<%if (IsSalesAssistantFeatureEnabled)
...
<tr>
<td nowrap valign="center">
<label tabindex="-1" id="labelSalesAssistant" for="rdSalesAssistant">
<loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.PreviewTab.SalesAssistant.Label" runat="server"/>
</label>
</td>
<td valign="center" colspan="2" role="radiogroup" aria-labelledby="labelSalesAssistant">
<crm:Radio id="rdSalesAssistant" runat="server"/>
</td>
</tr>
<%}%>
...
{%>
<tr>
<td class="ms-crm-Form-Section ms-crm-Form-SectionBar" colspan="3" valign="bottom" nowrap><BR><loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.PreviewTab.BotLUISConsent.Title" runat="server"/></td>
</tr>
<tr>
<td nowrap valign="center">
<label tabindex="-1" id="labelLUISConsentPreview" for="rdLUISforD365Bot">
<loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.PreviewTab.BotLUISConsent" runat="server"/>
</label>
</td>
<td valign="center" colspan="2" role="radiogroup" aria-labelledby="labelLUISConsentPreview">
<crm:Radio id="rdLUISforD365Bot" OnChange="onLUISConsentSelectionChanged('rdLUISforD365Bot');" runat="server"/>
</td>
</tr>
<tr>
<td>
<img src="/_imgs/info_16.gif" alt=""/>
<%= Dynamics365BotHelpLink %>
</td>
</tr>
<%}%>
<%if (IsRelationshipIntelligenceEnabled)
...
<%if (IsLeadScoringEnabled && IsLeadScoringSolutionInstalled)
{%>
<tr>
<td nowrap valign="center"><label><%=LeadScoringPreviewText%></label>
</td>
</tr>
<%}%>
<%}%>
...
<td class="ms-crm-Form-Section ms-crm-Form-SectionBar" colspan="3" valign="bottom" nowrap>
<br>
<label id="labelUseSyncFeatureTitle" runat="server">
<loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.PreviewTab.SyncOptInSection.Title" runat="server" />
</label>
</td>
</tr>
<tr>
<td nowrap valign="center" >
<label tabindex="-1" id="labelUseSyncFeature" for="rdSyncOptInSelection" runat="server">
<loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.PreviewTab.SyncOptInSection.Selection" runat="server" />
</label>
</td>
<td valign="center" colspan="2" role="radiogroup" aria-labelledby="labelUseSyncFeature">
<crm:Radio id="rdSyncOptInSelection" OnChange="onSyncOptInSelectionChange('rdSyncOptInSelection');" runat="server" />
</td>
</tr>
<tr>
<td nowrap valign="center"><label for="syncOptInSelectionStatus">
<loc:Text ResourceId="SystemCustomization.SystemSettingsDialog.PreviewTab.SyncOptInSection.SelectionStatus" runat="server"/></label>
</td>
<td valign="center" class="systemsettings_td_trackingpref" colspan="2">
<crm:TextBox id="syncOptInSelectionStatus" runat="server"/>
</td>
</tr>
<%}%>
</table>
