...
<head>
	...
	<script language="javascript" type="text/javascript">
		...
		///     For XlsxCreateUpdate - always want to skip this page after the first load
		///     Remapping of the Entity during XlsxCreateUpdate was cut, so we need to skip this page
		/// </summary>
		/// <returns>Update unless Xlsx-specific conditions are met then XlsxCreateUpdate</returns>
