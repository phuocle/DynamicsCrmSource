...
<table style="width: 100%" cellpadding="0" cellspacing="0">
<tr>
<td class="uiElements_td_FilterLabel" style="white-space: nowrap"><label for="selFilterViews"><span class="ms-crm-Bold-Header"><loc:Text ResourceId="SystemCustomization.EntityListPage.Labels.Filter" runat="server"/></span></label></td>
<td style="width:100%"><ui:Select id="selFilterViews" OnChange="onFilterChange('1039');" runat="server"/></td>
</tr>
</table>
</div>
<div style="bottom: 0px; right: 0px; top: 74px; left: 0px; position: absolute; width: 100%;">
...
<table style="width: 100%" cellpadding="0" cellspacing="0">
<tr>
<td class="uiElements_td_FilterLabel" style="white-space: nowrap"><label for="selFilterCharts"><span class="ms-crm-Bold-Header"><loc:Text ResourceId="SystemCustomization.EntityListPage.Labels.Filter" runat="server"/></span></label></td>
<td style="width:100%"><ui:Select id="selFilterCharts" OnChange="onFilterChange('1111');" runat="server"/></td>
</tr>
</table>
</div>
<div style="bottom: 0px; right: 0px; top: 74px; left: 0px; position: absolute; width: 100%;">
...
<table style="width: 100%" cellpadding="0" cellspacing="0">
<tr>
<td class="attributeList_td_Filter" style="white-space: nowrap"><label for="selFilterAttributes"><span class="ms-crm-Bold-Header"><loc:Text ResourceId="SystemCustomization.EntityListPage.Labels.Filter" runat="server"/></span></label></td>
<td style="width:100%"><ui:Select id="selFilterAttributes" OnChange="onFilterChange('9802');" runat="server"/></td>
</tr>
</table>
</div>
<div style="bottom: 0px; right: 0px; top: 74px; left: 0px; position: absolute; width: 100%;">
...
<table style="width: 100%" cellpadding="0" cellspacing="0">
<tr>
<td class="relationshipList_td_FilterType" style="white-space: nowrap"><label for="selFilterRelationships"><span class="ms-crm-Bold-Header"><loc:Text ResourceId="SystemCustomization.RelationshipListPage.Labels.TypeFilter" runat="server"/></span></label></td>
<td style="width:100%"><ui:Select id="selFilterRelationships" OnChange="onFilterChange('9803',Mscrm.SolutionComponentList.oneToManyRelationshipRole);" runat="server"/></td>
</tr>
</table>
</div>
<div style="bottom: 0px; right: 0px; top: 74px; left: 0px; position: absolute; width: 100%;">
...
<table style="width: 100%" cellpadding="0" cellspacing="0">
<tr>
<td class="relationshipList_td_FilterType" style="white-space: nowrap"><label for="selFilterMRelationships"><span class="ms-crm-Bold-Header"><loc:Text ResourceId="SystemCustomization.RelationshipListPage.Labels.TypeFilter" runat="server"/></span></label></td>
<td style="width:100%"><ui:Select id="selFilterMRelationships" OnChange="onFilterChange('9803',Mscrm.SolutionComponentList.manyToOneRelationshipRole);" runat="server"/></td>
</tr>
</table>
</div>
<div style="bottom: 0px; right: 0px; top: 74px; left: 0px; position: absolute; width: 100%;">
...
<table style="width: 100%" cellpadding="0" cellspacing="0">
<tr>
<td class="relationshipList_td_FilterType" style="white-space: nowrap"><label for="selFilterNToNRelationships"><span class="ms-crm-Bold-Header"><loc:Text ResourceId="SystemCustomization.RelationshipListPage.Labels.TypeFilter" runat="server"/></span></label></td>
<td style="width:100%"><ui:Select id="selFilterNToNRelationships" OnChange="onFilterChange('9803',Mscrm.SolutionComponentList.manyToManyRelationshipRole);" runat="server"/></td>
</tr>
</table>
</div>
<div style="bottom: 0px; right: 0px; top: 74px; left: 0px; position: absolute; width: 100%;">
