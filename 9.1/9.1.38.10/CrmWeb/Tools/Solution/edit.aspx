...
<link rel="stylesheet" type="text/css" href="/_static/_common/styles/npsstyle.css"></link>
<script type="text/javascript" src="/_static/tools/solution/scripts/nps.js"></script>
...
function OnLoad()
{
if (!(!window.redirectToMakerUrl || 0 === window.redirectToMakerUrl.length))
{
Mscrm.SolutionHandler.openSolutionRedirectDialog(window.redirectToMakerUrl);
}
}
window.onload=OnLoad;

Sys.Application.add_load(function () {
intervalId = window.setInterval(loadDefaultNode, 1);
});
...
{
$find('Attribute_friendlyname').set_value(Mscrm.FormControlInputBehavior.GetBehavior("friendlyname").get_dataValue());
$find("Attribute_uniquename").set_value(Mscrm.FormControlInputBehavior.GetBehavior("uniquename").get_dataValue());
$find("Attribute_publisherid").set_value(Mscrm.FormControlInputBehavior.GetBehavior("publisherid").get_dataValue());
$find("Attribute_configurationpageid").set_value(Mscrm.FormControlInputBehavior.GetBehavior("configurationpageid").get_dataValue());
$find("Attribute_version").set_value(Mscrm.FormControlInputBehavior.GetBehavior("version").get_dataValue());
$find("Attribute_description").set_value(Mscrm.FormControlInputBehavior.GetBehavior("description").get_dataValue());
$find("Attribute_ismanaged").set_value(Mscrm.FormControlInputBehavior.GetBehavior("ismanaged").get_dataValue());
$find("Attribute_installedon").set_value(Mscrm.FormControlInputBehavior.GetBehavior("installedon").get_dataValue());
}
}catch(e)
{}
}
...
<table class="ms-crm-Form-Layout" cellspacing="0" cellpadding="0" style="position:fixed;top:90px;height:calc(100% - 90px)">
...
<div id="npsHost" class="npsHost"></div>
