...
<td colspan="2">
<div id="divProgress">
<div id='divFillBg' style='display:inline;position:absolute;left:20px;height:23px;width:360px;background-color:#ffffff;'>&nbsp;</div>
<%if(!Microsoft.Crm.Application.Utility.CrmCultureInfo.CurrentUICulture.TextInfo.IsRightToLeft){ %>
<div id='divFill' class='ms-crm-ProgressBar-fillBar' style='display:inline;position:absolute;left:20px;height:23px;width:0px;'>&nbsp;</div>
<%} else {%>
<div id='divFill' class='ms-crm-ProgressBar-fillBar' style='display:inline;position:absolute;left:381px;height:23px;width:0px;'></div>
<%} %>
<div id='divStatus'	style='display:inline;position:absolute;left:19px;height:23px;width:362px;'><img alt='' src='/_imgs/statusbar.gif' height='23' width='362'></div>
</div>
...
<label for="txtMessages"><loc:Text ResourceId="SystemCustomization.ImportCustomizationsPage.Strings.AdditionalMessages" runat="server"/></label><br/>
