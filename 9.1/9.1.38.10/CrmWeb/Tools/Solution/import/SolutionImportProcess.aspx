...
<div id="infoContainerDiv" style="position:absolute; bottom:5px; top:26px; width:100%; overflow:auto ">
...
<input type="hidden" id="solutionUniqueName" value="<%=Microsoft.Crm.CrmEncodeDecode.CrmHtmlAttributeEncode(solutionImportInformationSection.UniqueName)%>" />
