...
{
uri = Mscrm.CrmUri.create('/Tools/Solution/ExportWizard/MissingDependencyPage.aspx?appSolutionId=' + solutionId);
}
else
{
uri = Mscrm.CrmUri.create('/Tools/Solution/ExportWizard/AdditionalItemsPage.aspx?appSolutionId=' + solutionId);
}
