...
<input type="radio" id="rbRunNow" aria-label="<loc:Text ResourceId="BulkDeleteWizard.AdditionalOptionsPage.RunNow" runat="server" />" onclick="onChangeRbRunNow();" runat="Server" name="Schedule" width="auto" />
</td>
<td>
<label for="chkRunNow">
...
<tr align="left">
<td style="padding-top: 5px; padding-bottom: 5px;">
<input type="radio" id="rdSchedule" aria-label="<loc:Text ResourceId="BulkDeleteWizard.AdditionalOptionsPage.ScheduleText" runat="server" />" onclick="onChangeRbRunNow();" runat="server" name="Schedule" width="auto" checked="true" />
</td>
<td>
<br />
<label id="startTime_c" for="chkRecurrence">
