...
var parentiFrame = window.parent.parent.document.getElementById(window.parent.name);
if (parentiFrame) {
parentiFrame.setAttribute("title", "<%= AppResourceManager.Default.GetString("BulkDeleteWizard.SelectCriteriaPage.Title") %>")
}
}
}
...
<iframe id="searchCriteriaFrame" name="searchCriteriaFrame" width="100%" height="100%" scrolling="no" frameborder="0" role="none">
</iframe>
</frm:WizardForm>
</body>
</html>
