<%@ Page Language="c#" Inherits="Microsoft.Crm.Web.Tools.SyncBulkOperations.WelcomePage" %>
...
{
var oUrl = Mscrm.CrmUri.create("/Tools/SyncBulkOperations/SyncBulkOperationsWizard/SearchCriteriaContainerPage.aspx");
...
syncBulkOperationType = wizardData[1];
if(wizardData.length == 4)
{
viewType = wizardData[2];
viewid = wizardData[3];
WizardSetProperty("viewid", viewid);
WizardSetProperty("viewType", viewType);
}
WizardSetProperty("objectTypeCode", objectTypeCode);
WizardSetProperty("syncBulkOperationType", syncBulkOperationType);
return true;
}
return false;
}
...
<tr valign="top">
<td>
<loc:Text ResourceId="SyncBulkOperations_Wizard_Page1_IntroText" runat="server"/>
</td>
</tr>
<tr height="20">
<td>
...
<li>
<loc:Text ResourceId="SyncBulkOperations_Wizard_Page1_IntroText4" runat="server" />
</li>
<li>
