<%@ Page language="c#" Inherits="Microsoft.Crm.Web.Tools.SyncBulkOperations.AdditionalOptionsPage" %>
...
document.getElementById("rdSchedule").disabled = true;
document.getElementById("rdSchedule").checked = false;
document.getElementById("chkRecurrence").disabled = true;
document.getElementById("chkRecurrence").checked = false;
document.getElementById("checkNotify").disabled = true;
document.getElementById("checkNotify").checked = false;
document.getElementById("rbRunNow").disabled = false;
document.getElementById("rbRunNow").checked = true;
onChangeRbRunNow();
}
...
var entityName = "";
var syncBulkOperationType = "";
if (WizardHasProperty("entityName")) {
entityName = WizardGetProperty("entityName");
}
if (WizardHasProperty("syncBulkOperationType")) {
syncBulkOperationType = WizardGetProperty("syncBulkOperationType");
}
var oUrl = Mscrm.CrmUri.create("/Tools/SyncBulkOperations/SyncBulkOperationsWizard/SummaryPage.aspx");
oUrl.get_query()["entityName"] = entityName;
oUrl.get_query()["startDateTime"] = FormatUtcDate(_startTime.get_dataValue());
oUrl.get_query()["syncBulkOperationType"] = syncBulkOperationType;
...
<table width="100%" cellpadding=0 cellspacing=0>
<tr>
<td><label class="ms-crm-Bold-Header" for="startTime"><loc:Text ResourceId="SyncBulkOperationsWizard.AdditionalOptionsPage.JobStartTime" runat="server"/></label></td>
</tr>
<tr>
<td>
<table width="100%">
