<%@ Page Language="c#" Inherits="Microsoft.Crm.Web.Tools.Admin.AddOn.AddStorageCompletePage"
...
function storageLicenseCompletePage_onload()
{
Initialize();
}


Sys.Application.add_load(storageLicenseCompletePage_onload);

function Initialize()
{

XUI.Html.SetText($get('TransactionInfoDescription'), PAGE_DESCRIPTION);
XUI.Html.SetText($get('StorageLicensesAdded'), LICENSE_CHANGE);
...
<loc:Text ResourceId="AddOnWizard.StorageLicenseCompletePage.StorageLicensesAddedDescription" runat="server" />
</div>
<div class="ms-crm-LeftSideBox">
<label id="StorageLicensesAdded">
</label>
