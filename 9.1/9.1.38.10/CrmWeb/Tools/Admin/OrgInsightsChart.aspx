...
formatter: function () {
return '<div class="tooltop">'+ this.x + '<br />' + this.series.name + ': ' + '<b>' + this.y + '</b></div>';
}
},
plotOptions: {
series: {
...
window.self[Mscrm.RefreshFormMarker.IsUserOrgInsightsChart] = '<%= IsUserOrgInsightsConfiguration.ToString() %>';
