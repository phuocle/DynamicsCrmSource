...
<li>
<a href="https://go.microsoft.com/fwlink/p/?LinkID=519212" target="_blank" rel="noopener noreferrer"  title="<loc:text ResourceId='Dialog.AppsForCrm.MoCA_Phone.Windows.ButtonText' runat='server' />">

<img id="imgForWindowsPhone" runat="server" alt="<loc:text ResourceId='Dialog.AppsForCrm.MoCA_Phone.Windows.ButtonText' runat='server' />" style="height : 40px"/></a>
</a>
</li>
<li>
<a href="https://go.microsoft.com/fwlink/p/?LinkID=519213"  target="_blank" rel="noopener noreferrer"  title="<loc:text ResourceId='Dialog.AppsForCrm.MoCA_Phone.IOS.ButtonText' runat='server' />">

<img id="imgForIPhone" runat="server" alt="<loc:text ResourceId='Dialog.AppsForCrm.MoCA_Phone.IOS.ButtonText' runat='server' />" style="height : 40px"/></a>
</a>
</li>
<li>
<a href="https://go.microsoft.com/fwlink/p/?LinkID=519214"  target="_blank" rel="noopener noreferrer" title="<loc:text ResourceId='Dialog.AppsForCrm.MoCA_Phone.Android.ButtonText' runat='server' />">
<img id="imgForAndroid" runat="server" alt="<loc:text ResourceId='Dialog.AppsForCrm.MoCA_Phone.Android.ButtonText' runat='server' />" style="height : 40px"/></a>
</li>
</ul>
</div>
</div>
...
<a id="learnMoreLink" href="https://go.microsoft.com/fwlink/p/?LinkId=296267" target="_blank" rel="noopener noreferrer" class="ms-crm-appsForDynamicsCrm-messages-links-text" title="<loc:Text Encoding='HtmlAttribute' ResourceId='MailApp.Generic.LearnMore' runat='server'/>">
<loc:Text ResourceId="MailApp.Generic.LearnMore" runat="server" />
</a>
</span>
...
<ul id="horizontalButtons">
<li>
<a href="https://go.microsoft.com/fwlink/p/?LinkID=392776" target="_blank" rel="noopener noreferrer"  title="<loc:text ResourceId='Dialog.AppsForCrm.MoCA_Tablet.Windows.ButtonText' runat='server' />">

<img id="imgForWindowsTablet" runat="server" alt="<loc:text ResourceId='Dialog.AppsForCrm.MoCA_Tablet.Windows.ButtonText' runat='server' />" style="height : 40px"/></a>
</a>
</li>
<li>
<a href="https://go.microsoft.com/fwlink/p/?LinkID=313645" target="_blank" rel="noopener noreferrer"  title="<loc:text ResourceId='Dialog.AppsForCrm.MoCA_Tablet.IOS.ButtonText' runat='server' />">

<img id="imgForIPhoneTablet" runat="server" alt="<loc:text ResourceId='Dialog.AppsForCrm.MoCA_Tablet.IOS.ButtonText' runat='server' />" style="height : 40px"/></a>
</a>
</li>
<li>
<a href="https://go.microsoft.com/fwlink/p/?LinkID=392774" target="_blank" rel="noopener noreferrer"  title="<loc:text ResourceId='Dialog.AppsForCrm.MoCA_Tablet.Android.ButtonText' runat='server' />">
<img id="imgForAndroidTablet" runat="server" alt="<loc:text ResourceId='Dialog.AppsForCrm.MoCA_Tablet.Android.ButtonText' runat='server' />" style="height : 40px"/></a>
</li>
</ul>
</div>
</div>
...
<a id="learnMoreLink" href="https://go.microsoft.com/fwlink/p/?LinkId=532714" target="_blank" rel="noopener noreferrer"  class="ms-crm-appsForDynamicsCrm-messages-links-text" title="<loc:Text Encoding='HtmlAttribute' ResourceId='MailApp.Generic.LearnMore' runat='server'/>">
<loc:Text ResourceId="MailApp.Generic.LearnMore" runat="server" />
</a>
</span>
...
<span tabindex="0" class="ms-crm-appsForDynamicsCrm-text-regular">
<a id="learnMoreIFD" href="https://go.microsoft.com/fwlink/p/?LinkID=723354" target="_blank" rel="noopener noreferrer" class="ms-crm-appsForDynamicsCrm-messages-links-text" title="<loc:Text Encoding='HtmlAttribute' ResourceId='MailApp.RootPage.Settings.IFDEnabled.LearnMoreLink' runat='server'/>">
...
<div id="mailAppInstallFailedHelp">
<a tabindex="0" id="dynamicHelpLink" class="ms-crm-appsForDynamicsCrm-messages-links-text" title="<loc:Text Encoding='HtmlAttribute' ResourceId='MailApp.RootPage.Grid.Column.Status.Value.Issue.Help' runat='server'/>">
...
<div class="ms-crm-popup-icon"><a tabindex="0" id="closePopupMessage" href="#">
<img id="iconClose" alt="" src="/_imgs/appsforcrm/close_icon_tooltip_hover_12x12.png" /></a></div>
...
<div id="outlookClientSection" class="ms-crm-appsForDynamicsCrm-sectionHeader hidden" runat="server">
<span tabindex="0" class="ms-crm-appsForDynamicsCrm-subTitle">
...
<a id="learnMoreLink" target="_blank" rel="noopener noreferrer"  href="https://go.microsoft.com/fwlink/p/?LinkId=395156" class="ms-crm-appsForDynamicsCrm-messages-links-text" title="<loc:Text Encoding='HtmlAttribute' ResourceId='MailApp.Generic.LearnMore' runat='server'/>">
<loc:Text ResourceId="MailApp.Generic.LearnMore" runat="server" />
</a>
</span>
