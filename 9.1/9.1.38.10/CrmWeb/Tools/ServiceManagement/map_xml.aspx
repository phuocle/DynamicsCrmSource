...
<link inline="0">
var getAllOptionsFromDoc = function (xmlOptionsDocument) {
var optionNodes = XUI.Xml.SelectNodes(xmlOptionsDocument, "select/option", null);
return optionNodes.map(function (node) {
return ({
Id: node.getAttribute("value"),
DisplayName: XUI.Xml.GetText(node.firstChild)
});
}).sort(function (optionA, optionB) {
return optionA.DisplayName.toUpperCase() &lt; optionB.DisplayName.toUpperCase()?-1:1;
});
};
...
var dialogArguments = {};
dialogArguments["values_xml"] =_xmlOptionsDocument;
dialogArguments["all_attributes"]=JSON.stringify(getAllOptionsFromDoc(_xmlOptionsDocument));
var options = new Xrm.DialogOptions();
options.height = 500;
options.width = 1000;
Xrm.Dialog.openDialog("CaseSettings", options, dialogArguments, null, null);
</link>
...
<url><app:FlatHomepageUrlControl EntityLogicalName="contracttemplate" XmlEncode="true" runat="server" /></url>
...
<%
if (!UnifiedResourceSchedulingUtility.IsURSEnabled())
{
%>
<section>
...
<url><app:FlatHomepageUrlControl EntityLogicalName="service" XmlEncode="true" runat="server" /></url>
...
<link inline="1" entitytype="<%=Microsoft.Crm.Application.Utility.EntityNames.Equipment%>">/_static/loading.htm</link>
<url><app:FlatHomepageUrlControl EntityLogicalName="equipment" XmlEncode="true" runat="server" /></url>
...
<url><app:FlatHomepageUrlControl EntityLogicalName="site" XmlEncode="true" runat="server" /></url>
