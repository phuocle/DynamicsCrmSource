...
Mscrm.FormEditorVariables.formAccessType = parseInt(<%= Microsoft.Crm.CrmEncodeDecode.CrmJavaScriptEncode(((int)dashboardType).ToString()) %>, 10);
...
Mscrm.FormEditorVariables.dashboardCategory = XUI.Xml.SelectSingleNode(Mscrm.FormEditorVariables.formXml, "//entity/form/tabs", null).getAttribute("dashboardCategory");
if(typeof window.ENTITY_TYPE_CODE != 'undefined'){
...
if(Mscrm.FormEditorVariables.dashboardCategory != InteractionCentricDashboardCategory.ENTITYDASHBOARD){
if(Mscrm.FormEditorVariables.dashboardCategory != InteractionCentricDashboardCategory.CSR1 && Mscrm.FormEditorVariables.dashboardCategory != InteractionCentricDashboardCategory.CSR2)
...
if(Mscrm.FormEditorVariables.dashboardCategory === InteractionCentricDashboardCategory.CSR2){
var streamObject = XUI.Xml.SelectSingleNode(Mscrm.FormEditorVariables.formXml, "//entity/form/tabs/tab[@name = 'StreamsContainer']/columns/column/sections/section[@name = 'Streams']/rows/row/cell/control/parameters/StreamObjects/StreamObject", null);
...
Mscrm.FormEditorVariables.streamsIsQueueSelected = false;
Mscrm.FormEditorVariables.selectedView = XUI.Xml.GetText(XUI.Xml.SelectSingleNode(streamObject, "EntityViewId", null));
}
}
}
...
if (typeof _previousPrimaryEntityValue != 'undefined' && document.getElementById("dashboardPrimaryEntityInput").disabled == false)
{
isDirty = true;
}
}
...
var streamObjectsNodeXml = XUI.Xml.SelectSingleNode(Mscrm.FormEditorVariables.formXml, "//entity/form/tabs/tab[@name = 'StreamsContainer']/columns/column/sections/section[@name = 'Streams']/rows/row/cell/control/parameters/StreamObjects", null);
...
etc = Xrm.Internal.getEntityCode(XUI.Xml.GetText(XUI.Xml.SelectSingleNode(node, "LogicalEntityName", null))) == -1 ? 0 : Xrm.Internal.getEntityCode(XUI.Xml.GetText(XUI.Xml.SelectSingleNode(node, "LogicalEntityName", null)));
}
...
Xrm.Internal.messages.retrieve(Mscrm.InternalUtilities.EntityNames.SavedQuery, guid, columns).then(function (retrieveResponse) {
var viewName = "";
var queueName = "";
var entityName = "";
...
renderStreamorTiles(streamObjectId, otc, queueid, viewid, objecttypecode, type, isStream, parentElement, viewName, queueName, entityName);
},function(error){
...
renderStreamorTiles(streamObjectId, objecttypecode, queueid, viewid, objecttypecode, type, isStream, parentElement, viewName, queueName, entityName);
});
}

function renderStreamorTiles(streamObjectId, entityObjectTypeCode, queueid, viewid, objecttypecode, type, isStream, parentElement, viewName, queueName, entityName){
var monikers = new Array();
if(type == Stream.Queue){
var cols = ["name"];
Xrm.Internal.messages.retrieve(Mscrm.InternalUtilities.EntityNames.Queue, queueid, cols).then(function (result){
...
{
var tileCells = XUI.Xml.SelectNodes(Mscrm.FormEditorVariables.formXml, "//entity/form/tabs/tab[@name = 'StreamsContainer']/columns/column/sections/section[@name = 'Tiles']/rows/row/cell[@istilecell = 'true']", null);
...
var tileParamsNode = XUI.Xml.SelectSingleNode(tileCells[i], "control/parameters/StreamObjects/StreamObject", null);
...
function streamsTab() {
var result = XUI.Xml.SelectSingleNode(Mscrm.FormEditorVariables.formXml, "//entity/form/tabs/tab[@name = 'StreamsContainer']", null);
return getEmptyIfNull(result);
}

function streamsSection() {
var result = XUI.Xml.SelectSingleNode(Mscrm.FormEditorVariables.formXml, "//entity/form/tabs/tab[@name = 'StreamsContainer']/columns/column/sections/section[@name = 'Streams']", null);
return getEmptyIfNull(result);
}

function streamsCell() {
var result = XUI.Xml.SelectSingleNode(Mscrm.FormEditorVariables.formXml, "//entity/form/tabs/tab[@name = 'StreamsContainer']/columns/column/sections/section[@name = 'Streams']/rows/row/cell", null);
return getEmptyIfNull(result);
}

function tilesSection()
{
var result = XUI.Xml.SelectSingleNode(Mscrm.FormEditorVariables.formXml, "//entity/form/tabs/tab/columns/column/sections/section[@name = 'Tiles']", null);
return getEmptyIfNull(result);
}
...
var result = "";
if (Mscrm.FormEditorVariables.dashboardCategory === InteractionCentricDashboardCategory.CSR2){
result = XUI.Xml.SelectSingleNode(Mscrm.FormEditorVariables.formXml, "//entity/form/tabs/tab/columns/column/sections/section[@name = 'VisualFilters']", null);
}
else {
result = XUI.Xml.SelectSingleNode(Mscrm.FormEditorVariables.formXml, "//entity/form/tabs/tab/columns/column/sections/section", null);
}
return getEmptyIfNull(result);
}
...
XUI.Xml.SelectSingleNode(Mscrm.FormEditorVariables.formXml, "//entity/form/tabs", null).setAttribute("filterby", "" + filterByValue);
XUI.Xml.SelectSingleNode(Mscrm.FormEditorVariables.formXml, "//entity/form/tabs", null).setAttribute("timeframe", "" + timeFrameValue);
XUI.Xml.SelectSingleNode(Mscrm.FormEditorVariables.formXml, "//entity/form/tabs", null).setAttribute("primaryentitylogicalname", Xrm.Internal.getEntityName(parseInt(entitySelected.value)));
XUI.Xml.SelectSingleNode(Mscrm.FormEditorVariables.formXml, "//entity/form/tabs", null).setAttribute("entityview", "" + viewSelected.value);
return true;
}
...
if(typeof window.ENTITY_TYPE_CODE === 'undefined')
{
XUI.Xml.SelectSingleNode(Mscrm.FormEditorVariables.formXml, "//entity/form/tabs", null).setAttribute("dashboardCategory", "" + Mscrm.FormEditorVariables.dashboardCategory);
success = Mscrm.FormUtils.saveForm(parseInt(<%= systemFormType.ToString() %>, 10), 0, dashName.get_dataValue(), dashDesc.get_dataValue(), Mscrm.FormEditorVariables.isTabletEnabled);
}
else
{
XUI.Xml.SelectSingleNode(Mscrm.FormEditorVariables.formXml, "//entity/form/tabs", null).setAttribute("dashboardCategory", "" + Mscrm.FormEditorVariables.dashboardCategory);
success = Mscrm.FormUtils.saveForm(parseInt(<%= systemFormType.ToString() %>, 10), window.ENTITY_TYPE_CODE, dashName.get_dataValue(), dashDesc.get_dataValue(), Mscrm.FormEditorVariables.isTabletEnabled);
}
...
Mscrm.Utilities.updatePowerAppsNavBarComponentName(dashName.get_element().value);
...
{
if(!IsNull(window.parent) && !IsNull(window.parent.opener) && !IsNull(window.parent.opener.AppDesignerCallback))
{

var id = Mscrm.FormEditorVariables.formId.replace(/{|}/g, '').toLowerCase();
var url = Mscrm.CrmUri.create(window.parent.location.href);
var resultobj;
var objecttypecode = url.get_query()["entitytypecode"];
if ( !IsNull(objecttypecode)) {
resultobj = {"id":id, "displayName": dashName.get_dataValue(), "description": dashDesc.get_value(), "formType": 10, "objectTypeCode": objecttypecode}
} else {
resultobj = {"id":id, "displayName": dashName.get_dataValue(), "description": dashDesc.get_value(), "formType": 10}
}
...
originalOpener.Mscrm.DashboardRibbonActions.refreshDashboardSelector(Mscrm.FormEditorVariables.formId);
...
{
var tabsHtml = XUI.Xml.SelectSingleNode(Mscrm.FormEditorVariables.formXml, "//entity/form/tabs", null).outerHTML;
if(tabsHtml != null){
...
{
var tilespresent = XUI.Xml.SelectSingleNode(Mscrm.FormEditorVariables.formXml, "//entity/form/tabs", null).getAttribute("tilespresent");
if(tilespresent === "false")
{
var addTilesButton = window.top.document.getElementById("Mscrm.InteractionCentricDashboardEditorTab.InsertButtons.Tiles");
...
<label for="dashboardNameInput" id="dashboardNameHintText" class="ms-crm-Bold-Header-Ic"><loc:Text ResourceId="Web.Visualization.Designer.SaveAs.Name" runat="server" /></label>
...
<label for="dashboardPrimaryEntityInput" id="dashboardPrimaryEntityHintText" class="ms-crm-Bold-Header-Ic"><loc:Text ResourceId="Web.Visualization.Designer.SaveAs.VisualFilterEntity" runat="server" /></label>
<img src="/_imgs/frm_required.gif" alt="<loc:Text Encoding='HtmlAttribute' ResourceId='Forms.Required.AltTag' runat='server'/>" />
</div>
...
<label for="dashboardViewInput" id="dashboardViewHintText" class="ms-crm-Bold-Header-Ic"><loc:Text ResourceId="Web.Visualization.Designer.SaveAs.EntityView" runat="server" /></label>
...
<label for="dashboardFilterByInput" id="dashboardFilterByHintText" class="ms-crm-Bold-Header-Ic"><loc:Text ResourceId="Web.Visualization.Designer.SaveAs.FilterBy" runat="server" /></label>
<img src="/_imgs/frm_required.gif" alt="<loc:Text Encoding='HtmlAttribute' ResourceId='Forms.Required.AltTag' runat='server'/>" />
</div>
...
<label for="dashboardTimeframeInput" id="dashboardTimeFrameHintText" class="ms-crm-Bold-Header-Ic"><loc:Text ResourceId="Web.Visualization.Designer.SaveAs.TimeFrame" runat="server" /></label>
<img src="/_imgs/frm_required.gif" alt="<loc:Text Encoding='HtmlAttribute' ResourceId='Forms.Required.AltTag' runat='server'/>" />
</div>
