...
'dashboard',
<%= CrmEncodeDecode.CrmJavaScriptEncode(Microsoft.Crm.ObjectModel.PowerBIUtility.GetOrganizationTenant(Microsoft.Crm.Application.Security.UserInformation.Current.OrganizationId)) %>);
function onLoad() {
