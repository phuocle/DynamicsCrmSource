...
var requestSubmitted = Mscrm.MobileOfflineProvisioningHelper.switchMobileOfflineForOrganization(isEnabled);
...
<div><label style="font-family:'Segoe UI Light, Segoe UI, Tahoma, Arial'; font-size: 24px; padding-left: 0px" class="ms-crm-Setting-ContextHeader-Title"><loc:text resourceid="Web.Tools.MobileOfflineProvisioning.Config.Title" runat="server" /></label></div>
...
<div>
<b><loc:text resourceid="Web.Tools.MobileOfflineProvisioning.Config.Heading" runat="server" /></b>
</div>
<div class="indent">
...
<b><loc:text resourceid="Web.Tools.MobileOfflineProvisioning.Config.EnableMobileOffline" runat="server" /></b>
</label>
</div>
<div class="ms-crm-Hidden-NoBehavior" aria-describeby="mobileOfflineEnable">
<b>	<loc:Text Encoding='Html' ResourceId='Web.Tools.MobileOfflineProvisioning.Config.EnableMobileOfflineTooltip' runat="server"/></b>
</div>
<div class="radioButtonDiv">
<label for="mobileOfflineEnable"><asp:Label id="enableStatusLabel" runat="server" /></label>
</div>
</div>
...
<b><loc:text resourceid="Web.Tools.MobileOfflineProvisioning.Config.DisableMobileOffline" runat="server" /></b>
</label>
</div>
<div class="ms-crm-Hidden-NoBehavior" aria-describeby="mobileOfflineDisable">
<b><loc:Text Encoding='Html' ResourceId='Web.Tools.MobileOfflineProvisioning.Config.DisableMobileOfflineTooltip' runat="server"/></b>
</div>
<div class="radioButtonDiv">
<label for="mobileOfflineDisable"><asp:Label id="disableStatusLabel" runat="server" /></label>
</div>
</div>
</div>
