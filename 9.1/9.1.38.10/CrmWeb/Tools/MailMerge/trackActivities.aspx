...
{
var quickCampaingText = Mscrm.FormControlInputBehavior.GetBehavior("QuickCampaignInputTextBox").get_dataValue();
...
{
var unsubscribeLink = Mscrm.FormControlInputBehavior.GetBehavior("UnsubscribeLinkInputTextBox").get_dataValue();
...
Mscrm.FormControlInputBehavior.GetBehavior("QuickCampaignInputTextBox").set_disabled(!$get("cbQuickCampaign").checked);
Mscrm.FormControlInputBehavior.GetBehavior("UnsubscribeLinkInputTextBox").set_disabled(!$get("cbUnsubscribeLink").checked);
...
{
var oCheckboxControl = XUI.Html.DomUtils.GetFirstChild(XUI.Html.DomUtils.GetPrevSibling(oInputControl.parentNode));
