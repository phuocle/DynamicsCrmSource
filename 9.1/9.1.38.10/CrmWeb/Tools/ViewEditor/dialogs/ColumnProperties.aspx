...
return Mscrm.FormControlInputBehavior.GetBehavior('imageProviderWebResource').get_dataValue()[0].name;
else
return "";
}
else
...
<td><sdk:LookupControl id="imageProviderWebResource" DefaultViewId="125A31CE-0F5E-4957-8AA3-7A10C0713886" DisableViewPicker="true" LookupBrowse="false" LookupStyle="single" runat="server"/></td>
</tr>
<tr>
