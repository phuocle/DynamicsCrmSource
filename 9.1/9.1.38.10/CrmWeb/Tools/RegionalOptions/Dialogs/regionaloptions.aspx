...
function AddRolesToDialog(){
if (!Mscrm.Utilities.isIE()) {
$("#selectDecimalSymbol, #selectDigitGroupingSymbol, #selectDigitGroup, #selectNegativeNumberFormat, #selectCurrencyFormat, #selectNegativeCurrencyFormat, #selectTimeFormat,\
#selectTimeSeparator, #selectAMSymbol, #selectPMSymbol, #selectShortDateFormat, #selectShortDateSeparator, #selectLongDateFormat").attr("role","combobox");
}
}
...
<table role="presentation" id="x" style="width: 100%;">
<tr>
...
<table role="presentation" id="Table1" width="100%">
<tr>
...
<td colspan="3">
<fieldset>
<table role="presentation" id="Table2" width="100%" style="padding:10px 0 10px 0;">
<tr>
...
<table role="presentation" id="Table3" width="100%">
<tr>
...
<table role="presentation" id="short_date_table" width="100%">
<col width="250" /><col width="200" /><col />
<tr>
...
<table role="presentation" id="long_date_table" width="100%">
<col width="250" /><col width="200" /><col />
<tr>
