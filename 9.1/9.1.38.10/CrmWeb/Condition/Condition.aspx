...
//callback method, called by cachemanager
function OnPopulateFieldList()
{
	$find("appConditionBuilder").OnPopulateFieldListForWorkflow(oArgs);
}

// Fix for 63685 - Workflow: Specify Workflow Condition Page: No prompt appears when user tries to close the page without saving changes made on it
...
// The workflow properties can be hosted in iframe for new process designer
// In that case, attach the event with parent window
...
<style type="text/css">
	...
	/* on resize the scroll bar should appear */
	.cndCondition>div
	{
		min-width:770px;/* width[150] of 5 columns + filter icon column width[20px] */
	}
</style>
</head>
