...
/* Simple text style for element types - body, input, td, etc. */
...
/* ------------------------------------------ Common Simple Font Styles ---------------------------------------------------------*/
/* Simple text style for headers, bold text, labels, etc. */
...
/* Font styles for specialized UI */
...
/* These three styles come from the About box.*/
div.info
{
	font-size: <%= WebUtility.GetFontResourceForStyle("General.16px.font_size") %>;
	font-weight: <%= WebUtility.GetFontResourceForStyle("General.Normal.font_weight") %>;
...
/* Overriding anchor style on hover with this class name */
a.ms-crm-InlineTabHeaderText:hover
{
	text-decoration: none;
}
