...
.ms-crm-ListControl, 
.cc-grid.cc-grid-desktop .wj-flexgrid.wj-content,
.cc-grid.cc-grid-desktop .cc-grid-pager/*Editable grid*/,
...
.ms-crm-List-Header,
.cc-grid.cc-grid-desktop .wj-flexgrid .wj-colheaders > .wj-header,   /*Editable grid theme*/
.cc-grid.cc-grid-desktop .wj-flexgrid .wj-topleft .wj-cell.wj-header
{
...
.cc-grid.cc-grid-desktop .wj-flexgrid .wj-colheaders > .wj-header:before/*Editble Grid*/
{
