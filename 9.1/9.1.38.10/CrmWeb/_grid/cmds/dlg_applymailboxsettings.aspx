...
if ($get("showrecordselection").value == "True" && $get("dialogMode").value == 1 && IS_LIVEOSDP && (typeof IS_SSSRELIABILITY_FEATUREENABLED != "undefined" && IS_SSSRELIABILITY_FEATUREENABLED)) {
...
var applySettingsMode = getRadioValue("recordOptions");
if ($get("showrecordselection").value == "True" && $get("dialogMode").value == 1) {
applySettingsMode = 0;
}
...
<tr valign="middle">
<td>
<input type="checkbox" name="runtestaccess" id="runtestaccesscheckbox" style="border: 0px; width: 20px; cursor: hand;" checked="checked" /></td>
<td>
...
<tr valign="middle">
<td>
<input type="checkbox" name="primaryexchangesyncorg" id="primaryexchangesyncorg" checked="true" style="border: 0px; width: 20px; cursor: hand;" /></td>
<td>
<label for="primaryexchangesyncorgcheckbox" style="cursor: hand;">
<loc:Text Id="primaryExchangeSyncOrgCheckBoxText" runat="server" />
<a href="http://go.microsoft.com/fwlink/?LinkID=391868" target="_blank" rel="noopener noreferrer" style="color: #0645AD; text-decoration: underline">
...
<td align="center">
<b>
<label id="total" style="vertical-align: top"></label></b>
</td>
<td align="center">
<img src="/_imgs/CircularPreloader_Grey_16x16.gif" alt="inp" />
<b>
<label id="inprogress" style="vertical-align: top"></label></b>
</td>
<td align="center">
<img src="/_imgs/Alert_16.png" alt="inp" />
<b>
<label id="unapproved" style="vertical-align: top"></label></b>
</td>
</tr>
</table>
</div>
