...
<td valign="top">
<label for="rdoMe">
<b><loc:Text ResourceId="Dialog_QueueItemWorkOn_Me_Label" runat="server"/></b>
</label>
<br>
<div class="Desc"><loc:Text ResourceId="Dialog_QueueItemWorkOn_Me_Description" runat="server"></loc:Text></div>
</td>
</tr>
...
<td valign="top">
<label for="rdoOther">
<b><loc:Text ResourceId="Dialog_QueueItemWorkOn_Other_Label" runat="server"/></b>
</label>
<br>
<div class="Desc" style="padding-bottom:10px;"><loc:Text ResourceId="Dialog_QueueItemWorkOn_Other_Description" runat="server"></loc:Text></div>
