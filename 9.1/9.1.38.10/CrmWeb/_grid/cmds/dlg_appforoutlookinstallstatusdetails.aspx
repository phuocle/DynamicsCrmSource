...
function handleCloseBtnKeyPress(event) {
...
<div class="navTourClose" runat="server" tabindex="0" onkeypress="handleCloseBtnKeyPress(event);">
...
<td>
<div>
<a tabindex="0" id="helpLink" target="_blank" rel="noopener noreferrer" class="anchorLink" runat="server">
...
<span tabindex="0" class="ms-crm-Dialog-CloseButton closeButton" title="<loc:Text Encoding='HtmlAttribute' ResourceId='EmailConnector.TestExchangeServerProfile.CloseButton' runat='server'/>" onkeypress="handleCloseBtnKeyPress(event);">
