...
$get('bottomCaption').innerHTML = "<br/><br/>" +stringFormat(created, createdArguments) + "<br/>" + stringFormat(modified, modifiedArguments);
}
}
...
<tr>
<td class="ms-crm-Form-Section ms-crm-Form-SectionBar" style="white-space: nowrap"><br />
<label for="title"><loc:Text ResourceId="Web._grid.cmds.dlg_editdocumentproperties.DocumentTitle" runat="server"/></label>
</td>
<td style="padding-left:10">
