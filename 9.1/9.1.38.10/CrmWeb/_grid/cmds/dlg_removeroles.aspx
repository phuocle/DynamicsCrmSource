...
<html>
<head>
<title><loc:Text ResourceId="Web._grid.cmds.dlg_removeroles.aspx_34" runat="server"/></title>
...
%>
_custParams += "&iAllRoles=<%=iAllRoles%>&userid=<%=Microsoft.Crm.CrmEncodeDecode.CrmJavaScriptEncodeNoQuotes(Microsoft.Crm.CrmEncodeDecode.CrmUrlEncode(Request.QueryString["userid"]))%>";
go();
}
