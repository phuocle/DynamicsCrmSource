...
<title><loc:Text resourceid="Ribbon.emailserverprofile.TestExchangeServerProfile.Title" runat="server" /></title>
...
if (result && result.ReturnValue) {
objA.target = "_self";
objA.href = '/_grid/cmds/dlg_testexchangeserver_status.aspx?mailboxid=' + mailboxId + '&emailserverprofileid=' + selectedrecordId;
}
}
}
...
<span class='ms-crm-RefreshDialog-Button ms-crm-TestExchangeServerProfile-runtestbutton-hover'><a target="_self" id="runTheTest" name="runTheTest" onclick="applychanges(this)" id="">
<loc:Text resourceid="Ribbon.emailserverprofile.TestExchangeServerProfile.RunTheTest" runat="server" /></a></span>
</td>
</tr>
</table>
</div>
