...
'<filter type="and">' +
'<condition attribute="queueid" operator="eq" value="' + _queueId + '" /> ' +
'</filter>' +
'</link-entity>' +
' </entity>' +
'</fetch>';
...
<label for="rdQueuebutton"><loc:Text ResourceId="Dialog_QueueItemRoute_RouteTo_Label" runat="server"/></label>
</td>
<td style="padding-bottom:8px;">
...
<label for="rdQueuebutton" id="lblQueuebutton" runat="server"><loc:Text ResourceId="Dialog_AddToQueue_LabelDetails" runat="server"/></label>
</div>
</td>
</tr>
</table>
...
<div class="Desc" style="padding-bottom:8px;">
<label for="rdUserbutton" id="lblUserbutton" runat="server"><loc:Text ResourceId="Dialog_QueueItemRoute_User_Label" runat="server"/></label>
</div>
</td>
</tr>
</table>
...
<td colspan="2">
<div class="Desc" style="padding-bottom:8px;">
<label id="routeToQueueLabel" runat="server"><loc:Text ResourceId="RouteToQueue_Text" runat="server"/></label>
</div>
</td>
<td></td>
</tr>
...
<td colspan="3">
<div class="Desc" style="padding-bottom:8px;">
<label id="routeToUserLabel" runat="server"><loc:Text ResourceId="RouteToUser_Text" runat="server"/></label>
</div>
</td>
<td></td>
</tr>
...
<input tabindex="1" class="checkbox" type="checkbox" name="type" id="chkBoxRemove"><label for="chkBoxRemove"><loc:Text ResourceId="Dialog_QueueItemWorkOn_Remove_Check_Label" runat="server"  /></label>
</td>
</tr>
