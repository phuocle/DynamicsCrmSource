...
__dialogXml = "<dataxml><jobname>" + CrmEncodeDecode.CrmHtmlEncode(Trim(txtJobName.value)) + "</jobname><ccrecipients>" + CrmEncodeDecode.CrmHtmlEncode(_sCCRecipients) + "</ccrecipients><deleteimport>" + CrmEncodeDecode.CrmHtmlEncode($get("deleteImportHistory").checked) + "</deleteimport><sendemail>" + CrmEncodeDecode.CrmHtmlEncode(checkNotify.checked) + "</sendemail><DeleteMode>" + CrmEncodeDecode.CrmHtmlEncode(_sDeleteMode) + "</DeleteMode></dataxml>";
...
<table width="100%" cellpadding=0 cellspacing=0>
<tr>
<td><loc:Text ResourceId="BulkDelete.DeleteImporteRecords.Info" runat="server"/></td>
</tr>
<tr height=15>
<td>&nbsp;</td>
</tr>
...
<table width="100%" cellpadding=0 cellspacing=0>
<tr height=10>
<td><loc:Text ResourceId="BulkDeleteWizard.AdditionalOptionsPage.Description" runat="server"/></td>
</tr>
<tr>
...
<table width="100%" cellpadding=0 cellspacing=0>
<tr>
<td><ui:CheckBox id="deleteImportHistory" runat="Server" /></td>
<td id="deleteImport"><label for="deleteImportHistory" id="deleteImportHistoryText" ><loc:Text ResourceId="BulkDelete.DeleteImporteRecords.DeleteImportHistory" runat="server"/></label></td>
</tr>
</table>
</td>
</tr>
