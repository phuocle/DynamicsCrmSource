...
.ms-crm-RefreshDialog-Button_ok:hover
{
...
<a href="#" id="btnCross" title="<loc:Text Encoding='HtmlAttribute' ResourceId='Button_Label_Cancel' runat='server'/>"><img alt="" src="/_imgs/CloseDialog.png" style="height:16px;width:16px;" onclick="if(!Mscrm.Utilities.resetValidationFailedElement()) {cancel(); return false;}"></a>
...
<td style="padding-left:2"><sdk:PicklistControl runat="server" id="documentLocations" onchange="OnPickListChange();"/> </td>
</tr>
<tr style="height: 7.5px">
</tr>
<tr>
...
<table>
<tr>
<td style="vertical-align:top;"><img style="margin-right:10px" src="/_imgs/tools/Notification_Error_16.png" alt="<loc:Text Encoding='HtmlAttribute' ResourceId='Odb_NewUpload_Dlg_Error_Msg_Document_Name' runat='server'/>" /></td>
