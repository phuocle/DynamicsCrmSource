...
<script type="text/javascript" src="<%=GetJSPath("/_static/_common/scripts/jquery1.7.2.min.js")%>"></script>
...
<div class="helpDiv">
<a id="helpLink" class="helpLink enableHover" href="https://go.microsoft.com/fwlink/?LinkID=511924" target="_blank" rel="noopener noreferrer"
...
<div id="${postId}_errorCode" class="text" onselectstart="window.event.cancelBubble=true;return true;"><b><loc:Text Encoding='Html' ResourceId='Web.Wall_ServerErrorCodeTraceLabel' runat='server'/></b> {{html CrmEncodeDecode.CrmHtmlEncode(serverErrorCodeBase)}}
{{if $data.serverErrorHelpLinkBase != null && $data.serverErrorHelpLinkBase != '' }}
<a href="{{html CrmEncodeDecode.CrmHtmlEncode(serverErrorHelpLinkBase)}}" target="_blank" rel="noopener noreferrer"><loc:Text Encoding='HtmlAttribute' ResourceId='Web.Tools.ViewEditor.viewmanager.aspx_98' runat='server'/></a>
{{/if}}
</div>
</div>
{{/if}}
...
&nbsp;<span><loc:Text Encoding='HtmlAttribute' ResourceId='Mailbox.AlertsWall.ErrorDetails' runat='server'/></span>
...
Wall.Control.Resources.WallControl.ellipsis = "<%=CurrentResourceManager.GetString("Web.Wall_Ellipsis")%>";
