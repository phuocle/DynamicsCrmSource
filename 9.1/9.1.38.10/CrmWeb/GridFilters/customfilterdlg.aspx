...
<tr>
<td width="40%">
<label for="primaryOperator" style="display:none"><loc:Text ResourceId="Web.Dialogues.CustomFiltersDlg.aspx_primary_operator" runat="server"/></label><ui:Select id="primaryOperator" runat="server"/>
</td>
<td>
<div id="primaryValue">
</div>
...
<tr>
<td width="40%">
<label for="secondaryOperator" style="display:none"><loc:Text ResourceId="Web.Dialogues.CustomFiltersDlg.aspx_secondary_operator" runat="server"/></label><ui:Select id="secondaryOperator" runat="server"/>
</td>
<td>
