...
var initDate = new Date( <%=Microsoft.Crm.Utility.DateTimeUtility.DateTimeToJavaScriptConstructorStringScript(initDate) %> );


var oHomeCalendarElements = getHomeCalendarElements( );
oHomeCalendarElements.oMiniCalendar.innerHTML = DrawMonth( initDate, "GoToDate(this);", HILITE_MONTH, initDate );


UpdateCalendarMenu( oHomeCalendarElements.oMonthMenuItem );

XUI.Html.SetText(oHomeCalendarElements.oTitle, <%=Microsoft.Crm.CrmEncodeDecode.CrmJavaScriptEncode(calendarTitle) %>);
});
