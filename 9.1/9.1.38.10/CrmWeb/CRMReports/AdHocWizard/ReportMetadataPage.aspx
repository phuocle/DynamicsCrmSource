...
var sExistingReportId = (WizardHasProperty("ColumnXml")) ? WizardGetProperty("ReportId") : null;
...
{
notificationsControl.AddNotification("entityUnavailable", Mscrm.Severity.SEVERITYWARNING, "", LOCID_INVALID_PRIMARY_ENTITY);
}
else
{
...
{
notificationsControl.AddNotification("entityUnavailable", Mscrm.Severity.SEVERITYWARNING, "", LOCID_INVALID_SECONDARY_ENTITY);
}
}
}
...
if (!IsNull(iWizardMode) && iWizardMode == EDIT_MODE_CREATE && !IsNull(reportNameControl.get_dataValue())&& reportNameControl.get_dataValue().length > 0)
{
var reportNameFormatString = Mscrm.ReportUtil.getReportCopySuffix(LOCID_REPORT_NAME_FORMAT);
reportNameControl.set_dataValue(formatString(reportNameFormatString, reportNameControl.get_dataValue()));
}
}
...
{
Mscrm.FormControlInputBehavior.GetBehavior("reportDescription").set_dataValue(WizardGetProperty("ReportDescription"));
}

primaryEntityBehavior = Mscrm.CrmUIBehavior.getBehaviorByName(primaryEntityComponent.get_element(), "EntitySelect");
secondaryEntityBehavior = Mscrm.CrmUIBehavior.getBehaviorByName(secondaryEntityComponent.get_element(), "SetOptionsSelect");
...
var oFetchXml;
oFetchXml = getXmlDocumentFromString(WizardGetProperty("FetchXml"));
...
if (!WizardHasProperty("FetchXml") && !IsNull(sWizardXml) && sWizardXml.length > 0)
{
...
if (!IsNull(oXmlNode))
{
WizardSetProperty(sPropertyName, XUI.Xml.XMLSerializer.serializeToString(oXmlNode));
}
}
...
WizardSetProperty("ReportDescription", Trim(Mscrm.FormControlInputBehavior.GetBehavior("reportDescription").get_value()));
...
_oFetchBuilder.LoadXml(getXmlDocumentFromString(WizardGetProperty("FetchXml")));
...
{
var bEnableNextButton = !IsNull(reportNameControl.get_dataValue()) && !IsNull(primaryEntityComponent.get_dataValue());
...
<table cellpadding="0" cellspacing="5" width="100%" style="padding: 5px; table-layout: fixed;" role="presentation">
<col width="220" />
<col />
<tr>
<td colspan="2">
...
<tr>
<frm:FormCell runat="server" ID="reportNameCell" ShowLabel="True"><sdk:TextBoxControl id="reportName" runat="server" /></frm:FormCell>
</tr>
<tr>
<frm:FormCell runat="server" ID="reportDescriptionCell" ShowLabel="True"><sdk:TextAreaControl id="reportDescription" height="45px" runat="server"/></frm:FormCell>
</tr>
...
<tr>
<frm:FormCell runat="server" id="primaryEntityCell" ShowLabel="True" RequiredLevel="Required"><ui:Select id="primaryEntity" runat="server" /></frm:FormCell>
</tr>
<tr>
<frm:FormCell runat="server" id="secondaryEntityCell" ShowLabel="True"><ui:Select id="secondaryEntity" Disabled="true" runat="server" /></frm:FormCell>
</tr>
</table>
</frm:WizardForm>
</body>
