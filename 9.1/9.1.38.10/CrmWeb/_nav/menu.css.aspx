...
<% } %>
height: 19px;
<% if (Request.Browser.Browser == "Chrome" || Request.Browser.Browser == "Safari") { %>
overflow-x: hidden;
<% } %>
overflow-y: hidden;
cursor: default;
...
LI.ms-crm-Menu-Read SPAN.ms-crm-Menu-Label-Hovered,
LI#mnucrmGridMoreActions SPAN.ms-crm-Menu-Label-Hovered,
LI#mnucrmGridInactiveMoreActions SPAN.ms-crm-Menu-Label-Hovered
{
...
<% } %>
height: 18px;
<% if (Request.Browser.Browser == "Safari" || (CrmStyles.IsRightToLeft)) { %>
overflow-x: hidden;
<% } %>
overflow-y: hidden;
display:inline-block;
