...
{
var encodedText = CrmEncodeDecode.CrmHtmlEncode(highlightedBody[j].toString());
var body = encodedText.replace(/&#123;crmhit&#125;/g,'<em>');
...
window.open(Mscrm.CrmUri.create("/MultiEntityQuickFind/MultiEntityQuickFind.aspx?pagemode=iframe&text="+searchtxt+appId),'_self');
}
else if(value == "3")
{
Mscrm.ExternalSearch.metricsReportingForSearchDropDown("CustomSearch");
...
if(x[0].id == "customSearchLi") { onSelectionBoxChange('3');}
}
...
if(window.parent.document.getElementById('crmAppMessageBar').style.height == '0px')
{
...
{ %>
<div class="megaContainerRelevanceSearch">
<div class="megaContainerRelevanceSearchBGColor"></div>
<% } %>
...
<% if (Microsoft.Crm.Application.Utility.Util.IsWebClientVisualRefreshFeatureAvailable(null))
{ %>
<nobr class="ms-crm-VS-header-MenuItem-Title ms-crm-VS-header-MenuItem-Title-Rest" style="width:180px !important;">
<% }
else
{ %>
...
<nobr class="ms-crm-VS-header-MenuItem-Title ms-crm-VS-header-MenuItem-Title-Rest" style="width:120px !important;">
<% } %>
<span style="font-weight: normal;" title="<%=CurrentResourceManager.GetString("CategorizedSearch_Label_Tooltip")%>" class="ms-crm-VS-header-MenuItem-Title ms-crm-VS-header-MenuItem-Title-Rest"><%= Microsoft.Crm.CrmEncodeDecode.CrmHtmlEncode(CurrentResourceManager.GetString("CategorizedSearch_Relevance_Search"))%></span></nobr></span></a>
</li>
<% if (IsCustomSearchEnabled)
{ %>
<li id="customSearchLi" role="option" aria-selected="false"  aria-label="<%=SearchProviderName %>" class="ms-crm-MenuItem-NoOutline ms-crm-VS-header-MenuItem ms-crm-VS-header-MenuItem-Rest" style="float: none;" ><a href="#" class="ms-crm-VS-header-MenuItem-Aux ms-crm-VS-header-MenuItem-Aux-Rest" style="float: right; display: none;"><span class="ms-crm-VS-header-MenuItem-Aux ms-crm-VS-header-MenuItem-Aux-Rest"><img title="" alt="" class="ms-crm-VS-header-MenuItem-Aux ms-crm-VS-header-MenuItem-Aux-Rest"></span></a><a class="crmntfcoverride ms-crm-VS-header-MenuItem-Anchor-Rest" style="cursor: default;" onclick="onSelectionBoxChange('3')" style="background-color: none;"><span><span class="ms-crm-VS-header-MenuItem-Icon ms-crm-VS-header-MenuItem-Icon-Rest"><img src="/_imgs/DashboardSelector/crm_dashboard.png" class="ms-crm-VS-header-MenuItem-Icon ms-crm-VS-header-MenuItem-Icon-Rest"></span><span class="ms-crm-VS-header-MenuItem-Sep ms-crm-VS-header-MenuItem-Sep-Rest"></span>
<% if (Microsoft.Crm.Application.Utility.Util.IsWebClientVisualRefreshFeatureAvailable(null))
{ %>
<nobr class="ms-crm-VS-header-MenuItem-Title ms-crm-VS-header-MenuItem-Title-Rest" style="width:180px !important;">
<% }
...
<nobr class="ms-crm-VS-header-MenuItem-Title ms-crm-VS-header-MenuItem-Title-Rest" style="width:120px !important;">
<% } %>
<span style="font-weight: normal;" title="<%=SearchProviderName %>" class="ms-crm-VS-header-MenuItem-Title ms-crm-VS-header-MenuItem-Title-Rest"><%=SearchProviderName %></span></nobr></span></a>
</li>
<% } %>
</ul>
</div>
...
<div onscroll="scrollForMoreRecords()" class="row facets_searchresultcontainer ms-crm-VS-RelevanceSearch-AbsolutePosition">
...
<div id="visualRefreshSearchCriteria" runat="server" style="display: none;" tabindex="0"  class="searchboxiconcontainer meqfsearchCriteria"  />
<% } %>
