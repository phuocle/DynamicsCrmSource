...
<script language="javascript" src="<%= Microsoft.Crm.Application.Utility.CrmUri.Create(Microsoft.Crm.Application.ContentDelivery.HostBasedContentDeliveryService.GetCDNUrl().TrimEnd('/') + "/_static/_common/scripts/es6-shim.js")%>" ></script>
