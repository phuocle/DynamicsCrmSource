...
Microsoft.Crm.Workflow.FormulaDisplayVisitor = function(useForReadMode, calculatedFieldLabelDescription, getAttributeLocalizedNameFunc) {
    ...
    this.$b_2 = this.$d_2 && !Microsoft.Crm.Workflow.Utils.ObjectUtils.isNull(this.$a_2);
}
...
Microsoft.Crm.Workflow.FormulaDisplayVisitor.prototype = {
    ...
    visitSetAttributeValueStep: function(setAttributeValueStep) {
        ...
        if (this.$d_2) {
            $v_0 = String.format(window.LOCID_BUSINESSRULE_SETATTRVALUE, String.format('<b>{0}</b>', CrmEncodeDecode.CrmHtmlEncode(this.$1F_2)), String.format('<b>{0}</b>', CrmEncodeDecode.CrmHtmlEncode($v_0)));
        }
        this.$t_2($v_0);
    },
    ...
    visitEntityAttributeExpression: function(expression) {
        if (Microsoft.Crm.Workflow.Expressions.RelatedEntity.isInstanceOfType(expression.entity)) {
            this.$2_2.append(this.$1q_2(expression));
        }
        else {
            this.$2_2.append(this.$1c_2(expression));
        }
    },
    ...
    $1q_2: function($p0) {
        var $v_0 = $p0.entity;
        var $v_1 = this.$1c_2($p0);
        var $v_2 = (this.$b_2) ? this.$a_2($p0.$0_0.primaryEntityName, $v_0.get_relatedAttributeName()) : $v_0.get_relatedAttributeName();
        return String.format(this.get_$1p_2(), $v_2, $v_1);
    },
...
Microsoft.Crm.Workflow.SharedExpressionVisitor.prototype = {
    ...
    visitFlowStep: function(flowStep) {
        Microsoft.Crm.Workflow.Utils.SharedUtility.throwException(0);
    },
    ...
    visitPropertySpecification: function(propertySpecification) {
        if (propertySpecification.propertyValueExpr) {
...
Microsoft.Crm.Workflow.ObjectModel.NullObjectsFactory.buildStep = function(className) {
    ...
    switch (className) {
        ...
        case 'FlowStep:#Microsoft.Crm.Workflow.ObjectModel':
            return new Microsoft.Crm.Workflow.ObjectModel.FlowStep($v_0);
        ...
        case 'WaitBranchStep:#Microsoft.Crm.Workflow.ObjectModel':
            ...
            return new Microsoft.Crm.Workflow.ObjectModel.WaitBranchStep($v_2, new Microsoft.Crm.Workflow.Expressions.NullExpression($v_0));
        ...
        case 'WaitTimeoutStep:#Microsoft.Crm.Workflow.ObjectModel':
            ...
            return new Microsoft.Crm.Workflow.ObjectModel.WaitTimeoutStep($v_3, new Microsoft.Crm.Workflow.Expressions.NullExpression($v_0));
...
Microsoft.Crm.Workflow.ObjectModel.NullObjectsFactory.buildEntity = function(className) {
    ...
    switch (className) {
        ...
        case 'RelatedEntityLinked:#Microsoft.Crm.Workflow.Expressions':
            return new Microsoft.Crm.Workflow.Expressions.RelatedEntityLinked($v_0, 'dummyProperty', 'dummyEntity', 'dummyRelationshipName');
...
Microsoft.Crm.Workflow.ObjectModel.AssignStep.prototype = {
    ...
    toJson: function() {
        ...
        if (this.assignTo) {
            $v_0.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getObjectJson('assignTo', this.assignTo.toJson(), true));
        }
        if (this.entity) {
    ...
    initializeFromDynamic: function(deserialized) {
        if (deserialized) {
            ...
            var $v_0 = deserialized;
            if ($v_0.assignTo) {
                this.assignTo = Microsoft.Crm.Workflow.ObjectModel.NullObjectsFactory.buildExpression($v_0.assignTo.__class);
...
Microsoft.Crm.Workflow.ObjectModel.AssignVariableStep.prototype = {
    ...
    toJson: function() {
        ...
        $v_0.append('{');
        $v_0.append(Microsoft.Crm.Workflow.ObjectModel.StepBase.prototype.toJson.call(this));
        $v_0.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getPropertyJson('variableName', this.variableName, true));
        $v_0.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getObjectJson('readOnly', Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getJson(this.readOnly), true));
        $v_0.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getObjectJson('direction', Microsoft.Crm.Workflow.Utils.StringUtility.toStringInvariant(this.direction), true));
        $v_0.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getObjectJson('dataType', this.$1s_1(this.dataType), true));
        if (this.valueExpression) {
            $v_0.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getObjectJson('valueExpression', this.valueExpression.toJson(), true));
        }
        $v_0.append('}');
        return $v_0.toString();
    },
    ...
    initializeFromDynamic: function(deserialized) {
        if (deserialized) {
            ...
            if ($v_0.valueExpression) {
                this.valueExpression = Microsoft.Crm.Workflow.ObjectModel.NullObjectsFactory.buildExpression($v_0.valueExpression.__class);
...
Microsoft.Crm.Workflow.ObjectModel.ActionStep.prototype = {
    ...
    toJson: function() {
        ...
        $v_0.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getPropertyJson('actionType', Microsoft.Crm.Workflow.Utils.StringUtility.toStringInvariant(this.actionType), true));
        $v_0.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getPropertyJson('processId', this.processId.toString(), true));
        $v_0.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getPropertyJson('uniqueName', this.uniqueName, true));
        if (this.triggerEvents && this.triggerEvents.length > 0) {
            ...
            $v_0.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getObjectJson('triggerEvents', $v_1.toString(), true));
        }
        if (!Microsoft.Crm.Workflow.Utils.StringUtility.isNull(this.actionControl)) {
            $v_0.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getObjectJson('actionControl', this.actionControl.toJson(), true));
        }
        $v_0.append('}');
        return $v_0.toString();
    },
    ...
    initializeFromDynamic: function(deserialized) {
        if (deserialized) {
            ...
            if ($v_0.actionControl) {
                this.actionControl = Microsoft.Crm.Workflow.ObjectModel.NullObjectsFactory.buildStep($v_0.actionControl.__class);
...
Microsoft.Crm.Workflow.ObjectModel.FlowStep = function(workflowStep) {
    Microsoft.Crm.Workflow.ObjectModel.FlowStep.initializeBase(this);
    Microsoft.Crm.Workflow.Utils.ExceptionUtility.throwIfNull(workflowStep, 'workflowStep');
    this.__class = 'FlowStep:#Microsoft.Crm.Workflow.ObjectModel';
    this.setNameAndId(workflowStep.$3_2());
}
Microsoft.Crm.Workflow.ObjectModel.FlowStep.prototype = {
    
    get_flowControl: function() {
        return this.flowControl;
    },
    
    set_flowControl: function(value) {
    ...
    get_workflowId: function() {
        return this.workflowId;
    },
    
    set_workflowId: function(value) {
    ...
    toJson: function() {
        ...
        $v_0.append('{');
        $v_0.append(Microsoft.Crm.Workflow.ObjectModel.CompositeStepBase.prototype.toJson.call(this));
        $v_0.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getPropertyJson('workflowId', this.workflowId.toString(), true));
        $v_0.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getPropertyJson('actionId', (this.actionId) ? this.actionId.toString() : Microsoft.Crm.Client.Core.Framework.Guid.get_empty().toString(), true));
        $v_0.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getPropertyJson('uniqueName', this.uniqueName, true));
        if (!Microsoft.Crm.Workflow.Utils.StringUtility.isNull(this.flowControl)) {
            $v_0.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getObjectJson('flowControl', this.flowControl.toJson(), true));
        }
        $v_0.append('}');
        return $v_0.toString();
    },
    ...
    fixInternalLinks: function() {
        Microsoft.Crm.Workflow.ObjectModel.CompositeStepBase.prototype.fixInternalLinks.call(this);
        if (this.flowControl) {
            this.flowControl.set_parent(this);
            this.flowControl.$0_0.stepDictionary.set_item(this.flowControl.id, this.flowControl);
            this.flowControl.fixInternalLinks();
        }
    },
    ...
    initializeFromDynamic: function(deserialized) {
        if (deserialized) {
            ...
            var $v_0 = deserialized;
            this.uniqueName = $v_0.uniqueName;
            this.workflowId = Microsoft.Crm.Client.Core.Framework.Guid.get_empty();
            if ($v_0.workflowId) {
                this.workflowId = Microsoft.Crm.Client.Core.Framework.Guid.tryCreate($v_0.workflowId.toString());
            }
            this.actionId = Microsoft.Crm.Client.Core.Framework.Guid.get_empty();
            if ($v_0.actionId) {
                this.actionId = Microsoft.Crm.Client.Core.Framework.Guid.tryCreate($v_0.actionId.toString());
            }
            if ($v_0.flowControl) {
                this.flowControl = Microsoft.Crm.Workflow.ObjectModel.NullObjectsFactory.buildStep($v_0.flowControl.__class);
                this.flowControl.initializeFromDynamic($v_0.flowControl);
            }
        }
    }
}
...
Microsoft.Crm.Workflow.ObjectModel.ProcessTriggerData.prototype = {
    ...
    toJson: function() {
        ...
        $v_0.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getPropertyJson('pipelineStageId', this.pipelineStageId, true));
        $v_0.append('}');
        return $v_0.toString();
    },
...
Microsoft.Crm.Workflow.ObjectModel.ControlStep.getControlStep = function(stepBase) {
    ...
    else if (Microsoft.Crm.Workflow.ObjectModel.FlowStep.isInstanceOfType(stepBase)) {
        return (stepBase).flowControl;
    }
    return null;
}
Microsoft.Crm.Workflow.ObjectModel.ControlStep.prototype = {
    ...
    toJson: function() {
        ...
        $v_0.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getPropertyJson('systemStepType', Microsoft.Crm.Workflow.Utils.StringUtility.toStringInvariant(this.systemStepType), true));
        ...
        $v_0.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getObjectJson('isUnbound', Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getJson(this.isUnbound), true));
        $v_0.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getPropertyJson('controlType', Microsoft.Crm.Workflow.Utils.StringUtility.toStringInvariant(this.controlType), true));
...
Microsoft.Crm.Workflow.ObjectModel.RelationshipStep.prototype = {
    ...
    toJson: function() {
        ...
        $v_0.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getPropertyJson('relationshipName', this.relationshipName, true));
        $v_0.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getPropertyJson('attributeName', this.attributeName, true));
        $v_0.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getPropertyJson('sourceStageId', this.sourceStageId, true));
        $v_0.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getPropertyJson('targetStageId', this.targetStageId, true));
        $v_0.append('}');
        return $v_0.toString();
    },
...
Microsoft.Crm.Workflow.ObjectModel.StepStep.prototype = {
    ...
    appendStep: function(newStep) {
        Microsoft.Crm.Workflow.Utils.ExceptionUtility.assert(Microsoft.Crm.Workflow.ObjectModel.ControlStep.isInstanceOfType(newStep) || Microsoft.Crm.Workflow.ObjectModel.FlowStep.isInstanceOfType(newStep) || Microsoft.Crm.Workflow.ObjectModel.ActionStep.isInstanceOfType(newStep), 'Cannot insert a non Control/flow/action Step');
        Microsoft.Crm.Workflow.ObjectModel.CompositeStepBase.prototype.appendStep.call(this, newStep);
    },
    
    remove: function(stepBase) {
        Microsoft.Crm.Workflow.Utils.ExceptionUtility.assert(Microsoft.Crm.Workflow.ObjectModel.ControlStep.isInstanceOfType(stepBase) || Microsoft.Crm.Workflow.ObjectModel.FlowStep.isInstanceOfType(stepBase) || Microsoft.Crm.Workflow.ObjectModel.ActionStep.isInstanceOfType(stepBase), 'Cannot remove a non Control/Flow/Action Step');
        Microsoft.Crm.Workflow.ObjectModel.CompositeStepBase.prototype.remove.call(this, stepBase);
    },
    ...
    toJson: function() {
        ...
        $v_0.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getObjectJson('isHidden', Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getJson(this.isHidden), true));
        $v_0.append('}');
        return $v_0.toString();
    },
...
Microsoft.Crm.Workflow.ObjectModel.ChildWorkflowStep.prototype = {
    ...
    toJson: function() {
        ...
        if (this.childWorkflow) {
            $v_0.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getObjectJson('childWorkflow', this.childWorkflow.toJson(), true));
        }
        if (this.entity) {
            $v_0.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getObjectJson('entity', this.entity.toJson(), true));
        }
    ...
    initializeFromDynamic: function(deserialized) {
        if (deserialized) {
            ...
            if ($v_0.childWorkflow) {
                this.childWorkflow = Microsoft.Crm.Workflow.ObjectModel.NullObjectsFactory.buildExpression($v_0.childWorkflow.__class);
...
Microsoft.Crm.Workflow.ObjectModel.CreateStep.prototype = {
    ...
    toJson: function() {
        ...
        if (this.output) {
            $v_0.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getObjectJson('output', this.output.toJson(), true));
        }
        $v_0.append('}');
        return $v_0.toString();
    },
...
Microsoft.Crm.Workflow.ObjectModel.CustomActivityInfoBase.prototype = {
    ...
    toJson: function() {
        ...
        $v_0.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getPropertyJson('pluginTypeId', this.pluginTypeId, true));
        $v_0.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getPropertyJson('assemblyName', this.assemblyName, true));
        $v_0.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getPropertyJson('publicKeyToken', this.publicKeyToken, true));
        $v_0.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getPropertyJson('culture', this.culture, true));
        $v_0.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getPropertyJson('assemblyVersion', this.assemblyVersion, true));
        $v_0.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getObjectJson('isNet4', Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getJson(this.get_isNet4()), true));
        $v_0.append('}');
        return $v_0.toString();
    },
...
Microsoft.Crm.Workflow.ObjectModel.CustomParameterInfoBase.prototype = {
    ...
    toJson: function() {
        var $v_0 = new Sys.StringBuilder();
        $v_0.append('{');
        $v_0.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getObjectJson('required', Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getJson(this.required), false));
        $v_0.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getPropertyJson('name', this.name, true));
        $v_0.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getPropertyJson('typeName', this.typeName, true));
        $v_0.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getPropertyJson('attributeName', this.attributeName, true));
        $v_0.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getPropertyJson('dependencyProperty', this.dependencyProperty, true));
        $v_0.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getPropertyJson('workflowAttributeType', Microsoft.Crm.Workflow.Utils.StringUtility.toStringInvariant(this.workflowAttributeType), true));
        $v_0.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getObjectJson('isInOutArgument', Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getJson(this.isInOutArgument), true));
        $v_0.append('}');
        return $v_0.toString();
    },
...
Microsoft.Crm.Workflow.ObjectModel.CustomStepBase.prototype = {
    ...
    get_skipValidation: function() {
        return this.skipValidation;
    },
    
    set_skipValidation: function(value) {
    ...
    get_isWebPluginActivity: function() {
        return this.isWebPluginActivity;
    },
    
    set_isWebPluginActivity: function(value) {
        this.isWebPluginActivity = value;
        return value;
    },
    
    isWebPluginActivity: false,
    ...
    toJson: function() {
        ...
        if (this.activityInfo) {
            $v_0.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getObjectJson('activityInfo', (this.activityInfo).toJson(), true));
        }
        $v_0.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getObjectJson('hasOutputs', Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getJson(this.hasOutputs), true));
        $v_0.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getObjectJson('isInvalid', Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getJson(this.isInvalid), true));
        $v_0.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getObjectJson('isWebPluginActivity', Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getJson(this.isWebPluginActivity), true));
        $v_0.append(',');
        $v_0.append('\"outputs\":');
        var $$t_3 = this, $$t_4 = this;
        $v_0.append(Microsoft.Crm.Workflow.Utils.DictionaryUtility.toJson(String, Microsoft.Crm.Workflow.ObjectModel.CustomParameterInfoBase, this.outputs, function($p1_0) {
    ...
    initializeFromDynamic: function(deserialized) {
        if (deserialized) {
            ...
            this.isWebPluginActivity = $v_0.isWebPluginActivity;
            if ($v_0.outputs) {
                var $$t_5 = this, $$t_6 = this;
                this.outputs = Microsoft.Crm.Workflow.Utils.DictionaryUtility.fromJson(String, Microsoft.Crm.Workflow.ObjectModel.CustomActivityParameterInfo, $v_0.outputs, function($p1_0) {
                    return $p1_0;
                }, function($p1_0) {
...
Microsoft.Crm.Workflow.ObjectModel.DataValue.prototype = {
    ...
    getDisplayName: function(cultureInfo) {
        Microsoft.Crm.Workflow.Utils.ExceptionUtility.assert(!!this.$Z_0, 'Source should be non null in GetDisplayName');
...
Microsoft.Crm.Workflow.ObjectModel.DynamicAttributesInProcess.$$cctor = function() {
    Microsoft.Crm.Workflow.ObjectModel.DynamicAttributesInProcess.$X['!Process_Custom_Attribute_URL_'] = 'Dialog.CustomAttribute.URL.DisplayName';
    Microsoft.Crm.Workflow.ObjectModel.DynamicAttributesInProcess.$X['!Process_Custom_Attribute_PostURL_'] = 'ActivityFeeds.CustomAttribute.PostURL.DisplayName';
}
...
Microsoft.Crm.Workflow.ObjectModel.EntityDataSource = function(entitySource, isRestrictiveAttributeListDefined, restrictiveAttributeList) {
...
Microsoft.Crm.Workflow.ObjectModel.EntityDataSource.prototype = {
    ...
    getLocalizedNameForDataValue: function(value, cultureInfo) {
        Microsoft.Crm.Workflow.Utils.ExceptionUtility.assert(value.$Z_0 === this, 'Data value does not belong to this data source');
        ...
        if (Microsoft.Crm.Workflow.ObjectModel.DynamicAttributesInProcess.containsKey($v_1)) {
            return this.$6_0.$0_0.$9_2.getResourceString(Microsoft.Crm.Workflow.ObjectModel.DynamicAttributesInProcess.getAttribute($v_1));
        }
    ...
    getDataValues: function(valueType) {
        try {
            if (!Microsoft.Crm.Workflow.Utils.StringUtility.isNullOrEmpty(this.$6_0.entityName)) {
                ...
                var $v_1 = this.$1b_0(this.$1f_0($v_0));
                return this.$1l_0(valueType, $v_1);
            }
        }
        catch ($$e_3) {
        }
    ...
    getLookupDataValues: function(objectTypeCode) {
        try {
            if (!Microsoft.Crm.Workflow.Utils.StringUtility.isNullOrEmpty(this.$6_0.entityName)) {
                ...
                return this.$1b_0(this.$1f_0($v_0));
            }
        }
        catch ($$e_2) {
        }
    ...
    $1b_0: function($p0) {
        ...
        for (var $$arr_2 = $p0, $$len_3 = $$arr_2.length, $$idx_4 = 0; $$idx_4 < $$len_3; ++$$idx_4) {
            ...
            $v_0.add(new Microsoft.Crm.Workflow.ObjectModel.DataValue(this, this.$6_0.get_uiXmlName() + '.' + $v_4, $v_2));
        }
        return $v_0;
    },
    ...
    $1l_0: function($p0, $p1) {
        if ($p0 === 14) {
            for (var $$arr_2 = Microsoft.Crm.Workflow.ObjectModel.DynamicAttributesInProcess.get_keys(), $$len_3 = $$arr_2.length, $$idx_4 = 0; $$idx_4 < $$len_3; ++$$idx_4) {
                var $v_0 = $$arr_2[$$idx_4];
                $p1.add(new Microsoft.Crm.Workflow.ObjectModel.DataValue(this, this.$6_0.get_uiXmlName() + '.' + $v_0, ''));
            }
        }
        return $p1;
    },
    ...
    toJson: function() {
        ...
        if (this.inputs) {
            ...
            for (var $$arr_2 = this.inputs.get_keys(), $$len_3 = $$arr_2.length, $$idx_4 = 0; $$idx_4 < $$len_3; ++$$idx_4) {
                var $v_3 = $$arr_2[$$idx_4];
                $v_1.add(Microsoft.Crm.Workflow.ObjectModel.ChildInteractiveWorkflowStep.$1y($v_3.toJson(), this.inputs.get_item($v_3).toJson()));
            }
            var $v_2 = '[' + Microsoft.Crm.Workflow.ObjectModel.ChildInteractiveWorkflowStep.$1x(',', $v_1.toArray()) + ']';
...
Microsoft.Crm.Workflow.ObjectModel.InteractionPageStep.prototype = {
    ...
    toJson: function() {
        ...
        $v_0.append('{');
        $v_0.append(Microsoft.Crm.Workflow.ObjectModel.CompositeStepBase.prototype.toJson.call(this));
        $v_0.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getObjectJson('allowBack', Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getJson(this.$s_2), true));
        $v_0.append('}');
        return $v_0.toString();
    },
...
Microsoft.Crm.Workflow.ObjectModel.InteractionStep.prototype = {
    ...
    toJson: function() {
        ...
        $v_0.append(Microsoft.Crm.Workflow.ObjectModel.StepBase.prototype.toJson.call(this));
        if (this.promptText) {
            $v_0.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getObjectJson('promptText', this.promptText.toJson(), true));
        }
        if (this.hintText) {
            $v_0.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getObjectJson('hintText', this.hintText.toJson(), true));
        }
        $v_0.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getObjectJson('logResponse', Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getJson(this.logResponse), true));
        $v_0.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getPropertyJson('responseContainerType', Microsoft.Crm.Workflow.Utils.StringUtility.toStringInvariant(this.responseContainerType), true));
        $v_0.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getPropertyJson('responseMetadataType', Microsoft.Crm.Workflow.Utils.StringUtility.toStringInvariant(this.responseMetadataType), true));
        $v_0.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getPropertyJson('staticResponseValues', this.staticResponseValues, true));
        if (this.defaultResponseValue) {
            $v_0.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getObjectJson('defaultResponseValue', this.defaultResponseValue.toJson(), true));
        }
        $v_0.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getPropertyJson('attributeList', this.attributeList, true));
        $v_0.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getPropertyJson('queryVariableName', this.queryVariableName, true));
        $v_0.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getPropertyJson('queryEntityName', this.queryEntityName, true));
        $v_0.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getPropertyJson('attributeDelimiter', this.attributeDelimiter, true));
        $v_0.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getObjectJson('isResponseMetadataBound', Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getJson(this.isResponseMetadataBound), true));
        $v_0.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getPropertyJson('InteractionResponsePostfix', '_interactionResponseValue', true));
        $v_0.append('}');
        return $v_0.toString();
    },
    ...
    initializeFromDynamic: function(deserialized) {
        if (deserialized) {
            ...
            var $v_0 = deserialized;
            if ($v_0.promptText) {
                this.promptText = Microsoft.Crm.Workflow.ObjectModel.NullObjectsFactory.buildExpression($v_0.promptText.__class);
                this.promptText.initializeFromDynamic($v_0.promptText);
            }
            if ($v_0.hintText) {
                this.hintText = Microsoft.Crm.Workflow.ObjectModel.NullObjectsFactory.buildExpression($v_0.hintText.__class);
            ...
            this.staticResponseValues = Microsoft.Crm.Workflow.Utils.StringUtility.reduceToCanonicalForm($v_0.staticResponseValues);
            if ($v_0.defaultResponseValue) {
                this.defaultResponseValue = Microsoft.Crm.Workflow.ObjectModel.NullObjectsFactory.buildExpression($v_0.defaultResponseValue.__class);
            ...
            this.queryVariableName = Microsoft.Crm.Workflow.Utils.StringUtility.reduceToCanonicalForm($v_0.queryVariableName);
            this.queryEntityName = Microsoft.Crm.Workflow.Utils.StringUtility.reduceToCanonicalForm($v_0.queryEntityName);
            this.attributeDelimiter = Microsoft.Crm.Workflow.Utils.StringUtility.reduceToCanonicalForm($v_0.attributeDelimiter);
...
Microsoft.Crm.Workflow.ObjectModel.InteractiveWorkflowInputDictionary.prototype = {
    ...
    get_keys: function() {
        var $v_0 = new (Microsoft.Crm.Client.Core.Framework.List$1.$$(Microsoft.Crm.Workflow.ObjectModel.CustomActivityParameterInfo))();
        var $$dict_2 = this.$n_0;
...
Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getPropertyJson = function(propertyName, propertyValue, prependComma) {
    ...
    return ((prependComma) ? ',' : '') + Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getQuotedString(propertyName) + ':' + $v_0;
}
...
Microsoft.Crm.Workflow.ObjectModel.PublicationParametersFactory.$1n = function($p0, $p1) {
    switch ($p0) {
        default:
...
Microsoft.Crm.Workflow.ObjectModel.StepVisitorBase.prototype = {
...
Microsoft.Crm.Workflow.ObjectModel.WorkflowPublicationParameters.prototype = {
    ...
    get_isCustomProcessingStepAllowedForOtherPublishers: function() {
        return this.$1N_0;
    },
    
    set_isCustomProcessingStepAllowedForOtherPublishers: function(value) {
        this.$1N_0 = value;
        return value;
    },
    ...
    containsUpdateTriggerCondition: function() {
        ...
        else if (Microsoft.Crm.Workflow.Utils.StringUtility.areEqual(this.$D_0, 'statecode') || Microsoft.Crm.Workflow.Utils.StringUtility.areEqual(this.$D_0, 'ownerid') || Microsoft.Crm.Workflow.Utils.StringUtility.areEqual(this.$D_0, 'statecode;ownerid') || Microsoft.Crm.Workflow.Utils.StringUtility.areEqual(this.$D_0, 'ownerid;statecode')) {
            $v_0 = false;
        }
        else {
            $v_0 = true;
...
Microsoft.Crm.Workflow.ObjectModel.CustomJavascriptStep.prototype = {
    ...
    toJson: function() {
        ...
        $v_0.append('{');
        $v_0.append(Microsoft.Crm.Workflow.ObjectModel.StepBase.prototype.toJson.call(this));
        $v_0.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getPropertyJson('javascript', this.javascript, true));
        $v_0.append('}');
        return $v_0.toString();
    },
...
Microsoft.Crm.Workflow.ObjectModel.SetMessageStep.prototype = {
    ...
    toJson: function() {
        ...
        $v_0.append('{');
        $v_0.append(Microsoft.Crm.Workflow.ObjectModel.StepBase.prototype.toJson.call(this));
        $v_0.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getObjectJson('actionSteps', this.actionSteps.toJson(), true));
        $v_0.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getPropertyJson('controlId', this.controlId, true));
        if (this.entity) {
            $v_0.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getObjectJson('entity', this.entity.toJson(), true));
        }
...
Microsoft.Crm.Workflow.ObjectModel.SetNextStageStep.prototype = {
    ...
    toJson: function() {
        ...
        $v_0.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getPropertyJson('parentStageId', this.parentStageId, true));
        $v_0.append('}');
        return $v_0.toString();
    },
...
Microsoft.Crm.Workflow.ObjectModel.QueryStep.prototype = {
    ...
    toJson: function() {
        ...
        if (this.fetchExpression) {
            $v_0.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getObjectJson('fetchExpression', this.fetchExpression.toJson(), true));
        }
        $v_0.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getPropertyJson('fetchCount', this.fetchCount + '', true));
        $v_0.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getPropertyJson('attributeList', this.attributeList, true));
        $v_0.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getPropertyJson('entityName', this.entityName, true));
        $v_0.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getPropertyJson('originalFetchXml', this.originalFetchXml, true));
        $v_0.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getPropertyJson('originalLayoutXml', this.originalLayoutXml, true));
        $v_0.append('}');
        return $v_0.toString();
    },
    ...
    initializeFromDynamic: function(deserialized) {
        if (deserialized) {
            ...
            if ($v_0.fetchExpression) {
                this.fetchExpression = Microsoft.Crm.Workflow.ObjectModel.NullObjectsFactory.buildExpression($v_0.fetchExpression.__class);
...
Microsoft.Crm.Workflow.ObjectModel.RollupRuleStep.prototype = {
    ...
    toJson: function() {
        ...
        if (this.sourceFilter) {
            $v_0.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getObjectJson('sourceFilter', this.sourceFilter.toJson(), true));
        }
        $v_0.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getPropertyJson('hierarchicalRelationshipName', this.hierarchicalRelationshipName, true));
        if (this.targetFilter) {
            $v_0.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getObjectJson('targetFilter', this.targetFilter.toJson(), true));
        }
        if (this.targetRelationship) {
            $v_0.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getObjectJson('targetRelationship', this.targetRelationship.toJson(), true));
        }
        if (this.targetLinkedFilter) {
            $v_0.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getObjectJson('targetLinkedFilter', this.targetLinkedFilter.toJson(), true));
        }
        if (this.targetRelationshipLinked) {
            $v_0.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getObjectJson('targetRelationshipLinked', this.targetRelationshipLinked.toJson(), true));
        }
        if (this.aggregate) {
            $v_0.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getObjectJson('aggregate', this.aggregate.toJson(), true));
        }
        $v_0.append('}');
        return $v_0.toString();
    },
    ...
    initializeFromDynamic: function(deserialized) {
        if (deserialized) {
            ...
            if ($v_0.sourceFilter) {
                this.sourceFilter = Microsoft.Crm.Workflow.ObjectModel.NullObjectsFactory.buildExpression($v_0.sourceFilter.__class);
                this.sourceFilter.initializeFromDynamic($v_0.sourceFilter);
            }
            if ($v_0.targetRelationship) {
                this.targetRelationship = Microsoft.Crm.Workflow.ObjectModel.NullObjectsFactory.buildEntity($v_0.targetRelationship.__class);
                this.targetRelationship.initializeFromDynamic($v_0.targetRelationship);
            }
            if ($v_0.targetFilter) {
                this.targetFilter = Microsoft.Crm.Workflow.ObjectModel.NullObjectsFactory.buildExpression($v_0.targetFilter.__class);
                this.targetFilter.initializeFromDynamic($v_0.targetFilter);
            }
            if ($v_0.targetRelationshipLinked) {
                this.targetRelationshipLinked = Microsoft.Crm.Workflow.ObjectModel.NullObjectsFactory.buildEntity($v_0.targetRelationshipLinked.__class);
                this.targetRelationshipLinked.initializeFromDynamic($v_0.targetRelationshipLinked);
            }
            if ($v_0.targetLinkedFilter) {
                this.targetLinkedFilter = Microsoft.Crm.Workflow.ObjectModel.NullObjectsFactory.buildExpression($v_0.targetLinkedFilter.__class);
                this.targetLinkedFilter.initializeFromDynamic($v_0.targetLinkedFilter);
            }
            if ($v_0.aggregate) {
                this.aggregate = Microsoft.Crm.Workflow.ObjectModel.NullObjectsFactory.buildExpression($v_0.aggregate.__class);
...
Microsoft.Crm.Workflow.ObjectModel.SendEmailStep.prototype = {
    ...
    toJson: function() {
        ...
        $v_0.append('{');
        $v_0.append(Microsoft.Crm.Workflow.ObjectModel.StepBase.prototype.toJson.call(this));
        $v_0.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getPropertyJson('sendEmailType', Microsoft.Crm.Workflow.Utils.StringUtility.toStringInvariant(this.sendEmailType), true));
        $v_0.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getPropertyJson('emailTemplateId', this.emailTemplateId.toString(), true));
        if (this.entity) {
            $v_0.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getObjectJson('entity', this.entity.toJson(), true));
        }
        if (this.regardingEntity) {
            $v_0.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getObjectJson('regardingEntity', this.regardingEntity.toJson(), true));
        }
        $v_0.append('}');
        return $v_0.toString();
    },
    ...
    initializeFromDynamic: function(deserialized) {
        if (deserialized) {
            ...
            if ($v_0.regardingEntity) {
                this.regardingEntity = Microsoft.Crm.Workflow.ObjectModel.NullObjectsFactory.buildEntity($v_0.regardingEntity.__class);
...
Microsoft.Crm.Workflow.ObjectModel.SetStateStep.prototype = {
    ...
    toJson: function() {
        ...
        $v_0.append(Microsoft.Crm.Workflow.ObjectModel.StepBase.prototype.toJson.call(this));
        if (this.state) {
            $v_0.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getObjectJson('state', this.state.toJson(), true));
        }
        if (this.status) {
            $v_0.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getObjectJson('status', this.status.toJson(), true));
        }
        if (this.entity) {
            $v_0.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getObjectJson('entity', this.entity.toJson(), true));
        }
    ...
    initializeFromDynamic: function(deserialized) {
        if (deserialized) {
            ...
            var $v_0 = deserialized;
            if ($v_0.status) {
                this.status = Microsoft.Crm.Workflow.ObjectModel.NullObjectsFactory.buildExpression($v_0.status.__class);
...
Microsoft.Crm.Workflow.ObjectModel.StepBase.prototype = {
    ...
    setNameAndId: function(stepId) {
        var $v_0 = Object.getType(this).getName().split('.');
        var $v_1 = $v_0[$v_0.length - 1];
        this.id = $v_1 + stepId;
...
Microsoft.Crm.Workflow.ObjectModel.StepCollection.prototype = {
    ...
    $11_0: function($p0, $p1) {
        var $v_0 = new (Microsoft.Crm.Workflow.ObjectModel.StepCollectionChangedEventArgs$1.$$(Microsoft.Crm.Workflow.ObjectModel.StepBase))();
        $v_0.set_action($p0);
        $v_0.set_step($p1);
        $v_0.set_newItems($p1);
        return $v_0;
...
Microsoft.Crm.Workflow.ObjectModel.StopWorkflowStep.prototype = {
    ...
    toJson: function() {
        ...
        $v_0.append('{');
        $v_0.append(Microsoft.Crm.Workflow.ObjectModel.StepBase.prototype.toJson.call(this));
        $v_0.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getPropertyJson('status', Microsoft.Crm.Workflow.Utils.StringUtility.toStringInvariant(this.status), true));
        if (this.message) {
            $v_0.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getObjectJson('message', this.message.toJson(), true));
        }
        $v_0.append('}');
        return $v_0.toString();
    },
    ...
    initializeFromDynamic: function(deserialized) {
        if (deserialized) {
            ...
            if ($v_0.message) {
                this.message = Microsoft.Crm.Workflow.ObjectModel.NullObjectsFactory.buildExpression($v_0.message.__class);
    ...
    initializeFromDynamic: function(deserialized) {
        if (deserialized) {
            ...
            if ($v_0.pageUniqueName) {
                this.pageUniqueName = Microsoft.Crm.Workflow.Utils.StringUtility.reduceToCanonicalForm($v_0.pageUniqueName);
            }
        }
    }
}
...
Microsoft.Crm.Workflow.ObjectModel.UpdateStep.prototype = {
    ...
    toJson: function() {
        ...
        $v_0.append(Microsoft.Crm.Workflow.ObjectModel.StepBase.prototype.toJson.call(this));
        if (this.entitySpec) {
            $v_0.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getObjectJson('entitySpec', this.entitySpec.toJson(), true));
        }
        if (this.entity) {
            $v_0.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getObjectJson('entity', this.entity.toJson(), true));
        }
...
Microsoft.Crm.Workflow.ObjectModel.WaitBranchStep.prototype = {
    ...
    addPeer: function(direction, newStep) {
        ...
        Microsoft.Crm.Workflow.Utils.ExceptionUtility.assert((!!$v_0) || (!!$v_1), 'A child of WaitStep must be of type WaitBranchStep or WaitTimeoutStep.');
        if ($v_0) {
...
Microsoft.Crm.Workflow.ObjectModel.WaitStep.prototype = {
    ...
    $1A_2: function() {
        ...
        return (Microsoft.Crm.Workflow.ObjectModel.WaitBranchStep.isInstanceOfType(this.steps.get_item($v_0 - 1))) ? this.steps.get_item($v_0 - 1) : null;
    },
...
Microsoft.Crm.Workflow.ObjectModel.WaitTimeoutStep.prototype = {
    ...
    $1k_2: function($p0) {
        ...
        Microsoft.Crm.Workflow.Utils.ExceptionUtility.assert(Microsoft.Crm.Workflow.Expressions.NullExpression.isInstanceOfType($p0) || Microsoft.Crm.Workflow.Expressions.TimeSpanExpression.isInstanceOfType($p0) || $p0.type === 2 || $p0.type === 14 || Microsoft.Crm.Workflow.Expressions.MethodCallExpression.isInstanceOfType($p0), 'Type of TimeoutExpression must be DateTime, TimeSpan or MethodCallExpression');
    },
    ...
    toJson: function() {
        ...
        if (this.timeoutExpression) {
            $v_0.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getObjectJson('timeoutExpression', this.timeoutExpression.toJson(), true));
        }
        $v_0.append('}');
        return $v_0.toString();
    },
    ...
    initializeFromDynamic: function(deserialized) {
        if (deserialized) {
            ...
            if ($v_0.timeoutExpression) {
                this.timeoutExpression = Microsoft.Crm.Workflow.ObjectModel.NullObjectsFactory.buildExpression($v_0.timeoutExpression.__class);
...
Microsoft.Crm.Workflow.ObjectModel.WorkflowArgument.prototype = {
    ...
    toJson: function() {
        var $v_0 = new Sys.StringBuilder();
        $v_0.append('{');
        $v_0.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getPropertyJson('_description', this._description, false));
        $v_0.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getPropertyJson('_entityName', this._entityName, true));
        $v_0.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getPropertyJson('_name', this._name, true));
        $v_0.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getPropertyJson('_required', Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getJson(this._required), true));
        $v_0.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getPropertyJson('_target', Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getJson(this._target), true));
        $v_0.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getPropertyJson('_argumentTypeCode', this._argumentTypeCode.toString(), true));
        $v_0.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getPropertyJson('_argumentTypeDisplay', this._argumentTypeDisplay, true));
        $v_0.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getObjectJson('_argumentDirection', Microsoft.Crm.Workflow.Utils.StringUtility.toStringInvariant(this._argumentDirection), true));
        $v_0.append('}');
        return $v_0.toString();
    },
...
Microsoft.Crm.Workflow.ObjectModel.WorkflowStep = function(primaryEntityName, category) {
    ...
    this.$1D_2 = new (Microsoft.Crm.Client.Core.Framework.List$1.$$(Microsoft.Crm.Workflow.ObjectModel.WorkflowArgument))();
    this.$1C_2 = new (Microsoft.Crm.Client.Core.Framework.List$1.$$(Microsoft.Crm.Workflow.ObjectModel.WorkflowArgument))();
...
Microsoft.Crm.Workflow.ObjectModel.WorkflowStep.prototype = {
    ...
    $1w_2: function($p0, $p1, $p2, $p3) {
        ...
        this.publicationParameters = Microsoft.Crm.Workflow.ObjectModel.PublicationParametersFactory.$1n($p1, $p2);
        if (!$p1 && !$p2) {
    ...
    get_hasPrimaryEntity: function() {
        return !Microsoft.Crm.Workflow.Utils.StringUtility.isNullOrWhiteSpace(this.primaryEntityName);
    },
    ...
    deleteStep: function(step) {
        ...
        if ((step.$0_0 !== this) || !(Microsoft.Crm.Workflow.ObjectModel.CompositeStepBase.isInstanceOfType(step.get_parent()))) {
    ...
    set_primaryEntityName: function(value) {
    ...
    getIdentifierDisplayName: function(variableName) {
        ...
        Microsoft.Crm.Workflow.Utils.ExceptionUtility.assert(($v_0.length === 4), 'Invalid variable name format');
        return $v_0[3];
    },
    ...
    toJson: function() {
        ...
        $v_0.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getPropertyJson('businessProcessType', Microsoft.Crm.Workflow.Utils.StringUtility.toStringInvariant(this.businessProcessType), true));
        ...
        $v_0.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getPropertyJson('description', this.description, true));
        $v_0.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getPropertyJson('workflowEntityId', this.workflowEntityId.toString(), true));
        ...
        $v_0.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getObjectJson('variables', this.$1h_2(false), true));
        $v_0.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getObjectJson('inputs', this.$1h_2(true), true));
        $v_0.append('}');
        return $v_0.toString();
    },
    ...
    $1h_2: function($p0) {
        ...
        for (var $v_2 = 0; $v_2 < $v_0.get_Count(); ++$v_2) {
            ...
            $v_4.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getPropertyJson('type', $v_3._argumentTypeDisplay, true));
            $v_4.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getPropertyJson('type_code', $v_3._argumentTypeCode.toString(), true));
            $v_4.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getObjectJson('value', ($v_3._value).toJson(), true));
            $v_4.append('}');
    ...
    initializeFromDynamic: function(deserialized) {
        if (deserialized) {
            ...
            this._arguments = new (Microsoft.Crm.Client.Core.Framework.List$1.$$(Microsoft.Crm.Workflow.ObjectModel.WorkflowArgument))();
            var $v_1 = new (Microsoft.Crm.Client.Core.Framework.List$1.$$(Microsoft.Crm.Workflow.ObjectModel.WorkflowArgument))($v_0.argumentsArray);
...
Microsoft.Crm.Workflow.ObjectModel.DataCollection$1.prototype = {
    ...
    set_item: function(index, value) {
        Microsoft.Crm.Workflow.Utils.ExceptionUtility.assert(!this.$15_0, 'Cannot modify value in a readonly data value collection');
...
Microsoft.Crm.Workflow.Utils.DictionaryUtility.toJson = function(TKey, TValue, items, keyJsonConverter, valueJsonConverter) {
    var $v_0 = new Sys.StringBuilder();
    $v_0.append('{');
    $v_0.append('\"keys\":');
    $v_0.append(Microsoft.Crm.Workflow.Utils.ArrayUtility.arrayToJson(TKey, _Dictionary.keys(items), keyJsonConverter).toString());
    $v_0.append(',');
    $v_0.append('\"values\":');
    $v_0.append(Microsoft.Crm.Workflow.Utils.ArrayUtility.arrayToJson(TValue, _Dictionary.toArray(TValue, items), valueJsonConverter).toString());
    $v_0.append('}');
    return $v_0.toString();
}
Microsoft.Crm.Workflow.Utils.DictionaryUtility.fromJson = function(TKey, TValue, deserializedObject, keyJsonConverter, valueJsonConverter) {
...
Microsoft.Crm.Workflow.Utils.SharedUtility.dictionaryAddOrUpdate = function(TKey, TValue, dictionary, key, value) {
    dictionary[key.toString()] = value;
}
...
Microsoft.Crm.Workflow.Utils.SharedUtility.throwException = function(code) {
    ...
    Microsoft.Crm.Workflow.Utils.ExceptionUtility.throwException(Microsoft.Crm.Workflow.Utils.StringUtility.formatInvariant.apply(null, [ $v_0 ].concat(args)));
}
...
Microsoft.Crm.Workflow.Utils.ObjectUtils = function() {
}
Microsoft.Crm.Workflow.Utils.ObjectUtils.isNull = function(value) {
    return typeof(value) === 'undefined' || typeof(value) === 'unknown' || value == null;
}
Microsoft.Crm.Workflow.Utils.ObjectUtils.isArray = function(item) {
    return !!item && ((Array.isInstanceOfType(item)) || typeof(item.splice) === 'function');
}
Microsoft.Crm.Workflow.Utils.ObjectUtils.isInstanceOfTypeAcrossFrames = function(item, type) {
    try {
        return (Microsoft.Crm.Workflow.Utils.ObjectUtils.isNull(item) || Microsoft.Crm.Workflow.Utils.ObjectUtils.isNull(type)) ? false : (Object.getType(item).getName() === type.getName());
    }
    catch ($$e_2) {
        return false;
    }
}
Microsoft.Crm.Workflow.Utils.ObjectUtils.isNullOrEmptyString = function(value) {
    return Microsoft.Crm.Workflow.Utils.ObjectUtils.isNull(value) || (typeof(value) === 'string' && !value.length);
}
Microsoft.Crm.Workflow.Utils.ObjectUtils.getClass = function(value) {
    return Object.prototype.toString.call(value).slice(8, -1);
}
Microsoft.Crm.Workflow.Utils.ObjectUtils.isOfClass = function(value, soughtClass) {
    return Microsoft.Crm.Workflow.Utils.ObjectUtils.getClass(value) === soughtClass;
}


Microsoft.Crm.Workflow.Utils.TypeNames = function() {
}
...
Microsoft.Crm.Workflow.Expressions.EntityAttributeExpression.prototype = {
    ...
    getDisplayText: function(cultureInfo) {
        ...
        if (Microsoft.Crm.Workflow.ObjectModel.DynamicAttributesInProcess.containsKey(this.attributeName)) {
            $v_1 = this.$0_0.$9_2.getResourceString(Microsoft.Crm.Workflow.ObjectModel.DynamicAttributesInProcess.getAttribute(this.attributeName));
        }
        else {
...
Microsoft.Crm.Workflow.Expressions.RelatedEntity.prototype = {
    ...
    getLocalizedName: function(cultureInfo) {
        return Microsoft.Crm.Workflow.Utils.StringUtility.formatInvariant('{0} ({1})', this.$0_0.$9_2.getAttributeLocalizedName(cultureInfo, this.$0_0.primaryEntityName, this.get_relatedAttributeName()), this.$0_0.$9_2.getEntityLocalizedName(cultureInfo, this.entityName));
    },
...
Microsoft.Crm.Workflow.Expressions.RelatedEntityLinked = function(workflow, relatedAttributeName, relatedEntity, relationshipName) {
...
Microsoft.Crm.Workflow.Expressions.EntityCreatedByStep = function(workflow, step, entityName, entityIdentifier, parameterName, isCustomOperationArgument) {
...
Microsoft.Crm.Workflow.Expressions.EntityCreatedByStep.prototype = {
    ...
    toJson: function() {
        ...
        $v_0.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getPropertyJson('entityIdentifier', this.entityIdentifier, true));
        $v_0.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getPropertyJson('identifierName', this.identifierName, true));
        $v_0.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getObjectJson('isCustomOperationArgument', Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getJson(this.isCustomOperationArgument), true));
        $v_0.append('}');
        return $v_0.toString();
    },
...
Microsoft.Crm.Workflow.Expressions.EntitySpecification.prototype = {
    ...
    toJson: function() {
        var $v_0 = new Sys.StringBuilder();
        $v_0.append('{');
        $v_0.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getPropertyJson('entityName', this.entityName, false));
        $v_0.append(',');
        $v_0.append('\"properties\":');
        var $$t_2 = this;
        $v_0.append(Microsoft.Crm.Workflow.Utils.ArrayUtility.toJson(Microsoft.Crm.Workflow.Expressions.PropertySpecification, this.properties, function($p1_0) {
            return $p1_0.toJson();
        }).toString());
        $v_0.append('}');
        return $v_0.toString();
...
Microsoft.Crm.Workflow.Expressions.ExpressionBase.prototype = {
    ...
    toJson: function() {
        ...
        $v_0.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getObjectJson('behavior', Microsoft.Crm.Workflow.Utils.StringUtility.toStringInvariant(this.behavior), true));
        return $v_0.toString();
    },
...
Microsoft.Crm.Workflow.Expressions.ExpressionCollection.prototype = {
    ...
    set_item: function(index, value) {
        Microsoft.Crm.Workflow.Utils.ExceptionUtility.assert(!this.$j_0, 'Cannot modify value in a readonly expression collection');
...
Microsoft.Crm.Workflow.Expressions.PrimitiveExpression.prototype = {
    ...
    toJson: function() {
        ...
        if (this.type === 9) {
            ...
            $v_0.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getPropertyJson('primitiveValue', this.$1u_1(), true));
        }
        $v_0.append('}');
        return $v_0.toString();
    },
...
Microsoft.Crm.Workflow.Expressions.EntityBaseDecorator$1 = function(entity, metadataProvider) {
    Microsoft.Crm.Workflow.Expressions.EntityBaseDecorator$1.$$(this.$$gta['Microsoft.Crm.Workflow.Expressions.EntityBaseDecorator$1']['TEntity']).initializeBase(this, [ entity.$0_0, entity.parameterName ]);
    this.$6_1 = entity;
...
Microsoft.Crm.Workflow.Validators.UnaryExpressionValidator = function(expression) {
    ...
    var $v_0 = Microsoft.Crm.Workflow.Utils.SharedUtility.getList(Microsoft.Crm.Workflow.Expressions.WorkflowConditionOperator);
    $v_0.add(0);
    $v_0.add(1);
    Microsoft.Crm.Workflow.Utils.SharedUtility.dictionaryAdd(Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType, Sales.Common.Framework.IList$1.$$(Microsoft.Crm.Workflow.Expressions.WorkflowConditionOperator), this.applicableOperatorsDictionary, 0, $v_0);
    Microsoft.Crm.Workflow.Utils.SharedUtility.dictionaryAdd(Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType, Sales.Common.Framework.IList$1.$$(Microsoft.Crm.Workflow.Expressions.WorkflowConditionOperator), this.applicableOperatorsDictionary, 6, $v_0);
    Microsoft.Crm.Workflow.Utils.SharedUtility.dictionaryAdd(Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType, Sales.Common.Framework.IList$1.$$(Microsoft.Crm.Workflow.Expressions.WorkflowConditionOperator), this.applicableOperatorsDictionary, 11, $v_0);
    Microsoft.Crm.Workflow.Utils.SharedUtility.dictionaryAdd(Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType, Sales.Common.Framework.IList$1.$$(Microsoft.Crm.Workflow.Expressions.WorkflowConditionOperator), this.applicableOperatorsDictionary, 1, $v_0);
    Microsoft.Crm.Workflow.Utils.SharedUtility.dictionaryAdd(Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType, Sales.Common.Framework.IList$1.$$(Microsoft.Crm.Workflow.Expressions.WorkflowConditionOperator), this.applicableOperatorsDictionary, 8, $v_0);
    Microsoft.Crm.Workflow.Utils.SharedUtility.dictionaryAdd(Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType, Sales.Common.Framework.IList$1.$$(Microsoft.Crm.Workflow.Expressions.WorkflowConditionOperator), this.applicableOperatorsDictionary, 2, $v_0);
    Microsoft.Crm.Workflow.Utils.SharedUtility.dictionaryAdd(Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType, Sales.Common.Framework.IList$1.$$(Microsoft.Crm.Workflow.Expressions.WorkflowConditionOperator), this.applicableOperatorsDictionary, 5, $v_0);
    Microsoft.Crm.Workflow.Utils.SharedUtility.dictionaryAdd(Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType, Sales.Common.Framework.IList$1.$$(Microsoft.Crm.Workflow.Expressions.WorkflowConditionOperator), this.applicableOperatorsDictionary, 3, $v_0);
    Microsoft.Crm.Workflow.Utils.SharedUtility.dictionaryAdd(Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType, Sales.Common.Framework.IList$1.$$(Microsoft.Crm.Workflow.Expressions.WorkflowConditionOperator), this.applicableOperatorsDictionary, 14, $v_0);
    Microsoft.Crm.Workflow.Utils.SharedUtility.dictionaryAdd(Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType, Sales.Common.Framework.IList$1.$$(Microsoft.Crm.Workflow.Expressions.WorkflowConditionOperator), this.applicableOperatorsDictionary, 7, $v_0);
    Microsoft.Crm.Workflow.Utils.SharedUtility.dictionaryAdd(Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType, Sales.Common.Framework.IList$1.$$(Microsoft.Crm.Workflow.Expressions.WorkflowConditionOperator), this.applicableOperatorsDictionary, 4, $v_0);
    Microsoft.Crm.Workflow.Utils.SharedUtility.dictionaryAdd(Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType, Sales.Common.Framework.IList$1.$$(Microsoft.Crm.Workflow.Expressions.WorkflowConditionOperator), this.applicableOperatorsDictionary, 10, $v_0);
    Microsoft.Crm.Workflow.Utils.SharedUtility.dictionaryAdd(Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType, Sales.Common.Framework.IList$1.$$(Microsoft.Crm.Workflow.Expressions.WorkflowConditionOperator), this.applicableOperatorsDictionary, 12, $v_0);
    Microsoft.Crm.Workflow.Utils.SharedUtility.dictionaryAdd(Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType, Sales.Common.Framework.IList$1.$$(Microsoft.Crm.Workflow.Expressions.WorkflowConditionOperator), this.applicableOperatorsDictionary, 13, $v_0);
}
...
Microsoft.Crm.Workflow.Validators.BinaryExpressionValidator = function(expression) {
    ...
    this.$k_1 = {};
    this.$l_1 = {};
    Microsoft.Crm.Workflow.Validators.BinaryExpressionValidator.$1B = Microsoft.Crm.Workflow.Utils.SharedUtility.getList(Microsoft.Crm.Workflow.Expressions.WorkflowConditionOperator);
    ...
    $v_0.add(7);
    $v_0.add(4);
    Microsoft.Crm.Workflow.Utils.SharedUtility.dictionaryAddOrUpdate(Microsoft.Crm.Workflow.Expressions.WorkflowConditionOperator, Sales.Common.Framework.IList$1.$$(Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType), this.$M_1, 6, $v_0);
    Microsoft.Crm.Workflow.Utils.SharedUtility.dictionaryAddOrUpdate(Microsoft.Crm.Workflow.Expressions.WorkflowConditionOperator, Sales.Common.Framework.IList$1.$$(Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType), this.$M_1, 7, $v_0);
    Microsoft.Crm.Workflow.Utils.SharedUtility.dictionaryAddOrUpdate(Microsoft.Crm.Workflow.Expressions.WorkflowConditionOperator, Sales.Common.Framework.IList$1.$$(Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType), this.$M_1, 14, $v_0);
    Microsoft.Crm.Workflow.Utils.SharedUtility.dictionaryAddOrUpdate(Microsoft.Crm.Workflow.Expressions.WorkflowConditionOperator, Sales.Common.Framework.IList$1.$$(Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType), this.$M_1, 16, $v_0);
    Microsoft.Crm.Workflow.Utils.SharedUtility.dictionaryAddOrUpdate(Microsoft.Crm.Workflow.Expressions.WorkflowConditionOperator, Sales.Common.Framework.IList$1.$$(Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType), this.$M_1, 15, $v_0);
    Microsoft.Crm.Workflow.Utils.SharedUtility.dictionaryAddOrUpdate(Microsoft.Crm.Workflow.Expressions.WorkflowConditionOperator, Sales.Common.Framework.IList$1.$$(Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType), this.$M_1, 17, $v_0);
    $v_0 = Microsoft.Crm.Workflow.Utils.SharedUtility.getList(Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType);
    $v_0.add(2);
    Microsoft.Crm.Workflow.Utils.SharedUtility.dictionaryAddOrUpdate(Microsoft.Crm.Workflow.Expressions.WorkflowConditionOperator, Sales.Common.Framework.IList$1.$$(Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType), this.$K_1, 16, $v_0);
    Microsoft.Crm.Workflow.Utils.SharedUtility.dictionaryAddOrUpdate(Microsoft.Crm.Workflow.Expressions.WorkflowConditionOperator, Sales.Common.Framework.IList$1.$$(Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType), this.$K_1, 17, $v_0);
    Microsoft.Crm.Workflow.Utils.SharedUtility.dictionaryAddOrUpdate(Microsoft.Crm.Workflow.Expressions.WorkflowConditionOperator, Sales.Common.Framework.IList$1.$$(Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType), this.$K_1, 14, $v_0);
    Microsoft.Crm.Workflow.Utils.SharedUtility.dictionaryAddOrUpdate(Microsoft.Crm.Workflow.Expressions.WorkflowConditionOperator, Sales.Common.Framework.IList$1.$$(Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType), this.$K_1, 15, $v_0);
    Microsoft.Crm.Workflow.Utils.SharedUtility.dictionaryAddOrUpdate(Microsoft.Crm.Workflow.Expressions.WorkflowConditionOperator, Sales.Common.Framework.IList$1.$$(Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType), this.$K_1, 6, $v_0);
    Microsoft.Crm.Workflow.Utils.SharedUtility.dictionaryAddOrUpdate(Microsoft.Crm.Workflow.Expressions.WorkflowConditionOperator, Sales.Common.Framework.IList$1.$$(Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType), this.$K_1, 7, $v_0);
    $v_0 = Microsoft.Crm.Workflow.Utils.SharedUtility.getList(Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType);
    $v_0.add(0);
    Microsoft.Crm.Workflow.Utils.SharedUtility.dictionaryAddOrUpdate(Microsoft.Crm.Workflow.Expressions.WorkflowConditionOperator, Sales.Common.Framework.IList$1.$$(Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType), this.$S_1, 6, $v_0);
    Microsoft.Crm.Workflow.Utils.SharedUtility.dictionaryAddOrUpdate(Microsoft.Crm.Workflow.Expressions.WorkflowConditionOperator, Sales.Common.Framework.IList$1.$$(Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType), this.$S_1, 7, $v_0);
    Microsoft.Crm.Workflow.Utils.SharedUtility.dictionaryAddOrUpdate(Microsoft.Crm.Workflow.Expressions.WorkflowConditionOperator, Sales.Common.Framework.IList$1.$$(Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType), this.$S_1, 2, $v_0);
    Microsoft.Crm.Workflow.Utils.SharedUtility.dictionaryAddOrUpdate(Microsoft.Crm.Workflow.Expressions.WorkflowConditionOperator, Sales.Common.Framework.IList$1.$$(Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType), this.$S_1, 3, $v_0);
    $v_0 = Microsoft.Crm.Workflow.Utils.SharedUtility.getList(Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType);
    $v_0.add(10);
    Microsoft.Crm.Workflow.Utils.SharedUtility.dictionaryAddOrUpdate(Microsoft.Crm.Workflow.Expressions.WorkflowConditionOperator, Sales.Common.Framework.IList$1.$$(Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType), this.$i_1, 6, $v_0);
    Microsoft.Crm.Workflow.Utils.SharedUtility.dictionaryAddOrUpdate(Microsoft.Crm.Workflow.Expressions.WorkflowConditionOperator, Sales.Common.Framework.IList$1.$$(Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType), this.$i_1, 7, $v_0);
    $v_0 = Microsoft.Crm.Workflow.Utils.SharedUtility.getList(Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType);
    $v_0.add(12);
    Microsoft.Crm.Workflow.Utils.SharedUtility.dictionaryAddOrUpdate(Microsoft.Crm.Workflow.Expressions.WorkflowConditionOperator, Sales.Common.Framework.IList$1.$$(Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType), this.$k_1, 6, $v_0);
    Microsoft.Crm.Workflow.Utils.SharedUtility.dictionaryAddOrUpdate(Microsoft.Crm.Workflow.Expressions.WorkflowConditionOperator, Sales.Common.Framework.IList$1.$$(Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType), this.$k_1, 7, $v_0);
    $v_0 = Microsoft.Crm.Workflow.Utils.SharedUtility.getList(Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType);
    $v_0.add(13);
    Microsoft.Crm.Workflow.Utils.SharedUtility.dictionaryAddOrUpdate(Microsoft.Crm.Workflow.Expressions.WorkflowConditionOperator, Sales.Common.Framework.IList$1.$$(Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType), this.$l_1, 6, $v_0);
    Microsoft.Crm.Workflow.Utils.SharedUtility.dictionaryAddOrUpdate(Microsoft.Crm.Workflow.Expressions.WorkflowConditionOperator, Sales.Common.Framework.IList$1.$$(Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType), this.$l_1, 7, $v_0);
    $v_0 = Microsoft.Crm.Workflow.Utils.SharedUtility.getList(Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType);
    $v_0.add(14);
    Microsoft.Crm.Workflow.Utils.SharedUtility.dictionaryAddOrUpdate(Microsoft.Crm.Workflow.Expressions.WorkflowConditionOperator, Sales.Common.Framework.IList$1.$$(Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType), this.$C_1, 6, $v_0);
    Microsoft.Crm.Workflow.Utils.SharedUtility.dictionaryAddOrUpdate(Microsoft.Crm.Workflow.Expressions.WorkflowConditionOperator, Sales.Common.Framework.IList$1.$$(Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType), this.$C_1, 7, $v_0);
    Microsoft.Crm.Workflow.Utils.SharedUtility.dictionaryAddOrUpdate(Microsoft.Crm.Workflow.Expressions.WorkflowConditionOperator, Sales.Common.Framework.IList$1.$$(Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType), this.$C_1, 8, $v_0);
    Microsoft.Crm.Workflow.Utils.SharedUtility.dictionaryAddOrUpdate(Microsoft.Crm.Workflow.Expressions.WorkflowConditionOperator, Sales.Common.Framework.IList$1.$$(Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType), this.$C_1, 9, $v_0);
    Microsoft.Crm.Workflow.Utils.SharedUtility.dictionaryAddOrUpdate(Microsoft.Crm.Workflow.Expressions.WorkflowConditionOperator, Sales.Common.Framework.IList$1.$$(Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType), this.$C_1, 10, $v_0);
    Microsoft.Crm.Workflow.Utils.SharedUtility.dictionaryAddOrUpdate(Microsoft.Crm.Workflow.Expressions.WorkflowConditionOperator, Sales.Common.Framework.IList$1.$$(Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType), this.$C_1, 11, $v_0);
    Microsoft.Crm.Workflow.Utils.SharedUtility.dictionaryAddOrUpdate(Microsoft.Crm.Workflow.Expressions.WorkflowConditionOperator, Sales.Common.Framework.IList$1.$$(Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType), this.$C_1, 12, $v_0);
    Microsoft.Crm.Workflow.Utils.SharedUtility.dictionaryAddOrUpdate(Microsoft.Crm.Workflow.Expressions.WorkflowConditionOperator, Sales.Common.Framework.IList$1.$$(Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType), this.$C_1, 13, $v_0);
}
...
Microsoft.Crm.Workflow.Validators.MethodCallArithmeticEvaluateExpressionValidator = function($p0, $p1, $p2) {
    Microsoft.Crm.Workflow.Validators.MethodCallArithmeticEvaluateExpressionValidator.initializeBase(this, [ $p0, $p1, $p2 ]);
    if (!this.$4_0) {
    ...
    if (this.$4_0.length !== 2) {
        this.$1_0.trace('Invalid number of operands in {0}: expected {1} actual {2}', Object.getType(this).getName(), this.$4_0.length, 2);
        Microsoft.Crm.Workflow.Utils.SharedUtility.throwException(-2147089372, this.$1_0.get_attributeLogicalName());
    }
    this.$Q_1 = {};
    Microsoft.Crm.Workflow.Utils.SharedUtility.dictionaryAdd(Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType, Number, this.$Q_1, 5, 1);
    Microsoft.Crm.Workflow.Utils.SharedUtility.dictionaryAdd(Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType, Number, this.$Q_1, 3, 2);
    Microsoft.Crm.Workflow.Utils.SharedUtility.dictionaryAdd(Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType, Number, this.$Q_1, 7, 3);
}
Microsoft.Crm.Workflow.Validators.MethodCallArithmeticEvaluateExpressionValidator.prototype = {
    ...
    validate: function() {
        this.$22_1();
        this.$J_0 = Microsoft.Crm.Workflow.Validators.TypeUtility.methodCallExpressionSetTypeFromRank(this.$Q_1, this.$4_0);
        if (this.$B_0 === 3) {
            this.$23_1();
        }
    },
    ...
    $23_1: function() {
        for (var $v_0 = 1; $v_0 < this.$4_0.length; $v_0++) {
            ...
            this.$1_0.trace('Attempted to divide by zero in sub-formula {0} in {1}', $v_0, $v_2.primitiveValue.toString(), Object.getType(this).getName());
    ...
    $22_1: function() {
        var $v_0 = this.$4_0[0];
        var $v_1 = $v_0.type;
        if (!Microsoft.Crm.Workflow.Utils.SharedUtility.dictionaryContainKey(Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType, Number, this.$Q_1, $v_1)) {
            this.$1_0.trace('Invalid operand #{0} of WorkflowAttributeType {1} in {2}', 0, Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType.toString($v_1), Object.getType(this).getName());
            Microsoft.Crm.Workflow.Utils.SharedUtility.throwException(-2147089370, Microsoft.Crm.Workflow.FormulaDisplayVisitor.expressionToString($v_0), Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType.toString($v_1));
        }
        for (var $v_2 = 1; $v_2 < this.$4_0.length; $v_2++) {
            var $v_3 = this.$4_0[$v_2];
            var $v_4 = $v_3.type;
            if (!Microsoft.Crm.Workflow.Utils.SharedUtility.dictionaryContainKey(Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType, Number, this.$Q_1, $v_4)) {
                this.$1_0.trace('Invalid operand #{0} of WorkflowAttributeType {1} in {2}', $v_2, Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType.toString($v_4), Object.getType(this).getName());
                Microsoft.Crm.Workflow.Utils.SharedUtility.throwException(-2147089370, Microsoft.Crm.Workflow.FormulaDisplayVisitor.expressionToString($v_3), Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType.toString($v_4));
            }
        }
    }
}
...
Microsoft.Crm.Workflow.Validators.MethodCallDateMathEvaluateExpressionValidator = function($p0, $p1, $p2) {
    Microsoft.Crm.Workflow.Validators.MethodCallDateMathEvaluateExpressionValidator.initializeBase(this, [ $p0, $p1, $p2 ]);
    switch ($p1) {
        case 42:
        case 47:
        case 43:
...
Microsoft.Crm.Workflow.Validators.MethodCallDateMathEvaluateExpressionValidator.prototype = {
    ...
    validate: function() {
        ...
        if (this.$4_0.length !== 2) {
            this.$1_0.trace('Invalid number of operands in {0}: expected {1} actual {2}', Object.getType(this).getName(), 2, this.$4_0.length);
            Microsoft.Crm.Workflow.Utils.SharedUtility.throwException(-2147089372, this.$1_0.get_attributeLogicalName());
        }
        var $v_0 = this.$4_0[0];
        var $v_1 = this.$4_0[1];
        ...
        switch (this.$B_0) {
            ...
            case 46:
                if ($v_0.type !== 2) {
                    this.$1_0.trace('Unexpected operand #{0} in {1}: expected {2} actual {3}', 0, Object.getType(this).getName(), 'Integer', Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType.toString($v_0.type));
                    Microsoft.Crm.Workflow.Utils.SharedUtility.throwException(-2147089364, Microsoft.Crm.Workflow.FormulaDisplayVisitor.expressionToString($v_0), Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType.toString($v_0.type));
                }
                if ($v_1.type !== 2) {
                    this.$1_0.trace('Unexpected operand #{0} in {1}: expected {2} actual {3}', 1, Object.getType(this).getName(), 'DateTime', Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType.toString($v_1.type));
                    Microsoft.Crm.Workflow.Utils.SharedUtility.throwException(-2147089364, Microsoft.Crm.Workflow.FormulaDisplayVisitor.expressionToString($v_1), Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType.toString($v_1.type));
                }
                if ($v_0.behavior !== $v_1.behavior) {
                    this.$1_0.trace('Invalid operand #{0} of WorkflowAttributeType {1} in {2}', 1, Object.getType(this).getName(), 'DateTime', Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType.toString($v_1.type));
                    Microsoft.Crm.Workflow.Utils.SharedUtility.throwException(-2147089364, Microsoft.Crm.Workflow.FormulaDisplayVisitor.expressionToString($v_1), Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType.toString($v_1.type));
                }
                if ((this.$B_0 === 42 || this.$B_0 === 43) && $v_0.behavior === 2) {
                    this.$1_0.trace('Invalid operand #{0} of WorkflowAttributeType {1} in {2}', 1, Object.getType(this).getName(), 'DateTime', Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType.toString($v_1.type));
                    Microsoft.Crm.Workflow.Utils.SharedUtility.throwException(-2147089370, Microsoft.Crm.Workflow.FormulaDisplayVisitor.expressionToString($v_1), Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType.toString($v_1.type));
                }
                break;
            default:
                if ($v_0.type !== 5) {
...
Microsoft.Crm.Workflow.Validators.MethodCallEvaluateExpressionValidatorBase = function(operands, expressionOperator, context) {
...
Microsoft.Crm.Workflow.Validators.MethodCallEvaluateExpressionValidatorFactory.getValidator = function(expressionOperator, expressions, context) {
    var $v_0 = null;
    switch (expressionOperator) {
        ...
        case 2:
        case 3:
            $v_0 = new Microsoft.Crm.Workflow.Validators.MethodCallArithmeticEvaluateExpressionValidator(expressions, expressionOperator, context);
            break;
        case 25:
        case 27:
        case 29:
        ...
        case 46:
        case 47:
            $v_0 = new Microsoft.Crm.Workflow.Validators.MethodCallDateMathEvaluateExpressionValidator(expressions, expressionOperator, context);
            break;
        case 22:
        case 24:
        case 23:
            $v_0 = new Microsoft.Crm.Workflow.Validators.MethodCallStringEvaluateExpressionValidator(expressions, expressionOperator, context);
            break;
        case 35:
        case 37:
        case 39:
...
Microsoft.Crm.Workflow.Validators.MethodCallStringEvaluateExpressionValidator.prototype = {
    ...
    validate: function() {
        switch (this.$B_0) {
            ...
            case 23:
                ...
                break;
            default:
                this.$1_0.trace('Unexpected expression operator {0} in {1}', Microsoft.Crm.Workflow.Activities.ExpressionOperator.toString(this.$B_0), Object.getType(this).getName());
                Microsoft.Crm.Workflow.Utils.SharedUtility.throwException(-2147089369, Microsoft.Crm.Workflow.Activities.ExpressionOperator.toString(this.$B_0));
                break;
        }
    },
    ...
    validateConcat: function() {
        ...
        if (this.$4_0.length < 2) {
            this.$1_0.trace('Invalid number of operands in {0}: expected {1} actual {2}', Object.getType(this).getName(), '>1', this.$4_0.length);
            Microsoft.Crm.Workflow.Utils.SharedUtility.throwException(-2147089372, this.$1_0.get_attributeLogicalName());
        }
        var $v_0 = null;
        for (var $v_1 = 0; $v_1 < this.$4_0.length; $v_1++) {
            ...
            if ($v_0.type !== 14 && $v_0.type !== 5 && $v_0.type !== 7 && $v_0.type !== 3) {
                this.$1_0.trace('Invalid operand #{0} of WorkflowAttributeType {1} in {2}', $v_1, Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType.toString($v_0.type), Object.getType(this).getName());
                Microsoft.Crm.Workflow.Utils.SharedUtility.throwException(-2147089364, Microsoft.Crm.Workflow.FormulaDisplayVisitor.expressionToString($v_0), Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType.toString($v_0.type));
            }
        }
    },
    ...
    validateTrim: function() {
        ...
        if ($v_0.type !== 14) {
            this.$1_0.trace('Unexpected operand #{0} in {1}: expected {2} actual {3}', 0, Object.getType(this).getName(), 'String', Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType.toString($v_0.type));
            Microsoft.Crm.Workflow.Utils.SharedUtility.throwException(-2147089364, Microsoft.Crm.Workflow.FormulaDisplayVisitor.expressionToString($v_0), Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType.toString($v_0.type));
        }
        if ($v_1.type !== 5 && $v_1.type !== 3) {
            this.$1_0.trace('Unexpected operand #{0} in {1}: expected {2} actual {3}', 1, Object.getType(this).getName(), 'Integer', Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType.toString($v_1.type));
            Microsoft.Crm.Workflow.Utils.SharedUtility.throwException(-2147089364, Microsoft.Crm.Workflow.FormulaDisplayVisitor.expressionToString($v_1), Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType.toString($v_1.type));
        }
    }
}
...
Microsoft.Crm.Workflow.Validators.MethodCallExpressionValidator.prototype = {
    ...
    validate: function() {
        switch (this.$7_1.method) {
            ...
            case 0:
                ...
                break;
            default:
                this.$1_0.trace('Unexpected method call {0} in {1}', Microsoft.Crm.Workflow.Expressions.MethodCall.toString(this.$7_1.method), Object.getType(this).getName());
                Microsoft.Crm.Workflow.Utils.SharedUtility.throwException(-2147089372, this.$1_0.get_attributeLogicalName());
                break;
        }
    },
    ...
    $24_1: function() {
        ...
        if ($v_0.length < 1) {
            this.$1_0.trace('Invalid number of parameters in {0}: expected {1} actual {2}', Object.getType(this).getName(), '>=1', $v_0.length);
            Microsoft.Crm.Workflow.Utils.SharedUtility.throwException(-2147089372, this.$1_0.get_attributeLogicalName());
        }
        ...
        if ($v_0.length !== $v_1.length + 1) {
            this.$1_0.trace('Invalid number of operands in {0}: expected {1} actual {2}', Object.getType(this).getName(), $v_0.length - 1, $v_1.length);
            Microsoft.Crm.Workflow.Utils.SharedUtility.throwException(-2147089372, this.$1_0.get_attributeLogicalName());
        }
        var $v_3 = Microsoft.Crm.Workflow.Validators.MethodCallEvaluateExpressionValidatorFactory.getValidator($v_2, $v_1, this.$1_0);
        $v_3.validate();
    ...
    $25_1: function() {
        ...
        var $v_1 = $v_0[0];
        if ((Microsoft.Crm.Workflow.Expressions.EntityAttributeExpression.isInstanceOfType($v_0[0]) || Microsoft.Crm.Workflow.Expressions.MethodCallExpression.isInstanceOfType($v_0[0])) && this.$7_1.type === 2 && !this.$7_1.behavior) {
...
Microsoft.Crm.Workflow.Validators.SetAttributeValueStepValidator = function() {
    ...
    $v_0 = Microsoft.Crm.Workflow.Utils.SharedUtility.getList(Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType);
    $v_0.add(0);
    Microsoft.Crm.Workflow.Utils.SharedUtility.dictionaryAdd(Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType, Sales.Common.Framework.IList$1.$$(Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType), this.$E_0, 0, $v_0);
    $v_0 = Microsoft.Crm.Workflow.Utils.SharedUtility.getList(Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType);
    $v_0.add(2);
    Microsoft.Crm.Workflow.Utils.SharedUtility.dictionaryAdd(Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType, Sales.Common.Framework.IList$1.$$(Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType), this.$E_0, 2, $v_0);
    $v_0 = Microsoft.Crm.Workflow.Utils.SharedUtility.getList(Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType);
    $v_0.add(3);
    $v_0.add(5);
    $v_0.add(7);
    Microsoft.Crm.Workflow.Utils.SharedUtility.dictionaryAdd(Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType, Sales.Common.Framework.IList$1.$$(Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType), this.$E_0, 3, $v_0);
    $v_0 = Microsoft.Crm.Workflow.Utils.SharedUtility.getList(Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType);
    $v_0.add(3);
    $v_0.add(5);
    $v_0.add(7);
    Microsoft.Crm.Workflow.Utils.SharedUtility.dictionaryAdd(Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType, Sales.Common.Framework.IList$1.$$(Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType), this.$E_0, 5, $v_0);
    $v_0 = Microsoft.Crm.Workflow.Utils.SharedUtility.getList(Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType);
    $v_0.add(3);
    $v_0.add(5);
    $v_0.add(7);
    Microsoft.Crm.Workflow.Utils.SharedUtility.dictionaryAdd(Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType, Sales.Common.Framework.IList$1.$$(Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType), this.$E_0, 7, $v_0);
    $v_0 = Microsoft.Crm.Workflow.Utils.SharedUtility.getList(Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType);
    $v_0.add(10);
    Microsoft.Crm.Workflow.Utils.SharedUtility.dictionaryAdd(Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType, Sales.Common.Framework.IList$1.$$(Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType), this.$E_0, 10, $v_0);
    $v_0 = Microsoft.Crm.Workflow.Utils.SharedUtility.getList(Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType);
    $v_0.add(14);
    $v_0.add(3);
    $v_0.add(5);
    $v_0.add(7);
    Microsoft.Crm.Workflow.Utils.SharedUtility.dictionaryAdd(Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType, Sales.Common.Framework.IList$1.$$(Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType), this.$E_0, 14, $v_0);
}
Microsoft.Crm.Workflow.Validators.SetAttributeValueStepValidator.prototype = {
    ...
    validateAssignmentApplicability: function(attributeType, attributeBehaviorDateTimeType, expression) {
        ...
        if (!Microsoft.Crm.Workflow.Utils.SharedUtility.dictionaryContainKey(Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType, Sales.Common.Framework.IList$1.$$(Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType), this.$E_0, $v_0)) {
            this.$1_0.trace('Attribute {0} is not a valid calculated field', Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType.toString($v_2));
            Microsoft.Crm.Workflow.Utils.SharedUtility.throwException(-2147089372, this.$1_0.get_attributeLogicalName());
        }
        if (!Microsoft.Crm.Workflow.Utils.SharedUtility.dictionaryGetValue(Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType, Sales.Common.Framework.IList$1.$$(Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType), this.$E_0, $v_0).contains($v_2)) {
            this.$1_0.trace('Attribute type {0} is not a valid for set on {1} type calculated field', Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType.toString($v_2), Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType.toString($v_0));
            Microsoft.Crm.Workflow.Utils.SharedUtility.throwException(-2147089365, Microsoft.Crm.Workflow.FormulaDisplayVisitor.expressionToString(expression), Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType.toString($v_2), Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType.toString($v_0));
        }
        if ($v_0 === 2 && $v_3 !== $v_1) {
            if ($v_1 === 2) {
...
Microsoft.Crm.Workflow.Validators.TypeUtility.methodCallExpressionSetTypeFromRank = function(rankDictionary, operands) {
    ...
    for (var $$arr_4 = operands, $$len_5 = $$arr_4.length, $$idx_6 = 0; $$idx_6 < $$len_5; ++$$idx_6) {
        var $v_2 = $$arr_4[$$idx_6];
        Microsoft.Crm.Workflow.Utils.ExceptionUtility.assert(Microsoft.Crm.Workflow.Utils.SharedUtility.dictionaryContainKey(Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType, Number, rankDictionary, $v_2.type), 'dictionary does not contain key');
        if ($v_1) {
            $v_0 = $v_2.type;
            $v_1 = false;
            continue;
        }
        if (Microsoft.Crm.Workflow.Utils.SharedUtility.dictionaryGetValue(Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType, Number, rankDictionary, $v_2.type) > Microsoft.Crm.Workflow.Utils.SharedUtility.dictionaryGetValue(Microsoft.Crm.Workflow.Expressions.WorkflowAttributeType, Number, rankDictionary, $v_0)) {
            $v_0 = $v_2.type;
        }
    }
    return $v_0;
...
ProcessObjectModel.Visitors.BusinessProcessFlowStepVisitorBase.prototype = {
    ...
    visitChildren: function($p0) {
        for (var $v_0 = 0; $v_0 < $p0.steps.get_Count(); $v_0++) {
            ...
            if (Microsoft.Crm.Workflow.Utils.ObjectUtils.isNull($v_2)) {
                continue;
            }
            $v_2.visit($v_1);
        }
...
ProcessObjectModel.Visitors.StepVisitorFactory.prototype = {
    ...
    createStepVisitor: function($p0, $p1) {
        ...
        if (!Microsoft.Crm.Workflow.Utils.ObjectUtils.isNull($v_0)) {
...
ProcessObjectModel.Visitors.BusinessProcessFlowVisitor.prototype = {
    ...
    get_stages: function() {
        if (Microsoft.Crm.Workflow.Utils.ObjectUtils.isNull(this.$18_0)) {
            this.$18_0 = [];
        }
        return this.$18_0;
    },
    ...
    get_$V_0: function() {
        if (Microsoft.Crm.Workflow.Utils.ObjectUtils.isNull(this.$16_0)) {
            this.$16_0 = {};
        }
        return this.$16_0;
    },
    ...
    $1m_0: function() {
        ...
        while (!Microsoft.Crm.Workflow.Utils.StringUtility.isNullOrWhiteSpace($v_0.nextStageId)) {
    ...
    get_entities: function() {
        if (Microsoft.Crm.Workflow.Utils.ObjectUtils.isNull(this.$10_0)) {
            this.$10_0 = [];
        }
        return this.$10_0;
    },
    ...
    get_entitiesByEntityName: function() {
        if (Microsoft.Crm.Workflow.Utils.ObjectUtils.isNull(this.$y_0)) {
            this.$y_0 = {};
        }
        return this.$y_0;
    },
    ...
    get_conditionsByParentStageId: function() {
        if (Microsoft.Crm.Workflow.Utils.ObjectUtils.isNull(this.$v_0)) {
            this.$v_0 = {};
        }
        return this.$v_0;
    },
    ...
    get_stagesById: function() {
        if (Microsoft.Crm.Workflow.Utils.ObjectUtils.isNull(this.$19_0)) {
            this.$19_0 = {};
        }
        return this.$19_0;
    },
    ...
    get_firstLevelStages: function() {
        if (Microsoft.Crm.Workflow.Utils.ObjectUtils.isNull(this.$O_0)) {
            this.$O_0 = {};
        }
        return this.$O_0;
    },
    ...
    $1j_0: function() {
        for (var $v_0 = 0; $v_0 < this.get_entities().length - 1; $v_0++) {
            ...
            if (Microsoft.Crm.Workflow.Utils.ObjectUtils.isNullOrEmptyString($v_3) || Microsoft.Crm.Workflow.Utils.ObjectUtils.isNullOrEmptyString($v_4)) {
                continue;
            }
    ...
    get_businessProcessFlowStepVisitorFactory: function() {
        if (Microsoft.Crm.Workflow.Utils.ObjectUtils.isNull(this.$e_0)) {
    ...
    addRelationship: function(relationship) {
        if (Microsoft.Crm.Workflow.Utils.ObjectUtils.isNullOrEmptyString(relationship.sourceStageId) || Microsoft.Crm.Workflow.Utils.ObjectUtils.isNullOrEmptyString(relationship.targetStageId)) {
            return;
        }
...
Microsoft.Crm.Workflow.ObjectModel.FlowStep.registerClass('Microsoft.Crm.Workflow.ObjectModel.FlowStep', Microsoft.Crm.Workflow.ObjectModel.CompositeStepBase);
...
Microsoft.Crm.Workflow.ObjectModel.InteractiveWorkflowInputDictionary.Wrapper.registerClass('Microsoft.Crm.Workflow.ObjectModel.InteractiveWorkflowInputDictionary.Wrapper');
...
Microsoft.Crm.Workflow.Utils.ObjectUtils.registerClass('Microsoft.Crm.Workflow.Utils.ObjectUtils');
Microsoft.Crm.Workflow.Utils.TypeNames.registerClass('Microsoft.Crm.Workflow.Utils.TypeNames');
...
Microsoft.Crm.Workflow.Validators.MethodCallArithmeticEvaluateExpressionValidator.registerClass('Microsoft.Crm.Workflow.Validators.MethodCallArithmeticEvaluateExpressionValidator', Microsoft.Crm.Workflow.Validators.MethodCallEvaluateExpressionValidatorBase);
Microsoft.Crm.Workflow.Validators.MethodCallDateMathEvaluateExpressionValidator.registerClass('Microsoft.Crm.Workflow.Validators.MethodCallDateMathEvaluateExpressionValidator', Microsoft.Crm.Workflow.Validators.MethodCallEvaluateExpressionValidatorBase);
...
Microsoft.Crm.Workflow.Validators.MethodCallStringEvaluateExpressionValidator.registerClass('Microsoft.Crm.Workflow.Validators.MethodCallStringEvaluateExpressionValidator', Microsoft.Crm.Workflow.Validators.MethodCallEvaluateExpressionValidatorBase);
...
ProcessObjectModel.Visitors.BusinessProcessFlowStepVisitorBase.registerClass('ProcessObjectModel.Visitors.BusinessProcessFlowStepVisitorBase');
ProcessObjectModel.Visitors.ConditionStepVisitor.registerClass('ProcessObjectModel.Visitors.ConditionStepVisitor', ProcessObjectModel.Visitors.BusinessProcessFlowStepVisitorBase, ProcessObjectModel.Visitors.IBusinessProcessFlowStepVisitor);
ProcessObjectModel.Visitors.RelationshipCollectionStepVisitor.registerClass('ProcessObjectModel.Visitors.RelationshipCollectionStepVisitor', ProcessObjectModel.Visitors.BusinessProcessFlowStepVisitorBase, ProcessObjectModel.Visitors.IBusinessProcessFlowStepVisitor);
ProcessObjectModel.Visitors.EntityStepVisitor.registerClass('ProcessObjectModel.Visitors.EntityStepVisitor', ProcessObjectModel.Visitors.BusinessProcessFlowStepVisitorBase, ProcessObjectModel.Visitors.IBusinessProcessFlowStepVisitor);
ProcessObjectModel.Visitors.StageStepVisitor.registerClass('ProcessObjectModel.Visitors.StageStepVisitor', ProcessObjectModel.Visitors.BusinessProcessFlowStepVisitorBase, ProcessObjectModel.Visitors.IStageStepVisitor, ProcessObjectModel.Visitors.IBusinessProcessFlowStepVisitor);
ProcessObjectModel.Visitors.StepVisitorFactory.registerClass('ProcessObjectModel.Visitors.StepVisitorFactory', null, ProcessObjectModel.Visitors.IBusinessProcessFlowStepVisitorFactory);
...
ProcessObjectModel.Visitors.WorkflowStepVisitor.registerClass('ProcessObjectModel.Visitors.WorkflowStepVisitor', ProcessObjectModel.Visitors.BusinessProcessFlowStepVisitorBase, ProcessObjectModel.Visitors.IBusinessProcessFlowStepVisitor);
...
Microsoft.Crm.Workflow.Utils.TypeNames.NumberType = 'number';
Microsoft.Crm.Workflow.Utils.TypeNames.StringType = 'string';
Microsoft.Crm.Workflow.Utils.TypeNames.BooleanType = 'boolean';
Microsoft.Crm.Workflow.Utils.TypeNames.ObjectType = 'object';
Microsoft.Crm.Workflow.Utils.TypeNames.FunctionType = 'function';
Microsoft.Crm.Workflow.Utils.TypeNames.UndefinedType = 'undefined';
Microsoft.Crm.Workflow.Utils.TypeNames.UnknownType = 'unknown';
