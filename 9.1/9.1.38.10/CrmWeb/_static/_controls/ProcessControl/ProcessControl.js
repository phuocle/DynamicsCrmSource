...
Mscrm.NullProcessControlData = function() {
    this.$$d_$5o_1 = Function.createDelegate(this, this.$5o_1);
...
Mscrm.NullProcessControlData.prototype = {
    ...
    switchProcess: function() {
        if (IsNull(this.$36_1)) {
            var $v_0 = $P_CRM('body');
            var $v_1 = Xrm.Page.data.entity.getEntityName();
            this.$36_1 = new Mscrm.SwitchProcessFlyOut($v_0, Xrm.Page.data.entity.getId(), $v_1);
            this.$36_1.add_processSwitched(this.$$d_$5o_1);
        }
        this.$36_1.selectView(false);
    },
...
Mscrm.ProcessControlClientApiUserHandler.get_instance = function() {
    if (!Mscrm.ProcessControlClientApiUserHandler.$3K) {
        Mscrm.ProcessControlClientApiUserHandler.$3K = new Mscrm.ProcessControlClientApiUserHandler();
    }
    return Mscrm.ProcessControlClientApiUserHandler.$3K;
}
...
Mscrm.ProcessControlShared.ObjectModels.ActionLogStatus = function() {}
Mscrm.ProcessControlShared.ObjectModels.ActionLogStatus.prototype = {
    InProgress: 1, 
    Succeeded: 2, 
    Failed: 3, 
    Canceled: 4, 
...
Mscrm.ProcessControlShared.ObjectModels.ActionLogStatus.registerEnum('Mscrm.ProcessControlShared.ObjectModels.ActionLogStatus', false);
...
Mscrm.ProcessControlShared.ObjectModels.ActionLog = function() {
}
Mscrm.ProcessControlShared.ObjectModels.ActionLog.prototype = {
    ErrorCode: null,
    Message: null,
    Status: 0,
    WorkflowLogId: null,
...
Mscrm.ProcessControlShared.ObjectModels.TraversedPath.prototype = {
    ...
    set_path: function(value) {
        this.$18_0 = Microsoft.Crm.Workflow.Utils.StringUtility.reduceToCanonicalForm(value);
        while (this.$18_0 && this.$18_0.indexOf('{') > 0) {
            this.$18_0 = Microsoft.Crm.Workflow.Utils.StringUtility.reduceToCanonicalForm(this.$18_0);
        }
        return value;
    },
    
    equals: function(traversedPath) {
        if (this.$18_0 === traversedPath.get_path()) {
            return true;
        }
        return false;
    },
    ...
    isInTraversedPath: function(stageId) {
        if (!Microsoft.Crm.Workflow.Utils.StringUtility.isNullOrEmpty(stageId) && !Microsoft.Crm.Workflow.Utils.StringUtility.isNullOrEmpty(this.$18_0)) {
            if (this.$18_0.indexOf(Microsoft.Crm.Workflow.Utils.StringUtility.reduceToCanonicalForm(stageId)) > -1) {
                return true;
            }
        }
        return false;
...
Mscrm.ProcessControlShared.ObjectModels.Stage.prototype = {
    ...
    get_completed: function() {
        return this.$1_0.isCompleted(this.$t_0);
    },
    ...
    get_advance: function() {
        return this.$1_0.canAdvance(this.$t_0);
    },
    
    get_back: function() {
        return this.$1_0.canGoBack(this.$t_0);
    },
    
    get_navigate: function() {
        return this.$1_0.canNavigate(this.$t_0);
    },
    
    get_setActive: function() {
        return this.$1_0.canSetActive(this.$t_0);
    },
    ...
    get_edit: function() {
        return this.$1_0.isEditable(this.$t_0);
    },
...
ProcessControl.FormDataUtility.getActiveStageValue = function(stages, formData, traversedPath, hasTraversedInfo) {
    ...
    var $v_2 = (formData._processControlDataKey) ? formData._processControlDataKey._globalNavigationData : null;
    var $v_3 = ($v_2) ? $v_2.activeStageId : null;
    if (Microsoft.Crm.Client.Core.Framework.Guid.isNullOrEmpty($v_3)) {
        return null;
    }
    ...
    var $v_4 = (!$v_0) ? Microsoft.Crm.Workflow.Utils.StringUtility.reduceToCanonicalForm($v_3) : null;
    var $v_5 = ($v_2) ? $v_2.traversedPath : null;
    if (IsNull($v_5)) {
        traversedPath.val = new Mscrm.ProcessControlShared.ObjectModels.TraversedPath(Mscrm.ProcessControlShared.ObjectModels.TraversedPath.getCandidateTraversedPathFromStagStep(stages, $v_4));
    }
    else {
        traversedPath.val = new Mscrm.ProcessControlShared.ObjectModels.TraversedPath($v_5);
    }
    hasTraversedInfo.val = true;
    var $v_6 = (Mscrm.InternalUtilities._String.isNullOrEmpty($v_0)) ? '' : Microsoft.Crm.Workflow.Utils.StringUtility.reduceToCanonicalForm($v_0);
    var $v_7 = '';
    var $v_8 = false;
    var $v_9 = false;
    for (var $v_A = 0; $v_A < stages.length && !$v_8; $v_A++) {
        var $v_B = stages[$v_A];
        var $v_C = Microsoft.Crm.Workflow.Utils.StringUtility.reduceToCanonicalForm($v_B.get_stageId());
        var $v_D = $v_B.get_parent();
        if ($v_D && $v_D.get_EntityLogicalName().toLowerCase() === $v_1.toLowerCase()) {
            if ($v_C === $v_4) {
                $v_8 = true;
            }
            else if ($v_C === $v_6) {
            ...
            else if (traversedPath.val.isInTraversedPath($v_C)) {
                $v_7 = $v_C;
            }
        }
    }
    ...
    return (Mscrm.InternalUtilities._String.isNullOrEmpty($v_7)) ? $v_4 : $v_7;
}
...
ProcessControl.ClientApi.BusinessProcessFlow = function(processId, processInstanceId, processInstanceName, processName, state, status, isRendered, processStages) {
    ...
    this.$4f_1 = processId;
    this.$1t_1 = processInstanceId;
    this.$2H_1 = processName;
    this.$4n_1 = isRendered;
    this.$47_1 = new ProcessControl.ClientApi.BusinessProcessFlow.XrmProcessStages();
    this.$4v_1 = state;
    this.$2L_1 = status;
    this.$4m_1 = processInstanceName;
...
ProcessControl.ClientApi.BusinessProcessFlow.prototype = {
    ...
    getStatus: function() {
        return Xrm.BusinessProcessFlowInstanceStatus.toString(this.$2L_1);
    },
    ...
    getState: function() {
        return Xrm.BusinessProcessFlowInstanceState.toString(this.$4v_1);
    },
...
ProcessControl.ClientApi.ProcessObjectBuilder.prototype = {
    ...
    processStepBuilder: function(stepStep) {
        ...
        var $v_3 = 0;
        if (Microsoft.Crm.Workflow.ObjectModel.ActionStep.isInstanceOfType($v_1.get_parent()) || Microsoft.Crm.Workflow.ObjectModel.FlowStep.isInstanceOfType($v_1.get_parent())) {
            $v_3 = (Microsoft.Crm.Workflow.ObjectModel.ActionStep.isInstanceOfType($v_1.get_parent())) ? 1 : 2;
            $v_2 = '';
            return new ProcessControl.ClientApi.ProcessStep($v_0.get_description(), $v_3, stepStep.get_isProcessRequired(), $v_2, stepStep.get_stepStepId(), $v_1.get_controlId());
        }
...
ProcessControl.ClientApi.ProcessStage = function(stageId, stageName, stageCategory, stageEntity, stageStatus, stageSteps) {
    ...
    this.$4C_0 = stageCategory;
    this.$4U_0 = Xrm.ProcessStatus.toString(stageStatus);
    this.$3g_0 = new ProcessControl.ClientApi.ProcessStage.XrmProcessSteps();
...
ProcessControl.ClientApi.ProcessStep = function(stepName, stepType, isRequired, attribute, stepStepId, controlId) {
    ProcessControl.ClientApi.ProcessStep.initializeBase(this);
    this.$2H_1 = stepName;
    this.$2M_1 = Xrm.StepType.toString(stepType);
    this.$4p_1 = isRequired;
    this.$4V_1 = attribute;
    this.$4w_1 = stepStepId;
    this.$1j_1 = controlId;
}
ProcessControl.ClientApi.ProcessStep.prototype = {
    ...
    getProgress: function() {
        if (this.$2M_1 !== Xrm.StepType.toString(1) || isNullOrEmptyString(this.$1j_1)) {
            return 4;
        }
        var $v_0 = $P_CRM('#processStep_' + this.$1j_1);
        if (Mscrm.InternalUtilities.JSTypes.isNull($v_0)) {
            return 4;
        }
        if ($v_0.hasClass('successAction')) {
            return 2;
        }
        else if ($v_0.hasClass('failAction')) {
            return 3;
        }
        else if ($v_0.hasClass('pendingAction')) {
            return 1;
        }
        else if ($v_0.hasClass('emptyValue')) {
            return 0;
        }
        else if ($v_0.hasClass('disabled')) {
            return 5;
        }
        return 4;
    },
    
    setProgress: function(status, message) {
        if (this.$2M_1 !== Xrm.StepType.toString(1) && this.$2M_1 !== Xrm.StepType.toString(2)) {
            return Xrm.ProcessResponse.toString(1);
        }
        if (isNullOrEmptyString(this.$1j_1) || (!isNullOrEmptyString(message) && !(String.isInstanceOfType(message)))) {
            return Xrm.ProcessResponse.toString(1);
        }
        var $v_0 = Xrm.ProcessResponse.toString(1);
        switch (status) {
            case 0:
                $v_0 = this.$39_1('emptyValue', false, Microsoft.Crm.Client.Core.Framework.Common.ResourceManager.getLocalizedString('ProcessControl.ActionExecuter.Execute'), '');
                break;
            case 5:
                $v_0 = this.$39_1('disabled', true, Microsoft.Crm.Client.Core.Framework.Common.ResourceManager.getLocalizedString('ProcessControl.ActionExecuter.Execute'), '');
                break;
            case 1:
                $v_0 = this.$39_1('pendingAction', true, Microsoft.Crm.Client.Core.Framework.Common.ResourceManager.getLocalizedString('ProcessingActionStepData'), '');
                break;
            case 3:
                $v_0 = this.$39_1('failAction', false, Microsoft.Crm.Client.Core.Framework.Common.ResourceManager.getLocalizedString('ProcessControl.ActionExecuter.Execute'), message);
                break;
            case 2:
                $v_0 = this.$39_1('successAction', false, Microsoft.Crm.Client.Core.Framework.Common.ResourceManager.getLocalizedString('ProcessControl.ActionExecuter.Execute'), message);
                break;
        }
        return $v_0;
    },
    
    $39_1: function($p0, $p1, $p2, $p3) {
        var $v_0 = $P_CRM('#processStep_' + this.$1j_1);
        var $v_1 = Xrm.Page.ui.controls.get('header_process_' + this.$1j_1);
        if (IsNull($v_0) || IsNull($v_1)) {
            return Xrm.ProcessResponse.toString(1);
        }
        $v_0.removeClass('emptyValue');
        $v_0.removeClass('failAction');
        $v_0.removeClass('successAction');
        $v_0.removeClass('pendingAction');
        $v_0.addClass($p0);
        $v_1.setDisabled($p1);
        $v_1.setInnerText($p2);
        if (!isNullOrEmptyString($p3)) {
            ...
            $v_0.removeAttr('title');
        }
        return Xrm.ProcessResponse.toString(0);
    },
...
ProcessControl.ClientApi.LightWeightAttributeManager.get_instance = function() {
    if (IsNull(ProcessControl.ClientApi.LightWeightAttributeManager.$3C)) {
        ProcessControl.ClientApi.LightWeightAttributeManager.$3C = new ProcessControl.ClientApi.LightWeightAttributeManager();
    }
    return ProcessControl.ClientApi.LightWeightAttributeManager.$3C;
}
ProcessControl.ClientApi.LightWeightAttributeManager.prototype = {
    ...
    get_attributeFactory: function() {
        if (IsNull(this.$2O_0)) {
            this.$2O_0 = new ProcessControl.ClientApi.LightWeightAttributeFactory(this.$Y_0);
        }
        return this.$2O_0;
    },
    ...
    getWrapper: function(attributeName) {
        if (!((attributeName) in this.$2U_0)) {
            if (IsNull(this.$11_0)) {
                return null;
            }
            var $v_0 = this.$11_0[attributeName];
            if (IsNull($v_0)) {
                var $v_2 = Array.indexOf(this.$11_0._unProcessedAttributes, attributeName);
                if ($v_2 === -1) {
                    return null;
                }
                $v_0 = {};
            ...
            this.$2U_0[attributeName] = $v_1;
        }
        return this.$2U_0[attributeName];
    }
}


ProcessControl.ClientApi.LightWeightAttributeFactory = function(entityMetadata) {
    this.$Y_0 = entityMetadata;
}
ProcessControl.ClientApi.LightWeightAttributeFactory.prototype = {
    ...
    getWrapper: function(attributeName, attributeObject) {
        ...
        switch ($v_0.AttributeType) {
            case 'bit':
                $v_1 = new ProcessControl.ClientApi.BooleanLightWeightAttributeWrapper(attributeObject, this.$Y_0);
                break;
            case 'picklist':
            case 'state':
            case 'status':
                $v_1 = new ProcessControl.ClientApi.OptionSetLightWeightAttributeWrapper(attributeObject, this.$Y_0);
                break;
            case 'owner':
            case 'customer':
            case 'lookup':
                $v_1 = new ProcessControl.ClientApi.LookupLightWeightAttributeWrapper(attributeObject, this.$Y_0);
                break;
            case 'partylist':
                $v_1 = new ProcessControl.ClientApi.PartyListLightWeightAttributeWrapper(attributeObject, this.$Y_0);
                break;
            case 'money':
                $v_1 = new ProcessControl.ClientApi.CurrencyLightWeightAttributeWrapper(attributeObject, this.$Y_0);
                break;
            case 'int':
            case 'float':
            case 'decimal':
                $v_1 = new ProcessControl.ClientApi.NumberLightWeightAttributeWrapper(attributeObject, this.$Y_0);
                break;
            case 'datetime':
                $v_1 = new ProcessControl.ClientApi.DateTimeLightWeightAttributeWrapper(attributeObject, this.$Y_0);
                break;
            default:
                $v_1 = new ProcessControl.ClientApi.DefaultLightWeightAttributeWrapper(attributeObject, this.$Y_0);
                break;
        }
        return $v_1;
    }
...
ProcessControl.Constants.CriticalAttributes.isCriticalAttribute = function(attributeName) {
    return (attributeName === ProcessControl.Constants.CriticalAttributes.$5p || attributeName === ProcessControl.Constants.CriticalAttributes.$5q);
}
...
ProcessControl.Reflow.NonTraversedDefaultPathCalculator.prototype = {
    ...
    get_pathChangeHandler: function() {
        if (!this.$17_0) {
            this.$17_0 = new ProcessControl.Reflow.DefaultPathChangeHandler(this.$5_0, this.$4_0, true);
        }
        return this.$17_0;
    },
...
ProcessControl.Reflow.BusinessRuleStageCommand.prototype = {
    ...
    tryExecute: function() {
        var $v_0 = Microsoft.Crm.Workflow.Utils.StringUtility.reduceToCanonicalForm(this.$2J_0.get_stageId());
...
ProcessControl.Reflow.TraversedDefaultPathCalculator.prototype = {
    ...
    get_lastDefaultNode: function() {
        return this.$1y_0.get_lastEvaluatedNodeInDefaultPath();
    },
    
    get_staticPathToDefaultPath: function() {
        if (!this.$1y_0) {
            this.$1y_0 = new ProcessControl.Reflow.StaticPathToDefaultPathCalculator(this.$5_0, this.$4_0, this.get_traversedPath());
        }
        return this.$1y_0;
    },
...
ProcessControl.Reflow.AfterLoadDefaultPathCalculator.prototype = {
    ...
    get_nonTraversedDefaultPathCalculator: function() {
        if (!this.$30_0) {
            this.$30_0 = new ProcessControl.Reflow.NonTraversedDefaultPathCalculator(this.$5_0, this.$b_0, this.$4_0);
        }
        return this.$30_0;
    },
...
ProcessControl.Reflow.LoadTimeDefaultPathCalculator.prototype = {
    ...
    get_lastCalculatedDefaultNode: function() {
        ...
        return this.$1z_0.get_lastDefaultNode();
    },
    
    $56_0: function() {
        this.get_traversedDefaultPathCalculator().set_traversedPath(this.$W_0.split(','));
        this.get_traversedDefaultPathCalculator().calculate();
    },
    
    get_traversedDefaultPathCalculator: function() {
        if (!this.$1z_0) {
            this.$1z_0 = new ProcessControl.Reflow.TraversedDefaultPathCalculator(this.$5_0, this.$4_0);
        }
        return this.$1z_0;
    },
...
ProcessControl.Reflow.RuntimeDefaultPathCalculator.prototype = {
    ...
    get_pathChangeHandler: function() {
        if (!this.$17_0) {
            this.$17_0 = new ProcessControl.Reflow.DefaultPathChangeHandler(this.$5_0, this.$4_0, false);
        }
        return this.$17_0;
    },
...
ProcessControl.Reflow.StaticPathToDefaultPathCalculator.prototype = {
    ...
    calculate: function() {
        ...
        for (var $v_1 = 0; $v_1 < this.$48_0.length; $v_1++) {
            var $v_2 = this.$48_0[$v_1];
    ...
    get_startingNodeIndexInDefaultPath: function() {
        if (this.$2K_0 === -1) {
            this.$2K_0 = this.$4_0.indexOf(this.get_startingNodeInDefaultPath().get_value(), true);
        }
        return this.$2K_0;
    },
...
ProcessControl.Reflow.BusinessRulePrimaryEntityStageCommand.prototype = {
    ...
    executeCondition: function() {
        var $v_0 = String.format('bpf_{0}', this.$8i_1(this.$2J_0.get_stageId()));
...
ProcessControl.Reflow.WebBusinessRuleCaller.prototype = {
    ...
    get_businessRuleReadyPromise: function() {
        if (!this.$2i_0) {
            this.$2i_0 = jQueryApi.jQueryDeferredFactory.Deferred(Object, Object);
            this.$2i_0.resolve(null);
        }
        return this.$2i_0.promise();
    },
...
ProcessControl.Reflow.TraversedPathProvider.prototype = {
    ...
    get_traversedPath: function() {
        ...
        return this.$j_0.$T_0.get_traversedPath().get_path();
    },
    
    get_traversedPathPromise: function() {
        if (!Microsoft.Crm.Workflow.Utils.StringUtility.isNull(this.$1g_0)) {
            return this.$1g_0.promise();
        }
        this.$1g_0 = jQueryApi.jQueryDeferredFactory.Deferred(String, Object);
        var $$t_2 = this, $$t_3 = this;
        this.$j_0.fetchGlobalTraversedStageInfo().done(function($p1_0) {
            $$t_2.$1g_0.resolve($p1_0.get_traversedPath().get_path());
        }).fail(function($p1_0) {
            $$t_3.$1g_0.reject(null);
        });
        return this.$1g_0.promise();
    },
...
ProcessControl.Reflow.DefaultPathChangeContext.prototype = {
    ...
    getStageStep: function(stageId) {
        ...
        var $v_0 = this.$4t_0[Microsoft.Crm.Workflow.Utils.StringUtility.reduceToCanonicalForm(stageId)];
    ...
    get_businessProcessFlowVisitor: function() {
        if (!this.$2A_0) {
            this.$2A_0 = new ProcessObjectModel.Visitors.BusinessProcessFlowVisitor();
        }
        return this.$2A_0;
    },
    ...
    set_businessProcessFlowVisitor: function(value) {
        this.$2A_0 = value;
        this.$4t_0 = this.$2A_0.get_stagesById();
        return value;
    },
...
ProcessControl.Reflow.DefaultPathChangeHandler.prototype = {
    ...
    triggerSubsequentDefaultPathCalculation: function(stageNode) {
        ...
        if (!this.$97_0(stageNode)) {
            var $v_1 = this.$5_0.getStageStep($v_0);
            if (Mscrm.InternalUtilities._Script.isNullOrUndefined($v_1)) {
                return;
            }
            var $v_2 = $v_1.get_nextStageId();
            if (Mscrm.InternalUtilities._Script.isNullOrUndefined($v_2)) {
                return;
            }
            var $v_3 = this.$4_0.find($v_2, true);
            if (!Mscrm.InternalUtilities._Script.isNullOrUndefined($v_3)) {
                if (this.$4Y_0) {
                    this.triggerSubsequentDefaultPathCalculation($v_3);
                }
                return;
            }
            this.$4_0.addAfter(stageNode, new ProcessControl.Reflow.StageLinkedNode($v_2));
    ...
    get_businessRuleCommandFactory: function() {
        if (!this.$2s_0) {
            this.$2s_0 = new ProcessControl.Reflow.BusinessRuleStageCommandFactory();
        }
        return this.$2s_0;
    },
    ...
    $97_0: function($p0) {
        ...
        try {
            ...
            if (Mscrm.InternalUtilities._Script.isNullOrUndefined($p0)) {
                return false;
            }
...
ProcessControl.Reflow.DefaultPathChangeListener.prototype = {
    ...
    pathChanged: function(args) {
        if (this.$2w_0 && !Microsoft.Crm.Workflow.Utils.StringUtility.isNullOrEmpty(args.$2I_1)) {
            this.$2w_0.handleChange(args.$2I_1, args.$2z_1);
        }
    },
...
ProcessControl.Reflow.DefaultPathManager = function(traversedPathProvider, context) {
    this.$2C_0 = new Sys.EventHandlerList();
    this.$5_0 = context;
...
ProcessControl.Reflow.DefaultPathManager.prototype = {
    ...
    add_defaultPathChanged: function(value) {
        this.$2C_0.addHandler('DefauiltPathChanged', value);
    },
    
    remove_defaultPathChanged: function(value) {
        this.$2C_0.removeHandler('DefauiltPathChanged', value);
    },
    
    add_defaultPathInitialized: function(value) {
        this.$2C_0.addHandler('DefauiltPathInitialized', value);
    },
    
    remove_defaultPathInitialized: function(value) {
        this.$2C_0.removeHandler('DefauiltPathInitialized', value);
    },
    ...
    initializeComplete: function() {
        if (!this.$1K_0.get_isResolved() || !this.$5_0.get_businessRuleCaller().get_isResolved()) {
            ...
            Microsoft.Crm.Client.Core.Imported.DeferredPromiseHelper.when(this.$1K_0.get_traversedPathPromise(), this.$5_0.get_businessRuleCaller().get_businessRuleReadyPromise()).then(function($p1_0) {
    ...
    get_loadTimePathCalculator: function() {
        if (!this.$2y_0) {
            this.$2y_0 = new ProcessControl.Reflow.LoadTimeDefaultPathCalculator(this.$5_0, this.$4_0);
        }
        return this.$2y_0;
    },
    ...
    get_afterLoadPathCalculator: function() {
        if (!this.$2o_0) {
            this.$2o_0 = new ProcessControl.Reflow.AfterLoadDefaultPathCalculator(this.$5_0, this.get_listener(), this.$4_0);
        }
        return this.$2o_0;
    },
    ...
    get_runtimePathCalculator: function() {
        if (!this.$32_0) {
            this.$32_0 = new ProcessControl.Reflow.RuntimeDefaultPathCalculator(this.$5_0, this.get_listener(), this.$4_0);
        }
        return this.$32_0;
    },
    ...
    $P_0: function($p0) {
        var $v_0 = this.$2C_0.getHandler($p0);
        if ($v_0) {
            $v_0(this, null);
        }
    },
...
ProcessControl.Reflow.LinkedNode$1 = function(value) {
    this.$4A_0 = ((this.$$gta['ProcessControl.Reflow.LinkedNode$1']['T'] === Number || Type.isEnum(this.$$gta['ProcessControl.Reflow.LinkedNode$1']['T'])) ? 0 : (this.$$gta['ProcessControl.Reflow.LinkedNode$1']['T'] === Boolean) ? false : null);
    this.$4A_0 = value;
    this.$3x_0 = null;
}
...
ProcessControl.Reflow.StageLinkedListArray.prototype = {
    ...
    find: function(value, searchOnlyRootNodes) {
        ...
        if (searchOnlyRootNodes) {
            var $v_0 = Array.indexOf(this.$31_0, value);
            if ($v_0 !== -1) {
                return this.$p_0[$v_0];
            }
            return null;
    ...
    indexOf: function(value, searchOnlyRootNodes) {
        if (searchOnlyRootNodes) {
            return Array.indexOf(this.$31_0, value);
        }
    ...
    set_item: function(index, value) {
        this.$2x_0 = false;
        this.$p_0[index] = value;
        this.$31_0[index] = value.get_value();
        return value;
    },
    
    addAfter: function(node, nextNode) {
        if (this.find(nextNode.get_value(), true)) {
            this.$55_0(node, new ProcessControl.Reflow.StageLinkedNode(null));
            return;
        }
        this.$55_0(node, nextNode);
    },
    ...
    get_defaultPathHash: function() {
        this.$5S_0();
        return this.$3v_0.getTime().toString();
    },
    ...
    $8I_0: function() {
        this.$1k_0 = new Array(0);
        for (var $v_0 = 0; $v_0 < this.$p_0.length; $v_0++) {
            var $v_1 = this.$p_0[$v_0];
            Array.add(this.$1k_0, $v_1.get_value());
            while ($v_1.get_next()) {
                var $v_2 = $v_1.get_next();
                if ($v_2.get_value()) {
                    Array.add(this.$1k_0, $v_2.get_value());
                }
                $v_1 = $v_2;
            }
        }
...
ProcessControl.Services.ActionQueue.prototype = {
    ...
    push: function(action, condition) {
        ...
        this.$2j_0.push($v_0);
        window.setTimeout(this.$$d_$8r_0, 100);
    },
...
ProcessControl.Services.ClosedLoopService.prototype = {
    ...
    canCloseEntity: function(stageId) {
        ...
        if (!Array.contains(this.get_$6f_0(), $v_1.get_EntityLogicalName())) {
            return false;
        }
...
ProcessControl.Services.BusinessRuleService.prototype = {
    ...
    get_onChangeHandlers: function() {
        if (!this.$2f_0) {
            this.$2f_0 = Mscrm.BusinessRulesScript && Mscrm.BusinessRulesScript.AttributesOnChangeHandlers;
        }
        return this.$2f_0;
    },
    ...
    get_attributes: function() {
        if (!this.$2Q_0) {
            this.$2Q_0 = Xrm.Page.data.entity.attributes;
        }
        return this.$2Q_0;
    },
...
ProcessControl.Services.NavigationService.prototype = {
    ...
    get_navigationSource: function() {
        if (!this.$4K_0) {
            ...
            this.$d_0 = new Mscrm.ProcessControlShared.ObjectModels.NavigationSource();
            this.$d_0.$1l_0 = new Mscrm.ProcessControlShared.ObjectModels.NavigationEntity();
            this.$d_0.$1l_0.Id = $v_1;
            this.$d_0.$1l_0.EntityLogicalName = $v_2;
            this.$d_0.$1l_0.EntityTypeCode = Number.parseInvariant($v_3);
            this.$d_0.$1E_0 = $v_5;
            this.$d_0.$W_0 = $v_4;
            this.$d_0.$c_0 = $v_6;
            this.$d_0.$1t_0 = $v_7;
...
ProcessControl.Services.LocalTraversedPathAndActiveStageService.prototype = {
    ...
    findOtherEntitiesLocalActiveStage: function() {
        var $v_0 = this.$1_0.$1C_0[this.$1_0.$1C_0.length - 1];
        var $v_1 = $v_0.Id;
        ...
        $v_4.retrieveMultiple(String.format('<fetch version=\"1.0\" output-format=\"xml-platform\" mapping=\"logical\" distinct=\"false\">\r\n\t\t\t\t<entity name=\"{0}\">\r\n\t\t\t\t<attribute name=\"stageid\" />\r\n\t\t\t\t<attribute name=\"traversedpath\" />\r\n\t\t\t\t<filter type=\"and\">\r\n\t\t\t\t\t<condition attribute=\"{1}\" operator=\"eq\" value=\"{2}\" />\r\n\t\t\t\t</filter>\r\n\t\t\t\t</entity>\r\n\t\t\t</fetch>', $v_2, $v_3, $v_1)).then(function($p1_0) {
            ...
            if ($p1_0.entities.length && (('stageid') in $p1_0.entities[0].attributes)) {
                ...
                if (IsNull($v_7) && !IsNull($v_5)) {
                    $v_6 = new Mscrm.ProcessControlShared.ObjectModels.TraversedPath(Mscrm.ProcessControlShared.ObjectModels.TraversedPath.getCandidateTraversedPathFromStagStep($$t_D.$1_0.$13_0, $v_5.get_stageId()));
                }
                else {
                    $v_6 = new Mscrm.ProcessControlShared.ObjectModels.TraversedPath($v_7);
                }
                var $$t_B, $$t_C;
                $$t_D.$8g_0(($$t_B = {'val': $v_5}), ($$t_C = {'val': $v_6})), $v_5 = $$t_B.val, $v_6 = $$t_C.val;
            }
            if (IsNull($v_5)) {
                var $v_8 = {};
                $v_8[$$t_D.$1_0.$1G_0] = $$t_D.$1_0.$2t_0;
                $$t_D.$1_0.$l_0 = $v_8;
                $$t_D.$1_0.$1P_0 = 1;
    ...
    findLocalTraversedPathAndStageInfo: function(formData) {
        ...
        if (IsNull($v_4)) {
            $v_4 = this.$5O_0(formData._entity.TypeName).get_Steps().getArrayList()[0];
    ...
    $8B_0: function($p0) {
        ...
        if (!IsNull($v_1)) {
            var $v_2 = this.$1_0.getStageStepByStageId($v_1.$1E_0);
            var $v_3 = new Mscrm.ProcessControlShared.ObjectModels.TraversedPath($v_1.$W_0);
            ...
            var $v_4 = this.$5O_0($p0._entity.TypeName);
        ...
        this.$1_0.$25_0 = $v_0.get_stage();
        this.$1_0.$2g_0 = $v_0.get_traversedPath();
        this.$6R_0($p0);
        return $v_0;
    },
...
ProcessControl.Services.PlatformService.get_platform = function() {
    return ProcessControl.Services.PlatformService.$u;
}
ProcessControl.Services.PlatformService.set_platform = function(value) {
    ProcessControl.Services.PlatformService.$u = value;
    return value;
}
...
ProcessControl.Services.StageActionService = function(controlDataService) {
    ...
    this.$$d_$6V_0 = Function.createDelegate(this, this.$6V_0);
    this.$$d_$7s_0 = Function.createDelegate(this, this.$7s_0);
    this.$6_0 = new Sys.EventHandlerList();
    this.$1_0 = controlDataService;
    this.$20_0 = new ProcessControl.Services.ActionQueue();
    this.$1R_0 = ProcessControl.Services.SaveServiceFactory.getService(this.$1_0.get_currentEntity().get_EntityLogicalName());
    this.$1f_0 = [];
    this.$1d_0 = [];
    this.$1e_0 = [];
}
ProcessControl.Services.StageActionService.prototype = {
    ...
    dispose: function() {
        ...
        this._disposed = true;
        this.$1R_0.remove_stageSetEvent(this.$$d_$7s_0);
    ...
    advanceStage: function(condition) {
        this.$20_0.push(this.$$d_$6V_0, condition);
    },
    ...
    backStage: function(condition) {
        this.$20_0.push(this.$$d_$6Y_0, condition);
    },
    ...
    setActiveStage: function(canSet, stageValue, traversedPath, advance, save) {
        ...
        this.$1R_0.add_stageSetEvent(this.$$d_$7s_0);
        var $v_1 = stageValue.toLowerCase();
        if (save) {
            this.$1R_0.setStageAndSave($v_1, traversedPath.get_path(), $v_0);
        }
        else {
            this.$1R_0.setStageWithoutSaving($v_1, traversedPath.get_path(), $v_0);
        }
        return true;
    },
    ...
    registerMoveNextCallback: function(callback) {
        if (!IsNull(callback)) {
            Array.add(this.$1d_0, callback);
        }
    },
    
    registerMovePreviousCallback: function(callback) {
        if (!IsNull(callback)) {
            Array.add(this.$1e_0, callback);
        }
    },
    ...
    $7s_0: function($p0, $p1) {
        ...
        if ($p1.get_isError()) {
            this.$6B_0($v_1, $p1.error);
        }
        else {
            this.$96_0($v_1, $v_0.stageId, $v_0.traversedPath);
        }
        if ($v_0.advance) {
    ...
    $96_0: function($p0, $p1, $p2) {
        ...
        if (!IsNull(this.$1_0.get_globalTraversedPathAndActiveStage()) && !IsNull(this.$1_0.get_globalTraversedPathAndActiveStage().get_traversedPath())) {
            this.$8h_0($p2, this.$1_0.get_globalTraversedPathAndActiveStage().get_traversedPath());
        }
    ...
    $8h_0: function($p0, $p1) {
        if (!IsNull($p0) && !IsNull($p0.get_path()) && !IsNull($p1) && !IsNull($p1.get_path())) {
            ...
            var $v_1 = this.$5Z_0($v_0);
            var $v_2 = this.$5Z_0($p0);
            var $$t_7 = this;
...
ProcessControl.Services.ControlDataService = function(controlData) {
    ...
    this.$c_0 = controlData._processId;
    if (!Mscrm.InternalUtilities._Script.isNullOrUndefined(controlData._globalNavigationData)) {
        this.$1F_0 = controlData._globalNavigationData.businessProcessInstanceId;
        this.$2B_0 = controlData._globalNavigationData.businessProcessInstanceName;
    }
...
ProcessControl.Services.ControlDataService.prototype = {
    ...
    set_businessProcessInstanceName: function(value) {
        this.$2B_0 = value;
        return value;
    },
    ...
    get_actionStepStateData: function() {
        return this.$2N_0;
    },
    
    set_actionStepStateData: function(value) {
        this.$2N_0 = value;
        return value;
    },
    ...
    set_globalTraversedPathAndActiveStage: function(value) {
        this.$T_0 = value;
        this.$C_0 = this.$T_0.get_stage();
        this.$3I_0 = this.$9_0.get_EntityLogicalName() === this.findStageEntity(this.$T_0.get_stage()).get_EntityLogicalName();
        this.$s_0.resolve(this.$T_0);
        this.adjustLocalActiveStage(this.$T_0.get_stage(), this.$T_0.get_traversedPath());
        return value;
    },
    ...
    get_closedLoopService: function() {
        if (!this.$2W_0) {
            this.$2W_0 = new ProcessControl.Services.ClosedLoopService(this);
        }
        return this.$2W_0;
    },
    ...
    get_localTraversedPathAndActiveStageService: function() {
        if (!this.$2d_0) {
            this.$2d_0 = new ProcessControl.Services.LocalTraversedPathAndActiveStageService(this);
        }
        return this.$2d_0;
    },
    ...
    get_navigationService: function() {
        if (!this.$2e_0) {
            this.$2e_0 = new ProcessControl.Services.NavigationService();
        }
        return this.$2e_0;
    },
    ...
    initializeFormData: function(formData, isNewUseCase, isReadOnlyUseCase) {
        ...
        this.$E_0 = isNewUseCase;
        this.$V_0 = isReadOnlyUseCase;
        this.$4W_0 = $v_0._globalNavigationData.activeStageId;
        this.$1F_0 = $v_0._globalNavigationData.businessProcessInstanceId;
        this.$2B_0 = $v_0._globalNavigationData.businessProcessInstanceName;
        this.$2q_0 = (Microsoft.Crm.Workflow.Utils.StringUtility.isNullOrEmpty($v_0._globalNavigationData.businessProcessState)) ? 0 : (Number.parseInvariant($v_0._globalNavigationData.businessProcessState));
        this.$2r_0 = (Microsoft.Crm.Workflow.Utils.StringUtility.isNullOrEmpty($v_0._globalNavigationData.businessProcessStatus)) ? 1 : (Number.parseInvariant($v_0._globalNavigationData.businessProcessStatus));
        this.$2S_0 = new Mscrm.ProcessControlShared.ObjectModels.TraversedPath($v_0._globalNavigationData.traversedPath);
        this.$1C_0 = $v_0._globalNavigationData.navigationEntities;
        this.$6q_0(this.$1C_0);
        this.$8e_0(formData);
        this.$2t_0 = formData._entity.Id;
        this.$1G_0 = formData._entity.TypeName;
    ...
    $7R_0: function($p0) {
        if (!isNullOrEmptyString($p0._globalNavigationData.activeStageStartedOn)) {
            this.$28_0 = this.$4a_0($p0._globalNavigationData.activeStageStartedOn);
        }
        if (!isNullOrEmptyString($p0._globalNavigationData.createdOn)) {
            this.$1h_0 = this.$4a_0($p0._globalNavigationData.createdOn);
        }
        if (!isNullOrEmptyString($p0._globalNavigationData.completedOn)) {
            this.$29_0 = this.$4a_0($p0._globalNavigationData.completedOn);
        }
    },
    ...
    $7P_0: function() {
        this.$z_0 = new ProcessObjectModel.Visitors.BusinessProcessFlowVisitor();
        this.$z_0.visit(this.$O_0);
        this.$2m_0 = this.$z_0.get_stagesById();
    },
    ...
    $7o_0: function($p0) {
        return IsNull($p0) || IsNull($p0['value']) || $p0['value'] !== this.$c_0;
    },
    ...
    fetchGlobalTraversedStageInfo: function() {
        ...
        this.$s_0 = jQueryApi.jQueryDeferredFactory.Deferred(Mscrm.ProcessControlShared.ObjectModels.IPathAndStageInfo, Mscrm.ProcessControlShared.ObjectModels.PathAndStageInfo);
        if (this.$6b_0()) {
            return this.$s_0;
        }
        if (this.$1C_0.length > 0 && this.$1C_0[this.$1C_0.length - 1].EntityLogicalName !== this.$1G_0) {
        ...
        if (!((this.$1G_0) in this.$l_0)) {
            this.$l_0[this.$1G_0] = this.$2t_0;
            this.$1P_0++;
        }
        this.set_globalTraversedPathAndActiveStage(this.$Z_0);
        return this.$s_0;
    ...
    adjustLocalActiveStage: function(globalActiveStage, globalTraversedPath) {
        if (this.$V_0 || this.$E_0) {
            return;
        }
        if (IsNull(globalActiveStage)) {
            return;
        }
        if (!globalTraversedPath.isInTraversedPath(this.$J_0.get_stageId()) || (this.getEntityStepByStageId(this.$J_0.get_stageId())).get_EntityLogicalName() !== this.$9_0.get_EntityLogicalName()) {
            var $v_1 = this.$72_0(this.$9_0.get_EntityLogicalName(), globalTraversedPath.get_path());
            if (!IsNull($v_1)) {
                this.$J_0 = this.$1N_0 = $v_1;
            }
            return;
        }
        var $v_0 = this.isCompleted(this.$J_0);
        if (!$v_0) {
            return;
        }
        if (IsNull(this.$J_0)) {
            this.$J_0 = this.$1N_0 = this.$9_0.get_Steps().get_item(this.$9_0.get_Steps().get_Count() - 1);
        }
    },
    ...
    $6b_0: function() {
        var $v_0 = this.getStageByValue(this.$4W_0);
        if (!IsNull($v_0)) {
            if (isNullOrEmptyString(this.$2S_0.get_path())) {
                this.$2S_0 = new Mscrm.ProcessControlShared.ObjectModels.TraversedPath(Mscrm.ProcessControlShared.ObjectModels.TraversedPath.getCandidateTraversedPathFromStagStep(this.$13_0, $v_0.get_stageId()));
            }
            var $v_1 = new Mscrm.ProcessControlShared.ObjectModels.PathAndStageInfo(this.$2S_0, $v_0);
            this.set_globalTraversedPathAndActiveStage($v_1);
            return true;
        }
        return false;
    ...
    isActive: function(stage) {
        ...
        var $v_1 = this.$1p_0();
        return $v_1 && $v_0 === this.$T_0.get_stage();
    },
    ...
    getStageByIndex: function(stageIndex) {
        if (stageIndex < 0 && stageIndex >= this.$1U_0.length) {
            return null;
        }
        var $v_0 = this.getStageStepByStageId(this.$1U_0[stageIndex].currentStageValue);
        if (!IsNull($v_0)) {
            return $v_0;
        }
        return null;
    ...
    getStageStepByStageId: function(stageId) {
        ...
        var $v_0 = this.$2m_0[Microsoft.Crm.Workflow.Utils.StringUtility.reduceToCanonicalForm(stageId)];
        if (IsNull($v_0)) {
            return null;
        }
        return $v_0;
    ...
    stageIndex: function(stage) {
        ...
        var $v_0 = Array.indexOf(this.$13_0, stage);
        if ($v_0 !== -1) {
            return $v_0;
        }
    ...
    canAdvance: function(stage) {
        ...
        var $v_2 = this.$I_0.getNextStage(stage.get_stageId());
    ...
    canSetActive: function(stage) {
        if (!IsNull(this.$C_0)) {
            ...
            if ($v_0.get_EntityLogicalName() === $v_1.get_EntityLogicalName()) {
                return stage === this.$J_0 || this.isCompleted(stage);
            }
        }
    ...
    canGoBack: function(stage) {
        ...
        var $v_0 = this.findStageEntity(stage);
        var $v_1 = $v_0.get_EntityLogicalName() === this.$9_0.get_EntityLogicalName();
        var $v_2 = this.$I_0.getPreviousStage(stage.get_stageId());
        if (isNullOrEmptyString($v_2)) {
            return false;
        }
        return $v_1;
    ...
    canNavigate: function(stage) {
        ...
        var $v_0 = this.findStageEntity(stage);
        var $v_1 = this.$I_0.getNextStage(stage.get_stageId());
    ...
    $7d_0: function() {
        ...
        if (this.$1P_0 <= 1 && !IsNull($v_0) && !IsNull(this.$9_0) && this.$9_0.get_EntityLogicalName() !== $v_0.get_EntityLogicalName()) {
            return true;
        }
        return false;
    },
    ...
    canMoveNextViaClientAPI: function(returnMessage) {
        if (!this.$1p_0() || this.$E_0 || IsNull(this.$C_0)) {
        ...
        var $v_0 = this.$I_0.getNextStage(this.$C_0.get_stageId());
    ...
    canMovePreviousViaClientAPI: function(returnMessage) {
        ...
        var $v_0 = this.$I_0.getPreviousStage(this.$C_0.get_stageId());
        if (isNullOrEmptyString($v_0)) {
    ...
    $1p_0: function() {
        return this.$s_0.state() === 'resolved';
    },
    ...
    findStageEntity: function(stage) {
        ...
        var $v_0 = this.$z_0.get_parentEntityStepByStageId()[Microsoft.Crm.Workflow.Utils.StringUtility.reduceToCanonicalForm(stage.get_stageId())];
        if (!IsNull($v_0)) {
            return $v_0;
        }
...
ProcessControl.Services.ProcessControlInitializer = function(isTurboForm) {
    this.$$d_$7e_0 = Function.createDelegate(this, this.$7e_0);
    this.$$d_$8A_0 = Function.createDelegate(this, this.$8A_0);
    this.$20_0 = new ProcessControl.Services.ActionQueue();
...
ProcessControl.Services.ProcessControlInitializer.prototype = {
    ...
    processLayout: function(processControlData, entityMetadata) {
        ...
        $v_0.start();
        ProcessControl.Services.PlatformService.$u = 1;
        ...
        this.$U_0 = new ProcessControl.Views.ProcessControlView(this.$0_0);
        this.$U_0.processLayout();
        $v_0.stop();
        return this.$U_0;
    },
    ...
    render: function() {
        if (!IsNull(this.$0_0)) {
            ...
            this.$U_0.render();
            this.$2c_0 = true;
            window.IsBusinessProcessPresent = this.$2c_0;
            refreshRibbon();
        }
    },
    
    postInitialize: function(entityMetadata) {
        this.$52_0 = entityMetadata;
        this.$20_0.push(this.$$d_$8A_0, this.$$d_$7e_0);
    },
    ...
    completeInitialization: function() {
        ...
        this.$U_0.completeInitialization();
    },
    
    dispose: function() {
        Mscrm.Utilities.safeDispose(this.$U_0);
        this.$U_0 = null;
...
ProcessControl.Services.RefreshFormActionService = function(dataService) {
    ...
    ProcessControl.Services.DebugService.assert(ProcessControl.Services.PlatformService.$u === 1, 'This service is only supported in RefreshForm platform');
}
...
ProcessControl.Services.RefreshFormSaveService.$7a = function($p0, $p1) {
    var $v_0 = Microsoft.Crm.Workflow.Utils.StringUtility.reduceToCanonicalForm($p0.getValue());
    return ProcessControl.Services.RefreshFormSaveService.$3u($v_0, $p1);
}
ProcessControl.Services.RefreshFormSaveService.$3u = function($p0, $p1) {
    $p0 = Microsoft.Crm.Workflow.Utils.StringUtility.reduceToCanonicalForm($p0);
...
ProcessControl.Services.RefreshFormSaveService.prototype = {
    ...
    get_$1J_1: function() {
        return Xrm.Internal.getStageId();
    },
    
    set_$1J_1: function($p0) {
        Xrm.Internal.setStageId($p0);
        return $p0;
    },
    
    get_$37_1: function() {
        return Xrm.Internal.getTraversedPath();
    },
    
    set_$37_1: function($p0) {
        Xrm.Internal.setTraversedPath($p0);
        return $p0;
    },
    ...
    setStageWithoutSaving: function(stageValue, traversedPath, argument) {
        ...
        this.set_$1J_1(stageValue);
        this.set_$37_1(traversedPath);
        var $v_0 = Xrm.Page.getAttribute(ProcessControl.Services.AttributeNames.stageId);
        if (!IsNull($v_0)) {
            $v_0.resetInitialValue(stageValue);
        }
        var $v_1 = Xrm.Page.getAttribute(ProcessControl.Services.AttributeNames.traversedPath);
        if (!IsNull($v_1)) {
            $v_1.resetInitialValue(traversedPath);
        }
        this.setStageCompleted(0, argument);
    },
    ...
    setStageAndSave: function(stageValue, traversedPath, argument) {
        Mscrm.CrmDebug.assert(!isNullOrEmptyString(stageValue), 'Stage ID was not specified');
        if (ProcessControl.Services.RefreshFormSaveService.$3u(this.get_$1J_1(), stageValue)) {
            this.setStageCompleted(0, argument);
            return;
        }
        this.set_$1J_1(stageValue);
    ...
    saveDirtyForm: function() {
        ...
        var $v_1 = !IsNull(Xrm.Page.data) && !IsNull(Xrm.Page.data.entity) && Xrm.Page.data.entity.getIsDirty();
        if ($v_1) {
            var $v_2 = new Xrm.SaveOptions();
            $v_2.isProcessControlNavigation = true;
            var $$t_5 = this, $$t_6 = this;
            Xrm.Page.data.save($v_2).then(function($p1_0) {
                $v_0.resolve($p1_0);
            }, function($p1_0) {
                $v_0.reject($p1_0);
            });
    ...
    $63_1: function($p0) {
        ...
        try {
            ...
            $v_1.isProcessControlNavigation = true;
            var $$t_5 = this, $$t_6 = this;
            Xrm.Page.data.save($v_1).then(function($p1_0) {
                $$t_5.setStageCompleted(0, $p0);
            }, function($p1_0) {
                if (!IsNull($p0) && (IsNull($p1_0) || ($p1_0.errorCode) !== -1)) {
                    if (!isNullOrEmptyString(($p0).oldStageId)) {
                        $$t_6.set_$1J_1(($p0).oldStageId);
                    }
                    if (!isNullOrEmptyString(($p0).oldTraversedPath.get_path())) {
                        $$t_6.set_$37_1(($p0).oldTraversedPath.get_path());
                    }
                }
                $$t_6.setStageCompleted(4, $p0);
            });
        }
        finally {
    ...
    setProcessWithoutSaving: function(processId) {
        ...
        this.get_$3y_1().setValue(processId);
        this.get_$3y_1().resetInitialValue(processId);
    },
    
    setProcessAndSave: function(processId, stageId, traversedPath) {
        Mscrm.CrmDebug.assert(!isNullOrEmptyString(processId), 'Process ID was not specified');
        Mscrm.CrmDebug.assert(!isNullOrEmptyString(stageId), 'Stage ID was not specified');
        var $v_0 = ProcessControl.Services.RefreshFormSaveService.$3u(this.get_$1J_1(), stageId);
        var $v_1 = ProcessControl.Services.RefreshFormSaveService.$7a(this.get_$3y_1(), processId);
        var $v_2 = ProcessControl.Services.RefreshFormSaveService.$3u(this.get_$37_1(), traversedPath);
        if (!$v_0) {
            this.set_$1J_1(stageId);
        }
        if (!$v_1) {
            this.get_$3y_1().setValue(processId);
        }
...
ProcessControl.Services.SaveServiceFactory.getService = function(entityLogicalName) {
    if (ProcessControl.Services.PlatformService.$u === 1) {
        return new ProcessControl.Services.RefreshFormSaveService(entityLogicalName);
    }
    if (!ProcessControl.Services.PlatformService.$u) {
        return new ProcessControl.Services.EmptySaveService(entityLogicalName);
    }
    ProcessControl.Services.DebugService.assert(false, 'Unknown platform: ' + ProcessControl.Services.PlatformService.$u);
    return null;
}
...
ProcessControl.ViewModels.ProcessControlViewModel = function(processControlData, entityMetadata, processObjectBuilder) {
    this.$$d_$81_0 = Function.createDelegate(this, this.$81_0);
    this.$$d_$84_0 = Function.createDelegate(this, this.$84_0);
    ...
    this.$$d_$83_0 = Function.createDelegate(this, this.$83_0);
    this.$$d_isActionable = Function.createDelegate(this, this.isActionable);
    this.$$d_$7t_0 = Function.createDelegate(this, this.$7t_0);
    this.$46_0 = -1;
    this.$6_0 = new Sys.EventHandlerList();
    this.$6K_0 = new (Microsoft.Crm.Client.Core.Framework.List$1.$$(Function))();
    this.$1i_0 = processControlData;
    ProcessControl.Services.DebugService.assert(!IsNull(this.$1i_0), 'the initial data cannot be null');
    this.$1c_0 = entityMetadata;
    this.$8_0 = this.$1i_0._processControlStrings;
    this.$Q_0 = processObjectBuilder;
    var $v_0 = ProcessControl.StopwatchFactory.createStopwatch('ProcessControl.ViewModel.initDataService.Building');
    $v_0.start();
    this.$1_0 = new ProcessControl.Services.ControlDataService(this.$1i_0);
    $v_0.stop();
}
ProcessControl.ViewModels.ProcessControlViewModel.prototype = {
    ...
    get_$n_0: function() {
        if (!this.$3G_0) {
            this.$3G_0 = new Mscrm.ClientApiEventHandlerList(this.$6_0);
        }
        return this.$3G_0;
    },
    ...
    get_controlIdActionIdDictionary: function() {
        return this.$1b_0;
    },
    
    get_stages: function() {
        return this.$1_0.$1U_0;
    },
    ...
    get_warning: function() {
        return this.$1i_0._warningCode;
    },
    
    get_initialWarning: function() {
        return this.$1i_0._warning;
    },
    ...
    get_localActiveStage: function() {
        var $v_0 = this.$1_0.stageIndex(this.$1_0.$J_0);
    ...
    get_selectedStage: function() {
        this.$2k_0 = this.$2k_0 || this.get_initialSelectedStage();
        return this.$2k_0;
    },
    ...
    get_isSaveStagePending: function() {
        return !IsNull(this.$1_0.$25_0);
    },
    
    get_activeStageActiveFor: function() {
        if (!IsNull(this.$1_0.$28_0)) {
            var $v_0 = new Date() - this.$1_0.$28_0;
    ...
    get_bpfInstanceActiveFor: function() {
        if (!IsNull(this.$1_0.$1h_0)) {
            var $v_0 = new Date() - this.$1_0.$1h_0;
            return this.getHumanTimeFormatFromMilliseconds($v_0);
        }
        return null;
    },
    ...
    get_bpfInstanceCompletedIn: function() {
        if (!IsNull(this.$1_0.$29_0) && !IsNull(this.$1_0.$1h_0)) {
            var $v_0 = this.$1_0.$29_0 - this.$1_0.$1h_0;
            return this.getHumanTimeFormatFromMilliseconds($v_0);
        }
        return null;
    },
    ...
    add_actionStepDataChanged: function(value) {
        this.$6_0.addHandler('ActionStepDataChangedEvent', value);
    },
    
    remove_actionStepDataChanged: function(value) {
        this.$6_0.addHandler('ActionStepDataChangedEvent', value);
    },
    ...
    initializeFormData: function(formData, reinitialize) {
        ...
        this.$E_0 = isNullOrEmptyString(this.$7_0.Id);
        this.$V_0 = this.$7D_0(formData);
        if (!reinitialize) {
            var $v_2 = ProcessControl.StopwatchFactory.createStopwatch('ProcessControl.ViewModel.initDataServiceNew');
            $v_2.start();
            this.$3H_0 = formData._formId;
            this.$1_0.initializeFormData(formData, this.$E_0, this.$V_0);
            this.$K_0 = ProcessControl.Services.StageActonFactory.getService(this.$1_0);
            this.$2Y_0 = (this.$1_0.fetchGlobalTraversedStageInfo().state() === 'resolved');
            this.$v_0 = ProcessControl.Services.SaveServiceFactory.getService(this.$7_0.TypeName);
            if (!IsNull(this.$1c_0)) {
                this.$8m_0(this.$1c_0);
                if (!ProcessControl.Services.ProcessControlInitializer.$N) {
                    this.$7W_0(formData);
            ...
            var $v_4 = this.$11_0;
            $v_3.start();
            this.$1_0.$I_0.reinitializeOnTraversedPathChange();
            this.$1_0.$E_0 = this.$E_0;
            this.$1_0.$V_0 = this.$V_0;
            this.$1_0.update(formData);
            var $v_5 = (Microsoft.Crm.Workflow.Utils.StringUtility.isNullOrEmpty(formData._processControlDataKey._globalNavigationData.businessProcessState)) ? 0 : (Number.parseInvariant(formData._processControlDataKey._globalNavigationData.businessProcessState));
            var $v_6 = (Microsoft.Crm.Workflow.Utils.StringUtility.isNullOrEmpty(formData._processControlDataKey._globalNavigationData.businessProcessStatus)) ? 1 : (Number.parseInvariant(formData._processControlDataKey._globalNavigationData.businessProcessStatus));
            this.initializeStateAndStatus($v_5, $v_6);
            if (!ProcessControl.Services.ProcessControlInitializer.$N) {
                if (!Mscrm.InternalUtilities.JSTypes.isNull($v_4) && (('_extraParams') in $v_4)) {
                    var $v_7 = $v_4['_extraParams'];
                    if (!Mscrm.InternalUtilities.JSTypes.isNull($v_7) && (('processinstanceid') in $v_7)) {
                        this.$1_0.$1F_0 = $v_7['processinstanceid'];
                    }
                    if (!Mscrm.InternalUtilities.JSTypes.isNull($v_7) && (('processinstancename') in $v_7)) {
                        this.$1_0.$2B_0 = $v_7['processinstancename'];
                    }
                }
            }
            $v_3.stop();
    ...
    initializeDefaultPathManager: function() {
        ...
        $v_1.set_businessProcessFlowVisitor(this.$1_0.$z_0);
        $v_1.set_workflowStep(this.$1_0.$O_0);
        $v_1.set_currentEntityName(this.$1_0.$1G_0);
        $v_1.set_businessRuleCaller(new ProcessControl.Reflow.WebBusinessRuleCaller());
        this.$1_0.$I_0 = new ProcessControl.Reflow.DefaultPathManager(new ProcessControl.Reflow.TraversedPathProvider(this.$1_0), $v_1);
        this.$1_0.$I_0.initializeComplete();
        $v_0.stop();
    },
    ...
    isInitialAttributeEmpty: function(attributeName) {
        ...
        if (this.$5g_0(attributeName)) {
            return $v_0['raw'] === '0';
        }
        if (this.$5i_0(attributeName) && !isNullOrEmptyString($v_0['raw'])) {
    ...
    $8m_0: function($p0) {
        this.$1c_0 = $p0;
        this.$2P_0 = ((this.$3H_0) in $p0) ? $p0[this.$3H_0] : ((('PrimaryEntity') in $p0) ? $p0['PrimaryEntity'] : {});
    },
    
    $5g_0: function($p0) {
        var $v_0 = this.$2P_0[$p0];
        if (IsNull($v_0)) {
            return false;
        }
    ...
    set_processInstanceName: function(value) {
        this.$1_0.set_businessProcessInstanceName(value);
        return value;
    },
    ...
    checkRequiredCompleted: function() {
        var $v_0 = false;
        for (var $v_1 = 0, $v_2 = -1; $v_1 < this.$1_0.$J_0.get_Steps().get_Count(); $v_1++) {
            var $v_3 = this.$1_0.$J_0.get_Steps().get_item($v_1);
            if (!(Microsoft.Crm.Workflow.ObjectModel.StepStep.isInstanceOfType($v_3))) {
                continue;
            }
            $v_2++;
    ...
    checkIfValueIsEnteredByUser: function(step, stepIndex) {
        for (var $v_0 = 0; $v_0 < step.get_Steps().get_Count(); $v_0++) {
            ...
            if ($v_1) {
                ...
                if (isNullOrEmptyString($v_2) || this.$7i_0($v_2)) {
    ...
    $7i_0: function($p0) {
        ...
        if (this.$5i_0($p0) && !isNullOrEmptyString($v_1.toString())) {
    ...
    isActionable: function() {
        return !!this.get_$1J_0() && this.$3L_0;
    },
    
    advanceStage: function(callback) {
        var $v_0 = (IsNull(callback)) ? null : callback;
        if (this.get_businessProcessInstanceState() === 1) {
            this.$g_0($v_0, 1);
            return;
        }
        if (Xrm.Page.ui.getFormType() !== 4) {
            this.$K_0.add_advanceStageTaskCompleted(this.$$d_$7t_0);
            this.$K_0.advanceStage(this.$$d_isActionable);
        }
        else {
            var $v_1 = this.$1_0.$J_0;
            var $v_2 = this.$1_0.getStageStepByStageId(this.$1_0.$I_0.getNextStage($v_1.get_stageId()));
            ProcessControl.Services.DebugService.assert(!!$v_2, 'Can\'t advance after the last stage');
            if (!IsNull($v_2)) {
                var $v_3 = new Mscrm.ProcessControlShared.ObjectModels.TraversedPath(Mscrm.ProcessControlShared.ObjectModels.TraversedPath.getCandidateTraversedPath(this.$1_0.$I_0.get_defaultPath(), $v_2.get_stageId()));
                this.$57_0($v_2.get_stageId(), this.$1_0.findStageEntity($v_2), $v_2, $v_3, false, $v_0, 'Next');
            }
            else {
                this.$g_0($v_0, 8);
            }
    ...
    backStage: function(callback, calledFromUI) {
        var $v_0 = (IsNull(callback)) ? null : callback;
        var $$t_5 = this, $$t_6 = this;
        this.$v_0.saveDirtyForm().then(function($p1_0) {
            $$t_5.setActiveStage($$t_5.get_defaultPathManager().getPreviousStage($$t_5.getActiveStage().get_stageId()), $v_0, calledFromUI);
        }, function($p1_0) {
        });
    },
    
    selectStage: function(stage) {
        this.add_stageSelectionTaskCompleted(this.$$d_$83_0);
        var $v_0 = new ProcessControl.Events.TaskCompletionEventArgs();
        $v_0.results = stage;
    ...
    entityStageChange: function() {
        this.add_entityStageChangeTaskCompleted(this.$$d_$7x_0);
        var $v_0 = new ProcessControl.Events.TaskCompletionEventArgs();
        this.$P_0('EntityStageChangeTaskCompletedEvent', $v_0);
    },
    
    setActiveStage: function(stageId, callback, calledFromUI) {
        if (this.$3t_0() || (this.get_businessProcessInstanceState() === 1)) {
            this.$g_0(callback, 1);
            return;
        }
        ...
        if (isNullOrEmptyString(stageId) || this.$E_0 || IsNull($v_1) || !this.$1_0.isActionOrphanEnabled($v_1)) {
            this.$g_0(callback, 1);
            return;
        }
        ...
        if ($v_5 && (calledFromUI || !Xrm.Page.data.entity.getIsDirty())) {
            ...
            if (!$v_7 && !$v_6) {
                this.$K_0.add_backStageTaskCompleted(this.$$d_$7v_0);
                if (!this.$K_0.setActiveStage(true, stageId, $v_3, false, true)) {
                    this.$g_0(callback, 1);
                    return;
                }
            }
            else {
                this.$57_0(stageId, $v_4, $v_1, $v_3, $v_7, callback, 'Previous');
            }
        }
        else {
            if (!$v_5) {
                ...
                this.$g_0(callback, 11);
            }
        }
    },
    
    $57_0: function($p0, $p1, $p2, $p3, $p4, $p5, $p6) {
        ...
        if (!IsNull($v_0)) {
            ...
            var $v_3 = function($p1_0, $p1_1) {
                ...
                $v_4.results = ($$t_E.$1_0.$T_0) ? $$t_E.$1_0.$T_0.get_stage() : null;
                if ($p1_0.Success && $$t_E.$K_0.setActiveStage(true, $p0, $p3, $p6 === 'Next', false)) {
                    ...
                    if ($p6 === 'Next') {
                        $$t_E.$K_0.remove_advanceStageTaskCompleted($$t_E.$$d_$7t_0);
                    }
                    else {
                        $$t_E.$K_0.remove_backStageTaskCompleted($$t_E.$$d_$7v_0);
                    }
                    $$t_E.$g_0($p5, 1);
                    return;
                }
            };
            Mscrm.SwitchProcessFlyoutViewModel.executeSwitchProcessRemoteCommand($v_1.toString(), $p1.get_EntityLogicalName(), this.$1_0.$c_0, this.$1_0.$1F_0, $v_2.toString(), $p3.get_path(), $v_3);
        }
    },
    ...
    $8j_0: function() {
        ...
        try {
            ...
            var $$t_5 = this, $$t_6 = this;
            Xrm.Page.data.save($v_1).then(function($p1_0) {
                $$t_5.executeUpdateBusinessProcessFlowStateCommand(1, 2, $$t_5.$2E_0(1, 2, null));
            }, function($p1_0) {
                var $v_2 = new ProcessControl.Events.TaskCompletionEventArgs();
                $v_2.error = $p1_0.errorCode;
                $v_2.errorMessage = $p1_0.message;
                $$t_6.$P_0('FinishProcessTaskCompleted', $v_2);
            });
        }
        finally {
            Mscrm.InlineEditDataServiceProxy.set_performDuplicateCheck($v_0);
    ...
    abandonProcess: function() {
        ...
        if (this.get_businessProcessInstanceStatus() !== 3) {
            this.executeUpdateBusinessProcessFlowStateCommand(1, 3, this.$2E_0(1, 3, null));
        }
    },
    ...
    reactivateProcess: function() {
        ...
        if (this.get_businessProcessInstanceStatus() !== 1) {
            this.executeUpdateBusinessProcessFlowStateCommand(0, 1, this.$2E_0(0, 1, null));
        }
    },
    
    $2E_0: function($p0, $p1, $p2) {
        var $$t_7 = this;
    ...
    executeUpdateBusinessProcessFlowStateCommand: function(state, status, callback) {
        ...
        $v_1.SetParameter('entityLogicalName', this.$1_0.$1G_0);
        $v_1.SetParameter('entityId', $v_0);
        $v_1.SetParameter('state', state);
        $v_1.SetParameter('status', status);
        $v_1.SetParameter('bpfInstanceId', this.$1_0.$1F_0);
    ...
    setStatus: function(newStatus, callback) {
        ...
        if (Xrm.BusinessProcessFlowInstanceStatus.toString(this.get_businessProcessInstanceStatus()).toLowerCase() !== newStatus.toLowerCase()) {
            if ($v_0 === Xrm.BusinessProcessFlowInstanceStatus.toString(1).toLowerCase()) {
                this.executeUpdateBusinessProcessFlowStateCommand(0, 1, this.$2E_0(0, 1, callback));
            }
            else if ($v_0 === Xrm.BusinessProcessFlowInstanceStatus.toString(3).toLowerCase()) {
                this.executeUpdateBusinessProcessFlowStateCommand(1, 3, this.$2E_0(1, 3, callback));
            }
            else if ($v_0 === Xrm.BusinessProcessFlowInstanceStatus.toString(2).toLowerCase()) {
                this.executeUpdateBusinessProcessFlowStateCommand(1, 2, this.$2E_0(1, 2, callback));
            }
        }
    },
    ...
    initializeStateAndStatus: function(state, status) {
        this.$1_0.$2q_0 = state;
        this.$1_0.$2r_0 = status;
    },
    
    $7t_0: function($p0, $p1) {
        this.$K_0.remove_advanceStageTaskCompleted(this.$$d_$7t_0);
        var $v_0 = this.$1_0.$C_0;
        this.$6E_0($p1);
        var $v_1 = this.$5L_0($p1);
    ...
    $83_0: function($p0, $p1) {
        this.remove_stageSelectionTaskCompleted(this.$$d_$83_0);
        this.fireStageSelectedEvent($p1);
    },
    
    $7x_0: function($p0, $p1) {
        this.remove_entityStageChangeTaskCompleted(this.$$d_$7x_0);
        var $v_0 = this.$1_0.$C_0;
        if ($v_0) {
            $p1.results = $v_0;
            this.fireStageChangeEvent($p1, 'Next');
    ...
    $7v_0: function($p0, $p1) {
        this.$K_0.remove_backStageTaskCompleted(this.$$d_$7v_0);
        var $v_0 = this.$1_0.$C_0;
        this.$6E_0($p1);
        this.$6D_0();
        var $v_1 = this.$5L_0($p1);
    ...
    $6D_0: function() {
        var $v_0 = this.$1_0.$J_0;
        if (!IsNull($v_0)) {
            var $v_1 = $v_0.get_stageId();
            this.$1_0.$I_0.triggerDefaultPathUpdate($v_1);
    ...
    $6E_0: function($p0) {
        ...
        var $v_1 = this.$1_0.getEntityStepByStageId($v_0.$21_0.get_stageId());
        this.$1_0.$9_0 = $v_1;
    },
    ...
    $5L_0: function($p0) {
        ...
        $v_0.error = $p0.error;
        var $v_1 = $p0.results;
        $v_0.results = this.convertModelViewModel((IsNull($v_1)) ? null : $v_1.$21_0);
        return $v_0;
    },
    ...
    addSetActiveStageCallback: function(callback) {
        this.$K_0.registerSetActiveStageCallback(callback);
    },
    
    addMoveNextCallback: function(callback) {
        this.$K_0.registerMoveNextCallback(callback);
    },
    
    addMovePreviousCallback: function(callback) {
        this.$K_0.registerMovePreviousCallback(callback);
    },
    ...
    reflow: function(parentStage, nextStage) {
        if (!isNullOrEmptyString(parentStage) && (this.$1_0.fetchGlobalTraversedStageInfo().state() === 'resolved')) {
            ...
            if (Microsoft.Crm.Workflow.Utils.StringUtility.reduceToCanonicalForm($v_0.get_stage().get_stageId()) === parentStage || $v_0.get_traversedPath().get_path().indexOf(parentStage) < 0) {
                this.$1_0.$I_0.updateDefaultPath(parentStage, nextStage);
            }
        }
    },
    ...
    $7W_0: function($p0) {
        ...
        $v_0.set_formData($p0);
        $v_0.set_entityMetadata(this.$2P_0);
    },
    ...
    $6W_0: function() {
        ...
        if (this.$1_0.$2h_0) {
            if (this.$E_0) {
                this.$v_0.setProcessWithoutSaving(this.$1_0.$c_0);
            }
            else {
                this.$v_0.add_stageSetEvent(this.$$d_$80_0);
                var $v_4 = Microsoft.Crm.Workflow.Utils.StringUtility.reduceToCanonicalForm(this.$1_0.getStageByIndex(0).get_stageId());
                this.$v_0.setProcessAndSave(this.$1_0.$c_0, $v_4, $v_4);
                return;
            }
        }
        var $v_0 = this.$1_0.$25_0;
        var $v_1 = this.$1_0.$2g_0;
        if (IsNull($v_0)) {
            return;
        }
        var $v_2 = $v_0.get_stageId();
        var $v_3 = this.$6g_0($v_2);
        if ($v_3) {
            this.$K_0.setActiveStage(true, $v_0.get_stageId(), $v_1, true, this.$1_0.$2Z_0);
        }
    },
    
    $80_0: function($p0, $p1) {
        this.$v_0.remove_stageSetEvent(this.$$d_$80_0);
        if ($p1.get_isError()) {
            return;
        }
        this.$3L_0 = true;
    ...
    $2p_0: function() {
        if (IsNull(this.get_$1J_0())) {
            return;
        }
        if (ProcessControl.Services.ProcessControlInitializer.$N) {
            Mscrm.TurboForm.Control.CommandService.get_instance().addAfterCommandExecutionHandler(1, this.$$d_$84_0);
            Mscrm.TurboForm.Control.CommandService.get_instance().addAfterCommandExecutionHandler(208, this.$$d_$84_0);
        }
        else {
            Mscrm.InlineEditDataServiceProxy.addFormRefreshedEventHandler(this.$$d_$81_0);
        }
    },
    ...
    unBindEvents: function() {
        ...
        if (ProcessControl.Services.ProcessControlInitializer.$N) {
            if (!IsNull(Mscrm.TurboForm.Control.CommandService.get_instance())) {
                Mscrm.TurboForm.Control.CommandService.get_instance().removeAfterCommandExecutionHandler(1, this.$$d_$84_0);
                Mscrm.TurboForm.Control.CommandService.get_instance().removeAfterCommandExecutionHandler(208, this.$$d_$84_0);
            }
        }
        else {
            if (!Mscrm.InlineEditDataServiceProxy.get_instanceIsDisposed()) {
                Mscrm.InlineEditDataServiceProxy.removeFormRefreshedEventHandler(this.$$d_$81_0);
            }
        }
    },
    ...
    dispose: function() {
        ...
        this.remove_stageSelectionTaskCompleted(this.$$d_$83_0);
        Mscrm.Utilities.safeDispose(this.$K_0);
        if (!IsNull(this.$v_0)) {
            this.$v_0.remove_stageSetEvent(this.$$d_$80_0);
        }
        if (ProcessControl.Services.ProcessControlInitializer.$N) {
    ...
    $8X_0: function() {
        if (Xrm.Internal.isFeatureEnabled('FCB.BpfActionSupportPUV2') && !this.$E_0 && Xrm.Internal.isFeatureEnabled('FCB.BpfActionSupportActionQuerying')) {
            var $v_0 = this.$7B_0();
            if ($v_0.length > 0) {
                this.$8W_0($v_0);
            }
    ...
    $8W_0: function($p0) {
        var $v_0 = ProcessControl.StopwatchFactory.createStopwatch(' ProcessControl.ActionLog.Request');
        $v_0.start();
        var $$t_A = this;
        var $v_1 = function($p1_0, $p1_1) {
            var $v_3 = new ProcessControl.Events.TaskCompletionEventArgs();
            if ($p1_0.Success) {
                var $v_4 = JSON.parse($p1_0.ReturnValue.toString());
                $$t_A.$1_0.$2N_0 = $v_4;
                $v_3.results = $v_4;
                $v_3.error = 0;
            }
                ...
                for (var $v_6 = 0; $v_6 < $p0.length; $v_6++) {
                    $v_5[$p0[$v_6]] = $p1_0.Success;
                }
                $v_3.error = 1;
                $v_3.errorMessage = $p1_0.ReturnValue.toString();
                $$t_A.$1_0.$2N_0 = $v_5;
            }
            $v_0.stop();
            $$t_A.$P_0('ActionStepDataChangedEvent', $v_3);
        };
        var $v_2 = new RemoteCommand('ProcessControl', 'RequestActionLogState', null);
        $v_2.SetParameter('actionStepIds', JSON.stringify($p0));
        $v_2.SetParameter('processDefinitionId', this.get_processId());
        $v_2.SetParameter('processInstanceId', this.get_processInstanceId());
        $v_2.Execute($v_1);
    },
    
    $7B_0: function() {
        var $v_0 = [];
        for (var $$arr_1 = this.$1_0.$13_0, $$len_2 = $$arr_1.length, $$idx_3 = 0; $$idx_3 < $$len_2; ++$$idx_3) {
            var $v_1 = $$arr_1[$$idx_3];
            for (var $v_2 = 0; $v_2 < $v_1.get_Steps().get_Count(); $v_2++) {
                var $v_3 = $v_1.get_Steps().get_item($v_2);
                for (var $v_4 = 0; $v_4 < $v_3.get_Steps().get_Count(); $v_4++) {
                    var $v_5 = $v_3.get_Steps().get_item($v_4);
                    if ($v_5 && Microsoft.Crm.Workflow.ObjectModel.ActionStep.isInstanceOfType($v_5)) {
                        this.$9F_0($v_5);
                        $v_0.push($v_5.get_actionId().toString());
                    }
                }
            }
        }
    ...
    $9F_0: function($p0) {
        ...
        if (IsNull(this.$1b_0)) {
            this.$1b_0 = new (Microsoft.Crm.Client.Core.Framework.TypedDictionary$1.$$(String))();
        }
        var $v_0 = '';
        if (!IsNull($p0.get_actionControl())) {
            $v_0 = $p0.get_actionControl().get_controlId();
        }
        if (!this.$1b_0.containsKey($v_0) && !isNullOrEmptyString($v_0)) {
            this.$1b_0.set_item($v_0, $p0.get_Id());
        }
    },
    ...
    $84_0: function($p0) {
        ...
        this.$54_0 = (!isNullOrEmptyString($p0.get_saveMode())) && $p0.get_saveMode() === 'saveandclose';
        this.$5t_0($p0.get_command(), $v_0);
        this.$7X_0();
    },
    ...
    $81_0: function($p0, $p1) {
        ...
        this.$5t_0($p1.get_command(), $p1.get_jsonData());
    },
    ...
    $5t_0: function($p0, $p1) {
        if ($p0 === 1) {
            if (!this.$E_0) {
                ...
                var $v_2;
                var $$t_C, $$t_D, $$t_E;
                var $v_3 = (($$t_E = ProcessControl.FormDataUtility.getActiveStageValue(this.$1_0.$13_0, $p1, ($$t_C = {'val': $v_2}), ($$t_D = {'val': $v_1}))), $v_2 = $$t_C.val, $v_1 = $$t_D.val, $$t_E);
                $v_3 = Microsoft.Crm.Workflow.Utils.StringUtility.reduceToCanonicalForm($v_3);
                var $v_4 = Microsoft.Crm.Workflow.Utils.StringUtility.reduceToCanonicalForm(this.$1_0.$J_0.get_stageId());
                var $v_5 = this.$1_0.$Z_0.get_traversedPath();
                if ($v_1 && !$p1.traversedpath) {
                    return;
                }
            ...
            if (!IsNull($v_6) && IsNull($v_6.getValue())) {
                ...
                this.$v_0.setProcessAndSave(this.$1_0.$c_0, $v_8, $v_9);
            }
            this.initializeFormData($p1, true);
            this.$4u_0('StageAttributeRefreshedEvent');
        }
    ...
    $5K_0: function($p0) {
        ...
        if (!IsNull($p0) && !Mscrm.InternalUtilities._String.isNullOrWhiteSpace($p0.$1E_0)) {
            var $v_0 = this.$1_0.getStageStepByStageId($p0.$1E_0);
            this.set_selectedStage(this.convertModelViewModel($v_0));
        }
        this.$4N_0 = true;
        setPerfMarkerTimestamp('FinishNavigateToEntityTimestamp');
        this.navigateToEntity(this.$7_0.TypeName, this.$7_0.Id);
    },
    ...
    getForwardNavigationRelationshipInfo: function(stage) {
        ...
        var $v_2 = this.$1_0.$I_0.getNextStage(stage.currentStageValue);
        ...
        var $v_5 = this.$1_0.$z_0.getRelationshipStep(stage.currentStageValue, $v_2);
    ...
    navigateToEntity: function(navigationEntityLogicalName, navigateToEntityId) {
        this.$4j_0(navigationEntityLogicalName, navigateToEntityId, this.get_processId(), this.get_processInstanceId());
    },
    
    $4j_0: function($p0, $p1, $p2, $p3) {
        var $v_0 = {};
        ...
        var $v_1 = Xrm.Page.ui;
        if (this.$7_0.TypeName === $p0 && !IsNull($v_1) && !IsNull($v_1.formSelector) && !IsNull($v_1.formSelector.getCurrentItem()) && !isNullOrEmptyString($v_1.formSelector.getCurrentItem().getId())) {
            $v_0['formid'] = $v_1.formSelector.getCurrentItem().getId();
        }
    ...
    navigateToCloseLoop: function(closeLoopEntity, currentStageId) {
        var $v_0 = this.$1_0.$I_0.getNextStage(currentStageId);
        var $v_1 = this.$1_0.getStageStepByStageId($v_0);
        var $v_2 = Mscrm.ProcessControlShared.ObjectModels.TraversedPath.getCandidateTraversedPath(this.$1_0.$I_0.get_defaultPath(), $v_0);
        var $$t_8 = this;
        var $v_3 = function($p1_0, $p1_1) {
            if ($p1_0.Success) {
                $$t_8.get_selectedStage().currentStageValue = $v_0;
                Xrm.Internal.setStageId($v_0);
                Xrm.Internal.setTraversedPath($v_2);
                $$t_8.navigateToEntity(closeLoopEntity.EntityLogicalName, closeLoopEntity.Id);
            }
            else {
                $$t_8.$g_0(null, 1);
            }
        ...
        Mscrm.SwitchProcessFlyoutViewModel.executeSwitchProcessRemoteCommand(closeLoopEntity.Id, closeLoopEntity.EntityLogicalName, this.$1_0.$c_0, this.$1_0.$1F_0, $v_1.get_stageId(), Mscrm.ProcessControlShared.ObjectModels.TraversedPath.getCandidateTraversedPath(this.$1_0.$I_0.get_defaultPath(), $v_0), $v_3);
    },
    
    getProcessInstances: function(responseCallback) {
        var $$t_3 = this, $$t_4 = this;
        $P_CRM.when(this.populateProcessInstancesList()).done(function($p1_0) {
            responseCallback($$t_3.$7K_0($p1_0));
        }).fail(function($p1_0) {
    ...
    populateProcessInstancesList: function() {
        if (_Script.isNullOrUndefined(this.$2D_0)) {
            this.$2D_0 = jQueryApi.jQueryDeferredFactory.Deferred(RemoteCommandResult, Mscrm.ErrorInformation);
            ...
            $v_0.Execute(function($p1_0, $p1_1) {
                if ($p1_0.Success) {
                    $$t_3.$2D_0.resolve($p1_0.ReturnValue);
                }
                else {
                    $$t_3.$2D_0.reject($p1_0.ReturnValue);
                }
            });
        }
        return this.$2D_0.promise();
    },
    ...
    $7K_0: function($p0) {
        ...
        if ($v_1 && $v_1.ProcessInstances && ($v_1.ProcessInstances.length > 0)) {
            ...
            for (var $$arr_3 = $v_1.ProcessInstances, $$len_4 = $$arr_3.length, $$idx_5 = 0; $$idx_5 < $$len_4; ++$$idx_5) {
                ...
                $v_3.ProcessDefinitionID = $v_2.ProcessDefinitionId;
                $v_3.ProcessDefinitionName = $v_2.ProcessDefinitionName;
                $v_3.CreatedOnDate = new Date($v_2.CreatedOn);
    ...
    setActiveProcess: function(processId) {
        ...
        Mscrm.SwitchProcessFlyoutViewModel.executeSwitchProcessRemoteCommand(this.$7_0.Id, this.$7_0.TypeName, processId, '', '', '', function($p1_0, $p1_1) {
            $$t_3.$4j_0($$t_3.$7_0.TypeName, $$t_3.$7_0.Id, processId, null);
        });
    ...
    setActiveProcessInstance: function(processInstanceId) {
        ...
        Mscrm.SwitchProcessFlyoutViewModel.executeSwitchProcessRemoteCommand(this.$7_0.Id, this.$7_0.TypeName, '', processInstanceId, '', '', function($p1_0, $p1_1) {
            $$t_3.$4j_0($$t_3.$7_0.TypeName, $$t_3.$7_0.Id, null, processInstanceId);
        });
        this.fireOnProcessChangeEvent();
        return 0;
    },
    ...
    fireOnProcessChangeEvent: function() {
        var $v_0 = new ProcessControl.Events.TaskCompletionEventArgs();
        $v_0.results = (this.$1_0.$T_0) ? this.$1_0.$T_0.get_stage() : null;
        this.fireProcessChangeEvent($v_0);
    },
    
    error: function(message) {
        this.$7q_0(message, true);
    },
    ...
    $6P_0: function($p0, $p1) {
        this.get_$n_0().addHandler('OnStageChange', $p0, $p1);
    },
    
    $8Q_0: function($p0) {
        this.get_$n_0().removeHandler('OnStageChange', $p0);
    },
    
    $6N_0: function($p0, $p1) {
        this.get_$n_0().addHandler('OnProcessChange', $p0, $p1);
    },
    
    $8O_0: function($p0) {
        this.get_$n_0().removeHandler('OnProcessChange', $p0);
    },
    
    $6O_0: function($p0, $p1) {
        this.get_$n_0().addHandler('OnProcessStatusChange', $p0, $p1);
    },
    
    $8P_0: function($p0) {
        this.get_$n_0().removeHandler('OnProcessStatusChange', $p0);
    },
    
    $6Q_0: function($p0, $p1) {
        this.get_$n_0().addHandler('OnStageSelected', $p0, $p1);
    },
    
    $8R_0: function($p0) {
        this.get_$n_0().removeHandler('OnStageSelected', $p0);
    },
    
    fireStageChangeEvent: function(eventArgs, direction) {
        var $v_0 = this.$6m_0(eventArgs, direction);
        var $v_1 = this.get_$n_0().getHandler('OnStageChange');
        if ($v_1) {
            $v_1($v_0.getStage(), $v_0);
        }
    },
    
    fireStageSelectedEvent: function(eventArgs) {
        var $v_0 = this.$6n_0(eventArgs);
        var $v_1 = this.get_$n_0().getHandler('OnStageSelected');
        if ($v_1) {
            $v_1($v_0.getStage(), $v_0);
        }
    },
    ...
    fireProcessChangeEvent: function(eventArgs) {
        var $v_0 = this.$6l_0(eventArgs);
        var $v_1 = this.get_$n_0().getHandler('OnProcessChange');
        if ($v_1) {
            $v_1(this, $v_0);
        }
    },
    ...
    fireProcessStatusChangeEvent: function(status) {
        var $v_0 = new ProcessControl.Events.ProcessControlEventArgs(null, null, status);
        var $v_1 = this.get_$n_0().getHandler('OnProcessStatusChange');
        var $v_2 = this.$Q_0.businessProcessFlowBuilder(this.get_processId(), this.get_processInstanceId(), this.get_processInstanceName(), this.$1_0.$O_0.get_title(), this.get_businessProcessInstanceState(), this.get_businessProcessInstanceStatus(), true, this.getProcessStages());
        if ($v_1) {
            $v_1($v_2, $v_0);
        }
    },
    ...
    $6n_0: function($p0) {
        ...
        var $v_3 = this.$Q_0.processStageBuilder($v_1, $v_0, $v_0.entityLogicalName, $v_2);
    ...
    getProcessStages: function() {
        ...
        for (var $v_1 = 0; $v_1 < this.get_stages().length; $v_1++) {
            ...
            $v_0[$v_1] = this.$Q_0.processStageBuilder(this.getStageModel(this.get_stages()[$v_1]), this.get_stages()[$v_1], this.get_stages()[$v_1].entityLogicalName, $v_2);
        }
        return $v_0;
    },
    ...
    showStageGatingMessageBar: function() {
        ...
        window.clearTimeout(this.$46_0);
        var $$t_0 = this;
        this.$46_0 = window.setTimeout(function() {
...
ProcessControl.Views.ActionsView = function(viewModel) {
    this.$$d_$7m_1 = Function.createDelegate(this, this.$7m_1);
    ...
    this.$$d_$73_1 = Function.createDelegate(this, this.$73_1);
    this.$$d_$6X_1 = Function.createDelegate(this, this.$6X_1);
    this.$$d_$6U_1 = Function.createDelegate(this, this.$6U_1);
    this.$5j_1 = Mscrm.FeatureControl.get_Current().isFeatureEnabled(Mscrm.FeatureNames.ProcessUnification);
    this.$46_1 = -1;
    ...
    this.$L_1 = $P_CRM('#stageAdvanceActionContainer');
    this.$B_1 = $P_CRM('#stageNavigateActionContainer');
    this.$e_1 = $P_CRM('#stageSetActiveActionContainer');
    this.$S_1 = $P_CRM('#stageFinishActionContainer');
    this.$10_1 = $P_CRM('#finishLabelContainer');
    this.$3V_1 = $P_CRM('#processDuration');
    this.$3W_1 = $P_CRM('#processName');
    this.$2R_1 = this.$H_1.find('img');
    this.$3B_1 = this.$L_1.find('img');
    this.$12_1 = this.$B_1.find('img');
    this.$G_1 = ProcessControl.Views.ProcessControlView.$G;
}
ProcessControl.Views.ActionsView.$6d = function($p0, $p1, $p2) {
...
ProcessControl.Views.ActionsView.prototype = {
    ...
    set_dataContext: function(value) {
        ...
        this.$38_1();
        this.$0_1 = value;
        this.$0_1.add_advanceStageTaskCompleted(this.$$d_$6U_1);
        this.$0_1.add_backStageTaskCompleted(this.$$d_$6X_1);
        this.$0_1.add_finishProcessTaskCompleted(this.$$d_$73_1);
        return value;
    },
    
    $38_1: function() {
        if (!IsNull(this.$0_1)) {
            this.$0_1.remove_advanceStageTaskCompleted(this.$$d_$6U_1);
            this.$0_1.remove_backStageTaskCompleted(this.$$d_$6X_1);
            this.$0_1.remove_finishProcessTaskCompleted(this.$$d_$73_1);
        }
    },
    ...
    render: function() {
        ...
        $v_0.start();
        this.$0_1.get_defaultPathManager().add_defaultPathChanged(this.$$d_$6r_1);
        this.$34_1(this.$0_1.get_selectedStage());
        this.$6F_1();
        $v_0.stop();
    },
    ...
    changeActionStatus: function(newStage, switchAcrossCloseLoop) {
        if (switchAcrossCloseLoop) {
            this.$k_1 = this.$70_1(this.$0_1.get_defaultPath());
            this.$34_1(this.$k_1);
        }
        else {
            this.$34_1(newStage);
    ...
    $9C_1: function() {
        $P_CRM(window).unbind('resize', this.$$d_$7N_1);
        this.$L_1.unbind();
        this.$H_1.unbind();
        this.$B_1.unbind();
        this.$e_1.unbind();
        ...
        if (!IsNull(this.$0_1.get_defaultPathManager())) {
            this.$0_1.get_defaultPathManager().remove_defaultPathChanged(this.$$d_$6r_1);
        }
    },
    
    $2p_1: function() {
        this.$L_1.click(this.$$d_$5A_1);
        var $$t_5 = this;
        this.$L_1.keydown(function($p1_0) {
            if ($$t_5.$1o_1($p1_0.which)) {
                $$t_5.$5A_1($p1_0);
            }
        });
        this.$H_1.click(this.$$d_$5B_1);
        var $$t_6 = this;
        ...
        this.$S_1.click(this.$$d_$5D_1);
        var $$t_9 = this;
        this.$S_1.keydown(function($p1_0) {
    ...
    $6r_1: function($p0, $p1) {
        this.$34_1(this.$0_1.get_localActiveStage());
        this.$5y_1();
    },
    ...
    $2G_1: function($p0) {
        if (this.$F_1 || this.$15_1($p0) || this.$0_1.isBusinessProcessAborted() || (ProcessControl.Services.ProcessControlInitializer.$N && !Xrm.Page.data.entity.isValid())) {
            return false;
        }
        if ($p0 === 1) {
            return true;
    ...
    $5E_1: function($p0) {
        if (!this.$2G_1(2) || !this.$0_1.isActionable()) {
            return;
        }
        this.$0_1.entityStageChange();
        this.$B_1.focus();
        this.$F_1 = true;
        this.$1Z_1(this.$B_1, this.$12_1);
        Mscrm.MetricsReporting.instance().addMetric('Sales Process Back', 'navigate button');
        this.$1x_1('StartGetNavigateToEntitiesTimestamp');
        ...
        if (!IsNull($v_1)) {
            ...
            this.$0_1.getSaveStageService().saveDirtyForm().then(function($p1_0) {
                $$t_6.$0_1.navigateToCloseLoop($v_1, $v_0);
            }, function($p1_0) {
            });
            $p0.preventDefault();
            return;
    ...
    $62_1: function($p0) {
        ...
        $v_0.execute().then(function($p1_0) {
            $$t_4.$7J_1($p1_0);
            $$t_4.$1x_1('FinishGetNavigateToEntitiesTimestamp');
        }, function($p1_0) {
            $$t_5.$1x_1('FinishGetNavigateToEntitiesTimestamp');
        });
    },
    
    $7J_1: function($p0) {
        this.$7Q_1($p0);
        this.$1B_1.show(this.$B_1);
        $P_CRM(window).resize(this.$$d_$7N_1);
        var $v_0 = this.$1B_1.dialogChrome();
        $v_0.children('.ui-dialog-content').css('min-height', '0px');
        var $v_1 = 15;
        var $v_2 = $P_CRM('#processActionsContainer').offset().left;
        var $v_3 = $P_CRM('#processActionsContainer').offset().top + 8 + 1 + $v_1;
        if (Mscrm.Utilities.get_isLeftToRight()) {
            var $v_4 = $v_0.css('left');
            var $v_5 = parseInt($v_4.substr(0, $v_4.length - 2), 10);
            $v_2 = $v_5 - 8 - 1 - 25;
        }
        $v_0.css('left', $v_2 + 'px');
        $v_0.css('top', $v_3 + 'px');
    ...
    $7Q_1: function($p0) {
        ...
        if (!IsNull($p0.NavigationEntities) && $p0.NavigationEntities.length >= 1) {
            $v_0 = this.$6p_1($p0.NavigationEntities, $p0.EntityDisplayName, $p0.EntityLogicalName, $p0.EntityTypeCode, $p0.ShowCreate);
        }
        else {
            $v_0 = this.$6o_1($p0.EntityDisplayName, $p0.EntityLogicalName, $p0.EntityTypeCode, $p0.ShowCreate);
        }
        this.$5P_1();
        this.$1B_1 = Mscrm.FlyOutMenu.createFlyOut($v_0);
    },
    ...
    $5P_1: function() {
        ...
        this.$1B_1.dialogChrome().find('.navigateMenuItem, .navigateMenuCreate').unbind('click');
        this.$1B_1.dispose();
    },
    
    $7N_1: function($p0) {
        this.$1B_1.hide();
        $P_CRM('body').unbind('resize', this.$$d_$7N_1);
    },
    
    $6o_1: function($p0, $p1, $p2, $p3) {
        ...
        $v_0.menuSections = [ this.$5N_1($p0), $v_1, this.$5M_1(0, $p1, $p2, $p3) ];
        return $v_0;
    },
    ...
    $5M_1: function($p0, $p1, $p2, $p3) {
        var $v_0 = new Mscrm.MenuSectionDescriptor();
        $v_0.cssClass = 'navigateFooterSection';
        $v_0.clickHandler = this.$$d_$7I_1;
        ...
        if ($p3 && this.$7Y_1(this.$0_1.$7_0.TypeName, $p1)) {
    ...
    $6p_1: function($p0, $p1, $p2, $p3, $p4) {
        var $v_0 = new Mscrm.FlyOutMenuDescriptor();
        $v_0.cssClass = 'processNavigateMenu';
        $v_0.width = 200;
        var $v_1 = new Mscrm.MenuSectionDescriptor();
        $v_1.clickHandler = this.$$d_$7I_1;
        $v_1.cssClass = 'navigateMenuSection';
        ...
        $v_0.menuSections = [ this.$5N_1($p1), $v_1, this.$5M_1($p0.length, $p2, $p3, $p4) ];
        return $v_0;
    },
        ...
        this.$0_1.getSaveStageService().saveDirtyForm().then(function($p1_0) {
            switch ($p0['Command']) {
                case 'OpenEntity':
                    ...
                    break;
                case 'Create':
                    $$t_3.$7G_1($p0['targetEntityLogicalName']);
                    break;
            }
        }, function($p1_0) {
        });
    ...
    $7H_1: function($p0) {
        var $v_0 = ProcessControl.Views.ActionsView.$6d($p0['targetEntityLogicalName'], $p0['ETC'], $p0['Id']);
        this.$7l_1($v_0);
    },
    ...
    $7l_1: function($p0) {
        this.$1x_1('StartNavigateToEntityTimestamp');
        ...
        $v_1.navigateToNextEntity(this.$0_1.$7_0.Id, this.$0_1.$7_0.TypeName, $p0.Id, $p0.EntityLogicalName, this.$0_1.get_processId(), (Xrm.Internal.isFeatureEnabled('FCB.ProcessUnification')) ? (this.$0_1.get_processInstanceId() || Microsoft.Crm.Client.Core.Framework.Guid.get_empty().toString()) : null, $v_2, $v_3).then(function($p1_0) {
            $$t_7.$1x_1('FinishNavigateToEntityTimestamp');
            Xrm.Internal.setStageId($v_2);
            Xrm.Internal.setTraversedPath($v_3);
    ...
    $7m_1: function($p0) {
        this.$1B_1.hide();
        this.$1x_1('FinishNavigateToEntityTimestamp');
        this.$F_1 = false;
        this.$3A_1(this.$B_1, this.$12_1);
    ...
    $1Z_1: function($p0, $p1) {
        $p0.addClass('loading');
        this.$4O_1 = $p1.attr('src');
        this.$3S_1 = $p1.attr('class');
        $p1.removeClass(this.$3S_1);
        this.$65_1($p1, '/_imgs/processcontrol/circularpreloader_white_15x15.gif');
        $p1.addClass('stageActionIcon');
    },
    
    $3A_1: function($p0, $p1) {
        $p0.removeClass('loading');
        this.$65_1($p1, this.$4O_1);
        $p1.attr('class', this.$3S_1);
    },
    ...
    $15_1: function($p0) {
        ...
        if ($p0 === 2) {
            ...
            return this.$0_1.$E_0 || !this.$0_1.get_selectedStage().get_navigate() || !this.$0_1.$1_0.isActionOrphanEnabled($v_4);
        }
        else if ($p0 === 3) {
            return this.$0_1.$E_0;
        }
            ...
            return this.$0_1.$E_0 || !$v_1 || !this.$0_1.$1_0.isActionOrphanEnabled($v_6);
        }
        else if ($p0 === 4) {
            return !(!this.$0_1.get_defaultPathManager().getNextStage(this.$0_1.getActiveStage().get_stageId()));
        }
        else {
            return this.$0_1.$E_0 || !$v_1;
        }
    },
    
    $8Y_1: function() {
        this.$L_1.removeClass('loading');
        if (this.$15_1(0) || this.$0_1.isBusinessProcessAborted()) {
            this.$L_1.addClass('disabled');
            this.$L_1.attr('tabindex', '-1');
        }
        else {
            this.$L_1.removeClass('disabled');
            this.$L_1.attr('tabindex', '1000');
        }
    },
    
    $8Z_1: function() {
        this.$H_1.removeClass('loading');
        if (this.$15_1(1) || this.$0_1.isBusinessProcessAborted()) {
    ...
    $8a_1: function() {
        this.$S_1.removeClass('loading');
        if (this.$15_1(4) || this.$0_1.$7_0.Id === '' || this.$0_1.isBusinessProcessAborted()) {
            this.$S_1.addClass('disabled');
            this.$S_1.attr('tabindex', '-1');
        }
        else {
            this.$S_1.removeClass('disabled');
            this.$S_1.attr('tabindex', '1000');
        }
    },
    
    $8d_1: function() {
        this.$B_1.removeClass('loading');
        if (this.$15_1(2) || this.$0_1.isBusinessProcessAborted()) {
    ...
    $8f_1: function() {
        ...
        if (!this.$2G_1(3) || this.$0_1.isBusinessProcessAborted()) {
    ...
    $8b_1: function() {
        this.$10_1.removeClass('loading');
        if (!this.$0_1.checkBusinessProcessFlowInstanceStatus(this.$0_1.$1_0.get_businessProcessInstanceStatus(), 2)) {
            this.$10_1.addClass('disabled');
            this.$10_1.attr('tabindex', '-1');
        }
        else {
            this.$10_1.removeClass('disabled');
            this.$10_1.attr('tabindex', '1000');
        }
    },
    ...
    $5y_1: function() {
        this.$40_1();
        var $v_0 = this.$0_1.get_warning() === 3;
        var $v_1 = $v_0 || this.$15_1(0) && this.$15_1(1) && this.$15_1(2) && this.$15_1(3) && this.$15_1(4);
        if ($v_1) {
    ...
    $34_1: function($p0) {
        this.$k_1 = $p0;
        this.$8w_1();
        this.$8x_1($p0.get_advance());
        this.$8y_1($p0.get_back());
        this.$92_1($p0.get_navigate());
        this.$93_1();
        this.$69_1($p0.get_advance(), $p0.get_navigate(), this.$0_1.get_selectedStage().get_active());
        this.$S_1.addClass('hidden');
        this.$10_1.addClass('hidden');
        var $v_0 = false;
        if (this.$5j_1) {
            this.$69_1($p0.get_advance(), $p0.get_navigate(), this.$0_1.get_selectedStage().get_active());
            this.$90_1(this.$0_1.$1_0.get_businessProcessInstanceStatus());
            $v_0 = this.$S_1.hasClass('hidden');
        }
    ...
    $8w_1: function() {
        if (Mscrm.Utilities.isIosDevice()) {
            ...
            this.$L_1.addClass('stageAdvanceActionContainerForIOS');
            this.$B_1.addClass('stageNavigateActionContainerForIOS');
            this.$S_1.addClass('stageFinishActionContainerForIOS');
        }
        else {
            this.$H_1.removeClass('stageBackActionContainerForIOS');
            this.$L_1.removeClass('stageAdvanceActionContainerForIOS');
            this.$B_1.removeClass('stageNavigateActionContainerForIOS');
            this.$S_1.removeClass('stageFinishActionContainerForIOS');
        }
    },
    ...
    $8x_1: function($p0) {
        ...
        if ($p0 && this.$0_1.get_selectedStage().get_active() && !$v_0) {
            this.$L_1.removeClass('hidden');
        }
        else {
            this.$L_1.addClass('hidden');
        }
    },
    ...
    $69_1: function($p0, $p1, $p2) {
        var $v_0 = this.$0_1.checkBusinessProcessFlowInstanceStatus(this.$0_1.$1_0.get_businessProcessInstanceStatus(), 2);
        if (!$p0 && !$p1 && $p2 && !$v_0) {
            this.$S_1.removeClass('hidden');
        }
        else {
            this.$S_1.addClass('hidden');
        }
    ...
    $6F_1: function() {
        if (!IsNull(this.$3V_1)) {
            ...
            if (!isNullOrEmptyString($v_2)) {
                this.$3V_1.html($v_2);
                if (!IsNull(this.$3W_1)) {
                    this.$3W_1.attr('title', String.format('{0} {1}', this.$0_1.get_processInstanceName(), $v_2));
                }
            }
        }
    },
    ...
    moveAdvance: function(callback) {
        ...
        if (!this.$0_1.checkRequiredCompleted()) {
            ...
            var $$t_3, $$t_4;
            if (!this.$F_1 && !IsNull($v_1) && $v_1.get_EntityLogicalName() === this.$0_1.get_selectedStage().entityLogicalName && (($$t_4 = this.$0_1.canMoveNextViaClientAPI(($$t_3 = {'val': $v_0}))), $v_0 = $$t_3.val, $$t_4)) {
                if (!IsNull(callback)) {
    ...
    moveBack: function(callback) {
        ...
        var $$t_3, $$t_4;
        if (!this.$F_1 && !IsNull($v_1) && $v_1.get_EntityLogicalName() === this.$0_1.get_selectedStage().entityLogicalName && (($$t_4 = this.$0_1.canMovePreviousViaClientAPI(($$t_3 = {'val': $v_0}))), $v_0 = $$t_3.val, $$t_4)) {
            if (!IsNull(callback)) {
    ...
    navigate: function() {
        ...
        if (!IsNull($v_1)) {
            var $$t_5 = this, $$t_6 = this;
            this.$0_1.getSaveStageService().saveDirtyForm().then(function($p1_0) {
                $$t_5.$0_1.navigateToCloseLoop($v_1, $v_0);
            }, function($p1_0) {
            });
            return 0;
        }
...
ProcessControl.Views.CollapsibleView = function(viewModel, processContainer) {
    ...
    this.$0_1 = viewModel;
    this.$4P_1 = processContainer;
    this.$3X_1 = $P_CRM('#processStagesContainer');
    this.$3_1 = $P_CRM('#collapsibleView');
    this.$1a_1 = $P_CRM('#processControlCollapseButtonContainer');
    this.$2b_1 = $P_CRM('#processName');
    this.$51_1 = $P_CRM('#processControlCollapseButton');
    this.$2p_1();
    this.$8z_1();
}
ProcessControl.Views.CollapsibleView.prototype = {
    ...
    get_openAsCollapsed: function() {
        return this.$4H_1 || this.$0_1.$E_0;
    },
    
    $8z_1: function() {
        if (Mscrm.Utilities.isIosDevice()) {
            this.$1a_1.addClass('collapseButtonContainerForIOS');
        }
        else {
            this.$1a_1.removeClass('collapseButtonContainerForIOS');
        }
    },
    ...
    $2p_1: function() {
        var $$t_3 = this;
        this.$3X_1.bind(ProcessControl.Views.CollapsibleView.expandEvent, function() {
            $$t_3.expand();
        });
        this.$1a_1.click(this.$$d_$5C_1);
        var $$t_4 = this;
        this.$1a_1.keydown(function($p1_0) {
            if ($$t_4.$1o_1($p1_0.which)) {
                $$t_4.$5C_1($p1_0);
            }
        });
        var $$t_5 = this;
        this.$2b_1.mouseenter(function($p1_0) {
            $$t_5.$5s_1();
            $$t_5.$26_1.fadeIn(100);
        });
        var $$t_6 = this;
        (this.$2b_1).focusin(function($p1_0) {
            $$t_6.$5s_1();
            $$t_6.$26_1.fadeIn(100);
        });
    },
    ...
    $5s_1: function() {
        var $v_0 = this.$4P_1.width();
        if (this.get_$6c_1().get_agent() === 1) {
            $v_0 = $v_0 - 1;
        }
        var $v_1 = $v_0 - 61;
        this.get_$8E_1().css('max-width', $v_1 + 'px');
    },
    ...
    $8N_1: function() {
        document.cookie = String.format('{0}=0; expires = Tue, 01-Jan-1900 00:00:00 GMT', this.$4d_1());
    },
    ...
    $8n_1: function() {
        ...
        document.cookie = String.format('{0}=1; expires = {1:ddd, dd-MMM}-{2} {3:hh:mm:ss} GMT', this.$4d_1(), $v_0, $v_0.getFullYear(), $v_0);
    },
    ...
    get_$8E_1: function() {
        if (!this.$26_1) {
            this.$26_1 = $P_CRM('#processNameText', this.$3_1);
        }
        return this.$26_1;
    },
    ...
    get_$6c_1: function() {
        if (!this.$19_1) {
            this.$19_1 = Mscrm.CrmBrowser.get_currentBrowser();
        }
        return this.$19_1;
    }
}
...
ProcessControl.Views.ProcessControlView = function(viewModel) {
    ...
    this.$$d_$82_1 = Function.createDelegate(this, this.$82_1);
    this.$$d_$7w_1 = Function.createDelegate(this, this.$7w_1);
    this.$$d_$7p_1 = Function.createDelegate(this, this.$7p_1);
    this.$$d_$7r_1 = Function.createDelegate(this, this.$7r_1);
    this.$$d_$95_1 = Function.createDelegate(this, this.$95_1);
    this.$y_1 = ProcessControl.StopwatchFactory.createStopwatch('ProcessControl.SlideDown');
    ...
    ProcessControl.Views.ProcessControlView.$8M(this.$3_1);
    ProcessControl.Views.ProcessControlView.$G = $P_CRM('body').css('direction').toLowerCase() === 'rtl';
    this.$M_1 = new ProcessControl.Views.StagesView(viewModel);
    this.$A_1 = new ProcessControl.Views.StepsView(viewModel);
    this.$X_1 = new ProcessControl.Views.ActionsView(viewModel);
    this.$R_1 = new ProcessControl.Views.CollapsibleView(viewModel, this.$3_1);
    this.$Q_1 = new ProcessControl.ClientApi.ProcessObjectBuilder();
    $v_1.stop();
    this.set_dataContext(viewModel);
    this.$m_1 = new ProcessControl.Views.WarningBarView(this.$3_1, viewModel);
    this.$2X_1 = $P_CRM('#processControlCollapsibleArea');
    this.$1D_1 = $P_CRM('#processHeaderArea');
    if (this.$1D_1 && this.$1D_1.find('#processStagesScrollRegion')) {
        for (var $v_2 = 0; $v_2 < this.$1D_1.find('#processStagesScrollRegion').contents().length; $v_2++) {
            ProcessControl.Views.ProcessControlView.registerChildWithXrmUIControl(this.$1D_1, 'stage_' + $v_2, 'ProcessStage', 'processControlContainer');
        }
    }
    this.$1T_1 = $P_CRM('#processControlScrollPane');
    this.$3b_1 = $P_CRM('#processControlScrollbarContainer');
    this.$23_1 = $P_CRM('#processScrollbarMask');
    this.$1Q_1 = $P_CRM('#processStepsContainer');
    if (this.$1Q_1 && this.$1Q_1.find('.processStepsContent')) {
        for (var $v_3 = 0; $v_3 < this.$1Q_1.find('.processStepsContent').contents().length; $v_3++) {
            ProcessControl.Views.ProcessControlView.registerChildWithXrmUIControl(this.$1D_1, 'processSteps_' + $v_3, 'ProcessStep', 'processStepsContainer');
            for (var $v_4 = 0; $v_4 < this.$1Q_1.find('#processSteps_' + $v_3).contents().length; $v_4++) {
                ProcessControl.Views.ProcessControlView.registerChildWithXrmUIControl(this.$1D_1, 'processStepColumn_' + $v_4 + '_' + $v_3, 'ProcessStepColumn', 'ProcessSteps');
            }
        }
    }
    this.$19_1 = Mscrm.CrmBrowser.get_currentBrowser();
...
ProcessControl.Views.ProcessControlView.get_isRtl = function() {
    return ProcessControl.Views.ProcessControlView.$G;
}
ProcessControl.Views.ProcessControlView.$8M = function($p0) {
    var $v_0 = {};
...
ProcessControl.Views.ProcessControlView.$7c = function() {
...
ProcessControl.Views.ProcessControlView.getAllEnabledProcesses = function(entityTypeName, processObjectBuilder, callback) {
    ...
    Xrm.Internal.messages.retrieveFilteredProcesses(entityTypeName).then(function($p1_0) {
        ...
        if ($v_0 && $v_0.processes.get_count() > 0) {
            var $v_2 = $v_0.processes;
            if ($v_2) {
                $v_1 = processObjectBuilder.businessProcessFlowListBuilder($v_2);
            }
        }
        if (!IsNull(callback)) {
            callback($v_1);
...
ProcessControl.Views.ProcessControlView.prototype = {
    ...
    get_$35_1: function() {
        return (ProcessControl.Views.ProcessControlView.$G) ? 'margin-right' : 'margin-left';
    },
    ...
    set_dataContext: function(value) {
        ...
        this.$38_1();
        this.$2_1 = value;
        this.$2_1.add_stageAttributeRefreshed(this.$$d_$95_1);
        this.$2_1.add_actionStepDataChanged(this.$$d_$7r_1);
        this.$2_1.add_newEntitySaved(this.$$d_$7p_1);
        this.$X_1.set_dataContext(this.$2_1);
        return value;
    },
    
    $7r_1: function($p0, $p1) {
        var $v_0 = ProcessControl.StopwatchFactory.createStopwatch(' ProcessControl.ActionStep.DataChange');
        $v_0.start();
        var $v_1 = this.$2_1.$1b_0;
        var $v_2 = {};
        if (!IsNull($p1.results)) {
            $v_2 = $p1.results;
        }
        for (var $$arr_5 = $v_1.get_keys(), $$len_6 = $$arr_5.length, $$idx_7 = 0; $$idx_7 < $$len_6; ++$$idx_7) {
            var $v_3 = $$arr_5[$$idx_7];
            var $v_4 = $v_1.get_item($v_3);
            var $v_5 = this.$2_1.$1_0.get_process().getStepWithId($v_4);
            var $v_6 = this.$Q_1.processStepBuilder($v_5.get_parent());
            var $v_7 = $v_2[($v_5).get_actionId()];
            if (IsNull($v_7)) {
                continue;
            }
            var $v_8 = $v_7.Status;
            var $v_9 = (IsNull($v_7.ModifiedOn)) ? '' : $v_7.ModifiedOn.toLocaleString();
            var $v_A = '';
            if (!isNullOrEmptyString($v_9)) {
                $v_A = String.format(Microsoft.Crm.Client.Core.Framework.Common.ResourceManager.getLocalizedString('ProcessControl.ActionExecuter.ExecutionTimeTooltip'), $v_9);
            }
            if ($v_8 === 2) {
                $v_6.setProgress(2, $v_A);
            }
            else if ($v_8 === 3) {
                var $v_B = Microsoft.Crm.Client.Core.Framework.Common.ResourceManager.getLocalizedString('Crm.GenericErrorMessage');
                if (!Mscrm.InternalUtilities.JSTypes.isNullOrEmptyString($p1.errorMessage)) {
                    $v_B = $p1.errorMessage;
                }
                var $v_C = String.format(Microsoft.Crm.Client.Core.Framework.Common.ResourceManager.getLocalizedString('ProcessControl.ActionExecuter.ErrorMessageTooltip'), $v_B);
                var $v_D = $v_A + '\n' + $v_C;
                $v_6.setProgress(3, $v_D);
            }
            else if ($v_8 === 1) {
                $v_6.setProgress(1);
            }
    ...
    $38_1: function() {
        if (!IsNull(this.$2_1)) {
            this.$2_1.remove_stageAttributeRefreshed(this.$$d_$95_1);
            this.$2_1.remove_actionStepDataChanged(this.$$d_$7r_1);
            this.$2_1.remove_newEntitySaved(this.$$d_$7p_1);
            if (!IsNull(this.$2_1.get_defaultPathManager())) {
                this.$2_1.get_defaultPathManager().remove_defaultPathInitialized(this.$$d_$7w_1);
            }
        }
    },
    
    $6T_1: function() {
        var $v_0 = this.$19_1.get_name();
        if (this.$19_1.get_isIE8()) {
            $v_0 += ' ie8';
        }
        if (ProcessControl.Views.ProcessControlView.$G) {
            $v_0 += ' rtl';
        }
        if (ProcessControl.Views.ProcessControlView.$7c()) {
            $v_0 += ' highContrast';
        }
        if (this.get_$85_1()) {
            $v_0 += ' outlook';
    ...
    $2p_1: function() {
        ...
        this.$M_1.get_viewContainer().bind(ProcessControl.Views.StagesView.stageChange, function($p1_0) {
            ...
            if ($$t_4.$2_1.get_localActiveStage()) {
                $$t_4.$X_1.changeActionStatus($$t_4.$2_1.get_selectedStage(), arguments[1]);
            }
            $$t_4.$2n_1();
            $$t_4.$4q_1();
            var $v_0 = $$t_4.$5z_1();
            $$t_4.$M_1.resize($$t_4.$X_1.get_containerWidth(), $v_0 - 25);
            $$t_4.$4r_1(null);
            if (window.UseTabletExperience && ProcessControl.Views.ProcessControlView.$G) {
                $$t_4.$64_1();
            }
        });
    },
    ...
    $4r_1: function($p0) {
        window.clearTimeout(this.$4R_1);
        var $$t_1 = this;
        this.$4R_1 = window.setTimeout(function() {
    ...
    $94_1: function($p0) {
        ...
        if ($v_1 > $v_0) {
            var $v_2 = (ProcessControl.Views.ProcessControlView.$G) ? 100 - $p0.value : $p0.value;
            var $v_3 = $v_2 / 100 * ($v_0 - $v_1);
            this.$A_1.get_viewContainer().css(this.get_$35_1(), $v_3 + 'px');
        }
        else {
            this.$A_1.get_viewContainer().css(this.get_$35_1(), '0px');
        }
    },
    ...
    $41_1: function() {
        ...
        this.$5z_1();
        this.$M_1.resize(this.$X_1.get_containerWidth(), this.$D_1 - 25);
        this.$60_1();
        if (window.UseTabletExperience && ProcessControl.Views.ProcessControlView.$G) {
            this.$64_1();
        }
    ...
    $5z_1: function() {
        var $v_0 = Math.max(this.$D_1 - 25 - 0, this.$M_1.$27_1);
        this.$M_1.setWidth($v_0);
        var $v_1 = (this.$D_1 < this.$3J_1) ? this.$3J_1 : this.$D_1;
        this.$1D_1[0].style.minWidth = $v_1 + 'px';
        return this.$D_1;
    },
    ...
    $8p_1: function() {
        this.$3J_1 = this.$M_1.$27_1 + 0 + this.$X_1.get_containerWidth();
    },
    ...
    processLayout: function() {
        ...
        this.$X_1.processLayout();
        this.$R_1.processLayout();
        this.$m_1.processLayout();
        $v_0.stop();
    },
    ...
    render: function() {
        ...
        $v_2.stop();
        this.resize();
        this.$3Y_1 = this.$2_1.get_defaultPathManager().get_defaultPathHash();
        if (!IsNull(this.$2_1) && !IsNull(this.$2_1.get_defaultPathManager())) {
            this.$2_1.get_defaultPathManager().remove_defaultPathInitialized(this.$$d_$7w_1);
            this.$2_1.get_defaultPathManager().add_defaultPathInitialized(this.$$d_$7w_1);
        }
        $v_0.stop();
    },
    ...
    $68_1: function($p0) {
        ...
        this.$R_1.$q_1 = 1;
        this.$2X_1.slideDown($p0, this.$$d_$82_1);
    },
    ...
    completeInitialization: function() {
        this.reflow(true);
        this.$3b_1.find('a').attr('title', this.$2_1.$8_0.slider);
        ...
        if (!this.$R_1.get_openAsCollapsed() && !this.$R_1.$q_1) {
            var $$t_2 = this;
            window.setTimeout(function() {
                if (!$$t_2._disposed) {
                    $$t_2.$68_1(1000);
    ...
    $6u_1: function() {
        ...
        Mscrm.Utilities.safeDispose(this.$X_1);
        Mscrm.Utilities.safeDispose(this.$R_1);
        Mscrm.Utilities.safeDispose(this.$m_1);
    },
    
    $49_1: function() {
        $P_CRM(window).unbind(Mscrm.FormNavControl.toggleEvent, this.$$d_$7y_1);
        $P_CRM(window).unbind('resize', this.$$d_$4r_1);
        this.$A_1.get_viewContainer().unbind();
        this.$M_1.get_viewContainer().unbind();
        if (!IsNull(this.$a_1)) {
            this.$a_1.unbind('slide');
        }
        this.$X_1.get_viewContainer().unbind();
        this.$R_1.get_viewContainer().unbind();
        this.$23_1.unbind();
        if (!IsNull(this.$1V_1)) {
            this.$1V_1.remove_processSwitched(this.$$d_$5o_1);
            this.$1V_1.dispose();
        }
    },
    ...
    $88_1: function() {
        ...
        $P_CRM(window).bind(Mscrm.FormNavControl.toggleEvent, this.$$d_$7y_1);
        if (this.get_$1L_1()) {
            var $$t_F = this;
        ...
        $P_CRM(window).bind('resize', this.$$d_$4r_1);
        var $$t_G = this;
        ...
        var $$t_K = this;
        this.$X_1.get_viewContainer().bind(ProcessControl.Views.ActionsView.actionCompleted, function($p1_0) {
        ...
        var $$t_L = this;
        this.$R_1.get_viewContainer().bind(ProcessControl.Views.CollapsibleView.expanded, function($p1_0) {
            if ($$t_L.$y_1) {
                $$t_L.$y_1.start();
            ...
            $$t_L.$2X_1.slideDown(500, $$t_L.$$d_$82_1);
            $$t_L.$2n_1();
        });
        var $$t_M = this;
        this.$R_1.get_viewContainer().bind(ProcessControl.Views.CollapsibleView.collapsed, function($p1_0) {
            $$t_M.$2X_1.slideUp(500, function() {
                $P_CRM(window).trigger('resize-header');
            });
            $$t_M.$2n_1();
        });
        if (this.$19_1.get_agent() === 1) {
            var $$t_N = this;
            this.$23_1.bind('click', function($p1_0) {
                $$t_N.$87_1($p1_0);
            });
        }
        this.$1M_1 = true;
    ...
    $4Z_1: function($p0, $p1) {
        if ($p0.stageIndex === this.$M_1.$1A_1) {
            return;
        }
    ...
    $8t_1: function($p0) {
        var $v_0 = this.$1T_1.offset();
        var $v_1 = $v_0.left + this.$1T_1.width();
        var $v_2 = $p0 - $v_1 + 20;
        if ($v_2 <= 0) {
            return;
        }
    ...
    $4o_1: function() {
        ...
        var $v_0 = ((ProcessControl.Views.ProcessControlView.$G) ? '100' : '0') + '%';
        this.$a_1.find('.ui-slider-handle').css('left', $v_0);
    },
    
    $8J_1: function() {
        var $v_0 = this.$A_1.get_viewContainer().css(this.get_$35_1());
        var $v_1 = parseInt($v_0);
        var $v_2 = this.$A_1.get_viewContainer().width() + $v_1;
        var $v_3 = this.$1T_1.width() - $v_2;
        if ($v_3 > 0) {
            this.$A_1.get_viewContainer().css(this.get_$35_1(), $v_1 + $v_3 + 'px');
        }
    },
    ...
    $64_1: function() {
        if (this.$1T_1 && this.$1Q_1) {
            var $v_0 = this.$1Q_1.width();
            var $v_1 = this.$1T_1.width();
            if ($v_0 > $v_1) {
                this.$1T_1.scrollLeft($v_0 - $v_1);
            }
        }
    },
    ...
    reflow: function(updateUI, parentStage, nextStage) {
        ...
        if (this.$2_1.get_businessProcessInstanceState() === 1) {
            return;
        }
    ...
    getDisplayState: function() {
        ...
        switch (this.$R_1.$q_1) {
            ...
            case 1:
                ...
                break;
            default:
                $v_0 = ProcessControl.Views.CollapsibleStatus.toString(this.$R_1.$q_1);
                break;
        }
        return $v_0;
    },
    ...
    getActiveProcess: function() {
        ...
        if ($v_0) {
            this.$4E_1 = $v_0.getAttribute('data-title');
        }
        var $v_1 = this.$2_1.getProcessStages();
        var $v_2 = this.$Q_1.businessProcessFlowBuilder(this.$2_1.get_processId(), this.$2_1.get_processInstanceId(), this.$2_1.get_processInstanceName(), this.$4E_1, this.$2_1.get_businessProcessInstanceState(), this.$2_1.get_businessProcessInstanceStatus(), true, $v_1);
        return $v_2;
    },
    ...
    getActiveStage: function() {
        ...
        var $v_2 = this.$Q_1.processStageBuilder($v_0, $v_1, $v_1.entityLogicalName, 1);
        return $v_2;
    },
    ...
    getActivePath: function() {
        ...
        for (var $$arr_4 = this.$2_1.get_defaultPath(), $$len_5 = $$arr_4.length, $$idx_6 = 0; $$idx_6 < $$len_5; ++$$idx_6) {
            ...
            $v_2 = this.$Q_1.processStageBuilder($v_0, $v_1, $v_1.entityLogicalName, $v_5);
            $v_3.add($v_2);
        }
        return $v_3;
    },
    ...
    switchProcess: function() {
        if (IsNull(this.$1V_1)) {
            var $v_0 = $P_CRM('body');
            var $v_1 = Xrm.Page.data.entity.getEntityName();
            this.$1V_1 = new Mscrm.SwitchProcessFlyOut($v_0, Xrm.Page.data.entity.getId(), $v_1);
            this.$1V_1.add_processSwitched(this.$$d_$5o_1);
        }
        this.$1V_1.selectView(false);
    },
    ...
    getEnabledProcesses: function(callback) {
        ProcessControl.Views.ProcessControlView.getAllEnabledProcesses(this.$2_1.$7_0.TypeName, this.$Q_1, callback);
    },
    
    moveNext: function(callback) {
        this.$X_1.moveAdvance(callback);
    },
    
    movePrevious: function(callback) {
        this.$X_1.moveBack(callback);
    },
    ...
    addOnStageChange: function(handler, system) {
        this.$2_1.$6P_0(handler, !!system);
    },
    
    removeOnStageChange: function(handler) {
        this.$2_1.$8Q_0(handler);
    },
    
    addOnProcessChange: function(handler, system) {
        this.$2_1.$6N_0(handler, !!system);
    },
    
    removeOnProcessChange: function(handler) {
        this.$2_1.$8O_0(handler);
    },
    
    addOnProcessStatusChange: function(handler, system) {
        this.$2_1.$6O_0(handler, !!system);
    },
    
    removeOnProcessStatusChange: function(handler) {
        this.$2_1.$8P_0(handler);
    },
    
    addOnStageSelected: function(handler, system) {
        this.$2_1.$6Q_0(handler, !!system);
    },
    
    removeOnStageSelected: function(handler) {
        this.$2_1.$8R_0(handler);
    },
...
ProcessControl.Views.StagesView = function(viewModel) {
    ...
    this.$0_1 = viewModel;
    this.$3U_1 = $P_CRM('#processHeaderContainer');
...
ProcessControl.Views.StagesView.prototype = {
    ...
    get_$16_1: function() {
        if (!this.$3N_1) {
            this.$3N_1 = $P_CRM('#leftScrollButton', this.$3U_1);
        }
        return this.$3N_1;
    },
    ...
    get_$x_1: function() {
        if (!this.$3Z_1) {
            this.$3Z_1 = $P_CRM('#rightScrollButton', this.$3U_1);
        }
        return this.$3Z_1;
    },
    ...
    get_$3w_1: function() {
        if (!this.$3O_1) {
            this.$3O_1 = $P_CRM('.globalActiveStageFlag', this.get_$16_1());
        }
        return this.$3O_1;
    },
    ...
    get_$42_1: function() {
        if (!this.$3a_1) {
            this.$3a_1 = $P_CRM('.globalActiveStageFlag', this.get_$x_1());
        }
        return this.$3a_1;
    },
    ...
    get_$h_1: function() {
        if (!this.$3c_1) {
            this.$3c_1 = $P_CRM('#processStagesScrollRegion');
        }
        return this.$3c_1;
    },
    
    get_$43_1: function() {
        return this.$1I_1(this.get_currentSelectedStageIndex());
    },
    
    get_$1v_1: function() {
        var $v_0 = (!this.$G_1) ? this.get_$h_1().css('margin-left') : this.get_$h_1().css('margin-right');
        return parseInt($v_0.substring(0, $v_0.length - 2));
    },
    
    get_$1q_1: function() {
        return (!this.$G_1) ? 'margin-left' : 'margin-right';
    },
    
    $66_1: function() {
        this.$27_1 = 200;
        this.$3_1.css('min-width', this.$27_1 + 'px');
        var $v_0 = this.$0_1.get_stages().length;
        var $v_1 = $P_CRM('.processStageContainer').filter('.hideStage').length;
        this.$22_1 = ($v_0 - $v_1) * 145;
        this.get_$h_1().css('min-width', this.$22_1 + 'px');
    },
    ...
    $6A_1: function($p0, $p1) {
        var $v_0 = this.$0_1.$7f_0($p0.currentStageValue, $p1);
        var $v_1 = this.$1I_1($p0.stageIndex);
        ...
        if (!$v_0 === $p0.isVisible) {
            ...
            if ($v_0) {
                ...
                if (this.$7h_1($p0)) {
                    this.$3n_1(this.$0_1.get_localActiveStage());
                }
            }
        }
    ...
    resize: function(actionsContainerWidth, viewContainerWidth) {
        ...
        $v_4.css($v_3);
        this.$4F_1 = Math.max($v_2, 135);
        this.$6w_1(viewContainerWidth);
        if (this.$1S_1) {
            this.$8c_1(viewContainerWidth);
            this.$8l_1();
            this.$2F_1();
            if (this.$4L_1 !== actionsContainerWidth) {
                this.get_$x_1().css((!this.$G_1) ? 'right' : 'left', (actionsContainerWidth - 3) + 'px');
                this.$4L_1 = actionsContainerWidth;
            }
        }
    },
    
    $8c_1: function($p0) {
        this.$1O_1 = this.$22_1 - $p0 + this.$1u_1;
        if (this.get_$1v_1() < -this.$1O_1) {
            this.get_$h_1().css(this.get_$1q_1(), -this.$1O_1 + 'px');
        }
    },
    
    $8l_1: function() {
        if (!this.get_$43_1().length) {
            this.get_$h_1().css(this.get_$1q_1(), this.$1u_1 + 'px');
            return;
        }
        var $v_0 = this.$3m_1(this.get_currentSelectedStageIndex());
        var $v_1 = $v_0 + this.$3_1.innerWidth() - this.get_$43_1().outerWidth() - 2 * this.$1u_1;
        if (this.get_$1v_1() >= $v_0 && this.get_$1v_1() <= $v_1) {
            return;
        }
    ...
    $6w_1: function($p0) {
        if (!this.$1S_1 && this.$22_1 > $p0) {
            this.$1S_1 = true;
            this.get_$16_1().css('display', 'block');
            this.get_$x_1().css('display', 'block');
            this.$5R_1(this.$1u_1);
        }
        else if (this.$1S_1 && this.$22_1 < $p0) {
            this.$1S_1 = false;
            this.get_$16_1().css('display', 'none');
            this.get_$x_1().css('display', 'none');
    ...
    processLayout: function() {
        ...
        $v_0.start();
        Object.getType(this.get_$16_1());
        Object.getType(this.get_$x_1());
        Object.getType(this.get_$3w_1());
        Object.getType(this.get_$42_1());
    ...
    render: function() {
        ...
        for (var $v_5 = 0; $v_5 < $v_1; $v_5++) {
            ...
            this.$8V_1($v_6, $v_7, $v_3, $P_CRM($v_4[$v_5]));
        }
        this.$66_1();
        $v_0.stop();
    },
    ...
    $5w_1: function($p0) {
        ...
        $v_1.find('.globalActiveStageFlag').click(this.$$d_$7L_1);
    },
    
    $7C_1: function() {
        var $v_0 = this.get_$1v_1();
        for (var $v_1 = 0; $v_1 < this.get_renderedStages().length; $v_1++) {
            var $v_2 = this.$3m_1($v_1);
            if ($v_2 <= $v_0) {
                return $v_1;
            }
        }
    ...
    $7M_1: function($p0) {
        var $v_0 = this.$7C_1();
        if (this.$3E_1 || (!$p0 && !$v_0) || ($p0 && $v_0 === this.get_renderedStages().length - 1)) {
            return;
        }
        var $v_1 = $v_0 + (($p0) ? 1 : -1);
        var $v_2 = this.$3m_1($v_1);
        if ($v_2 === this.get_$1v_1()) {
            return;
        }
    ...
    $2F_1: function() {
        if (!this.get_$1W_1().length) {
            return;
        }
        if (this.$1S_1 && this.$8u_1()) {
            this.get_$3w_1().css('visibility', 'visible');
            this.get_$42_1().css('visibility', 'hidden');
            this.get_$1W_1().css('visibility', 'hidden');
        }
        else if (this.$1S_1 && this.$8v_1()) {
            this.get_$42_1().css('visibility', 'visible');
            this.get_$3w_1().css('visibility', 'hidden');
            this.get_$1W_1().css('visibility', 'hidden');
        }
        else {
            this.get_$3w_1().css('visibility', 'hidden');
            this.get_$42_1().css('visibility', 'hidden');
            this.get_$1W_1().css('visibility', '');
        }
    },
    
    $8u_1: function() {
        return ((!this.$G_1 && this.get_$1W_1().offset().left < this.get_$16_1().offset().left) || (this.$G_1 && this.get_$1W_1().offset().left > this.get_$16_1().offset().left));
    },
    
    $8v_1: function() {
        return (!this.$G_1 && this.get_$1W_1().offset().left > this.get_$x_1().offset().left) || (this.$G_1 && this.get_$1W_1().offset().left < this.get_$x_1().offset().left);
    },
    
    $3m_1: function($p0) {
        var $v_0 = ($p0 > 0) ? this.$53_1 : 0;
        return -1 * (this.$4F_1 - 5) * $p0 + this.$1u_1 - $v_0;
    },
    
    $5R_1: function($p0) {
        if ($p0 <= -this.$1O_1) {
            this.get_$16_1().removeClass('disabled');
            this.get_$x_1().addClass('disabled');
        }
        else if ($p0 >= this.$1u_1) {
            this.get_$16_1().addClass('disabled');
            this.get_$x_1().removeClass('disabled');
        }
        else {
            this.get_$16_1().removeClass('disabled');
            this.get_$x_1().removeClass('disabled');
    ...
    $7L_1: function($p0) {
        ...
        this.$3E_1 = true;
        var $v_1 = this.$3m_1(this.$1A_1);
        $v_1 = Math.max($v_1, -this.$1O_1);
        this.$3d_1 = 1;
        var $$t_3 = this;
        this.$4G_1 = window.setInterval(function() {
            $$t_3.$74_1($v_1);
        }, 10);
        var $$t_4 = this;
        this.$4S_1 = window.setInterval(function() {
            $$t_4.$3d_1 *= 2;
        }, 300);
    },
    
    $74_1: function($p0) {
        var $v_0 = $p0 < this.get_$1v_1();
        var $v_1 = this.get_$1v_1() + (($v_0) ? -1 : 1) * this.$3d_1;
        if (($v_0 && $v_1 < $p0) || (!$v_0 && $v_1 > $p0)) {
            window.clearInterval(this.$4G_1);
            window.clearInterval(this.$4S_1);
    ...
    $8F_1: function($p0, $p1) {
        ...
        $p1.children()[1].title = this.$4e_1($p0, '');
        this.$6Z_1($p0, $p1);
    },
    
    $8V_1: function($p0, $p1, $p2, $p3) {
        this.$5v_1($p3);
        $p3.addClass(this.$5a_1($p0, $p1));
        var $v_0 = this.$0_1.checkBusinessProcessFlowInstanceStatus(this.$0_1.$1_0.get_businessProcessInstanceStatus(), 3);
        var $v_1 = this.$0_1.checkBusinessProcessFlowInstanceStatus(this.$0_1.$1_0.get_businessProcessInstanceStatus(), 2);
        if ($v_1) {
    ...
    $49_1: function() {
        for (var $v_0 = 0; $v_0 < this.$0_1.get_stages().length; $v_0++) {
            ...
            var $v_2 = this.$1I_1($v_1.stageIndex).children();
            var $v_3 = $v_2.parents('.processStageContainer').first();
            $v_3.unbind();
        }
        this.$6C_1(this.get_$16_1());
        this.$6C_1(this.get_$x_1());
    },
    ...
    $6I_1: function() {
        for (var $v_0 = 0; $v_0 < this.$0_1.get_stages().length; $v_0++) {
            var $v_1 = this.$1I_1($v_0).children('.processStageTailContainer, .stageLabelMask');
            this.$8q_1(this.$0_1.get_stages()[$v_0], $v_1);
        }
    },
    ...
    $9G_1: function() {
        for (var $v_0 = 0; $v_0 < this.$0_1.get_stages().length; $v_0++) {
            ...
            this.$5v_1($v_1);
            $v_1.addClass(this.$5a_1($v_2, $v_4));
        }
    },
    ...
    $6H_1: function() {
        for (var $v_0 = 0; $v_0 < this.$0_1.get_stages().length; $v_0++) {
            var $v_1 = this.$1I_1($v_0);
            var $v_2 = $v_1.find('span');
            this.$67_1(this.$0_1.get_stages()[$v_0], $v_2);
        }
    },
    ...
    $6L_1: function($p0) {
        ...
        if ($v_0 || isNullOrEmptyString(this.$0_1.get_activeStageActiveFor())) {
            return this.$4k_1($p0) + ' ' + this.$0_1.$8_0.active;
        }
        else {
            return this.$4k_1($p0) + String.format('<span style=\'text-transform: none\'> {0}</span>', String.format(this.$0_1.$8_0.activeFor, this.$0_1.get_activeStageActiveFor()));
        }
    },
    ...
    $67_1: function($p0, $p1) {
        ...
        if ($p0.get_active() && !$v_0) {
            $p1.html(this.$6L_1($p0));
        }
        else {
            $p1.text(this.$4k_1($p0));
        }
    },
    ...
    $8q_1: function($p0, $p1) {
        var $v_0 = this.$5b_1($p0);
        var $v_1 = this.$4e_1($p0, $v_0);
        $p1.attr('title', $v_1);
    },
    ...
    changeStageCompleted: function(newActiveStage, advance) {
        this.$6h_1(newActiveStage, advance);
        this.$3n_1(newActiveStage);
        this.$6I_1();
        this.$9G_1();
        this.$6G_1();
        this.$6H_1();
    ...
    $6t_1: function() {
        for (var $v_0 = 0; $v_0 < this.$0_1.get_stages().length; $v_0++) {
            this.$6A_1(this.$0_1.get_stages()[$v_0], this.$0_1.get_defaultPath());
        }
        this.$66_1();
    },
...
ProcessControl.Views.StepsView = function(viewModel) {
    this.$$d_$5n_1 = Function.createDelegate(this, this.$5n_1);
    ...
    this.$0_1 = viewModel;
    this.$1M_1 = false;
    this.$4B_1 = new ProcessControl.Views.StepsView.StageStepsButtonStateProcessor(viewModel);
    this.$6a_1();
}
ProcessControl.Views.StepsView.$9A = function($p0) {
    var $v_0 = $p0.find('[tabindex]');
    $v_0.children().unbind('keyup');
    $p0.unbind('keyup');
}
ProcessControl.Views.StepsView.$7E = function($p0) {
...
ProcessControl.Views.StepsView.prototype = {
    ...
    get_businessRuleService: function() {
        if (IsNull(this.$2T_1)) {
            this.$2T_1 = new ProcessControl.Services.BusinessRuleService();
        }
        return this.$2T_1;
    },
    ...
    $9D_1: function() {
        for (var $v_0 = 0; $v_0 < this.$0_1.get_stages().length; $v_0++) {
            var $v_1 = this.$0_1.get_stages()[$v_0];
            var $v_2 = this.$1Y_1($v_1.stageIndex);
            var $v_3 = this.getStageSteps($v_1.stageIndex);
            $v_3.unbind();
            ProcessControl.Views.StepsView.$9A($v_2);
            this.$9E_1($v_1.stageIndex);
            this.$9B_1($v_2);
        }
    },
    ...
    $9B_1: function($p0) {
        ...
        for (var $v_1 = 0; $v_1 < $v_0.length; $v_1++) {
            var $v_2 = $v_0[$v_1];
            var $v_3 = $P_CRM($v_2);
            $v_3.unbind('attribute-changed', this.$$d_$6i_1);
        }
    },
    
    $9E_1: function($p0) {
        var $v_0 = this.$5c_1($p0);
        for (var $v_1 = 0; $v_1 < $v_0.length; $v_1++) {
            var $v_2 = $v_0[$v_1];
            var $v_3 = $P_CRM($v_2);
            $v_3.unbind('attribute-changed', this.$$d_$7u_1);
        }
    },
    
    $38_1: function() {
        this.$0_1.remove_stageGatesVisibilityChanged(this.$$d_$5n_1);
    },
    
    $6a_1: function() {
        this.$0_1.add_stageGatesVisibilityChanged(this.$$d_$5n_1);
    },
    
    $5n_1: function($p0, $p1) {
        if (this.$0_1.$2l_0) {
            this.$r_1.removeClass('stageGatesHidden');
        }
        else {
            this.$r_1.addClass('stageGatesHidden');
        }
    },
    ...
    processLayout: function() {
        ...
        for (var $v_1 = 0; $v_1 < this.$0_1.get_stages().length; $v_1++) {
            ...
            var $v_3 = this.$1Y_1($v_2.stageIndex);
            if (!$v_3.hasClass('hidden')) {
                $v_3.addClass('hidden');
            }
            this.$8H_1($v_2.stageIndex);
        }
        $v_0.stop();
    },
    ...
    $8H_1: function($p0) {
        ...
        $v_0.unbind('stepControlNarrow').bind('stepControlNarrow', function($p1_0) {
            var $v_4 = $$t_9.$r_1.find('[id^=processStepColumn_]');
            $$t_9.$D_1 = $v_4.length * $$t_9.get_$5I_1() + $v_4.length;
    ...
    $5x_1: function($p0) {
        var $v_0 = this.$1Y_1($p0.stageIndex);
        var $v_1 = '';
    ...
    $7Z_1: function($p0) {
        return ProcessControl.Constants.CriticalAttributes.isCriticalAttribute($p0) && this.$5h_1();
    },
    ...
    changeCurrentSteps: function() {
        ...
        this.$r_1 = this.$1Y_1(this.$0_1.get_selectedStage().stageIndex);
        this.$r_1.removeClass('hidden');
        this.$98_1(this.$0_1.get_selectedStage());
        this.$61_1(this.$0_1.get_selectedStage());
    },
    ...
    $98_1: function($p0) {
        ...
        if (!ProcessControl.Services.ProcessControlInitializer.$N) {
            var $v_0 = this.$r_1.find('div[' + Mscrm.InlineEditConstants.HtmlAttributeForAttributeLogicalName + '][' + 'data-fdeid' + '=PrimaryEntity]');
            var $v_1 = this.$6z_1($v_0);
            var $v_2 = this.$6y_1($v_1);
            var $v_3 = Mscrm.ErrorDisplayContainerProviderFactory.createFormErrorDisplayContainerProvider();
            var $v_4 = Mscrm.InlineEditControlInitializersFactory.createDomElementInitializer($v_3, this.$0_1.$1c_0, $v_1.get(), false);
    ...
    $6z_1: function($p0) {
        var $v_0 = {};
        var $$t_7 = this;
        this.$r_1.find('.ms-crm-LinkControl-content div[' + Mscrm.InlineEditConstants.HtmlAttributeForAttributeLogicalName + ']').each(function($p1_0, $p1_1) {
            $v_0[$p1_1.id] = $p1_1;
        });
        var $$t_8 = this;
    ...
    $61_1: function($p0) {
        ...
        this.$D_1 = $v_0 * this.get_$5I_1() + $v_0;
    ...
    $59_1: function($p0) {
        ...
        for (var $v_1 = 0; $v_1 < $v_0.length; $v_1++) {
            ...
            if (!ProcessControl.Services.ProcessControlInitializer.$N) {
                ...
                this.$4y_1($v_6, $v_5, false);
                this.$4x_1($v_6);
            }
            $v_3.unbind('attribute-changed', this.$$d_$7u_1).bind('attribute-changed', this.$$d_$7u_1);
        }
    },
    ...
    $7u_1: function($p0) {
        ...
        for (var $v_7 = 0; $v_7 < $v_6.length; $v_7++) {
            ...
            if ($v_4 === $v_8.getAttribute('data-attributename')) {
                ...
                this.$4y_1($v_A, $v_1, false);
                this.$4x_1($v_3);
            }
        }
    },
    
    $4y_1: function($p0, $p1, $p2) {
    ...
    $6j_1: function($p0) {
        var $v_0 = ProcessControl.Views.StepsView.$7E($p0);
        for (var $v_1 = 0; $v_1 < $v_0.length; $v_1++) {
            var $v_2 = $v_0[$v_1];
            var $v_3 = Mscrm.FormControlInputBehavior.GetBehavior($v_2.id);
            if (IsNull($v_3)) {
            ...
            if ($v_4.get_isEligibleForMarkComplete()) {
                var $v_5 = $P_CRM($v_2);
                this.$58_1($v_5, $v_4);
                $v_5.unbind('attribute-changed', this.$$d_$6i_1).bind('attribute-changed', this.$$d_$6i_1);
            }
        }
    },
    ...
    getStageSteps: function(stageIndex) {
        ...
        if ((($v_0) in this.$3i_1)) {
            return this.$3i_1[$v_0];
        }
        else {
            var $v_1 = this.$1Y_1(stageIndex);
...
ProcessControl.Views.StepsView.StageStepsButtonStateProcessor = function($p0) {
    this.$2_0 = $p0;
    this.$Q_0 = new ProcessControl.ClientApi.ProcessObjectBuilder();
}
ProcessControl.Views.StepsView.StageStepsButtonStateProcessor.prototype = {
    $Q_0: null,
    $2_0: null,
    
    $6s_0: function() {
        return this.$2_0.$E_0 || this.$2_0.$V_0 || (window.IS_OUTLOOK_CLIENT && !window.IS_ONLINE);
    },
    
    $8C_0: function($p0) {
        var $v_0 = $p0;
        if (!IsNull($v_0.get_actionControl())) {
            var $v_1 = $v_0.get_actionControl().get_controlId();
            if (!isNullOrEmptyString($v_1)) {
                var $v_2 = this.$Q_0.processStepBuilder($p0.get_parent());
                if (this.$6s_0()) {
                    $v_2.setProgress(1);
                    var $v_3 = Xrm.Page.ui.controls.get('header_process_' + $v_1);
                    if (!IsNull($v_3)) {
                        $v_3.setInnerText(Microsoft.Crm.Client.Core.Framework.Common.ResourceManager.getLocalizedString('ProcessControl.ActionExecuter.Execute'));
                    }
                }
                else {
                    $v_2.setProgress(0);
    ...
    $8D_0: function($p0) {
        var $v_0 = $p0;
        if (!IsNull($v_0.get_flowControl())) {
            var $v_1 = $v_0.get_flowControl().get_controlId();
            if (!isNullOrEmptyString($v_1)) {
                var $v_2 = this.$Q_0.processStepBuilder($p0.get_parent());
                $v_2.setProgress(5);
                var $v_3 = Xrm.Page.ui.controls.get('header_process_' + $v_1);
                if (!IsNull($v_3)) {
                    $v_3.setInnerText(Microsoft.Crm.Client.Core.Framework.Common.ResourceManager.getLocalizedString('FlowStep_Execute'));
                }
            }
        }
    },
    ...
    process: function($p0) {
        ...
        for (var $v_0 = 0; $v_0 < $p0.$t_0.get_Steps().get_Count(); $v_0++) {
            var $v_1 = $p0.$t_0.get_Steps().get_item($v_0);
            for (var $v_2 = 0; $v_2 < $v_1.get_Steps().get_Count(); $v_2++) {
                this.$8G_0($v_1.get_Steps().get_item($v_2));
            }
        }
    },
    
    $8G_0: function($p0) {
        if (!IsNull($p0) && Microsoft.Crm.Workflow.ObjectModel.ActionStep.isInstanceOfType($p0)) {
            this.$8C_0($p0);
        }
        else if (!IsNull($p0) && Microsoft.Crm.Workflow.ObjectModel.FlowStep.isInstanceOfType($p0)) {
            this.$8D_0($p0);
        }
    }
}
...
ProcessControl.Views.WarningBarView = function($p0, $p1) {
    this.$$d_$7z_1 = Function.createDelegate(this, this.$7z_1);
    this.$$d_$5n_1 = Function.createDelegate(this, this.$5n_1);
...
ProcessControl.Views.WarningBarView.prototype = {
    ...
    get_viewContainer: function() {
        if (!this.$3_1) {
            this.$3_1 = this.$4D_1.children('.processWarningBar');
        }
        return this.$3_1;
    },
    ...
    get_$5H_1: function() {
        if (!this.$3D_1) {
            this.$3D_1 = this.get_viewContainer().children('.processWarningBar-Close');
        }
        return this.$3D_1;
    },
    ...
    get_$7k_1: function() {
        if (!this.$3P_1) {
            this.$3P_1 = this.get_viewContainer().children('.processWarningBar-Text');
        }
        return this.$3P_1;
    },
    ...
    get_$6J_1: function() {
        if (!this.$3l_1) {
            this.$3l_1 = this.get_viewContainer().children('.processBarWarningIcon');
        }
        return this.$3l_1;
    },
    ...
    get_$5T_1: function() {
        if (!this.$3F_1) {
            this.$3F_1 = this.get_viewContainer().children('.processBarErrorIcon');
        }
        return this.$3F_1;
    },
    ...
    get_$5r_1: function() {
        if (!this.$3T_1) {
            this.$3T_1 = this.get_viewContainer().parents('tr').first();
        }
        return this.$3T_1;
    },
    
    showParentTR: function() {
        this.get_$5r_1().css('display', 'table-row');
    },
    
    hideParentTR: function() {
        this.get_$5r_1().css('display', 'none');
    },
    ...
    show: function($p0, $p1, $p2) {
        ...
        this.$91_1($p2);
        this.$24_1++;
        this.get_$7k_1().text($p0).attr('title', $p0);
        this.get_viewContainer().css('display', 'block');
        if ($p1 > 0) {
            this.$8k_1(this.$24_1, $p1);
        }
        return this.$24_1;
    },
    ...
    $91_1: function($p0) {
        if ($p0) {
            this.get_$5T_1().css('display', 'block');
            this.get_$6J_1().css('display', 'none');
        }
        else {
            this.get_$5T_1().css('display', 'none');
            this.get_$6J_1().css('display', 'block');
        }
    },
    ...
    $99_1: function() {
        ...
        var $$t_1 = this;
        this.get_$5H_1().bind('click', function($p1_0) {
    ...
    $2p_1: function() {
        if (!IsNull(this.$0_1)) {
            this.$0_1.add_stageGatesVisibilityChanged(this.$$d_$5n_1);
            this.$0_1.add_notification(this.$$d_$7z_1);
        }
    },
    
    $49_1: function() {
        this.get_$5H_1().unbind();
        if (!IsNull(this.$0_1)) {
            this.$0_1.remove_stageGatesVisibilityChanged(this.$$d_$5n_1);
            this.$0_1.remove_notification(this.$$d_$7z_1);
        }
    },
    ...
    $5n_1: function($p0, $p1) {
        if (this.$0_1.$2l_0) {
            this.$4T_1 = this.show(this.$0_1.$8_0.fillRequiredWarning, 10000, false);
        }
        else {
            if (this.$4T_1 === this.$24_1) {
...
Mscrm.ProcessControlShared.ObjectModels.ActionLog.registerClass('Mscrm.ProcessControlShared.ObjectModels.ActionLog');
...
ProcessControl.Views.StepsView.StageStepsButtonStateProcessor.registerClass('ProcessControl.Views.StepsView.StageStepsButtonStateProcessor');
ProcessControl.Views.WarningBarView.registerClass('ProcessControl.Views.WarningBarView', ProcessControl.Views.BaseView);
Mscrm.ProcessControlClientApiUserHandler.$3K = null;
...
ProcessControl.ClientApi.LightWeightAttributeManager.$3C = null;
ProcessControl.Constants.CriticalAttributes.$5p = 'parentaccountid';
ProcessControl.Constants.CriticalAttributes.$5q = 'parentcontactid';
...
ProcessControl.Constants.StopwatchNames.actionLogRequest = ' ProcessControl.ActionLog.Request';
ProcessControl.Constants.StopwatchNames.actionStepDataChange = ' ProcessControl.ActionStep.DataChange';
...
ProcessControl.Services.PlatformService.$u = 0;
...
ProcessControl.Views.ProcessControlView.$G = false;
