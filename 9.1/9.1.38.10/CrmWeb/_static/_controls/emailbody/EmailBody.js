...
function unblockAppointment(appointmentId,entityType,wrpcTokenAsQueryString)
{
    if(window.confirm(LOCID_WARN_HARMFUL_CONTENT))
    {
        var o = openStdWin(Mscrm.CrmUri.create("/_controls/emailbody/msgBody.aspx?unblockContent=1&id=" + appointmentId + "&entityType=" + entityType + "" + wrpcTokenAsQueryString),null,700,500,"menubar=1,status=1,resizable=1,scrollbars=1");
        o.opener = null;
        o.focus()
    }
}
