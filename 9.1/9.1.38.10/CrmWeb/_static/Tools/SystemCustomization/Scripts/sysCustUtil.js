...
var _oSCUConst = {sEntityMode:"entity",sAttributeMode:"attribute",sRelationshipMode:"relationship",sShowUsageUrlFormat:"/tools/systemcustomization/showUsage.aspx?mode={0}",iUsageDialogWidth:600,iUsageDialogHeight:400},
    _oSCUErrorCodes = {sAccessDenied:"0x80070005"},
    _oTags = {activities:"activities",activityparties:"activityparties",assign:"assign",associatedentity:"associatedentity",attribute:"attribute",attributeid:"attributeid",attributemap:"attributemap",attributeschemaname:"attributeschemaname",attributeexternalname:"attributeexternalname",auditenabled:"auditenabled",retrieveauditenabled:"retrieveauditenabled",retrievemultipleauditenabled:"retrievemultipleauditenabled",changetrackingenabled:"changetrackingenabled",autoroutetoownerqueue:"autoroutetoownerqueue",autocreateaccessteams:"autocreateaccessteams",businessprocessenabled:"businessprocessenabled",connection:"connection",cascading:"cascading",relationshipbehavior:"relationshipbehavior",defaultvalue:"defaultvalue",Delete:"delete",description:"description",displayarea:"displayarea",displayareas:"displayareas",displayed:"displayed",displayname:"displayname",collaboration:"collaboration",docmgmtenabled:"docmgmtenabled",knowledgemgmtenabled:"knowledgemgmtenabled",duplicatecheck:"duplicatecheck",isfieldsecurityenabled:"isfieldsecurityenabled",entity:"entity",entities:"entities",entityid:"entityid",entitymapid:"entitymapid",entityisactivity:"entityisactivity",format:"format",id:"id",iscommunicationactivity:"iscommunicationactivity",isvalidforadvancedfind:"isvalidforadvancedfind",ishierarchical:"ishierarchical",length:"length",local:"local",mailmergecheck:"mailmergecheck",maxvalue:"maxvalue",merge:"merge",minvalue:"minvalue",multiplevalue:"multiplevalue",mobileofflinefilters:"mobileofflinefilters",name:"name",notes:"notes",offline:"offline",optionsetid:"optionsetid",ownershiptype:"ownershiptype",pluralname:"pluralname",precision:"precision",precisionsource:"precisionsource",primaryimagename:"primaryimagename",publish:"publish",referencedentityname:"referencedentityname",referencedinstancename:"referencedinstancename",referencingentityname:"referencingentityname",referencinginstancename:"referencinginstancename",relationship:"relationship",relationshipid:"relationshipid",reparent:"reparent",reqlevel:"reqlevel",richclient:"richclient",schemaname:"schemaname",schemaname2:"schemaname2",searchable:"searchable",share:"share",singularname:"singularname",type:"type",imemode:"imemode",yomiof:"yomiof",sourceattributename:"sourceattributename",targetattributename:"targetattributename",unshare:"unshare",associatedmenu:"associatedmenu",displayoption:"displayoption",navpaneorder:"navpaneorder",customlabel:"customlabel",currententity:"currententity",otherentity:"otherentity",entityname:"entityname",entityrelationshipid:"entityrelationshipid",manytomany:"manytomany",associatedmenuotherentity:"associatedmenuotherentity",currententityname:"currententityname",otherentityname:"otherentityname",intersectentityname:"intersectentityname",icons:"icons",iconlarge:"iconlarge",iconmedium:"iconmedium",iconsmall:"iconsmall",iconvector:"iconvector",visibleinmobile:"visibleinmobile",readingpaneenabled:"readingpaneenabled",visibleinmobileclient:"visibleinmobileclient",readonlyinmobileclient:"readonlyinmobileclient",offlineinmobileclient:"offlineinmobileclient",dayssincerecordlastmodified:"dayssincerecordlastmodified",isquickcreateenabled:"isquickcreateenabled",issolutionawareenabled:"issolutionawareenabled",formuladefinition:"formuladefinition",sourcetype:"sourcetype",entityhelpurl:"entityhelpurl",entityhelpurlenabled:"entityhelpurlenabled",entitycolor:"entitycolor",behaviors:"behavior",onenoteintegrationenabled:"onenoteintegrationenabled",entitykey:"entitykey",interactioncentricenabled:"interactioncentricenabled",entitykeyid:"entitykeyid",entitykeyattributes:"entitykeyattributes",isexportkey:"isexportkey",isexternalappenabled:"isexternalappenabled",isenabledforexternalchannels:"isenabledforexternalchannels",isglobalfilterenabled:"isglobalfilterenabled",issortableenabled:"issortableenabled",islocalizable:"islocalizable",isexportable:"isexportable",feedback:"feedback",isslaenabled:"isslaenabled",sitemapid:"sitemapid",isvirtualentity:"isvirtualentity",externalname:"externalname",externalcollectionname:"externalcollectionname",isdatasourcesecret:"isdatasourcesecret",datasourceid:"datasourceid",dataproviderid:"dataproviderid",parentenumattributeid:"parentenumattributeid",optionsetexternalname:"optionsetexternalname"};
...
function convertXmlDocToString(oXml)
{
        ...
        i = 0; i < sUnicodeXml.length; i++)
    {
        ...
        if(code < 128)
            ...
            if(code >= 55296 && code <= 56319 && code2 >= 56320 && code2 <= 57343)
            {
...
function addControlDataValue(oParentNode,sChildNodeName,element,bAddEvenIfDisabled)
{
    ...
    ajaxControl != null && (!ajaxControl.get_disabled() || bAddEvenIfDisabled) && 
...
{
    openStdWin(Mscrm.CrmUri.create(SOLUTIONS_UIGUIDANCE_ASSEMBLY),null,window.screen.availWidth * .9,window.screen.availHeight * .9,"scrollbars=1,toolbar=1,menubar=1,location=1")
}
function OpenSdkMessageProcessingStep()
{
    openStdWin(Mscrm.CrmUri.create(SOLUTIONS_UIGUIDANCE_STEP),null,window.screen.availWidth * .9,window.screen.availHeight * .9,"scrollbars=1,toolbar=1,menubar=1,location=1")
}
function OpenServiceEndpoint()
{
    openStdWin(Mscrm.CrmUri.create(SOLUTIONS_UIGUIDANCE_ENDPOINT),null,window.screen.availWidth * .9,window.screen.availHeight * .9,"scrollbars=1,toolbar=1,menubar=1,location=1")
}
