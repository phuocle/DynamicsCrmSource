...
function dispatchAction(sRelationshipOid,sAction)
{
    ...
    switch(sAction)
    {
        ...
        case _oConst.sComponentHistoryAction:
            Mscrm.SolutionComponentList.launchComponentHistoryDlg("EntityRelationship",getRelationshipId(sRelationshipOid));
            break;
