...
var _oMessages = {sNoSelectedMapping:LOCID_MAPLST_MUSTSELECT,sConfirmAutomap:LOCID_MAPLST_CONFIRMAUTOMAP,sAutoMapping:LOCID_MAPLST_AUTOMAPING,sCreatingMapping:LOCID_MAPLST_CREATINGMAP},
    _oConst = {entityMapId:"entityMapId",sCustomizationCommandObject:"SystemCustomization",sAutoMapCommand:"AutoMapEntityMap",sCreateMappingCommand:"CreateAttributeMap",sCommandParameterName:"data",sDisableDoubleClick:"0",sCreateMappingUrlFormat:"/tools/systemcustomization/relationships/mappings/createMapping.aspx?mappingId={0}",iCreateDialogWidth:920,iCreateDialogHeight:400,sDeleteDialogUrlFormat:"/_grid/cmds/dlg_delete.aspx?iObjType={0}&iTotal={1}",sDeleteAction:"delete",iDeleteDialogWidth:470,iDeleteDialogHeight:250},
...
function createMappingAction()
{
    ...
    if(isWebClientVisualRefreshFeatureEnabled)
        _oConst.iCreateDialogHeight = 505;
...
function deleteMappingAction(aMappingList)
{
    var oUrl = Mscrm.CrmUri.create(formatString(_oConst.sDeleteDialogUrlFormat,AttributeMap,aMappingList.length)),
        crmDialog = new Mscrm.CrmDialog(oUrl,aMappingList,_oConst.iDeleteDialogWidth,_oConst.iDeleteDialogHeight,null),
