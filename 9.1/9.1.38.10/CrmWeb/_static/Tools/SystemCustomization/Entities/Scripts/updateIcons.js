...
var _iconUpdateConst = {sIconSmall:"iconSmall",sIconMedium:"iconMedium",sIconVector:"iconVector",sIconLarge:"sIconLarge"};
function cancel()
{
...
function validateParameters()
{
    ...
    bValid = bValid && checkWebResourceType($get(_iconUpdateConst.sIconVector));
    return bValid
}
...
function addIconsXml(oDataXml)
{
    ...
    addIcon(oCXml,_oTags.iconvector,$get(_iconUpdateConst.sIconVector))
}
