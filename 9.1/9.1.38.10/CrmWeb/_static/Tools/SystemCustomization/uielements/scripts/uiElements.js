    ...
    if(sUIElementOid == null)
        ...
        switch(sAction)
        {
            ...
            case _oConst.sComponentHistoryAction:
                Mscrm.SolutionComponentList.launchComponentHistoryDlg("SavedQuery",getViewId(sUIElementOid));
                break;
...
function createView()
{
    if(Mscrm.FeatureControl.get_Current().isFeatureEnabled(Mscrm.FeatureNames.CustomControlViewSupport))
        _oConst.iViewEditorHeight = 800;
