...
var _oErrors = {sNoneSelected:LOCID_MANUIE_MUSTSELECT},
    _oConst = {entityOtc:"entityOtc",visualizationsFilters:"visualizationsFilters",sEditAction:"edit",sDeleteAction:"delete",sExportAction:"export",sShowDependencyAction:"showDependency",sComponentHistoryAction:"componentHistory",sManagedPropertyAction:"managedProperty",sDisableDoubleClick:"0"},
    _entityOtc,
    ...
    if(sOid == null)
        ...
        switch(sAction)
        {
            ...
            case _oConst.sComponentHistoryAction:
                Mscrm.SolutionComponentList.launchComponentHistoryDlg("SavedQueryVisualization",sOid);
                break;
