...
function GetFieldObj(oActive)
{
    ...
    var sSectionName = GetCurrentSectionName(_oActive),
        ...
        oFields = [],
        fieldObj = new FieldObj(sLabel,true,false,sTabName,sSectionName,false,1,1,false,GetControlClassId(sDataType,sFormat),null,sDataType,sFormat,sLabel,sSchemaName);
    oFields[0] = fieldObj;
    return oFields
}
function AddView()
    ...
    try
    {
        ...
        if(result.Success)
        {
            var entityId = result.ReturnValue,
                url = Mscrm.CrmUri.create(formatString("/tools/vieweditor/viewManager.aspx?objectTypeCode={0}&mode=new&entityId={1}",CrmEncodeDecode.CrmUrlEncode(_objectTypeCode),CrmEncodeDecode.CrmUrlEncode(entityId))),
...
function EnableDisableNotesControl()
{
    if(!IsNull(Mscrm) && !IsNull(Mscrm.FormEditorVariables) && !IsNull(Mscrm.FormEditorVariables.fieldExpIsFor))
        if(Mscrm.FormEditorVariables.fieldExpIsFor == Mscrm.DragDropUtils.MAIN && !Mscrm.FieldPropertiesUtils.formContainsNotesControl() && Mscrm.FormEditorVariables.supportNotes === "True")
            return true;
        else
            return false;
    else
...
{
    if(!IsNull(Mscrm) && !IsNull(Mscrm.FormEditorVariables) && !IsNull(Mscrm.FormEditorVariables.fieldExpIsFor))
        if(Mscrm.FormEditorVariables.fieldExpIsFor == Mscrm.DragDropUtils.MAIN && IsNull(Mscrm.DragDropUtils.getCellNode(Mscrm.DragDropUtils.BingMapsControlId)) && Mscrm.FormEditorVariables.supportBingMaps === "True")
            return true;
        else
            return false;
    else
...
{
    if(!IsNull(Mscrm) && !IsNull(Mscrm.FormEditorVariables) && !IsNull(Mscrm.FormEditorVariables.fieldExpIsFor))
        if(Mscrm.FormEditorVariables.fieldExpIsFor == Mscrm.DragDropUtils.MAIN && IsNull(Mscrm.DragDropUtils.getCellNode(Mscrm.DragDropUtils.SOCIALINSIGHT)) && Mscrm.FormEditorVariables.supportSocialInsights === "True")
            return true;
        else
            return false;
    else
...
{
    if(!IsNull(Mscrm) && !IsNull(Mscrm.FormEditorVariables) && !IsNull(Mscrm.FormEditorVariables.fieldExpIsFor))
        if(Mscrm.FormEditorVariables.fieldExpIsFor == Mscrm.DragDropUtils.MAIN && IsNull(Mscrm.DragDropUtils.getCellNode(Mscrm.DragDropUtils.ORGINSIGHTS)) && Mscrm.FormEditorVariables.supportOrgInsights === "True")
            return true;
        else
            return false;
    else
...
{
    if(!IsNull(Mscrm) && !IsNull(Mscrm.FormEditorVariables) && !IsNull(Mscrm.FormEditorVariables.fieldExpIsFor))
        if(Mscrm.FormEditorVariables.fieldExpIsFor == Mscrm.DragDropUtils.MAIN && IsNull(Mscrm.DragDropUtils.getCellNode(Mscrm.DragDropUtils.POWERBITILE)) && Mscrm.FormEditorVariables.supportPowerBITile === "True" && !window.top.isOutlookHostedWindow())
            return true;
    return false
}
function EnableDisableTimeline()
{
    if(!IsNull(Mscrm) && !IsNull(Mscrm.FormEditorVariables) && !IsNull(Mscrm.FormEditorVariables.fieldExpIsFor))
        if(Mscrm.FormEditorVariables.fieldExpIsFor == Mscrm.DragDropUtils.MAIN && IsNull(Mscrm.DragDropUtils.getCellNode(Mscrm.DragDropUtils.NOTES_CONTROL_ID)))
            return true;
    return false
}
function EnableDisablePowerBIEditProperties()
{
    return _oActive && _oActive.className != "powerbitile" || Mscrm.FormEditorVariables.supportPowerBITile === "True"
}
function EnableDisableTimerControl()
{
    if(Mscrm.FormEditorVariables.FormType == "card")
        return false;
    if(!IsNull(Mscrm) && !IsNull(Mscrm.FormEditorVariables) && !IsNull(Mscrm.FormEditorVariables.fieldExpIsFor))
        if(Mscrm.FormEditorVariables.fieldExpIsFor == Mscrm.DragDropUtils.MAIN && Mscrm.FormEditorVariables.supportTimerControl === "True")
            return true;
        else
            return false;
    else
...
{
    if(!IsNull(Mscrm) && !IsNull(Mscrm.FormEditorVariables) && !IsNull(Mscrm.FormEditorVariables.fieldExpIsFor))
        if(Mscrm.FormEditorVariables.fieldExpIsFor == Mscrm.DragDropUtils.MAIN && Mscrm.Utilities.IsKnowledgeBaseFeatureAvailable() && Mscrm.FormEditorVariables.supportKMControl === "True")
            return true;
        else
            return false;
    else
...
{
    if(!IsNull(Mscrm) && !IsNull(Mscrm.FormEditorVariables) && !IsNull(Mscrm.FormEditorVariables.fieldExpIsFor))
        if(Mscrm.FormEditorVariables.fieldExpIsFor == Mscrm.DragDropUtils.MAIN && Mscrm.FormEditorVariables.supportACIControl === "True")
            return true;
        else
            return false;
    else
...
function EnableDisableRICardsActionsControl()
{
    AddTelemetryLog("EnableDisableRICardsActionsControl");
    if(!IsNull(Mscrm) && !IsNull(Mscrm.FormEditorVariables) && !IsNull(Mscrm.FormEditorVariables.fieldExpIsFor))
        if(Mscrm.FormEditorVariables.fieldExpIsFor == Mscrm.DragDropUtils.MAIN && IsNull(Mscrm.DragDropUtils.getCellNodeFromUniqueId(Mscrm.ControlClassIds.riActionCard)) && Mscrm.FormEditorVariables.supportRICards === "True")
            return true;
        else
            return false;
    else
...
function EnableDisableLeadScoringCardControl()
{
    var leadScoreField = oFieldsXml ? XUI.Xml.SelectSingleNode(oFieldsXml,"/entity/fields/field[@name = 'msdyn_leadscore']",null) : null;
    if(IsNull(leadScoreField))
        return false;
    if(!IsNull(Mscrm) && !IsNull(Mscrm.FormEditorVariables) && !IsNull(Mscrm.FormEditorVariables.fieldExpIsFor))
        if(Mscrm.FormEditorVariables.fieldExpIsFor == Mscrm.DragDropUtils.MAIN && IsNull(Mscrm.DragDropUtils.getCellNodeFromUniqueId(Mscrm.ControlClassIds.lsCard)))
            return true;
        else
            return false;
    else
...
function EnableDisableOpportunityScoringCardControl()
{
    var opportunityScoreField = oFieldsXml ? XUI.Xml.SelectSingleNode(oFieldsXml,"/entity/fields/field[@name = 'msdyn_opportunityscore']",null) : null;
    if(IsNull(opportunityScoreField))
        return false;
    if(!IsNull(Mscrm) && !IsNull(Mscrm.FormEditorVariables) && !IsNull(Mscrm.FormEditorVariables.fieldExpIsFor))
        if(Mscrm.FormEditorVariables.fieldExpIsFor == Mscrm.DragDropUtils.MAIN && IsNull(Mscrm.DragDropUtils.getCellNodeFromUniqueId(Mscrm.ControlClassIds.lsCard)))
            return true;
...
{
    var oUrl = Mscrm.CrmUri.create(formatString("/tools/systemcustomization/attributes/manageAttribute.aspx?entityId={0}",CrmEncodeDecode.CrmUrlEncode(_entityId))),
        windowInfo = Mscrm.WindowInformation.getWindowInformation(Mscrm.EntityTypeCode.Attribute),
...
function OpenEditAttributeDialog(attributeName,sObjectTypeCode,solutionId)
{
    var entityId = GetEntityId(sObjectTypeCode),
        ...
        oUrl = Mscrm.CrmUri.create(formatString("/tools/systemcustomization/attributes/manageAttribute.aspx?attributeId={0}&entityId={1}&appSolutionId={2}",CrmEncodeDecode.CrmUrlEncode(attrId),CrmEncodeDecode.CrmUrlEncode(entityId),CrmEncodeDecode.CrmUrlEncode(solutionId))),
        windowInfo = Mscrm.WindowInformation.getWindowInformation(Mscrm.EntityTypeCode.Attribute),
        retVals = openStdDlg(oUrl,null,windowInfo.Width,windowInfo.Height)
}
...
{
    var oRows = Mscrm.DragDropUtils.getRowsNode(oFieldObj.SectionName,null),
        oCell;
    oCell = Mscrm.FormEditorVariables.formXml.createElement("cell");
    oCell.setAttribute("id",createGuid());
    oCell.setAttribute("auto",oFieldObj.Auto.toString());
    oCell.setAttribute("showlabel",oFieldObj.ShowLabel.toString());
    oCell.setAttribute("colspan",oFieldObj.ColSpan.toString());
    ...
    AddCellToFormXml(oRows,oCell,oFieldObj.RowSpan,oFieldObj.bSpansTwoColumns,oFieldObj.Auto);
    var oLabels = new Array(new LocalizedObj(oFieldObj.Label,_langCode)),
    ...
    PersistLocalizedNodes(Mscrm.FormEditorVariables.formXml,formXMLPath + "/row/cell[@id = '" + oCell.getAttribute("id") + "']/labels/label",oLabels)
}
...
function UpdateField(oActive)
{
    ...
    if(!IsNull(slabelNode))
    {
        ...
        labels = [new LocalizedObj(sLabel,slabelNode.getAttribute("languagecode"))]
    }
    var oParameters = GetParameterBag(XUI.Xml.SelectNodes(oFormCell,"control/parameters/*",null)),
        oEntity = oFieldsXml ? XUI.Xml.SelectSingleNode(oFieldsXml,"/entity",null).getAttribute("name") : null,
        oEntityField = oFieldsXml ? XUI.Xml.SelectSingleNode(oFieldsXml,"/entity/fields/field[@name = '" + sActualName + "']",null) : null,
    ...
    {
        var oPropertiesField = XUI.Xml.SelectSingleNode(oPropertiesXml,"/entity/fields/field[@name = '" + sActualName + "']",null);
        sDataType = oEntityField.getAttribute("datatype");
        sDataTypeFormat = oPropertiesField.getAttribute("format");
        sAttributeDisplayName = XUI.Xml.SelectSingleNode(oPropertiesField,"displaynames/displayname[@languagecode = " + GetLanguageCode() + "]",null).getAttribute("description");
    ...
    var id = oControl.getAttribute("id"),
        oFieldObj = new FieldObj(sLabel,bShowLabel,bDisabled,sTabName,sSectionName,bLocked,iColSpan,iRowSpan,bAutoExpanding,sControlClassId,sDataType,sDataTypeFormat,sAttributeDisplayName,sAttributeSchemaName,sAttributeDescription,oParameters,false,null,null,Mscrm.FormEditorVariables.formXml,bVisible,bAvailable,sCustomControlUniqueId,id,labels,oEntity);
    ...
    if(oTab !== null && oTab.getAttribute("availableforphone") !== null && oTab.getAttribute("availableforphone") === "false" || oSection !== null && oSection.getAttribute("availableforphone") !== null && oSection.getAttribute("availableforphone") === "false")
    ...
    if(!(oActive.getAttribute("class") === Mscrm.DragDropUtils.NOTES || controlFor === Mscrm.DragDropUtils.HEADER || controlFor === Mscrm.DragDropUtils.FOOTER))
    ...
    if(Mscrm.FeatureControl.get_Current().isFeatureEnabled(Mscrm.FeatureNames.CustomControlMobile))
        if(oArgs.sFldExpFor.toUpperCase() == "FOOTER")
            ...
            if(sActualName.indexOf("_composite") != -1 || sActualName == "fullname" || sActualName.indexOf("yomi") === 0 || !IsTypeCustomControlManifestType(sDataType))
                showCustomControl = false;
            else
    ...
    if(Mscrm.FormEditorVariables.FormType != "card")
    {
        ...
        if(Mscrm.FormEditorVariables.editorType != Mscrm.EditorType.dashboardEditor)
            oUrl = Mscrm.CrmUri.create("/Tools/FormEditor/Dialogs/fieldprops.aspx?mode=" + (_bPreviewMode ? "Preview" : "Form") + "&datatype=" + CrmEncodeDecode.CrmUrlEncode(sDataType) + "&format=" + CrmEncodeDecode.CrmUrlEncode(sDataTypeFormat) + "&controlClassId=" + CrmEncodeDecode.CrmUrlEncode(sControlClassId) + "&objectTypeCode=" + CrmEncodeDecode.CrmUrlEncode(GetObjectTypeCode()) + "&formId=" + CrmEncodeDecode.CrmUrlEncode(Mscrm.FormEditorVariables.currentFormId) + (!IsNull(attributeId) ? "&attributeId=" + CrmEncodeDecode.CrmUrlEncode(attributeId) : "") + "&formType=" + CrmEncodeDecode.CrmUrlEncode(Mscrm.FormEditorVariables.FormType) + "&showCustomControl=" + CrmEncodeDecode.CrmUrlEncode(showCustomControl) + (!IsNull(attributeIdInHeaderForCC) ? "&attributeIdInHeaderForCC=" + CrmEncodeDecode.CrmUrlEncode(attributeIdInHeaderForCC) : ""));
        else
        {
            oArgs.EditorType = Mscrm.EditorType.dashboardEditor;
            oUrl = "/Tools/FormEditor/Dialogs/fieldprops.aspx?mode=add&editorType=DashboardEditor"
        }
        var iWidth = 590,
...
function BindUpdatedFieldProperties(oUpdatedFieldObj,oFieldObj,oActive)
{
    if(oUpdatedFieldObj)
    {
        ...
        if(!IsNull(oUpdatedFieldObj.FormXml) && XUI.Xml.XMLSerializer.serializeToString(oUpdatedFieldObj.FormXml) != XUI.Xml.XMLSerializer.serializeToString(Mscrm.FormEditorVariables.formXml))
        {
        ...
        var oLabels = new Array(new LocalizedObj(oUpdatedFieldObj.Label,_langCode));
        PersistLocalizedNodes(Mscrm.FormEditorVariables.formXml,formXMLPath + "/row/cell[@id = '" + oActive.id + "']/labels/label",oLabels);
        oCell.setAttribute("showlabel",oUpdatedFieldObj.ShowLabel.toString());
        if(Mscrm.DependenciesUtils.isControlDependent(oUpdatedFieldObj.sAttributeSchemaName,Mscrm.FormEditorVariables.formXml))
        ...
        if(oFieldObj.ColSpan != oUpdatedFieldObj.ColSpan)
        {
            var xmlAdjusted = Mscrm.FieldPropertiesUtils.adjustFormXmlForColSpanChange(oCell,oFieldObj.ColSpan,oUpdatedFieldObj.ColSpan);
            if(xmlAdjusted)
            {
                oCell.setAttribute("colspan",oUpdatedFieldObj.ColSpan.toString());
                if(oUpdatedFieldObj.ColSpan < oFieldObj.ColSpan)
                {
                    var elemIdInHTML = oCell.getAttribute("id"),
                        domElem = document.getElementById(elemIdInHTML);
                    HandleAfterColSpanReduced(oCell,domElem,oUpdatedFieldObj.ColSpan,oFieldObj.ColSpan)
                }
            }
            else
                return
        ...
        if(Mscrm.FormEditorVariables.fieldExpIsFor === "section")
            if(oFieldObj.Auto != oUpdatedFieldObj.Auto)
            {
                oCell.setAttribute("auto",oUpdatedFieldObj.Auto.toString());
                oUpdatedFieldObj.Auto && 
        ...
        oUpdatedFieldObj.AvailableForPhone != null && 
            setAttributeIfNotDefaultValue(oCell,"availableforphone",oUpdatedFieldObj.AvailableForPhone.toString(),"true");
        if(!IsNull(oUpdatedFieldObj.RowSpan) && oFieldObj.RowSpan != oUpdatedFieldObj.RowSpan)
        {
            Mscrm.FieldPropertiesUtils.adjustFormXmlForRowSpanChange(oCell,oFieldObj.RowSpan,oUpdatedFieldObj.RowSpan);
            oCell.setAttribute("rowspan",oUpdatedFieldObj.RowSpan.toString())
        }
...
function RemoveField(oActive,bCheckIsRequired)
{
    ...
    var fieldName = oActive.getAttribute("name"),
        ...
        oNodes = XUI.Xml.SelectNodes(oSection,"rows/row/cell[@id='" + oActive.id + "']/control[@id = '" + oActive.getAttribute("name") + "']",null),
    ...
    if(EnableRequiredFieldsOnlyInHeader())
        fieldCount = Mscrm.FieldPropertiesUtils.getFieldCountOnForm(oCell,Mscrm.DragDropUtils.HEADER) + Mscrm.FieldPropertiesUtils.getFieldCountOnForm(oCell,Mscrm.DragDropUtils.MAIN);
    if(fieldCount <= 1)
    {
    ...
    for(var iRow = dragObject.get_elementPosition().get_row(),
        ...
        rows = [],
        i = 0,
        j = 0; i < rowsNode.childNodes.length; i++)
...
{
    var oSection = oActive.parentNode.parentNode.parentNode;
    if(oActive.className == "ricards")
    {
        var tabs = XUI.Xml.SelectNodes(Mscrm.FormEditorVariables.formXml,"/entity/form/tabs/tab",null);
        RefreshAllTab(tabs)
    }
    else
        RefreshSectionHtml(oSection,null,true)
}
function RefreshAllTab(tabsNode)
{
    for(k = 0; k < tabsNode.length; k++)
    {
        var columnnodes = XUI.Xml.SelectNodes(tabsNode[k],"columns/column",null);
        for(i = 0; i < columnnodes.length; i++)
        {
            var sections = XUI.Xml.SelectNodes(columnnodes[i],"sections/section",null);
            for(j = 0; j < sections.length; j++)
            {
                var secDOM = document.getElementById(XUI.Xml.GetText(sections[j].attributes.getNamedItem("id")));
                RefreshSectionHtml(secDOM,null,false)
            }
        }
    }
}
...
{
    var oEvent = XUI.Xml.SelectSingleNode(Mscrm.FormEditorVariables.formXml,"/entity/form/tabs/tab/columns/column/sections/section/rows/row/cell[control/@id = '" + sFieldName + "']/events/event[@application = 'false' and @name = '" + oUpdatedEventObj.Name + "']",null),
        oNewNode,
        oNode;
    if(!oEvent)
    {
        var oEvents = XUI.Xml.SelectSingleNode(Mscrm.FormEditorVariables.formXml,"/entity/form/tabs/tab/columns/column/sections/section/rows/row/cell[control/@id = '" + sFieldName + "']/events",null);
        if(!oEvents)
        {
            var oNode = XUI.Xml.SelectSingleNode(Mscrm.FormEditorVariables.formXml,"/entity/form/tabs/tab/columns/column/sections/section/rows/row/cell[control/@id = '" + sFieldName + "']",null);
    ...
    XUI.Html.DomUtils.GetFirstChild(oScript).replaceData(0,XUI.Html.DomUtils.GetFirstChild(oScript).length,oUpdatedEventObj.Script);
    return
}
...
{
    if(oActive.className == Mscrm.DragDropUtils.REFERENCEPANELSUBGRID || oActive.className == Mscrm.DragDropUtils.REFERENCEPANELQUICKFORMCOLLECTION || oActive.className == Mscrm.DragDropUtils.REFERENCEPANELSEARCHWIDGET || oActive.getAttribute("name").startsWith("ref_pan_"))
        return true;
    else
        if(oActive.className == Mscrm.DragDropUtils.TAB && oActive.childNodes[0].childNodes[0].childNodes[0].childNodes[1].childNodes[1].childNodes[0].childNodes[0].childNodes[0].childNodes[0].childNodes[0].childNodes[0].childNodes[0].getAttribute("name").startsWith("ref_pan_"))
            return true;
    return false
}
...
function AddUnboundCustomControl(oActive,useComponentGallery)
{
    if(Mscrm.FormEditorVariables.fieldExpIsFor != "section")
        return false;
    ...
    oArgs.Field = new UnboundCustomControlObj("",rowSpan,secCols,false,sTabName,sSectionName,null,false,null,true,null,null,true,false,null,Mscrm.FormEditorVariables.formXml);
    ...
    var uri,
        height,
        width;
    createInlineDlg(Mscrm.CrmUri.create("/Tools/FormEditor/Dialogs/CustomControl.aspx?mode=add&scrolling=auto"),oArgs,_lookupDialogParentDefaults.iDialogHeight,_lookupDialogParentDefaults.iDialogWidth,AddUnboundCustomControlCallback,[sTabName,sSectionName,oArgs.SecCols],null)
}
function AddSubGrid(oActive,isChart,useComponentGallery)
{
    if(Mscrm.FormEditorVariables.supportInteractionCentric === "True")
        if(Mscrm.FormEditorVariables.dashboardCategory === InteractionCentricDashboardCategory.CSR2 && Mscrm.FormEditorVariables.streamsCount == 0)
        {
    ...
    var headerColorCode = "";
    oArgs.Field = new SubGridObj("","","",rowSpan,rowsPerPage,secCols,false,false,"",false,"",false,false,gridMode,"",true,null,"",false,false,true,null,null,isReferencePanelType(oActive),null,false,"",headerColorCode);
    oArgs.FieldsXml = oFieldsXml;
    oArgs.FieldPropertiesXml = oPropertiesXml;
    oArgs.FormXml = Mscrm.FormEditorVariables.formXml;
    oArgs.FormType = Mscrm.FormEditorVariables.FormType;
    ...
    if(!IsNull(useComponentGallery) && useComponentGallery)
    {
        ...
        if(Mscrm.FormEditorVariables.supportInteractionCentric === "True")
        {
            ...
            if(Mscrm.FormEditorVariables.dashboardCategory === InteractionCentricDashboardCategory.CSR2 && Mscrm.FormEditorVariables.streamsIsQueueSelected)
            {
        ...
        height = Mscrm.DashboardEditorConstants.componentGalleryHeight, width = Mscrm.DashboardEditorConstants.componentGalleryWidth
    }
    else
    {
        uri = Mscrm.CrmUri.create("/Tools/FormEditor/Dialogs/subGrid.aspx?title=" + CrmEncodeDecode.CrmUrlEncode(LOCID_FORMED_SUBGRIDPROPS) + "&description=" + CrmEncodeDecode.CrmUrlEncode(LOCID_FORMED_MODIFYSUBGRIDPROPS) + "&formType=" + CrmEncodeDecode.CrmUrlEncode(Mscrm.FormEditorVariables.FormType) + "&chartgridmode=" + CrmEncodeDecode.CrmUrlEncode(gridMode));
...
function checkIfChartPresent(oFormCell)
{
    if(oFormCell != null)
    {
        var tabsHtml = XUI.Xml.SelectSingleNode(Mscrm.FormEditorVariables.formXml,"//entity/form/tabs/tab/columns/column/sections/section[@name = 'VisualFilters']/rows/row/cell[@id = '" + oFormCell.getAttribute("id") + "']/control/parameters/VisualizationId",null);
        if(tabsHtml == null)
            return false;
        else
        {
...
function AddOrgInsights(oActive,useComponentGallery)
{
    ...
    oArgs.Field = new OrgInsightsObj("",rowSpan,secCols,true,sTabName,sSectionName,null,true,null,"auto",true,Mscrm.FormEditorVariables.formXml,true,null,false);
    if(Mscrm.FormEditorVariables.editorType !== Mscrm.EditorType.dashboardEditor)
    {
        ...
        uri.get_query()["dashboardType"] = oArgs.FormAccessType.toString();
        height = Mscrm.DashboardEditorConstants.orgInsightsComponentGalleryHeight, width = Mscrm.DashboardEditorConstants.orgInsightsComponentGalleryWidth;
        var parameters = [sTabName,sSectionName,secCols];
...
function OpenComponentGallery(oSubGrid,sTabName,sSectionName,secCols)
{
    if(oSubGrid)
    {
        ...
        var rowsNode = Mscrm.DragDropUtils.getRowsNode(sSectionName,null),
            bNeedChangeClassId;
        if(Mscrm.FeatureControl.get_Current().isFeatureEnabled(Mscrm.FeatureNames.CustomControlMobile) && oSubGrid.CustomControlSnippet != null)
            bNeedChangeClassId = !IsNull(XUI.Xml.SelectSingleNode(oSubGrid.CustomControlSnippet,"//controlDescription",null));
        var subGridId = AddSubGridFormXml(oSubGrid);
        Mscrm.DragDropUtils.removeSystemSpacerRows(rowsNode);
        RefreshCellHtml(oSubGrid.TabName,oSubGrid.SectionName,subGridId);
        if(Mscrm.FeatureControl.get_Current().isFeatureEnabled(Mscrm.FeatureNames.CustomControlMobile) && bNeedChangeClassId)
        {
            var controlNode = XUI.Xml.SelectSingleNode(Mscrm.FormEditorVariables.formXml,"/entity/form/tabs/tab/columns/column/sections/section/rows/row/cell/control[@id = '" + oSubGrid.Id + "']");
...
function AddUnboundCustomControlCallback(oUnboundCustomControl,sTabName,sSectionName,secCols)
{
    if(oUnboundCustomControl)
    {
        if(secCols < oUnboundCustomControl.ColSpan)
        {
            alert(Mscrm.FormEditorVariables.addColumnsMessage);
            return
        }
        oUnboundCustomControl.TabName = sTabName;
        oUnboundCustomControl.SectionName = sSectionName;
        var rowsNode = Mscrm.DragDropUtils.getRowsNode(sSectionName,null),
            bNeedChangeClassId;
        if(Mscrm.FeatureControl.get_Current().isFeatureEnabled(Mscrm.FeatureNames.CustomControlMobile) && oUnboundCustomControl.CustomControlSnippet != null)
            bNeedChangeClassId = !IsNull(XUI.Xml.SelectSingleNode(oUnboundCustomControl.CustomControlSnippet,"//controlDescription",null));
        var unboundCustomControlId = AddUnboundControlFormXml(oUnboundCustomControl);
        Mscrm.DragDropUtils.removeSystemSpacerRows(rowsNode);
        RefreshCellHtml(oUnboundCustomControl.TabName,oUnboundCustomControl.SectionName,unboundCustomControlId);
        if(Mscrm.FeatureControl.get_Current().isFeatureEnabled(Mscrm.FeatureNames.CustomControlMobile) && bNeedChangeClassId)
        {
            var controlNode = XUI.Xml.SelectSingleNode(Mscrm.FormEditorVariables.formXml,"/entity/form/tabs/tab/columns/column/sections/section/rows/row/cell/control[@id = '" + oUnboundCustomControl.Id + "']");
            controlNode.setAttribute("classid",_ControlClassIds.customControl);
            controlNode.setAttribute("isunbound",true);
            controlNode.setAttribute("uniqueid",oUnboundCustomControl.CustomControlUniqueId)
        }
    }
}
...
function AddQuickForm(oActive)
{
    ...
    if(Mscrm.FormEditorVariables.FormType != "card")
    {
        var url = Mscrm.CrmUri.create("/Tools/FormEditor/Dialogs/quickFormCollectionControl.aspx?title=" + CrmEncodeDecode.CrmUrlEncode(LOCID_FORMED_SUBFORMPROPS) + "&description=" + CrmEncodeDecode.CrmUrlEncode(LOCID_FORMED_MODIFYSUBFORMPROPS)),
        ...
        var callbkFunction = Mscrm.Utilities.createCallbackFunctionForXrmDialog(quickFormCallBackFunction,callBackParameters);
...
function AddTimelineControlFromRibbon(useComponentGallery)
{
    AddIFrame(_oActive,"timeline",useComponentGallery)
}
function AddWebResourceFromRibbon(useComponentGallery)
{
    AddIFrame(_oActive,"webresource",useComponentGallery)
}
function AddCustomControlFromRibbon(useComponentGallery)
{
    AddUnboundCustomControl(_oActive,useComponentGallery)
}
...
function AddDashboardRICardsFromRibbon(useComponentGallery)
{
    Mscrm.FieldPropertiesUtils.addRiCardsControlForDashboard(_oActive,_objectTypeCode)
}
function AddTimerControlFromRibbon(useComponentGallery)
{
    AddIFrame(_oActive,"timercontrol",useComponentGallery)
}
function AddRICardsFromRibbon(useComponentGallery)
{
    Mscrm.FieldPropertiesUtils.addRiActionCardsControl(_oActive,_objectTypeCode)
}
function AddLeadScoringCardFromRibbon(useComponentGallery)
{
    Mscrm.FieldPropertiesUtils.addLeadScoringCardsControl(_oActive,_objectTypeCode)
}
...
{
    if(!IsNull(Mscrm.FormEditorVariables.selectedStreamDiv) && !isNullOrEmptyString(Mscrm.FormEditorVariables.selectedStreamDiv.getAttribute("id")))
        EditSelectedStream(Mscrm.FormEditorVariables.selectedStreamDiv.getAttribute("id"),Mscrm.FormEditorVariables.selectedStreamDiv.getAttribute("objecttypecode"));
    else
        alert(LOCID_IC_SELECT_STREAM)
}
function EditSelectedStream(id,otc)
{
    var streamObject = XUI.Xml.SelectSingleNode(Mscrm.FormEditorVariables.formXml,"//entity/form/tabs/tab[@name = 'StreamsContainer']/columns/column/sections/section[@name = 'Streams']/rows/row/cell/control[@classid='{EE9078C8-6946-4E2C-B8F8-35E65F4BE6A8}']/parameters/StreamObjects/StreamObject[@id='" + id + "']",null);
    ...
    if(!IsNull(entityLogicalNameNode))
        if(!isNullOrEmptyString(XUI.Xml.GetText(entityLogicalNameNode)))
            oArgs.entityCode = Xrm.Internal.getEntityCode(XUI.Xml.GetText(entityLogicalNameNode)) == -1 ? "0" : Xrm.Internal.getEntityCode(XUI.Xml.GetText(entityLogicalNameNode)).toString();
    ...
    if(!IsNull(Mscrm.FormEditorVariables.IS_ENTITY_DASHBOARD))
        createInlineDlg(Mscrm.CrmUri.create("/Tools/FormEditor/Dialogs/dlg_queues.aspx?title=3&objecttypecode=" + _objectTypeCode + "&dashboardcategory=" + Mscrm.FormEditorVariables.dashboardCategory + "&isentitydashboard=" + Mscrm.FormEditorVariables.IS_ENTITY_DASHBOARD),oArgs,300,500,EditQueueCallback,parameters,null);
    else
        createInlineDlg(Mscrm.CrmUri.create("/Tools/FormEditor/Dialogs/dlg_queues.aspx?title=3&objecttypecode=" + _objectTypeCode + "&dashboardcategory=" + Mscrm.FormEditorVariables.dashboardCategory),oArgs,300,500,EditQueueCallback,parameters,null)
}
function AddQueuesFromRibbon(isChart,queueType,useComponentGallery)
{
    if(Mscrm.FormEditorVariables.supportInteractionCentric === "True" && Mscrm.FormEditorVariables.dashboardCategory === InteractionCentricDashboardCategory.CSR2)
        ...
        Mscrm.FormEditorVariables.supportInteractionCentric === "True" && (Mscrm.FormEditorVariables.dashboardCategory === InteractionCentricDashboardCategory.CSR1 || Mscrm.FormEditorVariables.dashboardCategory === InteractionCentricDashboardCategory.ENTITYDASHBOARD) && 
...
function AddMultipleQueues(queueType)
{
    ...
    else
    {
        ...
        if(!IsNull(Mscrm.FormEditorVariables.IS_ENTITY_DASHBOARD))
            createInlineDlg(Mscrm.CrmUri.create("/Tools/FormEditor/Dialogs/dlg_queues.aspx?title=1&objecttypecode=" + _objectTypeCode + "&dashboardcategory=" + Mscrm.FormEditorVariables.dashboardCategory + "&isentitydashboard=" + Mscrm.FormEditorVariables.IS_ENTITY_DASHBOARD),oArgs,300,500,MultipleQueueAddedCallback,parameters,null);
        else
            createInlineDlg(Mscrm.CrmUri.create("/Tools/FormEditor/Dialogs/dlg_queues.aspx?title=1&objecttypecode=" + _objectTypeCode + "&dashboardcategory=" + Mscrm.FormEditorVariables.dashboardCategory),oArgs,300,500,MultipleQueueAddedCallback,parameters,null)
    }
}
...
function AddQueues(oActive,queueType)
{
    ...
    if(queueType == "queues")
    {
        ...
        if(!IsNull(Mscrm.FormEditorVariables.IS_ENTITY_DASHBOARD))
            createInlineDlg(Mscrm.CrmUri.create("/Tools/FormEditor/Dialogs/dlg_queues.aspx?title=1&objecttypecode=" + _objectTypeCode + "&dashboardcategory=" + Mscrm.FormEditorVariables.dashboardCategory + "&isentitydashboard=" + Mscrm.FormEditorVariables.IS_ENTITY_DASHBOARD),oArgs,300,500,QueueAddedCallback,parameters,null);
        else
            createInlineDlg(Mscrm.CrmUri.create("/Tools/FormEditor/Dialogs/dlg_queues.aspx?title=1&objecttypecode=" + _objectTypeCode + "&dashboardcategory=" + Mscrm.FormEditorVariables.dashboardCategory),oArgs,300,500,QueueAddedCallback,parameters,null)
    }
    else
        if(queueType == "tiles")
        {
            oFormCell = XUI.Xml.SelectSingleNode(Mscrm.FormEditorVariables.formXml,"//entity/form/tabs/tab[@name = 'StreamsContainer']/columns/column/sections/section[@name = 'Tiles']/rows/row/cell[@id = '" + oActive.getAttribute("id") + "']",null);
            ...
            if(!IsNull(Mscrm.FormEditorVariables.IS_ENTITY_DASHBOARD))
                createInlineDlg(Mscrm.CrmUri.create("/Tools/FormEditor/Dialogs/dlg_queues.aspx?title=2&objecttypecode=" + _objectTypeCode + "&dashboardcategory=" + Mscrm.FormEditorVariables.dashboardCategory + "&isentitydashboard=" + Mscrm.FormEditorVariables.IS_ENTITY_DASHBOARD),oArgs,300,500,TileAddedCallback,parameters,null);
            else
                createInlineDlg(Mscrm.CrmUri.create("/Tools/FormEditor/Dialogs/dlg_queues.aspx?title=2&objecttypecode=" + _objectTypeCode + "&dashboardcategory=" + Mscrm.FormEditorVariables.dashboardCategory),oArgs,300,500,TileAddedCallback,parameters,null)
        }
}
...
function AddStreamObjectNode(oQueue,oStreamObjects,isTileCell,editMode)
{
    ...
    if(editMode === true)
    {
        oStreamObject = XUI.Xml.SelectSingleNode(oStreamObjects,"StreamObject[@id = '" + oQueue.EditStreamObjectId + "']",null);
    ...
    if(oQueue.queueViewSelected)
    {
        ...
        if(oQueue.isQueueCollection == "false")
        {
            ...
            XUI.Xml.SetText(oEntityLogicalNameForQueue,Xrm.Internal.getEntityName(parseInt(oQueue.queueEntityTypeCode)));
        ...
        else
        {
            ...
            XUI.Xml.SetText(oEntityLogicalNameForSavedQuery,Xrm.Internal.getEntityName(parseInt(oQueue.queueEntityTypeCode)));
            otc = oQueue.queueEntityTypeCode;
        ...
        if(!isTileCell)
        {
            if(Mscrm.FormEditorVariables.dashboardCategory === InteractionCentricDashboardCategory.CSR2)
                imageHTML = addDivElements(oStreamObject.getAttribute("id"),"stream-divtier2",oQueue,"stream-queuetier2 textEllipsis","stream-queuetier2text textEllipsis",false,editMode,isTileCell);
            else
                imageHTML = addDivElements(oStreamObject.getAttribute("id"),"stream-div",oQueue,"stream-queue textEllipsis","textEllipsis",false,editMode,isTileCell);
            ...
            imageHTML = addDivElements(oStreamObject.getAttribute("id"),"tile-div",oQueue,"tile-queue textEllipsis","textEllipsis",false,editMode,isTileCell)
    }
    else
    {
        ...
        {
            if(Mscrm.FormEditorVariables.dashboardCategory === InteractionCentricDashboardCategory.CSR2)
                imageHTML = addDivElements(oStreamObject.getAttribute("id"),"stream-divtier2",oQueue,"stream-queuetier2 textEllipsis","stream-queuetier2text textEllipsis",true,editMode,isTileCell);
            else
                imageHTML = addDivElements(oStreamObject.getAttribute("id"),"stream-div",oQueue,"stream-queue textEllipsis","textEllipsis",true,editMode,isTileCell);
            imageHTML.setAttribute("objecttypecode",otc);
            if(Mscrm.FormEditorVariables.dashboardCategory === InteractionCentricDashboardCategory.CSR2)
            {
            ...
            imageHTML = addDivElements(oStreamObject.getAttribute("id"),"tile-div",oQueue,"tile-queue textEllipsis","textEllipsis",true,editMode,isTileCell)
    }
    return imageHTML
}
...
function AddStreamObjectsNode(sTabName,sSectionName,oQueue,oFormCell,oAnchor)
{
    ...
    var imageHTML = AddStreamObjectNode(oQueue,oStreamObjects,oFormCell.getAttribute("istilecell") == "true" ? true : false,false);
    PersistLocalizedNodes(Mscrm.FormEditorVariables.formXml,"/entity/form/tabs/tab/columns/column/sections/section/rows/row/cell[control/@id = '" + oQueue.Id + "']/labels/label",oQueue.Labels);
...
function TileAddedCallback(oQueue,sTabName,sSectionName,oActive,oFormCell,queueType)
{
    ...
    var oFormCell = XUI.Xml.SelectSingleNode(Mscrm.FormEditorVariables.formXml,"//entity/form/tabs/tab[@name = 'StreamsContainer']/columns/column/sections/section[@name = 'Tiles']/rows/row/cell[@id = '" + oActive.getAttribute("id") + "']",null);
...
function AddDelve(oActive,useComponentGallery)
{
    ...
    var gridMode = "Grid",
        ...
        oSubGrid = new SubGridObj(subGridId,"",Mscrm.FormEditorVariables.officeGraphDocument,rowSpan,rowsPerPage,secCols,false,true,Mscrm.FormEditorVariables.delveViewId,false,"",false,false,gridMode,"",false,labels,"",false,false,true,gridUIMode,null,false,null,false,null,headerColorCode);
...
function UpdateDelve(oActive,bEditComponent)
{
    ...
    var headerColorCode = "";
    if(isWebClientVisualRefreshFeatureEnabled)
        if(XUI.Xml.SelectSingleNode(oParameters,"HeaderColorCode",null) != null)
            headerColorCode = XUI.Xml.GetText(XUI.Xml.SelectSingleNode(oParameters,"HeaderColorCode",null));
        else
        {
            var oheaderColorCode = Mscrm.FormEditorVariables.formXml.createElement("HeaderColorCode");
            XUI.Xml.SetText(oheaderColorCode,headerColorCode);
            oParameters.appendChild(oheaderColorCode)
        }
    var viewId = "";
    ...
    var oSubGrid = new SubGridObj(oControl.getAttribute("id"),XUI.Xml.GetText(XUI.Xml.SelectSingleNode(oParameters,"RelationshipName",null)),XUI.Xml.GetText(XUI.Xml.SelectSingleNode(oParameters,"TargetEntityType",null)),parseInt(oFormCell.getAttribute("rowspan"),10),recPerPage,parseInt(oFormCell.getAttribute("colspan"),10),oFormCell.getAttribute("auto") == "true",oFormCell.getAttribute("showlabel") == "true",viewId,enViewPicker,viewIds,enQuickFind,enJumpBar,chartGridMode,visualizationId,enChartPicker,GetLocalizedObjsArray(XUI.Xml.SelectNodes(oFormCell,"labels/label",null)),relOrdinal,isUserView,isUserChart,oFormCell.getAttribute("availableforphone") !== "false",gridUIMode,null,false,null,false,null,headerColorCode),
        labels = new Array(new LocalizedObj(Xrm.Internal.getResourceString("LOCID_DELVE_TITLE"),_langCode));
    if(!bEditComponent)
    {
        var oUpdatedGrid = new SubGridObj(oControl.getAttribute("id"),relationshipName,Mscrm.FormEditorVariables.officeGraphDocument,parseInt(oFormCell.getAttribute("rowspan"),10),recPerPage,parseInt(oFormCell.getAttribute("colspan"),10),false,true,Mscrm.FormEditorVariables.delveViewId,false,viewIds,false,false,chartGridMode,visualizationId,false,labels,relOrdinal,isUserView,isUserChart,oFormCell.getAttribute("availableforphone") !== "false",gridUIMode,null,false,null,false,null,headerColorCode);
    ...
    else
    {
        ...
        var uri,
            height,
            width;
        uri = Mscrm.CrmUri.create("/Tools/FormEditor/Dialogs/Delve.aspx?title=" + CrmEncodeDecode.CrmUrlEncode(LOCID_FORMED_SUBGRIDPROPS) + "&description=" + CrmEncodeDecode.CrmUrlEncode(LOCID_FORMED_MODIFYSUBGRIDPROPS) + "&editorType=" + CrmEncodeDecode.CrmUrlEncode(oArgs.EditorType));
        height = _subGridDefaults.iDialogHeight, width = _subGridDefaults.iDialogWidth;
...
function AddIFrame(oActive,type,useComponentGallery)
{
    if(!CanAddFields(oActive))
        return;
    var oFormCell = Mscrm.DragDropUtils.getCellNode(oActive.getAttribute("name"));
    if(Mscrm.PreviewCellUtils.isPreviewCell(oFormCell) && type != "timeline")
    {
    ...
    {
        case "iframe":
            oArgs.Field = new IframeObj("","",false,rowSpan,secCols,false,true,sTabName,sSectionName,null,false,null,null,true,Mscrm.FormEditorVariables.formXml,true,false);
            createInlineDlg(Mscrm.CrmUri.create("/Tools/FormEditor/Dialogs/iframe.aspx?mode=add&datatype=iframe&scrolling=auto&editorType=" + CrmEncodeDecode.CrmUrlEncode(oArgs.EditorType)),oArgs,_subGridDefaults.iDialogHeight,_subGridDefaults.iDialogWidth,BindFormDataOnCallback,[type,sTabName,sSectionName,oArgs.SecCols],null);
            return;
        case "webresource":
            oArgs.FormXml = Mscrm.FormEditorVariables.formXml;
            oArgs.Field = new WebResourceObj("","",false,rowSpan,secCols,false,false,sTabName,sSectionName,null,false,null,null,true,null,null,null,null,"","","","",true,false);
            createInlineDlg(Mscrm.CrmUri.create("/Tools/FormEditor/Dialogs/webresource.aspx?mode=add&datatype=iframe&scrolling=auto&editorType=" + CrmEncodeDecode.CrmUrlEncode(oArgs.EditorType)),oArgs,_lookupDialogParentDefaults.iDialogHeight,_lookupDialogParentDefaults.iDialogWidth,BindFormDataOnCallback,[type,sTabName,sSectionName,oArgs.SecCols],null);
            return;
        case "timeline":
            oArgs.oField = new FieldObj("",true,false,sTabName,sSectionName,false,secCols,rowSpan,false,_ControlClassIds.notes,"","","","","",null,false,null,null,Mscrm.FormEditorVariables.formXml,true,false,"","notescontrol",[new LocalizedObj("Timeline",_langCode)]);
            oUrl = Mscrm.CrmUri.create("/Tools/FormEditor/Dialogs/fieldprops.aspx?mode=add&editorType=DashboardEditor");
            createInlineDlg(oUrl,oArgs,720,590,BindFormDataOnCallback,[type,sTabName,sSectionName,oArgs.SecCols],null);
            return;
        case "powerbitile":
            oArgs.Field = new PowerBITileObj("Component" + createGuid().substr(1,8),rowSpan,secCols,false,sTabName,sSectionName,"",true,"","","","",0,true,true);
            createInlineDlg(Mscrm.CrmUri.create("/Tools/FormEditor/Dialogs/powerbitile.aspx?mode=add&editorType=" + CrmEncodeDecode.CrmUrlEncode(oArgs.EditorType)),oArgs,_powerBiTileDialogDefaults.iDialogHeight,_powerBiTileDialogDefaults.iDialogWidth,BindFormDataOnCallback,[type,sTabName,sSectionName,oArgs.SecCols],null);
            return;
        case "bingmap":
            oArgs.Field = new BingMapObj(Mscrm.DragDropUtils.BingMapsControlId,"",8,secCols,false,sTabName,sSectionName,null,false,Mscrm.FormEditorVariables.formXml,true);
            createInlineDlg(Mscrm.CrmUri.create("/Tools/FormEditor/Dialogs/bingmap.aspx?mode=add&etc=" + CrmEncodeDecode.CrmUrlEncode(_objectTypeCode)),oArgs,_subGridDefaults.iDialogHeight,_subGridDefaults.iDialogWidth,BindFormDataOnCallback,[type,sTabName,sSectionName,oArgs.SecCols],null);
            return;
        case "timercontrol":
            oArgs.Field = new TimerControlObj("","","","","","","","","","","","",2,secCols,sTabName,sSectionName,null,false,Mscrm.FormEditorVariables.formXml,true);
            createInlineDlg(Mscrm.CrmUri.create("/Tools/FormEditor/Dialogs/dlg_TimerControl.aspx?mode=add&datatype=iframe&editorType=" + CrmEncodeDecode.CrmUrlEncode(oArgs.EditorType) + "&etc=" + CrmEncodeDecode.CrmUrlEncode(_objectTypeCode)),oArgs,_timerControlDefaults.iDialogHeight,_timerControlDefaults.iDialogWidth,BindFormDataOnCallback,[type,sTabName,sSectionName,oArgs.SecCols],null);
            return;
        case "searchwidget":
            oArgs.Field = new SearchWidgetObj("","","","","","","","","","","","",0,secCols,sTabName,sSectionName,null,false,Mscrm.FormEditorVariables.formXml,true,"",isReferencePanelType(oActive),null,false,"",[],false,false);
            createInlineDlg(Mscrm.CrmUri.create("/Tools/FormEditor/Dialogs/dlg_KMControl.aspx?mode=add&datatype=iframe&editorType=" + CrmEncodeDecode.CrmUrlEncode(oArgs.EditorType) + "&etc=" + CrmEncodeDecode.CrmUrlEncode(_objectTypeCode) + "&icon="),oArgs,_kmControlDefaults.iDialogHeight,_kmControlDefaults.iDialogWidth,BindFormDataOnCallback,[type,sTabName,sSectionName,oArgs.SecCols],null);
            break;
        case "socialInsight":
            oArgs.Field = new SocialInsightObj("",null,false,rowSpan,secCols,true,sTabName,sSectionName,null,true,null,"auto",true,Mscrm.FormEditorVariables.formXml,true);
            if(Mscrm.FormEditorVariables.editorType !== Mscrm.EditorType.dashboardEditor)
            {
                oArgs.Field.Id = "Component" + createGuid().substr(1,8);
                createInlineDlg(Mscrm.CrmUri.create("/Tools/FormEditor/Dialogs/SocialInsight.aspx?mode=add&datatype=iframe&scrolling=auto&editorType=" + CrmEncodeDecode.CrmUrlEncode(oArgs.EditorType)),oArgs,_subGridDefaults.iDialogHeight,_subGridDefaults.iDialogWidth,BindFormDataOnCallback,[type,sTabName,sSectionName,oArgs.SecCols],null);
                return
            }
            else
            {
                ShowSocialInsightsConfigWizardOnDashboard("add","add",oArgs,"Component" + createGuid().substr(1,8),null);
        ...
        case "orgInsights":
            ...
            break;
        case "aci":
            oArgs.Field = new ACIWidgetObj("","",false,rowSpan,secCols,false,true,sTabName,sSectionName,null,false,null,null,true,Mscrm.FormEditorVariables.formXml,true,false);
            createInlineDlg(Mscrm.CrmUri.create("/Tools/FormEditor/Dialogs/ACIWidget.aspx?mode=add&datatype=iframe&scrolling=auto&editorType=" + CrmEncodeDecode.CrmUrlEncode(oArgs.EditorType)),oArgs,_subGridDefaults.iDialogHeight,_subGridDefaults.iDialogWidth,BindFormDataOnCallback,[type,sTabName,sSectionName,oArgs.SecCols],null);
            break
    }
}
...
function BindFormDataOnCallback(oControl,type,sTabName,sSectionName,secCols)
{
    if(oControl)
    {
        if(type == "iframe")
        {
            if(!IsNull(oControl.FormXml) && XUI.Xml.XMLSerializer.serializeToString(oControl.FormXml) != XUI.Xml.XMLSerializer.serializeToString(Mscrm.FormEditorVariables.formXml))
                Mscrm.FormEditorVariables.formXml = oControl.FormXml
        }
        else
            if(type == "socialInsight" || type == "powerbitile")
            {
                oControl.Url = null;
                ...
                if(type == "orgInsights")
                {
                    ...
                    if(type == "timercontrol" || type == "searchwidget")
                    {
                        if(!IsNull(oControl.FormXml) && XUI.Xml.XMLSerializer.serializeToString(oControl.FormXml) != XUI.Xml.XMLSerializer.serializeToString(Mscrm.FormEditorVariables.formXml))
                            Mscrm.FormEditorVariables.formXml = oControl.FormXml
                    }
...
function ShowSocialInsightsConfigWizardOnDashboard(socialInsightMode,formMode,oArgs,label,oActive)
{
    ...
    var crmDialog = new Mscrm.CrmDialog(Mscrm.CrmUri.create("/WebWizard/WizardContainer.aspx?WizardId=2F705211-E38E-4CF8-A0E3-980FC83025C6"),oArgs,_socialInsightDefaults.iDialogWidth,_socialInsightDefaults.iDialogHeight,null),
    ...
    if(formMode == "add")
    {
        returnFunctionReference.parameters = [oSocialInsightObj,oSocialInsightObj.TabName,oSocialInsightObj.SectionName];
        returnFunctionReference.callback = function(oSocialInsightObj,sTabName,sSectionName)
        {
            if(!IsNull(oSocialInsightObj.FormXml) && XUI.Xml.XMLSerializer.serializeToString(oSocialInsightObj.FormXml) !== XUI.Xml.XMLSerializer.serializeToString(Mscrm.FormEditorVariables.formXml))
        ...
        if(formMode == "edit")
        {
            if(oArgs.FormID === "00000000-0000-0000-0000-000000000000" && !IsNull(Mscrm.FormEditorVariables.socialInsightsConfigurations[oArgs.Field.Id]))
                oArgs.socialInsightsConfiguration = Mscrm.FormEditorVariables.socialInsightsConfigurations[oArgs.Field.Id];
            returnFunctionReference.parameters = [oSocialInsightObj.TabName,oSocialInsightObj.SectionName,socialInsightMode,oActive,oSocialInsightObj];
...
function AddSubGridFormXml(oSubGrid)
{
    ...
    var headerColorCode = Mscrm.FormEditorVariables.formXml.createElement("HeaderColorCode");
    isWebClientVisualRefreshFeatureEnabled && 
        XUI.Xml.SetText(headerColorCode,oSubGrid.HeaderColorCode.toString());
    oParameters.appendChild(headerColorCode);
    ...
    if(oSubGrid.IsReferencePanelSubGrid)
    {
        var oReferencePanelSubGridIconUrl = Mscrm.FormEditorVariables.formXml.createElement("ReferencePanelSubgridIconUrl");
    ...
    AddCustomControlSnippet(oParameters,oSubGrid.CustomControlSnippet,oSubGrid.CustomControlUniqueId);
    PersistLocalizedNodes(Mscrm.FormEditorVariables.formXml,"/entity/form/tabs/tab/columns/column/sections/section/rows/row/cell[control/@id = '" + oSubGrid.Id + "']/labels/label",oSubGrid.Labels);
    return cellId
}
function AddUnboundControlFormXml(oUnboundCustomControl)
{
    var oRows = Mscrm.DragDropUtils.getRowsNode(oUnboundCustomControl.SectionName,null),
        oCell = Mscrm.FormEditorVariables.formXml.createElement("cell"),
        cellId = createGuid();
    oCell.setAttribute("id",cellId);
    oCell.setAttribute("showlabel",oUnboundCustomControl.ShowLabel.toString());
    oCell.setAttribute("colspan",oUnboundCustomControl.ColSpan.toString());
    oCell.appendChild(Mscrm.FormEditorVariables.formXml.createElement("labels"));
    var oControl = Mscrm.FormEditorVariables.formXml.createElement("control");
    oCell.appendChild(oControl);
    oControl.setAttribute("id",oUnboundCustomControl.Id);
    oControl.setAttribute("classid",_ControlClassIds.customControl);
    oControl.setAttribute("isunbound",true);
    oCell.setAttribute("auto",oUnboundCustomControl.Auto.toString());
    oUnboundCustomControl.Auto && 
        ModifyOtherAutoExpandingFieldIfRequired(oCell);
    var oParameters = Mscrm.FormEditorVariables.formXml.createElement("parameters");
    oControl.appendChild(oParameters);
    AddCellToFormXml(oRows,oCell,oUnboundCustomControl.RowSpan,false,oUnboundCustomControl.Auto);
    AddCustomControlSnippet(oParameters,oUnboundCustomControl.CustomControlSnippet,oUnboundCustomControl.CustomControlUniqueId);
    PersistLocalizedNodes(Mscrm.FormEditorVariables.formXml,"/entity/form/tabs/tab/columns/column/sections/section/rows/row/cell[control/@id = '" + oUnboundCustomControl.Id + "']/labels/label",oUnboundCustomControl.Labels);
    return cellId
}
function AddOrgInsightsFormXml(oOrgInsights)
{
    ...
    PersistLocalizedNodes(Mscrm.FormEditorVariables.formXml,"/entity/form/tabs/tab/columns/column/sections/section/rows/row/cell[control/@id = '" + oOrgInsights.Id + "']/labels/label",oOrgInsights.Labels);
    return cellId
}
function AddQuickFormCollectionXml(oQuickForm)
{
    ...
    for(i = 0; i < len; i++)
        nodeText += '<QuickFormId entityname="' + oQuickForm.QuickFormCollectionInfo[i].entity + '">' + oQuickForm.QuickFormCollectionInfo[i].formId + "</QuickFormId>";
    ...
    if(oQuickForm.IsReferencePanelQuickFormCollection)
    {
        var oReferencePanelQuickFormIconUrl = Mscrm.FormEditorVariables.formXml.createElement("ReferencePanelQuickFormCollectionIconUrl");
    ...
    PersistLocalizedNodes(Mscrm.FormEditorVariables.formXml,"/entity/form/tabs/tab/columns/column/sections/section/rows/row/cell[control/@id = '" + oQuickForm.Id + "']/labels/label",oQuickForm.Labels);
    return cellId
}
function AddControlFormXml(oFormControl,type)
{
    ...
    switch(type)
    {
        ...
        case "aci":
            ...
            break;
        case "timeline":
            oControl.setAttribute("classid",_ControlClassIds.notes);
            break;
        case "webresource":
            var wrClassId;
    ...
    if(type === "powerbitile")
    {
        if(oFormControl.GroupId != null)
        {
            var el = Mscrm.FormEditorVariables.formXml.createElement("PowerBIGroupId");
            oParameters.appendChild(el);
            XUI.Xml.SetText(el,oFormControl.GroupId)
        }
    ...
    if(type == "timeline")
    {
        if(oFormControl.oParameters["UClientUniqueName"] != null)
        {
            var sName = Mscrm.FormEditorVariables.formXml.createElement("UClientUniqueName");
            oParameters.appendChild(sName);
            XUI.Xml.SetText(sName,oFormControl.oParameters["UClientUniqueName"])
        }
        if(oFormControl.oParameters["UClientModules"] != null)
        {
            var sModules = Mscrm.FormEditorVariables.formXml.createElement("UClientModules");
            oParameters.appendChild(sModules);
            XUI.Xml.SetText(sModules,oFormControl.oParameters["UClientModules"])
        }
        if(oFormControl.oParameters["UClientExpandFilterPane"] != null)
        {
            var bExpFilter = Mscrm.FormEditorVariables.formXml.createElement("UClientExpandFilterPane");
            oParameters.appendChild(bExpFilter);
            XUI.Xml.SetText(bExpFilter,oFormControl.oParameters["UClientExpandFilterPane"])
        }
        if(oFormControl.oParameters["UClientShowFilterPane"] != null)
        {
            var bShowFilter = Mscrm.FormEditorVariables.formXml.createElement("UClientShowFilterPane");
            oParameters.appendChild(bShowFilter);
            XUI.Xml.SetText(bShowFilter,oFormControl.oParameters["UClientShowFilterPane"])
        }
        if(oFormControl.oParameters["UClientOrderBy"] != null)
        {
            var sOrderBy = Mscrm.FormEditorVariables.formXml.createElement("UClientOrderBy");
            oParameters.appendChild(sOrderBy);
            XUI.Xml.SetText(sOrderBy,oFormControl.oParameters["UClientOrderBy"])
        }
        if(oFormControl.oParameters["UClientRecordPerPage"] != null)
        {
            var iRecPerPage = Mscrm.FormEditorVariables.formXml.createElement("UClientRecordPerPage");
            oParameters.appendChild(iRecPerPage);
            XUI.Xml.SetText(iRecPerPage,oFormControl.oParameters["UClientRecordPerPage"])
        }
        if(oFormControl.oParameters["UClientActivities"] != null)
        {
            var sActivities = Mscrm.FormEditorVariables.formXml.createElement("UClientActivities");
            oParameters.appendChild(sActivities);
            XUI.Xml.SetText(sActivities,oFormControl.oParameters["UClientActivities"])
        }
        if(oFormControl.oParameters["UClientSortActivitiesByValue"] != null)
        {
            var sSortActivities = Mscrm.FormEditorVariables.formXml.createElement("UClientSortActivitiesByValue");
            oParameters.appendChild(sSortActivities);
            XUI.Xml.SetText(sSortActivities,oFormControl.oParameters["UClientSortActivitiesByValue"])
        }
        if(oFormControl.oParameters["UClientDisplayActivityHeaderUsing"] != null)
        {
            var sDispHeader = Mscrm.FormEditorVariables.formXml.createElement("UClientDisplayActivityHeaderUsing");
            oParameters.appendChild(sDispHeader);
            XUI.Xml.SetText(sDispHeader,oFormControl.oParameters["UClientDisplayActivityHeaderUsing"])
        }
        if(oFormControl.oParameters["UClientCreateActivityUsing"] != null)
        {
            var sCreateAct = Mscrm.FormEditorVariables.formXml.createElement("UClientCreateActivityUsing");
            oParameters.appendChild(sCreateAct);
            XUI.Xml.SetText(sCreateAct,oFormControl.oParameters["UClientCreateActivityUsing"])
        }
        if(oFormControl.oParameters["UClientDisplayActivityUsing"] != null)
        {
            var sDispAct = Mscrm.FormEditorVariables.formXml.createElement("UClientDisplayActivityUsing");
            oParameters.appendChild(sDispAct);
            XUI.Xml.SetText(sDispAct,oFormControl.oParameters["UClientDisplayActivityUsing"])
        }
        if(oFormControl.oParameters["UClientActivityCardMap"] != null)
        {
            var sCardMap = Mscrm.FormEditorVariables.formXml.createElement("UClientActivityCardMap");
            oParameters.appendChild(sCardMap);
            XUI.Xml.SetText(sCardMap,oFormControl.oParameters["UClientActivityCardMap"])
        }
    }
    if(type === "aci")
    {
    ...
    if(type == "searchwidget")
    {
        ...
        if(oFormControl.SearchForAutoSuggestionsUsing != null && oFormControl.SearchForAutoSuggestionsUsing.length > 0)
        {
            var oAutomaticSuggestionSearchField = Mscrm.FormEditorVariables.formXml.createElement("SearchForAutoSuggestionsUsing");
        ...
        if(oFormControl.SelectPrimaryCustomer != null && oFormControl.SelectPrimaryCustomer.length > 0)
        {
            ...
            XUI.Xml.SetText(oPrimaryCustomer,oFormControl.SelectPrimaryCustomer != null ? oFormControl.SelectPrimaryCustomer : "")
        }
        if(oFormControl.IsReferencePanelSearchWidget)
        {
            var oReferencePanelSearchWidgetIconUrl = Mscrm.FormEditorVariables.formXml.createElement("ReferencePanelSearchWidgetIconUrl");
        ...
        if(!window.IS_ONPREMISE && Xrm.Internal.isFeatureEnabled(Mscrm.FeatureNames.MetadataDrivenFilterForKbSearch))
        {
            if(oFormControl.MappedFields != null && oFormControl.MappedFields.length > 0)
            {
                oMappedFields = Mscrm.FormEditorVariables.formXml.createElement("MappedFields");
                oParameters.appendChild(oMappedFields);
                XUI.Xml.SetText(oMappedFields,JSON.stringify(oFormControl.MappedFields))
            }
            if(oFormControl.EnableMDF)
            {
                oEnableMDF = Mscrm.FormEditorVariables.formXml.createElement("EnableMDF");
                oParameters.appendChild(oEnableMDF);
                XUI.Xml.SetText(oEnableMDF,oFormControl.EnableMDF)
            }
            if(oFormControl.AllowDisablingMDFOnUI)
            {
                oAllowDisablingMDFOnUI = Mscrm.FormEditorVariables.formXml.createElement("AllowDisablingMDFOnUI");
                oParameters.appendChild(oAllowDisablingMDFOnUI);
                XUI.Xml.SetText(oAllowDisablingMDFOnUI,oFormControl.AllowDisablingMDFOnUI)
            }
        }
    }
    ...
    PersistLocalizedNodes(Mscrm.FormEditorVariables.formXml,formXmlPath + "[@id = '" + cellId + "']/labels/label",oFormControl.Labels);
    return cellId
}
...
function UpdateSubGrid(oActive,isChart,useComponentGallery)
{
    var sSubGridName = oActive.getAttribute("name"),
        oFormCell = Mscrm.DragDropUtils.getCellNodeFromId(oActive.id);
    if(Mscrm.FormEditorVariables.supportInteractionCentric === "True" && typeof isChart === "undefined" && typeof useComponentGallery === "undefined")
        return;
    if(!CanUpdateField(oFormCell))
        return;
    var sTabName = GetCurrentTabName(oActive),
        sSectionName = GetCurrentSectionName(oActive),
        oControl = XUI.Xml.SelectSingleNode(oFormCell,"control",null),
        oUniqueId = oControl.getAttribute("uniqueid");
    if(oUniqueId == null)
        oUniqueId = "";
    Mscrm.PreviewCellUtils.isPreviewCell(oFormCell) && 
    ...
    if(XUI.Xml.SelectSingleNode(oParameters,"GridUIMode",null) != null)
    {
        ...
        if(gridUIMode == "Card" && XUI.Xml.GetText(XUI.Xml.SelectSingleNode(oParameters,"TargetEntityType",null)) == Mscrm.FormEditorVariables.officeGraphDocument)
        {
    ...
    if(isReferencePanelSubGrid && XUI.Xml.SelectSingleNode(oParameters,"ReferencePanelSubgridIconUrl",null) != null)
        referencePanelSubGridIconUrl = XUI.Xml.GetText(XUI.Xml.SelectSingleNode(oParameters,"ReferencePanelSubgridIconUrl",null));
    var oSubGrid = new SubGridObj(oControl.getAttribute("id"),XUI.Xml.GetText(XUI.Xml.SelectSingleNode(oParameters,"RelationshipName",null)),XUI.Xml.GetText(XUI.Xml.SelectSingleNode(oParameters,"TargetEntityType",null)),oFormCell.getAttribute("rowspan") != null ? parseInt(oFormCell.getAttribute("rowspan"),10) : 0,recPerPage,parseInt(oFormCell.getAttribute("colspan"),10),oFormCell.getAttribute("auto") == "true",oFormCell.getAttribute("showlabel") == "true",viewId,enViewPicker,viewIds,enQuickFind,enJumpBar,chartGridMode,visualizationId,enChartPicker,GetLocalizedObjsArray(XUI.Xml.SelectNodes(oFormCell,"labels/label",null)),relOrdinal,isUserView,isUserChart,oFormCell.getAttribute("availableforphone") !== "false",null,null,isReferencePanelSubGrid,referencePanelSubGridIconUrl,null,null,headerColorCode);
    if(XUI.Xml.SelectSingleNode(oParameters,"TeamTemplateId",null) != null)
        oSubGrid.TeamTemplateId = XUI.Xml.GetText(XUI.Xml.SelectSingleNode(oParameters,"TeamTemplateId",null));
    oArgs.Field = oSubGrid;
    oArgs.FieldsXml = oFieldsXml;
    oArgs.FieldPropertiesXml = oPropertiesXml;
    oArgs.FormXml = Mscrm.FormEditorVariables.formXml;
    ...
    else
    {
        ...
        if(Mscrm.FeatureControl.get_Current().isFeatureEnabled(Mscrm.FeatureNames.EditableGridControlJsEvents))
            oArgs.CellId = oActive.id;
        if(oArgs.sCustomControlUniqueId == "{3ff9a528-dd50-4aca-8f10-2e5ed73513ad}")
            propertyDescription = CrmEncodeDecode.CrmUrlEncode(LOCID_FORMED_MODIFYRACARDSDPROPS);
        else
            propertyDescription = CrmEncodeDecode.CrmUrlEncode(LOCID_FORMED_MODIFYSUBGRIDPROPS);
        uri = Mscrm.CrmUri.create("/Tools/FormEditor/Dialogs/subGrid.aspx?title=" + CrmEncodeDecode.CrmUrlEncode(LOCID_FORMED_SUBGRIDPROPS) + "&description=" + propertyDescription + "&editorType=" + CrmEncodeDecode.CrmUrlEncode(oArgs.EditorType) + "&parentFormType=" + CrmEncodeDecode.CrmUrlEncode(Mscrm.FormEditorVariables.FormType) + "&icon=" + CrmEncodeDecode.CrmUrlEncode(referencePanelSubGridIconUrl) + "&chartgridmode=" + CrmEncodeDecode.CrmUrlEncode(chartGridMode) + "&uniqueid=" + CrmEncodeDecode.CrmUrlEncode(oUniqueId));
        height = _subGridDefaults.iDialogHeight, width = _subGridDefaults.iDialogWidth
    }
    var parameters = [oSubGrid,sTabName,sSectionName,oActive,oControl,oFormCell,recPerPage];
    createInlineDlg(uri,oArgs,height,width,UpdateComponentGallery,parameters,null);
    AddTelemetryLog("UpdateSubGrid")
}
function UpdateUnboundCustomControl(oActive,useComponentGallery)
{
    var sUnboundCustomControlName = oActive.getAttribute("name"),
        oFormCell = Mscrm.DragDropUtils.getCellNodeFromId(oActive.id);
    if(!CanUpdateField(oFormCell))
        return;
    var sTabName = GetCurrentTabName(oActive),
    ...
    var heightNode = XUI.Xml.SelectSingleNode(oParameters,"Height",null),
        ...
        oUnboundCustomControl = new UnboundCustomControlObj(sUnboundCustomControlName,parseInt(oFormCell.getAttribute("rowspan"),10),parseInt(oFormCell.getAttribute("colspan"),10),oFormCell.getAttribute("auto") == "true",sTabName,sSectionName,GetLocalizedObjsArray(XUI.Xml.SelectNodes(oFormCell,"labels/label",null)),oFormCell.getAttribute("showlabel") == "true",sScrolling,border == "true",height,width,true,false,null,Mscrm.FormEditorVariables.formXml);
    oArgs.Field = oUnboundCustomControl;
    oArgs.FieldsXml = oFieldsXml;
    oArgs.FieldPropertiesXml = oPropertiesXml;
    oArgs.FormXml = Mscrm.FormEditorVariables.formXml;
    oArgs.ObjectTypeCode = _objectTypeCode;
    ...
    if(Mscrm.FeatureControl.get_Current().isFeatureEnabled(Mscrm.FeatureNames.EditableGridControlJsEvents))
        oArgs.CellId = oActive.id;
    uri = Mscrm.CrmUri.create("/Tools/FormEditor/Dialogs/CustomControl.aspx?mode=edit&scrolling=auto");
    height = _subGridDefaults.iDialogHeight, width = _subGridDefaults.iDialogWidth;
    var parameters = [oUnboundCustomControl,sTabName,sSectionName,oActive,oControl,oFormCell];
    createInlineDlg(uri,oArgs,height,width,UpdateUnboundCustomControlCallback,parameters,null)
}
function UpdateSubGridOrgInsights(oActive,useComponentGallery)
{
    ...
    var oOrgInsights = new OrgInsightsObj(oControl.getAttribute("id"),rowSpan,secCols,true,sTabName,sSectionName,null,true,null,"auto",true,Mscrm.FormEditorVariables.formXml,true,visualizationId,false);
...
function UpdateComponentGallery(oUpdatedGrid,oSubGrid,sTabName,sSectionName,oActive,control,oFormCell,recPerPage)
{
    if(oUpdatedGrid)
    {
        ...
        if(Mscrm.FeatureControl.get_Current().isFeatureEnabled(Mscrm.FeatureNames.EditableGridControlJsEvents))
            if(!IsNull(oUpdatedGrid.FormXml) && XUI.Xml.XMLSerializer.serializeToString(oUpdatedGrid.FormXml) != XUI.Xml.XMLSerializer.serializeToString(Mscrm.FormEditorVariables.formXml))
            {
                var form = XUI.Xml.SelectSingleNode(Mscrm.FormEditorVariables.formXml,Mscrm.FormXmlPaths.formPath,null),
                    existingLibraries = XUI.Xml.SelectSingleNode(Mscrm.FormEditorVariables.formXml,Mscrm.FormXmlPaths.formLibrariesPath,null),
                    existingEvents = XUI.Xml.SelectSingleNode(Mscrm.FormEditorVariables.formXml,Mscrm.FormXmlPaths.formEventsPath,null),
                    updatedLibraries = XUI.Xml.SelectSingleNode(oUpdatedGrid.FormXml,Mscrm.FormXmlPaths.formLibrariesPath,null),
                    updatedEvents = XUI.Xml.SelectSingleNode(oUpdatedGrid.FormXml,Mscrm.FormXmlPaths.formEventsPath,null);
        ...
        oUpdatedGrid.AvailableForPhone != null && 
            setAttributeIfNotDefaultValue(oFormCell,"availableforphone",oUpdatedGrid.AvailableForPhone.toString(),"true");
        XUI.Xml.SetText(XUI.Xml.SelectSingleNode(oParameters,"ViewId",null),oUpdatedGrid.DefaultView);
        XUI.Xml.SetText(XUI.Xml.SelectSingleNode(oParameters,"IsUserView",null),oUpdatedGrid.IsUserView.toString());
        XUI.Xml.SetText(XUI.Xml.SelectSingleNode(oParameters,"EnableViewPicker",null),oUpdatedGrid.EnableViewPicker.toString());
        ...
        oUpdatedGrid.RowsPerPage != null && 
            XUI.Xml.SetText(XUI.Xml.SelectSingleNode(oParameters,"RecordsPerPage",null),oUpdatedGrid.RowsPerPage.toString());
        XUI.Xml.SetText(XUI.Xml.SelectSingleNode(oParameters,"EnableQuickFind",null),oUpdatedGrid.EnableSearchBox.toString());
        XUI.Xml.SetText(XUI.Xml.SelectSingleNode(oParameters,"EnableJumpBar",null),oUpdatedGrid.EnableIndex.toString());
        ...
        XUI.Xml.SetText(XUI.Xml.SelectSingleNode(oParameters,"IsUserChart",null),oUpdatedGrid.IsUserChart.toString());
        XUI.Xml.SetText(XUI.Xml.SelectSingleNode(oParameters,"EnableChartPicker",null),oUpdatedGrid.EnableChartPicker.toString());
        isWebClientVisualRefreshFeatureEnabled && 
            XUI.Xml.SetText(XUI.Xml.SelectSingleNode(oParameters,"HeaderColorCode",null),oUpdatedGrid.HeaderColorCode.toString());
        if(oUpdatedGrid.IsReferencePanelSubGrid)
            if(XUI.Xml.SelectSingleNode(oParameters,"ReferencePanelSubgridIconUrl",null) != null)
                XUI.Xml.SetText(XUI.Xml.SelectSingleNode(oParameters,"ReferencePanelSubgridIconUrl",null),oUpdatedGrid.IconUrl);
            else
            {
                var oReferencePanelSubGridIconUrl = Mscrm.FormEditorVariables.formXml.createElement("ReferencePanelSubgridIconUrl");
        ...
        if(oUpdatedGrid.AssociationRoleOrdinal.length > 0)
        {
            ...
            XUI.Xml.SetText(XUI.Xml.SelectSingleNode(oParameters,"RelationshipRoleOrdinal",null),oUpdatedGrid.AssociationRoleOrdinal)
        }
        else
            node != null && 
        ...
        oUpdatedGrid.TeamTemplateId != null && 
            XUI.Xml.SetText(XUI.Xml.SelectSingleNode(oParameters,"TeamTemplateId",null),oUpdatedGrid.TeamTemplateId.toString());
        var oUniqueId = oControl.getAttribute("uniqueid");
        if(oUniqueId == null)
            oUniqueId = "";
        oUniqueId != "{3ff9a528-dd50-4aca-8f10-2e5ed73513ad}" && 
            DeleteExistingControlSnippet(oControl);
        oControl.setAttribute("id",oUpdatedGrid.Id);
        var bChangeClassId = null;
        if(oUniqueId != "{3ff9a528-dd50-4aca-8f10-2e5ed73513ad}")
            bChangeClassId = AddCustomControlSnippet(oParameters,oUpdatedGrid.CustomControlSnippet,oUpdatedGrid.CustomControlUniqueId);
        if(oUniqueId == "{3ff9a528-dd50-4aca-8f10-2e5ed73513ad}")
        {
            AddTelemetryLog("UpdateRAcardsComponentGallery");
            oControl.setAttribute("classid",_ControlClassIds.customControl)
        }
        PersistLocalizedNodes(Mscrm.FormEditorVariables.formXml,"/entity/form/tabs/tab/columns/column/sections/section/rows/row/cell[@id = '" + oActive.id + "']/labels/label",oUpdatedGrid.Labels);
        ...
        if(Mscrm.FeatureControl.get_Current().isFeatureEnabled(Mscrm.FeatureNames.CustomControlMobile) && bChangeClassId)
        {
            var controlType = oSubGrid.IsReferencePanelSubGrid ? _ControlClassIds.referencepanelsubgrid : _ControlClassIds.subgrid,
                controlNode = null;
            if(Mscrm.FeatureControl.get_Current().isFeatureEnabled(Mscrm.FeatureNames.EditableGridControlJsEvents))
                controlNode = XUI.Xml.SelectSingleNode(Mscrm.FormEditorVariables.formXml,"/entity/form/tabs/tab/columns/column/sections/section/rows/row/cell[@id = '" + oActive.id + "']/control");
            else
                controlNode = XUI.Xml.SelectSingleNode(Mscrm.FormEditorVariables.formXml,"/entity/form/tabs/tab/columns/column/sections/section/rows/row/cell[@id = '" + oActive.id + "']/control[@classid = '" + controlType + "']");
            controlNode.setAttribute("classid",_ControlClassIds.customControl)
        }
        AddTelemetryLog("UpdateComponentGallery")
    }
}
function UpdateUnboundCustomControlCallback(oUpdatedUnboundCustomControl,oUnboundCustomControl,sTabName,sSectionName,oActive,control,oFormCell)
{
    if(oUpdatedUnboundCustomControl)
    {
        oUpdatedUnboundCustomControl.TabName = sTabName;
        oUpdatedUnboundCustomControl.SectionName = sSectionName;
        oUnboundCustomControl.CustomControlUniqueId = oUpdatedUnboundCustomControl.CustomControlUniqueId;
        control.setAttribute("classid",_ControlClassIds.customControl);
        control.setAttribute("isunbound",true);
        control.setAttribute("uniqueid",oUnboundCustomControl.CustomControlUniqueId);
        var oCell = Mscrm.DragDropUtils.getCellNodeFromId(oActive.id),
            oControl = XUI.Xml.SelectSingleNode(oCell,"control",null),
            oParameters = XUI.Xml.SelectSingleNode(oControl,"parameters",null);
        if(!CheckAndUpdateColSpan(oCell,oUnboundCustomControl.ColSpan,oUpdatedUnboundCustomControl.ColSpan))
            return;
        oFormCell.setAttribute("auto",oUpdatedUnboundCustomControl.Auto.toString());
        oUpdatedUnboundCustomControl.Auto && 
            ModifyOtherAutoExpandingFieldIfRequired(oFormCell);
        oFormCell.setAttribute("showlabel",oUpdatedUnboundCustomControl.ShowLabel.toString());
        if(oUpdatedUnboundCustomControl.RowSpan != null)
            if(oUnboundCustomControl.RowSpan != oUpdatedUnboundCustomControl.RowSpan)
            {
                Mscrm.FieldPropertiesUtils.adjustFormXmlForRowSpanChange(oFormCell,oUnboundCustomControl.RowSpan,oUpdatedUnboundCustomControl.RowSpan);
                oFormCell.setAttribute("rowspan",oUpdatedUnboundCustomControl.RowSpan.toString())
            }
        var oUniqueId = oControl.getAttribute("uniqueid");
        if(oUniqueId == null)
            oUniqueId = "";
        DeleteExistingControlSnippet(oControl);
        oControl.setAttribute("id",oUpdatedUnboundCustomControl.Id);
        var bChangeClassId = AddCustomControlSnippet(oParameters,oUpdatedUnboundCustomControl.CustomControlSnippet,oUpdatedUnboundCustomControl.CustomControlUniqueId);
        PersistLocalizedNodes(Mscrm.FormEditorVariables.formXml,"/entity/form/tabs/tab/columns/column/sections/section/rows/row/cell[@id = '" + oActive.id + "']/labels/label",oUpdatedUnboundCustomControl.Labels);
        var bRefreshCellOnly = oUnboundCustomControl.ColSpan == oUpdatedUnboundCustomControl.ColSpan && oUnboundCustomControl.RowSpan == oUpdatedUnboundCustomControl.RowSpan;
        RefreshCellHtml(oUpdatedUnboundCustomControl.TabName,oUpdatedUnboundCustomControl.SectionName,oActive.id,bRefreshCellOnly);
        if(Mscrm.FeatureControl.get_Current().isFeatureEnabled(Mscrm.FeatureNames.CustomControlMobile) && bChangeClassId)
        {
            var controlType = oUnboundCustomControl.IsReferencePanelSubGrid ? _ControlClassIds.referencepanelsubgrid : _ControlClassIds.subgrid,
                controlNode = null;
            if(Mscrm.FeatureControl.get_Current().isFeatureEnabled(Mscrm.FeatureNames.EditableGridControlJsEvents))
                controlNode = XUI.Xml.SelectSingleNode(Mscrm.FormEditorVariables.formXml,"/entity/form/tabs/tab/columns/column/sections/section/rows/row/cell[@id = '" + oActive.id + "']/control");
            else
...
function UpdateComponentGalleryOrgInsights(oUpdatedGrid,oSubGrid,sTabName,sSectionName,oActive,control,oFormCell,recPerPage)
{
    if(oUpdatedGrid)
    {
        oUpdatedGrid.TabName = sTabName;
...
function UpdateQuickFormCollection(oActive)
{
    ...
    if(isReferencePanelQuickFormCollection && XUI.Xml.SelectSingleNode(oParameters,"ReferencePanelQuickFormCollectionIconUrl",null) != null)
        referencePanelQuickFormCollectionIconUrl = XUI.Xml.GetText(XUI.Xml.SelectSingleNode(oParameters,"ReferencePanelQuickFormCollectionIconUrl",null));
    var displayAsCustomer360Tile = null;
    if(XUI.Xml.SelectSingleNode(oParameters,"DisplayAsCustomer360Tile",null) != null)
        displayAsCustomer360Tile = XUI.Xml.GetText(XUI.Xml.SelectSingleNode(oParameters,"DisplayAsCustomer360Tile",null));
    var oArgs = {},
        quickforms = "";
    ...
    var oQuickForm = new QuickFormObj(oControl.getAttribute("id"),oFormCell.getAttribute("showlabel") == "true",GetLocalizedObjsArray(XUI.Xml.SelectNodes(oFormCell,"labels/label",null)),oFormCell.getAttribute("auto") == "true",sDataFieldName,oQuickFormCollectionInfo,isReferencePanelQuickFormCollection,referencePanelQuickFormCollectionIconUrl,displayAsCustomer360Tile == "true");
    ...
    var url = Mscrm.CrmUri.create("/Tools/FormEditor/Dialogs/quickFormCollectionControl.aspx?title=" + CrmEncodeDecode.CrmUrlEncode(LOCID_FORMED_SUBFORMPROPS) + "&description=" + CrmEncodeDecode.CrmUrlEncode(LOCID_FORMED_MODIFYSUBFORMPROPS) + "&icon=" + CrmEncodeDecode.CrmUrlEncode(referencePanelQuickFormCollectionIconUrl)),
        callBackParameters = [sTabName,sSectionName,oActive,sDataFieldName,oFormCell],
        dialogOptions = new Xrm.DialogOptions;
    dialogOptions.height = _subGridDefaults.iDialogHeight;
    dialogOptions.width = _subGridDefaults.iDialogWidth + 60;
    var callbkFunction = Mscrm.Utilities.createCallbackFunctionForXrmDialog(quickFormUpdateCallBackFunction,callBackParameters);
    Xrm.Internal.openDialog(url.toString(),dialogOptions,oArgs,null,callbkFunction)
}
    ...
    if(oUpdateQuickForm)
    {
        ...
        if(oUpdateQuickForm.IsReferencePanelQuickFormCollection)
            if(XUI.Xml.SelectSingleNode(oParameters,"ReferencePanelQuickFormCollectionIconUrl",null) != null)
                XUI.Xml.SetText(XUI.Xml.SelectSingleNode(oParameters,"ReferencePanelQuickFormCollectionIconUrl",null),oUpdateQuickForm.IconUrl);
            else
            {
                var oReferencePanelQuickFormCollectionIconUrl = Mscrm.FormEditorVariables.formXml.createElement("ReferencePanelQuickFormCollectionIconUrl");
        ...
        if(XUI.Xml.SelectSingleNode(oParameters,"DisplayAsCustomer360Tile",null) != null)
            XUI.Xml.SetText(XUI.Xml.SelectSingleNode(oParameters,"DisplayAsCustomer360Tile",null),oUpdateQuickForm.DisplayAsCustomer360Tile);
        else
        {
            var oDisplayAsCustomer360Tile = Mscrm.FormEditorVariables.formXml.createElement("DisplayAsCustomer360Tile");
        ...
        var nodeText = "<QuickFormIds>";
        for(i = 0; i < len; i++)
            nodeText += '<QuickFormId entityname="' + oUpdateQuickForm.QuickFormCollectionInfo[i].entity + '">' + oUpdateQuickForm.QuickFormCollectionInfo[i].formId + "</QuickFormId>";
        nodeText += "</QuickFormIds>";
        ...
        PersistLocalizedNodes(Mscrm.FormEditorVariables.formXml,"/entity/form/tabs/tab/columns/column/sections/section/rows/row/cell[@id = '" + oActive.id + "']/labels/label",oUpdateQuickForm.Labels);
...
function UpdateIFrame(oActive,useComponentGallery,mode)
{
    ...
    switch(oActive.className)
    {
        case "iframe":
            ...
            oIframe = new IframeObj(oControl.getAttribute("id"),XUI.Xml.GetText(XUI.Xml.SelectSingleNode(oParameters,"Url",null)),XUI.Xml.GetText(XUI.Xml.SelectSingleNode(oParameters,"PassParameters",null)) == "true",parseInt(oFormCell.getAttribute("rowspan"),10),parseInt(oFormCell.getAttribute("colspan"),10),oFormCell.getAttribute("auto") == "true",XUI.Xml.GetText(XUI.Xml.SelectSingleNode(oParameters,"Security",null)) == "true",sTabName,sSectionName,GetLocalizedObjsArray(XUI.Xml.SelectNodes(oFormCell,"labels/label",null)),oFormCell.getAttribute("showlabel") == "true",oDependsAry,sScrolling,XUI.Xml.GetText(XUI.Xml.SelectSingleNode(oParameters,"Border",null)) == "true",Mscrm.FormEditorVariables.formXml,bVisible,showOnMobileClient == "true");
            oArgs.CellId = oActive.id;
            break;
        case "aci":
            var showOnMobileClient = "true";
            oIframe = new ACIWidgetObj(oControl.getAttribute("id"),XUI.Xml.GetText(XUI.Xml.SelectSingleNode(oParameters,"ViewName",null)),true,parseInt(oFormCell.getAttribute("rowspan"),10),parseInt(oFormCell.getAttribute("colspan"),10),oFormCell.getAttribute("auto") == "true",false,sTabName,sSectionName,GetLocalizedObjsArray(XUI.Xml.SelectNodes(oFormCell,"labels/label",null)),true,oDependsAry,sScrolling,XUI.Xml.GetText(XUI.Xml.SelectSingleNode(oParameters,"Border",null)) == "true",Mscrm.FormEditorVariables.formXml,true,true);
            oArgs.CellId = oActive.id;
            break;
        case "powerbitile":
            oIframe = new PowerBITileObj(oControl.getAttribute("id"),parseInt(oFormCell.getAttribute("rowspan"),10),parseInt(oFormCell.getAttribute("colspan"),10),false,sTabName,sSectionName,GetLocalizedObjsArray(XUI.Xml.SelectNodes(oFormCell,"labels/label",null)),oFormCell.getAttribute("showlabel") == "true",XUI.Xml.GetText(XUI.Xml.SelectSingleNode(oParameters,"PowerBIGroupId",null)),XUI.Xml.GetText(XUI.Xml.SelectSingleNode(oParameters,"PowerBIDashboardId",null)),XUI.Xml.GetText(XUI.Xml.SelectSingleNode(oParameters,"TileId",null)),XUI.Xml.GetText(XUI.Xml.SelectSingleNode(oParameters,"TileUrl",null)),0,XUI.Xml.GetText(XUI.Xml.SelectSingleNode(oParameters,"EnableInMobile",null)) == "true",bVisible);
            oArgs.CellId = oActive.id;
            break;
        case "webresource":
            var heightNode = XUI.Xml.SelectSingleNode(oParameters,"Height",null),
            ...
            oArgs.FormXml = Mscrm.FormEditorVariables.formXml;
            oIframe = new WebResourceObj(oControl.getAttribute("id"),XUI.Xml.GetText(XUI.Xml.SelectSingleNode(oParameters,"Url",null)),passParam == "true",parseInt(oFormCell.getAttribute("rowspan"),10),parseInt(oFormCell.getAttribute("colspan"),10),oFormCell.getAttribute("auto") == "true",security == "true",sTabName,sSectionName,GetLocalizedObjsArray(XUI.Xml.SelectNodes(oFormCell,"labels/label",null)),oFormCell.getAttribute("showlabel") == "true",oDependsAry,sScrolling,border == "true",null,height,width,sizeType,altText,customParameter,horizontalAlignment,verticalAlignment,bVisible,showOnMobileClient == "true",webResourceId);
            break;
        case "bingmap":
            var addressFieldNode = oParameters ? XUI.Xml.SelectSingleNode(oParameters,"AddressField",null) : null;
            oIframe = new BingMapObj(oControl.getAttribute("id"),addressFieldNode ? XUI.Xml.GetText(addressFieldNode) : "",parseInt(oFormCell.getAttribute("rowspan"),10),parseInt(oFormCell.getAttribute("colspan"),10),oFormCell.getAttribute("auto") == "true",sTabName,sSectionName,GetLocalizedObjsArray(XUI.Xml.SelectNodes(oFormCell,"labels/label",null)),oFormCell.getAttribute("showlabel") == "true",Mscrm.FormEditorVariables.formXml,bVisible);
            oArgs.CellId = oActive.id;
            break;
        case "socialInsight":
            oIframe = new SocialInsightObj(oControl.getAttribute("id"),null,XUI.Xml.GetText(XUI.Xml.SelectSingleNode(oParameters,"PassParameters",null)) == "true",parseInt(oFormCell.getAttribute("rowspan"),10),parseInt(oFormCell.getAttribute("colspan"),10),oFormCell.getAttribute("auto") == "true",sTabName,sSectionName,GetLocalizedObjsArray(XUI.Xml.SelectNodes(oFormCell,"labels/label",null)),oFormCell.getAttribute("showlabel") == "true",oDependsAry,sScrolling,XUI.Xml.GetText(XUI.Xml.SelectSingleNode(oParameters,"Border",null)) == "true",Mscrm.FormEditorVariables.formXml,bVisible);
            oArgs.CellId = oActive.id;
            break;
        case "timercontrol":
            var successConditionNameNode = oParameters ? XUI.Xml.SelectSingleNode(oParameters,"SuccessConditionName",null) : null,
                SuccessConditionValueNode = oParameters ? XUI.Xml.SelectSingleNode(oParameters,"SuccessConditionValue",null) : null,
                failureConditionNameNode = oParameters ? XUI.Xml.SelectSingleNode(oParameters,"FailureConditionName",null) : null,
                failureConditionValueNode = oParameters ? XUI.Xml.SelectSingleNode(oParameters,"FailureConditionValue",null) : null,
                warningConditionNameNode = oParameters ? XUI.Xml.SelectSingleNode(oParameters,"WarningConditionName",null) : null,
                warningConditionValueNode = oParameters ? XUI.Xml.SelectSingleNode(oParameters,"WarningConditionValue",null) : null,
                cancelConditionNameNode = oParameters ? XUI.Xml.SelectSingleNode(oParameters,"CancelConditionName",null) : null,
                cancelConditionValueNode = oParameters ? XUI.Xml.SelectSingleNode(oParameters,"CancelConditionValue",null) : null,
                pauseConditionNameNode = oParameters ? XUI.Xml.SelectSingleNode(oParameters,"PauseConditionName",null) : null,
                pauseConditionValueNode = oParameters ? XUI.Xml.SelectSingleNode(oParameters,"PauseConditionValue",null) : null,
                failureTimeFieldNode = oParameters ? XUI.Xml.SelectSingleNode(oParameters,"FailureTimeField",null) : null;
            oIframe = new TimerControlObj(oControl.getAttribute("id"),successConditionNameNode,SuccessConditionValueNode,failureConditionNameNode,failureConditionValueNode,warningConditionNameNode,warningConditionValueNode,cancelConditionNameNode,cancelConditionValueNode,pauseConditionNameNode,pauseConditionValueNode,failureTimeFieldNode,parseInt(oFormCell.getAttribute("rowspan"),10),parseInt(oFormCell.getAttribute("colspan"),10),sTabName,sSectionName,GetLocalizedObjsArray(XUI.Xml.SelectNodes(oFormCell,"labels/label",null)),oFormCell.getAttribute("showlabel") == "true",Mscrm.FormEditorVariables.formXml,bVisible);
            oArgs.CellId = oActive.id;
            break;
        case "searchwidget":
        case "referencepanelsearchwidget":
            var showFilterSearchResultsNode = oParameters ? XUI.Xml.SelectSingleNode(oParameters,"FilterResults",null) : null,
                allowChangeFiltersNode = oParameters ? XUI.Xml.SelectSingleNode(oParameters,"AllowChangingFiltersOnUI",null) : null,
                showLanguageFilter = oParameters ? XUI.Xml.SelectSingleNode(oParameters,"ShowLanguageFilter",null) : null,
                showDepartmentFilter = oParameters ? XUI.Xml.SelectSingleNode(oParameters,"ShowDepartmentFilter",null) : null,
                enableAutomaticSuggestionsNode = oParameters ? XUI.Xml.SelectSingleNode(oParameters,"EnableAutoSuggestions",null) : null,
                automaticSuggestionSearchFieldNode = oParameters ? XUI.Xml.SelectSingleNode(oParameters,"SearchForAutoSuggestionsUsing",null) : null,
                ...
                autoSuggestionSource = oParameters ? XUI.Xml.SelectSingleNode(oParameters,"AutoSuggestionSource",null) : "1",
                recordsPerPageNode = parseInt(XUI.Xml.GetText(XUI.Xml.SelectSingleNode(oParameters,"NumberOfResults",null)),10),
                primaryCustomerNode = oParameters ? XUI.Xml.SelectSingleNode(oParameters,"SelectPrimaryCustomer",null) : null,
                showContextualActions = oParameters ? XUI.Xml.SelectSingleNode(oParameters,"ShowContextualActions",null) : null,
                actionList = oParameters ? XUI.Xml.SelectSingleNode(oParameters,"ActionList",null) : null,
                defaultLanguageNode = oParameters ? XUI.Xml.SelectSingleNode(oParameters,"SelectDefaultLanguage",null) : null,
                mappedFieldNode = oParameters ? XUI.Xml.SelectSingleNode(oParameters,"MappedFields",null) : null,
                mappedFieldData = IsNull(mappedFieldNode) ? null : JSON.parse(XUI.Xml.GetText(mappedFieldNode)),
                enableMDFNode = oParameters ? XUI.Xml.SelectSingleNode(oParameters,"EnableMDF",null) : null,
                enableMDFData = IsNull(enableMDFNode) ? false : JSON.parse(XUI.Xml.GetText(enableMDFNode)),
                allowDisablingMDFNode = oParameters ? XUI.Xml.SelectSingleNode(oParameters,"AllowDisablingMDFOnUI",null) : null,
                allowDisablingMDFData = IsNull(allowDisablingMDFNode) ? false : JSON.parse(XUI.Xml.GetText(allowDisablingMDFNode)),
            ...
            if(isReferencePanelSearchWidget && XUI.Xml.SelectSingleNode(oParameters,"ReferencePanelSearchWidgetIconUrl",null) != null)
                referencePanelSearchWidgetIconUrl = XUI.Xml.GetText(XUI.Xml.SelectSingleNode(oParameters,"ReferencePanelSearchWidgetIconUrl",null));
            oIframe = new SearchWidgetObj(oControl.getAttribute("id"),showFilterSearchResultsNode,allowChangeFiltersNode,showLanguageFilter,showDepartmentFilter,enableAutomaticSuggestionsNode,automaticSuggestionSearchFieldNode,autoSuggestionSource,recordsPerPageNode,showContextualActions,actionList,primaryCustomerNode,parseInt(oFormCell.getAttribute("rowspan"),10),parseInt(oFormCell.getAttribute("colspan"),10),sTabName,sSectionName,GetLocalizedObjsArray(XUI.Xml.SelectNodes(oFormCell,"labels/label",null)),oFormCell.getAttribute("showlabel") == "true",Mscrm.FormEditorVariables.formXml,bVisible,defaultLanguageNode,isReferencePanelSearchWidget,referencePanelSearchWidgetIconUrl,enableRatingNode,showRatingFieldNode,mappedFieldData,enableMDFData,allowDisablingMDFData);
            oArgs.CellId = oActive.id;
            break
    }
    AddTelemetryLog("UpdateIFrame");
    oArgs.Field = oIframe;
    oArgs.FieldsXml = oFieldsXml;
    oArgs.FieldPropertiesXml = oPropertiesXml;
    oArgs.ObjectTypeCode = _objectTypeCode;
    ...
    {
        case "iframe":
            createInlineDlg(Mscrm.CrmUri.create("/Tools/FormEditor/Dialogs/iframe.aspx?mode=" + mode + "&datatype=iframe&scrolling=" + CrmEncodeDecode.CrmUrlEncode(sScrolling) + "&editorType=" + CrmEncodeDecode.CrmUrlEncode(oArgs.EditorType)),oArgs,_subGridDefaults.iDialogHeight,_subGridDefaults.iDialogWidth,UpdateFormXml,[sTabName,sSectionName,mode,oActive,oIframe],null);
            return;
        case "aci":
            createInlineDlg(Mscrm.CrmUri.create("/Tools/FormEditor/Dialogs/ACIWidget.aspx?mode=" + mode + "&datatype=iframe&scrolling=" + CrmEncodeDecode.CrmUrlEncode(sScrolling) + "&editorType=" + CrmEncodeDecode.CrmUrlEncode(oArgs.EditorType)),oArgs,_subGridDefaults.iDialogHeight,_subGridDefaults.iDialogWidth,UpdateFormXml,[sTabName,sSectionName,mode,oActive,oIframe],null);
            return;
        case "powerbitile":
            createInlineDlg(Mscrm.CrmUri.create("/Tools/FormEditor/Dialogs/powerbitile.aspx?mode=" + mode + "&editorType=" + CrmEncodeDecode.CrmUrlEncode(oArgs.EditorType)),oArgs,Math.min(window.parent.innerHeight,_powerBiTileDialogDefaults.iDialogHeight),_powerBiTileDialogDefaults.iDialogWidth,UpdateFormXml,[sTabName,sSectionName,mode,oActive,oIframe],null);
            return;
        case "webresource":
            createInlineDlg(Mscrm.CrmUri.create("/Tools/FormEditor/Dialogs/webresource.aspx?mode=" + mode + "&name=" + CrmEncodeDecode.CrmUrlEncode(XUI.Xml.GetText(XUI.Xml.SelectSingleNode(oParameters,"Url",null))) + "&datatype=iframe&scrolling=" + CrmEncodeDecode.CrmUrlEncode(sScrolling) + "&editorType=" + CrmEncodeDecode.CrmUrlEncode(oArgs.EditorType)),oArgs,_lookupDialogParentDefaults.iDialogHeight,_lookupDialogParentDefaults.iDialogWidth,UpdateFormXml,[sTabName,sSectionName,mode,oActive,oIframe],null);
            return;
        case "bingmap":
            createInlineDlg(Mscrm.CrmUri.create("/Tools/FormEditor/Dialogs/bingmap.aspx?mode=" + mode + "&etc=" + CrmEncodeDecode.CrmUrlEncode(_objectTypeCode) + "&addr=" + CrmEncodeDecode.CrmUrlEncode(oIframe.AddressField)),oArgs,_subGridDefaults.iDialogHeight,_subGridDefaults.iDialogWidth,UpdateFormXml,[sTabName,sSectionName,mode,oActive,oIframe],null);
            return;
        case "timercontrol":
            createInlineDlg(Mscrm.CrmUri.create("/Tools/FormEditor/Dialogs/dlg_TimerControl.aspx?mode=" + mode + "&etc=" + CrmEncodeDecode.CrmUrlEncode(_objectTypeCode) + "&addr=" + CrmEncodeDecode.CrmUrlEncode(oIframe.AddressField)),oArgs,_timerControlDefaults.iDialogHeight,_timerControlDefaults.iDialogWidth,UpdateFormXml,[sTabName,sSectionName,mode,oActive,oIframe],null);
            return;
        case "searchwidget":
        case "referencepanelsearchwidget":
            if(referencePanelSearchWidgetIconUrl == null)
                referencePanelSearchWidgetIconUrl = "";
            createInlineDlg(Mscrm.CrmUri.create("/Tools/FormEditor/Dialogs/dlg_KMControl.aspx?mode=" + mode + "&etc=" + CrmEncodeDecode.CrmUrlEncode(_objectTypeCode) + "&addr=" + CrmEncodeDecode.CrmUrlEncode(oIframe.AddressField) + "&icon=" + CrmEncodeDecode.CrmUrlEncode(referencePanelSearchWidgetIconUrl)),oArgs,_kmControlDefaults.iDialogHeight,_kmControlDefaults.iDialogWidth,UpdateFormXml,[sTabName,sSectionName,mode,oActive,oIframe],null);
            break;
        case "socialInsight":
            if(Mscrm.FormEditorVariables.editorType != Mscrm.EditorType.dashboardEditor)
                createInlineDlg(Mscrm.CrmUri.create("/Tools/FormEditor/Dialogs/SocialInsight.aspx?mode=" + mode + "&datatype=iframe&scrolling=" + CrmEncodeDecode.CrmUrlEncode(sScrolling) + "&editorType=" + CrmEncodeDecode.CrmUrlEncode(oArgs.EditorType)),oArgs,_subGridDefaults.iDialogHeight,_subGridDefaults.iDialogWidth,UpdateFormXml,[sTabName,sSectionName,mode,oActive,oIframe],null);
            else
            {
...
function UpdateFormXml(oUpdatedIframe,sTabName,sSectionName,mode,oActive,oIframe)
{
    if(oUpdatedIframe)
    {
        if(oActive.className == "socialInsight" && Mscrm.FormEditorVariables.formId == "00000000-0000-0000-0000-000000000000")
            Mscrm.FormEditorVariables.socialInsightsConfigurations[oUpdatedIframe.Id] = oUpdatedIframe.socialInsightsConfiguration;
        if(oActive.className == "orgInsights" && Mscrm.FormEditorVariables.formId == "00000000-0000-0000-0000-000000000000")
            Mscrm.FormEditorVariables.orgInsightsConfigurations[oUpdatedIframe.Id] = oUpdatedIframe.orgInsightsConfiguration;
        var fRefreshFormEditor = false;
        if(!IsNull(oUpdatedIframe.FormXml) && XUI.Xml.XMLSerializer.serializeToString(oUpdatedIframe.FormXml) != XUI.Xml.XMLSerializer.serializeToString(Mscrm.FormEditorVariables.formXml))
        {
            fRefreshFormEditor = true;
        ...
        {
            oControl.setAttribute("classid",_ControlClassIds.timercontrol);
            XUI.Xml.SetText(XUI.Xml.SelectSingleNode(oParameters,"SuccessConditionName",null),oUpdatedIframe.SuccessConditionName);
            XUI.Xml.SetText(XUI.Xml.SelectSingleNode(oParameters,"SuccessConditionValue",null),oUpdatedIframe.SuccessConditionValue);
            ...
            XUI.Xml.SetText(XUI.Xml.SelectSingleNode(oParameters,"FailureTimeField",null),oUpdatedIframe.FailureTimeField)
        }
        else
            if(oActive.className == "searchwidget" || oActive.className == "referencepanelsearchwidget")
            {
                ...
                XUI.Xml.SetText(XUI.Xml.SelectSingleNode(oParameters,"AllowChangingFiltersOnUI",null),oUpdatedIframe.AllowChangingFiltersOnUI.toString());
                XUI.Xml.SetText(XUI.Xml.SelectSingleNode(oParameters,"ShowLanguageFilter",null),oUpdatedIframe.ShowLanguageFilter.toString());
                XUI.Xml.SetText(XUI.Xml.SelectSingleNode(oParameters,"ShowDepartmentFilter",null),oUpdatedIframe.ShowDepartmentFilter.toString());
                XUI.Xml.SetText(XUI.Xml.SelectSingleNode(oParameters,"EnableAutoSuggestions",null),oUpdatedIframe.EnableAutoSuggestions.toString());
                XUI.Xml.SetText(XUI.Xml.SelectSingleNode(oParameters,"SearchForAutoSuggestionsUsing",null),oUpdatedIframe.SearchForAutoSuggestionsUsing);
                XUI.Xml.SetText(XUI.Xml.SelectSingleNode(oParameters,"AutoSuggestionSource",null),oUpdatedIframe.AutoSuggestionSource);
                XUI.Xml.SetText(XUI.Xml.SelectSingleNode(oParameters,"NumberOfResults",null),oUpdatedIframe.NumberOfResults);
                XUI.Xml.SetText(XUI.Xml.SelectSingleNode(oParameters,"ShowContextualActions",null),oUpdatedIframe.ShowContextualActions.toString());
                XUI.Xml.SetText(XUI.Xml.SelectSingleNode(oParameters,"ActionList",null),oUpdatedIframe.ActionList.toString());
                XUI.Xml.SetText(XUI.Xml.SelectSingleNode(oParameters,"SelectDefaultLanguage",null),oUpdatedIframe.SelectDefaultLanguage);
                XUI.Xml.SetText(XUI.Xml.SelectSingleNode(oParameters,"EnableRating",null),oUpdatedIframe.EnableRating.toString());
                XUI.Xml.SetText(XUI.Xml.SelectSingleNode(oParameters,"ShowRatingUsing",null),oUpdatedIframe.ShowRatingUsing);
                ...
                if(!IsNull(oUpdatedIframe.SelectPrimaryCustomer) && oUpdatedIframe.SelectPrimaryCustomer.length > 0)
                {
                    if(IsNull(oSelectPrimaryCustomerParam))
                        oSelectPrimaryCustomerParam = Mscrm.FormEditorVariables.formXml.createElement("SelectPrimaryCustomer");
                ...
                if(!window.IS_ONPREMISE && Xrm.Internal.isFeatureEnabled(Mscrm.FeatureNames.MetadataDrivenFilterForKbSearch))
                {
                    var oMappedFields = XUI.Xml.SelectSingleNode(oParameters,"MappedFields",null),
                        shouldUpdateMappedFields = !IsNull(oUpdatedIframe.MappedFields) && oUpdatedIframe.MappedFields.length > 0;
                    if(shouldUpdateMappedFields)
                    {
                        if(IsNull(oMappedFields))
                        {
                            oMappedFields = Mscrm.FormEditorVariables.formXml.createElement("MappedFields");
                            oParameters.appendChild(oMappedFields)
                        }
                        XUI.Xml.SetText(oMappedFields,JSON.stringify(oUpdatedIframe.MappedFields))
                    }
                    else
                        !IsNull(oMappedFields) && 
                            oParameters.removeChild(oMappedFields);
                    var oEnableMDF = XUI.Xml.SelectSingleNode(oParameters,"EnableMDF",null),
                        shouldUpdateEnableMDF = !IsNull(oEnableMDF) || oUpdatedIframe.EnableMDF;
                    if(shouldUpdateEnableMDF)
                    {
                        if(IsNull(oEnableMDF))
                        {
                            oEnableMDF = Mscrm.FormEditorVariables.formXml.createElement("EnableMDF");
                            oParameters.appendChild(oEnableMDF)
                        }
                        XUI.Xml.SetText(oEnableMDF,oUpdatedIframe.EnableMDF)
                    }
                    var oAllowDisablingMDFOnUI = XUI.Xml.SelectSingleNode(oParameters,"AllowDisablingMDFOnUI",null),
                        shouldUpdateAllowDisablingMDFOnUI = !IsNull(oAllowDisablingMDFOnUI) || oUpdatedIframe.AllowDisablingMDFOnUI;
                    if(shouldUpdateAllowDisablingMDFOnUI)
                    {
                        if(IsNull(oAllowDisablingMDFOnUI))
                        {
                            oAllowDisablingMDFOnUI = Mscrm.FormEditorVariables.formXml.createElement("AllowDisablingMDFOnUI");
                            oParameters.appendChild(oAllowDisablingMDFOnUI)
                        }
                        XUI.Xml.SetText(oAllowDisablingMDFOnUI,oUpdatedIframe.AllowDisablingMDFOnUI)
                    }
                }
                if(oActive.className == "referencepanelsearchwidget")
                    if(XUI.Xml.SelectSingleNode(oParameters,"ReferencePanelSearchWidgetIconUrl",null) != null)
                        XUI.Xml.SetText(XUI.Xml.SelectSingleNode(oParameters,"ReferencePanelSearchWidgetIconUrl",null),oUpdatedIframe.IconUrl);
                    else
                    {
                        var oReferencePanelSearchWidgetIconUrl = Mscrm.FormEditorVariables.formXml.createElement("ReferencePanelSearchWidgetIconUrl");
                        oParameters.appendChild(oReferencePanelSearchWidgetIconUrl);
                ...
                if(oActive.className == "powerbitile")
                {
                    oControl.setAttribute("classid",_ControlClassIds.powerBITile);
                    XUI.Xml.SetText(XUI.Xml.SelectSingleNode(oParameters,"PowerBIGroupId",null),oUpdatedIframe.GroupId);
                    XUI.Xml.SetText(XUI.Xml.SelectSingleNode(oParameters,"PowerBIDashboardId",null),oUpdatedIframe.DashboardId);
                    ...
                    XUI.Xml.SetText(XUI.Xml.SelectSingleNode(oParameters,"EnableInMobile","false"),oUpdatedIframe.EnableInMobile.toString())
                }
                else
                    if(oActive.className == "aci")
                    {
                        oControl.setAttribute("classid",_ControlClassIds.aci);
                        XUI.Xml.SetText(XUI.Xml.SelectSingleNode(oParameters,"ViewName",null),oUpdatedIframe.ViewName);
                        XUI.Xml.SetText(XUI.Xml.SelectSingleNode(oParameters,"PassParameters",null),oUpdatedIframe.PassParams.toString());
                        ...
                        if(oActive.className == "socialInsight")
                        {
                            ...
                            if(oActive.className == "orgInsights")
                            {
                                ...
                                if(oActive.className == "bingmap")
                                {
                                    ...
                                    if(oActive.className == "webresource")
                                    {
        ...
        if(Mscrm.FormEditorVariables.fieldExpIsFor != "section")
            formXMLPath = "/entity/form/" + Mscrm.FormEditorVariables.fieldExpIsFor + "/rows";
        PersistLocalizedNodes(Mscrm.FormEditorVariables.formXml,formXMLPath + "/row/cell[@id = '" + oActive.id + "']/labels/label",oUpdatedIframe.Labels);
        ...
        {
            var bRefreshCellOnly = oIframe.ColSpan == oUpdatedIframe.ColSpan && oIframe.RowSpan == oUpdatedIframe.RowSpan;
...
function AddCellToFormXml(oRows,oCell,iRowSpan,bCanSpanColumn,bAuto)
{
    ...
    if(lastRow != null)
    {
        var i = 0,
            ...
            bInsertRow = true,
            bCellInserted = false;
        XUI.Html.DomUtils.ForEachChild(lastRow,function(cellInLastRow)
        {
...
function RemoveFieldXml(oActive)
{
    ...
    else
    {
        ...
        while(deleteRow != null && deleteRow.childNodes.length == maxColumns && XUI.Xml.SelectSingleNode(deleteRow,"cell/control",null) == null)
        {
            oRows.removeChild(deleteRow);
...
{
    if(updatedColSpan && originalColSpan != updatedColSpan)
    {
        var xmlAdjusted = Mscrm.FieldPropertiesUtils.adjustFormXmlForColSpanChange(oCell,originalColSpan,updatedColSpan);
        if(xmlAdjusted)
        {
...
function AddCustomControlSnippet(oParameters,oCustomControlSnippet,sCustomControlUniqueId)
{
    ...
    if(Mscrm.FeatureControl.get_Current().isFeatureEnabled(Mscrm.FeatureNames.CustomControlMobile) && oCustomControlSnippet != null)
    {
        ...
        if(IsNull(XUI.Xml.SelectSingleNode(formXMLDoc,"entity/form/controlDescriptions",null)))
        {
            ...
            controlDescriptionsTagXmlNode = XUI.Xml.SelectSingleNode(formXMLDoc,"entity/form/controlDescriptions",null);
        ...
        if(controlDescriptionInSnippet != null)
        {
            ...
            if(isOutlookHostedWindow())
            {
                var controlDescriptionInSnippetDoc = XUI.Xml.LoadXml(XUI.Xml.XMLSerializer.serializeToString(controlDescriptionInSnippet));
            ...
            var controlId = _ControlClassIds.subgrid;
            if(XUI.Xml.SelectSingleNode(oParameters,"ReferencePanelSubgridIconUrl",null) != null)
                controlId = _ControlClassIds.referencepanelsubgrid;
            var defaultControlNodes = XUI.Xml.SelectNodes(formXMLDoc,"entity/form/controlDescriptions/controlDescription[@forControl='" + sCustomControlUniqueId + "']/customControl[@id='" + controlId + "']",null);
...
function AddTelemetryLog(operationName)
{
    try
    {
        ...
        Mscrm.MetricsReporting.instance().addMetric("fieldproperties",arguments)
    }
    catch(e)
    {
    }
}
function DeleteExistingControlSnippet(oControl)
{
    if(Mscrm.FeatureControl.get_Current().isFeatureEnabled(Mscrm.FeatureNames.CustomControlMobile))
    {
        var oldSubgridControlUniqueId = oControl.getAttribute("uniqueid"),
            controlDecriptionNode = XUI.Xml.SelectSingleNode(Mscrm.FormEditorVariables.formXml,"entity/form/controlDescriptions/controlDescription[@forControl='" + oldSubgridControlUniqueId + "']",null);
        if(controlDecriptionNode != null)
        {
            var numberOfControlsForSameUniqueId = Mscrm.DragDropUtils.getNumberOfControlsForGivenUniqueId(Mscrm.FormEditorVariables.formXml,oldSubgridControlUniqueId);
            if(numberOfControlsForSameUniqueId <= 1)
            {
...
var _subGridDefaults = {iRecPerPage:4,bEnableViewPicker:false,bEnableQuickFind:false,bEnableJumpBar:false,bChartGridMode:"All",sGridUIMode:"List",bEnableChartPicker:true,iDialogWidth:470,iDialogHeight:660},
    ...
    _powerBiTileDialogDefaults = {iDialogWidth:519,iDialogHeight:660},
    isWebClientVisualRefreshFeatureEnabled = Mscrm.FeatureControl.get_Current().isFeatureEnabled("FCB.WebClientVisualRefresh")
