...
function AddTelemetryLog(operationName)
{
    try
    {
        ...
        Mscrm.MetricsReporting.instance().addMetric("moveaction",arguments)
    }
    catch(e)
    {
    }
