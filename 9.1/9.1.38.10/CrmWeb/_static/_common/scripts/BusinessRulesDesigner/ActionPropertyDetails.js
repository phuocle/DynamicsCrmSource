            ...
            var DateTimeEditView = (function (_super) {
                ...
                DateTimeEditView.prototype.updateDateTime = function (event) {
                    ...
                    if (this.inlineControlView.get_validateResult().isValid) {
                        ...
                        if (dateTimeStr != null) {
                            var dateTimeGMT = ProcessControl.Configuration.PBLClientProxy.getUserSettingTime(dateTimeStr, !this.isTimeRendered);
                ...
                DateTimeEditView.prototype.initializeInlineControl = function () {
                    ...
                    var element = ProcessControl.Configuration.PBLClientProxy.buildChromeElement(this.dateTimeElementId);
                    ...
                    if (this.get() != null && this.get() != "" && this.get() != " ") {
                        if (this.isTimeRendered) {
                            ...
                            initialDateTime = ProcessControl.Configuration.PBLClientProxy.parseDateInvariant(this.get());
                        }
                    }
                    this.inlineControlView = ProcessControl.Configuration.PBLClientProxy.createInlineDateTimeControl(element.get_jQueryObject(), this.dateTimeElementId, initialDateTime, dateTimeContainerId, !this.isTimeRendered);
                    this.inlineControlView.clearValidation();
                    ...
                    $("#" + this.dateTimeElementId + " .ms-crm-ImageStrip-inlineedit_time_icon").attr("title", MscrmControls.ProcessDesigner.MetadataProvider.getLocalizedString("ProcessDesignerControl_BPF_Tooltip_Time_Picker"));
            ...
            var TextBoxEditView = (function (_super) {
                ...
                function TextBoxEditView(options) {
                    ...
                    if (!Util.isNull(MetadataProxy.SourceAttributesMap[model.entityLogicalName][model.getAttribute()]))
                        attributeType = MetadataProxy.SourceAttributesMap[model.entityLogicalName][model.getAttribute()].attributeType;
                    this.$el.on("change", function (event) {
                        ...
                        if (isNumber) {
                            switch (attributeType) {
                                ...
                                case AttributeType.Integer:
                                case AttributeType.Money:
                                    if (!Util.isNull(value) && !Util.isEmptyString(value) && value != 'NaN' && !isNaN(value) && !Util.isNull(MetadataProxy.SourceAttributesMap[model.entityLogicalName][model.getAttribute()]) && MetadataProxy.SourceAttributesMap[model.entityLogicalName][model.getAttribute()] != undefined) {
        ...
        (function (View) {
            ...
            var LookupEditView = (function (_super) {
                ...
                LookupEditView.prototype.render = function () {
                    var self = this;
                    self.$el.append("<input type='text' id='txtLookup_" + this.cid + "' name='lookup' class='field action-prop-lookup-textbox' /><span id='btnSearch_" + this.cid + "' class='prop-CCFSymbolFont prop-findSymbol prop-find-fontIcons-size prop-find' ></span>");
                    ...
                    if (this.$("#txtLookup_" + this.cid).val() == "") {
                        this.$("#txtLookup_" + this.cid).attr("title", MscrmControls.ProcessDesigner.MetadataProvider.getLocalizedString("ProcessDesignerControl_BPF_PropertyPage_EmptyTexttooltip"));
                    }
                    else {
                ...
                LookupEditView.prototype.launchLookupDialog = function (event) {
                    ProcessControl.Configuration.PBLClientProxy.launchLookupDialog(this.entity, this.attribute, this.lookupDialogCloseCallback);
                };
                LookupEditView.prototype.lookupDialogCloseCallback = function (dialogParams, callbackParams) {
                    ...
                    if (lookupControlItems.length > 0) {
                        ...
                        this.$(".action-prop-lookup-textbox").trigger('change');
    ...
    (function (ActionPropertyPage) {
        ...
        var ActionDetailsModel = (function (_super) {
            ...
            function ActionDetailsModel(options) {
                ...
                if (!(MscrmControls.ProcessDesigner.Util.isNull(options.lookupProperties)) && options.lookupProperties.islookup && !options.value.lookup) {
                ...
                _.bindAll(this, 'getValue', 'setValue', 'getDisplayName', 'setDisplayName', 'setLookupDisplayName', 'getLookupDisplayName', 'setLookupValue', 'setLookupEntity', 'enableLookup', 'disableLookup');
            }
            ActionDetailsModel.prototype.setAttribute = function (value) {
                this.pblActionActivity.clearWarningMessages();
            ...
            ActionDetailsModel.prototype.setType = function (value) {
                ...
                if (value == ActionPropertyPage.ActionOperators.Field) {
                    ...
                    var field = new Field();
                    field.field = "";
                    field.entity = new Microsoft.Crm.Workflow.Expressions.PrimaryEntity(MscrmControls.ProcessDesigner.processStep);
                    exp.value = field;
                }
                else if (value == ActionPropertyPage.ActionOperators.Formula) {
                    var attrField = new Field();
                    attrField.field = "NEW_EXP";
                    attrField.entity = new Microsoft.Crm.Workflow.Expressions.PrimaryEntity(MscrmControls.ProcessDesigner.processStep);
            ...
            ActionDetailsModel.prototype.setValue = function (value) {
                ...
                else if (this.pblActionActivity.operator == ActionPropertyPage.ActionOperators.Visibility || this.pblActionActivity.operator == ActionPropertyPage.ActionOperators.DisplayMode) {
                    this.pblActionActivity.value = (value == "1") ? true : false;
                }
                else if (MetadataProxy.SourceAttributesMap[this.entityLogicalName][this.getAttribute()].dateFormat == "datetime") {
                    this.pblActionActivity.value = value;
                    this.trigger('changeEvent');
                }
                else {
                    if (this.pblActionActivity.value.lookup != "undefined" && this.pblActionActivity.value.lookup != null && this.lookupProperties.islookup == true) {
            ...
            ActionDetailsModel.prototype.setFormula = function (value) {
                ...
                if (MetadataProxy.SourceAttributesMap[this.entityLogicalName][this.getAttribute()] != null && MetadataProxy.SourceAttributesMap[this.entityLogicalName][this.getAttribute()] != undefined) {
                    var attributeType = MetadataProxy.SourceAttributesMap[this.entityLogicalName][this.getAttribute()].attributeType;
            ...
            ActionDetailsModel.prototype.setFormulaValueType = function (formulaValueType) {
                ...
                if (formulaValueType == ActionPropertyPage.ActionOperators.Field) {
                    ...
                    MetadataProxy.getComparableAttributes(this.pblActionActivity.entity.entityName, this.pblActionActivity.field, firstKey).then(function (attributeList) {
            ...
            ActionDetailsModel.prototype.getWarningMessages = function () {
                return this.pblActionActivity.getwarningMessages();
            };
            ...
            ActionDetailsModel.prototype.setValueSource = function (value) {
                var self = this;
                MetadataProxy.getComparableAttributes(self.pblActionActivity.entity.get_entityName(), self.pblActionActivity.field, value.get_entityName()).then(function (attributeList) {
                    for (var firstKey in attributeList) {
                        break;
                    }
                    if (firstKey != null && firstKey != undefined) {
                        self.pblActionActivity.value.field = [attributeList[firstKey].logicalName];
                        self.pblActionActivity.value.fieldType = MetadataProxy.getAttributeType(attributeList[firstKey].logicalName, value.get_entityName());
                    }
                });
            ...
            ActionDetailsModel.prototype.setFormulaSource = function (value) {
                var self = this;
                MetadataProxy.getComparableAttributes(self.pblActionActivity.entity.entityName, self.pblActionActivity.field, value.get_entityName()).then(function (attributeList) {
                    for (var firstKey in attributeList) {
                        break;
                    }
                    if (firstKey != null && firstKey != undefined) {
                        self.pblActionActivity.value.formula.attribute.field = attributeList[firstKey].logicalName;
                        self.pblActionActivity.value.formula.attribute.fieldType = MetadataProxy.getAttributeType(attributeList[firstKey].logicalName, value.get_entityName());
                    }
                });
            ...
            ActionDetailsModel.prototype.setFormulaValueSource = function (value) {
                ...
                MetadataProxy.getComparableAttributes(self.pblActionActivity.entity.entityName, self.pblActionActivity.field, value.get_entityName()).then(function (attributeList) {
                    ...
                    if (firstKey != null && firstKey != undefined) {
                        ...
                        self.pblActionActivity.value.formula.value.fieldType = MetadataProxy.getAttributeType(attributeList[firstKey].logicalName, value.get_entityName());
                    }
                });
            ...
            ActionDetailsModel.prototype.setPickListAttributes = function (isDependentOptionSet, attributeType) {
                this.pblActionActivity.attributeType = attributeType;
                this.pblActionActivity.isDependentOptionSet = isDependentOptionSet;
            };
            ActionDetailsModel.prototype.enableLookup = function () {
                this.lookupProperties.islookup = true;
                if (this.pblActionActivity.value == null || this.pblActionActivity.value == "" || this.pblActionActivity.value == undefined) {
                    this.pblActionActivity.value = {};
                    this.pblActionActivity.value.lookup = {};
                }
            ...
            ActionDetailsModel.lookupStringOperators = [ConditionOperator.Contains, ConditionOperator.DoesNotContain, ConditionOperator.BeginsWith, ConditionOperator.DoesNotBeginWith, ConditionOperator.EndsWith, ConditionOperator.DoesNotEndWith];
            ActionDetailsModel.fieldTypesNeedingFormatting = [AttributeType.BigInt, AttributeType.DateTime, AttributeType.Decimal, AttributeType.Double, AttributeType.Integer, AttributeType.Money];
    ...
    (function (ActionPropertyPage) {
        ...
        var ActionPropertiesModel = (function (_super) {
            ...
            function ActionPropertiesModel(options) {
                ...
                this.pblActionActivity = options;
                this.viewDescriptorProvider = new ActionPropertyPage.ViewDescriptorProvider(this.entityLogicalName);
                if (this.pblActionActivity.field == null && this.pblActionActivity.operator == null && this.pblActionActivity.value == null) {
            ...
            ActionPropertiesModel.prototype.getViewDescriptor = function () {
                ...
                switch (this.pblActionActivity.getActivityTypeID()) {
                    case MscrmControls.ProcessDesigner.PblActivityType.customJavascriptStep:
                        finalView.viewDescriptor = this.viewDescriptorProvider.customJavascriptViewDescriptor(this.pblActionActivity);
                        break;
                    default:
    ...
    (function (ActionPropertyPage) {
        ...
        var ActionDetailsView = (function (_super) {
            ...
            function ActionDetailsView(options) {
                ...
                _.bindAll(this);
                ["formulaValueTypeChanged", "formulaChanged", "valueChanged"].forEach(function (key) {
            ...
            ActionDetailsView.prototype.initialize = function () {
                ...
                this.events = {
                    ...
                    'change #formula-operator': 'formulaChanged',
                    'change #formula-attribute': 'formulaChanged',
                    'change #formula-type': 'formulaValueTypeChanged',
            ...
            ActionDetailsView.prototype.render = function () {
                ...
                this.model.getViewDescriptor().then(function (d) {
                    ...
                    if (typeVal && typeVal.val().trim() == ActionPropertyPage.ActionOperators.Formula) {
                        ...
                        if (!Util.isNull(MetadataProxy.SourceAttributesMap[self.model.entityLogicalName][self.model.getAttribute()]) && MetadataProxy.SourceAttributesMap[self.model.entityLogicalName][self.model.getAttribute()] != undefined) {
                            var attributeType = MetadataProxy.SourceAttributesMap[self.model.entityLogicalName][self.model.getAttribute()].attributeType;
                            if (ActionPropertyPage.ActionDetailsModel.fieldTypesNeedingFormatting.indexOf(attributeType) > -1
                                ...
                                var precision = MetadataProxy.SourceAttributesMap[self.model.entityLogicalName][self.model.getAttribute()].precision;
                                if (!Util.isNull(precision) && precision != undefined) {
                                    precision = parseInt(MetadataProxy.SourceAttributesMap[self.model.entityLogicalName][self.model.getAttribute()].precision, 10);
                                }
                                else {
                                    precision = 0;
                                }
                                var newValue = Mscrm.NumberUtility.addFormatting(parseFloat(self.model.pblActionActivity.value.formula.value), precision);
                    ...
                    else if (typeVal && typeVal.val() && typeVal.val().trim() == ActionPropertyPage.ActionOperators.Value && self.model.pblActionActivity.field != 'NEW_EXP') {
                        self.renderValue();
                    }
                    ...
                    DOMUtil.renderWarningMessages(self.model, self.$el, self.model.getWarningMessages());
                ...
                ActionPropertyPage.ActionPropertiesView.prototype.setActionPropertiesHeaderText(this.model.pblActionActivity);
            ...
            ActionDetailsView.prototype.renderValue = function () {
                ...
                if (!attr || attr.length == 0) {
                    this.$("#valueContainer").html(new TextBoxEditView({ model: this.model, get: this.model.getValue, set: this.model.setValue, attributes: { id: 'value', class: 'field', type: 'text', value: this.model.getValue() } }).render().$el);
                }
                else {
                    ...
                    if (!attr || attr.length == 0) {
                    ...
                    else if (MetadataProxy.isEnumeratedField(this.model.getAttribute(), this.model.entityLogicalName)) {
                        new ActionPropertyPage.DropdownView({ model: this.model }).render().then(function (view) {
                            ...
                            if ($("#" + $(view.$el).children().attr("id") + " :selected").text() == "") {
                                $(view.$el).children().attr("title", MscrmControls.ProcessDesigner.MetadataProvider.getLocalizedString("ProcessDesignerControl_BPF_PropertyPage_EmptyDropDowntooltip"));
                            }
                            else {
                                $(view.$el).children().attr("title", $("#" + $(view.$el).children().attr("id") + " :selected").text());
                            }
                        });
                    }
                        ...
                        this.valueView = new DateTimeEditView({ model: this.model, get: this.model.getValue, set: this.model.setValue, isTimeRendered: isTimeRendered });
                        this.$("#valueContainer").html(this.valueView.render().$el);
                        $("#valueContainer .hasDatepicker").parent().addClass("prop-exp-input_type_value");
                    }
                    else if (dataType == AttributeType.Lookup || dataType == AttributeType.Owner || dataType == AttributeType.Customer) {
                        if (MetadataProxy.SourceAttributesMap != null) {
                            ...
                            var displayName = this.model.getLookupDisplayName();
                            if (Util.isEmptyString(displayName) || typeof displayName === 'undefined') {
                                var guid = self.model.getValue().lookup.value;
                                if (MetadataProxy.SourceAttributesMap[self.model.entityLogicalName][self.model.getAttribute()].targetEntityForLookUp && !Util.isEmptyString(guid)) {
                                    this.model.enableLookup();
                                    this.model.updateLookupDisplayName(self.model.getValue().lookup.label);
                                    this.model.setLookupValue(guid);
                                    if (self.model.getValue().lookup.entity != null) {
                                        this.model.setLookupEntity(self.model.getValue().lookup.entity);
                                    }
                                    else {
                                        this.model.setLookupEntity(targetEntity);
                                    }
                                }
                            }
                            else {
                            ...
                            this.valueView = new LookupEditView({ model: this.model, get: self.model.getValue, set: self.model.setValue, targetEntity: targetEntity, isMulti: isMulti, getNameCB: this.model.getLookupDisplayName, setNameCB: this.model.setLookupDisplayName, enableLookup: this.model.enableLookup, setLookupEntity: this.model.setLookupEntity });
                            this.$("#valueContainer").html(this.valueView.render().$el);
                            this.$("#valueContainer").find(".action-prop-lookup-textbox").bind("change", ActionPropertyPage.ActionPropertiesView.showUnsavedChangesNote);
                            $("#valueContainer .action-prop-lookup-textbox").parent().addClass("action-prop-lookup-header");
                        }
                        if (this.$("#valueContainer") != null && this.$("#valueContainer").find(".action-prop-lookup-textbox") != null && this.$("#valueContainer").find(".action-prop-lookup-textbox").val() != null) {
                            this.$("#valueContainer").find(".action-prop-lookup-textbox").focus();
                        }
                    }
                    else if (MetadataProxy.isTextFieldNoOp(attr, this.model.entityLogicalName) || MetadataProxy.isNumericField(attr, this.model.entityLogicalName)) {
                        this.$("#valueContainer").html(new TextBoxEditView({
                            model: this.model, get: this.model.getValue, set: this.model.setValue, attributes: { id: 'value', class: 'field', type: 'text', value: this.model.getValue() }
                        }).render().$el);
                        ...
                        if (this.$("#valueContainer").children().text() == "") {
                            ...
                            this.$("#valueContainer").children().attr("title", this.$("#valueContainer").children().text());
                        }
            ...
            ActionDetailsView.prototype.changedTooltips = function () {
                ...
                if ($('#value').length > 0) {
                    if ($('#value').attr("role") != "combobox") {
                        if (!MscrmControls.ProcessDesigner.Util.isNull($('#value').val()) && this.$('#value').val().length > 0) {
                ...
                if (this.$('#messageValue').val() == "") {
                    this.$('#messageValue').attr("title", MscrmControls.ProcessDesigner.MetadataProvider.getLocalizedString("ProcessDesignerControl_BPF_PropertyPage_EmptyTexttooltip"));
                    this.$('#messageValue').attr("aria-label", this.$("#lblMessage").text());
                }
                else {
                    this.$('#messageValue').attr("title", this.$('#messageValue').val());
                    this.$('#messageValue').attr("aria-label", this.$("#lblMessage").text() + " " + this.$('#messageValue').val());
                }
                ...
                this.$('#formula-value-field-source').attr("title", this.$('#formula-value-field-source :selected').text());
            };
            ActionDetailsView.prototype.attributeChanged = function () {
                ...
                if (dataType == AttributeType.Lookup || dataType == AttributeType.Owner || dataType == AttributeType.Customer) {
                    this.model.lookupProperties["lookupLabel"] = "";
                    this.model.enableLookup();
                }
                else if (dataType == AttributeType.Picklist) {
                    var isDependentOptionSet = MetadataProxy.isDependentOptionSet(attribute, this.model.entityLogicalName);
                    this.model.setPickListAttributes(isDependentOptionSet, dataType);
                    if (isDependentOptionSet) {
                        MscrmControls.ProcessDesigner.PBLDesignerControl.validationMode = GenericWorkflowDesigner.ValidationMode.Warning;
                    }
                }
                else {
            ...
            ActionDetailsView.prototype.formulaValueTypeChanged = function () {
                ...
                $('[id=typeValueField]:has(#expression1)').find('#actionValueLabel').attr("style", "display: none !important");
                this.changedTooltips();
            ...
            ActionDetailsView.prototype.visibilityChanged = function () {
                ...
                this.model.setValue(value);
                $("#lblVisible").text(MscrmControls.ProcessDesigner.MetadataProvider.getLocalizedString("ProcessDesignerControl_PBL_Visible"));
                this.changedTooltips();
            ...
            ActionDetailsView.refreshErrorMessages = function () {
                if (ActionDetailsView.self.model.pblActionActivity.getErrorCount() > 0) {
                    MscrmControls.ProcessDesigner.DOMUtil.renderErrorMessages(ActionDetailsView.self.model.pblActionActivity, ActionDetailsView.self.$el, ActionDetailsView.self.model.pblActionActivity.getErrorMessages());
                }
                else if (GenericWorkflowDesigner.PropertyView.getPropertyViewCurrentModel().getErrorCount() > 0 && !ActionDetailsView.self.model.pblActionActivity.isValid) {
                    MscrmControls.ProcessDesigner.DOMUtil.renderErrorMessages(GenericWorkflowDesigner.PropertyView.getPropertyViewCurrentModel(), ActionDetailsView.self.$el, GenericWorkflowDesigner.PropertyView.getPropertyViewCurrentModel().getErrorMessages());
                }
                else {
                    DOMUtil.renderErrorMessages(ActionDetailsView.self.model, ActionDetailsView.self.$el, ActionDetailsView.self.model.getErrorMessages());
                }
            };
    ...
    (function (ActionPropertyPage) {
        ...
        var ActionPropertiesView = (function (_super) {
            ...
            ActionPropertiesView.prototype.render = function () {
                ...
                if (this.model.pblActionActivity.getActivityTypeID() == "customJavascript") {
                    DOMUtil.renderErrorMessages(this.model.pblActionActivity, this.$el, this.model.pblActionActivity.getErrorMessages());
                ...
                this.removeUnsavedChangesNote();
                GenericWorkflowDesigner.attachInputElementChange("properties", ActionPropertiesView.showUnsavedChangesNote);
                return this;
            };
            ActionPropertiesView.showUnsavedChangesNote = function () {
            ...
            ActionPropertiesView.prototype.removeUnsavedChangesNote = function () {
                ...
                try {
                    ...
                    if (isValid) {
                        ...
                        if (propertyViewCurrentModel.getActivityTypeID() == "customJavascript") {
                            ...
                            if (this.model.pblActionActivity.getActivityTypeID() == "setMessage" && !this.model.pblActionActivity.value.labelId) {
                        ...
                        GenericWorkflowDesigner.eventManager.trigger(MscrmControls.ProcessDesigner.PblEvents.updatePlainTextView);
                        GenericWorkflowDesigner.eventManager.trigger(GenericWorkflowDesigner.FrameworkEvents.updateProperty);
                        this.removeUnsavedChangesNote();
                        ActionPropertiesView.self.model.pblActionActivity.clearWarningMessages();
                        MscrmControls.ProcessDesigner.DOMUtil.renderWarningMessages(ActionPropertiesView.self.model.pblActionActivity, ActionPropertiesView.self.$el, ActionPropertiesView.self.model.pblActionActivity.getwarningMessages());
                        stopwatch.stop();
                        localStorage.setItem("PBL_" + propertyViewCurrentModel.attributes.ActivityTypeID + "ApplyTime", stopwatch.elapsedMilliseconds.toString());
                    }
                    this.render();
                }
                catch (ex) {
            ...
            ActionPropertiesView.prototype.discardAction = function (event) {
                try {
                    ...
                    this.removeUnsavedChangesNote();
                    stopwatch.stop();
                    localStorage.setItem("PBL_" + propertyViewCurrentModel.attributes.ActivityTypeID + "DiscardTime", stopwatch.elapsedMilliseconds.toString());
                    this.changedTooltips();
                }
                catch (ex) {
                    console.log(ex.stack);
            ...
            ActionPropertiesView.prototype.updateFieldType = function (pblActionActivity) {
                var entityName = ActionPropertyPage.isTaskFlow ? pblActionActivity.entity.entityName : this.model.entityLogicalName;
                pblActionActivity.fieldtype = MetadataProxy.SourceAttributesMap[entityName][pblActionActivity.field].attributeType;
                if (pblActionActivity.operator == ActionPropertyPage.ActionOperators.Field) {
                    entityName = ActionPropertyPage.isTaskFlow ? pblActionActivity.value.entity.entityName : this.model.entityLogicalName;
                    pblActionActivity.value.fieldtype = MetadataProxy.SourceAttributesMap[entityName][pblActionActivity.value.field].attributeType;
                }
                else if (pblActionActivity.operator == ActionPropertyPage.ActionOperators.Formula) {
                    entityName = ActionPropertyPage.isTaskFlow ? pblActionActivity.value.formula.attribute.entity.entityName : this.model.entityLogicalName;
                    pblActionActivity.value.formula.attribute.fieldtype = MetadataProxy.SourceAttributesMap[entityName][pblActionActivity.value.formula.attribute.field].attributeType;
                    if (pblActionActivity.value.formula.valueType == ActionPropertyPage.ActionOperators.Field) {
                        entityName = ActionPropertyPage.isTaskFlow ? pblActionActivity.value.formula.value.entity.entityName : this.model.entityLogicalName;
                        pblActionActivity.value.formula.value.fieldtype = MetadataProxy.SourceAttributesMap[entityName][pblActionActivity.value.formula.value.field].attributeType;
                    }
                    else {
                        pblActionActivity.value.formula.value.fieldtype = pblActionActivity.value.formula.attribute.fieldtype;
                    }
                }
                else {
            ...
            ActionPropertiesView.prototype.setLocalizedHTMLStrings = function () {
                $("#actionprop-save").val(MscrmControls.ProcessDesigner.MetadataProvider.getLocalizedString('ProcessDesignerControl_BPF_BranchPropertyDetails_Apply'));
                $("#actionprop-discard").val(MscrmControls.ProcessDesigner.MetadataProvider.getLocalizedString('ProcessDesignerControl_BPF_BranchPropertyDetails_Discard'));
                $("#EntityHeader").text(MscrmControls.ProcessDesigner.MetadataProvider.getLocalizedString("ProcessDesignerControl_BPF_StagePropertyDetails_Entity"));
                $("#EntityHeader").attr('title', MscrmControls.ProcessDesigner.MetadataProvider.getLocalizedString("ProcessDesignerControl_PBL_EntityTooltip"));
                $("#JavascriptHeader").text(MscrmControls.ProcessDesigner.MetadataProvider.getLocalizedString("ProcessDesignerControl_PBL_CustomJavascriptHeader"));
                $("#DisplayNameHeader").text(MscrmControls.ProcessDesigner.MetadataProvider.getLocalizedString("ProcessDesignerControl_BPF_BranchPropertyDetails_Header"));
                $("#DisplayNameHeader").attr('title', MscrmControls.ProcessDesigner.MetadataProvider.getLocalizedString("ProcessDesignerControl_PBL_ActionProperty_ActionDisplayName"));
                $("#lblField").text(MscrmControls.ProcessDesigner.MetadataProvider.getLocalizedString("ProcessDesignerControl_PBL_PlainTextGenerator_Field"));
                $("#lblField").attr('title', MscrmControls.ProcessDesigner.MetadataProvider.getLocalizedString("ProcessDesignerControl_PBL_FieldTooltip"));
                $("#lblField1").text(MscrmControls.ProcessDesigner.MetadataProvider.getLocalizedString("ProcessDesignerControl_PBL_PlainTextGenerator_Field"));
                $("#lblField1").attr('title', MscrmControls.ProcessDesigner.MetadataProvider.getLocalizedString("ProcessDesignerControl_PBL_FieldTooltip"));
                $("#lblField2").text(MscrmControls.ProcessDesigner.MetadataProvider.getLocalizedString("ProcessDesignerControl_PBL_PlainTextGenerator_Field"));
                $("#lblField2").attr('title', MscrmControls.ProcessDesigner.MetadataProvider.getLocalizedString("ProcessDesignerControl_PBL_FieldTooltip"));
                $("#lblType").text(MscrmControls.ProcessDesigner.MetadataProvider.getLocalizedString("ProcessDesignerControl_BPF_BranchPropertyDetails_Type"));
                $("#lblType").attr('title', MscrmControls.ProcessDesigner.MetadataProvider.getLocalizedString("ProcessDesignerControl_BPF_TypeTooltip"));
                $("#lblType1").text(MscrmControls.ProcessDesigner.MetadataProvider.getLocalizedString("ProcessDesignerControl_BPF_BranchPropertyDetails_Type"));
                $("#lblType1").attr('title', MscrmControls.ProcessDesigner.MetadataProvider.getLocalizedString("ProcessDesignerControl_BPF_TypeTooltip"));
                $("#lblOperator").text(MscrmControls.ProcessDesigner.MetadataProvider.getLocalizedString("ProcessDesignerControl_BPF_BranchPropertyDetails_Operator"));
                $("#lblOperator").attr('title', MscrmControls.ProcessDesigner.MetadataProvider.getLocalizedString("ProcessDesignerControl_BPF_OperatorTooltip"));
                $("#lblStatus").text(MscrmControls.ProcessDesigner.MetadataProvider.getLocalizedString("ProcessDesignerControl_PBL_Status"));
                $("#lblStatus").attr('title', MscrmControls.ProcessDesigner.MetadataProvider.getLocalizedString("ProcessDesignerControl_PBL_StatusTooltip"));
                $("#lblStatus1").text(MscrmControls.ProcessDesigner.MetadataProvider.getLocalizedString("ProcessDesignerControl_PBL_Status"));
                $("#lblStatus1").attr('title', MscrmControls.ProcessDesigner.MetadataProvider.getLocalizedString("ProcessDesignerControl_PBL_StatusTooltip"));
                $("#lblStatus2").text(MscrmControls.ProcessDesigner.MetadataProvider.getLocalizedString("ProcessDesignerControl_PBL_SetVisibility_Visible"));
                $("#lblStatus2").attr('title', MscrmControls.ProcessDesigner.MetadataProvider.getLocalizedString("ProcessDesignerControl_PBL_VisibleStatusTooltip"));
                $("#lblMessage").text(MscrmControls.ProcessDesigner.MetadataProvider.getLocalizedString("ProcessDesignerControl_PBL_Message"));
                $("#lblMessage").attr('title', MscrmControls.ProcessDesigner.MetadataProvider.getLocalizedString("ProcessDesignerControl_PBL_MessageTooltip"));
                $("#lblVisible").text(MscrmControls.ProcessDesigner.MetadataProvider.getLocalizedString("ProcessDesignerControl_PBL_Visible"));
                $("#lblVisible").attr('title', MscrmControls.ProcessDesigner.MetadataProvider.getLocalizedString("ProcessDesignerControl_PBL_VisibleStatusTooltip"));
                $("#actionValueLabel").attr('title', MscrmControls.ProcessDesigner.MetadataProvider.getLocalizedString("ProcessDesignerControl_BPF_ValueTooltip"));
                $("#lblFieldSource").text(MscrmControls.ProcessDesigner.MetadataProvider.getLocalizedString("ProcessDesignerControl_PBL_BranchPropertyDetails_Source"));
                $("#lblValueSource").text(MscrmControls.ProcessDesigner.MetadataProvider.getLocalizedString("ProcessDesignerControl_PBL_BranchPropertyDetails_Source"));
                $("#lblattributeSource").text(MscrmControls.ProcessDesigner.MetadataProvider.getLocalizedString("ProcessDesignerControl_PBL_BranchPropertyDetails_Source"));
                $("#lblformula-attribute-source").text(MscrmControls.ProcessDesigner.MetadataProvider.getLocalizedString("ProcessDesignerControl_PBL_BranchPropertyDetails_Source"));
                $("#formulaValueLabelSource").text(MscrmControls.ProcessDesigner.MetadataProvider.getLocalizedString("ProcessDesignerControl_PBL_BranchPropertyDetails_Source"));
                if ($('#actionprop-save').attr("disabled") == undefined) {
                    $('#actionprop-save').attr('title', MscrmControls.ProcessDesigner.MetadataProvider.getLocalizedString("ProcessDesignerControl_BPF_Tooltip_Apply_Available"));
                }
                else {
                    $('#actionprop-save').attr('title', MscrmControls.ProcessDesigner.MetadataProvider.getLocalizedString("ProcessDesignerControl_BPF_Tooltip_Apply_Unavailable"));
                }
                $("#actionprop-discard").attr('title', MscrmControls.ProcessDesigner.MetadataProvider.getLocalizedString("ProcessDesignerControl_BPF_DiscardChangesTooltip"));
            };
            ActionPropertiesView.prototype.setActionPropertiesHeaderText = function (pblActionActivity) {
                switch (pblActionActivity.getActivityTypeID()) {
                    case "setAttributeValue":
                        var tileTitle = MscrmControls.ProcessDesigner.MetadataProvider.getLocalizedString("ProcessDesignerControl_PBL_SetFieldValue");
                        $("#ActionPropertiesHeader").text(tileTitle);
                        $("#ActionPropertiesSubHeader").text(MscrmControls.ProcessDesigner.MetadataProvider.getLocalizedString("ProcessDesignerControl_PBL_FieldValue"));
                        break;
                    case "setDefaultValue":
                        var tileTitle = MscrmControls.ProcessDesigner.MetadataProvider.getLocalizedString("ProcessDesignerControl_PBL_SetDefaultValue");
                        $("#ActionPropertiesHeader").text(tileTitle);
                        $("#ActionPropertiesSubHeader").text(MscrmControls.ProcessDesigner.MetadataProvider.getLocalizedString("ProcessDesignerControl_PBL_DefaultValue"));
                        break;
                    case "setMessage":
                        var tileTitle = MscrmControls.ProcessDesigner.MetadataProvider.getLocalizedString("ProcessDesignerControl_PBL_ShowError");
                        $("#ActionPropertiesHeader").text(tileTitle);
                        tileTitle = tileTitle.substr(tileTitle.indexOf(" ") + 1);
                        $("#ActionPropertiesSubHeader").text(tileTitle);
                        break;
                    case "setDisplayMode":
                        var tileTitle = MscrmControls.ProcessDesigner.MetadataProvider.getLocalizedString("ProcessDesignerControl_PBL_Lock_Unlock");
                        $("#ActionPropertiesHeader").text(tileTitle);
                        tileTitle = tileTitle.substr(tileTitle.indexOf(" ") + 1);
                        $("#ActionPropertiesSubHeader").text(tileTitle);
                        break;
                    case "setVisibility":
                        var tileTitle = MscrmControls.ProcessDesigner.MetadataProvider.getLocalizedString("ProcessDesignerControl_PBL_SetVisibility");
                        $("#ActionPropertiesHeader").text(tileTitle);
                        $("#ActionPropertiesSubHeader").text(MscrmControls.ProcessDesigner.MetadataProvider.getLocalizedString("ProcessDesignerControl_PBL_Visibility"));
                        break;
                    case "setFieldRequiredLevel":
                        var tileTitle = MscrmControls.ProcessDesigner.MetadataProvider.getLocalizedString("ProcessDesignerControl_PBL_SetBusinessRequired");
                        $("#ActionPropertiesHeader").text(tileTitle);
                        $("#ActionPropertiesSubHeader").text(MscrmControls.ProcessDesigner.MetadataProvider.getLocalizedString("ProcessDesignerControl_PBL_BusinessRequired"));
                        break;
                    case "customJavascript":
                        var tileTitle = MscrmControls.ProcessDesigner.MetadataProvider.getLocalizedString("ProcessDesignerControl_PBL_CustomJavascript");
                        $("#ActionPropertiesHeader").text(tileTitle);
                        tileTitle = tileTitle.substr(tileTitle.indexOf(" ") + 1);
                        $("#ActionPropertiesSubHeader").text(tileTitle);
                        break;
            ...
            ActionPropertiesView.refreshErrorMessages = function () {
                if (ActionPropertiesView.self.model.pblActionActivity.getErrorCount() > 0) {
                    MscrmControls.ProcessDesigner.DOMUtil.renderErrorMessages(ActionPropertiesView.self.model.pblActionActivity, ActionPropertiesView.self.$el, ActionPropertiesView.self.model.pblActionActivity.getErrorMessages());
                }
                else if (GenericWorkflowDesigner.PropertyView.getPropertyViewCurrentModel().getErrorCount() > 0 && !ActionPropertiesView.self.model.pblActionActivity.isValid) {
                    MscrmControls.ProcessDesigner.DOMUtil.renderErrorMessages(GenericWorkflowDesigner.PropertyView.getPropertyViewCurrentModel(), ActionPropertiesView.self.$el, GenericWorkflowDesigner.PropertyView.getPropertyViewCurrentModel().getErrorMessages());
                }
                else {
                    DOMUtil.renderErrorMessages(ActionPropertiesView.self.model.pblActionActivity, ActionPropertiesView.self.$el, ActionPropertiesView.self.model.pblActionActivity.getErrorMessages());
                }
            };
        ...
        var DateTimeControlView = (function (_super) {
            ...
            DateTimeControlView.prototype.render = function () {
                ...
                this.$("#datepicker_" + this.cid).datepicker({
                    dateFormat: 'm/d/yy',
                    showOn: "both",
                    buttonText: "<span class='pblprop-calendar-fontIcons-size prop-CCFSymbolFont prop-calendarSymbol'></span>"
                });
            ...
            DropdownView.prototype.render = function () {
                ...
                MetadataProxy.getPickListValues(this.model.entityLogicalName, attributeLogicalName).then(function (values) {
                    ...
                    _.each(picklistValues, function (item) {
                        ...
                        dropdownElement.append("<option value='" + item.pickListValueOrderId + "' " + selected + ">" + item.pickListValue + "</option>");
                    });
    ...
    (function (ActionPropertyPage) {
        ...
        var ViewDescriptorProvider = (function () {
            ...
            ViewDescriptorProvider.prototype.getExpressionDescriptor = function (pblActionActivity) {
                ...
                MetadataProxy.getAttributeList(self._entityLogicalName).then(function (attributeList) {
                    ...
                    if (ActionPropertyPage.isTaskFlow) {
                        ...
                        expressionDescriptor.sourceList.unshift(MscrmControls.ProcessDesigner.ControlManager.primaryEntityName);
                        expressionDescriptor.selectedSource = (pblActionActivity.entity instanceof Microsoft.Crm.Workflow.Expressions.PrimaryEntity) ? pblActionActivity.entity.get_entityName() : pblActionActivity.entity.get_relationshipName();
                    }
                    ...
                    expressionDescriptor.selectedAttribute = (isNewExpr || isNew) ? expressionDescriptor.attributeList[firstKey].logicalName : pblActionActivity.field;
                    if (MscrmControls.ProcessDesigner.Util.isNull(MetadataProxy.SourceAttributesMap[self._entityLogicalName][expressionDescriptor.selectedAttribute])) {
                        expressionDescriptor.selectedAttribute = expressionDescriptor.attributeList[firstKey].logicalName;
                    ...
                    expressionDescriptor.types.push({ val: ActionPropertyPage.ActionOperators.Value, name: MscrmControls.ProcessDesigner.MetadataProvider.getLocalizedString("ProcessDesignerControl_PBL_PlainTextGenerator_Value") });
                    if (!expressionDescriptor.isNew_) {
                        expressionDescriptor.types.push({ val: ActionPropertyPage.ActionOperators.Field, name: MscrmControls.ProcessDesigner.MetadataProvider.getLocalizedString("ProcessDesignerControl_PBL_PlainTextGenerator_Field") });
                        if (isFormulaValid) {
                            expressionDescriptor.types.push({ val: ActionPropertyPage.ActionOperators.Formula, name: MscrmControls.ProcessDesigner.MetadataProvider.getLocalizedString("ProcessDesignerControl_PBL_PlainTextGenerator_Formula") });
                        }
                        if (pblActionActivity.getActivityTypeID() == "setAttributeValue" && MetadataProxy.SourceAttributesMap[self._entityLogicalName][expressionDescriptor.selectedAttribute].attributeType != AttributeType.Boolean && MetadataProxy.SourceAttributesMap[self._entityLogicalName][expressionDescriptor.selectedAttribute].attributeType != AttributeType.State && MetadataProxy.SourceAttributesMap[self._entityLogicalName][expressionDescriptor.selectedAttribute].attributeType != AttributeType.Status) {
                            expressionDescriptor.types.push({ val: ActionPropertyPage.ActionOperators.Clear, name: MscrmControls.ProcessDesigner.MetadataProvider.getLocalizedString("ProcessDesignerControl_PBL_PlainTextGenerator_Clear") });
                        }
                    }
                    if (pblActionActivity.operator == ActionPropertyPage.ActionOperators.Field) {
                        expressionDescriptor.selectedType = pblActionActivity.operator;
                        expressionDescriptor.actionValueLabelText = MscrmControls.ProcessDesigner.MetadataProvider.getLocalizedString("ProcessDesignerControl_PBL_PlainTextGenerator_Field");
                        if (!ActionPropertyPage.isTaskFlow) {
                            MetadataProxy.getComparableAttributes(self._entityLogicalName, expressionDescriptor.selectedAttribute, self._entityLogicalName).done(function (list) {
                            ...
                            var attributeSelectedSource = (pblActionActivity.value.entity instanceof Microsoft.Crm.Workflow.Expressions.PrimaryEntity) ? pblActionActivity.value.entity.get_entityName() : pblActionActivity.value.entity.get_relationshipName();
                            var targetEntity = pblActionActivity.value.entity.get_entityName();
                            MetadataProxy.getComparableAttributes(self._entityLogicalName, expressionDescriptor.selectedAttribute, targetEntity).done(function (list) {
                                expressionDescriptor.value = {
                                    attributeList: list,
                        ...
                        expressionDescriptor.selectedType = pblActionActivity.operator;
                        expressionDescriptor.actionValueLabelText = MscrmControls.ProcessDesigner.MetadataProvider.getLocalizedString("ProcessDesignerControl_PBL_PlainTextGenerator_Formula");
                        var formulaValue;
                        ...
                        else if (pblActionActivity.value.formula.valueType == ActionPropertyPage.ActionOperators.Field) {
                        ...
                        expressionDescriptor.value = {
                            ...
                            operators: [{ name: '+', value: 0 }, { name: '-', value: 1 }, { name: '*', value: 2 }, { name: '/', value: 3 }],
                            selectedOperator: pblActionActivity.value.formula.operator,
                            selectedValue: formulaValue,
                            formulaValueTypes: [{ name: MscrmControls.ProcessDesigner.MetadataProvider.getLocalizedString("ProcessDesignerControl_PBL_PlainTextGenerator_Field"), value: ActionPropertyPage.ActionOperators.Field }, { name: MscrmControls.ProcessDesigner.MetadataProvider.getLocalizedString("ProcessDesignerControl_PBL_PlainTextGenerator_Value"), value: ActionPropertyPage.ActionOperators.Value }],
                            ...
                            dayValueTooltip: MscrmControls.ProcessDesigner.MetadataProvider.getLocalizedString("ProcessDesignerControl_BPF_Tooltip_Label_Days")
                        };
                        if (!ActionPropertyPage.isTaskFlow) {
                            ...
                            var leftSelectedSource = (pblActionActivity.value.formula.attribute.entity instanceof Microsoft.Crm.Workflow.Expressions.PrimaryEntity) ? pblActionActivity.value.formula.attribute.entity.get_entityName() : pblActionActivity.value.formula.attribute.entity.get_relationshipName();
                            var targetEntityLeft = pblActionActivity.value.formula.attribute.entity.get_entityName();
                            MetadataProxy.getComparableAttributes(self._entityLogicalName, expressionDescriptor.selectedAttribute, targetEntityLeft).done(function (attrList) {
                                expressionDescriptor.value.leftSelectedSource = leftSelectedSource;
                                expressionDescriptor.value.attributeList = attrList;
                                if (pblActionActivity.value.formula.valueType == MscrmControls.ProcessDesigner.MetadataProvider.getLocalizedString("ProcessDesignerControl_PBL_PlainTextGenerator_Field")
                                    && pblActionActivity.value.formula.value.entity != null && pblActionActivity.value.formula.value.entity != undefined) {
                                    var rightSelectedSource = (pblActionActivity.value.formula.value.entity instanceof Microsoft.Crm.Workflow.Expressions.PrimaryEntity) ? pblActionActivity.value.formula.value.entity.get_entityName() : pblActionActivity.value.formula.value.entity.get_relationshipName();
                                    var targetEntityRight = pblActionActivity.value.formula.value.entity.get_entityName();
                                    MetadataProxy.getComparableAttributes(self._entityLogicalName, expressionDescriptor.selectedAttribute, targetEntityRight).done(function (rightAttrList) {
                        ...
                        if (pblActionActivity.value.formula.valueType == ActionPropertyPage.ActionOperators.Value) {
                            expressionDescriptor.value.formulaValueLabelText = MscrmControls.ProcessDesigner.MetadataProvider.getLocalizedString("ProcessDesignerControl_PBL_PlainTextGenerator_Value");
                        }
                        else if (pblActionActivity.value.formula.valueType == ActionPropertyPage.ActionOperators.Field) {
                            expressionDescriptor.value.formulaValueLabelText = MscrmControls.ProcessDesigner.MetadataProvider.getLocalizedString("ProcessDesignerControl_PBL_PlainTextGenerator_Field");
                            ;
                        }
                        ...
                        var dataType = MetadataProxy.SourceAttributesMap[self._entityLogicalName][expressionDescriptor.selectedAttribute].attributeType;
                        if (dataType == AttributeType.DateTime) {
                            expressionDescriptor.value.operators = [{ name: '+', value: 0 }, { name: '-', value: 1 }];
                            expressionDescriptor.value.formulaValueTypes = [{ name: MscrmControls.ProcessDesigner.MetadataProvider.getLocalizedString("ProcessDesignerControl_PBL_PlainTextGenerator_Value"), value: ActionPropertyPage.ActionOperators.Value }];
                            expressionDescriptor.value.formulaValueLabelText = MscrmControls.ProcessDesigner.MetadataProvider.getLocalizedString("ProcessDesignerControl_BPF_BranchPropertyDetails_Days");
                        }
                    }
                    else {
                        expressionDescriptor.actionValueLabelText = MscrmControls.ProcessDesigner.MetadataProvider.getLocalizedString("ProcessDesignerControl_PBL_PlainTextGenerator_Value");
                        if (pblActionActivity.getActivityTypeID() == "setAttributeValue" && pblActionActivity.operator == ActionPropertyPage.ActionOperators.Value && pblActionActivity.value == MscrmControls.ProcessDesigner.PBLStringConstants.NullStringForTypeClear) {
                            ...
                            expressionDescriptor.value.isText = MetadataProxy.isTextFieldNoOp(expressionDescriptor.selectedAttribute, self._entityLogicalName) || MetadataProxy.isNumericField(expressionDescriptor.selectedAttribute, self._entityLogicalName);
                        }
                    }
                ...
                MetadataProxy.getAttributeList(self._entityLogicalName).then(function (attributeList) {
                    ...
                    switch (pblActionActivity.getActivityTypeID()) {
                        ...
                        case "setFieldRequiredLevel":
                            ...
                            expressionDescriptor.value = {
                                setBusinessRequired: [{ name: MscrmControls.ProcessDesigner.MetadataProvider.getLocalizedString("ProcessDesignerControl_PBL_PlainTextGenerator_BusinessRequired"), value: 1 }, { name: MscrmControls.ProcessDesigner.MetadataProvider.getLocalizedString("ProcessDesignerControl_PBL_PlainTextGenerator_NotBusinessRequired"), value: 0 }],
                                selectedValue: pblActionActivity.value
                            };
                            break;
                        case "setDisplayMode":
                            ...
                            expressionDescriptor.value = {
                                setDisplayModes: [{ name: MscrmControls.ProcessDesigner.MetadataProvider.getLocalizedString("ProcessDesignerControl_PBL_PlainTextGenerator_Lock"), value: 1 }, { name: MscrmControls.ProcessDesigner.MetadataProvider.getLocalizedString("ProcessDesignerControl_PBL_PlainTextGenerator_Unlock"), value: 0 }],
                                selectedValue: pblActionActivity.value
                            };
                            break;
                        case "setVisibility":
                            ...
                            expressionDescriptor.value = {
                                setVisibilities: [{ name: MscrmControls.ProcessDesigner.MetadataProvider.getLocalizedString("ProcessDesignerControl_PBL_SetVisibility_Yes"), value: 1 }, { name: MscrmControls.ProcessDesigner.MetadataProvider.getLocalizedString("ProcessDesignerControl_PBL_SetVisibility_No"), value: 0 }],
                                selectedValue: pblActionActivity.value
                            };
                            break;
                        case "setMessage":
            ...
            ViewDescriptorProvider.prototype.commonDataDescriptor = function (pblActionActivity) {
                ...
                descriptor.entityDisplayName = MscrmControls.ProcessDesigner.Util.isNull(pblActionActivity.entity.entityName) || MscrmControls.ProcessDesigner.Util.isEmptyString(pblActionActivity.entity.entityName) ? pblActionActivity.entity.entityName : _window.Xrm.Internal.getEntityDisplayName(pblActionActivity.entity.entityName);
            ...
            ViewDescriptorProvider.prototype.filterAttributesForActions = function (attributeList) {
                ...
                for (var key in attributeList) {
                    ...
                    if (!MscrmControls.ProcessDesigner.Util.isNull(attributeMetadata) && !attributeMetadata.sourceType) {
