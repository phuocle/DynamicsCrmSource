    ...
    (function (ProcessDesigner) {
        ...
        var MetadataProvider = (function () {
                    ...
                    for (var i = 0; i < attributesList.length; i++) {
                        ...
                        if (_this.verifyAttributeType(attributeData.Type)) {
                            ...
                            if (displayName) {
                                ...
                                else if (attributeType === AttributeType.Picklist) {
                                    attributeMetadataJson.push({
                                        logicalName: logicalName,
                                        displayName: displayName,
                                        attributeType: attributeType,
                                        dateFormat: attributeFormat,
                                        sourceType: sourceType,
                                        isDependentOptionSet: attributeData.AdditionalMetadata.IsDependentOptionSet
                                    });
                                }
                                else {
                                    attributeMetadataJson.push({
            ...
            MetadataProvider.verifyAttributeType = function (attributeTypeValue) {
                var attributeType = MscrmControls.ProcessDesigner.Common.AttributeType[attributeTypeValue];
...
(function (MscrmControls) {
    ...
    (function (ProcessDesigner) {
        ...
        var MetadataProxy = (function () {
            ...
            MetadataProxy.isDependentOptionSet = function (attributeLogicalName, entityLogicalName) {
                if (MetadataProxy.SourceAttributesMap) {
                    if (MetadataProxy.SourceAttributesMap[entityLogicalName][attributeLogicalName]) {
                        return MetadataProxy.SourceAttributesMap[entityLogicalName][attributeLogicalName].isDependentOptionSet;
                    }
                }
                return false;
            };
            ...
            DOMUtil._renderErrorMessages = function (model, el, labelClass, errorElementClass, errors) {
                ...
                for (var id in errors) {
                    if (iFields.indexOf(id) == -1) {
                        var error = errors[id];
                        var errorIconMessage = ProcessDesigner.PBLDesignerControl.dataBag.resources.getString("ProcessDesignerControl_PBL_ErrorOn_Prefix");
                        var elem = el.find(id);
                        var elem1 = elem;
                        if (elem.hasClass("action-prop-lookup-header")) {
                            elem1 = elem.find("input:first");
            ...
            DOMUtil._renderWarningMessages = function (model, el, labelClass, warningElementClass, warnings) {
                ...
                for (var id in warnings) {
                    if (iFields.indexOf(id) == -1) {
                        ...
                        var warningIconMessage = ProcessDesigner.PBLDesignerControl.dataBag.resources.getString("ProcessDesignerControl_PBL_Warning_Prefix");
                        var elem = el.find(id);
                        if (elem && warning) {
    ...
    (function (ProcessDesigner) {
        ...
        var BpfToActivityCollectionVisitor = (function (_super) {
            ...
            BpfToActivityCollectionVisitor.prototype.visitSetNextStageStep = function (setNextStageStep) {
                ...
                var nextStage = this.businessProcessFlowVisitor.get_stagesById()[nextStageId];
            ...
            BpfToActivityCollectionVisitor.prototype.createStageActivity = function (stageStep, activityType) {
                ...
                if (relationshipSteps != null) {
                    ...
                    for (var i = 0; i < relationshipSteps.length; ++i) {
                        ...
                        var source = this.businessProcessFlowVisitor.get_stagesById()[entry.key];
    ...
    (function (ProcessDesigner) {
        ...
        var PBLActionActivityDeleteHandler = (function (_super) {
            ...
            PBLActionActivityDeleteHandler.prototype.deleteActivityConfirmationDialog = function (activity) {
                ...
                if (activity == 'setSuggestion') {
                    activityDisplayName = ProcessDesigner.MetadataProvider.getLocalizedString("ProcessDesignerControl_PBL_Recommendation_Activity_Name");
                }
                else {
                    activityDisplayName = ProcessDesigner.MetadataProvider.getLocalizedString("ProcessDesignerControl_PBL_Action_Activity_Name");
                }
    ...
    (function (ProcessDesigner) {
        ...
        var PBLActionActivityInSuggestionDeleteHandler = (function (_super) {
            ...
            PBLActionActivityInSuggestionDeleteHandler.prototype.deleteActivityConfirmationDialog = function (activity) {
                var message = ProcessDesigner.MetadataProvider.getLocalizedString("ProcessDesignerControl_BPF_Delete_Message");
                message = window['String'].format(message, ProcessDesigner.MetadataProvider.getLocalizedString("ProcessDesignerControl_PBL_Action_Activity_Name"));
                var dialogDetails = {
                    dialogTitle: ProcessDesigner.MetadataProvider.getLocalizedString("ProcessDesignerControl_PBL_PBLActionActivityDeleteHandler_Title"),
                    dialogMessage: message,
                    messageType: ProcessDesigner.PBLDialogMessageTypes.Warning,
    ...
    (function (ProcessDesigner) {
        ...
        var PBLConditionActivityDeleteHandler = (function (_super) {
            ...
            PBLConditionActivityDeleteHandler.prototype.deleteActivityConfirmationDialog = function (activity) {
                var message = ProcessDesigner.MetadataProvider.getLocalizedString("ProcessDesignerControl_BPF_Delete_Message");
                message = window['String'].format(message, ProcessDesigner.MetadataProvider.getLocalizedString("ProcessDesignerControl_BPF_Condition_Activity_Name"));
                var dialogDetails = {
        ...
        var BPFSlotGeneratorProvider = (function () {
            ...
            BPFSlotGeneratorProvider.prototype.AddButtonEventListner = function (slotList) {
                ...
                $(document).on('AddButton', function (event, droppable) {
                    ...
                    var allDroppableTiles = $('.ui-droppable.slot.hoverOverDroppable .tile .setSuggestionTile');
                    $.each(allDroppableTiles, function (key, val) {
                        var droppableTile = $(val);
                        droppableTile.attr("aria-label", ProcessDesigner.PBLDesignerControl.dataBag.resources.getString("ProcessDesignerControl_BPF_ScreenReader_AddNewTile")).attr("aria-hidden", "false");
                    });
                });
            };
    ...
    (function (ProcessDesigner) {
        ...
        var BpfMetadataProvider = (function () {
            ...
            BpfMetadataProvider.getCategoryIndex2DisplayName = function (list) {
                var iList = new Array();
                var options = Mscrm.BusinessRules.Views.ViewHelper.get_editorDataWrapper().EntityBpfMetadata.StageCategories.Options;
                for (var i = 0; i < options.length; i++) {
                    var optionValue = options[i].Value;
                    if (list.indexOf(optionValue.toString()) > -1) {
                        iList.push(i);
                    }
                }
                var text = '';
                if (iList.length > 0) {
                    text = Mscrm.BusinessRules.Views.ViewHelper.get_editorDataWrapper().EntityBpfMetadata.StageCategories.Options[iList[0]].Label;
                    for (var i = 1; i < iList.length; i++) {
                        text = text + "," + Mscrm.BusinessRules.Views.ViewHelper.get_editorDataWrapper().EntityBpfMetadata.StageCategories.Options[iList[i]].Label;
                    }
                }
                return text;
            };
    ...
    (function (ProcessDesigner) {
        ...
        var PblActionActivity = (function (_super) {
            ...
            function PblActionActivity(activityType) {
                ...
                this._sequence = -1;
                this._isNewlyAdded = false;
                this._isDependentOptionSet = false;
            }
            ...
            Object.defineProperty(PblActionActivity.prototype, "attributeType", {
                get: function () {
                    return this._attributeType;
                },
                set: function (value) {
            ...
            Object.defineProperty(PblActionActivity.prototype, "isDependentOptionSet", {
                get: function () {
                    return this._isDependentOptionSet;
                },
                set: function (value) {
                    if (this._isDependentOptionSet !== value) {
                        this._isDependentOptionSet = value;
                    }
                },
                enumerable: true,
                configurable: true
            ...
            PblActionActivity.prototype.validateAttribute = function () {
                ...
                if (!this.field) {
                    ...
                    if (this._attributeType == AttributeType.Picklist && this.isDependentOptionSet) {
                        this.addWarningMessage("#attribute", ProcessDesigner.MetadataProvider.getLocalizedString("ProcessDesignerControl_BPF_BPFStepActivity_DependentOptionSetField_WarningMessage"));
                        ProcessDesigner.PBLDesignerControl.validationMode = ProcessDesigner.PBLDesignerControl.validationMode > 1 ? ProcessDesigner.PBLDesignerControl.validationMode : GenericWorkflowDesigner.ValidationMode.None;
                    }
                }
                return status;
            };
            ...
            PblActionActivity.prototype.clone = function (pblActionActivity) {
                ...
                if (self.parentSuggestionActivity != null && self.parentSuggestionActivity.getActivityTypeID() == ProcessDesigner.PblActivityType.setSuggestionStep) {
                    pblActionActivity.setActivityID(self.getActivityID());
                }
...
(function (MscrmControls) {
    ...
    (function (ProcessDesigner) {
        ...
        var PblSuggestionActivity = (function (_super) {
            ...
            Object.defineProperty(PblSuggestionActivity.prototype, "attributeType", {
                get: function () {
                    return this._attributeType;
                },
                set: function (value) {
            ...
            Object.defineProperty(PblSuggestionActivity.prototype, "isDependentOptionSet", {
                get: function () {
                    return this._isDependentOptionSet;
                },
                set: function (value) {
            ...
            PblSuggestionActivity.prototype.validateProperties = function () {
                ...
                status = this.addResult(result) && status;
                if (result.isValid && this._attributeType == AttributeType.Picklist && this.isDependentOptionSet) {
                    this.addWarningMessage("#attributeNameDropDown", ProcessDesigner.MetadataProvider.getLocalizedString("ProcessDesignerControl_BPF_BPFStepActivity_DependentOptionSetField_WarningMessage"));
                    ProcessDesigner.PBLDesignerControl.validationMode = (ProcessDesigner.PBLDesignerControl.validationMode == GenericWorkflowDesigner.ValidationMode.Error) ? ProcessDesigner.PBLDesignerControl.validationMode : GenericWorkflowDesigner.ValidationMode.None;
                }
                if (ProcessDesigner.PBLDesignerControl.validationMode == GenericWorkflowDesigner.ValidationMode.Error) {
    ...
    (function (ProcessDesigner) {
        ...
        var ControlManager = (function () {
            ...
            ControlManager.prototype.render = function (inputBag) {
                ...
                GenericWorkflowDesigner.designerType = GenericWorkflowDesigner.DesignerType.PblDesigner;
                ...
                this.setupExpandCollapseContainer();
                this.setupMenuBarStyle();
            ...
            ControlManager.prototype.setupExpandCollapseContainer = function () {
                var self = this;
                $("#expandContainer").click(function () {
                    self.ShowDetailsSection();
                });
                $("#collapseContainer").click(function () {
                    self.HideDetailsSection();
                });
                $("#expandContainer").keydown(function (event) {
                    if (event.keyCode == 13 || event.keyCode == 32) {
                        self.ShowDetailsSection();
                    }
                });
                $("#collapseContainer").keydown(function (event) {
                    if (event.keyCode == 13 || event.keyCode == 32) {
                        self.HideDetailsSection();
                    }
                });
                $("#expandContainer").focus();
                $("#expandContainer").attr("title", ProcessDesigner.MetadataProvider.getLocalizedString("ProcessControl_Configurator_Expand"));
                $("#collapseContainer").attr("title", ProcessDesigner.MetadataProvider.getLocalizedString("ProcessControl_Configurator_Collapse"));
                $('DIV#BusinessRuleName').removeAttr("tabindex");
                $('#descriptionfield_header').removeAttr("tabindex");
            };
            ControlManager.prototype.ShowDetailsSection = function () {
                $("#expandContainer").hide();
                $("#collapseContainer").show();
                $("#collapseContainer").css("display", "inline-block");
                $(".pblDetailsArea").slideDown('fast');
                $("#BusinessRuleName input").focus();
            };
            ControlManager.prototype.HideDetailsSection = function () {
                $("#collapseContainer").hide();
                $("#expandContainer").show();
                $("#expandContainer").css("display", "inline-block");
                $(".pblDetailsArea").slideUp('fast');
                $("#expandContainer").focus();
            };
            ControlManager.prototype.setupMenuBarStyle = function () {
                $('#ScopeSelector .ms-crm-Inline-Value').attr('style', 'padding: 0px !important');
                $('<span\>', {
                    id: 'scopeDescriptionLabel',
                    text: ProcessDesigner.MetadataProvider.getLocalizedString("ProcessDesignerControl_PBL_ScopeDescriptionText"),
                    style: 'display:none'
                }).appendTo('#scopecontainer');
                $('#ScopeSelector').attr('role', 'menuitem')
                    .attr('aria-labelledby', 'scopeLabel')
                    .attr('aria-describedby', 'scopeDescriptionLabel');
            };
                            ...
                            if (activity.getActivityTypeID() == ProcessDesigner.PblActivityType.setSuggestionStep) {
                                if ($("#" + activity.id).find(".step-list-listitem").length > 0) {
                                    ...
                                    if ($("#" + activity.id).find(".place-holder-listitem").length > 0) {
                                        $("#" + activity.id).find(".place-holder-listitem").attr("title", ProcessDesigner.PBLDesignerControl.dataBag.resources.getString("ProcessDesignerControl_BPF_ScreenReader_AddNewTile"));
                                        $("#" + activity.id).find(".place-holder-listitem").attr("aria-label", ProcessDesigner.PBLDesignerControl.dataBag.resources.getString("ProcessDesignerControl_BPF_ScreenReader_AddNewTile"));
            ...
            ControlManager.ResizeComponentsTab = function () {
                ...
                if (window.devicePixelRatio >= 1 && ((hasVerticalScrollbar == true && currentlyExpanded == "true") || (hasVerticalScrollbar == false && currentlyExpanded == "false"))) {
                    var workspaceWrapperWidth = '72.4%';
                    var toolpaneWidth = '25%';
    ...
    (function (ProcessDesigner) {
        ...
        var PBLDesignerControl = (function () {
            ...
            PBLDesignerControl.prototype.initCore = function (context) {
                ...
                this.ToolpaneTab();
                $("#HeaderViewContainer").on("keydown", function (event) {
                    ProcessDesigner.ControlManager.SetShortcutKeysToMoveOnMajorAreas(event);
                });
            };
            ...
            PBLDesignerControl.prototype.ToolpaneTab = function () {
    ...
    (function (ProcessDesigner) {
        ...
        var TelemetryEventReporter = (function () {
            ...
            TelemetryEventReporter.ReportProcessDesignerCloseEvent = function (context) {
                ...
                event.SetInfo(ProcessDesigner.processId, ProcessDesigner.ProcessTypeNames.BusinessRule, ProcessDesigner.sessionId, ProcessDesigner.processState, sessionType);
                var userId = context.internal.userId.replace('{', '').replace('}', '');
                var userRoles = context.internal.userRoles.toString();
                var organizationId = window.ORG_ID.toString().replace('{', '').replace('}', '');
                event.SetUserAndOrgInfo(userId, userRoles, organizationId);
