        ...
        (function (View) {
            ...
            var DateTimeEditView = (function (_super) {
                ...
                DateTimeEditView.prototype.dateChanged = function (event) {
                    ...
                    if (this.$el.find("#DateInput").val().length > 0) {
                        this.$el.find("#DateInput").attr("title", this.$el.find("#DateInput").val());
                        this.$el.find("#" + this.dateTimeElementId + "_iTimeInput").attr("title", $("#" + this.dateTimeElementId + "_iTimeInput").val());
                    }
                    else {
                        this.$el.find("#DateInput").attr("title", MscrmControls.ProcessDesigner.MetadataProvider.getLocalizedString("ProcessDesignerControl_BPF_PropertyPage_EmptyTexttooltip"));
            ...
            var LookupEditView = (function (_super) {
                ...
                LookupEditView.prototype.lookupDialogCloseCallback = function (dialogParams, callbackParams) {
                    ...
                    if (lookupControlItems.length > 0) {
                        ...
                        this.set(this.selectedValue, lookupControlItems[0].typename);
                    }
                };
    ...
    (function (Common) {
        ...
        (function (View) {
            ...
            var PickListEditView = (function (_super) {
                ...
                PickListEditView.prototype.loadPickList = function () {
                    ...
                    this.pickListCB(this.options).then(function (values) {
                        ...
                        _.each(pickListValues, function (item) {
                            ...
                            self.$el.append("<div><input id='prop-picklistValue' class='prop-picklist-checkbox'  tabindex='" + Util.tabIndexValue + "' type='checkbox' value='" + item.pickListValueOrderId + "' " + checked + "><span class='headline2'>" + item.pickListValue + '</span></div>');
                        });
                        var optionSetSelectedValues = self.selectedValues;
                        for (var i = 0; i < optionSetSelectedValues.length; i++) {
                            var result = pickListValues.filter(function (el) {
                                return el.pickListValueOrderId == optionSetSelectedValues[i];
                            });
                            if (result.length == 0) {
                ...
                PickListEditView.prototype.showUnsavedChangesNote = function () {
            ...
            var TextBoxEditView = (function (_super) {
                ...
                TextBoxEditView.prototype.render = function () {
                    ...
                    switch (attributeType) {
                        ...
                        case AttributeType.Integer:
                        case AttributeType.Money:
                            if (!Util.isNull(value) && !Util.isEmptyString(value) && value != 'NaN' && !isNaN(value) && MetadataProxy.SourceAttributesMap[model.entityLogicalName][model.getAttribute()] != null && MetadataProxy.SourceAttributesMap[model.entityLogicalName][model.getAttribute()] != undefined) {
                                var precision = MetadataProxy.SourceAttributesMap[model.entityLogicalName][model.getAttribute()].precision;
                                if (!Util.isNull(precision) && precision != undefined) {
                                    precision = parseInt(MetadataProxy.SourceAttributesMap[model.entityLogicalName][model.getAttribute()].precision, 10);
                                }
    ...
    (function (ConditionPropertyPage) {
        ...
        var ConditionExpressionModel = (function (_super) {
            ...
            function ConditionExpressionModel(attrs, options) {
                ...
                _.bindAll(this, 'getValue', 'getValues', 'getSingleValue', 'setValue', 'setSingleValue', 'getDisplayName', 'setDisplayName', 'getFormulaValue', 'setFormulaValue', 'isLookupType');
            ...
            ConditionExpressionModel.prototype.setSource = function (value) {
                ...
                exp._entity = new Microsoft.Crm.Workflow.Expressions.PrimaryEntity(MscrmControls.ProcessDesigner.ControlManager.workflowStep);
                this.resetValue(exp);
            ...
            ConditionExpressionModel.prototype.setFormulaValueType = function (formulaValueType) {
                ...
                if (formulaValueType == ConditionPropertyPage.ConditionTypes.Field) {
                    ...
                    MetadataProxy.getComparableAttributes(formula._leftEntity.get_entityName(), formula._attribute, firstKey).then(function (attributeList) {
                    ...
                    formula._rightEntity = new Microsoft.Crm.Workflow.Expressions.PrimaryEntity(MscrmControls.ProcessDesigner.ControlManager.workflowStep);
                }
            ...
            ConditionExpressionModel.prototype.setOperator = function (value) {
                ...
                else if (this.isStatusType(MetadataProxy.getAttributeType(exp._attribute, this.entityLogicalName)) && ConditionExpressionModel.isUniversalStringOperator(exp._operator)) {
                    exp._value._attributeType = AttributeType.String;
                }
                else {
                    exp._value._isLookup = false;
                }
                if (!this.isBpfAttribute() && this.clearValueOnOperatorChange(exp._attribute, this.entityLogicalName, value)) {
                    exp._value._value = [];
                }
                this.set('_expression', exp);
            };
            ...
            ConditionExpressionModel.prototype.setType = function (value) {
                ...
                if (!this.isBpfAttribute()) {
                    if (value == ConditionPropertyPage.ConditionTypes.Field) {
                        ...
                        exp._value._isLookup = false;
                        exp._value._value = [];
                        exp._value._entity = new Microsoft.Crm.Workflow.Expressions.PrimaryEntity(MscrmControls.ProcessDesigner.ControlManager.workflowStep);
                        if (this.isLookupType(MetadataProxy.getAttributeType(exp._attribute, this.entityLogicalName))) {
                            exp._value._lookupEntityType = null;
                            exp._value._lookupLabel = null;
                        }
                        ...
                        exp._value._formula._value = "";
                        exp._value._formula._leftEntity = new Microsoft.Crm.Workflow.Expressions.PrimaryEntity(MscrmControls.ProcessDesigner.ControlManager.workflowStep);
                        this.resetFormulaType(exp);
                    }
                    else {
                        exp._value._isFormula = false;
                        exp._value._isAttribute = false;
                        if (this.isLookupType(MetadataProxy.getAttributeType(exp._attribute, this.entityLogicalName)) && !ConditionExpressionModel.isUniversalStringOperator(exp._operator)) {
                            exp._value._isLookup = true;
            ...
            ConditionExpressionModel.prototype.setSingleValue = function (value, lookupEntityType) {
                var exp = this.get('_expression');
                exp._value._value = [value];
                if (this.isLookupType(MetadataProxy.getAttributeType(exp._attribute, this.entityLogicalName)) && !ConditionExpressionModel.isUniversalStringOperator(exp._operator)) {
                    exp._value._lookupEntityType = lookupEntityType || MetadataProxy.SourceAttributesMap[this.entityLogicalName][this.getAttribute()].targetEntityForLookUp[0];
            ...
            ConditionExpressionModel.prototype.setFormula = function (value) {
                ...
                exp._value._formula._attributeType = MetadataProxy.getAttributeType(value._attribute, this.entityLogicalName);
                this.set('_expression', exp);
                this.trigger('change');
            };
            ...
            ConditionExpressionModel.prototype.getExpressionText = function () {
                ...
                try {
                    if (exp._sourceType.isEntity) {
                        ...
                        operators = $.grep(operatorList, function (operator) { return operator.value == exp._operator; });
                        operatorDisplayName = "";
                        if (operators.length > 0) {
                            operatorDisplayName = operators[0].name;
                        }
                        text = MetadataProxy.SourceAttributesMap[exp._entity.get_entityName()][exp._attribute].displayName + ' ' + operatorDisplayName + ' ';
                        if (exp._value) {
                            if (exp._value._isFormula) {
                                var strValue = exp._value._formula.isAttribute ? MetadataProxy.SourceAttributesMap[exp._value._formula.rightEntity.get_entityName()][exp._value._formula._value].displayName : exp._value._formula._value;
                                text += '[' + MetadataProxy.SourceAttributesMap[exp._value._formula.leftEntity.get_entityName()][exp._value._formula._attribute].displayName + ' ' + ConditionPropertyPage.FormulaOperatorSymbol[exp._value._formula._operator] + ' ' + strValue + ']';
                            }
                            else if (!(typeof exp._value._value === 'undefined' || exp._value._value == null)) {
                                if (!exp._value._isAttribute && MetadataProxy.SourceAttributesMap && MetadataProxy.isEnumeratedField(this.getAttribute(), this.entityLogicalName) && !(this.isStatusType(exp._attributeType) && ConditionExpressionModel.isUniversalStringOperator(exp._operator))) {
                                    text += '[' + MetadataProxy.getPicklistValueNames(this.getAttribute(), exp._value._value).join() + ']';
                                }
                                else if (!exp._value._isAttribute && this.isLookupType(MetadataProxy.getAttributeType(this.getAttribute(), this.entityLogicalName)) && !(ConditionExpressionModel.isUniversalStringOperator(exp._operator))) {
                                    text += '[' + this.getDisplayName() + ']';
                                }
                                else {
                                    var strValue;
                                    if (exp._value.isAttribute) {
                                        strValue = typeof MetadataProxy.SourceAttributesMap[exp._value.entity.get_entityName()][exp._value._value.toString()] != "undefined" ? MetadataProxy.SourceAttributesMap[exp._value.entity.get_entityName()][exp._value._value.toString()].displayName : "";
                                    }
                                    else {
                                        strValue = exp._value._value.toString();
                                        if (exp._attributeType == 2 && !isNaN(Date.parse(strValue))) {
                                            var isDateOnly = false;
                                            if (MetadataProxy.SourceAttributesMap[exp._entity.get_entityName()][exp._attribute]) {
                                                if ((MetadataProxy.SourceAttributesMap[exp._entity.get_entityName()][exp._attribute].dateFormat == DateFormat[DateFormat.Date].toLowerCase()) || (exp._operator == ConditionOperator.NotOn || exp._operator == ConditionOperator.On)) {
                                                    isDateOnly = true;
                                                }
                                            }
                                            ...
                                            if (isDateOnly) {
                                                var userTime = ProcessControl.Configuration.PBLClientProxy.convertToUserSettingTime(exp._value._value, isDateOnly);
                                                dateToBeLocalized = ProcessControl.Configuration.PBLClientProxy.parseDateInvariant(userTime.toString());
                                            }
                                            else {
                                                var userTime = ProcessControl.Configuration.PBLClientProxy.convertToUserSettingTime(new Date(exp._value._value), isDateOnly);
                        ...
                        if (exp._isCategory) {
                            if (exp._stageType.isActive) {
                                text = BpfMetadataProvider.getDisplayName(BpfFields.ActiveStageCategory) + '  ' + operatorDisplayName + ' ';
                            }
                            else if (exp._stageType.isSelected) {
                                text = BpfMetadataProvider.getDisplayName(BpfFields.SelectedStageCategory) + '  ' + operatorDisplayName + ' ';
                            }
                            text += '[' + BpfMetadataProvider.getCategoryIndex2DisplayName(exp._value.value) + ']';
                        }
                        else {
                            text = BpfMetadataProvider.getDisplayName(BpfFields.BpfProcess) + '  ' + operatorDisplayName;
                            text += ' [' + BpfMetadataProvider.getProcessDisplayName(exp._processId) + ']';
                            operators = $.grep(operatorList, function (operator) { return operator.value == exp._stageOperator; });
                            if (operators.length > 0) {
                                operatorDisplayName = operators[0].name;
                            }
                            if (exp._stageType.isActive) {
                                text += ' ' + MscrmControls.ProcessDesigner.MetadataProvider.getLocalizedString("ProcessDesignerControl_PBL_PlainTextGenerator_where") + ' ' + BpfMetadataProvider.getDisplayName(BpfFields.ActiveStage) + '  ' + operatorDisplayName;
                                text += ' [' + BpfMetadataProvider.getStageIndex2DisplayName(exp._processId, exp._value.value) + ']';
                            }
                            else if (exp._stageType.isSelected) {
                                text += ' ' + MscrmControls.ProcessDesigner.MetadataProvider.getLocalizedString("ProcessDesignerControl_PBL_PlainTextGenerator_where") + ' ' + BpfMetadataProvider.getDisplayName(BpfFields.SelectedStage) + '  ' + operatorDisplayName;
                                text += ' [' + BpfMetadataProvider.getStageIndex2DisplayName(exp._processId, exp._value.value) + ']';
                            }
                        }
                    }
            ...
            LookupView.prototype.render = function () {
                ...
                if (values.length > 0) {
                    ...
                    if (this.selectedValue) {
                        ...
                        this.$("#txtLookup_" + this.cid).val(GenericWorkflowDesigner.CrmEncodeDecode.CrmHtmlEncode(displayName));
                    }
                }
                return this;
            };
        ...
        var PicklistView = (function (_super) {
            ...
            PicklistView.prototype.render = function () {
                ...
                MetadataProxy.getPickListValues(this.model.entityLogicalName, attributeLogicalName).then(function (values) {
                    ...
                    _.each(picklistValues, function (item) {
                        var checked = (self.selectedValues.indexOf(item.pickListValueOrderId.toString()) >= 0) ? 'checked' : '';
                        self.$el.append("<div><input id='bpfprop-picklistValue' type='checkbox' value='" + item.pickListValueOrderId + "' " + checked + "><span>" + item.pickListValue + '</span></div>');
                    });
                    deferred.resolve(self);
                });
                return deferred.promise();
    ...
    (function (ConditionPropertyPage) {
        ...
        var PropertiesView = (function (_super) {
            ...
            PropertiesView.prototype.setToolTips = function () {
                $('#name').attr('title', MetadataProvider.getLocalizedString("ProcessDesignerControl_BPF_ConditionNameTooltip"));
                $('#desc').attr('title', MetadataProvider.getLocalizedString("ProcessDesignerControl_BPF_DescriptionTooltip"));
    ...
    (function (ConditionPropertyPage) {
        ...
        var ConditionExpressionView = (function (_super) {
            ...
            ConditionExpressionView.prototype.render = function () {
                ...
                this.model.getViewDescriptor().then(function (d) {
                    ...
                    if (!self.model.isBpfAttribute()) {
                        ...
                        else if (typeVal && typeVal.val() && typeVal.val() == ConditionPropertyPage.ConditionTypes.Value && self.model.get('_expression')._attribute != 'NEW_EXP') {
                            var displayName = self.model.getDisplayName();
                            if (Util.isEmptyString(displayName) || typeof displayName === 'undefined' || typeof displayName === null) {
                                if (MetadataProxy.SourceAttributesMap[self.model.entityLogicalName][self.model.getAttribute()].targetEntityForLookUp && self.model.get('_expression')._value.value && self.model.get('_expression')._value.value.length > 0 && !(ConditionPropertyPage.ConditionExpressionModel.isUniversalStringOperator(self.model.get('_expression').operator))) {
            ...
            ConditionExpressionView.prototype.renderValue = function () {
                ...
                var isText = MetadataProxy.isTextField(this.model.getAttribute(), this.model.entityLogicalName, ConditionOperator[operatorType]);
                if (isText) {
                ...
                switch (attributeType) {
                    ...
                    case AttributeType.Integer:
                    case AttributeType.Money:
                        this.valueView = new TextBoxEditView({ model: this.model, attributeType: attributeType, get: this.model.getSingleValue, set: this.model.setSingleValue, attributes: { id: 'value', class: 'prop-input headline4', value: this.model.getSingleValue() } });
                        this.$("#valueContainer").html(this.valueView.render().$el);
                    ...
                    case AttributeType.String:
                        this.valueView = new TextBoxEditView({ model: this.model, allowEmpty: false, get: this.model.getSingleValue, set: this.model.setSingleValue, attributes: { id: 'value', class: 'prop-input headline4', value: this.model.getSingleValue() } });
                        this.$("#valueContainer").html(this.valueView.render().$el);
            ...
            ConditionExpressionView.prototype.renderBpfValue = function () {
                ...
                if (exp._isCategory) {
                    this.valueView = new PickListEditView({ model: this.model, get: this.model.getValues, set: this.model.setValue, pickListCB: this.pickListCBCategory });
                }
                else {
                    selector = "#stageValueContainer";
                    this.valueView = new PickListEditView({ model: this.model, get: this.pickListCBSelectedStageValues, set: this.model.setValue, pickListCB: this.pickListCBStage });
                }
                this.valueView.render().then(function (view) {
            ...
            ConditionExpressionView.prototype.valueChanged = function () {
                ...
                if (!this.model.isBpfAttribute()) {
                    if (MetadataProxy.SourceAttributesMap[this.model.entityLogicalName][this.model.getAttribute()]) {
                        attributeType = MetadataProxy.SourceAttributesMap[this.model.entityLogicalName][this.model.getAttribute()].attributeType;
                    }
                }
    ...
    (function (ConditionPropertyPage) {
        ...
        var ConditionPropertiesView = (function (_super) {
            ...
            function ConditionPropertiesView(options) {
                ...
                this.pageLevelErrorCount = this.getPageLevelErrorCount(this.propertyViewCurrentModelClone.getErrorMessages());
            ...
            ConditionPropertiesView.prototype.updateFieldType = function (field) {
                if (field._sourceType.isEntity) {
                    field.attributeType = MetadataProxy.getAttributeType(field.attribute, ConditionPropertyPage.isTaskFlow ? field.entity.entityName : this.model.entityLogicalName);
                    if (field.value != null) {
                        if (field.value.isAttribute) {
                            field.value.attributeType = MetadataProxy.getAttributeType(field.value.value[0], ConditionPropertyPage.isTaskFlow ? field.value.entity.entityName : this.model.entityLogicalName);
                        }
                        else if (field.value.isLookup) {
                        }
                        else if (field.value.isFormula) {
                            field.value.formula.attributeType = MetadataProxy.getAttributeType(field.value.formula.attribute, ConditionPropertyPage.isTaskFlow ? field.value.formula.leftEntity.entityName : this.model.entityLogicalName);
                            field.value.formula.leftAttributeType = MetadataProxy.getAttributeType(field.value.formula.attribute, ConditionPropertyPage.isTaskFlow ? field.value.formula.leftEntity.entityName : this.model.entityLogicalName);
                            ...
                            if (ConditionPropertyPage.ConditionExpressionModel.isUniversalStringOperator(field.operator)) {
            ...
            ConditionPropertiesView.prototype.saveCondition = function (event) {
                try {
                    ...
                    DOMUtil.renderPropertyPageLevelErrorMessages(propertyViewCurrentModel, $("#properties-panel"), propertyViewCurrentModel.getErrorMessages());
                    $('[id=ruleHeadLabel]').html(function (i) { return MscrmControls.ProcessDesigner.MetadataProvider.getLocalizedString("ProcessDesignerControl_BPF_BranchPropertyDetails_Rule") + ' ' + (i + 1); });
                    $('[id=ruleHeadLabel]').attr("title", function (i) { return MscrmControls.ProcessDesigner.MetadataProvider.getLocalizedString("ProcessDesignerControl_BPF_BranchPropertyDetails_Rule") + ' ' + (i + 1); });
                    stopwatch.stop();
    ...
    (function (ConditionPropertyPage) {
        ...
        var ViewDescriptorProvider = (function () {
            ...
            ViewDescriptorProvider.prototype.getExpressionDescriptor = function (expression, index) {
                ...
                expressionDescriptor.sourceTypes.push(new OptionModel(MscrmControls.ProcessDesigner.MetadataProvider.getLocalizedString("ProcessDesignerControl_PBL_Source_Entity"), 0));
                if (!MscrmControls.ProcessDesigner.PBLScope.isEntity() || expression._sourceType.isBpfAttribute) {
                    expressionDescriptor.sourceTypes.push(new OptionModel(MscrmControls.ProcessDesigner.MetadataProvider.getLocalizedString("ProcessDesignerControl_PBL_Source_Business_Process"), 1));
                }
                var isNew = (expression._attribute == "NEW_EXP");
                var ruleLabels = new ConditionPropertyPage.Dictionary();
                ruleLabels["lblOperator"] = MscrmControls.ProcessDesigner.MetadataProvider.getLocalizedString("ProcessDesignerControl_BPF_BranchPropertyDetails_Operator");
                ruleLabels["lblOperatorTooltip"] = MscrmControls.ProcessDesigner.MetadataProvider.getLocalizedString("ProcessDesignerControl_BPF_OperatorTooltip");
                ruleLabels["lblField"] = MscrmControls.ProcessDesigner.MetadataProvider.getLocalizedString("ProcessDesignerControl_BPF_BranchPropertyDetails_Field");
                ruleLabels["lblFieldTooltip"] = MscrmControls.ProcessDesigner.MetadataProvider.getLocalizedString("ProcessDesignerControl_BPF_FieldTooltip");
                ruleLabels["lblType"] = MscrmControls.ProcessDesigner.MetadataProvider.getLocalizedString("ProcessDesignerControl_BPF_BranchPropertyDetails_Type");
                ruleLabels["lblTypeTooltip"] = MscrmControls.ProcessDesigner.MetadataProvider.getLocalizedString("ProcessDesignerControl_BPF_TypeTooltip");
                ruleLabels["lblValue"] = MscrmControls.ProcessDesigner.MetadataProvider.getLocalizedString("ProcessDesignerControl_PBL_PlainTextGenerator_Value");
                ruleLabels["lblValueTooltip"] = MscrmControls.ProcessDesigner.MetadataProvider.getLocalizedString("ProcessDesignerControl_BPF_ValueTooltip");
                ruleLabels["lblDays"] = MscrmControls.ProcessDesigner.MetadataProvider.getLocalizedString("ProcessDesignerControl_BPF_BranchPropertyDetails_Days");
                ruleLabels["lblDaysTooltip"] = MscrmControls.ProcessDesigner.MetadataProvider.getLocalizedString("ProcessDesignerControl_BPF_Tooltip_Label_Days");
                ruleLabels["lblSource"] = MscrmControls.ProcessDesigner.MetadataProvider.getLocalizedString("ProcessDesignerControl_PBL_BranchPropertyDetails_Source");
                ruleLabels["lblSourceTooltip"] = MscrmControls.ProcessDesigner.MetadataProvider.getLocalizedString("ProcessDesignerControl_TBX_SourceTooltip");
                ruleLabels["lblStageType"] = MscrmControls.ProcessDesigner.MetadataProvider.getLocalizedString("ProcessDesignerControl_PBL_BranchPropertyDetails_StageType");
                ...
                if (expression._sourceType.isBpfAttribute) {
                    ...
                    expressionDescriptor.operators = [{ name: MscrmControls.ProcessDesigner.MetadataProvider.getLocalizedString("ProcessDesignerControl_BPF_ConditionOperator_Equal"), value: 6 },
                        { name: MscrmControls.ProcessDesigner.MetadataProvider.getLocalizedString("ProcessDesignerControl_BPF_ConditionOperator_NotEqual"), value: 7 }
                    ];
                    expressionDescriptor.stageOperators = [{ name: MscrmControls.ProcessDesigner.MetadataProvider.getLocalizedString("ProcessDesignerControl_BPF_ConditionOperator_Equal"), value: 6 },
                        { name: MscrmControls.ProcessDesigner.MetadataProvider.getLocalizedString("ProcessDesignerControl_BPF_ConditionOperator_NotEqual"), value: 7 }
                    ];
                    ...
                    expressionDescriptor.types.push({ value: ConditionPropertyPage.ConditionTypes.Value, name: ConditionPropertyPage.ValueType.Value });
                    ...
                    if (!expression._isCategory) {
                        ...
                        if (!MscrmControls.ProcessDesigner.Util.isNull(expressionDescriptor.processList) && expressionDescriptor.processList != undefined && expressionDescriptor.processList.length > 0) {
                            expressionDescriptor.types.push({ value: ConditionPropertyPage.ConditionTypes.ValueWithStage, name: ConditionPropertyPage.ValueType.ValueWithStage });
                    ...
                    MetadataProxy.getAttributeList(self._entityLogicalName, expression._entity.relationshipName).then(function (attributeList) {
                        ...
                        if (MscrmControls.ProcessDesigner.Util.isNull(MetadataProxy.SourceAttributesMap[self._entityLogicalName][expressionDescriptor.selectedAttribute])) {
                            ...
                            attributeTypeName = MetadataProxy.SourceAttributesMap[self._entityLogicalName][expressionDescriptor.selectedAttribute].attributeType;
                        }
                        ...
                        if (expression._value._isAttribute) {
                            expressionDescriptor.types.push({ value: ConditionPropertyPage.ConditionTypes.Field, name: ConditionPropertyPage.ValueType.Field });
                            expressionDescriptor.types.push({ value: ConditionPropertyPage.ConditionTypes.Value, name: ConditionPropertyPage.ValueType.Value });
                            if (isFormulaValid) {
                                expressionDescriptor.types.push({ value: ConditionPropertyPage.ConditionTypes.Formula, name: ConditionPropertyPage.ValueType.Formula });
                            }
                            if (!ConditionPropertyPage.isTaskFlow) {
                            ...
                            if (expression._value._formula._isAttribute) {
                                expressionDescriptor.value.types = [{ value: ConditionPropertyPage.ConditionTypes.Field, name: ConditionPropertyPage.ValueType.Field }, { value: ConditionPropertyPage.ConditionTypes.Value, name: ConditionPropertyPage.ValueType.Value }];
                            }
                            else {
                                ...
                                if (dataType == AttributeType.DateTime) {
                                    expressionDescriptor.value.types = [{ value: ConditionPropertyPage.ConditionTypes.Value, name: ConditionPropertyPage.ValueType.Value }];
                                }
                                else {
                                    expressionDescriptor.value.types = [{ value: ConditionPropertyPage.ConditionTypes.Value, name: ConditionPropertyPage.ValueType.Value }, { value: ConditionPropertyPage.ConditionTypes.Field, name: ConditionPropertyPage.ValueType.Field }];
                                }
                            }
                            if (!ConditionPropertyPage.isTaskFlow) {
            ...
            ViewDescriptorProvider.prototype.getConditionPropertyDescriptor = function (model) {
                ...
                conditionDescriptor.entityDisplayName = MscrmControls.ProcessDesigner.Util.isNull(model.entityLogicalName) || MscrmControls.ProcessDesigner.Util.isEmptyString(model.entityLogicalName) ? model.entityLogicalName : _window.Xrm.Internal.getEntityDisplayName(model.entityLogicalName);
                ...
                propertyLabels["lblConditionProperties"] = MscrmControls.ProcessDesigner.MetadataProvider.getLocalizedString("ProcessDesignerControl_PBL_Library_Condition");
                propertyLabels["lblEntity"] = MscrmControls.ProcessDesigner.MetadataProvider.getLocalizedString("ProcessDesignerControl_BPF_StagePropertyDetails_Entity");
                propertyLabels["lblConditionName"] = MscrmControls.ProcessDesigner.MetadataProvider.getLocalizedString("ProcessDesignerControl_BPF_BranchPropertyDetails_Header");
                propertyLabels["lblbranchpropertydetails_rule"] = MscrmControls.ProcessDesigner.MetadataProvider.getLocalizedString("ProcessDesignerControl_BPF_BranchPropertyDetails_Rules");
                propertyLabels["branchpropertydetails_add"] = MscrmControls.ProcessDesigner.MetadataProvider.getLocalizedString("ProcessDesignerControl_BPF_New");
                propertyLabels["lblRuleLogic"] = MscrmControls.ProcessDesigner.MetadataProvider.getLocalizedString("ProcessDesignerControl_BPF_BranchPropertyDetails_RuleLogic");
                propertyLabels["lblConditionExpression"] = MscrmControls.ProcessDesigner.MetadataProvider.getLocalizedString("ProcessDesignerControl_BPF_Condition_Expression_Label");
...
(function (MscrmControls) {
    ...
    (function (ConditionPropertyPage) {
        ...
        var ValueType = (function () {
            ...
            Object.defineProperty(ValueType, "Field", {
            ...
            Object.defineProperty(ValueType, "ValueWithStage", {
                get: function () { return MscrmControls.ProcessDesigner.MetadataProvider.getLocalizedString("ProcessDesignerControl_PBL_PlainTextGenerator_Value_with_Stage"); },
                enumerable: true,
                configurable: true
            });
            return ValueType;
