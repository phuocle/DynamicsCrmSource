...
Microsoft.Crm.Workflow.ObjectModel.ActionStep.prototype = {	
	...
	appendStep: function Microsoft_Crm_Workflow_ObjectModel_ActionStep$appendStep(newStep) {		
		Microsoft.Crm.Workflow.Utils.ExceptionUtility.assert((Microsoft.Crm.Workflow.ObjectModel.AssignVariableStep.isInstanceOfType(newStep)) || (Microsoft.Crm.Workflow.ObjectModel.CustomJavascriptStep.isInstanceOfType(newStep)) || (Microsoft.Crm.Workflow.ObjectModel.SetAttributeValueStep.isInstanceOfType(newStep)), 'Can only insert AssignVariableStep, SetAttributeValueStep, or CustomJavascriptStep');		
...
Microsoft.Crm.Workflow.ObjectModel.InteractiveWorkflowInputDictionary.prototype = {
	...
	get_keys: function Microsoft_Crm_Workflow_ObjectModel_InteractiveWorkflowInputDictionary$get_keys() {
		var keys = new (Microsoft.Crm.Client.Core.Framework2.List$1.$$(Microsoft.Crm.Workflow.ObjectModel.CustomActivityParameterInfo))();
...
Microsoft.Crm.Workflow.ObjectModel.WorkflowArgument.prototype = {
	...
	toJson: function Microsoft_Crm_Workflow_ObjectModel_WorkflowArgument$toJson() {
		...
		sb.append(Microsoft.Crm.Workflow.ObjectModel.JsonBuilder.getPropertyJson('_argumentDirection', this._argumentDirection.toString(), true));
		sb.append('}');
		return sb.toString();
	},
...
Microsoft.Crm.Workflow.ObjectModel.WorkflowStep = function Microsoft_Crm_Workflow_ObjectModel_WorkflowStep(primaryEntityName, category) {
	this._arguments = new (Microsoft.Crm.Client.Core.Framework2.List$1.$$(Microsoft.Crm.Workflow.ObjectModel.WorkflowArgument))();
	this.stepDictionary = new Microsoft.Crm.Workflow.ObjectModel.StepDictionary();
	this._workflowStepVariables$p$2 = new (Microsoft.Crm.Client.Core.Framework2.List$1.$$(Microsoft.Crm.Workflow.ObjectModel.WorkflowArgument))();
	this._workflowStepInputs$p$2 = new (Microsoft.Crm.Client.Core.Framework2.List$1.$$(Microsoft.Crm.Workflow.ObjectModel.WorkflowArgument))();
...
Microsoft.Crm.Workflow.ObjectModel.WorkflowStep.prototype = {
	...
	initializeFromDynamic: function Microsoft_Crm_Workflow_ObjectModel_WorkflowStep$initializeFromDynamic(deserialized) {
		if (deserialized) {
			...
			this._arguments = new (Microsoft.Crm.Client.Core.Framework2.List$1.$$(Microsoft.Crm.Workflow.ObjectModel.WorkflowArgument))();
			var sourceArgumentArray = new (Microsoft.Crm.Client.Core.Framework2.List$1.$$(Microsoft.Crm.Workflow.ObjectModel.WorkflowArgument))(sourceObject.argumentsArray);
...
Microsoft.Crm.Workflow.ObjectModel.DataCollection$1.$$ = function Microsoft_Crm_Workflow_ObjectModel_DataCollection$1$$$(T) {
	...
	if (!Microsoft.Crm.Workflow.ObjectModel[$$cn]) {
		...
		$$ccr.registerClass('Microsoft.Crm.Workflow.ObjectModel.' + $$cn, null, Microsoft.Crm.Client.Core.Framework2.IList$1.$$(T));
...
Microsoft.Crm.Workflow.Validators._methodCallEvaluateExpressionValidatorBase = function Microsoft_Crm_Workflow_Validators__methodCallEvaluateExpressionValidatorBase(operands, expressionOperator, context) {
...
Microsoft.Crm.Workflow.Validators._methodCallEvaluateExpressionValidatorBase.prototype = {
	...
	set_operands: function Microsoft_Crm_Workflow_Validators__methodCallEvaluateExpressionValidatorBase$set_operands(value) {
	...
	get_behaviorType: function Microsoft_Crm_Workflow_Validators__methodCallEvaluateExpressionValidatorBase$get_behaviorType() {
		return this._behaviorType$0;
	},

	set_behaviorType: function Microsoft_Crm_Workflow_Validators__methodCallEvaluateExpressionValidatorBase$set_behaviorType(value) {
	...
	set_context: function Microsoft_Crm_Workflow_Validators__methodCallEvaluateExpressionValidatorBase$set_context(value) {
		this._context$0 = value;
		return value;
	},
	...
	set_operator: function Microsoft_Crm_Workflow_Validators__methodCallEvaluateExpressionValidatorBase$set_operator(value) {
...
Microsoft.Crm.Workflow.Validators._methodCallEvaluateExpressionValidatorFactory = function Microsoft_Crm_Workflow_Validators__methodCallEvaluateExpressionValidatorFactory() {
}
Microsoft.Crm.Workflow.Validators._methodCallEvaluateExpressionValidatorFactory._getValidator$i = function Microsoft_Crm_Workflow_Validators__methodCallEvaluateExpressionValidatorFactory$_getValidator$i(expressionOperator, expressions, context) {
	...
	switch (expressionOperator) {
		...
		case 36:
			break;
		default:
			context.trace('Unexpected expression operator {0} in {1}', Microsoft.Crm.Workflow.Activities.ExpressionOperator.toString(expressionOperator), Microsoft.Crm.Workflow.Validators._methodCallEvaluateExpressionValidatorFactory.getName());
...
Microsoft.Crm.Workflow.Validators.MethodCallExpressionValidator.prototype = {
	...
	_validateEvaluateExpression$p$1: function Microsoft_Crm_Workflow_Validators_MethodCallExpressionValidator$_validateEvaluateExpression$p$1() {
		...
		var validator = Microsoft.Crm.Workflow.Validators._methodCallEvaluateExpressionValidatorFactory._getValidator$i(expressionOperator, methodCallExpressions, this._context$0);
		validator.validate();
...
Microsoft.Crm.Workflow.ObjectModel.ArgumentDirection.registerClass('Microsoft.Crm.Workflow.ObjectModel.ArgumentDirection');
...
Microsoft.Crm.Workflow.Validators._methodCallEvaluateExpressionValidatorBase.registerClass('Microsoft.Crm.Workflow.Validators._methodCallEvaluateExpressionValidatorBase');
Microsoft.Crm.Workflow.Validators._methodCallArithmeticEvaluateExpressionValidator.registerClass('Microsoft.Crm.Workflow.Validators._methodCallArithmeticEvaluateExpressionValidator', Microsoft.Crm.Workflow.Validators._methodCallEvaluateExpressionValidatorBase);
Microsoft.Crm.Workflow.Validators._methodCallDateMathEvaluateExpressionValidator.registerClass('Microsoft.Crm.Workflow.Validators._methodCallDateMathEvaluateExpressionValidator', Microsoft.Crm.Workflow.Validators._methodCallEvaluateExpressionValidatorBase);
Microsoft.Crm.Workflow.Validators._methodCallEvaluateExpressionValidatorFactory.registerClass('Microsoft.Crm.Workflow.Validators._methodCallEvaluateExpressionValidatorFactory');
Microsoft.Crm.Workflow.Validators._methodCallStringEvaluateExpressionValidator.registerClass('Microsoft.Crm.Workflow.Validators._methodCallStringEvaluateExpressionValidator', Microsoft.Crm.Workflow.Validators._methodCallEvaluateExpressionValidatorBase);
