...
extend(Rect, {
    ...
    ofContent: function (element, inContentSpace) {
        ...
        if (inContentSpace) {
        	...
        	return new Rect(element.getBoundingClientRect().left - element.scrollLeft, element.getBoundingClientRect().top - element.scrollTop, element.scrollWidth, element.scrollHeight);
        }
    },
