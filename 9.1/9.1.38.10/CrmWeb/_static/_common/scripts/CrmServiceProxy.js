...
Microsoft.Crm.Client.Core.Storage.WebService.WebServiceBase.prototype = {
    ...
    executeJsonRequest: function(requestData) {
        ...
        this.$27_0(requestData).then(function($p1_0) {
            ...
            if ($v_2.indexOf('<!DOCTYPE html') > -1) {
                ...
                try {
                    $v_0.resolve((!Microsoft.Crm.Client.Core.Framework._String.isNullOrEmpty($v_2)) ? JSON.parse($v_2) : null);
                }
                catch ($v_3) {
    ...
    $27_0: function($p0) {
        ...
        $v_0.beforeSend = function($p1_0) {
            ...
            if ($p0.name === 'Delete' && $p0.requestOptions.requestType === 'POST' && $p0.requestOptions.endPointUrl.indexOf('/XRMServices/2011/Organization.svc/web') >= 0) {
                window.Mscrm.WrpcTokenFuncs.setTokenInHeader($p1_0, window.Mscrm.CrmUri.create("/XRMServices/2011/Organization.svc/web"));
            }
        };
        var $v_1 = {};
