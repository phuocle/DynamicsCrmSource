...
$(window).load(function()
{
    ...
    }).keyup(function(e)
    {
        ...
        keyCodesCombination[0] == 17 && keyCodesCombination[1] == 16 && keyCodesCombination[2] == 51 && 
...
function loadAccessibility()
{
    ...
    {
        $(".tile-filters-draftApps , .tile-filters-publishedApps").off("keydown").on("keydown",function(e)
        {
            if(e.which === 13)
            {
                this.click();
        ...
        $("body",parent.document).find(":tabbable").first().off("keydown").on("keydown",function(e)
        {
        ...
        $("#appModuleContainerPanel").find(":tabbable").last().on("keydown",function(e)
        {
            if(!(e.which === 9 && e.shiftKey))
                if(e.which === 9)
        ...
        $(".tile-button").off("keydown").on("keydown",function(e)
        {
            if(e.which === 13)
            {
                this.click();
        ...
        $(".tiles-createNewApp-button").off("keydown").on("keydown",function(e)
        {
            if(e.which === 13)
            {
                this.click();
        ...
        $(".tile-button-icon-img").on("error",function()
        {
...
{
    $(".tiles-moreInfoFlyout-row").off("keydown").on("keydown",function(e)
    {
        if(e.which === 13)
        {
