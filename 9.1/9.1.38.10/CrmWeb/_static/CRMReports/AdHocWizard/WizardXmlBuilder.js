...
function WizardXmlBuilder()
{
    ...
    {
        return XUI.Xml.XMLSerializer.serializeToString(_oColumnXml)
    }
    ...
    {
        return XUI.Xml.XMLSerializer.serializeToString(_oGroupingXml)
    }
    ...
    {
        return XUI.Xml.XMLSerializer.serializeToString(_oTableLayoutXml)
    }
