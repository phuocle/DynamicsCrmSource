...
function ShowQuery()
{
    ...
    var AFMetricsStopwatch = new Mscrm.MetricsStopwatch("AdvFind");
    AFMetricsStopwatch.start();
    changeArea(QueryPage);
    AFMetricsStopwatch.stop();
    AddTelemetryLog("ViewQuery",AFMetricsStopwatch.get_elapsedMilliseconds())
}
function ExecuteQuery()
{
    ...
    var doesNotContain = XUI.Xml.SelectNodes(oXmlDom,"//link-entity[@link-type='outer']");
    if(doesNotContain && doesNotContain.length > 0)
        AddTelemetryLog("ExecuteQueryForNotIn",AFMetricsStopwatch.get_elapsedMilliseconds());
    else
        AddTelemetryLog("ExecuteQuery",AFMetricsStopwatch.get_elapsedMilliseconds())
}
...
function QuerySave()
{
    ...
    AFMetricsStopwatch.stop();
    AddTelemetryLog("Save",AFMetricsStopwatch.get_elapsedMilliseconds())
}
function QuerySaveAs()
{
    ...
    AFMetricsStopwatch.stop();
    AddTelemetryLog("SaveAs",AFMetricsStopwatch.get_elapsedMilliseconds())
}
function QueryNew()
{
    var AFMetricsStopwatch = new Mscrm.MetricsStopwatch("AdvFind");
    ...
    refreshRibbon();
    AFMetricsStopwatch.stop();
    AddTelemetryLog("NewQuery",AFMetricsStopwatch.get_elapsedMilliseconds())
}
function QueryEditColumns()
{
    ...
    AFMetricsStopwatch.stop();
    AddTelemetryLog("EditColumns",AFMetricsStopwatch.get_elapsedMilliseconds())
}
function QueryEditProperties()
{
    ...
    AFMetricsStopwatch.stop();
    AddTelemetryLog("EditProperties",AFMetricsStopwatch.get_elapsedMilliseconds())
}
function EditQueryHint()
{
    _mainWindow.$find("advFind").EditQueryHint();
    AddTelemetryLog("EditQueryHint")
}
function ClearQuery()
{
    var AFMetricsStopwatch = new Mscrm.MetricsStopwatch("AdvFind");
    ...
    AFMetricsStopwatch.stop();
    AddTelemetryLog("ClearQuery",AFMetricsStopwatch.get_elapsedMilliseconds())
}
function GroupAnd()
{
    if(!IsValidInput())
    ...
    AFMetricsStopwatch.stop();
    AddTelemetryLog("GroupAnd",AFMetricsStopwatch.get_elapsedMilliseconds())
}
function GroupOr()
{
    if(!IsValidInput())
    ...
    AFMetricsStopwatch.stop();
    AddTelemetryLog("GroupOr",AFMetricsStopwatch.get_elapsedMilliseconds())
}
function ToggleDetails()
{
    ...
    AFMetricsStopwatch.stop();
    AddTelemetryLog("ToggleDetails",AFMetricsStopwatch.get_elapsedMilliseconds())
}
...
function DownloadFetchXml()
{
    ...
    AFMetricsStopwatch.stop();
    AddTelemetryLog("DownloadFetchXml",AFMetricsStopwatch.get_elapsedMilliseconds())
}
...
function AddTelemetryLog(operationName,execTimeMS)
{
    try
    {
        ...
        arguments["execTimeMS"] = execTimeMS;
        arguments["isHybridClient"] = window.parent.IsHybridAF !== undefined && window.parent.IsHybridAF === true;
