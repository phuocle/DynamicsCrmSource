...
function CacheManager()
{
    ...
    function _initialize(bConditionExpression)
    {
        ...
        _oaCache["Operator"]["multiselectpicklist"] = _createOpCtrl(oaOpNames,"eq;ne;not-null;null;contain-values;not-contain-values");
        _oaCache["Operator"]["multiselectpicklistwithname"] = _createOpCtrl(oaOpNames,"eq;ne;not-null;null;contain-values;not-contain-values");
        ...
        _oaCache["Operator"]["lookupwithuserwithhierarchy"] = _createOpCtrl(oaOpNames,"eq-userid;ne-userid;eq;ne;not-null;null;under;not-under");
        _oaCache["Operator"]["lookupwithuserwithhierarchywithname"] = _createOpCtrl(oaOpNames,"eq-userid;ne-userid;eq;ne;not-null;null;contains;doesnotcontain;beginswith;doesnotbeginwith;endswith;doesnotendwith;under;not-under");
        _oaCache["Operator"]["owner"] = _createOpCtrl(oaOpNames,"eq-userid;ne-userid;eq-userteams;eq-useroruserhierarchy;eq-useroruserhierarchyandteams;eq-useroruserteams;eq;ne;not-null;null");
        _oaCache["Operator"]["lookupwithuserwithname"] = _createOpCtrl(oaOpNames,"eq-userid;ne-userid;eq;ne;not-null;null;contains;doesnotcontain;beginswith;doesnotbeginwith;endswith;doesnotendwith");
        _oaCache["Operator"]["ownerwithname"] = _createOpCtrl(oaOpNames,"eq-userid;ne-userid;eq-useroruserhierarchy;eq-useroruserhierarchyandteams;eq-userteams;eq-useroruserteams;eq;ne;not-null;null;contains;doesnotcontain;beginswith;doesnotbeginwith;endswith;doesnotendwith");
        _oaCache["Operator"]["lookupwithbusinessunit"] = _oaCache["Operator"]["businessunit"] = _createOpCtrl(oaOpNames,"eq-businessid;ne-businessid;eq;ne;not-null;null");
        _oaCache["Operator"]["lookupwithbusinesswithname"] = _oaCache["Operator"]["lookupwithbusinessunitwithname"] = _createOpCtrl(oaOpNames,"eq-businessid;ne-businessid;eq;ne;not-null;null;contains;doesnotcontain;beginswith;doesnotbeginwith;endswith;doesnotendwith");
        ...
        _oaCache["ConditionControlOperator"]["dateonly"] = _createOpCtrl(oaOpNames,"eq;ne;gt;ge;lt;le;on;not-on;on-or-after;on-or-before;not-null;null");
        ...
        _oaCache["Operator"]["lookupwithhierarchywithname"] = _createOpCtrl(oaOpNames,"eq;ne;not-null;null;contains;doesnotcontain;beginswith;doesnotbeginwith;endswith;doesnotendwith;under;not-under");
        _oaCache["ConditionControlOperator"]["lookupwithbusinessunit"] = _oaCache["ConditionControlOperator"]["businessunitid"] = _createOpCtrl(oaOpNames,"eq;ne;not-null;null");
        _oaCache["ConditionControlOperator"]["lookupwithbusinessunitwithname"] = _oaCache["ConditionControlOperator"]["businessunitidname"] = _createOpCtrl(oaOpNames,"eq;ne;not-null;null;contains;doesnotcontain;beginswith;doesnotbeginwith;endswith;doesnotendwith");
        _oaCache["ConditionControlOperator"]["partylist"] = _createOpCtrl(oaOpNames,"eq;ne;not-null;null;contains;doesnotcontain");
        _oaCache["ConditionControlOperator"]["lookupwithuserwithhierarchy"] = _createOpCtrl(oaOpNames,"eq;ne;not-null;null;under;not-under");
        _oaCache["ConditionControlOperator"]["lookupwithuserwithhierarchywithname"] = _createOpCtrl(oaOpNames,"eq;ne;not-null;null;contains;doesnotcontain;beginswith;doesnotbeginwith;endswith;doesnotendwith;under;not-under");
    ...
    function _getRelatedEntity(sRelatedEntity,sFrom,sTo,sEntity)
    {
        ...
        return XUI.Xml.SelectSingleNode(_oXml,'/related/option[@entity="' + sRelatedEntity + '" and @from="' + sFrom + '" and @to="' + sTo + '"]',null)
    }
    ...
    function _getElement(sEleType,sKey,vOptParam)
    {
        ...
        else
        {
            ...
            switch(sEleType)
            {
                ...
                case "Field":
                    oaParameters["entityName"] = sKey;
                    var isWorkflowDependentPage = window.location.pathname.toUpperCase().endsWith("/CONDITION.ASPX") || window.location.pathname.toUpperCase().endsWith("/SLAITEM/EDIT.ASPX") || window.location.pathname.toUpperCase().endsWith("/CONVERTRULEITEM/EDIT.ASPX") || window.location.pathname.toUpperCase().endsWith("/ROUTINGRULEITEM/EDIT.ASPX");
                    if(vOptParam != null && vOptParam["ShowOnlyFilterControl"] != null && vOptParam["ShowOnlyFilterControl"] || isWorkflowDependentPage)
                    {
                        oaParameters["isValidForUpdateRequired"] = vOptParam != null && vOptParam["ShowOnlyFilterControl"] != null && vOptParam["ShowOnlyFilterControl"] ? true : false;
                        if(isWorkflowDependentPage)
                            oaParameters["removeMSOSAttribute"] = true;
                        else
                            oaParameters["removeMSOSAttribute"] = false;
                        vEle = _executeRemoteCommand("GetEntityFieldListWithRestriction","AdvancedFind",oaParameters,_getFieldList,sKey)
                    }
                    else
