...
Mscrm.TurboForm.Control.SfaTabs.Commands.ICreateSFATabControlsCommand.registerInterface('Mscrm.TurboForm.Control.SfaTabs.Commands.ICreateSFATabControlsCommand');
...
Mscrm.TurboForm.Control.SfaTabs.Components.ActivitiesComponent = function() {
    this.$0_0 = new Mscrm.TurboForm.Control.SfaTabs.Components.WallDataPreloader(Mscrm.TurboForm.Control.SfaTabs.Components.ActivitiesComponent.getName());
...
Mscrm.TurboForm.Control.SfaTabs.Components.ActivitiesComponent.preloadRequestFactory = function() {
    ...
    var $v_2 = Mscrm.Caching.LocalStorageCache.getEntityMetadataCache(Mscrm.TurboForm.Control.PageManager.get_instance().get_pageState().entityName);
    if (IsNull($v_0.$4_1)) {
        $v_0.$4_1 = $v_2.get_item('ActivityPointerRelationshipName');
        if (IsNullOrEmptyString($v_0.$4_1)) {
            return null;
        }
        Xrm.Internal.trace.logT(Mscrm.TurboForm.Control.SfaTabs.Components.ActivitiesComponent, 'PreloadRequestFactory: using ActivityPointerRelationshipName from metadata cache');
    }
    else {
    ...
    if (($v_1 != null)) {
        ...
        $v_1 = $v_3 === '1';
        Xrm.Internal.trace.logT(Mscrm.TurboForm.Control.SfaTabs.Components.ActivitiesComponent, 'PreloadRequestFactory: using IsActivityParty from metadata cache: {0}', $v_3);
    }
    $v_0.$C_1 = $v_1;
    return $v_0;
}
...
Mscrm.TurboForm.Control.SfaTabs.Components.ActivitiesComponent.$d = function() {
    if (IsNull(Mscrm.FormInputControl.ActivitiesWallPage.localizedStrings) || IsNull(Mscrm.FormInputControl.ActivitiesWallPage.localizedStrings.ISACTIVITYPARTY_LOC_STRING)) {
        return null;
    }
    return Mscrm.FormInputControl.ActivitiesWallPage.localizedStrings.ISACTIVITYPARTY_LOC_STRING.toUpperCase() === 'TRUE';
}
...
Mscrm.TurboForm.Control.SfaTabs.Components.ActivitiesPreloadRequest.prototype = {
    ...
    createWallService: function() {
        return new ActivitiesWall.Service.WallService(this.$5_0.get_id(), null, this.$5_0.get_typeCode().toString(), this.$4_1, this.$C_1);
    }
}
...
Mscrm.TurboForm.Control.SfaTabs.Components.NotesComponent = function() {
    ...
    this.$0_0 = new Mscrm.TurboForm.Control.SfaTabs.Components.WallDataPreloader(Mscrm.TurboForm.Control.SfaTabs.Components.NotesComponent.getName());
...
Mscrm.TurboForm.Control.SfaTabs.Components.SfaTabsComponent.$$cctor = function() {
    Mscrm.TurboForm.Control.PageBootstrapper.add_onDataBound(Mscrm.TurboForm.Control.SfaTabs.Components.SfaTabsComponent.$1.$$d_$Q_0);
}
...
Mscrm.TurboForm.Control.SfaTabs.Components.SfaTabsComponent.$j = function() {
    ...
    if (!IsNull($v_0)) {
        ...
        if (!IsNull($v_1)) {
            ...
            if (!IsNull($v_2) && ($v_2.getAttribute('tabid') === 'ActivityFeedsSystemTab' || $v_2.getAttribute('tabid') === 'ActivitiesTab')) {
                return true;
            }
        }
    }
...
Mscrm.TurboForm.Control.SfaTabs.Components.SfaTabsComponent.$x = function() {
    ...
    if (!IsNull($v_2)) {
        if ($v_2.nodeName.toUpperCase() === 'IFRAME' || !Mscrm.TurboForm.Control.SfaTabs.Components.SfaTabsComponent.$j()) {
            return;
        }
...
Mscrm.TurboForm.Control.SfaTabs.Components.SfaTabsComponent.$i = function() {
    ...
    var $v_1 = (typeof(Mscrm.CaseResearchConstants) !== 'undefined') ? $find('header_process_CaseResearch_LinkControl_casesconversations') : null;
...
Mscrm.TurboForm.Control.SfaTabs.Components.ActivityFeedsComponent = function() {
    this.$$d_$q_0 = Function.createDelegate(this, this.$q_0);
    this.$$d_$Q_0 = Function.createDelegate(this, this.$Q_0);
    this.$0_0 = new Mscrm.TurboForm.Control.SfaTabs.Components.WallDataPreloader(Mscrm.TurboForm.Control.SfaTabs.Components.ActivityFeedsComponent.getName());
    var $$t_0 = this;
...
Mscrm.TurboForm.Control.SfaTabs.Components.ActivityFeedsComponent.$$cctor = function() {
    Mscrm.TurboForm.Control.PageBootstrapper.add_onDataBound(Mscrm.TurboForm.Control.SfaTabs.Components.ActivityFeedsComponent.$1.$$d_$Q_0);
    Mscrm.TurboForm.Control.PageBootstrapper.add_onBeforeUnload(Mscrm.TurboForm.Control.SfaTabs.Components.ActivityFeedsComponent.$1.$$d_$q_0);
}
...
Mscrm.TurboForm.Control.SfaTabs.Components.ActivityFeedsComponent.prototype = {
    ...
    $10_0: function() {
        var $v_0 = Mscrm.TurboForm.Control.PageManager.get_instance().get_activityFeedsState();
        if (!$v_0 || !$v_0.IsConfigured || !$v_0.IsWallEnabled) {
            Xrm.Internal.trace.warningT(Mscrm.TurboForm.Control.SfaTabs.Components.ActivityFeedsComponent, 'Activity Feeds state is not accessible. Some features may be unavailable');
            return;
        }
        this.$6_0 = new ActivityFeeds.Services.ActivityFeedService();
        ...
        Xrm.Internal.getServiceDirectory().register(ActivityFeeds.Services.IActivityFeedService, this.$6_0);
        Xrm.Internal.getServiceDirectory().register(ActivityFeeds.Services.IFollowService, this.$6_0);
    },
    
    $11_0: function() {
        if (this.$6_0) {
            Xrm.Internal.getServiceDirectory().unregister(ActivityFeeds.Services.IActivityFeedService, this.$6_0);
            Xrm.Internal.getServiceDirectory().unregister(ActivityFeeds.Services.IFollowService, this.$6_0);
            this.$6_0 = null;
        }
    }
}
...
Mscrm.TurboForm.Control.SfaTabs.Components.WallDataPreloader.$b = function() {
    ...
    if (IsNull($v_0) || $v_0.equals(Microsoft.Crm.Client.Core.Framework.Guid.get_empty())) {
        return Mscrm.TurboForm.Control.DefaultFormCache.get_instance().get_item(Mscrm.TurboForm.Control.PageManager.get_instance().get_pageState().entityName);
    }
    return $v_0;
}
Mscrm.TurboForm.Control.SfaTabs.Components.WallDataPreloader.prototype = {
    ...
    get_preloadRequest: function() {
        ...
        if (this.$B_0.equals($v_2)) {
            ...
            Xrm.Tracing.XrmTraceHelper.traceWarning(this, 'discarded preloaded data for {0}: request parameters mismatch', this.$I_0);
            return null;
        }
    },
...
Mscrm.TurboForm.Control.SfaTabs.Components.WallPreloadRequest.prototype = {
    ...
    submit: function() {
        ...
        var $$t_4 = this;
        $v_1.retrievePosts($v_2, function($p1_0) {
    ...
    equals: function(obj) {
        ...
        var $v_0 = obj;
        return Mscrm.TurboForm.Control.SfaTabs.Components.WallPreloadRequest.$a(this.$5_0, $v_0.$5_0) && !IsNull(this.$A_0) && !IsNull($v_0.$A_0) && this.$A_0.equals($v_0.$A_0);
    }
}
...
Mscrm.TurboForm.Control.SfaTabs.ViewModels.SfaTabsViewModel = function(descriptor, container, parentFormUI) {
    Mscrm.TurboForm.Control.SfaTabs.ViewModels.SfaTabsViewModel.initializeBase(this, [ descriptor, container, parentFormUI ]);
}
Mscrm.TurboForm.Control.SfaTabs.ViewModels.SfaTabsViewModel.$$cctor = function() {
    Mscrm.TurboForm.Control.ControlBuilder.get_instance().registerViewModelBuilder(Mscrm.TurboForm.Common.FormControlClassId.notesControl, Mscrm.TurboForm.Control.SfaTabs.ViewModels.SfaTabsViewModel.$T);
}
...
Mscrm.TurboForm.Control.SfaTabs.Views.SfaTabsView.$$cctor = function() {
    ...
    Mscrm.TurboForm.Control.ControlBuilder.get_instance().registerViewBuilder(Mscrm.TurboForm.Common.FormControlClassId.notesControl, Mscrm.TurboForm.Control.SfaTabs.Views.SfaTabsView.buildSfaTabsView);
}
...
Mscrm.TurboForm.Control.SfaTabs.Views.SfaTabsView.$w = function() {
    ...
    Mscrm.TurboForm.Control.SfaTabs.Views.SfaTabsView.$8.loadContent($v_B, 'html', function($p1_0) {
        $P_CRM($p1_0);
        $v_3.resolve($p1_0);
    });
    Mscrm.TurboForm.Control.SfaTabs.Views.SfaTabsView.$8.loadContent($v_C, 'html', function($p1_0) {
        $v_4.resolve($p1_0);
    });
    Mscrm.TurboForm.Control.SfaTabs.Views.SfaTabsView.$8.loadContent($v_D, 'html', function($p1_0) {
        $v_5.resolve($p1_0);
    });
    Mscrm.TurboForm.Control.SfaTabs.Views.SfaTabsView.$8.loadContent($v_E, 'html', function($p1_0) {
        $v_6.resolve($p1_0);
    });
...
Mscrm.TurboForm.Control.SfaTabs.Views.SfaTabsView.$X = function() {
    ...
    Mscrm.TurboForm.Control.CustomScriptsManager.get_instance().addMessageHandler('TurboFormPostOnloadTimestamp', function() {
        $v_0.resolve(null);
    });
    return $v_0.promise();
}
Mscrm.TurboForm.Control.SfaTabs.Views.SfaTabsView.prototype = {
    ...
    $V_3: function() {
        if (this.getKey() === 'header_process_CaseResearch_LinkControl_casesconversations' && typeof(Mscrm.CaseResearchConstants) !== 'undefined') {
            this.$7_3 = true;
        }
        else {
            this.$7_3 = false;
    ...
    $v_3: function() {
        ...
        if (!IsNull($v_0)) {
            ...
            if (window.IS_ACTIONHUB_ENABLED) {
                this.$U_3($v_1);
                var $v_2 = $P_CRM('#containerID');
                var $v_3 = $v_2.parent();
                if ($v_3) {
                    $v_3.attr('style', 'height:auto;');
                }
            }
            this.$z_3($v_1);
        }
        else {
            Xrm.Internal.trace.warningT(Mscrm.TurboForm.Control.SfaTabs.Views.SfaTabsView, 'Could not find SFATabsControl with Key: {0} ', this.getKey());
        }
    },
    
    $z_3: function($p0) {
        var $v_0 = $P_CRM('#header');
        if ($p0 === 'ActivityFeedsTab' || $p0 === 'NotesTab') {
    ...
    $U_3: function($p0) {
        ...
        if ($p0 !== 'ActionHubTab') {
            if (this.$l_3() && !this.$k_3()) {
                var $v_1 = $v_0.parent();
                if ($v_1) {
                    $v_1.attr('style', 'height:auto;');
                }
                var $v_2 = $v_0.children('#iFrmActionCards');
                $v_2.attr('src', 'about:blank');
                $v_0.attr('style', 'display:block;');
            }
        }
        else {
    ...
    $W_3: function() {
        ...
        var $v_1 = $get($v_0);
        if (!this.$7_3) {
            Mscrm.TurboForm.Control.SfaTabs.Components.ActivityFeedsComponent.$1.$0_0.togglePreloadingForCurrentForm(false);
        }
        if ($v_1) {
            ...
            Xrm.Internal.trace.warningT(Mscrm.TurboForm.Control.SfaTabs.Views.SfaTabsView, 'activity feeds element {0} was not found', $v_0);
        }
    },
    ...
    $g_3: function($p0) {
        ...
        if (!this.$7_3) {
            this.$3_3.set_preloadRequest(this.$N_3(Wall.Interfaces.IRetrievePostsResponse, Error, Mscrm.TurboForm.Control.SfaTabs.Components.ActivityFeedsComponent.$1.$0_0.get_preloadRequest()));
            Mscrm.TurboForm.Control.SfaTabs.Components.ActivityFeedsComponent.$1.$0_0.togglePreloadingForCurrentForm(true);
        }
    ...
    $r_3: function() {
        ...
        var $v_1 = $get($v_0);
        if (!this.$7_3) {
            Mscrm.TurboForm.Control.SfaTabs.Components.ActivitiesComponent.$1.$0_0.togglePreloadingForCurrentForm(false);
        }
        if ($v_1) {
            if (!Mscrm.TurboForm.Control.SfaTabs.Views.SfaTabsView.$L($v_1)) {
                this.$f_3($v_1);
            ...
            Xrm.Internal.trace.warningT(Mscrm.TurboForm.Control.SfaTabs.Views.SfaTabsView, 'Activities element {0} was not found', $v_0);
        }
    },
    ...
    $f_3: function($p0) {
        ...
        if (this.$7_3) {
            ...
            if (!$p0.hasChildNodes()) {
                Xrm.Internal.trace.warningT(Mscrm.TurboForm.Control.SfaTabs.Views.SfaTabsView, 'ActivityContainer with ID {0} does not contain child nodes', $p0.id);
                return;
            }
            $v_0 = $p0.lastChild.id;
        }
        if (isNullOrEmptyString($v_0)) {
            Xrm.Internal.trace.warningT(Mscrm.TurboForm.Control.SfaTabs.Views.SfaTabsView, 'ActivitiesWallPageID was not found');
            return;
        }
        this.$9_3 = $find($v_0);
        if (IsNull(this.$9_3)) {
            Xrm.Internal.trace.warningT(Mscrm.TurboForm.Control.SfaTabs.Views.SfaTabsView, 'Activities Control was not found on Page');
            return;
        }
        if (!this.$7_3) {
            this.$9_3.set_preloadRequest(this.$N_3(Wall.Interfaces.IRetrievePostsResponse, Error, Mscrm.TurboForm.Control.SfaTabs.Components.ActivitiesComponent.$1.$0_0.get_preloadRequest()));
            Mscrm.TurboForm.Control.SfaTabs.Components.ActivitiesComponent.$1.$0_0.togglePreloadingForCurrentForm(false);
        }
    ...
    $s_3: function() {
        ...
        if ($v_1) {
            if (!Mscrm.TurboForm.Control.SfaTabs.Views.SfaTabsView.$L($v_1) && !isNullOrEmptyString(getCurrentEntityId())) {
                this.$h_3($v_1);
            }
        }
        else {
            Xrm.Internal.trace.warningT(Mscrm.TurboForm.Control.SfaTabs.Views.SfaTabsView, 'Notes element {0} was not found', $v_0);
        }
    },
    ...
    $h_3: function($p0) {
        this.$2_3 = $find($p0.id);
        if (IsNull(this.$2_3)) {
            Xrm.Internal.trace.warningT(Mscrm.TurboForm.Control.SfaTabs.Views.SfaTabsView, 'Cannot Find Component with Notes ID : {0}', $p0.id);
            return;
        }
        if (!this.$7_3) {
            this.$2_3.set_preloadRequest(this.$N_3(Wall.Interfaces.IRetrievePostsResponse, Error, Mscrm.TurboForm.Control.SfaTabs.Components.NotesComponent.$1.$0_0.get_preloadRequest()));
            Mscrm.TurboForm.Control.SfaTabs.Components.NotesComponent.$1.$0_0.togglePreloadingForCurrentForm(false);
        }
    ...
    $y_3: function() {
        if (IsNull(this.$2_3)) {
            ...
            if ($v_1 && !Mscrm.TurboForm.Control.SfaTabs.Views.SfaTabsView.$L($v_1)) {
                ...
                if (IsNull(this.$2_3)) {
                    Xrm.Internal.trace.warningT(Mscrm.TurboForm.Control.SfaTabs.Views.SfaTabsView, 'Cannot Find Component with Notes ID : {0}', $v_1.id);
                }
            }
        }
    },
    ...
    $o_3: function($p0) {
        ...
        if (($v_0 === 2) || (Xrm.Page.ui.getFormType() === 2)) {
            this.$y_3();
...
Mscrm.TurboForm.Control.SfaTabs.Commands.CreateSFATabControlsCommand.registerClass('Mscrm.TurboForm.Control.SfaTabs.Commands.CreateSFATabControlsCommand', null, Mscrm.TurboForm.Control.SfaTabs.Commands.ICreateSFATabControlsCommand);
Mscrm.TurboForm.Control.SfaTabs.Components.ActivitiesComponent.registerClass('Mscrm.TurboForm.Control.SfaTabs.Components.ActivitiesComponent');
Mscrm.TurboForm.Control.SfaTabs.Components.WallPreloadRequest.registerClass('Mscrm.TurboForm.Control.SfaTabs.Components.WallPreloadRequest');
Mscrm.TurboForm.Control.SfaTabs.Components.ActivitiesPreloadRequest.registerClass('Mscrm.TurboForm.Control.SfaTabs.Components.ActivitiesPreloadRequest', Mscrm.TurboForm.Control.SfaTabs.Components.WallPreloadRequest);
Mscrm.TurboForm.Control.SfaTabs.Components.ActivityFeedsPreloadRequest.registerClass('Mscrm.TurboForm.Control.SfaTabs.Components.ActivityFeedsPreloadRequest', Mscrm.TurboForm.Control.SfaTabs.Components.WallPreloadRequest);
Mscrm.TurboForm.Control.SfaTabs.Components.NotesComponent.registerClass('Mscrm.TurboForm.Control.SfaTabs.Components.NotesComponent');
Mscrm.TurboForm.Control.SfaTabs.Components.NotesPreloadRequest.registerClass('Mscrm.TurboForm.Control.SfaTabs.Components.NotesPreloadRequest', Mscrm.TurboForm.Control.SfaTabs.Components.WallPreloadRequest);
Mscrm.TurboForm.Control.SfaTabs.Components.SfaTabsComponent.registerClass('Mscrm.TurboForm.Control.SfaTabs.Components.SfaTabsComponent');
Mscrm.TurboForm.Control.SfaTabs.Components.ActivityFeedsComponent.registerClass('Mscrm.TurboForm.Control.SfaTabs.Components.ActivityFeedsComponent');
Mscrm.TurboForm.Control.SfaTabs.Components.WallDataPreloader.registerClass('Mscrm.TurboForm.Control.SfaTabs.Components.WallDataPreloader');
Mscrm.TurboForm.Control.SfaTabs.ViewModels.SfaTabsViewModel.registerClass('Mscrm.TurboForm.Control.SfaTabs.ViewModels.SfaTabsViewModel', Mscrm.TurboForm.Control.ViewModel.ControlViewModelBase);
Mscrm.TurboForm.Control.SfaTabs.Views.SfaTabsView.registerClass('Mscrm.TurboForm.Control.SfaTabs.Views.SfaTabsView', Mscrm.TurboForm.Control.View.ControlViewBase);
Mscrm.TurboForm.Control.SfaTabs.Components.ActivitiesComponent.$1 = new Mscrm.TurboForm.Control.SfaTabs.Components.ActivitiesComponent();
Mscrm.TurboForm.Control.SfaTabs.Components.ActivitiesComponent.activityPointerRelationshipNameCacheKey = 'ActivityPointerRelationshipName';
Mscrm.TurboForm.Control.SfaTabs.Components.ActivitiesComponent.isActivityPartyCacheKey = 'IsActivityParty';
Mscrm.TurboForm.Control.SfaTabs.Components.NotesComponent.$1 = new Mscrm.TurboForm.Control.SfaTabs.Components.NotesComponent();
Mscrm.TurboForm.Control.SfaTabs.Components.SfaTabsComponent.$1 = new Mscrm.TurboForm.Control.SfaTabs.Components.SfaTabsComponent();
Mscrm.TurboForm.Control.SfaTabs.Components.SfaTabsComponent.$$cctor();
Mscrm.TurboForm.Control.SfaTabs.Components.ActivityFeedsComponent.$1 = new Mscrm.TurboForm.Control.SfaTabs.Components.ActivityFeedsComponent();
