...
Mscrm.DataSetCancellationTokenSource = function() {
    this.$a_0 = new Mscrm.DataSetCancellationToken(this);
}
...
Mscrm.DataSetColumn.getDataSetLookupFromOutside = function(recordFactory, lookupDefinition, dataProvider, defaultViewId, targetEntityName, bindAttributeName, bindRecordId, cancellationTokenSource) {
    ...
    var $v_1 = function($p1_0) {
        ...
        $v_0.done(function() {
            $p1_0.removeOnDataSetUpdated($v_5);
        });
        $p1_0.addOnDataSetUpdated($v_5);
    };
    Mscrm.DataSetColumn.$37(Mscrm.DataSetControlDataProvider.get_instance(), lookupDefinition, defaultViewId, cancellationTokenSource).done(function($p1_0) {
        var $v_2 = new Mscrm.DataSetLookup(Mscrm.DataSetControlDataProvider.get_instance(), recordFactory, $p1_0);
        $p1_0.set_entityLogicalName(targetEntityName);
        $p1_0.set_entityTypeCode(Xrm.Internal.getEntityCode(targetEntityName));
        $v_2.$10_2 = targetEntityName + 'id';
        $v_2.initialize();
        var $v_3 = $v_2.filtering;
        $v_3.lookupConfiguration = lookupDefinition;
        $v_3.set_$1r_1((!isNullOrEmptyString(bindRecordId)) ? bindRecordId : null);
        $v_2.generateAdditionalAttributes().done(function() {
            $v_0.resolve($v_2);
        });
    }).fail(function($p1_0) {
        var $v_4 = new Mscrm.DataSetLookup(Mscrm.DataSetControlDataProvider.get_instance(), recordFactory, null);
        $v_4.hasError = true;
        $v_4.errorMessage = $p1_0.get_message();
        $v_0.resolve($v_4);
    });
    return $v_0.promise();
}
Mscrm.DataSetColumn.getDataSetObjectFromOutside = function(recordFactory, dataProvider, defaultViewId, targetEntityType, dataSetColumns, cancellationTokenSource) {
    var $v_0 = Microsoft.Crm.Client.Core.Imported.MscrmComponents.deferredPromiseFactory(Mscrm.DataSetObject, Microsoft.Crm.Client.Core.Framework.ErrorStatus);
    Mscrm.DataSetColumn.$35(Mscrm.DataSetControlDataProvider.get_instance(), defaultViewId, cancellationTokenSource).done(function($p1_0) {
        $p1_0.set_entityLogicalName(targetEntityType);
        var $v_1 = new Mscrm.DataSetObject(Mscrm.DataSetControlDataProvider.get_instance(), recordFactory, $p1_0);
        $v_1.columns = dataSetColumns;
        $v_1.set_selectionHelper(new Mscrm.DataSetRecordSelectionHelper($v_1));
        $v_1.initialize();
        $v_0.resolve($v_1);
    }).fail(function($p1_0) {
        var $v_2 = new Mscrm.DataSetObject(Mscrm.DataSetControlDataProvider.get_instance(), recordFactory, null);
        $v_2.hasError = true;
        $v_2.errorMessage = $p1_0.get_message();
        $v_0.resolve($v_2);
    });
    return $v_0.promise();
}
...
Mscrm.DataSetColumn.$37 = function($p0, $p1, $p2, $p3) {
    ...
    if (!IsNull($p1) && !Microsoft.Crm.Client.Core.Framework._String.isNullOrEmpty($p1.fetchXml) && !Microsoft.Crm.Client.Core.Framework._String.isNullOrEmpty($p1.layoutXml)) {
        ...
        var $v_2 = String.format(Mscrm.DataSetLookup.fetchXmlForLookup, $p2);
        $p0.retrieveMultiple($v_2, $p3.$a_0).done(function($p1_0) {
            var $v_3 = $p1_0;
...
Mscrm.DataSetColumn.$35 = function($p0, $p1, $p2) {
    var $v_0 = Microsoft.Crm.Client.Core.Imported.MscrmComponents.deferredPromiseFactory(Mscrm.IDataSetObjectInputs, Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.Responses.CrmErrorResponse);
    var $v_1 = new Mscrm.DataSetObjectInputs();
    $v_1.set_isFetchXmlNotFinal(false);
    var $v_2 = String.format(Mscrm.DataSetLookup.fetchXmlForLookup, $p1);
    $p0.retrieveMultiple($v_2, $p2.$a_0).done(function($p1_0) {
        var $v_3 = $p1_0;
        if (!IsNull($v_3) && !IsNull($v_3.entityCollection) && !IsNull($v_3.entityCollection.get_entities())) {
            var $v_4 = $v_3.entityCollection.get_entities()[0];
            $v_1.set_fetchXml($v_4.get_fields()['fetchxml']);
...
Mscrm.DataSetColumn.prototype = {
    ...
    updateAttributes: function(metadata) {
        ...
        this.$1V_0 = Microsoft.Crm.Client.Core.Framework.CustomControlUtils.extractUnformattedAttributeData($v_4, this.attributes);
    ...
    getDataSetLookup: function(recordFactory, selectedRecord, lookupDefinition) {
        var $v_0 = Microsoft.Crm.Client.Core.Imported.MscrmComponents.deferredPromiseFactory(Mscrm.DataSetLookup, Microsoft.Crm.Client.Core.Framework.ErrorStatus);
        if (this.$x_0 !== 6 || _Script.isNullOrUndefined(this.attributes) || !(('targets') in this.attributes)) {
            ...
            if (!_Script.isNullOrUndefined(this.$v_0)) {
                var $v_2 = this.$v_0;
                $v_2.reset();
                var $v_3 = $v_2.filtering;
                $v_3.set_$1r_1((!_Script.isNullOrUndefined(selectedRecord)) ? selectedRecord.getRecordId() : null);
                ...
                this.$36_0(Mscrm.DataSetControlDataProvider.get_instance(), lookupDefinition, $v_6).done(function($p1_0) {
                    ...
                    $v_8.set_$1r_1((!_Script.isNullOrUndefined(selectedRecord)) ? selectedRecord.getRecordId() : null);
    ...
    $36_0: function($p0, $p1, $p2) {
        ...
        if (!IsNull($p1) && !Microsoft.Crm.Client.Core.Framework._String.isNullOrEmpty($p1.fetchXml) && !Microsoft.Crm.Client.Core.Framework._String.isNullOrEmpty($p1.layoutXml)) {
            ...
            $p0.retrieveMultiple($v_2, this.$Q_0.$a_0).done(function($p1_0) {
                var $v_3 = $p1_0;
                if (!IsNull($v_3) && !IsNull($v_3.entityCollection) && !IsNull($v_3.entityCollection.get_entities())) {
                    var $v_4 = $v_3.entityCollection.get_entities()[0];
                    $v_1.set_fetchXml($v_4.get_fields()['fetchxml']);
...
Mscrm.DataSetColumnValidator.prototype = {
    ...
    validate: function(value, isValueChanging, isDisabled) {
        return new Mscrm.DataSetColumnValidatorResult(this.$1X_0.validate(value, isValueChanging, isDisabled));
    },
...
Mscrm.DataSetControl = function(element) {
    this.$$d_$2w_3 = Function.createDelegate(this, this.$2w_3);
    ...
    this.$X_3 = this.get_id().replace(Mscrm.DataSetControl.datasetctrL_PREFIX, '');
    this.$3_3 = Mscrm.GridControl.findComponent(this.$X_3);
    this.$14_3 = $get(this.$X_3);
    this.$D_3 = new Mscrm.DataSetObjectInputs(this.$3_3);
    this.$1w_3(false);
    this.$1N_3 = false;
    this.get_element().style.height = '100%';
    this.get_element().className += ' ms-crm-ListControl-Editable';
    this.$b_3 = Microsoft.Crm.Client.Core.Framework.Guid.get_empty();
    var $v_0 = this.get_element().attributes.getNamedItem('type');
    if ($v_0) {
        this.$I_3 = $v_0.value;
    }
    this.$3_3.add_onResetComplete(this.$$d_$2I_3);
    this.$3_3.add_onRefresh(this.$$d_$2v_3);
    if (Mscrm.InternalUtilities._String.isNullOrWhiteSpace(this.$D_3.get_fetchXml())) {
        this.$1J_3 = true;
    }
    if (!Mscrm.InternalUtilities._Script.isNullOrUndefined(this.get_$w_3())) {
        this.get_$w_3().addTabStateChange(this.$$d_$2y_3);
    }
}
...
Mscrm.DataSetControl.$2E = function($p0) {
    var $v_0 = $P_CRM($p0.frameElement);
    return !$v_0.length || (Mscrm.DataSetControl.$2E($p0.parent) && $v_0.is(':visible') && $v_0.css('visibility') === 'visible');
}
Mscrm.DataSetControl.prototype = {
    ...
    get_controlManifest: function() {
        return this.$W_3;
    },
    
    set_controlManifest: function(value) {
        this.$W_3 = value;
        return value;
    },
    ...
    get_$2q_3: function() {
        return (!Mscrm.InternalUtilities._Script.isNullOrUndefined(this.get_$w_3())) ? this.get_$w_3().getDisplayState() === 'expanded' : true;
    },
    ...
    get_addContextualButton: function() {
        var $v_0 = this.$X_3 + '_addImageButton';
        return $get($v_0);
    },
    ...
    isConfigurationSame: function(configurationId) {
        return this.$b_3.equals(new Microsoft.Crm.Client.Core.Framework.Guid(configurationId));
    },
    ...
    changeVisualizationTo: function(id, parameters, constructor, stylesToLoad, scriptsToLoad, configurationIdString) {
        ...
        if (!this.$b_3.equals($v_0)) {
            if (new Microsoft.Crm.Client.Core.Framework.Guid(id).equals(Mscrm.TurboForm.Common.FormControlClassId.gridControl)) {
                ...
                if (this.$I_3 !== constructor) {
                    this.$31_3(parameters, constructor, stylesToLoad, scriptsToLoad);
                }
                else {
                    this.$n_3 = new Mscrm.DataSetControlDefinitions(parameters);
                    this.$1T_3();
                }
                this.$b_3 = $v_0;
            }
    ...
    $1F_3: function($p0) {
        ...
        $v_0 = $v_0 && !this.$c_3;
        $v_0 = $v_0 && !this.$1J_3;
        $v_0 = $v_0 && (this.$3_3.get_gridType() === Mscrm.GridControl.hompageGrid || !this.$1o_3() || this.$2i_3());
        if ($v_0) {
            this.$2k_3($p0);
        }
    },
    ...
    $2k_3: function($p0) {
        if (!isNullOrEmptyString(this.$I_3)) {
            if (!$p0) {
                var $$t_3, $$t_4;
                (($$t_4 = Mscrm.JsonUtilities.tryGetParsedJson(eval(String.format('window.DataSetDefinitions{0}', this.get_id())), ($$t_3 = {'val': $p0}))), $p0 = $$t_3.val, $$t_4);
                if (Mscrm.InternalUtilities.JSTypes.isNull($p0)) {
                    throw Error.argumentNull('dataSetDefinitions');
                }
            }
            this.$n_3 = new Mscrm.DataSetControlDefinitions($p0);
            if (!this.$W_3 && !this.$1o_3()) {
                var $v_0;
                var $$t_5, $$t_6;
                (($$t_6 = Mscrm.JsonUtilities.tryGetParsedJson(eval(String.format('window.Manifest{0}', this.get_id())), ($$t_5 = {'val': $v_0}))), $v_0 = $$t_5.val, $$t_6);
                this.$W_3 = $v_0;
                if (!this.$W_3) {
                    var $v_1 = new Mscrm.UnifiedClient.Metadata.Descriptors.ICustomControlManifest();
                    $v_1.Name = this.$I_3;
                    $v_1.IsVirtual = eval(String.format('window.ControlIsVirtual{0}', this.get_id()));
                    $v_1.Properties = new Mscrm.UnifiedClient.Metadata.Descriptors.ICustomControlManifestProperties();
                    $v_1.Properties.Resources = new Array(0);
                    this.$W_3 = $v_1;
                }
            }
            this.$1T_3();
    ...
    $32_3: function() {
        ...
        try {
            $v_0 = $v_2.buildDataSetControl(this.get_element(), this.$X_3, this.$I_3, this.$n_3, this.$D_3, this.$1k_3(), this.$1o_3(), this.$W_3);
        }
        catch ($v_3) {
        ...
        $v_0.done(function($p1_0) {
            try {
                $$t_7.$2_3 = $p1_0;
                $$t_7.$2_3.add_onSelectionChanged($$t_7.$$d_$2J_3);
                $$t_7.$2_3.init();
                $v_1.resolve(true);
            }
            catch ($v_4) {
    ...
    $2i_3: function() {
        try {
            if (!Mscrm.InternalUtilities._Script.isNullOrUndefined(eval(this.$I_3))) {
                return true;
            }
            return false;
        }
    ...
    $1w_3: function($p0) {
        ...
        if (this.$3_3.get_gridType() === Mscrm.GridControl.hompageGrid) {
            ...
            Sys.UI.DomElement.setVisible(this.$14_3, $p0);
        }
        if ($p0) {
            this.$3_3.Refresh();
        }
    ...
    $1o_3: function() {
        return this.$I_3 === 'MscrmControls.Grid.GridControl';
    },
    ...
    $1k_3: function() {
        return this.get_$2q_3() && this.getVisible();
    },
    ...
    initialize: function() {
        ...
        this.$1F_3(null);
        if (!this.$c_3) {
            $addHandler(window, 'load', this.$$d_$2w_3);
        }
    },
    ...
    dispose: function() {
        ...
        if (!this.$3_3.get_isDisposed()) {
            if (this.$3_3.get_gridType() !== Mscrm.GridControl.hompageGrid) {
                $removeHandler(window, 'load', this.$$d_$2w_3);
            }
            this.$3_3.remove_onResetComplete(this.$$d_$2I_3);
            this.$3_3.remove_onRefresh(this.$$d_$2v_3);
        }
        if (!Mscrm.InternalUtilities._Script.isNullOrUndefined(this.get_$w_3())) {
            this.get_$w_3().removeTabStateChange(this.$$d_$2y_3);
        }
    ...
    $24_3: function() {
        if (!IsNull(this.$2_3)) {
            this.$2_3.remove_onSelectionChanged(this.$$d_$2J_3);
            this.$2_3.dispose();
        }
    },
    ...
    handleEvent: function(eventCode, parameters, sourceComponent) {
        switch (eventCode) {
            ...
            case 87:
            case 9:
                if (!IsNull(this.$2_3) && this.getVisible() && (!this.$1N_3 || eventCode === 87)) {
                    this.$1N_3 = true;
                    this.$1U_3();
                }
                this.$1m_3();
    ...
    getVisible: function() {
        var $v_0 = Mscrm.DataSetControl.$2E(window.self) && $P_CRM(this.get_element()).is(':visible');
        return $v_0;
    },
    ...
    refreshRibbon: function() {
        this.$3_3.refreshRibbon();
    },
    
    addCustomFilter: function(fetchXmlFilter) {
        this.$3_3.addCustomFilter(fetchXmlFilter);
    },
    
    getGridType: function() {
        return this.$3_3.getGridType();
    },
    
    getUrl: function() {
        return this.$3_3.getUrl();
    }
}
    ...
    for (var $$arr_5 = $v_2, $$len_6 = $$arr_5.length, $$idx_7 = 0; $$idx_7 < $$len_6; ++$$idx_7) {
        ...
        switch ($v_3) {
            ...
            case 'parentPicklistLogicalName':
                $v_0['parentPicklistLogicalName'] = metadata.get_parentPicklistLogicalName();
                break;
            case 'childPicklistLogicalNames':
                $v_0['childPicklistLogicalNames'] = metadata.get_childPicklistLogicalNames();
                break;
        }
    }
    return $v_0;
...
Mscrm.DataSetControlAttributeHelper.addGlobalAssociatedAttributes = function(attributes, userContext) {
    ...
    if ($v_0 === 'integer') {
        if ($v_1 === 'timezone') {
            attributes['timezonebycode'] = Mscrm.DataSetControlAttributeHelper.$2b(userContext);
        }
...
Mscrm.DataSetControlAttributeHelper.$2b = function($p0) {
...
Mscrm.DataSetControlClientInfo = function(maxAvailableWidth, viewportHeight) {
    ...
    this.formatInfoCultureName = Microsoft.Crm.Client.Core.Storage.DataApi.DataSource.get_defaultInstance().get_userContext().get_UserSettings().get_formatInfoCultureName();
    this.allocatedWidth = maxAvailableWidth;
    this.allocatedHeight = viewportHeight;
...
Mscrm.DataSetControlClientInfo.prototype = {
    ...
    get_formatInfoCultureName: function() {
        return this.formatInfoCultureName;
    },
    
    set_formatInfoCultureName: function(value) {
        this.formatInfoCultureName = value;
        return value;
    },
    
    get_allocatedWidth: function() {
        return this.allocatedWidth;
    },
    
    set_allocatedWidth: function(value) {
        this.allocatedWidth = value;
        return value;
    },
    
    get_allocatedHeight: function() {
        return this.allocatedHeight;
    },
    
    set_allocatedHeight: function(value) {
        this.allocatedHeight = value;
        return value;
    },
    ...
    adjustDataAreaHeight: function(controlName, currentHeight, rowHeight, nonDataHeight) {
        ...
        var $v_2 = 24;
        try {
            var $v_3 = $find(controlName);
            if (IsNull($v_3) || IsNull($v_3.$3_3)) {
                return currentHeight;
            }
            if ($v_3.get_gridType() === Mscrm.GridControl.inlineSubGrid && $v_3.$3_3.isLiteSubGrid()) {
                var $v_4 = $v_3.$3_3.GetGridSpan();
                if (IsNull($v_4)) {
                    return currentHeight;
                }
                var $v_5 = Number.parseInvariant($v_3.$3_3.GetProperty('recsPerPage'));
                if (isNaN($v_5)) {
                    return currentHeight;
                }
                var $v_6 = 0;
                var $v_7 = $v_4.querySelector('.ms-crm-Form-SubGrid-Layout-Lite');
                var $v_8 = this.$1l_0($v_3.get_element(), 2);
                if (!IsNull($v_8)) {
                    var $v_A = $v_8.style.display;
                    $v_8.style.display = '';
                    var $v_B = this.$1l_0($v_3.get_element(), 1);
                    if (!IsNull($v_B)) {
                        var $v_C = $v_B.style.display;
                        $v_B.style.display = 'inline-block';
                        var $v_D = this.$1l_0($v_3.get_element(), 0);
                        if (!IsNull($v_D)) {
                            var $v_E = $v_D.style.display;
                            $v_D.style.display = '';
                            $v_6 = $v_7.offsetHeight;
                            $v_D.style.display = $v_E;
                        }
                        $v_B.style.display = $v_C;
                    }
                    $v_8.style.display = $v_A;
                }
                var $v_9 = ($v_5 + 1) * rowHeight + $v_0 + $v_1;
                $v_3.get_element().style.height = String.format('{0}px', $v_9);
                $v_4.parentNode.style.height = String.format('{0}px', $v_9 + nonDataHeight + $v_6);
                this.allocatedHeight = $v_9 + nonDataHeight;
                return $v_9;
            }
        }
        catch ($$e_J) {
...
Mscrm.DataSetControlDataProvider = function($p0) {
    this.$18_0 = {};
    this.$1P_0 = $p0.get_metadataCache();
    this.$1W_0 = new Microsoft.Crm.Client.Core.Storage.DataApi.UserPrivileges($p0.get_userContext());
}
Mscrm.DataSetControlDataProvider.get_instance = function() {
    if (_Script.isNullOrUndefined(Mscrm.DataSetControlDataProvider.$1K)) {
        Mscrm.DataSetControlDataProvider.$1K = new Mscrm.DataSetControlDataProvider(Microsoft.Crm.Client.Core.Storage.DataApi.DataSource.get_defaultInstance());
    }
    return Mscrm.DataSetControlDataProvider.$1K;
}
Mscrm.DataSetControlDataProvider.prototype = {
    ...
    retrieveMultiple: function(fetchXml, cancellationToken) {
        return this.$3H_0(Xrm.Sdk.Response, Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.Responses.CrmErrorResponse, Xrm.Internal.messages.retrieveMultiple(fetchXml), cancellationToken);
    },
    ...
    retrieveEntityMetadata: function(entityLogicalName) {
        ...
        if (!_Script.isNullOrUndefined(this.$18_0[entityLogicalName])) {
            return this.$18_0[entityLogicalName];
        }
        this.$18_0[entityLogicalName] = $v_0.promise();
        ...
        Xrm.Internal.messages.retrieveEntityMetadata(entityLogicalName, Xrm.Page.context.getUserLcid()).done(function($p1_0) {
            ...
            if (!_Script.isNullOrUndefined($p1_0.get_entityMetadataCollection()) && $p1_0.get_entityMetadataCollection().get_count() > 0) {
                ...
                $$t_7.$1P_0.cacheEntityMetadata($v_3);
                $$t_7.$1P_0.cacheAttributeMetadata(entityLogicalName, $v_2.get_allAttributes(), new (Microsoft.Crm.Client.Core.Framework.CallbackSafeArray$1.$$(Microsoft.Crm.Client.Core.Storage.Common.IAttributeMetadata))($v_2.get_attributes()));
...
Mscrm.DataSetControlFactory.prototype = {
    ...
    buildDataSetControl: function(container, controlName, constructorName, dataSetDefinitions, primaryDataSetInputs, isActive, isEditableGridControl, controlManifest) {
        ...
        this.$2V_0(isEditableGridControl).done(function() {
            ...
            $v_2.set_propertyBag($$t_C.$2X_0(container, controlName, constructorName, dataSetDefinitions, primaryDataSetInputs, isActive, isEditableGridControl));
            if (isEditableGridControl) {
                $v_2.set_controlInstance(eval('new ' + constructorName + '()'));
            }
            else {
                $v_2.set_controlInstance(new Mscrm.WebCustom.Control.View.DataSetControlInstanceAdapter(container, controlManifest));
            }
            $v_0.resolve($v_2);
        }).fail(function($p1_0) {
    ...
    $2X_0: function($p0, $p1, $p2, $p3, $p4, $p5, $p6) {
        ...
        this.$2W_0($v_0, $p3, $p1, $p4, $p6);
        return $v_0;
    },
    
    $2W_0: function($p0, $p1, $p2, $p3, $p4) {
        for (var $$arr_5 = $p1.DataSetDefinitions.get_keys(), $$len_6 = $$arr_5.length, $$idx_7 = 0; $$idx_7 < $$len_6; ++$$idx_7) {
            var $v_0 = $$arr_5[$$idx_7];
            if ($v_0 !== 'Grid' && $p4) {
                continue;
            }
            ...
            $v_3.$1C_0 = $v_1.Lookups;
            $v_3.$7_0 = this.$2U_0($p2, $v_3, $p3);
            $p0.addDataSetParameter($v_0, $v_3.$7_0);
        }
        for (var $$arr_E = $p1.PropertyDefinitions.get_keys(), $$len_F = $$arr_E.length, $$idx_G = 0; $$idx_G < $$len_F; ++$$idx_G) {
            var $v_6 = $$arr_E[$$idx_G];
    ...
    $2U_0: function($p0, $p1, $p2) {
        var $v_0 = new Array(0);
        if (!IsNull($p1.$J_0)) {
            for (var $v_2 = 0; $v_2 < $p1.$J_0.length; $v_2++) {
                var $v_3 = $p1.$J_0[$v_2];
        ...
        $v_1.set_columns($v_0);
        $v_1.set_lookups(this.$2T_0($p2.get_entityLogicalName(), $p1.$1C_0));
        $v_1.set_selectionHelper(new Mscrm.DataSetRecordSelectionHelper($v_1));
        $v_1.initialize();
        return $v_1;
    },
    ...
    $2V_0: function($p0) {
        ...
        $v_0.LOCID_VALIDATION_ERROR_MSOS_MAX = window.LOCID_VALIDATION_ERROR_MSOS_MAX;
        $v_0.MaxSelectionsAllowed = window.MaxSelectionsAllowed;
        if ($p0) {
            return Microsoft.Crm.Client.Core.Storage.DataApi.DataSource.initialize();
        }
        var $v_1 = Microsoft.Crm.Client.Core.Imported.MscrmComponents.deferredPromiseFactory(Boolean, Microsoft.Crm.Client.Core.Framework.ErrorStatus);
        $v_1.resolve(true);
        return $v_1.promise();
    }
}
...
Mscrm.DataSetControlFormatting = function() {
    this.timeZoneUtcOffsetMinutes = Microsoft.Crm.Client.Core.Storage.DataApi.DataSource.get_defaultInstance().get_userContext().get_timeZoneUtcOffsetMinutes();
    this.timeZoneAdjusters = Microsoft.Crm.Client.Core.Storage.DataApi.DataSource.get_defaultInstance().get_userContext().get_timeZoneAdjusters();
}
Mscrm.DataSetControlFormatting.prototype = {
    timeZoneUtcOffsetMinutes: 0,
    timeZoneAdjusters: null,
    
    get_timeZoneUtcOffsetMinutes: function() {
        return this.timeZoneUtcOffsetMinutes;
    },
    
    set_timeZoneUtcOffsetMinutes: function(value) {
        this.timeZoneUtcOffsetMinutes = value;
        return value;
    },
    
    get_timeZoneAdjusters: function() {
        return this.timeZoneAdjusters;
    },
    
    set_timeZoneAdjusters: function(value) {
        this.timeZoneAdjusters = value;
        return value;
    },
    ...
    formatDateLongAbbreviated: function(value) {
        return Microsoft.Crm.Client.Core.Storage.Common.CrmFormatter.get_instance().formatDateLongAbbreviated(value, 0);
    },
    
    formatDateYearMonth: function(value) {
        return Microsoft.Crm.Client.Core.Storage.Common.CrmFormatter.get_instance().formatDateYearMonthValue(value, 0);
    },
    ...
    formatSortableDateValue: function(value, behavior) {
        return Microsoft.Crm.Client.Core.Storage.Common.CrmFormatter.get_instance().formatSortableDateValue(value, behavior);
    },
    
    formatSortableDateTimeValue: function(input, behavior) {
        return Microsoft.Crm.Client.Core.Storage.Common.CrmFormatter.get_instance().formatSortableDateTimeValue(input, behavior);
    }
}
...
Mscrm.DataSetControlHost.prototype = {
    ...
    get_primaryDataSet: function() {
        return (!_Script.isNullOrUndefined(this.$B_1)) ? this.$B_1.get_primaryDataSet() : null;
    },
    ...
    set_propertyBag: function(value) {
        this.$B_1 = value;
        this.$B_1.add_onPropertyBagChanged(this.$$d_update);
        this.$B_1.add_onSelectionChanged(this.$$d_$2G_1);
        return value;
    },
    ...
    init: function() {
        var $v_0 = new Mscrm.Performance.PerformanceStopwatch('DataSetControl.DataSetControlHost.Init ' + this.$d_1.id);
        $v_0.start();
        this.$B_1.get_updatedProperties().push('activation');
        try {
            this.$Y_1.init(this.$B_1, this.$$d_$2t_1, this.$13_1, this.$d_1);
        }
        catch ($v_1) {
            this.$1O_1('Init', $v_1);
        }
    ...
    update: function() {
        var $v_0 = new Mscrm.Performance.PerformanceStopwatch('DataSetControl.DataSetControlHost.Update ' + this.$d_1.id);
        $v_0.start();
        try {
            this.$Y_1.updateView(this.$B_1);
        }
        catch ($v_1) {
            this.$1O_1('Update', $v_1);
        }
        this.$B_1.clearUpdatedProperties();
        $v_0.stop();
    },
    
    activate: function(width, height) {
        this.$B_1.activate(width, height);
    },
    ...
    isActive: function() {
        return this.$B_1.get_mode().get_isActive();
    },
    
    resize: function(width, height) {
        this.$B_1.resize(width, height);
    },
    ...
    dispose: function() {
        try {
            ...
            this.$1O_1('Destroy', $v_0);
        }
        this.$B_1.remove_onPropertyBagChanged(this.$$d_update);
        this.$B_1.remove_onSelectionChanged(this.$$d_$2G_1);
        this.$B_1.dispose();
    ...
    $2t_1: function() {
        var $v_0 = null;
        try {
            $v_0 = this.$Y_1.getOutputs();
        }
        catch ($v_1) {
            this.$1O_1('GetOutputs', $v_1);
        }
        if (!_Script.isNullOrUndefined($v_0)) {
            this.$B_1.updateLinkedOutputs($v_0);
        }
    },
    ...
    $1O_1: function($p0, $p1) {
        ...
        var $v_1 = String.format('Control id={0} type={1} threw an exception on {2}(): {3}', this.$d_1.id, this.$d_1.getAttribute('type'), $p0, $v_0);
...
Mscrm.DataSetControlNavigationUtilities.prototype = {
    ...
    openForm: function(formOptions, formParameters) {
        Xrm.Navigation.openForm(formOptions, formParameters);
    },
    
    openGridPage: function(entityTypeName) {
        throw Error.notImplemented('OpenGridPage');
    },
...
Mscrm.DataSetControlPropertyBag = function() {
    this.$$d_$2G_1 = Function.createDelegate(this, this.$2G_1);
    this.$$d_$2H_1 = Function.createDelegate(this, this.$2H_1);
...
Mscrm.DataSetControlPropertyBag.prototype = {
    ...
    addDataSetParameter: function(parameterKey, dataSetObject) {
        ...
        dataSetObject.addOnDataSetUpdated(this.$$d_$2H_1);
        dataSetObject.addOnSelectionChange(this.$$d_$2G_1);
    },
    ...
    resize: function(width, height) {
        var $v_0 = this.$2R_1(width, height);
        if ($v_0) {
    ...
    dispose: function() {
        ...
        for (var $$key_3 in $$dict_2) {
            ...
            if (Mscrm.IDataSetObject.isInstanceOfType($v_0.value)) {
                var $v_1 = $v_0.value;
                $v_1.removeOnDataSetUpdated(this.$$d_$2H_1);
                $v_1.removeOnSelectionChange(this.$$d_$2G_1);
                $v_1.dispose();
            }
        }
    },
    ...
    $2R_1: function($p0, $p1) {
        var $v_0 = this.client.get_allocatedWidth() !== $p0 || this.client.get_allocatedHeight() !== $p1;
        if ($v_0) {
            this.client.set_allocatedWidth($p0);
            this.client.set_allocatedHeight($p1);
...
Mscrm.DataSetControlTheming = function() {
    ...
    this.panelheaderbackgroundcolor = '#E0E0E0';
    this.pageheaderbackgroundcolor = '#F3F3F3';
...
Mscrm.DataSetControlTheming.prototype = {
    ...
    fontcolor: null,
    fontsize: null,
    panelheaderbackgroundcolor: null,
    ...
    get_panelHeaderBackgroundColor: function() {
        return this.panelheaderbackgroundcolor;
    },
    
    set_panelHeaderBackgroundColor: function(value) {
        this.panelheaderbackgroundcolor = value;
        return value;
    },
    ...
    set_mainColor: function(value) {
        this.maincolor = value;
        return value;
    },
    
    get_accentColor: function() {
        return this.accentcolor;
    },
    
    set_accentColor: function(value) {
        this.accentcolor = value;
        return value;
    },
    
    get_pageHeaderBackgroundColor: function() {
        return this.pageheaderbackgroundcolor;
    },
    
    set_pageHeaderBackgroundColor: function(value) {
        this.pageheaderbackgroundcolor = value;
        return value;
    },
...
Mscrm.DataSetControlUtilities = function(constructorName, viewId) {
    this.$I_0 = constructorName;
    this.$1b_0 = viewId;
}
Mscrm.DataSetControlUtilities.getState = function(constructorName, viewId) {
    var $v_0 = Xrm.Internal.getLocalStorageItem(Mscrm.DataSetControlUtilities.$2C(constructorName, viewId));
    return (_Script.isNullOrUndefined($v_0)) ? {} : Sys.Serialization.JavaScriptSerializer.deserialize($v_0);
}
Mscrm.DataSetControlUtilities.$2C = function($p0, $p1) {
...
Mscrm.DataSetControlUtilities.prototype = {
    ...
    setState: function(state) {
        Xrm.Internal.setLocalStorageItem(Mscrm.DataSetControlUtilities.$2C(this.$I_0, this.$1b_0), Sys.Serialization.JavaScriptSerializer.serialize(state));
        return true;
    },
    ...
    isFeatureEnabled: function(featureName) {
        var $v_0 = featureName;
        if (!featureName.startsWith('FCB.')) {
            $v_0 = 'FCB.' + featureName;
        }
        return Mscrm.FeatureControl.get_Current().isFeatureEnabled($v_0);
    }
}


Mscrm.DataSetDefinition = function(name, viewId, columns, contextFilter, relationshipExtraCondition, relationshipType, enableViewPicker, filteredViewIds, relationshipName, referencingName) {
    this.$2P_0 = -1;
    this.$1e_0 = name;
    this.$20_0 = viewId;
    this.$J_0 = columns;
    this.$22_0 = contextFilter;
    this.$2N_0 = relationshipExtraCondition;
    this.$1f_0 = enableViewPicker;
    this.$1h_0 = filteredViewIds;
    this.$2P_0 = relationshipType;
    this.$2O_0 = relationshipName;
    this.$2M_0 = referencingName;
}
Mscrm.DataSetDefinition.prototype = {
    ...
    set_dataSetObject: function(value) {
        this.$7_0 = value;
        return value;
    },
    ...
    add_onDataSetUpdated: function(value) {
        if (!_Script.isNullOrUndefined(this.$7_0)) {
            this.$7_0.addOnDataSetUpdated(value);
        }
    },
    
    remove_onDataSetUpdated: function(value) {
        if (!_Script.isNullOrUndefined(this.$7_0)) {
            this.$7_0.removeOnDataSetUpdated(value);
        }
    },
...
Mscrm.DataSetFetchXmlHelper.refreshFetchXmlSorting = function(fetchXmlDocument, sortingInfo, entityLogicalName) {
    if (!_Script.isNullOrUndefined(sortingInfo)) {
        Mscrm.DataSetFetchXmlHelper.$2Y(fetchXmlDocument);
        Mscrm.DataSetFetchXmlHelper.$23(fetchXmlDocument, entityLogicalName, sortingInfo.get_SortByField(), sortingInfo.get_SortDescending());
        Mscrm.DataSetFetchXmlHelper.$23(fetchXmlDocument, entityLogicalName, sortingInfo.get_SecondarySortByField(), sortingInfo.get_SecondarySortDescending());
    }
}
        ...
        if (!_Script.isNullOrUndefined($v_1)) {
            for (var $v_2 = 0; $v_2 < rollupDateColumnNames.get_Count(); $v_2++) {
                ...
                if (_Script.isNullOrUndefined($v_7)) {
                    Mscrm.DataSetFetchXmlHelper.$2Z(fetchXmlDocument, $v_5, $v_3);
                }
            }
        }
    }
}
Mscrm.DataSetFetchXmlHelper.$2Y = function($p0) {
...
Mscrm.DataSetFetchXmlHelper.$23 = function($p0, $p1, $p2, $p3) {
    var $v_0 = null;
...
Mscrm.DataSetFetchXmlHelper.$2Z = function($p0, $p1, $p2) {
    if (!Microsoft.Crm.Client.Core.Framework._String.isNullOrEmpty($p2)) {
...
Mscrm.DataSetFetchXmlHelper.addColumn = function(fetchDocument, entityLogicalName, columnName) {
    entityLogicalName = entityLogicalName.toLowerCase();
    Mscrm.DataSetFetchXmlHelper.$1c(fetchDocument, entityLogicalName, columnName);
    return XUI.Xml.XMLSerializer.serializeToString(fetchDocument);
}
Mscrm.DataSetFetchXmlHelper.addInternalColumns = function(fetchXml, entityLogicalName) {
    ...
    var $v_2 = eval($v_1);
    if ($v_2) {
        Mscrm.DataSetFetchXmlHelper.$1c($v_0, entityLogicalName, 'statecode');
    }
    if (entityLogicalName === 'systemuser') {
        Mscrm.DataSetFetchXmlHelper.$1c($v_0, entityLogicalName, 'isdisabled');
    }
    return XUI.Xml.XMLSerializer.serializeToString($v_0);
}
Mscrm.DataSetFetchXmlHelper.$1c = function($p0, $p1, $p2) {
...
Mscrm.DataSetFieldAccessHelper.prototype = {
    ...
    getColumnAttributes: function(column) {
        ...
        this.$1t_1().done(function() {
            $v_2.stop();
            $v_1.updateAttributes($$t_5.$o_1.get_attributesByName().get_item(column.get_name()));
    ...
    isRecordDisabled: function() {
        ...
        var $v_1 = this.$N_1.get_fields()['statecode'];
        if (!Microsoft.Crm.Client.Core.Models.StateCodeHelper.canRetrieveActivationState(this.$N_1)) {
            $v_0.resolve(false);
        }
        else {
            $v_0.resolve(Microsoft.Crm.Client.Core.Models.StateCodeHelper.isRecordDisabled(this.$N_1, $v_1, this.$G_1.get_userPrivileges().get_rolePrivileges()));
        }
        return $v_0.promise();
    },
    ...
    getFieldAccessLevelsForOperation: function(fieldName, operationType) {
        ...
        this.$1s_1().done(function() {
            $v_1.stop();
            $$t_6.$G_1.get_userPrivileges().getFieldAccessLevelsForOperation($$t_6.$N_1, fieldName, operationType, $$t_6.$o_1).done(function($p2_0) {
                $v_0.resolve($p2_0);
            }).fail(function($p2_0) {
                $v_0.reject($p2_0);
            });
    ...
    internalGetFieldRequiredLevel: function(fieldName) {
        ...
        this.$1t_1().done(function() {
            $v_0.resolve($$t_3.$o_1.get_attributesByName().get_item(fieldName).get_requiredLevel());
        }).fail(function($p1_0) {
            $v_0.reject(Microsoft.Crm.Client.Core.Framework.ErrorStatus.fromMessage($p1_0.get_localizedMessage() || $p1_0.get_message()));
        });
        return $v_0.promise();
    ...
    isOperationEnabledOnModel: function(operationType) {
        ...
        this.$1s_1().done(function() {
            var $v_1 = $$t_4.$G_1.get_userPrivileges().isOperationEnabledOnModel($$t_4.$N_1.get_actionableIdentifier().LogicalName, $$t_4.$N_1, 2, $$t_4.$q_1, $$t_4.$1q_1);
            $v_0.resolve($v_1);
        }).fail(function($p1_0) {
            $v_0.reject($p1_0);
        });
    ...
    $39_1: function() {
        if (!_Script.isNullOrUndefined(this.$i_1)) {
            return this.$i_1;
        }
        this.$i_1 = Microsoft.Crm.Client.Core.Imported.MscrmComponents.deferredPromiseFactory(Boolean, Microsoft.Crm.Client.Core.Framework.ErrorStatus);
        var $$t_2 = this, $$t_3 = this;
        this.$G_1.retrieveRecordRelatedEntities(this.$q_1, 'RetrieveRecordRelatedEntities', this.$N_1.get_actionableIdentifier(), this.$N_1.get_directColumnSet(), this.$N_1).done(function($p1_0) {
            $$t_2.$i_1.resolve(true);
        }).fail(function($p1_0) {
            $$t_3.$i_1.reject($p1_0);
        });
        return this.$i_1.promise();
    },
    ...
    $1t_1: function() {
        ...
        var $$t_4 = this, $$t_5 = this;
        this.$G_1.retrieveEntityMetadata(this.$N_1.get_actionableIdentifier().LogicalName).done(function($p1_0) {
            $$t_4.$q_1 = $p1_0.get_entityMetadata();
            $$t_4.$o_1 = $p1_0.get_attributeMetadataCollection();
            if ($$t_4.$q_1.get_isChildEntity()) {
                $$t_4.$G_1.retrieveEntityMetadata($$t_4.$q_1.get_parentEntityLogicalName()).done(function($p2_0) {
                    $$t_4.$1q_1 = $p2_0.get_entityMetadata();
    ...
    $2m_1: function($p0, $p1) {
        ...
        if ($v_3 && $p0.get_isSecured()) {
            $v_4 = this.$G_1.get_userPrivileges().hasAttributeAccessRights($p0, 2, this.$N_1);
        }
        switch ($v_1) {
            case 1:
            ...
            case 8:
                ...
                break;
            case 9:
                $v_2 = new Microsoft.Crm.Client.Core.Models.Validation.MultiSelectPicklistValidator($v_3, $v_4);
                break;
            case 0:
            default:
                $v_2 = null;
...
Mscrm.DataSetFiltering.prototype = {
    ...
    filterExpressionToFetchXml: function(filterExpression) {
        ...
        if (!_Script.isNullOrUndefined(filterExpression.conditions)) {
            ...
            for (var $v_1 = 0; $v_1 < filterExpression.conditions.length; $v_1++) {
                ...
                var $v_4 = this.$j_0($v_2.attributeName);
                ...
                if (_Script.isNullOrUndefined($v_2.value) && _Script.isNullOrUndefined($v_2.values)) {
                ...
                else if (Object.getType($v_2.value) !== Array && !_Script.isNullOrUndefined($v_2.value) && $v_2.value !== '') {
                ...
                else if (Object.getType($v_2.value) === Array && !_Script.isNullOrUndefined($v_2.value) && $v_2.value.length > 0) {
                    var $v_8 = $v_2.value;
                    var $v_9 = $v_8;
                    $v_0 += String.format('<condition {0} {1} {2}>', $v_5, $v_6, $v_7);
                    for (var $v_A = 0; $v_A < $v_9.length; $v_A++) {
                        $v_0 += '<value>' + Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.EncodeDecode.xmlEncode($v_9[$v_A]) + '</value>';
                    }
                    $v_0 += '</condition>';
                }
                    ...
                    var $v_B = $v_2.values;
                    $v_0 += String.format('<condition {0} {1} {2}>', $v_5, $v_6, $v_7);
                    for (var $v_C = 0; $v_C < $v_B.get_Count(); $v_C++) {
                        $v_0 += '<value>' + Microsoft.Crm.Client.Core.Storage.CrmSoapServiceProxy.EncodeDecode.xmlEncode($v_B.get_item($v_C)) + '</value>';
                    }
                    $v_0 += '</condition>';
                }
            }
            ...
            for (var $v_D = 0; $v_D < filterExpression.filters.length; $v_D++) {
                $v_0 += this.filterExpressionToFetchXml(filterExpression.filters[$v_D]);
            }
            if (filterExpression.filters.length > 1) {
                $v_0 += '</filter>';
            }
    ...
    refreshFetchXml: function(fetchXmlDocument, entityLogicalName) {
        Mscrm.DataSetFetchXmlHelper.refreshXmlFiltering(fetchXmlDocument, this.$16_0, this.filterExpressionToFetchXml(this.filterExpression), entityLogicalName);
    },
...
Mscrm.DataSetLookupFiltering.prototype = {
    ...
    disableRelationshipFilter: function() {
        if (this.canDisableRelationshipFilter()) {
            ...
            this.$k_0 = '';
            this.$12_0 = '';
            this.get_$1d_1().reset();
        }
    },
    
    clearFilter: function() {
        if (!Mscrm.InternalUtilities._Script.isNullOrUndefined(this.$1E_1)) {
            this.setFilter(null);
        }
        else {
    ...
    setFilter: function(filterExpression) {
        if (!Mscrm.InternalUtilities._Script.isNullOrUndefined(this.$1E_1)) {
            ...
            $v_0.attributeName = this.get_$1d_1().get_primaryIdAttribute();
            $v_0.value = this.$1E_1;
    ...
    enableRelationshipFilter: function(parentRecord) {
        ...
        if (!Mscrm.InternalUtilities._Script.isNullOrUndefined(parentRecord) && !Mscrm.InternalUtilities._Script.isNullOrUndefined(this.lookupConfiguration.dependentAttributeName) && !Mscrm.InternalUtilities._String.isNullOrEmpty(this.lookupConfiguration.dependentAttributeName)) {
            ...
            this.$11_0 = this.lookupConfiguration.contextFilter;
            this.$k_0 = $v_0;
        }
        this.$12_0 = this.lookupConfiguration.extraCondition;
    },
    
    refreshFetchXml: function(fetchXmlDocument, entityLogicalName) {
        Mscrm.DataSetFiltering.prototype.refreshFetchXml.call(this, fetchXmlDocument, entityLogicalName);
        Mscrm.DataSetFetchXmlHelper.setContextFilterValue(fetchXmlDocument, this.$k_0);
    },
...
Mscrm.DataSetObject.prototype = {
    ...
    get_$26_1: function() {
        if (IsNull(this.$19_1) || !this.$19_1.length) {
    ...
    initialize: function() {
        ...
        $v_0.start();
        var $v_1 = this.$2f_1(this.$8_1.get_layoutXml());
        this.$2g_1($v_1);
        this.set_fetchXml(this.$2j_1(this.$8_1.get_fetchXml()));
        $v_0.stop();
    },
    ...
    $27_1: function() {
        ...
        this.$38_1().always(function() {
            ...
            for (var $$arr_4 = $v_1.entityCollection.get_entities(), $$len_5 = $$arr_4.length, $$idx_6 = 0; $$idx_6 < $$len_5; ++$$idx_6) {
                var $v_3 = $$arr_4[$$idx_6];
                var $v_4 = $$t_C.$1Q_1.buildDataSetRecord($v_3, $$t_C.columns, $$t_C.$E_1);
                var $v_5 = $v_3.get_identifier().get_identifier();
                $$t_C.sortedRecordIds[$v_2] = $v_5;
                $$t_C.records[$v_5] = $v_4;
                $v_4.add_onChange($$t_C.$$d_$2u_1);
                $v_2++;
            }
    ...
    fireOnRecordSelect: function(wrapper) {
        ...
        if ($v_0) {
            var $v_1 = this.$H_1.get_selectedIds()[0];
            var $v_2 = this.records[$v_1];
            if (!_Script.isNullOrUndefined($v_2)) {
                var $$t_4 = this, $$t_5 = this;
                $v_2.enableEditing().then(function() {
                    if (!$v_2.get_isDisposed() && $$t_4.$H_1.get_selectedRecords().length === 1 && Array.indexOf($$t_4.selectedRecordIds, $v_1) !== -1) {
                        $v_0(wrapper, null);
                    }
                }, function() {
                });
    ...
    generateAdditionalAttributes: function() {
        var $v_0 = Microsoft.Crm.Client.Core.Imported.MscrmComponents.deferredPromiseFactory(Boolean, Object);
        var $v_1 = new Array(this.get_$26_1().length);
        for (var $$arr_2 = this.get_$26_1(), $$len_3 = $$arr_2.length, $$idx_4 = 0; $$idx_4 < $$len_3; ++$$idx_4) {
            var $v_2 = $$arr_2[$$idx_4];
    ...
    getLookupDataSet: function(columnName) {
        ...
        return $v_0.getDataSetLookup(this.$1Q_1, this.getSelectedRecord(), $v_2);
    },
    ...
    $2o_1: function($p0) {
        ...
        this.$G_1.update($p0.get_entityRecord()).done(function() {
            ...
            if (!_Script.isNullOrUndefined($v_0) && !_Script.isNullOrUndefined($v_0.documentElement)) {
                ...
                Mscrm.DataSetFetchXmlHelper.refreshXmlFiltering($v_0, $v_3.$16_0, $v_4, $$t_E.$8_1.get_entityLogicalName());
                ...
                $$t_E.$G_1.retrieveMultiple($v_6, $$t_E.$Q_1.$a_0).done(function($p2_0) {
                    var $v_7 = $p2_0;
    ...
    deleteEntityAndRefresh: function(id, entityName) {
        if (_Script.isNullOrUndefined(XrmCore) || _Script.isNullOrUndefined(XrmCore.Commands) || _Script.isNullOrUndefined(XrmCore.Commands.Delete) || _Script.isNullOrUndefined(XrmCore.Commands.Delete.deleteRecords)) {
            return;
        }
        var $v_0 = Xrm.Page.getControl(this.$E_1);
        if (!_Script.isNullOrUndefined($v_0)) {
            var $v_1 = Xrm.Internal.getEntityCode(entityName);
            var $v_2 = new Mscrm.EntityReference();
            $v_2.Id = id;
            $v_2.TypeCode = $v_1;
            var $v_3 = [ $v_2 ];
            XrmCore.Commands.Delete.deleteRecords($v_0, $v_3, entityName);
        }
    },
    ...
    dispose: function() {
        this.$Q_1.cancel();
        this.$25_1();
        this.$H_1.remove_onSelectionChanged(this.$$d_$2J_1);
        this.$H_1.dispose();
        Mscrm.NotifyPropertyChanged.prototype.dispose.call(this);
        this.records = null;
    ...
    $33_1: function($p0, $p1) {
        ...
        this.$G_1.retrieveEntityMetadata($p0).done(function($p1_0) {
            ...
            if ($v_4) {
                $$t_A.$3E_1($v_3, $p1_0.get_entityMetadata().get_logicalName());
            }
            else {
                $$t_A.$3D_1($v_3, $p1_0.get_entityMetadata().get_logicalName());
            }
            $v_1.resolve(true);
        }).fail(function($p1_0) {
            $v_1.reject($p1_0);
    ...
    $25_1: function() {
        ...
        for (var $$key_3 in $$dict_2) {
            var $v_0 = { key: $$key_3, value: $$dict_2[$$key_3] };
            var $v_1 = $v_0.value;
            $v_1.remove_onChange(this.$$d_$2u_1);
            $v_1.dispose();
        }
    },
    ...
    $38_1: function() {
        ...
        var $$t_3 = this, $$t_4 = this;
        this.$G_1.retrieveMultiple(this.$8_1.get_fetchXml(), this.$Q_1.$a_0).done(function($p1_0) {
            $v_0.resolve($p1_0);
        }).fail(function($p1_0) {
    ...
    $2f_1: function($p0) {
        var $v_0 = {};
        this.$1S_1 = new (Microsoft.Crm.Client.Core.Framework.List$1.$$(String))();
    ...
    $2z_1: function() {
        ...
        if (!_Script.isNullOrUndefined($v_0) && !_Script.isNullOrUndefined($v_0.documentElement)) {
            ...
            this.$3F_1();
            Mscrm.DataSetFetchXmlHelper.refreshFetchXmlSorting($v_0, this.$K_1, this.$8_1.get_entityLogicalName());
            Mscrm.DataSetFetchXmlHelper.refreshFetchXmlRollupFields($v_0, this.$1S_1, this.$8_1.get_entityLogicalName());
        }
        this.set_fetchXml(XUI.Xml.XMLSerializer.serializeToString($v_0));
    },
    ...
    $3B_1: function() {
        ...
        if (!this.$1p_1) {
            this.$1p_1 = true;
            var $v_1 = String.format('{0}{1}', Mscrm.DataSetControl.datasetctrL_PREFIX, this.$E_1);
            var $v_2 = $find($v_1);
            if ($v_2) {
            ...
            if (Mscrm.FeatureControl.get_Current().isFeatureEnabled('FCB.EditableGridControlPbl')) {
                ...
                var $v_3 = this.$E_1 + ':' + this.$8_1.get_entityLogicalName();
                if (Mscrm.Utilities.isTurboForm()) {
                    $v_3 = '\'' + $v_3 + '\'';
            ...
            if (Mscrm.FeatureControl.get_Current().isFeatureEnabled('FCB.EditableGridControlJsEvents')) {
                var $v_4 = this.$E_1 + ':' + this.$8_1.get_entityLogicalName();
                if (Mscrm.Utilities.isTurboForm()) {
        ...
        if ((Mscrm.FeatureControl.get_Current().isFeatureEnabled('FCB.EditableGridControlPbl') || Mscrm.FeatureControl.get_Current().isFeatureEnabled('FCB.EditableGridControlJsEvents')) && !_Script.isNullOrUndefined(Xrm.Page) && !_Script.isNullOrUndefined(Xrm.Page.getControl(this.$E_1)) && !_Script.isNullOrUndefined(Xrm.Page.getControl(this.$E_1).getGrid())) {
            Xrm.Page.getControl(this.$E_1).getGrid().fireOnRecordSelect();
        }
        $v_0.stop();
    },
    ...
    $3C_1: function() {
        ...
        $v_0.start();
        if ((Mscrm.FeatureControl.get_Current().isFeatureEnabled('FCB.EditableGridControlPbl') || Mscrm.FeatureControl.get_Current().isFeatureEnabled('FCB.EditableGridControlJsEvents')) && !_Script.isNullOrUndefined(Xrm.Page) && !_Script.isNullOrUndefined(Xrm.Page.getControl(this.$E_1)) && !_Script.isNullOrUndefined(Xrm.Page.getControl(this.$E_1).getGrid()) && !_Script.isNullOrUndefined(Xrm.Page.getControl(this.$E_1).getGrid().getSelectedRows()) && !_Script.isNullOrUndefined(Xrm.Page.getControl(this.$E_1).getGrid().getSelectedRows().get(0)) && !_Script.isNullOrUndefined(Xrm.Page.getControl(this.$E_1).getGrid().getSelectedRows().get(0).getData()) && !_Script.isNullOrUndefined(Xrm.Page.getControl(this.$E_1).getGrid().getSelectedRows().get(0).getData().entity)) {
            var $v_1 = Xrm.Page.getControl(this.$E_1).getGrid().getSelectedRows().get(0).getData().entity;
    ...
    $2S_1: function($p0) {
        ...
        $p0.add_onSelectionChanged(this.$$d_$2J_1);
        return $p0;
    },
    ...
    $2l_1: function() {
        this.$K_1 = Microsoft.Crm.Client.Core.Framework.SortingInfo.createFromFetchXml(XUI.Xml.LoadXml(this.get_fetchXml()));
        if (!_Script.isNull(this.$K_1)) {
            if (!_Script.isNull(this.$K_1.get_SortByField()) && !_Script.isNull(this.$K_1.get_SortDescending())) {
                var $v_0 = new Mscrm.DataSetSorting();
                $v_0.name = this.$K_1.get_SortByField();
                $v_0.sortDirection = (this.$K_1.get_SortDescending()) ? 1 : 0;
                this.sorting[0] = $v_0;
            }
            if (!_Script.isNull(this.$K_1.get_SecondarySortByField()) && !_Script.isNull(this.$K_1.get_SecondarySortDescending())) {
                var $v_1 = new Mscrm.DataSetSorting();
                $v_1.name = this.$K_1.get_SecondarySortByField();
                $v_1.sortDirection = (this.$K_1.get_SecondarySortDescending()) ? 1 : 0;
                this.sorting[1] = $v_1;
            }
        }
    },
...
Mscrm.DataSetObjectInputs.prototype = {
    ...
    get_gridXml: function() {
        return XUI.Xml.XMLSerializer.serializeToString(this.$f_0);
    },
    
    set_gridXml: function(value) {
        this.$f_0 = XUI.Xml.LoadXml(value);
        return value;
    },
    ...
    get_$2K_0: function() {
        return XUI.Xml.SelectSingleNode(this.$f_0, '/grid/parameters', null);
    },
    
    get_$2L_0: function() {
        return XUI.Xml.SelectSingleNode(this.$f_0, '/grid', null);
    },
    
    getProperty: function(key) {
        return this.$2Q_0(this.get_$2L_0(), key);
    },
    
    setProperty: function(key, value) {
        this.$1v_0(this.get_$2L_0(), key, value);
    },
    
    getParameter: function(key) {
        return this.$2Q_0(this.get_$2K_0(), key);
    },
    
    setParameter: function(key, value) {
        this.$1v_0(this.get_$2K_0(), key, value);
    },
    ...
    $2Q_0: function($p0, $p1) {
        ...
        if (!_Script.isNullOrUndefined(this.$t_0)) {
            var $v_3 = ($v_2) ? this.$t_0.GetParameter($p1) : this.$t_0.GetProperty($p1);
    ...
    $1v_0: function($p0, $p1, $p2) {
        var $v_0 = XUI.Xml.SelectSingleNode($p0, $p1, null);
        if (_Script.isNullOrUndefined($v_0)) {
            $v_0 = this.$f_0.createElement($p1);
            $p0.appendChild($v_0);
        }
...
Mscrm.DataSetPaging.prototype = {
    ...
    set_totalResultCount: function(value) {
        this.$u_0.set_totalResultCount(value);
    ...
    set_currentPageNumber: function(value) {
        this.$u_0.set_currentPageNumber(value);
        this.$p_0 = value;
        return value;
    },
    ...
    initialize: function(fetchXml) {
        ...
        if (!_Script.isNullOrUndefined($v_0) && !_Script.isNullOrUndefined($v_0.documentElement)) {
            ...
            if (!_Script.isNullOrUndefined($v_1)) {
                this.$g_0 = Number.parseInvariant($v_1.value);
            }
...
Mscrm.DataSetRecord = function(entityRecord, columns, fieldAccessHelper, controlName, validationErrorMessage) {
    ...
    this.$J_1 = columns;
    this.$15_1 = this.$2a_1(columns);
    this.$1y_1 = this.$2c_1(columns);
    this.$C_1 = fieldAccessHelper;
    this.$L_1 = controlName;
    this.$1z_1 = validationErrorMessage;
...
Mscrm.DataSetRecord.prototype = {
    ...
    set_record: function(value) {
        if (!_Script.isNullOrUndefined(this.$9_1)) {
            this.$9_1.remove_propertyChanged(this.$$d_$2x_1);
        }
        this.$9_1 = value;
        this.$9_1.add_propertyChanged(this.$$d_$2x_1);
        return value;
    },
    ...
    getValue: function(columnAlias) {
        var $v_0 = this.$j_1(columnAlias);
        return this.$R_1[$v_0];
    },
    
    setValue: function(columnAlias, newValue) {
        var $v_0 = Microsoft.Crm.Client.Core.Imported.MscrmComponents.deferredPromiseFactory(Boolean, Mscrm.DataSetControlErrorStatus);
        var $v_1 = this.$1A_1(columnAlias);
        if (_Script.isNullOrUndefined($v_1)) {
            return $v_0.reject();
        }
        ...
        this.$1G_1($v_1.get_name(), $v_2, $v_3);
        $v_0.resolve(true);
        return $v_0.promise();
    },
    ...
    getFormattedValue: function(columnAlias) {
        var $v_0 = this.$j_1(columnAlias);
        if (!_Script.isNullOrUndefined(this.$r_1[$v_0])) {
            return this.$r_1[$v_0];
        }
        else {
            return this.$R_1[$v_0];
    ...
    isRecordValid: function() {
        var $v_0 = Microsoft.Crm.Client.Core.Framework._String.isNullOrWhiteSpace(this.$Z_1);
        for (var $$arr_1 = this.$J_1, $$len_2 = $$arr_1.length, $$idx_3 = 0; $$idx_3 < $$len_2; ++$$idx_3) {
            var $v_1 = $$arr_1[$$idx_3];
    ...
    setFieldEditableProperty: function(columnName, isEditable) {
        ...
        var $v_1 = this.getNotification(columnName);
        var $$t_6 = this, $$t_7 = this;
        this.$C_1.isEditable(this.$1A_1(columnName)).done(function($p1_0) {
            $$t_6.$C_1.setFieldEditableProperty(columnName, isEditable);
            $$t_6.$1G_1(columnName, $v_0, $v_1);
    ...
    isEditable: function(columnName) {
        return this.$C_1.isEditable(this.$1A_1(columnName));
    },
    ...
    enableEditing: function() {
        ...
        for (var $$arr_1 = this.$J_1, $$len_2 = $$arr_1.length, $$idx_3 = 0; $$idx_3 < $$len_2; ++$$idx_3) {
            var $v_1 = $$arr_1[$$idx_3];
            Array.add($v_0, this.isEditable($v_1.get_alias()));
            Array.add($v_0, this.getFieldRequiredLevel($v_1.get_alias()));
        }
        return Microsoft.Crm.Client.Core.Imported.DeferredPromiseHelper.whenArray($v_0);
    },
    ...
    getNamedReference: function() {
        var $v_0 = this.$9_1.get_namedReference();
        $v_0.id = $v_0.get_identifier();
        $v_0.typeName = $v_0.TypeName;
        $v_0.logicalName = $v_0.LogicalName;
        $v_0.entityType = $v_0.LogicalName;
        $v_0.name = $v_0.Name;
        return $v_0;
    },
    ...
    validateAllColumns: function() {
        var $v_0 = Microsoft.Crm.Client.Core.Imported.MscrmComponents.deferredPromiseFactory(Boolean, Mscrm.DataSetControlErrorStatus);
        var $v_1 = Mscrm.DataSetColumn.filterByMainEntityVisibleColumns(this.$J_1);
        ...
        this.$C_1.getValidationParameters($v_1).done(function($p1_0) {
            for (var $$arr_3 = $v_1, $$len_4 = $$arr_3.length, $$idx_5 = 0; $$idx_5 < $$len_4; ++$$idx_5) {
                ...
                $$t_B.$2D_1($v_2.get_name(), $v_3, $v_4, $v_5);
            }
            $v_0.resolve($$t_B.isRecordValid());
        }).fail(function($p1_0) {
            $$t_C.$Z_1 = $p1_0.message;
            $v_0.reject($p1_0);
        });
        return $v_0.promise();
    },
    ...
    merge: function(changes) {
        var $v_0 = new Mscrm.Performance.PerformanceStopwatch('DataSetControl.MergeChanges ' + this.$L_1);
        $v_0.start();
        this.$1M_1 = true;
        try {
    ...
    $1G_1: function($p0, $p1, $p2) {
        var $$t_6 = this, $$t_7 = this;
        this.$C_1.getValidationParameters([ this.$1A_1($p0) ]).done(function($p1_0) {
            var $v_0 = $p1_0[$p0];
            $$t_6.$2D_1($p0, $v_0, $p1, $p2);
        }).fail(function($p1_0) {
            $$t_7.$Z_1 = $p1_0.message;
        });
    },
    
    $2D_1: function($p0, $p1, $p2, $p3) {
        var $v_0 = $p2;
        var $v_1 = this.getValue($p0);
        var $v_2 = this.getColumnType($p0);
        if (!_Script.isNullOrUndefined($v_1) && ($v_2 === 'decimal' || $v_2 === 'money' || $v_2 === 'float' || $v_2 === 'double')) {
            $v_1 = String.localeFormat('{0:N10}', $v_1);
        }
        var $v_3 = false;
        if (!_Script.isNullOrUndefined($p1) && !_Script.isNullOrUndefined($p1.$l_0)) {
            var $v_4 = !$p1.$y_0;
            var $v_5 = $p1.$l_0.validate($v_1, $v_3, $v_4);
            this.$C_1.setValidatorResult($p0, $v_5.isValid, $v_1, $v_5.errorMessage);
            $v_0 = this.$C_1.isValid($p0);
            var $v_6 = this.$C_1.getNotification($p0);
            if ($p2 !== $v_0 || $p3 !== $v_6) {
    ...
    $j_1: function($p0) {
        if (!_Script.isNullOrUndefined(this.$15_1[$p0])) {
            return this.$15_1[$p0];
        }
        return $p0;
    },
    ...
    $1A_1: function($p0) {
        var $v_0 = this.$15_1[$p0];
        var $v_1 = !_Script.isNullOrUndefined($v_0);
        for (var $$arr_3 = this.$J_1, $$len_4 = $$arr_3.length, $$idx_5 = 0; $$idx_5 < $$len_4; ++$$idx_5) {
            var $v_2 = $$arr_3[$$idx_5];
    ...
    refreshValues: function(record) {
        ...
        for (var $$arr_1 = this.$J_1, $$len_2 = $$arr_1.length, $$idx_3 = 0; $$idx_3 < $$len_2; ++$$idx_3) {
            var $v_0 = $$arr_1[$$idx_3];
            var $v_1 = this.$2n_1(record, $v_0.get_name());
    ...
    $3A_1: function($p0) {
        var $v_0 = new Mscrm.Performance.PerformanceStopwatch('DataSetControl.DataSetRecord.RunOnDataSetColumnChangeHandlers ' + this.$L_1);
        $v_0.start();
        if ((Mscrm.FeatureControl.get_Current().isFeatureEnabled('FCB.EditableGridControlPbl') || Mscrm.FeatureControl.get_Current().isFeatureEnabled('FCB.EditableGridControlJsEvents')) && !_Script.isNullOrUndefined(Xrm.Page) && !_Script.isNullOrUndefined(Xrm.Page.getControl(this.$L_1)) && !_Script.isNullOrUndefined(Xrm.Page.getControl(this.$L_1).getGrid()) && !_Script.isNullOrUndefined(Xrm.Page.getControl(this.$L_1).getGrid().getSelectedRows()) && !_Script.isNullOrUndefined(Xrm.Page.getControl(this.$L_1).getGrid().getSelectedRows().get(0)) && !_Script.isNullOrUndefined(Xrm.Page.getControl(this.$L_1).getGrid().getSelectedRows().get(0).getData()) && !_Script.isNullOrUndefined(Xrm.Page.getControl(this.$L_1).getGrid().getSelectedRows().get(0).getData().entity) && !_Script.isNullOrUndefined(Xrm.Page.getControl(this.$L_1).getGrid().getSelectedRows().get(0).getData().entity.attributes)) {
            if (!_Script.isNullOrUndefined(Xrm.Page.getControl(this.$L_1).getGrid().getSelectedRows().get(0).getData().entity.attributes.get($p0))) {
                Xrm.Page.getControl(this.$L_1).getGrid().getSelectedRows().get(0).getData().entity.attributes.get($p0).fireOnChange();
            }
        }
        $v_0.stop();
    }
...
Mscrm.DataSetRecordSelectionHelper = function(dataSetObject) {
    ...
    this.$F_1 = {};
    this.$O_1 = {};
    this.$7_1.addOnDataSetUpdated(this.$$d_$2H_1);
}
Mscrm.DataSetRecordSelectionHelper.prototype = {
    ...
    selectRecord: function(id) {
        if (!_Script.isNullOrUndefined(this.$F_1) && ((id) in this.$F_1)) {
            return;
        }
        this.$F_1 = {};
        if (((id) in this.$O_1)) {
            this.$F_1[id] = this.$O_1[id];
        }
        else {
        }
        this.fireEvent('OnSelectionChanged', null);
    ...
    selectRecords: function(ids) {
        ...
        for (var $v_4 = 0; $v_4 < $v_1.get_Count(); $v_4++) {
            delete this.$F_1[$v_1.get_item($v_4)];
            $v_2 = true;
        }
        for (var $v_5 = 0; $v_5 < $v_0.get_Count(); $v_5++) {
            if ((($v_0.get_item($v_5)) in this.$O_1)) {
                if ((($v_0.get_item($v_5)) in this.$F_1)) {
                    continue;
                }
                this.$F_1[$v_0.get_item($v_5)] = this.$O_1[$v_0.get_item($v_5)];
                $v_2 = true;
            }
            else {
            }
    ...
    get_recordCount: function() {
        return Microsoft.Crm.Client.Core.Framework._Dictionary.count(this.$O_1);
    },
    ...
    get_selectedRecordCount: function() {
        return Microsoft.Crm.Client.Core.Framework._Dictionary.count(this.$F_1);
    },
    ...
    $2H_1: function() {
        this.$O_1 = this.$7_1.get_records() || {};
        this.clearSelection();
    },
    
    dispose: function() {
        this.$7_1.removeOnDataSetUpdated(this.$$d_$2H_1);
        this.$7_1 = null;
        this.$O_1 = null;
        this.$F_1 = null;
        Mscrm.NotifyPropertyChanged.prototype.dispose.call(this);
...
Mscrm.NotifyPropertyChanged.prototype = {
    ...
    get_$1g_0: function() {
        return this.$1I_0 || (this.$1I_0 = new Sys.EventHandlerList());
    },
    
    addEventHandler: function(eventName, eventHandler) {
        this.get_$1g_0().addHandler(eventName, eventHandler);
    },
    
    removeEventHandler: function(eventName, eventHandler) {
        this.get_$1g_0().removeHandler(eventName, eventHandler);
    },
    
    getHandler: function(eventName) {
        return this.get_$1g_0().getHandler(eventName);
    },
    ...
    dispose: function() {
        this.$1I_0 = new Sys.EventHandlerList();
    }
}
...
Mscrm.XrmControlDataSetWrapper.prototype = {
    ...
    get_$h_1: function() {
        try {
            return this.$m_1.$2_3.get_primaryDataSet();
        }
        catch ($$e_0) {
            return null;
        }
    ...
    getTotalRecordCount: function() {
        return this.$m_1.get_totalRecordCount();
    },
    
    getRows: function() {
        return this.$2B_1(false);
    },
    
    getSelectedRows: function() {
        return this.$2B_1(true);
    },
    ...
    $2B_1: function($p0) {
        ...
        var $v_1 = ($p0) ? this.$m_1.get_selectedRecords() : this.$m_1.get_allRecords();
        ...
        for (var $$arr_4 = $v_1, $$len_5 = $$arr_4.length, $$idx_6 = 0; $$idx_6 < $$len_5; ++$$idx_6) {
            var $v_3 = $$arr_4[$$idx_6];
            $v_0.add(new Mscrm.XrmDataSetRecordWrapper(this.get_$h_1(), $v_3, $v_2));
        }
        return $v_0;
    },
    
    addOnRecordSelect: function(handler) {
        if ((Mscrm.FeatureControl.get_Current().isFeatureEnabled('FCB.EditableGridControlPbl') || Mscrm.FeatureControl.get_Current().isFeatureEnabled('FCB.EditableGridControlJsEvents')) && !IsNull(this.get_$h_1())) {
            this.get_$h_1().addOnRecordSelect(handler, false);
        }
    },
    
    removeOnRecordSelect: function(handler) {
        if ((Mscrm.FeatureControl.get_Current().isFeatureEnabled('FCB.EditableGridControlPbl') || Mscrm.FeatureControl.get_Current().isFeatureEnabled('FCB.EditableGridControlJsEvents')) && !IsNull(this.get_$h_1())) {
            this.get_$h_1().removeOnRecordSelect(handler);
        }
    },
    
    fireOnRecordSelect: function() {
        if ((Mscrm.FeatureControl.get_Current().isFeatureEnabled('FCB.EditableGridControlPbl') || Mscrm.FeatureControl.get_Current().isFeatureEnabled('FCB.EditableGridControlJsEvents')) && !IsNull(this.get_$h_1())) {
            this.get_$h_1().fireOnRecordSelect(this.getSelectedRows().get(0).getData().entity);
        }
    },
...
Mscrm.XrmDataSetDataWrapper = function($p0, $p1, $p2) {
    ...
    this.$M_1 = $p1;
    this.$4_1 = $p2;
    this.entity = new Mscrm.XrmDataSetEntityWrapper(this.$5_1, this.$M_1, this.$4_1);
}
...
Mscrm.XrmDataSetEntityMultiSelectOptionSetAttributeWrapper = function($p0, $p1, $p2, $p3, $p4, $p5) {
    Mscrm.XrmDataSetEntityMultiSelectOptionSetAttributeWrapper.initializeBase(this);
    this.$0_3 = new Mscrm.XrmDataSetEntityAttributeWrapper($p0, $p1, $p2, $p3, $p4, $p5);
    this.controls = this.$0_3.controls;
    this.$1_3 = $p2;
}
Mscrm.XrmDataSetEntityMultiSelectOptionSetAttributeWrapper.prototype = {
    $0_3: null,
    $1_3: null,
    ...
    getSelectedOption: function() {
        if (!IsNull(this.$0_3.getValue())) {
            var $v_0 = [];
            var $v_1 = 0;
            var $v_2 = this.$0_3.getValue();
            for (var $v_3 = 0; $v_3 < $v_2.length; $v_3++) {
                if (!IsNull($v_2[$v_3])) {
                    $v_0[$v_1++] = this.getOption($v_2[$v_3]);
                }
            }
            return $v_0;
        }
    ...
    getText: function() {
        if (!IsNull(this.$0_3.getValue())) {
            ...
            var $v_2 = this.$0_3.getValue();
            for (var $v_3 = 0; $v_3 < $v_2.length; $v_3++) {
                var $v_4 = $v_2[$v_3].toString();
                if (!IsNull(this.$1_3) && !IsNull(this.$1_3.get_attributeMetadata()) && !IsNull(this.$1_3.get_attributeMetadata().get_optionSet()) && !IsNull(this.$1_3.get_attributeMetadata().get_optionSet().get_options()) && !IsNull(this.$1_3.get_attributeMetadata().get_optionSet().get_options()[$v_4])) {
                    var $v_5 = this.$1_3.get_attributeMetadata().get_optionSet().get_options()[$v_4.toString()];
                    if (!IsNull($v_5) && !IsNull($v_5.get_label())) {
                        $v_0[$v_1++] = $v_5.get_label();
                    }
                }
            }
            return $v_0;
    ...
    setValue: function(value) {
        ...
        if (!IsNull($v_0) && $v_0.length > 0) {
            this.$0_3.setValue($v_0);
        }
        else {
            this.$0_3.setValue(null);
        }
    }
}
    ...
    if (!IsNull(this.$5_1) && !IsNull(this.$5_1.get_columns())) {
        for (var $$arr_3 = this.$5_1.get_columns(), $$len_4 = $$arr_3.length, $$idx_5 = 0; $$idx_5 < $$len_4; ++$$idx_5) {
            ...
            switch ($v_0.get_attributeType()) {
                case 2:
                    this.attributes.add(new Mscrm.XrmDataSetEntityDateTimeAttributeWrapper(this.$5_1, this.get_$17_1(), $v_0, this.$4_1, this, $v_0.get_name()));
                    break;
                case 0:
                    this.attributes.add(new Mscrm.XrmDataSetEntityBooleanAttributeWrapper(this.$5_1, this.get_$17_1(), $v_0, this.$4_1, this, $v_0.get_name()));
                    break;
                case 11:
                case 12:
                case 13:
                    this.attributes.add(new Mscrm.XrmDataSetEntityOptionSetAttributeWrapper(this.$5_1, this.get_$17_1(), $v_0, this.$4_1, this, $v_0.get_name()));
                    break;
                case 24:
                    this.attributes.add(new Mscrm.XrmDataSetEntityMultiSelectOptionSetAttributeWrapper(this.$5_1, this.get_$17_1(), $v_0, this.$4_1, this, $v_0.get_name()));
                    break;
                default:
                    this.attributes.add(new Mscrm.XrmDataSetEntityAttributeWrapper(this.$5_1, this.get_$17_1(), $v_0, this.$4_1, this, $v_0.get_name()));
                    break;
            }
        }
    }
...
Mscrm.XrmDataSetEntityWrapper.prototype = {
    ...
    get_$17_1: function() {
        if (IsNull(this.$6_1) && !IsNull(this.$5_1) && !IsNull(this.$5_1.get_records()) && !IsNull(((this.$M_1.Id) in this.$5_1.get_records()))) {
            this.$6_1 = this.$5_1.get_records()[this.$M_1.Id];
        }
        return this.$6_1;
    },
    
    getEntityName: function() {
        return this.$M_1.TypeName;
    },
...
Mscrm.XrmDataSetRecordWrapper = function($p0, $p1, $p2) {
    ...
    this.$M_1 = $p1;
    this.$4_1 = $p2;
    this.data = new Mscrm.XrmDataSetDataWrapper(this.$5_1, this.$M_1, this.$4_1);
}
...
Type.registerNamespace('Mscrm.WebCustom.Control.View');

Mscrm.WebCustom.Control.View.DataSetControlInstanceAdapter = function($p0, $p1) {
    this.$21_0 = new Mscrm.WebCustom.Control.View.WebCustomControlView($p0, $p1);
}
Mscrm.WebCustom.Control.View.DataSetControlInstanceAdapter.prototype = {
    $21_0: null,
...
Mscrm.XrmDataSetEntityMultiSelectOptionSetAttributeWrapper.registerClass('Mscrm.XrmDataSetEntityMultiSelectOptionSetAttributeWrapper', Xrm.XrmEntityAttributeOptionSet, Xrm.Interfaces.IXrmDataSetColumn);
...
Mscrm.WebCustom.Control.View.DataSetControlInstanceAdapter.registerClass('Mscrm.WebCustom.Control.View.DataSetControlInstanceAdapter', null, Mscrm.IDataSetControlInstance);
...
Mscrm.DataSetControlDataProvider.$1K = null;
