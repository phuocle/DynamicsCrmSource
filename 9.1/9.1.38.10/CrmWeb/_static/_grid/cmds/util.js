...
function DisplayActionMsg(sMsg,iWidth,iHeight)
{
    if(IsNull(_oActMsgPopup) || IsNull(XUI.Html.DomUtils.GetFirstChild(_oActMsgDom)))
    {
        ...
        _oActMsgDom.innerHTML = "<table width=100% height=100%><tr><td style='font-weight: bold; font-size: 15px;text-align: center; vertical-align: middle; cursor: wait; color: #000099'> </td></tr></table>";
