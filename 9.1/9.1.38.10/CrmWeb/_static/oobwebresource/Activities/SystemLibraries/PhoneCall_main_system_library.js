...
(function (Activities) {
    ...
    var PhoneCallPageHandler = (function (_super) {
        ...
        /// <summary>
        /// Sets the default value for a new phonecall form
        /// </summary>
        ...
        /// <summary>
        /// Sets the priority to normal, which is a default value
        /// </summary>
        PhoneCallPageHandler.prototype.setDefaultPriority = function (xrmPage, telemetryItem) {
            ...
            if (!Activities.Common.Util.IsNull(priorityAttribute) && Activities.Common.Util.IsNull(priorityAttribute.getValue())) {
