...
function ExportErrors(importFileId,gridRecordsNumber)
{
    if(gridRecordsNumber > 0)
    {
        ...
        errorRowForm.action = Mscrm.CrmUri.create("/import/downloaderrors.aspx?id=" + CrmEncodeDecode.CrmUrlEncode(importFileId)).toString();
        errorRowForm.submit()
    }
    else
...
function assignImport()
{
    ...
    var callbackFunctionObject = Mscrm.Utilities.createCallbackFunctionObject("frmAssignImportAction",this,parameters);
